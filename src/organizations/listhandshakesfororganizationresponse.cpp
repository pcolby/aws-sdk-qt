 ...
 *
 * \brief The ListHandshakesForOrganizationResponse class encapsulates Organizations ListHandshakesForOrganization responses.
 *
 ...
 *
 * \sa OrganizationsClient::listHandshakesForOrganization
 */
