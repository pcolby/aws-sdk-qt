...
#include "deregisterdelegatedadministratorrequest_p.h"
...
/*!
 * \class QtAws::Organizations::DeregisterDelegatedAdministratorRequest
 * \brief The DeregisterDelegatedAdministratorRequest class provides an interface for Organizations DeregisterDelegatedAdministrator requests.
 *
 ...
 */
DeregisterDelegatedAdministratorRequest::DeregisterDelegatedAdministratorRequest(const DeregisterDelegatedAdministratorRequest &other)
    : OrganizationsRequest(new DeregisterDelegatedAdministratorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeregisterDelegatedAdministratorRequest object.
 */
DeregisterDelegatedAdministratorRequest::DeregisterDelegatedAdministratorRequest()
    : OrganizationsRequest(new DeregisterDelegatedAdministratorRequestPrivate(OrganizationsRequest::DeregisterDelegatedAdministratorAction, this))
{
 ...
 * \reimp
 */
bool DeregisterDelegatedAdministratorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeregisterDelegatedAdministratorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeregisterDelegatedAdministratorRequest::response(QNetworkReply * const reply) const
{
    return new DeregisterDelegatedAdministratorResponse(*this, reply);
}

/*!
 * \class QtAws::Organizations::DeregisterDelegatedAdministratorRequestPrivate
 * \brief The DeregisterDelegatedAdministratorRequestPrivate class provides private implementation for DeregisterDelegatedAdministratorRequest.
 * \internal
 *
 * \inmodule QtAwsOrganizations
 */
...
/*!
 * Constructs a DeregisterDelegatedAdministratorRequestPrivate object for Organizations \a action,
 * with public implementation \a q.
 */
DeregisterDelegatedAdministratorRequestPrivate::DeregisterDelegatedAdministratorRequestPrivate(
    const OrganizationsRequest::Action action, DeregisterDelegatedAdministratorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeregisterDelegatedAdministratorRequest
 * class' copy constructor.
 */
DeregisterDelegatedAdministratorRequestPrivate::DeregisterDelegatedAdministratorRequestPrivate(
    const DeregisterDelegatedAdministratorRequestPrivate &other, DeregisterDelegatedAdministratorRequest * const q)
