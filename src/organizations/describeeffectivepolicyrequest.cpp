...
#include "describeeffectivepolicyrequest_p.h"
...
/*!
 * \class QtAws::Organizations::DescribeEffectivePolicyRequest
 * \brief The DescribeEffectivePolicyRequest class provides an interface for Organizations DescribeEffectivePolicy requests.
 *
 ...
 */
DescribeEffectivePolicyRequest::DescribeEffectivePolicyRequest(const DescribeEffectivePolicyRequest &other)
    : OrganizationsRequest(new DescribeEffectivePolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeEffectivePolicyRequest object.
 */
DescribeEffectivePolicyRequest::DescribeEffectivePolicyRequest()
    : OrganizationsRequest(new DescribeEffectivePolicyRequestPrivate(OrganizationsRequest::DescribeEffectivePolicyAction, this))
{
 ...
 * \reimp
 */
bool DescribeEffectivePolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeEffectivePolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeEffectivePolicyRequest::response(QNetworkReply * const reply) const
{
    return new DescribeEffectivePolicyResponse(*this, reply);
}

/*!
 * \class QtAws::Organizations::DescribeEffectivePolicyRequestPrivate
 * \brief The DescribeEffectivePolicyRequestPrivate class provides private implementation for DescribeEffectivePolicyRequest.
 * \internal
 *
 * \inmodule QtAwsOrganizations
 */
...
/*!
 * Constructs a DescribeEffectivePolicyRequestPrivate object for Organizations \a action,
 * with public implementation \a q.
 */
DescribeEffectivePolicyRequestPrivate::DescribeEffectivePolicyRequestPrivate(
    const OrganizationsRequest::Action action, DescribeEffectivePolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeEffectivePolicyRequest
 * class' copy constructor.
 */
DescribeEffectivePolicyRequestPrivate::DescribeEffectivePolicyRequestPrivate(
    const DescribeEffectivePolicyRequestPrivate &other, DescribeEffectivePolicyRequest * const q)
