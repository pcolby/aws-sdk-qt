...
/*!
 * \class QtAws::Organizations::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Organizations UntagResource responses.
 *
 ...
 *
 * \sa OrganizationsClient::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : OrganizationsResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(OrganizationsResponse::request());
}

/*!
 * \reimp
 * Parses a successful Organizations UntagResource \a response.
 */
...
/*!
 * \class QtAws::Organizations::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : OrganizationsResponsePrivate(q)
{

}

/*!
 * Parses a Organizations UntagResource response element from \a xml.
 */
