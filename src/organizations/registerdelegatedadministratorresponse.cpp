...
#include "registerdelegatedadministratorresponse_p.h"
...
/*!
 * \class QtAws::Organizations::RegisterDelegatedAdministratorResponse
 * \brief The RegisterDelegatedAdministratorResponse class provides an interace for Organizations RegisterDelegatedAdministrator responses.
 *
 ...
 *
 * \sa OrganizationsClient::registerDelegatedAdministrator
 */

/*!
 * Constructs a RegisterDelegatedAdministratorResponse object for \a reply to \a request, with parent \a parent.
 */
RegisterDelegatedAdministratorResponse::RegisterDelegatedAdministratorResponse(
        const RegisterDelegatedAdministratorRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : OrganizationsResponse(new RegisterDelegatedAdministratorResponsePrivate(this), parent)
{
    setRequest(new RegisterDelegatedAdministratorRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const RegisterDelegatedAdministratorRequest * RegisterDelegatedAdministratorResponse::request() const
{
    Q_D(const RegisterDelegatedAdministratorResponse);
    return static_cast<const RegisterDelegatedAdministratorRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Organizations RegisterDelegatedAdministrator \a response.
 */
void RegisterDelegatedAdministratorResponse::parseSuccess(QIODevice &response)
{
    //Q_D(RegisterDelegatedAdministratorResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Organizations::RegisterDelegatedAdministratorResponsePrivate
 * \brief The RegisterDelegatedAdministratorResponsePrivate class provides private implementation for RegisterDelegatedAdministratorResponse.
 * \internal
 *
 * \inmodule QtAwsOrganizations
 */
...
/*!
 * Constructs a RegisterDelegatedAdministratorResponsePrivate object with public implementation \a q.
 */
RegisterDelegatedAdministratorResponsePrivate::RegisterDelegatedAdministratorResponsePrivate(
    RegisterDelegatedAdministratorResponse * const q) : OrganizationsResponsePrivate(q)
{

}

/*!
 * Parses a Organizations RegisterDelegatedAdministrator response element from \a xml.
 */
void RegisterDelegatedAdministratorResponsePrivate::parseRegisterDelegatedAdministratorResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("RegisterDelegatedAdministratorResponse"));
    Q_UNUSED(xml) ///< @todo
}
