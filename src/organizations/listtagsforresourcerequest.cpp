...
/*!
 * \class QtAws::Organizations::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for Organizations ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : OrganizationsRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : OrganizationsRequest(new ListTagsForResourceRequestPrivate(OrganizationsRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::Organizations::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for Organizations \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const OrganizationsRequest::Action action, ListTagsForResourceRequest * const q)
