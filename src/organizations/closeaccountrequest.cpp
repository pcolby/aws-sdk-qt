...
#include "closeaccountrequest_p.h"
...
/*!
 * \class QtAws::Organizations::CloseAccountRequest
 * \brief The CloseAccountRequest class provides an interface for Organizations CloseAccount requests.
 *
 ...
 */
CloseAccountRequest::CloseAccountRequest(const CloseAccountRequest &other)
    : OrganizationsRequest(new CloseAccountRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CloseAccountRequest object.
 */
CloseAccountRequest::CloseAccountRequest()
    : OrganizationsRequest(new CloseAccountRequestPrivate(OrganizationsRequest::CloseAccountAction, this))
{
 ...
 * \reimp
 */
bool CloseAccountRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CloseAccountResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CloseAccountRequest::response(QNetworkReply * const reply) const
{
    return new CloseAccountResponse(*this, reply);
}

/*!
 * \class QtAws::Organizations::CloseAccountRequestPrivate
 * \brief The CloseAccountRequestPrivate class provides private implementation for CloseAccountRequest.
 * \internal
 *
 * \inmodule QtAwsOrganizations
 */
...
/*!
 * Constructs a CloseAccountRequestPrivate object for Organizations \a action,
 * with public implementation \a q.
 */
CloseAccountRequestPrivate::CloseAccountRequestPrivate(
    const OrganizationsRequest::Action action, CloseAccountRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CloseAccountRequest
 * class' copy constructor.
 */
CloseAccountRequestPrivate::CloseAccountRequestPrivate(
    const CloseAccountRequestPrivate &other, CloseAccountRequest * const q)
