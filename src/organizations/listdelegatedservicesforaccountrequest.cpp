...
#include "listdelegatedservicesforaccountrequest_p.h"
...
/*!
 * \class QtAws::Organizations::ListDelegatedServicesForAccountRequest
 * \brief The ListDelegatedServicesForAccountRequest class provides an interface for Organizations ListDelegatedServicesForAccount requests.
 *
 ...
 */
ListDelegatedServicesForAccountRequest::ListDelegatedServicesForAccountRequest(const ListDelegatedServicesForAccountRequest &other)
    : OrganizationsRequest(new ListDelegatedServicesForAccountRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListDelegatedServicesForAccountRequest object.
 */
ListDelegatedServicesForAccountRequest::ListDelegatedServicesForAccountRequest()
    : OrganizationsRequest(new ListDelegatedServicesForAccountRequestPrivate(OrganizationsRequest::ListDelegatedServicesForAccountAction, this))
{
 ...
 * \reimp
 */
bool ListDelegatedServicesForAccountRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListDelegatedServicesForAccountResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListDelegatedServicesForAccountRequest::response(QNetworkReply * const reply) const
{
    return new ListDelegatedServicesForAccountResponse(*this, reply);
}

/*!
 * \class QtAws::Organizations::ListDelegatedServicesForAccountRequestPrivate
 * \brief The ListDelegatedServicesForAccountRequestPrivate class provides private implementation for ListDelegatedServicesForAccountRequest.
 * \internal
 *
 * \inmodule QtAwsOrganizations
 */
...
/*!
 * Constructs a ListDelegatedServicesForAccountRequestPrivate object for Organizations \a action,
 * with public implementation \a q.
 */
ListDelegatedServicesForAccountRequestPrivate::ListDelegatedServicesForAccountRequestPrivate(
    const OrganizationsRequest::Action action, ListDelegatedServicesForAccountRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListDelegatedServicesForAccountRequest
 * class' copy constructor.
 */
ListDelegatedServicesForAccountRequestPrivate::ListDelegatedServicesForAccountRequestPrivate(
    const ListDelegatedServicesForAccountRequestPrivate &other, ListDelegatedServicesForAccountRequest * const q)
