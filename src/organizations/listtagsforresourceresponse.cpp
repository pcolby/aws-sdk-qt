...
/*!
 * \class QtAws::Organizations::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Organizations ListTagsForResource responses.
 *
 ...
 *
 * \sa OrganizationsClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : OrganizationsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(OrganizationsResponse::request());
}

/*!
 * \reimp
 * Parses a successful Organizations ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Organizations::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : OrganizationsResponsePrivate(q)
{

}

/*!
 * Parses a Organizations ListTagsForResource response element from \a xml.
 */
