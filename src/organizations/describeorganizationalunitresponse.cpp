 ...
 *
 * \brief The DescribeOrganizationalUnitResponse class encapsulates Organizations DescribeOrganizationalUnit responses.
 *
 ...
 *
 * \sa OrganizationsClient::describeOrganizationalUnit
 */
