...
#include "listdelegatedadministratorsrequest_p.h"
...
/*!
 * \class QtAws::Organizations::ListDelegatedAdministratorsRequest
 * \brief The ListDelegatedAdministratorsRequest class provides an interface for Organizations ListDelegatedAdministrators requests.
 *
 ...
 *
 * \sa OrganizationsClient::listDelegatedAdministrators
 */

/*!
 * Constructs a copy of \a other.
 */
ListDelegatedAdministratorsRequest::ListDelegatedAdministratorsRequest(const ListDelegatedAdministratorsRequest &other)
    : OrganizationsRequest(new ListDelegatedAdministratorsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListDelegatedAdministratorsRequest object.
 */
ListDelegatedAdministratorsRequest::ListDelegatedAdministratorsRequest()
    : OrganizationsRequest(new ListDelegatedAdministratorsRequestPrivate(OrganizationsRequest::ListDelegatedAdministratorsAction, this))
{
 ...
 * \reimp
 */
bool ListDelegatedAdministratorsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListDelegatedAdministratorsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListDelegatedAdministratorsRequest::response(QNetworkReply * const reply) const
{
    return new ListDelegatedAdministratorsResponse(*this, reply);
}

/*!
 * \class QtAws::Organizations::ListDelegatedAdministratorsRequestPrivate
 * \brief The ListDelegatedAdministratorsRequestPrivate class provides private implementation for ListDelegatedAdministratorsRequest.
 * \internal
 *
 * \inmodule QtAwsOrganizations
 */
...
/*!
 * Constructs a ListDelegatedAdministratorsRequestPrivate object for Organizations \a action,
 * with public implementation \a q.
 */
ListDelegatedAdministratorsRequestPrivate::ListDelegatedAdministratorsRequestPrivate(
    const OrganizationsRequest::Action action, ListDelegatedAdministratorsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListDelegatedAdministratorsRequest
 * class' copy constructor.
 */
ListDelegatedAdministratorsRequestPrivate::ListDelegatedAdministratorsRequestPrivate(
    const ListDelegatedAdministratorsRequestPrivate &other, ListDelegatedAdministratorsRequest * const q)
