...
#include "listdelegatedadministratorsresponse_p.h"
...
/*!
 * \class QtAws::Organizations::ListDelegatedAdministratorsResponse
 * \brief The ListDelegatedAdministratorsResponse class provides an interace for Organizations ListDelegatedAdministrators responses.
 *
...
/*!
 * Constructs a ListDelegatedAdministratorsResponse object for \a reply to \a request, with parent \a parent.
 */
ListDelegatedAdministratorsResponse::ListDelegatedAdministratorsResponse(
        const ListDelegatedAdministratorsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : OrganizationsResponse(new ListDelegatedAdministratorsResponsePrivate(this), parent)
{
    setRequest(new ListDelegatedAdministratorsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Organizations ListDelegatedAdministrators \a response.
 */
void ListDelegatedAdministratorsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListDelegatedAdministratorsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Organizations::ListDelegatedAdministratorsResponsePrivate
 * \brief The ListDelegatedAdministratorsResponsePrivate class provides private implementation for ListDelegatedAdministratorsResponse.
 * \internal
 *
 * \inmodule QtAwsOrganizations
 */
...
/*!
 * Constructs a ListDelegatedAdministratorsResponsePrivate object with public implementation \a q.
 */
ListDelegatedAdministratorsResponsePrivate::ListDelegatedAdministratorsResponsePrivate(
    ListDelegatedAdministratorsResponse * const q) : OrganizationsResponsePrivate(q)
{

}

/*!
 * Parses a Organizations ListDelegatedAdministrators response element from \a xml.
 */
void ListDelegatedAdministratorsResponsePrivate::parseListDelegatedAdministratorsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListDelegatedAdministratorsResponse"));
    Q_UNUSED(xml) ///< @todo
}
