...
#include "leaveorganizationrequest_p.h"
...
/*!
 * \class QtAws::Organizations::LeaveOrganizationRequest
 * \brief The LeaveOrganizationRequest class provides an interface for Organizations LeaveOrganization requests.
 *
 ...
 *
 * \sa OrganizationsClient::leaveOrganization
 */

/*!
 * Constructs a copy of \a other.
 */
LeaveOrganizationRequest::LeaveOrganizationRequest(const LeaveOrganizationRequest &other)
    : OrganizationsRequest(new LeaveOrganizationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a LeaveOrganizationRequest object.
 */
LeaveOrganizationRequest::LeaveOrganizationRequest()
    : OrganizationsRequest(new LeaveOrganizationRequestPrivate(OrganizationsRequest::LeaveOrganizationAction, this))
{
 ...
 * \reimp
 */
bool LeaveOrganizationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a LeaveOrganizationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * LeaveOrganizationRequest::response(QNetworkReply * const reply) const
{
    return new LeaveOrganizationResponse(*this, reply);
}

/*!
 * \class QtAws::Organizations::LeaveOrganizationRequestPrivate
 * \brief The LeaveOrganizationRequestPrivate class provides private implementation for LeaveOrganizationRequest.
 * \internal
 *
 * \inmodule QtAwsOrganizations
 */
...
/*!
 * Constructs a LeaveOrganizationRequestPrivate object for Organizations \a action,
 * with public implementation \a q.
 */
LeaveOrganizationRequestPrivate::LeaveOrganizationRequestPrivate(
    const OrganizationsRequest::Action action, LeaveOrganizationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the LeaveOrganizationRequest
 * class' copy constructor.
 */
LeaveOrganizationRequestPrivate::LeaveOrganizationRequestPrivate(
    const LeaveOrganizationRequestPrivate &other, LeaveOrganizationRequest * const q)
