...
/*!
 * \class QtAws::Organizations::DeleteOrganizationRequest
 * \brief The DeleteOrganizationRequest class provides an interface for Organizations DeleteOrganization requests.
 *
 ...
 *
 * \sa OrganizationsClient::deleteOrganization
 */
...
DeleteOrganizationRequest::DeleteOrganizationRequest(const DeleteOrganizationRequest &other)
    : OrganizationsRequest(new DeleteOrganizationRequestPrivate(*other.d_func(), this))
{
...
DeleteOrganizationRequest::DeleteOrganizationRequest()
    : OrganizationsRequest(new DeleteOrganizationRequestPrivate(OrganizationsRequest::DeleteOrganizationAction, this))
{
...
/*!
 * \class QtAws::Organizations::DeleteOrganizationRequestPrivate
...
/*!
 * Constructs a DeleteOrganizationRequestPrivate object for Organizations \a action,
 * with public implementation \a q.
 */
DeleteOrganizationRequestPrivate::DeleteOrganizationRequestPrivate(
    const OrganizationsRequest::Action action, DeleteOrganizationRequest * const q)
