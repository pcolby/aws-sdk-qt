...
/*!
 * \class QtAws::Organizations::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for Organizations UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : OrganizationsRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : OrganizationsRequest(new UntagResourceRequestPrivate(OrganizationsRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::Organizations::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for Organizations \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const OrganizationsRequest::Action action, UntagResourceRequest * const q)
