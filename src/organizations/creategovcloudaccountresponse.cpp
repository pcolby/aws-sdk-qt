...
#include "creategovcloudaccountresponse_p.h"
...
/*!
 * \class QtAws::Organizations::CreateGovCloudAccountResponse
 * \brief The CreateGovCloudAccountResponse class provides an interace for Organizations CreateGovCloudAccount responses.
 *
...
/*!
 * Constructs a CreateGovCloudAccountResponse object for \a reply to \a request, with parent \a parent.
 */
CreateGovCloudAccountResponse::CreateGovCloudAccountResponse(
        const CreateGovCloudAccountRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : OrganizationsResponse(new CreateGovCloudAccountResponsePrivate(this), parent)
{
    setRequest(new CreateGovCloudAccountRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Organizations CreateGovCloudAccount \a response.
 */
void CreateGovCloudAccountResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateGovCloudAccountResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Organizations::CreateGovCloudAccountResponsePrivate
 * \brief The CreateGovCloudAccountResponsePrivate class provides private implementation for CreateGovCloudAccountResponse.
 * \internal
 *
 * \inmodule QtAwsOrganizations
 */
...
/*!
 * Constructs a CreateGovCloudAccountResponsePrivate object with public implementation \a q.
 */
CreateGovCloudAccountResponsePrivate::CreateGovCloudAccountResponsePrivate(
    CreateGovCloudAccountResponse * const q) : OrganizationsResponsePrivate(q)
{

}

/*!
 * Parses a Organizations CreateGovCloudAccount response element from \a xml.
 */
void CreateGovCloudAccountResponsePrivate::parseCreateGovCloudAccountResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateGovCloudAccountResponse"));
    Q_UNUSED(xml) ///< @todo
}
