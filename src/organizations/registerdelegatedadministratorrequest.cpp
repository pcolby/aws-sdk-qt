...
#include "registerdelegatedadministratorrequest_p.h"
...
/*!
 * \class QtAws::Organizations::RegisterDelegatedAdministratorRequest
 * \brief The RegisterDelegatedAdministratorRequest class provides an interface for Organizations RegisterDelegatedAdministrator requests.
 *
 ...
 */
RegisterDelegatedAdministratorRequest::RegisterDelegatedAdministratorRequest(const RegisterDelegatedAdministratorRequest &other)
    : OrganizationsRequest(new RegisterDelegatedAdministratorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a RegisterDelegatedAdministratorRequest object.
 */
RegisterDelegatedAdministratorRequest::RegisterDelegatedAdministratorRequest()
    : OrganizationsRequest(new RegisterDelegatedAdministratorRequestPrivate(OrganizationsRequest::RegisterDelegatedAdministratorAction, this))
{
 ...
 * \reimp
 */
bool RegisterDelegatedAdministratorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a RegisterDelegatedAdministratorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * RegisterDelegatedAdministratorRequest::response(QNetworkReply * const reply) const
{
    return new RegisterDelegatedAdministratorResponse(*this, reply);
}

/*!
 * \class QtAws::Organizations::RegisterDelegatedAdministratorRequestPrivate
 * \brief The RegisterDelegatedAdministratorRequestPrivate class provides private implementation for RegisterDelegatedAdministratorRequest.
 * \internal
 *
 * \inmodule QtAwsOrganizations
 */
...
/*!
 * Constructs a RegisterDelegatedAdministratorRequestPrivate object for Organizations \a action,
 * with public implementation \a q.
 */
RegisterDelegatedAdministratorRequestPrivate::RegisterDelegatedAdministratorRequestPrivate(
    const OrganizationsRequest::Action action, RegisterDelegatedAdministratorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the RegisterDelegatedAdministratorRequest
 * class' copy constructor.
 */
RegisterDelegatedAdministratorRequestPrivate::RegisterDelegatedAdministratorRequestPrivate(
    const RegisterDelegatedAdministratorRequestPrivate &other, RegisterDelegatedAdministratorRequest * const q)
