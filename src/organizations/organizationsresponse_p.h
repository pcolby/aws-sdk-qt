...
class QTAWS_EXPORT OrganizationsResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {

public:

    OrganizationsResponsePrivate(OrganizationsResponse * const q);
