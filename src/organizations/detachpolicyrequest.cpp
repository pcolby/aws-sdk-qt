 ...
 *
 * \sa OrganizationsClient::detachPolicy
 */
...
/*!
 * \class QtAws::Organizations::DetachPolicyRequestPrivate
...
/*!
 *
 * Constructs a DetachPolicyRequestPrivate object for Organizations \a action with,
