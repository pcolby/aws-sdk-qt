...
/*!
 * \class QtAws::Organizations::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Organizations TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : OrganizationsResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(OrganizationsResponse::request());
}

/*!
 * \reimp
 * Parses a successful Organizations TagResource \a response.
 */
...
/*!
 * \class QtAws::Organizations::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : OrganizationsResponsePrivate(q)
{

}

/*!
 * Parses a Organizations TagResource response element from \a xml.
 */
