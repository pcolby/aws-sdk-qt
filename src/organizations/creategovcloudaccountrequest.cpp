...
#include "creategovcloudaccountrequest_p.h"
...
/*!
 * \class QtAws::Organizations::CreateGovCloudAccountRequest
 * \brief The CreateGovCloudAccountRequest class provides an interface for Organizations CreateGovCloudAccount requests.
 *
 ...
 *
 * \sa OrganizationsClient::createGovCloudAccount
 */

/*!
 * Constructs a copy of \a other.
 */
CreateGovCloudAccountRequest::CreateGovCloudAccountRequest(const CreateGovCloudAccountRequest &other)
    : OrganizationsRequest(new CreateGovCloudAccountRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateGovCloudAccountRequest object.
 */
CreateGovCloudAccountRequest::CreateGovCloudAccountRequest()
    : OrganizationsRequest(new CreateGovCloudAccountRequestPrivate(OrganizationsRequest::CreateGovCloudAccountAction, this))
{
 ...
 * \reimp
 */
bool CreateGovCloudAccountRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateGovCloudAccountResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateGovCloudAccountRequest::response(QNetworkReply * const reply) const
{
    return new CreateGovCloudAccountResponse(*this, reply);
}

/*!
 * \class QtAws::Organizations::CreateGovCloudAccountRequestPrivate
 * \brief The CreateGovCloudAccountRequestPrivate class provides private implementation for CreateGovCloudAccountRequest.
 * \internal
 *
 * \inmodule QtAwsOrganizations
 */
...
/*!
 * Constructs a CreateGovCloudAccountRequestPrivate object for Organizations \a action,
 * with public implementation \a q.
 */
CreateGovCloudAccountRequestPrivate::CreateGovCloudAccountRequestPrivate(
    const OrganizationsRequest::Action action, CreateGovCloudAccountRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateGovCloudAccountRequest
 * class' copy constructor.
 */
CreateGovCloudAccountRequestPrivate::CreateGovCloudAccountRequestPrivate(
    const CreateGovCloudAccountRequestPrivate &other, CreateGovCloudAccountRequest * const q)
