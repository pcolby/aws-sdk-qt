...
class QTAWS_EXPORT CreateAnomalySubscriptionResponsePrivate : public CostExplorerResponsePrivate {

public:

    CreateAnomalySubscriptionResponsePrivate(CreateAnomalySubscriptionResponse * const q);
