...
class QTAWS_EXPORT CreateAnomalyMonitorResponsePrivate : public CostExplorerResponsePrivate {

public:

    CreateAnomalyMonitorResponsePrivate(CreateAnomalyMonitorResponse * const q);
