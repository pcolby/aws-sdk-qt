...
class QTAWS_EXPORT GetSavingsPlansCoverageResponsePrivate : public CostExplorerResponsePrivate {

public:

    GetSavingsPlansCoverageResponsePrivate(GetSavingsPlansCoverageResponse * const q);
