...
class QTAWS_EXPORT GetAnomalySubscriptionsResponsePrivate : public CostExplorerResponsePrivate {

public:

    GetAnomalySubscriptionsResponsePrivate(GetAnomalySubscriptionsResponse * const q);
