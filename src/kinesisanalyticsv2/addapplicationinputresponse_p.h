...
class QTAWS_EXPORT AddApplicationInputResponsePrivate : public KinesisAnalyticsV2ResponsePrivate {

public:

    AddApplicationInputResponsePrivate(AddApplicationInputResponse * const q);
