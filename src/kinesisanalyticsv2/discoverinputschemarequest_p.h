...
class QTAWS_EXPORT DiscoverInputSchemaRequestPrivate : public KinesisAnalyticsV2RequestPrivate {

public:
    DiscoverInputSchemaRequestPrivate(const KinesisAnalyticsV2Request::Action action,
