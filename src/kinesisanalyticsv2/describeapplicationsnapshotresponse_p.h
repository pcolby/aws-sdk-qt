...
class QTAWS_EXPORT DescribeApplicationSnapshotResponsePrivate : public KinesisAnalyticsV2ResponsePrivate {

public:

    DescribeApplicationSnapshotResponsePrivate(DescribeApplicationSnapshotResponse * const q);
