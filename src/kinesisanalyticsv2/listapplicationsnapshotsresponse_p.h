...
class QTAWS_EXPORT ListApplicationSnapshotsResponsePrivate : public KinesisAnalyticsV2ResponsePrivate {

public:

    ListApplicationSnapshotsResponsePrivate(ListApplicationSnapshotsResponse * const q);
