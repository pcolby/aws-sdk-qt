...
class QTAWS_EXPORT CreateApplicationRequestPrivate : public KinesisAnalyticsV2RequestPrivate {

public:
    CreateApplicationRequestPrivate(const KinesisAnalyticsV2Request::Action action,
