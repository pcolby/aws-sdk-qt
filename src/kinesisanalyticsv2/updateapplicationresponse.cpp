...
/*!
 * \class QtAws::KinesisAnalyticsV2::UpdateApplicationResponse
 * \brief The UpdateApplicationResponse class provides an interace for KinesisAnalyticsV2 UpdateApplication responses.
 *
...
UpdateApplicationResponse::UpdateApplicationResponse(
    ...
    : KinesisAnalyticsV2Response(new UpdateApplicationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful KinesisAnalyticsV2 UpdateApplication \a response.
 */
...
/*!
 * \class QtAws::KinesisAnalyticsV2::UpdateApplicationResponsePrivate
...
UpdateApplicationResponsePrivate::UpdateApplicationResponsePrivate(
    UpdateApplicationResponse * const q) : KinesisAnalyticsV2ResponsePrivate(q)
{

}

/*!
 * Parses a KinesisAnalyticsV2 UpdateApplication response element from \a xml.
 */
