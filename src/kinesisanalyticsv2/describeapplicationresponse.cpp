...
/*!
 * \class QtAws::KinesisAnalyticsV2::DescribeApplicationResponse
 * \brief The DescribeApplicationResponse class provides an interace for KinesisAnalyticsV2 DescribeApplication responses.
 *
...
DescribeApplicationResponse::DescribeApplicationResponse(
    ...
    : KinesisAnalyticsV2Response(new DescribeApplicationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful KinesisAnalyticsV2 DescribeApplication \a response.
 */
...
/*!
 * \class QtAws::KinesisAnalyticsV2::DescribeApplicationResponsePrivate
...
DescribeApplicationResponsePrivate::DescribeApplicationResponsePrivate(
    DescribeApplicationResponse * const q) : KinesisAnalyticsV2ResponsePrivate(q)
{

}

/*!
 * Parses a KinesisAnalyticsV2 DescribeApplication response element from \a xml.
 */
