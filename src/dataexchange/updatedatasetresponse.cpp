...
/*!
 * \class QtAws::DataExchange::UpdateDataSetResponse
 * \brief The UpdateDataSetResponse class provides an interace for DataExchange UpdateDataSet responses.
 *
...
UpdateDataSetResponse::UpdateDataSetResponse(
    ...
    : DataExchangeResponse(new UpdateDataSetResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful DataExchange UpdateDataSet \a response.
 */
...
/*!
 * \class QtAws::DataExchange::UpdateDataSetResponsePrivate
...
UpdateDataSetResponsePrivate::UpdateDataSetResponsePrivate(
    UpdateDataSetResponse * const q) : DataExchangeResponsePrivate(q)
{

}

/*!
 * Parses a DataExchange UpdateDataSet response element from \a xml.
 */
