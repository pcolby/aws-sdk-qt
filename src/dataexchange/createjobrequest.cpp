...
/*!
 * \class QtAws::DataExchange::CreateJobRequest
 * \brief The CreateJobRequest class provides an interface for DataExchange CreateJob requests.
 *
...
CreateJobRequest::CreateJobRequest(const CreateJobRequest &other)
    : DataExchangeRequest(new CreateJobRequestPrivate(*other.d_func(), this))
{
...
CreateJobRequest::CreateJobRequest()
    : DataExchangeRequest(new CreateJobRequestPrivate(DataExchangeRequest::CreateJobAction, this))
{
...
/*!
 * \class QtAws::DataExchange::CreateJobRequestPrivate
...
/*!
 * Constructs a CreateJobRequestPrivate object for DataExchange \a action,
 * with public implementation \a q.
 */
CreateJobRequestPrivate::CreateJobRequestPrivate(
    const DataExchangeRequest::Action action, CreateJobRequest * const q)
