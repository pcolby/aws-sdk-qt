...
/*!
 * \class QtAws::DataExchange::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for DataExchange ListTagsForResource responses.
 *
 ...
 *
 * \sa DataExchangeClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : DataExchangeResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(DataExchangeResponse::request());
}

/*!
 * \reimp
 * Parses a successful DataExchange ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::DataExchange::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : DataExchangeResponsePrivate(q)
{

}

/*!
 * Parses a DataExchange ListTagsForResource response element from \a xml.
 */
