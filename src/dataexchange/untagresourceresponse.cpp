...
/*!
 * \class QtAws::DataExchange::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for DataExchange UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : DataExchangeResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(DataExchangeResponse::request());
}

/*!
 * \reimp
 * Parses a successful DataExchange UntagResource \a response.
 */
...
/*!
 * \class QtAws::DataExchange::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : DataExchangeResponsePrivate(q)
{

}

/*!
 * Parses a DataExchange UntagResource response element from \a xml.
 */
