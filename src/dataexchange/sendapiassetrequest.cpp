...
#include "sendapiassetrequest_p.h"
...
/*!
 * \class QtAws::DataExchange::SendApiAssetRequest
 * \brief The SendApiAssetRequest class provides an interface for DataExchange SendApiAsset requests.
 *
 ...
 */
SendApiAssetRequest::SendApiAssetRequest(const SendApiAssetRequest &other)
    : DataExchangeRequest(new SendApiAssetRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a SendApiAssetRequest object.
 */
SendApiAssetRequest::SendApiAssetRequest()
    : DataExchangeRequest(new SendApiAssetRequestPrivate(DataExchangeRequest::SendApiAssetAction, this))
{
 ...
 * \reimp
 */
bool SendApiAssetRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a SendApiAssetResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * SendApiAssetRequest::response(QNetworkReply * const reply) const
{
    return new SendApiAssetResponse(*this, reply);
}

/*!
 * \class QtAws::DataExchange::SendApiAssetRequestPrivate
 * \brief The SendApiAssetRequestPrivate class provides private implementation for SendApiAssetRequest.
 * \internal
 *
 * \inmodule QtAwsDataExchange
 */
...
/*!
 * Constructs a SendApiAssetRequestPrivate object for DataExchange \a action,
 * with public implementation \a q.
 */
SendApiAssetRequestPrivate::SendApiAssetRequestPrivate(
    const DataExchangeRequest::Action action, SendApiAssetRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the SendApiAssetRequest
 * class' copy constructor.
 */
SendApiAssetRequestPrivate::SendApiAssetRequestPrivate(
    const SendApiAssetRequestPrivate &other, SendApiAssetRequest * const q)
