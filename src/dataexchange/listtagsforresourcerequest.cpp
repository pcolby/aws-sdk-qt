...
/*!
 * \class QtAws::DataExchange::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for DataExchange ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : DataExchangeRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : DataExchangeRequest(new ListTagsForResourceRequestPrivate(DataExchangeRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::DataExchange::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for DataExchange \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const DataExchangeRequest::Action action, ListTagsForResourceRequest * const q)
