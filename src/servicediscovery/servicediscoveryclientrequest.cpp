...
/**
 * @brief  Constructs a new ServiceDiscoveryClientRequest object.
 *
...
/**
 * @brief  Constructs a new ServiceDiscoveryClientRequest object by copying another.
 *
 ...
 */
ServiceDiscoveryClientRequest& ServiceDiscoveryClientRequest::operator=(const ServiceDiscoveryClientRequest &other)
{
    Q_D(ServiceDiscoveryClientRequest);
 ...
 * implementation that inherits from ServiceDiscoveryClientRequestPrivate.
 *
 ...
 */
ServiceDiscoveryClientRequest::Action ServiceDiscoveryClientRequest::action() const
{
    Q_D(const ServiceDiscoveryClientRequest);
    return d->action;
}
 ...
 */
QString ServiceDiscoveryClientRequest::actionString() const
{
    return ServiceDiscoveryClientRequestPrivate::toString(action());
}
 ...
 */
QString ServiceDiscoveryClientRequest::apiVersion() const
{
    Q_D(const ServiceDiscoveryClientRequest);
    return d->apiVersion;
}
 ...
 */
void ServiceDiscoveryClientRequest::setAction(const Action action)
{
    Q_D(ServiceDiscoveryClientRequest);
    d->action = action;
}
 ...
 */
void ServiceDiscoveryClientRequest::setApiVersion(const QString &version)
{
    Q_D(ServiceDiscoveryClientRequest);
 ...
 */
bool ServiceDiscoveryClientRequest::operator==(const ServiceDiscoveryClientRequest &other) const
{
 ...
 */
bool ServiceDiscoveryClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int ServiceDiscoveryClientRequest::clearParameter(const QString &name)
{
    Q_D(ServiceDiscoveryClientRequest);
 ...
 */
void ServiceDiscoveryClientRequest::clearParameters()
{
    Q_D(ServiceDiscoveryClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant ServiceDiscoveryClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const ServiceDiscoveryClientRequest);
 ...
 */
const QVariantMap &ServiceDiscoveryClientRequest::parameters() const
{
    Q_D(const ServiceDiscoveryClientRequest);
    return d->parameters;
}
 ...
 */
void ServiceDiscoveryClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(ServiceDiscoveryClientRequest);
 ...
 */
void ServiceDiscoveryClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(ServiceDiscoveryClientRequest);
 ...
 */
QNetworkRequest ServiceDiscoveryClientRequest::unsignedRequest(const QUrl &endpoint) const
{
    Q_D(const ServiceDiscoveryClientRequest);
    QUrl url(endpoint);
 ...
 *
 * @brief  Private implementation for ServiceDiscoveryClientRequest.
 */

/**
 * @internal
 *
 * @brief  Constructs a new ServiceDiscoveryClientRequestPrivate object.
 *
 ...
 * @internal
 *
 * @brief  Constructs a new ServiceDiscoveryClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the ServiceDiscoveryClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public ServiceDiscoveryClientRequest instance.
 */
 ...
 *
 * This function converts ServiceDiscoveryClientRequest::Action enumerator values to their respective
 ...
 */
QString ServiceDiscoveryClientRequestPrivate::toString(const ServiceDiscoveryClientRequest::Action &action)
{
    #define ActionToString(action) \
        case ServiceDiscoveryClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
