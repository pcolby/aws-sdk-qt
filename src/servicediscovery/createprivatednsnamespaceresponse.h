...
class QTAWS_EXPORT CreatePrivateDnsNamespaceResponse : public ServiceDiscoveryResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreatePrivateDnsNamespaceRequest * request() const override;
