...
/*!
 * \class QtAws::ServiceDiscovery::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for ServiceDiscovery ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ServiceDiscoveryResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ServiceDiscovery ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::ServiceDiscovery::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ServiceDiscoveryResponsePrivate(q)
{

}

/*!
 * Parses a ServiceDiscovery ListTagsForResource response element from \a xml.
 */
