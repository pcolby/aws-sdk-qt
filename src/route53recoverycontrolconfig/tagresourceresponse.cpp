...
/*!
 * \class QtAws::Route53RecoveryControlConfig::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Route53RecoveryControlConfig TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : Route53RecoveryControlConfigResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Route53RecoveryControlConfig TagResource \a response.
 */
...
/*!
 * \class QtAws::Route53RecoveryControlConfig::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : Route53RecoveryControlConfigResponsePrivate(q)
{

}

/*!
 * Parses a Route53RecoveryControlConfig TagResource response element from \a xml.
 */
