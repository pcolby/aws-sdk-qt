...
/*!
 * \class QtAws::Route53RecoveryControlConfig::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Route53RecoveryControlConfig ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : Route53RecoveryControlConfigResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Route53RecoveryControlConfig ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Route53RecoveryControlConfig::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : Route53RecoveryControlConfigResponsePrivate(q)
{

}

/*!
 * Parses a Route53RecoveryControlConfig ListTagsForResource response element from \a xml.
 */
