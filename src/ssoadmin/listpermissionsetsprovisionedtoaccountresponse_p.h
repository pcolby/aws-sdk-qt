...
class QTAWS_EXPORT ListPermissionSetsProvisionedToAccountResponsePrivate : public SSOAdminResponsePrivate {

public:

    ListPermissionSetsProvisionedToAccountResponsePrivate(ListPermissionSetsProvisionedToAccountResponse * const q);
