...
/*!
 * \class QtAws::SSOAdmin::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for SSOAdmin ListTagsForResource responses.
 *
 * \inmodule QtAwsSSOAdmin
 *
 *
 * \sa SSOAdminClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : SSOAdminResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(SSOAdminResponse::request());
}

/*!
 * \reimp
 * Parses a successful SSOAdmin ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::SSOAdmin::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : SSOAdminResponsePrivate(q)
{

}

/*!
 * Parses a SSOAdmin ListTagsForResource response element from \a xml.
 */
