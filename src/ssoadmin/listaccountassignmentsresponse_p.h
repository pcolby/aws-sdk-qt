...
class QTAWS_EXPORT ListAccountAssignmentsResponsePrivate : public SSOAdminResponsePrivate {

public:

    ListAccountAssignmentsResponsePrivate(ListAccountAssignmentsResponse * const q);
