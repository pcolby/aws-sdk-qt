...
class QTAWS_EXPORT GetInlinePolicyForPermissionSetResponsePrivate : public SSOAdminResponsePrivate {

public:

    GetInlinePolicyForPermissionSetResponsePrivate(GetInlinePolicyForPermissionSetResponse * const q);
