...
class QTAWS_EXPORT ListPermissionSetsResponsePrivate : public SSOAdminResponsePrivate {

public:

    ListPermissionSetsResponsePrivate(ListPermissionSetsResponse * const q);
