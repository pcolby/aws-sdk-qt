...
class QTAWS_EXPORT ListPermissionSetProvisioningStatusResponsePrivate : public SSOAdminResponsePrivate {

public:

    ListPermissionSetProvisioningStatusResponsePrivate(ListPermissionSetProvisioningStatusResponse * const q);
