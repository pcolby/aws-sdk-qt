...
class QTAWS_EXPORT DeletePendingAggregationRequestResponse : public ConfigServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeletePendingAggregationRequestRequest * request() const;
