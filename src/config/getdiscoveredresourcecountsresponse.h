...
class QTAWS_EXPORT GetDiscoveredResourceCountsResponse : public ConfigServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetDiscoveredResourceCountsRequest * request() const override;
