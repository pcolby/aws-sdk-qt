...
class QTAWS_EXPORT DescribeAggregationAuthorizationsResponse : public ConfigServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeAggregationAuthorizationsRequest * request() const;
