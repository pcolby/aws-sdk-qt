...
class QTAWS_EXPORT GetComplianceDetailsByResourceRequestPrivate : public ConfigServicePrivate {

public:
    GetComplianceDetailsByResourceRequestPrivate(const ConfigService::Action action,
