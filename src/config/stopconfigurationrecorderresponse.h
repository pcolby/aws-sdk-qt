...
class QTAWS_EXPORT StopConfigurationRecorderResponse : public StopConfigurationRecorderResponse {
    Q_OBJECT
...
public:
    ...
    virtual const StopConfigurationRecorderRequest * request() const;
