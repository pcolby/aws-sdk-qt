...
class QTAWS_EXPORT DescribeAggregateComplianceByConfigRulesResponse : public ConfigServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeAggregateComplianceByConfigRulesRequest * request() const override;
