...
class QTAWS_EXPORT GetAppValidationConfigurationResponsePrivate : public SmsResponsePrivate {

public:

    GetAppValidationConfigurationResponsePrivate(GetAppValidationConfigurationResponse * const q);
