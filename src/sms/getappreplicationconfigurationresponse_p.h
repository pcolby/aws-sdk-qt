...
class QTAWS_EXPORT GetAppReplicationConfigurationResponsePrivate : public SmsResponsePrivate {

public:

    GetAppReplicationConfigurationResponsePrivate(GetAppReplicationConfigurationResponse * const q);
