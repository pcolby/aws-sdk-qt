...
class QTAWS_EXPORT DeleteAppLaunchConfigurationResponsePrivate : public SmsResponsePrivate {

public:

    DeleteAppLaunchConfigurationResponsePrivate(DeleteAppLaunchConfigurationResponse * const q);
