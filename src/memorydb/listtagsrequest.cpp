...
/*!
 * \class QtAws::MemoryDb::ListTagsRequest
 * \brief The ListTagsRequest class provides an interface for MemoryDb ListTags requests.
 *
...
ListTagsRequest::ListTagsRequest(const ListTagsRequest &other)
    : MemoryDbRequest(new ListTagsRequestPrivate(*other.d_func(), this))
{
...
ListTagsRequest::ListTagsRequest()
    : MemoryDbRequest(new ListTagsRequestPrivate(MemoryDbRequest::ListTagsAction, this))
{
...
/*!
 * \class QtAws::MemoryDb::ListTagsRequestPrivate
...
/*!
 * Constructs a ListTagsRequestPrivate object for MemoryDb \a action,
 * with public implementation \a q.
 */
ListTagsRequestPrivate::ListTagsRequestPrivate(
    const MemoryDbRequest::Action action, ListTagsRequest * const q)
