...
/*!
 * \class QtAws::MemoryDb::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for MemoryDb TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : MemoryDbResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful MemoryDb TagResource \a response.
 */
...
/*!
 * \class QtAws::MemoryDb::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : MemoryDbResponsePrivate(q)
{

}

/*!
 * Parses a MemoryDb TagResource response element from \a xml.
 */
