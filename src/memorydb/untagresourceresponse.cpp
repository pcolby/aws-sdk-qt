...
/*!
 * \class QtAws::MemoryDb::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for MemoryDb UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : MemoryDbResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful MemoryDb UntagResource \a response.
 */
...
/*!
 * \class QtAws::MemoryDb::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : MemoryDbResponsePrivate(q)
{

}

/*!
 * Parses a MemoryDb UntagResource response element from \a xml.
 */
