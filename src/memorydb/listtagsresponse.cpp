...
/*!
 * \class QtAws::MemoryDb::ListTagsResponse
 * \brief The ListTagsResponse class provides an interace for MemoryDb ListTags responses.
 *
...
ListTagsResponse::ListTagsResponse(
    ...
    : MemoryDbResponse(new ListTagsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful MemoryDb ListTags \a response.
 */
...
/*!
 * \class QtAws::MemoryDb::ListTagsResponsePrivate
...
ListTagsResponsePrivate::ListTagsResponsePrivate(
    ListTagsResponse * const q) : MemoryDbResponsePrivate(q)
{

}

/*!
 * Parses a MemoryDb ListTags response element from \a xml.
 */
