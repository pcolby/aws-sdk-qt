...
/*!
 * \class QtAws::WorkSpacesWeb::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for WorkSpacesWeb ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : WorkSpacesWebResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WorkSpacesWeb ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::WorkSpacesWeb::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : WorkSpacesWebResponsePrivate(q)
{

}

/*!
 * Parses a WorkSpacesWeb ListTagsForResource response element from \a xml.
 */
