...
class CreateIdentityProviderRequestPrivate : public WorkSpacesWebRequestPrivate {

public:
    CreateIdentityProviderRequestPrivate(const WorkSpacesWebRequest::Action action,
