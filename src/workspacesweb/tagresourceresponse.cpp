...
/*!
 * \class QtAws::WorkSpacesWeb::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for WorkSpacesWeb TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : WorkSpacesWebResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WorkSpacesWeb TagResource \a response.
 */
...
/*!
 * \class QtAws::WorkSpacesWeb::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : WorkSpacesWebResponsePrivate(q)
{

}

/*!
 * Parses a WorkSpacesWeb TagResource response element from \a xml.
 */
