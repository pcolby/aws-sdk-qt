...
/*!
 * \class QtAws::WorkSpacesWeb::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for WorkSpacesWeb UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : WorkSpacesWebResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WorkSpacesWeb UntagResource \a response.
 */
...
/*!
 * \class QtAws::WorkSpacesWeb::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : WorkSpacesWebResponsePrivate(q)
{

}

/*!
 * Parses a WorkSpacesWeb UntagResource response element from \a xml.
 */
