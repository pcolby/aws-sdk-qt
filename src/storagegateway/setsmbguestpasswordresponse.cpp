...
#include "setsmbguestpasswordresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::SetSMBGuestPasswordResponse
 * \brief The SetSMBGuestPasswordResponse class provides an interace for StorageGateway SetSMBGuestPassword responses.
 *
...
/*!
 * Constructs a SetSMBGuestPasswordResponse object for \a reply to \a request, with parent \a parent.
 */
SetSMBGuestPasswordResponse::SetSMBGuestPasswordResponse(
        const SetSMBGuestPasswordRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new SetSMBGuestPasswordResponsePrivate(this), parent)
{
    setRequest(new SetSMBGuestPasswordRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway SetSMBGuestPassword \a response.
 */
void SetSMBGuestPasswordResponse::parseSuccess(QIODevice &response)
{
    //Q_D(SetSMBGuestPasswordResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::SetSMBGuestPasswordResponsePrivate
 * \brief The SetSMBGuestPasswordResponsePrivate class provides private implementation for SetSMBGuestPasswordResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a SetSMBGuestPasswordResponsePrivate object with public implementation \a q.
 */
SetSMBGuestPasswordResponsePrivate::SetSMBGuestPasswordResponsePrivate(
    SetSMBGuestPasswordResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway SetSMBGuestPassword response element from \a xml.
 */
