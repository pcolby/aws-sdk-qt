...
#include "updatesmbsecuritystrategyresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::UpdateSMBSecurityStrategyResponse
 * \brief The UpdateSMBSecurityStrategyResponse class provides an interace for StorageGateway UpdateSMBSecurityStrategy responses.
 *
...
/*!
 * Constructs a UpdateSMBSecurityStrategyResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateSMBSecurityStrategyResponse::UpdateSMBSecurityStrategyResponse(
        const UpdateSMBSecurityStrategyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new UpdateSMBSecurityStrategyResponsePrivate(this), parent)
{
    setRequest(new UpdateSMBSecurityStrategyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway UpdateSMBSecurityStrategy \a response.
 */
void UpdateSMBSecurityStrategyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateSMBSecurityStrategyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::UpdateSMBSecurityStrategyResponsePrivate
 * \brief The UpdateSMBSecurityStrategyResponsePrivate class provides private implementation for UpdateSMBSecurityStrategyResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a UpdateSMBSecurityStrategyResponsePrivate object with public implementation \a q.
 */
UpdateSMBSecurityStrategyResponsePrivate::UpdateSMBSecurityStrategyResponsePrivate(
    UpdateSMBSecurityStrategyResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway UpdateSMBSecurityStrategy response element from \a xml.
 */
void UpdateSMBSecurityStrategyResponsePrivate::parseUpdateSMBSecurityStrategyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateSMBSecurityStrategyResponse"));
    Q_UNUSED(xml) ///< @todo
}
