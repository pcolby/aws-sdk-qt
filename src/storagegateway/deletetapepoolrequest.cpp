...
#include "deletetapepoolrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::DeleteTapePoolRequest
 * \brief The DeleteTapePoolRequest class provides an interface for StorageGateway DeleteTapePool requests.
 *
 ...
 */
DeleteTapePoolRequest::DeleteTapePoolRequest(const DeleteTapePoolRequest &other)
    : StorageGatewayRequest(new DeleteTapePoolRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteTapePoolRequest object.
 */
DeleteTapePoolRequest::DeleteTapePoolRequest()
    : StorageGatewayRequest(new DeleteTapePoolRequestPrivate(StorageGatewayRequest::DeleteTapePoolAction, this))
{
 ...
 * \reimp
 */
bool DeleteTapePoolRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteTapePoolResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteTapePoolRequest::response(QNetworkReply * const reply) const
{
    return new DeleteTapePoolResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::DeleteTapePoolRequestPrivate
 * \brief The DeleteTapePoolRequestPrivate class provides private implementation for DeleteTapePoolRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DeleteTapePoolRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
DeleteTapePoolRequestPrivate::DeleteTapePoolRequestPrivate(
    const StorageGatewayRequest::Action action, DeleteTapePoolRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteTapePoolRequest
 * class' copy constructor.
 */
DeleteTapePoolRequestPrivate::DeleteTapePoolRequestPrivate(
    const DeleteTapePoolRequestPrivate &other, DeleteTapePoolRequest * const q)
