...
#include "describeavailabilitymonitortestresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::DescribeAvailabilityMonitorTestResponse
 * \brief The DescribeAvailabilityMonitorTestResponse class provides an interace for StorageGateway DescribeAvailabilityMonitorTest responses.
 *
...
/*!
 * Constructs a DescribeAvailabilityMonitorTestResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeAvailabilityMonitorTestResponse::DescribeAvailabilityMonitorTestResponse(
        const DescribeAvailabilityMonitorTestRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new DescribeAvailabilityMonitorTestResponsePrivate(this), parent)
{
    setRequest(new DescribeAvailabilityMonitorTestRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway DescribeAvailabilityMonitorTest \a response.
 */
void DescribeAvailabilityMonitorTestResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeAvailabilityMonitorTestResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::DescribeAvailabilityMonitorTestResponsePrivate
 * \brief The DescribeAvailabilityMonitorTestResponsePrivate class provides private implementation for DescribeAvailabilityMonitorTestResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DescribeAvailabilityMonitorTestResponsePrivate object with public implementation \a q.
 */
DescribeAvailabilityMonitorTestResponsePrivate::DescribeAvailabilityMonitorTestResponsePrivate(
    DescribeAvailabilityMonitorTestResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway DescribeAvailabilityMonitorTest response element from \a xml.
 */
void DescribeAvailabilityMonitorTestResponsePrivate::parseDescribeAvailabilityMonitorTestResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeAvailabilityMonitorTestResponse"));
    Q_UNUSED(xml) ///< @todo
}
