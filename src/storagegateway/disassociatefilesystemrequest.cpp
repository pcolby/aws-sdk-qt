...
#include "disassociatefilesystemrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::DisassociateFileSystemRequest
 * \brief The DisassociateFileSystemRequest class provides an interface for StorageGateway DisassociateFileSystem requests.
 *
 ...
 *
 * \sa StorageGatewayClient::disassociateFileSystem
 */

/*!
 * Constructs a copy of \a other.
 */
DisassociateFileSystemRequest::DisassociateFileSystemRequest(const DisassociateFileSystemRequest &other)
    : StorageGatewayRequest(new DisassociateFileSystemRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DisassociateFileSystemRequest object.
 */
DisassociateFileSystemRequest::DisassociateFileSystemRequest()
    : StorageGatewayRequest(new DisassociateFileSystemRequestPrivate(StorageGatewayRequest::DisassociateFileSystemAction, this))
{
 ...
 * \reimp
 */
bool DisassociateFileSystemRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DisassociateFileSystemResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DisassociateFileSystemRequest::response(QNetworkReply * const reply) const
{
    return new DisassociateFileSystemResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::DisassociateFileSystemRequestPrivate
 * \brief The DisassociateFileSystemRequestPrivate class provides private implementation for DisassociateFileSystemRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DisassociateFileSystemRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
DisassociateFileSystemRequestPrivate::DisassociateFileSystemRequestPrivate(
    const StorageGatewayRequest::Action action, DisassociateFileSystemRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DisassociateFileSystemRequest
 * class' copy constructor.
 */
DisassociateFileSystemRequestPrivate::DisassociateFileSystemRequestPrivate(
    const DisassociateFileSystemRequestPrivate &other, DisassociateFileSystemRequest * const q)
