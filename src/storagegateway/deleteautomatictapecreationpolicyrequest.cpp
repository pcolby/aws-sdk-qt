...
#include "deleteautomatictapecreationpolicyrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::DeleteAutomaticTapeCreationPolicyRequest
 * \brief The DeleteAutomaticTapeCreationPolicyRequest class provides an interface for StorageGateway DeleteAutomaticTapeCreationPolicy requests.
 *
 ...
 *
 * \sa StorageGatewayClient::deleteAutomaticTapeCreationPolicy
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteAutomaticTapeCreationPolicyRequest::DeleteAutomaticTapeCreationPolicyRequest(const DeleteAutomaticTapeCreationPolicyRequest &other)
    : StorageGatewayRequest(new DeleteAutomaticTapeCreationPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteAutomaticTapeCreationPolicyRequest object.
 */
DeleteAutomaticTapeCreationPolicyRequest::DeleteAutomaticTapeCreationPolicyRequest()
    : StorageGatewayRequest(new DeleteAutomaticTapeCreationPolicyRequestPrivate(StorageGatewayRequest::DeleteAutomaticTapeCreationPolicyAction, this))
{
 ...
 * \reimp
 */
bool DeleteAutomaticTapeCreationPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteAutomaticTapeCreationPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteAutomaticTapeCreationPolicyRequest::response(QNetworkReply * const reply) const
{
    return new DeleteAutomaticTapeCreationPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::DeleteAutomaticTapeCreationPolicyRequestPrivate
 * \brief The DeleteAutomaticTapeCreationPolicyRequestPrivate class provides private implementation for DeleteAutomaticTapeCreationPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DeleteAutomaticTapeCreationPolicyRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
DeleteAutomaticTapeCreationPolicyRequestPrivate::DeleteAutomaticTapeCreationPolicyRequestPrivate(
    const StorageGatewayRequest::Action action, DeleteAutomaticTapeCreationPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteAutomaticTapeCreationPolicyRequest
 * class' copy constructor.
 */
DeleteAutomaticTapeCreationPolicyRequestPrivate::DeleteAutomaticTapeCreationPolicyRequestPrivate(
    const DeleteAutomaticTapeCreationPolicyRequestPrivate &other, DeleteAutomaticTapeCreationPolicyRequest * const q)
