...
#include "updatefilesystemassociationresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::UpdateFileSystemAssociationResponse
 * \brief The UpdateFileSystemAssociationResponse class provides an interace for StorageGateway UpdateFileSystemAssociation responses.
 *
...
/*!
 * Constructs a UpdateFileSystemAssociationResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateFileSystemAssociationResponse::UpdateFileSystemAssociationResponse(
        const UpdateFileSystemAssociationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new UpdateFileSystemAssociationResponsePrivate(this), parent)
{
    setRequest(new UpdateFileSystemAssociationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway UpdateFileSystemAssociation \a response.
 */
void UpdateFileSystemAssociationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateFileSystemAssociationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::UpdateFileSystemAssociationResponsePrivate
 * \brief The UpdateFileSystemAssociationResponsePrivate class provides private implementation for UpdateFileSystemAssociationResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a UpdateFileSystemAssociationResponsePrivate object with public implementation \a q.
 */
UpdateFileSystemAssociationResponsePrivate::UpdateFileSystemAssociationResponsePrivate(
    UpdateFileSystemAssociationResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway UpdateFileSystemAssociation response element from \a xml.
 */
void UpdateFileSystemAssociationResponsePrivate::parseUpdateFileSystemAssociationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateFileSystemAssociationResponse"));
    Q_UNUSED(xml) ///< @todo
}
