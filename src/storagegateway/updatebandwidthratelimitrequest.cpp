 ...
 *
 * \brief The UpdateBandwidthRateLimitRequest class encapsulates StorageGateway UpdateBandwidthRateLimit requests.
 *
 ...
 *
 * \sa StorageGatewayClient::updateBandwidthRateLimit
 */
