...
#include "disassociatefilesystemresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::DisassociateFileSystemResponse
 * \brief The DisassociateFileSystemResponse class provides an interace for StorageGateway DisassociateFileSystem responses.
 *
...
/*!
 * Constructs a DisassociateFileSystemResponse object for \a reply to \a request, with parent \a parent.
 */
DisassociateFileSystemResponse::DisassociateFileSystemResponse(
        const DisassociateFileSystemRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new DisassociateFileSystemResponsePrivate(this), parent)
{
    setRequest(new DisassociateFileSystemRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway DisassociateFileSystem \a response.
 */
void DisassociateFileSystemResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DisassociateFileSystemResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::DisassociateFileSystemResponsePrivate
 * \brief The DisassociateFileSystemResponsePrivate class provides private implementation for DisassociateFileSystemResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DisassociateFileSystemResponsePrivate object with public implementation \a q.
 */
DisassociateFileSystemResponsePrivate::DisassociateFileSystemResponsePrivate(
    DisassociateFileSystemResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway DisassociateFileSystem response element from \a xml.
 */
void DisassociateFileSystemResponsePrivate::parseDisassociateFileSystemResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DisassociateFileSystemResponse"));
    Q_UNUSED(xml) ///< @todo
}
