...
#include "assigntapepoolrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::AssignTapePoolRequest
 * \brief The AssignTapePoolRequest class provides an interface for StorageGateway AssignTapePool requests.
 *
 ...
 *
 * \sa StorageGatewayClient::assignTapePool
 */

/*!
 * Constructs a copy of \a other.
 */
AssignTapePoolRequest::AssignTapePoolRequest(const AssignTapePoolRequest &other)
    : StorageGatewayRequest(new AssignTapePoolRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AssignTapePoolRequest object.
 */
AssignTapePoolRequest::AssignTapePoolRequest()
    : StorageGatewayRequest(new AssignTapePoolRequestPrivate(StorageGatewayRequest::AssignTapePoolAction, this))
{
 ...
 * \reimp
 */
bool AssignTapePoolRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AssignTapePoolResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AssignTapePoolRequest::response(QNetworkReply * const reply) const
{
    return new AssignTapePoolResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::AssignTapePoolRequestPrivate
 * \brief The AssignTapePoolRequestPrivate class provides private implementation for AssignTapePoolRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a AssignTapePoolRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
AssignTapePoolRequestPrivate::AssignTapePoolRequestPrivate(
    const StorageGatewayRequest::Action action, AssignTapePoolRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AssignTapePoolRequest
 * class' copy constructor.
 */
AssignTapePoolRequestPrivate::AssignTapePoolRequestPrivate(
    const AssignTapePoolRequestPrivate &other, AssignTapePoolRequest * const q)
