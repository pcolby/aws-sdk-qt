...
#include "updatesmbfilesharevisibilityresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::UpdateSMBFileShareVisibilityResponse
 * \brief The UpdateSMBFileShareVisibilityResponse class provides an interace for StorageGateway UpdateSMBFileShareVisibility responses.
 *
...
/*!
 * Constructs a UpdateSMBFileShareVisibilityResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateSMBFileShareVisibilityResponse::UpdateSMBFileShareVisibilityResponse(
        const UpdateSMBFileShareVisibilityRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new UpdateSMBFileShareVisibilityResponsePrivate(this), parent)
{
    setRequest(new UpdateSMBFileShareVisibilityRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway UpdateSMBFileShareVisibility \a response.
 */
void UpdateSMBFileShareVisibilityResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateSMBFileShareVisibilityResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::UpdateSMBFileShareVisibilityResponsePrivate
 * \brief The UpdateSMBFileShareVisibilityResponsePrivate class provides private implementation for UpdateSMBFileShareVisibilityResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a UpdateSMBFileShareVisibilityResponsePrivate object with public implementation \a q.
 */
UpdateSMBFileShareVisibilityResponsePrivate::UpdateSMBFileShareVisibilityResponsePrivate(
    UpdateSMBFileShareVisibilityResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway UpdateSMBFileShareVisibility response element from \a xml.
 */
void UpdateSMBFileShareVisibilityResponsePrivate::parseUpdateSMBFileShareVisibilityResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateSMBFileShareVisibilityResponse"));
    Q_UNUSED(xml) ///< @todo
}
