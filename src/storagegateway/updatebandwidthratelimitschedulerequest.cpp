...
#include "updatebandwidthratelimitschedulerequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::UpdateBandwidthRateLimitScheduleRequest
 * \brief The UpdateBandwidthRateLimitScheduleRequest class provides an interface for StorageGateway UpdateBandwidthRateLimitSchedule requests.
 *
 ...
 *
 * \sa StorageGatewayClient::updateBandwidthRateLimitSchedule
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateBandwidthRateLimitScheduleRequest::UpdateBandwidthRateLimitScheduleRequest(const UpdateBandwidthRateLimitScheduleRequest &other)
    : StorageGatewayRequest(new UpdateBandwidthRateLimitScheduleRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateBandwidthRateLimitScheduleRequest object.
 */
UpdateBandwidthRateLimitScheduleRequest::UpdateBandwidthRateLimitScheduleRequest()
    : StorageGatewayRequest(new UpdateBandwidthRateLimitScheduleRequestPrivate(StorageGatewayRequest::UpdateBandwidthRateLimitScheduleAction, this))
{
 ...
 * \reimp
 */
bool UpdateBandwidthRateLimitScheduleRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateBandwidthRateLimitScheduleResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateBandwidthRateLimitScheduleRequest::response(QNetworkReply * const reply) const
{
    return new UpdateBandwidthRateLimitScheduleResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::UpdateBandwidthRateLimitScheduleRequestPrivate
 * \brief The UpdateBandwidthRateLimitScheduleRequestPrivate class provides private implementation for UpdateBandwidthRateLimitScheduleRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a UpdateBandwidthRateLimitScheduleRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
UpdateBandwidthRateLimitScheduleRequestPrivate::UpdateBandwidthRateLimitScheduleRequestPrivate(
    const StorageGatewayRequest::Action action, UpdateBandwidthRateLimitScheduleRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateBandwidthRateLimitScheduleRequest
 * class' copy constructor.
 */
UpdateBandwidthRateLimitScheduleRequestPrivate::UpdateBandwidthRateLimitScheduleRequestPrivate(
    const UpdateBandwidthRateLimitScheduleRequestPrivate &other, UpdateBandwidthRateLimitScheduleRequest * const q)
