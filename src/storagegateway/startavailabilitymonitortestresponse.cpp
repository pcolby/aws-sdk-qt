...
#include "startavailabilitymonitortestresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::StartAvailabilityMonitorTestResponse
 * \brief The StartAvailabilityMonitorTestResponse class provides an interace for StorageGateway StartAvailabilityMonitorTest responses.
 *
 ...
 *
 * \sa StorageGatewayClient::startAvailabilityMonitorTest
 */

/*!
 * Constructs a StartAvailabilityMonitorTestResponse object for \a reply to \a request, with parent \a parent.
 */
StartAvailabilityMonitorTestResponse::StartAvailabilityMonitorTestResponse(
        const StartAvailabilityMonitorTestRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new StartAvailabilityMonitorTestResponsePrivate(this), parent)
{
    setRequest(new StartAvailabilityMonitorTestRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const StartAvailabilityMonitorTestRequest * StartAvailabilityMonitorTestResponse::request() const
{
    Q_D(const StartAvailabilityMonitorTestResponse);
    return static_cast<const StartAvailabilityMonitorTestRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful StorageGateway StartAvailabilityMonitorTest \a response.
 */
void StartAvailabilityMonitorTestResponse::parseSuccess(QIODevice &response)
{
    //Q_D(StartAvailabilityMonitorTestResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::StartAvailabilityMonitorTestResponsePrivate
 * \brief The StartAvailabilityMonitorTestResponsePrivate class provides private implementation for StartAvailabilityMonitorTestResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a StartAvailabilityMonitorTestResponsePrivate object with public implementation \a q.
 */
StartAvailabilityMonitorTestResponsePrivate::StartAvailabilityMonitorTestResponsePrivate(
    StartAvailabilityMonitorTestResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway StartAvailabilityMonitorTest response element from \a xml.
 */
void StartAvailabilityMonitorTestResponsePrivate::parseStartAvailabilityMonitorTestResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("StartAvailabilityMonitorTestResponse"));
    Q_UNUSED(xml) ///< @todo
}
