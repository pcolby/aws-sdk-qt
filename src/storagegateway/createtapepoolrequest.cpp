...
#include "createtapepoolrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::CreateTapePoolRequest
 * \brief The CreateTapePoolRequest class provides an interface for StorageGateway CreateTapePool requests.
 *
 ...
 *
 * \sa StorageGatewayClient::createTapePool
 */

/*!
 * Constructs a copy of \a other.
 */
CreateTapePoolRequest::CreateTapePoolRequest(const CreateTapePoolRequest &other)
    : StorageGatewayRequest(new CreateTapePoolRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateTapePoolRequest object.
 */
CreateTapePoolRequest::CreateTapePoolRequest()
    : StorageGatewayRequest(new CreateTapePoolRequestPrivate(StorageGatewayRequest::CreateTapePoolAction, this))
{
 ...
 * \reimp
 */
bool CreateTapePoolRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateTapePoolResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateTapePoolRequest::response(QNetworkReply * const reply) const
{
    return new CreateTapePoolResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::CreateTapePoolRequestPrivate
 * \brief The CreateTapePoolRequestPrivate class provides private implementation for CreateTapePoolRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a CreateTapePoolRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
CreateTapePoolRequestPrivate::CreateTapePoolRequestPrivate(
    const StorageGatewayRequest::Action action, CreateTapePoolRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateTapePoolRequest
 * class' copy constructor.
 */
CreateTapePoolRequestPrivate::CreateTapePoolRequestPrivate(
    const CreateTapePoolRequestPrivate &other, CreateTapePoolRequest * const q)
