...
#include "describeavailabilitymonitortestrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::DescribeAvailabilityMonitorTestRequest
 * \brief The DescribeAvailabilityMonitorTestRequest class provides an interface for StorageGateway DescribeAvailabilityMonitorTest requests.
 *
 ...
 *
 * \sa StorageGatewayClient::describeAvailabilityMonitorTest
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeAvailabilityMonitorTestRequest::DescribeAvailabilityMonitorTestRequest(const DescribeAvailabilityMonitorTestRequest &other)
    : StorageGatewayRequest(new DescribeAvailabilityMonitorTestRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeAvailabilityMonitorTestRequest object.
 */
DescribeAvailabilityMonitorTestRequest::DescribeAvailabilityMonitorTestRequest()
    : StorageGatewayRequest(new DescribeAvailabilityMonitorTestRequestPrivate(StorageGatewayRequest::DescribeAvailabilityMonitorTestAction, this))
{
 ...
 * \reimp
 */
bool DescribeAvailabilityMonitorTestRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeAvailabilityMonitorTestResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeAvailabilityMonitorTestRequest::response(QNetworkReply * const reply) const
{
    return new DescribeAvailabilityMonitorTestResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::DescribeAvailabilityMonitorTestRequestPrivate
 * \brief The DescribeAvailabilityMonitorTestRequestPrivate class provides private implementation for DescribeAvailabilityMonitorTestRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DescribeAvailabilityMonitorTestRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
DescribeAvailabilityMonitorTestRequestPrivate::DescribeAvailabilityMonitorTestRequestPrivate(
    const StorageGatewayRequest::Action action, DescribeAvailabilityMonitorTestRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeAvailabilityMonitorTestRequest
 * class' copy constructor.
 */
DescribeAvailabilityMonitorTestRequestPrivate::DescribeAvailabilityMonitorTestRequestPrivate(
    const DescribeAvailabilityMonitorTestRequestPrivate &other, DescribeAvailabilityMonitorTestRequest * const q)
