...
#include "updatesmbfileshareresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::UpdateSMBFileShareResponse
 * \brief The UpdateSMBFileShareResponse class provides an interace for StorageGateway UpdateSMBFileShare responses.
 *
...
/*!
 * Constructs a UpdateSMBFileShareResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateSMBFileShareResponse::UpdateSMBFileShareResponse(
        const UpdateSMBFileShareRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new UpdateSMBFileShareResponsePrivate(this), parent)
{
    setRequest(new UpdateSMBFileShareRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway UpdateSMBFileShare \a response.
 */
void UpdateSMBFileShareResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateSMBFileShareResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::UpdateSMBFileShareResponsePrivate
 * \brief The UpdateSMBFileShareResponsePrivate class provides private implementation for UpdateSMBFileShareResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a UpdateSMBFileShareResponsePrivate object with public implementation \a q.
 */
UpdateSMBFileShareResponsePrivate::UpdateSMBFileShareResponsePrivate(
    UpdateSMBFileShareResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway UpdateSMBFileShare response element from \a xml.
 */
