...
class QTAWSSTORAGEGATEWAY_EXPORT DescribeChapCredentialsResponse : public StorageGatewayResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeChapCredentialsRequest * request() const Q_DECL_OVERRIDE;
