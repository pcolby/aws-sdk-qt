...
#include "listtapepoolsrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::ListTapePoolsRequest
 * \brief The ListTapePoolsRequest class provides an interface for StorageGateway ListTapePools requests.
 *
 ...
 */
ListTapePoolsRequest::ListTapePoolsRequest(const ListTapePoolsRequest &other)
    : StorageGatewayRequest(new ListTapePoolsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListTapePoolsRequest object.
 */
ListTapePoolsRequest::ListTapePoolsRequest()
    : StorageGatewayRequest(new ListTapePoolsRequestPrivate(StorageGatewayRequest::ListTapePoolsAction, this))
{
 ...
 * \reimp
 */
bool ListTapePoolsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListTapePoolsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListTapePoolsRequest::response(QNetworkReply * const reply) const
{
    return new ListTapePoolsResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::ListTapePoolsRequestPrivate
 * \brief The ListTapePoolsRequestPrivate class provides private implementation for ListTapePoolsRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a ListTapePoolsRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
ListTapePoolsRequestPrivate::ListTapePoolsRequestPrivate(
    const StorageGatewayRequest::Action action, ListTapePoolsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListTapePoolsRequest
 * class' copy constructor.
 */
ListTapePoolsRequestPrivate::ListTapePoolsRequestPrivate(
    const ListTapePoolsRequestPrivate &other, ListTapePoolsRequest * const q)
