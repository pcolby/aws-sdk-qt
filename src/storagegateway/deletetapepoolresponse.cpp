...
#include "deletetapepoolresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::DeleteTapePoolResponse
 * \brief The DeleteTapePoolResponse class provides an interace for StorageGateway DeleteTapePool responses.
 *
 ...
 *
 * \sa StorageGatewayClient::deleteTapePool
 */

/*!
 * Constructs a DeleteTapePoolResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteTapePoolResponse::DeleteTapePoolResponse(
        const DeleteTapePoolRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new DeleteTapePoolResponsePrivate(this), parent)
{
    setRequest(new DeleteTapePoolRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteTapePoolRequest * DeleteTapePoolResponse::request() const
{
    Q_D(const DeleteTapePoolResponse);
    return static_cast<const DeleteTapePoolRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful StorageGateway DeleteTapePool \a response.
 */
void DeleteTapePoolResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteTapePoolResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::DeleteTapePoolResponsePrivate
 * \brief The DeleteTapePoolResponsePrivate class provides private implementation for DeleteTapePoolResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DeleteTapePoolResponsePrivate object with public implementation \a q.
 */
DeleteTapePoolResponsePrivate::DeleteTapePoolResponsePrivate(
    DeleteTapePoolResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway DeleteTapePool response element from \a xml.
 */
void DeleteTapePoolResponsePrivate::parseDeleteTapePoolResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteTapePoolResponse"));
    Q_UNUSED(xml) ///< @todo
}
