...
class QTAWS_EXPORT DescribeCachediSCSIVolumesRequestPrivate : public StorageGatewayPrivate {

public:
    DescribeCachediSCSIVolumesRequestPrivate(const StorageGateway::Action action,
