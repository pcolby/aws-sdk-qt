...
/*!
 * \class QtAws::StorageGateway::AttachVolumeResponse
 * \brief The AttachVolumeResponse class provides an interace for StorageGateway AttachVolume responses.
 *
...
AttachVolumeResponse::AttachVolumeResponse(
    ...
    : StorageGatewayResponse(new AttachVolumeResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful StorageGateway AttachVolume \a response.
 */
...
/*!
 * \class QtAws::StorageGateway::AttachVolumeResponsePrivate
...
AttachVolumeResponsePrivate::AttachVolumeResponsePrivate(
    AttachVolumeResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway AttachVolume response element from \a xml.
 */
