...
#include "updatesmblocalgroupsresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::UpdateSMBLocalGroupsResponse
 * \brief The UpdateSMBLocalGroupsResponse class provides an interace for StorageGateway UpdateSMBLocalGroups responses.
 *
 ...
 *
 * \sa StorageGatewayClient::updateSMBLocalGroups
 */

/*!
 * Constructs a UpdateSMBLocalGroupsResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateSMBLocalGroupsResponse::UpdateSMBLocalGroupsResponse(
        const UpdateSMBLocalGroupsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new UpdateSMBLocalGroupsResponsePrivate(this), parent)
{
    setRequest(new UpdateSMBLocalGroupsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateSMBLocalGroupsRequest * UpdateSMBLocalGroupsResponse::request() const
{
    Q_D(const UpdateSMBLocalGroupsResponse);
    return static_cast<const UpdateSMBLocalGroupsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful StorageGateway UpdateSMBLocalGroups \a response.
 */
void UpdateSMBLocalGroupsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateSMBLocalGroupsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::UpdateSMBLocalGroupsResponsePrivate
 * \brief The UpdateSMBLocalGroupsResponsePrivate class provides private implementation for UpdateSMBLocalGroupsResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a UpdateSMBLocalGroupsResponsePrivate object with public implementation \a q.
 */
UpdateSMBLocalGroupsResponsePrivate::UpdateSMBLocalGroupsResponsePrivate(
    UpdateSMBLocalGroupsResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway UpdateSMBLocalGroups response element from \a xml.
 */
void UpdateSMBLocalGroupsResponsePrivate::parseUpdateSMBLocalGroupsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateSMBLocalGroupsResponse"));
    Q_UNUSED(xml) ///< @todo
}
