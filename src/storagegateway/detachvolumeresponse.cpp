...
/*!
 * \class QtAws::StorageGateway::DetachVolumeResponse
 * \brief The DetachVolumeResponse class provides an interace for StorageGateway DetachVolume responses.
 *
...
DetachVolumeResponse::DetachVolumeResponse(
    ...
    : StorageGatewayResponse(new DetachVolumeResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful StorageGateway DetachVolume \a response.
 */
...
/*!
 * \class QtAws::StorageGateway::DetachVolumeResponsePrivate
...
DetachVolumeResponsePrivate::DetachVolumeResponsePrivate(
    DetachVolumeResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway DetachVolume response element from \a xml.
 */
