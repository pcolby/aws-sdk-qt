...
#include "listautomatictapecreationpoliciesresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::ListAutomaticTapeCreationPoliciesResponse
 * \brief The ListAutomaticTapeCreationPoliciesResponse class provides an interace for StorageGateway ListAutomaticTapeCreationPolicies responses.
 *
 ...
 *
 * \sa StorageGatewayClient::listAutomaticTapeCreationPolicies
 */

/*!
 * Constructs a ListAutomaticTapeCreationPoliciesResponse object for \a reply to \a request, with parent \a parent.
 */
ListAutomaticTapeCreationPoliciesResponse::ListAutomaticTapeCreationPoliciesResponse(
        const ListAutomaticTapeCreationPoliciesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new ListAutomaticTapeCreationPoliciesResponsePrivate(this), parent)
{
    setRequest(new ListAutomaticTapeCreationPoliciesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListAutomaticTapeCreationPoliciesRequest * ListAutomaticTapeCreationPoliciesResponse::request() const
{
    Q_D(const ListAutomaticTapeCreationPoliciesResponse);
    return static_cast<const ListAutomaticTapeCreationPoliciesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful StorageGateway ListAutomaticTapeCreationPolicies \a response.
 */
void ListAutomaticTapeCreationPoliciesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListAutomaticTapeCreationPoliciesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::ListAutomaticTapeCreationPoliciesResponsePrivate
 * \brief The ListAutomaticTapeCreationPoliciesResponsePrivate class provides private implementation for ListAutomaticTapeCreationPoliciesResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a ListAutomaticTapeCreationPoliciesResponsePrivate object with public implementation \a q.
 */
ListAutomaticTapeCreationPoliciesResponsePrivate::ListAutomaticTapeCreationPoliciesResponsePrivate(
    ListAutomaticTapeCreationPoliciesResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway ListAutomaticTapeCreationPolicies response element from \a xml.
 */
void ListAutomaticTapeCreationPoliciesResponsePrivate::parseListAutomaticTapeCreationPoliciesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListAutomaticTapeCreationPoliciesResponse"));
    Q_UNUSED(xml) ///< @todo
}
