...
#include "updatesmblocalgroupsrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::UpdateSMBLocalGroupsRequest
 * \brief The UpdateSMBLocalGroupsRequest class provides an interface for StorageGateway UpdateSMBLocalGroups requests.
 *
 ...
 */
UpdateSMBLocalGroupsRequest::UpdateSMBLocalGroupsRequest(const UpdateSMBLocalGroupsRequest &other)
    : StorageGatewayRequest(new UpdateSMBLocalGroupsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateSMBLocalGroupsRequest object.
 */
UpdateSMBLocalGroupsRequest::UpdateSMBLocalGroupsRequest()
    : StorageGatewayRequest(new UpdateSMBLocalGroupsRequestPrivate(StorageGatewayRequest::UpdateSMBLocalGroupsAction, this))
{
 ...
 * \reimp
 */
bool UpdateSMBLocalGroupsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateSMBLocalGroupsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateSMBLocalGroupsRequest::response(QNetworkReply * const reply) const
{
    return new UpdateSMBLocalGroupsResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::UpdateSMBLocalGroupsRequestPrivate
 * \brief The UpdateSMBLocalGroupsRequestPrivate class provides private implementation for UpdateSMBLocalGroupsRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a UpdateSMBLocalGroupsRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
UpdateSMBLocalGroupsRequestPrivate::UpdateSMBLocalGroupsRequestPrivate(
    const StorageGatewayRequest::Action action, UpdateSMBLocalGroupsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateSMBLocalGroupsRequest
 * class' copy constructor.
 */
UpdateSMBLocalGroupsRequestPrivate::UpdateSMBLocalGroupsRequestPrivate(
    const UpdateSMBLocalGroupsRequestPrivate &other, UpdateSMBLocalGroupsRequest * const q)
