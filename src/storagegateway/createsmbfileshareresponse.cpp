...
#include "createsmbfileshareresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::CreateSMBFileShareResponse
 * \brief The CreateSMBFileShareResponse class provides an interace for StorageGateway CreateSMBFileShare responses.
 *
...
/*!
 * Constructs a CreateSMBFileShareResponse object for \a reply to \a request, with parent \a parent.
 */
CreateSMBFileShareResponse::CreateSMBFileShareResponse(
        const CreateSMBFileShareRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new CreateSMBFileShareResponsePrivate(this), parent)
{
    setRequest(new CreateSMBFileShareRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway CreateSMBFileShare \a response.
 */
void CreateSMBFileShareResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateSMBFileShareResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::CreateSMBFileShareResponsePrivate
 * \brief The CreateSMBFileShareResponsePrivate class provides private implementation for CreateSMBFileShareResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a CreateSMBFileShareResponsePrivate object with public implementation \a q.
 */
CreateSMBFileShareResponsePrivate::CreateSMBFileShareResponsePrivate(
    CreateSMBFileShareResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway CreateSMBFileShare response element from \a xml.
 */
void CreateSMBFileShareResponsePrivate::parseCreateSMBFileShareResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateSMBFileShareResponse"));
    /// @todo
}
