 ...
 *
 * \brief The RetrieveTapeRecoveryPointResponse class encapsulates StorageGateway RetrieveTapeRecoveryPoint responses.
 *
 ...
 *
 * \sa StorageGatewayClient::retrieveTapeRecoveryPoint
 */
