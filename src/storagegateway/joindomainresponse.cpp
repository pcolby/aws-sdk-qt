...
#include "joindomainresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::JoinDomainResponse
 * \brief The JoinDomainResponse class provides an interace for StorageGateway JoinDomain responses.
 *
...
/*!
 * Constructs a JoinDomainResponse object for \a reply to \a request, with parent \a parent.
 */
JoinDomainResponse::JoinDomainResponse(
        const JoinDomainRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new JoinDomainResponsePrivate(this), parent)
{
    setRequest(new JoinDomainRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway JoinDomain \a response.
 */
void JoinDomainResponse::parseSuccess(QIODevice &response)
{
    //Q_D(JoinDomainResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::JoinDomainResponsePrivate
 * \brief The JoinDomainResponsePrivate class provides private implementation for JoinDomainResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a JoinDomainResponsePrivate object with public implementation \a q.
 */
JoinDomainResponsePrivate::JoinDomainResponsePrivate(
    JoinDomainResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway JoinDomain response element from \a xml.
 */
