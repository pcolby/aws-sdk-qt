...
#include "describesmbfilesharesresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::DescribeSMBFileSharesResponse
 * \brief The DescribeSMBFileSharesResponse class provides an interace for StorageGateway DescribeSMBFileShares responses.
 *
...
/*!
 * Constructs a DescribeSMBFileSharesResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeSMBFileSharesResponse::DescribeSMBFileSharesResponse(
        const DescribeSMBFileSharesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new DescribeSMBFileSharesResponsePrivate(this), parent)
{
    setRequest(new DescribeSMBFileSharesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeSMBFileSharesRequest * DescribeSMBFileSharesResponse::request() const
{
    Q_D(const DescribeSMBFileSharesResponse);
    return static_cast<const DescribeSMBFileSharesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful StorageGateway DescribeSMBFileShares \a response.
 */
void DescribeSMBFileSharesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeSMBFileSharesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::DescribeSMBFileSharesResponsePrivate
 * \brief The DescribeSMBFileSharesResponsePrivate class provides private implementation for DescribeSMBFileSharesResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DescribeSMBFileSharesResponsePrivate object with public implementation \a q.
 */
DescribeSMBFileSharesResponsePrivate::DescribeSMBFileSharesResponsePrivate(
    DescribeSMBFileSharesResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway DescribeSMBFileShares response element from \a xml.
 */
