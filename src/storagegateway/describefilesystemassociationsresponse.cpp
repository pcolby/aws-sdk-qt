...
#include "describefilesystemassociationsresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::DescribeFileSystemAssociationsResponse
 * \brief The DescribeFileSystemAssociationsResponse class provides an interace for StorageGateway DescribeFileSystemAssociations responses.
 *
...
/*!
 * Constructs a DescribeFileSystemAssociationsResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeFileSystemAssociationsResponse::DescribeFileSystemAssociationsResponse(
        const DescribeFileSystemAssociationsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new DescribeFileSystemAssociationsResponsePrivate(this), parent)
{
    setRequest(new DescribeFileSystemAssociationsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway DescribeFileSystemAssociations \a response.
 */
void DescribeFileSystemAssociationsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeFileSystemAssociationsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::DescribeFileSystemAssociationsResponsePrivate
 * \brief The DescribeFileSystemAssociationsResponsePrivate class provides private implementation for DescribeFileSystemAssociationsResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DescribeFileSystemAssociationsResponsePrivate object with public implementation \a q.
 */
DescribeFileSystemAssociationsResponsePrivate::DescribeFileSystemAssociationsResponsePrivate(
    DescribeFileSystemAssociationsResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway DescribeFileSystemAssociations response element from \a xml.
 */
void DescribeFileSystemAssociationsResponsePrivate::parseDescribeFileSystemAssociationsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeFileSystemAssociationsResponse"));
    Q_UNUSED(xml) ///< @todo
}
