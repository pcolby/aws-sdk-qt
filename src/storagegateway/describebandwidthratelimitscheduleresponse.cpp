...
#include "describebandwidthratelimitscheduleresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::DescribeBandwidthRateLimitScheduleResponse
 * \brief The DescribeBandwidthRateLimitScheduleResponse class provides an interace for StorageGateway DescribeBandwidthRateLimitSchedule responses.
 *
 ...
 *
 * \sa StorageGatewayClient::describeBandwidthRateLimitSchedule
 */

/*!
 * Constructs a DescribeBandwidthRateLimitScheduleResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeBandwidthRateLimitScheduleResponse::DescribeBandwidthRateLimitScheduleResponse(
        const DescribeBandwidthRateLimitScheduleRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new DescribeBandwidthRateLimitScheduleResponsePrivate(this), parent)
{
    setRequest(new DescribeBandwidthRateLimitScheduleRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeBandwidthRateLimitScheduleRequest * DescribeBandwidthRateLimitScheduleResponse::request() const
{
    Q_D(const DescribeBandwidthRateLimitScheduleResponse);
    return static_cast<const DescribeBandwidthRateLimitScheduleRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful StorageGateway DescribeBandwidthRateLimitSchedule \a response.
 */
void DescribeBandwidthRateLimitScheduleResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeBandwidthRateLimitScheduleResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::DescribeBandwidthRateLimitScheduleResponsePrivate
 * \brief The DescribeBandwidthRateLimitScheduleResponsePrivate class provides private implementation for DescribeBandwidthRateLimitScheduleResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DescribeBandwidthRateLimitScheduleResponsePrivate object with public implementation \a q.
 */
DescribeBandwidthRateLimitScheduleResponsePrivate::DescribeBandwidthRateLimitScheduleResponsePrivate(
    DescribeBandwidthRateLimitScheduleResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway DescribeBandwidthRateLimitSchedule response element from \a xml.
 */
void DescribeBandwidthRateLimitScheduleResponsePrivate::parseDescribeBandwidthRateLimitScheduleResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeBandwidthRateLimitScheduleResponse"));
    Q_UNUSED(xml) ///< @todo
}
