...
#include "associatefilesystemrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::AssociateFileSystemRequest
 * \brief The AssociateFileSystemRequest class provides an interface for StorageGateway AssociateFileSystem requests.
 *
 ...
 *
 * \sa StorageGatewayClient::associateFileSystem
 */

/*!
 * Constructs a copy of \a other.
 */
AssociateFileSystemRequest::AssociateFileSystemRequest(const AssociateFileSystemRequest &other)
    : StorageGatewayRequest(new AssociateFileSystemRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AssociateFileSystemRequest object.
 */
AssociateFileSystemRequest::AssociateFileSystemRequest()
    : StorageGatewayRequest(new AssociateFileSystemRequestPrivate(StorageGatewayRequest::AssociateFileSystemAction, this))
{
 ...
 * \reimp
 */
bool AssociateFileSystemRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AssociateFileSystemResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AssociateFileSystemRequest::response(QNetworkReply * const reply) const
{
    return new AssociateFileSystemResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::AssociateFileSystemRequestPrivate
 * \brief The AssociateFileSystemRequestPrivate class provides private implementation for AssociateFileSystemRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a AssociateFileSystemRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
AssociateFileSystemRequestPrivate::AssociateFileSystemRequestPrivate(
    const StorageGatewayRequest::Action action, AssociateFileSystemRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AssociateFileSystemRequest
 * class' copy constructor.
 */
AssociateFileSystemRequestPrivate::AssociateFileSystemRequestPrivate(
    const AssociateFileSystemRequestPrivate &other, AssociateFileSystemRequest * const q)
