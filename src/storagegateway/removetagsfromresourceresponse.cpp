 ...
 *
 * \brief The RemoveTagsFromResourceResponse class encapsulates StorageGateway RemoveTagsFromResource responses.
 *
 ...
 *
 * \sa StorageGatewayClient::removeTagsFromResource
 */
