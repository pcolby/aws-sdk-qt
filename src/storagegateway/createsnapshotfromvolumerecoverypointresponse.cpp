 ...
 *
 * \brief The CreateSnapshotFromVolumeRecoveryPointResponse class encapsulates StorageGateway CreateSnapshotFromVolumeRecoveryPoint responses.
 *
 ...
 *
 * \sa StorageGatewayClient::createSnapshotFromVolumeRecoveryPoint
 */
