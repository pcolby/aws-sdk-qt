 ...
 *
 * \brief The DescribeWorkingStorageResponse class encapsulates StorageGateway DescribeWorkingStorage responses.
 *
 ...
 *
 * \sa StorageGatewayClient::describeWorkingStorage
 */
