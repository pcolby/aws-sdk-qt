 ...
 *
 * \brief The DescribeCachediSCSIVolumesRequest class encapsulates StorageGateway DescribeCachediSCSIVolumes requests.
 *
 ...
 *
 * \sa StorageGatewayClient::describeCachediSCSIVolumes
 */
