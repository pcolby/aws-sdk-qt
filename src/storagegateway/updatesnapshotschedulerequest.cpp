 ...
 *
 * \brief The UpdateSnapshotScheduleRequest class encapsulates StorageGateway UpdateSnapshotSchedule requests.
 *
 ...
 *
 * \sa StorageGatewayClient::updateSnapshotSchedule
 */
