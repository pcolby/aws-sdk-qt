 ...
 *
 * \brief The ListTagsForResourceResponse class encapsulates StorageGateway ListTagsForResource responses.
 *
 ...
 *
 * \sa StorageGatewayClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : StorageGatewayResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
