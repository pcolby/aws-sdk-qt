...
#include "setsmbguestpasswordrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::SetSMBGuestPasswordRequest
 * \brief The SetSMBGuestPasswordRequest class provides an interface for StorageGateway SetSMBGuestPassword requests.
 *
 ...
 *
 * \sa StorageGatewayClient::setSMBGuestPassword
 */

/*!
 * Constructs a copy of \a other.
 */
SetSMBGuestPasswordRequest::SetSMBGuestPasswordRequest(const SetSMBGuestPasswordRequest &other)
    : StorageGatewayRequest(new SetSMBGuestPasswordRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a SetSMBGuestPasswordRequest object.
 */
SetSMBGuestPasswordRequest::SetSMBGuestPasswordRequest()
    : StorageGatewayRequest(new SetSMBGuestPasswordRequestPrivate(StorageGatewayRequest::SetSMBGuestPasswordAction, this))
{
 ...
 * \reimp
 */
bool SetSMBGuestPasswordRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a SetSMBGuestPasswordResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * SetSMBGuestPasswordRequest::response(QNetworkReply * const reply) const
{
    return new SetSMBGuestPasswordResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::SetSMBGuestPasswordRequestPrivate
 * \brief The SetSMBGuestPasswordRequestPrivate class provides private implementation for SetSMBGuestPasswordRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a SetSMBGuestPasswordRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
SetSMBGuestPasswordRequestPrivate::SetSMBGuestPasswordRequestPrivate(
    const StorageGatewayRequest::Action action, SetSMBGuestPasswordRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the SetSMBGuestPasswordRequest
 * class' copy constructor.
 */
SetSMBGuestPasswordRequestPrivate::SetSMBGuestPasswordRequestPrivate(
    const SetSMBGuestPasswordRequestPrivate &other, SetSMBGuestPasswordRequest * const q)
