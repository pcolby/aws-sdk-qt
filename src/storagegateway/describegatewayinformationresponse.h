...
class QTAWS_EXPORT DescribeGatewayInformationResponse : public DescribeGatewayInformationResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeGatewayInformationRequest * request() const;
