 ...
 *
 * \brief The UpdateGatewayInformationResponse class encapsulates StorageGateway UpdateGatewayInformation responses.
 *
 ...
 *
 * \sa StorageGatewayClient::updateGatewayInformation
 */
