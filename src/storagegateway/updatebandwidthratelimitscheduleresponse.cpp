...
#include "updatebandwidthratelimitscheduleresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::UpdateBandwidthRateLimitScheduleResponse
 * \brief The UpdateBandwidthRateLimitScheduleResponse class provides an interace for StorageGateway UpdateBandwidthRateLimitSchedule responses.
 *
...
/*!
 * Constructs a UpdateBandwidthRateLimitScheduleResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateBandwidthRateLimitScheduleResponse::UpdateBandwidthRateLimitScheduleResponse(
        const UpdateBandwidthRateLimitScheduleRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new UpdateBandwidthRateLimitScheduleResponsePrivate(this), parent)
{
    setRequest(new UpdateBandwidthRateLimitScheduleRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway UpdateBandwidthRateLimitSchedule \a response.
 */
void UpdateBandwidthRateLimitScheduleResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateBandwidthRateLimitScheduleResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::UpdateBandwidthRateLimitScheduleResponsePrivate
 * \brief The UpdateBandwidthRateLimitScheduleResponsePrivate class provides private implementation for UpdateBandwidthRateLimitScheduleResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a UpdateBandwidthRateLimitScheduleResponsePrivate object with public implementation \a q.
 */
UpdateBandwidthRateLimitScheduleResponsePrivate::UpdateBandwidthRateLimitScheduleResponsePrivate(
    UpdateBandwidthRateLimitScheduleResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway UpdateBandwidthRateLimitSchedule response element from \a xml.
 */
void UpdateBandwidthRateLimitScheduleResponsePrivate::parseUpdateBandwidthRateLimitScheduleResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateBandwidthRateLimitScheduleResponse"));
    Q_UNUSED(xml) ///< @todo
}
