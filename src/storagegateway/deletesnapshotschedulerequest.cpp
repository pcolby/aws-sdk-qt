 ...
 *
 * \brief The DeleteSnapshotScheduleRequest class encapsulates StorageGateway DeleteSnapshotSchedule requests.
 *
 ...
 *
 * \sa StorageGatewayClient::deleteSnapshotSchedule
 */
