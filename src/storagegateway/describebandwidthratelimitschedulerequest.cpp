...
#include "describebandwidthratelimitschedulerequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::DescribeBandwidthRateLimitScheduleRequest
 * \brief The DescribeBandwidthRateLimitScheduleRequest class provides an interface for StorageGateway DescribeBandwidthRateLimitSchedule requests.
 *
 ...
 */
DescribeBandwidthRateLimitScheduleRequest::DescribeBandwidthRateLimitScheduleRequest(const DescribeBandwidthRateLimitScheduleRequest &other)
    : StorageGatewayRequest(new DescribeBandwidthRateLimitScheduleRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeBandwidthRateLimitScheduleRequest object.
 */
DescribeBandwidthRateLimitScheduleRequest::DescribeBandwidthRateLimitScheduleRequest()
    : StorageGatewayRequest(new DescribeBandwidthRateLimitScheduleRequestPrivate(StorageGatewayRequest::DescribeBandwidthRateLimitScheduleAction, this))
{
 ...
 * \reimp
 */
bool DescribeBandwidthRateLimitScheduleRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeBandwidthRateLimitScheduleResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeBandwidthRateLimitScheduleRequest::response(QNetworkReply * const reply) const
{
    return new DescribeBandwidthRateLimitScheduleResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::DescribeBandwidthRateLimitScheduleRequestPrivate
 * \brief The DescribeBandwidthRateLimitScheduleRequestPrivate class provides private implementation for DescribeBandwidthRateLimitScheduleRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DescribeBandwidthRateLimitScheduleRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
DescribeBandwidthRateLimitScheduleRequestPrivate::DescribeBandwidthRateLimitScheduleRequestPrivate(
    const StorageGatewayRequest::Action action, DescribeBandwidthRateLimitScheduleRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeBandwidthRateLimitScheduleRequest
 * class' copy constructor.
 */
DescribeBandwidthRateLimitScheduleRequestPrivate::DescribeBandwidthRateLimitScheduleRequestPrivate(
    const DescribeBandwidthRateLimitScheduleRequestPrivate &other, DescribeBandwidthRateLimitScheduleRequest * const q)
