...
#include "startavailabilitymonitortestrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::StartAvailabilityMonitorTestRequest
 * \brief The StartAvailabilityMonitorTestRequest class provides an interface for StorageGateway StartAvailabilityMonitorTest requests.
 *
 ...
 */
StartAvailabilityMonitorTestRequest::StartAvailabilityMonitorTestRequest(const StartAvailabilityMonitorTestRequest &other)
    : StorageGatewayRequest(new StartAvailabilityMonitorTestRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a StartAvailabilityMonitorTestRequest object.
 */
StartAvailabilityMonitorTestRequest::StartAvailabilityMonitorTestRequest()
    : StorageGatewayRequest(new StartAvailabilityMonitorTestRequestPrivate(StorageGatewayRequest::StartAvailabilityMonitorTestAction, this))
{
 ...
 * \reimp
 */
bool StartAvailabilityMonitorTestRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a StartAvailabilityMonitorTestResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * StartAvailabilityMonitorTestRequest::response(QNetworkReply * const reply) const
{
    return new StartAvailabilityMonitorTestResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::StartAvailabilityMonitorTestRequestPrivate
 * \brief The StartAvailabilityMonitorTestRequestPrivate class provides private implementation for StartAvailabilityMonitorTestRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a StartAvailabilityMonitorTestRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
StartAvailabilityMonitorTestRequestPrivate::StartAvailabilityMonitorTestRequestPrivate(
    const StorageGatewayRequest::Action action, StartAvailabilityMonitorTestRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the StartAvailabilityMonitorTestRequest
 * class' copy constructor.
 */
StartAvailabilityMonitorTestRequestPrivate::StartAvailabilityMonitorTestRequestPrivate(
    const StartAvailabilityMonitorTestRequestPrivate &other, StartAvailabilityMonitorTestRequest * const q)
