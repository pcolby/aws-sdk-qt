 ...
 *
 * \brief The CreateStorediSCSIVolumeResponse class encapsulates StorageGateway CreateStorediSCSIVolume responses.
 *
 ...
 *
 * \sa StorageGatewayClient::createStorediSCSIVolume
 */
