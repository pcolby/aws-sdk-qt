...
#include "assigntapepoolresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::AssignTapePoolResponse
 * \brief The AssignTapePoolResponse class provides an interace for StorageGateway AssignTapePool responses.
 *
...
/*!
 * Constructs a AssignTapePoolResponse object for \a reply to \a request, with parent \a parent.
 */
AssignTapePoolResponse::AssignTapePoolResponse(
        const AssignTapePoolRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new AssignTapePoolResponsePrivate(this), parent)
{
    setRequest(new AssignTapePoolRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway AssignTapePool \a response.
 */
void AssignTapePoolResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AssignTapePoolResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::AssignTapePoolResponsePrivate
 * \brief The AssignTapePoolResponsePrivate class provides private implementation for AssignTapePoolResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a AssignTapePoolResponsePrivate object with public implementation \a q.
 */
AssignTapePoolResponsePrivate::AssignTapePoolResponsePrivate(
    AssignTapePoolResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway AssignTapePool response element from \a xml.
 */
void AssignTapePoolResponsePrivate::parseAssignTapePoolResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AssignTapePoolResponse"));
    Q_UNUSED(xml) ///< @todo
}
