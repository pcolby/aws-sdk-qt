...
#include "updatesmbfilesharerequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::UpdateSMBFileShareRequest
 * \brief The UpdateSMBFileShareRequest class provides an interface for StorageGateway UpdateSMBFileShare requests.
 *
 ...
 *
 * \sa StorageGatewayClient::updateSMBFileShare
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateSMBFileShareRequest::UpdateSMBFileShareRequest(const UpdateSMBFileShareRequest &other)
    : StorageGatewayRequest(new UpdateSMBFileShareRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateSMBFileShareRequest object.
 */
UpdateSMBFileShareRequest::UpdateSMBFileShareRequest()
    : StorageGatewayRequest(new UpdateSMBFileShareRequestPrivate(StorageGatewayRequest::UpdateSMBFileShareAction, this))
{
 ...
 * \reimp
 */
bool UpdateSMBFileShareRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateSMBFileShareResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateSMBFileShareRequest::response(QNetworkReply * const reply) const
{
    return new UpdateSMBFileShareResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::UpdateSMBFileShareRequestPrivate
 * \brief The UpdateSMBFileShareRequestPrivate class provides private implementation for UpdateSMBFileShareRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a UpdateSMBFileShareRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
UpdateSMBFileShareRequestPrivate::UpdateSMBFileShareRequestPrivate(
    const StorageGatewayRequest::Action action, UpdateSMBFileShareRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateSMBFileShareRequest
 * class' copy constructor.
 */
UpdateSMBFileShareRequestPrivate::UpdateSMBFileShareRequestPrivate(
    const UpdateSMBFileShareRequestPrivate &other, UpdateSMBFileShareRequest * const q)
