 ...
 *
 * \brief The DescribeMaintenanceStartTimeResponse class encapsulates StorageGateway DescribeMaintenanceStartTime responses.
 *
...
{
    Q_D(DescribeMaintenanceStartTimeResponse);
