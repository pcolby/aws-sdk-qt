...
#include "updateautomatictapecreationpolicyresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::UpdateAutomaticTapeCreationPolicyResponse
 * \brief The UpdateAutomaticTapeCreationPolicyResponse class provides an interace for StorageGateway UpdateAutomaticTapeCreationPolicy responses.
 *
...
/*!
 * Constructs a UpdateAutomaticTapeCreationPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateAutomaticTapeCreationPolicyResponse::UpdateAutomaticTapeCreationPolicyResponse(
        const UpdateAutomaticTapeCreationPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new UpdateAutomaticTapeCreationPolicyResponsePrivate(this), parent)
{
    setRequest(new UpdateAutomaticTapeCreationPolicyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway UpdateAutomaticTapeCreationPolicy \a response.
 */
void UpdateAutomaticTapeCreationPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateAutomaticTapeCreationPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::UpdateAutomaticTapeCreationPolicyResponsePrivate
 * \brief The UpdateAutomaticTapeCreationPolicyResponsePrivate class provides private implementation for UpdateAutomaticTapeCreationPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a UpdateAutomaticTapeCreationPolicyResponsePrivate object with public implementation \a q.
 */
UpdateAutomaticTapeCreationPolicyResponsePrivate::UpdateAutomaticTapeCreationPolicyResponsePrivate(
    UpdateAutomaticTapeCreationPolicyResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway UpdateAutomaticTapeCreationPolicy response element from \a xml.
 */
void UpdateAutomaticTapeCreationPolicyResponsePrivate::parseUpdateAutomaticTapeCreationPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateAutomaticTapeCreationPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
