...
#include "listfilesystemassociationsrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::ListFileSystemAssociationsRequest
 * \brief The ListFileSystemAssociationsRequest class provides an interface for StorageGateway ListFileSystemAssociations requests.
 *
 ...
 *
 * \sa StorageGatewayClient::listFileSystemAssociations
 */

/*!
 * Constructs a copy of \a other.
 */
ListFileSystemAssociationsRequest::ListFileSystemAssociationsRequest(const ListFileSystemAssociationsRequest &other)
    : StorageGatewayRequest(new ListFileSystemAssociationsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListFileSystemAssociationsRequest object.
 */
ListFileSystemAssociationsRequest::ListFileSystemAssociationsRequest()
    : StorageGatewayRequest(new ListFileSystemAssociationsRequestPrivate(StorageGatewayRequest::ListFileSystemAssociationsAction, this))
{
 ...
 * \reimp
 */
bool ListFileSystemAssociationsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListFileSystemAssociationsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListFileSystemAssociationsRequest::response(QNetworkReply * const reply) const
{
    return new ListFileSystemAssociationsResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::ListFileSystemAssociationsRequestPrivate
 * \brief The ListFileSystemAssociationsRequestPrivate class provides private implementation for ListFileSystemAssociationsRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a ListFileSystemAssociationsRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
ListFileSystemAssociationsRequestPrivate::ListFileSystemAssociationsRequestPrivate(
    const StorageGatewayRequest::Action action, ListFileSystemAssociationsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListFileSystemAssociationsRequest
 * class' copy constructor.
 */
ListFileSystemAssociationsRequestPrivate::ListFileSystemAssociationsRequestPrivate(
    const ListFileSystemAssociationsRequestPrivate &other, ListFileSystemAssociationsRequest * const q)
