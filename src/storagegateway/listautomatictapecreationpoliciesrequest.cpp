...
#include "listautomatictapecreationpoliciesrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::ListAutomaticTapeCreationPoliciesRequest
 * \brief The ListAutomaticTapeCreationPoliciesRequest class provides an interface for StorageGateway ListAutomaticTapeCreationPolicies requests.
 *
 ...
 */
ListAutomaticTapeCreationPoliciesRequest::ListAutomaticTapeCreationPoliciesRequest(const ListAutomaticTapeCreationPoliciesRequest &other)
    : StorageGatewayRequest(new ListAutomaticTapeCreationPoliciesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListAutomaticTapeCreationPoliciesRequest object.
 */
ListAutomaticTapeCreationPoliciesRequest::ListAutomaticTapeCreationPoliciesRequest()
    : StorageGatewayRequest(new ListAutomaticTapeCreationPoliciesRequestPrivate(StorageGatewayRequest::ListAutomaticTapeCreationPoliciesAction, this))
{
 ...
 * \reimp
 */
bool ListAutomaticTapeCreationPoliciesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListAutomaticTapeCreationPoliciesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListAutomaticTapeCreationPoliciesRequest::response(QNetworkReply * const reply) const
{
    return new ListAutomaticTapeCreationPoliciesResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::ListAutomaticTapeCreationPoliciesRequestPrivate
 * \brief The ListAutomaticTapeCreationPoliciesRequestPrivate class provides private implementation for ListAutomaticTapeCreationPoliciesRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a ListAutomaticTapeCreationPoliciesRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
ListAutomaticTapeCreationPoliciesRequestPrivate::ListAutomaticTapeCreationPoliciesRequestPrivate(
    const StorageGatewayRequest::Action action, ListAutomaticTapeCreationPoliciesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListAutomaticTapeCreationPoliciesRequest
 * class' copy constructor.
 */
ListAutomaticTapeCreationPoliciesRequestPrivate::ListAutomaticTapeCreationPoliciesRequestPrivate(
    const ListAutomaticTapeCreationPoliciesRequestPrivate &other, ListAutomaticTapeCreationPoliciesRequest * const q)
