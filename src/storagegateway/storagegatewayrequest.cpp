 ...
 * \value AssociateFileSystemAction StorageGateway AssociateFileSystem action.
 ...
 * \value CreateTapePoolAction StorageGateway CreateTapePool action.
 ...
 * \value DeleteAutomaticTapeCreationPolicyAction StorageGateway DeleteAutomaticTapeCreationPolicy action.
 ...
 * \value DeleteTapePoolAction StorageGateway DeleteTapePool action.
 * \value DeleteVolumeAction StorageGateway DeleteVolume action.
 * \value DescribeAvailabilityMonitorTestAction StorageGateway DescribeAvailabilityMonitorTest action.
 * \value DescribeBandwidthRateLimitAction StorageGateway DescribeBandwidthRateLimit action.
 * \value DescribeBandwidthRateLimitScheduleAction StorageGateway DescribeBandwidthRateLimitSchedule action.
 ...
 * \value DescribeFileSystemAssociationsAction StorageGateway DescribeFileSystemAssociations action.
 ...
 * \value DisassociateFileSystemAction StorageGateway DisassociateFileSystem action.
 * \value JoinDomainAction StorageGateway JoinDomain action.
 * \value ListAutomaticTapeCreationPoliciesAction StorageGateway ListAutomaticTapeCreationPolicies action.
 * \value ListFileSharesAction StorageGateway ListFileShares action.
 * \value ListFileSystemAssociationsAction StorageGateway ListFileSystemAssociations action.
 ...
 * \value ListTapePoolsAction StorageGateway ListTapePools action.
 ...
 * \value StartAvailabilityMonitorTestAction StorageGateway StartAvailabilityMonitorTest action.
 * \value StartGatewayAction StorageGateway StartGateway action.
 * \value UpdateAutomaticTapeCreationPolicyAction StorageGateway UpdateAutomaticTapeCreationPolicy action.
 * \value UpdateBandwidthRateLimitAction StorageGateway UpdateBandwidthRateLimit action.
 * \value UpdateBandwidthRateLimitScheduleAction StorageGateway UpdateBandwidthRateLimitSchedule action.
 * \value UpdateChapCredentialsAction StorageGateway UpdateChapCredentials action.
 * \value UpdateFileSystemAssociationAction StorageGateway UpdateFileSystemAssociation action.
...
StorageGatewayRequest::StorageGatewayRequest(const Action action)
    : d_ptr(new StorageGatewayRequestPrivate(action, this))
{
...
StorageGatewayRequest::StorageGatewayRequest(const StorageGatewayRequest &other)
    : QtAws::Core::AwsAbstractRequest(*this),
      d_ptr(new StorageGatewayRequestPrivate(*other.d_func(), this))
{
 ...
 */
StorageGatewayRequest::StorageGatewayRequest(StorageGatewayRequestPrivate * const d) : d_ptr(d)
{
...
QString StorageGatewayRequestPrivate::toString(const StorageGatewayRequest::Action &action)
{
    ...
    switch (action) {
        ActionToString(ActivateGateway);
        ActionToString(AddCache);
        ActionToString(AddTagsToResource);
        ActionToString(AddUploadBuffer);
        ActionToString(AddWorkingStorage);
        ActionToString(AssignTapePool);
        ActionToString(AssociateFileSystem);
        ActionToString(AttachVolume);
        ActionToString(CancelArchival);
        ActionToString(CancelRetrieval);
        ActionToString(CreateCachediSCSIVolume);
        ActionToString(CreateNFSFileShare);
        ActionToString(CreateSMBFileShare);
        ActionToString(CreateSnapshot);
        ActionToString(CreateSnapshotFromVolumeRecoveryPoint);
        ActionToString(CreateStorediSCSIVolume);
        ActionToString(CreateTapePool);
        ActionToString(CreateTapeWithBarcode);
        ActionToString(CreateTapes);
        ActionToString(DeleteAutomaticTapeCreationPolicy);
        ActionToString(DeleteBandwidthRateLimit);
        ActionToString(DeleteChapCredentials);
        ActionToString(DeleteFileShare);
        ActionToString(DeleteGateway);
        ActionToString(DeleteSnapshotSchedule);
        ActionToString(DeleteTape);
        ActionToString(DeleteTapeArchive);
        ActionToString(DeleteTapePool);
        ActionToString(DeleteVolume);
        ActionToString(DescribeAvailabilityMonitorTest);
        ActionToString(DescribeBandwidthRateLimit);
        ActionToString(DescribeBandwidthRateLimitSchedule);
        ActionToString(DescribeCache);
        ActionToString(DescribeCachediSCSIVolumes);
        ActionToString(DescribeChapCredentials);
        ActionToString(DescribeFileSystemAssociations);
        ActionToString(DescribeGatewayInformation);
        ActionToString(DescribeMaintenanceStartTime);
        ActionToString(DescribeNFSFileShares);
        ActionToString(DescribeSMBFileShares);
        ActionToString(DescribeSMBSettings);
        ActionToString(DescribeSnapshotSchedule);
        ActionToString(DescribeStorediSCSIVolumes);
        ActionToString(DescribeTapeArchives);
        ActionToString(DescribeTapeRecoveryPoints);
        ActionToString(DescribeTapes);
        ActionToString(DescribeUploadBuffer);
        ActionToString(DescribeVTLDevices);
        ActionToString(DescribeWorkingStorage);
        ActionToString(DetachVolume);
        ActionToString(DisableGateway);
        ActionToString(DisassociateFileSystem);
        ActionToString(JoinDomain);
        ActionToString(ListAutomaticTapeCreationPolicies);
        ActionToString(ListFileShares);
        ActionToString(ListFileSystemAssociations);
        ActionToString(ListGateways);
        ActionToString(ListLocalDisks);
        ActionToString(ListTagsForResource);
        ActionToString(ListTapePools);
        ActionToString(ListTapes);
        ActionToString(ListVolumeInitiators);
        ActionToString(ListVolumeRecoveryPoints);
        ActionToString(ListVolumes);
        ActionToString(NotifyWhenUploaded);
        ActionToString(RefreshCache);
        ActionToString(RemoveTagsFromResource);
        ActionToString(ResetCache);
        ActionToString(RetrieveTapeArchive);
        ActionToString(RetrieveTapeRecoveryPoint);
        ActionToString(SetLocalConsolePassword);
        ActionToString(SetSMBGuestPassword);
        ActionToString(ShutdownGateway);
        ActionToString(StartAvailabilityMonitorTest);
        ActionToString(StartGateway);
        ActionToString(UpdateAutomaticTapeCreationPolicy);
        ActionToString(UpdateBandwidthRateLimit);
        ActionToString(UpdateBandwidthRateLimitSchedule);
        ActionToString(UpdateChapCredentials);
        ActionToString(UpdateFileSystemAssociation);
        ActionToString(UpdateGatewayInformation);
        ActionToString(UpdateGatewaySoftwareNow);
        ActionToString(UpdateMaintenanceStartTime);
