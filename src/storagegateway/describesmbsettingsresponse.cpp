...
#include "describesmbsettingsresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::DescribeSMBSettingsResponse
 * \brief The DescribeSMBSettingsResponse class provides an interace for StorageGateway DescribeSMBSettings responses.
 *
...
/*!
 * Constructs a DescribeSMBSettingsResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeSMBSettingsResponse::DescribeSMBSettingsResponse(
        const DescribeSMBSettingsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new DescribeSMBSettingsResponsePrivate(this), parent)
{
    setRequest(new DescribeSMBSettingsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway DescribeSMBSettings \a response.
 */
void DescribeSMBSettingsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeSMBSettingsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::DescribeSMBSettingsResponsePrivate
 * \brief The DescribeSMBSettingsResponsePrivate class provides private implementation for DescribeSMBSettingsResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DescribeSMBSettingsResponsePrivate object with public implementation \a q.
 */
DescribeSMBSettingsResponsePrivate::DescribeSMBSettingsResponsePrivate(
    DescribeSMBSettingsResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway DescribeSMBSettings response element from \a xml.
 */
