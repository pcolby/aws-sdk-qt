...
#include "createsmbfilesharerequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::CreateSMBFileShareRequest
 * \brief The CreateSMBFileShareRequest class provides an interface for StorageGateway CreateSMBFileShare requests.
 *
 ...
 *
 * \sa StorageGatewayClient::createSMBFileShare
 */

/*!
 * Constructs a copy of \a other.
 */
CreateSMBFileShareRequest::CreateSMBFileShareRequest(const CreateSMBFileShareRequest &other)
    : StorageGatewayRequest(new CreateSMBFileShareRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateSMBFileShareRequest object.
 */
CreateSMBFileShareRequest::CreateSMBFileShareRequest()
    : StorageGatewayRequest(new CreateSMBFileShareRequestPrivate(StorageGatewayRequest::CreateSMBFileShareAction, this))
{
 ...
 * \reimp
 */
bool CreateSMBFileShareRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateSMBFileShareResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateSMBFileShareRequest::response(QNetworkReply * const reply) const
{
    return new CreateSMBFileShareResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::CreateSMBFileShareRequestPrivate
 * \brief The CreateSMBFileShareRequestPrivate class provides private implementation for CreateSMBFileShareRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a CreateSMBFileShareRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
CreateSMBFileShareRequestPrivate::CreateSMBFileShareRequestPrivate(
    const StorageGatewayRequest::Action action, CreateSMBFileShareRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateSMBFileShareRequest
 * class' copy constructor.
 */
CreateSMBFileShareRequestPrivate::CreateSMBFileShareRequestPrivate(
    const CreateSMBFileShareRequestPrivate &other, CreateSMBFileShareRequest * const q)
