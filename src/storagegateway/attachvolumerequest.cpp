...
/*!
 * \class QtAws::StorageGateway::AttachVolumeRequest
 * \brief The AttachVolumeRequest class provides an interface for StorageGateway AttachVolume requests.
 *
 ...
 *
 * \sa StorageGatewayClient::attachVolume
 */
...
AttachVolumeRequest::AttachVolumeRequest(const AttachVolumeRequest &other)
    : StorageGatewayRequest(new AttachVolumeRequestPrivate(*other.d_func(), this))
{
...
AttachVolumeRequest::AttachVolumeRequest()
    : StorageGatewayRequest(new AttachVolumeRequestPrivate(StorageGatewayRequest::AttachVolumeAction, this))
{
...
/*!
 * \class QtAws::StorageGateway::AttachVolumeRequestPrivate
...
/*!
 * Constructs a AttachVolumeRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
AttachVolumeRequestPrivate::AttachVolumeRequestPrivate(
    const StorageGatewayRequest::Action action, AttachVolumeRequest * const q)
