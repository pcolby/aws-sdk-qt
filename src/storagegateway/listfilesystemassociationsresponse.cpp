...
#include "listfilesystemassociationsresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::ListFileSystemAssociationsResponse
 * \brief The ListFileSystemAssociationsResponse class provides an interace for StorageGateway ListFileSystemAssociations responses.
 *
...
/*!
 * Constructs a ListFileSystemAssociationsResponse object for \a reply to \a request, with parent \a parent.
 */
ListFileSystemAssociationsResponse::ListFileSystemAssociationsResponse(
        const ListFileSystemAssociationsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new ListFileSystemAssociationsResponsePrivate(this), parent)
{
    setRequest(new ListFileSystemAssociationsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway ListFileSystemAssociations \a response.
 */
void ListFileSystemAssociationsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListFileSystemAssociationsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::ListFileSystemAssociationsResponsePrivate
 * \brief The ListFileSystemAssociationsResponsePrivate class provides private implementation for ListFileSystemAssociationsResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a ListFileSystemAssociationsResponsePrivate object with public implementation \a q.
 */
ListFileSystemAssociationsResponsePrivate::ListFileSystemAssociationsResponsePrivate(
    ListFileSystemAssociationsResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway ListFileSystemAssociations response element from \a xml.
 */
void ListFileSystemAssociationsResponsePrivate::parseListFileSystemAssociationsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListFileSystemAssociationsResponse"));
    Q_UNUSED(xml) ///< @todo
}
