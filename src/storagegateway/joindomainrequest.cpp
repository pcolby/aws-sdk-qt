...
/*!
 * \class QtAws::StorageGateway::JoinDomainRequest
 * \brief The JoinDomainRequest class provides an interface for StorageGateway JoinDomain requests.
 *
 ...
 *
 * \sa StorageGatewayClient::joinDomain
 */

/*!
 * Constructs a copy of \a other.
 */
JoinDomainRequest::JoinDomainRequest(const JoinDomainRequest &other)
    : StorageGatewayRequest(new JoinDomainRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a JoinDomainRequest object.
 */
JoinDomainRequest::JoinDomainRequest()
    : StorageGatewayRequest(new JoinDomainRequestPrivate(StorageGatewayRequest::JoinDomainAction, this))
{
 ...
 * \reimp
 */
bool JoinDomainRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a JoinDomainResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * JoinDomainRequest::response(QNetworkReply * const reply) const
{
    return new JoinDomainResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::JoinDomainRequestPrivate
 * \brief The JoinDomainRequestPrivate class provides private implementation for JoinDomainRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a JoinDomainRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
JoinDomainRequestPrivate::JoinDomainRequestPrivate(
    const StorageGatewayRequest::Action action, JoinDomainRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the JoinDomainRequest
 * class' copy constructor.
 */
JoinDomainRequestPrivate::JoinDomainRequestPrivate(
    const JoinDomainRequestPrivate &other, JoinDomainRequest * const q)
