...
#include "updatefilesystemassociationrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::UpdateFileSystemAssociationRequest
 * \brief The UpdateFileSystemAssociationRequest class provides an interface for StorageGateway UpdateFileSystemAssociation requests.
 *
 ...
 *
 * \sa StorageGatewayClient::updateFileSystemAssociation
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateFileSystemAssociationRequest::UpdateFileSystemAssociationRequest(const UpdateFileSystemAssociationRequest &other)
    : StorageGatewayRequest(new UpdateFileSystemAssociationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateFileSystemAssociationRequest object.
 */
UpdateFileSystemAssociationRequest::UpdateFileSystemAssociationRequest()
    : StorageGatewayRequest(new UpdateFileSystemAssociationRequestPrivate(StorageGatewayRequest::UpdateFileSystemAssociationAction, this))
{
 ...
 * \reimp
 */
bool UpdateFileSystemAssociationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateFileSystemAssociationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateFileSystemAssociationRequest::response(QNetworkReply * const reply) const
{
    return new UpdateFileSystemAssociationResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::UpdateFileSystemAssociationRequestPrivate
 * \brief The UpdateFileSystemAssociationRequestPrivate class provides private implementation for UpdateFileSystemAssociationRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a UpdateFileSystemAssociationRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
UpdateFileSystemAssociationRequestPrivate::UpdateFileSystemAssociationRequestPrivate(
    const StorageGatewayRequest::Action action, UpdateFileSystemAssociationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateFileSystemAssociationRequest
 * class' copy constructor.
 */
UpdateFileSystemAssociationRequestPrivate::UpdateFileSystemAssociationRequestPrivate(
    const UpdateFileSystemAssociationRequestPrivate &other, UpdateFileSystemAssociationRequest * const q)
