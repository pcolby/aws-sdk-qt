...
#include "associatefilesystemresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::AssociateFileSystemResponse
 * \brief The AssociateFileSystemResponse class provides an interace for StorageGateway AssociateFileSystem responses.
 *
...
/*!
 * Constructs a AssociateFileSystemResponse object for \a reply to \a request, with parent \a parent.
 */
AssociateFileSystemResponse::AssociateFileSystemResponse(
        const AssociateFileSystemRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new AssociateFileSystemResponsePrivate(this), parent)
{
    setRequest(new AssociateFileSystemRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway AssociateFileSystem \a response.
 */
void AssociateFileSystemResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AssociateFileSystemResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::AssociateFileSystemResponsePrivate
 * \brief The AssociateFileSystemResponsePrivate class provides private implementation for AssociateFileSystemResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a AssociateFileSystemResponsePrivate object with public implementation \a q.
 */
AssociateFileSystemResponsePrivate::AssociateFileSystemResponsePrivate(
    AssociateFileSystemResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway AssociateFileSystem response element from \a xml.
 */
void AssociateFileSystemResponsePrivate::parseAssociateFileSystemResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AssociateFileSystemResponse"));
    Q_UNUSED(xml) ///< @todo
}
