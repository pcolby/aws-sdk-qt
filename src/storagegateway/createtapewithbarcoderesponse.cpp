 ...
 *
 * \brief The CreateTapeWithBarcodeResponse class encapsulates StorageGateway CreateTapeWithBarcode responses.
 *
 ...
 *
 * \sa StorageGatewayClient::createTapeWithBarcode
 */
