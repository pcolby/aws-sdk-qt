...
/*!
 * \class QtAws::StorageGateway::DetachVolumeRequest
 * \brief The DetachVolumeRequest class provides an interface for StorageGateway DetachVolume requests.
 *
 ...
 *
 * \sa StorageGatewayClient::detachVolume
 */
...
DetachVolumeRequest::DetachVolumeRequest(const DetachVolumeRequest &other)
    : StorageGatewayRequest(new DetachVolumeRequestPrivate(*other.d_func(), this))
{
...
DetachVolumeRequest::DetachVolumeRequest()
    : StorageGatewayRequest(new DetachVolumeRequestPrivate(StorageGatewayRequest::DetachVolumeAction, this))
{
...
/*!
 * \class QtAws::StorageGateway::DetachVolumeRequestPrivate
...
/*!
 * Constructs a DetachVolumeRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
DetachVolumeRequestPrivate::DetachVolumeRequestPrivate(
    const StorageGatewayRequest::Action action, DetachVolumeRequest * const q)
