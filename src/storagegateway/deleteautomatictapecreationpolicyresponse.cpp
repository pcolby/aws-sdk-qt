...
#include "deleteautomatictapecreationpolicyresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::DeleteAutomaticTapeCreationPolicyResponse
 * \brief The DeleteAutomaticTapeCreationPolicyResponse class provides an interace for StorageGateway DeleteAutomaticTapeCreationPolicy responses.
 *
...
/*!
 * Constructs a DeleteAutomaticTapeCreationPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteAutomaticTapeCreationPolicyResponse::DeleteAutomaticTapeCreationPolicyResponse(
        const DeleteAutomaticTapeCreationPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new DeleteAutomaticTapeCreationPolicyResponsePrivate(this), parent)
{
    setRequest(new DeleteAutomaticTapeCreationPolicyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway DeleteAutomaticTapeCreationPolicy \a response.
 */
void DeleteAutomaticTapeCreationPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteAutomaticTapeCreationPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::DeleteAutomaticTapeCreationPolicyResponsePrivate
 * \brief The DeleteAutomaticTapeCreationPolicyResponsePrivate class provides private implementation for DeleteAutomaticTapeCreationPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DeleteAutomaticTapeCreationPolicyResponsePrivate object with public implementation \a q.
 */
DeleteAutomaticTapeCreationPolicyResponsePrivate::DeleteAutomaticTapeCreationPolicyResponsePrivate(
    DeleteAutomaticTapeCreationPolicyResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway DeleteAutomaticTapeCreationPolicy response element from \a xml.
 */
void DeleteAutomaticTapeCreationPolicyResponsePrivate::parseDeleteAutomaticTapeCreationPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteAutomaticTapeCreationPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
