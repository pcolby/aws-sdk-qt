...
#include "updateautomatictapecreationpolicyrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::UpdateAutomaticTapeCreationPolicyRequest
 * \brief The UpdateAutomaticTapeCreationPolicyRequest class provides an interface for StorageGateway UpdateAutomaticTapeCreationPolicy requests.
 *
 ...
 *
 * \sa StorageGatewayClient::updateAutomaticTapeCreationPolicy
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateAutomaticTapeCreationPolicyRequest::UpdateAutomaticTapeCreationPolicyRequest(const UpdateAutomaticTapeCreationPolicyRequest &other)
    : StorageGatewayRequest(new UpdateAutomaticTapeCreationPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateAutomaticTapeCreationPolicyRequest object.
 */
UpdateAutomaticTapeCreationPolicyRequest::UpdateAutomaticTapeCreationPolicyRequest()
    : StorageGatewayRequest(new UpdateAutomaticTapeCreationPolicyRequestPrivate(StorageGatewayRequest::UpdateAutomaticTapeCreationPolicyAction, this))
{
 ...
 * \reimp
 */
bool UpdateAutomaticTapeCreationPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateAutomaticTapeCreationPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateAutomaticTapeCreationPolicyRequest::response(QNetworkReply * const reply) const
{
    return new UpdateAutomaticTapeCreationPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::UpdateAutomaticTapeCreationPolicyRequestPrivate
 * \brief The UpdateAutomaticTapeCreationPolicyRequestPrivate class provides private implementation for UpdateAutomaticTapeCreationPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a UpdateAutomaticTapeCreationPolicyRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
UpdateAutomaticTapeCreationPolicyRequestPrivate::UpdateAutomaticTapeCreationPolicyRequestPrivate(
    const StorageGatewayRequest::Action action, UpdateAutomaticTapeCreationPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateAutomaticTapeCreationPolicyRequest
 * class' copy constructor.
 */
UpdateAutomaticTapeCreationPolicyRequestPrivate::UpdateAutomaticTapeCreationPolicyRequestPrivate(
    const UpdateAutomaticTapeCreationPolicyRequestPrivate &other, UpdateAutomaticTapeCreationPolicyRequest * const q)
