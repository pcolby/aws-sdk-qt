...
#include "listtapepoolsresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::ListTapePoolsResponse
 * \brief The ListTapePoolsResponse class provides an interace for StorageGateway ListTapePools responses.
 *
 ...
 *
 * \sa StorageGatewayClient::listTapePools
 */

/*!
 * Constructs a ListTapePoolsResponse object for \a reply to \a request, with parent \a parent.
 */
ListTapePoolsResponse::ListTapePoolsResponse(
        const ListTapePoolsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new ListTapePoolsResponsePrivate(this), parent)
{
    setRequest(new ListTapePoolsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListTapePoolsRequest * ListTapePoolsResponse::request() const
{
    Q_D(const ListTapePoolsResponse);
    return static_cast<const ListTapePoolsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful StorageGateway ListTapePools \a response.
 */
void ListTapePoolsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListTapePoolsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::ListTapePoolsResponsePrivate
 * \brief The ListTapePoolsResponsePrivate class provides private implementation for ListTapePoolsResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a ListTapePoolsResponsePrivate object with public implementation \a q.
 */
ListTapePoolsResponsePrivate::ListTapePoolsResponsePrivate(
    ListTapePoolsResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway ListTapePools response element from \a xml.
 */
void ListTapePoolsResponsePrivate::parseListTapePoolsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListTapePoolsResponse"));
    Q_UNUSED(xml) ///< @todo
}
