...
#include "describesmbfilesharesrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::DescribeSMBFileSharesRequest
 * \brief The DescribeSMBFileSharesRequest class provides an interface for StorageGateway DescribeSMBFileShares requests.
 *
 ...
 *
 * \sa StorageGatewayClient::describeSMBFileShares
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeSMBFileSharesRequest::DescribeSMBFileSharesRequest(const DescribeSMBFileSharesRequest &other)
    : StorageGatewayRequest(new DescribeSMBFileSharesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeSMBFileSharesRequest object.
 */
DescribeSMBFileSharesRequest::DescribeSMBFileSharesRequest()
    : StorageGatewayRequest(new DescribeSMBFileSharesRequestPrivate(StorageGatewayRequest::DescribeSMBFileSharesAction, this))
{
 ...
 * \reimp
 */
bool DescribeSMBFileSharesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeSMBFileSharesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeSMBFileSharesRequest::response(QNetworkReply * const reply) const
{
    return new DescribeSMBFileSharesResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::DescribeSMBFileSharesRequestPrivate
 * \brief The DescribeSMBFileSharesRequestPrivate class provides private implementation for DescribeSMBFileSharesRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DescribeSMBFileSharesRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
DescribeSMBFileSharesRequestPrivate::DescribeSMBFileSharesRequestPrivate(
    const StorageGatewayRequest::Action action, DescribeSMBFileSharesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeSMBFileSharesRequest
 * class' copy constructor.
 */
DescribeSMBFileSharesRequestPrivate::DescribeSMBFileSharesRequestPrivate(
    const DescribeSMBFileSharesRequestPrivate &other, DescribeSMBFileSharesRequest * const q)
