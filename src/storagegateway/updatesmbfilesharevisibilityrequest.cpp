...
#include "updatesmbfilesharevisibilityrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::UpdateSMBFileShareVisibilityRequest
 * \brief The UpdateSMBFileShareVisibilityRequest class provides an interface for StorageGateway UpdateSMBFileShareVisibility requests.
 *
 ...
 *
 * \sa StorageGatewayClient::updateSMBFileShareVisibility
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateSMBFileShareVisibilityRequest::UpdateSMBFileShareVisibilityRequest(const UpdateSMBFileShareVisibilityRequest &other)
    : StorageGatewayRequest(new UpdateSMBFileShareVisibilityRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateSMBFileShareVisibilityRequest object.
 */
UpdateSMBFileShareVisibilityRequest::UpdateSMBFileShareVisibilityRequest()
    : StorageGatewayRequest(new UpdateSMBFileShareVisibilityRequestPrivate(StorageGatewayRequest::UpdateSMBFileShareVisibilityAction, this))
{
 ...
 * \reimp
 */
bool UpdateSMBFileShareVisibilityRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateSMBFileShareVisibilityResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateSMBFileShareVisibilityRequest::response(QNetworkReply * const reply) const
{
    return new UpdateSMBFileShareVisibilityResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::UpdateSMBFileShareVisibilityRequestPrivate
 * \brief The UpdateSMBFileShareVisibilityRequestPrivate class provides private implementation for UpdateSMBFileShareVisibilityRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a UpdateSMBFileShareVisibilityRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
UpdateSMBFileShareVisibilityRequestPrivate::UpdateSMBFileShareVisibilityRequestPrivate(
    const StorageGatewayRequest::Action action, UpdateSMBFileShareVisibilityRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateSMBFileShareVisibilityRequest
 * class' copy constructor.
 */
UpdateSMBFileShareVisibilityRequestPrivate::UpdateSMBFileShareVisibilityRequestPrivate(
    const UpdateSMBFileShareVisibilityRequestPrivate &other, UpdateSMBFileShareVisibilityRequest * const q)
