 ...
 *
 * \brief The DescribeNFSFileSharesResponse class encapsulates StorageGateway DescribeNFSFileShares responses.
 *
 ...
 *
 * \sa StorageGatewayClient::describeNFSFileShares
 */
