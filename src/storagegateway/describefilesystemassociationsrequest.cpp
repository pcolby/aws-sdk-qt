...
#include "describefilesystemassociationsrequest_p.h"
...
/*!
 * \class QtAws::StorageGateway::DescribeFileSystemAssociationsRequest
 * \brief The DescribeFileSystemAssociationsRequest class provides an interface for StorageGateway DescribeFileSystemAssociations requests.
 *
 ...
 *
 * \sa StorageGatewayClient::describeFileSystemAssociations
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeFileSystemAssociationsRequest::DescribeFileSystemAssociationsRequest(const DescribeFileSystemAssociationsRequest &other)
    : StorageGatewayRequest(new DescribeFileSystemAssociationsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeFileSystemAssociationsRequest object.
 */
DescribeFileSystemAssociationsRequest::DescribeFileSystemAssociationsRequest()
    : StorageGatewayRequest(new DescribeFileSystemAssociationsRequestPrivate(StorageGatewayRequest::DescribeFileSystemAssociationsAction, this))
{
 ...
 * \reimp
 */
bool DescribeFileSystemAssociationsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeFileSystemAssociationsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeFileSystemAssociationsRequest::response(QNetworkReply * const reply) const
{
    return new DescribeFileSystemAssociationsResponse(*this, reply);
}

/*!
 * \class QtAws::StorageGateway::DescribeFileSystemAssociationsRequestPrivate
 * \brief The DescribeFileSystemAssociationsRequestPrivate class provides private implementation for DescribeFileSystemAssociationsRequest.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a DescribeFileSystemAssociationsRequestPrivate object for StorageGateway \a action,
 * with public implementation \a q.
 */
DescribeFileSystemAssociationsRequestPrivate::DescribeFileSystemAssociationsRequestPrivate(
    const StorageGatewayRequest::Action action, DescribeFileSystemAssociationsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeFileSystemAssociationsRequest
 * class' copy constructor.
 */
DescribeFileSystemAssociationsRequestPrivate::DescribeFileSystemAssociationsRequestPrivate(
    const DescribeFileSystemAssociationsRequestPrivate &other, DescribeFileSystemAssociationsRequest * const q)
