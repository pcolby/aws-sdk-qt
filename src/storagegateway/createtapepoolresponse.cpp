...
#include "createtapepoolresponse_p.h"
...
/*!
 * \class QtAws::StorageGateway::CreateTapePoolResponse
 * \brief The CreateTapePoolResponse class provides an interace for StorageGateway CreateTapePool responses.
 *
...
/*!
 * Constructs a CreateTapePoolResponse object for \a reply to \a request, with parent \a parent.
 */
CreateTapePoolResponse::CreateTapePoolResponse(
        const CreateTapePoolRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : StorageGatewayResponse(new CreateTapePoolResponsePrivate(this), parent)
{
    setRequest(new CreateTapePoolRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful StorageGateway CreateTapePool \a response.
 */
void CreateTapePoolResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateTapePoolResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::StorageGateway::CreateTapePoolResponsePrivate
 * \brief The CreateTapePoolResponsePrivate class provides private implementation for CreateTapePoolResponse.
 * \internal
 *
 * \inmodule QtAwsStorageGateway
 */
...
/*!
 * Constructs a CreateTapePoolResponsePrivate object with public implementation \a q.
 */
CreateTapePoolResponsePrivate::CreateTapePoolResponsePrivate(
    CreateTapePoolResponse * const q) : StorageGatewayResponsePrivate(q)
{

}

/*!
 * Parses a StorageGateway CreateTapePool response element from \a xml.
 */
void CreateTapePoolResponsePrivate::parseCreateTapePoolResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateTapePoolResponse"));
    Q_UNUSED(xml) ///< @todo
}
