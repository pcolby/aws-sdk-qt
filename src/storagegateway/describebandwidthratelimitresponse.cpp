 ...
 *
 * \brief The DescribeBandwidthRateLimitResponse class encapsulates StorageGateway DescribeBandwidthRateLimit responses.
 *
 ...
 *
 * \sa StorageGatewayClient::describeBandwidthRateLimit
 */
