...
/*!
 * \class QtAws::LookoutEquipment::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for LookoutEquipment UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : LookoutEquipmentResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful LookoutEquipment UntagResource \a response.
 */
...
/*!
 * \class QtAws::LookoutEquipment::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : LookoutEquipmentResponsePrivate(q)
{

}

/*!
 * Parses a LookoutEquipment UntagResource response element from \a xml.
 */
