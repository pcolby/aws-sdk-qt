...
/*!
 * \class QtAws::LookoutEquipment::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for LookoutEquipment TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : LookoutEquipmentResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(LookoutEquipmentResponse::request());
}

/*!
 * \reimp
 * Parses a successful LookoutEquipment TagResource \a response.
 */
...
/*!
 * \class QtAws::LookoutEquipment::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : LookoutEquipmentResponsePrivate(q)
{

}

/*!
 * Parses a LookoutEquipment TagResource response element from \a xml.
 */
