...
class QTAWS_EXPORT CreateInferenceSchedulerResponsePrivate : public LookoutEquipmentResponsePrivate {

public:

    CreateInferenceSchedulerResponsePrivate(CreateInferenceSchedulerResponse * const q);
