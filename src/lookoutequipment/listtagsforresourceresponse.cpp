...
/*!
 * \class QtAws::LookoutEquipment::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for LookoutEquipment ListTagsForResource responses.
 *
 ...
 *
 * \sa LookoutEquipmentClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : LookoutEquipmentResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(LookoutEquipmentResponse::request());
}

/*!
 * \reimp
 * Parses a successful LookoutEquipment ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::LookoutEquipment::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : LookoutEquipmentResponsePrivate(q)
{

}

/*!
 * Parses a LookoutEquipment ListTagsForResource response element from \a xml.
 */
