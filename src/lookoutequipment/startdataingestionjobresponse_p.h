...
class QTAWS_EXPORT StartDataIngestionJobResponsePrivate : public LookoutEquipmentResponsePrivate {

public:

    StartDataIngestionJobResponsePrivate(StartDataIngestionJobResponse * const q);
