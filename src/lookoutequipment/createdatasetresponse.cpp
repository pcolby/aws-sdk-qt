...
/*!
 * \class QtAws::LookoutEquipment::CreateDatasetResponse
 * \brief The CreateDatasetResponse class provides an interace for LookoutEquipment CreateDataset responses.
 *
...
CreateDatasetResponse::CreateDatasetResponse(
    ...
    : LookoutEquipmentResponse(new CreateDatasetResponsePrivate(this), parent)
{
...
{
    return static_cast<const CreateDatasetRequest *>(LookoutEquipmentResponse::request());
}

/*!
 * \reimp
 * Parses a successful LookoutEquipment CreateDataset \a response.
 */
...
/*!
 * \class QtAws::LookoutEquipment::CreateDatasetResponsePrivate
...
CreateDatasetResponsePrivate::CreateDatasetResponsePrivate(
    CreateDatasetResponse * const q) : LookoutEquipmentResponsePrivate(q)
{

}

/*!
 * Parses a LookoutEquipment CreateDataset response element from \a xml.
 */
