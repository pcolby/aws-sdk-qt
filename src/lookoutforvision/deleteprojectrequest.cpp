...
/*!
 * \class QtAws::LookoutforVision::DeleteProjectRequest
 * \brief The DeleteProjectRequest class provides an interface for LookoutforVision DeleteProject requests.
 *
...
DeleteProjectRequest::DeleteProjectRequest(const DeleteProjectRequest &other)
    : LookoutforVisionRequest(new DeleteProjectRequestPrivate(*other.d_func(), this))
{
...
DeleteProjectRequest::DeleteProjectRequest()
    : LookoutforVisionRequest(new DeleteProjectRequestPrivate(LookoutforVisionRequest::DeleteProjectAction, this))
{
...
/*!
 * \class QtAws::LookoutforVision::DeleteProjectRequestPrivate
...
/*!
 * Constructs a DeleteProjectRequestPrivate object for LookoutforVision \a action,
 * with public implementation \a q.
 */
DeleteProjectRequestPrivate::DeleteProjectRequestPrivate(
    const LookoutforVisionRequest::Action action, DeleteProjectRequest * const q)
