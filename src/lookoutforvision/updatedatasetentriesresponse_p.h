...
class QTAWS_EXPORT UpdateDatasetEntriesResponsePrivate : public LookoutforVisionResponsePrivate {

public:

    UpdateDatasetEntriesResponsePrivate(UpdateDatasetEntriesResponse * const q);
