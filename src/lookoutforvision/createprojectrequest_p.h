...
class QTAWS_EXPORT CreateProjectRequestPrivate : public LookoutforVisionRequestPrivate {

public:
    CreateProjectRequestPrivate(const LookoutforVisionRequest::Action action,
