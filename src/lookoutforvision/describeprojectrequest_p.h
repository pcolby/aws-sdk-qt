...
class QTAWS_EXPORT DescribeProjectRequestPrivate : public LookoutforVisionRequestPrivate {

public:
    DescribeProjectRequestPrivate(const LookoutforVisionRequest::Action action,
