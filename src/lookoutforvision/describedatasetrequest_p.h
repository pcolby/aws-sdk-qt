...
class QTAWS_EXPORT DescribeDatasetRequestPrivate : public LookoutforVisionRequestPrivate {

public:
    DescribeDatasetRequestPrivate(const LookoutforVisionRequest::Action action,
