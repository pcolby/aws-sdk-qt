...
/*!
 * \class QtAws::LookoutforVision::DeleteModelResponse
 * \brief The DeleteModelResponse class provides an interace for LookoutforVision DeleteModel responses.
 *
...
DeleteModelResponse::DeleteModelResponse(
    ...
    : LookoutforVisionResponse(new DeleteModelResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful LookoutforVision DeleteModel \a response.
 */
...
/*!
 * \class QtAws::LookoutforVision::DeleteModelResponsePrivate
...
DeleteModelResponsePrivate::DeleteModelResponsePrivate(
    DeleteModelResponse * const q) : LookoutforVisionResponsePrivate(q)
{

}

/*!
 * Parses a LookoutforVision DeleteModel response element from \a xml.
 */
