...
/*!
 * \class QtAws::LookoutforVision::CreateProjectRequest
 * \brief The CreateProjectRequest class provides an interface for LookoutforVision CreateProject requests.
 *
...
CreateProjectRequest::CreateProjectRequest(const CreateProjectRequest &other)
    : LookoutforVisionRequest(new CreateProjectRequestPrivate(*other.d_func(), this))
{
...
CreateProjectRequest::CreateProjectRequest()
    : LookoutforVisionRequest(new CreateProjectRequestPrivate(LookoutforVisionRequest::CreateProjectAction, this))
{
...
/*!
 * \class QtAws::LookoutforVision::CreateProjectRequestPrivate
...
/*!
 * Constructs a CreateProjectRequestPrivate object for LookoutforVision \a action,
 * with public implementation \a q.
 */
CreateProjectRequestPrivate::CreateProjectRequestPrivate(
    const LookoutforVisionRequest::Action action, CreateProjectRequest * const q)
