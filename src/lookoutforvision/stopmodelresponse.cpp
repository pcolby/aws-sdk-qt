...
/*!
 * \class QtAws::LookoutforVision::StopModelResponse
 * \brief The StopModelResponse class provides an interace for LookoutforVision StopModel responses.
 *
...
StopModelResponse::StopModelResponse(
    ...
    : LookoutforVisionResponse(new StopModelResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful LookoutforVision StopModel \a response.
 */
...
/*!
 * \class QtAws::LookoutforVision::StopModelResponsePrivate
...
StopModelResponsePrivate::StopModelResponsePrivate(
    StopModelResponse * const q) : LookoutforVisionResponsePrivate(q)
{

}

/*!
 * Parses a LookoutforVision StopModel response element from \a xml.
 */
