...
class QTAWS_EXPORT CreateDatasetRequestPrivate : public LookoutforVisionRequestPrivate {

public:
    CreateDatasetRequestPrivate(const LookoutforVisionRequest::Action action,
