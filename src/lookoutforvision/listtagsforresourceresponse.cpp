...
/*!
 * \class QtAws::LookoutforVision::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for LookoutforVision ListTagsForResource responses.
 *
 ...
 *
 * \sa LookoutforVisionClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : LookoutforVisionResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(LookoutforVisionResponse::request());
}

/*!
 * \reimp
 * Parses a successful LookoutforVision ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::LookoutforVision::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : LookoutforVisionResponsePrivate(q)
{

}

/*!
 * Parses a LookoutforVision ListTagsForResource response element from \a xml.
 */
