...
class QTAWS_EXPORT ListProjectsRequestPrivate : public LookoutforVisionRequestPrivate {

public:
    ListProjectsRequestPrivate(const LookoutforVisionRequest::Action action,
