...
/*!
 * \class QtAws::LookoutforVision::DeleteDatasetResponse
 * \brief The DeleteDatasetResponse class provides an interace for LookoutforVision DeleteDataset responses.
 *
...
DeleteDatasetResponse::DeleteDatasetResponse(
    ...
    : LookoutforVisionResponse(new DeleteDatasetResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteDatasetRequest *>(LookoutforVisionResponse::request());
}

/*!
 * \reimp
 * Parses a successful LookoutforVision DeleteDataset \a response.
 */
...
/*!
 * \class QtAws::LookoutforVision::DeleteDatasetResponsePrivate
...
DeleteDatasetResponsePrivate::DeleteDatasetResponsePrivate(
    DeleteDatasetResponse * const q) : LookoutforVisionResponsePrivate(q)
{

}

/*!
 * Parses a LookoutforVision DeleteDataset response element from \a xml.
 */
