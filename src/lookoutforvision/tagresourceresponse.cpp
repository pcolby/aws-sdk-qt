...
/*!
 * \class QtAws::LookoutforVision::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for LookoutforVision TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : LookoutforVisionResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(LookoutforVisionResponse::request());
}

/*!
 * \reimp
 * Parses a successful LookoutforVision TagResource \a response.
 */
...
/*!
 * \class QtAws::LookoutforVision::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : LookoutforVisionResponsePrivate(q)
{

}

/*!
 * Parses a LookoutforVision TagResource response element from \a xml.
 */
