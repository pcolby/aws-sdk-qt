...
class QTAWS_EXPORT ListClusterOperationsResponsePrivate : public KafkaResponsePrivate {

public:

    ListClusterOperationsResponsePrivate(ListClusterOperationsResponse * const q);
