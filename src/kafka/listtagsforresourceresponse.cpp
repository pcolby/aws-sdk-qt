...
/*!
 * \class QtAws::Kafka::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Kafka ListTagsForResource responses.
 *
 * \inmodule QtAwsKafka
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : KafkaResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(KafkaResponse::request());
}

/*!
 * \reimp
 * Parses a successful Kafka ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Kafka::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : KafkaResponsePrivate(q)
{

}

/*!
 * Parses a Kafka ListTagsForResource response element from \a xml.
 */
