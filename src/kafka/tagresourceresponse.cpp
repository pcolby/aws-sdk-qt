...
/*!
 * \class QtAws::Kafka::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Kafka TagResource responses.
 *
 * \inmodule QtAwsKafka
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : KafkaResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(KafkaResponse::request());
}

/*!
 * \reimp
 * Parses a successful Kafka TagResource \a response.
 */
...
/*!
 * \class QtAws::Kafka::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : KafkaResponsePrivate(q)
{

}

/*!
 * Parses a Kafka TagResource response element from \a xml.
 */
