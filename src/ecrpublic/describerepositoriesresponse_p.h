...
class QTAWS_EXPORT DescribeRepositoriesResponsePrivate : public ECRPublicResponsePrivate {

public:

    DescribeRepositoriesResponsePrivate(DescribeRepositoriesResponse * const q);
