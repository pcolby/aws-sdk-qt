...
class QTAWS_EXPORT PutRepositoryCatalogDataResponsePrivate : public ECRPublicResponsePrivate {

public:

    PutRepositoryCatalogDataResponsePrivate(PutRepositoryCatalogDataResponse * const q);
