...
class QTAWS_EXPORT PutRegistryCatalogDataResponsePrivate : public ECRPublicResponsePrivate {

public:

    PutRegistryCatalogDataResponsePrivate(PutRegistryCatalogDataResponse * const q);
