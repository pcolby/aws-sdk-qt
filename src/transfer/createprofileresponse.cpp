...
/*!
 * \class QtAws::Transfer::CreateProfileResponse
 * \brief The CreateProfileResponse class provides an interace for Transfer CreateProfile responses.
 *
...
CreateProfileResponse::CreateProfileResponse(
    ...
    : TransferResponse(new CreateProfileResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Transfer CreateProfile \a response.
 */
...
/*!
 * \class QtAws::Transfer::CreateProfileResponsePrivate
...
CreateProfileResponsePrivate::CreateProfileResponsePrivate(
    CreateProfileResponse * const q) : TransferResponsePrivate(q)
{

}

/*!
 * Parses a Transfer CreateProfile response element from \a xml.
 */
