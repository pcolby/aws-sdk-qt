...
/*!
 * \class QtAws::Transfer::DescribeExecutionRequest
 * \brief The DescribeExecutionRequest class provides an interface for Transfer DescribeExecution requests.
 *
...
DescribeExecutionRequest::DescribeExecutionRequest(const DescribeExecutionRequest &other)
    : TransferRequest(new DescribeExecutionRequestPrivate(*other.d_func(), this))
{
...
DescribeExecutionRequest::DescribeExecutionRequest()
    : TransferRequest(new DescribeExecutionRequestPrivate(TransferRequest::DescribeExecutionAction, this))
{
...
/*!
 * \class QtAws::Transfer::DescribeExecutionRequestPrivate
...
/*!
 * Constructs a DescribeExecutionRequestPrivate object for Transfer \a action,
 * with public implementation \a q.
 */
DescribeExecutionRequestPrivate::DescribeExecutionRequestPrivate(
    const TransferRequest::Action action, DescribeExecutionRequest * const q)
