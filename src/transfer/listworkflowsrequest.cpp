...
/*!
 * \class QtAws::Transfer::ListWorkflowsRequest
 * \brief The ListWorkflowsRequest class provides an interface for Transfer ListWorkflows requests.
 *
...
ListWorkflowsRequest::ListWorkflowsRequest(const ListWorkflowsRequest &other)
    : TransferRequest(new ListWorkflowsRequestPrivate(*other.d_func(), this))
{
...
ListWorkflowsRequest::ListWorkflowsRequest()
    : TransferRequest(new ListWorkflowsRequestPrivate(TransferRequest::ListWorkflowsAction, this))
{
...
/*!
 * \class QtAws::Transfer::ListWorkflowsRequestPrivate
...
/*!
 * Constructs a ListWorkflowsRequestPrivate object for Transfer \a action,
 * with public implementation \a q.
 */
ListWorkflowsRequestPrivate::ListWorkflowsRequestPrivate(
    const TransferRequest::Action action, ListWorkflowsRequest * const q)
