...
/*!
 * \class QtAws::Transfer::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Transfer TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : TransferResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Transfer TagResource \a response.
 */
...
/*!
 * \class QtAws::Transfer::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : TransferResponsePrivate(q)
{

}

/*!
 * Parses a Transfer TagResource response element from \a xml.
 */
