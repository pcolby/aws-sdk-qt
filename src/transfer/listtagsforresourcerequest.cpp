...
/*!
 * \class QtAws::Transfer::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for Transfer ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : TransferRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : TransferRequest(new ListTagsForResourceRequestPrivate(TransferRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::Transfer::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for Transfer \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const TransferRequest::Action action, ListTagsForResourceRequest * const q)
