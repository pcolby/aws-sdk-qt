...
/*!
 * \class QtAws::Transfer::DeleteCertificateRequest
 * \brief The DeleteCertificateRequest class provides an interface for Transfer DeleteCertificate requests.
 *
...
DeleteCertificateRequest::DeleteCertificateRequest(const DeleteCertificateRequest &other)
    : TransferRequest(new DeleteCertificateRequestPrivate(*other.d_func(), this))
{
...
DeleteCertificateRequest::DeleteCertificateRequest()
    : TransferRequest(new DeleteCertificateRequestPrivate(TransferRequest::DeleteCertificateAction, this))
{
...
/*!
 * \class QtAws::Transfer::DeleteCertificateRequestPrivate
...
/*!
 * Constructs a DeleteCertificateRequestPrivate object for Transfer \a action,
 * with public implementation \a q.
 */
DeleteCertificateRequestPrivate::DeleteCertificateRequestPrivate(
    const TransferRequest::Action action, DeleteCertificateRequest * const q)
