...
class QTAWS_EXPORT RegisterScalableTargetResponse : public ApplicationAutoScalingResponse {
    Q_OBJECT
...
public:
    ...
    virtual const RegisterScalableTargetRequest * request() const override;
