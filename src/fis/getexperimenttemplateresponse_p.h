...
class QTAWS_EXPORT GetExperimentTemplateResponsePrivate : public FisResponsePrivate {

public:

    GetExperimentTemplateResponsePrivate(GetExperimentTemplateResponse * const q);
