...
class QTAWS_EXPORT ListWorkersWithQualificationTypeResponse : public MTurkResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListWorkersWithQualificationTypeRequest * request() const override;
