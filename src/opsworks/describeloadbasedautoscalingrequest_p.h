...
class QTAWS_EXPORT DescribeLoadBasedAutoScalingRequestPrivate : public OpsWorksPrivate {

public:
    DescribeLoadBasedAutoScalingRequestPrivate(const OpsWorks::Action action,
