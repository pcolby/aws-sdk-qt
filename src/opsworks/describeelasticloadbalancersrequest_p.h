...
class QTAWS_EXPORT DescribeElasticLoadBalancersRequestPrivate : public OpsWorksPrivate {

public:
    DescribeElasticLoadBalancersRequestPrivate(const OpsWorks::Action action,
