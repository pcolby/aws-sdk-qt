...
#include "describemyuserprofilerequest_p.h"
...
/*!
 * \class QtAws::OpsWorks::DescribeMyUserProfileRequest
 * \brief The DescribeMyUserProfileRequest class provides an interface for OpsWorks DescribeMyUserProfile requests.
 *
 ...
 *  12 as soon as
 *
 * \sa OpsWorksClient::describeMyUserProfile
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeMyUserProfileRequest::DescribeMyUserProfileRequest(const DescribeMyUserProfileRequest &other)
    : OpsWorksRequest(new DescribeMyUserProfileRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeMyUserProfileRequest object.
 */
DescribeMyUserProfileRequest::DescribeMyUserProfileRequest()
    : OpsWorksRequest(new DescribeMyUserProfileRequestPrivate(OpsWorksRequest::DescribeMyUserProfileAction, this))
{
 ...
 * \reimp
 */
bool DescribeMyUserProfileRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeMyUserProfileResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeMyUserProfileRequest::response(QNetworkReply * const reply) const
{
    return new DescribeMyUserProfileResponse(*this, reply);
}

/*!
 * \class QtAws::OpsWorks::DescribeMyUserProfileRequestPrivate
 * \brief The DescribeMyUserProfileRequestPrivate class provides private implementation for DescribeMyUserProfileRequest.
 * \internal
 *
 * \inmodule QtAwsOpsWorks
 */
...
/*!
 * Constructs a DescribeMyUserProfileRequestPrivate object for OpsWorks \a action,
 * with public implementation \a q.
 */
DescribeMyUserProfileRequestPrivate::DescribeMyUserProfileRequestPrivate(
    const OpsWorksRequest::Action action, DescribeMyUserProfileRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeMyUserProfileRequest
 * class' copy constructor.
 */
DescribeMyUserProfileRequestPrivate::DescribeMyUserProfileRequestPrivate(
    const DescribeMyUserProfileRequestPrivate &other, DescribeMyUserProfileRequest * const q)
