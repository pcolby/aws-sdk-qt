 ...
 *
 * \brief The AttachElasticLoadBalancerResponse class encapsulates OpsWorks AttachElasticLoadBalancer responses.
 *
 * \ingroup OpsWorks
 *
 ...
 *  12 as soon as
 *
 * \sa OpsWorksClient::attachElasticLoadBalancer
 */
...
{
    Q_D(AttachElasticLoadBalancerResponse);
