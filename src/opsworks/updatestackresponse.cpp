...
/*!
 * \class QtAws::OpsWorks::UpdateStackResponse
 * \brief The UpdateStackResponse class provides an interace for OpsWorks UpdateStack responses.
 *
...
{
    return static_cast<const UpdateStackRequest *>(OpsWorksResponse::request());
}

/*!
 * \reimp
 * Parses a successful OpsWorks UpdateStack \a response.
 */
...
/*!
 * \class QtAws::OpsWorks::UpdateStackResponsePrivate
...
UpdateStackResponsePrivate::UpdateStackResponsePrivate(
    UpdateStackResponse * const q) : OpsWorksResponsePrivate(q)
{

}

/*!
 * Parses a OpsWorks UpdateStack response element from \a xml.
 */
