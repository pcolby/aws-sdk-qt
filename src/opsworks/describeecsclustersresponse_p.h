...
class QTAWS_EXPORT DescribeEcsClustersResponsePrivate : public OpsWorksResponsePrivate {
    Q_OBJECT

public:

    DescribeEcsClustersResponsePrivate(DescribeEcsClustersResponse * const q);
