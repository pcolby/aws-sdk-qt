...
OpsWorksRequest::OpsWorksRequest(const Action action)
    : d_ptr(new OpsWorksRequestPrivate(action, this))
{
...
OpsWorksRequest::OpsWorksRequest(const OpsWorksRequest &other)
    : QtAws::Core::AwsAbstractRequest(*this),
      d_ptr(new OpsWorksRequestPrivate(*other.d_func(), this))
{
 ...
 */
OpsWorksRequest::OpsWorksRequest(OpsWorksRequestPrivate * const d) : d_ptr(d)
{
...
QString OpsWorksRequestPrivate::toString(const OpsWorksRequest::Action &action)
{
    ...
    switch (action) {
        ActionToString(AssignInstance);
        ActionToString(AssignVolume);
        ActionToString(AssociateElasticIp);
        ActionToString(AttachElasticLoadBalancer);
        ActionToString(CloneStack);
        ActionToString(CreateApp);
        ActionToString(CreateDeployment);
        ActionToString(CreateInstance);
        ActionToString(CreateLayer);
        ActionToString(CreateStack);
        ActionToString(CreateUserProfile);
        ActionToString(DeleteApp);
        ActionToString(DeleteInstance);
        ActionToString(DeleteLayer);
        ActionToString(DeleteStack);
        ActionToString(DeleteUserProfile);
        ActionToString(DeregisterEcsCluster);
        ActionToString(DeregisterElasticIp);
        ActionToString(DeregisterInstance);
        ActionToString(DeregisterRdsDbInstance);
        ActionToString(DeregisterVolume);
        ActionToString(DescribeAgentVersions);
        ActionToString(DescribeApps);
        ActionToString(DescribeCommands);
        ActionToString(DescribeDeployments);
        ActionToString(DescribeEcsClusters);
        ActionToString(DescribeElasticIps);
        ActionToString(DescribeElasticLoadBalancers);
        ActionToString(DescribeInstances);
        ActionToString(DescribeLayers);
        ActionToString(DescribeLoadBasedAutoScaling);
        ActionToString(DescribeMyUserProfile);
        ActionToString(DescribeOperatingSystems);
        ActionToString(DescribePermissions);
        ActionToString(DescribeRaidArrays);
        ActionToString(DescribeRdsDbInstances);
        ActionToString(DescribeServiceErrors);
        ActionToString(DescribeStackProvisioningParameters);
        ActionToString(DescribeStackSummary);
        ActionToString(DescribeStacks);
        ActionToString(DescribeTimeBasedAutoScaling);
        ActionToString(DescribeUserProfiles);
        ActionToString(DescribeVolumes);
        ActionToString(DetachElasticLoadBalancer);
        ActionToString(DisassociateElasticIp);
        ActionToString(GetHostnameSuggestion);
        ActionToString(GrantAccess);
        ActionToString(ListTags);
        ActionToString(RebootInstance);
        ActionToString(RegisterEcsCluster);
        ActionToString(RegisterElasticIp);
        ActionToString(RegisterInstance);
        ActionToString(RegisterRdsDbInstance);
        ActionToString(RegisterVolume);
        ActionToString(SetLoadBasedAutoScaling);
        ActionToString(SetPermission);
        ActionToString(SetTimeBasedAutoScaling);
        ActionToString(StartInstance);
        ActionToString(StartStack);
        ActionToString(StopInstance);
        ActionToString(StopStack);
        ActionToString(TagResource);
        ActionToString(UnassignInstance);
        ActionToString(UnassignVolume);
        ActionToString(UntagResource);
        ActionToString(UpdateApp);
        ActionToString(UpdateElasticIp);
        ActionToString(UpdateInstance);
        ActionToString(UpdateLayer);
        ActionToString(UpdateMyUserProfile);
        ActionToString(UpdateRdsDbInstance);
