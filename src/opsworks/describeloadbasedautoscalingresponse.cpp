 ...
 *
 * \brief The DescribeLoadBasedAutoScalingResponse class encapsulates OpsWorks DescribeLoadBasedAutoScaling responses.
 *
 * \ingroup OpsWorks
 *
 ...
 *  12 as soon as
 *
 * \sa OpsWorksClient::describeLoadBasedAutoScaling
 */
