...
/*!
 * \reimp
 * Parses a successful OpsWorks CreateStack \a response.
 */
...
/*!
 * \class QtAws::OpsWorks::CreateStackResponsePrivate
...
CreateStackResponsePrivate::CreateStackResponsePrivate(
    CreateStackResponse * const q) : OpsWorksResponsePrivate(q)
{

}

/*!
 * Parses a OpsWorks CreateStack response element from \a xml.
 */
