...
class DescribeRdsDbInstancesResponsePrivate : public OpsWorksResponsePrivate {

public:

    explicit DescribeRdsDbInstancesResponsePrivate(DescribeRdsDbInstancesResponse * const q);
