...
public slots:
    ...
    DescribeMyUserProfileResponse * describeMyUserProfile(const DescribeMyUserProfileRequest &request);
    DescribeMyUserProfileResponse * describeMyUserProfile();
    DescribeOperatingSystemsResponse * describeOperatingSystems(const DescribeOperatingSystemsRequest &request);
