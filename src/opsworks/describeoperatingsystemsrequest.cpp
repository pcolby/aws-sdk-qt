...
#include "describeoperatingsystemsrequest_p.h"
...
/*!
 * \class QtAws::OpsWorks::DescribeOperatingSystemsRequest
 * \brief The DescribeOperatingSystemsRequest class provides an interface for OpsWorks DescribeOperatingSystems requests.
 *
 ...
 *  12 as soon as
 *
 * \sa OpsWorksClient::describeOperatingSystems
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeOperatingSystemsRequest::DescribeOperatingSystemsRequest(const DescribeOperatingSystemsRequest &other)
    : OpsWorksRequest(new DescribeOperatingSystemsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeOperatingSystemsRequest object.
 */
DescribeOperatingSystemsRequest::DescribeOperatingSystemsRequest()
    : OpsWorksRequest(new DescribeOperatingSystemsRequestPrivate(OpsWorksRequest::DescribeOperatingSystemsAction, this))
{
 ...
 * \reimp
 */
bool DescribeOperatingSystemsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeOperatingSystemsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeOperatingSystemsRequest::response(QNetworkReply * const reply) const
{
    return new DescribeOperatingSystemsResponse(*this, reply);
}

/*!
 * \class QtAws::OpsWorks::DescribeOperatingSystemsRequestPrivate
 * \brief The DescribeOperatingSystemsRequestPrivate class provides private implementation for DescribeOperatingSystemsRequest.
 * \internal
 *
 * \inmodule QtAwsOpsWorks
 */
...
/*!
 * Constructs a DescribeOperatingSystemsRequestPrivate object for OpsWorks \a action,
 * with public implementation \a q.
 */
DescribeOperatingSystemsRequestPrivate::DescribeOperatingSystemsRequestPrivate(
    const OpsWorksRequest::Action action, DescribeOperatingSystemsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeOperatingSystemsRequest
 * class' copy constructor.
 */
DescribeOperatingSystemsRequestPrivate::DescribeOperatingSystemsRequestPrivate(
    const DescribeOperatingSystemsRequestPrivate &other, DescribeOperatingSystemsRequest * const q)
