...
class QTAWS_EXPORT MarketplaceMeteringResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {

public:

    MarketplaceMeteringResponsePrivate(MarketplaceMeteringResponse * const q);
