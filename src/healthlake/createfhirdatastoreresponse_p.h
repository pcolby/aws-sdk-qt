...
class QTAWS_EXPORT CreateFHIRDatastoreResponsePrivate : public HealthLakeResponsePrivate {

public:

    CreateFHIRDatastoreResponsePrivate(CreateFHIRDatastoreResponse * const q);
