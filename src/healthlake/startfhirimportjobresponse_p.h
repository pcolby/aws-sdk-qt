...
class QTAWS_EXPORT StartFHIRImportJobResponsePrivate : public HealthLakeResponsePrivate {

public:

    StartFHIRImportJobResponsePrivate(StartFHIRImportJobResponse * const q);
