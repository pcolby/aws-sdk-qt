...
/*!
 * \class QtAws::HealthLake::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for HealthLake TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : HealthLakeResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful HealthLake TagResource \a response.
 */
...
/*!
 * \class QtAws::HealthLake::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : HealthLakeResponsePrivate(q)
{

}

/*!
 * Parses a HealthLake TagResource response element from \a xml.
 */
