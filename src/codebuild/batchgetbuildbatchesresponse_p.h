...
class QTAWS_EXPORT BatchGetBuildBatchesResponsePrivate : public CodeBuildResponsePrivate {

public:

    BatchGetBuildBatchesResponsePrivate(BatchGetBuildBatchesResponse * const q);
