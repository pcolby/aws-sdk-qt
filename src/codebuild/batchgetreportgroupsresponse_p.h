...
class QTAWS_EXPORT BatchGetReportGroupsResponsePrivate : public CodeBuildResponsePrivate {

public:

    BatchGetReportGroupsResponsePrivate(BatchGetReportGroupsResponse * const q);
