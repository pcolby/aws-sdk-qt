...
class QTAWS_EXPORT DescribeBrokerInstanceOptionsResponsePrivate : public MqResponsePrivate {

public:

    DescribeBrokerInstanceOptionsResponsePrivate(DescribeBrokerInstanceOptionsResponse * const q);
