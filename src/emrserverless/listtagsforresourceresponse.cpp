...
/*!
 * \class QtAws::EmrServerless::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for EmrServerless ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : EmrServerlessResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful EmrServerless ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::EmrServerless::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : EmrServerlessResponsePrivate(q)
{

}

/*!
 * Parses a EmrServerless ListTagsForResource response element from \a xml.
 */
