...
/*!
 * \class QtAws::EmrServerless::ListApplicationsRequest
 * \brief The ListApplicationsRequest class provides an interface for EmrServerless ListApplications requests.
 *
...
ListApplicationsRequest::ListApplicationsRequest(const ListApplicationsRequest &other)
    : EmrServerlessRequest(new ListApplicationsRequestPrivate(*other.d_func(), this))
{
...
ListApplicationsRequest::ListApplicationsRequest()
    : EmrServerlessRequest(new ListApplicationsRequestPrivate(EmrServerlessRequest::ListApplicationsAction, this))
{
...
/*!
 * \class QtAws::EmrServerless::ListApplicationsRequestPrivate
...
/*!
 * Constructs a ListApplicationsRequestPrivate object for EmrServerless \a action,
 * with public implementation \a q.
 */
ListApplicationsRequestPrivate::ListApplicationsRequestPrivate(
    const EmrServerlessRequest::Action action, ListApplicationsRequest * const q)
