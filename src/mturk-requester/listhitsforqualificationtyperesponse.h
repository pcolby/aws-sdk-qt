...
class QTAWS_EXPORT ListHITsForQualificationTypeResponse : public ListHITsForQualificationTypeResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListHITsForQualificationTypeRequest * request() const;
