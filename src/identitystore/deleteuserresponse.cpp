...
/*!
 * \class QtAws::IdentityStore::DeleteUserResponse
 * \brief The DeleteUserResponse class provides an interace for IdentityStore DeleteUser responses.
 *
...
DeleteUserResponse::DeleteUserResponse(
    ...
    : IdentityStoreResponse(new DeleteUserResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IdentityStore DeleteUser \a response.
 */
...
/*!
 * \class QtAws::IdentityStore::DeleteUserResponsePrivate
...
DeleteUserResponsePrivate::DeleteUserResponsePrivate(
    DeleteUserResponse * const q) : IdentityStoreResponsePrivate(q)
{

}

/*!
 * Parses a IdentityStore DeleteUser response element from \a xml.
 */
