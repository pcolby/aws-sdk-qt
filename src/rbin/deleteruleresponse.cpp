...
/*!
 * \class QtAws::Rbin::DeleteRuleResponse
 * \brief The DeleteRuleResponse class provides an interace for Rbin DeleteRule responses.
 *
 * \inmodule QtAwsRbin
 *
...
DeleteRuleResponse::DeleteRuleResponse(
    ...
    : RbinResponse(new DeleteRuleResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Rbin DeleteRule \a response.
 */
...
/*!
 * \class QtAws::Rbin::DeleteRuleResponsePrivate
...
DeleteRuleResponsePrivate::DeleteRuleResponsePrivate(
    DeleteRuleResponse * const q) : RbinResponsePrivate(q)
{

}

/*!
 * Parses a Rbin DeleteRule response element from \a xml.
 */
