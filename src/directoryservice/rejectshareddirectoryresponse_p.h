...
class QTAWS_EXPORT RejectSharedDirectoryResponsePrivate : public DirectoryServiceResponsePrivate {

public:

    RejectSharedDirectoryResponsePrivate(RejectSharedDirectoryResponse * const q);
