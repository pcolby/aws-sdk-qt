...
class QTAWS_EXPORT DescribeConditionalForwardersResponse : public DirectoryServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeConditionalForwardersRequest * request() const override;
