...
/*!
 * \class QtAws::DirectoryService::ListCertificatesRequest
 * \brief The ListCertificatesRequest class provides an interface for DirectoryService ListCertificates requests.
 *
...
ListCertificatesRequest::ListCertificatesRequest(const ListCertificatesRequest &other)
    : DirectoryServiceRequest(new ListCertificatesRequestPrivate(*other.d_func(), this))
{
...
ListCertificatesRequest::ListCertificatesRequest()
    : DirectoryServiceRequest(new ListCertificatesRequestPrivate(DirectoryServiceRequest::ListCertificatesAction, this))
{
...
/*!
 * \class QtAws::DirectoryService::ListCertificatesRequestPrivate
...
/*!
 * Constructs a ListCertificatesRequestPrivate object for DirectoryService \a action,
 * with public implementation \a q.
 */
ListCertificatesRequestPrivate::ListCertificatesRequestPrivate(
    const DirectoryServiceRequest::Action action, ListCertificatesRequest * const q)
