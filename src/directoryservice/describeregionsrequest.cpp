...
/*!
 * \class QtAws::DirectoryService::DescribeRegionsRequest
 * \brief The DescribeRegionsRequest class provides an interface for DirectoryService DescribeRegions requests.
 *
...
DescribeRegionsRequest::DescribeRegionsRequest(const DescribeRegionsRequest &other)
    : DirectoryServiceRequest(new DescribeRegionsRequestPrivate(*other.d_func(), this))
{
...
DescribeRegionsRequest::DescribeRegionsRequest()
    : DirectoryServiceRequest(new DescribeRegionsRequestPrivate(DirectoryServiceRequest::DescribeRegionsAction, this))
{
...
/*!
 * \class QtAws::DirectoryService::DescribeRegionsRequestPrivate
...
/*!
 * Constructs a DescribeRegionsRequestPrivate object for DirectoryService \a action,
 * with public implementation \a q.
 */
DescribeRegionsRequestPrivate::DescribeRegionsRequestPrivate(
    const DirectoryServiceRequest::Action action, DescribeRegionsRequest * const q)
