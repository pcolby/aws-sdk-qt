...
class QTAWS_EXPORT ListCertificatesResponsePrivate : public DirectoryServiceResponsePrivate {

public:

    ListCertificatesResponsePrivate(ListCertificatesResponse * const q);
