...
public slots:
    ...
    DescribeClientAuthenticationSettingsResponse * describeClientAuthenticationSettings(const DescribeClientAuthenticationSettingsRequest &request);
    ...
    DescribeSettingsResponse * describeSettings(const DescribeSettingsRequest &request);
