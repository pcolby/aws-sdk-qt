...
class QTAWS_EXPORT RemoveAllResourcePermissionsRequestPrivate : public WorkDocsPrivate {

public:
    RemoveAllResourcePermissionsRequestPrivate(const WorkDocs::Action action,
