...
class QTAWS_EXPORT CreateNotificationSubscriptionResponse : public WorkDocsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateNotificationSubscriptionRequest * request() const override;
