 ...
 */
DescribeNotificationSubscriptionsResponse::{OperationName}}Response(
 ...
 */
void DescribeNotificationSubscriptionsResponsePrivate::DescribeNotificationSubscriptionsResponse(QXmlStreamReader &xml)
{
