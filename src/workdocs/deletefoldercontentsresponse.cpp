 ...
 *
 * \brief The DeleteFolderContentsResponse class encapsulates WorkDocs DeleteFolderContents responses.
 *
 * \ingroup WorkDocs
 *
...
/*!
 * @brief  Constructs a new DeleteFolderContentsResponse object.
 *
