 ...
 *
 * \brief The CreateNotificationSubscriptionRequest class encapsulates WorkDocs CreateNotificationSubscription requests.
 *
 * \ingroup WorkDocs
 *
 ...
 *
 * \sa WorkDocsClient::createNotificationSubscription
 */
