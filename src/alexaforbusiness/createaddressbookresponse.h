...
class QTAWSALEXAFORBUSINESS_EXPORT CreateAddressBookResponse : public AlexaForBusinessResponse {
    Q_OBJECT

public:
    CreateAddressBookResponse(const CreateAddressBookRequest &request, QNetworkReply * const reply, QObject * const parent = 0);

    virtual const CreateAddressBookRequest * request() const Q_DECL_OVERRIDE;
