...
class QTAWS_EXPORT ListGatewayGroupsResponsePrivate : public AlexaForBusinessResponsePrivate {

public:

    ListGatewayGroupsResponsePrivate(ListGatewayGroupsResponse * const q);
