...
class QTAWS_EXPORT SearchAddressBooksResponsePrivate : public AlexaForBusinessResponsePrivate {
    Q_OBJECT

public:

    SearchAddressBooksResponsePrivate(SearchAddressBooksResponse * const q);
