...
class QTAWS_EXPORT ListSkillsStoreCategoriesResponsePrivate : public AlexaForBusinessResponsePrivate {

public:

    ListSkillsStoreCategoriesResponsePrivate(ListSkillsStoreCategoriesResponse * const q);
