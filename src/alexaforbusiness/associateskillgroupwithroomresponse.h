...
class QTAWS_EXPORT AssociateSkillGroupWithRoomResponse : public AlexaForBusinessResponse {
    Q_OBJECT
...
public:
    ...
    virtual const AssociateSkillGroupWithRoomRequest * request() const override;
