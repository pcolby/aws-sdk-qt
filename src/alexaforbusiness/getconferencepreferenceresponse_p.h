...
class QTAWS_EXPORT GetConferencePreferenceResponsePrivate : public AlexaForBusinessResponsePrivate {

public:

    GetConferencePreferenceResponsePrivate(GetConferencePreferenceResponse * const q);
