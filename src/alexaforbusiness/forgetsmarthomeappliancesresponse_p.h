...
class QTAWS_EXPORT ForgetSmartHomeAppliancesResponsePrivate : public AlexaForBusinessResponsePrivate {

public:

    ForgetSmartHomeAppliancesResponsePrivate(ForgetSmartHomeAppliancesResponse * const q);
