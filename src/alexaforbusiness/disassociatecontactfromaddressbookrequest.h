...
#ifndef QTAWS_DISASSOCIATECONTACTFROMADDRESSBOOKREQUEST_H
#define QTAWS_DISASSOCIATECONTACTFROMADDRESSBOOKREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(DisassociateContactFromAddressBookRequest)
