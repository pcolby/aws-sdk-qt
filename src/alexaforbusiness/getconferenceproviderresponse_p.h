...
class QTAWS_EXPORT GetConferenceProviderResponsePrivate : public AlexaForBusinessResponsePrivate {

public:

    GetConferenceProviderResponsePrivate(GetConferenceProviderResponse * const q);
