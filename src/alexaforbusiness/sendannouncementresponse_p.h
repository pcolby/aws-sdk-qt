...
class QTAWS_EXPORT SendAnnouncementResponsePrivate : public AlexaForBusinessResponsePrivate {

public:

    SendAnnouncementResponsePrivate(SendAnnouncementResponse * const q);
