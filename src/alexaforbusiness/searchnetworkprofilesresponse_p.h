...
class QTAWS_EXPORT SearchNetworkProfilesResponsePrivate : public AlexaForBusinessResponsePrivate {

public:

    SearchNetworkProfilesResponsePrivate(SearchNetworkProfilesResponse * const q);
