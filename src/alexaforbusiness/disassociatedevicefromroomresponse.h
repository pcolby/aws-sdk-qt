...
class QTAWS_EXPORT DisassociateDeviceFromRoomResponse : public AlexaForBusinessResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DisassociateDeviceFromRoomRequest * request() const override;
