...
class QTAWS_EXPORT DisassociateDeviceFromRoomResponse : public DisassociateDeviceFromRoomResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DisassociateDeviceFromRoomRequest * request() const;
