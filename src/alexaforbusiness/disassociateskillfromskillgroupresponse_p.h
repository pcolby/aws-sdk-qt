...
class QTAWS_EXPORT DisassociateSkillFromSkillGroupResponsePrivate : public AlexaForBusinessResponsePrivate {

public:

    DisassociateSkillFromSkillGroupResponsePrivate(DisassociateSkillFromSkillGroupResponse * const q);
