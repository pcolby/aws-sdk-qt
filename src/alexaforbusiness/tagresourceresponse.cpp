 ...
 *
 * @brief  Handles AlexaForBusiness TagResource responses.
 *
 * @see    AlexaForBusinessClient::tagResource
 */
...
/**
 * @brief  Parse a AlexaForBusiness TagResource response.
 *
...
/**
 * @brief  Parse an AlexaForBusiness TagResourceResponse element.
 *
