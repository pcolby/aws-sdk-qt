 ...
 *  organization.
 *
 * \sa AlexaForBusinessClient::tagResource
 */
...
TagResourceResponse::TagResourceResponse(
    ...
    : AlexaForBusinessResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(AlexaForBusinessResponse::request());
}

/*!
 * \reimp
 * Parses a successful AlexaForBusiness TagResource \a response.
 */
...
/*!
 * \class QtAws::AlexaForBusiness::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : AlexaForBusinessResponsePrivate(q)
{

}

/*!
 * Parses a AlexaForBusiness TagResource response element from \a xml.
 */
