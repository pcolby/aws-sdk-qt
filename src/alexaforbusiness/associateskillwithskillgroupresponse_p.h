...
class QTAWS_EXPORT AssociateSkillWithSkillGroupResponsePrivate : public AlexaForBusinessResponsePrivate {

public:

    AssociateSkillWithSkillGroupResponsePrivate(AssociateSkillWithSkillGroupResponse * const q);
