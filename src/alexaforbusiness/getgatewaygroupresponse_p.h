...
class QTAWS_EXPORT GetGatewayGroupResponsePrivate : public AlexaForBusinessResponsePrivate {

public:

    GetGatewayGroupResponsePrivate(GetGatewayGroupResponse * const q);
