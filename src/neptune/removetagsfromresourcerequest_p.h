...
class QTAWS_EXPORT RemoveTagsFromResourceRequestPrivate : public NeptuneRequestPrivate {

public:
    RemoveTagsFromResourceRequestPrivate(const NeptuneRequest::Action action,
