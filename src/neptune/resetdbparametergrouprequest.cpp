...
/*!
 * \class QtAws::Neptune::ResetDBParameterGroupRequest
 * \brief The ResetDBParameterGroupRequest class provides an interface for Neptune ResetDBParameterGroup requests.
 *
...
ResetDBParameterGroupRequest::ResetDBParameterGroupRequest(const ResetDBParameterGroupRequest &other)
    : NeptuneRequest(new ResetDBParameterGroupRequestPrivate(*other.d_func(), this))
{
...
ResetDBParameterGroupRequest::ResetDBParameterGroupRequest()
    : NeptuneRequest(new ResetDBParameterGroupRequestPrivate(NeptuneRequest::ResetDBParameterGroupAction, this))
{
...
/*!
 * \class QtAws::Neptune::ResetDBParameterGroupRequestPrivate
...
/*!
 * Constructs a ResetDBParameterGroupRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
ResetDBParameterGroupRequestPrivate::ResetDBParameterGroupRequestPrivate(
    const NeptuneRequest::Action action, ResetDBParameterGroupRequest * const q)
