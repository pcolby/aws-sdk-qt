...
/*!
 * \class QtAws::Neptune::DeleteDBInstanceRequest
 * \brief The DeleteDBInstanceRequest class provides an interface for Neptune DeleteDBInstance requests.
 *
...
DeleteDBInstanceRequest::DeleteDBInstanceRequest(const DeleteDBInstanceRequest &other)
    : NeptuneRequest(new DeleteDBInstanceRequestPrivate(*other.d_func(), this))
{
...
DeleteDBInstanceRequest::DeleteDBInstanceRequest()
    : NeptuneRequest(new DeleteDBInstanceRequestPrivate(NeptuneRequest::DeleteDBInstanceAction, this))
{
...
/*!
 * \class QtAws::Neptune::DeleteDBInstanceRequestPrivate
...
/*!
 * Constructs a DeleteDBInstanceRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
DeleteDBInstanceRequestPrivate::DeleteDBInstanceRequestPrivate(
    const NeptuneRequest::Action action, DeleteDBInstanceRequest * const q)
