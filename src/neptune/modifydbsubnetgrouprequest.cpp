...
/*!
 * \class QtAws::Neptune::ModifyDBSubnetGroupRequest
 * \brief The ModifyDBSubnetGroupRequest class provides an interface for Neptune ModifyDBSubnetGroup requests.
 *
...
ModifyDBSubnetGroupRequest::ModifyDBSubnetGroupRequest(const ModifyDBSubnetGroupRequest &other)
    : NeptuneRequest(new ModifyDBSubnetGroupRequestPrivate(*other.d_func(), this))
{
...
ModifyDBSubnetGroupRequest::ModifyDBSubnetGroupRequest()
    : NeptuneRequest(new ModifyDBSubnetGroupRequestPrivate(NeptuneRequest::ModifyDBSubnetGroupAction, this))
{
...
/*!
 * \class QtAws::Neptune::ModifyDBSubnetGroupRequestPrivate
...
/*!
 * Constructs a ModifyDBSubnetGroupRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
ModifyDBSubnetGroupRequestPrivate::ModifyDBSubnetGroupRequestPrivate(
    const NeptuneRequest::Action action, ModifyDBSubnetGroupRequest * const q)
