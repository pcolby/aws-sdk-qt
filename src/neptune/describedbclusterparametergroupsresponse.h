...
class QTAWS_EXPORT DescribeDBClusterParameterGroupsResponse : public NeptuneResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeDBClusterParameterGroupsRequest * request() const override;
