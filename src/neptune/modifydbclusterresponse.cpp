...
/*!
 * \class QtAws::Neptune::ModifyDBClusterResponse
 * \brief The ModifyDBClusterResponse class provides an interace for Neptune ModifyDBCluster responses.
 *
...
ModifyDBClusterResponse::ModifyDBClusterResponse(
    ...
    : NeptuneResponse(new ModifyDBClusterResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Neptune ModifyDBCluster \a response.
 */
...
/*!
 * \class QtAws::Neptune::ModifyDBClusterResponsePrivate
...
ModifyDBClusterResponsePrivate::ModifyDBClusterResponsePrivate(
    ModifyDBClusterResponse * const q) : NeptuneResponsePrivate(q)
{

}

/*!
 * Parses a Neptune ModifyDBCluster response element from \a xml.
 */
