...
/*!
 * \class QtAws::Neptune::DescribeValidDBInstanceModificationsRequest
 * \brief The DescribeValidDBInstanceModificationsRequest class provides an interface for Neptune DescribeValidDBInstanceModifications requests.
 *
...
DescribeValidDBInstanceModificationsRequest::DescribeValidDBInstanceModificationsRequest(const DescribeValidDBInstanceModificationsRequest &other)
    : NeptuneRequest(new DescribeValidDBInstanceModificationsRequestPrivate(*other.d_func(), this))
{
...
DescribeValidDBInstanceModificationsRequest::DescribeValidDBInstanceModificationsRequest()
    : NeptuneRequest(new DescribeValidDBInstanceModificationsRequestPrivate(NeptuneRequest::DescribeValidDBInstanceModificationsAction, this))
{
...
/*!
 * \class QtAws::Neptune::DescribeValidDBInstanceModificationsRequestPrivate
...
/*!
 * Constructs a DescribeValidDBInstanceModificationsRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
DescribeValidDBInstanceModificationsRequestPrivate::DescribeValidDBInstanceModificationsRequestPrivate(
    const NeptuneRequest::Action action, DescribeValidDBInstanceModificationsRequest * const q)
