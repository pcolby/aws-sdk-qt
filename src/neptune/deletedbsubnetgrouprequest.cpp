...
/*!
 * \class QtAws::Neptune::DeleteDBSubnetGroupRequest
 * \brief The DeleteDBSubnetGroupRequest class provides an interface for Neptune DeleteDBSubnetGroup requests.
 *
...
DeleteDBSubnetGroupRequest::DeleteDBSubnetGroupRequest(const DeleteDBSubnetGroupRequest &other)
    : NeptuneRequest(new DeleteDBSubnetGroupRequestPrivate(*other.d_func(), this))
{
...
DeleteDBSubnetGroupRequest::DeleteDBSubnetGroupRequest()
    : NeptuneRequest(new DeleteDBSubnetGroupRequestPrivate(NeptuneRequest::DeleteDBSubnetGroupAction, this))
{
...
/*!
 * \class QtAws::Neptune::DeleteDBSubnetGroupRequestPrivate
...
/*!
 * Constructs a DeleteDBSubnetGroupRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
DeleteDBSubnetGroupRequestPrivate::DeleteDBSubnetGroupRequestPrivate(
    const NeptuneRequest::Action action, DeleteDBSubnetGroupRequest * const q)
