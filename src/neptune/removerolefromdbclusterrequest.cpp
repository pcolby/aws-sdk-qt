...
/*!
 * \class QtAws::Neptune::RemoveRoleFromDBClusterRequest
 * \brief The RemoveRoleFromDBClusterRequest class provides an interface for Neptune RemoveRoleFromDBCluster requests.
 *
...
RemoveRoleFromDBClusterRequest::RemoveRoleFromDBClusterRequest(const RemoveRoleFromDBClusterRequest &other)
    : NeptuneRequest(new RemoveRoleFromDBClusterRequestPrivate(*other.d_func(), this))
{
...
RemoveRoleFromDBClusterRequest::RemoveRoleFromDBClusterRequest()
    : NeptuneRequest(new RemoveRoleFromDBClusterRequestPrivate(NeptuneRequest::RemoveRoleFromDBClusterAction, this))
{
...
/*!
 * \class QtAws::Neptune::RemoveRoleFromDBClusterRequestPrivate
...
/*!
 * Constructs a RemoveRoleFromDBClusterRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
RemoveRoleFromDBClusterRequestPrivate::RemoveRoleFromDBClusterRequestPrivate(
    const NeptuneRequest::Action action, RemoveRoleFromDBClusterRequest * const q)
