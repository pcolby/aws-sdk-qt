...
/*!
 * \class QtAws::Neptune::CreateDBClusterRequest
 * \brief The CreateDBClusterRequest class provides an interface for Neptune CreateDBCluster requests.
 *
 ...
 *
 * \sa NeptuneClient::createDBCluster
 */
...
CreateDBClusterRequest::CreateDBClusterRequest(const CreateDBClusterRequest &other)
    : NeptuneRequest(new CreateDBClusterRequestPrivate(*other.d_func(), this))
{
...
CreateDBClusterRequest::CreateDBClusterRequest()
    : NeptuneRequest(new CreateDBClusterRequestPrivate(NeptuneRequest::CreateDBClusterAction, this))
{
...
/*!
 * \class QtAws::Neptune::CreateDBClusterRequestPrivate
...
/*!
 * Constructs a CreateDBClusterRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
CreateDBClusterRequestPrivate::CreateDBClusterRequestPrivate(
    const NeptuneRequest::Action action, CreateDBClusterRequest * const q)
