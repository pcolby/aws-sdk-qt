...
/*!
 * \class QtAws::Neptune::StopDBClusterResponse
 * \brief The StopDBClusterResponse class provides an interace for Neptune StopDBCluster responses.
 *
...
StopDBClusterResponse::StopDBClusterResponse(
    ...
    : NeptuneResponse(new StopDBClusterResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Neptune StopDBCluster \a response.
 */
...
/*!
 * \class QtAws::Neptune::StopDBClusterResponsePrivate
...
StopDBClusterResponsePrivate::StopDBClusterResponsePrivate(
    StopDBClusterResponse * const q) : NeptuneResponsePrivate(q)
{

}

/*!
 * Parses a Neptune StopDBCluster response element from \a xml.
 */
