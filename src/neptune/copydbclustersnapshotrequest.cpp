...
/*!
 * \class QtAws::Neptune::CopyDBClusterSnapshotRequest
 * \brief The CopyDBClusterSnapshotRequest class provides an interface for Neptune CopyDBClusterSnapshot requests.
 *
...
CopyDBClusterSnapshotRequest::CopyDBClusterSnapshotRequest(const CopyDBClusterSnapshotRequest &other)
    : NeptuneRequest(new CopyDBClusterSnapshotRequestPrivate(*other.d_func(), this))
{
...
CopyDBClusterSnapshotRequest::CopyDBClusterSnapshotRequest()
    : NeptuneRequest(new CopyDBClusterSnapshotRequestPrivate(NeptuneRequest::CopyDBClusterSnapshotAction, this))
{
...
/*!
 * \class QtAws::Neptune::CopyDBClusterSnapshotRequestPrivate
...
/*!
 * Constructs a CopyDBClusterSnapshotRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
CopyDBClusterSnapshotRequestPrivate::CopyDBClusterSnapshotRequestPrivate(
    const NeptuneRequest::Action action, CopyDBClusterSnapshotRequest * const q)
