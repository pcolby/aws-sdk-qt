...
/*!
 * \class QtAws::Neptune::AddTagsToResourceRequest
 * \brief The AddTagsToResourceRequest class provides an interface for Neptune AddTagsToResource requests.
 *
...
AddTagsToResourceRequest::AddTagsToResourceRequest(const AddTagsToResourceRequest &other)
    : NeptuneRequest(new AddTagsToResourceRequestPrivate(*other.d_func(), this))
{
...
AddTagsToResourceRequest::AddTagsToResourceRequest()
    : NeptuneRequest(new AddTagsToResourceRequestPrivate(NeptuneRequest::AddTagsToResourceAction, this))
{
...
/*!
 * \class QtAws::Neptune::AddTagsToResourceRequestPrivate
...
/*!
 * Constructs a AddTagsToResourceRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
AddTagsToResourceRequestPrivate::AddTagsToResourceRequestPrivate(
    const NeptuneRequest::Action action, AddTagsToResourceRequest * const q)
