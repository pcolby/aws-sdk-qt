...
/*!
 * \class QtAws::Neptune::DescribeEngineDefaultParametersResponse
 * \brief The DescribeEngineDefaultParametersResponse class provides an interace for Neptune DescribeEngineDefaultParameters responses.
 *
...
DescribeEngineDefaultParametersResponse::DescribeEngineDefaultParametersResponse(
    ...
    : NeptuneResponse(new DescribeEngineDefaultParametersResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Neptune DescribeEngineDefaultParameters \a response.
 */
...
/*!
 * \class QtAws::Neptune::DescribeEngineDefaultParametersResponsePrivate
...
DescribeEngineDefaultParametersResponsePrivate::DescribeEngineDefaultParametersResponsePrivate(
    DescribeEngineDefaultParametersResponse * const q) : NeptuneResponsePrivate(q)
{

}

/*!
 * Parses a Neptune DescribeEngineDefaultParameters response element from \a xml.
 */
