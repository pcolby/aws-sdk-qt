...
/*!
 * \class QtAws::Neptune::DescribeEventsResponse
 * \brief The DescribeEventsResponse class provides an interace for Neptune DescribeEvents responses.
 *
 ...
 *
 * \sa NeptuneClient::describeEvents
 */
...
DescribeEventsResponse::DescribeEventsResponse(
    ...
    : NeptuneResponse(new DescribeEventsResponsePrivate(this), parent)
{
...
{
    return static_cast<const DescribeEventsRequest *>(NeptuneResponse::request());
}

/*!
 * \reimp
 * Parses a successful Neptune DescribeEvents \a response.
 */
...
/*!
 * \class QtAws::Neptune::DescribeEventsResponsePrivate
...
DescribeEventsResponsePrivate::DescribeEventsResponsePrivate(
    DescribeEventsResponse * const q) : NeptuneResponsePrivate(q)
{

}

/*!
 * Parses a Neptune DescribeEvents response element from \a xml.
 */
