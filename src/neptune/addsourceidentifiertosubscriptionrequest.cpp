...
/*!
 * \class QtAws::Neptune::AddSourceIdentifierToSubscriptionRequest
 * \brief The AddSourceIdentifierToSubscriptionRequest class provides an interface for Neptune AddSourceIdentifierToSubscription requests.
 *
...
AddSourceIdentifierToSubscriptionRequest::AddSourceIdentifierToSubscriptionRequest(const AddSourceIdentifierToSubscriptionRequest &other)
    : NeptuneRequest(new AddSourceIdentifierToSubscriptionRequestPrivate(*other.d_func(), this))
{
...
AddSourceIdentifierToSubscriptionRequest::AddSourceIdentifierToSubscriptionRequest()
    : NeptuneRequest(new AddSourceIdentifierToSubscriptionRequestPrivate(NeptuneRequest::AddSourceIdentifierToSubscriptionAction, this))
{
...
/*!
 * \class QtAws::Neptune::AddSourceIdentifierToSubscriptionRequestPrivate
...
/*!
 * Constructs a AddSourceIdentifierToSubscriptionRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
AddSourceIdentifierToSubscriptionRequestPrivate::AddSourceIdentifierToSubscriptionRequestPrivate(
    const NeptuneRequest::Action action, AddSourceIdentifierToSubscriptionRequest * const q)
