...
class QTAWS_EXPORT DescribeOrderableDBInstanceOptionsResponse : public NeptuneResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeOrderableDBInstanceOptionsRequest * request() const override;
