...
/*!
 * \class QtAws::Neptune::ApplyPendingMaintenanceActionResponse
 * \brief The ApplyPendingMaintenanceActionResponse class provides an interace for Neptune ApplyPendingMaintenanceAction responses.
 *
...
ApplyPendingMaintenanceActionResponse::ApplyPendingMaintenanceActionResponse(
    ...
    : NeptuneResponse(new ApplyPendingMaintenanceActionResponsePrivate(this), parent)
{
...
{
    return static_cast<const ApplyPendingMaintenanceActionRequest *>(NeptuneResponse::request());
}

/*!
 * \reimp
 * Parses a successful Neptune ApplyPendingMaintenanceAction \a response.
 */
...
/*!
 * \class QtAws::Neptune::ApplyPendingMaintenanceActionResponsePrivate
...
ApplyPendingMaintenanceActionResponsePrivate::ApplyPendingMaintenanceActionResponsePrivate(
    ApplyPendingMaintenanceActionResponse * const q) : NeptuneResponsePrivate(q)
{

}

/*!
 * Parses a Neptune ApplyPendingMaintenanceAction response element from \a xml.
 */
