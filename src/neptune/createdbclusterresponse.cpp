...
/*!
 * \class QtAws::Neptune::CreateDBClusterResponse
 * \brief The CreateDBClusterResponse class provides an interace for Neptune CreateDBCluster responses.
 *
...
CreateDBClusterResponse::CreateDBClusterResponse(
    ...
    : NeptuneResponse(new CreateDBClusterResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Neptune CreateDBCluster \a response.
 */
...
/*!
 * \class QtAws::Neptune::CreateDBClusterResponsePrivate
...
CreateDBClusterResponsePrivate::CreateDBClusterResponsePrivate(
    CreateDBClusterResponse * const q) : NeptuneResponsePrivate(q)
{

}

/*!
 * Parses a Neptune CreateDBCluster response element from \a xml.
 */
