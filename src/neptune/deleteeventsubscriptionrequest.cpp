...
/*!
 * \class QtAws::Neptune::DeleteEventSubscriptionRequest
 * \brief The DeleteEventSubscriptionRequest class provides an interface for Neptune DeleteEventSubscription requests.
 *
...
DeleteEventSubscriptionRequest::DeleteEventSubscriptionRequest(const DeleteEventSubscriptionRequest &other)
    : NeptuneRequest(new DeleteEventSubscriptionRequestPrivate(*other.d_func(), this))
{
...
DeleteEventSubscriptionRequest::DeleteEventSubscriptionRequest()
    : NeptuneRequest(new DeleteEventSubscriptionRequestPrivate(NeptuneRequest::DeleteEventSubscriptionAction, this))
{
...
/*!
 * \class QtAws::Neptune::DeleteEventSubscriptionRequestPrivate
...
/*!
 * Constructs a DeleteEventSubscriptionRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
DeleteEventSubscriptionRequestPrivate::DeleteEventSubscriptionRequestPrivate(
    const NeptuneRequest::Action action, DeleteEventSubscriptionRequest * const q)
