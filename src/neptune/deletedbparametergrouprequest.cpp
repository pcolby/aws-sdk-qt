...
/*!
 * \class QtAws::Neptune::DeleteDBParameterGroupRequest
 * \brief The DeleteDBParameterGroupRequest class provides an interface for Neptune DeleteDBParameterGroup requests.
 *
...
DeleteDBParameterGroupRequest::DeleteDBParameterGroupRequest(const DeleteDBParameterGroupRequest &other)
    : NeptuneRequest(new DeleteDBParameterGroupRequestPrivate(*other.d_func(), this))
{
...
DeleteDBParameterGroupRequest::DeleteDBParameterGroupRequest()
    : NeptuneRequest(new DeleteDBParameterGroupRequestPrivate(NeptuneRequest::DeleteDBParameterGroupAction, this))
{
...
/*!
 * \class QtAws::Neptune::DeleteDBParameterGroupRequestPrivate
...
/*!
 * Constructs a DeleteDBParameterGroupRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
DeleteDBParameterGroupRequestPrivate::DeleteDBParameterGroupRequestPrivate(
    const NeptuneRequest::Action action, DeleteDBParameterGroupRequest * const q)
