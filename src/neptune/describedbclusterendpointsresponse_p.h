...
class QTAWS_EXPORT DescribeDBClusterEndpointsResponsePrivate : public NeptuneResponsePrivate {

public:

    DescribeDBClusterEndpointsResponsePrivate(DescribeDBClusterEndpointsResponse * const q);
