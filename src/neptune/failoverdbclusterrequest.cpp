...
/*!
 * \class QtAws::Neptune::FailoverDBClusterRequest
 * \brief The FailoverDBClusterRequest class provides an interface for Neptune FailoverDBCluster requests.
 *
...
FailoverDBClusterRequest::FailoverDBClusterRequest(const FailoverDBClusterRequest &other)
    : NeptuneRequest(new FailoverDBClusterRequestPrivate(*other.d_func(), this))
{
...
FailoverDBClusterRequest::FailoverDBClusterRequest()
    : NeptuneRequest(new FailoverDBClusterRequestPrivate(NeptuneRequest::FailoverDBClusterAction, this))
{
...
/*!
 * \class QtAws::Neptune::FailoverDBClusterRequestPrivate
...
/*!
 * Constructs a FailoverDBClusterRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
FailoverDBClusterRequestPrivate::FailoverDBClusterRequestPrivate(
    const NeptuneRequest::Action action, FailoverDBClusterRequest * const q)
