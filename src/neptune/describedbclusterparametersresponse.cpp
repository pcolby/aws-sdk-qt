...
/*!
 * \class QtAws::Neptune::DescribeDBClusterParametersResponse
 * \brief The DescribeDBClusterParametersResponse class provides an interace for Neptune DescribeDBClusterParameters responses.
 *
...
DescribeDBClusterParametersResponse::DescribeDBClusterParametersResponse(
    ...
    : NeptuneResponse(new DescribeDBClusterParametersResponsePrivate(this), parent)
{
...
{
    return static_cast<const DescribeDBClusterParametersRequest *>(NeptuneResponse::request());
}

/*!
 * \reimp
 * Parses a successful Neptune DescribeDBClusterParameters \a response.
 */
...
/*!
 * \class QtAws::Neptune::DescribeDBClusterParametersResponsePrivate
...
DescribeDBClusterParametersResponsePrivate::DescribeDBClusterParametersResponsePrivate(
    DescribeDBClusterParametersResponse * const q) : NeptuneResponsePrivate(q)
{

}

/*!
 * Parses a Neptune DescribeDBClusterParameters response element from \a xml.
 */
