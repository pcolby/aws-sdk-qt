...
/*!
 * \class QtAws::Neptune::DescribeDBParameterGroupsRequest
 * \brief The DescribeDBParameterGroupsRequest class provides an interface for Neptune DescribeDBParameterGroups requests.
 *
...
DescribeDBParameterGroupsRequest::DescribeDBParameterGroupsRequest(const DescribeDBParameterGroupsRequest &other)
    : NeptuneRequest(new DescribeDBParameterGroupsRequestPrivate(*other.d_func(), this))
{
...
DescribeDBParameterGroupsRequest::DescribeDBParameterGroupsRequest()
    : NeptuneRequest(new DescribeDBParameterGroupsRequestPrivate(NeptuneRequest::DescribeDBParameterGroupsAction, this))
{
...
/*!
 * \class QtAws::Neptune::DescribeDBParameterGroupsRequestPrivate
...
/*!
 * Constructs a DescribeDBParameterGroupsRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
DescribeDBParameterGroupsRequestPrivate::DescribeDBParameterGroupsRequestPrivate(
    const NeptuneRequest::Action action, DescribeDBParameterGroupsRequest * const q)
