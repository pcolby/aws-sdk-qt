...
/*!
 * \class QtAws::Neptune::DescribeEventSubscriptionsResponse
 * \brief The DescribeEventSubscriptionsResponse class provides an interace for Neptune DescribeEventSubscriptions responses.
 *
...
DescribeEventSubscriptionsResponse::DescribeEventSubscriptionsResponse(
    ...
    : NeptuneResponse(new DescribeEventSubscriptionsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Neptune DescribeEventSubscriptions \a response.
 */
...
/*!
 * \class QtAws::Neptune::DescribeEventSubscriptionsResponsePrivate
...
DescribeEventSubscriptionsResponsePrivate::DescribeEventSubscriptionsResponsePrivate(
    DescribeEventSubscriptionsResponse * const q) : NeptuneResponsePrivate(q)
{

}

/*!
 * Parses a Neptune DescribeEventSubscriptions response element from \a xml.
 */
