...
/*!
 * \class QtAws::Neptune::DescribeEventsRequest
 * \brief The DescribeEventsRequest class provides an interface for Neptune DescribeEvents requests.
 *
...
DescribeEventsRequest::DescribeEventsRequest(const DescribeEventsRequest &other)
    : NeptuneRequest(new DescribeEventsRequestPrivate(*other.d_func(), this))
{
...
DescribeEventsRequest::DescribeEventsRequest()
    : NeptuneRequest(new DescribeEventsRequestPrivate(NeptuneRequest::DescribeEventsAction, this))
{
...
/*!
 * \class QtAws::Neptune::DescribeEventsRequestPrivate
...
/*!
 * Constructs a DescribeEventsRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
DescribeEventsRequestPrivate::DescribeEventsRequestPrivate(
    const NeptuneRequest::Action action, DescribeEventsRequest * const q)
