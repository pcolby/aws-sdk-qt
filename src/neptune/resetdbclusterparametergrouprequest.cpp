...
/*!
 * \class QtAws::Neptune::ResetDBClusterParameterGroupRequest
 * \brief The ResetDBClusterParameterGroupRequest class provides an interface for Neptune ResetDBClusterParameterGroup requests.
 *
...
ResetDBClusterParameterGroupRequest::ResetDBClusterParameterGroupRequest(const ResetDBClusterParameterGroupRequest &other)
    : NeptuneRequest(new ResetDBClusterParameterGroupRequestPrivate(*other.d_func(), this))
{
...
ResetDBClusterParameterGroupRequest::ResetDBClusterParameterGroupRequest()
    : NeptuneRequest(new ResetDBClusterParameterGroupRequestPrivate(NeptuneRequest::ResetDBClusterParameterGroupAction, this))
{
...
/*!
 * \class QtAws::Neptune::ResetDBClusterParameterGroupRequestPrivate
...
/*!
 * Constructs a ResetDBClusterParameterGroupRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
ResetDBClusterParameterGroupRequestPrivate::ResetDBClusterParameterGroupRequestPrivate(
    const NeptuneRequest::Action action, ResetDBClusterParameterGroupRequest * const q)
