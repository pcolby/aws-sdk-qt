...
/*!
 * \class QtAws::Neptune::DescribeDBClusterParameterGroupsRequest
 * \brief The DescribeDBClusterParameterGroupsRequest class provides an interface for Neptune DescribeDBClusterParameterGroups requests.
 *
...
DescribeDBClusterParameterGroupsRequest::DescribeDBClusterParameterGroupsRequest(const DescribeDBClusterParameterGroupsRequest &other)
    : NeptuneRequest(new DescribeDBClusterParameterGroupsRequestPrivate(*other.d_func(), this))
{
...
DescribeDBClusterParameterGroupsRequest::DescribeDBClusterParameterGroupsRequest()
    : NeptuneRequest(new DescribeDBClusterParameterGroupsRequestPrivate(NeptuneRequest::DescribeDBClusterParameterGroupsAction, this))
{
...
/*!
 * \class QtAws::Neptune::DescribeDBClusterParameterGroupsRequestPrivate
...
/*!
 * Constructs a DescribeDBClusterParameterGroupsRequestPrivate object for Neptune \a action,
 * with public implementation \a q.
 */
DescribeDBClusterParameterGroupsRequestPrivate::DescribeDBClusterParameterGroupsRequestPrivate(
    const NeptuneRequest::Action action, DescribeDBClusterParameterGroupsRequest * const q)
