...
/*!
 * \class QtAws::GlueDataBrew::ListSchedulesResponse
 * \brief The ListSchedulesResponse class provides an interace for GlueDataBrew ListSchedules responses.
 *
...
ListSchedulesResponse::ListSchedulesResponse(
    ...
    : GlueDataBrewResponse(new ListSchedulesResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GlueDataBrew ListSchedules \a response.
 */
...
/*!
 * \class QtAws::GlueDataBrew::ListSchedulesResponsePrivate
...
ListSchedulesResponsePrivate::ListSchedulesResponsePrivate(
    ListSchedulesResponse * const q) : GlueDataBrewResponsePrivate(q)
{

}

/*!
 * Parses a GlueDataBrew ListSchedules response element from \a xml.
 */
