...
class QTAWS_EXPORT StartProjectSessionRequestPrivate : public GlueDataBrewRequestPrivate {

public:
    StartProjectSessionRequestPrivate(const GlueDataBrewRequest::Action action,
