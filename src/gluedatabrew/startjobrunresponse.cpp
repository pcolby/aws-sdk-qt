...
/*!
 * \class QtAws::GlueDataBrew::StartJobRunResponse
 * \brief The StartJobRunResponse class provides an interace for GlueDataBrew StartJobRun responses.
 *
...
StartJobRunResponse::StartJobRunResponse(
    ...
    : GlueDataBrewResponse(new StartJobRunResponsePrivate(this), parent)
{
...
{
    return static_cast<const StartJobRunRequest *>(GlueDataBrewResponse::request());
}

/*!
 * \reimp
 * Parses a successful GlueDataBrew StartJobRun \a response.
 */
...
/*!
 * \class QtAws::GlueDataBrew::StartJobRunResponsePrivate
...
StartJobRunResponsePrivate::StartJobRunResponsePrivate(
    StartJobRunResponse * const q) : GlueDataBrewResponsePrivate(q)
{

}

/*!
 * Parses a GlueDataBrew StartJobRun response element from \a xml.
 */
