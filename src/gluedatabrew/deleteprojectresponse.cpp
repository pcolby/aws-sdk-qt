...
/*!
 * \class QtAws::GlueDataBrew::DeleteProjectResponse
 * \brief The DeleteProjectResponse class provides an interace for GlueDataBrew DeleteProject responses.
 *
...
DeleteProjectResponse::DeleteProjectResponse(
    ...
    : GlueDataBrewResponse(new DeleteProjectResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GlueDataBrew DeleteProject \a response.
 */
...
/*!
 * \class QtAws::GlueDataBrew::DeleteProjectResponsePrivate
...
DeleteProjectResponsePrivate::DeleteProjectResponsePrivate(
    DeleteProjectResponse * const q) : GlueDataBrewResponsePrivate(q)
{

}

/*!
 * Parses a GlueDataBrew DeleteProject response element from \a xml.
 */
