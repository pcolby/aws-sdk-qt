...
/*!
 * \class QtAws::GlueDataBrew::DescribeJobResponse
 * \brief The DescribeJobResponse class provides an interace for GlueDataBrew DescribeJob responses.
 *
...
DescribeJobResponse::DescribeJobResponse(
    ...
    : GlueDataBrewResponse(new DescribeJobResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GlueDataBrew DescribeJob \a response.
 */
...
/*!
 * \class QtAws::GlueDataBrew::DescribeJobResponsePrivate
...
DescribeJobResponsePrivate::DescribeJobResponsePrivate(
    DescribeJobResponse * const q) : GlueDataBrewResponsePrivate(q)
{

}

/*!
 * Parses a GlueDataBrew DescribeJob response element from \a xml.
 */
