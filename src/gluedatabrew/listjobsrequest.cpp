...
/*!
 * \class QtAws::GlueDataBrew::ListJobsRequest
 * \brief The ListJobsRequest class provides an interface for GlueDataBrew ListJobs requests.
 *
...
ListJobsRequest::ListJobsRequest(const ListJobsRequest &other)
    : GlueDataBrewRequest(new ListJobsRequestPrivate(*other.d_func(), this))
{
...
ListJobsRequest::ListJobsRequest()
    : GlueDataBrewRequest(new ListJobsRequestPrivate(GlueDataBrewRequest::ListJobsAction, this))
{
...
/*!
 * \class QtAws::GlueDataBrew::ListJobsRequestPrivate
...
/*!
 * Constructs a ListJobsRequestPrivate object for GlueDataBrew \a action,
 * with public implementation \a q.
 */
ListJobsRequestPrivate::ListJobsRequestPrivate(
    const GlueDataBrewRequest::Action action, ListJobsRequest * const q)
