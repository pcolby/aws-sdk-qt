...
class QTAWS_EXPORT DescribeProjectRequestPrivate : public GlueDataBrewRequestPrivate {

public:
    DescribeProjectRequestPrivate(const GlueDataBrewRequest::Action action,
