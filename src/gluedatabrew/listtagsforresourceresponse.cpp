...
/*!
 * \class QtAws::GlueDataBrew::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for GlueDataBrew ListTagsForResource responses.
 *
 ...
 *
 * \sa GlueDataBrewClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : GlueDataBrewResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(GlueDataBrewResponse::request());
}

/*!
 * \reimp
 * Parses a successful GlueDataBrew ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::GlueDataBrew::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : GlueDataBrewResponsePrivate(q)
{

}

/*!
 * Parses a GlueDataBrew ListTagsForResource response element from \a xml.
 */
