...
/*!
 * \class QtAws::GlueDataBrew::ListDatasetsRequest
 * \brief The ListDatasetsRequest class provides an interface for GlueDataBrew ListDatasets requests.
 *
 ...
 *
 * \sa GlueDataBrewClient::listDatasets
 */
...
ListDatasetsRequest::ListDatasetsRequest(const ListDatasetsRequest &other)
    : GlueDataBrewRequest(new ListDatasetsRequestPrivate(*other.d_func(), this))
{
...
ListDatasetsRequest::ListDatasetsRequest()
    : GlueDataBrewRequest(new ListDatasetsRequestPrivate(GlueDataBrewRequest::ListDatasetsAction, this))
{
...
/*!
 * \class QtAws::GlueDataBrew::ListDatasetsRequestPrivate
...
/*!
 * Constructs a ListDatasetsRequestPrivate object for GlueDataBrew \a action,
 * with public implementation \a q.
 */
ListDatasetsRequestPrivate::ListDatasetsRequestPrivate(
    const GlueDataBrewRequest::Action action, ListDatasetsRequest * const q)
