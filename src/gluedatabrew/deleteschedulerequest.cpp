...
/*!
 * \class QtAws::GlueDataBrew::DeleteScheduleRequest
 * \brief The DeleteScheduleRequest class provides an interface for GlueDataBrew DeleteSchedule requests.
 *
...
DeleteScheduleRequest::DeleteScheduleRequest(const DeleteScheduleRequest &other)
    : GlueDataBrewRequest(new DeleteScheduleRequestPrivate(*other.d_func(), this))
{
...
DeleteScheduleRequest::DeleteScheduleRequest()
    : GlueDataBrewRequest(new DeleteScheduleRequestPrivate(GlueDataBrewRequest::DeleteScheduleAction, this))
{
...
/*!
 * \class QtAws::GlueDataBrew::DeleteScheduleRequestPrivate
...
/*!
 * Constructs a DeleteScheduleRequestPrivate object for GlueDataBrew \a action,
 * with public implementation \a q.
 */
DeleteScheduleRequestPrivate::DeleteScheduleRequestPrivate(
    const GlueDataBrewRequest::Action action, DeleteScheduleRequest * const q)
