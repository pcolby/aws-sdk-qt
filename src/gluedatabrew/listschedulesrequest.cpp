...
/*!
 * \class QtAws::GlueDataBrew::ListSchedulesRequest
 * \brief The ListSchedulesRequest class provides an interface for GlueDataBrew ListSchedules requests.
 *
 ...
 *
 * \sa GlueDataBrewClient::listSchedules
 */
...
ListSchedulesRequest::ListSchedulesRequest(const ListSchedulesRequest &other)
    : GlueDataBrewRequest(new ListSchedulesRequestPrivate(*other.d_func(), this))
{
...
ListSchedulesRequest::ListSchedulesRequest()
    : GlueDataBrewRequest(new ListSchedulesRequestPrivate(GlueDataBrewRequest::ListSchedulesAction, this))
{
...
/*!
 * \class QtAws::GlueDataBrew::ListSchedulesRequestPrivate
...
/*!
 * Constructs a ListSchedulesRequestPrivate object for GlueDataBrew \a action,
 * with public implementation \a q.
 */
ListSchedulesRequestPrivate::ListSchedulesRequestPrivate(
    const GlueDataBrewRequest::Action action, ListSchedulesRequest * const q)
