...
class QTAWS_EXPORT CreateRecipeJobRequestPrivate : public GlueDataBrewRequestPrivate {

public:
    CreateRecipeJobRequestPrivate(const GlueDataBrewRequest::Action action,
