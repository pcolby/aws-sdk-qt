...
/*!
 * \class QtAws::GlueDataBrew::ListJobsResponse
 * \brief The ListJobsResponse class provides an interace for GlueDataBrew ListJobs responses.
 *
 ...
 *
 * \sa GlueDataBrewClient::listJobs
 */
...
ListJobsResponse::ListJobsResponse(
    ...
    : GlueDataBrewResponse(new ListJobsResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListJobsRequest *>(GlueDataBrewResponse::request());
}

/*!
 * \reimp
 * Parses a successful GlueDataBrew ListJobs \a response.
 */
...
/*!
 * \class QtAws::GlueDataBrew::ListJobsResponsePrivate
...
ListJobsResponsePrivate::ListJobsResponsePrivate(
    ListJobsResponse * const q) : GlueDataBrewResponsePrivate(q)
{

}

/*!
 * Parses a GlueDataBrew ListJobs response element from \a xml.
 */
