...
/*!
 * \class QtAws::GlueDataBrew::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for GlueDataBrew UntagResource responses.
 *
 ...
 *
 * \sa GlueDataBrewClient::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : GlueDataBrewResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(GlueDataBrewResponse::request());
}

/*!
 * \reimp
 * Parses a successful GlueDataBrew UntagResource \a response.
 */
...
/*!
 * \class QtAws::GlueDataBrew::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : GlueDataBrewResponsePrivate(q)
{

}

/*!
 * Parses a GlueDataBrew UntagResource response element from \a xml.
 */
