...
/*!
 * \class QtAws::GlueDataBrew::DescribeProjectResponse
 * \brief The DescribeProjectResponse class provides an interace for GlueDataBrew DescribeProject responses.
 *
...
DescribeProjectResponse::DescribeProjectResponse(
    ...
    : GlueDataBrewResponse(new DescribeProjectResponsePrivate(this), parent)
{
...
{
    return static_cast<const DescribeProjectRequest *>(GlueDataBrewResponse::request());
}

/*!
 * \reimp
 * Parses a successful GlueDataBrew DescribeProject \a response.
 */
...
/*!
 * \class QtAws::GlueDataBrew::DescribeProjectResponsePrivate
...
DescribeProjectResponsePrivate::DescribeProjectResponsePrivate(
    DescribeProjectResponse * const q) : GlueDataBrewResponsePrivate(q)
{

}

/*!
 * Parses a GlueDataBrew DescribeProject response element from \a xml.
 */
