...
/*!
 * \class QtAws::GlueDataBrew::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for GlueDataBrew TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : GlueDataBrewResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GlueDataBrew TagResource \a response.
 */
...
/*!
 * \class QtAws::GlueDataBrew::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : GlueDataBrewResponsePrivate(q)
{

}

/*!
 * Parses a GlueDataBrew TagResource response element from \a xml.
 */
