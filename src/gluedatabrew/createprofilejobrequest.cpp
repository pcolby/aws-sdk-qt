...
/*!
 * \class QtAws::GlueDataBrew::CreateProfileJobRequest
 * \brief The CreateProfileJobRequest class provides an interface for GlueDataBrew CreateProfileJob requests.
 *
...
CreateProfileJobRequest::CreateProfileJobRequest(const CreateProfileJobRequest &other)
    : GlueDataBrewRequest(new CreateProfileJobRequestPrivate(*other.d_func(), this))
{
...
CreateProfileJobRequest::CreateProfileJobRequest()
    : GlueDataBrewRequest(new CreateProfileJobRequestPrivate(GlueDataBrewRequest::CreateProfileJobAction, this))
{
...
/*!
 * \class QtAws::GlueDataBrew::CreateProfileJobRequestPrivate
...
/*!
 * Constructs a CreateProfileJobRequestPrivate object for GlueDataBrew \a action,
 * with public implementation \a q.
 */
CreateProfileJobRequestPrivate::CreateProfileJobRequestPrivate(
    const GlueDataBrewRequest::Action action, CreateProfileJobRequest * const q)
