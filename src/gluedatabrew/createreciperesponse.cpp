...
/*!
 * \class QtAws::GlueDataBrew::CreateRecipeResponse
 * \brief The CreateRecipeResponse class provides an interace for GlueDataBrew CreateRecipe responses.
 *
...
CreateRecipeResponse::CreateRecipeResponse(
    ...
    : GlueDataBrewResponse(new CreateRecipeResponsePrivate(this), parent)
{
...
{
    return static_cast<const CreateRecipeRequest *>(GlueDataBrewResponse::request());
}

/*!
 * \reimp
 * Parses a successful GlueDataBrew CreateRecipe \a response.
 */
...
/*!
 * \class QtAws::GlueDataBrew::CreateRecipeResponsePrivate
...
CreateRecipeResponsePrivate::CreateRecipeResponsePrivate(
    CreateRecipeResponse * const q) : GlueDataBrewResponsePrivate(q)
{

}

/*!
 * Parses a GlueDataBrew CreateRecipe response element from \a xml.
 */
