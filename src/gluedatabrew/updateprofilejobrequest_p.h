...
class QTAWS_EXPORT UpdateProfileJobRequestPrivate : public GlueDataBrewRequestPrivate {

public:
    UpdateProfileJobRequestPrivate(const GlueDataBrewRequest::Action action,
