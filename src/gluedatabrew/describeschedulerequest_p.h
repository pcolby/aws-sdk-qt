...
class QTAWS_EXPORT DescribeScheduleRequestPrivate : public GlueDataBrewRequestPrivate {

public:
    DescribeScheduleRequestPrivate(const GlueDataBrewRequest::Action action,
