...
/*!
 * \class QtAws::GlueDataBrew::UpdateProjectRequest
 * \brief The UpdateProjectRequest class provides an interface for GlueDataBrew UpdateProject requests.
 *
...
UpdateProjectRequest::UpdateProjectRequest(const UpdateProjectRequest &other)
    : GlueDataBrewRequest(new UpdateProjectRequestPrivate(*other.d_func(), this))
{
...
UpdateProjectRequest::UpdateProjectRequest()
    : GlueDataBrewRequest(new UpdateProjectRequestPrivate(GlueDataBrewRequest::UpdateProjectAction, this))
{
...
/*!
 * \class QtAws::GlueDataBrew::UpdateProjectRequestPrivate
...
/*!
 * Constructs a UpdateProjectRequestPrivate object for GlueDataBrew \a action,
 * with public implementation \a q.
 */
UpdateProjectRequestPrivate::UpdateProjectRequestPrivate(
    const GlueDataBrewRequest::Action action, UpdateProjectRequest * const q)
