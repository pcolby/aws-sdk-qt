...
/*!
 * \class QtAws::GlueDataBrew::DescribeScheduleResponse
 * \brief The DescribeScheduleResponse class provides an interace for GlueDataBrew DescribeSchedule responses.
 *
...
DescribeScheduleResponse::DescribeScheduleResponse(
    ...
    : GlueDataBrewResponse(new DescribeScheduleResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GlueDataBrew DescribeSchedule \a response.
 */
...
/*!
 * \class QtAws::GlueDataBrew::DescribeScheduleResponsePrivate
...
DescribeScheduleResponsePrivate::DescribeScheduleResponsePrivate(
    DescribeScheduleResponse * const q) : GlueDataBrewResponsePrivate(q)
{

}

/*!
 * Parses a GlueDataBrew DescribeSchedule response element from \a xml.
 */
