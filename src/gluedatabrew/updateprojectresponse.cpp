...
/*!
 * \class QtAws::GlueDataBrew::UpdateProjectResponse
 * \brief The UpdateProjectResponse class provides an interace for GlueDataBrew UpdateProject responses.
 *
 ...
 *
 * \sa GlueDataBrewClient::updateProject
 */
...
UpdateProjectResponse::UpdateProjectResponse(
    ...
    : GlueDataBrewResponse(new UpdateProjectResponsePrivate(this), parent)
{
...
{
    return static_cast<const UpdateProjectRequest *>(GlueDataBrewResponse::request());
}

/*!
 * \reimp
 * Parses a successful GlueDataBrew UpdateProject \a response.
 */
...
/*!
 * \class QtAws::GlueDataBrew::UpdateProjectResponsePrivate
...
UpdateProjectResponsePrivate::UpdateProjectResponsePrivate(
    UpdateProjectResponse * const q) : GlueDataBrewResponsePrivate(q)
{

}

/*!
 * Parses a GlueDataBrew UpdateProject response element from \a xml.
 */
