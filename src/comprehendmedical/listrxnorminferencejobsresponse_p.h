...
class QTAWS_EXPORT ListRxNormInferenceJobsResponsePrivate : public ComprehendMedicalResponsePrivate {

public:

    ListRxNormInferenceJobsResponsePrivate(ListRxNormInferenceJobsResponse * const q);
