...
class QTAWS_EXPORT DescribeICD10CMInferenceJobResponsePrivate : public ComprehendMedicalResponsePrivate {

public:

    DescribeICD10CMInferenceJobResponsePrivate(DescribeICD10CMInferenceJobResponse * const q);
