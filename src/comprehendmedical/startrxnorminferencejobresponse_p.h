...
class QTAWS_EXPORT StartRxNormInferenceJobResponsePrivate : public ComprehendMedicalResponsePrivate {

public:

    StartRxNormInferenceJobResponsePrivate(StartRxNormInferenceJobResponse * const q);
