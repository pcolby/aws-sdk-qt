...
class QTAWS_EXPORT StopEntitiesDetectionV2JobResponsePrivate : public ComprehendMedicalResponsePrivate {

public:

    StopEntitiesDetectionV2JobResponsePrivate(StopEntitiesDetectionV2JobResponse * const q);
