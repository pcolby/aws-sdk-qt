...
class QTAWS_EXPORT StartPHIDetectionJobResponsePrivate : public ComprehendMedicalResponsePrivate {

public:

    StartPHIDetectionJobResponsePrivate(StartPHIDetectionJobResponse * const q);
