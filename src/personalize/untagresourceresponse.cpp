...
/*!
 * \class QtAws::Personalize::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Personalize UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : PersonalizeResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Personalize UntagResource \a response.
 */
...
/*!
 * \class QtAws::Personalize::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : PersonalizeResponsePrivate(q)
{

}

/*!
 * Parses a Personalize UntagResource response element from \a xml.
 */
