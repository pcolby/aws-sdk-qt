...
class QTAWS_EXPORT DescribeEventTrackerResponsePrivate : public PersonalizeResponsePrivate {

public:

    DescribeEventTrackerResponsePrivate(DescribeEventTrackerResponse * const q);
