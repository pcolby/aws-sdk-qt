...
/*!
 * \class QtAws::Personalize::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Personalize ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : PersonalizeResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Personalize ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Personalize::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : PersonalizeResponsePrivate(q)
{

}

/*!
 * Parses a Personalize ListTagsForResource response element from \a xml.
 */
