...
/*!
 * \class QtAws::Personalize::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Personalize TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : PersonalizeResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Personalize TagResource \a response.
 */
...
/*!
 * \class QtAws::Personalize::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : PersonalizeResponsePrivate(q)
{

}

/*!
 * Parses a Personalize TagResource response element from \a xml.
 */
