...
class QTAWS_EXPORT CreateDatasetExportJobResponsePrivate : public PersonalizeResponsePrivate {

public:

    CreateDatasetExportJobResponsePrivate(CreateDatasetExportJobResponse * const q);
