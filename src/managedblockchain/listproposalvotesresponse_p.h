...
class QTAWS_EXPORT ListProposalVotesResponsePrivate : public ManagedBlockchainResponsePrivate {

public:

    ListProposalVotesResponsePrivate(ListProposalVotesResponse * const q);
