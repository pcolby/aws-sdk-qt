...
/*!
 * \class QtAws::ManagedBlockchain::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for ManagedBlockchain ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ManagedBlockchainResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ManagedBlockchain ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::ManagedBlockchain::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ManagedBlockchainResponsePrivate(q)
{

}

/*!
 * Parses a ManagedBlockchain ListTagsForResource response element from \a xml.
 */
