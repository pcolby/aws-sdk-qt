...
class QTAWS_EXPORT DescribePredictorResponsePrivate : public ForecastServiceResponsePrivate {

public:

    DescribePredictorResponsePrivate(DescribePredictorResponse * const q);
