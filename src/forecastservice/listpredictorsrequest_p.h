...
class QTAWS_EXPORT ListPredictorsRequestPrivate : public ForecastServiceRequestPrivate {

public:
    ListPredictorsRequestPrivate(const ForecastServiceRequest::Action action,
