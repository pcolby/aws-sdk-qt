...
class QTAWS_EXPORT DeleteDatasetRequestPrivate : public ForecastServiceRequestPrivate {

public:
    DeleteDatasetRequestPrivate(const ForecastServiceRequest::Action action,
