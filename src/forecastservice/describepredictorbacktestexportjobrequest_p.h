...
class QTAWS_EXPORT DescribePredictorBacktestExportJobRequestPrivate : public ForecastServiceRequestPrivate {

public:
    DescribePredictorBacktestExportJobRequestPrivate(const ForecastServiceRequest::Action action,
