...
class QTAWS_EXPORT ListDatasetImportJobsRequestPrivate : public ForecastServiceRequestPrivate {

public:
    ListDatasetImportJobsRequestPrivate(const ForecastServiceRequest::Action action,
