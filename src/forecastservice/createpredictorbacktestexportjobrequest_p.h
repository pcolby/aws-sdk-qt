...
class QTAWS_EXPORT CreatePredictorBacktestExportJobRequestPrivate : public ForecastServiceRequestPrivate {

public:
    CreatePredictorBacktestExportJobRequestPrivate(const ForecastServiceRequest::Action action,
