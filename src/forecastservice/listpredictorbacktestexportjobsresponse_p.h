...
class QTAWS_EXPORT ListPredictorBacktestExportJobsResponsePrivate : public ForecastServiceResponsePrivate {

public:

    ListPredictorBacktestExportJobsResponsePrivate(ListPredictorBacktestExportJobsResponse * const q);
