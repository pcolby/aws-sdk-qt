...
class QTAWS_EXPORT ListForecastsRequestPrivate : public ForecastServiceRequestPrivate {

public:
    ListForecastsRequestPrivate(const ForecastServiceRequest::Action action,
