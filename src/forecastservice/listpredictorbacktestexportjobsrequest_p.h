...
class QTAWS_EXPORT ListPredictorBacktestExportJobsRequestPrivate : public ForecastServiceRequestPrivate {

public:
    ListPredictorBacktestExportJobsRequestPrivate(const ForecastServiceRequest::Action action,
