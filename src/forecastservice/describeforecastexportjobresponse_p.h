...
class QTAWS_EXPORT DescribeForecastExportJobResponsePrivate : public ForecastServiceResponsePrivate {

public:

    DescribeForecastExportJobResponsePrivate(DescribeForecastExportJobResponse * const q);
