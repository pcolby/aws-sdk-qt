...
class QTAWS_EXPORT ListDatasetGroupsResponsePrivate : public ForecastServiceResponsePrivate {

public:

    ListDatasetGroupsResponsePrivate(ListDatasetGroupsResponse * const q);
