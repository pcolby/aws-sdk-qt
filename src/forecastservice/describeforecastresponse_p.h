...
class QTAWS_EXPORT DescribeForecastResponsePrivate : public ForecastServiceResponsePrivate {

public:

    DescribeForecastResponsePrivate(DescribeForecastResponse * const q);
