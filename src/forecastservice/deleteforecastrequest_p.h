...
class QTAWS_EXPORT DeleteForecastRequestPrivate : public ForecastServiceRequestPrivate {

public:
    DeleteForecastRequestPrivate(const ForecastServiceRequest::Action action,
