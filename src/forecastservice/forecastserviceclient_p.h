...
#ifndef QTAWS_FORECASTSERVICECLIENT_P_H
#define QTAWS_FORECASTSERVICECLIENT_P_H
...
private:
    Q_DECLARE_PUBLIC(ForecastServiceClient)
    Q_DISABLE_COPY(ForecastServiceClientPrivate)
