...
class QTAWS_EXPORT DeleteForecastExportJobRequestPrivate : public ForecastServiceRequestPrivate {

public:
    DeleteForecastExportJobRequestPrivate(const ForecastServiceRequest::Action action,
