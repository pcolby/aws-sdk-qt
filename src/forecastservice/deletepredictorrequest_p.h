...
class QTAWS_EXPORT DeletePredictorRequestPrivate : public ForecastServiceRequestPrivate {

public:
    DeletePredictorRequestPrivate(const ForecastServiceRequest::Action action,
