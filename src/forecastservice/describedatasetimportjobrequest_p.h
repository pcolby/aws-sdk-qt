...
class QTAWS_EXPORT DescribeDatasetImportJobRequestPrivate : public ForecastServiceRequestPrivate {

public:
    DescribeDatasetImportJobRequestPrivate(const ForecastServiceRequest::Action action,
