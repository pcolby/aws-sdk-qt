...
class QTAWS_EXPORT DescribeForecastRequestPrivate : public ForecastServiceRequestPrivate {

public:
    DescribeForecastRequestPrivate(const ForecastServiceRequest::Action action,
