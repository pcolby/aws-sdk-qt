...
class QTAWS_EXPORT CreateForecastRequestPrivate : public ForecastServiceRequestPrivate {

public:
    CreateForecastRequestPrivate(const ForecastServiceRequest::Action action,
