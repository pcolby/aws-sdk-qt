...
class QTAWS_EXPORT CreateDatasetRequestPrivate : public ForecastServiceRequestPrivate {

public:
    CreateDatasetRequestPrivate(const ForecastServiceRequest::Action action,
