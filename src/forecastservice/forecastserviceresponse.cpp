...
/*!
 * \class QtAws::ForecastService::ForecastServiceResponse
 * \brief The ForecastServiceResponse class provides an interface for ForecastService responses.
 *
...
/*!
 * \internal
 * Constructs a ForecastServiceResponse object with private implementation \a d,
 * and parent \a parent.
 *
 ...
 * \reimp
 */
void ForecastServiceResponse::parseFailure(QIODevice &response)
{
    //Q_D(ForecastServiceResponse);
    Q_UNUSED(response);
...
/*!
 * \class QtAws::ForecastService::ForecastServiceResponsePrivate
 * \brief The ForecastServiceResponsePrivate class provides private implementation for ForecastServiceResponse.
 * \internal
 *
 * \inmodule QtAwsForecastService
 */
