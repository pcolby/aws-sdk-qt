...
class QTAWS_EXPORT GetGroupCertificateAuthorityResponse : public GreengrassResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetGroupCertificateAuthorityRequest * request() const override;
