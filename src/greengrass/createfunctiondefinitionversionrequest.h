...
#ifndef QTAWS_CREATEFUNCTIONDEFINITIONVERSIONREQUEST_H
#define QTAWS_CREATEFUNCTIONDEFINITIONVERSIONREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(CreateFunctionDefinitionVersionRequest)
