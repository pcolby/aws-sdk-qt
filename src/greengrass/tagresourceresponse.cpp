...
/*!
 * \class QtAws::Greengrass::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Greengrass TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : GreengrassResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(GreengrassResponse::request());
}

/*!
 * \reimp
 * Parses a successful Greengrass TagResource \a response.
 */
...
/*!
 * \class QtAws::Greengrass::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : GreengrassResponsePrivate(q)
{

}

/*!
 * Parses a Greengrass TagResource response element from \a xml.
 */
