...
class QTAWS_EXPORT GetCoreDefinitionVersionRequestPrivate : public GreengrassRequestPrivate {

public:
    GetCoreDefinitionVersionRequestPrivate(const Greengrass::Action action,
