...
class QTAWS_EXPORT CreateSubscriptionDefinitionRequestPrivate : public GreengrassRequestPrivate {

public:
    CreateSubscriptionDefinitionRequestPrivate(const Greengrass::Action action,
