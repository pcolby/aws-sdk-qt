...
class QTAWS_EXPORT GetCoreDefinitionResponsePrivate : public GreengrassResponsePrivate {

public:

    GetCoreDefinitionResponsePrivate(GetCoreDefinitionResponse * const q);
