...
class QTAWS_EXPORT CreateResourceDefinitionResponsePrivate : public GreengrassResponsePrivate {
    Q_OBJECT

public:

    CreateResourceDefinitionResponsePrivate(CreateResourceDefinitionResponse * const q);
