...
class QTAWS_EXPORT ListBulkDeploymentsResponsePrivate : public GreengrassResponsePrivate {

public:

    ListBulkDeploymentsResponsePrivate(ListBulkDeploymentsResponse * const q);
