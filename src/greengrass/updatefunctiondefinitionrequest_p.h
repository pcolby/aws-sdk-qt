...
class QTAWS_EXPORT UpdateFunctionDefinitionRequestPrivate : public GreengrassPrivate {

public:
    UpdateFunctionDefinitionRequestPrivate(const Greengrass::Action action,
