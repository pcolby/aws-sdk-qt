...
class QTAWS_EXPORT ListSubscriptionDefinitionsResponse : public GreengrassResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListSubscriptionDefinitionsRequest * request() const override;
