...
class QTAWS_EXPORT ListSubscriptionDefinitionsResponse : public ListSubscriptionDefinitionsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListSubscriptionDefinitionsRequest * request() const;
