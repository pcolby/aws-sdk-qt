...
class QTAWS_EXPORT CreateCoreDefinitionVersionRequestPrivate : public GreengrassPrivate {

public:
    CreateCoreDefinitionVersionRequestPrivate(const Greengrass::Action action,
