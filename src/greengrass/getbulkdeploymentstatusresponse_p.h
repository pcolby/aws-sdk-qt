...
class QTAWS_EXPORT GetBulkDeploymentStatusResponsePrivate : public GreengrassResponsePrivate {

public:

    GetBulkDeploymentStatusResponsePrivate(GetBulkDeploymentStatusResponse * const q);
