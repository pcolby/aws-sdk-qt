...
class QTAWS_EXPORT GetDeviceDefinitionVersionRequestPrivate : public GreengrassRequestPrivate {

public:
    GetDeviceDefinitionVersionRequestPrivate(const Greengrass::Action action,
