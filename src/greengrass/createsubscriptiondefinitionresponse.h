...
class QTAWS_EXPORT CreateSubscriptionDefinitionResponse : public CreateSubscriptionDefinitionResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateSubscriptionDefinitionRequest * request() const;
