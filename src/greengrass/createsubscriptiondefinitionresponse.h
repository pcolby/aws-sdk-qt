...
class QTAWS_EXPORT CreateSubscriptionDefinitionResponse : public GreengrassResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateSubscriptionDefinitionRequest * request() const override;
