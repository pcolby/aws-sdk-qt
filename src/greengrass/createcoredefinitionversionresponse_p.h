...
class QTAWS_EXPORT CreateCoreDefinitionVersionResponsePrivate : public GreengrassResponsePrivate {

public:

    CreateCoreDefinitionVersionResponsePrivate(CreateCoreDefinitionVersionResponse * const q);
