...
class QTAWS_EXPORT CreateConnectorDefinitionResponsePrivate : public GreengrassResponsePrivate {

public:

    CreateConnectorDefinitionResponsePrivate(CreateConnectorDefinitionResponse * const q);
