...
class QTAWSGREENGRASS_EXPORT DeleteLoggerDefinitionResponse : public GreengrassResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteLoggerDefinitionRequest * request() const Q_DECL_OVERRIDE;
