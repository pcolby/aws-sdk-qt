...
class QTAWSGREENGRASS_EXPORT GetLoggerDefinitionVersionResponse : public GreengrassResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetLoggerDefinitionVersionRequest * request() const Q_DECL_OVERRIDE;
