...
class QTAWS_EXPORT GetCoreDefinitionVersionResponse : public GetCoreDefinitionVersionResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetCoreDefinitionVersionRequest * request() const;
