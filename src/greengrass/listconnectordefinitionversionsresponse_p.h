...
class QTAWS_EXPORT ListConnectorDefinitionVersionsResponsePrivate : public GreengrassResponsePrivate {

public:

    ListConnectorDefinitionVersionsResponsePrivate(ListConnectorDefinitionVersionsResponse * const q);
