...
class QTAWS_EXPORT UpdateSubscriptionDefinitionRequestPrivate : public GreengrassRequestPrivate {

public:
    UpdateSubscriptionDefinitionRequestPrivate(const Greengrass::Action action,
