...
/*!
 * \class QtAws::Greengrass::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Greengrass ListTagsForResource responses.
 *
 ...
 *
 * \sa GreengrassClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : GreengrassResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(GreengrassResponse::request());
}

/*!
 * \reimp
 * Parses a successful Greengrass ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Greengrass::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : GreengrassResponsePrivate(q)
{

}

/*!
 * Parses a Greengrass ListTagsForResource response element from \a xml.
 */
