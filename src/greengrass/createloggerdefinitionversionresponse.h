...
class QTAWS_EXPORT CreateLoggerDefinitionVersionResponse : public GreengrassResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateLoggerDefinitionVersionRequest * request() const override;
