...
/*!
 * \class QtAws::Glue::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Glue TagResource responses.
 *
 * \inmodule QtAwsGlue
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : GlueResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(GlueResponse::request());
}

/*!
 * \reimp
 * Parses a successful Glue TagResource \a response.
 */
...
/*!
 * \class QtAws::Glue::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : GlueResponsePrivate(q)
{

}

/*!
 * Parses a Glue TagResource response element from \a xml.
 */
