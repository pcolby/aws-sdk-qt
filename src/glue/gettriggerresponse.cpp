 ...
 *
 * @brief  Handles Glue GetTrigger responses.
 *
 ...
 */
GetTriggerResponse::{OperationName}}Response(
...
GetTriggerResponsePrivate::GetTriggerResponsePrivate(
    GetTriggerQueueResponse * const q) : GetTriggerPrivate(q)
{
 ...
 */
void GetTriggerResponsePrivate::GetTriggerResponse(QXmlStreamReader &xml)
{
