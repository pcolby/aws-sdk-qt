 ...
 *
 * \brief The CreateJobResponse class encapsulates Glue CreateJob responses.
 *
 * \ingroup Glue
 *
...
/*!
 * @brief  Parse a Glue CreateJob response.
 *
...
/*!
 * @brief  Parse an Glue CreateJobResponse element.
 *
