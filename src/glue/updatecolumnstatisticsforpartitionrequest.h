...
#ifndef QTAWS_UPDATECOLUMNSTATISTICSFORPARTITIONREQUEST_H
#define QTAWS_UPDATECOLUMNSTATISTICSFORPARTITIONREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(UpdateColumnStatisticsForPartitionRequest)
