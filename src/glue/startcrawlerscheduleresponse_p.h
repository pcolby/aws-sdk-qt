...
class QTAWS_EXPORT StartCrawlerScheduleResponsePrivate : public GlueResponsePrivate {
    Q_OBJECT

public:

    StartCrawlerScheduleResponsePrivate(StartCrawlerScheduleResponse * const q);
