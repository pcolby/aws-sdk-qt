...
class QTAWS_EXPORT GetWorkflowRunPropertiesResponsePrivate : public GlueResponsePrivate {

public:

    GetWorkflowRunPropertiesResponsePrivate(GetWorkflowRunPropertiesResponse * const q);
