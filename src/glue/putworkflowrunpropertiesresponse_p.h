...
class QTAWS_EXPORT PutWorkflowRunPropertiesResponsePrivate : public GlueResponsePrivate {

public:

    PutWorkflowRunPropertiesResponsePrivate(PutWorkflowRunPropertiesResponse * const q);
