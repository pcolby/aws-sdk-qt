...
class QTAWS_EXPORT CreatePartitionIndexResponsePrivate : public GlueResponsePrivate {

public:

    CreatePartitionIndexResponsePrivate(CreatePartitionIndexResponse * const q);
