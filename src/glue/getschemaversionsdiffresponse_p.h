...
class QTAWS_EXPORT GetSchemaVersionsDiffResponsePrivate : public GlueResponsePrivate {

public:

    GetSchemaVersionsDiffResponsePrivate(GetSchemaVersionsDiffResponse * const q);
