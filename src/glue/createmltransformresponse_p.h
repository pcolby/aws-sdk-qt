...
#ifndef QTAWS_CREATEMLTRANSFORMRESPONSE_P_H
#define QTAWS_CREATEMLTRANSFORMRESPONSE_P_H
...
private:
    Q_DECLARE_PUBLIC(CreateMLTransformResponse)
    Q_DISABLE_COPY(CreateMLTransformResponsePrivate)
