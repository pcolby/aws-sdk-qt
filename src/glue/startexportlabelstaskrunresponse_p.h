...
class QTAWS_EXPORT StartExportLabelsTaskRunResponsePrivate : public GlueResponsePrivate {

public:

    StartExportLabelsTaskRunResponsePrivate(StartExportLabelsTaskRunResponse * const q);
