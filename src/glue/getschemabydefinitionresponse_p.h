...
class QTAWS_EXPORT GetSchemaByDefinitionResponsePrivate : public GlueResponsePrivate {

public:

    GetSchemaByDefinitionResponsePrivate(GetSchemaByDefinitionResponse * const q);
