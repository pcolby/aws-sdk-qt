...
/*!
 * \class QtAws::SecretsManager::PutResourcePolicyResponse
 * \brief The PutResourcePolicyResponse class provides an interace for SecretsManager PutResourcePolicy responses.
 *
...
PutResourcePolicyResponse::PutResourcePolicyResponse(
    ...
    : SecretsManagerResponse(new PutResourcePolicyResponsePrivate(this), parent)
{
...
{
    return static_cast<const PutResourcePolicyRequest *>(SecretsManagerResponse::request());
}

/*!
 * \reimp
 * Parses a successful SecretsManager PutResourcePolicy \a response.
 */
...
/*!
 * \class QtAws::SecretsManager::PutResourcePolicyResponsePrivate
...
PutResourcePolicyResponsePrivate::PutResourcePolicyResponsePrivate(
    PutResourcePolicyResponse * const q) : SecretsManagerResponsePrivate(q)
{

}

/*!
 * Parses a SecretsManager PutResourcePolicy response element from \a xml.
 */
