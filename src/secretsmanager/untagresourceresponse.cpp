 ...
 *
 * @brief  Handles SecretsManager UntagResource responses.
 *
 * @see    SecretsManagerClient::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : SecretsManagerResponse(new UntagResourceResponsePrivate(this), parent)
{
