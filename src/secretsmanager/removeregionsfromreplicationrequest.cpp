...
#include "removeregionsfromreplicationrequest_p.h"
...
/*!
 * \class QtAws::SecretsManager::RemoveRegionsFromReplicationRequest
 * \brief The RemoveRegionsFromReplicationRequest class provides an interface for SecretsManager RemoveRegionsFromReplication requests.
 *
 ...
 */
RemoveRegionsFromReplicationRequest::RemoveRegionsFromReplicationRequest(const RemoveRegionsFromReplicationRequest &other)
    : SecretsManagerRequest(new RemoveRegionsFromReplicationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a RemoveRegionsFromReplicationRequest object.
 */
RemoveRegionsFromReplicationRequest::RemoveRegionsFromReplicationRequest()
    : SecretsManagerRequest(new RemoveRegionsFromReplicationRequestPrivate(SecretsManagerRequest::RemoveRegionsFromReplicationAction, this))
{
 ...
 * \reimp
 */
bool RemoveRegionsFromReplicationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a RemoveRegionsFromReplicationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * RemoveRegionsFromReplicationRequest::response(QNetworkReply * const reply) const
{
    return new RemoveRegionsFromReplicationResponse(*this, reply);
}

/*!
 * \class QtAws::SecretsManager::RemoveRegionsFromReplicationRequestPrivate
 * \brief The RemoveRegionsFromReplicationRequestPrivate class provides private implementation for RemoveRegionsFromReplicationRequest.
 * \internal
 *
 * \inmodule QtAwsSecretsManager
 */
...
/*!
 * Constructs a RemoveRegionsFromReplicationRequestPrivate object for SecretsManager \a action,
 * with public implementation \a q.
 */
RemoveRegionsFromReplicationRequestPrivate::RemoveRegionsFromReplicationRequestPrivate(
    const SecretsManagerRequest::Action action, RemoveRegionsFromReplicationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the RemoveRegionsFromReplicationRequest
 * class' copy constructor.
 */
RemoveRegionsFromReplicationRequestPrivate::RemoveRegionsFromReplicationRequestPrivate(
    const RemoveRegionsFromReplicationRequestPrivate &other, RemoveRegionsFromReplicationRequest * const q)
