...
class QTAWS_EXPORT GetResourcePolicyResponsePrivate : public SecretsManagerResponsePrivate {

public:

    GetResourcePolicyResponsePrivate(GetResourcePolicyResponse * const q);
