...
/*!
 * \class QtAws::SecretsManager::DeleteResourcePolicyResponse
 * \brief The DeleteResourcePolicyResponse class provides an interace for SecretsManager DeleteResourcePolicy responses.
 *
...
DeleteResourcePolicyResponse::DeleteResourcePolicyResponse(
    ...
    : SecretsManagerResponse(new DeleteResourcePolicyResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful SecretsManager DeleteResourcePolicy \a response.
 */
...
/*!
 * \class QtAws::SecretsManager::DeleteResourcePolicyResponsePrivate
...
DeleteResourcePolicyResponsePrivate::DeleteResourcePolicyResponsePrivate(
    DeleteResourcePolicyResponse * const q) : SecretsManagerResponsePrivate(q)
{

}

/*!
 * Parses a SecretsManager DeleteResourcePolicy response element from \a xml.
 */
