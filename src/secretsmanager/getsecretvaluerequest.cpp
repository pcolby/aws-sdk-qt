...
#include "getsecretvaluerequest_p.h"
 ...
 *
 * @brief  Implements SecretsManager GetSecretValue requests.
 *
...
bool GetSecretValueRequest::isValid() const
{
    return false;
}
...
{
    return new GetSecretValueResponse(*this, reply);
}
