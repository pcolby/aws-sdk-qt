...
#include "replicatesecrettoregionsresponse_p.h"
...
/*!
 * \class QtAws::SecretsManager::ReplicateSecretToRegionsResponse
 * \brief The ReplicateSecretToRegionsResponse class provides an interace for SecretsManager ReplicateSecretToRegions responses.
 *
...
/*!
 * Constructs a ReplicateSecretToRegionsResponse object for \a reply to \a request, with parent \a parent.
 */
ReplicateSecretToRegionsResponse::ReplicateSecretToRegionsResponse(
        const ReplicateSecretToRegionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : SecretsManagerResponse(new ReplicateSecretToRegionsResponsePrivate(this), parent)
{
    setRequest(new ReplicateSecretToRegionsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful SecretsManager ReplicateSecretToRegions \a response.
 */
void ReplicateSecretToRegionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ReplicateSecretToRegionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::SecretsManager::ReplicateSecretToRegionsResponsePrivate
 * \brief The ReplicateSecretToRegionsResponsePrivate class provides private implementation for ReplicateSecretToRegionsResponse.
 * \internal
 *
 * \inmodule QtAwsSecretsManager
 */
...
/*!
 * Constructs a ReplicateSecretToRegionsResponsePrivate object with public implementation \a q.
 */
ReplicateSecretToRegionsResponsePrivate::ReplicateSecretToRegionsResponsePrivate(
    ReplicateSecretToRegionsResponse * const q) : SecretsManagerResponsePrivate(q)
{

}

/*!
 * Parses a SecretsManager ReplicateSecretToRegions response element from \a xml.
 */
void ReplicateSecretToRegionsResponsePrivate::parseReplicateSecretToRegionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ReplicateSecretToRegionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
