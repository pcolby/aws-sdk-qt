...
#include "validateresourcepolicyrequest_p.h"
...
/*!
 * \class QtAws::SecretsManager::ValidateResourcePolicyRequest
 * \brief The ValidateResourcePolicyRequest class provides an interface for SecretsManager ValidateResourcePolicy requests.
 *
 ...
 */
ValidateResourcePolicyRequest::ValidateResourcePolicyRequest(const ValidateResourcePolicyRequest &other)
    : SecretsManagerRequest(new ValidateResourcePolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ValidateResourcePolicyRequest object.
 */
ValidateResourcePolicyRequest::ValidateResourcePolicyRequest()
    : SecretsManagerRequest(new ValidateResourcePolicyRequestPrivate(SecretsManagerRequest::ValidateResourcePolicyAction, this))
{
 ...
 * \reimp
 */
bool ValidateResourcePolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ValidateResourcePolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ValidateResourcePolicyRequest::response(QNetworkReply * const reply) const
{
    return new ValidateResourcePolicyResponse(*this, reply);
}

/*!
 * \class QtAws::SecretsManager::ValidateResourcePolicyRequestPrivate
 * \brief The ValidateResourcePolicyRequestPrivate class provides private implementation for ValidateResourcePolicyRequest.
 * \internal
 *
 * \inmodule QtAwsSecretsManager
 */
...
/*!
 * Constructs a ValidateResourcePolicyRequestPrivate object for SecretsManager \a action,
 * with public implementation \a q.
 */
ValidateResourcePolicyRequestPrivate::ValidateResourcePolicyRequestPrivate(
    const SecretsManagerRequest::Action action, ValidateResourcePolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ValidateResourcePolicyRequest
 * class' copy constructor.
 */
ValidateResourcePolicyRequestPrivate::ValidateResourcePolicyRequestPrivate(
    const ValidateResourcePolicyRequestPrivate &other, ValidateResourcePolicyRequest * const q)
