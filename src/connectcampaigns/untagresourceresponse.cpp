...
/*!
 * \class QtAws::ConnectCampaigns::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for ConnectCampaigns UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : ConnectCampaignsResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ConnectCampaigns UntagResource \a response.
 */
...
/*!
 * \class QtAws::ConnectCampaigns::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : ConnectCampaignsResponsePrivate(q)
{

}

/*!
 * Parses a ConnectCampaigns UntagResource response element from \a xml.
 */
