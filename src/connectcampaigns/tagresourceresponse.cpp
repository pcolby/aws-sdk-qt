...
/*!
 * \class QtAws::ConnectCampaigns::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for ConnectCampaigns TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ConnectCampaignsResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ConnectCampaigns TagResource \a response.
 */
...
/*!
 * \class QtAws::ConnectCampaigns::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ConnectCampaignsResponsePrivate(q)
{

}

/*!
 * Parses a ConnectCampaigns TagResource response element from \a xml.
 */
