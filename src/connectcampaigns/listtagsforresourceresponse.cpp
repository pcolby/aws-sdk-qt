...
/*!
 * \class QtAws::ConnectCampaigns::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for ConnectCampaigns ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ConnectCampaignsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ConnectCampaigns ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::ConnectCampaigns::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ConnectCampaignsResponsePrivate(q)
{

}

/*!
 * Parses a ConnectCampaigns ListTagsForResource response element from \a xml.
 */
