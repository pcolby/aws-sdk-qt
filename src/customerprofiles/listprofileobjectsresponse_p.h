...
class QTAWS_EXPORT ListProfileObjectsResponsePrivate : public CustomerProfilesResponsePrivate {

public:

    ListProfileObjectsResponsePrivate(ListProfileObjectsResponse * const q);
