...
/*!
 * \class QtAws::CustomerProfiles::CreateProfileResponse
 * \brief The CreateProfileResponse class provides an interace for CustomerProfiles CreateProfile responses.
 *
...
CreateProfileResponse::CreateProfileResponse(
    ...
    : CustomerProfilesResponse(new CreateProfileResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CustomerProfiles CreateProfile \a response.
 */
...
/*!
 * \class QtAws::CustomerProfiles::CreateProfileResponsePrivate
...
CreateProfileResponsePrivate::CreateProfileResponsePrivate(
    CreateProfileResponse * const q) : CustomerProfilesResponsePrivate(q)
{

}

/*!
 * Parses a CustomerProfiles CreateProfile response element from \a xml.
 */
