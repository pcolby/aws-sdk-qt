...
class QTAWS_EXPORT ListIntegrationsResponsePrivate : public CustomerProfilesResponsePrivate {

public:

    ListIntegrationsResponsePrivate(ListIntegrationsResponse * const q);
