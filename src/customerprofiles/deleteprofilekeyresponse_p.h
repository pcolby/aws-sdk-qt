...
class QTAWS_EXPORT DeleteProfileKeyResponsePrivate : public CustomerProfilesResponsePrivate {

public:

    DeleteProfileKeyResponsePrivate(DeleteProfileKeyResponse * const q);
