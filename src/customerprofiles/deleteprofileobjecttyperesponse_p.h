...
class QTAWS_EXPORT DeleteProfileObjectTypeResponsePrivate : public CustomerProfilesResponsePrivate {

public:

    DeleteProfileObjectTypeResponsePrivate(DeleteProfileObjectTypeResponse * const q);
