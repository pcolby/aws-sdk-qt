...
class QTAWS_EXPORT GetProfileObjectTypeTemplateResponsePrivate : public CustomerProfilesResponsePrivate {

public:

    GetProfileObjectTypeTemplateResponsePrivate(GetProfileObjectTypeTemplateResponse * const q);
