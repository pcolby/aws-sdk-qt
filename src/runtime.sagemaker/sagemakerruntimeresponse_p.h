...
class QTAWS_EXPORT SageMakerRuntimeResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {
    Q_OBJECT

public:

    SageMakerRuntimeResponsePrivate(SageMakerRuntimeResponse * const q);
