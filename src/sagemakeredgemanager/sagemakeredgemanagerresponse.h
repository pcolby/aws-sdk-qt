...
#ifndef QTAWS_SAGEMAKEREDGEMANAGERRESPONSE_H
...
public:
    SagemakerEdgeManagerResponse(QObject * const parent = 0);
...
private:
    Q_DECLARE_PRIVATE(SagemakerEdgeManagerResponse)
    Q_DISABLE_COPY(SagemakerEdgeManagerResponse)
