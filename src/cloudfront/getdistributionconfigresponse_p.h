...
class QTAWS_EXPORT GetDistributionConfigResponsePrivate : public CloudFrontResponsePrivate {

public:

    GetDistributionConfigResponsePrivate(GetDistributionConfigResponse * const q);
