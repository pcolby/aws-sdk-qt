...
class QTAWS_EXPORT ListFieldLevelEncryptionConfigsResponse : public CloudFrontResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListFieldLevelEncryptionConfigsRequest * request() const override;
