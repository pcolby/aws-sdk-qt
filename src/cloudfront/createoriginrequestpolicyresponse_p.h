...
class QTAWS_EXPORT CreateOriginRequestPolicyResponsePrivate : public CloudFrontResponsePrivate {

public:

    CreateOriginRequestPolicyResponsePrivate(CreateOriginRequestPolicyResponse * const q);
