...
class QTAWS_EXPORT CreateCachePolicyResponsePrivate : public CloudFrontResponsePrivate {

public:

    CreateCachePolicyResponsePrivate(CreateCachePolicyResponse * const q);
