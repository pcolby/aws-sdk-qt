...
/**
 * @brief  Constructs a new CloudFrontClientRequest object.
 *
...
/**
 * @brief  Constructs a new CloudFrontClientRequest object by copying another.
 *
 ...
 */
CloudFrontClientRequest& CloudFrontClientRequest::operator=(const CloudFrontClientRequest &other)
{
    Q_D(CloudFrontClientRequest);
 ...
 * implementation that inherits from CloudFrontClientRequestPrivate.
 *
 ...
 */
CloudFrontClientRequest::Action CloudFrontClientRequest::action() const
{
    Q_D(const CloudFrontClientRequest);
    return d->action;
}
 ...
 */
QString CloudFrontClientRequest::actionString() const
{
    return CloudFrontClientRequestPrivate::toString(action());
}
 ...
 */
QString CloudFrontClientRequest::apiVersion() const
{
    Q_D(const CloudFrontClientRequest);
    return d->apiVersion;
}
 ...
 */
void CloudFrontClientRequest::setAction(const Action action)
{
    Q_D(CloudFrontClientRequest);
    d->action = action;
}
 ...
 */
void CloudFrontClientRequest::setApiVersion(const QString &version)
{
    Q_D(CloudFrontClientRequest);
 ...
 */
bool CloudFrontClientRequest::operator==(const CloudFrontClientRequest &other) const
{
 ...
 */
bool CloudFrontClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int CloudFrontClientRequest::clearParameter(const QString &name)
{
    Q_D(CloudFrontClientRequest);
 ...
 */
void CloudFrontClientRequest::clearParameters()
{
    Q_D(CloudFrontClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant CloudFrontClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const CloudFrontClientRequest);
 ...
 */
const QVariantMap &CloudFrontClientRequest::parameters() const
{
    Q_D(const CloudFrontClientRequest);
    return d->parameters;
}
 ...
 */
void CloudFrontClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(CloudFrontClientRequest);
 ...
 */
void CloudFrontClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(CloudFrontClientRequest);
 ...
 */
QNetworkRequest CloudFrontClientRequest::unsignedRequest(const QUrl &endpoint) const
{
    Q_D(const CloudFrontClientRequest);
    QUrl url(endpoint);
 ...
 *
 * @brief  Private implementation for CloudFrontClientRequest.
 */

/**
 * @internal
 *
 * @brief  Constructs a new CloudFrontClientRequestPrivate object.
 *
 ...
 * @internal
 *
 * @brief  Constructs a new CloudFrontClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the CloudFrontClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public CloudFrontClientRequest instance.
 */
 ...
 *
 * This function converts CloudFrontClientRequest::Action enumerator values to their respective
 ...
 */
QString CloudFrontClientRequestPrivate::toString(const CloudFrontClientRequest::Action &action)
{
    #define ActionToString(action) \
        case CloudFrontClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
