...
class QTAWS_EXPORT UpdateFieldLevelEncryptionConfigResponse : public CloudFrontResponse {
    Q_OBJECT
...
public:
    ...
    virtual const UpdateFieldLevelEncryptionConfigRequest * request() const override;
