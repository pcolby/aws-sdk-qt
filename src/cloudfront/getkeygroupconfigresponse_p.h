...
class QTAWS_EXPORT GetKeyGroupConfigResponsePrivate : public CloudFrontResponsePrivate {

public:

    GetKeyGroupConfigResponsePrivate(GetKeyGroupConfigResponse * const q);
