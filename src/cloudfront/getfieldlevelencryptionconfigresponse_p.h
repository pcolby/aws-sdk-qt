...
class QTAWS_EXPORT GetFieldLevelEncryptionConfigResponsePrivate : public CloudFrontResponsePrivate {

public:

    GetFieldLevelEncryptionConfigResponsePrivate(GetFieldLevelEncryptionConfigResponse * const q);
