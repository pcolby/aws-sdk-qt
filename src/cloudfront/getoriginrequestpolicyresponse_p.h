...
class QTAWS_EXPORT GetOriginRequestPolicyResponsePrivate : public CloudFrontResponsePrivate {

public:

    GetOriginRequestPolicyResponsePrivate(GetOriginRequestPolicyResponse * const q);
