...
class QTAWS_EXPORT DeleteFieldLevelEncryptionConfigResponsePrivate : public CloudFrontResponsePrivate {

public:

    DeleteFieldLevelEncryptionConfigResponsePrivate(DeleteFieldLevelEncryptionConfigResponse * const q);
