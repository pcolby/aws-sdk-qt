...
class QTAWS_EXPORT GetCachePolicyConfigResponsePrivate : public CloudFrontResponsePrivate {

public:

    GetCachePolicyConfigResponsePrivate(GetCachePolicyConfigResponse * const q);
