...
class QTAWS_EXPORT ListFieldLevelEncryptionProfilesResponsePrivate : public CloudFrontResponsePrivate {

public:

    ListFieldLevelEncryptionProfilesResponsePrivate(ListFieldLevelEncryptionProfilesResponse * const q);
