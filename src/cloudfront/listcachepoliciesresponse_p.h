...
class QTAWS_EXPORT ListCachePoliciesResponsePrivate : public CloudFrontResponsePrivate {

public:

    ListCachePoliciesResponsePrivate(ListCachePoliciesResponse * const q);
