...
class QTAWS_EXPORT GetFieldLevelEncryptionProfileResponsePrivate : public CloudFrontResponsePrivate {

public:

    GetFieldLevelEncryptionProfileResponsePrivate(GetFieldLevelEncryptionProfileResponse * const q);
