...
class QTAWS_EXPORT CreateCloudFrontOriginAccessIdentityResponse : public CloudFrontResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateCloudFrontOriginAccessIdentityRequest * request() const override;
