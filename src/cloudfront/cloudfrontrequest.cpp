...
QString CloudFrontRequestPrivate::toString(const CloudFrontRequest::Action &action)
{
    ...
    switch (action) {
        ...
        ActionToString(CreateDistributionWithTags);
        ActionToString(CreateFieldLevelEncryptionConfig);
        ActionToString(CreateFieldLevelEncryptionProfile);
        ...
        ActionToString(DeleteCloudFrontOriginAccessIdentity);
        ActionToString(DeleteDistribution);
        ActionToString(DeleteFieldLevelEncryptionConfig);
        ActionToString(DeleteFieldLevelEncryptionProfile);
        ...
        ActionToString(GetCachePolicyConfig);
        ActionToString(GetCloudFrontOriginAccessIdentity);
        ActionToString(GetCloudFrontOriginAccessIdentityConfig);
        ActionToString(GetDistribution);
        ActionToString(GetDistributionConfig);
        ActionToString(GetFieldLevelEncryption);
        ActionToString(GetFieldLevelEncryptionConfig);
        ActionToString(GetFieldLevelEncryptionProfile);
        ActionToString(GetFieldLevelEncryptionProfileConfig);
        ActionToString(GetFunction);
        ActionToString(GetInvalidation);
        ...
        ActionToString(TestFunction);
        ActionToString(UntagResource);
        ActionToString(UpdateCachePolicy);
        ActionToString(UpdateCloudFrontOriginAccessIdentity);
        ActionToString(UpdateDistribution);
        ActionToString(UpdateFieldLevelEncryptionConfig);
