...
class QTAWS_EXPORT UpdateCloudFrontOriginAccessIdentityResponse : public CloudFrontResponse {
    Q_OBJECT
...
public:
    ...
    virtual const UpdateCloudFrontOriginAccessIdentityRequest * request() const override;
