...
class QTAWS_EXPORT DeleteFieldLevelEncryptionProfileResponse : public CloudFrontResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteFieldLevelEncryptionProfileRequest * request() const override;
