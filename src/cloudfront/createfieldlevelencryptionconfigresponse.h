...
class QTAWS_EXPORT CreateFieldLevelEncryptionConfigResponse : public CloudFrontResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateFieldLevelEncryptionConfigRequest * request() const override;
