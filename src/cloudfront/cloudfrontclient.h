...
public slots:
    AssociateAliasResponse * associateAlias(const AssociateAliasRequest &request);
    ...
    CreateOriginAccessControlResponse * createOriginAccessControl(const CreateOriginAccessControlRequest &request);
    ...
    CreateResponseHeadersPolicyResponse * createResponseHeadersPolicy(const CreateResponseHeadersPolicyRequest &request);
    ...
    DeleteOriginAccessControlResponse * deleteOriginAccessControl(const DeleteOriginAccessControlRequest &request);
    ...
    DeleteResponseHeadersPolicyResponse * deleteResponseHeadersPolicy(const DeleteResponseHeadersPolicyRequest &request);
    ...
    GetOriginAccessControlResponse * getOriginAccessControl(const GetOriginAccessControlRequest &request);
    GetOriginAccessControlConfigResponse * getOriginAccessControlConfig(const GetOriginAccessControlConfigRequest &request);
    ...
    GetResponseHeadersPolicyResponse * getResponseHeadersPolicy(const GetResponseHeadersPolicyRequest &request);
    GetResponseHeadersPolicyConfigResponse * getResponseHeadersPolicyConfig(const GetResponseHeadersPolicyConfigRequest &request);
    ...
    ListConflictingAliasesResponse * listConflictingAliases(const ListConflictingAliasesRequest &request);
    ...
    ListDistributionsByResponseHeadersPolicyIdResponse * listDistributionsByResponseHeadersPolicyId(const ListDistributionsByResponseHeadersPolicyIdRequest &request);
    ...
    ListOriginAccessControlsResponse * listOriginAccessControls(const ListOriginAccessControlsRequest &request);
    ...
    ListResponseHeadersPoliciesResponse * listResponseHeadersPolicies(const ListResponseHeadersPoliciesRequest &request);
    ...
    UpdateOriginAccessControlResponse * updateOriginAccessControl(const UpdateOriginAccessControlRequest &request);
    ...
    UpdateResponseHeadersPolicyResponse * updateResponseHeadersPolicy(const UpdateResponseHeadersPolicyRequest &request);
