...
class QTAWS_EXPORT GetFieldLevelEncryptionConfigResponse : public CloudFrontResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetFieldLevelEncryptionConfigRequest * request() const override;
