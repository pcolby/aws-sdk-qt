...
class QTAWS_EXPORT GetCloudFrontOriginAccessIdentityResponsePrivate : public CloudFrontResponsePrivate {

public:

    GetCloudFrontOriginAccessIdentityResponsePrivate(GetCloudFrontOriginAccessIdentityResponse * const q);
