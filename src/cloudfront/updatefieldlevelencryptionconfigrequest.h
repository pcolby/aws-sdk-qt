...
#ifndef QTAWS_UPDATEFIELDLEVELENCRYPTIONCONFIGREQUEST_H
#define QTAWS_UPDATEFIELDLEVELENCRYPTIONCONFIGREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(UpdateFieldLevelEncryptionConfigRequest)
