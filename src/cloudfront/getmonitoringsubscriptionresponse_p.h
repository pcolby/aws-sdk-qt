...
class QTAWS_EXPORT GetMonitoringSubscriptionResponsePrivate : public CloudFrontResponsePrivate {

public:

    GetMonitoringSubscriptionResponsePrivate(GetMonitoringSubscriptionResponse * const q);
