...
public:
    ...
    CloudFrontClientResponsePrivate(CloudFrontClientResponse * const q);

    void parseResponse(QXmlStreamReader &xml);

private:
    Q_DECLARE_PUBLIC(CloudFrontClientResponse)
    Q_DISABLE_COPY(CloudFrontClientResponsePrivate)
