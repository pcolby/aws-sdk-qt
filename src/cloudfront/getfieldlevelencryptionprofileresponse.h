...
class QTAWS_EXPORT GetFieldLevelEncryptionProfileResponse : public CloudFrontResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetFieldLevelEncryptionProfileRequest * request() const override;
