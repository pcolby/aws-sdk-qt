 ...
 * consists of a data blob that can be up to 1,000 KiB in size, and any kind of data. For example, it can be a segment from
 ...
 * (before base64 encoding), up to a limit of 4 MB for the entire request. These limits cannot be
 *
 * changed>
 *
 * You must specify the name of the delivery stream and the data record when using <a>PutRecord</a>. The data record
