...
#include "deletefunctionurlconfigrequest_p.h"
...
/*!
 * \class QtAws::Lambda::DeleteFunctionUrlConfigRequest
 * \brief The DeleteFunctionUrlConfigRequest class provides an interface for Lambda DeleteFunctionUrlConfig requests.
 *
 ...
 */
DeleteFunctionUrlConfigRequest::DeleteFunctionUrlConfigRequest(const DeleteFunctionUrlConfigRequest &other)
    : LambdaRequest(new DeleteFunctionUrlConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteFunctionUrlConfigRequest object.
 */
DeleteFunctionUrlConfigRequest::DeleteFunctionUrlConfigRequest()
    : LambdaRequest(new DeleteFunctionUrlConfigRequestPrivate(LambdaRequest::DeleteFunctionUrlConfigAction, this))
{
 ...
 * \reimp
 */
bool DeleteFunctionUrlConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteFunctionUrlConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteFunctionUrlConfigRequest::response(QNetworkReply * const reply) const
{
    return new DeleteFunctionUrlConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Lambda::DeleteFunctionUrlConfigRequestPrivate
 * \brief The DeleteFunctionUrlConfigRequestPrivate class provides private implementation for DeleteFunctionUrlConfigRequest.
 * \internal
 *
 * \inmodule QtAwsLambda
 */
...
/*!
 * Constructs a DeleteFunctionUrlConfigRequestPrivate object for Lambda \a action,
 * with public implementation \a q.
 */
DeleteFunctionUrlConfigRequestPrivate::DeleteFunctionUrlConfigRequestPrivate(
    const LambdaRequest::Action action, DeleteFunctionUrlConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteFunctionUrlConfigRequest
 * class' copy constructor.
 */
DeleteFunctionUrlConfigRequestPrivate::DeleteFunctionUrlConfigRequestPrivate(
    const DeleteFunctionUrlConfigRequestPrivate &other, DeleteFunctionUrlConfigRequest * const q)
