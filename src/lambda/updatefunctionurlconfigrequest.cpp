...
#include "updatefunctionurlconfigrequest_p.h"
...
/*!
 * \class QtAws::Lambda::UpdateFunctionUrlConfigRequest
 * \brief The UpdateFunctionUrlConfigRequest class provides an interface for Lambda UpdateFunctionUrlConfig requests.
 *
 ...
 */
UpdateFunctionUrlConfigRequest::UpdateFunctionUrlConfigRequest(const UpdateFunctionUrlConfigRequest &other)
    : LambdaRequest(new UpdateFunctionUrlConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateFunctionUrlConfigRequest object.
 */
UpdateFunctionUrlConfigRequest::UpdateFunctionUrlConfigRequest()
    : LambdaRequest(new UpdateFunctionUrlConfigRequestPrivate(LambdaRequest::UpdateFunctionUrlConfigAction, this))
{
 ...
 * \reimp
 */
bool UpdateFunctionUrlConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateFunctionUrlConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateFunctionUrlConfigRequest::response(QNetworkReply * const reply) const
{
    return new UpdateFunctionUrlConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Lambda::UpdateFunctionUrlConfigRequestPrivate
 * \brief The UpdateFunctionUrlConfigRequestPrivate class provides private implementation for UpdateFunctionUrlConfigRequest.
 * \internal
 *
 * \inmodule QtAwsLambda
 */
...
/*!
 * Constructs a UpdateFunctionUrlConfigRequestPrivate object for Lambda \a action,
 * with public implementation \a q.
 */
UpdateFunctionUrlConfigRequestPrivate::UpdateFunctionUrlConfigRequestPrivate(
    const LambdaRequest::Action action, UpdateFunctionUrlConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateFunctionUrlConfigRequest
 * class' copy constructor.
 */
UpdateFunctionUrlConfigRequestPrivate::UpdateFunctionUrlConfigRequestPrivate(
    const UpdateFunctionUrlConfigRequestPrivate &other, UpdateFunctionUrlConfigRequest * const q)
