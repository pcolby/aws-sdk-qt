...
class QTAWS_EXPORT DeleteFunctionCodeSigningConfigResponsePrivate : public LambdaResponsePrivate {

public:

    DeleteFunctionCodeSigningConfigResponsePrivate(DeleteFunctionCodeSigningConfigResponse * const q);
