...
#include "createfunctionurlconfigrequest_p.h"
...
/*!
 * \class QtAws::Lambda::CreateFunctionUrlConfigRequest
 * \brief The CreateFunctionUrlConfigRequest class provides an interface for Lambda CreateFunctionUrlConfig requests.
 *
 ...
 */
CreateFunctionUrlConfigRequest::CreateFunctionUrlConfigRequest(const CreateFunctionUrlConfigRequest &other)
    : LambdaRequest(new CreateFunctionUrlConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateFunctionUrlConfigRequest object.
 */
CreateFunctionUrlConfigRequest::CreateFunctionUrlConfigRequest()
    : LambdaRequest(new CreateFunctionUrlConfigRequestPrivate(LambdaRequest::CreateFunctionUrlConfigAction, this))
{
 ...
 * \reimp
 */
bool CreateFunctionUrlConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateFunctionUrlConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateFunctionUrlConfigRequest::response(QNetworkReply * const reply) const
{
    return new CreateFunctionUrlConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Lambda::CreateFunctionUrlConfigRequestPrivate
 * \brief The CreateFunctionUrlConfigRequestPrivate class provides private implementation for CreateFunctionUrlConfigRequest.
 * \internal
 *
 * \inmodule QtAwsLambda
 */
...
/*!
 * Constructs a CreateFunctionUrlConfigRequestPrivate object for Lambda \a action,
 * with public implementation \a q.
 */
CreateFunctionUrlConfigRequestPrivate::CreateFunctionUrlConfigRequestPrivate(
    const LambdaRequest::Action action, CreateFunctionUrlConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateFunctionUrlConfigRequest
 * class' copy constructor.
 */
CreateFunctionUrlConfigRequestPrivate::CreateFunctionUrlConfigRequestPrivate(
    const CreateFunctionUrlConfigRequestPrivate &other, CreateFunctionUrlConfigRequest * const q)
