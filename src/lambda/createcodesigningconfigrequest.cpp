...
#include "createcodesigningconfigrequest_p.h"
...
/*!
 * \class QtAws::Lambda::CreateCodeSigningConfigRequest
 * \brief The CreateCodeSigningConfigRequest class provides an interface for Lambda CreateCodeSigningConfig requests.
 *
 ...
 */
CreateCodeSigningConfigRequest::CreateCodeSigningConfigRequest(const CreateCodeSigningConfigRequest &other)
    : LambdaRequest(new CreateCodeSigningConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateCodeSigningConfigRequest object.
 */
CreateCodeSigningConfigRequest::CreateCodeSigningConfigRequest()
    : LambdaRequest(new CreateCodeSigningConfigRequestPrivate(LambdaRequest::CreateCodeSigningConfigAction, this))
{
 ...
 * \reimp
 */
bool CreateCodeSigningConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateCodeSigningConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateCodeSigningConfigRequest::response(QNetworkReply * const reply) const
{
    return new CreateCodeSigningConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Lambda::CreateCodeSigningConfigRequestPrivate
 * \brief The CreateCodeSigningConfigRequestPrivate class provides private implementation for CreateCodeSigningConfigRequest.
 * \internal
 *
 * \inmodule QtAwsLambda
 */
...
/*!
 * Constructs a CreateCodeSigningConfigRequestPrivate object for Lambda \a action,
 * with public implementation \a q.
 */
CreateCodeSigningConfigRequestPrivate::CreateCodeSigningConfigRequestPrivate(
    const LambdaRequest::Action action, CreateCodeSigningConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateCodeSigningConfigRequest
 * class' copy constructor.
 */
CreateCodeSigningConfigRequestPrivate::CreateCodeSigningConfigRequestPrivate(
    const CreateCodeSigningConfigRequestPrivate &other, CreateCodeSigningConfigRequest * const q)
