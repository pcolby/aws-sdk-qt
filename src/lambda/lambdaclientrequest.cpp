...
/**
 * @brief  Constructs a new LambdaClientRequest object by copying another.
 *
 ...
 */
LambdaClientRequest& LambdaClientRequest::operator=(const LambdaClientRequest &other)
{
    Q_D(LambdaClientRequest);
 ...
 * implementation that inherits from LambdaClientRequestPrivate.
 *
...
{
    return LambdaClientRequestPrivate::toString(action());
}
 ...
 */
void LambdaClientRequest::setAction(const Action action)
{
    Q_D(LambdaClientRequest);
    d->action = action;
}
 ...
 */
bool LambdaClientRequest::operator==(const LambdaClientRequest &other) const
{
 ...
 */
bool LambdaClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int LambdaClientRequest::clearParameter(const QString &name)
{
    Q_D(LambdaClientRequest);
 ...
 */
void LambdaClientRequest::clearParameters()
{
    Q_D(LambdaClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant LambdaClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const LambdaClientRequest);
 ...
 */
const QVariantMap &LambdaClientRequest::parameters() const
{
    Q_D(const LambdaClientRequest);
    return d->parameters;
}
 ...
 */
void LambdaClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(LambdaClientRequest);
 ...
 */
void LambdaClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(LambdaClientRequest);
 ...
 *
 * @brief  Private implementation for LambdaClientRequest.
 */
 ...
 * @internal
 *
 * @brief  Constructs a new LambdaClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the LambdaClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public LambdaClientRequest instance.
 */
 ...
 */
QString LambdaClientRequestPrivate::toString(const LambdaClientRequest::Action &action)
{
    #define ActionToString(action) \
        case LambdaClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
