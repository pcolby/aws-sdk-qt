...
#include "createfunctionurlconfigresponse_p.h"
...
/*!
 * \class QtAws::Lambda::CreateFunctionUrlConfigResponse
 * \brief The CreateFunctionUrlConfigResponse class provides an interace for Lambda CreateFunctionUrlConfig responses.
 *
 ...
 *
 * \sa LambdaClient::createFunctionUrlConfig
 */

/*!
 * Constructs a CreateFunctionUrlConfigResponse object for \a reply to \a request, with parent \a parent.
 */
CreateFunctionUrlConfigResponse::CreateFunctionUrlConfigResponse(
        const CreateFunctionUrlConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : LambdaResponse(new CreateFunctionUrlConfigResponsePrivate(this), parent)
{
    setRequest(new CreateFunctionUrlConfigRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateFunctionUrlConfigRequest * CreateFunctionUrlConfigResponse::request() const
{
    Q_D(const CreateFunctionUrlConfigResponse);
    return static_cast<const CreateFunctionUrlConfigRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Lambda CreateFunctionUrlConfig \a response.
 */
void CreateFunctionUrlConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateFunctionUrlConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Lambda::CreateFunctionUrlConfigResponsePrivate
 * \brief The CreateFunctionUrlConfigResponsePrivate class provides private implementation for CreateFunctionUrlConfigResponse.
 * \internal
 *
 * \inmodule QtAwsLambda
 */
...
/*!
 * Constructs a CreateFunctionUrlConfigResponsePrivate object with public implementation \a q.
 */
CreateFunctionUrlConfigResponsePrivate::CreateFunctionUrlConfigResponsePrivate(
    CreateFunctionUrlConfigResponse * const q) : LambdaResponsePrivate(q)
{

}

/*!
 * Parses a Lambda CreateFunctionUrlConfig response element from \a xml.
 */
void CreateFunctionUrlConfigResponsePrivate::parseCreateFunctionUrlConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateFunctionUrlConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
