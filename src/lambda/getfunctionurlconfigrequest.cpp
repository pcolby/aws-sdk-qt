...
#include "getfunctionurlconfigrequest_p.h"
...
/*!
 * \class QtAws::Lambda::GetFunctionUrlConfigRequest
 * \brief The GetFunctionUrlConfigRequest class provides an interface for Lambda GetFunctionUrlConfig requests.
 *
 ...
 */
GetFunctionUrlConfigRequest::GetFunctionUrlConfigRequest(const GetFunctionUrlConfigRequest &other)
    : LambdaRequest(new GetFunctionUrlConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetFunctionUrlConfigRequest object.
 */
GetFunctionUrlConfigRequest::GetFunctionUrlConfigRequest()
    : LambdaRequest(new GetFunctionUrlConfigRequestPrivate(LambdaRequest::GetFunctionUrlConfigAction, this))
{
 ...
 * \reimp
 */
bool GetFunctionUrlConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetFunctionUrlConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetFunctionUrlConfigRequest::response(QNetworkReply * const reply) const
{
    return new GetFunctionUrlConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Lambda::GetFunctionUrlConfigRequestPrivate
 * \brief The GetFunctionUrlConfigRequestPrivate class provides private implementation for GetFunctionUrlConfigRequest.
 * \internal
 *
 * \inmodule QtAwsLambda
 */
...
/*!
 * Constructs a GetFunctionUrlConfigRequestPrivate object for Lambda \a action,
 * with public implementation \a q.
 */
GetFunctionUrlConfigRequestPrivate::GetFunctionUrlConfigRequestPrivate(
    const LambdaRequest::Action action, GetFunctionUrlConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetFunctionUrlConfigRequest
 * class' copy constructor.
 */
GetFunctionUrlConfigRequestPrivate::GetFunctionUrlConfigRequestPrivate(
    const GetFunctionUrlConfigRequestPrivate &other, GetFunctionUrlConfigRequest * const q)
