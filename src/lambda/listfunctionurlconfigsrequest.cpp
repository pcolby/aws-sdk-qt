...
#include "listfunctionurlconfigsrequest_p.h"
...
/*!
 * \class QtAws::Lambda::ListFunctionUrlConfigsRequest
 * \brief The ListFunctionUrlConfigsRequest class provides an interface for Lambda ListFunctionUrlConfigs requests.
 *
 ...
 */
ListFunctionUrlConfigsRequest::ListFunctionUrlConfigsRequest(const ListFunctionUrlConfigsRequest &other)
    : LambdaRequest(new ListFunctionUrlConfigsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListFunctionUrlConfigsRequest object.
 */
ListFunctionUrlConfigsRequest::ListFunctionUrlConfigsRequest()
    : LambdaRequest(new ListFunctionUrlConfigsRequestPrivate(LambdaRequest::ListFunctionUrlConfigsAction, this))
{
 ...
 * \reimp
 */
bool ListFunctionUrlConfigsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListFunctionUrlConfigsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListFunctionUrlConfigsRequest::response(QNetworkReply * const reply) const
{
    return new ListFunctionUrlConfigsResponse(*this, reply);
}

/*!
 * \class QtAws::Lambda::ListFunctionUrlConfigsRequestPrivate
 * \brief The ListFunctionUrlConfigsRequestPrivate class provides private implementation for ListFunctionUrlConfigsRequest.
 * \internal
 *
 * \inmodule QtAwsLambda
 */
...
/*!
 * Constructs a ListFunctionUrlConfigsRequestPrivate object for Lambda \a action,
 * with public implementation \a q.
 */
ListFunctionUrlConfigsRequestPrivate::ListFunctionUrlConfigsRequestPrivate(
    const LambdaRequest::Action action, ListFunctionUrlConfigsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListFunctionUrlConfigsRequest
 * class' copy constructor.
 */
ListFunctionUrlConfigsRequestPrivate::ListFunctionUrlConfigsRequestPrivate(
    const ListFunctionUrlConfigsRequestPrivate &other, ListFunctionUrlConfigsRequest * const q)
