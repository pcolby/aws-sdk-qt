...
class QTAWS_EXPORT GetProvisionedConcurrencyConfigResponsePrivate : public LambdaResponsePrivate {

public:

    GetProvisionedConcurrencyConfigResponsePrivate(GetProvisionedConcurrencyConfigResponse * const q);
