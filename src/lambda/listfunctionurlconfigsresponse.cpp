...
#include "listfunctionurlconfigsresponse_p.h"
...
/*!
 * \class QtAws::Lambda::ListFunctionUrlConfigsResponse
 * \brief The ListFunctionUrlConfigsResponse class provides an interace for Lambda ListFunctionUrlConfigs responses.
 *
 ...
 *
 * \sa LambdaClient::listFunctionUrlConfigs
 */

/*!
 * Constructs a ListFunctionUrlConfigsResponse object for \a reply to \a request, with parent \a parent.
 */
ListFunctionUrlConfigsResponse::ListFunctionUrlConfigsResponse(
        const ListFunctionUrlConfigsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : LambdaResponse(new ListFunctionUrlConfigsResponsePrivate(this), parent)
{
    setRequest(new ListFunctionUrlConfigsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListFunctionUrlConfigsRequest * ListFunctionUrlConfigsResponse::request() const
{
    Q_D(const ListFunctionUrlConfigsResponse);
    return static_cast<const ListFunctionUrlConfigsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Lambda ListFunctionUrlConfigs \a response.
 */
void ListFunctionUrlConfigsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListFunctionUrlConfigsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Lambda::ListFunctionUrlConfigsResponsePrivate
 * \brief The ListFunctionUrlConfigsResponsePrivate class provides private implementation for ListFunctionUrlConfigsResponse.
 * \internal
 *
 * \inmodule QtAwsLambda
 */
...
/*!
 * Constructs a ListFunctionUrlConfigsResponsePrivate object with public implementation \a q.
 */
ListFunctionUrlConfigsResponsePrivate::ListFunctionUrlConfigsResponsePrivate(
    ListFunctionUrlConfigsResponse * const q) : LambdaResponsePrivate(q)
{

}

/*!
 * Parses a Lambda ListFunctionUrlConfigs response element from \a xml.
 */
void ListFunctionUrlConfigsResponsePrivate::parseListFunctionUrlConfigsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListFunctionUrlConfigsResponse"));
    Q_UNUSED(xml) ///< @todo
}
