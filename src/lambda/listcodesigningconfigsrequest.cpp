...
#include "listcodesigningconfigsrequest_p.h"
...
/*!
 * \class QtAws::Lambda::ListCodeSigningConfigsRequest
 * \brief The ListCodeSigningConfigsRequest class provides an interface for Lambda ListCodeSigningConfigs requests.
 *
 ...
 */
ListCodeSigningConfigsRequest::ListCodeSigningConfigsRequest(const ListCodeSigningConfigsRequest &other)
    : LambdaRequest(new ListCodeSigningConfigsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListCodeSigningConfigsRequest object.
 */
ListCodeSigningConfigsRequest::ListCodeSigningConfigsRequest()
    : LambdaRequest(new ListCodeSigningConfigsRequestPrivate(LambdaRequest::ListCodeSigningConfigsAction, this))
{
 ...
 * \reimp
 */
bool ListCodeSigningConfigsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListCodeSigningConfigsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListCodeSigningConfigsRequest::response(QNetworkReply * const reply) const
{
    return new ListCodeSigningConfigsResponse(*this, reply);
}

/*!
 * \class QtAws::Lambda::ListCodeSigningConfigsRequestPrivate
 * \brief The ListCodeSigningConfigsRequestPrivate class provides private implementation for ListCodeSigningConfigsRequest.
 * \internal
 *
 * \inmodule QtAwsLambda
 */
...
/*!
 * Constructs a ListCodeSigningConfigsRequestPrivate object for Lambda \a action,
 * with public implementation \a q.
 */
ListCodeSigningConfigsRequestPrivate::ListCodeSigningConfigsRequestPrivate(
    const LambdaRequest::Action action, ListCodeSigningConfigsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListCodeSigningConfigsRequest
 * class' copy constructor.
 */
ListCodeSigningConfigsRequestPrivate::ListCodeSigningConfigsRequestPrivate(
    const ListCodeSigningConfigsRequestPrivate &other, ListCodeSigningConfigsRequest * const q)
