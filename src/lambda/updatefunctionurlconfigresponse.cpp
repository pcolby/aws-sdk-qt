...
#include "updatefunctionurlconfigresponse_p.h"
...
/*!
 * \class QtAws::Lambda::UpdateFunctionUrlConfigResponse
 * \brief The UpdateFunctionUrlConfigResponse class provides an interace for Lambda UpdateFunctionUrlConfig responses.
 *
 ...
 *
 * \sa LambdaClient::updateFunctionUrlConfig
 */

/*!
 * Constructs a UpdateFunctionUrlConfigResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateFunctionUrlConfigResponse::UpdateFunctionUrlConfigResponse(
        const UpdateFunctionUrlConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : LambdaResponse(new UpdateFunctionUrlConfigResponsePrivate(this), parent)
{
    setRequest(new UpdateFunctionUrlConfigRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateFunctionUrlConfigRequest * UpdateFunctionUrlConfigResponse::request() const
{
    Q_D(const UpdateFunctionUrlConfigResponse);
    return static_cast<const UpdateFunctionUrlConfigRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Lambda UpdateFunctionUrlConfig \a response.
 */
void UpdateFunctionUrlConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateFunctionUrlConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Lambda::UpdateFunctionUrlConfigResponsePrivate
 * \brief The UpdateFunctionUrlConfigResponsePrivate class provides private implementation for UpdateFunctionUrlConfigResponse.
 * \internal
 *
 * \inmodule QtAwsLambda
 */
...
/*!
 * Constructs a UpdateFunctionUrlConfigResponsePrivate object with public implementation \a q.
 */
UpdateFunctionUrlConfigResponsePrivate::UpdateFunctionUrlConfigResponsePrivate(
    UpdateFunctionUrlConfigResponse * const q) : LambdaResponsePrivate(q)
{

}

/*!
 * Parses a Lambda UpdateFunctionUrlConfig response element from \a xml.
 */
void UpdateFunctionUrlConfigResponsePrivate::parseUpdateFunctionUrlConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateFunctionUrlConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
