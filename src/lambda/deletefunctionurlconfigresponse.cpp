...
#include "deletefunctionurlconfigresponse_p.h"
...
/*!
 * \class QtAws::Lambda::DeleteFunctionUrlConfigResponse
 * \brief The DeleteFunctionUrlConfigResponse class provides an interace for Lambda DeleteFunctionUrlConfig responses.
 *
 ...
 *
 * \sa LambdaClient::deleteFunctionUrlConfig
 */

/*!
 * Constructs a DeleteFunctionUrlConfigResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteFunctionUrlConfigResponse::DeleteFunctionUrlConfigResponse(
        const DeleteFunctionUrlConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : LambdaResponse(new DeleteFunctionUrlConfigResponsePrivate(this), parent)
{
    setRequest(new DeleteFunctionUrlConfigRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteFunctionUrlConfigRequest * DeleteFunctionUrlConfigResponse::request() const
{
    Q_D(const DeleteFunctionUrlConfigResponse);
    return static_cast<const DeleteFunctionUrlConfigRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Lambda DeleteFunctionUrlConfig \a response.
 */
void DeleteFunctionUrlConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteFunctionUrlConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Lambda::DeleteFunctionUrlConfigResponsePrivate
 * \brief The DeleteFunctionUrlConfigResponsePrivate class provides private implementation for DeleteFunctionUrlConfigResponse.
 * \internal
 *
 * \inmodule QtAwsLambda
 */
...
/*!
 * Constructs a DeleteFunctionUrlConfigResponsePrivate object with public implementation \a q.
 */
DeleteFunctionUrlConfigResponsePrivate::DeleteFunctionUrlConfigResponsePrivate(
    DeleteFunctionUrlConfigResponse * const q) : LambdaResponsePrivate(q)
{

}

/*!
 * Parses a Lambda DeleteFunctionUrlConfig response element from \a xml.
 */
void DeleteFunctionUrlConfigResponsePrivate::parseDeleteFunctionUrlConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteFunctionUrlConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
