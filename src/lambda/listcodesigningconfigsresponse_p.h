...
class QTAWS_EXPORT ListCodeSigningConfigsResponsePrivate : public LambdaResponsePrivate {

public:

    ListCodeSigningConfigsResponsePrivate(ListCodeSigningConfigsResponse * const q);
