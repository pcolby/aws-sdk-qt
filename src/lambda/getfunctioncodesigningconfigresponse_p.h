...
class QTAWS_EXPORT GetFunctionCodeSigningConfigResponsePrivate : public LambdaResponsePrivate {

public:

    GetFunctionCodeSigningConfigResponsePrivate(GetFunctionCodeSigningConfigResponse * const q);
