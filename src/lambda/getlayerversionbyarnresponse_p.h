...
class QTAWS_EXPORT GetLayerVersionByArnResponsePrivate : public LambdaResponsePrivate {

public:

    GetLayerVersionByArnResponsePrivate(GetLayerVersionByArnResponse * const q);
