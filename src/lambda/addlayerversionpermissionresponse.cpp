...
#include "addlayerversionpermissionresponse_p.h"
...
/*!
 * \class QtAws::Lambda::AddLayerVersionPermissionResponse
 * \brief The AddLayerVersionPermissionResponse class provides an interace for Lambda AddLayerVersionPermission responses.
 *
...
/*!
 * Constructs a AddLayerVersionPermissionResponse object for \a reply to \a request, with parent \a parent.
 */
AddLayerVersionPermissionResponse::AddLayerVersionPermissionResponse(
    ...
    : LambdaResponse(new AddLayerVersionPermissionResponsePrivate(this), parent)
{
    setRequest(new AddLayerVersionPermissionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Lambda AddLayerVersionPermission \a response.
 */
void AddLayerVersionPermissionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AddLayerVersionPermissionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Lambda::AddLayerVersionPermissionResponsePrivate
 * \brief The AddLayerVersionPermissionResponsePrivate class provides private implementation for AddLayerVersionPermissionResponse.
 * \internal
 *
 * \inmodule QtAwsLambda
 */
...
/*!
 * Constructs a AddLayerVersionPermissionResponsePrivate object with public implementation \a q.
 */
AddLayerVersionPermissionResponsePrivate::AddLayerVersionPermissionResponsePrivate(
    AddLayerVersionPermissionResponse * const q) : LambdaResponsePrivate(q)
{

}

/*!
 * Parses a Lambda AddLayerVersionPermission response element from \a xml.
 */
void AddLayerVersionPermissionResponsePrivate::parseAddLayerVersionPermissionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AddLayerVersionPermissionResponse"));
    Q_UNUSED(xml) ///< @todo
}
