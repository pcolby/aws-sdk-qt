...
#include "getfunctionconcurrencyrequest_p.h"
...
/*!
 * \class QtAws::Lambda::GetFunctionConcurrencyRequest
 * \brief The GetFunctionConcurrencyRequest class provides an interface for Lambda GetFunctionConcurrency requests.
 *
 ...
 */
GetFunctionConcurrencyRequest::GetFunctionConcurrencyRequest(const GetFunctionConcurrencyRequest &other)
    : LambdaRequest(new GetFunctionConcurrencyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetFunctionConcurrencyRequest object.
 */
GetFunctionConcurrencyRequest::GetFunctionConcurrencyRequest()
    : LambdaRequest(new GetFunctionConcurrencyRequestPrivate(LambdaRequest::GetFunctionConcurrencyAction, this))
{
 ...
 * \reimp
 */
bool GetFunctionConcurrencyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetFunctionConcurrencyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetFunctionConcurrencyRequest::response(QNetworkReply * const reply) const
{
    return new GetFunctionConcurrencyResponse(*this, reply);
}

/*!
 * \class QtAws::Lambda::GetFunctionConcurrencyRequestPrivate
 * \brief The GetFunctionConcurrencyRequestPrivate class provides private implementation for GetFunctionConcurrencyRequest.
 * \internal
 *
 * \inmodule QtAwsLambda
 */
...
/*!
 * Constructs a GetFunctionConcurrencyRequestPrivate object for Lambda \a action,
 * with public implementation \a q.
 */
GetFunctionConcurrencyRequestPrivate::GetFunctionConcurrencyRequestPrivate(
    const LambdaRequest::Action action, GetFunctionConcurrencyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetFunctionConcurrencyRequest
 * class' copy constructor.
 */
GetFunctionConcurrencyRequestPrivate::GetFunctionConcurrencyRequestPrivate(
    const GetFunctionConcurrencyRequestPrivate &other, GetFunctionConcurrencyRequest * const q)
