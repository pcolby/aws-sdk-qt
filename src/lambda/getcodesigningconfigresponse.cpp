...
#include "getcodesigningconfigresponse_p.h"
...
/*!
 * \class QtAws::Lambda::GetCodeSigningConfigResponse
 * \brief The GetCodeSigningConfigResponse class provides an interace for Lambda GetCodeSigningConfig responses.
 *
...
/*!
 * Constructs a GetCodeSigningConfigResponse object for \a reply to \a request, with parent \a parent.
 */
GetCodeSigningConfigResponse::GetCodeSigningConfigResponse(
        const GetCodeSigningConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : LambdaResponse(new GetCodeSigningConfigResponsePrivate(this), parent)
{
    setRequest(new GetCodeSigningConfigRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetCodeSigningConfigRequest * GetCodeSigningConfigResponse::request() const
{
    Q_D(const GetCodeSigningConfigResponse);
    return static_cast<const GetCodeSigningConfigRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Lambda GetCodeSigningConfig \a response.
 */
void GetCodeSigningConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetCodeSigningConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Lambda::GetCodeSigningConfigResponsePrivate
 * \brief The GetCodeSigningConfigResponsePrivate class provides private implementation for GetCodeSigningConfigResponse.
 * \internal
 *
 * \inmodule QtAwsLambda
 */
...
/*!
 * Constructs a GetCodeSigningConfigResponsePrivate object with public implementation \a q.
 */
GetCodeSigningConfigResponsePrivate::GetCodeSigningConfigResponsePrivate(
    GetCodeSigningConfigResponse * const q) : LambdaResponsePrivate(q)
{

}

/*!
 * Parses a Lambda GetCodeSigningConfig response element from \a xml.
 */
void GetCodeSigningConfigResponsePrivate::parseGetCodeSigningConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetCodeSigningConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
