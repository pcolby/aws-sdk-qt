...
class QTAWS_EXPORT CreateLicenseManagerReportGeneratorResponsePrivate : public LicenseManagerResponsePrivate {

public:

    CreateLicenseManagerReportGeneratorResponsePrivate(CreateLicenseManagerReportGeneratorResponse * const q);
