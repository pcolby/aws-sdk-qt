...
/*!
 * \class QtAws::LicenseManager::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for LicenseManager UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : LicenseManagerResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(LicenseManagerResponse::request());
}

/*!
 * \reimp
 * Parses a successful LicenseManager UntagResource \a response.
 */
...
/*!
 * \class QtAws::LicenseManager::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : LicenseManagerResponsePrivate(q)
{

}

/*!
 * Parses a LicenseManager UntagResource response element from \a xml.
 */
