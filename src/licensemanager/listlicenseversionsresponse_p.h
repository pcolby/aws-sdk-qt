...
class QTAWS_EXPORT ListLicenseVersionsResponsePrivate : public LicenseManagerResponsePrivate {

public:

    ListLicenseVersionsResponsePrivate(ListLicenseVersionsResponse * const q);
