...
class QTAWS_EXPORT CreateLicenseConfigurationResponsePrivate : public LicenseManagerResponsePrivate {

public:

    CreateLicenseConfigurationResponsePrivate(CreateLicenseConfigurationResponse * const q);
