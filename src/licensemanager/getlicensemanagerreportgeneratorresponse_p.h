...
class QTAWS_EXPORT GetLicenseManagerReportGeneratorResponsePrivate : public LicenseManagerResponsePrivate {

public:

    GetLicenseManagerReportGeneratorResponsePrivate(GetLicenseManagerReportGeneratorResponse * const q);
