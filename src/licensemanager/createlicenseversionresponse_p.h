...
class QTAWS_EXPORT CreateLicenseVersionResponsePrivate : public LicenseManagerResponsePrivate {

public:

    CreateLicenseVersionResponsePrivate(CreateLicenseVersionResponse * const q);
