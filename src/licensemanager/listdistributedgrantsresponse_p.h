...
class QTAWS_EXPORT ListDistributedGrantsResponsePrivate : public LicenseManagerResponsePrivate {

public:

    ListDistributedGrantsResponsePrivate(ListDistributedGrantsResponse * const q);
