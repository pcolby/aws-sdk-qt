...
class QTAWS_EXPORT ListReceivedGrantsResponsePrivate : public LicenseManagerResponsePrivate {

public:

    ListReceivedGrantsResponsePrivate(ListReceivedGrantsResponse * const q);
