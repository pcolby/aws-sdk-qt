...
class QTAWS_EXPORT ListLicenseConfigurationsResponsePrivate : public LicenseManagerResponsePrivate {

public:

    ListLicenseConfigurationsResponsePrivate(ListLicenseConfigurationsResponse * const q);
