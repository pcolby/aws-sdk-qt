...
/*!
 * \class QtAws::LicenseManager::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for LicenseManager TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : LicenseManagerResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(LicenseManagerResponse::request());
}

/*!
 * \reimp
 * Parses a successful LicenseManager TagResource \a response.
 */
...
/*!
 * \class QtAws::LicenseManager::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : LicenseManagerResponsePrivate(q)
{

}

/*!
 * Parses a LicenseManager TagResource response element from \a xml.
 */
