...
class QTAWS_EXPORT UpdateMultiplexProgramResponsePrivate : public MediaLiveResponsePrivate {

public:

    UpdateMultiplexProgramResponsePrivate(UpdateMultiplexProgramResponse * const q);
