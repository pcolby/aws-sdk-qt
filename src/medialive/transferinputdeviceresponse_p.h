...
class QTAWS_EXPORT TransferInputDeviceResponsePrivate : public MediaLiveResponsePrivate {

public:

    TransferInputDeviceResponsePrivate(TransferInputDeviceResponse * const q);
