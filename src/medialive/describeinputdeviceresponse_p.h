...
class QTAWS_EXPORT DescribeInputDeviceResponsePrivate : public MediaLiveResponsePrivate {

public:

    DescribeInputDeviceResponsePrivate(DescribeInputDeviceResponse * const q);
