...
/*!
 * \class QtAws::MediaLive::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for MediaLive ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : MediaLiveResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(MediaLiveResponse::request());
}

/*!
 * \reimp
 * Parses a successful MediaLive ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::MediaLive::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : MediaLiveResponsePrivate(q)
{

}

/*!
 * Parses a MediaLive ListTagsForResource response element from \a xml.
 */
