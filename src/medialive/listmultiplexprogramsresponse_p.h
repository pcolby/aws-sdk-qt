...
class QTAWS_EXPORT ListMultiplexProgramsResponsePrivate : public MediaLiveResponsePrivate {

public:

    ListMultiplexProgramsResponsePrivate(ListMultiplexProgramsResponse * const q);
