...
class QTAWS_EXPORT RejectInputDeviceTransferResponsePrivate : public MediaLiveResponsePrivate {

public:

    RejectInputDeviceTransferResponsePrivate(RejectInputDeviceTransferResponse * const q);
