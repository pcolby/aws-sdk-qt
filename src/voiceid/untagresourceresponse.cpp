...
/*!
 * \class QtAws::VoiceId::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for VoiceId UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : VoiceIdResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful VoiceId UntagResource \a response.
 */
...
/*!
 * \class QtAws::VoiceId::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : VoiceIdResponsePrivate(q)
{

}

/*!
 * Parses a VoiceId UntagResource response element from \a xml.
 */
