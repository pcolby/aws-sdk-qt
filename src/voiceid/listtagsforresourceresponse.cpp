...
/*!
 * \class QtAws::VoiceId::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for VoiceId ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : VoiceIdResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful VoiceId ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::VoiceId::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : VoiceIdResponsePrivate(q)
{

}

/*!
 * Parses a VoiceId ListTagsForResource response element from \a xml.
 */
