...
/*!
 * \class QtAws::VoiceId::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for VoiceId TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : VoiceIdResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful VoiceId TagResource \a response.
 */
...
/*!
 * \class QtAws::VoiceId::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : VoiceIdResponsePrivate(q)
{

}

/*!
 * Parses a VoiceId TagResource response element from \a xml.
 */
