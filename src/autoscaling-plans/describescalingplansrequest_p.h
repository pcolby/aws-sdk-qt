...
class QTAWS_EXPORT DescribeScalingPlansRequestPrivate : public AutoScalingPlansPrivate {

public:
    DescribeScalingPlansRequestPrivate(const AutoScalingPlans::Action action,
