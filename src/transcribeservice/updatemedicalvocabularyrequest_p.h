...
class QTAWS_EXPORT UpdateMedicalVocabularyRequestPrivate : public TranscribeServiceRequestPrivate {

public:
    UpdateMedicalVocabularyRequestPrivate(const TranscribeServiceRequest::Action action,
