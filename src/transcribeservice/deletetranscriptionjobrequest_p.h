...
class QTAWS_EXPORT DeleteTranscriptionJobRequestPrivate : public TranscribeServiceRequestPrivate {

public:
    DeleteTranscriptionJobRequestPrivate(const TranscribeServiceRequest::Action action,
