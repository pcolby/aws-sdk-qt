...
/*!
 * \class QtAws::TranscribeService::CreateLanguageModelRequest
 * \brief The CreateLanguageModelRequest class provides an interface for TranscribeService CreateLanguageModel requests.
 *
...
CreateLanguageModelRequest::CreateLanguageModelRequest(const CreateLanguageModelRequest &other)
    : TranscribeServiceRequest(new CreateLanguageModelRequestPrivate(*other.d_func(), this))
{
...
CreateLanguageModelRequest::CreateLanguageModelRequest()
    : TranscribeServiceRequest(new CreateLanguageModelRequestPrivate(TranscribeServiceRequest::CreateLanguageModelAction, this))
{
...
/*!
 * \class QtAws::TranscribeService::CreateLanguageModelRequestPrivate
...
/*!
 * Constructs a CreateLanguageModelRequestPrivate object for TranscribeService \a action,
 * with public implementation \a q.
 */
CreateLanguageModelRequestPrivate::CreateLanguageModelRequestPrivate(
    const TranscribeServiceRequest::Action action, CreateLanguageModelRequest * const q)
