...
class QTAWS_EXPORT ListMedicalTranscriptionJobsResponsePrivate : public TranscribeServiceResponsePrivate {

public:

    ListMedicalTranscriptionJobsResponsePrivate(ListMedicalTranscriptionJobsResponse * const q);
