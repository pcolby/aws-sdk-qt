...
class QTAWS_EXPORT UpdateVocabularyFilterResponsePrivate : public TranscribeServiceResponsePrivate {

public:

    UpdateVocabularyFilterResponsePrivate(UpdateVocabularyFilterResponse * const q);
