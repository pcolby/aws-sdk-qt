...
class QTAWS_EXPORT CreateMedicalVocabularyRequestPrivate : public TranscribeServiceRequestPrivate {

public:
    CreateMedicalVocabularyRequestPrivate(const TranscribeServiceRequest::Action action,
