...
class QTAWS_EXPORT CreateLanguageModelResponsePrivate : public TranscribeServiceResponsePrivate {

public:

    CreateLanguageModelResponsePrivate(CreateLanguageModelResponse * const q);
