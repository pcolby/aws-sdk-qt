...
class QTAWS_EXPORT ListMedicalVocabulariesRequestPrivate : public TranscribeServiceRequestPrivate {

public:
    ListMedicalVocabulariesRequestPrivate(const TranscribeServiceRequest::Action action,
