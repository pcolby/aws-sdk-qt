...
#ifndef QTAWS_TRANSCRIBESERVICEREQUEST_H
#define QTAWS_TRANSCRIBESERVICEREQUEST_H
...
class QTAWSTRANSCRIBESERVICE_EXPORT TranscribeServiceRequest : public QtAws::Core::AwsAbstractRequest {
...
public:
    ...
    TranscribeServiceRequest(const Action action);
    TranscribeServiceRequest(const TranscribeServiceRequest &other);
    TranscribeServiceRequest &operator=(const TranscribeServiceRequest &other);
    ...
    virtual bool operator==(const TranscribeServiceRequest &other) const;
...
private:
    Q_DECLARE_PRIVATE(TranscribeServiceRequest)
