...
class QTAWS_EXPORT DescribeLanguageModelResponsePrivate : public TranscribeServiceResponsePrivate {

public:

    DescribeLanguageModelResponsePrivate(DescribeLanguageModelResponse * const q);
