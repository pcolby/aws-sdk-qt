...
class QTAWS_EXPORT ListLanguageModelsRequestPrivate : public TranscribeServiceRequestPrivate {

public:
    ListLanguageModelsRequestPrivate(const TranscribeServiceRequest::Action action,
