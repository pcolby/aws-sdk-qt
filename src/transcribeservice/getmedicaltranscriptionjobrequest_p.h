...
class QTAWS_EXPORT GetMedicalTranscriptionJobRequestPrivate : public TranscribeServiceRequestPrivate {

public:
    GetMedicalTranscriptionJobRequestPrivate(const TranscribeServiceRequest::Action action,
