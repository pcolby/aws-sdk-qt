...
class QTAWSTRANSCRIBESERVICE_EXPORT ListTranscriptionJobsResponse : public TranscribeServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListTranscriptionJobsRequest * request() const Q_DECL_OVERRIDE;
