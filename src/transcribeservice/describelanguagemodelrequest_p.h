...
class QTAWS_EXPORT DescribeLanguageModelRequestPrivate : public TranscribeServiceRequestPrivate {

public:
    DescribeLanguageModelRequestPrivate(const TranscribeServiceRequest::Action action,
