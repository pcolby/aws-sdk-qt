...
class QTAWS_EXPORT GetMedicalTranscriptionJobResponsePrivate : public TranscribeServiceResponsePrivate {

public:

    GetMedicalTranscriptionJobResponsePrivate(GetMedicalTranscriptionJobResponse * const q);
