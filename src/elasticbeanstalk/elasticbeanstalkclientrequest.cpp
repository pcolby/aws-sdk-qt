...
/**
 * @brief  Constructs a new ElasticBeanstalkClientRequest object.
 *
...
/**
 * @brief  Constructs a new ElasticBeanstalkClientRequest object by copying another.
 *
 ...
 */
ElasticBeanstalkClientRequest& ElasticBeanstalkClientRequest::operator=(const ElasticBeanstalkClientRequest &other)
{
    Q_D(ElasticBeanstalkClientRequest);
 ...
 * implementation that inherits from ElasticBeanstalkClientRequestPrivate.
 *
 ...
 */
ElasticBeanstalkClientRequest::Action ElasticBeanstalkClientRequest::action() const
{
    Q_D(const ElasticBeanstalkClientRequest);
    return d->action;
}
 ...
 */
QString ElasticBeanstalkClientRequest::actionString() const
{
    return ElasticBeanstalkClientRequestPrivate::toString(action());
}
 ...
 */
QString ElasticBeanstalkClientRequest::apiVersion() const
{
    Q_D(const ElasticBeanstalkClientRequest);
    return d->apiVersion;
}
 ...
 */
void ElasticBeanstalkClientRequest::setAction(const Action action)
{
    Q_D(ElasticBeanstalkClientRequest);
    d->action = action;
}
 ...
 */
void ElasticBeanstalkClientRequest::setApiVersion(const QString &version)
{
    Q_D(ElasticBeanstalkClientRequest);
 ...
 */
bool ElasticBeanstalkClientRequest::operator==(const ElasticBeanstalkClientRequest &other) const
{
 ...
 */
bool ElasticBeanstalkClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int ElasticBeanstalkClientRequest::clearParameter(const QString &name)
{
    Q_D(ElasticBeanstalkClientRequest);
 ...
 */
void ElasticBeanstalkClientRequest::clearParameters()
{
    Q_D(ElasticBeanstalkClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant ElasticBeanstalkClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const ElasticBeanstalkClientRequest);
 ...
 */
const QVariantMap &ElasticBeanstalkClientRequest::parameters() const
{
    Q_D(const ElasticBeanstalkClientRequest);
    return d->parameters;
}
 ...
 */
void ElasticBeanstalkClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(ElasticBeanstalkClientRequest);
 ...
 */
void ElasticBeanstalkClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(ElasticBeanstalkClientRequest);
 ...
 */
QNetworkRequest ElasticBeanstalkClientRequest::unsignedRequest(const QUrl &endpoint) const
{
    Q_D(const ElasticBeanstalkClientRequest);
    QUrl url(endpoint);
 ...
 *
 * @brief  Private implementation for ElasticBeanstalkClientRequest.
 */

/**
 * @internal
 *
 * @brief  Constructs a new ElasticBeanstalkClientRequestPrivate object.
 *
 ...
 * @internal
 *
 * @brief  Constructs a new ElasticBeanstalkClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the ElasticBeanstalkClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public ElasticBeanstalkClientRequest instance.
 */
 ...
 *
 * This function converts ElasticBeanstalkClientRequest::Action enumerator values to their respective
 ...
 */
QString ElasticBeanstalkClientRequestPrivate::toString(const ElasticBeanstalkClientRequest::Action &action)
{
    #define ActionToString(action) \
        case ElasticBeanstalkClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
