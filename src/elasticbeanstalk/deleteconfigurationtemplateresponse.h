...
class QTAWS_EXPORT DeleteConfigurationTemplateResponse : public DeleteConfigurationTemplateResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteConfigurationTemplateRequest * request() const;
