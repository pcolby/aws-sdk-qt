...
class QTAWS_EXPORT ElasticBeanstalkResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {
    Q_OBJECT

public:

    ElasticBeanstalkResponsePrivate(ElasticBeanstalkResponse * const q);
