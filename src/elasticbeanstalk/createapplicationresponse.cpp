 ...
 *
 * @brief  Handles ElasticBeanstalk CreateApplication responses.
 *
...
/**
 * @brief  Parse a ElasticBeanstalk CreateApplication response.
 *
...
/**
 * @brief  Parse an ElasticBeanstalk CreateApplicationResponse element.
 *
