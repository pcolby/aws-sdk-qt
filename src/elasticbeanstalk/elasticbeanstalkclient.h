...
public slots:
    ...
    AssociateEnvironmentOperationsRoleResponse * associateEnvironmentOperationsRole(const AssociateEnvironmentOperationsRoleRequest &request);
    ...
    DisassociateEnvironmentOperationsRoleResponse * disassociateEnvironmentOperationsRole(const DisassociateEnvironmentOperationsRoleRequest &request);
    ...
    ListPlatformBranchesResponse * listPlatformBranches(const ListPlatformBranchesRequest &request);
