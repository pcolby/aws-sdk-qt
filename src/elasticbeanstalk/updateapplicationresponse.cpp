 ...
 *
 * @brief  Handles ElasticBeanstalk UpdateApplication responses.
 *
...
/**
 * @brief  Parse a ElasticBeanstalk UpdateApplication response.
 *
...
/**
 * @brief  Parse an ElasticBeanstalk UpdateApplicationResponse element.
 *
