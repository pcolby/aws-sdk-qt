...
class QTAWSLEXRUNTIMEV2_EXPORT LexRuntimeV2Request : public QtAws::Core::AwsAbstractRequest {
...
protected:
    ...
    explicit LexRuntimeV2Request(LexRuntimeV2RequestPrivate * const d);
    /// @endcond
