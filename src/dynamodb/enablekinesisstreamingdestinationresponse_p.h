...
class QTAWS_EXPORT EnableKinesisStreamingDestinationResponsePrivate : public DynamoDBResponsePrivate {

public:

    EnableKinesisStreamingDestinationResponsePrivate(EnableKinesisStreamingDestinationResponse * const q);
