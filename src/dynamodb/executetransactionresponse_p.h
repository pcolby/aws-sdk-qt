...
class QTAWS_EXPORT ExecuteTransactionResponsePrivate : public DynamoDBResponsePrivate {

public:

    ExecuteTransactionResponsePrivate(ExecuteTransactionResponse * const q);
