...
class QTAWS_EXPORT ListContributorInsightsResponsePrivate : public DynamoDBResponsePrivate {

public:

    ListContributorInsightsResponsePrivate(ListContributorInsightsResponse * const q);
