 ...
 *
 * @brief  Handles DynamoDB TagResource responses.
 *
 * @see    DynamoDBClient::tagResource
 */
...
/**
 * @brief  Parse a DynamoDB TagResource response.
 *
...
/**
 * @brief  Parse an DynamoDB TagResourceResponse element.
 *
