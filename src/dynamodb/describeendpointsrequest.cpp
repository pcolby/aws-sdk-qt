...
/*!
 * \class QtAws::DynamoDB::DescribeEndpointsRequest
 * \brief The DescribeEndpointsRequest class provides an interface for DynamoDB DescribeEndpoints requests.
 *
...
DescribeEndpointsRequest::DescribeEndpointsRequest(const DescribeEndpointsRequest &other)
    : DynamoDBRequest(new DescribeEndpointsRequestPrivate(*other.d_func(), this))
{
...
DescribeEndpointsRequest::DescribeEndpointsRequest()
    : DynamoDBRequest(new DescribeEndpointsRequestPrivate(DynamoDBRequest::DescribeEndpointsAction, this))
{
...
/*!
 * \class QtAws::DynamoDB::DescribeEndpointsRequestPrivate
...
/*!
 * Constructs a DescribeEndpointsRequestPrivate object for DynamoDB \a action,
 * with public implementation \a q.
 */
DescribeEndpointsRequestPrivate::DescribeEndpointsRequestPrivate(
    const DynamoDBRequest::Action action, DescribeEndpointsRequest * const q)
