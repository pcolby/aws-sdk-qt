...
class QTAWS_EXPORT DescribeFleetLocationAttributesResponsePrivate : public GameLiftResponsePrivate {

public:

    DescribeFleetLocationAttributesResponsePrivate(DescribeFleetLocationAttributesResponse * const q);
