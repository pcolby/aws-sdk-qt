...
#include "describescriptresponse_p.h"
...
/*!
 * \class QtAws::GameLift::DescribeScriptResponse
 * \brief The DescribeScriptResponse class provides an interace for GameLift DescribeScript responses.
 *
...
/*!
 * Constructs a DescribeScriptResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeScriptResponse::DescribeScriptResponse(
        const DescribeScriptRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new DescribeScriptResponsePrivate(this), parent)
{
    setRequest(new DescribeScriptRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GameLift DescribeScript \a response.
 */
void DescribeScriptResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeScriptResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::DescribeScriptResponsePrivate
 * \brief The DescribeScriptResponsePrivate class provides private implementation for DescribeScriptResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DescribeScriptResponsePrivate object with public implementation \a q.
 */
DescribeScriptResponsePrivate::DescribeScriptResponsePrivate(
    DescribeScriptResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift DescribeScript response element from \a xml.
 */
void DescribeScriptResponsePrivate::parseDescribeScriptResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeScriptResponse"));
    Q_UNUSED(xml) ///< @todo
}
