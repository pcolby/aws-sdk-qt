...
#include "deregistergameserverrequest_p.h"
...
/*!
 * \class QtAws::GameLift::DeregisterGameServerRequest
 * \brief The DeregisterGameServerRequest class provides an interface for GameLift DeregisterGameServer requests.
 *
 ...
 *  resources</a>
 *
 * \sa GameLiftClient::deregisterGameServer
 */

/*!
 * Constructs a copy of \a other.
 */
DeregisterGameServerRequest::DeregisterGameServerRequest(const DeregisterGameServerRequest &other)
    : GameLiftRequest(new DeregisterGameServerRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeregisterGameServerRequest object.
 */
DeregisterGameServerRequest::DeregisterGameServerRequest()
    : GameLiftRequest(new DeregisterGameServerRequestPrivate(GameLiftRequest::DeregisterGameServerAction, this))
{
 ...
 * \reimp
 */
bool DeregisterGameServerRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeregisterGameServerResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeregisterGameServerRequest::response(QNetworkReply * const reply) const
{
    return new DeregisterGameServerResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::DeregisterGameServerRequestPrivate
 * \brief The DeregisterGameServerRequestPrivate class provides private implementation for DeregisterGameServerRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DeregisterGameServerRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
DeregisterGameServerRequestPrivate::DeregisterGameServerRequestPrivate(
    const GameLiftRequest::Action action, DeregisterGameServerRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeregisterGameServerRequest
 * class' copy constructor.
 */
DeregisterGameServerRequestPrivate::DeregisterGameServerRequestPrivate(
    const DeregisterGameServerRequestPrivate &other, DeregisterGameServerRequest * const q)
