...
#include "registergameserverrequest_p.h"
...
/*!
 * \class QtAws::GameLift::RegisterGameServerRequest
 * \brief The RegisterGameServerRequest class provides an interface for GameLift RegisterGameServer requests.
 *
 ...
 */
RegisterGameServerRequest::RegisterGameServerRequest(const RegisterGameServerRequest &other)
    : GameLiftRequest(new RegisterGameServerRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a RegisterGameServerRequest object.
 */
RegisterGameServerRequest::RegisterGameServerRequest()
    : GameLiftRequest(new RegisterGameServerRequestPrivate(GameLiftRequest::RegisterGameServerAction, this))
{
 ...
 * \reimp
 */
bool RegisterGameServerRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a RegisterGameServerResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * RegisterGameServerRequest::response(QNetworkReply * const reply) const
{
    return new RegisterGameServerResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::RegisterGameServerRequestPrivate
 * \brief The RegisterGameServerRequestPrivate class provides private implementation for RegisterGameServerRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a RegisterGameServerRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
RegisterGameServerRequestPrivate::RegisterGameServerRequestPrivate(
    const GameLiftRequest::Action action, RegisterGameServerRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the RegisterGameServerRequest
 * class' copy constructor.
 */
RegisterGameServerRequestPrivate::RegisterGameServerRequestPrivate(
    const RegisterGameServerRequestPrivate &other, RegisterGameServerRequest * const q)
