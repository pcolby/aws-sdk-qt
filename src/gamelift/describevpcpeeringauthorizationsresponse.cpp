 ...
 *
 * \brief The DescribeVpcPeeringAuthorizationsResponse class encapsulates GameLift DescribeVpcPeeringAuthorizations responses.
 *
 * \ingroup GameLift
 *
...
{
    Q_D(DescribeVpcPeeringAuthorizationsResponse);
