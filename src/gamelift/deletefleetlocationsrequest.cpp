...
#include "deletefleetlocationsrequest_p.h"
...
/*!
 * \class QtAws::GameLift::DeleteFleetLocationsRequest
 * \brief The DeleteFleetLocationsRequest class provides an interface for GameLift DeleteFleetLocations requests.
 *
 ...
 *  resources</a>
 *
 * \sa GameLiftClient::deleteFleetLocations
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteFleetLocationsRequest::DeleteFleetLocationsRequest(const DeleteFleetLocationsRequest &other)
    : GameLiftRequest(new DeleteFleetLocationsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteFleetLocationsRequest object.
 */
DeleteFleetLocationsRequest::DeleteFleetLocationsRequest()
    : GameLiftRequest(new DeleteFleetLocationsRequestPrivate(GameLiftRequest::DeleteFleetLocationsAction, this))
{
 ...
 * \reimp
 */
bool DeleteFleetLocationsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteFleetLocationsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteFleetLocationsRequest::response(QNetworkReply * const reply) const
{
    return new DeleteFleetLocationsResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::DeleteFleetLocationsRequestPrivate
 * \brief The DeleteFleetLocationsRequestPrivate class provides private implementation for DeleteFleetLocationsRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DeleteFleetLocationsRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
DeleteFleetLocationsRequestPrivate::DeleteFleetLocationsRequestPrivate(
    const GameLiftRequest::Action action, DeleteFleetLocationsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteFleetLocationsRequest
 * class' copy constructor.
 */
DeleteFleetLocationsRequestPrivate::DeleteFleetLocationsRequestPrivate(
    const DeleteFleetLocationsRequestPrivate &other, DeleteFleetLocationsRequest * const q)
