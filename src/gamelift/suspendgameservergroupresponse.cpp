...
#include "suspendgameservergroupresponse_p.h"
...
/*!
 * \class QtAws::GameLift::SuspendGameServerGroupResponse
 * \brief The SuspendGameServerGroupResponse class provides an interace for GameLift SuspendGameServerGroup responses.
 *
...
/*!
 * Constructs a SuspendGameServerGroupResponse object for \a reply to \a request, with parent \a parent.
 */
SuspendGameServerGroupResponse::SuspendGameServerGroupResponse(
        const SuspendGameServerGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new SuspendGameServerGroupResponsePrivate(this), parent)
{
    setRequest(new SuspendGameServerGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GameLift SuspendGameServerGroup \a response.
 */
void SuspendGameServerGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(SuspendGameServerGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::SuspendGameServerGroupResponsePrivate
 * \brief The SuspendGameServerGroupResponsePrivate class provides private implementation for SuspendGameServerGroupResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a SuspendGameServerGroupResponsePrivate object with public implementation \a q.
 */
SuspendGameServerGroupResponsePrivate::SuspendGameServerGroupResponsePrivate(
    SuspendGameServerGroupResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift SuspendGameServerGroup response element from \a xml.
 */
void SuspendGameServerGroupResponsePrivate::parseSuspendGameServerGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("SuspendGameServerGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
