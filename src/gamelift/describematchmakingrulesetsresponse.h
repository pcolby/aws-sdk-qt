...
class QTAWS_EXPORT DescribeMatchmakingRuleSetsResponse : public DescribeMatchmakingRuleSetsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeMatchmakingRuleSetsRequest * request() const;
