...
class QTAWS_EXPORT DescribeGameServerResponsePrivate : public GameLiftResponsePrivate {

public:

    DescribeGameServerResponsePrivate(DescribeGameServerResponse * const q);
