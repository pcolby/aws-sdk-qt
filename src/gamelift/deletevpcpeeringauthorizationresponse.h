...
class QTAWS_EXPORT DeleteVpcPeeringAuthorizationResponse : public GameLiftResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteVpcPeeringAuthorizationRequest * request() const override;
