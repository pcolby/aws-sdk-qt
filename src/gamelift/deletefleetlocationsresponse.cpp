...
#include "deletefleetlocationsresponse_p.h"
...
/*!
 * \class QtAws::GameLift::DeleteFleetLocationsResponse
 * \brief The DeleteFleetLocationsResponse class provides an interace for GameLift DeleteFleetLocations responses.
 *
...
/*!
 * Constructs a DeleteFleetLocationsResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteFleetLocationsResponse::DeleteFleetLocationsResponse(
        const DeleteFleetLocationsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new DeleteFleetLocationsResponsePrivate(this), parent)
{
    setRequest(new DeleteFleetLocationsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GameLift DeleteFleetLocations \a response.
 */
void DeleteFleetLocationsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteFleetLocationsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::DeleteFleetLocationsResponsePrivate
 * \brief The DeleteFleetLocationsResponsePrivate class provides private implementation for DeleteFleetLocationsResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DeleteFleetLocationsResponsePrivate object with public implementation \a q.
 */
DeleteFleetLocationsResponsePrivate::DeleteFleetLocationsResponsePrivate(
    DeleteFleetLocationsResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift DeleteFleetLocations response element from \a xml.
 */
void DeleteFleetLocationsResponsePrivate::parseDeleteFleetLocationsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteFleetLocationsResponse"));
    Q_UNUSED(xml) ///< @todo
}
