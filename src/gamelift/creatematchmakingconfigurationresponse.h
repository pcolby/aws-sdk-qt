...
class QTAWS_EXPORT CreateMatchmakingConfigurationResponse : public GameLiftResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateMatchmakingConfigurationRequest * request() const override;
