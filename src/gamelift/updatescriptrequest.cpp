...
#include "updatescriptrequest_p.h"
...
/*!
 * \class QtAws::GameLift::UpdateScriptRequest
 * \brief The UpdateScriptRequest class provides an interface for GameLift UpdateScript requests.
 *
 ...
 */
UpdateScriptRequest::UpdateScriptRequest(const UpdateScriptRequest &other)
    : GameLiftRequest(new UpdateScriptRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateScriptRequest object.
 */
UpdateScriptRequest::UpdateScriptRequest()
    : GameLiftRequest(new UpdateScriptRequestPrivate(GameLiftRequest::UpdateScriptAction, this))
{
 ...
 * \reimp
 */
bool UpdateScriptRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateScriptResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateScriptRequest::response(QNetworkReply * const reply) const
{
    return new UpdateScriptResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::UpdateScriptRequestPrivate
 * \brief The UpdateScriptRequestPrivate class provides private implementation for UpdateScriptRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a UpdateScriptRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
UpdateScriptRequestPrivate::UpdateScriptRequestPrivate(
    const GameLiftRequest::Action action, UpdateScriptRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateScriptRequest
 * class' copy constructor.
 */
UpdateScriptRequestPrivate::UpdateScriptRequestPrivate(
    const UpdateScriptRequestPrivate &other, UpdateScriptRequest * const q)
