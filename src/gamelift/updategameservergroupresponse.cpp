...
#include "updategameservergroupresponse_p.h"
...
/*!
 * \class QtAws::GameLift::UpdateGameServerGroupResponse
 * \brief The UpdateGameServerGroupResponse class provides an interace for GameLift UpdateGameServerGroup responses.
 *
 ...
 *  resources</a>
 *
 * \sa GameLiftClient::updateGameServerGroup
 */

/*!
 * Constructs a UpdateGameServerGroupResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateGameServerGroupResponse::UpdateGameServerGroupResponse(
        const UpdateGameServerGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new UpdateGameServerGroupResponsePrivate(this), parent)
{
    setRequest(new UpdateGameServerGroupRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateGameServerGroupRequest * UpdateGameServerGroupResponse::request() const
{
    Q_D(const UpdateGameServerGroupResponse);
    return static_cast<const UpdateGameServerGroupRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GameLift UpdateGameServerGroup \a response.
 */
void UpdateGameServerGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateGameServerGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::UpdateGameServerGroupResponsePrivate
 * \brief The UpdateGameServerGroupResponsePrivate class provides private implementation for UpdateGameServerGroupResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a UpdateGameServerGroupResponsePrivate object with public implementation \a q.
 */
UpdateGameServerGroupResponsePrivate::UpdateGameServerGroupResponsePrivate(
    UpdateGameServerGroupResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift UpdateGameServerGroup response element from \a xml.
 */
void UpdateGameServerGroupResponsePrivate::parseUpdateGameServerGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateGameServerGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
