...
/*!
 * \class QtAws::GameLift::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for GameLift UntagResource responses.
 *
 ...
 *  resources</a>
 *
 * \sa GameLiftClient::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : GameLiftResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(GameLiftResponse::request());
}

/*!
 * \reimp
 * Parses a successful GameLift UntagResource \a response.
 */
...
/*!
 * \class QtAws::GameLift::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift UntagResource response element from \a xml.
 */
