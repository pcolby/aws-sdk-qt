...
#include "describefleetlocationutilizationresponse_p.h"
...
/*!
 * \class QtAws::GameLift::DescribeFleetLocationUtilizationResponse
 * \brief The DescribeFleetLocationUtilizationResponse class provides an interace for GameLift DescribeFleetLocationUtilization responses.
 *
...
/*!
 * Constructs a DescribeFleetLocationUtilizationResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeFleetLocationUtilizationResponse::DescribeFleetLocationUtilizationResponse(
        const DescribeFleetLocationUtilizationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new DescribeFleetLocationUtilizationResponsePrivate(this), parent)
{
    setRequest(new DescribeFleetLocationUtilizationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GameLift DescribeFleetLocationUtilization \a response.
 */
void DescribeFleetLocationUtilizationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeFleetLocationUtilizationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::DescribeFleetLocationUtilizationResponsePrivate
 * \brief The DescribeFleetLocationUtilizationResponsePrivate class provides private implementation for DescribeFleetLocationUtilizationResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DescribeFleetLocationUtilizationResponsePrivate object with public implementation \a q.
 */
DescribeFleetLocationUtilizationResponsePrivate::DescribeFleetLocationUtilizationResponsePrivate(
    DescribeFleetLocationUtilizationResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift DescribeFleetLocationUtilization response element from \a xml.
 */
void DescribeFleetLocationUtilizationResponsePrivate::parseDescribeFleetLocationUtilizationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeFleetLocationUtilizationResponse"));
    Q_UNUSED(xml) ///< @todo
}
