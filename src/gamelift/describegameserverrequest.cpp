...
#include "describegameserverrequest_p.h"
...
/*!
 * \class QtAws::GameLift::DescribeGameServerRequest
 * \brief The DescribeGameServerRequest class provides an interface for GameLift DescribeGameServer requests.
 *
 ...
 */
DescribeGameServerRequest::DescribeGameServerRequest(const DescribeGameServerRequest &other)
    : GameLiftRequest(new DescribeGameServerRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeGameServerRequest object.
 */
DescribeGameServerRequest::DescribeGameServerRequest()
    : GameLiftRequest(new DescribeGameServerRequestPrivate(GameLiftRequest::DescribeGameServerAction, this))
{
 ...
 * \reimp
 */
bool DescribeGameServerRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeGameServerResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeGameServerRequest::response(QNetworkReply * const reply) const
{
    return new DescribeGameServerResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::DescribeGameServerRequestPrivate
 * \brief The DescribeGameServerRequestPrivate class provides private implementation for DescribeGameServerRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DescribeGameServerRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
DescribeGameServerRequestPrivate::DescribeGameServerRequestPrivate(
    const GameLiftRequest::Action action, DescribeGameServerRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeGameServerRequest
 * class' copy constructor.
 */
DescribeGameServerRequestPrivate::DescribeGameServerRequestPrivate(
    const DescribeGameServerRequestPrivate &other, DescribeGameServerRequest * const q)
