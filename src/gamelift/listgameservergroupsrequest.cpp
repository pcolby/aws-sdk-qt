...
#include "listgameservergroupsrequest_p.h"
...
/*!
 * \class QtAws::GameLift::ListGameServerGroupsRequest
 * \brief The ListGameServerGroupsRequest class provides an interface for GameLift ListGameServerGroups requests.
 *
 ...
 */
ListGameServerGroupsRequest::ListGameServerGroupsRequest(const ListGameServerGroupsRequest &other)
    : GameLiftRequest(new ListGameServerGroupsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListGameServerGroupsRequest object.
 */
ListGameServerGroupsRequest::ListGameServerGroupsRequest()
    : GameLiftRequest(new ListGameServerGroupsRequestPrivate(GameLiftRequest::ListGameServerGroupsAction, this))
{
 ...
 * \reimp
 */
bool ListGameServerGroupsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListGameServerGroupsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListGameServerGroupsRequest::response(QNetworkReply * const reply) const
{
    return new ListGameServerGroupsResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::ListGameServerGroupsRequestPrivate
 * \brief The ListGameServerGroupsRequestPrivate class provides private implementation for ListGameServerGroupsRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a ListGameServerGroupsRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
ListGameServerGroupsRequestPrivate::ListGameServerGroupsRequestPrivate(
    const GameLiftRequest::Action action, ListGameServerGroupsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListGameServerGroupsRequest
 * class' copy constructor.
 */
ListGameServerGroupsRequestPrivate::ListGameServerGroupsRequestPrivate(
    const ListGameServerGroupsRequestPrivate &other, ListGameServerGroupsRequest * const q)
