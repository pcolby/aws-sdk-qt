 ...
 *
 * \brief The CreateVpcPeeringAuthorizationRequest class encapsulates GameLift CreateVpcPeeringAuthorization requests.
 *
 * \ingroup GameLift
 *
 ...
 *
 * \sa GameLiftClient::createVpcPeeringAuthorization
 */
