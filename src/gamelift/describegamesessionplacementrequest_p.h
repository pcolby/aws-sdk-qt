...
class QTAWS_EXPORT DescribeGameSessionPlacementRequestPrivate : public GameLiftRequestPrivate {

public:
    DescribeGameSessionPlacementRequestPrivate(const GameLift::Action action,
