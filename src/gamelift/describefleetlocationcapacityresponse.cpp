...
#include "describefleetlocationcapacityresponse_p.h"
...
/*!
 * \class QtAws::GameLift::DescribeFleetLocationCapacityResponse
 * \brief The DescribeFleetLocationCapacityResponse class provides an interace for GameLift DescribeFleetLocationCapacity responses.
 *
 ...
 *  resources</a>
 *
 * \sa GameLiftClient::describeFleetLocationCapacity
 */

/*!
 * Constructs a DescribeFleetLocationCapacityResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeFleetLocationCapacityResponse::DescribeFleetLocationCapacityResponse(
        const DescribeFleetLocationCapacityRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new DescribeFleetLocationCapacityResponsePrivate(this), parent)
{
    setRequest(new DescribeFleetLocationCapacityRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeFleetLocationCapacityRequest * DescribeFleetLocationCapacityResponse::request() const
{
    Q_D(const DescribeFleetLocationCapacityResponse);
    return static_cast<const DescribeFleetLocationCapacityRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GameLift DescribeFleetLocationCapacity \a response.
 */
void DescribeFleetLocationCapacityResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeFleetLocationCapacityResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::DescribeFleetLocationCapacityResponsePrivate
 * \brief The DescribeFleetLocationCapacityResponsePrivate class provides private implementation for DescribeFleetLocationCapacityResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DescribeFleetLocationCapacityResponsePrivate object with public implementation \a q.
 */
DescribeFleetLocationCapacityResponsePrivate::DescribeFleetLocationCapacityResponsePrivate(
    DescribeFleetLocationCapacityResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift DescribeFleetLocationCapacity response element from \a xml.
 */
void DescribeFleetLocationCapacityResponsePrivate::parseDescribeFleetLocationCapacityResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeFleetLocationCapacityResponse"));
    Q_UNUSED(xml) ///< @todo
}
