...
class QTAWS_EXPORT DescribeMatchmakingConfigurationsResponse : public GameLiftResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeMatchmakingConfigurationsRequest * request() const override;
