...
#include "deletegameservergroupresponse_p.h"
...
/*!
 * \class QtAws::GameLift::DeleteGameServerGroupResponse
 * \brief The DeleteGameServerGroupResponse class provides an interace for GameLift DeleteGameServerGroup responses.
 *
...
/*!
 * Constructs a DeleteGameServerGroupResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteGameServerGroupResponse::DeleteGameServerGroupResponse(
        const DeleteGameServerGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new DeleteGameServerGroupResponsePrivate(this), parent)
{
    setRequest(new DeleteGameServerGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GameLift DeleteGameServerGroup \a response.
 */
void DeleteGameServerGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteGameServerGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::DeleteGameServerGroupResponsePrivate
 * \brief The DeleteGameServerGroupResponsePrivate class provides private implementation for DeleteGameServerGroupResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DeleteGameServerGroupResponsePrivate object with public implementation \a q.
 */
DeleteGameServerGroupResponsePrivate::DeleteGameServerGroupResponsePrivate(
    DeleteGameServerGroupResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift DeleteGameServerGroup response element from \a xml.
 */
void DeleteGameServerGroupResponsePrivate::parseDeleteGameServerGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteGameServerGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
