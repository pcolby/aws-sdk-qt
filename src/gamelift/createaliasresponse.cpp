 ...
 *
 * \brief The CreateAliasResponse class encapsulates GameLift CreateAlias responses.
 *
 * \ingroup GameLift
 *
...
CreateAliasResponse::CreateAliasResponse(
    ...
    : GameLiftResponse(new CreateAliasResponsePrivate(this), parent)
{
