...
#include "updategameserverrequest_p.h"
...
/*!
 * \class QtAws::GameLift::UpdateGameServerRequest
 * \brief The UpdateGameServerRequest class provides an interface for GameLift UpdateGameServer requests.
 *
 ...
 *  resources</a>
 *
 * \sa GameLiftClient::updateGameServer
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateGameServerRequest::UpdateGameServerRequest(const UpdateGameServerRequest &other)
    : GameLiftRequest(new UpdateGameServerRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateGameServerRequest object.
 */
UpdateGameServerRequest::UpdateGameServerRequest()
    : GameLiftRequest(new UpdateGameServerRequestPrivate(GameLiftRequest::UpdateGameServerAction, this))
{
 ...
 * \reimp
 */
bool UpdateGameServerRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateGameServerResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateGameServerRequest::response(QNetworkReply * const reply) const
{
    return new UpdateGameServerResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::UpdateGameServerRequestPrivate
 * \brief The UpdateGameServerRequestPrivate class provides private implementation for UpdateGameServerRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a UpdateGameServerRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
UpdateGameServerRequestPrivate::UpdateGameServerRequestPrivate(
    const GameLiftRequest::Action action, UpdateGameServerRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateGameServerRequest
 * class' copy constructor.
 */
UpdateGameServerRequestPrivate::UpdateGameServerRequestPrivate(
    const UpdateGameServerRequestPrivate &other, UpdateGameServerRequest * const q)
