...
/*!
 * \class QtAws::GameLift::DescribeFleetAttributesResponse
 * \brief The DescribeFleetAttributesResponse class provides an interace for GameLift DescribeFleetAttributes responses.
 *
...
/*!
 * Constructs a DescribeFleetAttributesResponse object for \a reply to \a request, with parent \a parent.
 */
...
{
    return static_cast<const DescribeFleetAttributesRequest *>(GameLiftResponse::request());
}

/*!
 * \reimp
 * Parses a successful GameLift DescribeFleetAttributes \a response.
 */
void DescribeFleetAttributesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeFleetAttributesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::DescribeFleetAttributesResponsePrivate
 * \brief The DescribeFleetAttributesResponsePrivate class provides private implementation for DescribeFleetAttributesResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DescribeFleetAttributesResponsePrivate object with public implementation \a q.
 */
DescribeFleetAttributesResponsePrivate::DescribeFleetAttributesResponsePrivate(
    DescribeFleetAttributesResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift DescribeFleetAttributes response element from \a xml.
 */
