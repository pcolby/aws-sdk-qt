...
#include "updategameserverresponse_p.h"
...
/*!
 * \class QtAws::GameLift::UpdateGameServerResponse
 * \brief The UpdateGameServerResponse class provides an interace for GameLift UpdateGameServer responses.
 *
...
/*!
 * Constructs a UpdateGameServerResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateGameServerResponse::UpdateGameServerResponse(
        const UpdateGameServerRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new UpdateGameServerResponsePrivate(this), parent)
{
    setRequest(new UpdateGameServerRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GameLift UpdateGameServer \a response.
 */
void UpdateGameServerResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateGameServerResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::UpdateGameServerResponsePrivate
 * \brief The UpdateGameServerResponsePrivate class provides private implementation for UpdateGameServerResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a UpdateGameServerResponsePrivate object with public implementation \a q.
 */
UpdateGameServerResponsePrivate::UpdateGameServerResponsePrivate(
    UpdateGameServerResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift UpdateGameServer response element from \a xml.
 */
void UpdateGameServerResponsePrivate::parseUpdateGameServerResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateGameServerResponse"));
    Q_UNUSED(xml) ///< @todo
}
