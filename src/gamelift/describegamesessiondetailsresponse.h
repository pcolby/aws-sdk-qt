...
class QTAWS_EXPORT DescribeGameSessionDetailsResponse : public DescribeGameSessionDetailsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeGameSessionDetailsRequest * request() const;
