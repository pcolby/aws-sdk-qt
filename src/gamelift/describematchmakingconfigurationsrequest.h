...
#ifndef QTAWS_DESCRIBEMATCHMAKINGCONFIGURATIONSREQUEST_H
#define QTAWS_DESCRIBEMATCHMAKINGCONFIGURATIONSREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(DescribeMatchmakingConfigurationsRequest)
