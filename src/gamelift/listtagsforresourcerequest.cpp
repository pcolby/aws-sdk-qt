...
/*!
 * \class QtAws::GameLift::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for GameLift ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : GameLiftRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : GameLiftRequest(new ListTagsForResourceRequestPrivate(GameLiftRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::GameLift::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const GameLiftRequest::Action action, ListTagsForResourceRequest * const q)
