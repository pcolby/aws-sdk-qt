...
#include "describefleetlocationcapacityrequest_p.h"
...
/*!
 * \class QtAws::GameLift::DescribeFleetLocationCapacityRequest
 * \brief The DescribeFleetLocationCapacityRequest class provides an interface for GameLift DescribeFleetLocationCapacity requests.
 *
 ...
 */
DescribeFleetLocationCapacityRequest::DescribeFleetLocationCapacityRequest(const DescribeFleetLocationCapacityRequest &other)
    : GameLiftRequest(new DescribeFleetLocationCapacityRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeFleetLocationCapacityRequest object.
 */
DescribeFleetLocationCapacityRequest::DescribeFleetLocationCapacityRequest()
    : GameLiftRequest(new DescribeFleetLocationCapacityRequestPrivate(GameLiftRequest::DescribeFleetLocationCapacityAction, this))
{
 ...
 * \reimp
 */
bool DescribeFleetLocationCapacityRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeFleetLocationCapacityResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeFleetLocationCapacityRequest::response(QNetworkReply * const reply) const
{
    return new DescribeFleetLocationCapacityResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::DescribeFleetLocationCapacityRequestPrivate
 * \brief The DescribeFleetLocationCapacityRequestPrivate class provides private implementation for DescribeFleetLocationCapacityRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DescribeFleetLocationCapacityRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
DescribeFleetLocationCapacityRequestPrivate::DescribeFleetLocationCapacityRequestPrivate(
    const GameLiftRequest::Action action, DescribeFleetLocationCapacityRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeFleetLocationCapacityRequest
 * class' copy constructor.
 */
DescribeFleetLocationCapacityRequestPrivate::DescribeFleetLocationCapacityRequestPrivate(
    const DescribeFleetLocationCapacityRequestPrivate &other, DescribeFleetLocationCapacityRequest * const q)
