...
#include "describegameservergrouprequest_p.h"
...
/*!
 * \class QtAws::GameLift::DescribeGameServerGroupRequest
 * \brief The DescribeGameServerGroupRequest class provides an interface for GameLift DescribeGameServerGroup requests.
 *
 ...
 *  resources</a>
 *
 * \sa GameLiftClient::describeGameServerGroup
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeGameServerGroupRequest::DescribeGameServerGroupRequest(const DescribeGameServerGroupRequest &other)
    : GameLiftRequest(new DescribeGameServerGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeGameServerGroupRequest object.
 */
DescribeGameServerGroupRequest::DescribeGameServerGroupRequest()
    : GameLiftRequest(new DescribeGameServerGroupRequestPrivate(GameLiftRequest::DescribeGameServerGroupAction, this))
{
 ...
 * \reimp
 */
bool DescribeGameServerGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeGameServerGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeGameServerGroupRequest::response(QNetworkReply * const reply) const
{
    return new DescribeGameServerGroupResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::DescribeGameServerGroupRequestPrivate
 * \brief The DescribeGameServerGroupRequestPrivate class provides private implementation for DescribeGameServerGroupRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DescribeGameServerGroupRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
DescribeGameServerGroupRequestPrivate::DescribeGameServerGroupRequestPrivate(
    const GameLiftRequest::Action action, DescribeGameServerGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeGameServerGroupRequest
 * class' copy constructor.
 */
DescribeGameServerGroupRequestPrivate::DescribeGameServerGroupRequestPrivate(
    const DescribeGameServerGroupRequestPrivate &other, DescribeGameServerGroupRequest * const q)
