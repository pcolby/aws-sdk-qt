...
#include "deletegameservergrouprequest_p.h"
...
/*!
 * \class QtAws::GameLift::DeleteGameServerGroupRequest
 * \brief The DeleteGameServerGroupRequest class provides an interface for GameLift DeleteGameServerGroup requests.
 *
 ...
 *  resources</a>
 *
 * \sa GameLiftClient::deleteGameServerGroup
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteGameServerGroupRequest::DeleteGameServerGroupRequest(const DeleteGameServerGroupRequest &other)
    : GameLiftRequest(new DeleteGameServerGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteGameServerGroupRequest object.
 */
DeleteGameServerGroupRequest::DeleteGameServerGroupRequest()
    : GameLiftRequest(new DeleteGameServerGroupRequestPrivate(GameLiftRequest::DeleteGameServerGroupAction, this))
{
 ...
 * \reimp
 */
bool DeleteGameServerGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteGameServerGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteGameServerGroupRequest::response(QNetworkReply * const reply) const
{
    return new DeleteGameServerGroupResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::DeleteGameServerGroupRequestPrivate
 * \brief The DeleteGameServerGroupRequestPrivate class provides private implementation for DeleteGameServerGroupRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DeleteGameServerGroupRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
DeleteGameServerGroupRequestPrivate::DeleteGameServerGroupRequestPrivate(
    const GameLiftRequest::Action action, DeleteGameServerGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteGameServerGroupRequest
 * class' copy constructor.
 */
DeleteGameServerGroupRequestPrivate::DeleteGameServerGroupRequestPrivate(
    const DeleteGameServerGroupRequestPrivate &other, DeleteGameServerGroupRequest * const q)
