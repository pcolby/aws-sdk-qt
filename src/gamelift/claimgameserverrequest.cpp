...
#include "claimgameserverrequest_p.h"
...
/*!
 * \class QtAws::GameLift::ClaimGameServerRequest
 * \brief The ClaimGameServerRequest class provides an interface for GameLift ClaimGameServer requests.
 *
 ...
 *  resources</a>
 *
 * \sa GameLiftClient::claimGameServer
 */

/*!
 * Constructs a copy of \a other.
 */
ClaimGameServerRequest::ClaimGameServerRequest(const ClaimGameServerRequest &other)
    : GameLiftRequest(new ClaimGameServerRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ClaimGameServerRequest object.
 */
ClaimGameServerRequest::ClaimGameServerRequest()
    : GameLiftRequest(new ClaimGameServerRequestPrivate(GameLiftRequest::ClaimGameServerAction, this))
{
 ...
 * \reimp
 */
bool ClaimGameServerRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ClaimGameServerResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ClaimGameServerRequest::response(QNetworkReply * const reply) const
{
    return new ClaimGameServerResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::ClaimGameServerRequestPrivate
 * \brief The ClaimGameServerRequestPrivate class provides private implementation for ClaimGameServerRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a ClaimGameServerRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
ClaimGameServerRequestPrivate::ClaimGameServerRequestPrivate(
    const GameLiftRequest::Action action, ClaimGameServerRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ClaimGameServerRequest
 * class' copy constructor.
 */
ClaimGameServerRequestPrivate::ClaimGameServerRequestPrivate(
    const ClaimGameServerRequestPrivate &other, ClaimGameServerRequest * const q)
