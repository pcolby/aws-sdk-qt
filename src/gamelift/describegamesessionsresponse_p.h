...
class QTAWS_EXPORT DescribeGameSessionsResponsePrivate : public GameLiftResponsePrivate {

public:

    DescribeGameSessionsResponsePrivate(DescribeGameSessionsResponse * const q);
