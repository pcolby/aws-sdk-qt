...
#include "resumegameservergrouprequest_p.h"
...
/*!
 * \class QtAws::GameLift::ResumeGameServerGroupRequest
 * \brief The ResumeGameServerGroupRequest class provides an interface for GameLift ResumeGameServerGroup requests.
 *
 ...
 */
ResumeGameServerGroupRequest::ResumeGameServerGroupRequest(const ResumeGameServerGroupRequest &other)
    : GameLiftRequest(new ResumeGameServerGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ResumeGameServerGroupRequest object.
 */
ResumeGameServerGroupRequest::ResumeGameServerGroupRequest()
    : GameLiftRequest(new ResumeGameServerGroupRequestPrivate(GameLiftRequest::ResumeGameServerGroupAction, this))
{
 ...
 * \reimp
 */
bool ResumeGameServerGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ResumeGameServerGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ResumeGameServerGroupRequest::response(QNetworkReply * const reply) const
{
    return new ResumeGameServerGroupResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::ResumeGameServerGroupRequestPrivate
 * \brief The ResumeGameServerGroupRequestPrivate class provides private implementation for ResumeGameServerGroupRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a ResumeGameServerGroupRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
ResumeGameServerGroupRequestPrivate::ResumeGameServerGroupRequestPrivate(
    const GameLiftRequest::Action action, ResumeGameServerGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ResumeGameServerGroupRequest
 * class' copy constructor.
 */
ResumeGameServerGroupRequestPrivate::ResumeGameServerGroupRequestPrivate(
    const ResumeGameServerGroupRequestPrivate &other, ResumeGameServerGroupRequest * const q)
