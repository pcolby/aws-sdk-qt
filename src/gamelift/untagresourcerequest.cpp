...
/*!
 * \class QtAws::GameLift::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for GameLift UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : GameLiftRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : GameLiftRequest(new UntagResourceRequestPrivate(GameLiftRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::GameLift::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const GameLiftRequest::Action action, UntagResourceRequest * const q)
