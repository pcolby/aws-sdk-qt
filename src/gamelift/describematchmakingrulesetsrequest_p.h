...
class QTAWS_EXPORT DescribeMatchmakingRuleSetsRequestPrivate : public GameLiftPrivate {

public:
    DescribeMatchmakingRuleSetsRequestPrivate(const GameLift::Action action,
