...
#include "describefleetlocationattributesresponse_p.h"
...
/*!
 * \class QtAws::GameLift::DescribeFleetLocationAttributesResponse
 * \brief The DescribeFleetLocationAttributesResponse class provides an interace for GameLift DescribeFleetLocationAttributes responses.
 *
...
/*!
 * Constructs a DescribeFleetLocationAttributesResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeFleetLocationAttributesResponse::DescribeFleetLocationAttributesResponse(
        const DescribeFleetLocationAttributesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new DescribeFleetLocationAttributesResponsePrivate(this), parent)
{
    setRequest(new DescribeFleetLocationAttributesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeFleetLocationAttributesRequest * DescribeFleetLocationAttributesResponse::request() const
{
    Q_D(const DescribeFleetLocationAttributesResponse);
    return static_cast<const DescribeFleetLocationAttributesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GameLift DescribeFleetLocationAttributes \a response.
 */
void DescribeFleetLocationAttributesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeFleetLocationAttributesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::DescribeFleetLocationAttributesResponsePrivate
 * \brief The DescribeFleetLocationAttributesResponsePrivate class provides private implementation for DescribeFleetLocationAttributesResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DescribeFleetLocationAttributesResponsePrivate object with public implementation \a q.
 */
DescribeFleetLocationAttributesResponsePrivate::DescribeFleetLocationAttributesResponsePrivate(
    DescribeFleetLocationAttributesResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift DescribeFleetLocationAttributes response element from \a xml.
 */
void DescribeFleetLocationAttributesResponsePrivate::parseDescribeFleetLocationAttributesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeFleetLocationAttributesResponse"));
    Q_UNUSED(xml) ///< @todo
}
