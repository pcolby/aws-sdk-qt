...
#include "listscriptsrequest_p.h"
...
/*!
 * \class QtAws::GameLift::ListScriptsRequest
 * \brief The ListScriptsRequest class provides an interface for GameLift ListScripts requests.
 *
 ...
 */
ListScriptsRequest::ListScriptsRequest(const ListScriptsRequest &other)
    : GameLiftRequest(new ListScriptsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListScriptsRequest object.
 */
ListScriptsRequest::ListScriptsRequest()
    : GameLiftRequest(new ListScriptsRequestPrivate(GameLiftRequest::ListScriptsAction, this))
{
 ...
 * \reimp
 */
bool ListScriptsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListScriptsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListScriptsRequest::response(QNetworkReply * const reply) const
{
    return new ListScriptsResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::ListScriptsRequestPrivate
 * \brief The ListScriptsRequestPrivate class provides private implementation for ListScriptsRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a ListScriptsRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
ListScriptsRequestPrivate::ListScriptsRequestPrivate(
    const GameLiftRequest::Action action, ListScriptsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListScriptsRequest
 * class' copy constructor.
 */
ListScriptsRequestPrivate::ListScriptsRequestPrivate(
    const ListScriptsRequestPrivate &other, ListScriptsRequest * const q)
