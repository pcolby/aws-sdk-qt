...
#include "claimgameserverresponse_p.h"
...
/*!
 * \class QtAws::GameLift::ClaimGameServerResponse
 * \brief The ClaimGameServerResponse class provides an interace for GameLift ClaimGameServer responses.
 *
...
/*!
 * Constructs a ClaimGameServerResponse object for \a reply to \a request, with parent \a parent.
 */
ClaimGameServerResponse::ClaimGameServerResponse(
        const ClaimGameServerRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new ClaimGameServerResponsePrivate(this), parent)
{
    setRequest(new ClaimGameServerRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GameLift ClaimGameServer \a response.
 */
void ClaimGameServerResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ClaimGameServerResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::ClaimGameServerResponsePrivate
 * \brief The ClaimGameServerResponsePrivate class provides private implementation for ClaimGameServerResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a ClaimGameServerResponsePrivate object with public implementation \a q.
 */
ClaimGameServerResponsePrivate::ClaimGameServerResponsePrivate(
    ClaimGameServerResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift ClaimGameServer response element from \a xml.
 */
void ClaimGameServerResponsePrivate::parseClaimGameServerResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ClaimGameServerResponse"));
    Q_UNUSED(xml) ///< @todo
}
