...
class QTAWS_EXPORT CreateMatchmakingConfigurationResponsePrivate : public GameLiftResponsePrivate {

public:

    CreateMatchmakingConfigurationResponsePrivate(CreateMatchmakingConfigurationResponse * const q);
