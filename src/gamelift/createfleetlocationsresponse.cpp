...
#include "createfleetlocationsresponse_p.h"
...
/*!
 * \class QtAws::GameLift::CreateFleetLocationsResponse
 * \brief The CreateFleetLocationsResponse class provides an interace for GameLift CreateFleetLocations responses.
 *
...
/*!
 * Constructs a CreateFleetLocationsResponse object for \a reply to \a request, with parent \a parent.
 */
CreateFleetLocationsResponse::CreateFleetLocationsResponse(
        const CreateFleetLocationsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new CreateFleetLocationsResponsePrivate(this), parent)
{
    setRequest(new CreateFleetLocationsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GameLift CreateFleetLocations \a response.
 */
void CreateFleetLocationsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateFleetLocationsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::CreateFleetLocationsResponsePrivate
 * \brief The CreateFleetLocationsResponsePrivate class provides private implementation for CreateFleetLocationsResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a CreateFleetLocationsResponsePrivate object with public implementation \a q.
 */
CreateFleetLocationsResponsePrivate::CreateFleetLocationsResponsePrivate(
    CreateFleetLocationsResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift CreateFleetLocations response element from \a xml.
 */
void CreateFleetLocationsResponsePrivate::parseCreateFleetLocationsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateFleetLocationsResponse"));
    Q_UNUSED(xml) ///< @todo
}
