...
#include "updategameservergrouprequest_p.h"
...
/*!
 * \class QtAws::GameLift::UpdateGameServerGroupRequest
 * \brief The UpdateGameServerGroupRequest class provides an interface for GameLift UpdateGameServerGroup requests.
 *
 ...
 */
UpdateGameServerGroupRequest::UpdateGameServerGroupRequest(const UpdateGameServerGroupRequest &other)
    : GameLiftRequest(new UpdateGameServerGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateGameServerGroupRequest object.
 */
UpdateGameServerGroupRequest::UpdateGameServerGroupRequest()
    : GameLiftRequest(new UpdateGameServerGroupRequestPrivate(GameLiftRequest::UpdateGameServerGroupAction, this))
{
 ...
 * \reimp
 */
bool UpdateGameServerGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateGameServerGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateGameServerGroupRequest::response(QNetworkReply * const reply) const
{
    return new UpdateGameServerGroupResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::UpdateGameServerGroupRequestPrivate
 * \brief The UpdateGameServerGroupRequestPrivate class provides private implementation for UpdateGameServerGroupRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a UpdateGameServerGroupRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
UpdateGameServerGroupRequestPrivate::UpdateGameServerGroupRequestPrivate(
    const GameLiftRequest::Action action, UpdateGameServerGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateGameServerGroupRequest
 * class' copy constructor.
 */
UpdateGameServerGroupRequestPrivate::UpdateGameServerGroupRequestPrivate(
    const UpdateGameServerGroupRequestPrivate &other, UpdateGameServerGroupRequest * const q)
