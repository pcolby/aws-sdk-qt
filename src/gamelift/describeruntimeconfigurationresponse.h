...
class QTAWS_EXPORT DescribeRuntimeConfigurationResponse : public GameLiftResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeRuntimeConfigurationRequest * request() const override;
