...
#include "deletescriptresponse_p.h"
...
/*!
 * \class QtAws::GameLift::DeleteScriptResponse
 * \brief The DeleteScriptResponse class provides an interace for GameLift DeleteScript responses.
 *
...
/*!
 * Constructs a DeleteScriptResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteScriptResponse::DeleteScriptResponse(
        const DeleteScriptRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new DeleteScriptResponsePrivate(this), parent)
{
    setRequest(new DeleteScriptRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GameLift DeleteScript \a response.
 */
void DeleteScriptResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteScriptResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::DeleteScriptResponsePrivate
 * \brief The DeleteScriptResponsePrivate class provides private implementation for DeleteScriptResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DeleteScriptResponsePrivate object with public implementation \a q.
 */
DeleteScriptResponsePrivate::DeleteScriptResponsePrivate(
    DeleteScriptResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift DeleteScript response element from \a xml.
 */
void DeleteScriptResponsePrivate::parseDeleteScriptResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteScriptResponse"));
    Q_UNUSED(xml) ///< @todo
}
