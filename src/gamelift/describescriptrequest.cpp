...
#include "describescriptrequest_p.h"
...
/*!
 * \class QtAws::GameLift::DescribeScriptRequest
 * \brief The DescribeScriptRequest class provides an interface for GameLift DescribeScript requests.
 *
 ...
 *  actions</a> </b>
 *
 * \sa GameLiftClient::describeScript
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeScriptRequest::DescribeScriptRequest(const DescribeScriptRequest &other)
    : GameLiftRequest(new DescribeScriptRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeScriptRequest object.
 */
DescribeScriptRequest::DescribeScriptRequest()
    : GameLiftRequest(new DescribeScriptRequestPrivate(GameLiftRequest::DescribeScriptAction, this))
{
 ...
 * \reimp
 */
bool DescribeScriptRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeScriptResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeScriptRequest::response(QNetworkReply * const reply) const
{
    return new DescribeScriptResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::DescribeScriptRequestPrivate
 * \brief The DescribeScriptRequestPrivate class provides private implementation for DescribeScriptRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DescribeScriptRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
DescribeScriptRequestPrivate::DescribeScriptRequestPrivate(
    const GameLiftRequest::Action action, DescribeScriptRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeScriptRequest
 * class' copy constructor.
 */
DescribeScriptRequestPrivate::DescribeScriptRequestPrivate(
    const DescribeScriptRequestPrivate &other, DescribeScriptRequest * const q)
