...
#include "deregistergameserverresponse_p.h"
...
/*!
 * \class QtAws::GameLift::DeregisterGameServerResponse
 * \brief The DeregisterGameServerResponse class provides an interace for GameLift DeregisterGameServer responses.
 *
...
/*!
 * Constructs a DeregisterGameServerResponse object for \a reply to \a request, with parent \a parent.
 */
DeregisterGameServerResponse::DeregisterGameServerResponse(
        const DeregisterGameServerRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new DeregisterGameServerResponsePrivate(this), parent)
{
    setRequest(new DeregisterGameServerRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GameLift DeregisterGameServer \a response.
 */
void DeregisterGameServerResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeregisterGameServerResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::DeregisterGameServerResponsePrivate
 * \brief The DeregisterGameServerResponsePrivate class provides private implementation for DeregisterGameServerResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DeregisterGameServerResponsePrivate object with public implementation \a q.
 */
DeregisterGameServerResponsePrivate::DeregisterGameServerResponsePrivate(
    DeregisterGameServerResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift DeregisterGameServer response element from \a xml.
 */
void DeregisterGameServerResponsePrivate::parseDeregisterGameServerResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeregisterGameServerResponse"));
    Q_UNUSED(xml) ///< @todo
}
