...
#include "listgameservergroupsresponse_p.h"
...
/*!
 * \class QtAws::GameLift::ListGameServerGroupsResponse
 * \brief The ListGameServerGroupsResponse class provides an interace for GameLift ListGameServerGroups responses.
 *
 ...
 *  resources</a>
 *
 * \sa GameLiftClient::listGameServerGroups
 */

/*!
 * Constructs a ListGameServerGroupsResponse object for \a reply to \a request, with parent \a parent.
 */
ListGameServerGroupsResponse::ListGameServerGroupsResponse(
        const ListGameServerGroupsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new ListGameServerGroupsResponsePrivate(this), parent)
{
    setRequest(new ListGameServerGroupsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListGameServerGroupsRequest * ListGameServerGroupsResponse::request() const
{
    Q_D(const ListGameServerGroupsResponse);
    return static_cast<const ListGameServerGroupsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GameLift ListGameServerGroups \a response.
 */
void ListGameServerGroupsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListGameServerGroupsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::ListGameServerGroupsResponsePrivate
 * \brief The ListGameServerGroupsResponsePrivate class provides private implementation for ListGameServerGroupsResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a ListGameServerGroupsResponsePrivate object with public implementation \a q.
 */
ListGameServerGroupsResponsePrivate::ListGameServerGroupsResponsePrivate(
    ListGameServerGroupsResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift ListGameServerGroups response element from \a xml.
 */
void ListGameServerGroupsResponsePrivate::parseListGameServerGroupsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListGameServerGroupsResponse"));
    Q_UNUSED(xml) ///< @todo
}
