...
#include "startfleetactionsresponse_p.h"
...
/*!
 * \class QtAws::GameLift::StartFleetActionsResponse
 * \brief The StartFleetActionsResponse class provides an interace for GameLift StartFleetActions responses.
 *
...
/*!
 * Constructs a StartFleetActionsResponse object for \a reply to \a request, with parent \a parent.
 */
StartFleetActionsResponse::StartFleetActionsResponse(
        const StartFleetActionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new StartFleetActionsResponsePrivate(this), parent)
{
    setRequest(new StartFleetActionsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GameLift StartFleetActions \a response.
 */
...
/*!
 * \class QtAws::GameLift::StartFleetActionsResponsePrivate
 * \brief The StartFleetActionsResponsePrivate class provides private implementation for StartFleetActionsResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a StartFleetActionsResponsePrivate object with public implementation \a q.
 */
StartFleetActionsResponsePrivate::StartFleetActionsResponsePrivate(
    StartFleetActionsResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift StartFleetActions response element from \a xml.
 */
void StartFleetActionsResponsePrivate::parseStartFleetActionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("StartFleetActionsResponse"));
    /// @todo
}
