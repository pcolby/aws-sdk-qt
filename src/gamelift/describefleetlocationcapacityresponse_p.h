...
class QTAWS_EXPORT DescribeFleetLocationCapacityResponsePrivate : public GameLiftResponsePrivate {

public:

    DescribeFleetLocationCapacityResponsePrivate(DescribeFleetLocationCapacityResponse * const q);
