...
#include "describefleetlocationutilizationrequest_p.h"
...
/*!
 * \class QtAws::GameLift::DescribeFleetLocationUtilizationRequest
 * \brief The DescribeFleetLocationUtilizationRequest class provides an interface for GameLift DescribeFleetLocationUtilization requests.
 *
 ...
 *  resources</a>
 *
 * \sa GameLiftClient::describeFleetLocationUtilization
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeFleetLocationUtilizationRequest::DescribeFleetLocationUtilizationRequest(const DescribeFleetLocationUtilizationRequest &other)
    : GameLiftRequest(new DescribeFleetLocationUtilizationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeFleetLocationUtilizationRequest object.
 */
DescribeFleetLocationUtilizationRequest::DescribeFleetLocationUtilizationRequest()
    : GameLiftRequest(new DescribeFleetLocationUtilizationRequestPrivate(GameLiftRequest::DescribeFleetLocationUtilizationAction, this))
{
 ...
 * \reimp
 */
bool DescribeFleetLocationUtilizationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeFleetLocationUtilizationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeFleetLocationUtilizationRequest::response(QNetworkReply * const reply) const
{
    return new DescribeFleetLocationUtilizationResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::DescribeFleetLocationUtilizationRequestPrivate
 * \brief The DescribeFleetLocationUtilizationRequestPrivate class provides private implementation for DescribeFleetLocationUtilizationRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DescribeFleetLocationUtilizationRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
DescribeFleetLocationUtilizationRequestPrivate::DescribeFleetLocationUtilizationRequestPrivate(
    const GameLiftRequest::Action action, DescribeFleetLocationUtilizationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeFleetLocationUtilizationRequest
 * class' copy constructor.
 */
DescribeFleetLocationUtilizationRequestPrivate::DescribeFleetLocationUtilizationRequestPrivate(
    const DescribeFleetLocationUtilizationRequestPrivate &other, DescribeFleetLocationUtilizationRequest * const q)
