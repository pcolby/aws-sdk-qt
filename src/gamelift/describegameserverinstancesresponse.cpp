...
#include "describegameserverinstancesresponse_p.h"
...
/*!
 * \class QtAws::GameLift::DescribeGameServerInstancesResponse
 * \brief The DescribeGameServerInstancesResponse class provides an interace for GameLift DescribeGameServerInstances responses.
 *
...
/*!
 * Constructs a DescribeGameServerInstancesResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeGameServerInstancesResponse::DescribeGameServerInstancesResponse(
        const DescribeGameServerInstancesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new DescribeGameServerInstancesResponsePrivate(this), parent)
{
    setRequest(new DescribeGameServerInstancesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeGameServerInstancesRequest * DescribeGameServerInstancesResponse::request() const
{
    Q_D(const DescribeGameServerInstancesResponse);
    return static_cast<const DescribeGameServerInstancesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GameLift DescribeGameServerInstances \a response.
 */
void DescribeGameServerInstancesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeGameServerInstancesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::DescribeGameServerInstancesResponsePrivate
 * \brief The DescribeGameServerInstancesResponsePrivate class provides private implementation for DescribeGameServerInstancesResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DescribeGameServerInstancesResponsePrivate object with public implementation \a q.
 */
DescribeGameServerInstancesResponsePrivate::DescribeGameServerInstancesResponsePrivate(
    DescribeGameServerInstancesResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift DescribeGameServerInstances response element from \a xml.
 */
void DescribeGameServerInstancesResponsePrivate::parseDescribeGameServerInstancesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeGameServerInstancesResponse"));
    Q_UNUSED(xml) ///< @todo
}
