...
#include "stopfleetactionsresponse_p.h"
...
/*!
 * \class QtAws::GameLift::StopFleetActionsResponse
 * \brief The StopFleetActionsResponse class provides an interace for GameLift StopFleetActions responses.
 *
...
/*!
 * Constructs a StopFleetActionsResponse object for \a reply to \a request, with parent \a parent.
 */
StopFleetActionsResponse::StopFleetActionsResponse(
        const StopFleetActionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new StopFleetActionsResponsePrivate(this), parent)
{
    setRequest(new StopFleetActionsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GameLift StopFleetActions \a response.
 */
...
/*!
 * \class QtAws::GameLift::StopFleetActionsResponsePrivate
 * \brief The StopFleetActionsResponsePrivate class provides private implementation for StopFleetActionsResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a StopFleetActionsResponsePrivate object with public implementation \a q.
 */
StopFleetActionsResponsePrivate::StopFleetActionsResponsePrivate(
    StopFleetActionsResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift StopFleetActions response element from \a xml.
 */
