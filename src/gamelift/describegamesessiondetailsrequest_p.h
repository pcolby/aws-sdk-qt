...
class QTAWS_EXPORT DescribeGameSessionDetailsRequestPrivate : public GameLiftRequestPrivate {

public:
    DescribeGameSessionDetailsRequestPrivate(const GameLift::Action action,
