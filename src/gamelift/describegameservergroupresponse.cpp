...
#include "describegameservergroupresponse_p.h"
...
/*!
 * \class QtAws::GameLift::DescribeGameServerGroupResponse
 * \brief The DescribeGameServerGroupResponse class provides an interace for GameLift DescribeGameServerGroup responses.
 *
...
/*!
 * Constructs a DescribeGameServerGroupResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeGameServerGroupResponse::DescribeGameServerGroupResponse(
        const DescribeGameServerGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GameLiftResponse(new DescribeGameServerGroupResponsePrivate(this), parent)
{
    setRequest(new DescribeGameServerGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GameLift DescribeGameServerGroup \a response.
 */
void DescribeGameServerGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeGameServerGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GameLift::DescribeGameServerGroupResponsePrivate
 * \brief The DescribeGameServerGroupResponsePrivate class provides private implementation for DescribeGameServerGroupResponse.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a DescribeGameServerGroupResponsePrivate object with public implementation \a q.
 */
DescribeGameServerGroupResponsePrivate::DescribeGameServerGroupResponsePrivate(
    DescribeGameServerGroupResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift DescribeGameServerGroup response element from \a xml.
 */
void DescribeGameServerGroupResponsePrivate::parseDescribeGameServerGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeGameServerGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
