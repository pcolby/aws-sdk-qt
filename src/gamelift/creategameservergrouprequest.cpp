...
#include "creategameservergrouprequest_p.h"
...
/*!
 * \class QtAws::GameLift::CreateGameServerGroupRequest
 * \brief The CreateGameServerGroupRequest class provides an interface for GameLift CreateGameServerGroup requests.
 *
 ...
 */
CreateGameServerGroupRequest::CreateGameServerGroupRequest(const CreateGameServerGroupRequest &other)
    : GameLiftRequest(new CreateGameServerGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateGameServerGroupRequest object.
 */
CreateGameServerGroupRequest::CreateGameServerGroupRequest()
    : GameLiftRequest(new CreateGameServerGroupRequestPrivate(GameLiftRequest::CreateGameServerGroupAction, this))
{
 ...
 * \reimp
 */
bool CreateGameServerGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateGameServerGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateGameServerGroupRequest::response(QNetworkReply * const reply) const
{
    return new CreateGameServerGroupResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::CreateGameServerGroupRequestPrivate
 * \brief The CreateGameServerGroupRequestPrivate class provides private implementation for CreateGameServerGroupRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a CreateGameServerGroupRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
CreateGameServerGroupRequestPrivate::CreateGameServerGroupRequestPrivate(
    const GameLiftRequest::Action action, CreateGameServerGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateGameServerGroupRequest
 * class' copy constructor.
 */
CreateGameServerGroupRequestPrivate::CreateGameServerGroupRequestPrivate(
    const CreateGameServerGroupRequestPrivate &other, CreateGameServerGroupRequest * const q)
