...
/*!
 * \class QtAws::GameLift::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for GameLift TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : GameLiftResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(GameLiftResponse::request());
}

/*!
 * \reimp
 * Parses a successful GameLift TagResource \a response.
 */
...
/*!
 * \class QtAws::GameLift::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : GameLiftResponsePrivate(q)
{

}

/*!
 * Parses a GameLift TagResource response element from \a xml.
 */
