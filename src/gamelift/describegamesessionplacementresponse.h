...
class QTAWS_EXPORT DescribeGameSessionPlacementResponse : public DescribeGameSessionPlacementResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeGameSessionPlacementRequest * request() const;
