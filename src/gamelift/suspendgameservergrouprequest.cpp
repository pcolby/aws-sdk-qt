...
#include "suspendgameservergrouprequest_p.h"
...
/*!
 * \class QtAws::GameLift::SuspendGameServerGroupRequest
 * \brief The SuspendGameServerGroupRequest class provides an interface for GameLift SuspendGameServerGroup requests.
 *
 ...
 *  resources</a>
 *
 * \sa GameLiftClient::suspendGameServerGroup
 */

/*!
 * Constructs a copy of \a other.
 */
SuspendGameServerGroupRequest::SuspendGameServerGroupRequest(const SuspendGameServerGroupRequest &other)
    : GameLiftRequest(new SuspendGameServerGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a SuspendGameServerGroupRequest object.
 */
SuspendGameServerGroupRequest::SuspendGameServerGroupRequest()
    : GameLiftRequest(new SuspendGameServerGroupRequestPrivate(GameLiftRequest::SuspendGameServerGroupAction, this))
{
 ...
 * \reimp
 */
bool SuspendGameServerGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a SuspendGameServerGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * SuspendGameServerGroupRequest::response(QNetworkReply * const reply) const
{
    return new SuspendGameServerGroupResponse(*this, reply);
}

/*!
 * \class QtAws::GameLift::SuspendGameServerGroupRequestPrivate
 * \brief The SuspendGameServerGroupRequestPrivate class provides private implementation for SuspendGameServerGroupRequest.
 * \internal
 *
 * \inmodule QtAwsGameLift
 */
...
/*!
 * Constructs a SuspendGameServerGroupRequestPrivate object for GameLift \a action,
 * with public implementation \a q.
 */
SuspendGameServerGroupRequestPrivate::SuspendGameServerGroupRequestPrivate(
    const GameLiftRequest::Action action, SuspendGameServerGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the SuspendGameServerGroupRequest
 * class' copy constructor.
 */
SuspendGameServerGroupRequestPrivate::SuspendGameServerGroupRequestPrivate(
    const SuspendGameServerGroupRequestPrivate &other, SuspendGameServerGroupRequest * const q)
