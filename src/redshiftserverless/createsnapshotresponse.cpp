...
/*!
 * \class QtAws::RedshiftServerless::CreateSnapshotResponse
 * \brief The CreateSnapshotResponse class provides an interace for RedshiftServerless CreateSnapshot responses.
 *
...
CreateSnapshotResponse::CreateSnapshotResponse(
    ...
    : RedshiftServerlessResponse(new CreateSnapshotResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful RedshiftServerless CreateSnapshot \a response.
 */
...
/*!
 * \class QtAws::RedshiftServerless::CreateSnapshotResponsePrivate
...
CreateSnapshotResponsePrivate::CreateSnapshotResponsePrivate(
    CreateSnapshotResponse * const q) : RedshiftServerlessResponsePrivate(q)
{

}

/*!
 * Parses a RedshiftServerless CreateSnapshot response element from \a xml.
 */
