...
/*!
 * \class QtAws::RedshiftServerless::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for RedshiftServerless ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : RedshiftServerlessResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful RedshiftServerless ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::RedshiftServerless::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : RedshiftServerlessResponsePrivate(q)
{

}

/*!
 * Parses a RedshiftServerless ListTagsForResource response element from \a xml.
 */
