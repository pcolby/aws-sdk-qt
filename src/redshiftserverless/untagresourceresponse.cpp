...
/*!
 * \class QtAws::RedshiftServerless::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for RedshiftServerless UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : RedshiftServerlessResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful RedshiftServerless UntagResource \a response.
 */
...
/*!
 * \class QtAws::RedshiftServerless::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : RedshiftServerlessResponsePrivate(q)
{

}

/*!
 * Parses a RedshiftServerless UntagResource response element from \a xml.
 */
