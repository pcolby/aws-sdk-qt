...
/*!
 * \class QtAws::RedshiftServerless::CreateSnapshotRequest
 * \brief The CreateSnapshotRequest class provides an interface for RedshiftServerless CreateSnapshot requests.
 *
 ...
 *
 * \sa RedshiftServerlessClient::createSnapshot
 */
...
CreateSnapshotRequest::CreateSnapshotRequest(const CreateSnapshotRequest &other)
    : RedshiftServerlessRequest(new CreateSnapshotRequestPrivate(*other.d_func(), this))
{
...
CreateSnapshotRequest::CreateSnapshotRequest()
    : RedshiftServerlessRequest(new CreateSnapshotRequestPrivate(RedshiftServerlessRequest::CreateSnapshotAction, this))
{
...
/*!
 * \class QtAws::RedshiftServerless::CreateSnapshotRequestPrivate
...
/*!
 * Constructs a CreateSnapshotRequestPrivate object for RedshiftServerless \a action,
 * with public implementation \a q.
 */
CreateSnapshotRequestPrivate::CreateSnapshotRequestPrivate(
    const RedshiftServerlessRequest::Action action, CreateSnapshotRequest * const q)
