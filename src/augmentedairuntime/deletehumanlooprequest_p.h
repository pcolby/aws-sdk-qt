...
class QTAWS_EXPORT DeleteHumanLoopRequestPrivate : public AugmentedAIRuntimeRequestPrivate {

public:
    DeleteHumanLoopRequestPrivate(const AugmentedAIRuntimeRequest::Action action,
