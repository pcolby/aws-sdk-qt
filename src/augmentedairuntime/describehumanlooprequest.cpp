...
/*!
 * \class QtAws::AugmentedAIRuntime::DescribeHumanLoopRequest
 * \brief The DescribeHumanLoopRequest class provides an interface for AugmentedAIRuntime DescribeHumanLoop requests.
 *
 ...
 *  SageMaker Developer
 *
 * \sa AugmentedAIRuntimeClient::describeHumanLoop
 */
...
DescribeHumanLoopRequest::DescribeHumanLoopRequest(const DescribeHumanLoopRequest &other)
    : AugmentedAIRuntimeRequest(new DescribeHumanLoopRequestPrivate(*other.d_func(), this))
{
...
DescribeHumanLoopRequest::DescribeHumanLoopRequest()
    : AugmentedAIRuntimeRequest(new DescribeHumanLoopRequestPrivate(AugmentedAIRuntimeRequest::DescribeHumanLoopAction, this))
{
...
/*!
 * \class QtAws::AugmentedAIRuntime::DescribeHumanLoopRequestPrivate
...
/*!
 * Constructs a DescribeHumanLoopRequestPrivate object for AugmentedAIRuntime \a action,
 * with public implementation \a q.
 */
DescribeHumanLoopRequestPrivate::DescribeHumanLoopRequestPrivate(
    const AugmentedAIRuntimeRequest::Action action, DescribeHumanLoopRequest * const q)
