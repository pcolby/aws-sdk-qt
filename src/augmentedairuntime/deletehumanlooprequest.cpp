...
#include "deletehumanlooprequest_p.h"
...
/*!
 * \class QtAws::AugmentedAIRuntime::DeleteHumanLoopRequest
 * \brief The DeleteHumanLoopRequest class provides an interface for AugmentedAIRuntime DeleteHumanLoop requests.
 *
 ...
 *  SageMaker Developer
 *
 * \sa AugmentedAIRuntimeClient::deleteHumanLoop
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteHumanLoopRequest::DeleteHumanLoopRequest(const DeleteHumanLoopRequest &other)
    : AugmentedAIRuntimeRequest(new DeleteHumanLoopRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteHumanLoopRequest object.
 */
DeleteHumanLoopRequest::DeleteHumanLoopRequest()
    : AugmentedAIRuntimeRequest(new DeleteHumanLoopRequestPrivate(AugmentedAIRuntimeRequest::DeleteHumanLoopAction, this))
{
 ...
 * \reimp
 */
bool DeleteHumanLoopRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteHumanLoopResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteHumanLoopRequest::response(QNetworkReply * const reply) const
{
    return new DeleteHumanLoopResponse(*this, reply);
}

/*!
 * \class QtAws::AugmentedAIRuntime::DeleteHumanLoopRequestPrivate
 * \brief The DeleteHumanLoopRequestPrivate class provides private implementation for DeleteHumanLoopRequest.
 * \internal
 *
 * \inmodule QtAwsAugmentedAIRuntime
 */
...
/*!
 * Constructs a DeleteHumanLoopRequestPrivate object for AugmentedAIRuntime \a action,
 * with public implementation \a q.
 */
DeleteHumanLoopRequestPrivate::DeleteHumanLoopRequestPrivate(
    const AugmentedAIRuntimeRequest::Action action, DeleteHumanLoopRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteHumanLoopRequest
 * class' copy constructor.
 */
DeleteHumanLoopRequestPrivate::DeleteHumanLoopRequestPrivate(
    const DeleteHumanLoopRequestPrivate &other, DeleteHumanLoopRequest * const q)
