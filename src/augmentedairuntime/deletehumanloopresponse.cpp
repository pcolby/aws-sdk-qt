...
/*!
 * \class QtAws::AugmentedAIRuntime::DeleteHumanLoopResponse
 * \brief The DeleteHumanLoopResponse class provides an interace for AugmentedAIRuntime DeleteHumanLoop responses.
 *
...
DeleteHumanLoopResponse::DeleteHumanLoopResponse(
    ...
    : AugmentedAIRuntimeResponse(new DeleteHumanLoopResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful AugmentedAIRuntime DeleteHumanLoop \a response.
 */
...
/*!
 * \class QtAws::AugmentedAIRuntime::DeleteHumanLoopResponsePrivate
...
DeleteHumanLoopResponsePrivate::DeleteHumanLoopResponsePrivate(
    DeleteHumanLoopResponse * const q) : AugmentedAIRuntimeResponsePrivate(q)
{

}

/*!
 * Parses a AugmentedAIRuntime DeleteHumanLoop response element from \a xml.
 */
