...
/*!
 * \class QtAws::AugmentedAIRuntime::ListHumanLoopsResponse
 * \brief The ListHumanLoopsResponse class provides an interace for AugmentedAIRuntime ListHumanLoops responses.
 *
...
ListHumanLoopsResponse::ListHumanLoopsResponse(
    ...
    : AugmentedAIRuntimeResponse(new ListHumanLoopsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful AugmentedAIRuntime ListHumanLoops \a response.
 */
...
/*!
 * \class QtAws::AugmentedAIRuntime::ListHumanLoopsResponsePrivate
...
ListHumanLoopsResponsePrivate::ListHumanLoopsResponsePrivate(
    ListHumanLoopsResponse * const q) : AugmentedAIRuntimeResponsePrivate(q)
{

}

/*!
 * Parses a AugmentedAIRuntime ListHumanLoops response element from \a xml.
 */
