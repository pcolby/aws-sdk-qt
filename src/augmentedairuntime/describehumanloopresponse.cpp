...
/*!
 * \class QtAws::AugmentedAIRuntime::DescribeHumanLoopResponse
 * \brief The DescribeHumanLoopResponse class provides an interace for AugmentedAIRuntime DescribeHumanLoop responses.
 *
...
DescribeHumanLoopResponse::DescribeHumanLoopResponse(
    ...
    : AugmentedAIRuntimeResponse(new DescribeHumanLoopResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful AugmentedAIRuntime DescribeHumanLoop \a response.
 */
...
/*!
 * \class QtAws::AugmentedAIRuntime::DescribeHumanLoopResponsePrivate
...
DescribeHumanLoopResponsePrivate::DescribeHumanLoopResponsePrivate(
    DescribeHumanLoopResponse * const q) : AugmentedAIRuntimeResponsePrivate(q)
{

}

/*!
 * Parses a AugmentedAIRuntime DescribeHumanLoop response element from \a xml.
 */
