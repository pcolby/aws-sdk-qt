...
/*!
 * \class QtAws::AugmentedAIRuntime::StartHumanLoopRequest
 * \brief The StartHumanLoopRequest class provides an interface for AugmentedAIRuntime StartHumanLoop requests.
 *
...
StartHumanLoopRequest::StartHumanLoopRequest(const StartHumanLoopRequest &other)
    : AugmentedAIRuntimeRequest(new StartHumanLoopRequestPrivate(*other.d_func(), this))
{
...
StartHumanLoopRequest::StartHumanLoopRequest()
    : AugmentedAIRuntimeRequest(new StartHumanLoopRequestPrivate(AugmentedAIRuntimeRequest::StartHumanLoopAction, this))
{
...
/*!
 * \class QtAws::AugmentedAIRuntime::StartHumanLoopRequestPrivate
...
/*!
 * Constructs a StartHumanLoopRequestPrivate object for AugmentedAIRuntime \a action,
 * with public implementation \a q.
 */
StartHumanLoopRequestPrivate::StartHumanLoopRequestPrivate(
    const AugmentedAIRuntimeRequest::Action action, StartHumanLoopRequest * const q)
