...
/*!
 * \class QtAws::AugmentedAIRuntime::StartHumanLoopResponse
 * \brief The StartHumanLoopResponse class provides an interace for AugmentedAIRuntime StartHumanLoop responses.
 *
 ...
 *  SageMaker Developer
 *
 * \sa AugmentedAIRuntimeClient::startHumanLoop
 */
...
StartHumanLoopResponse::StartHumanLoopResponse(
    ...
    : AugmentedAIRuntimeResponse(new StartHumanLoopResponsePrivate(this), parent)
{
...
{
    return static_cast<const StartHumanLoopRequest *>(AugmentedAIRuntimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful AugmentedAIRuntime StartHumanLoop \a response.
 */
...
/*!
 * \class QtAws::AugmentedAIRuntime::StartHumanLoopResponsePrivate
...
StartHumanLoopResponsePrivate::StartHumanLoopResponsePrivate(
    StartHumanLoopResponse * const q) : AugmentedAIRuntimeResponsePrivate(q)
{

}

/*!
 * Parses a AugmentedAIRuntime StartHumanLoop response element from \a xml.
 */
