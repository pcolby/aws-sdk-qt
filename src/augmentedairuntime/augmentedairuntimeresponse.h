...
#ifndef QTAWS_AUGMENTEDAIRUNTIMERESPONSE_H
...
public:
    AugmentedAIRuntimeResponse(QObject * const parent = 0);
...
private:
    Q_DECLARE_PRIVATE(AugmentedAIRuntimeResponse)
    Q_DISABLE_COPY(AugmentedAIRuntimeResponse)
