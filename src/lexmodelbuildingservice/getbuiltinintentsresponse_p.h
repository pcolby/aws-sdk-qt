...
class QTAWS_EXPORT GetBuiltinIntentsResponsePrivate : public LexModelBuildingServiceResponsePrivate {

public:

    GetBuiltinIntentsResponsePrivate(GetBuiltinIntentsResponse * const q);
