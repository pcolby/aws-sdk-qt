...
class QTAWS_EXPORT GetIntentsRequestPrivate : public LexModelBuildingServiceRequestPrivate {

public:
    GetIntentsRequestPrivate(const LexModelBuildingServiceRequest::Action action,
