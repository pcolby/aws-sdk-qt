 ...
 * \brief The GetIntentsRequest class provides an interface for LexModelBuildingService GetIntents requests.
 *
...
/*!
 * \class QtAws::LexModelBuildingService::GetIntentsRequestPrivate
