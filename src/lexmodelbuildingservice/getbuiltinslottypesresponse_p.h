...
class QTAWS_EXPORT GetBuiltinSlotTypesResponsePrivate : public LexModelBuildingServiceResponsePrivate {

public:

    GetBuiltinSlotTypesResponsePrivate(GetBuiltinSlotTypesResponse * const q);
