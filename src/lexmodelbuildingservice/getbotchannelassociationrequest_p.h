...
class QTAWS_EXPORT GetBotChannelAssociationRequestPrivate : public LexModelBuildingServiceRequestPrivate {

public:
    GetBotChannelAssociationRequestPrivate(const LexModelBuildingServiceRequest::Action action,
