...
class QTAWS_EXPORT DescribeElasticsearchDomainsResponse : public ElasticsearchServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeElasticsearchDomainsRequest * request() const override;
