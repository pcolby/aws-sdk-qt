...
class QTAWS_EXPORT ListDomainNamesRequestPrivate : public ElasticsearchServiceRequestPrivate {

public:
    ListDomainNamesRequestPrivate(const ElasticsearchServiceRequest::Action action,
