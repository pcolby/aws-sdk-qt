...
class QTAWS_EXPORT DescribeReservedElasticsearchInstancesResponse : public ElasticsearchServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeReservedElasticsearchInstancesRequest * request() const override;
