...
class QTAWS_EXPORT DescribeReservedElasticsearchInstanceOfferingsResponse : public ElasticsearchServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeReservedElasticsearchInstanceOfferingsRequest * request() const override;
