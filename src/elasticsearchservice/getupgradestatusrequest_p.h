...
class QTAWS_EXPORT GetUpgradeStatusRequestPrivate : public ElasticsearchServiceRequestPrivate {

public:
    GetUpgradeStatusRequestPrivate(const ElasticsearchServiceRequest::Action action,
