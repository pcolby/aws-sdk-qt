...
class QTAWS_EXPORT PurchaseReservedElasticsearchInstanceOfferingResponse : public ElasticsearchServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const PurchaseReservedElasticsearchInstanceOfferingRequest * request() const override;
