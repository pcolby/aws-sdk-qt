...
class QTAWS_EXPORT ListDomainsForPackageResponsePrivate : public ElasticsearchServiceResponsePrivate {

public:

    ListDomainsForPackageResponsePrivate(ListDomainsForPackageResponse * const q);
