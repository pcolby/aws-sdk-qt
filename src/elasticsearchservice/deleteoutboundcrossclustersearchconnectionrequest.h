...
class QTAWS_EXPORT DeleteOutboundCrossClusterSearchConnectionRequest : public ElasticsearchServiceRequest {
...
private:
    Q_DECLARE_PRIVATE(DeleteOutboundCrossClusterSearchConnectionRequest)
