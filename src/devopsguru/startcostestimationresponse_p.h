...
class QTAWS_EXPORT StartCostEstimationResponsePrivate : public DevOpsGuruResponsePrivate {

public:

    StartCostEstimationResponsePrivate(StartCostEstimationResponse * const q);
