...
/*!
 * \class QtAws::CloudWatchEvents::DeleteApiDestinationRequest
 * \brief The DeleteApiDestinationRequest class provides an interface for CloudWatchEvents DeleteApiDestination requests.
 *
...
DeleteApiDestinationRequest::DeleteApiDestinationRequest(const DeleteApiDestinationRequest &other)
    : CloudWatchEventsRequest(new DeleteApiDestinationRequestPrivate(*other.d_func(), this))
{
...
DeleteApiDestinationRequest::DeleteApiDestinationRequest()
    : CloudWatchEventsRequest(new DeleteApiDestinationRequestPrivate(CloudWatchEventsRequest::DeleteApiDestinationAction, this))
{
...
/*!
 * \class QtAws::CloudWatchEvents::DeleteApiDestinationRequestPrivate
...
/*!
 * Constructs a DeleteApiDestinationRequestPrivate object for CloudWatchEvents \a action,
 * with public implementation \a q.
 */
DeleteApiDestinationRequestPrivate::DeleteApiDestinationRequestPrivate(
    const CloudWatchEventsRequest::Action action, DeleteApiDestinationRequest * const q)
