...
/*!
 * \class QtAws::CloudWatchEvents::UpdateArchiveResponse
 * \brief The UpdateArchiveResponse class provides an interace for CloudWatchEvents UpdateArchive responses.
 *
...
UpdateArchiveResponse::UpdateArchiveResponse(
    ...
    : CloudWatchEventsResponse(new UpdateArchiveResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CloudWatchEvents UpdateArchive \a response.
 */
...
/*!
 * \class QtAws::CloudWatchEvents::UpdateArchiveResponsePrivate
...
UpdateArchiveResponsePrivate::UpdateArchiveResponsePrivate(
    UpdateArchiveResponse * const q) : CloudWatchEventsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchEvents UpdateArchive response element from \a xml.
 */
