...
/*!
 * \class QtAws::CloudWatchEvents::DescribeConnectionRequest
 * \brief The DescribeConnectionRequest class provides an interface for CloudWatchEvents DescribeConnection requests.
 *
 ...
 *
 * \sa CloudWatchEventsClient::describeConnection
 */
...
DescribeConnectionRequest::DescribeConnectionRequest(const DescribeConnectionRequest &other)
    : CloudWatchEventsRequest(new DescribeConnectionRequestPrivate(*other.d_func(), this))
{
...
DescribeConnectionRequest::DescribeConnectionRequest()
    : CloudWatchEventsRequest(new DescribeConnectionRequestPrivate(CloudWatchEventsRequest::DescribeConnectionAction, this))
{
...
/*!
 * \class QtAws::CloudWatchEvents::DescribeConnectionRequestPrivate
...
/*!
 * Constructs a DescribeConnectionRequestPrivate object for CloudWatchEvents \a action,
 * with public implementation \a q.
 */
DescribeConnectionRequestPrivate::DescribeConnectionRequestPrivate(
    const CloudWatchEventsRequest::Action action, DescribeConnectionRequest * const q)
