...
/*!
 * \class QtAws::CloudWatchEvents::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for CloudWatchEvents UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : CloudWatchEventsResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CloudWatchEvents UntagResource \a response.
 */
...
/*!
 * \class QtAws::CloudWatchEvents::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : CloudWatchEventsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchEvents UntagResource response element from \a xml.
 */
