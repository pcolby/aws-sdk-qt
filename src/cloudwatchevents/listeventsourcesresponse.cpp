...
/*!
 * \class QtAws::CloudWatchEvents::ListEventSourcesResponse
 * \brief The ListEventSourcesResponse class provides an interace for CloudWatchEvents ListEventSources responses.
 *
...
ListEventSourcesResponse::ListEventSourcesResponse(
    ...
    : CloudWatchEventsResponse(new ListEventSourcesResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListEventSourcesRequest *>(CloudWatchEventsResponse::request());
}

/*!
 * \reimp
 * Parses a successful CloudWatchEvents ListEventSources \a response.
 */
...
/*!
 * \class QtAws::CloudWatchEvents::ListEventSourcesResponsePrivate
...
ListEventSourcesResponsePrivate::ListEventSourcesResponsePrivate(
    ListEventSourcesResponse * const q) : CloudWatchEventsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchEvents ListEventSources response element from \a xml.
 */
