...
/*!
 * \class QtAws::CloudWatchEvents::DescribeArchiveResponse
 * \brief The DescribeArchiveResponse class provides an interace for CloudWatchEvents DescribeArchive responses.
 *
 ...
 *
 * \sa CloudWatchEventsClient::describeArchive
 */
...
DescribeArchiveResponse::DescribeArchiveResponse(
    ...
    : CloudWatchEventsResponse(new DescribeArchiveResponsePrivate(this), parent)
{
...
{
    return static_cast<const DescribeArchiveRequest *>(CloudWatchEventsResponse::request());
}

/*!
 * \reimp
 * Parses a successful CloudWatchEvents DescribeArchive \a response.
 */
...
/*!
 * \class QtAws::CloudWatchEvents::DescribeArchiveResponsePrivate
...
DescribeArchiveResponsePrivate::DescribeArchiveResponsePrivate(
    DescribeArchiveResponse * const q) : CloudWatchEventsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchEvents DescribeArchive response element from \a xml.
 */
