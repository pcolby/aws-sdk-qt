...
class QTAWS_EXPORT ListEventSourcesResponsePrivate : public CloudWatchEventsResponsePrivate {

public:

    ListEventSourcesResponsePrivate(ListEventSourcesResponse * const q);
