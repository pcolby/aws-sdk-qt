...
/*!
 * \class QtAws::CloudWatchEvents::CancelReplayResponse
 * \brief The CancelReplayResponse class provides an interace for CloudWatchEvents CancelReplay responses.
 *
...
CancelReplayResponse::CancelReplayResponse(
    ...
    : CloudWatchEventsResponse(new CancelReplayResponsePrivate(this), parent)
{
...
{
    return static_cast<const CancelReplayRequest *>(CloudWatchEventsResponse::request());
}

/*!
 * \reimp
 * Parses a successful CloudWatchEvents CancelReplay \a response.
 */
...
/*!
 * \class QtAws::CloudWatchEvents::CancelReplayResponsePrivate
...
CancelReplayResponsePrivate::CancelReplayResponsePrivate(
    CancelReplayResponse * const q) : CloudWatchEventsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchEvents CancelReplay response element from \a xml.
 */
