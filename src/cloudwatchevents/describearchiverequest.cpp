...
/*!
 * \class QtAws::CloudWatchEvents::DescribeArchiveRequest
 * \brief The DescribeArchiveRequest class provides an interface for CloudWatchEvents DescribeArchive requests.
 *
...
DescribeArchiveRequest::DescribeArchiveRequest(const DescribeArchiveRequest &other)
    : CloudWatchEventsRequest(new DescribeArchiveRequestPrivate(*other.d_func(), this))
{
...
DescribeArchiveRequest::DescribeArchiveRequest()
    : CloudWatchEventsRequest(new DescribeArchiveRequestPrivate(CloudWatchEventsRequest::DescribeArchiveAction, this))
{
...
/*!
 * \class QtAws::CloudWatchEvents::DescribeArchiveRequestPrivate
...
/*!
 * Constructs a DescribeArchiveRequestPrivate object for CloudWatchEvents \a action,
 * with public implementation \a q.
 */
DescribeArchiveRequestPrivate::DescribeArchiveRequestPrivate(
    const CloudWatchEventsRequest::Action action, DescribeArchiveRequest * const q)
