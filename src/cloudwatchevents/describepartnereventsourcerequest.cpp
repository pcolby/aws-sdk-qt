...
/*!
 * \class QtAws::CloudWatchEvents::DescribePartnerEventSourceRequest
 * \brief The DescribePartnerEventSourceRequest class provides an interface for CloudWatchEvents DescribePartnerEventSource requests.
 *
...
DescribePartnerEventSourceRequest::DescribePartnerEventSourceRequest(const DescribePartnerEventSourceRequest &other)
    : CloudWatchEventsRequest(new DescribePartnerEventSourceRequestPrivate(*other.d_func(), this))
{
...
DescribePartnerEventSourceRequest::DescribePartnerEventSourceRequest()
    : CloudWatchEventsRequest(new DescribePartnerEventSourceRequestPrivate(CloudWatchEventsRequest::DescribePartnerEventSourceAction, this))
{
...
/*!
 * \class QtAws::CloudWatchEvents::DescribePartnerEventSourceRequestPrivate
...
/*!
 * Constructs a DescribePartnerEventSourceRequestPrivate object for CloudWatchEvents \a action,
 * with public implementation \a q.
 */
DescribePartnerEventSourceRequestPrivate::DescribePartnerEventSourceRequestPrivate(
    const CloudWatchEventsRequest::Action action, DescribePartnerEventSourceRequest * const q)
