...
/*!
 * \class QtAws::CloudWatchEvents::DescribeApiDestinationRequest
 * \brief The DescribeApiDestinationRequest class provides an interface for CloudWatchEvents DescribeApiDestination requests.
 *
...
DescribeApiDestinationRequest::DescribeApiDestinationRequest(const DescribeApiDestinationRequest &other)
    : CloudWatchEventsRequest(new DescribeApiDestinationRequestPrivate(*other.d_func(), this))
{
...
DescribeApiDestinationRequest::DescribeApiDestinationRequest()
    : CloudWatchEventsRequest(new DescribeApiDestinationRequestPrivate(CloudWatchEventsRequest::DescribeApiDestinationAction, this))
{
...
/*!
 * \class QtAws::CloudWatchEvents::DescribeApiDestinationRequestPrivate
...
/*!
 * Constructs a DescribeApiDestinationRequestPrivate object for CloudWatchEvents \a action,
 * with public implementation \a q.
 */
DescribeApiDestinationRequestPrivate::DescribeApiDestinationRequestPrivate(
    const CloudWatchEventsRequest::Action action, DescribeApiDestinationRequest * const q)
