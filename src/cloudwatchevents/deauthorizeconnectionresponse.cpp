...
/*!
 * \class QtAws::CloudWatchEvents::DeauthorizeConnectionResponse
 * \brief The DeauthorizeConnectionResponse class provides an interace for CloudWatchEvents DeauthorizeConnection responses.
 *
...
DeauthorizeConnectionResponse::DeauthorizeConnectionResponse(
    ...
    : CloudWatchEventsResponse(new DeauthorizeConnectionResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CloudWatchEvents DeauthorizeConnection \a response.
 */
...
/*!
 * \class QtAws::CloudWatchEvents::DeauthorizeConnectionResponsePrivate
...
DeauthorizeConnectionResponsePrivate::DeauthorizeConnectionResponsePrivate(
    DeauthorizeConnectionResponse * const q) : CloudWatchEventsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchEvents DeauthorizeConnection response element from \a xml.
 */
