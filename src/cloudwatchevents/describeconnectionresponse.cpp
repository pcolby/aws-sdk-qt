...
/*!
 * \class QtAws::CloudWatchEvents::DescribeConnectionResponse
 * \brief The DescribeConnectionResponse class provides an interace for CloudWatchEvents DescribeConnection responses.
 *
...
DescribeConnectionResponse::DescribeConnectionResponse(
    ...
    : CloudWatchEventsResponse(new DescribeConnectionResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CloudWatchEvents DescribeConnection \a response.
 */
...
/*!
 * \class QtAws::CloudWatchEvents::DescribeConnectionResponsePrivate
...
DescribeConnectionResponsePrivate::DescribeConnectionResponsePrivate(
    DescribeConnectionResponse * const q) : CloudWatchEventsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchEvents DescribeConnection response element from \a xml.
 */
