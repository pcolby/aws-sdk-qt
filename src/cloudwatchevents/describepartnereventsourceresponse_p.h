...
class QTAWS_EXPORT DescribePartnerEventSourceResponsePrivate : public CloudWatchEventsResponsePrivate {

public:

    DescribePartnerEventSourceResponsePrivate(DescribePartnerEventSourceResponse * const q);
