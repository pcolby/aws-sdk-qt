...
/*!
 * \class QtAws::CloudWatchEvents::CreateConnectionResponse
 * \brief The CreateConnectionResponse class provides an interace for CloudWatchEvents CreateConnection responses.
 *
...
CreateConnectionResponse::CreateConnectionResponse(
    ...
    : CloudWatchEventsResponse(new CreateConnectionResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CloudWatchEvents CreateConnection \a response.
 */
...
/*!
 * \class QtAws::CloudWatchEvents::CreateConnectionResponsePrivate
...
CreateConnectionResponsePrivate::CreateConnectionResponsePrivate(
    CreateConnectionResponse * const q) : CloudWatchEventsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchEvents CreateConnection response element from \a xml.
 */
