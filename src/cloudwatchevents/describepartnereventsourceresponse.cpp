...
/*!
 * \class QtAws::CloudWatchEvents::DescribePartnerEventSourceResponse
 * \brief The DescribePartnerEventSourceResponse class provides an interace for CloudWatchEvents DescribePartnerEventSource responses.
 *
 ...
 *
 * \sa CloudWatchEventsClient::describePartnerEventSource
 */
...
DescribePartnerEventSourceResponse::DescribePartnerEventSourceResponse(
    ...
    : CloudWatchEventsResponse(new DescribePartnerEventSourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const DescribePartnerEventSourceRequest *>(CloudWatchEventsResponse::request());
}

/*!
 * \reimp
 * Parses a successful CloudWatchEvents DescribePartnerEventSource \a response.
 */
...
/*!
 * \class QtAws::CloudWatchEvents::DescribePartnerEventSourceResponsePrivate
...
DescribePartnerEventSourceResponsePrivate::DescribePartnerEventSourceResponsePrivate(
    DescribePartnerEventSourceResponse * const q) : CloudWatchEventsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchEvents DescribePartnerEventSource response element from \a xml.
 */
