...
/*!
 * \class QtAws::CloudWatchEvents::CreateArchiveRequest
 * \brief The CreateArchiveRequest class provides an interface for CloudWatchEvents CreateArchive requests.
 *
...
CreateArchiveRequest::CreateArchiveRequest(const CreateArchiveRequest &other)
    : CloudWatchEventsRequest(new CreateArchiveRequestPrivate(*other.d_func(), this))
{
...
CreateArchiveRequest::CreateArchiveRequest()
    : CloudWatchEventsRequest(new CreateArchiveRequestPrivate(CloudWatchEventsRequest::CreateArchiveAction, this))
{
...
/*!
 * \class QtAws::CloudWatchEvents::CreateArchiveRequestPrivate
...
/*!
 * Constructs a CreateArchiveRequestPrivate object for CloudWatchEvents \a action,
 * with public implementation \a q.
 */
CreateArchiveRequestPrivate::CreateArchiveRequestPrivate(
    const CloudWatchEventsRequest::Action action, CreateArchiveRequest * const q)
