...
/*!
 * \class QtAws::CloudWatchEvents::StartReplayRequest
 * \brief The StartReplayRequest class provides an interface for CloudWatchEvents StartReplay requests.
 *
...
StartReplayRequest::StartReplayRequest(const StartReplayRequest &other)
    : CloudWatchEventsRequest(new StartReplayRequestPrivate(*other.d_func(), this))
{
...
StartReplayRequest::StartReplayRequest()
    : CloudWatchEventsRequest(new StartReplayRequestPrivate(CloudWatchEventsRequest::StartReplayAction, this))
{
...
/*!
 * \class QtAws::CloudWatchEvents::StartReplayRequestPrivate
...
/*!
 * Constructs a StartReplayRequestPrivate object for CloudWatchEvents \a action,
 * with public implementation \a q.
 */
StartReplayRequestPrivate::StartReplayRequestPrivate(
    const CloudWatchEventsRequest::Action action, StartReplayRequest * const q)
