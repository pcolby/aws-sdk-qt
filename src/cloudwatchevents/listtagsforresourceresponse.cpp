...
/*!
 * \class QtAws::CloudWatchEvents::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for CloudWatchEvents ListTagsForResource responses.
 *
 ...
 *
 * \sa CloudWatchEventsClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : CloudWatchEventsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(CloudWatchEventsResponse::request());
}

/*!
 * \reimp
 * Parses a successful CloudWatchEvents ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::CloudWatchEvents::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : CloudWatchEventsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchEvents ListTagsForResource response element from \a xml.
 */
