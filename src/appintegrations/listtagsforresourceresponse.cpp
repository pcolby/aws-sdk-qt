...
/*!
 * \class QtAws::AppIntegrations::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for AppIntegrations ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : AppIntegrationsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful AppIntegrations ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::AppIntegrations::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : AppIntegrationsResponsePrivate(q)
{

}

/*!
 * Parses a AppIntegrations ListTagsForResource response element from \a xml.
 */
