...
/*!
 * \class QtAws::Nimble::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Nimble ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : NimbleResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Nimble ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Nimble::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : NimbleResponsePrivate(q)
{

}

/*!
 * Parses a Nimble ListTagsForResource response element from \a xml.
 */
