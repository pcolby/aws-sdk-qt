...
/*!
 * \class QtAws::Nimble::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Nimble UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : NimbleResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Nimble UntagResource \a response.
 */
...
/*!
 * \class QtAws::Nimble::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : NimbleResponsePrivate(q)
{

}

/*!
 * Parses a Nimble UntagResource response element from \a xml.
 */
