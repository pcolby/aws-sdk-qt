...
/*!
 * \class QtAws::Nimble::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Nimble TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : NimbleResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Nimble TagResource \a response.
 */
...
/*!
 * \class QtAws::Nimble::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : NimbleResponsePrivate(q)
{

}

/*!
 * Parses a Nimble TagResource response element from \a xml.
 */
