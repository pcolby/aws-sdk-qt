...
/*!
 * \class QtAws::CodeArtifact::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for CodeArtifact TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : CodeArtifactResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(CodeArtifactResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeArtifact TagResource \a response.
 */
...
/*!
 * \class QtAws::CodeArtifact::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact TagResource response element from \a xml.
 */
