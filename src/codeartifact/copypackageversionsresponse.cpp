...
#include "copypackageversionsresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::CopyPackageVersionsResponse
 * \brief The CopyPackageVersionsResponse class provides an interace for CodeArtifact CopyPackageVersions responses.
 *
...
/*!
 * Constructs a CopyPackageVersionsResponse object for \a reply to \a request, with parent \a parent.
 */
CopyPackageVersionsResponse::CopyPackageVersionsResponse(
        const CopyPackageVersionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new CopyPackageVersionsResponsePrivate(this), parent)
{
    setRequest(new CopyPackageVersionsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact CopyPackageVersions \a response.
 */
void CopyPackageVersionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CopyPackageVersionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::CopyPackageVersionsResponsePrivate
 * \brief The CopyPackageVersionsResponsePrivate class provides private implementation for CopyPackageVersionsResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a CopyPackageVersionsResponsePrivate object with public implementation \a q.
 */
CopyPackageVersionsResponsePrivate::CopyPackageVersionsResponsePrivate(
    CopyPackageVersionsResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact CopyPackageVersions response element from \a xml.
 */
void CopyPackageVersionsResponsePrivate::parseCopyPackageVersionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CopyPackageVersionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
