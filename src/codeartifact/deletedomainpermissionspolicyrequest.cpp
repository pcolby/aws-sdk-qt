...
#include "deletedomainpermissionspolicyrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::DeleteDomainPermissionsPolicyRequest
 * \brief The DeleteDomainPermissionsPolicyRequest class provides an interface for CodeArtifact DeleteDomainPermissionsPolicy requests.
 *
 ...
 *
 * \sa CodeArtifactClient::deleteDomainPermissionsPolicy
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteDomainPermissionsPolicyRequest::DeleteDomainPermissionsPolicyRequest(const DeleteDomainPermissionsPolicyRequest &other)
    : CodeArtifactRequest(new DeleteDomainPermissionsPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteDomainPermissionsPolicyRequest object.
 */
DeleteDomainPermissionsPolicyRequest::DeleteDomainPermissionsPolicyRequest()
    : CodeArtifactRequest(new DeleteDomainPermissionsPolicyRequestPrivate(CodeArtifactRequest::DeleteDomainPermissionsPolicyAction, this))
{
 ...
 * \reimp
 */
bool DeleteDomainPermissionsPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteDomainPermissionsPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteDomainPermissionsPolicyRequest::response(QNetworkReply * const reply) const
{
    return new DeleteDomainPermissionsPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::DeleteDomainPermissionsPolicyRequestPrivate
 * \brief The DeleteDomainPermissionsPolicyRequestPrivate class provides private implementation for DeleteDomainPermissionsPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a DeleteDomainPermissionsPolicyRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
DeleteDomainPermissionsPolicyRequestPrivate::DeleteDomainPermissionsPolicyRequestPrivate(
    const CodeArtifactRequest::Action action, DeleteDomainPermissionsPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteDomainPermissionsPolicyRequest
 * class' copy constructor.
 */
DeleteDomainPermissionsPolicyRequestPrivate::DeleteDomainPermissionsPolicyRequestPrivate(
    const DeleteDomainPermissionsPolicyRequestPrivate &other, DeleteDomainPermissionsPolicyRequest * const q)
