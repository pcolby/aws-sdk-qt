...
#include "getpackageversionreadmerequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::GetPackageVersionReadmeRequest
 * \brief The GetPackageVersionReadmeRequest class provides an interface for CodeArtifact GetPackageVersionReadme requests.
 *
 ...
 *
 * \sa CodeArtifactClient::getPackageVersionReadme
 */

/*!
 * Constructs a copy of \a other.
 */
GetPackageVersionReadmeRequest::GetPackageVersionReadmeRequest(const GetPackageVersionReadmeRequest &other)
    : CodeArtifactRequest(new GetPackageVersionReadmeRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetPackageVersionReadmeRequest object.
 */
GetPackageVersionReadmeRequest::GetPackageVersionReadmeRequest()
    : CodeArtifactRequest(new GetPackageVersionReadmeRequestPrivate(CodeArtifactRequest::GetPackageVersionReadmeAction, this))
{
 ...
 * \reimp
 */
bool GetPackageVersionReadmeRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetPackageVersionReadmeResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetPackageVersionReadmeRequest::response(QNetworkReply * const reply) const
{
    return new GetPackageVersionReadmeResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::GetPackageVersionReadmeRequestPrivate
 * \brief The GetPackageVersionReadmeRequestPrivate class provides private implementation for GetPackageVersionReadmeRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a GetPackageVersionReadmeRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
GetPackageVersionReadmeRequestPrivate::GetPackageVersionReadmeRequestPrivate(
    const CodeArtifactRequest::Action action, GetPackageVersionReadmeRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetPackageVersionReadmeRequest
 * class' copy constructor.
 */
GetPackageVersionReadmeRequestPrivate::GetPackageVersionReadmeRequestPrivate(
    const GetPackageVersionReadmeRequestPrivate &other, GetPackageVersionReadmeRequest * const q)
