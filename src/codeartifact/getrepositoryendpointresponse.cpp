...
#include "getrepositoryendpointresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::GetRepositoryEndpointResponse
 * \brief The GetRepositoryEndpointResponse class provides an interace for CodeArtifact GetRepositoryEndpoint responses.
 *
...
/*!
 * Constructs a GetRepositoryEndpointResponse object for \a reply to \a request, with parent \a parent.
 */
GetRepositoryEndpointResponse::GetRepositoryEndpointResponse(
        const GetRepositoryEndpointRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new GetRepositoryEndpointResponsePrivate(this), parent)
{
    setRequest(new GetRepositoryEndpointRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact GetRepositoryEndpoint \a response.
 */
void GetRepositoryEndpointResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetRepositoryEndpointResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::GetRepositoryEndpointResponsePrivate
 * \brief The GetRepositoryEndpointResponsePrivate class provides private implementation for GetRepositoryEndpointResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a GetRepositoryEndpointResponsePrivate object with public implementation \a q.
 */
GetRepositoryEndpointResponsePrivate::GetRepositoryEndpointResponsePrivate(
    GetRepositoryEndpointResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact GetRepositoryEndpoint response element from \a xml.
 */
void GetRepositoryEndpointResponsePrivate::parseGetRepositoryEndpointResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetRepositoryEndpointResponse"));
    Q_UNUSED(xml) ///< @todo
}
