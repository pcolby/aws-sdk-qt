...
/*!
 * \class QtAws::CodeArtifact::DescribePackageVersionRequest
 * \brief The DescribePackageVersionRequest class provides an interface for CodeArtifact DescribePackageVersion requests.
 *
...
DescribePackageVersionRequest::DescribePackageVersionRequest(const DescribePackageVersionRequest &other)
    : CodeArtifactRequest(new DescribePackageVersionRequestPrivate(*other.d_func(), this))
{
...
DescribePackageVersionRequest::DescribePackageVersionRequest()
    : CodeArtifactRequest(new DescribePackageVersionRequestPrivate(CodeArtifactRequest::DescribePackageVersionAction, this))
{
...
/*!
 * \class QtAws::CodeArtifact::DescribePackageVersionRequestPrivate
...
/*!
 * Constructs a DescribePackageVersionRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
DescribePackageVersionRequestPrivate::DescribePackageVersionRequestPrivate(
    const CodeArtifactRequest::Action action, DescribePackageVersionRequest * const q)
