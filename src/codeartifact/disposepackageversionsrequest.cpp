...
#include "disposepackageversionsrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::DisposePackageVersionsRequest
 * \brief The DisposePackageVersionsRequest class provides an interface for CodeArtifact DisposePackageVersions requests.
 *
 ...
 *
 * \sa CodeArtifactClient::disposePackageVersions
 */

/*!
 * Constructs a copy of \a other.
 */
DisposePackageVersionsRequest::DisposePackageVersionsRequest(const DisposePackageVersionsRequest &other)
    : CodeArtifactRequest(new DisposePackageVersionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DisposePackageVersionsRequest object.
 */
DisposePackageVersionsRequest::DisposePackageVersionsRequest()
    : CodeArtifactRequest(new DisposePackageVersionsRequestPrivate(CodeArtifactRequest::DisposePackageVersionsAction, this))
{
 ...
 * \reimp
 */
bool DisposePackageVersionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DisposePackageVersionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DisposePackageVersionsRequest::response(QNetworkReply * const reply) const
{
    return new DisposePackageVersionsResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::DisposePackageVersionsRequestPrivate
 * \brief The DisposePackageVersionsRequestPrivate class provides private implementation for DisposePackageVersionsRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a DisposePackageVersionsRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
DisposePackageVersionsRequestPrivate::DisposePackageVersionsRequestPrivate(
    const CodeArtifactRequest::Action action, DisposePackageVersionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DisposePackageVersionsRequest
 * class' copy constructor.
 */
DisposePackageVersionsRequestPrivate::DisposePackageVersionsRequestPrivate(
    const DisposePackageVersionsRequestPrivate &other, DisposePackageVersionsRequest * const q)
