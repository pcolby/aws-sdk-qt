...
/*!
 * \class QtAws::CodeArtifact::GetAuthorizationTokenResponse
 * \brief The GetAuthorizationTokenResponse class provides an interace for CodeArtifact GetAuthorizationToken responses.
 *
...
GetAuthorizationTokenResponse::GetAuthorizationTokenResponse(
    ...
    : CodeArtifactResponse(new GetAuthorizationTokenResponsePrivate(this), parent)
{
...
{
    return static_cast<const GetAuthorizationTokenRequest *>(CodeArtifactResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeArtifact GetAuthorizationToken \a response.
 */
...
/*!
 * \class QtAws::CodeArtifact::GetAuthorizationTokenResponsePrivate
...
GetAuthorizationTokenResponsePrivate::GetAuthorizationTokenResponsePrivate(
    GetAuthorizationTokenResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact GetAuthorizationToken response element from \a xml.
 */
