...
class QTAWS_EXPORT DescribePackageVersionResponsePrivate : public CodeArtifactResponsePrivate {

public:

    DescribePackageVersionResponsePrivate(DescribePackageVersionResponse * const q);
