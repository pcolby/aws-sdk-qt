...
#include "putpackageoriginconfigurationrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::PutPackageOriginConfigurationRequest
 * \brief The PutPackageOriginConfigurationRequest class provides an interface for CodeArtifact PutPackageOriginConfiguration requests.
 *
 ...
 */
PutPackageOriginConfigurationRequest::PutPackageOriginConfigurationRequest(const PutPackageOriginConfigurationRequest &other)
    : CodeArtifactRequest(new PutPackageOriginConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutPackageOriginConfigurationRequest object.
 */
PutPackageOriginConfigurationRequest::PutPackageOriginConfigurationRequest()
    : CodeArtifactRequest(new PutPackageOriginConfigurationRequestPrivate(CodeArtifactRequest::PutPackageOriginConfigurationAction, this))
{
 ...
 * \reimp
 */
bool PutPackageOriginConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutPackageOriginConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutPackageOriginConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new PutPackageOriginConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::PutPackageOriginConfigurationRequestPrivate
 * \brief The PutPackageOriginConfigurationRequestPrivate class provides private implementation for PutPackageOriginConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a PutPackageOriginConfigurationRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
PutPackageOriginConfigurationRequestPrivate::PutPackageOriginConfigurationRequestPrivate(
    const CodeArtifactRequest::Action action, PutPackageOriginConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutPackageOriginConfigurationRequest
 * class' copy constructor.
 */
PutPackageOriginConfigurationRequestPrivate::PutPackageOriginConfigurationRequestPrivate(
    const PutPackageOriginConfigurationRequestPrivate &other, PutPackageOriginConfigurationRequest * const q)
