...
#ifndef QTAWS_PUTREPOSITORYPERMISSIONSPOLICYREQUEST_H
#define QTAWS_PUTREPOSITORYPERMISSIONSPOLICYREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(PutRepositoryPermissionsPolicyRequest)
