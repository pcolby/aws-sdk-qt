...
#include "associateexternalconnectionrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::AssociateExternalConnectionRequest
 * \brief The AssociateExternalConnectionRequest class provides an interface for CodeArtifact AssociateExternalConnection requests.
 *
 ...
 *
 * \sa CodeArtifactClient::associateExternalConnection
 */

/*!
 * Constructs a copy of \a other.
 */
AssociateExternalConnectionRequest::AssociateExternalConnectionRequest(const AssociateExternalConnectionRequest &other)
    : CodeArtifactRequest(new AssociateExternalConnectionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AssociateExternalConnectionRequest object.
 */
AssociateExternalConnectionRequest::AssociateExternalConnectionRequest()
    : CodeArtifactRequest(new AssociateExternalConnectionRequestPrivate(CodeArtifactRequest::AssociateExternalConnectionAction, this))
{
 ...
 * \reimp
 */
bool AssociateExternalConnectionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AssociateExternalConnectionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AssociateExternalConnectionRequest::response(QNetworkReply * const reply) const
{
    return new AssociateExternalConnectionResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::AssociateExternalConnectionRequestPrivate
 * \brief The AssociateExternalConnectionRequestPrivate class provides private implementation for AssociateExternalConnectionRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a AssociateExternalConnectionRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
AssociateExternalConnectionRequestPrivate::AssociateExternalConnectionRequestPrivate(
    const CodeArtifactRequest::Action action, AssociateExternalConnectionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AssociateExternalConnectionRequest
 * class' copy constructor.
 */
AssociateExternalConnectionRequestPrivate::AssociateExternalConnectionRequestPrivate(
    const AssociateExternalConnectionRequestPrivate &other, AssociateExternalConnectionRequest * const q)
