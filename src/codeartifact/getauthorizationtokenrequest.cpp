...
/*!
 * \class QtAws::CodeArtifact::GetAuthorizationTokenRequest
 * \brief The GetAuthorizationTokenRequest class provides an interface for CodeArtifact GetAuthorizationToken requests.
 *
 ...
 *
 * \sa CodeArtifactClient::getAuthorizationToken
 */
...
GetAuthorizationTokenRequest::GetAuthorizationTokenRequest(const GetAuthorizationTokenRequest &other)
    : CodeArtifactRequest(new GetAuthorizationTokenRequestPrivate(*other.d_func(), this))
{
...
GetAuthorizationTokenRequest::GetAuthorizationTokenRequest()
    : CodeArtifactRequest(new GetAuthorizationTokenRequestPrivate(CodeArtifactRequest::GetAuthorizationTokenAction, this))
{
...
/*!
 * \class QtAws::CodeArtifact::GetAuthorizationTokenRequestPrivate
...
/*!
 * Constructs a GetAuthorizationTokenRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
GetAuthorizationTokenRequestPrivate::GetAuthorizationTokenRequestPrivate(
    const CodeArtifactRequest::Action action, GetAuthorizationTokenRequest * const q)
