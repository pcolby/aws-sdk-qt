...
#include "deletepackageversionsrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::DeletePackageVersionsRequest
 * \brief The DeletePackageVersionsRequest class provides an interface for CodeArtifact DeletePackageVersions requests.
 *
 ...
 *
 * \sa CodeArtifactClient::deletePackageVersions
 */

/*!
 * Constructs a copy of \a other.
 */
DeletePackageVersionsRequest::DeletePackageVersionsRequest(const DeletePackageVersionsRequest &other)
    : CodeArtifactRequest(new DeletePackageVersionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeletePackageVersionsRequest object.
 */
DeletePackageVersionsRequest::DeletePackageVersionsRequest()
    : CodeArtifactRequest(new DeletePackageVersionsRequestPrivate(CodeArtifactRequest::DeletePackageVersionsAction, this))
{
 ...
 * \reimp
 */
bool DeletePackageVersionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeletePackageVersionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeletePackageVersionsRequest::response(QNetworkReply * const reply) const
{
    return new DeletePackageVersionsResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::DeletePackageVersionsRequestPrivate
 * \brief The DeletePackageVersionsRequestPrivate class provides private implementation for DeletePackageVersionsRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a DeletePackageVersionsRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
DeletePackageVersionsRequestPrivate::DeletePackageVersionsRequestPrivate(
    const CodeArtifactRequest::Action action, DeletePackageVersionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeletePackageVersionsRequest
 * class' copy constructor.
 */
DeletePackageVersionsRequestPrivate::DeletePackageVersionsRequestPrivate(
    const DeletePackageVersionsRequestPrivate &other, DeletePackageVersionsRequest * const q)
