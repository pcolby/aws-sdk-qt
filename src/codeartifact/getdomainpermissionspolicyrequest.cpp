...
#include "getdomainpermissionspolicyrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::GetDomainPermissionsPolicyRequest
 * \brief The GetDomainPermissionsPolicyRequest class provides an interface for CodeArtifact GetDomainPermissionsPolicy requests.
 *
 ...
 *
 * \sa CodeArtifactClient::getDomainPermissionsPolicy
 */

/*!
 * Constructs a copy of \a other.
 */
GetDomainPermissionsPolicyRequest::GetDomainPermissionsPolicyRequest(const GetDomainPermissionsPolicyRequest &other)
    : CodeArtifactRequest(new GetDomainPermissionsPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetDomainPermissionsPolicyRequest object.
 */
GetDomainPermissionsPolicyRequest::GetDomainPermissionsPolicyRequest()
    : CodeArtifactRequest(new GetDomainPermissionsPolicyRequestPrivate(CodeArtifactRequest::GetDomainPermissionsPolicyAction, this))
{
 ...
 * \reimp
 */
bool GetDomainPermissionsPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetDomainPermissionsPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetDomainPermissionsPolicyRequest::response(QNetworkReply * const reply) const
{
    return new GetDomainPermissionsPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::GetDomainPermissionsPolicyRequestPrivate
 * \brief The GetDomainPermissionsPolicyRequestPrivate class provides private implementation for GetDomainPermissionsPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a GetDomainPermissionsPolicyRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
GetDomainPermissionsPolicyRequestPrivate::GetDomainPermissionsPolicyRequestPrivate(
    const CodeArtifactRequest::Action action, GetDomainPermissionsPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetDomainPermissionsPolicyRequest
 * class' copy constructor.
 */
GetDomainPermissionsPolicyRequestPrivate::GetDomainPermissionsPolicyRequestPrivate(
    const GetDomainPermissionsPolicyRequestPrivate &other, GetDomainPermissionsPolicyRequest * const q)
