...
#include "putdomainpermissionspolicyrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::PutDomainPermissionsPolicyRequest
 * \brief The PutDomainPermissionsPolicyRequest class provides an interface for CodeArtifact PutDomainPermissionsPolicy requests.
 *
 ...
 *
 * \sa CodeArtifactClient::putDomainPermissionsPolicy
 */

/*!
 * Constructs a copy of \a other.
 */
PutDomainPermissionsPolicyRequest::PutDomainPermissionsPolicyRequest(const PutDomainPermissionsPolicyRequest &other)
    : CodeArtifactRequest(new PutDomainPermissionsPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutDomainPermissionsPolicyRequest object.
 */
PutDomainPermissionsPolicyRequest::PutDomainPermissionsPolicyRequest()
    : CodeArtifactRequest(new PutDomainPermissionsPolicyRequestPrivate(CodeArtifactRequest::PutDomainPermissionsPolicyAction, this))
{
 ...
 * \reimp
 */
bool PutDomainPermissionsPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutDomainPermissionsPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutDomainPermissionsPolicyRequest::response(QNetworkReply * const reply) const
{
    return new PutDomainPermissionsPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::PutDomainPermissionsPolicyRequestPrivate
 * \brief The PutDomainPermissionsPolicyRequestPrivate class provides private implementation for PutDomainPermissionsPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a PutDomainPermissionsPolicyRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
PutDomainPermissionsPolicyRequestPrivate::PutDomainPermissionsPolicyRequestPrivate(
    const CodeArtifactRequest::Action action, PutDomainPermissionsPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutDomainPermissionsPolicyRequest
 * class' copy constructor.
 */
PutDomainPermissionsPolicyRequestPrivate::PutDomainPermissionsPolicyRequestPrivate(
    const PutDomainPermissionsPolicyRequestPrivate &other, PutDomainPermissionsPolicyRequest * const q)
