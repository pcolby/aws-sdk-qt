...
#include "putpackageoriginconfigurationresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::PutPackageOriginConfigurationResponse
 * \brief The PutPackageOriginConfigurationResponse class provides an interace for CodeArtifact PutPackageOriginConfiguration responses.
 *
 ...
 *
 * \sa CodeArtifactClient::putPackageOriginConfiguration
 */

/*!
 * Constructs a PutPackageOriginConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
PutPackageOriginConfigurationResponse::PutPackageOriginConfigurationResponse(
        const PutPackageOriginConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new PutPackageOriginConfigurationResponsePrivate(this), parent)
{
    setRequest(new PutPackageOriginConfigurationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const PutPackageOriginConfigurationRequest * PutPackageOriginConfigurationResponse::request() const
{
    Q_D(const PutPackageOriginConfigurationResponse);
    return static_cast<const PutPackageOriginConfigurationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful CodeArtifact PutPackageOriginConfiguration \a response.
 */
void PutPackageOriginConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutPackageOriginConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::PutPackageOriginConfigurationResponsePrivate
 * \brief The PutPackageOriginConfigurationResponsePrivate class provides private implementation for PutPackageOriginConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a PutPackageOriginConfigurationResponsePrivate object with public implementation \a q.
 */
PutPackageOriginConfigurationResponsePrivate::PutPackageOriginConfigurationResponsePrivate(
    PutPackageOriginConfigurationResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact PutPackageOriginConfiguration response element from \a xml.
 */
void PutPackageOriginConfigurationResponsePrivate::parsePutPackageOriginConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutPackageOriginConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
