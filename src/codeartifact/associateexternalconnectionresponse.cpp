...
#include "associateexternalconnectionresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::AssociateExternalConnectionResponse
 * \brief The AssociateExternalConnectionResponse class provides an interace for CodeArtifact AssociateExternalConnection responses.
 *
...
/*!
 * Constructs a AssociateExternalConnectionResponse object for \a reply to \a request, with parent \a parent.
 */
AssociateExternalConnectionResponse::AssociateExternalConnectionResponse(
        const AssociateExternalConnectionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new AssociateExternalConnectionResponsePrivate(this), parent)
{
    setRequest(new AssociateExternalConnectionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact AssociateExternalConnection \a response.
 */
void AssociateExternalConnectionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AssociateExternalConnectionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::AssociateExternalConnectionResponsePrivate
 * \brief The AssociateExternalConnectionResponsePrivate class provides private implementation for AssociateExternalConnectionResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a AssociateExternalConnectionResponsePrivate object with public implementation \a q.
 */
AssociateExternalConnectionResponsePrivate::AssociateExternalConnectionResponsePrivate(
    AssociateExternalConnectionResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact AssociateExternalConnection response element from \a xml.
 */
void AssociateExternalConnectionResponsePrivate::parseAssociateExternalConnectionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AssociateExternalConnectionResponse"));
    Q_UNUSED(xml) ///< @todo
}
