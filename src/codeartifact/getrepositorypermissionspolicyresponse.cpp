...
#include "getrepositorypermissionspolicyresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::GetRepositoryPermissionsPolicyResponse
 * \brief The GetRepositoryPermissionsPolicyResponse class provides an interace for CodeArtifact GetRepositoryPermissionsPolicy responses.
 *
...
/*!
 * Constructs a GetRepositoryPermissionsPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
GetRepositoryPermissionsPolicyResponse::GetRepositoryPermissionsPolicyResponse(
        const GetRepositoryPermissionsPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new GetRepositoryPermissionsPolicyResponsePrivate(this), parent)
{
    setRequest(new GetRepositoryPermissionsPolicyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact GetRepositoryPermissionsPolicy \a response.
 */
void GetRepositoryPermissionsPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetRepositoryPermissionsPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::GetRepositoryPermissionsPolicyResponsePrivate
 * \brief The GetRepositoryPermissionsPolicyResponsePrivate class provides private implementation for GetRepositoryPermissionsPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a GetRepositoryPermissionsPolicyResponsePrivate object with public implementation \a q.
 */
GetRepositoryPermissionsPolicyResponsePrivate::GetRepositoryPermissionsPolicyResponsePrivate(
    GetRepositoryPermissionsPolicyResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact GetRepositoryPermissionsPolicy response element from \a xml.
 */
void GetRepositoryPermissionsPolicyResponsePrivate::parseGetRepositoryPermissionsPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetRepositoryPermissionsPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
