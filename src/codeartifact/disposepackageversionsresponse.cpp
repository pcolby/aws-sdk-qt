...
#include "disposepackageversionsresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::DisposePackageVersionsResponse
 * \brief The DisposePackageVersionsResponse class provides an interace for CodeArtifact DisposePackageVersions responses.
 *
...
/*!
 * Constructs a DisposePackageVersionsResponse object for \a reply to \a request, with parent \a parent.
 */
DisposePackageVersionsResponse::DisposePackageVersionsResponse(
        const DisposePackageVersionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new DisposePackageVersionsResponsePrivate(this), parent)
{
    setRequest(new DisposePackageVersionsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact DisposePackageVersions \a response.
 */
void DisposePackageVersionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DisposePackageVersionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::DisposePackageVersionsResponsePrivate
 * \brief The DisposePackageVersionsResponsePrivate class provides private implementation for DisposePackageVersionsResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a DisposePackageVersionsResponsePrivate object with public implementation \a q.
 */
DisposePackageVersionsResponsePrivate::DisposePackageVersionsResponsePrivate(
    DisposePackageVersionsResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact DisposePackageVersions response element from \a xml.
 */
void DisposePackageVersionsResponsePrivate::parseDisposePackageVersionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DisposePackageVersionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
