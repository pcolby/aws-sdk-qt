...
#include "getpackageversionreadmeresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::GetPackageVersionReadmeResponse
 * \brief The GetPackageVersionReadmeResponse class provides an interace for CodeArtifact GetPackageVersionReadme responses.
 *
...
/*!
 * Constructs a GetPackageVersionReadmeResponse object for \a reply to \a request, with parent \a parent.
 */
GetPackageVersionReadmeResponse::GetPackageVersionReadmeResponse(
        const GetPackageVersionReadmeRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new GetPackageVersionReadmeResponsePrivate(this), parent)
{
    setRequest(new GetPackageVersionReadmeRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact GetPackageVersionReadme \a response.
 */
void GetPackageVersionReadmeResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetPackageVersionReadmeResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::GetPackageVersionReadmeResponsePrivate
 * \brief The GetPackageVersionReadmeResponsePrivate class provides private implementation for GetPackageVersionReadmeResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a GetPackageVersionReadmeResponsePrivate object with public implementation \a q.
 */
GetPackageVersionReadmeResponsePrivate::GetPackageVersionReadmeResponsePrivate(
    GetPackageVersionReadmeResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact GetPackageVersionReadme response element from \a xml.
 */
void GetPackageVersionReadmeResponsePrivate::parseGetPackageVersionReadmeResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetPackageVersionReadmeResponse"));
    Q_UNUSED(xml) ///< @todo
}
