...
/*!
 * \class QtAws::CodeArtifact::DescribeDomainRequest
 * \brief The DescribeDomainRequest class provides an interface for CodeArtifact DescribeDomain requests.
 *
 ...
 *
 * \sa CodeArtifactClient::describeDomain
 */
...
DescribeDomainRequest::DescribeDomainRequest(const DescribeDomainRequest &other)
    : CodeArtifactRequest(new DescribeDomainRequestPrivate(*other.d_func(), this))
{
...
DescribeDomainRequest::DescribeDomainRequest()
    : CodeArtifactRequest(new DescribeDomainRequestPrivate(CodeArtifactRequest::DescribeDomainAction, this))
{
...
/*!
 * \class QtAws::CodeArtifact::DescribeDomainRequestPrivate
...
/*!
 * Constructs a DescribeDomainRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
DescribeDomainRequestPrivate::DescribeDomainRequestPrivate(
    const CodeArtifactRequest::Action action, DescribeDomainRequest * const q)
