...
/*!
 * \class QtAws::CodeArtifact::ListDomainsRequest
 * \brief The ListDomainsRequest class provides an interface for CodeArtifact ListDomains requests.
 *
 ...
 *
 * \sa CodeArtifactClient::listDomains
 */
...
ListDomainsRequest::ListDomainsRequest(const ListDomainsRequest &other)
    : CodeArtifactRequest(new ListDomainsRequestPrivate(*other.d_func(), this))
{
...
ListDomainsRequest::ListDomainsRequest()
    : CodeArtifactRequest(new ListDomainsRequestPrivate(CodeArtifactRequest::ListDomainsAction, this))
{
...
/*!
 * \class QtAws::CodeArtifact::ListDomainsRequestPrivate
...
/*!
 * Constructs a ListDomainsRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
ListDomainsRequestPrivate::ListDomainsRequestPrivate(
    const CodeArtifactRequest::Action action, ListDomainsRequest * const q)
