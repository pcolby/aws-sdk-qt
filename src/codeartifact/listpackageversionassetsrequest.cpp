...
#include "listpackageversionassetsrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::ListPackageVersionAssetsRequest
 * \brief The ListPackageVersionAssetsRequest class provides an interface for CodeArtifact ListPackageVersionAssets requests.
 *
 ...
 *
 * \sa CodeArtifactClient::listPackageVersionAssets
 */

/*!
 * Constructs a copy of \a other.
 */
ListPackageVersionAssetsRequest::ListPackageVersionAssetsRequest(const ListPackageVersionAssetsRequest &other)
    : CodeArtifactRequest(new ListPackageVersionAssetsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListPackageVersionAssetsRequest object.
 */
ListPackageVersionAssetsRequest::ListPackageVersionAssetsRequest()
    : CodeArtifactRequest(new ListPackageVersionAssetsRequestPrivate(CodeArtifactRequest::ListPackageVersionAssetsAction, this))
{
 ...
 * \reimp
 */
bool ListPackageVersionAssetsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListPackageVersionAssetsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListPackageVersionAssetsRequest::response(QNetworkReply * const reply) const
{
    return new ListPackageVersionAssetsResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::ListPackageVersionAssetsRequestPrivate
 * \brief The ListPackageVersionAssetsRequestPrivate class provides private implementation for ListPackageVersionAssetsRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a ListPackageVersionAssetsRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
ListPackageVersionAssetsRequestPrivate::ListPackageVersionAssetsRequestPrivate(
    const CodeArtifactRequest::Action action, ListPackageVersionAssetsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListPackageVersionAssetsRequest
 * class' copy constructor.
 */
ListPackageVersionAssetsRequestPrivate::ListPackageVersionAssetsRequestPrivate(
    const ListPackageVersionAssetsRequestPrivate &other, ListPackageVersionAssetsRequest * const q)
