...
/*!
 * \class QtAws::CodeArtifact::ListPackagesResponse
 * \brief The ListPackagesResponse class provides an interace for CodeArtifact ListPackages responses.
 *
...
ListPackagesResponse::ListPackagesResponse(
    ...
    : CodeArtifactResponse(new ListPackagesResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CodeArtifact ListPackages \a response.
 */
...
/*!
 * \class QtAws::CodeArtifact::ListPackagesResponsePrivate
...
ListPackagesResponsePrivate::ListPackagesResponsePrivate(
    ListPackagesResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact ListPackages response element from \a xml.
 */
