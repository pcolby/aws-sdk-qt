...
/*!
 * \class QtAws::CodeArtifact::DescribeDomainResponse
 * \brief The DescribeDomainResponse class provides an interace for CodeArtifact DescribeDomain responses.
 *
...
DescribeDomainResponse::DescribeDomainResponse(
    ...
    : CodeArtifactResponse(new DescribeDomainResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CodeArtifact DescribeDomain \a response.
 */
...
/*!
 * \class QtAws::CodeArtifact::DescribeDomainResponsePrivate
...
DescribeDomainResponsePrivate::DescribeDomainResponsePrivate(
    DescribeDomainResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact DescribeDomain response element from \a xml.
 */
