...
/*!
 * \class QtAws::CodeArtifact::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for CodeArtifact ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : CodeArtifactResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CodeArtifact ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::CodeArtifact::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact ListTagsForResource response element from \a xml.
 */
