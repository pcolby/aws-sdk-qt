...
/*!
 * \class QtAws::CodeArtifact::ListDomainsResponse
 * \brief The ListDomainsResponse class provides an interace for CodeArtifact ListDomains responses.
 *
...
ListDomainsResponse::ListDomainsResponse(
    ...
    : CodeArtifactResponse(new ListDomainsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CodeArtifact ListDomains \a response.
 */
...
/*!
 * \class QtAws::CodeArtifact::ListDomainsResponsePrivate
...
ListDomainsResponsePrivate::ListDomainsResponsePrivate(
    ListDomainsResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact ListDomains response element from \a xml.
 */
