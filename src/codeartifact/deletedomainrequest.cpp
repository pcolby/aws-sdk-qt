...
/*!
 * \class QtAws::CodeArtifact::DeleteDomainRequest
 * \brief The DeleteDomainRequest class provides an interface for CodeArtifact DeleteDomain requests.
 *
 ...
 *
 * \sa CodeArtifactClient::deleteDomain
 */
...
DeleteDomainRequest::DeleteDomainRequest(const DeleteDomainRequest &other)
    : CodeArtifactRequest(new DeleteDomainRequestPrivate(*other.d_func(), this))
{
...
DeleteDomainRequest::DeleteDomainRequest()
    : CodeArtifactRequest(new DeleteDomainRequestPrivate(CodeArtifactRequest::DeleteDomainAction, this))
{
...
/*!
 * \class QtAws::CodeArtifact::DeleteDomainRequestPrivate
...
/*!
 * Constructs a DeleteDomainRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
DeleteDomainRequestPrivate::DeleteDomainRequestPrivate(
    const CodeArtifactRequest::Action action, DeleteDomainRequest * const q)
