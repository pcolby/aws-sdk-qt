...
#include "listpackageversiondependenciesresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::ListPackageVersionDependenciesResponse
 * \brief The ListPackageVersionDependenciesResponse class provides an interace for CodeArtifact ListPackageVersionDependencies responses.
 *
...
/*!
 * Constructs a ListPackageVersionDependenciesResponse object for \a reply to \a request, with parent \a parent.
 */
ListPackageVersionDependenciesResponse::ListPackageVersionDependenciesResponse(
        const ListPackageVersionDependenciesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new ListPackageVersionDependenciesResponsePrivate(this), parent)
{
    setRequest(new ListPackageVersionDependenciesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact ListPackageVersionDependencies \a response.
 */
void ListPackageVersionDependenciesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListPackageVersionDependenciesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::ListPackageVersionDependenciesResponsePrivate
 * \brief The ListPackageVersionDependenciesResponsePrivate class provides private implementation for ListPackageVersionDependenciesResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a ListPackageVersionDependenciesResponsePrivate object with public implementation \a q.
 */
ListPackageVersionDependenciesResponsePrivate::ListPackageVersionDependenciesResponsePrivate(
    ListPackageVersionDependenciesResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact ListPackageVersionDependencies response element from \a xml.
 */
void ListPackageVersionDependenciesResponsePrivate::parseListPackageVersionDependenciesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListPackageVersionDependenciesResponse"));
    Q_UNUSED(xml) ///< @todo
}
