...
/*!
 * \class QtAws::CodeArtifact::DeleteRepositoryRequest
 * \brief The DeleteRepositoryRequest class provides an interface for CodeArtifact DeleteRepository requests.
 *
 ...
 *
 * \sa CodeArtifactClient::deleteRepository
 */
...
DeleteRepositoryRequest::DeleteRepositoryRequest(const DeleteRepositoryRequest &other)
    : CodeArtifactRequest(new DeleteRepositoryRequestPrivate(*other.d_func(), this))
{
...
DeleteRepositoryRequest::DeleteRepositoryRequest()
    : CodeArtifactRequest(new DeleteRepositoryRequestPrivate(CodeArtifactRequest::DeleteRepositoryAction, this))
{
...
/*!
 * \class QtAws::CodeArtifact::DeleteRepositoryRequestPrivate
...
/*!
 * Constructs a DeleteRepositoryRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
DeleteRepositoryRequestPrivate::DeleteRepositoryRequestPrivate(
    const CodeArtifactRequest::Action action, DeleteRepositoryRequest * const q)
