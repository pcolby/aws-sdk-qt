...
/*!
 * \class QtAws::CodeArtifact::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for CodeArtifact UntagResource requests.
 *
 ...
 *
 * \sa CodeArtifactClient::untagResource
 */
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : CodeArtifactRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : CodeArtifactRequest(new UntagResourceRequestPrivate(CodeArtifactRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::CodeArtifact::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const CodeArtifactRequest::Action action, UntagResourceRequest * const q)
