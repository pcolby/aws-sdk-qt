...
#include "putdomainpermissionspolicyresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::PutDomainPermissionsPolicyResponse
 * \brief The PutDomainPermissionsPolicyResponse class provides an interace for CodeArtifact PutDomainPermissionsPolicy responses.
 *
...
/*!
 * Constructs a PutDomainPermissionsPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
PutDomainPermissionsPolicyResponse::PutDomainPermissionsPolicyResponse(
        const PutDomainPermissionsPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new PutDomainPermissionsPolicyResponsePrivate(this), parent)
{
    setRequest(new PutDomainPermissionsPolicyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact PutDomainPermissionsPolicy \a response.
 */
void PutDomainPermissionsPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutDomainPermissionsPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::PutDomainPermissionsPolicyResponsePrivate
 * \brief The PutDomainPermissionsPolicyResponsePrivate class provides private implementation for PutDomainPermissionsPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a PutDomainPermissionsPolicyResponsePrivate object with public implementation \a q.
 */
PutDomainPermissionsPolicyResponsePrivate::PutDomainPermissionsPolicyResponsePrivate(
    PutDomainPermissionsPolicyResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact PutDomainPermissionsPolicy response element from \a xml.
 */
void PutDomainPermissionsPolicyResponsePrivate::parsePutDomainPermissionsPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutDomainPermissionsPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
