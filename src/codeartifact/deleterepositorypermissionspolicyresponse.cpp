...
#include "deleterepositorypermissionspolicyresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::DeleteRepositoryPermissionsPolicyResponse
 * \brief The DeleteRepositoryPermissionsPolicyResponse class provides an interace for CodeArtifact DeleteRepositoryPermissionsPolicy responses.
 *
...
/*!
 * Constructs a DeleteRepositoryPermissionsPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteRepositoryPermissionsPolicyResponse::DeleteRepositoryPermissionsPolicyResponse(
        const DeleteRepositoryPermissionsPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new DeleteRepositoryPermissionsPolicyResponsePrivate(this), parent)
{
    setRequest(new DeleteRepositoryPermissionsPolicyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact DeleteRepositoryPermissionsPolicy \a response.
 */
void DeleteRepositoryPermissionsPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteRepositoryPermissionsPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::DeleteRepositoryPermissionsPolicyResponsePrivate
 * \brief The DeleteRepositoryPermissionsPolicyResponsePrivate class provides private implementation for DeleteRepositoryPermissionsPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a DeleteRepositoryPermissionsPolicyResponsePrivate object with public implementation \a q.
 */
DeleteRepositoryPermissionsPolicyResponsePrivate::DeleteRepositoryPermissionsPolicyResponsePrivate(
    DeleteRepositoryPermissionsPolicyResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact DeleteRepositoryPermissionsPolicy response element from \a xml.
 */
void DeleteRepositoryPermissionsPolicyResponsePrivate::parseDeleteRepositoryPermissionsPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteRepositoryPermissionsPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
