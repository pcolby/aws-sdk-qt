...
/*!
 * \class QtAws::CodeArtifact::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for CodeArtifact TagResource requests.
 *
 ...
 *
 * \sa CodeArtifactClient::tagResource
 */
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : CodeArtifactRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : CodeArtifactRequest(new TagResourceRequestPrivate(CodeArtifactRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::CodeArtifact::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const CodeArtifactRequest::Action action, TagResourceRequest * const q)
