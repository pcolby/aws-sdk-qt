...
#include "getpackageversionassetresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::GetPackageVersionAssetResponse
 * \brief The GetPackageVersionAssetResponse class provides an interace for CodeArtifact GetPackageVersionAsset responses.
 *
 ...
 *
 * \sa CodeArtifactClient::getPackageVersionAsset
 */

/*!
 * Constructs a GetPackageVersionAssetResponse object for \a reply to \a request, with parent \a parent.
 */
GetPackageVersionAssetResponse::GetPackageVersionAssetResponse(
        const GetPackageVersionAssetRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new GetPackageVersionAssetResponsePrivate(this), parent)
{
    setRequest(new GetPackageVersionAssetRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetPackageVersionAssetRequest * GetPackageVersionAssetResponse::request() const
{
    Q_D(const GetPackageVersionAssetResponse);
    return static_cast<const GetPackageVersionAssetRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful CodeArtifact GetPackageVersionAsset \a response.
 */
void GetPackageVersionAssetResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetPackageVersionAssetResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::GetPackageVersionAssetResponsePrivate
 * \brief The GetPackageVersionAssetResponsePrivate class provides private implementation for GetPackageVersionAssetResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a GetPackageVersionAssetResponsePrivate object with public implementation \a q.
 */
GetPackageVersionAssetResponsePrivate::GetPackageVersionAssetResponsePrivate(
    GetPackageVersionAssetResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact GetPackageVersionAsset response element from \a xml.
 */
void GetPackageVersionAssetResponsePrivate::parseGetPackageVersionAssetResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetPackageVersionAssetResponse"));
    Q_UNUSED(xml) ///< @todo
}
