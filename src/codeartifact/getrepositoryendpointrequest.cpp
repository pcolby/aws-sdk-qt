...
#include "getrepositoryendpointrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::GetRepositoryEndpointRequest
 * \brief The GetRepositoryEndpointRequest class provides an interface for CodeArtifact GetRepositoryEndpoint requests.
 *
 ...
 *
 * \sa CodeArtifactClient::getRepositoryEndpoint
 */

/*!
 * Constructs a copy of \a other.
 */
GetRepositoryEndpointRequest::GetRepositoryEndpointRequest(const GetRepositoryEndpointRequest &other)
    : CodeArtifactRequest(new GetRepositoryEndpointRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetRepositoryEndpointRequest object.
 */
GetRepositoryEndpointRequest::GetRepositoryEndpointRequest()
    : CodeArtifactRequest(new GetRepositoryEndpointRequestPrivate(CodeArtifactRequest::GetRepositoryEndpointAction, this))
{
 ...
 * \reimp
 */
bool GetRepositoryEndpointRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetRepositoryEndpointResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetRepositoryEndpointRequest::response(QNetworkReply * const reply) const
{
    return new GetRepositoryEndpointResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::GetRepositoryEndpointRequestPrivate
 * \brief The GetRepositoryEndpointRequestPrivate class provides private implementation for GetRepositoryEndpointRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a GetRepositoryEndpointRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
GetRepositoryEndpointRequestPrivate::GetRepositoryEndpointRequestPrivate(
    const CodeArtifactRequest::Action action, GetRepositoryEndpointRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetRepositoryEndpointRequest
 * class' copy constructor.
 */
GetRepositoryEndpointRequestPrivate::GetRepositoryEndpointRequestPrivate(
    const GetRepositoryEndpointRequestPrivate &other, GetRepositoryEndpointRequest * const q)
