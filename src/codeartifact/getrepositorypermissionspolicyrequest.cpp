...
#include "getrepositorypermissionspolicyrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::GetRepositoryPermissionsPolicyRequest
 * \brief The GetRepositoryPermissionsPolicyRequest class provides an interface for CodeArtifact GetRepositoryPermissionsPolicy requests.
 *
 ...
 *
 * \sa CodeArtifactClient::getRepositoryPermissionsPolicy
 */

/*!
 * Constructs a copy of \a other.
 */
GetRepositoryPermissionsPolicyRequest::GetRepositoryPermissionsPolicyRequest(const GetRepositoryPermissionsPolicyRequest &other)
    : CodeArtifactRequest(new GetRepositoryPermissionsPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetRepositoryPermissionsPolicyRequest object.
 */
GetRepositoryPermissionsPolicyRequest::GetRepositoryPermissionsPolicyRequest()
    : CodeArtifactRequest(new GetRepositoryPermissionsPolicyRequestPrivate(CodeArtifactRequest::GetRepositoryPermissionsPolicyAction, this))
{
 ...
 * \reimp
 */
bool GetRepositoryPermissionsPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetRepositoryPermissionsPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetRepositoryPermissionsPolicyRequest::response(QNetworkReply * const reply) const
{
    return new GetRepositoryPermissionsPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::GetRepositoryPermissionsPolicyRequestPrivate
 * \brief The GetRepositoryPermissionsPolicyRequestPrivate class provides private implementation for GetRepositoryPermissionsPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a GetRepositoryPermissionsPolicyRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
GetRepositoryPermissionsPolicyRequestPrivate::GetRepositoryPermissionsPolicyRequestPrivate(
    const CodeArtifactRequest::Action action, GetRepositoryPermissionsPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetRepositoryPermissionsPolicyRequest
 * class' copy constructor.
 */
GetRepositoryPermissionsPolicyRequestPrivate::GetRepositoryPermissionsPolicyRequestPrivate(
    const GetRepositoryPermissionsPolicyRequestPrivate &other, GetRepositoryPermissionsPolicyRequest * const q)
