...
#include "listpackageversionsrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::ListPackageVersionsRequest
 * \brief The ListPackageVersionsRequest class provides an interface for CodeArtifact ListPackageVersions requests.
 *
 ...
 */
ListPackageVersionsRequest::ListPackageVersionsRequest(const ListPackageVersionsRequest &other)
    : CodeArtifactRequest(new ListPackageVersionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListPackageVersionsRequest object.
 */
ListPackageVersionsRequest::ListPackageVersionsRequest()
    : CodeArtifactRequest(new ListPackageVersionsRequestPrivate(CodeArtifactRequest::ListPackageVersionsAction, this))
{
 ...
 * \reimp
 */
bool ListPackageVersionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListPackageVersionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListPackageVersionsRequest::response(QNetworkReply * const reply) const
{
    return new ListPackageVersionsResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::ListPackageVersionsRequestPrivate
 * \brief The ListPackageVersionsRequestPrivate class provides private implementation for ListPackageVersionsRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a ListPackageVersionsRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
ListPackageVersionsRequestPrivate::ListPackageVersionsRequestPrivate(
    const CodeArtifactRequest::Action action, ListPackageVersionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListPackageVersionsRequest
 * class' copy constructor.
 */
ListPackageVersionsRequestPrivate::ListPackageVersionsRequestPrivate(
    const ListPackageVersionsRequestPrivate &other, ListPackageVersionsRequest * const q)
