...
#include "updaterepositoryresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::UpdateRepositoryResponse
 * \brief The UpdateRepositoryResponse class provides an interace for CodeArtifact UpdateRepository responses.
 *
...
/*!
 * Constructs a UpdateRepositoryResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateRepositoryResponse::UpdateRepositoryResponse(
        const UpdateRepositoryRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new UpdateRepositoryResponsePrivate(this), parent)
{
    setRequest(new UpdateRepositoryRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact UpdateRepository \a response.
 */
void UpdateRepositoryResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateRepositoryResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::UpdateRepositoryResponsePrivate
 * \brief The UpdateRepositoryResponsePrivate class provides private implementation for UpdateRepositoryResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a UpdateRepositoryResponsePrivate object with public implementation \a q.
 */
UpdateRepositoryResponsePrivate::UpdateRepositoryResponsePrivate(
    UpdateRepositoryResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact UpdateRepository response element from \a xml.
 */
void UpdateRepositoryResponsePrivate::parseUpdateRepositoryResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateRepositoryResponse"));
    Q_UNUSED(xml) ///< @todo
}
