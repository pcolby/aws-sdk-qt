...
#include "listrepositoriesindomainresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::ListRepositoriesInDomainResponse
 * \brief The ListRepositoriesInDomainResponse class provides an interace for CodeArtifact ListRepositoriesInDomain responses.
 *
...
/*!
 * Constructs a ListRepositoriesInDomainResponse object for \a reply to \a request, with parent \a parent.
 */
ListRepositoriesInDomainResponse::ListRepositoriesInDomainResponse(
        const ListRepositoriesInDomainRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new ListRepositoriesInDomainResponsePrivate(this), parent)
{
    setRequest(new ListRepositoriesInDomainRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact ListRepositoriesInDomain \a response.
 */
void ListRepositoriesInDomainResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListRepositoriesInDomainResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::ListRepositoriesInDomainResponsePrivate
 * \brief The ListRepositoriesInDomainResponsePrivate class provides private implementation for ListRepositoriesInDomainResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a ListRepositoriesInDomainResponsePrivate object with public implementation \a q.
 */
ListRepositoriesInDomainResponsePrivate::ListRepositoriesInDomainResponsePrivate(
    ListRepositoriesInDomainResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact ListRepositoriesInDomain response element from \a xml.
 */
void ListRepositoriesInDomainResponsePrivate::parseListRepositoriesInDomainResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListRepositoriesInDomainResponse"));
    Q_UNUSED(xml) ///< @todo
}
