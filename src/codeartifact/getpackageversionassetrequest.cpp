...
#include "getpackageversionassetrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::GetPackageVersionAssetRequest
 * \brief The GetPackageVersionAssetRequest class provides an interface for CodeArtifact GetPackageVersionAsset requests.
 *
 ...
 */
GetPackageVersionAssetRequest::GetPackageVersionAssetRequest(const GetPackageVersionAssetRequest &other)
    : CodeArtifactRequest(new GetPackageVersionAssetRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetPackageVersionAssetRequest object.
 */
GetPackageVersionAssetRequest::GetPackageVersionAssetRequest()
    : CodeArtifactRequest(new GetPackageVersionAssetRequestPrivate(CodeArtifactRequest::GetPackageVersionAssetAction, this))
{
 ...
 * \reimp
 */
bool GetPackageVersionAssetRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetPackageVersionAssetResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetPackageVersionAssetRequest::response(QNetworkReply * const reply) const
{
    return new GetPackageVersionAssetResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::GetPackageVersionAssetRequestPrivate
 * \brief The GetPackageVersionAssetRequestPrivate class provides private implementation for GetPackageVersionAssetRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a GetPackageVersionAssetRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
GetPackageVersionAssetRequestPrivate::GetPackageVersionAssetRequestPrivate(
    const CodeArtifactRequest::Action action, GetPackageVersionAssetRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetPackageVersionAssetRequest
 * class' copy constructor.
 */
GetPackageVersionAssetRequestPrivate::GetPackageVersionAssetRequestPrivate(
    const GetPackageVersionAssetRequestPrivate &other, GetPackageVersionAssetRequest * const q)
