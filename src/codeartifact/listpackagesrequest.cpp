...
/*!
 * \class QtAws::CodeArtifact::ListPackagesRequest
 * \brief The ListPackagesRequest class provides an interface for CodeArtifact ListPackages requests.
 *
 ...
 *
 * \sa CodeArtifactClient::listPackages
 */
...
ListPackagesRequest::ListPackagesRequest(const ListPackagesRequest &other)
    : CodeArtifactRequest(new ListPackagesRequestPrivate(*other.d_func(), this))
{
...
ListPackagesRequest::ListPackagesRequest()
    : CodeArtifactRequest(new ListPackagesRequestPrivate(CodeArtifactRequest::ListPackagesAction, this))
{
...
/*!
 * \class QtAws::CodeArtifact::ListPackagesRequestPrivate
...
/*!
 * Constructs a ListPackagesRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
ListPackagesRequestPrivate::ListPackagesRequestPrivate(
    const CodeArtifactRequest::Action action, ListPackagesRequest * const q)
