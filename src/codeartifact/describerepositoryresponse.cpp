...
#include "describerepositoryresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::DescribeRepositoryResponse
 * \brief The DescribeRepositoryResponse class provides an interace for CodeArtifact DescribeRepository responses.
 *
...
/*!
 * Constructs a DescribeRepositoryResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeRepositoryResponse::DescribeRepositoryResponse(
        const DescribeRepositoryRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new DescribeRepositoryResponsePrivate(this), parent)
{
    setRequest(new DescribeRepositoryRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact DescribeRepository \a response.
 */
void DescribeRepositoryResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeRepositoryResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::DescribeRepositoryResponsePrivate
 * \brief The DescribeRepositoryResponsePrivate class provides private implementation for DescribeRepositoryResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a DescribeRepositoryResponsePrivate object with public implementation \a q.
 */
DescribeRepositoryResponsePrivate::DescribeRepositoryResponsePrivate(
    DescribeRepositoryResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact DescribeRepository response element from \a xml.
 */
void DescribeRepositoryResponsePrivate::parseDescribeRepositoryResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeRepositoryResponse"));
    Q_UNUSED(xml) ///< @todo
}
