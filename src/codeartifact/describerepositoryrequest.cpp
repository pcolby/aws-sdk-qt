...
#include "describerepositoryrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::DescribeRepositoryRequest
 * \brief The DescribeRepositoryRequest class provides an interface for CodeArtifact DescribeRepository requests.
 *
 ...
 *
 * \sa CodeArtifactClient::describeRepository
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeRepositoryRequest::DescribeRepositoryRequest(const DescribeRepositoryRequest &other)
    : CodeArtifactRequest(new DescribeRepositoryRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeRepositoryRequest object.
 */
DescribeRepositoryRequest::DescribeRepositoryRequest()
    : CodeArtifactRequest(new DescribeRepositoryRequestPrivate(CodeArtifactRequest::DescribeRepositoryAction, this))
{
 ...
 * \reimp
 */
bool DescribeRepositoryRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeRepositoryResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeRepositoryRequest::response(QNetworkReply * const reply) const
{
    return new DescribeRepositoryResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::DescribeRepositoryRequestPrivate
 * \brief The DescribeRepositoryRequestPrivate class provides private implementation for DescribeRepositoryRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a DescribeRepositoryRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
DescribeRepositoryRequestPrivate::DescribeRepositoryRequestPrivate(
    const CodeArtifactRequest::Action action, DescribeRepositoryRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeRepositoryRequest
 * class' copy constructor.
 */
DescribeRepositoryRequestPrivate::DescribeRepositoryRequestPrivate(
    const DescribeRepositoryRequestPrivate &other, DescribeRepositoryRequest * const q)
