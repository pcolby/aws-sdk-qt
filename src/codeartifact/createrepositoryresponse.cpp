...
/*!
 * \class QtAws::CodeArtifact::CreateRepositoryResponse
 * \brief The CreateRepositoryResponse class provides an interace for CodeArtifact CreateRepository responses.
 *
...
CreateRepositoryResponse::CreateRepositoryResponse(
    ...
    : CodeArtifactResponse(new CreateRepositoryResponsePrivate(this), parent)
{
...
{
    return static_cast<const CreateRepositoryRequest *>(CodeArtifactResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeArtifact CreateRepository \a response.
 */
...
/*!
 * \class QtAws::CodeArtifact::CreateRepositoryResponsePrivate
...
CreateRepositoryResponsePrivate::CreateRepositoryResponsePrivate(
    CreateRepositoryResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact CreateRepository response element from \a xml.
 */
