...
#include "listrepositoriesindomainrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::ListRepositoriesInDomainRequest
 * \brief The ListRepositoriesInDomainRequest class provides an interface for CodeArtifact ListRepositoriesInDomain requests.
 *
 ...
 *
 * \sa CodeArtifactClient::listRepositoriesInDomain
 */

/*!
 * Constructs a copy of \a other.
 */
ListRepositoriesInDomainRequest::ListRepositoriesInDomainRequest(const ListRepositoriesInDomainRequest &other)
    : CodeArtifactRequest(new ListRepositoriesInDomainRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListRepositoriesInDomainRequest object.
 */
ListRepositoriesInDomainRequest::ListRepositoriesInDomainRequest()
    : CodeArtifactRequest(new ListRepositoriesInDomainRequestPrivate(CodeArtifactRequest::ListRepositoriesInDomainAction, this))
{
 ...
 * \reimp
 */
bool ListRepositoriesInDomainRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListRepositoriesInDomainResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListRepositoriesInDomainRequest::response(QNetworkReply * const reply) const
{
    return new ListRepositoriesInDomainResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::ListRepositoriesInDomainRequestPrivate
 * \brief The ListRepositoriesInDomainRequestPrivate class provides private implementation for ListRepositoriesInDomainRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a ListRepositoriesInDomainRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
ListRepositoriesInDomainRequestPrivate::ListRepositoriesInDomainRequestPrivate(
    const CodeArtifactRequest::Action action, ListRepositoriesInDomainRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListRepositoriesInDomainRequest
 * class' copy constructor.
 */
ListRepositoriesInDomainRequestPrivate::ListRepositoriesInDomainRequestPrivate(
    const ListRepositoriesInDomainRequestPrivate &other, ListRepositoriesInDomainRequest * const q)
