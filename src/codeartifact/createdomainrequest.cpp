...
/*!
 * \class QtAws::CodeArtifact::CreateDomainRequest
 * \brief The CreateDomainRequest class provides an interface for CodeArtifact CreateDomain requests.
 *
 ...
 *
 * \sa CodeArtifactClient::createDomain
 */
...
CreateDomainRequest::CreateDomainRequest(const CreateDomainRequest &other)
    : CodeArtifactRequest(new CreateDomainRequestPrivate(*other.d_func(), this))
{
...
CreateDomainRequest::CreateDomainRequest()
    : CodeArtifactRequest(new CreateDomainRequestPrivate(CodeArtifactRequest::CreateDomainAction, this))
{
...
/*!
 * \class QtAws::CodeArtifact::CreateDomainRequestPrivate
...
/*!
 * Constructs a CreateDomainRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
CreateDomainRequestPrivate::CreateDomainRequestPrivate(
    const CodeArtifactRequest::Action action, CreateDomainRequest * const q)
