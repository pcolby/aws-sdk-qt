...
#include "listpackageversionassetsresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::ListPackageVersionAssetsResponse
 * \brief The ListPackageVersionAssetsResponse class provides an interace for CodeArtifact ListPackageVersionAssets responses.
 *
...
/*!
 * Constructs a ListPackageVersionAssetsResponse object for \a reply to \a request, with parent \a parent.
 */
ListPackageVersionAssetsResponse::ListPackageVersionAssetsResponse(
        const ListPackageVersionAssetsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new ListPackageVersionAssetsResponsePrivate(this), parent)
{
    setRequest(new ListPackageVersionAssetsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact ListPackageVersionAssets \a response.
 */
void ListPackageVersionAssetsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListPackageVersionAssetsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::ListPackageVersionAssetsResponsePrivate
 * \brief The ListPackageVersionAssetsResponsePrivate class provides private implementation for ListPackageVersionAssetsResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a ListPackageVersionAssetsResponsePrivate object with public implementation \a q.
 */
ListPackageVersionAssetsResponsePrivate::ListPackageVersionAssetsResponsePrivate(
    ListPackageVersionAssetsResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact ListPackageVersionAssets response element from \a xml.
 */
void ListPackageVersionAssetsResponsePrivate::parseListPackageVersionAssetsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListPackageVersionAssetsResponse"));
    Q_UNUSED(xml) ///< @todo
}
