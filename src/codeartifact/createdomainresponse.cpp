...
/*!
 * \class QtAws::CodeArtifact::CreateDomainResponse
 * \brief The CreateDomainResponse class provides an interace for CodeArtifact CreateDomain responses.
 *
...
CreateDomainResponse::CreateDomainResponse(
    ...
    : CodeArtifactResponse(new CreateDomainResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CodeArtifact CreateDomain \a response.
 */
...
/*!
 * \class QtAws::CodeArtifact::CreateDomainResponsePrivate
...
CreateDomainResponsePrivate::CreateDomainResponsePrivate(
    CreateDomainResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact CreateDomain response element from \a xml.
 */
