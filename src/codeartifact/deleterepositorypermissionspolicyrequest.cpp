...
#include "deleterepositorypermissionspolicyrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::DeleteRepositoryPermissionsPolicyRequest
 * \brief The DeleteRepositoryPermissionsPolicyRequest class provides an interface for CodeArtifact DeleteRepositoryPermissionsPolicy requests.
 *
 ...
 *
 * \sa CodeArtifactClient::deleteRepositoryPermissionsPolicy
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteRepositoryPermissionsPolicyRequest::DeleteRepositoryPermissionsPolicyRequest(const DeleteRepositoryPermissionsPolicyRequest &other)
    : CodeArtifactRequest(new DeleteRepositoryPermissionsPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteRepositoryPermissionsPolicyRequest object.
 */
DeleteRepositoryPermissionsPolicyRequest::DeleteRepositoryPermissionsPolicyRequest()
    : CodeArtifactRequest(new DeleteRepositoryPermissionsPolicyRequestPrivate(CodeArtifactRequest::DeleteRepositoryPermissionsPolicyAction, this))
{
 ...
 * \reimp
 */
bool DeleteRepositoryPermissionsPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteRepositoryPermissionsPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteRepositoryPermissionsPolicyRequest::response(QNetworkReply * const reply) const
{
    return new DeleteRepositoryPermissionsPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::DeleteRepositoryPermissionsPolicyRequestPrivate
 * \brief The DeleteRepositoryPermissionsPolicyRequestPrivate class provides private implementation for DeleteRepositoryPermissionsPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a DeleteRepositoryPermissionsPolicyRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
DeleteRepositoryPermissionsPolicyRequestPrivate::DeleteRepositoryPermissionsPolicyRequestPrivate(
    const CodeArtifactRequest::Action action, DeleteRepositoryPermissionsPolicyRequest * const q)
    : CodeArtifactRequestPrivate(action, q)
{
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteRepositoryPermissionsPolicyRequest
 * class' copy constructor.
 */
DeleteRepositoryPermissionsPolicyRequestPrivate::DeleteRepositoryPermissionsPolicyRequestPrivate(
    const DeleteRepositoryPermissionsPolicyRequestPrivate &other, DeleteRepositoryPermissionsPolicyRequest * const q)
    : CodeArtifactRequestPrivate(other, q)
{
