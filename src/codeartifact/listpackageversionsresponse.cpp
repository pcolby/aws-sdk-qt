...
#include "listpackageversionsresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::ListPackageVersionsResponse
 * \brief The ListPackageVersionsResponse class provides an interace for CodeArtifact ListPackageVersions responses.
 *
 ...
 *
 * \sa CodeArtifactClient::listPackageVersions
 */

/*!
 * Constructs a ListPackageVersionsResponse object for \a reply to \a request, with parent \a parent.
 */
ListPackageVersionsResponse::ListPackageVersionsResponse(
        const ListPackageVersionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new ListPackageVersionsResponsePrivate(this), parent)
{
    setRequest(new ListPackageVersionsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListPackageVersionsRequest * ListPackageVersionsResponse::request() const
{
    Q_D(const ListPackageVersionsResponse);
    return static_cast<const ListPackageVersionsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful CodeArtifact ListPackageVersions \a response.
 */
void ListPackageVersionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListPackageVersionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::ListPackageVersionsResponsePrivate
 * \brief The ListPackageVersionsResponsePrivate class provides private implementation for ListPackageVersionsResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a ListPackageVersionsResponsePrivate object with public implementation \a q.
 */
ListPackageVersionsResponsePrivate::ListPackageVersionsResponsePrivate(
    ListPackageVersionsResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact ListPackageVersions response element from \a xml.
 */
void ListPackageVersionsResponsePrivate::parseListPackageVersionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListPackageVersionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
