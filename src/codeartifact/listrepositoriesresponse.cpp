...
/*!
 * \class QtAws::CodeArtifact::ListRepositoriesResponse
 * \brief The ListRepositoriesResponse class provides an interace for CodeArtifact ListRepositories responses.
 *
...
ListRepositoriesResponse::ListRepositoriesResponse(
    ...
    : CodeArtifactResponse(new ListRepositoriesResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListRepositoriesRequest *>(CodeArtifactResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeArtifact ListRepositories \a response.
 */
...
/*!
 * \class QtAws::CodeArtifact::ListRepositoriesResponsePrivate
...
ListRepositoriesResponsePrivate::ListRepositoriesResponsePrivate(
    ListRepositoriesResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact ListRepositories response element from \a xml.
 */
