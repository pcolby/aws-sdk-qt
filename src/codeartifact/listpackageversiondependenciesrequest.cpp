...
#include "listpackageversiondependenciesrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::ListPackageVersionDependenciesRequest
 * \brief The ListPackageVersionDependenciesRequest class provides an interface for CodeArtifact ListPackageVersionDependencies requests.
 *
 ...
 *
 * \sa CodeArtifactClient::listPackageVersionDependencies
 */

/*!
 * Constructs a copy of \a other.
 */
ListPackageVersionDependenciesRequest::ListPackageVersionDependenciesRequest(const ListPackageVersionDependenciesRequest &other)
    : CodeArtifactRequest(new ListPackageVersionDependenciesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListPackageVersionDependenciesRequest object.
 */
ListPackageVersionDependenciesRequest::ListPackageVersionDependenciesRequest()
    : CodeArtifactRequest(new ListPackageVersionDependenciesRequestPrivate(CodeArtifactRequest::ListPackageVersionDependenciesAction, this))
{
 ...
 * \reimp
 */
bool ListPackageVersionDependenciesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListPackageVersionDependenciesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListPackageVersionDependenciesRequest::response(QNetworkReply * const reply) const
{
    return new ListPackageVersionDependenciesResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::ListPackageVersionDependenciesRequestPrivate
 * \brief The ListPackageVersionDependenciesRequestPrivate class provides private implementation for ListPackageVersionDependenciesRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a ListPackageVersionDependenciesRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
ListPackageVersionDependenciesRequestPrivate::ListPackageVersionDependenciesRequestPrivate(
    const CodeArtifactRequest::Action action, ListPackageVersionDependenciesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListPackageVersionDependenciesRequest
 * class' copy constructor.
 */
ListPackageVersionDependenciesRequestPrivate::ListPackageVersionDependenciesRequestPrivate(
    const ListPackageVersionDependenciesRequestPrivate &other, ListPackageVersionDependenciesRequest * const q)
