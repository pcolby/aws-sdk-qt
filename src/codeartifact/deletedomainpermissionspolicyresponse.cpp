...
#include "deletedomainpermissionspolicyresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::DeleteDomainPermissionsPolicyResponse
 * \brief The DeleteDomainPermissionsPolicyResponse class provides an interace for CodeArtifact DeleteDomainPermissionsPolicy responses.
 *
...
/*!
 * Constructs a DeleteDomainPermissionsPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteDomainPermissionsPolicyResponse::DeleteDomainPermissionsPolicyResponse(
        const DeleteDomainPermissionsPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new DeleteDomainPermissionsPolicyResponsePrivate(this), parent)
{
    setRequest(new DeleteDomainPermissionsPolicyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact DeleteDomainPermissionsPolicy \a response.
 */
void DeleteDomainPermissionsPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteDomainPermissionsPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::DeleteDomainPermissionsPolicyResponsePrivate
 * \brief The DeleteDomainPermissionsPolicyResponsePrivate class provides private implementation for DeleteDomainPermissionsPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a DeleteDomainPermissionsPolicyResponsePrivate object with public implementation \a q.
 */
DeleteDomainPermissionsPolicyResponsePrivate::DeleteDomainPermissionsPolicyResponsePrivate(
    DeleteDomainPermissionsPolicyResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact DeleteDomainPermissionsPolicy response element from \a xml.
 */
void DeleteDomainPermissionsPolicyResponsePrivate::parseDeleteDomainPermissionsPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteDomainPermissionsPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
