...
#include "getdomainpermissionspolicyresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::GetDomainPermissionsPolicyResponse
 * \brief The GetDomainPermissionsPolicyResponse class provides an interace for CodeArtifact GetDomainPermissionsPolicy responses.
 *
...
/*!
 * Constructs a GetDomainPermissionsPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
GetDomainPermissionsPolicyResponse::GetDomainPermissionsPolicyResponse(
        const GetDomainPermissionsPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new GetDomainPermissionsPolicyResponsePrivate(this), parent)
{
    setRequest(new GetDomainPermissionsPolicyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact GetDomainPermissionsPolicy \a response.
 */
void GetDomainPermissionsPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetDomainPermissionsPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::GetDomainPermissionsPolicyResponsePrivate
 * \brief The GetDomainPermissionsPolicyResponsePrivate class provides private implementation for GetDomainPermissionsPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a GetDomainPermissionsPolicyResponsePrivate object with public implementation \a q.
 */
GetDomainPermissionsPolicyResponsePrivate::GetDomainPermissionsPolicyResponsePrivate(
    GetDomainPermissionsPolicyResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact GetDomainPermissionsPolicy response element from \a xml.
 */
void GetDomainPermissionsPolicyResponsePrivate::parseGetDomainPermissionsPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetDomainPermissionsPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
