...
#include "deletepackageversionsresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::DeletePackageVersionsResponse
 * \brief The DeletePackageVersionsResponse class provides an interace for CodeArtifact DeletePackageVersions responses.
 *
...
/*!
 * Constructs a DeletePackageVersionsResponse object for \a reply to \a request, with parent \a parent.
 */
DeletePackageVersionsResponse::DeletePackageVersionsResponse(
        const DeletePackageVersionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new DeletePackageVersionsResponsePrivate(this), parent)
{
    setRequest(new DeletePackageVersionsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact DeletePackageVersions \a response.
 */
void DeletePackageVersionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeletePackageVersionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::DeletePackageVersionsResponsePrivate
 * \brief The DeletePackageVersionsResponsePrivate class provides private implementation for DeletePackageVersionsResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a DeletePackageVersionsResponsePrivate object with public implementation \a q.
 */
DeletePackageVersionsResponsePrivate::DeletePackageVersionsResponsePrivate(
    DeletePackageVersionsResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact DeletePackageVersions response element from \a xml.
 */
void DeletePackageVersionsResponsePrivate::parseDeletePackageVersionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeletePackageVersionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
