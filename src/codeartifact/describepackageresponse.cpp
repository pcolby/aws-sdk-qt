...
/*!
 * \class QtAws::CodeArtifact::DescribePackageResponse
 * \brief The DescribePackageResponse class provides an interace for CodeArtifact DescribePackage responses.
 *
...
DescribePackageResponse::DescribePackageResponse(
    ...
    : CodeArtifactResponse(new DescribePackageResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CodeArtifact DescribePackage \a response.
 */
...
/*!
 * \class QtAws::CodeArtifact::DescribePackageResponsePrivate
...
DescribePackageResponsePrivate::DescribePackageResponsePrivate(
    DescribePackageResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact DescribePackage response element from \a xml.
 */
