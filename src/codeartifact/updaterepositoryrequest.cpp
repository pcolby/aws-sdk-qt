...
#include "updaterepositoryrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::UpdateRepositoryRequest
 * \brief The UpdateRepositoryRequest class provides an interface for CodeArtifact UpdateRepository requests.
 *
 ...
 *
 * \sa CodeArtifactClient::updateRepository
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateRepositoryRequest::UpdateRepositoryRequest(const UpdateRepositoryRequest &other)
    : CodeArtifactRequest(new UpdateRepositoryRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateRepositoryRequest object.
 */
UpdateRepositoryRequest::UpdateRepositoryRequest()
    : CodeArtifactRequest(new UpdateRepositoryRequestPrivate(CodeArtifactRequest::UpdateRepositoryAction, this))
{
 ...
 * \reimp
 */
bool UpdateRepositoryRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateRepositoryResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateRepositoryRequest::response(QNetworkReply * const reply) const
{
    return new UpdateRepositoryResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::UpdateRepositoryRequestPrivate
 * \brief The UpdateRepositoryRequestPrivate class provides private implementation for UpdateRepositoryRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a UpdateRepositoryRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
UpdateRepositoryRequestPrivate::UpdateRepositoryRequestPrivate(
    const CodeArtifactRequest::Action action, UpdateRepositoryRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateRepositoryRequest
 * class' copy constructor.
 */
UpdateRepositoryRequestPrivate::UpdateRepositoryRequestPrivate(
    const UpdateRepositoryRequestPrivate &other, UpdateRepositoryRequest * const q)
