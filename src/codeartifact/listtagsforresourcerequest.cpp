...
/*!
 * \class QtAws::CodeArtifact::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for CodeArtifact ListTagsForResource requests.
 *
 ...
 *
 * \sa CodeArtifactClient::listTagsForResource
 */
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : CodeArtifactRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : CodeArtifactRequest(new ListTagsForResourceRequestPrivate(CodeArtifactRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::CodeArtifact::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const CodeArtifactRequest::Action action, ListTagsForResourceRequest * const q)
