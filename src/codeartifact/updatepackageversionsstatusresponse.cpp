...
#include "updatepackageversionsstatusresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::UpdatePackageVersionsStatusResponse
 * \brief The UpdatePackageVersionsStatusResponse class provides an interace for CodeArtifact UpdatePackageVersionsStatus responses.
 *
...
/*!
 * Constructs a UpdatePackageVersionsStatusResponse object for \a reply to \a request, with parent \a parent.
 */
UpdatePackageVersionsStatusResponse::UpdatePackageVersionsStatusResponse(
        const UpdatePackageVersionsStatusRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new UpdatePackageVersionsStatusResponsePrivate(this), parent)
{
    setRequest(new UpdatePackageVersionsStatusRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact UpdatePackageVersionsStatus \a response.
 */
void UpdatePackageVersionsStatusResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdatePackageVersionsStatusResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::UpdatePackageVersionsStatusResponsePrivate
 * \brief The UpdatePackageVersionsStatusResponsePrivate class provides private implementation for UpdatePackageVersionsStatusResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a UpdatePackageVersionsStatusResponsePrivate object with public implementation \a q.
 */
UpdatePackageVersionsStatusResponsePrivate::UpdatePackageVersionsStatusResponsePrivate(
    UpdatePackageVersionsStatusResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact UpdatePackageVersionsStatus response element from \a xml.
 */
void UpdatePackageVersionsStatusResponsePrivate::parseUpdatePackageVersionsStatusResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdatePackageVersionsStatusResponse"));
    Q_UNUSED(xml) ///< @todo
}
