...
#include "copypackageversionsrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::CopyPackageVersionsRequest
 * \brief The CopyPackageVersionsRequest class provides an interface for CodeArtifact CopyPackageVersions requests.
 *
 ...
 *
 * \sa CodeArtifactClient::copyPackageVersions
 */

/*!
 * Constructs a copy of \a other.
 */
CopyPackageVersionsRequest::CopyPackageVersionsRequest(const CopyPackageVersionsRequest &other)
    : CodeArtifactRequest(new CopyPackageVersionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CopyPackageVersionsRequest object.
 */
CopyPackageVersionsRequest::CopyPackageVersionsRequest()
    : CodeArtifactRequest(new CopyPackageVersionsRequestPrivate(CodeArtifactRequest::CopyPackageVersionsAction, this))
{
 ...
 * \reimp
 */
bool CopyPackageVersionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CopyPackageVersionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CopyPackageVersionsRequest::response(QNetworkReply * const reply) const
{
    return new CopyPackageVersionsResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::CopyPackageVersionsRequestPrivate
 * \brief The CopyPackageVersionsRequestPrivate class provides private implementation for CopyPackageVersionsRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a CopyPackageVersionsRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
CopyPackageVersionsRequestPrivate::CopyPackageVersionsRequestPrivate(
    const CodeArtifactRequest::Action action, CopyPackageVersionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CopyPackageVersionsRequest
 * class' copy constructor.
 */
CopyPackageVersionsRequestPrivate::CopyPackageVersionsRequestPrivate(
    const CopyPackageVersionsRequestPrivate &other, CopyPackageVersionsRequest * const q)
