...
#include "updatepackageversionsstatusrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::UpdatePackageVersionsStatusRequest
 * \brief The UpdatePackageVersionsStatusRequest class provides an interface for CodeArtifact UpdatePackageVersionsStatus requests.
 *
 ...
 *
 * \sa CodeArtifactClient::updatePackageVersionsStatus
 */

/*!
 * Constructs a copy of \a other.
 */
UpdatePackageVersionsStatusRequest::UpdatePackageVersionsStatusRequest(const UpdatePackageVersionsStatusRequest &other)
    : CodeArtifactRequest(new UpdatePackageVersionsStatusRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdatePackageVersionsStatusRequest object.
 */
UpdatePackageVersionsStatusRequest::UpdatePackageVersionsStatusRequest()
    : CodeArtifactRequest(new UpdatePackageVersionsStatusRequestPrivate(CodeArtifactRequest::UpdatePackageVersionsStatusAction, this))
{
 ...
 * \reimp
 */
bool UpdatePackageVersionsStatusRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdatePackageVersionsStatusResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdatePackageVersionsStatusRequest::response(QNetworkReply * const reply) const
{
    return new UpdatePackageVersionsStatusResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::UpdatePackageVersionsStatusRequestPrivate
 * \brief The UpdatePackageVersionsStatusRequestPrivate class provides private implementation for UpdatePackageVersionsStatusRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a UpdatePackageVersionsStatusRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
UpdatePackageVersionsStatusRequestPrivate::UpdatePackageVersionsStatusRequestPrivate(
    const CodeArtifactRequest::Action action, UpdatePackageVersionsStatusRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdatePackageVersionsStatusRequest
 * class' copy constructor.
 */
UpdatePackageVersionsStatusRequestPrivate::UpdatePackageVersionsStatusRequestPrivate(
    const UpdatePackageVersionsStatusRequestPrivate &other, UpdatePackageVersionsStatusRequest * const q)
