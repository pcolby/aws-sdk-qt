...
#include "disassociateexternalconnectionrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::DisassociateExternalConnectionRequest
 * \brief The DisassociateExternalConnectionRequest class provides an interface for CodeArtifact DisassociateExternalConnection requests.
 *
 ...
 */
DisassociateExternalConnectionRequest::DisassociateExternalConnectionRequest(const DisassociateExternalConnectionRequest &other)
    : CodeArtifactRequest(new DisassociateExternalConnectionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DisassociateExternalConnectionRequest object.
 */
DisassociateExternalConnectionRequest::DisassociateExternalConnectionRequest()
    : CodeArtifactRequest(new DisassociateExternalConnectionRequestPrivate(CodeArtifactRequest::DisassociateExternalConnectionAction, this))
{
 ...
 * \reimp
 */
bool DisassociateExternalConnectionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DisassociateExternalConnectionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DisassociateExternalConnectionRequest::response(QNetworkReply * const reply) const
{
    return new DisassociateExternalConnectionResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::DisassociateExternalConnectionRequestPrivate
 * \brief The DisassociateExternalConnectionRequestPrivate class provides private implementation for DisassociateExternalConnectionRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a DisassociateExternalConnectionRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
DisassociateExternalConnectionRequestPrivate::DisassociateExternalConnectionRequestPrivate(
    const CodeArtifactRequest::Action action, DisassociateExternalConnectionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DisassociateExternalConnectionRequest
 * class' copy constructor.
 */
DisassociateExternalConnectionRequestPrivate::DisassociateExternalConnectionRequestPrivate(
    const DisassociateExternalConnectionRequestPrivate &other, DisassociateExternalConnectionRequest * const q)
