...
/*!
 * \class QtAws::CodeArtifact::DescribePackageRequest
 * \brief The DescribePackageRequest class provides an interface for CodeArtifact DescribePackage requests.
 *
 ...
 *
 * \sa CodeArtifactClient::describePackage
 */
...
DescribePackageRequest::DescribePackageRequest(const DescribePackageRequest &other)
    : CodeArtifactRequest(new DescribePackageRequestPrivate(*other.d_func(), this))
{
...
DescribePackageRequest::DescribePackageRequest()
    : CodeArtifactRequest(new DescribePackageRequestPrivate(CodeArtifactRequest::DescribePackageAction, this))
{
...
/*!
 * \class QtAws::CodeArtifact::DescribePackageRequestPrivate
...
/*!
 * Constructs a DescribePackageRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
DescribePackageRequestPrivate::DescribePackageRequestPrivate(
    const CodeArtifactRequest::Action action, DescribePackageRequest * const q)
