...
/*!
 * \class QtAws::CodeArtifact::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for CodeArtifact UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : CodeArtifactResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(CodeArtifactResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeArtifact UntagResource \a response.
 */
...
/*!
 * \class QtAws::CodeArtifact::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact UntagResource response element from \a xml.
 */
