...
/*!
 * \class QtAws::CodeArtifact::DeleteDomainResponse
 * \brief The DeleteDomainResponse class provides an interace for CodeArtifact DeleteDomain responses.
 *
...
DeleteDomainResponse::DeleteDomainResponse(
    ...
    : CodeArtifactResponse(new DeleteDomainResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CodeArtifact DeleteDomain \a response.
 */
...
/*!
 * \class QtAws::CodeArtifact::DeleteDomainResponsePrivate
...
DeleteDomainResponsePrivate::DeleteDomainResponsePrivate(
    DeleteDomainResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact DeleteDomain response element from \a xml.
 */
