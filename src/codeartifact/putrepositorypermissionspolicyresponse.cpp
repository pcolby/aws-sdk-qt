...
#include "putrepositorypermissionspolicyresponse_p.h"
...
/*!
 * \class QtAws::CodeArtifact::PutRepositoryPermissionsPolicyResponse
 * \brief The PutRepositoryPermissionsPolicyResponse class provides an interace for CodeArtifact PutRepositoryPermissionsPolicy responses.
 *
...
/*!
 * Constructs a PutRepositoryPermissionsPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
PutRepositoryPermissionsPolicyResponse::PutRepositoryPermissionsPolicyResponse(
        const PutRepositoryPermissionsPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeArtifactResponse(new PutRepositoryPermissionsPolicyResponsePrivate(this), parent)
{
    setRequest(new PutRepositoryPermissionsPolicyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeArtifact PutRepositoryPermissionsPolicy \a response.
 */
void PutRepositoryPermissionsPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutRepositoryPermissionsPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeArtifact::PutRepositoryPermissionsPolicyResponsePrivate
 * \brief The PutRepositoryPermissionsPolicyResponsePrivate class provides private implementation for PutRepositoryPermissionsPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a PutRepositoryPermissionsPolicyResponsePrivate object with public implementation \a q.
 */
PutRepositoryPermissionsPolicyResponsePrivate::PutRepositoryPermissionsPolicyResponsePrivate(
    PutRepositoryPermissionsPolicyResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact PutRepositoryPermissionsPolicy response element from \a xml.
 */
void PutRepositoryPermissionsPolicyResponsePrivate::parsePutRepositoryPermissionsPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutRepositoryPermissionsPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
