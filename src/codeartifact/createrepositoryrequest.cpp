...
/*!
 * \class QtAws::CodeArtifact::CreateRepositoryRequest
 * \brief The CreateRepositoryRequest class provides an interface for CodeArtifact CreateRepository requests.
 *
 ...
 *
 * \sa CodeArtifactClient::createRepository
 */
...
CreateRepositoryRequest::CreateRepositoryRequest(const CreateRepositoryRequest &other)
    : CodeArtifactRequest(new CreateRepositoryRequestPrivate(*other.d_func(), this))
{
...
CreateRepositoryRequest::CreateRepositoryRequest()
    : CodeArtifactRequest(new CreateRepositoryRequestPrivate(CodeArtifactRequest::CreateRepositoryAction, this))
{
...
/*!
 * \class QtAws::CodeArtifact::CreateRepositoryRequestPrivate
...
/*!
 * Constructs a CreateRepositoryRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
CreateRepositoryRequestPrivate::CreateRepositoryRequestPrivate(
    const CodeArtifactRequest::Action action, CreateRepositoryRequest * const q)
