...
class QTAWS_EXPORT GetRepositoryPermissionsPolicyResponsePrivate : public CodeArtifactResponsePrivate {

public:

    GetRepositoryPermissionsPolicyResponsePrivate(GetRepositoryPermissionsPolicyResponse * const q);
