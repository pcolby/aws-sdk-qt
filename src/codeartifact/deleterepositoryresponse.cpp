...
/*!
 * \class QtAws::CodeArtifact::DeleteRepositoryResponse
 * \brief The DeleteRepositoryResponse class provides an interace for CodeArtifact DeleteRepository responses.
 *
...
DeleteRepositoryResponse::DeleteRepositoryResponse(
    ...
    : CodeArtifactResponse(new DeleteRepositoryResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteRepositoryRequest *>(CodeArtifactResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeArtifact DeleteRepository \a response.
 */
...
/*!
 * \class QtAws::CodeArtifact::DeleteRepositoryResponsePrivate
...
DeleteRepositoryResponsePrivate::DeleteRepositoryResponsePrivate(
    DeleteRepositoryResponse * const q) : CodeArtifactResponsePrivate(q)
{

}

/*!
 * Parses a CodeArtifact DeleteRepository response element from \a xml.
 */
