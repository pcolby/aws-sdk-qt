...
/*!
 * \class QtAws::CodeArtifact::ListRepositoriesRequest
 * \brief The ListRepositoriesRequest class provides an interface for CodeArtifact ListRepositories requests.
 *
 ...
 *
 * \sa CodeArtifactClient::listRepositories
 */
...
ListRepositoriesRequest::ListRepositoriesRequest(const ListRepositoriesRequest &other)
    : CodeArtifactRequest(new ListRepositoriesRequestPrivate(*other.d_func(), this))
{
...
ListRepositoriesRequest::ListRepositoriesRequest()
    : CodeArtifactRequest(new ListRepositoriesRequestPrivate(CodeArtifactRequest::ListRepositoriesAction, this))
{
...
/*!
 * \class QtAws::CodeArtifact::ListRepositoriesRequestPrivate
...
/*!
 * Constructs a ListRepositoriesRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
ListRepositoriesRequestPrivate::ListRepositoriesRequestPrivate(
    const CodeArtifactRequest::Action action, ListRepositoriesRequest * const q)
