...
#include "putrepositorypermissionspolicyrequest_p.h"
...
/*!
 * \class QtAws::CodeArtifact::PutRepositoryPermissionsPolicyRequest
 * \brief The PutRepositoryPermissionsPolicyRequest class provides an interface for CodeArtifact PutRepositoryPermissionsPolicy requests.
 *
 ...
 *
 * \sa CodeArtifactClient::putRepositoryPermissionsPolicy
 */

/*!
 * Constructs a copy of \a other.
 */
PutRepositoryPermissionsPolicyRequest::PutRepositoryPermissionsPolicyRequest(const PutRepositoryPermissionsPolicyRequest &other)
    : CodeArtifactRequest(new PutRepositoryPermissionsPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutRepositoryPermissionsPolicyRequest object.
 */
PutRepositoryPermissionsPolicyRequest::PutRepositoryPermissionsPolicyRequest()
    : CodeArtifactRequest(new PutRepositoryPermissionsPolicyRequestPrivate(CodeArtifactRequest::PutRepositoryPermissionsPolicyAction, this))
{
 ...
 * \reimp
 */
bool PutRepositoryPermissionsPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutRepositoryPermissionsPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutRepositoryPermissionsPolicyRequest::response(QNetworkReply * const reply) const
{
    return new PutRepositoryPermissionsPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::CodeArtifact::PutRepositoryPermissionsPolicyRequestPrivate
 * \brief The PutRepositoryPermissionsPolicyRequestPrivate class provides private implementation for PutRepositoryPermissionsPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsCodeArtifact
 */
...
/*!
 * Constructs a PutRepositoryPermissionsPolicyRequestPrivate object for CodeArtifact \a action,
 * with public implementation \a q.
 */
PutRepositoryPermissionsPolicyRequestPrivate::PutRepositoryPermissionsPolicyRequestPrivate(
    const CodeArtifactRequest::Action action, PutRepositoryPermissionsPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutRepositoryPermissionsPolicyRequest
 * class' copy constructor.
 */
PutRepositoryPermissionsPolicyRequestPrivate::PutRepositoryPermissionsPolicyRequestPrivate(
    const PutRepositoryPermissionsPolicyRequestPrivate &other, PutRepositoryPermissionsPolicyRequest * const q)
