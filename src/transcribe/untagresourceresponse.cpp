...
/*!
 * \class QtAws::Transcribe::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Transcribe UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : TranscribeResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Transcribe UntagResource \a response.
 */
...
/*!
 * \class QtAws::Transcribe::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : TranscribeResponsePrivate(q)
{

}

/*!
 * Parses a Transcribe UntagResource response element from \a xml.
 */
