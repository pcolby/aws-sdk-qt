...
/*!
 * \class QtAws::Transcribe::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Transcribe TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : TranscribeResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Transcribe TagResource \a response.
 */
...
/*!
 * \class QtAws::Transcribe::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : TranscribeResponsePrivate(q)
{

}

/*!
 * Parses a Transcribe TagResource response element from \a xml.
 */
