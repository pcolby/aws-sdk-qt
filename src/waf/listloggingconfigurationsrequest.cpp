...
ListLoggingConfigurationsRequest::ListLoggingConfigurationsRequest(const ListLoggingConfigurationsRequest &other)
    : WafRequest(new ListLoggingConfigurationsRequestPrivate(*other.d_func(), this))
{
...
ListLoggingConfigurationsRequest::ListLoggingConfigurationsRequest()
    : WafRequest(new ListLoggingConfigurationsRequestPrivate(WafRequest::ListLoggingConfigurationsAction, this))
{
...
/*!
 * Constructs a ListLoggingConfigurationsRequestPrivate object for Waf \a action,
 * with public implementation \a q.
 */
ListLoggingConfigurationsRequestPrivate::ListLoggingConfigurationsRequestPrivate(
    const WafRequest::Action action, ListLoggingConfigurationsRequest * const q)
