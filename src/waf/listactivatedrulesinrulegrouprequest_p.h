...
class QTAWS_EXPORT ListActivatedRulesInRuleGroupRequestPrivate : public WAFRequestPrivate {

public:
    ListActivatedRulesInRuleGroupRequestPrivate(const WAF::Action action,
