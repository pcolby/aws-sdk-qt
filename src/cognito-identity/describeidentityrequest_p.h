...
class QTAWS_EXPORT DescribeIdentityRequestPrivate : public CognitoIdentityRequestPrivate {

public:
    DescribeIdentityRequestPrivate(const CognitoIdentity::Action action,
