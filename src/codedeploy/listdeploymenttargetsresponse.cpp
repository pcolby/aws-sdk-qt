...
#include "listdeploymenttargetsresponse_p.h"
...
/*!
 * \class QtAws::CodeDeploy::ListDeploymentTargetsResponse
 * \brief The ListDeploymentTargetsResponse class provides an interace for CodeDeploy ListDeploymentTargets responses.
 *
...
/*!
 * Constructs a ListDeploymentTargetsResponse object for \a reply to \a request, with parent \a parent.
 */
ListDeploymentTargetsResponse::ListDeploymentTargetsResponse(
        const ListDeploymentTargetsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeDeployResponse(new ListDeploymentTargetsResponsePrivate(this), parent)
{
    setRequest(new ListDeploymentTargetsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeDeploy ListDeploymentTargets \a response.
 */
void ListDeploymentTargetsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListDeploymentTargetsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeDeploy::ListDeploymentTargetsResponsePrivate
 * \brief The ListDeploymentTargetsResponsePrivate class provides private implementation for ListDeploymentTargetsResponse.
 * \internal
 *
 * \inmodule QtAwsCodeDeploy
 */
...
/*!
 * Constructs a ListDeploymentTargetsResponsePrivate object with public implementation \a q.
 */
ListDeploymentTargetsResponsePrivate::ListDeploymentTargetsResponsePrivate(
    ListDeploymentTargetsResponse * const q) : CodeDeployResponsePrivate(q)
{

}

/*!
 * Parses a CodeDeploy ListDeploymentTargets response element from \a xml.
 */
void ListDeploymentTargetsResponsePrivate::parseListDeploymentTargetsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListDeploymentTargetsResponse"));
    Q_UNUSED(xml) ///< @todo
}
