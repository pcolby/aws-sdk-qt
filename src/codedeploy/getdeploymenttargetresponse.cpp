...
#include "getdeploymenttargetresponse_p.h"
...
/*!
 * \class QtAws::CodeDeploy::GetDeploymentTargetResponse
 * \brief The GetDeploymentTargetResponse class provides an interace for CodeDeploy GetDeploymentTarget responses.
 *
 ...
 *
 * \sa CodeDeployClient::getDeploymentTarget
 */

/*!
 * Constructs a GetDeploymentTargetResponse object for \a reply to \a request, with parent \a parent.
 */
GetDeploymentTargetResponse::GetDeploymentTargetResponse(
        const GetDeploymentTargetRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeDeployResponse(new GetDeploymentTargetResponsePrivate(this), parent)
{
    setRequest(new GetDeploymentTargetRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetDeploymentTargetRequest * GetDeploymentTargetResponse::request() const
{
    Q_D(const GetDeploymentTargetResponse);
    return static_cast<const GetDeploymentTargetRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful CodeDeploy GetDeploymentTarget \a response.
 */
void GetDeploymentTargetResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetDeploymentTargetResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeDeploy::GetDeploymentTargetResponsePrivate
 * \brief The GetDeploymentTargetResponsePrivate class provides private implementation for GetDeploymentTargetResponse.
 * \internal
 *
 * \inmodule QtAwsCodeDeploy
 */
...
/*!
 * Constructs a GetDeploymentTargetResponsePrivate object with public implementation \a q.
 */
GetDeploymentTargetResponsePrivate::GetDeploymentTargetResponsePrivate(
    GetDeploymentTargetResponse * const q) : CodeDeployResponsePrivate(q)
{

}

/*!
 * Parses a CodeDeploy GetDeploymentTarget response element from \a xml.
 */
void GetDeploymentTargetResponsePrivate::parseGetDeploymentTargetResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetDeploymentTargetResponse"));
    Q_UNUSED(xml) ///< @todo
}
