 ...
 *
 * \brief The BatchGetDeploymentInstancesResponse class encapsulates CodeDeploy BatchGetDeploymentInstances responses.
 *
 * \ingroup CodeDeploy
 *
 ...
 *
 * \sa CodeDeployClient::batchGetDeploymentInstances
 */
...
{
    Q_D(BatchGetDeploymentInstancesResponse);
