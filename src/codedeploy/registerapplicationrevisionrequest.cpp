 ...
 *
 * \brief The RegisterApplicationRevisionRequest class encapsulates CodeDeploy RegisterApplicationRevision requests.
 *
 * \ingroup CodeDeploy
 *
 ...
 *
 * \sa CodeDeployClient::registerApplicationRevision
 */
