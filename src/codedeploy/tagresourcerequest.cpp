...
/*!
 * \class QtAws::CodeDeploy::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for CodeDeploy TagResource requests.
 *
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : CodeDeployRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : CodeDeployRequest(new TagResourceRequestPrivate(CodeDeployRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::CodeDeploy::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for CodeDeploy \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const CodeDeployRequest::Action action, TagResourceRequest * const q)
