...
/*!
 * \class QtAws::CodeDeploy::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for CodeDeploy TagResource responses.
 *
 ...
 *
 * \sa CodeDeployClient::tagResource
 */
...
TagResourceResponse::TagResourceResponse(
    ...
    : CodeDeployResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(CodeDeployResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeDeploy TagResource \a response.
 */
...
/*!
 * \class QtAws::CodeDeploy::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : CodeDeployResponsePrivate(q)
{

}

/*!
 * Parses a CodeDeploy TagResource response element from \a xml.
 */
