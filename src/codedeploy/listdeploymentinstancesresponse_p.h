...
class QTAWS_EXPORT ListDeploymentInstancesResponsePrivate : public CodeDeployResponsePrivate {
    Q_OBJECT

public:

    ListDeploymentInstancesResponsePrivate(ListDeploymentInstancesResponse * const q);
