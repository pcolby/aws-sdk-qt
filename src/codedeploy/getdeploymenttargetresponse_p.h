...
class QTAWS_EXPORT GetDeploymentTargetResponsePrivate : public CodeDeployResponsePrivate {

public:

    GetDeploymentTargetResponsePrivate(GetDeploymentTargetResponse * const q);
