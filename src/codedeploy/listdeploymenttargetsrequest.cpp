...
#include "listdeploymenttargetsrequest_p.h"
...
/*!
 * \class QtAws::CodeDeploy::ListDeploymentTargetsRequest
 * \brief The ListDeploymentTargetsRequest class provides an interface for CodeDeploy ListDeploymentTargets requests.
 *
 ...
 *
 * \sa CodeDeployClient::listDeploymentTargets
 */

/*!
 * Constructs a copy of \a other.
 */
ListDeploymentTargetsRequest::ListDeploymentTargetsRequest(const ListDeploymentTargetsRequest &other)
    : CodeDeployRequest(new ListDeploymentTargetsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListDeploymentTargetsRequest object.
 */
ListDeploymentTargetsRequest::ListDeploymentTargetsRequest()
    : CodeDeployRequest(new ListDeploymentTargetsRequestPrivate(CodeDeployRequest::ListDeploymentTargetsAction, this))
{
 ...
 * \reimp
 */
bool ListDeploymentTargetsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListDeploymentTargetsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListDeploymentTargetsRequest::response(QNetworkReply * const reply) const
{
    return new ListDeploymentTargetsResponse(*this, reply);
}

/*!
 * \class QtAws::CodeDeploy::ListDeploymentTargetsRequestPrivate
 * \brief The ListDeploymentTargetsRequestPrivate class provides private implementation for ListDeploymentTargetsRequest.
 * \internal
 *
 * \inmodule QtAwsCodeDeploy
 */
...
/*!
 * Constructs a ListDeploymentTargetsRequestPrivate object for CodeDeploy \a action,
 * with public implementation \a q.
 */
ListDeploymentTargetsRequestPrivate::ListDeploymentTargetsRequestPrivate(
    const CodeDeployRequest::Action action, ListDeploymentTargetsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListDeploymentTargetsRequest
 * class' copy constructor.
 */
ListDeploymentTargetsRequestPrivate::ListDeploymentTargetsRequestPrivate(
    const ListDeploymentTargetsRequestPrivate &other, ListDeploymentTargetsRequest * const q)
