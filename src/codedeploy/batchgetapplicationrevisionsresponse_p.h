...
class QTAWS_EXPORT BatchGetApplicationRevisionsResponsePrivate : public CodeDeployResponsePrivate {

public:

    BatchGetApplicationRevisionsResponsePrivate(BatchGetApplicationRevisionsResponse * const q);
