...
class QTAWS_EXPORT ListDeploymentTargetsResponsePrivate : public CodeDeployResponsePrivate {

public:

    ListDeploymentTargetsResponsePrivate(ListDeploymentTargetsResponse * const q);
