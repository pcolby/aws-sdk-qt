...
#include "deleteresourcesbyexternalidrequest_p.h"
...
/*!
 * \class QtAws::CodeDeploy::DeleteResourcesByExternalIdRequest
 * \brief The DeleteResourcesByExternalIdRequest class provides an interface for CodeDeploy DeleteResourcesByExternalId requests.
 *
 ...
 *
 * \sa CodeDeployClient::deleteResourcesByExternalId
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteResourcesByExternalIdRequest::DeleteResourcesByExternalIdRequest(const DeleteResourcesByExternalIdRequest &other)
    : CodeDeployRequest(new DeleteResourcesByExternalIdRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteResourcesByExternalIdRequest object.
 */
DeleteResourcesByExternalIdRequest::DeleteResourcesByExternalIdRequest()
    : CodeDeployRequest(new DeleteResourcesByExternalIdRequestPrivate(CodeDeployRequest::DeleteResourcesByExternalIdAction, this))
{
 ...
 * \reimp
 */
bool DeleteResourcesByExternalIdRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteResourcesByExternalIdResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteResourcesByExternalIdRequest::response(QNetworkReply * const reply) const
{
    return new DeleteResourcesByExternalIdResponse(*this, reply);
}

/*!
 * \class QtAws::CodeDeploy::DeleteResourcesByExternalIdRequestPrivate
 * \brief The DeleteResourcesByExternalIdRequestPrivate class provides private implementation for DeleteResourcesByExternalIdRequest.
 * \internal
 *
 * \inmodule QtAwsCodeDeploy
 */
...
/*!
 * Constructs a DeleteResourcesByExternalIdRequestPrivate object for CodeDeploy \a action,
 * with public implementation \a q.
 */
DeleteResourcesByExternalIdRequestPrivate::DeleteResourcesByExternalIdRequestPrivate(
    const CodeDeployRequest::Action action, DeleteResourcesByExternalIdRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteResourcesByExternalIdRequest
 * class' copy constructor.
 */
DeleteResourcesByExternalIdRequestPrivate::DeleteResourcesByExternalIdRequestPrivate(
    const DeleteResourcesByExternalIdRequestPrivate &other, DeleteResourcesByExternalIdRequest * const q)
