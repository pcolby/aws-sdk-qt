...
/*!
 * \class QtAws::CodeDeploy::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for CodeDeploy ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : CodeDeployRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : CodeDeployRequest(new ListTagsForResourceRequestPrivate(CodeDeployRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::CodeDeploy::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for CodeDeploy \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const CodeDeployRequest::Action action, ListTagsForResourceRequest * const q)
