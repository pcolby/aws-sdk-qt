...
class QTAWS_EXPORT BatchGetApplicationRevisionsResponse : public BatchGetApplicationRevisionsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const BatchGetApplicationRevisionsRequest * request() const;
