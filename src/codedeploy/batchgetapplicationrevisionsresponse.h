...
class QTAWS_EXPORT BatchGetApplicationRevisionsResponse : public CodeDeployResponse {
    Q_OBJECT
...
public:
    ...
    virtual const BatchGetApplicationRevisionsRequest * request() const override;
