...
class QTAWS_EXPORT ListDeploymentConfigsRequestPrivate : public CodeDeployRequestPrivate {

public:
    ListDeploymentConfigsRequestPrivate(const CodeDeploy::Action action,
