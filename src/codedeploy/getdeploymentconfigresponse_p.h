...
class QTAWS_EXPORT GetDeploymentConfigResponsePrivate : public CodeDeployResponsePrivate {

public:

    GetDeploymentConfigResponsePrivate(GetDeploymentConfigResponse * const q);
