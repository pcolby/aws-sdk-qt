...
#include "batchgetdeploymenttargetsrequest_p.h"
...
/*!
 * \class QtAws::CodeDeploy::BatchGetDeploymentTargetsRequest
 * \brief The BatchGetDeploymentTargetsRequest class provides an interface for CodeDeploy BatchGetDeploymentTargets requests.
 *
 ...
 */
BatchGetDeploymentTargetsRequest::BatchGetDeploymentTargetsRequest(const BatchGetDeploymentTargetsRequest &other)
    : CodeDeployRequest(new BatchGetDeploymentTargetsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a BatchGetDeploymentTargetsRequest object.
 */
BatchGetDeploymentTargetsRequest::BatchGetDeploymentTargetsRequest()
    : CodeDeployRequest(new BatchGetDeploymentTargetsRequestPrivate(CodeDeployRequest::BatchGetDeploymentTargetsAction, this))
{
 ...
 * \reimp
 */
bool BatchGetDeploymentTargetsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BatchGetDeploymentTargetsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BatchGetDeploymentTargetsRequest::response(QNetworkReply * const reply) const
{
    return new BatchGetDeploymentTargetsResponse(*this, reply);
}

/*!
 * \class QtAws::CodeDeploy::BatchGetDeploymentTargetsRequestPrivate
 * \brief The BatchGetDeploymentTargetsRequestPrivate class provides private implementation for BatchGetDeploymentTargetsRequest.
 * \internal
 *
 * \inmodule QtAwsCodeDeploy
 */
...
/*!
 * Constructs a BatchGetDeploymentTargetsRequestPrivate object for CodeDeploy \a action,
 * with public implementation \a q.
 */
BatchGetDeploymentTargetsRequestPrivate::BatchGetDeploymentTargetsRequestPrivate(
    const CodeDeployRequest::Action action, BatchGetDeploymentTargetsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the BatchGetDeploymentTargetsRequest
 * class' copy constructor.
 */
BatchGetDeploymentTargetsRequestPrivate::BatchGetDeploymentTargetsRequestPrivate(
    const BatchGetDeploymentTargetsRequestPrivate &other, BatchGetDeploymentTargetsRequest * const q)
