...
#include "deleteresourcesbyexternalidresponse_p.h"
...
/*!
 * \class QtAws::CodeDeploy::DeleteResourcesByExternalIdResponse
 * \brief The DeleteResourcesByExternalIdResponse class provides an interace for CodeDeploy DeleteResourcesByExternalId responses.
 *
...
/*!
 * Constructs a DeleteResourcesByExternalIdResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteResourcesByExternalIdResponse::DeleteResourcesByExternalIdResponse(
        const DeleteResourcesByExternalIdRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeDeployResponse(new DeleteResourcesByExternalIdResponsePrivate(this), parent)
{
    setRequest(new DeleteResourcesByExternalIdRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeDeploy DeleteResourcesByExternalId \a response.
 */
void DeleteResourcesByExternalIdResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteResourcesByExternalIdResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeDeploy::DeleteResourcesByExternalIdResponsePrivate
 * \brief The DeleteResourcesByExternalIdResponsePrivate class provides private implementation for DeleteResourcesByExternalIdResponse.
 * \internal
 *
 * \inmodule QtAwsCodeDeploy
 */
...
/*!
 * Constructs a DeleteResourcesByExternalIdResponsePrivate object with public implementation \a q.
 */
DeleteResourcesByExternalIdResponsePrivate::DeleteResourcesByExternalIdResponsePrivate(
    DeleteResourcesByExternalIdResponse * const q) : CodeDeployResponsePrivate(q)
{

}

/*!
 * Parses a CodeDeploy DeleteResourcesByExternalId response element from \a xml.
 */
void DeleteResourcesByExternalIdResponsePrivate::parseDeleteResourcesByExternalIdResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteResourcesByExternalIdResponse"));
    Q_UNUSED(xml) ///< @todo
}
