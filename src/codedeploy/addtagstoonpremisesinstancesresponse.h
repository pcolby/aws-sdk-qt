...
class QTAWS_EXPORT AddTagsToOnPremisesInstancesResponse : public CodeDeployResponse {
    Q_OBJECT
...
public:
    ...
    virtual const AddTagsToOnPremisesInstancesRequest * request() const override;
