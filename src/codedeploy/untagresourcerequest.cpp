...
/*!
 * \class QtAws::CodeDeploy::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for CodeDeploy UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : CodeDeployRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : CodeDeployRequest(new UntagResourceRequestPrivate(CodeDeployRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::CodeDeploy::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for CodeDeploy \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const CodeDeployRequest::Action action, UntagResourceRequest * const q)
