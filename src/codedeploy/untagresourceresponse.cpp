...
/*!
 * \class QtAws::CodeDeploy::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for CodeDeploy UntagResource responses.
 *
 ...
 *
 * \sa CodeDeployClient::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : CodeDeployResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(CodeDeployResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeDeploy UntagResource \a response.
 */
...
/*!
 * \class QtAws::CodeDeploy::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : CodeDeployResponsePrivate(q)
{

}

/*!
 * Parses a CodeDeploy UntagResource response element from \a xml.
 */
