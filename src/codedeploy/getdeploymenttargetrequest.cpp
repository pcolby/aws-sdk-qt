...
#include "getdeploymenttargetrequest_p.h"
...
/*!
 * \class QtAws::CodeDeploy::GetDeploymentTargetRequest
 * \brief The GetDeploymentTargetRequest class provides an interface for CodeDeploy GetDeploymentTarget requests.
 *
 ...
 */
GetDeploymentTargetRequest::GetDeploymentTargetRequest(const GetDeploymentTargetRequest &other)
    : CodeDeployRequest(new GetDeploymentTargetRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetDeploymentTargetRequest object.
 */
GetDeploymentTargetRequest::GetDeploymentTargetRequest()
    : CodeDeployRequest(new GetDeploymentTargetRequestPrivate(CodeDeployRequest::GetDeploymentTargetAction, this))
{
 ...
 * \reimp
 */
bool GetDeploymentTargetRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetDeploymentTargetResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetDeploymentTargetRequest::response(QNetworkReply * const reply) const
{
    return new GetDeploymentTargetResponse(*this, reply);
}

/*!
 * \class QtAws::CodeDeploy::GetDeploymentTargetRequestPrivate
 * \brief The GetDeploymentTargetRequestPrivate class provides private implementation for GetDeploymentTargetRequest.
 * \internal
 *
 * \inmodule QtAwsCodeDeploy
 */
...
/*!
 * Constructs a GetDeploymentTargetRequestPrivate object for CodeDeploy \a action,
 * with public implementation \a q.
 */
GetDeploymentTargetRequestPrivate::GetDeploymentTargetRequestPrivate(
    const CodeDeployRequest::Action action, GetDeploymentTargetRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetDeploymentTargetRequest
 * class' copy constructor.
 */
GetDeploymentTargetRequestPrivate::GetDeploymentTargetRequestPrivate(
    const GetDeploymentTargetRequestPrivate &other, GetDeploymentTargetRequest * const q)
