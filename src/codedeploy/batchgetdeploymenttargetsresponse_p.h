...
class QTAWS_EXPORT BatchGetDeploymentTargetsResponsePrivate : public CodeDeployResponsePrivate {

public:

    BatchGetDeploymentTargetsResponsePrivate(BatchGetDeploymentTargetsResponse * const q);
