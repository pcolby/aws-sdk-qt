...
/*!
 * \class QtAws::CodeDeploy::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for CodeDeploy ListTagsForResource responses.
 *
 ...
 *
 * \sa CodeDeployClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : CodeDeployResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(CodeDeployResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeDeploy ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::CodeDeploy::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : CodeDeployResponsePrivate(q)
{

}

/*!
 * Parses a CodeDeploy ListTagsForResource response element from \a xml.
 */
