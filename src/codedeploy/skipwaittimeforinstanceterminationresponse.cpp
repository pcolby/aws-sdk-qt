 ...
 *
 * \brief The SkipWaitTimeForInstanceTerminationResponse class encapsulates CodeDeploy SkipWaitTimeForInstanceTermination responses.
 *
 * \ingroup CodeDeploy
 *
 ...
 *
 * \sa CodeDeployClient::skipWaitTimeForInstanceTermination
 */
