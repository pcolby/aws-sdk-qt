...
#include "batchgetdeploymenttargetsresponse_p.h"
...
/*!
 * \class QtAws::CodeDeploy::BatchGetDeploymentTargetsResponse
 * \brief The BatchGetDeploymentTargetsResponse class provides an interace for CodeDeploy BatchGetDeploymentTargets responses.
 *
 ...
 *
 * \sa CodeDeployClient::batchGetDeploymentTargets
 */

/*!
 * Constructs a BatchGetDeploymentTargetsResponse object for \a reply to \a request, with parent \a parent.
 */
BatchGetDeploymentTargetsResponse::BatchGetDeploymentTargetsResponse(
        const BatchGetDeploymentTargetsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeDeployResponse(new BatchGetDeploymentTargetsResponsePrivate(this), parent)
{
    setRequest(new BatchGetDeploymentTargetsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const BatchGetDeploymentTargetsRequest * BatchGetDeploymentTargetsResponse::request() const
{
    Q_D(const BatchGetDeploymentTargetsResponse);
    return static_cast<const BatchGetDeploymentTargetsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful CodeDeploy BatchGetDeploymentTargets \a response.
 */
void BatchGetDeploymentTargetsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(BatchGetDeploymentTargetsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeDeploy::BatchGetDeploymentTargetsResponsePrivate
 * \brief The BatchGetDeploymentTargetsResponsePrivate class provides private implementation for BatchGetDeploymentTargetsResponse.
 * \internal
 *
 * \inmodule QtAwsCodeDeploy
 */
...
/*!
 * Constructs a BatchGetDeploymentTargetsResponsePrivate object with public implementation \a q.
 */
BatchGetDeploymentTargetsResponsePrivate::BatchGetDeploymentTargetsResponsePrivate(
    BatchGetDeploymentTargetsResponse * const q) : CodeDeployResponsePrivate(q)
{

}

/*!
 * Parses a CodeDeploy BatchGetDeploymentTargets response element from \a xml.
 */
void BatchGetDeploymentTargetsResponsePrivate::parseBatchGetDeploymentTargetsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("BatchGetDeploymentTargetsResponse"));
    Q_UNUSED(xml) ///< @todo
}
