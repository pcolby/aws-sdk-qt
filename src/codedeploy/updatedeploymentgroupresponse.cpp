 ...
 *
 * \brief The UpdateDeploymentGroupResponse class encapsulates CodeDeploy UpdateDeploymentGroup responses.
 *
 * \ingroup CodeDeploy
 *
 ...
 *
 * \sa CodeDeployClient::updateDeploymentGroup
 */
...
{
    Q_D(UpdateDeploymentGroupResponse);
