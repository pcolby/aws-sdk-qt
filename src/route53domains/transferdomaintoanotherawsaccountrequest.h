...
#ifndef QTAWS_TRANSFERDOMAINTOANOTHERAWSACCOUNTREQUEST_H
#define QTAWS_TRANSFERDOMAINTOANOTHERAWSACCOUNTREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(TransferDomainToAnotherAwsAccountRequest)
