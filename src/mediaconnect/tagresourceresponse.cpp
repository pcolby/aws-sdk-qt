...
/*!
 * \class QtAws::MediaConnect::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for MediaConnect TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : MediaConnectResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(MediaConnectResponse::request());
}

/*!
 * \reimp
 * Parses a successful MediaConnect TagResource \a response.
 */
...
/*!
 * \class QtAws::MediaConnect::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : MediaConnectResponsePrivate(q)
{

}

/*!
 * Parses a MediaConnect TagResource response element from \a xml.
 */
