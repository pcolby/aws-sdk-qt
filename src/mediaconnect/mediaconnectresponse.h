...
#ifndef QTAWS_MEDIACONNECTRESPONSE_H
...
public:
    MediaConnectResponse(QObject * const parent = 0);
...
private:
    Q_DECLARE_PRIVATE(MediaConnectResponse)
    Q_DISABLE_COPY(MediaConnectResponse)
