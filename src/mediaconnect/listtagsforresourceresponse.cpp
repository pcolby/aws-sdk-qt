...
/*!
 * \class QtAws::MediaConnect::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for MediaConnect ListTagsForResource responses.
 *
 * \inmodule QtAwsMediaConnect
 *
 *
 * \sa MediaConnectClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : MediaConnectResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(MediaConnectResponse::request());
}

/*!
 * \reimp
 * Parses a successful MediaConnect ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::MediaConnect::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : MediaConnectResponsePrivate(q)
{

}

/*!
 * Parses a MediaConnect ListTagsForResource response element from \a xml.
 */
