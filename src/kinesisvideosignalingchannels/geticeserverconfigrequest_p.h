...
class QTAWS_EXPORT GetIceServerConfigRequestPrivate : public KinesisVideoSignalingChannelsRequestPrivate {

public:
    GetIceServerConfigRequestPrivate(const KinesisVideoSignalingChannelsRequest::Action action,
