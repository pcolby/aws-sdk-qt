 ...
 *
 * \brief The ListRuleGroupsResponse class encapsulates WAFRegional ListRuleGroups responses.
 *
 * \ingroup WAFRegional
 *
...
/*!
 * @brief  Parse a WAFRegional ListRuleGroups response.
 *
...
/*!
 * @brief  Parse an WAFRegional ListRuleGroupsResponse element.
 *
