 ...
 *
 * \brief The UpdateIPSetResponse class encapsulates WAFRegional UpdateIPSet responses.
 *
 * \ingroup WAFRegional
 *
...
/*!
 * @brief  Parse a WAFRegional UpdateIPSet response.
 *
...
/*!
 * @brief  Parse an WAFRegional UpdateIPSetResponse element.
 *
