...
class QTAWS_EXPORT DeleteRegexMatchSetRequestPrivate : public WAFRegionalRequestPrivate {

public:
    DeleteRegexMatchSetRequestPrivate(const WAFRegional::Action action,
