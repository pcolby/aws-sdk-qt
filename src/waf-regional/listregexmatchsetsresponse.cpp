 ...
 *
 * \brief The ListRegexMatchSetsResponse class encapsulates WAFRegional ListRegexMatchSets responses.
 *
 * \ingroup WAFRegional
 *
...
/*!
 * @brief  Parse a WAFRegional ListRegexMatchSets response.
 *
...
/*!
 * @brief  Parse an WAFRegional ListRegexMatchSetsResponse element.
 *
