...
/**
 * @brief  Constructs a new WAFRegionalClientRequest object.
 *
...
/**
 * @brief  Constructs a new WAFRegionalClientRequest object by copying another.
 *
 ...
 */
WAFRegionalClientRequest& WAFRegionalClientRequest::operator=(const WAFRegionalClientRequest &other)
{
    Q_D(WAFRegionalClientRequest);
 ...
 * implementation that inherits from WAFRegionalClientRequestPrivate.
 *
 ...
 */
WAFRegionalClientRequest::Action WAFRegionalClientRequest::action() const
{
    Q_D(const WAFRegionalClientRequest);
    return d->action;
}
 ...
 */
QString WAFRegionalClientRequest::actionString() const
{
    return WAFRegionalClientRequestPrivate::toString(action());
}
 ...
 */
QString WAFRegionalClientRequest::apiVersion() const
{
    Q_D(const WAFRegionalClientRequest);
    return d->apiVersion;
}
 ...
 */
void WAFRegionalClientRequest::setAction(const Action action)
{
    Q_D(WAFRegionalClientRequest);
    d->action = action;
}
 ...
 */
void WAFRegionalClientRequest::setApiVersion(const QString &version)
{
    Q_D(WAFRegionalClientRequest);
 ...
 */
bool WAFRegionalClientRequest::operator==(const WAFRegionalClientRequest &other) const
{
 ...
 */
bool WAFRegionalClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int WAFRegionalClientRequest::clearParameter(const QString &name)
{
    Q_D(WAFRegionalClientRequest);
 ...
 */
void WAFRegionalClientRequest::clearParameters()
{
    Q_D(WAFRegionalClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant WAFRegionalClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const WAFRegionalClientRequest);
 ...
 */
const QVariantMap &WAFRegionalClientRequest::parameters() const
{
    Q_D(const WAFRegionalClientRequest);
    return d->parameters;
}
 ...
 */
void WAFRegionalClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(WAFRegionalClientRequest);
 ...
 */
void WAFRegionalClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(WAFRegionalClientRequest);
 ...
 */
QNetworkRequest WAFRegionalClientRequest::unsignedRequest(const QUrl &endpoint) const
{
    Q_D(const WAFRegionalClientRequest);
    QUrl url(endpoint);
 ...
 *
 * @brief  Private implementation for WAFRegionalClientRequest.
 */

/**
 * @internal
 *
 * @brief  Constructs a new WAFRegionalClientRequestPrivate object.
 *
 ...
 * @internal
 *
 * @brief  Constructs a new WAFRegionalClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the WAFRegionalClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public WAFRegionalClientRequest instance.
 */
 ...
 *
 * This function converts WAFRegionalClientRequest::Action enumerator values to their respective
 ...
 */
QString WAFRegionalClientRequestPrivate::toString(const WAFRegionalClientRequest::Action &action)
{
    #define ActionToString(action) \
        case WAFRegionalClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
