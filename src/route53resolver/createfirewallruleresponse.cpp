...
#include "createfirewallruleresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::CreateFirewallRuleResponse
 * \brief The CreateFirewallRuleResponse class provides an interace for Route53Resolver CreateFirewallRule responses.
 *
 ...
 *
 * \sa Route53ResolverClient::createFirewallRule
 */

/*!
 * Constructs a CreateFirewallRuleResponse object for \a reply to \a request, with parent \a parent.
 */
CreateFirewallRuleResponse::CreateFirewallRuleResponse(
        const CreateFirewallRuleRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new CreateFirewallRuleResponsePrivate(this), parent)
{
    setRequest(new CreateFirewallRuleRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateFirewallRuleRequest * CreateFirewallRuleResponse::request() const
{
    Q_D(const CreateFirewallRuleResponse);
    return static_cast<const CreateFirewallRuleRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver CreateFirewallRule \a response.
 */
void CreateFirewallRuleResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateFirewallRuleResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::CreateFirewallRuleResponsePrivate
 * \brief The CreateFirewallRuleResponsePrivate class provides private implementation for CreateFirewallRuleResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a CreateFirewallRuleResponsePrivate object with public implementation \a q.
 */
CreateFirewallRuleResponsePrivate::CreateFirewallRuleResponsePrivate(
    CreateFirewallRuleResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver CreateFirewallRule response element from \a xml.
 */
void CreateFirewallRuleResponsePrivate::parseCreateFirewallRuleResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateFirewallRuleResponse"));
    Q_UNUSED(xml) ///< @todo
}
