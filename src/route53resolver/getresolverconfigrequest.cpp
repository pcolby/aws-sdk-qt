...
#include "getresolverconfigrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::GetResolverConfigRequest
 * \brief The GetResolverConfigRequest class provides an interface for Route53Resolver GetResolverConfig requests.
 *
 ...
 */
GetResolverConfigRequest::GetResolverConfigRequest(const GetResolverConfigRequest &other)
    : Route53ResolverRequest(new GetResolverConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetResolverConfigRequest object.
 */
GetResolverConfigRequest::GetResolverConfigRequest()
    : Route53ResolverRequest(new GetResolverConfigRequestPrivate(Route53ResolverRequest::GetResolverConfigAction, this))
{
 ...
 * \reimp
 */
bool GetResolverConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetResolverConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetResolverConfigRequest::response(QNetworkReply * const reply) const
{
    return new GetResolverConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::GetResolverConfigRequestPrivate
 * \brief The GetResolverConfigRequestPrivate class provides private implementation for GetResolverConfigRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a GetResolverConfigRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
GetResolverConfigRequestPrivate::GetResolverConfigRequestPrivate(
    const Route53ResolverRequest::Action action, GetResolverConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetResolverConfigRequest
 * class' copy constructor.
 */
GetResolverConfigRequestPrivate::GetResolverConfigRequestPrivate(
    const GetResolverConfigRequestPrivate &other, GetResolverConfigRequest * const q)
