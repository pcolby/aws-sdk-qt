...
class QTAWS_EXPORT DeleteResolverEndpointResponsePrivate : public Route53ResolverResponsePrivate {

public:

    DeleteResolverEndpointResponsePrivate(DeleteResolverEndpointResponse * const q);
