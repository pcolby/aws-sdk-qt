...
class QTAWS_EXPORT CreateFirewallRuleResponsePrivate : public Route53ResolverResponsePrivate {

public:

    CreateFirewallRuleResponsePrivate(CreateFirewallRuleResponse * const q);
