...
class QTAWS_EXPORT GetResolverRuleAssociationResponsePrivate : public Route53ResolverResponsePrivate {

public:

    GetResolverRuleAssociationResponsePrivate(GetResolverRuleAssociationResponse * const q);
