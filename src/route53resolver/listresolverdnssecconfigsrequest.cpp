...
#include "listresolverdnssecconfigsrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ListResolverDnssecConfigsRequest
 * \brief The ListResolverDnssecConfigsRequest class provides an interface for Route53Resolver ListResolverDnssecConfigs requests.
 *
 ...
 */
ListResolverDnssecConfigsRequest::ListResolverDnssecConfigsRequest(const ListResolverDnssecConfigsRequest &other)
    : Route53ResolverRequest(new ListResolverDnssecConfigsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListResolverDnssecConfigsRequest object.
 */
ListResolverDnssecConfigsRequest::ListResolverDnssecConfigsRequest()
    : Route53ResolverRequest(new ListResolverDnssecConfigsRequestPrivate(Route53ResolverRequest::ListResolverDnssecConfigsAction, this))
{
 ...
 * \reimp
 */
bool ListResolverDnssecConfigsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListResolverDnssecConfigsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListResolverDnssecConfigsRequest::response(QNetworkReply * const reply) const
{
    return new ListResolverDnssecConfigsResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::ListResolverDnssecConfigsRequestPrivate
 * \brief The ListResolverDnssecConfigsRequestPrivate class provides private implementation for ListResolverDnssecConfigsRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ListResolverDnssecConfigsRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
ListResolverDnssecConfigsRequestPrivate::ListResolverDnssecConfigsRequestPrivate(
    const Route53ResolverRequest::Action action, ListResolverDnssecConfigsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListResolverDnssecConfigsRequest
 * class' copy constructor.
 */
ListResolverDnssecConfigsRequestPrivate::ListResolverDnssecConfigsRequestPrivate(
    const ListResolverDnssecConfigsRequestPrivate &other, ListResolverDnssecConfigsRequest * const q)
