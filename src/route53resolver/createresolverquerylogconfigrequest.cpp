...
#include "createresolverquerylogconfigrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::CreateResolverQueryLogConfigRequest
 * \brief The CreateResolverQueryLogConfigRequest class provides an interface for Route53Resolver CreateResolverQueryLogConfig requests.
 *
 ...
 */
CreateResolverQueryLogConfigRequest::CreateResolverQueryLogConfigRequest(const CreateResolverQueryLogConfigRequest &other)
    : Route53ResolverRequest(new CreateResolverQueryLogConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateResolverQueryLogConfigRequest object.
 */
CreateResolverQueryLogConfigRequest::CreateResolverQueryLogConfigRequest()
    : Route53ResolverRequest(new CreateResolverQueryLogConfigRequestPrivate(Route53ResolverRequest::CreateResolverQueryLogConfigAction, this))
{
 ...
 * \reimp
 */
bool CreateResolverQueryLogConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateResolverQueryLogConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateResolverQueryLogConfigRequest::response(QNetworkReply * const reply) const
{
    return new CreateResolverQueryLogConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::CreateResolverQueryLogConfigRequestPrivate
 * \brief The CreateResolverQueryLogConfigRequestPrivate class provides private implementation for CreateResolverQueryLogConfigRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a CreateResolverQueryLogConfigRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
CreateResolverQueryLogConfigRequestPrivate::CreateResolverQueryLogConfigRequestPrivate(
    const Route53ResolverRequest::Action action, CreateResolverQueryLogConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateResolverQueryLogConfigRequest
 * class' copy constructor.
 */
CreateResolverQueryLogConfigRequestPrivate::CreateResolverQueryLogConfigRequestPrivate(
    const CreateResolverQueryLogConfigRequestPrivate &other, CreateResolverQueryLogConfigRequest * const q)
