...
class QTAWS_EXPORT ListResolverRulesResponsePrivate : public Route53ResolverResponsePrivate {

public:

    ListResolverRulesResponsePrivate(ListResolverRulesResponse * const q);
