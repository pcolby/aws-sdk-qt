...
class QTAWS_EXPORT ListFirewallDomainsResponsePrivate : public Route53ResolverResponsePrivate {

public:

    ListFirewallDomainsResponsePrivate(ListFirewallDomainsResponse * const q);
