...
#include "deletefirewallruleresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::DeleteFirewallRuleResponse
 * \brief The DeleteFirewallRuleResponse class provides an interace for Route53Resolver DeleteFirewallRule responses.
 *
 ...
 *
 * \sa Route53ResolverClient::deleteFirewallRule
 */

/*!
 * Constructs a DeleteFirewallRuleResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteFirewallRuleResponse::DeleteFirewallRuleResponse(
        const DeleteFirewallRuleRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new DeleteFirewallRuleResponsePrivate(this), parent)
{
    setRequest(new DeleteFirewallRuleRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteFirewallRuleRequest * DeleteFirewallRuleResponse::request() const
{
    Q_D(const DeleteFirewallRuleResponse);
    return static_cast<const DeleteFirewallRuleRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver DeleteFirewallRule \a response.
 */
void DeleteFirewallRuleResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteFirewallRuleResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::DeleteFirewallRuleResponsePrivate
 * \brief The DeleteFirewallRuleResponsePrivate class provides private implementation for DeleteFirewallRuleResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a DeleteFirewallRuleResponsePrivate object with public implementation \a q.
 */
DeleteFirewallRuleResponsePrivate::DeleteFirewallRuleResponsePrivate(
    DeleteFirewallRuleResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver DeleteFirewallRule response element from \a xml.
 */
void DeleteFirewallRuleResponsePrivate::parseDeleteFirewallRuleResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteFirewallRuleResponse"));
    Q_UNUSED(xml) ///< @todo
}
