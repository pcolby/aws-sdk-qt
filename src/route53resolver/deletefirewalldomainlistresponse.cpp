...
#include "deletefirewalldomainlistresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::DeleteFirewallDomainListResponse
 * \brief The DeleteFirewallDomainListResponse class provides an interace for Route53Resolver DeleteFirewallDomainList responses.
 *
...
/*!
 * Constructs a DeleteFirewallDomainListResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteFirewallDomainListResponse::DeleteFirewallDomainListResponse(
        const DeleteFirewallDomainListRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new DeleteFirewallDomainListResponsePrivate(this), parent)
{
    setRequest(new DeleteFirewallDomainListRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver DeleteFirewallDomainList \a response.
 */
void DeleteFirewallDomainListResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteFirewallDomainListResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::DeleteFirewallDomainListResponsePrivate
 * \brief The DeleteFirewallDomainListResponsePrivate class provides private implementation for DeleteFirewallDomainListResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a DeleteFirewallDomainListResponsePrivate object with public implementation \a q.
 */
DeleteFirewallDomainListResponsePrivate::DeleteFirewallDomainListResponsePrivate(
    DeleteFirewallDomainListResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver DeleteFirewallDomainList response element from \a xml.
 */
void DeleteFirewallDomainListResponsePrivate::parseDeleteFirewallDomainListResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteFirewallDomainListResponse"));
    Q_UNUSED(xml) ///< @todo
}
