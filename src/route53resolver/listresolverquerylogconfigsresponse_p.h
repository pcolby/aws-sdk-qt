...
class QTAWS_EXPORT ListResolverQueryLogConfigsResponsePrivate : public Route53ResolverResponsePrivate {

public:

    ListResolverQueryLogConfigsResponsePrivate(ListResolverQueryLogConfigsResponse * const q);
