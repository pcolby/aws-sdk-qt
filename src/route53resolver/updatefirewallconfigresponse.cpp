...
#include "updatefirewallconfigresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::UpdateFirewallConfigResponse
 * \brief The UpdateFirewallConfigResponse class provides an interace for Route53Resolver UpdateFirewallConfig responses.
 *
...
/*!
 * Constructs a UpdateFirewallConfigResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateFirewallConfigResponse::UpdateFirewallConfigResponse(
        const UpdateFirewallConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new UpdateFirewallConfigResponsePrivate(this), parent)
{
    setRequest(new UpdateFirewallConfigRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver UpdateFirewallConfig \a response.
 */
void UpdateFirewallConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateFirewallConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::UpdateFirewallConfigResponsePrivate
 * \brief The UpdateFirewallConfigResponsePrivate class provides private implementation for UpdateFirewallConfigResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a UpdateFirewallConfigResponsePrivate object with public implementation \a q.
 */
UpdateFirewallConfigResponsePrivate::UpdateFirewallConfigResponsePrivate(
    UpdateFirewallConfigResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver UpdateFirewallConfig response element from \a xml.
 */
void UpdateFirewallConfigResponsePrivate::parseUpdateFirewallConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateFirewallConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
