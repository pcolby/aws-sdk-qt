...
class QTAWS_EXPORT ListResolverEndpointsResponsePrivate : public Route53ResolverResponsePrivate {

public:

    ListResolverEndpointsResponsePrivate(ListResolverEndpointsResponse * const q);
