...
#include "associateresolverquerylogconfigrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::AssociateResolverQueryLogConfigRequest
 * \brief The AssociateResolverQueryLogConfigRequest class provides an interface for Route53Resolver AssociateResolverQueryLogConfig requests.
 *
 ...
 */
AssociateResolverQueryLogConfigRequest::AssociateResolverQueryLogConfigRequest(const AssociateResolverQueryLogConfigRequest &other)
    : Route53ResolverRequest(new AssociateResolverQueryLogConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AssociateResolverQueryLogConfigRequest object.
 */
AssociateResolverQueryLogConfigRequest::AssociateResolverQueryLogConfigRequest()
    : Route53ResolverRequest(new AssociateResolverQueryLogConfigRequestPrivate(Route53ResolverRequest::AssociateResolverQueryLogConfigAction, this))
{
 ...
 * \reimp
 */
bool AssociateResolverQueryLogConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AssociateResolverQueryLogConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AssociateResolverQueryLogConfigRequest::response(QNetworkReply * const reply) const
{
    return new AssociateResolverQueryLogConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::AssociateResolverQueryLogConfigRequestPrivate
 * \brief The AssociateResolverQueryLogConfigRequestPrivate class provides private implementation for AssociateResolverQueryLogConfigRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a AssociateResolverQueryLogConfigRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
AssociateResolverQueryLogConfigRequestPrivate::AssociateResolverQueryLogConfigRequestPrivate(
    const Route53ResolverRequest::Action action, AssociateResolverQueryLogConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AssociateResolverQueryLogConfigRequest
 * class' copy constructor.
 */
AssociateResolverQueryLogConfigRequestPrivate::AssociateResolverQueryLogConfigRequestPrivate(
    const AssociateResolverQueryLogConfigRequestPrivate &other, AssociateResolverQueryLogConfigRequest * const q)
