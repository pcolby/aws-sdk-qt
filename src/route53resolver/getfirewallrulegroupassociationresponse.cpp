...
#include "getfirewallrulegroupassociationresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::GetFirewallRuleGroupAssociationResponse
 * \brief The GetFirewallRuleGroupAssociationResponse class provides an interace for Route53Resolver GetFirewallRuleGroupAssociation responses.
 *
...
/*!
 * Constructs a GetFirewallRuleGroupAssociationResponse object for \a reply to \a request, with parent \a parent.
 */
GetFirewallRuleGroupAssociationResponse::GetFirewallRuleGroupAssociationResponse(
        const GetFirewallRuleGroupAssociationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new GetFirewallRuleGroupAssociationResponsePrivate(this), parent)
{
    setRequest(new GetFirewallRuleGroupAssociationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver GetFirewallRuleGroupAssociation \a response.
 */
void GetFirewallRuleGroupAssociationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetFirewallRuleGroupAssociationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::GetFirewallRuleGroupAssociationResponsePrivate
 * \brief The GetFirewallRuleGroupAssociationResponsePrivate class provides private implementation for GetFirewallRuleGroupAssociationResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a GetFirewallRuleGroupAssociationResponsePrivate object with public implementation \a q.
 */
GetFirewallRuleGroupAssociationResponsePrivate::GetFirewallRuleGroupAssociationResponsePrivate(
    GetFirewallRuleGroupAssociationResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver GetFirewallRuleGroupAssociation response element from \a xml.
 */
void GetFirewallRuleGroupAssociationResponsePrivate::parseGetFirewallRuleGroupAssociationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetFirewallRuleGroupAssociationResponse"));
    Q_UNUSED(xml) ///< @todo
}
