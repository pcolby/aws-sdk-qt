...
#include "listfirewalldomainlistsrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ListFirewallDomainListsRequest
 * \brief The ListFirewallDomainListsRequest class provides an interface for Route53Resolver ListFirewallDomainLists requests.
 *
 ...
 */
ListFirewallDomainListsRequest::ListFirewallDomainListsRequest(const ListFirewallDomainListsRequest &other)
    : Route53ResolverRequest(new ListFirewallDomainListsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListFirewallDomainListsRequest object.
 */
ListFirewallDomainListsRequest::ListFirewallDomainListsRequest()
    : Route53ResolverRequest(new ListFirewallDomainListsRequestPrivate(Route53ResolverRequest::ListFirewallDomainListsAction, this))
{
 ...
 * \reimp
 */
bool ListFirewallDomainListsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListFirewallDomainListsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListFirewallDomainListsRequest::response(QNetworkReply * const reply) const
{
    return new ListFirewallDomainListsResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::ListFirewallDomainListsRequestPrivate
 * \brief The ListFirewallDomainListsRequestPrivate class provides private implementation for ListFirewallDomainListsRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ListFirewallDomainListsRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
ListFirewallDomainListsRequestPrivate::ListFirewallDomainListsRequestPrivate(
    const Route53ResolverRequest::Action action, ListFirewallDomainListsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListFirewallDomainListsRequest
 * class' copy constructor.
 */
ListFirewallDomainListsRequestPrivate::ListFirewallDomainListsRequestPrivate(
    const ListFirewallDomainListsRequestPrivate &other, ListFirewallDomainListsRequest * const q)
