...
class QTAWS_EXPORT GetResolverQueryLogConfigAssociationResponsePrivate : public Route53ResolverResponsePrivate {

public:

    GetResolverQueryLogConfigAssociationResponsePrivate(GetResolverQueryLogConfigAssociationResponse * const q);
