...
#include "getresolverquerylogconfigassociationrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::GetResolverQueryLogConfigAssociationRequest
 * \brief The GetResolverQueryLogConfigAssociationRequest class provides an interface for Route53Resolver GetResolverQueryLogConfigAssociation requests.
 *
 ...
 */
GetResolverQueryLogConfigAssociationRequest::GetResolverQueryLogConfigAssociationRequest(const GetResolverQueryLogConfigAssociationRequest &other)
    : Route53ResolverRequest(new GetResolverQueryLogConfigAssociationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetResolverQueryLogConfigAssociationRequest object.
 */
GetResolverQueryLogConfigAssociationRequest::GetResolverQueryLogConfigAssociationRequest()
    : Route53ResolverRequest(new GetResolverQueryLogConfigAssociationRequestPrivate(Route53ResolverRequest::GetResolverQueryLogConfigAssociationAction, this))
{
 ...
 * \reimp
 */
bool GetResolverQueryLogConfigAssociationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetResolverQueryLogConfigAssociationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetResolverQueryLogConfigAssociationRequest::response(QNetworkReply * const reply) const
{
    return new GetResolverQueryLogConfigAssociationResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::GetResolverQueryLogConfigAssociationRequestPrivate
 * \brief The GetResolverQueryLogConfigAssociationRequestPrivate class provides private implementation for GetResolverQueryLogConfigAssociationRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a GetResolverQueryLogConfigAssociationRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
GetResolverQueryLogConfigAssociationRequestPrivate::GetResolverQueryLogConfigAssociationRequestPrivate(
    const Route53ResolverRequest::Action action, GetResolverQueryLogConfigAssociationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetResolverQueryLogConfigAssociationRequest
 * class' copy constructor.
 */
GetResolverQueryLogConfigAssociationRequestPrivate::GetResolverQueryLogConfigAssociationRequestPrivate(
    const GetResolverQueryLogConfigAssociationRequestPrivate &other, GetResolverQueryLogConfigAssociationRequest * const q)
