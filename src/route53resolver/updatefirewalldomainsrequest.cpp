...
#include "updatefirewalldomainsrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::UpdateFirewallDomainsRequest
 * \brief The UpdateFirewallDomainsRequest class provides an interface for Route53Resolver UpdateFirewallDomains requests.
 *
 ...
 */
UpdateFirewallDomainsRequest::UpdateFirewallDomainsRequest(const UpdateFirewallDomainsRequest &other)
    : Route53ResolverRequest(new UpdateFirewallDomainsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateFirewallDomainsRequest object.
 */
UpdateFirewallDomainsRequest::UpdateFirewallDomainsRequest()
    : Route53ResolverRequest(new UpdateFirewallDomainsRequestPrivate(Route53ResolverRequest::UpdateFirewallDomainsAction, this))
{
 ...
 * \reimp
 */
bool UpdateFirewallDomainsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateFirewallDomainsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateFirewallDomainsRequest::response(QNetworkReply * const reply) const
{
    return new UpdateFirewallDomainsResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::UpdateFirewallDomainsRequestPrivate
 * \brief The UpdateFirewallDomainsRequestPrivate class provides private implementation for UpdateFirewallDomainsRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a UpdateFirewallDomainsRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
UpdateFirewallDomainsRequestPrivate::UpdateFirewallDomainsRequestPrivate(
    const Route53ResolverRequest::Action action, UpdateFirewallDomainsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateFirewallDomainsRequest
 * class' copy constructor.
 */
UpdateFirewallDomainsRequestPrivate::UpdateFirewallDomainsRequestPrivate(
    const UpdateFirewallDomainsRequestPrivate &other, UpdateFirewallDomainsRequest * const q)
