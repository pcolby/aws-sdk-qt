...
#include "getfirewallrulegrouprequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::GetFirewallRuleGroupRequest
 * \brief The GetFirewallRuleGroupRequest class provides an interface for Route53Resolver GetFirewallRuleGroup requests.
 *
 ...
 */
GetFirewallRuleGroupRequest::GetFirewallRuleGroupRequest(const GetFirewallRuleGroupRequest &other)
    : Route53ResolverRequest(new GetFirewallRuleGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetFirewallRuleGroupRequest object.
 */
GetFirewallRuleGroupRequest::GetFirewallRuleGroupRequest()
    : Route53ResolverRequest(new GetFirewallRuleGroupRequestPrivate(Route53ResolverRequest::GetFirewallRuleGroupAction, this))
{
 ...
 * \reimp
 */
bool GetFirewallRuleGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetFirewallRuleGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetFirewallRuleGroupRequest::response(QNetworkReply * const reply) const
{
    return new GetFirewallRuleGroupResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::GetFirewallRuleGroupRequestPrivate
 * \brief The GetFirewallRuleGroupRequestPrivate class provides private implementation for GetFirewallRuleGroupRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a GetFirewallRuleGroupRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
GetFirewallRuleGroupRequestPrivate::GetFirewallRuleGroupRequestPrivate(
    const Route53ResolverRequest::Action action, GetFirewallRuleGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetFirewallRuleGroupRequest
 * class' copy constructor.
 */
GetFirewallRuleGroupRequestPrivate::GetFirewallRuleGroupRequestPrivate(
    const GetFirewallRuleGroupRequestPrivate &other, GetFirewallRuleGroupRequest * const q)
