...
#include "listfirewallrulegroupassociationsrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ListFirewallRuleGroupAssociationsRequest
 * \brief The ListFirewallRuleGroupAssociationsRequest class provides an interface for Route53Resolver ListFirewallRuleGroupAssociations requests.
 *
 ...
 */
ListFirewallRuleGroupAssociationsRequest::ListFirewallRuleGroupAssociationsRequest(const ListFirewallRuleGroupAssociationsRequest &other)
    : Route53ResolverRequest(new ListFirewallRuleGroupAssociationsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListFirewallRuleGroupAssociationsRequest object.
 */
ListFirewallRuleGroupAssociationsRequest::ListFirewallRuleGroupAssociationsRequest()
    : Route53ResolverRequest(new ListFirewallRuleGroupAssociationsRequestPrivate(Route53ResolverRequest::ListFirewallRuleGroupAssociationsAction, this))
{
 ...
 * \reimp
 */
bool ListFirewallRuleGroupAssociationsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListFirewallRuleGroupAssociationsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListFirewallRuleGroupAssociationsRequest::response(QNetworkReply * const reply) const
{
    return new ListFirewallRuleGroupAssociationsResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::ListFirewallRuleGroupAssociationsRequestPrivate
 * \brief The ListFirewallRuleGroupAssociationsRequestPrivate class provides private implementation for ListFirewallRuleGroupAssociationsRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ListFirewallRuleGroupAssociationsRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
ListFirewallRuleGroupAssociationsRequestPrivate::ListFirewallRuleGroupAssociationsRequestPrivate(
    const Route53ResolverRequest::Action action, ListFirewallRuleGroupAssociationsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListFirewallRuleGroupAssociationsRequest
 * class' copy constructor.
 */
ListFirewallRuleGroupAssociationsRequestPrivate::ListFirewallRuleGroupAssociationsRequestPrivate(
    const ListFirewallRuleGroupAssociationsRequestPrivate &other, ListFirewallRuleGroupAssociationsRequest * const q)
