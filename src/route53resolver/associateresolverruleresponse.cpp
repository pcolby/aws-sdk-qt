...
#include "associateresolverruleresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::AssociateResolverRuleResponse
 * \brief The AssociateResolverRuleResponse class provides an interace for Route53Resolver AssociateResolverRule responses.
 *
...
/*!
 * Constructs a AssociateResolverRuleResponse object for \a reply to \a request, with parent \a parent.
 */
AssociateResolverRuleResponse::AssociateResolverRuleResponse(
        const AssociateResolverRuleRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new AssociateResolverRuleResponsePrivate(this), parent)
{
    setRequest(new AssociateResolverRuleRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver AssociateResolverRule \a response.
 */
void AssociateResolverRuleResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AssociateResolverRuleResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::AssociateResolverRuleResponsePrivate
 * \brief The AssociateResolverRuleResponsePrivate class provides private implementation for AssociateResolverRuleResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a AssociateResolverRuleResponsePrivate object with public implementation \a q.
 */
AssociateResolverRuleResponsePrivate::AssociateResolverRuleResponsePrivate(
    AssociateResolverRuleResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver AssociateResolverRule response element from \a xml.
 */
void AssociateResolverRuleResponsePrivate::parseAssociateResolverRuleResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AssociateResolverRuleResponse"));
    Q_UNUSED(xml) ///< @todo
}
