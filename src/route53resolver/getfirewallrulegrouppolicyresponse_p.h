...
class QTAWS_EXPORT GetFirewallRuleGroupPolicyResponsePrivate : public Route53ResolverResponsePrivate {

public:

    GetFirewallRuleGroupPolicyResponsePrivate(GetFirewallRuleGroupPolicyResponse * const q);
