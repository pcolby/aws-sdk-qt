...
class QTAWS_EXPORT UpdateFirewallDomainsResponsePrivate : public Route53ResolverResponsePrivate {

public:

    UpdateFirewallDomainsResponsePrivate(UpdateFirewallDomainsResponse * const q);
