...
#include "listfirewallrulegroupsrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ListFirewallRuleGroupsRequest
 * \brief The ListFirewallRuleGroupsRequest class provides an interface for Route53Resolver ListFirewallRuleGroups requests.
 *
 ...
 *
 * \sa Route53ResolverClient::listFirewallRuleGroups
 */

/*!
 * Constructs a copy of \a other.
 */
ListFirewallRuleGroupsRequest::ListFirewallRuleGroupsRequest(const ListFirewallRuleGroupsRequest &other)
    : Route53ResolverRequest(new ListFirewallRuleGroupsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListFirewallRuleGroupsRequest object.
 */
ListFirewallRuleGroupsRequest::ListFirewallRuleGroupsRequest()
    : Route53ResolverRequest(new ListFirewallRuleGroupsRequestPrivate(Route53ResolverRequest::ListFirewallRuleGroupsAction, this))
{
 ...
 * \reimp
 */
bool ListFirewallRuleGroupsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListFirewallRuleGroupsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListFirewallRuleGroupsRequest::response(QNetworkReply * const reply) const
{
    return new ListFirewallRuleGroupsResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::ListFirewallRuleGroupsRequestPrivate
 * \brief The ListFirewallRuleGroupsRequestPrivate class provides private implementation for ListFirewallRuleGroupsRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ListFirewallRuleGroupsRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
ListFirewallRuleGroupsRequestPrivate::ListFirewallRuleGroupsRequestPrivate(
    const Route53ResolverRequest::Action action, ListFirewallRuleGroupsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListFirewallRuleGroupsRequest
 * class' copy constructor.
 */
ListFirewallRuleGroupsRequestPrivate::ListFirewallRuleGroupsRequestPrivate(
    const ListFirewallRuleGroupsRequestPrivate &other, ListFirewallRuleGroupsRequest * const q)
