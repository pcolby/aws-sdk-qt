...
#include "importfirewalldomainsresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ImportFirewallDomainsResponse
 * \brief The ImportFirewallDomainsResponse class provides an interace for Route53Resolver ImportFirewallDomains responses.
 *
...
/*!
 * Constructs a ImportFirewallDomainsResponse object for \a reply to \a request, with parent \a parent.
 */
ImportFirewallDomainsResponse::ImportFirewallDomainsResponse(
        const ImportFirewallDomainsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new ImportFirewallDomainsResponsePrivate(this), parent)
{
    setRequest(new ImportFirewallDomainsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver ImportFirewallDomains \a response.
 */
void ImportFirewallDomainsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ImportFirewallDomainsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::ImportFirewallDomainsResponsePrivate
 * \brief The ImportFirewallDomainsResponsePrivate class provides private implementation for ImportFirewallDomainsResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ImportFirewallDomainsResponsePrivate object with public implementation \a q.
 */
ImportFirewallDomainsResponsePrivate::ImportFirewallDomainsResponsePrivate(
    ImportFirewallDomainsResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver ImportFirewallDomains response element from \a xml.
 */
void ImportFirewallDomainsResponsePrivate::parseImportFirewallDomainsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ImportFirewallDomainsResponse"));
    Q_UNUSED(xml) ///< @todo
}
