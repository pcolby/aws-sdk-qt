...
class QTAWS_EXPORT ListFirewallRulesResponsePrivate : public Route53ResolverResponsePrivate {

public:

    ListFirewallRulesResponsePrivate(ListFirewallRulesResponse * const q);
