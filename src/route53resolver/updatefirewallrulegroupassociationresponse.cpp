...
#include "updatefirewallrulegroupassociationresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::UpdateFirewallRuleGroupAssociationResponse
 * \brief The UpdateFirewallRuleGroupAssociationResponse class provides an interace for Route53Resolver UpdateFirewallRuleGroupAssociation responses.
 *
...
/*!
 * Constructs a UpdateFirewallRuleGroupAssociationResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateFirewallRuleGroupAssociationResponse::UpdateFirewallRuleGroupAssociationResponse(
        const UpdateFirewallRuleGroupAssociationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new UpdateFirewallRuleGroupAssociationResponsePrivate(this), parent)
{
    setRequest(new UpdateFirewallRuleGroupAssociationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateFirewallRuleGroupAssociationRequest * UpdateFirewallRuleGroupAssociationResponse::request() const
{
    Q_D(const UpdateFirewallRuleGroupAssociationResponse);
    return static_cast<const UpdateFirewallRuleGroupAssociationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver UpdateFirewallRuleGroupAssociation \a response.
 */
void UpdateFirewallRuleGroupAssociationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateFirewallRuleGroupAssociationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::UpdateFirewallRuleGroupAssociationResponsePrivate
 * \brief The UpdateFirewallRuleGroupAssociationResponsePrivate class provides private implementation for UpdateFirewallRuleGroupAssociationResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a UpdateFirewallRuleGroupAssociationResponsePrivate object with public implementation \a q.
 */
UpdateFirewallRuleGroupAssociationResponsePrivate::UpdateFirewallRuleGroupAssociationResponsePrivate(
    UpdateFirewallRuleGroupAssociationResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver UpdateFirewallRuleGroupAssociation response element from \a xml.
 */
void UpdateFirewallRuleGroupAssociationResponsePrivate::parseUpdateFirewallRuleGroupAssociationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateFirewallRuleGroupAssociationResponse"));
    Q_UNUSED(xml) ///< @todo
}
