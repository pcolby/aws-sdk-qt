...
#include "deletefirewalldomainlistrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::DeleteFirewallDomainListRequest
 * \brief The DeleteFirewallDomainListRequest class provides an interface for Route53Resolver DeleteFirewallDomainList requests.
 *
 ...
 *
 * \sa Route53ResolverClient::deleteFirewallDomainList
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteFirewallDomainListRequest::DeleteFirewallDomainListRequest(const DeleteFirewallDomainListRequest &other)
    : Route53ResolverRequest(new DeleteFirewallDomainListRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteFirewallDomainListRequest object.
 */
DeleteFirewallDomainListRequest::DeleteFirewallDomainListRequest()
    : Route53ResolverRequest(new DeleteFirewallDomainListRequestPrivate(Route53ResolverRequest::DeleteFirewallDomainListAction, this))
{
 ...
 * \reimp
 */
bool DeleteFirewallDomainListRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteFirewallDomainListResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteFirewallDomainListRequest::response(QNetworkReply * const reply) const
{
    return new DeleteFirewallDomainListResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::DeleteFirewallDomainListRequestPrivate
 * \brief The DeleteFirewallDomainListRequestPrivate class provides private implementation for DeleteFirewallDomainListRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a DeleteFirewallDomainListRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
DeleteFirewallDomainListRequestPrivate::DeleteFirewallDomainListRequestPrivate(
    const Route53ResolverRequest::Action action, DeleteFirewallDomainListRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteFirewallDomainListRequest
 * class' copy constructor.
 */
DeleteFirewallDomainListRequestPrivate::DeleteFirewallDomainListRequestPrivate(
    const DeleteFirewallDomainListRequestPrivate &other, DeleteFirewallDomainListRequest * const q)
