...
/*!
 * \class QtAws::Route53Resolver::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Route53Resolver UntagResource responses.
 *
 ...
 *
 * \sa Route53ResolverClient::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : Route53ResolverResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(Route53ResolverResponse::request());
}

/*!
 * \reimp
 * Parses a successful Route53Resolver UntagResource \a response.
 */
...
/*!
 * \class QtAws::Route53Resolver::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver UntagResource response element from \a xml.
 */
