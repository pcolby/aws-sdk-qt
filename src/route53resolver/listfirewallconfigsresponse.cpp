...
#include "listfirewallconfigsresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ListFirewallConfigsResponse
 * \brief The ListFirewallConfigsResponse class provides an interace for Route53Resolver ListFirewallConfigs responses.
 *
...
/*!
 * Constructs a ListFirewallConfigsResponse object for \a reply to \a request, with parent \a parent.
 */
ListFirewallConfigsResponse::ListFirewallConfigsResponse(
        const ListFirewallConfigsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new ListFirewallConfigsResponsePrivate(this), parent)
{
    setRequest(new ListFirewallConfigsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListFirewallConfigsRequest * ListFirewallConfigsResponse::request() const
{
    Q_D(const ListFirewallConfigsResponse);
    return static_cast<const ListFirewallConfigsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver ListFirewallConfigs \a response.
 */
void ListFirewallConfigsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListFirewallConfigsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::ListFirewallConfigsResponsePrivate
 * \brief The ListFirewallConfigsResponsePrivate class provides private implementation for ListFirewallConfigsResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ListFirewallConfigsResponsePrivate object with public implementation \a q.
 */
ListFirewallConfigsResponsePrivate::ListFirewallConfigsResponsePrivate(
    ListFirewallConfigsResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver ListFirewallConfigs response element from \a xml.
 */
void ListFirewallConfigsResponsePrivate::parseListFirewallConfigsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListFirewallConfigsResponse"));
    Q_UNUSED(xml) ///< @todo
}
