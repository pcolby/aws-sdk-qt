...
class QTAWS_EXPORT PutFirewallRuleGroupPolicyResponsePrivate : public Route53ResolverResponsePrivate {

public:

    PutFirewallRuleGroupPolicyResponsePrivate(PutFirewallRuleGroupPolicyResponse * const q);
