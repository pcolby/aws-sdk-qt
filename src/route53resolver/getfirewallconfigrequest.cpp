...
#include "getfirewallconfigrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::GetFirewallConfigRequest
 * \brief The GetFirewallConfigRequest class provides an interface for Route53Resolver GetFirewallConfig requests.
 *
 ...
 */
GetFirewallConfigRequest::GetFirewallConfigRequest(const GetFirewallConfigRequest &other)
    : Route53ResolverRequest(new GetFirewallConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetFirewallConfigRequest object.
 */
GetFirewallConfigRequest::GetFirewallConfigRequest()
    : Route53ResolverRequest(new GetFirewallConfigRequestPrivate(Route53ResolverRequest::GetFirewallConfigAction, this))
{
 ...
 * \reimp
 */
bool GetFirewallConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetFirewallConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetFirewallConfigRequest::response(QNetworkReply * const reply) const
{
    return new GetFirewallConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::GetFirewallConfigRequestPrivate
 * \brief The GetFirewallConfigRequestPrivate class provides private implementation for GetFirewallConfigRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a GetFirewallConfigRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
GetFirewallConfigRequestPrivate::GetFirewallConfigRequestPrivate(
    const Route53ResolverRequest::Action action, GetFirewallConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetFirewallConfigRequest
 * class' copy constructor.
 */
GetFirewallConfigRequestPrivate::GetFirewallConfigRequestPrivate(
    const GetFirewallConfigRequestPrivate &other, GetFirewallConfigRequest * const q)
