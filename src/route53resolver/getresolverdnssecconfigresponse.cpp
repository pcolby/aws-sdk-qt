...
#include "getresolverdnssecconfigresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::GetResolverDnssecConfigResponse
 * \brief The GetResolverDnssecConfigResponse class provides an interace for Route53Resolver GetResolverDnssecConfig responses.
 *
...
/*!
 * Constructs a GetResolverDnssecConfigResponse object for \a reply to \a request, with parent \a parent.
 */
GetResolverDnssecConfigResponse::GetResolverDnssecConfigResponse(
        const GetResolverDnssecConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new GetResolverDnssecConfigResponsePrivate(this), parent)
{
    setRequest(new GetResolverDnssecConfigRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver GetResolverDnssecConfig \a response.
 */
void GetResolverDnssecConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetResolverDnssecConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::GetResolverDnssecConfigResponsePrivate
 * \brief The GetResolverDnssecConfigResponsePrivate class provides private implementation for GetResolverDnssecConfigResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a GetResolverDnssecConfigResponsePrivate object with public implementation \a q.
 */
GetResolverDnssecConfigResponsePrivate::GetResolverDnssecConfigResponsePrivate(
    GetResolverDnssecConfigResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver GetResolverDnssecConfig response element from \a xml.
 */
void GetResolverDnssecConfigResponsePrivate::parseGetResolverDnssecConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetResolverDnssecConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
