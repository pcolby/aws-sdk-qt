...
#include "deleteresolverquerylogconfigrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::DeleteResolverQueryLogConfigRequest
 * \brief The DeleteResolverQueryLogConfigRequest class provides an interface for Route53Resolver DeleteResolverQueryLogConfig requests.
 *
 ...
 *
 * \sa Route53ResolverClient::deleteResolverQueryLogConfig
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteResolverQueryLogConfigRequest::DeleteResolverQueryLogConfigRequest(const DeleteResolverQueryLogConfigRequest &other)
    : Route53ResolverRequest(new DeleteResolverQueryLogConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteResolverQueryLogConfigRequest object.
 */
DeleteResolverQueryLogConfigRequest::DeleteResolverQueryLogConfigRequest()
    : Route53ResolverRequest(new DeleteResolverQueryLogConfigRequestPrivate(Route53ResolverRequest::DeleteResolverQueryLogConfigAction, this))
{
 ...
 * \reimp
 */
bool DeleteResolverQueryLogConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteResolverQueryLogConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteResolverQueryLogConfigRequest::response(QNetworkReply * const reply) const
{
    return new DeleteResolverQueryLogConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::DeleteResolverQueryLogConfigRequestPrivate
 * \brief The DeleteResolverQueryLogConfigRequestPrivate class provides private implementation for DeleteResolverQueryLogConfigRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a DeleteResolverQueryLogConfigRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
DeleteResolverQueryLogConfigRequestPrivate::DeleteResolverQueryLogConfigRequestPrivate(
    const Route53ResolverRequest::Action action, DeleteResolverQueryLogConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteResolverQueryLogConfigRequest
 * class' copy constructor.
 */
DeleteResolverQueryLogConfigRequestPrivate::DeleteResolverQueryLogConfigRequestPrivate(
    const DeleteResolverQueryLogConfigRequestPrivate &other, DeleteResolverQueryLogConfigRequest * const q)
