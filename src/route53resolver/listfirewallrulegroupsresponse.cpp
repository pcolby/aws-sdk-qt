...
#include "listfirewallrulegroupsresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ListFirewallRuleGroupsResponse
 * \brief The ListFirewallRuleGroupsResponse class provides an interace for Route53Resolver ListFirewallRuleGroups responses.
 *
...
/*!
 * Constructs a ListFirewallRuleGroupsResponse object for \a reply to \a request, with parent \a parent.
 */
ListFirewallRuleGroupsResponse::ListFirewallRuleGroupsResponse(
        const ListFirewallRuleGroupsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new ListFirewallRuleGroupsResponsePrivate(this), parent)
{
    setRequest(new ListFirewallRuleGroupsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver ListFirewallRuleGroups \a response.
 */
void ListFirewallRuleGroupsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListFirewallRuleGroupsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::ListFirewallRuleGroupsResponsePrivate
 * \brief The ListFirewallRuleGroupsResponsePrivate class provides private implementation for ListFirewallRuleGroupsResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ListFirewallRuleGroupsResponsePrivate object with public implementation \a q.
 */
ListFirewallRuleGroupsResponsePrivate::ListFirewallRuleGroupsResponsePrivate(
    ListFirewallRuleGroupsResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver ListFirewallRuleGroups response element from \a xml.
 */
void ListFirewallRuleGroupsResponsePrivate::parseListFirewallRuleGroupsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListFirewallRuleGroupsResponse"));
    Q_UNUSED(xml) ///< @todo
}
