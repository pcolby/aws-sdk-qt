...
#include "updatefirewallruleresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::UpdateFirewallRuleResponse
 * \brief The UpdateFirewallRuleResponse class provides an interace for Route53Resolver UpdateFirewallRule responses.
 *
 ...
 *
 * \sa Route53ResolverClient::updateFirewallRule
 */

/*!
 * Constructs a UpdateFirewallRuleResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateFirewallRuleResponse::UpdateFirewallRuleResponse(
        const UpdateFirewallRuleRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new UpdateFirewallRuleResponsePrivate(this), parent)
{
    setRequest(new UpdateFirewallRuleRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateFirewallRuleRequest * UpdateFirewallRuleResponse::request() const
{
    Q_D(const UpdateFirewallRuleResponse);
    return static_cast<const UpdateFirewallRuleRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver UpdateFirewallRule \a response.
 */
void UpdateFirewallRuleResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateFirewallRuleResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::UpdateFirewallRuleResponsePrivate
 * \brief The UpdateFirewallRuleResponsePrivate class provides private implementation for UpdateFirewallRuleResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a UpdateFirewallRuleResponsePrivate object with public implementation \a q.
 */
UpdateFirewallRuleResponsePrivate::UpdateFirewallRuleResponsePrivate(
    UpdateFirewallRuleResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver UpdateFirewallRule response element from \a xml.
 */
void UpdateFirewallRuleResponsePrivate::parseUpdateFirewallRuleResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateFirewallRuleResponse"));
    Q_UNUSED(xml) ///< @todo
}
