...
#include "putresolverquerylogconfigpolicyresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::PutResolverQueryLogConfigPolicyResponse
 * \brief The PutResolverQueryLogConfigPolicyResponse class provides an interace for Route53Resolver PutResolverQueryLogConfigPolicy responses.
 *
...
/*!
 * Constructs a PutResolverQueryLogConfigPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
PutResolverQueryLogConfigPolicyResponse::PutResolverQueryLogConfigPolicyResponse(
        const PutResolverQueryLogConfigPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new PutResolverQueryLogConfigPolicyResponsePrivate(this), parent)
{
    setRequest(new PutResolverQueryLogConfigPolicyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver PutResolverQueryLogConfigPolicy \a response.
 */
void PutResolverQueryLogConfigPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutResolverQueryLogConfigPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::PutResolverQueryLogConfigPolicyResponsePrivate
 * \brief The PutResolverQueryLogConfigPolicyResponsePrivate class provides private implementation for PutResolverQueryLogConfigPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a PutResolverQueryLogConfigPolicyResponsePrivate object with public implementation \a q.
 */
PutResolverQueryLogConfigPolicyResponsePrivate::PutResolverQueryLogConfigPolicyResponsePrivate(
    PutResolverQueryLogConfigPolicyResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver PutResolverQueryLogConfigPolicy response element from \a xml.
 */
void PutResolverQueryLogConfigPolicyResponsePrivate::parsePutResolverQueryLogConfigPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutResolverQueryLogConfigPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
