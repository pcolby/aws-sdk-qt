...
class QTAWS_EXPORT ListResolverEndpointIpAddressesResponsePrivate : public Route53ResolverResponsePrivate {

public:

    ListResolverEndpointIpAddressesResponsePrivate(ListResolverEndpointIpAddressesResponse * const q);
