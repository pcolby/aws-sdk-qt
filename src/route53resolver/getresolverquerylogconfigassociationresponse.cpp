...
#include "getresolverquerylogconfigassociationresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::GetResolverQueryLogConfigAssociationResponse
 * \brief The GetResolverQueryLogConfigAssociationResponse class provides an interace for Route53Resolver GetResolverQueryLogConfigAssociation responses.
 *
 ...
 *
 * \sa Route53ResolverClient::getResolverQueryLogConfigAssociation
 */

/*!
 * Constructs a GetResolverQueryLogConfigAssociationResponse object for \a reply to \a request, with parent \a parent.
 */
GetResolverQueryLogConfigAssociationResponse::GetResolverQueryLogConfigAssociationResponse(
        const GetResolverQueryLogConfigAssociationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new GetResolverQueryLogConfigAssociationResponsePrivate(this), parent)
{
    setRequest(new GetResolverQueryLogConfigAssociationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetResolverQueryLogConfigAssociationRequest * GetResolverQueryLogConfigAssociationResponse::request() const
{
    Q_D(const GetResolverQueryLogConfigAssociationResponse);
    return static_cast<const GetResolverQueryLogConfigAssociationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver GetResolverQueryLogConfigAssociation \a response.
 */
void GetResolverQueryLogConfigAssociationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetResolverQueryLogConfigAssociationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::GetResolverQueryLogConfigAssociationResponsePrivate
 * \brief The GetResolverQueryLogConfigAssociationResponsePrivate class provides private implementation for GetResolverQueryLogConfigAssociationResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a GetResolverQueryLogConfigAssociationResponsePrivate object with public implementation \a q.
 */
GetResolverQueryLogConfigAssociationResponsePrivate::GetResolverQueryLogConfigAssociationResponsePrivate(
    GetResolverQueryLogConfigAssociationResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver GetResolverQueryLogConfigAssociation response element from \a xml.
 */
void GetResolverQueryLogConfigAssociationResponsePrivate::parseGetResolverQueryLogConfigAssociationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetResolverQueryLogConfigAssociationResponse"));
    Q_UNUSED(xml) ///< @todo
}
