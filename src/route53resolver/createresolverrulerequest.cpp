...
#include "createresolverrulerequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::CreateResolverRuleRequest
 * \brief The CreateResolverRuleRequest class provides an interface for Route53Resolver CreateResolverRule requests.
 *
 ...
 */
CreateResolverRuleRequest::CreateResolverRuleRequest(const CreateResolverRuleRequest &other)
    : Route53ResolverRequest(new CreateResolverRuleRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateResolverRuleRequest object.
 */
CreateResolverRuleRequest::CreateResolverRuleRequest()
    : Route53ResolverRequest(new CreateResolverRuleRequestPrivate(Route53ResolverRequest::CreateResolverRuleAction, this))
{
 ...
 * \reimp
 */
bool CreateResolverRuleRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateResolverRuleResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateResolverRuleRequest::response(QNetworkReply * const reply) const
{
    return new CreateResolverRuleResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::CreateResolverRuleRequestPrivate
 * \brief The CreateResolverRuleRequestPrivate class provides private implementation for CreateResolverRuleRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a CreateResolverRuleRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
CreateResolverRuleRequestPrivate::CreateResolverRuleRequestPrivate(
    const Route53ResolverRequest::Action action, CreateResolverRuleRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateResolverRuleRequest
 * class' copy constructor.
 */
CreateResolverRuleRequestPrivate::CreateResolverRuleRequestPrivate(
    const CreateResolverRuleRequestPrivate &other, CreateResolverRuleRequest * const q)
