...
#include "putfirewallrulegrouppolicyrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::PutFirewallRuleGroupPolicyRequest
 * \brief The PutFirewallRuleGroupPolicyRequest class provides an interface for Route53Resolver PutFirewallRuleGroupPolicy requests.
 *
 ...
 */
PutFirewallRuleGroupPolicyRequest::PutFirewallRuleGroupPolicyRequest(const PutFirewallRuleGroupPolicyRequest &other)
    : Route53ResolverRequest(new PutFirewallRuleGroupPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutFirewallRuleGroupPolicyRequest object.
 */
PutFirewallRuleGroupPolicyRequest::PutFirewallRuleGroupPolicyRequest()
    : Route53ResolverRequest(new PutFirewallRuleGroupPolicyRequestPrivate(Route53ResolverRequest::PutFirewallRuleGroupPolicyAction, this))
{
 ...
 * \reimp
 */
bool PutFirewallRuleGroupPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutFirewallRuleGroupPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutFirewallRuleGroupPolicyRequest::response(QNetworkReply * const reply) const
{
    return new PutFirewallRuleGroupPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::PutFirewallRuleGroupPolicyRequestPrivate
 * \brief The PutFirewallRuleGroupPolicyRequestPrivate class provides private implementation for PutFirewallRuleGroupPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a PutFirewallRuleGroupPolicyRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
PutFirewallRuleGroupPolicyRequestPrivate::PutFirewallRuleGroupPolicyRequestPrivate(
    const Route53ResolverRequest::Action action, PutFirewallRuleGroupPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutFirewallRuleGroupPolicyRequest
 * class' copy constructor.
 */
PutFirewallRuleGroupPolicyRequestPrivate::PutFirewallRuleGroupPolicyRequestPrivate(
    const PutFirewallRuleGroupPolicyRequestPrivate &other, PutFirewallRuleGroupPolicyRequest * const q)
