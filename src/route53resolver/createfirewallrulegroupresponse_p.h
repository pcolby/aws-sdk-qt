...
class QTAWS_EXPORT CreateFirewallRuleGroupResponsePrivate : public Route53ResolverResponsePrivate {

public:

    CreateFirewallRuleGroupResponsePrivate(CreateFirewallRuleGroupResponse * const q);
