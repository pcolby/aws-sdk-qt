...
#include "createfirewalldomainlistrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::CreateFirewallDomainListRequest
 * \brief The CreateFirewallDomainListRequest class provides an interface for Route53Resolver CreateFirewallDomainList requests.
 *
 ...
 */
CreateFirewallDomainListRequest::CreateFirewallDomainListRequest(const CreateFirewallDomainListRequest &other)
    : Route53ResolverRequest(new CreateFirewallDomainListRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateFirewallDomainListRequest object.
 */
CreateFirewallDomainListRequest::CreateFirewallDomainListRequest()
    : Route53ResolverRequest(new CreateFirewallDomainListRequestPrivate(Route53ResolverRequest::CreateFirewallDomainListAction, this))
{
 ...
 * \reimp
 */
bool CreateFirewallDomainListRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateFirewallDomainListResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateFirewallDomainListRequest::response(QNetworkReply * const reply) const
{
    return new CreateFirewallDomainListResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::CreateFirewallDomainListRequestPrivate
 * \brief The CreateFirewallDomainListRequestPrivate class provides private implementation for CreateFirewallDomainListRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a CreateFirewallDomainListRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
CreateFirewallDomainListRequestPrivate::CreateFirewallDomainListRequestPrivate(
    const Route53ResolverRequest::Action action, CreateFirewallDomainListRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateFirewallDomainListRequest
 * class' copy constructor.
 */
CreateFirewallDomainListRequestPrivate::CreateFirewallDomainListRequestPrivate(
    const CreateFirewallDomainListRequestPrivate &other, CreateFirewallDomainListRequest * const q)
