...
class QTAWS_EXPORT UpdateResolverRuleResponsePrivate : public Route53ResolverResponsePrivate {

public:

    UpdateResolverRuleResponsePrivate(UpdateResolverRuleResponse * const q);
