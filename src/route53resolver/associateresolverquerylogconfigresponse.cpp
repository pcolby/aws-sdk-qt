...
#include "associateresolverquerylogconfigresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::AssociateResolverQueryLogConfigResponse
 * \brief The AssociateResolverQueryLogConfigResponse class provides an interace for Route53Resolver AssociateResolverQueryLogConfig responses.
 *
 ...
 *
 * \sa Route53ResolverClient::associateResolverQueryLogConfig
 */

/*!
 * Constructs a AssociateResolverQueryLogConfigResponse object for \a reply to \a request, with parent \a parent.
 */
AssociateResolverQueryLogConfigResponse::AssociateResolverQueryLogConfigResponse(
        const AssociateResolverQueryLogConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new AssociateResolverQueryLogConfigResponsePrivate(this), parent)
{
    setRequest(new AssociateResolverQueryLogConfigRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const AssociateResolverQueryLogConfigRequest * AssociateResolverQueryLogConfigResponse::request() const
{
    Q_D(const AssociateResolverQueryLogConfigResponse);
    return static_cast<const AssociateResolverQueryLogConfigRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver AssociateResolverQueryLogConfig \a response.
 */
void AssociateResolverQueryLogConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AssociateResolverQueryLogConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::AssociateResolverQueryLogConfigResponsePrivate
 * \brief The AssociateResolverQueryLogConfigResponsePrivate class provides private implementation for AssociateResolverQueryLogConfigResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a AssociateResolverQueryLogConfigResponsePrivate object with public implementation \a q.
 */
AssociateResolverQueryLogConfigResponsePrivate::AssociateResolverQueryLogConfigResponsePrivate(
    AssociateResolverQueryLogConfigResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver AssociateResolverQueryLogConfig response element from \a xml.
 */
void AssociateResolverQueryLogConfigResponsePrivate::parseAssociateResolverQueryLogConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AssociateResolverQueryLogConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
