...
#include "putresolverquerylogconfigpolicyrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::PutResolverQueryLogConfigPolicyRequest
 * \brief The PutResolverQueryLogConfigPolicyRequest class provides an interface for Route53Resolver PutResolverQueryLogConfigPolicy requests.
 *
 ...
 *
 * \sa Route53ResolverClient::putResolverQueryLogConfigPolicy
 */

/*!
 * Constructs a copy of \a other.
 */
PutResolverQueryLogConfigPolicyRequest::PutResolverQueryLogConfigPolicyRequest(const PutResolverQueryLogConfigPolicyRequest &other)
    : Route53ResolverRequest(new PutResolverQueryLogConfigPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutResolverQueryLogConfigPolicyRequest object.
 */
PutResolverQueryLogConfigPolicyRequest::PutResolverQueryLogConfigPolicyRequest()
    : Route53ResolverRequest(new PutResolverQueryLogConfigPolicyRequestPrivate(Route53ResolverRequest::PutResolverQueryLogConfigPolicyAction, this))
{
 ...
 * \reimp
 */
bool PutResolverQueryLogConfigPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutResolverQueryLogConfigPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutResolverQueryLogConfigPolicyRequest::response(QNetworkReply * const reply) const
{
    return new PutResolverQueryLogConfigPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::PutResolverQueryLogConfigPolicyRequestPrivate
 * \brief The PutResolverQueryLogConfigPolicyRequestPrivate class provides private implementation for PutResolverQueryLogConfigPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a PutResolverQueryLogConfigPolicyRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
PutResolverQueryLogConfigPolicyRequestPrivate::PutResolverQueryLogConfigPolicyRequestPrivate(
    const Route53ResolverRequest::Action action, PutResolverQueryLogConfigPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutResolverQueryLogConfigPolicyRequest
 * class' copy constructor.
 */
PutResolverQueryLogConfigPolicyRequestPrivate::PutResolverQueryLogConfigPolicyRequestPrivate(
    const PutResolverQueryLogConfigPolicyRequestPrivate &other, PutResolverQueryLogConfigPolicyRequest * const q)
