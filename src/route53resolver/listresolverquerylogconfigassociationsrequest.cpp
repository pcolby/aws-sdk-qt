...
#include "listresolverquerylogconfigassociationsrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ListResolverQueryLogConfigAssociationsRequest
 * \brief The ListResolverQueryLogConfigAssociationsRequest class provides an interface for Route53Resolver ListResolverQueryLogConfigAssociations requests.
 *
 ...
 *
 * \sa Route53ResolverClient::listResolverQueryLogConfigAssociations
 */

/*!
 * Constructs a copy of \a other.
 */
ListResolverQueryLogConfigAssociationsRequest::ListResolverQueryLogConfigAssociationsRequest(const ListResolverQueryLogConfigAssociationsRequest &other)
    : Route53ResolverRequest(new ListResolverQueryLogConfigAssociationsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListResolverQueryLogConfigAssociationsRequest object.
 */
ListResolverQueryLogConfigAssociationsRequest::ListResolverQueryLogConfigAssociationsRequest()
    : Route53ResolverRequest(new ListResolverQueryLogConfigAssociationsRequestPrivate(Route53ResolverRequest::ListResolverQueryLogConfigAssociationsAction, this))
{
 ...
 * \reimp
 */
bool ListResolverQueryLogConfigAssociationsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListResolverQueryLogConfigAssociationsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListResolverQueryLogConfigAssociationsRequest::response(QNetworkReply * const reply) const
{
    return new ListResolverQueryLogConfigAssociationsResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::ListResolverQueryLogConfigAssociationsRequestPrivate
 * \brief The ListResolverQueryLogConfigAssociationsRequestPrivate class provides private implementation for ListResolverQueryLogConfigAssociationsRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ListResolverQueryLogConfigAssociationsRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
ListResolverQueryLogConfigAssociationsRequestPrivate::ListResolverQueryLogConfigAssociationsRequestPrivate(
    const Route53ResolverRequest::Action action, ListResolverQueryLogConfigAssociationsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListResolverQueryLogConfigAssociationsRequest
 * class' copy constructor.
 */
ListResolverQueryLogConfigAssociationsRequestPrivate::ListResolverQueryLogConfigAssociationsRequestPrivate(
    const ListResolverQueryLogConfigAssociationsRequestPrivate &other, ListResolverQueryLogConfigAssociationsRequest * const q)
