...
#include "associatefirewallrulegroupresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::AssociateFirewallRuleGroupResponse
 * \brief The AssociateFirewallRuleGroupResponse class provides an interace for Route53Resolver AssociateFirewallRuleGroup responses.
 *
 ...
 *
 * \sa Route53ResolverClient::associateFirewallRuleGroup
 */

/*!
 * Constructs a AssociateFirewallRuleGroupResponse object for \a reply to \a request, with parent \a parent.
 */
AssociateFirewallRuleGroupResponse::AssociateFirewallRuleGroupResponse(
        const AssociateFirewallRuleGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new AssociateFirewallRuleGroupResponsePrivate(this), parent)
{
    setRequest(new AssociateFirewallRuleGroupRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const AssociateFirewallRuleGroupRequest * AssociateFirewallRuleGroupResponse::request() const
{
    Q_D(const AssociateFirewallRuleGroupResponse);
    return static_cast<const AssociateFirewallRuleGroupRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver AssociateFirewallRuleGroup \a response.
 */
void AssociateFirewallRuleGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AssociateFirewallRuleGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::AssociateFirewallRuleGroupResponsePrivate
 * \brief The AssociateFirewallRuleGroupResponsePrivate class provides private implementation for AssociateFirewallRuleGroupResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a AssociateFirewallRuleGroupResponsePrivate object with public implementation \a q.
 */
AssociateFirewallRuleGroupResponsePrivate::AssociateFirewallRuleGroupResponsePrivate(
    AssociateFirewallRuleGroupResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver AssociateFirewallRuleGroup response element from \a xml.
 */
void AssociateFirewallRuleGroupResponsePrivate::parseAssociateFirewallRuleGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AssociateFirewallRuleGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
