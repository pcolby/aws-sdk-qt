...
#include "importfirewalldomainsrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ImportFirewallDomainsRequest
 * \brief The ImportFirewallDomainsRequest class provides an interface for Route53Resolver ImportFirewallDomains requests.
 *
 ...
 *
 * \sa Route53ResolverClient::importFirewallDomains
 */

/*!
 * Constructs a copy of \a other.
 */
ImportFirewallDomainsRequest::ImportFirewallDomainsRequest(const ImportFirewallDomainsRequest &other)
    : Route53ResolverRequest(new ImportFirewallDomainsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ImportFirewallDomainsRequest object.
 */
ImportFirewallDomainsRequest::ImportFirewallDomainsRequest()
    : Route53ResolverRequest(new ImportFirewallDomainsRequestPrivate(Route53ResolverRequest::ImportFirewallDomainsAction, this))
{
 ...
 * \reimp
 */
bool ImportFirewallDomainsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ImportFirewallDomainsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ImportFirewallDomainsRequest::response(QNetworkReply * const reply) const
{
    return new ImportFirewallDomainsResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::ImportFirewallDomainsRequestPrivate
 * \brief The ImportFirewallDomainsRequestPrivate class provides private implementation for ImportFirewallDomainsRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ImportFirewallDomainsRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
ImportFirewallDomainsRequestPrivate::ImportFirewallDomainsRequestPrivate(
    const Route53ResolverRequest::Action action, ImportFirewallDomainsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ImportFirewallDomainsRequest
 * class' copy constructor.
 */
ImportFirewallDomainsRequestPrivate::ImportFirewallDomainsRequestPrivate(
    const ImportFirewallDomainsRequestPrivate &other, ImportFirewallDomainsRequest * const q)
