...
#include "deletefirewallrulegroupresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::DeleteFirewallRuleGroupResponse
 * \brief The DeleteFirewallRuleGroupResponse class provides an interace for Route53Resolver DeleteFirewallRuleGroup responses.
 *
...
/*!
 * Constructs a DeleteFirewallRuleGroupResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteFirewallRuleGroupResponse::DeleteFirewallRuleGroupResponse(
        const DeleteFirewallRuleGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new DeleteFirewallRuleGroupResponsePrivate(this), parent)
{
    setRequest(new DeleteFirewallRuleGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver DeleteFirewallRuleGroup \a response.
 */
void DeleteFirewallRuleGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteFirewallRuleGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::DeleteFirewallRuleGroupResponsePrivate
 * \brief The DeleteFirewallRuleGroupResponsePrivate class provides private implementation for DeleteFirewallRuleGroupResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a DeleteFirewallRuleGroupResponsePrivate object with public implementation \a q.
 */
DeleteFirewallRuleGroupResponsePrivate::DeleteFirewallRuleGroupResponsePrivate(
    DeleteFirewallRuleGroupResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver DeleteFirewallRuleGroup response element from \a xml.
 */
void DeleteFirewallRuleGroupResponsePrivate::parseDeleteFirewallRuleGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteFirewallRuleGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
