...
/*!
 * \class QtAws::Route53Resolver::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Route53Resolver TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : Route53ResolverResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(Route53ResolverResponse::request());
}

/*!
 * \reimp
 * Parses a successful Route53Resolver TagResource \a response.
 */
...
/*!
 * \class QtAws::Route53Resolver::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver TagResource response element from \a xml.
 */
