...
#include "getresolverdnssecconfigrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::GetResolverDnssecConfigRequest
 * \brief The GetResolverDnssecConfigRequest class provides an interface for Route53Resolver GetResolverDnssecConfig requests.
 *
 ...
 *
 * \sa Route53ResolverClient::getResolverDnssecConfig
 */

/*!
 * Constructs a copy of \a other.
 */
GetResolverDnssecConfigRequest::GetResolverDnssecConfigRequest(const GetResolverDnssecConfigRequest &other)
    : Route53ResolverRequest(new GetResolverDnssecConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetResolverDnssecConfigRequest object.
 */
GetResolverDnssecConfigRequest::GetResolverDnssecConfigRequest()
    : Route53ResolverRequest(new GetResolverDnssecConfigRequestPrivate(Route53ResolverRequest::GetResolverDnssecConfigAction, this))
{
 ...
 * \reimp
 */
bool GetResolverDnssecConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetResolverDnssecConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetResolverDnssecConfigRequest::response(QNetworkReply * const reply) const
{
    return new GetResolverDnssecConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::GetResolverDnssecConfigRequestPrivate
 * \brief The GetResolverDnssecConfigRequestPrivate class provides private implementation for GetResolverDnssecConfigRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a GetResolverDnssecConfigRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
GetResolverDnssecConfigRequestPrivate::GetResolverDnssecConfigRequestPrivate(
    const Route53ResolverRequest::Action action, GetResolverDnssecConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetResolverDnssecConfigRequest
 * class' copy constructor.
 */
GetResolverDnssecConfigRequestPrivate::GetResolverDnssecConfigRequestPrivate(
    const GetResolverDnssecConfigRequestPrivate &other, GetResolverDnssecConfigRequest * const q)
