...
class QTAWS_EXPORT AssociateResolverRuleResponsePrivate : public Route53ResolverResponsePrivate {

public:

    AssociateResolverRuleResponsePrivate(AssociateResolverRuleResponse * const q);
