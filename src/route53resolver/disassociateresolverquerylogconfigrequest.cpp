...
#include "disassociateresolverquerylogconfigrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::DisassociateResolverQueryLogConfigRequest
 * \brief The DisassociateResolverQueryLogConfigRequest class provides an interface for Route53Resolver DisassociateResolverQueryLogConfig requests.
 *
 ...
 */
DisassociateResolverQueryLogConfigRequest::DisassociateResolverQueryLogConfigRequest(const DisassociateResolverQueryLogConfigRequest &other)
    : Route53ResolverRequest(new DisassociateResolverQueryLogConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DisassociateResolverQueryLogConfigRequest object.
 */
DisassociateResolverQueryLogConfigRequest::DisassociateResolverQueryLogConfigRequest()
    : Route53ResolverRequest(new DisassociateResolverQueryLogConfigRequestPrivate(Route53ResolverRequest::DisassociateResolverQueryLogConfigAction, this))
{
 ...
 * \reimp
 */
bool DisassociateResolverQueryLogConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DisassociateResolverQueryLogConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DisassociateResolverQueryLogConfigRequest::response(QNetworkReply * const reply) const
{
    return new DisassociateResolverQueryLogConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::DisassociateResolverQueryLogConfigRequestPrivate
 * \brief The DisassociateResolverQueryLogConfigRequestPrivate class provides private implementation for DisassociateResolverQueryLogConfigRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a DisassociateResolverQueryLogConfigRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
DisassociateResolverQueryLogConfigRequestPrivate::DisassociateResolverQueryLogConfigRequestPrivate(
    const Route53ResolverRequest::Action action, DisassociateResolverQueryLogConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DisassociateResolverQueryLogConfigRequest
 * class' copy constructor.
 */
DisassociateResolverQueryLogConfigRequestPrivate::DisassociateResolverQueryLogConfigRequestPrivate(
    const DisassociateResolverQueryLogConfigRequestPrivate &other, DisassociateResolverQueryLogConfigRequest * const q)
