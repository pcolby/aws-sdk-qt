...
class QTAWS_EXPORT GetResolverRulePolicyResponsePrivate : public Route53ResolverResponsePrivate {

public:

    GetResolverRulePolicyResponsePrivate(GetResolverRulePolicyResponse * const q);
