...
#include "deletefirewallrulegrouprequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::DeleteFirewallRuleGroupRequest
 * \brief The DeleteFirewallRuleGroupRequest class provides an interface for Route53Resolver DeleteFirewallRuleGroup requests.
 *
 ...
 *
 * \sa Route53ResolverClient::deleteFirewallRuleGroup
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteFirewallRuleGroupRequest::DeleteFirewallRuleGroupRequest(const DeleteFirewallRuleGroupRequest &other)
    : Route53ResolverRequest(new DeleteFirewallRuleGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteFirewallRuleGroupRequest object.
 */
DeleteFirewallRuleGroupRequest::DeleteFirewallRuleGroupRequest()
    : Route53ResolverRequest(new DeleteFirewallRuleGroupRequestPrivate(Route53ResolverRequest::DeleteFirewallRuleGroupAction, this))
{
 ...
 * \reimp
 */
bool DeleteFirewallRuleGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteFirewallRuleGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteFirewallRuleGroupRequest::response(QNetworkReply * const reply) const
{
    return new DeleteFirewallRuleGroupResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::DeleteFirewallRuleGroupRequestPrivate
 * \brief The DeleteFirewallRuleGroupRequestPrivate class provides private implementation for DeleteFirewallRuleGroupRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a DeleteFirewallRuleGroupRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
DeleteFirewallRuleGroupRequestPrivate::DeleteFirewallRuleGroupRequestPrivate(
    const Route53ResolverRequest::Action action, DeleteFirewallRuleGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteFirewallRuleGroupRequest
 * class' copy constructor.
 */
DeleteFirewallRuleGroupRequestPrivate::DeleteFirewallRuleGroupRequestPrivate(
    const DeleteFirewallRuleGroupRequestPrivate &other, DeleteFirewallRuleGroupRequest * const q)
