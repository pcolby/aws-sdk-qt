...
#include "updateresolverconfigresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::UpdateResolverConfigResponse
 * \brief The UpdateResolverConfigResponse class provides an interace for Route53Resolver UpdateResolverConfig responses.
 *
 ...
 *
 * \sa Route53ResolverClient::updateResolverConfig
 */

/*!
 * Constructs a UpdateResolverConfigResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateResolverConfigResponse::UpdateResolverConfigResponse(
        const UpdateResolverConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new UpdateResolverConfigResponsePrivate(this), parent)
{
    setRequest(new UpdateResolverConfigRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateResolverConfigRequest * UpdateResolverConfigResponse::request() const
{
    Q_D(const UpdateResolverConfigResponse);
    return static_cast<const UpdateResolverConfigRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver UpdateResolverConfig \a response.
 */
void UpdateResolverConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateResolverConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::UpdateResolverConfigResponsePrivate
 * \brief The UpdateResolverConfigResponsePrivate class provides private implementation for UpdateResolverConfigResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a UpdateResolverConfigResponsePrivate object with public implementation \a q.
 */
UpdateResolverConfigResponsePrivate::UpdateResolverConfigResponsePrivate(
    UpdateResolverConfigResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver UpdateResolverConfig response element from \a xml.
 */
void UpdateResolverConfigResponsePrivate::parseUpdateResolverConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateResolverConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
