...
#include "putfirewallrulegrouppolicyresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::PutFirewallRuleGroupPolicyResponse
 * \brief The PutFirewallRuleGroupPolicyResponse class provides an interace for Route53Resolver PutFirewallRuleGroupPolicy responses.
 *
 ...
 *
 * \sa Route53ResolverClient::putFirewallRuleGroupPolicy
 */

/*!
 * Constructs a PutFirewallRuleGroupPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
PutFirewallRuleGroupPolicyResponse::PutFirewallRuleGroupPolicyResponse(
        const PutFirewallRuleGroupPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new PutFirewallRuleGroupPolicyResponsePrivate(this), parent)
{
    setRequest(new PutFirewallRuleGroupPolicyRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const PutFirewallRuleGroupPolicyRequest * PutFirewallRuleGroupPolicyResponse::request() const
{
    Q_D(const PutFirewallRuleGroupPolicyResponse);
    return static_cast<const PutFirewallRuleGroupPolicyRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver PutFirewallRuleGroupPolicy \a response.
 */
void PutFirewallRuleGroupPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutFirewallRuleGroupPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::PutFirewallRuleGroupPolicyResponsePrivate
 * \brief The PutFirewallRuleGroupPolicyResponsePrivate class provides private implementation for PutFirewallRuleGroupPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a PutFirewallRuleGroupPolicyResponsePrivate object with public implementation \a q.
 */
PutFirewallRuleGroupPolicyResponsePrivate::PutFirewallRuleGroupPolicyResponsePrivate(
    PutFirewallRuleGroupPolicyResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver PutFirewallRuleGroupPolicy response element from \a xml.
 */
void PutFirewallRuleGroupPolicyResponsePrivate::parsePutFirewallRuleGroupPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutFirewallRuleGroupPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
