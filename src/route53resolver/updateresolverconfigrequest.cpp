...
#include "updateresolverconfigrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::UpdateResolverConfigRequest
 * \brief The UpdateResolverConfigRequest class provides an interface for Route53Resolver UpdateResolverConfig requests.
 *
 ...
 */
UpdateResolverConfigRequest::UpdateResolverConfigRequest(const UpdateResolverConfigRequest &other)
    : Route53ResolverRequest(new UpdateResolverConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateResolverConfigRequest object.
 */
UpdateResolverConfigRequest::UpdateResolverConfigRequest()
    : Route53ResolverRequest(new UpdateResolverConfigRequestPrivate(Route53ResolverRequest::UpdateResolverConfigAction, this))
{
 ...
 * \reimp
 */
bool UpdateResolverConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateResolverConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateResolverConfigRequest::response(QNetworkReply * const reply) const
{
    return new UpdateResolverConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::UpdateResolverConfigRequestPrivate
 * \brief The UpdateResolverConfigRequestPrivate class provides private implementation for UpdateResolverConfigRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a UpdateResolverConfigRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
UpdateResolverConfigRequestPrivate::UpdateResolverConfigRequestPrivate(
    const Route53ResolverRequest::Action action, UpdateResolverConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateResolverConfigRequest
 * class' copy constructor.
 */
UpdateResolverConfigRequestPrivate::UpdateResolverConfigRequestPrivate(
    const UpdateResolverConfigRequestPrivate &other, UpdateResolverConfigRequest * const q)
