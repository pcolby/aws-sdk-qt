...
#include "disassociatefirewallrulegrouprequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::DisassociateFirewallRuleGroupRequest
 * \brief The DisassociateFirewallRuleGroupRequest class provides an interface for Route53Resolver DisassociateFirewallRuleGroup requests.
 *
 ...
 *
 * \sa Route53ResolverClient::disassociateFirewallRuleGroup
 */

/*!
 * Constructs a copy of \a other.
 */
DisassociateFirewallRuleGroupRequest::DisassociateFirewallRuleGroupRequest(const DisassociateFirewallRuleGroupRequest &other)
    : Route53ResolverRequest(new DisassociateFirewallRuleGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DisassociateFirewallRuleGroupRequest object.
 */
DisassociateFirewallRuleGroupRequest::DisassociateFirewallRuleGroupRequest()
    : Route53ResolverRequest(new DisassociateFirewallRuleGroupRequestPrivate(Route53ResolverRequest::DisassociateFirewallRuleGroupAction, this))
{
 ...
 * \reimp
 */
bool DisassociateFirewallRuleGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DisassociateFirewallRuleGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DisassociateFirewallRuleGroupRequest::response(QNetworkReply * const reply) const
{
    return new DisassociateFirewallRuleGroupResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::DisassociateFirewallRuleGroupRequestPrivate
 * \brief The DisassociateFirewallRuleGroupRequestPrivate class provides private implementation for DisassociateFirewallRuleGroupRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a DisassociateFirewallRuleGroupRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
DisassociateFirewallRuleGroupRequestPrivate::DisassociateFirewallRuleGroupRequestPrivate(
    const Route53ResolverRequest::Action action, DisassociateFirewallRuleGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DisassociateFirewallRuleGroupRequest
 * class' copy constructor.
 */
DisassociateFirewallRuleGroupRequestPrivate::DisassociateFirewallRuleGroupRequestPrivate(
    const DisassociateFirewallRuleGroupRequestPrivate &other, DisassociateFirewallRuleGroupRequest * const q)
