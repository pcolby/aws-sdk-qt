...
#include "deleteresolverquerylogconfigresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::DeleteResolverQueryLogConfigResponse
 * \brief The DeleteResolverQueryLogConfigResponse class provides an interace for Route53Resolver DeleteResolverQueryLogConfig responses.
 *
...
/*!
 * Constructs a DeleteResolverQueryLogConfigResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteResolverQueryLogConfigResponse::DeleteResolverQueryLogConfigResponse(
        const DeleteResolverQueryLogConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new DeleteResolverQueryLogConfigResponsePrivate(this), parent)
{
    setRequest(new DeleteResolverQueryLogConfigRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver DeleteResolverQueryLogConfig \a response.
 */
void DeleteResolverQueryLogConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteResolverQueryLogConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::DeleteResolverQueryLogConfigResponsePrivate
 * \brief The DeleteResolverQueryLogConfigResponsePrivate class provides private implementation for DeleteResolverQueryLogConfigResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a DeleteResolverQueryLogConfigResponsePrivate object with public implementation \a q.
 */
DeleteResolverQueryLogConfigResponsePrivate::DeleteResolverQueryLogConfigResponsePrivate(
    DeleteResolverQueryLogConfigResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver DeleteResolverQueryLogConfig response element from \a xml.
 */
void DeleteResolverQueryLogConfigResponsePrivate::parseDeleteResolverQueryLogConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteResolverQueryLogConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
