...
class QTAWS_EXPORT CreateFirewallDomainListResponsePrivate : public Route53ResolverResponsePrivate {

public:

    CreateFirewallDomainListResponsePrivate(CreateFirewallDomainListResponse * const q);
