...
#include "deletefirewallrulerequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::DeleteFirewallRuleRequest
 * \brief The DeleteFirewallRuleRequest class provides an interface for Route53Resolver DeleteFirewallRule requests.
 *
 ...
 */
DeleteFirewallRuleRequest::DeleteFirewallRuleRequest(const DeleteFirewallRuleRequest &other)
    : Route53ResolverRequest(new DeleteFirewallRuleRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteFirewallRuleRequest object.
 */
DeleteFirewallRuleRequest::DeleteFirewallRuleRequest()
    : Route53ResolverRequest(new DeleteFirewallRuleRequestPrivate(Route53ResolverRequest::DeleteFirewallRuleAction, this))
{
 ...
 * \reimp
 */
bool DeleteFirewallRuleRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteFirewallRuleResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteFirewallRuleRequest::response(QNetworkReply * const reply) const
{
    return new DeleteFirewallRuleResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::DeleteFirewallRuleRequestPrivate
 * \brief The DeleteFirewallRuleRequestPrivate class provides private implementation for DeleteFirewallRuleRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a DeleteFirewallRuleRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
DeleteFirewallRuleRequestPrivate::DeleteFirewallRuleRequestPrivate(
    const Route53ResolverRequest::Action action, DeleteFirewallRuleRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteFirewallRuleRequest
 * class' copy constructor.
 */
DeleteFirewallRuleRequestPrivate::DeleteFirewallRuleRequestPrivate(
    const DeleteFirewallRuleRequestPrivate &other, DeleteFirewallRuleRequest * const q)
