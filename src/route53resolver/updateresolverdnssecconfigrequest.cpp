...
#include "updateresolverdnssecconfigrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::UpdateResolverDnssecConfigRequest
 * \brief The UpdateResolverDnssecConfigRequest class provides an interface for Route53Resolver UpdateResolverDnssecConfig requests.
 *
 ...
 */
UpdateResolverDnssecConfigRequest::UpdateResolverDnssecConfigRequest(const UpdateResolverDnssecConfigRequest &other)
    : Route53ResolverRequest(new UpdateResolverDnssecConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateResolverDnssecConfigRequest object.
 */
UpdateResolverDnssecConfigRequest::UpdateResolverDnssecConfigRequest()
    : Route53ResolverRequest(new UpdateResolverDnssecConfigRequestPrivate(Route53ResolverRequest::UpdateResolverDnssecConfigAction, this))
{
 ...
 * \reimp
 */
bool UpdateResolverDnssecConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateResolverDnssecConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateResolverDnssecConfigRequest::response(QNetworkReply * const reply) const
{
    return new UpdateResolverDnssecConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::UpdateResolverDnssecConfigRequestPrivate
 * \brief The UpdateResolverDnssecConfigRequestPrivate class provides private implementation for UpdateResolverDnssecConfigRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a UpdateResolverDnssecConfigRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
UpdateResolverDnssecConfigRequestPrivate::UpdateResolverDnssecConfigRequestPrivate(
    const Route53ResolverRequest::Action action, UpdateResolverDnssecConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateResolverDnssecConfigRequest
 * class' copy constructor.
 */
UpdateResolverDnssecConfigRequestPrivate::UpdateResolverDnssecConfigRequestPrivate(
    const UpdateResolverDnssecConfigRequestPrivate &other, UpdateResolverDnssecConfigRequest * const q)
