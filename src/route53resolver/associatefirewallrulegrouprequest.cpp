...
#include "associatefirewallrulegrouprequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::AssociateFirewallRuleGroupRequest
 * \brief The AssociateFirewallRuleGroupRequest class provides an interface for Route53Resolver AssociateFirewallRuleGroup requests.
 *
 ...
 */
AssociateFirewallRuleGroupRequest::AssociateFirewallRuleGroupRequest(const AssociateFirewallRuleGroupRequest &other)
    : Route53ResolverRequest(new AssociateFirewallRuleGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AssociateFirewallRuleGroupRequest object.
 */
AssociateFirewallRuleGroupRequest::AssociateFirewallRuleGroupRequest()
    : Route53ResolverRequest(new AssociateFirewallRuleGroupRequestPrivate(Route53ResolverRequest::AssociateFirewallRuleGroupAction, this))
{
 ...
 * \reimp
 */
bool AssociateFirewallRuleGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AssociateFirewallRuleGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AssociateFirewallRuleGroupRequest::response(QNetworkReply * const reply) const
{
    return new AssociateFirewallRuleGroupResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::AssociateFirewallRuleGroupRequestPrivate
 * \brief The AssociateFirewallRuleGroupRequestPrivate class provides private implementation for AssociateFirewallRuleGroupRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a AssociateFirewallRuleGroupRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
AssociateFirewallRuleGroupRequestPrivate::AssociateFirewallRuleGroupRequestPrivate(
    const Route53ResolverRequest::Action action, AssociateFirewallRuleGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AssociateFirewallRuleGroupRequest
 * class' copy constructor.
 */
AssociateFirewallRuleGroupRequestPrivate::AssociateFirewallRuleGroupRequestPrivate(
    const AssociateFirewallRuleGroupRequestPrivate &other, AssociateFirewallRuleGroupRequest * const q)
