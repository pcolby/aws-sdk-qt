...
#include "disassociatefirewallrulegroupresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::DisassociateFirewallRuleGroupResponse
 * \brief The DisassociateFirewallRuleGroupResponse class provides an interace for Route53Resolver DisassociateFirewallRuleGroup responses.
 *
...
/*!
 * Constructs a DisassociateFirewallRuleGroupResponse object for \a reply to \a request, with parent \a parent.
 */
DisassociateFirewallRuleGroupResponse::DisassociateFirewallRuleGroupResponse(
        const DisassociateFirewallRuleGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new DisassociateFirewallRuleGroupResponsePrivate(this), parent)
{
    setRequest(new DisassociateFirewallRuleGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver DisassociateFirewallRuleGroup \a response.
 */
void DisassociateFirewallRuleGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DisassociateFirewallRuleGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::DisassociateFirewallRuleGroupResponsePrivate
 * \brief The DisassociateFirewallRuleGroupResponsePrivate class provides private implementation for DisassociateFirewallRuleGroupResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a DisassociateFirewallRuleGroupResponsePrivate object with public implementation \a q.
 */
DisassociateFirewallRuleGroupResponsePrivate::DisassociateFirewallRuleGroupResponsePrivate(
    DisassociateFirewallRuleGroupResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver DisassociateFirewallRuleGroup response element from \a xml.
 */
void DisassociateFirewallRuleGroupResponsePrivate::parseDisassociateFirewallRuleGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DisassociateFirewallRuleGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
