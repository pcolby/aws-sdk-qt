...
#include "getresolverruleresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::GetResolverRuleResponse
 * \brief The GetResolverRuleResponse class provides an interace for Route53Resolver GetResolverRule responses.
 *
...
/*!
 * Constructs a GetResolverRuleResponse object for \a reply to \a request, with parent \a parent.
 */
GetResolverRuleResponse::GetResolverRuleResponse(
        const GetResolverRuleRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new GetResolverRuleResponsePrivate(this), parent)
{
    setRequest(new GetResolverRuleRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver GetResolverRule \a response.
 */
void GetResolverRuleResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetResolverRuleResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::GetResolverRuleResponsePrivate
 * \brief The GetResolverRuleResponsePrivate class provides private implementation for GetResolverRuleResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a GetResolverRuleResponsePrivate object with public implementation \a q.
 */
GetResolverRuleResponsePrivate::GetResolverRuleResponsePrivate(
    GetResolverRuleResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver GetResolverRule response element from \a xml.
 */
void GetResolverRuleResponsePrivate::parseGetResolverRuleResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetResolverRuleResponse"));
    Q_UNUSED(xml) ///< @todo
}
