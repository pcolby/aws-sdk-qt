...
#include "createresolverquerylogconfigresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::CreateResolverQueryLogConfigResponse
 * \brief The CreateResolverQueryLogConfigResponse class provides an interace for Route53Resolver CreateResolverQueryLogConfig responses.
 *
 ...
 *
 * \sa Route53ResolverClient::createResolverQueryLogConfig
 */

/*!
 * Constructs a CreateResolverQueryLogConfigResponse object for \a reply to \a request, with parent \a parent.
 */
CreateResolverQueryLogConfigResponse::CreateResolverQueryLogConfigResponse(
        const CreateResolverQueryLogConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new CreateResolverQueryLogConfigResponsePrivate(this), parent)
{
    setRequest(new CreateResolverQueryLogConfigRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateResolverQueryLogConfigRequest * CreateResolverQueryLogConfigResponse::request() const
{
    Q_D(const CreateResolverQueryLogConfigResponse);
    return static_cast<const CreateResolverQueryLogConfigRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver CreateResolverQueryLogConfig \a response.
 */
void CreateResolverQueryLogConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateResolverQueryLogConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::CreateResolverQueryLogConfigResponsePrivate
 * \brief The CreateResolverQueryLogConfigResponsePrivate class provides private implementation for CreateResolverQueryLogConfigResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a CreateResolverQueryLogConfigResponsePrivate object with public implementation \a q.
 */
CreateResolverQueryLogConfigResponsePrivate::CreateResolverQueryLogConfigResponsePrivate(
    CreateResolverQueryLogConfigResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver CreateResolverQueryLogConfig response element from \a xml.
 */
void CreateResolverQueryLogConfigResponsePrivate::parseCreateResolverQueryLogConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateResolverQueryLogConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
