...
#include "listfirewallrulegroupassociationsresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ListFirewallRuleGroupAssociationsResponse
 * \brief The ListFirewallRuleGroupAssociationsResponse class provides an interace for Route53Resolver ListFirewallRuleGroupAssociations responses.
 *
 ...
 *
 * \sa Route53ResolverClient::listFirewallRuleGroupAssociations
 */

/*!
 * Constructs a ListFirewallRuleGroupAssociationsResponse object for \a reply to \a request, with parent \a parent.
 */
ListFirewallRuleGroupAssociationsResponse::ListFirewallRuleGroupAssociationsResponse(
        const ListFirewallRuleGroupAssociationsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new ListFirewallRuleGroupAssociationsResponsePrivate(this), parent)
{
    setRequest(new ListFirewallRuleGroupAssociationsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListFirewallRuleGroupAssociationsRequest * ListFirewallRuleGroupAssociationsResponse::request() const
{
    Q_D(const ListFirewallRuleGroupAssociationsResponse);
    return static_cast<const ListFirewallRuleGroupAssociationsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver ListFirewallRuleGroupAssociations \a response.
 */
void ListFirewallRuleGroupAssociationsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListFirewallRuleGroupAssociationsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::ListFirewallRuleGroupAssociationsResponsePrivate
 * \brief The ListFirewallRuleGroupAssociationsResponsePrivate class provides private implementation for ListFirewallRuleGroupAssociationsResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ListFirewallRuleGroupAssociationsResponsePrivate object with public implementation \a q.
 */
ListFirewallRuleGroupAssociationsResponsePrivate::ListFirewallRuleGroupAssociationsResponsePrivate(
    ListFirewallRuleGroupAssociationsResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver ListFirewallRuleGroupAssociations response element from \a xml.
 */
void ListFirewallRuleGroupAssociationsResponsePrivate::parseListFirewallRuleGroupAssociationsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListFirewallRuleGroupAssociationsResponse"));
    Q_UNUSED(xml) ///< @todo
}
