...
/*!
 * \class QtAws::Route53Resolver::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for Route53Resolver UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : Route53ResolverRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : Route53ResolverRequest(new UntagResourceRequestPrivate(Route53ResolverRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::Route53Resolver::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const Route53ResolverRequest::Action action, UntagResourceRequest * const q)
