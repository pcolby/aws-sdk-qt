...
#include "updatefirewallconfigrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::UpdateFirewallConfigRequest
 * \brief The UpdateFirewallConfigRequest class provides an interface for Route53Resolver UpdateFirewallConfig requests.
 *
 ...
 *
 * \sa Route53ResolverClient::updateFirewallConfig
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateFirewallConfigRequest::UpdateFirewallConfigRequest(const UpdateFirewallConfigRequest &other)
    : Route53ResolverRequest(new UpdateFirewallConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateFirewallConfigRequest object.
 */
UpdateFirewallConfigRequest::UpdateFirewallConfigRequest()
    : Route53ResolverRequest(new UpdateFirewallConfigRequestPrivate(Route53ResolverRequest::UpdateFirewallConfigAction, this))
{
 ...
 * \reimp
 */
bool UpdateFirewallConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateFirewallConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateFirewallConfigRequest::response(QNetworkReply * const reply) const
{
    return new UpdateFirewallConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::UpdateFirewallConfigRequestPrivate
 * \brief The UpdateFirewallConfigRequestPrivate class provides private implementation for UpdateFirewallConfigRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a UpdateFirewallConfigRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
UpdateFirewallConfigRequestPrivate::UpdateFirewallConfigRequestPrivate(
    const Route53ResolverRequest::Action action, UpdateFirewallConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateFirewallConfigRequest
 * class' copy constructor.
 */
UpdateFirewallConfigRequestPrivate::UpdateFirewallConfigRequestPrivate(
    const UpdateFirewallConfigRequestPrivate &other, UpdateFirewallConfigRequest * const q)
