...
#include "listresolverquerylogconfigsresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ListResolverQueryLogConfigsResponse
 * \brief The ListResolverQueryLogConfigsResponse class provides an interace for Route53Resolver ListResolverQueryLogConfigs responses.
 *
...
/*!
 * Constructs a ListResolverQueryLogConfigsResponse object for \a reply to \a request, with parent \a parent.
 */
ListResolverQueryLogConfigsResponse::ListResolverQueryLogConfigsResponse(
        const ListResolverQueryLogConfigsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new ListResolverQueryLogConfigsResponsePrivate(this), parent)
{
    setRequest(new ListResolverQueryLogConfigsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListResolverQueryLogConfigsRequest * ListResolverQueryLogConfigsResponse::request() const
{
    Q_D(const ListResolverQueryLogConfigsResponse);
    return static_cast<const ListResolverQueryLogConfigsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver ListResolverQueryLogConfigs \a response.
 */
void ListResolverQueryLogConfigsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListResolverQueryLogConfigsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::ListResolverQueryLogConfigsResponsePrivate
 * \brief The ListResolverQueryLogConfigsResponsePrivate class provides private implementation for ListResolverQueryLogConfigsResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ListResolverQueryLogConfigsResponsePrivate object with public implementation \a q.
 */
ListResolverQueryLogConfigsResponsePrivate::ListResolverQueryLogConfigsResponsePrivate(
    ListResolverQueryLogConfigsResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver ListResolverQueryLogConfigs response element from \a xml.
 */
void ListResolverQueryLogConfigsResponsePrivate::parseListResolverQueryLogConfigsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListResolverQueryLogConfigsResponse"));
    Q_UNUSED(xml) ///< @todo
}
