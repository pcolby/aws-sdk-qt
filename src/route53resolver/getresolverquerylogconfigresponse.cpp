...
#include "getresolverquerylogconfigresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::GetResolverQueryLogConfigResponse
 * \brief The GetResolverQueryLogConfigResponse class provides an interace for Route53Resolver GetResolverQueryLogConfig responses.
 *
...
/*!
 * Constructs a GetResolverQueryLogConfigResponse object for \a reply to \a request, with parent \a parent.
 */
GetResolverQueryLogConfigResponse::GetResolverQueryLogConfigResponse(
        const GetResolverQueryLogConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new GetResolverQueryLogConfigResponsePrivate(this), parent)
{
    setRequest(new GetResolverQueryLogConfigRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver GetResolverQueryLogConfig \a response.
 */
void GetResolverQueryLogConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetResolverQueryLogConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::GetResolverQueryLogConfigResponsePrivate
 * \brief The GetResolverQueryLogConfigResponsePrivate class provides private implementation for GetResolverQueryLogConfigResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a GetResolverQueryLogConfigResponsePrivate object with public implementation \a q.
 */
GetResolverQueryLogConfigResponsePrivate::GetResolverQueryLogConfigResponsePrivate(
    GetResolverQueryLogConfigResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver GetResolverQueryLogConfig response element from \a xml.
 */
void GetResolverQueryLogConfigResponsePrivate::parseGetResolverQueryLogConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetResolverQueryLogConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
