...
#include "updatefirewalldomainsresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::UpdateFirewallDomainsResponse
 * \brief The UpdateFirewallDomainsResponse class provides an interace for Route53Resolver UpdateFirewallDomains responses.
 *
 ...
 *
 * \sa Route53ResolverClient::updateFirewallDomains
 */

/*!
 * Constructs a UpdateFirewallDomainsResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateFirewallDomainsResponse::UpdateFirewallDomainsResponse(
        const UpdateFirewallDomainsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new UpdateFirewallDomainsResponsePrivate(this), parent)
{
    setRequest(new UpdateFirewallDomainsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateFirewallDomainsRequest * UpdateFirewallDomainsResponse::request() const
{
    Q_D(const UpdateFirewallDomainsResponse);
    return static_cast<const UpdateFirewallDomainsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver UpdateFirewallDomains \a response.
 */
void UpdateFirewallDomainsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateFirewallDomainsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::UpdateFirewallDomainsResponsePrivate
 * \brief The UpdateFirewallDomainsResponsePrivate class provides private implementation for UpdateFirewallDomainsResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a UpdateFirewallDomainsResponsePrivate object with public implementation \a q.
 */
UpdateFirewallDomainsResponsePrivate::UpdateFirewallDomainsResponsePrivate(
    UpdateFirewallDomainsResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver UpdateFirewallDomains response element from \a xml.
 */
void UpdateFirewallDomainsResponsePrivate::parseUpdateFirewallDomainsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateFirewallDomainsResponse"));
    Q_UNUSED(xml) ///< @todo
}
