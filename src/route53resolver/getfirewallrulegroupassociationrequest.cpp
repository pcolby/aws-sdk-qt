...
#include "getfirewallrulegroupassociationrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::GetFirewallRuleGroupAssociationRequest
 * \brief The GetFirewallRuleGroupAssociationRequest class provides an interface for Route53Resolver GetFirewallRuleGroupAssociation requests.
 *
 ...
 *
 * \sa Route53ResolverClient::getFirewallRuleGroupAssociation
 */

/*!
 * Constructs a copy of \a other.
 */
GetFirewallRuleGroupAssociationRequest::GetFirewallRuleGroupAssociationRequest(const GetFirewallRuleGroupAssociationRequest &other)
    : Route53ResolverRequest(new GetFirewallRuleGroupAssociationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetFirewallRuleGroupAssociationRequest object.
 */
GetFirewallRuleGroupAssociationRequest::GetFirewallRuleGroupAssociationRequest()
    : Route53ResolverRequest(new GetFirewallRuleGroupAssociationRequestPrivate(Route53ResolverRequest::GetFirewallRuleGroupAssociationAction, this))
{
 ...
 * \reimp
 */
bool GetFirewallRuleGroupAssociationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetFirewallRuleGroupAssociationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetFirewallRuleGroupAssociationRequest::response(QNetworkReply * const reply) const
{
    return new GetFirewallRuleGroupAssociationResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::GetFirewallRuleGroupAssociationRequestPrivate
 * \brief The GetFirewallRuleGroupAssociationRequestPrivate class provides private implementation for GetFirewallRuleGroupAssociationRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a GetFirewallRuleGroupAssociationRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
GetFirewallRuleGroupAssociationRequestPrivate::GetFirewallRuleGroupAssociationRequestPrivate(
    const Route53ResolverRequest::Action action, GetFirewallRuleGroupAssociationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetFirewallRuleGroupAssociationRequest
 * class' copy constructor.
 */
GetFirewallRuleGroupAssociationRequestPrivate::GetFirewallRuleGroupAssociationRequestPrivate(
    const GetFirewallRuleGroupAssociationRequestPrivate &other, GetFirewallRuleGroupAssociationRequest * const q)
