...
class QTAWS_EXPORT AssociateResolverQueryLogConfigResponsePrivate : public Route53ResolverResponsePrivate {

public:

    AssociateResolverQueryLogConfigResponsePrivate(AssociateResolverQueryLogConfigResponse * const q);
