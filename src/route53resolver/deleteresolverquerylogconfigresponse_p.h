...
class QTAWS_EXPORT DeleteResolverQueryLogConfigResponsePrivate : public Route53ResolverResponsePrivate {

public:

    DeleteResolverQueryLogConfigResponsePrivate(DeleteResolverQueryLogConfigResponse * const q);
