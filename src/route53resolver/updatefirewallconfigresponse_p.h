...
class QTAWS_EXPORT UpdateFirewallConfigResponsePrivate : public Route53ResolverResponsePrivate {

public:

    UpdateFirewallConfigResponsePrivate(UpdateFirewallConfigResponse * const q);
