...
#include "createfirewalldomainlistresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::CreateFirewallDomainListResponse
 * \brief The CreateFirewallDomainListResponse class provides an interace for Route53Resolver CreateFirewallDomainList responses.
 *
 ...
 *
 * \sa Route53ResolverClient::createFirewallDomainList
 */

/*!
 * Constructs a CreateFirewallDomainListResponse object for \a reply to \a request, with parent \a parent.
 */
CreateFirewallDomainListResponse::CreateFirewallDomainListResponse(
        const CreateFirewallDomainListRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new CreateFirewallDomainListResponsePrivate(this), parent)
{
    setRequest(new CreateFirewallDomainListRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateFirewallDomainListRequest * CreateFirewallDomainListResponse::request() const
{
    Q_D(const CreateFirewallDomainListResponse);
    return static_cast<const CreateFirewallDomainListRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver CreateFirewallDomainList \a response.
 */
void CreateFirewallDomainListResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateFirewallDomainListResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::CreateFirewallDomainListResponsePrivate
 * \brief The CreateFirewallDomainListResponsePrivate class provides private implementation for CreateFirewallDomainListResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a CreateFirewallDomainListResponsePrivate object with public implementation \a q.
 */
CreateFirewallDomainListResponsePrivate::CreateFirewallDomainListResponsePrivate(
    CreateFirewallDomainListResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver CreateFirewallDomainList response element from \a xml.
 */
void CreateFirewallDomainListResponsePrivate::parseCreateFirewallDomainListResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateFirewallDomainListResponse"));
    Q_UNUSED(xml) ///< @todo
}
