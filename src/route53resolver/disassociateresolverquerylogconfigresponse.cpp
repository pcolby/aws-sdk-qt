...
#include "disassociateresolverquerylogconfigresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::DisassociateResolverQueryLogConfigResponse
 * \brief The DisassociateResolverQueryLogConfigResponse class provides an interace for Route53Resolver DisassociateResolverQueryLogConfig responses.
 *
 ...
 *
 * \sa Route53ResolverClient::disassociateResolverQueryLogConfig
 */

/*!
 * Constructs a DisassociateResolverQueryLogConfigResponse object for \a reply to \a request, with parent \a parent.
 */
DisassociateResolverQueryLogConfigResponse::DisassociateResolverQueryLogConfigResponse(
        const DisassociateResolverQueryLogConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new DisassociateResolverQueryLogConfigResponsePrivate(this), parent)
{
    setRequest(new DisassociateResolverQueryLogConfigRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DisassociateResolverQueryLogConfigRequest * DisassociateResolverQueryLogConfigResponse::request() const
{
    Q_D(const DisassociateResolverQueryLogConfigResponse);
    return static_cast<const DisassociateResolverQueryLogConfigRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver DisassociateResolverQueryLogConfig \a response.
 */
void DisassociateResolverQueryLogConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DisassociateResolverQueryLogConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::DisassociateResolverQueryLogConfigResponsePrivate
 * \brief The DisassociateResolverQueryLogConfigResponsePrivate class provides private implementation for DisassociateResolverQueryLogConfigResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a DisassociateResolverQueryLogConfigResponsePrivate object with public implementation \a q.
 */
DisassociateResolverQueryLogConfigResponsePrivate::DisassociateResolverQueryLogConfigResponsePrivate(
    DisassociateResolverQueryLogConfigResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver DisassociateResolverQueryLogConfig response element from \a xml.
 */
void DisassociateResolverQueryLogConfigResponsePrivate::parseDisassociateResolverQueryLogConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DisassociateResolverQueryLogConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
