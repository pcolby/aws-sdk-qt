...
#include "createfirewallrulerequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::CreateFirewallRuleRequest
 * \brief The CreateFirewallRuleRequest class provides an interface for Route53Resolver CreateFirewallRule requests.
 *
 ...
 */
CreateFirewallRuleRequest::CreateFirewallRuleRequest(const CreateFirewallRuleRequest &other)
    : Route53ResolverRequest(new CreateFirewallRuleRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateFirewallRuleRequest object.
 */
CreateFirewallRuleRequest::CreateFirewallRuleRequest()
    : Route53ResolverRequest(new CreateFirewallRuleRequestPrivate(Route53ResolverRequest::CreateFirewallRuleAction, this))
{
 ...
 * \reimp
 */
bool CreateFirewallRuleRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateFirewallRuleResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateFirewallRuleRequest::response(QNetworkReply * const reply) const
{
    return new CreateFirewallRuleResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::CreateFirewallRuleRequestPrivate
 * \brief The CreateFirewallRuleRequestPrivate class provides private implementation for CreateFirewallRuleRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a CreateFirewallRuleRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
CreateFirewallRuleRequestPrivate::CreateFirewallRuleRequestPrivate(
    const Route53ResolverRequest::Action action, CreateFirewallRuleRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateFirewallRuleRequest
 * class' copy constructor.
 */
CreateFirewallRuleRequestPrivate::CreateFirewallRuleRequestPrivate(
    const CreateFirewallRuleRequestPrivate &other, CreateFirewallRuleRequest * const q)
