...
#include "getresolverrulepolicyrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::GetResolverRulePolicyRequest
 * \brief The GetResolverRulePolicyRequest class provides an interface for Route53Resolver GetResolverRulePolicy requests.
 *
 ...
 */
GetResolverRulePolicyRequest::GetResolverRulePolicyRequest(const GetResolverRulePolicyRequest &other)
    : Route53ResolverRequest(new GetResolverRulePolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetResolverRulePolicyRequest object.
 */
GetResolverRulePolicyRequest::GetResolverRulePolicyRequest()
    : Route53ResolverRequest(new GetResolverRulePolicyRequestPrivate(Route53ResolverRequest::GetResolverRulePolicyAction, this))
{
 ...
 * \reimp
 */
bool GetResolverRulePolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetResolverRulePolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetResolverRulePolicyRequest::response(QNetworkReply * const reply) const
{
    return new GetResolverRulePolicyResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::GetResolverRulePolicyRequestPrivate
 * \brief The GetResolverRulePolicyRequestPrivate class provides private implementation for GetResolverRulePolicyRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a GetResolverRulePolicyRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
GetResolverRulePolicyRequestPrivate::GetResolverRulePolicyRequestPrivate(
    const Route53ResolverRequest::Action action, GetResolverRulePolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetResolverRulePolicyRequest
 * class' copy constructor.
 */
GetResolverRulePolicyRequestPrivate::GetResolverRulePolicyRequestPrivate(
    const GetResolverRulePolicyRequestPrivate &other, GetResolverRulePolicyRequest * const q)
