...
#include "listresolverquerylogconfigassociationsresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ListResolverQueryLogConfigAssociationsResponse
 * \brief The ListResolverQueryLogConfigAssociationsResponse class provides an interace for Route53Resolver ListResolverQueryLogConfigAssociations responses.
 *
...
/*!
 * Constructs a ListResolverQueryLogConfigAssociationsResponse object for \a reply to \a request, with parent \a parent.
 */
ListResolverQueryLogConfigAssociationsResponse::ListResolverQueryLogConfigAssociationsResponse(
        const ListResolverQueryLogConfigAssociationsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new ListResolverQueryLogConfigAssociationsResponsePrivate(this), parent)
{
    setRequest(new ListResolverQueryLogConfigAssociationsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver ListResolverQueryLogConfigAssociations \a response.
 */
void ListResolverQueryLogConfigAssociationsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListResolverQueryLogConfigAssociationsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::ListResolverQueryLogConfigAssociationsResponsePrivate
 * \brief The ListResolverQueryLogConfigAssociationsResponsePrivate class provides private implementation for ListResolverQueryLogConfigAssociationsResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ListResolverQueryLogConfigAssociationsResponsePrivate object with public implementation \a q.
 */
ListResolverQueryLogConfigAssociationsResponsePrivate::ListResolverQueryLogConfigAssociationsResponsePrivate(
    ListResolverQueryLogConfigAssociationsResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver ListResolverQueryLogConfigAssociations response element from \a xml.
 */
void ListResolverQueryLogConfigAssociationsResponsePrivate::parseListResolverQueryLogConfigAssociationsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListResolverQueryLogConfigAssociationsResponse"));
    Q_UNUSED(xml) ///< @todo
}
