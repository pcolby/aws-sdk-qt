...
#include "getfirewallrulegrouppolicyresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::GetFirewallRuleGroupPolicyResponse
 * \brief The GetFirewallRuleGroupPolicyResponse class provides an interace for Route53Resolver GetFirewallRuleGroupPolicy responses.
 *
...
/*!
 * Constructs a GetFirewallRuleGroupPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
GetFirewallRuleGroupPolicyResponse::GetFirewallRuleGroupPolicyResponse(
        const GetFirewallRuleGroupPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new GetFirewallRuleGroupPolicyResponsePrivate(this), parent)
{
    setRequest(new GetFirewallRuleGroupPolicyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Route53Resolver GetFirewallRuleGroupPolicy \a response.
 */
void GetFirewallRuleGroupPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetFirewallRuleGroupPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::GetFirewallRuleGroupPolicyResponsePrivate
 * \brief The GetFirewallRuleGroupPolicyResponsePrivate class provides private implementation for GetFirewallRuleGroupPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a GetFirewallRuleGroupPolicyResponsePrivate object with public implementation \a q.
 */
GetFirewallRuleGroupPolicyResponsePrivate::GetFirewallRuleGroupPolicyResponsePrivate(
    GetFirewallRuleGroupPolicyResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver GetFirewallRuleGroupPolicy response element from \a xml.
 */
void GetFirewallRuleGroupPolicyResponsePrivate::parseGetFirewallRuleGroupPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetFirewallRuleGroupPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
