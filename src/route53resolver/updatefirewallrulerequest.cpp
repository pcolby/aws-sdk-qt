...
#include "updatefirewallrulerequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::UpdateFirewallRuleRequest
 * \brief The UpdateFirewallRuleRequest class provides an interface for Route53Resolver UpdateFirewallRule requests.
 *
 ...
 */
UpdateFirewallRuleRequest::UpdateFirewallRuleRequest(const UpdateFirewallRuleRequest &other)
    : Route53ResolverRequest(new UpdateFirewallRuleRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateFirewallRuleRequest object.
 */
UpdateFirewallRuleRequest::UpdateFirewallRuleRequest()
    : Route53ResolverRequest(new UpdateFirewallRuleRequestPrivate(Route53ResolverRequest::UpdateFirewallRuleAction, this))
{
 ...
 * \reimp
 */
bool UpdateFirewallRuleRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateFirewallRuleResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateFirewallRuleRequest::response(QNetworkReply * const reply) const
{
    return new UpdateFirewallRuleResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::UpdateFirewallRuleRequestPrivate
 * \brief The UpdateFirewallRuleRequestPrivate class provides private implementation for UpdateFirewallRuleRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a UpdateFirewallRuleRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
UpdateFirewallRuleRequestPrivate::UpdateFirewallRuleRequestPrivate(
    const Route53ResolverRequest::Action action, UpdateFirewallRuleRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateFirewallRuleRequest
 * class' copy constructor.
 */
UpdateFirewallRuleRequestPrivate::UpdateFirewallRuleRequestPrivate(
    const UpdateFirewallRuleRequestPrivate &other, UpdateFirewallRuleRequest * const q)
