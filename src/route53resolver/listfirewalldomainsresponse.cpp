...
#include "listfirewalldomainsresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ListFirewallDomainsResponse
 * \brief The ListFirewallDomainsResponse class provides an interace for Route53Resolver ListFirewallDomains responses.
 *
...
/*!
 * Constructs a ListFirewallDomainsResponse object for \a reply to \a request, with parent \a parent.
 */
ListFirewallDomainsResponse::ListFirewallDomainsResponse(
        const ListFirewallDomainsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new ListFirewallDomainsResponsePrivate(this), parent)
{
    setRequest(new ListFirewallDomainsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListFirewallDomainsRequest * ListFirewallDomainsResponse::request() const
{
    Q_D(const ListFirewallDomainsResponse);
    return static_cast<const ListFirewallDomainsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver ListFirewallDomains \a response.
 */
void ListFirewallDomainsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListFirewallDomainsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::ListFirewallDomainsResponsePrivate
 * \brief The ListFirewallDomainsResponsePrivate class provides private implementation for ListFirewallDomainsResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ListFirewallDomainsResponsePrivate object with public implementation \a q.
 */
ListFirewallDomainsResponsePrivate::ListFirewallDomainsResponsePrivate(
    ListFirewallDomainsResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver ListFirewallDomains response element from \a xml.
 */
void ListFirewallDomainsResponsePrivate::parseListFirewallDomainsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListFirewallDomainsResponse"));
    Q_UNUSED(xml) ///< @todo
}
