...
#include "getfirewallrulegroupresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::GetFirewallRuleGroupResponse
 * \brief The GetFirewallRuleGroupResponse class provides an interace for Route53Resolver GetFirewallRuleGroup responses.
 *
 ...
 *
 * \sa Route53ResolverClient::getFirewallRuleGroup
 */

/*!
 * Constructs a GetFirewallRuleGroupResponse object for \a reply to \a request, with parent \a parent.
 */
GetFirewallRuleGroupResponse::GetFirewallRuleGroupResponse(
        const GetFirewallRuleGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new GetFirewallRuleGroupResponsePrivate(this), parent)
{
    setRequest(new GetFirewallRuleGroupRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetFirewallRuleGroupRequest * GetFirewallRuleGroupResponse::request() const
{
    Q_D(const GetFirewallRuleGroupResponse);
    return static_cast<const GetFirewallRuleGroupRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver GetFirewallRuleGroup \a response.
 */
void GetFirewallRuleGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetFirewallRuleGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::GetFirewallRuleGroupResponsePrivate
 * \brief The GetFirewallRuleGroupResponsePrivate class provides private implementation for GetFirewallRuleGroupResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a GetFirewallRuleGroupResponsePrivate object with public implementation \a q.
 */
GetFirewallRuleGroupResponsePrivate::GetFirewallRuleGroupResponsePrivate(
    GetFirewallRuleGroupResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver GetFirewallRuleGroup response element from \a xml.
 */
void GetFirewallRuleGroupResponsePrivate::parseGetFirewallRuleGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetFirewallRuleGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
