...
#include "listresolverconfigsrequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ListResolverConfigsRequest
 * \brief The ListResolverConfigsRequest class provides an interface for Route53Resolver ListResolverConfigs requests.
 *
 ...
 */
ListResolverConfigsRequest::ListResolverConfigsRequest(const ListResolverConfigsRequest &other)
    : Route53ResolverRequest(new ListResolverConfigsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListResolverConfigsRequest object.
 */
ListResolverConfigsRequest::ListResolverConfigsRequest()
    : Route53ResolverRequest(new ListResolverConfigsRequestPrivate(Route53ResolverRequest::ListResolverConfigsAction, this))
{
 ...
 * \reimp
 */
bool ListResolverConfigsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListResolverConfigsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListResolverConfigsRequest::response(QNetworkReply * const reply) const
{
    return new ListResolverConfigsResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::ListResolverConfigsRequestPrivate
 * \brief The ListResolverConfigsRequestPrivate class provides private implementation for ListResolverConfigsRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ListResolverConfigsRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
ListResolverConfigsRequestPrivate::ListResolverConfigsRequestPrivate(
    const Route53ResolverRequest::Action action, ListResolverConfigsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListResolverConfigsRequest
 * class' copy constructor.
 */
ListResolverConfigsRequestPrivate::ListResolverConfigsRequestPrivate(
    const ListResolverConfigsRequestPrivate &other, ListResolverConfigsRequest * const q)
