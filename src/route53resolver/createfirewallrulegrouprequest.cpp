...
#include "createfirewallrulegrouprequest_p.h"
...
/*!
 * \class QtAws::Route53Resolver::CreateFirewallRuleGroupRequest
 * \brief The CreateFirewallRuleGroupRequest class provides an interface for Route53Resolver CreateFirewallRuleGroup requests.
 *
 ...
 */
CreateFirewallRuleGroupRequest::CreateFirewallRuleGroupRequest(const CreateFirewallRuleGroupRequest &other)
    : Route53ResolverRequest(new CreateFirewallRuleGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateFirewallRuleGroupRequest object.
 */
CreateFirewallRuleGroupRequest::CreateFirewallRuleGroupRequest()
    : Route53ResolverRequest(new CreateFirewallRuleGroupRequestPrivate(Route53ResolverRequest::CreateFirewallRuleGroupAction, this))
{
 ...
 * \reimp
 */
bool CreateFirewallRuleGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateFirewallRuleGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateFirewallRuleGroupRequest::response(QNetworkReply * const reply) const
{
    return new CreateFirewallRuleGroupResponse(*this, reply);
}

/*!
 * \class QtAws::Route53Resolver::CreateFirewallRuleGroupRequestPrivate
 * \brief The CreateFirewallRuleGroupRequestPrivate class provides private implementation for CreateFirewallRuleGroupRequest.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a CreateFirewallRuleGroupRequestPrivate object for Route53Resolver \a action,
 * with public implementation \a q.
 */
CreateFirewallRuleGroupRequestPrivate::CreateFirewallRuleGroupRequestPrivate(
    const Route53ResolverRequest::Action action, CreateFirewallRuleGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateFirewallRuleGroupRequest
 * class' copy constructor.
 */
CreateFirewallRuleGroupRequestPrivate::CreateFirewallRuleGroupRequestPrivate(
    const CreateFirewallRuleGroupRequestPrivate &other, CreateFirewallRuleGroupRequest * const q)
