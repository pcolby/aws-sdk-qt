...
#include "listfirewallrulesresponse_p.h"
...
/*!
 * \class QtAws::Route53Resolver::ListFirewallRulesResponse
 * \brief The ListFirewallRulesResponse class provides an interace for Route53Resolver ListFirewallRules responses.
 *
...
/*!
 * Constructs a ListFirewallRulesResponse object for \a reply to \a request, with parent \a parent.
 */
ListFirewallRulesResponse::ListFirewallRulesResponse(
        const ListFirewallRulesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Route53ResolverResponse(new ListFirewallRulesResponsePrivate(this), parent)
{
    setRequest(new ListFirewallRulesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListFirewallRulesRequest * ListFirewallRulesResponse::request() const
{
    Q_D(const ListFirewallRulesResponse);
    return static_cast<const ListFirewallRulesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Route53Resolver ListFirewallRules \a response.
 */
void ListFirewallRulesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListFirewallRulesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Route53Resolver::ListFirewallRulesResponsePrivate
 * \brief The ListFirewallRulesResponsePrivate class provides private implementation for ListFirewallRulesResponse.
 * \internal
 *
 * \inmodule QtAwsRoute53Resolver
 */
...
/*!
 * Constructs a ListFirewallRulesResponsePrivate object with public implementation \a q.
 */
ListFirewallRulesResponsePrivate::ListFirewallRulesResponsePrivate(
    ListFirewallRulesResponse * const q) : Route53ResolverResponsePrivate(q)
{

}

/*!
 * Parses a Route53Resolver ListFirewallRules response element from \a xml.
 */
void ListFirewallRulesResponsePrivate::parseListFirewallRulesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListFirewallRulesResponse"));
    Q_UNUSED(xml) ///< @todo
}
