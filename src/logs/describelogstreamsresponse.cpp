 ...
 *
 * \brief The DescribeLogStreamsResponse class encapsulates CloudWatchLogs DescribeLogStreams responses.
 *
 ...
 *
 * \sa CloudWatchLogsClient::describeLogStreams
 */
...
{
    Q_D(DescribeLogStreamsResponse);
