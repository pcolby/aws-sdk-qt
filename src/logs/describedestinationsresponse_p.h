...
class QTAWS_EXPORT DescribeDestinationsResponsePrivate : public CloudWatchLogsResponsePrivate {
    Q_OBJECT

public:

    DescribeDestinationsResponsePrivate(DescribeDestinationsResponse * const q);
