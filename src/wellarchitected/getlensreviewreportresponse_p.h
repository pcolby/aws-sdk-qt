...
class QTAWS_EXPORT GetLensReviewReportResponsePrivate : public WellArchitectedResponsePrivate {

public:

    GetLensReviewReportResponsePrivate(GetLensReviewReportResponse * const q);
