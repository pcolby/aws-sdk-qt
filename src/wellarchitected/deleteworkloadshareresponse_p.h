...
class QTAWS_EXPORT DeleteWorkloadShareResponsePrivate : public WellArchitectedResponsePrivate {

public:

    DeleteWorkloadShareResponsePrivate(DeleteWorkloadShareResponse * const q);
