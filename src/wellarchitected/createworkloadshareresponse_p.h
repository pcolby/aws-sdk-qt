...
class QTAWS_EXPORT CreateWorkloadShareResponsePrivate : public WellArchitectedResponsePrivate {

public:

    CreateWorkloadShareResponsePrivate(CreateWorkloadShareResponse * const q);
