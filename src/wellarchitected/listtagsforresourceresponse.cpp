...
/*!
 * \class QtAws::WellArchitected::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for WellArchitected ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : WellArchitectedResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WellArchitected ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::WellArchitected::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : WellArchitectedResponsePrivate(q)
{

}

/*!
 * Parses a WellArchitected ListTagsForResource response element from \a xml.
 */
