...
class QTAWS_EXPORT ListWorkloadSharesResponsePrivate : public WellArchitectedResponsePrivate {

public:

    ListWorkloadSharesResponsePrivate(ListWorkloadSharesResponse * const q);
