...
/*!
 * \class QtAws::MediaStore::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for MediaStore ListTagsForResource responses.
 *
 ...
 *
 * \sa MediaStoreClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : MediaStoreResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(MediaStoreResponse::request());
}

/*!
 * \reimp
 * Parses a successful MediaStore ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::MediaStore::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : MediaStoreResponsePrivate(q)
{

}

/*!
 * Parses a MediaStore ListTagsForResource response element from \a xml.
 */
