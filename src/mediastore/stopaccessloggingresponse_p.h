...
class QTAWS_EXPORT StopAccessLoggingResponsePrivate : public MediaStoreResponsePrivate {

public:

    StopAccessLoggingResponsePrivate(StopAccessLoggingResponse * const q);
