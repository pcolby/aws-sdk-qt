...
class QTAWS_EXPORT DescribeContainerResponsePrivate : public MediaStoreResponsePrivate {

public:

    DescribeContainerResponsePrivate(DescribeContainerResponse * const q);
