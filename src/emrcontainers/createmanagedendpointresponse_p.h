...
class QTAWS_EXPORT CreateManagedEndpointResponsePrivate : public EMRContainersResponsePrivate {

public:

    CreateManagedEndpointResponsePrivate(CreateManagedEndpointResponse * const q);
