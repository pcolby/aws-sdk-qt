...
#include "describemanagedendpointresponse_p.h"
...
/*!
 * Constructs a DescribeManagedEndpointResponse object for \a reply to \a request, with parent \a parent.
 */
...
{
    //Q_D(DescribeManagedEndpointResponse);
...
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeManagedEndpointResponse"));
    Q_UNUSED(xml) ///< @todo
}
