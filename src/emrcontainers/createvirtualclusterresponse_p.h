...
class QTAWS_EXPORT CreateVirtualClusterResponsePrivate : public EMRContainersResponsePrivate {

public:

    CreateVirtualClusterResponsePrivate(CreateVirtualClusterResponse * const q);
