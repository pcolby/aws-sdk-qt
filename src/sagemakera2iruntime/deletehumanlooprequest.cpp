...
/*!
 * \class QtAws::SageMakerA2IRuntime::DeleteHumanLoopRequest
 * \brief The DeleteHumanLoopRequest class provides an interface for SageMakerA2IRuntime DeleteHumanLoop requests.
 *
...
DeleteHumanLoopRequest::DeleteHumanLoopRequest(const DeleteHumanLoopRequest &other)
    : SageMakerA2IRuntimeRequest(new DeleteHumanLoopRequestPrivate(*other.d_func(), this))
{
...
DeleteHumanLoopRequest::DeleteHumanLoopRequest()
    : SageMakerA2IRuntimeRequest(new DeleteHumanLoopRequestPrivate(SageMakerA2IRuntimeRequest::DeleteHumanLoopAction, this))
{
...
/*!
 * \class QtAws::SageMakerA2IRuntime::DeleteHumanLoopRequestPrivate
...
/*!
 * Constructs a DeleteHumanLoopRequestPrivate object for SageMakerA2IRuntime \a action,
 * with public implementation \a q.
 */
DeleteHumanLoopRequestPrivate::DeleteHumanLoopRequestPrivate(
    const SageMakerA2IRuntimeRequest::Action action, DeleteHumanLoopRequest * const q)
