...
class QTAWS_EXPORT ListBucketAnalyticsConfigurationsRequestPrivate : public S3Private {

public:
    ListBucketAnalyticsConfigurationsRequestPrivate(const S3::Action action,
