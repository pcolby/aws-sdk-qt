...
class QTAWS_EXPORT GetBucketAccelerateConfigurationResponse : public S3Response {
    Q_OBJECT
...
public:
    ...
    virtual const GetBucketAccelerateConfigurationRequest * request() const override;
