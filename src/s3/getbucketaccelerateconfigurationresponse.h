...
class QTAWS_EXPORT GetBucketAccelerateConfigurationResponse : public GetBucketAccelerateConfigurationResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetBucketAccelerateConfigurationRequest * request() const;
