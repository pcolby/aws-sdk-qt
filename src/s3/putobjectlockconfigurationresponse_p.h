...
class QTAWS_EXPORT PutObjectLockConfigurationResponsePrivate : public S3ResponsePrivate {

public:

    PutObjectLockConfigurationResponsePrivate(PutObjectLockConfigurationResponse * const q);
