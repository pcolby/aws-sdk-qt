...
class QTAWS_EXPORT GetBucketPolicyStatusResponsePrivate : public S3ResponsePrivate {

public:

    GetBucketPolicyStatusResponsePrivate(GetBucketPolicyStatusResponse * const q);
