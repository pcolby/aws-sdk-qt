...
QString S3RequestPrivate::toString(const S3Request::Action &action)
{
    ...
    switch (action) {
        ...
        ActionToString(CopyObject);
        ActionToString(CreateBucket);
        ActionToString(CreateMultipartUpload);
        ActionToString(DeleteBucket);
        ActionToString(DeleteBucketAnalyticsConfiguration);
        ActionToString(DeleteBucketCors);
        ActionToString(DeleteBucketEncryption);
        ActionToString(DeleteBucketIntelligentTieringConfiguration);
        ActionToString(DeleteBucketInventoryConfiguration);
        ActionToString(DeleteBucketLifecycle);
        ActionToString(DeleteBucketMetricsConfiguration);
        ActionToString(DeleteBucketOwnershipControls);
        ActionToString(DeleteBucketPolicy);
        ActionToString(DeleteBucketReplication);
        ActionToString(DeleteBucketTagging);
        ActionToString(DeleteBucketWebsite);
        ActionToString(DeleteObject);
        ActionToString(DeleteObjectTagging);
        ActionToString(DeleteObjects);
        ActionToString(DeletePublicAccessBlock);
        ActionToString(GetBucketAccelerateConfiguration);
        ActionToString(GetBucketAcl);
        ActionToString(GetBucketAnalyticsConfiguration);
        ActionToString(GetBucketCors);
        ...
        ActionToString(GetBucketPolicyStatus);
        ActionToString(GetBucketReplication);
        ActionToString(GetBucketRequestPayment);
        ...
        ActionToString(GetObjectTagging);
        ActionToString(GetObjectTorrent);
        ActionToString(GetPublicAccessBlock);
        ActionToString(HeadBucket);
        ActionToString(HeadObject);
        ActionToString(ListBucketAnalyticsConfigurations);
        ActionToString(ListBucketIntelligentTieringConfigurations);
        ActionToString(ListBucketInventoryConfigurations);
        ActionToString(ListBucketMetricsConfigurations);
        ActionToString(ListBuckets);
        ActionToString(ListMultipartUploads);
        ActionToString(ListObjectVersions);
        ActionToString(ListObjects);
        ActionToString(ListObjectsV2);
        ActionToString(ListParts);
        ActionToString(PutBucketAccelerateConfiguration);
        ActionToString(PutBucketAcl);
        ActionToString(PutBucketAnalyticsConfiguration);
        ActionToString(PutBucketCors);
        ...
        ActionToString(PutBucketReplication);
        ActionToString(PutBucketRequestPayment);
        ActionToString(PutBucketTagging);
        ActionToString(PutBucketVersioning);
        ActionToString(PutBucketWebsite);
        ActionToString(PutObject);
        ActionToString(PutObjectAcl);
        ActionToString(PutObjectLegalHold);
        ActionToString(PutObjectLockConfiguration);
        ActionToString(PutObjectRetention);
        ActionToString(PutObjectTagging);
        ActionToString(PutPublicAccessBlock);
        ActionToString(RestoreObject);
        ActionToString(SelectObjectContent);
        ActionToString(UploadPart);
        ActionToString(UploadPartCopy);
        ActionToString(WriteGetObjectResponse);
        default:
