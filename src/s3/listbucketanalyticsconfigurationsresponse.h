...
class QTAWS_EXPORT ListBucketAnalyticsConfigurationsResponse : public S3Response {
    Q_OBJECT
...
public:
    ...
    virtual const ListBucketAnalyticsConfigurationsRequest * request() const override;
