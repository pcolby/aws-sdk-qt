...
class QTAWS_EXPORT PutBucketAnalyticsConfigurationResponse : public S3Response {
    Q_OBJECT
...
public:
    ...
    virtual const PutBucketAnalyticsConfigurationRequest * request() const override;
