...
class QTAWS_EXPORT PutBucketAnalyticsConfigurationResponse : public PutBucketAnalyticsConfigurationResponse {
    Q_OBJECT
...
public:
    ...
    virtual const PutBucketAnalyticsConfigurationRequest * request() const;
