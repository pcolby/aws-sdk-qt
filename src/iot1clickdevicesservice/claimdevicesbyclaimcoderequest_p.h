...
class QTAWS_EXPORT ClaimDevicesByClaimCodeRequestPrivate : public IoT1ClickDevicesServiceRequestPrivate {

public:
    ClaimDevicesByClaimCodeRequestPrivate(const IoT1ClickDevicesServiceRequest::Action action,
