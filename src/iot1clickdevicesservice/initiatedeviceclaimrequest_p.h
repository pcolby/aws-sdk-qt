...
class QTAWS_EXPORT InitiateDeviceClaimRequestPrivate : public IoT1ClickDevicesServiceRequestPrivate {

public:
    InitiateDeviceClaimRequestPrivate(const IoT1ClickDevicesServiceRequest::Action action,
