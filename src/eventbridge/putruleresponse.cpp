...
/*!
 * \class QtAws::EventBridge::PutRuleResponse
 * \brief The PutRuleResponse class provides an interace for EventBridge PutRule responses.
 *
...
PutRuleResponse::PutRuleResponse(
    ...
    : EventBridgeResponse(new PutRuleResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful EventBridge PutRule \a response.
 */
...
/*!
 * \class QtAws::EventBridge::PutRuleResponsePrivate
...
PutRuleResponsePrivate::PutRuleResponsePrivate(
    PutRuleResponse * const q) : EventBridgeResponsePrivate(q)
{

}

/*!
 * Parses a EventBridge PutRule response element from \a xml.
 */
