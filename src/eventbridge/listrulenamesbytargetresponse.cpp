...
/*!
 * \class QtAws::EventBridge::ListRuleNamesByTargetResponse
 * \brief The ListRuleNamesByTargetResponse class provides an interace for EventBridge ListRuleNamesByTarget responses.
 *
...
ListRuleNamesByTargetResponse::ListRuleNamesByTargetResponse(
    ...
    : EventBridgeResponse(new ListRuleNamesByTargetResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful EventBridge ListRuleNamesByTarget \a response.
 */
...
/*!
 * \class QtAws::EventBridge::ListRuleNamesByTargetResponsePrivate
...
ListRuleNamesByTargetResponsePrivate::ListRuleNamesByTargetResponsePrivate(
    ListRuleNamesByTargetResponse * const q) : EventBridgeResponsePrivate(q)
{

}

/*!
 * Parses a EventBridge ListRuleNamesByTarget response element from \a xml.
 */
