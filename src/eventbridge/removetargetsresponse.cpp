...
/*!
 * \class QtAws::EventBridge::RemoveTargetsResponse
 * \brief The RemoveTargetsResponse class provides an interace for EventBridge RemoveTargets responses.
 *
...
RemoveTargetsResponse::RemoveTargetsResponse(
    ...
    : EventBridgeResponse(new RemoveTargetsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful EventBridge RemoveTargets \a response.
 */
...
/*!
 * \class QtAws::EventBridge::RemoveTargetsResponsePrivate
...
RemoveTargetsResponsePrivate::RemoveTargetsResponsePrivate(
    RemoveTargetsResponse * const q) : EventBridgeResponsePrivate(q)
{

}

/*!
 * Parses a EventBridge RemoveTargets response element from \a xml.
 */
