...
/*!
 * \class QtAws::EventBridge::TestEventPatternResponse
 * \brief The TestEventPatternResponse class provides an interace for EventBridge TestEventPattern responses.
 *
...
TestEventPatternResponse::TestEventPatternResponse(
    ...
    : EventBridgeResponse(new TestEventPatternResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful EventBridge TestEventPattern \a response.
 */
...
/*!
 * \class QtAws::EventBridge::TestEventPatternResponsePrivate
...
TestEventPatternResponsePrivate::TestEventPatternResponsePrivate(
    TestEventPatternResponse * const q) : EventBridgeResponsePrivate(q)
{

}

/*!
 * Parses a EventBridge TestEventPattern response element from \a xml.
 */
