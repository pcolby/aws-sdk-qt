...
/*!
 * \class QtAws::EventBridge::EnableRuleResponse
 * \brief The EnableRuleResponse class provides an interace for EventBridge EnableRule responses.
 *
...
EnableRuleResponse::EnableRuleResponse(
    ...
    : EventBridgeResponse(new EnableRuleResponsePrivate(this), parent)
{
...
{
    return static_cast<const EnableRuleRequest *>(EventBridgeResponse::request());
}

/*!
 * \reimp
 * Parses a successful EventBridge EnableRule \a response.
 */
...
/*!
 * \class QtAws::EventBridge::EnableRuleResponsePrivate
...
EnableRuleResponsePrivate::EnableRuleResponsePrivate(
    EnableRuleResponse * const q) : EventBridgeResponsePrivate(q)
{

}

/*!
 * Parses a EventBridge EnableRule response element from \a xml.
 */
