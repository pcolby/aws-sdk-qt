...
/*!
 * \class QtAws::EventBridge::ListPartnerEventSourcesRequest
 * \brief The ListPartnerEventSourcesRequest class provides an interface for EventBridge ListPartnerEventSources requests.
 *
...
ListPartnerEventSourcesRequest::ListPartnerEventSourcesRequest(const ListPartnerEventSourcesRequest &other)
    : EventBridgeRequest(new ListPartnerEventSourcesRequestPrivate(*other.d_func(), this))
{
...
ListPartnerEventSourcesRequest::ListPartnerEventSourcesRequest()
    : EventBridgeRequest(new ListPartnerEventSourcesRequestPrivate(EventBridgeRequest::ListPartnerEventSourcesAction, this))
{
...
/*!
 * \class QtAws::EventBridge::ListPartnerEventSourcesRequestPrivate
...
/*!
 * Constructs a ListPartnerEventSourcesRequestPrivate object for EventBridge \a action,
 * with public implementation \a q.
 */
ListPartnerEventSourcesRequestPrivate::ListPartnerEventSourcesRequestPrivate(
    const EventBridgeRequest::Action action, ListPartnerEventSourcesRequest * const q)
