...
/*!
 * \class QtAws::EventBridge::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for EventBridge ListTagsForResource responses.
 *
 ...
 *
 * \sa EventBridgeClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : EventBridgeResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(EventBridgeResponse::request());
}

/*!
 * \reimp
 * Parses a successful EventBridge ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::EventBridge::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : EventBridgeResponsePrivate(q)
{

}

/*!
 * Parses a EventBridge ListTagsForResource response element from \a xml.
 */
