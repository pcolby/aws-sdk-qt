...
/*!
 * \class QtAws::EventBridge::TestEventPatternRequest
 * \brief The TestEventPatternRequest class provides an interface for EventBridge TestEventPattern requests.
 *
 ...
 *
 * \sa EventBridgeClient::testEventPattern
 */
...
TestEventPatternRequest::TestEventPatternRequest(const TestEventPatternRequest &other)
    : EventBridgeRequest(new TestEventPatternRequestPrivate(*other.d_func(), this))
{
...
TestEventPatternRequest::TestEventPatternRequest()
    : EventBridgeRequest(new TestEventPatternRequestPrivate(EventBridgeRequest::TestEventPatternAction, this))
{
...
/*!
 * \class QtAws::EventBridge::TestEventPatternRequestPrivate
...
/*!
 * Constructs a TestEventPatternRequestPrivate object for EventBridge \a action,
 * with public implementation \a q.
 */
TestEventPatternRequestPrivate::TestEventPatternRequestPrivate(
    const EventBridgeRequest::Action action, TestEventPatternRequest * const q)
