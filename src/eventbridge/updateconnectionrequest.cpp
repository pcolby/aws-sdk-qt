...
/*!
 * \class QtAws::EventBridge::UpdateConnectionRequest
 * \brief The UpdateConnectionRequest class provides an interface for EventBridge UpdateConnection requests.
 *
...
UpdateConnectionRequest::UpdateConnectionRequest(const UpdateConnectionRequest &other)
    : EventBridgeRequest(new UpdateConnectionRequestPrivate(*other.d_func(), this))
{
...
UpdateConnectionRequest::UpdateConnectionRequest()
    : EventBridgeRequest(new UpdateConnectionRequestPrivate(EventBridgeRequest::UpdateConnectionAction, this))
{
...
/*!
 * \class QtAws::EventBridge::UpdateConnectionRequestPrivate
...
/*!
 * Constructs a UpdateConnectionRequestPrivate object for EventBridge \a action,
 * with public implementation \a q.
 */
UpdateConnectionRequestPrivate::UpdateConnectionRequestPrivate(
    const EventBridgeRequest::Action action, UpdateConnectionRequest * const q)
