...
/*!
 * \class QtAws::EventBridge::DeactivateEventSourceRequest
 * \brief The DeactivateEventSourceRequest class provides an interface for EventBridge DeactivateEventSource requests.
 *
 ...
 *
 * \sa EventBridgeClient::deactivateEventSource
 */
...
DeactivateEventSourceRequest::DeactivateEventSourceRequest(const DeactivateEventSourceRequest &other)
    : EventBridgeRequest(new DeactivateEventSourceRequestPrivate(*other.d_func(), this))
{
...
DeactivateEventSourceRequest::DeactivateEventSourceRequest()
    : EventBridgeRequest(new DeactivateEventSourceRequestPrivate(EventBridgeRequest::DeactivateEventSourceAction, this))
{
...
/*!
 * \class QtAws::EventBridge::DeactivateEventSourceRequestPrivate
...
/*!
 * Constructs a DeactivateEventSourceRequestPrivate object for EventBridge \a action,
 * with public implementation \a q.
 */
DeactivateEventSourceRequestPrivate::DeactivateEventSourceRequestPrivate(
    const EventBridgeRequest::Action action, DeactivateEventSourceRequest * const q)
