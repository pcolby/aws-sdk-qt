...
/*!
 * \class QtAws::EventBridge::DeleteConnectionRequest
 * \brief The DeleteConnectionRequest class provides an interface for EventBridge DeleteConnection requests.
 *
...
DeleteConnectionRequest::DeleteConnectionRequest(const DeleteConnectionRequest &other)
    : EventBridgeRequest(new DeleteConnectionRequestPrivate(*other.d_func(), this))
{
...
DeleteConnectionRequest::DeleteConnectionRequest()
    : EventBridgeRequest(new DeleteConnectionRequestPrivate(EventBridgeRequest::DeleteConnectionAction, this))
{
...
/*!
 * \class QtAws::EventBridge::DeleteConnectionRequestPrivate
...
/*!
 * Constructs a DeleteConnectionRequestPrivate object for EventBridge \a action,
 * with public implementation \a q.
 */
DeleteConnectionRequestPrivate::DeleteConnectionRequestPrivate(
    const EventBridgeRequest::Action action, DeleteConnectionRequest * const q)
