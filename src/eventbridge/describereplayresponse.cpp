...
/*!
 * \class QtAws::EventBridge::DescribeReplayResponse
 * \brief The DescribeReplayResponse class provides an interace for EventBridge DescribeReplay responses.
 *
...
DescribeReplayResponse::DescribeReplayResponse(
    ...
    : EventBridgeResponse(new DescribeReplayResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful EventBridge DescribeReplay \a response.
 */
...
/*!
 * \class QtAws::EventBridge::DescribeReplayResponsePrivate
...
DescribeReplayResponsePrivate::DescribeReplayResponsePrivate(
    DescribeReplayResponse * const q) : EventBridgeResponsePrivate(q)
{

}

/*!
 * Parses a EventBridge DescribeReplay response element from \a xml.
 */
