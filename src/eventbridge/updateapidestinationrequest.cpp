...
/*!
 * \class QtAws::EventBridge::UpdateApiDestinationRequest
 * \brief The UpdateApiDestinationRequest class provides an interface for EventBridge UpdateApiDestination requests.
 *
...
UpdateApiDestinationRequest::UpdateApiDestinationRequest(const UpdateApiDestinationRequest &other)
    : EventBridgeRequest(new UpdateApiDestinationRequestPrivate(*other.d_func(), this))
{
...
UpdateApiDestinationRequest::UpdateApiDestinationRequest()
    : EventBridgeRequest(new UpdateApiDestinationRequestPrivate(EventBridgeRequest::UpdateApiDestinationAction, this))
{
...
/*!
 * \class QtAws::EventBridge::UpdateApiDestinationRequestPrivate
...
/*!
 * Constructs a UpdateApiDestinationRequestPrivate object for EventBridge \a action,
 * with public implementation \a q.
 */
UpdateApiDestinationRequestPrivate::UpdateApiDestinationRequestPrivate(
    const EventBridgeRequest::Action action, UpdateApiDestinationRequest * const q)
