...
/*!
 * \class QtAws::EventBridge::ActivateEventSourceRequest
 * \brief The ActivateEventSourceRequest class provides an interface for EventBridge ActivateEventSource requests.
 *
...
ActivateEventSourceRequest::ActivateEventSourceRequest(const ActivateEventSourceRequest &other)
    : EventBridgeRequest(new ActivateEventSourceRequestPrivate(*other.d_func(), this))
{
...
ActivateEventSourceRequest::ActivateEventSourceRequest()
    : EventBridgeRequest(new ActivateEventSourceRequestPrivate(EventBridgeRequest::ActivateEventSourceAction, this))
{
...
/*!
 * \class QtAws::EventBridge::ActivateEventSourceRequestPrivate
...
/*!
 * Constructs a ActivateEventSourceRequestPrivate object for EventBridge \a action,
 * with public implementation \a q.
 */
ActivateEventSourceRequestPrivate::ActivateEventSourceRequestPrivate(
    const EventBridgeRequest::Action action, ActivateEventSourceRequest * const q)
