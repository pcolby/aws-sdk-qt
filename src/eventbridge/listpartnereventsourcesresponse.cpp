...
/*!
 * \class QtAws::EventBridge::ListPartnerEventSourcesResponse
 * \brief The ListPartnerEventSourcesResponse class provides an interace for EventBridge ListPartnerEventSources responses.
 *
 ...
 *
 * \sa EventBridgeClient::listPartnerEventSources
 */
...
ListPartnerEventSourcesResponse::ListPartnerEventSourcesResponse(
    ...
    : EventBridgeResponse(new ListPartnerEventSourcesResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListPartnerEventSourcesRequest *>(EventBridgeResponse::request());
}

/*!
 * \reimp
 * Parses a successful EventBridge ListPartnerEventSources \a response.
 */
...
/*!
 * \class QtAws::EventBridge::ListPartnerEventSourcesResponsePrivate
...
ListPartnerEventSourcesResponsePrivate::ListPartnerEventSourcesResponsePrivate(
    ListPartnerEventSourcesResponse * const q) : EventBridgeResponsePrivate(q)
{

}

/*!
 * Parses a EventBridge ListPartnerEventSources response element from \a xml.
 */
