...
/*!
 * \class QtAws::EventBridge::DeleteEventBusRequest
 * \brief The DeleteEventBusRequest class provides an interface for EventBridge DeleteEventBus requests.
 *
...
DeleteEventBusRequest::DeleteEventBusRequest(const DeleteEventBusRequest &other)
    : EventBridgeRequest(new DeleteEventBusRequestPrivate(*other.d_func(), this))
{
...
DeleteEventBusRequest::DeleteEventBusRequest()
    : EventBridgeRequest(new DeleteEventBusRequestPrivate(EventBridgeRequest::DeleteEventBusAction, this))
{
...
/*!
 * \class QtAws::EventBridge::DeleteEventBusRequestPrivate
...
/*!
 * Constructs a DeleteEventBusRequestPrivate object for EventBridge \a action,
 * with public implementation \a q.
 */
DeleteEventBusRequestPrivate::DeleteEventBusRequestPrivate(
    const EventBridgeRequest::Action action, DeleteEventBusRequest * const q)
