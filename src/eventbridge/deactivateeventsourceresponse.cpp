...
/*!
 * \class QtAws::EventBridge::DeactivateEventSourceResponse
 * \brief The DeactivateEventSourceResponse class provides an interace for EventBridge DeactivateEventSource responses.
 *
...
DeactivateEventSourceResponse::DeactivateEventSourceResponse(
    ...
    : EventBridgeResponse(new DeactivateEventSourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful EventBridge DeactivateEventSource \a response.
 */
...
/*!
 * \class QtAws::EventBridge::DeactivateEventSourceResponsePrivate
...
DeactivateEventSourceResponsePrivate::DeactivateEventSourceResponsePrivate(
    DeactivateEventSourceResponse * const q) : EventBridgeResponsePrivate(q)
{

}

/*!
 * Parses a EventBridge DeactivateEventSource response element from \a xml.
 */
