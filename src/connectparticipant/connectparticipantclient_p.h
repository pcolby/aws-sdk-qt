...
class QTAWS_EXPORT ConnectParticipantClientPrivate : public QtAws::Core::AwsAbstractClientPrivate {

public:
    ConnectParticipantClientPrivate(ConnectParticipantClient * const q);
