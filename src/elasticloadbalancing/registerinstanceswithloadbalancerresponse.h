...
class QTAWS_EXPORT RegisterInstancesWithLoadBalancerResponse : public ElasticLoadBalancingResponse {
    Q_OBJECT
...
public:
    ...
    virtual const RegisterInstancesWithLoadBalancerRequest * request() const override;
