...
DescribeTagsResponse::DescribeTagsResponse(
    ...
    : ElasticLoadBalancingResponse(new DescribeTagsResponsePrivate(this), parent)
{
...
{
    return static_cast<const DescribeTagsRequest *>(ElasticLoadBalancingResponse::request());
}
