 ...
 *
 * @brief  Handles ElasticLoadBalancing AddTags responses.
 *
...
/**
 * @brief  Parse a ElasticLoadBalancing AddTags response.
 *
...
/**
 * @brief  Parse an ElasticLoadBalancing AddTagsResponse element.
 *
