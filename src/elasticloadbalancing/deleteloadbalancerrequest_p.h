...
class QTAWS_EXPORT DeleteLoadBalancerRequestPrivate : public ElasticLoadBalancingPrivate {

public:
    DeleteLoadBalancerRequestPrivate(const ElasticLoadBalancing::Action action,
