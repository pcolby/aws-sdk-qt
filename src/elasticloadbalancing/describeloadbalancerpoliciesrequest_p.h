...
class QTAWS_EXPORT DescribeLoadBalancerPoliciesRequestPrivate : public ElasticLoadBalancingRequestPrivate {

public:
    DescribeLoadBalancerPoliciesRequestPrivate(const ElasticLoadBalancing::Action action,
