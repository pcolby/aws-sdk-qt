...
class QTAWS_EXPORT DeleteLoadBalancerListenersRequestPrivate : public ElasticLoadBalancingRequestPrivate {

public:
    DeleteLoadBalancerListenersRequestPrivate(const ElasticLoadBalancing::Action action,
