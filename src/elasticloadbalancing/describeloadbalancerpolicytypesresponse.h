...
class QTAWSELASTICLOADBALANCING_EXPORT DescribeLoadBalancerPolicyTypesResponse : public ElasticLoadBalancingResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeLoadBalancerPolicyTypesRequest * request() const Q_DECL_OVERRIDE;
