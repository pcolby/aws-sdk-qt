...
class QTAWSELASTICLOADBALANCING_EXPORT AttachLoadBalancerToSubnetsResponse : public ElasticLoadBalancingResponse {
    Q_OBJECT
...
public:
    ...
    virtual const AttachLoadBalancerToSubnetsRequest * request() const Q_DECL_OVERRIDE;
