...
/*!
 * \class QtAws::ChimeSdkIdentity::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for ChimeSdkIdentity UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : ChimeSdkIdentityResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ChimeSdkIdentity UntagResource \a response.
 */
...
/*!
 * \class QtAws::ChimeSdkIdentity::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : ChimeSdkIdentityResponsePrivate(q)
{

}

/*!
 * Parses a ChimeSdkIdentity UntagResource response element from \a xml.
 */
