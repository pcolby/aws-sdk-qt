...
/*!
 * \class QtAws::ChimeSdkIdentity::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for ChimeSdkIdentity TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ChimeSdkIdentityResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ChimeSdkIdentity TagResource \a response.
 */
...
/*!
 * \class QtAws::ChimeSdkIdentity::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ChimeSdkIdentityResponsePrivate(q)
{

}

/*!
 * Parses a ChimeSdkIdentity TagResource response element from \a xml.
 */
