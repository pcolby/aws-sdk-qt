...
/*!
 * \class QtAws::GroundStation::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for GroundStation ListTagsForResource responses.
 *
 ...
 *
 * \sa GroundStationClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : GroundStationResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(GroundStationResponse::request());
}

/*!
 * \reimp
 * Parses a successful GroundStation ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::GroundStation::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : GroundStationResponsePrivate(q)
{

}

/*!
 * Parses a GroundStation ListTagsForResource response element from \a xml.
 */
