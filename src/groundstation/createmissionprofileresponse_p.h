...
class QTAWS_EXPORT CreateMissionProfileResponsePrivate : public GroundStationResponsePrivate {

public:

    CreateMissionProfileResponsePrivate(CreateMissionProfileResponse * const q);
