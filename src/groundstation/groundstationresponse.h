...
#ifndef QTAWS_GROUNDSTATIONRESPONSE_H
...
public:
    GroundStationResponse(QObject * const parent = 0);
...
private:
    Q_DECLARE_PRIVATE(GroundStationResponse)
    Q_DISABLE_COPY(GroundStationResponse)
