...
/*!
 * \class QtAws::GroundStation::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for GroundStation TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : GroundStationResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(GroundStationResponse::request());
}

/*!
 * \reimp
 * Parses a successful GroundStation TagResource \a response.
 */
...
/*!
 * \class QtAws::GroundStation::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : GroundStationResponsePrivate(q)
{

}

/*!
 * Parses a GroundStation TagResource response element from \a xml.
 */
