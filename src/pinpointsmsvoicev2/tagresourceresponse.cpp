...
/*!
 * \class QtAws::PinpointSmsVoiceV2::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for PinpointSmsVoiceV2 TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : PinpointSmsVoiceV2Response(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful PinpointSmsVoiceV2 TagResource \a response.
 */
...
/*!
 * \class QtAws::PinpointSmsVoiceV2::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : PinpointSmsVoiceV2ResponsePrivate(q)
{

}

/*!
 * Parses a PinpointSmsVoiceV2 TagResource response element from \a xml.
 */
