...
/*!
 * \class QtAws::PinpointSmsVoiceV2::DeleteConfigurationSetResponse
 * \brief The DeleteConfigurationSetResponse class provides an interace for PinpointSmsVoiceV2 DeleteConfigurationSet responses.
 *
...
DeleteConfigurationSetResponse::DeleteConfigurationSetResponse(
    ...
    : PinpointSmsVoiceV2Response(new DeleteConfigurationSetResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful PinpointSmsVoiceV2 DeleteConfigurationSet \a response.
 */
...
/*!
 * \class QtAws::PinpointSmsVoiceV2::DeleteConfigurationSetResponsePrivate
...
DeleteConfigurationSetResponsePrivate::DeleteConfigurationSetResponsePrivate(
    DeleteConfigurationSetResponse * const q) : PinpointSmsVoiceV2ResponsePrivate(q)
{

}

/*!
 * Parses a PinpointSmsVoiceV2 DeleteConfigurationSet response element from \a xml.
 */
