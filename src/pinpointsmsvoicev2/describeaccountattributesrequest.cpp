...
/*!
 * \class QtAws::PinpointSmsVoiceV2::DescribeAccountAttributesRequest
 * \brief The DescribeAccountAttributesRequest class provides an interface for PinpointSmsVoiceV2 DescribeAccountAttributes requests.
 *
...
DescribeAccountAttributesRequest::DescribeAccountAttributesRequest(const DescribeAccountAttributesRequest &other)
    : PinpointSmsVoiceV2Request(new DescribeAccountAttributesRequestPrivate(*other.d_func(), this))
{
...
DescribeAccountAttributesRequest::DescribeAccountAttributesRequest()
    : PinpointSmsVoiceV2Request(new DescribeAccountAttributesRequestPrivate(PinpointSmsVoiceV2Request::DescribeAccountAttributesAction, this))
{
...
/*!
 * \class QtAws::PinpointSmsVoiceV2::DescribeAccountAttributesRequestPrivate
...
/*!
 * Constructs a DescribeAccountAttributesRequestPrivate object for PinpointSmsVoiceV2 \a action,
 * with public implementation \a q.
 */
DescribeAccountAttributesRequestPrivate::DescribeAccountAttributesRequestPrivate(
    const PinpointSmsVoiceV2Request::Action action, DescribeAccountAttributesRequest * const q)
