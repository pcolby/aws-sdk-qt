...
#include "createslackchannelconfigurationresponse_p.h"
...
/*!
 * \class QtAws::SupportApp::CreateSlackChannelConfigurationResponse
 * \brief The CreateSlackChannelConfigurationResponse class provides an interace for SupportApp CreateSlackChannelConfiguration responses.
 *
...
/*!
 * Constructs a CreateSlackChannelConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
CreateSlackChannelConfigurationResponse::CreateSlackChannelConfigurationResponse(
        const CreateSlackChannelConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : SupportAppResponse(new CreateSlackChannelConfigurationResponsePrivate(this), parent)
{
    setRequest(new CreateSlackChannelConfigurationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateSlackChannelConfigurationRequest * CreateSlackChannelConfigurationResponse::request() const
{
    Q_D(const CreateSlackChannelConfigurationResponse);
    return static_cast<const CreateSlackChannelConfigurationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful SupportApp CreateSlackChannelConfiguration \a response.
 */
void CreateSlackChannelConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateSlackChannelConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::SupportApp::CreateSlackChannelConfigurationResponsePrivate
 * \brief The CreateSlackChannelConfigurationResponsePrivate class provides private implementation for CreateSlackChannelConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsSupportApp
 */
...
/*!
 * Constructs a CreateSlackChannelConfigurationResponsePrivate object with public implementation \a q.
 */
CreateSlackChannelConfigurationResponsePrivate::CreateSlackChannelConfigurationResponsePrivate(
    CreateSlackChannelConfigurationResponse * const q) : SupportAppResponsePrivate(q)
{

}

/*!
 * Parses a SupportApp CreateSlackChannelConfiguration response element from \a xml.
 */
void CreateSlackChannelConfigurationResponsePrivate::parseCreateSlackChannelConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateSlackChannelConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
