...
#include "updateslackchannelconfigurationrequest_p.h"
...
/*!
 * \class QtAws::SupportApp::UpdateSlackChannelConfigurationRequest
 * \brief The UpdateSlackChannelConfigurationRequest class provides an interface for SupportApp UpdateSlackChannelConfiguration requests.
 *
 ...
 */
UpdateSlackChannelConfigurationRequest::UpdateSlackChannelConfigurationRequest(const UpdateSlackChannelConfigurationRequest &other)
    : SupportAppRequest(new UpdateSlackChannelConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateSlackChannelConfigurationRequest object.
 */
UpdateSlackChannelConfigurationRequest::UpdateSlackChannelConfigurationRequest()
    : SupportAppRequest(new UpdateSlackChannelConfigurationRequestPrivate(SupportAppRequest::UpdateSlackChannelConfigurationAction, this))
{
 ...
 * \reimp
 */
bool UpdateSlackChannelConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateSlackChannelConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateSlackChannelConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new UpdateSlackChannelConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::SupportApp::UpdateSlackChannelConfigurationRequestPrivate
 * \brief The UpdateSlackChannelConfigurationRequestPrivate class provides private implementation for UpdateSlackChannelConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsSupportApp
 */
...
/*!
 * Constructs a UpdateSlackChannelConfigurationRequestPrivate object for SupportApp \a action,
 * with public implementation \a q.
 */
UpdateSlackChannelConfigurationRequestPrivate::UpdateSlackChannelConfigurationRequestPrivate(
    const SupportAppRequest::Action action, UpdateSlackChannelConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateSlackChannelConfigurationRequest
 * class' copy constructor.
 */
UpdateSlackChannelConfigurationRequestPrivate::UpdateSlackChannelConfigurationRequestPrivate(
    const UpdateSlackChannelConfigurationRequestPrivate &other, UpdateSlackChannelConfigurationRequest * const q)
