...
/*!
 * \class QtAws::CodeGuruProfiler::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for CodeGuruProfiler TagResource responses.
 *
 ...
 *
 * \sa CodeGuruProfilerClient::tagResource
 */
...
TagResourceResponse::TagResourceResponse(
    ...
    : CodeGuruProfilerResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(CodeGuruProfilerResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeGuruProfiler TagResource \a response.
 */
...
/*!
 * \class QtAws::CodeGuruProfiler::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : CodeGuruProfilerResponsePrivate(q)
{

}

/*!
 * Parses a CodeGuruProfiler TagResource response element from \a xml.
 */
