...
/*!
 * \class QtAws::CodeGuruProfiler::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for CodeGuruProfiler TagResource requests.
 *
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : CodeGuruProfilerRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : CodeGuruProfilerRequest(new TagResourceRequestPrivate(CodeGuruProfilerRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::CodeGuruProfiler::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for CodeGuruProfiler \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const CodeGuruProfilerRequest::Action action, TagResourceRequest * const q)
