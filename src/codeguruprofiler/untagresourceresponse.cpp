...
/*!
 * \class QtAws::CodeGuruProfiler::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for CodeGuruProfiler UntagResource responses.
 *
 ...
 *
 * \sa CodeGuruProfilerClient::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : CodeGuruProfilerResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(CodeGuruProfilerResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeGuruProfiler UntagResource \a response.
 */
...
/*!
 * \class QtAws::CodeGuruProfiler::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : CodeGuruProfilerResponsePrivate(q)
{

}

/*!
 * Parses a CodeGuruProfiler UntagResource response element from \a xml.
 */
