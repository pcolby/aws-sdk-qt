...
class QTAWS_EXPORT CreateProfilingGroupResponsePrivate : public CodeGuruProfilerResponsePrivate {

public:

    CreateProfilingGroupResponsePrivate(CreateProfilingGroupResponse * const q);
