...
class QTAWS_EXPORT DescribeProfilingGroupResponsePrivate : public CodeGuruProfilerResponsePrivate {

public:

    DescribeProfilingGroupResponsePrivate(DescribeProfilingGroupResponse * const q);
