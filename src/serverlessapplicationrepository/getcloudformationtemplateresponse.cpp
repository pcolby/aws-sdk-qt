...
#include "getcloudformationtemplateresponse_p.h"
...
/*!
 * \class QtAws::ServerlessApplicationRepository::GetCloudFormationTemplateResponse
 * \brief The GetCloudFormationTemplateResponse class provides an interace for ServerlessApplicationRepository GetCloudFormationTemplate responses.
 *
...
/*!
 * Constructs a GetCloudFormationTemplateResponse object for \a reply to \a request, with parent \a parent.
 */
GetCloudFormationTemplateResponse::GetCloudFormationTemplateResponse(
        const GetCloudFormationTemplateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ServerlessApplicationRepositoryResponse(new GetCloudFormationTemplateResponsePrivate(this), parent)
{
    setRequest(new GetCloudFormationTemplateRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetCloudFormationTemplateRequest * GetCloudFormationTemplateResponse::request() const
{
    Q_D(const GetCloudFormationTemplateResponse);
    return static_cast<const GetCloudFormationTemplateRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful ServerlessApplicationRepository GetCloudFormationTemplate \a response.
 */
void GetCloudFormationTemplateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetCloudFormationTemplateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::ServerlessApplicationRepository::GetCloudFormationTemplateResponsePrivate
 * \brief The GetCloudFormationTemplateResponsePrivate class provides private implementation for GetCloudFormationTemplateResponse.
 * \internal
 *
 * \inmodule QtAwsServerlessApplicationRepository
 */
...
/*!
 * Constructs a GetCloudFormationTemplateResponsePrivate object with public implementation \a q.
 */
GetCloudFormationTemplateResponsePrivate::GetCloudFormationTemplateResponsePrivate(
    GetCloudFormationTemplateResponse * const q) : ServerlessApplicationRepositoryResponsePrivate(q)
{

}

/*!
 * Parses a ServerlessApplicationRepository GetCloudFormationTemplate response element from \a xml.
 */
void GetCloudFormationTemplateResponsePrivate::parseGetCloudFormationTemplateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetCloudFormationTemplateResponse"));
    Q_UNUSED(xml) ///< @todo
}
