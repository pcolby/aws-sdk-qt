...
/*!
 * \class QtAws::Braket::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Braket ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : BraketResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(BraketResponse::request());
}

/*!
 * \reimp
 * Parses a successful Braket ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Braket::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : BraketResponsePrivate(q)
{

}

/*!
 * Parses a Braket ListTagsForResource response element from \a xml.
 */
