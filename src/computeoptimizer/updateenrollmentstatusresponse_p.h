...
class QTAWS_EXPORT UpdateEnrollmentStatusResponsePrivate : public ComputeOptimizerResponsePrivate {

public:

    UpdateEnrollmentStatusResponsePrivate(UpdateEnrollmentStatusResponse * const q);
