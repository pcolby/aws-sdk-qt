...
#ifndef QTAWS_GETEBSVOLUMERECOMMENDATIONSREQUEST_H
#define QTAWS_GETEBSVOLUMERECOMMENDATIONSREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(GetEBSVolumeRecommendationsRequest)
