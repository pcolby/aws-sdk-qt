...
/*!
 * \class QtAws::CodePipeline::DeleteWebhookResponse
 * \brief The DeleteWebhookResponse class provides an interace for CodePipeline DeleteWebhook responses.
 *
...
DeleteWebhookResponse::DeleteWebhookResponse(
    ...
    : CodePipelineResponse(new DeleteWebhookResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CodePipeline DeleteWebhook \a response.
 */
...
/*!
 * \class QtAws::CodePipeline::DeleteWebhookResponsePrivate
...
DeleteWebhookResponsePrivate::DeleteWebhookResponsePrivate(
    DeleteWebhookResponse * const q) : CodePipelineResponsePrivate(q)
{

}

/*!
 * Parses a CodePipeline DeleteWebhook response element from \a xml.
 */
