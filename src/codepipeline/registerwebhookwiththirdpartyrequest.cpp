...
#include "registerwebhookwiththirdpartyrequest_p.h"
...
/*!
 * \class QtAws::CodePipeline::RegisterWebhookWithThirdPartyRequest
 * \brief The RegisterWebhookWithThirdPartyRequest class provides an interface for CodePipeline RegisterWebhookWithThirdParty requests.
 *
 ...
 *
 * \sa CodePipelineClient::registerWebhookWithThirdParty
 */

/*!
 * Constructs a copy of \a other.
 */
RegisterWebhookWithThirdPartyRequest::RegisterWebhookWithThirdPartyRequest(const RegisterWebhookWithThirdPartyRequest &other)
    : CodePipelineRequest(new RegisterWebhookWithThirdPartyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a RegisterWebhookWithThirdPartyRequest object.
 */
RegisterWebhookWithThirdPartyRequest::RegisterWebhookWithThirdPartyRequest()
    : CodePipelineRequest(new RegisterWebhookWithThirdPartyRequestPrivate(CodePipelineRequest::RegisterWebhookWithThirdPartyAction, this))
{
 ...
 * \reimp
 */
bool RegisterWebhookWithThirdPartyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a RegisterWebhookWithThirdPartyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * RegisterWebhookWithThirdPartyRequest::response(QNetworkReply * const reply) const
{
    return new RegisterWebhookWithThirdPartyResponse(*this, reply);
}

/*!
 * \class QtAws::CodePipeline::RegisterWebhookWithThirdPartyRequestPrivate
 * \brief The RegisterWebhookWithThirdPartyRequestPrivate class provides private implementation for RegisterWebhookWithThirdPartyRequest.
 * \internal
 *
 * \inmodule QtAwsCodePipeline
 */
...
/*!
 * Constructs a RegisterWebhookWithThirdPartyRequestPrivate object for CodePipeline \a action,
 * with public implementation \a q.
 */
RegisterWebhookWithThirdPartyRequestPrivate::RegisterWebhookWithThirdPartyRequestPrivate(
    const CodePipelineRequest::Action action, RegisterWebhookWithThirdPartyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the RegisterWebhookWithThirdPartyRequest
 * class' copy constructor.
 */
RegisterWebhookWithThirdPartyRequestPrivate::RegisterWebhookWithThirdPartyRequestPrivate(
    const RegisterWebhookWithThirdPartyRequestPrivate &other, RegisterWebhookWithThirdPartyRequest * const q)
