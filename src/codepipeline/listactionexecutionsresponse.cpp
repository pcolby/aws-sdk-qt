...
#include "listactionexecutionsresponse_p.h"
...
/*!
 * \class QtAws::CodePipeline::ListActionExecutionsResponse
 * \brief The ListActionExecutionsResponse class provides an interace for CodePipeline ListActionExecutions responses.
 *
...
/*!
 * Constructs a ListActionExecutionsResponse object for \a reply to \a request, with parent \a parent.
 */
ListActionExecutionsResponse::ListActionExecutionsResponse(
        const ListActionExecutionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodePipelineResponse(new ListActionExecutionsResponsePrivate(this), parent)
{
    setRequest(new ListActionExecutionsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodePipeline ListActionExecutions \a response.
 */
void ListActionExecutionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListActionExecutionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodePipeline::ListActionExecutionsResponsePrivate
 * \brief The ListActionExecutionsResponsePrivate class provides private implementation for ListActionExecutionsResponse.
 * \internal
 *
 * \inmodule QtAwsCodePipeline
 */
...
/*!
 * Constructs a ListActionExecutionsResponsePrivate object with public implementation \a q.
 */
ListActionExecutionsResponsePrivate::ListActionExecutionsResponsePrivate(
    ListActionExecutionsResponse * const q) : CodePipelineResponsePrivate(q)
{

}

/*!
 * Parses a CodePipeline ListActionExecutions response element from \a xml.
 */
void ListActionExecutionsResponsePrivate::parseListActionExecutionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListActionExecutionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
