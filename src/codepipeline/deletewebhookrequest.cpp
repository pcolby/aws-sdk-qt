...
/*!
 * \class QtAws::CodePipeline::DeleteWebhookRequest
 * \brief The DeleteWebhookRequest class provides an interface for CodePipeline DeleteWebhook requests.
 *
 ...
 *
 * \sa CodePipelineClient::deleteWebhook
 */
...
DeleteWebhookRequest::DeleteWebhookRequest(const DeleteWebhookRequest &other)
    : CodePipelineRequest(new DeleteWebhookRequestPrivate(*other.d_func(), this))
{
...
DeleteWebhookRequest::DeleteWebhookRequest()
    : CodePipelineRequest(new DeleteWebhookRequestPrivate(CodePipelineRequest::DeleteWebhookAction, this))
{
...
/*!
 * \class QtAws::CodePipeline::DeleteWebhookRequestPrivate
...
/*!
 * Constructs a DeleteWebhookRequestPrivate object for CodePipeline \a action,
 * with public implementation \a q.
 */
DeleteWebhookRequestPrivate::DeleteWebhookRequestPrivate(
    const CodePipelineRequest::Action action, DeleteWebhookRequest * const q)
