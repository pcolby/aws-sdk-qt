...
#include "getactiontyperesponse_p.h"
...
/*!
 * \class QtAws::CodePipeline::GetActionTypeResponse
 * \brief The GetActionTypeResponse class provides an interace for CodePipeline GetActionType responses.
 *
 ...
 *
 * \sa CodePipelineClient::getActionType
 */

/*!
 * Constructs a GetActionTypeResponse object for \a reply to \a request, with parent \a parent.
 */
GetActionTypeResponse::GetActionTypeResponse(
        const GetActionTypeRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodePipelineResponse(new GetActionTypeResponsePrivate(this), parent)
{
    setRequest(new GetActionTypeRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetActionTypeRequest * GetActionTypeResponse::request() const
{
    Q_D(const GetActionTypeResponse);
    return static_cast<const GetActionTypeRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful CodePipeline GetActionType \a response.
 */
void GetActionTypeResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetActionTypeResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodePipeline::GetActionTypeResponsePrivate
 * \brief The GetActionTypeResponsePrivate class provides private implementation for GetActionTypeResponse.
 * \internal
 *
 * \inmodule QtAwsCodePipeline
 */
...
/*!
 * Constructs a GetActionTypeResponsePrivate object with public implementation \a q.
 */
GetActionTypeResponsePrivate::GetActionTypeResponsePrivate(
    GetActionTypeResponse * const q) : CodePipelineResponsePrivate(q)
{

}

/*!
 * Parses a CodePipeline GetActionType response element from \a xml.
 */
void GetActionTypeResponsePrivate::parseGetActionTypeResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetActionTypeResponse"));
    Q_UNUSED(xml) ///< @todo
}
