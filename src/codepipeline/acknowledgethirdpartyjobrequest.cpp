 ...
 *
 * \brief The AcknowledgeThirdPartyJobRequest class encapsulates CodePipeline AcknowledgeThirdPartyJob requests.
 *
 ...
 *
 * \sa CodePipelineClient::acknowledgeThirdPartyJob
 */
