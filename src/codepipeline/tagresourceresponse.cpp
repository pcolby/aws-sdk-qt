...
/*!
 * \class QtAws::CodePipeline::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for CodePipeline TagResource responses.
 *
 ...
 *
 * \sa CodePipelineClient::tagResource
 */
...
TagResourceResponse::TagResourceResponse(
    ...
    : CodePipelineResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(CodePipelineResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodePipeline TagResource \a response.
 */
...
/*!
 * \class QtAws::CodePipeline::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : CodePipelineResponsePrivate(q)
{

}

/*!
 * Parses a CodePipeline TagResource response element from \a xml.
 */
