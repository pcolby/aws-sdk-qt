...
#include "updateactiontyperesponse_p.h"
...
/*!
 * \class QtAws::CodePipeline::UpdateActionTypeResponse
 * \brief The UpdateActionTypeResponse class provides an interace for CodePipeline UpdateActionType responses.
 *
...
/*!
 * Constructs a UpdateActionTypeResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateActionTypeResponse::UpdateActionTypeResponse(
        const UpdateActionTypeRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodePipelineResponse(new UpdateActionTypeResponsePrivate(this), parent)
{
    setRequest(new UpdateActionTypeRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodePipeline UpdateActionType \a response.
 */
void UpdateActionTypeResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateActionTypeResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodePipeline::UpdateActionTypeResponsePrivate
 * \brief The UpdateActionTypeResponsePrivate class provides private implementation for UpdateActionTypeResponse.
 * \internal
 *
 * \inmodule QtAwsCodePipeline
 */
...
/*!
 * Constructs a UpdateActionTypeResponsePrivate object with public implementation \a q.
 */
UpdateActionTypeResponsePrivate::UpdateActionTypeResponsePrivate(
    UpdateActionTypeResponse * const q) : CodePipelineResponsePrivate(q)
{

}

/*!
 * Parses a CodePipeline UpdateActionType response element from \a xml.
 */
void UpdateActionTypeResponsePrivate::parseUpdateActionTypeResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateActionTypeResponse"));
    Q_UNUSED(xml) ///< @todo
}
