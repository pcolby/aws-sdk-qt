...
/*!
 * \class QtAws::CodePipeline::StopPipelineExecutionResponse
 * \brief The StopPipelineExecutionResponse class provides an interace for CodePipeline StopPipelineExecution responses.
 *
...
StopPipelineExecutionResponse::StopPipelineExecutionResponse(
    ...
    : CodePipelineResponse(new StopPipelineExecutionResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CodePipeline StopPipelineExecution \a response.
 */
...
/*!
 * \class QtAws::CodePipeline::StopPipelineExecutionResponsePrivate
...
StopPipelineExecutionResponsePrivate::StopPipelineExecutionResponsePrivate(
    StopPipelineExecutionResponse * const q) : CodePipelineResponsePrivate(q)
{

}

/*!
 * Parses a CodePipeline StopPipelineExecution response element from \a xml.
 */
