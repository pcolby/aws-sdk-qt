...
#include "putwebhookresponse_p.h"
...
/*!
 * \class QtAws::CodePipeline::PutWebhookResponse
 * \brief The PutWebhookResponse class provides an interace for CodePipeline PutWebhook responses.
 *
...
/*!
 * Constructs a PutWebhookResponse object for \a reply to \a request, with parent \a parent.
 */
PutWebhookResponse::PutWebhookResponse(
        const PutWebhookRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodePipelineResponse(new PutWebhookResponsePrivate(this), parent)
{
    setRequest(new PutWebhookRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodePipeline PutWebhook \a response.
 */
...
/*!
 * \class QtAws::CodePipeline::PutWebhookResponsePrivate
 * \brief The PutWebhookResponsePrivate class provides private implementation for PutWebhookResponse.
 * \internal
 *
 * \inmodule QtAwsCodePipeline
 */
...
/*!
 * Constructs a PutWebhookResponsePrivate object with public implementation \a q.
 */
PutWebhookResponsePrivate::PutWebhookResponsePrivate(
    PutWebhookResponse * const q) : CodePipelineResponsePrivate(q)
{

}

/*!
 * Parses a CodePipeline PutWebhook response element from \a xml.
 */
