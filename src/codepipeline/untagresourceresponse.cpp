...
/*!
 * \class QtAws::CodePipeline::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for CodePipeline UntagResource responses.
 *
 ...
 *
 * \sa CodePipelineClient::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : CodePipelineResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(CodePipelineResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodePipeline UntagResource \a response.
 */
...
/*!
 * \class QtAws::CodePipeline::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : CodePipelineResponsePrivate(q)
{

}

/*!
 * Parses a CodePipeline UntagResource response element from \a xml.
 */
