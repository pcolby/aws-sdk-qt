...
#include "updateactiontyperequest_p.h"
...
/*!
 * \class QtAws::CodePipeline::UpdateActionTypeRequest
 * \brief The UpdateActionTypeRequest class provides an interface for CodePipeline UpdateActionType requests.
 *
 ...
 *
 * \sa CodePipelineClient::updateActionType
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateActionTypeRequest::UpdateActionTypeRequest(const UpdateActionTypeRequest &other)
    : CodePipelineRequest(new UpdateActionTypeRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateActionTypeRequest object.
 */
UpdateActionTypeRequest::UpdateActionTypeRequest()
    : CodePipelineRequest(new UpdateActionTypeRequestPrivate(CodePipelineRequest::UpdateActionTypeAction, this))
{
 ...
 * \reimp
 */
bool UpdateActionTypeRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateActionTypeResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateActionTypeRequest::response(QNetworkReply * const reply) const
{
    return new UpdateActionTypeResponse(*this, reply);
}

/*!
 * \class QtAws::CodePipeline::UpdateActionTypeRequestPrivate
 * \brief The UpdateActionTypeRequestPrivate class provides private implementation for UpdateActionTypeRequest.
 * \internal
 *
 * \inmodule QtAwsCodePipeline
 */
...
/*!
 * Constructs a UpdateActionTypeRequestPrivate object for CodePipeline \a action,
 * with public implementation \a q.
 */
UpdateActionTypeRequestPrivate::UpdateActionTypeRequestPrivate(
    const CodePipelineRequest::Action action, UpdateActionTypeRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateActionTypeRequest
 * class' copy constructor.
 */
UpdateActionTypeRequestPrivate::UpdateActionTypeRequestPrivate(
    const UpdateActionTypeRequestPrivate &other, UpdateActionTypeRequest * const q)
