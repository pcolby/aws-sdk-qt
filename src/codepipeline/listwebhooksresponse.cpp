...
/*!
 * \class QtAws::CodePipeline::ListWebhooksResponse
 * \brief The ListWebhooksResponse class provides an interace for CodePipeline ListWebhooks responses.
 *
...
ListWebhooksResponse::ListWebhooksResponse(
    ...
    : CodePipelineResponse(new ListWebhooksResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CodePipeline ListWebhooks \a response.
 */
...
/*!
 * \class QtAws::CodePipeline::ListWebhooksResponsePrivate
...
ListWebhooksResponsePrivate::ListWebhooksResponsePrivate(
    ListWebhooksResponse * const q) : CodePipelineResponsePrivate(q)
{

}

/*!
 * Parses a CodePipeline ListWebhooks response element from \a xml.
 */
