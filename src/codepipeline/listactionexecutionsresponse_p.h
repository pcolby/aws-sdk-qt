...
class QTAWS_EXPORT ListActionExecutionsResponsePrivate : public CodePipelineResponsePrivate {

public:

    ListActionExecutionsResponsePrivate(ListActionExecutionsResponse * const q);
