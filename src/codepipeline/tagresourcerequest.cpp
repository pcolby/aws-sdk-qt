...
/*!
 * \class QtAws::CodePipeline::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for CodePipeline TagResource requests.
 *
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : CodePipelineRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : CodePipelineRequest(new TagResourceRequestPrivate(CodePipelineRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::CodePipeline::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for CodePipeline \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const CodePipelineRequest::Action action, TagResourceRequest * const q)
