...
/*!
 * \class QtAws::CodePipeline::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for CodePipeline UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : CodePipelineRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : CodePipelineRequest(new UntagResourceRequestPrivate(CodePipelineRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::CodePipeline::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for CodePipeline \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const CodePipelineRequest::Action action, UntagResourceRequest * const q)
