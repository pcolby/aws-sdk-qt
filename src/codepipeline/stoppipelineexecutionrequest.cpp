...
/*!
 * \class QtAws::CodePipeline::StopPipelineExecutionRequest
 * \brief The StopPipelineExecutionRequest class provides an interface for CodePipeline StopPipelineExecution requests.
 *
 ...
 *
 * \sa CodePipelineClient::stopPipelineExecution
 */
...
StopPipelineExecutionRequest::StopPipelineExecutionRequest(const StopPipelineExecutionRequest &other)
    : CodePipelineRequest(new StopPipelineExecutionRequestPrivate(*other.d_func(), this))
{
...
StopPipelineExecutionRequest::StopPipelineExecutionRequest()
    : CodePipelineRequest(new StopPipelineExecutionRequestPrivate(CodePipelineRequest::StopPipelineExecutionAction, this))
{
...
/*!
 * \class QtAws::CodePipeline::StopPipelineExecutionRequestPrivate
...
/*!
 * Constructs a StopPipelineExecutionRequestPrivate object for CodePipeline \a action,
 * with public implementation \a q.
 */
StopPipelineExecutionRequestPrivate::StopPipelineExecutionRequestPrivate(
    const CodePipelineRequest::Action action, StopPipelineExecutionRequest * const q)
