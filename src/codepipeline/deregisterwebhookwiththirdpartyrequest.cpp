...
#include "deregisterwebhookwiththirdpartyrequest_p.h"
...
/*!
 * \class QtAws::CodePipeline::DeregisterWebhookWithThirdPartyRequest
 * \brief The DeregisterWebhookWithThirdPartyRequest class provides an interface for CodePipeline DeregisterWebhookWithThirdParty requests.
 *
 ...
 *
 * \sa CodePipelineClient::deregisterWebhookWithThirdParty
 */

/*!
 * Constructs a copy of \a other.
 */
DeregisterWebhookWithThirdPartyRequest::DeregisterWebhookWithThirdPartyRequest(const DeregisterWebhookWithThirdPartyRequest &other)
    : CodePipelineRequest(new DeregisterWebhookWithThirdPartyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeregisterWebhookWithThirdPartyRequest object.
 */
DeregisterWebhookWithThirdPartyRequest::DeregisterWebhookWithThirdPartyRequest()
    : CodePipelineRequest(new DeregisterWebhookWithThirdPartyRequestPrivate(CodePipelineRequest::DeregisterWebhookWithThirdPartyAction, this))
{
 ...
 * \reimp
 */
bool DeregisterWebhookWithThirdPartyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeregisterWebhookWithThirdPartyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeregisterWebhookWithThirdPartyRequest::response(QNetworkReply * const reply) const
{
    return new DeregisterWebhookWithThirdPartyResponse(*this, reply);
}

/*!
 * \class QtAws::CodePipeline::DeregisterWebhookWithThirdPartyRequestPrivate
 * \brief The DeregisterWebhookWithThirdPartyRequestPrivate class provides private implementation for DeregisterWebhookWithThirdPartyRequest.
 * \internal
 *
 * \inmodule QtAwsCodePipeline
 */
...
/*!
 * Constructs a DeregisterWebhookWithThirdPartyRequestPrivate object for CodePipeline \a action,
 * with public implementation \a q.
 */
DeregisterWebhookWithThirdPartyRequestPrivate::DeregisterWebhookWithThirdPartyRequestPrivate(
    const CodePipelineRequest::Action action, DeregisterWebhookWithThirdPartyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeregisterWebhookWithThirdPartyRequest
 * class' copy constructor.
 */
DeregisterWebhookWithThirdPartyRequestPrivate::DeregisterWebhookWithThirdPartyRequestPrivate(
    const DeregisterWebhookWithThirdPartyRequestPrivate &other, DeregisterWebhookWithThirdPartyRequest * const q)
