...
/*!
 * \class QtAws::CodePipeline::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for CodePipeline ListTagsForResource responses.
 *
 ...
 *
 * \sa CodePipelineClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : CodePipelineResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(CodePipelineResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodePipeline ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::CodePipeline::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : CodePipelineResponsePrivate(q)
{

}

/*!
 * Parses a CodePipeline ListTagsForResource response element from \a xml.
 */
