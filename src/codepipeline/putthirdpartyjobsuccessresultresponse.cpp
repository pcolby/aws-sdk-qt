 ...
 *
 * \brief The PutThirdPartyJobSuccessResultResponse class encapsulates CodePipeline PutThirdPartyJobSuccessResult responses.
 *
 ...
 *
 * \sa CodePipelineClient::putThirdPartyJobSuccessResult
 */
