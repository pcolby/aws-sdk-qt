...
/*!
 * \class QtAws::CodePipeline::PutWebhookRequest
 * \brief The PutWebhookRequest class provides an interface for CodePipeline PutWebhook requests.
 *
 ...
 *
 * \sa CodePipelineClient::putWebhook
 */

/*!
 * Constructs a copy of \a other.
 */
PutWebhookRequest::PutWebhookRequest(const PutWebhookRequest &other)
    : CodePipelineRequest(new PutWebhookRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutWebhookRequest object.
 */
PutWebhookRequest::PutWebhookRequest()
    : CodePipelineRequest(new PutWebhookRequestPrivate(CodePipelineRequest::PutWebhookAction, this))
{
 ...
 * \reimp
 */
bool PutWebhookRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutWebhookResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutWebhookRequest::response(QNetworkReply * const reply) const
{
    return new PutWebhookResponse(*this, reply);
}

/*!
 * \class QtAws::CodePipeline::PutWebhookRequestPrivate
 * \brief The PutWebhookRequestPrivate class provides private implementation for PutWebhookRequest.
 * \internal
 *
 * \inmodule QtAwsCodePipeline
 */
...
/*!
 * Constructs a PutWebhookRequestPrivate object for CodePipeline \a action,
 * with public implementation \a q.
 */
PutWebhookRequestPrivate::PutWebhookRequestPrivate(
    const CodePipelineRequest::Action action, PutWebhookRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutWebhookRequest
 * class' copy constructor.
 */
PutWebhookRequestPrivate::PutWebhookRequestPrivate(
    const PutWebhookRequestPrivate &other, PutWebhookRequest * const q)
