...
#include "registerwebhookwiththirdpartyresponse_p.h"
...
/*!
 * \class QtAws::CodePipeline::RegisterWebhookWithThirdPartyResponse
 * \brief The RegisterWebhookWithThirdPartyResponse class provides an interace for CodePipeline RegisterWebhookWithThirdParty responses.
 *
...
/*!
 * Constructs a RegisterWebhookWithThirdPartyResponse object for \a reply to \a request, with parent \a parent.
 */
RegisterWebhookWithThirdPartyResponse::RegisterWebhookWithThirdPartyResponse(
        const RegisterWebhookWithThirdPartyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodePipelineResponse(new RegisterWebhookWithThirdPartyResponsePrivate(this), parent)
{
    setRequest(new RegisterWebhookWithThirdPartyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodePipeline RegisterWebhookWithThirdParty \a response.
 */
...
/*!
 * \class QtAws::CodePipeline::RegisterWebhookWithThirdPartyResponsePrivate
 * \brief The RegisterWebhookWithThirdPartyResponsePrivate class provides private implementation for RegisterWebhookWithThirdPartyResponse.
 * \internal
 *
 * \inmodule QtAwsCodePipeline
 */
...
/*!
 * Constructs a RegisterWebhookWithThirdPartyResponsePrivate object with public implementation \a q.
 */
RegisterWebhookWithThirdPartyResponsePrivate::RegisterWebhookWithThirdPartyResponsePrivate(
    RegisterWebhookWithThirdPartyResponse * const q) : CodePipelineResponsePrivate(q)
{

}

/*!
 * Parses a CodePipeline RegisterWebhookWithThirdParty response element from \a xml.
 */
