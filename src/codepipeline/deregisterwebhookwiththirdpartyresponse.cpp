...
#include "deregisterwebhookwiththirdpartyresponse_p.h"
...
/*!
 * \class QtAws::CodePipeline::DeregisterWebhookWithThirdPartyResponse
 * \brief The DeregisterWebhookWithThirdPartyResponse class provides an interace for CodePipeline DeregisterWebhookWithThirdParty responses.
 *
...
/*!
 * Constructs a DeregisterWebhookWithThirdPartyResponse object for \a reply to \a request, with parent \a parent.
 */
DeregisterWebhookWithThirdPartyResponse::DeregisterWebhookWithThirdPartyResponse(
        const DeregisterWebhookWithThirdPartyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodePipelineResponse(new DeregisterWebhookWithThirdPartyResponsePrivate(this), parent)
{
    setRequest(new DeregisterWebhookWithThirdPartyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodePipeline DeregisterWebhookWithThirdParty \a response.
 */
...
/*!
 * \class QtAws::CodePipeline::DeregisterWebhookWithThirdPartyResponsePrivate
 * \brief The DeregisterWebhookWithThirdPartyResponsePrivate class provides private implementation for DeregisterWebhookWithThirdPartyResponse.
 * \internal
 *
 * \inmodule QtAwsCodePipeline
 */
...
/*!
 * Constructs a DeregisterWebhookWithThirdPartyResponsePrivate object with public implementation \a q.
 */
DeregisterWebhookWithThirdPartyResponsePrivate::DeregisterWebhookWithThirdPartyResponsePrivate(
    DeregisterWebhookWithThirdPartyResponse * const q) : CodePipelineResponsePrivate(q)
{

}

/*!
 * Parses a CodePipeline DeregisterWebhookWithThirdParty response element from \a xml.
 */
