...
public:
    ...
    CodePipelineClientResponsePrivate(CodePipelineClientResponse * const q);

    void parseResponse(QXmlStreamReader &xml);

private:
    Q_DECLARE_PUBLIC(CodePipelineClientResponse)
    Q_DISABLE_COPY(CodePipelineClientResponsePrivate)
