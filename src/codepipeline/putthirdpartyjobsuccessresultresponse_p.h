...
class QTAWS_EXPORT PutThirdPartyJobSuccessResultResponsePrivate : public CodePipelineResponsePrivate {
    Q_OBJECT

public:

    PutThirdPartyJobSuccessResultResponsePrivate(PutThirdPartyJobSuccessResultResponse * const q);
