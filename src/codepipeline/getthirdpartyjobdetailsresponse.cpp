 ...
 *
 * \sa CodePipelineClient::getThirdPartyJobDetails
 */

/*!
 * Constructs a GetThirdPartyJobDetailsResponse object for \a reply to \a request, with parent \a parent.
 */
...
{
    return static_cast<const GetThirdPartyJobDetailsRequest *>(CodePipelineResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodePipeline GetThirdPartyJobDetails \a response.
 */
...
/*!
 * \class QtAws::CodePipeline::GetThirdPartyJobDetailsResponsePrivate
 * \brief The GetThirdPartyJobDetailsResponsePrivate class provides private implementation for GetThirdPartyJobDetailsResponse.
 * \internal
 *
 * \inmodule QtAwsCodePipeline
 */
...
/*!
 * Constructs a GetThirdPartyJobDetailsResponsePrivate object with public implementation \a q.
 */
...
/*!
 * Parses a CodePipeline GetThirdPartyJobDetails response element from \a xml.
 */
