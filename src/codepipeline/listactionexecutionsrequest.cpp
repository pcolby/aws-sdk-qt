...
#include "listactionexecutionsrequest_p.h"
...
/*!
 * \class QtAws::CodePipeline::ListActionExecutionsRequest
 * \brief The ListActionExecutionsRequest class provides an interface for CodePipeline ListActionExecutions requests.
 *
 ...
 *
 * \sa CodePipelineClient::listActionExecutions
 */

/*!
 * Constructs a copy of \a other.
 */
ListActionExecutionsRequest::ListActionExecutionsRequest(const ListActionExecutionsRequest &other)
    : CodePipelineRequest(new ListActionExecutionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListActionExecutionsRequest object.
 */
ListActionExecutionsRequest::ListActionExecutionsRequest()
    : CodePipelineRequest(new ListActionExecutionsRequestPrivate(CodePipelineRequest::ListActionExecutionsAction, this))
{
 ...
 * \reimp
 */
bool ListActionExecutionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListActionExecutionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListActionExecutionsRequest::response(QNetworkReply * const reply) const
{
    return new ListActionExecutionsResponse(*this, reply);
}

/*!
 * \class QtAws::CodePipeline::ListActionExecutionsRequestPrivate
 * \brief The ListActionExecutionsRequestPrivate class provides private implementation for ListActionExecutionsRequest.
 * \internal
 *
 * \inmodule QtAwsCodePipeline
 */
...
/*!
 * Constructs a ListActionExecutionsRequestPrivate object for CodePipeline \a action,
 * with public implementation \a q.
 */
ListActionExecutionsRequestPrivate::ListActionExecutionsRequestPrivate(
    const CodePipelineRequest::Action action, ListActionExecutionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListActionExecutionsRequest
 * class' copy constructor.
 */
ListActionExecutionsRequestPrivate::ListActionExecutionsRequestPrivate(
    const ListActionExecutionsRequestPrivate &other, ListActionExecutionsRequest * const q)
