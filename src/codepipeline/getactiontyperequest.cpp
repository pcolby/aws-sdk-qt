...
#include "getactiontyperequest_p.h"
...
/*!
 * \class QtAws::CodePipeline::GetActionTypeRequest
 * \brief The GetActionTypeRequest class provides an interface for CodePipeline GetActionType requests.
 *
 ...
 */
GetActionTypeRequest::GetActionTypeRequest(const GetActionTypeRequest &other)
    : CodePipelineRequest(new GetActionTypeRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetActionTypeRequest object.
 */
GetActionTypeRequest::GetActionTypeRequest()
    : CodePipelineRequest(new GetActionTypeRequestPrivate(CodePipelineRequest::GetActionTypeAction, this))
{
 ...
 * \reimp
 */
bool GetActionTypeRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetActionTypeResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetActionTypeRequest::response(QNetworkReply * const reply) const
{
    return new GetActionTypeResponse(*this, reply);
}

/*!
 * \class QtAws::CodePipeline::GetActionTypeRequestPrivate
 * \brief The GetActionTypeRequestPrivate class provides private implementation for GetActionTypeRequest.
 * \internal
 *
 * \inmodule QtAwsCodePipeline
 */
...
/*!
 * Constructs a GetActionTypeRequestPrivate object for CodePipeline \a action,
 * with public implementation \a q.
 */
GetActionTypeRequestPrivate::GetActionTypeRequestPrivate(
    const CodePipelineRequest::Action action, GetActionTypeRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetActionTypeRequest
 * class' copy constructor.
 */
GetActionTypeRequestPrivate::GetActionTypeRequestPrivate(
    const GetActionTypeRequestPrivate &other, GetActionTypeRequest * const q)
