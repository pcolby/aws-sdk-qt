...
class QTAWS_EXPORT GetSqlInjectionMatchSetResponsePrivate : public WAFRegionalResponsePrivate {

public:

    GetSqlInjectionMatchSetResponsePrivate(GetSqlInjectionMatchSetResponse * const q);
