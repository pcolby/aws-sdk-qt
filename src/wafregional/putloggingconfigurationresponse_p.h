...
class QTAWS_EXPORT PutLoggingConfigurationResponsePrivate : public WAFRegionalResponsePrivate {

public:

    PutLoggingConfigurationResponsePrivate(PutLoggingConfigurationResponse * const q);
