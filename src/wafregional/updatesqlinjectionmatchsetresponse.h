...
class QTAWS_EXPORT UpdateSqlInjectionMatchSetResponse : public WAFRegionalResponse {
    Q_OBJECT
...
public:
    ...
    virtual const UpdateSqlInjectionMatchSetRequest * request() const override;
