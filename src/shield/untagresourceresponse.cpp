...
/*!
 * \class QtAws::Shield::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Shield UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : ShieldResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Shield UntagResource \a response.
 */
...
/*!
 * \class QtAws::Shield::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : ShieldResponsePrivate(q)
{

}

/*!
 * Parses a Shield UntagResource response element from \a xml.
 */
