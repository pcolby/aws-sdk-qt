...
/*!
 * \class QtAws::Shield::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Shield ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ShieldResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(ShieldResponse::request());
}

/*!
 * \reimp
 * Parses a successful Shield ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Shield::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ShieldResponsePrivate(q)
{

}

/*!
 * Parses a Shield ListTagsForResource response element from \a xml.
 */
