...
class QTAWS_EXPORT UpdateEmergencyContactSettingsResponse : public ShieldResponse {
    Q_OBJECT
...
public:
    ...
    virtual const UpdateEmergencyContactSettingsRequest * request() const override;
