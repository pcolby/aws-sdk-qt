...
class QTAWS_EXPORT CreateProtectionGroupResponsePrivate : public ShieldResponsePrivate {

public:

    CreateProtectionGroupResponsePrivate(CreateProtectionGroupResponse * const q);
