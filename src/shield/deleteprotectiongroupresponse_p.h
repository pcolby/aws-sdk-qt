...
class QTAWS_EXPORT DeleteProtectionGroupResponsePrivate : public ShieldResponsePrivate {

public:

    DeleteProtectionGroupResponsePrivate(DeleteProtectionGroupResponse * const q);
