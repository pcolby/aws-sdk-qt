...
/*!
 * \class QtAws::Shield::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Shield TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ShieldResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(ShieldResponse::request());
}

/*!
 * \reimp
 * Parses a successful Shield TagResource \a response.
 */
...
/*!
 * \class QtAws::Shield::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ShieldResponsePrivate(q)
{

}

/*!
 * Parses a Shield TagResource response element from \a xml.
 */
