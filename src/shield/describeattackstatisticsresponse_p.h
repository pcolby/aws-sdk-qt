...
class QTAWS_EXPORT DescribeAttackStatisticsResponsePrivate : public ShieldResponsePrivate {

public:

    DescribeAttackStatisticsResponsePrivate(DescribeAttackStatisticsResponse * const q);
