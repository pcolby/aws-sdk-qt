...
class QTAWS_EXPORT DescribeProtectionGroupResponsePrivate : public ShieldResponsePrivate {

public:

    DescribeProtectionGroupResponsePrivate(DescribeProtectionGroupResponse * const q);
