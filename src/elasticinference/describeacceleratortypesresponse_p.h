...
class QTAWS_EXPORT DescribeAcceleratorTypesResponsePrivate : public ElasticInferenceResponsePrivate {

public:

    DescribeAcceleratorTypesResponsePrivate(DescribeAcceleratorTypesResponse * const q);
