...
/*!
 * \class QtAws::ElasticInference::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for ElasticInference ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ElasticInferenceResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(ElasticInferenceResponse::request());
}

/*!
 * \reimp
 * Parses a successful ElasticInference ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::ElasticInference::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ElasticInferenceResponsePrivate(q)
{

}

/*!
 * Parses a ElasticInference ListTagsForResource response element from \a xml.
 */
