...
/*!
 * \class QtAws::ElasticInference::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for ElasticInference TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ElasticInferenceResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(ElasticInferenceResponse::request());
}

/*!
 * \reimp
 * Parses a successful ElasticInference TagResource \a response.
 */
...
/*!
 * \class QtAws::ElasticInference::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ElasticInferenceResponsePrivate(q)
{

}

/*!
 * Parses a ElasticInference TagResource response element from \a xml.
 */
