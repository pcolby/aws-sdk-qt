...
class QTAWS_EXPORT DescribeAcceleratorOfferingsResponsePrivate : public ElasticInferenceResponsePrivate {

public:

    DescribeAcceleratorOfferingsResponsePrivate(DescribeAcceleratorOfferingsResponse * const q);
