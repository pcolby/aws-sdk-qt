...
class QTAWS_EXPORT DescribeThemeAliasResponsePrivate : public QuickSightResponsePrivate {

public:

    DescribeThemeAliasResponsePrivate(DescribeThemeAliasResponse * const q);
