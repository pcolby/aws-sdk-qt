...
class QTAWS_EXPORT DeleteGroupMembershipResponsePrivate : public QuickSightResponsePrivate {

public:

    DeleteGroupMembershipResponsePrivate(DeleteGroupMembershipResponse * const q);
