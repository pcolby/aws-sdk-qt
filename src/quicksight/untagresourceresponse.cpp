...
/*!
 * \class QtAws::QuickSight::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for QuickSight UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : QuickSightResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful QuickSight UntagResource \a response.
 */
...
/*!
 * \class QtAws::QuickSight::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : QuickSightResponsePrivate(q)
{

}

/*!
 * Parses a QuickSight UntagResource response element from \a xml.
 */
