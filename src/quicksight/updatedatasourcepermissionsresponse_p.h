...
class QTAWS_EXPORT UpdateDataSourcePermissionsResponsePrivate : public QuickSightResponsePrivate {

public:

    UpdateDataSourcePermissionsResponsePrivate(UpdateDataSourcePermissionsResponse * const q);
