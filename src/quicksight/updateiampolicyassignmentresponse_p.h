...
class QTAWS_EXPORT UpdateIAMPolicyAssignmentResponsePrivate : public QuickSightResponsePrivate {

public:

    UpdateIAMPolicyAssignmentResponsePrivate(UpdateIAMPolicyAssignmentResponse * const q);
