...
class QTAWS_EXPORT DescribeTemplateAliasResponsePrivate : public QuickSightResponsePrivate {

public:

    DescribeTemplateAliasResponsePrivate(DescribeTemplateAliasResponse * const q);
