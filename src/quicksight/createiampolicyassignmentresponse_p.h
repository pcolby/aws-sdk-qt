...
class QTAWS_EXPORT CreateIAMPolicyAssignmentResponsePrivate : public QuickSightResponsePrivate {

public:

    CreateIAMPolicyAssignmentResponsePrivate(CreateIAMPolicyAssignmentResponse * const q);
