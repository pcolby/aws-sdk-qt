...
/*!
 * \class QtAws::QuickSight::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for QuickSight TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : QuickSightResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(QuickSightResponse::request());
}

/*!
 * \reimp
 * Parses a successful QuickSight TagResource \a response.
 */
...
/*!
 * \class QtAws::QuickSight::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : QuickSightResponsePrivate(q)
{

}

/*!
 * Parses a QuickSight TagResource response element from \a xml.
 */
