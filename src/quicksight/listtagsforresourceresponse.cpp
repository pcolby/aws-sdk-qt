...
/*!
 * \class QtAws::QuickSight::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for QuickSight ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : QuickSightResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(QuickSightResponse::request());
}

/*!
 * \reimp
 * Parses a successful QuickSight ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::QuickSight::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : QuickSightResponsePrivate(q)
{

}

/*!
 * Parses a QuickSight ListTagsForResource response element from \a xml.
 */
