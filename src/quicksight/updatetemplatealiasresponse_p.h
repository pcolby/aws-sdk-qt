...
class QTAWS_EXPORT UpdateTemplateAliasResponsePrivate : public QuickSightResponsePrivate {

public:

    UpdateTemplateAliasResponsePrivate(UpdateTemplateAliasResponse * const q);
