...
class QTAWS_EXPORT ListIAMPolicyAssignmentsResponsePrivate : public QuickSightResponsePrivate {

public:

    ListIAMPolicyAssignmentsResponsePrivate(ListIAMPolicyAssignmentsResponse * const q);
