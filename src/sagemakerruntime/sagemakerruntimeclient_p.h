...
class QTAWS_EXPORT SageMakerRuntimeClientPrivate : public QtAws::Core::AwsAbstractClientPrivate {

public:
    SageMakerRuntimeClientPrivate(SageMakerRuntimeClient * const q);
