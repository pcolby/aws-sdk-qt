...
class QTAWSSAGEMAKERRUNTIME_EXPORT SageMakerRuntimeRequest : public QtAws::Core::AwsAbstractRequest {
...
protected:
    /// @cond internal
    SageMakerRuntimeRequestPrivate * const d_ptr; ///< Internal d-pointer.
