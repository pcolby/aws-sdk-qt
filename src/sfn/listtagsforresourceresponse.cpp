...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : SfnResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(SfnResponse::request());
}
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : SfnResponsePrivate(q)
{
