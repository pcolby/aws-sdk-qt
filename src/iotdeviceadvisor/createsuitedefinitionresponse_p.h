...
class QTAWS_EXPORT CreateSuiteDefinitionResponsePrivate : public IoTDeviceAdvisorResponsePrivate {

public:

    CreateSuiteDefinitionResponsePrivate(CreateSuiteDefinitionResponse * const q);
