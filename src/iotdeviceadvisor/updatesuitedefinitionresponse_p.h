...
class QTAWS_EXPORT UpdateSuiteDefinitionResponsePrivate : public IoTDeviceAdvisorResponsePrivate {

public:

    UpdateSuiteDefinitionResponsePrivate(UpdateSuiteDefinitionResponse * const q);
