...
class QTAWS_EXPORT GetSuiteDefinitionResponsePrivate : public IoTDeviceAdvisorResponsePrivate {

public:

    GetSuiteDefinitionResponsePrivate(GetSuiteDefinitionResponse * const q);
