...
class QTAWS_EXPORT DescribeServiceAccessPoliciesResponse : public DescribeServiceAccessPoliciesResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeServiceAccessPoliciesRequest * request() const;
