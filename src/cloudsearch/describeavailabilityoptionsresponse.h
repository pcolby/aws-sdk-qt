...
class QTAWS_EXPORT DescribeAvailabilityOptionsResponse : public CloudSearchResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeAvailabilityOptionsRequest * request() const override;
