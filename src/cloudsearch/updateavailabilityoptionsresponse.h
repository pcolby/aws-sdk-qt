...
class QTAWS_EXPORT UpdateAvailabilityOptionsResponse : public UpdateAvailabilityOptionsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const UpdateAvailabilityOptionsRequest * request() const;
