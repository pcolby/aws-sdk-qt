...
#ifndef QTAWS_UPDATEDOMAINENDPOINTOPTIONSREQUEST_H
#define QTAWS_UPDATEDOMAINENDPOINTOPTIONSREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(UpdateDomainEndpointOptionsRequest)
