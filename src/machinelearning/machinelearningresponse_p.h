...
class QTAWS_EXPORT MachineLearningResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {

public:

    MachineLearningResponsePrivate(MachineLearningResponse * const q);
