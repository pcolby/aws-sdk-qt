...
class QTAWSMACHINELEARNING_EXPORT DescribeEvaluationsResponse : public MachineLearningResponse {
    Q_OBJECT

public:
    DescribeEvaluationsResponse(const DescribeEvaluationsRequest &request, QNetworkReply * const reply, QObject * const parent = 0);

    virtual const DescribeEvaluationsRequest * request() const Q_DECL_OVERRIDE;
