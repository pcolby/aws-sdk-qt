...
class QTAWSMACHINELEARNING_EXPORT DeleteBatchPredictionResponse : public MachineLearningResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteBatchPredictionRequest * request() const Q_DECL_OVERRIDE;
