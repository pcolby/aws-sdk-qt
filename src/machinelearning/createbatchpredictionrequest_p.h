...
class QTAWS_EXPORT CreateBatchPredictionRequestPrivate : public MachineLearningPrivate {

public:
    CreateBatchPredictionRequestPrivate(const MachineLearning::Action action,
