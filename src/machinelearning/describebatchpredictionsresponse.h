...
class QTAWS_EXPORT DescribeBatchPredictionsResponse : public DescribeBatchPredictionsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeBatchPredictionsRequest * request() const;
