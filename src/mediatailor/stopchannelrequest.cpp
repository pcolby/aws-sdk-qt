...
/*!
 * \class QtAws::MediaTailor::StopChannelRequest
 * \brief The StopChannelRequest class provides an interface for MediaTailor StopChannel requests.
 *
...
StopChannelRequest::StopChannelRequest(const StopChannelRequest &other)
    : MediaTailorRequest(new StopChannelRequestPrivate(*other.d_func(), this))
{
...
StopChannelRequest::StopChannelRequest()
    : MediaTailorRequest(new StopChannelRequestPrivate(MediaTailorRequest::StopChannelAction, this))
{
...
/*!
 * \class QtAws::MediaTailor::StopChannelRequestPrivate
...
/*!
 * Constructs a StopChannelRequestPrivate object for MediaTailor \a action,
 * with public implementation \a q.
 */
StopChannelRequestPrivate::StopChannelRequestPrivate(
    const MediaTailorRequest::Action action, StopChannelRequest * const q)
