...
class QTAWS_EXPORT DeletePlaybackConfigurationResponse : public MediaTailorResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeletePlaybackConfigurationRequest * request() const override;
