...
/*!
 * \class QtAws::MediaTailor::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for MediaTailor ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : MediaTailorResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(MediaTailorResponse::request());
}

/*!
 * \reimp
 * Parses a successful MediaTailor ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::MediaTailor::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : MediaTailorResponsePrivate(q)
{

}

/*!
 * Parses a MediaTailor ListTagsForResource response element from \a xml.
 */
