...
/*!
 * \class QtAws::MediaTailor::StartChannelResponse
 * \brief The StartChannelResponse class provides an interace for MediaTailor StartChannel responses.
 *
...
StartChannelResponse::StartChannelResponse(
    ...
    : MediaTailorResponse(new StartChannelResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful MediaTailor StartChannel \a response.
 */
...
/*!
 * \class QtAws::MediaTailor::StartChannelResponsePrivate
...
StartChannelResponsePrivate::StartChannelResponsePrivate(
    StartChannelResponse * const q) : MediaTailorResponsePrivate(q)
{

}

/*!
 * Parses a MediaTailor StartChannel response element from \a xml.
 */
