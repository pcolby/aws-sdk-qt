...
#include "notifyresourcedeploymentstatuschangerequest_p.h"
...
/*!
 * \class QtAws::Proton::NotifyResourceDeploymentStatusChangeRequest
 * \brief The NotifyResourceDeploymentStatusChangeRequest class provides an interface for Proton NotifyResourceDeploymentStatusChange requests.
 *
 ...
 */
NotifyResourceDeploymentStatusChangeRequest::NotifyResourceDeploymentStatusChangeRequest(const NotifyResourceDeploymentStatusChangeRequest &other)
    : ProtonRequest(new NotifyResourceDeploymentStatusChangeRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a NotifyResourceDeploymentStatusChangeRequest object.
 */
NotifyResourceDeploymentStatusChangeRequest::NotifyResourceDeploymentStatusChangeRequest()
    : ProtonRequest(new NotifyResourceDeploymentStatusChangeRequestPrivate(ProtonRequest::NotifyResourceDeploymentStatusChangeAction, this))
{
 ...
 * \reimp
 */
bool NotifyResourceDeploymentStatusChangeRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a NotifyResourceDeploymentStatusChangeResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * NotifyResourceDeploymentStatusChangeRequest::response(QNetworkReply * const reply) const
{
    return new NotifyResourceDeploymentStatusChangeResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::NotifyResourceDeploymentStatusChangeRequestPrivate
 * \brief The NotifyResourceDeploymentStatusChangeRequestPrivate class provides private implementation for NotifyResourceDeploymentStatusChangeRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a NotifyResourceDeploymentStatusChangeRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
NotifyResourceDeploymentStatusChangeRequestPrivate::NotifyResourceDeploymentStatusChangeRequestPrivate(
    const ProtonRequest::Action action, NotifyResourceDeploymentStatusChangeRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the NotifyResourceDeploymentStatusChangeRequest
 * class' copy constructor.
 */
NotifyResourceDeploymentStatusChangeRequestPrivate::NotifyResourceDeploymentStatusChangeRequestPrivate(
    const NotifyResourceDeploymentStatusChangeRequestPrivate &other, NotifyResourceDeploymentStatusChangeRequest * const q)
