...
#include "updateservicetemplateversionrequest_p.h"
...
/*!
 * \class QtAws::Proton::UpdateServiceTemplateVersionRequest
 * \brief The UpdateServiceTemplateVersionRequest class provides an interface for Proton UpdateServiceTemplateVersion requests.
 *
 ...
 */
UpdateServiceTemplateVersionRequest::UpdateServiceTemplateVersionRequest(const UpdateServiceTemplateVersionRequest &other)
    : ProtonRequest(new UpdateServiceTemplateVersionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateServiceTemplateVersionRequest object.
 */
UpdateServiceTemplateVersionRequest::UpdateServiceTemplateVersionRequest()
    : ProtonRequest(new UpdateServiceTemplateVersionRequestPrivate(ProtonRequest::UpdateServiceTemplateVersionAction, this))
{
 ...
 * \reimp
 */
bool UpdateServiceTemplateVersionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateServiceTemplateVersionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateServiceTemplateVersionRequest::response(QNetworkReply * const reply) const
{
    return new UpdateServiceTemplateVersionResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::UpdateServiceTemplateVersionRequestPrivate
 * \brief The UpdateServiceTemplateVersionRequestPrivate class provides private implementation for UpdateServiceTemplateVersionRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateServiceTemplateVersionRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
UpdateServiceTemplateVersionRequestPrivate::UpdateServiceTemplateVersionRequestPrivate(
    const ProtonRequest::Action action, UpdateServiceTemplateVersionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateServiceTemplateVersionRequest
 * class' copy constructor.
 */
UpdateServiceTemplateVersionRequestPrivate::UpdateServiceTemplateVersionRequestPrivate(
    const UpdateServiceTemplateVersionRequestPrivate &other, UpdateServiceTemplateVersionRequest * const q)
