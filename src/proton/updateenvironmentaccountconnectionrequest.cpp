...
#include "updateenvironmentaccountconnectionrequest_p.h"
...
/*!
 * \class QtAws::Proton::UpdateEnvironmentAccountConnectionRequest
 * \brief The UpdateEnvironmentAccountConnectionRequest class provides an interface for Proton UpdateEnvironmentAccountConnection requests.
 *
 ...
 */
UpdateEnvironmentAccountConnectionRequest::UpdateEnvironmentAccountConnectionRequest(const UpdateEnvironmentAccountConnectionRequest &other)
    : ProtonRequest(new UpdateEnvironmentAccountConnectionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateEnvironmentAccountConnectionRequest object.
 */
UpdateEnvironmentAccountConnectionRequest::UpdateEnvironmentAccountConnectionRequest()
    : ProtonRequest(new UpdateEnvironmentAccountConnectionRequestPrivate(ProtonRequest::UpdateEnvironmentAccountConnectionAction, this))
{
 ...
 * \reimp
 */
bool UpdateEnvironmentAccountConnectionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateEnvironmentAccountConnectionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateEnvironmentAccountConnectionRequest::response(QNetworkReply * const reply) const
{
    return new UpdateEnvironmentAccountConnectionResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::UpdateEnvironmentAccountConnectionRequestPrivate
 * \brief The UpdateEnvironmentAccountConnectionRequestPrivate class provides private implementation for UpdateEnvironmentAccountConnectionRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateEnvironmentAccountConnectionRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
UpdateEnvironmentAccountConnectionRequestPrivate::UpdateEnvironmentAccountConnectionRequestPrivate(
    const ProtonRequest::Action action, UpdateEnvironmentAccountConnectionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateEnvironmentAccountConnectionRequest
 * class' copy constructor.
 */
UpdateEnvironmentAccountConnectionRequestPrivate::UpdateEnvironmentAccountConnectionRequestPrivate(
    const UpdateEnvironmentAccountConnectionRequestPrivate &other, UpdateEnvironmentAccountConnectionRequest * const q)
