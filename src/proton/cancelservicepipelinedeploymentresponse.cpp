...
#include "cancelservicepipelinedeploymentresponse_p.h"
...
/*!
 * \class QtAws::Proton::CancelServicePipelineDeploymentResponse
 * \brief The CancelServicePipelineDeploymentResponse class provides an interace for Proton CancelServicePipelineDeployment responses.
 *
 ...
 *
 * \sa ProtonClient::cancelServicePipelineDeployment
 */

/*!
 * Constructs a CancelServicePipelineDeploymentResponse object for \a reply to \a request, with parent \a parent.
 */
CancelServicePipelineDeploymentResponse::CancelServicePipelineDeploymentResponse(
        const CancelServicePipelineDeploymentRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new CancelServicePipelineDeploymentResponsePrivate(this), parent)
{
    setRequest(new CancelServicePipelineDeploymentRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CancelServicePipelineDeploymentRequest * CancelServicePipelineDeploymentResponse::request() const
{
    Q_D(const CancelServicePipelineDeploymentResponse);
    return static_cast<const CancelServicePipelineDeploymentRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton CancelServicePipelineDeployment \a response.
 */
void CancelServicePipelineDeploymentResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CancelServicePipelineDeploymentResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::CancelServicePipelineDeploymentResponsePrivate
 * \brief The CancelServicePipelineDeploymentResponsePrivate class provides private implementation for CancelServicePipelineDeploymentResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CancelServicePipelineDeploymentResponsePrivate object with public implementation \a q.
 */
CancelServicePipelineDeploymentResponsePrivate::CancelServicePipelineDeploymentResponsePrivate(
    CancelServicePipelineDeploymentResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton CancelServicePipelineDeployment response element from \a xml.
 */
void CancelServicePipelineDeploymentResponsePrivate::parseCancelServicePipelineDeploymentResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CancelServicePipelineDeploymentResponse"));
    Q_UNUSED(xml) ///< @todo
}
