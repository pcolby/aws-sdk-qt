...
#include "gettemplatesyncstatusresponse_p.h"
...
/*!
 * \class QtAws::Proton::GetTemplateSyncStatusResponse
 * \brief The GetTemplateSyncStatusResponse class provides an interace for Proton GetTemplateSyncStatus responses.
 *
 ...
 *
 * \sa ProtonClient::getTemplateSyncStatus
 */

/*!
 * Constructs a GetTemplateSyncStatusResponse object for \a reply to \a request, with parent \a parent.
 */
GetTemplateSyncStatusResponse::GetTemplateSyncStatusResponse(
        const GetTemplateSyncStatusRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new GetTemplateSyncStatusResponsePrivate(this), parent)
{
    setRequest(new GetTemplateSyncStatusRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetTemplateSyncStatusRequest * GetTemplateSyncStatusResponse::request() const
{
    Q_D(const GetTemplateSyncStatusResponse);
    return static_cast<const GetTemplateSyncStatusRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton GetTemplateSyncStatus \a response.
 */
void GetTemplateSyncStatusResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetTemplateSyncStatusResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::GetTemplateSyncStatusResponsePrivate
 * \brief The GetTemplateSyncStatusResponsePrivate class provides private implementation for GetTemplateSyncStatusResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetTemplateSyncStatusResponsePrivate object with public implementation \a q.
 */
GetTemplateSyncStatusResponsePrivate::GetTemplateSyncStatusResponsePrivate(
    GetTemplateSyncStatusResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton GetTemplateSyncStatus response element from \a xml.
 */
void GetTemplateSyncStatusResponsePrivate::parseGetTemplateSyncStatusResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetTemplateSyncStatusResponse"));
    Q_UNUSED(xml) ///< @todo
}
