...
#include "listcomponentprovisionedresourcesrequest_p.h"
...
/*!
 * \class QtAws::Proton::ListComponentProvisionedResourcesRequest
 * \brief The ListComponentProvisionedResourcesRequest class provides an interface for Proton ListComponentProvisionedResources requests.
 *
 ...
 */
ListComponentProvisionedResourcesRequest::ListComponentProvisionedResourcesRequest(const ListComponentProvisionedResourcesRequest &other)
    : ProtonRequest(new ListComponentProvisionedResourcesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListComponentProvisionedResourcesRequest object.
 */
ListComponentProvisionedResourcesRequest::ListComponentProvisionedResourcesRequest()
    : ProtonRequest(new ListComponentProvisionedResourcesRequestPrivate(ProtonRequest::ListComponentProvisionedResourcesAction, this))
{
 ...
 * \reimp
 */
bool ListComponentProvisionedResourcesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListComponentProvisionedResourcesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListComponentProvisionedResourcesRequest::response(QNetworkReply * const reply) const
{
    return new ListComponentProvisionedResourcesResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::ListComponentProvisionedResourcesRequestPrivate
 * \brief The ListComponentProvisionedResourcesRequestPrivate class provides private implementation for ListComponentProvisionedResourcesRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListComponentProvisionedResourcesRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListComponentProvisionedResourcesRequestPrivate::ListComponentProvisionedResourcesRequestPrivate(
    const ProtonRequest::Action action, ListComponentProvisionedResourcesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListComponentProvisionedResourcesRequest
 * class' copy constructor.
 */
ListComponentProvisionedResourcesRequestPrivate::ListComponentProvisionedResourcesRequestPrivate(
    const ListComponentProvisionedResourcesRequestPrivate &other, ListComponentProvisionedResourcesRequest * const q)
