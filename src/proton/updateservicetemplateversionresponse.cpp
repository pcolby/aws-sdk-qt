...
#include "updateservicetemplateversionresponse_p.h"
...
/*!
 * \class QtAws::Proton::UpdateServiceTemplateVersionResponse
 * \brief The UpdateServiceTemplateVersionResponse class provides an interace for Proton UpdateServiceTemplateVersion responses.
 *
 ...
 *
 * \sa ProtonClient::updateServiceTemplateVersion
 */

/*!
 * Constructs a UpdateServiceTemplateVersionResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateServiceTemplateVersionResponse::UpdateServiceTemplateVersionResponse(
        const UpdateServiceTemplateVersionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new UpdateServiceTemplateVersionResponsePrivate(this), parent)
{
    setRequest(new UpdateServiceTemplateVersionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateServiceTemplateVersionRequest * UpdateServiceTemplateVersionResponse::request() const
{
    Q_D(const UpdateServiceTemplateVersionResponse);
    return static_cast<const UpdateServiceTemplateVersionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton UpdateServiceTemplateVersion \a response.
 */
void UpdateServiceTemplateVersionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateServiceTemplateVersionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::UpdateServiceTemplateVersionResponsePrivate
 * \brief The UpdateServiceTemplateVersionResponsePrivate class provides private implementation for UpdateServiceTemplateVersionResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateServiceTemplateVersionResponsePrivate object with public implementation \a q.
 */
UpdateServiceTemplateVersionResponsePrivate::UpdateServiceTemplateVersionResponsePrivate(
    UpdateServiceTemplateVersionResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton UpdateServiceTemplateVersion response element from \a xml.
 */
void UpdateServiceTemplateVersionResponsePrivate::parseUpdateServiceTemplateVersionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateServiceTemplateVersionResponse"));
    Q_UNUSED(xml) ///< @todo
}
