...
class QTAWS_EXPORT ListEnvironmentTemplateVersionsResponsePrivate : public ProtonResponsePrivate {

public:

    ListEnvironmentTemplateVersionsResponsePrivate(ListEnvironmentTemplateVersionsResponse * const q);
