...
#include "updateenvironmenttemplateversionresponse_p.h"
...
/*!
 * \class QtAws::Proton::UpdateEnvironmentTemplateVersionResponse
 * \brief The UpdateEnvironmentTemplateVersionResponse class provides an interace for Proton UpdateEnvironmentTemplateVersion responses.
 *
 ...
 *
 * \sa ProtonClient::updateEnvironmentTemplateVersion
 */

/*!
 * Constructs a UpdateEnvironmentTemplateVersionResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateEnvironmentTemplateVersionResponse::UpdateEnvironmentTemplateVersionResponse(
        const UpdateEnvironmentTemplateVersionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new UpdateEnvironmentTemplateVersionResponsePrivate(this), parent)
{
    setRequest(new UpdateEnvironmentTemplateVersionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateEnvironmentTemplateVersionRequest * UpdateEnvironmentTemplateVersionResponse::request() const
{
    Q_D(const UpdateEnvironmentTemplateVersionResponse);
    return static_cast<const UpdateEnvironmentTemplateVersionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton UpdateEnvironmentTemplateVersion \a response.
 */
void UpdateEnvironmentTemplateVersionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateEnvironmentTemplateVersionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::UpdateEnvironmentTemplateVersionResponsePrivate
 * \brief The UpdateEnvironmentTemplateVersionResponsePrivate class provides private implementation for UpdateEnvironmentTemplateVersionResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateEnvironmentTemplateVersionResponsePrivate object with public implementation \a q.
 */
UpdateEnvironmentTemplateVersionResponsePrivate::UpdateEnvironmentTemplateVersionResponsePrivate(
    UpdateEnvironmentTemplateVersionResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton UpdateEnvironmentTemplateVersion response element from \a xml.
 */
void UpdateEnvironmentTemplateVersionResponsePrivate::parseUpdateEnvironmentTemplateVersionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateEnvironmentTemplateVersionResponse"));
    Q_UNUSED(xml) ///< @todo
}
