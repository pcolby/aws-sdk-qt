...
/*!
 * \class QtAws::Proton::GetComponentRequest
 * \brief The GetComponentRequest class provides an interface for Proton GetComponent requests.
 *
...
GetComponentRequest::GetComponentRequest(const GetComponentRequest &other)
    : ProtonRequest(new GetComponentRequestPrivate(*other.d_func(), this))
{
...
GetComponentRequest::GetComponentRequest()
    : ProtonRequest(new GetComponentRequestPrivate(ProtonRequest::GetComponentAction, this))
{
...
/*!
 * \class QtAws::Proton::GetComponentRequestPrivate
...
/*!
 * Constructs a GetComponentRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
GetComponentRequestPrivate::GetComponentRequestPrivate(
    const ProtonRequest::Action action, GetComponentRequest * const q)
