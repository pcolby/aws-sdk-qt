...
#include "updateenvironmenttemplateversionrequest_p.h"
...
/*!
 * \class QtAws::Proton::UpdateEnvironmentTemplateVersionRequest
 * \brief The UpdateEnvironmentTemplateVersionRequest class provides an interface for Proton UpdateEnvironmentTemplateVersion requests.
 *
 ...
 */
UpdateEnvironmentTemplateVersionRequest::UpdateEnvironmentTemplateVersionRequest(const UpdateEnvironmentTemplateVersionRequest &other)
    : ProtonRequest(new UpdateEnvironmentTemplateVersionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateEnvironmentTemplateVersionRequest object.
 */
UpdateEnvironmentTemplateVersionRequest::UpdateEnvironmentTemplateVersionRequest()
    : ProtonRequest(new UpdateEnvironmentTemplateVersionRequestPrivate(ProtonRequest::UpdateEnvironmentTemplateVersionAction, this))
{
 ...
 * \reimp
 */
bool UpdateEnvironmentTemplateVersionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateEnvironmentTemplateVersionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateEnvironmentTemplateVersionRequest::response(QNetworkReply * const reply) const
{
    return new UpdateEnvironmentTemplateVersionResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::UpdateEnvironmentTemplateVersionRequestPrivate
 * \brief The UpdateEnvironmentTemplateVersionRequestPrivate class provides private implementation for UpdateEnvironmentTemplateVersionRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateEnvironmentTemplateVersionRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
UpdateEnvironmentTemplateVersionRequestPrivate::UpdateEnvironmentTemplateVersionRequestPrivate(
    const ProtonRequest::Action action, UpdateEnvironmentTemplateVersionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateEnvironmentTemplateVersionRequest
 * class' copy constructor.
 */
UpdateEnvironmentTemplateVersionRequestPrivate::UpdateEnvironmentTemplateVersionRequestPrivate(
    const UpdateEnvironmentTemplateVersionRequestPrivate &other, UpdateEnvironmentTemplateVersionRequest * const q)
