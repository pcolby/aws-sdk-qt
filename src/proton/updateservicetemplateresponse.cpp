...
#include "updateservicetemplateresponse_p.h"
...
/*!
 * \class QtAws::Proton::UpdateServiceTemplateResponse
 * \brief The UpdateServiceTemplateResponse class provides an interace for Proton UpdateServiceTemplate responses.
 *
...
/*!
 * Constructs a UpdateServiceTemplateResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateServiceTemplateResponse::UpdateServiceTemplateResponse(
        const UpdateServiceTemplateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new UpdateServiceTemplateResponsePrivate(this), parent)
{
    setRequest(new UpdateServiceTemplateRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton UpdateServiceTemplate \a response.
 */
void UpdateServiceTemplateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateServiceTemplateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::UpdateServiceTemplateResponsePrivate
 * \brief The UpdateServiceTemplateResponsePrivate class provides private implementation for UpdateServiceTemplateResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateServiceTemplateResponsePrivate object with public implementation \a q.
 */
UpdateServiceTemplateResponsePrivate::UpdateServiceTemplateResponsePrivate(
    UpdateServiceTemplateResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton UpdateServiceTemplate response element from \a xml.
 */
void UpdateServiceTemplateResponsePrivate::parseUpdateServiceTemplateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateServiceTemplateResponse"));
    Q_UNUSED(xml) ///< @todo
}
