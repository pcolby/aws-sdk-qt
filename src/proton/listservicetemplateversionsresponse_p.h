...
class QTAWS_EXPORT ListServiceTemplateVersionsResponsePrivate : public ProtonResponsePrivate {

public:

    ListServiceTemplateVersionsResponsePrivate(ListServiceTemplateVersionsResponse * const q);
