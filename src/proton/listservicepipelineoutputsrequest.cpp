...
#include "listservicepipelineoutputsrequest_p.h"
...
/*!
 * \class QtAws::Proton::ListServicePipelineOutputsRequest
 * \brief The ListServicePipelineOutputsRequest class provides an interface for Proton ListServicePipelineOutputs requests.
 *
 ...
 */
ListServicePipelineOutputsRequest::ListServicePipelineOutputsRequest(const ListServicePipelineOutputsRequest &other)
    : ProtonRequest(new ListServicePipelineOutputsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListServicePipelineOutputsRequest object.
 */
ListServicePipelineOutputsRequest::ListServicePipelineOutputsRequest()
    : ProtonRequest(new ListServicePipelineOutputsRequestPrivate(ProtonRequest::ListServicePipelineOutputsAction, this))
{
 ...
 * \reimp
 */
bool ListServicePipelineOutputsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListServicePipelineOutputsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListServicePipelineOutputsRequest::response(QNetworkReply * const reply) const
{
    return new ListServicePipelineOutputsResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::ListServicePipelineOutputsRequestPrivate
 * \brief The ListServicePipelineOutputsRequestPrivate class provides private implementation for ListServicePipelineOutputsRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListServicePipelineOutputsRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListServicePipelineOutputsRequestPrivate::ListServicePipelineOutputsRequestPrivate(
    const ProtonRequest::Action action, ListServicePipelineOutputsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListServicePipelineOutputsRequest
 * class' copy constructor.
 */
ListServicePipelineOutputsRequestPrivate::ListServicePipelineOutputsRequestPrivate(
    const ListServicePipelineOutputsRequestPrivate &other, ListServicePipelineOutputsRequest * const q)
