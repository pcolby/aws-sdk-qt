...
#include "listenvironmenttemplateversionsresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListEnvironmentTemplateVersionsResponse
 * \brief The ListEnvironmentTemplateVersionsResponse class provides an interace for Proton ListEnvironmentTemplateVersions responses.
 *
 ...
 *
 * \sa ProtonClient::listEnvironmentTemplateVersions
 */

/*!
 * Constructs a ListEnvironmentTemplateVersionsResponse object for \a reply to \a request, with parent \a parent.
 */
ListEnvironmentTemplateVersionsResponse::ListEnvironmentTemplateVersionsResponse(
        const ListEnvironmentTemplateVersionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListEnvironmentTemplateVersionsResponsePrivate(this), parent)
{
    setRequest(new ListEnvironmentTemplateVersionsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListEnvironmentTemplateVersionsRequest * ListEnvironmentTemplateVersionsResponse::request() const
{
    Q_D(const ListEnvironmentTemplateVersionsResponse);
    return static_cast<const ListEnvironmentTemplateVersionsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton ListEnvironmentTemplateVersions \a response.
 */
void ListEnvironmentTemplateVersionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListEnvironmentTemplateVersionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListEnvironmentTemplateVersionsResponsePrivate
 * \brief The ListEnvironmentTemplateVersionsResponsePrivate class provides private implementation for ListEnvironmentTemplateVersionsResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListEnvironmentTemplateVersionsResponsePrivate object with public implementation \a q.
 */
ListEnvironmentTemplateVersionsResponsePrivate::ListEnvironmentTemplateVersionsResponsePrivate(
    ListEnvironmentTemplateVersionsResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListEnvironmentTemplateVersions response element from \a xml.
 */
void ListEnvironmentTemplateVersionsResponsePrivate::parseListEnvironmentTemplateVersionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListEnvironmentTemplateVersionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
