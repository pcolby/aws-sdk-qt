...
#include "deleteservicetemplateresponse_p.h"
...
/*!
 * \class QtAws::Proton::DeleteServiceTemplateResponse
 * \brief The DeleteServiceTemplateResponse class provides an interace for Proton DeleteServiceTemplate responses.
 *
...
/*!
 * Constructs a DeleteServiceTemplateResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteServiceTemplateResponse::DeleteServiceTemplateResponse(
        const DeleteServiceTemplateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new DeleteServiceTemplateResponsePrivate(this), parent)
{
    setRequest(new DeleteServiceTemplateRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton DeleteServiceTemplate \a response.
 */
void DeleteServiceTemplateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteServiceTemplateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::DeleteServiceTemplateResponsePrivate
 * \brief The DeleteServiceTemplateResponsePrivate class provides private implementation for DeleteServiceTemplateResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a DeleteServiceTemplateResponsePrivate object with public implementation \a q.
 */
DeleteServiceTemplateResponsePrivate::DeleteServiceTemplateResponsePrivate(
    DeleteServiceTemplateResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton DeleteServiceTemplate response element from \a xml.
 */
void DeleteServiceTemplateResponsePrivate::parseDeleteServiceTemplateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteServiceTemplateResponse"));
    Q_UNUSED(xml) ///< @todo
}
