...
class QTAWS_EXPORT UpdateServiceTemplateResponsePrivate : public ProtonResponsePrivate {

public:

    UpdateServiceTemplateResponsePrivate(UpdateServiceTemplateResponse * const q);
