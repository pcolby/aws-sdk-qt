...
#include "createtemplatesyncconfigrequest_p.h"
...
/*!
 * \class QtAws::Proton::CreateTemplateSyncConfigRequest
 * \brief The CreateTemplateSyncConfigRequest class provides an interface for Proton CreateTemplateSyncConfig requests.
 *
 ...
 */
CreateTemplateSyncConfigRequest::CreateTemplateSyncConfigRequest(const CreateTemplateSyncConfigRequest &other)
    : ProtonRequest(new CreateTemplateSyncConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateTemplateSyncConfigRequest object.
 */
CreateTemplateSyncConfigRequest::CreateTemplateSyncConfigRequest()
    : ProtonRequest(new CreateTemplateSyncConfigRequestPrivate(ProtonRequest::CreateTemplateSyncConfigAction, this))
{
 ...
 * \reimp
 */
bool CreateTemplateSyncConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateTemplateSyncConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateTemplateSyncConfigRequest::response(QNetworkReply * const reply) const
{
    return new CreateTemplateSyncConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::CreateTemplateSyncConfigRequestPrivate
 * \brief The CreateTemplateSyncConfigRequestPrivate class provides private implementation for CreateTemplateSyncConfigRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CreateTemplateSyncConfigRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
CreateTemplateSyncConfigRequestPrivate::CreateTemplateSyncConfigRequestPrivate(
    const ProtonRequest::Action action, CreateTemplateSyncConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateTemplateSyncConfigRequest
 * class' copy constructor.
 */
CreateTemplateSyncConfigRequestPrivate::CreateTemplateSyncConfigRequestPrivate(
    const CreateTemplateSyncConfigRequestPrivate &other, CreateTemplateSyncConfigRequest * const q)
