...
#include "listcomponentprovisionedresourcesresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListComponentProvisionedResourcesResponse
 * \brief The ListComponentProvisionedResourcesResponse class provides an interace for Proton ListComponentProvisionedResources responses.
 *
 ...
 *
 * \sa ProtonClient::listComponentProvisionedResources
 */

/*!
 * Constructs a ListComponentProvisionedResourcesResponse object for \a reply to \a request, with parent \a parent.
 */
ListComponentProvisionedResourcesResponse::ListComponentProvisionedResourcesResponse(
        const ListComponentProvisionedResourcesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListComponentProvisionedResourcesResponsePrivate(this), parent)
{
    setRequest(new ListComponentProvisionedResourcesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListComponentProvisionedResourcesRequest * ListComponentProvisionedResourcesResponse::request() const
{
    Q_D(const ListComponentProvisionedResourcesResponse);
    return static_cast<const ListComponentProvisionedResourcesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton ListComponentProvisionedResources \a response.
 */
void ListComponentProvisionedResourcesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListComponentProvisionedResourcesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListComponentProvisionedResourcesResponsePrivate
 * \brief The ListComponentProvisionedResourcesResponsePrivate class provides private implementation for ListComponentProvisionedResourcesResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListComponentProvisionedResourcesResponsePrivate object with public implementation \a q.
 */
ListComponentProvisionedResourcesResponsePrivate::ListComponentProvisionedResourcesResponsePrivate(
    ListComponentProvisionedResourcesResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListComponentProvisionedResources response element from \a xml.
 */
void ListComponentProvisionedResourcesResponsePrivate::parseListComponentProvisionedResourcesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListComponentProvisionedResourcesResponse"));
    Q_UNUSED(xml) ///< @todo
}
