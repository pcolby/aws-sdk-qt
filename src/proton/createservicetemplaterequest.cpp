...
#include "createservicetemplaterequest_p.h"
...
/*!
 * \class QtAws::Proton::CreateServiceTemplateRequest
 * \brief The CreateServiceTemplateRequest class provides an interface for Proton CreateServiceTemplate requests.
 *
 ...
 */
CreateServiceTemplateRequest::CreateServiceTemplateRequest(const CreateServiceTemplateRequest &other)
    : ProtonRequest(new CreateServiceTemplateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateServiceTemplateRequest object.
 */
CreateServiceTemplateRequest::CreateServiceTemplateRequest()
    : ProtonRequest(new CreateServiceTemplateRequestPrivate(ProtonRequest::CreateServiceTemplateAction, this))
{
 ...
 * \reimp
 */
bool CreateServiceTemplateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateServiceTemplateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateServiceTemplateRequest::response(QNetworkReply * const reply) const
{
    return new CreateServiceTemplateResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::CreateServiceTemplateRequestPrivate
 * \brief The CreateServiceTemplateRequestPrivate class provides private implementation for CreateServiceTemplateRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CreateServiceTemplateRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
CreateServiceTemplateRequestPrivate::CreateServiceTemplateRequestPrivate(
    const ProtonRequest::Action action, CreateServiceTemplateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateServiceTemplateRequest
 * class' copy constructor.
 */
CreateServiceTemplateRequestPrivate::CreateServiceTemplateRequestPrivate(
    const CreateServiceTemplateRequestPrivate &other, CreateServiceTemplateRequest * const q)
