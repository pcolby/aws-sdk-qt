...
#include "getserviceinstanceresponse_p.h"
...
/*!
 * \class QtAws::Proton::GetServiceInstanceResponse
 * \brief The GetServiceInstanceResponse class provides an interace for Proton GetServiceInstance responses.
 *
...
/*!
 * Constructs a GetServiceInstanceResponse object for \a reply to \a request, with parent \a parent.
 */
GetServiceInstanceResponse::GetServiceInstanceResponse(
        const GetServiceInstanceRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new GetServiceInstanceResponsePrivate(this), parent)
{
    setRequest(new GetServiceInstanceRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton GetServiceInstance \a response.
 */
void GetServiceInstanceResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetServiceInstanceResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::GetServiceInstanceResponsePrivate
 * \brief The GetServiceInstanceResponsePrivate class provides private implementation for GetServiceInstanceResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetServiceInstanceResponsePrivate object with public implementation \a q.
 */
GetServiceInstanceResponsePrivate::GetServiceInstanceResponsePrivate(
    GetServiceInstanceResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton GetServiceInstance response element from \a xml.
 */
void GetServiceInstanceResponsePrivate::parseGetServiceInstanceResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetServiceInstanceResponse"));
    Q_UNUSED(xml) ///< @todo
}
