...
/*!
 * \class QtAws::Proton::GetRepositoryResponse
 * \brief The GetRepositoryResponse class provides an interace for Proton GetRepository responses.
 *
...
GetRepositoryResponse::GetRepositoryResponse(
    ...
    : ProtonResponse(new GetRepositoryResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton GetRepository \a response.
 */
...
/*!
 * \class QtAws::Proton::GetRepositoryResponsePrivate
...
GetRepositoryResponsePrivate::GetRepositoryResponsePrivate(
    GetRepositoryResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton GetRepository response element from \a xml.
 */
