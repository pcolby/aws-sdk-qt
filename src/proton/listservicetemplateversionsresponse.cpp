...
#include "listservicetemplateversionsresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListServiceTemplateVersionsResponse
 * \brief The ListServiceTemplateVersionsResponse class provides an interace for Proton ListServiceTemplateVersions responses.
 *
...
/*!
 * Constructs a ListServiceTemplateVersionsResponse object for \a reply to \a request, with parent \a parent.
 */
ListServiceTemplateVersionsResponse::ListServiceTemplateVersionsResponse(
        const ListServiceTemplateVersionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListServiceTemplateVersionsResponsePrivate(this), parent)
{
    setRequest(new ListServiceTemplateVersionsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton ListServiceTemplateVersions \a response.
 */
void ListServiceTemplateVersionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListServiceTemplateVersionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListServiceTemplateVersionsResponsePrivate
 * \brief The ListServiceTemplateVersionsResponsePrivate class provides private implementation for ListServiceTemplateVersionsResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListServiceTemplateVersionsResponsePrivate object with public implementation \a q.
 */
ListServiceTemplateVersionsResponsePrivate::ListServiceTemplateVersionsResponsePrivate(
    ListServiceTemplateVersionsResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListServiceTemplateVersions response element from \a xml.
 */
void ListServiceTemplateVersionsResponsePrivate::parseListServiceTemplateVersionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListServiceTemplateVersionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
