...
#include "acceptenvironmentaccountconnectionrequest_p.h"
...
/*!
 * \class QtAws::Proton::AcceptEnvironmentAccountConnectionRequest
 * \brief The AcceptEnvironmentAccountConnectionRequest class provides an interface for Proton AcceptEnvironmentAccountConnection requests.
 *
 ...
 */
AcceptEnvironmentAccountConnectionRequest::AcceptEnvironmentAccountConnectionRequest(const AcceptEnvironmentAccountConnectionRequest &other)
    : ProtonRequest(new AcceptEnvironmentAccountConnectionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AcceptEnvironmentAccountConnectionRequest object.
 */
AcceptEnvironmentAccountConnectionRequest::AcceptEnvironmentAccountConnectionRequest()
    : ProtonRequest(new AcceptEnvironmentAccountConnectionRequestPrivate(ProtonRequest::AcceptEnvironmentAccountConnectionAction, this))
{
 ...
 * \reimp
 */
bool AcceptEnvironmentAccountConnectionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AcceptEnvironmentAccountConnectionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AcceptEnvironmentAccountConnectionRequest::response(QNetworkReply * const reply) const
{
    return new AcceptEnvironmentAccountConnectionResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::AcceptEnvironmentAccountConnectionRequestPrivate
 * \brief The AcceptEnvironmentAccountConnectionRequestPrivate class provides private implementation for AcceptEnvironmentAccountConnectionRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a AcceptEnvironmentAccountConnectionRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
AcceptEnvironmentAccountConnectionRequestPrivate::AcceptEnvironmentAccountConnectionRequestPrivate(
    const ProtonRequest::Action action, AcceptEnvironmentAccountConnectionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AcceptEnvironmentAccountConnectionRequest
 * class' copy constructor.
 */
AcceptEnvironmentAccountConnectionRequestPrivate::AcceptEnvironmentAccountConnectionRequestPrivate(
    const AcceptEnvironmentAccountConnectionRequestPrivate &other, AcceptEnvironmentAccountConnectionRequest * const q)
