...
#include "getenvironmenttemplateversionrequest_p.h"
...
/*!
 * \class QtAws::Proton::GetEnvironmentTemplateVersionRequest
 * \brief The GetEnvironmentTemplateVersionRequest class provides an interface for Proton GetEnvironmentTemplateVersion requests.
 *
 ...
 */
GetEnvironmentTemplateVersionRequest::GetEnvironmentTemplateVersionRequest(const GetEnvironmentTemplateVersionRequest &other)
    : ProtonRequest(new GetEnvironmentTemplateVersionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetEnvironmentTemplateVersionRequest object.
 */
GetEnvironmentTemplateVersionRequest::GetEnvironmentTemplateVersionRequest()
    : ProtonRequest(new GetEnvironmentTemplateVersionRequestPrivate(ProtonRequest::GetEnvironmentTemplateVersionAction, this))
{
 ...
 * \reimp
 */
bool GetEnvironmentTemplateVersionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetEnvironmentTemplateVersionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetEnvironmentTemplateVersionRequest::response(QNetworkReply * const reply) const
{
    return new GetEnvironmentTemplateVersionResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::GetEnvironmentTemplateVersionRequestPrivate
 * \brief The GetEnvironmentTemplateVersionRequestPrivate class provides private implementation for GetEnvironmentTemplateVersionRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetEnvironmentTemplateVersionRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
GetEnvironmentTemplateVersionRequestPrivate::GetEnvironmentTemplateVersionRequestPrivate(
    const ProtonRequest::Action action, GetEnvironmentTemplateVersionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetEnvironmentTemplateVersionRequest
 * class' copy constructor.
 */
GetEnvironmentTemplateVersionRequestPrivate::GetEnvironmentTemplateVersionRequestPrivate(
    const GetEnvironmentTemplateVersionRequestPrivate &other, GetEnvironmentTemplateVersionRequest * const q)
