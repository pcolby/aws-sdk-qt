...
/*!
 * \class QtAws::Proton::UpdateServiceResponse
 * \brief The UpdateServiceResponse class provides an interace for Proton UpdateService responses.
 *
...
UpdateServiceResponse::UpdateServiceResponse(
    ...
    : ProtonResponse(new UpdateServiceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton UpdateService \a response.
 */
...
/*!
 * \class QtAws::Proton::UpdateServiceResponsePrivate
...
UpdateServiceResponsePrivate::UpdateServiceResponsePrivate(
    UpdateServiceResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton UpdateService response element from \a xml.
 */
