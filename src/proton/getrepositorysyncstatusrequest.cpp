...
#include "getrepositorysyncstatusrequest_p.h"
...
/*!
 * \class QtAws::Proton::GetRepositorySyncStatusRequest
 * \brief The GetRepositorySyncStatusRequest class provides an interface for Proton GetRepositorySyncStatus requests.
 *
 ...
 */
GetRepositorySyncStatusRequest::GetRepositorySyncStatusRequest(const GetRepositorySyncStatusRequest &other)
    : ProtonRequest(new GetRepositorySyncStatusRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetRepositorySyncStatusRequest object.
 */
GetRepositorySyncStatusRequest::GetRepositorySyncStatusRequest()
    : ProtonRequest(new GetRepositorySyncStatusRequestPrivate(ProtonRequest::GetRepositorySyncStatusAction, this))
{
 ...
 * \reimp
 */
bool GetRepositorySyncStatusRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetRepositorySyncStatusResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetRepositorySyncStatusRequest::response(QNetworkReply * const reply) const
{
    return new GetRepositorySyncStatusResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::GetRepositorySyncStatusRequestPrivate
 * \brief The GetRepositorySyncStatusRequestPrivate class provides private implementation for GetRepositorySyncStatusRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetRepositorySyncStatusRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
GetRepositorySyncStatusRequestPrivate::GetRepositorySyncStatusRequestPrivate(
    const ProtonRequest::Action action, GetRepositorySyncStatusRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetRepositorySyncStatusRequest
 * class' copy constructor.
 */
GetRepositorySyncStatusRequestPrivate::GetRepositorySyncStatusRequestPrivate(
    const GetRepositorySyncStatusRequestPrivate &other, GetRepositorySyncStatusRequest * const q)
