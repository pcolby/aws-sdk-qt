...
/*!
 * \class QtAws::Proton::ListServicesRequest
 * \brief The ListServicesRequest class provides an interface for Proton ListServices requests.
 *
...
ListServicesRequest::ListServicesRequest(const ListServicesRequest &other)
    : ProtonRequest(new ListServicesRequestPrivate(*other.d_func(), this))
{
...
ListServicesRequest::ListServicesRequest()
    : ProtonRequest(new ListServicesRequestPrivate(ProtonRequest::ListServicesAction, this))
{
...
/*!
 * \class QtAws::Proton::ListServicesRequestPrivate
...
/*!
 * Constructs a ListServicesRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListServicesRequestPrivate::ListServicesRequestPrivate(
    const ProtonRequest::Action action, ListServicesRequest * const q)
