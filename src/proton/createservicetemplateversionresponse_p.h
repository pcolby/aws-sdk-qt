...
class QTAWS_EXPORT CreateServiceTemplateVersionResponsePrivate : public ProtonResponsePrivate {

public:

    CreateServiceTemplateVersionResponsePrivate(CreateServiceTemplateVersionResponse * const q);
