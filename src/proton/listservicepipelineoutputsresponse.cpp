...
#include "listservicepipelineoutputsresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListServicePipelineOutputsResponse
 * \brief The ListServicePipelineOutputsResponse class provides an interace for Proton ListServicePipelineOutputs responses.
 *
 ...
 *
 * \sa ProtonClient::listServicePipelineOutputs
 */

/*!
 * Constructs a ListServicePipelineOutputsResponse object for \a reply to \a request, with parent \a parent.
 */
ListServicePipelineOutputsResponse::ListServicePipelineOutputsResponse(
        const ListServicePipelineOutputsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListServicePipelineOutputsResponsePrivate(this), parent)
{
    setRequest(new ListServicePipelineOutputsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListServicePipelineOutputsRequest * ListServicePipelineOutputsResponse::request() const
{
    Q_D(const ListServicePipelineOutputsResponse);
    return static_cast<const ListServicePipelineOutputsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton ListServicePipelineOutputs \a response.
 */
void ListServicePipelineOutputsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListServicePipelineOutputsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListServicePipelineOutputsResponsePrivate
 * \brief The ListServicePipelineOutputsResponsePrivate class provides private implementation for ListServicePipelineOutputsResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListServicePipelineOutputsResponsePrivate object with public implementation \a q.
 */
ListServicePipelineOutputsResponsePrivate::ListServicePipelineOutputsResponsePrivate(
    ListServicePipelineOutputsResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListServicePipelineOutputs response element from \a xml.
 */
void ListServicePipelineOutputsResponsePrivate::parseListServicePipelineOutputsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListServicePipelineOutputsResponse"));
    Q_UNUSED(xml) ///< @todo
}
