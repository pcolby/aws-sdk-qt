...
#include "createtemplatesyncconfigresponse_p.h"
...
/*!
 * \class QtAws::Proton::CreateTemplateSyncConfigResponse
 * \brief The CreateTemplateSyncConfigResponse class provides an interace for Proton CreateTemplateSyncConfig responses.
 *
 ...
 *
 * \sa ProtonClient::createTemplateSyncConfig
 */

/*!
 * Constructs a CreateTemplateSyncConfigResponse object for \a reply to \a request, with parent \a parent.
 */
CreateTemplateSyncConfigResponse::CreateTemplateSyncConfigResponse(
        const CreateTemplateSyncConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new CreateTemplateSyncConfigResponsePrivate(this), parent)
{
    setRequest(new CreateTemplateSyncConfigRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateTemplateSyncConfigRequest * CreateTemplateSyncConfigResponse::request() const
{
    Q_D(const CreateTemplateSyncConfigResponse);
    return static_cast<const CreateTemplateSyncConfigRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton CreateTemplateSyncConfig \a response.
 */
void CreateTemplateSyncConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateTemplateSyncConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::CreateTemplateSyncConfigResponsePrivate
 * \brief The CreateTemplateSyncConfigResponsePrivate class provides private implementation for CreateTemplateSyncConfigResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CreateTemplateSyncConfigResponsePrivate object with public implementation \a q.
 */
CreateTemplateSyncConfigResponsePrivate::CreateTemplateSyncConfigResponsePrivate(
    CreateTemplateSyncConfigResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton CreateTemplateSyncConfig response element from \a xml.
 */
void CreateTemplateSyncConfigResponsePrivate::parseCreateTemplateSyncConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateTemplateSyncConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
