...
#include "listenvironmenttemplatesresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListEnvironmentTemplatesResponse
 * \brief The ListEnvironmentTemplatesResponse class provides an interace for Proton ListEnvironmentTemplates responses.
 *
...
/*!
 * Constructs a ListEnvironmentTemplatesResponse object for \a reply to \a request, with parent \a parent.
 */
ListEnvironmentTemplatesResponse::ListEnvironmentTemplatesResponse(
        const ListEnvironmentTemplatesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListEnvironmentTemplatesResponsePrivate(this), parent)
{
    setRequest(new ListEnvironmentTemplatesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton ListEnvironmentTemplates \a response.
 */
void ListEnvironmentTemplatesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListEnvironmentTemplatesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListEnvironmentTemplatesResponsePrivate
 * \brief The ListEnvironmentTemplatesResponsePrivate class provides private implementation for ListEnvironmentTemplatesResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListEnvironmentTemplatesResponsePrivate object with public implementation \a q.
 */
ListEnvironmentTemplatesResponsePrivate::ListEnvironmentTemplatesResponsePrivate(
    ListEnvironmentTemplatesResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListEnvironmentTemplates response element from \a xml.
 */
void ListEnvironmentTemplatesResponsePrivate::parseListEnvironmentTemplatesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListEnvironmentTemplatesResponse"));
    Q_UNUSED(xml) ///< @todo
}
