...
#include "getenvironmentaccountconnectionresponse_p.h"
...
/*!
 * \class QtAws::Proton::GetEnvironmentAccountConnectionResponse
 * \brief The GetEnvironmentAccountConnectionResponse class provides an interace for Proton GetEnvironmentAccountConnection responses.
 *
...
/*!
 * Constructs a GetEnvironmentAccountConnectionResponse object for \a reply to \a request, with parent \a parent.
 */
GetEnvironmentAccountConnectionResponse::GetEnvironmentAccountConnectionResponse(
        const GetEnvironmentAccountConnectionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new GetEnvironmentAccountConnectionResponsePrivate(this), parent)
{
    setRequest(new GetEnvironmentAccountConnectionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton GetEnvironmentAccountConnection \a response.
 */
void GetEnvironmentAccountConnectionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetEnvironmentAccountConnectionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::GetEnvironmentAccountConnectionResponsePrivate
 * \brief The GetEnvironmentAccountConnectionResponsePrivate class provides private implementation for GetEnvironmentAccountConnectionResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetEnvironmentAccountConnectionResponsePrivate object with public implementation \a q.
 */
GetEnvironmentAccountConnectionResponsePrivate::GetEnvironmentAccountConnectionResponsePrivate(
    GetEnvironmentAccountConnectionResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton GetEnvironmentAccountConnection response element from \a xml.
 */
void GetEnvironmentAccountConnectionResponsePrivate::parseGetEnvironmentAccountConnectionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetEnvironmentAccountConnectionResponse"));
    Q_UNUSED(xml) ///< @todo
}
