...
#include "updateservicepipelinerequest_p.h"
...
/*!
 * \class QtAws::Proton::UpdateServicePipelineRequest
 * \brief The UpdateServicePipelineRequest class provides an interface for Proton UpdateServicePipeline requests.
 *
 ...
 *
 * \sa ProtonClient::updateServicePipeline
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateServicePipelineRequest::UpdateServicePipelineRequest(const UpdateServicePipelineRequest &other)
    : ProtonRequest(new UpdateServicePipelineRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateServicePipelineRequest object.
 */
UpdateServicePipelineRequest::UpdateServicePipelineRequest()
    : ProtonRequest(new UpdateServicePipelineRequestPrivate(ProtonRequest::UpdateServicePipelineAction, this))
{
 ...
 * \reimp
 */
bool UpdateServicePipelineRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateServicePipelineResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateServicePipelineRequest::response(QNetworkReply * const reply) const
{
    return new UpdateServicePipelineResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::UpdateServicePipelineRequestPrivate
 * \brief The UpdateServicePipelineRequestPrivate class provides private implementation for UpdateServicePipelineRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateServicePipelineRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
UpdateServicePipelineRequestPrivate::UpdateServicePipelineRequestPrivate(
    const ProtonRequest::Action action, UpdateServicePipelineRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateServicePipelineRequest
 * class' copy constructor.
 */
UpdateServicePipelineRequestPrivate::UpdateServicePipelineRequestPrivate(
    const UpdateServicePipelineRequestPrivate &other, UpdateServicePipelineRequest * const q)
