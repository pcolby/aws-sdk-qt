...
#include "deleteenvironmenttemplateversionrequest_p.h"
...
/*!
 * \class QtAws::Proton::DeleteEnvironmentTemplateVersionRequest
 * \brief The DeleteEnvironmentTemplateVersionRequest class provides an interface for Proton DeleteEnvironmentTemplateVersion requests.
 *
 ...
 */
DeleteEnvironmentTemplateVersionRequest::DeleteEnvironmentTemplateVersionRequest(const DeleteEnvironmentTemplateVersionRequest &other)
    : ProtonRequest(new DeleteEnvironmentTemplateVersionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteEnvironmentTemplateVersionRequest object.
 */
DeleteEnvironmentTemplateVersionRequest::DeleteEnvironmentTemplateVersionRequest()
    : ProtonRequest(new DeleteEnvironmentTemplateVersionRequestPrivate(ProtonRequest::DeleteEnvironmentTemplateVersionAction, this))
{
 ...
 * \reimp
 */
bool DeleteEnvironmentTemplateVersionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteEnvironmentTemplateVersionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteEnvironmentTemplateVersionRequest::response(QNetworkReply * const reply) const
{
    return new DeleteEnvironmentTemplateVersionResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::DeleteEnvironmentTemplateVersionRequestPrivate
 * \brief The DeleteEnvironmentTemplateVersionRequestPrivate class provides private implementation for DeleteEnvironmentTemplateVersionRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a DeleteEnvironmentTemplateVersionRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
DeleteEnvironmentTemplateVersionRequestPrivate::DeleteEnvironmentTemplateVersionRequestPrivate(
    const ProtonRequest::Action action, DeleteEnvironmentTemplateVersionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteEnvironmentTemplateVersionRequest
 * class' copy constructor.
 */
DeleteEnvironmentTemplateVersionRequestPrivate::DeleteEnvironmentTemplateVersionRequestPrivate(
    const DeleteEnvironmentTemplateVersionRequestPrivate &other, DeleteEnvironmentTemplateVersionRequest * const q)
