...
/*!
 * \class QtAws::Proton::DeleteComponentResponse
 * \brief The DeleteComponentResponse class provides an interace for Proton DeleteComponent responses.
 *
...
DeleteComponentResponse::DeleteComponentResponse(
    ...
    : ProtonResponse(new DeleteComponentResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton DeleteComponent \a response.
 */
...
/*!
 * \class QtAws::Proton::DeleteComponentResponsePrivate
...
DeleteComponentResponsePrivate::DeleteComponentResponsePrivate(
    DeleteComponentResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton DeleteComponent response element from \a xml.
 */
