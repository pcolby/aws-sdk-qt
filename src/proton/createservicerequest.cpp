...
/*!
 * \class QtAws::Proton::CreateServiceRequest
 * \brief The CreateServiceRequest class provides an interface for Proton CreateService requests.
 *
...
CreateServiceRequest::CreateServiceRequest(const CreateServiceRequest &other)
    : ProtonRequest(new CreateServiceRequestPrivate(*other.d_func(), this))
{
...
CreateServiceRequest::CreateServiceRequest()
    : ProtonRequest(new CreateServiceRequestPrivate(ProtonRequest::CreateServiceAction, this))
{
...
/*!
 * \class QtAws::Proton::CreateServiceRequestPrivate
...
/*!
 * Constructs a CreateServiceRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
CreateServiceRequestPrivate::CreateServiceRequestPrivate(
    const ProtonRequest::Action action, CreateServiceRequest * const q)
