...
/*!
 * \class QtAws::Proton::CreateServiceResponse
 * \brief The CreateServiceResponse class provides an interace for Proton CreateService responses.
 *
...
CreateServiceResponse::CreateServiceResponse(
    ...
    : ProtonResponse(new CreateServiceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton CreateService \a response.
 */
...
/*!
 * \class QtAws::Proton::CreateServiceResponsePrivate
...
CreateServiceResponsePrivate::CreateServiceResponsePrivate(
    CreateServiceResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton CreateService response element from \a xml.
 */
