...
/*!
 * \class QtAws::Proton::DeleteRepositoryResponse
 * \brief The DeleteRepositoryResponse class provides an interace for Proton DeleteRepository responses.
 *
...
DeleteRepositoryResponse::DeleteRepositoryResponse(
    ...
    : ProtonResponse(new DeleteRepositoryResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton DeleteRepository \a response.
 */
...
/*!
 * \class QtAws::Proton::DeleteRepositoryResponsePrivate
...
DeleteRepositoryResponsePrivate::DeleteRepositoryResponsePrivate(
    DeleteRepositoryResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton DeleteRepository response element from \a xml.
 */
