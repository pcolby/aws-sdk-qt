...
#include "listserviceinstanceprovisionedresourcesresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListServiceInstanceProvisionedResourcesResponse
 * \brief The ListServiceInstanceProvisionedResourcesResponse class provides an interace for Proton ListServiceInstanceProvisionedResources responses.
 *
 ...
 *
 * \sa ProtonClient::listServiceInstanceProvisionedResources
 */

/*!
 * Constructs a ListServiceInstanceProvisionedResourcesResponse object for \a reply to \a request, with parent \a parent.
 */
ListServiceInstanceProvisionedResourcesResponse::ListServiceInstanceProvisionedResourcesResponse(
        const ListServiceInstanceProvisionedResourcesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListServiceInstanceProvisionedResourcesResponsePrivate(this), parent)
{
    setRequest(new ListServiceInstanceProvisionedResourcesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListServiceInstanceProvisionedResourcesRequest * ListServiceInstanceProvisionedResourcesResponse::request() const
{
    Q_D(const ListServiceInstanceProvisionedResourcesResponse);
    return static_cast<const ListServiceInstanceProvisionedResourcesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton ListServiceInstanceProvisionedResources \a response.
 */
void ListServiceInstanceProvisionedResourcesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListServiceInstanceProvisionedResourcesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListServiceInstanceProvisionedResourcesResponsePrivate
 * \brief The ListServiceInstanceProvisionedResourcesResponsePrivate class provides private implementation for ListServiceInstanceProvisionedResourcesResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListServiceInstanceProvisionedResourcesResponsePrivate object with public implementation \a q.
 */
ListServiceInstanceProvisionedResourcesResponsePrivate::ListServiceInstanceProvisionedResourcesResponsePrivate(
    ListServiceInstanceProvisionedResourcesResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListServiceInstanceProvisionedResources response element from \a xml.
 */
void ListServiceInstanceProvisionedResourcesResponsePrivate::parseListServiceInstanceProvisionedResourcesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListServiceInstanceProvisionedResourcesResponse"));
    Q_UNUSED(xml) ///< @todo
}
