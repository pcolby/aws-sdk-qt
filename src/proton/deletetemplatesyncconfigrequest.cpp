...
#include "deletetemplatesyncconfigrequest_p.h"
...
/*!
 * \class QtAws::Proton::DeleteTemplateSyncConfigRequest
 * \brief The DeleteTemplateSyncConfigRequest class provides an interface for Proton DeleteTemplateSyncConfig requests.
 *
 ...
 */
DeleteTemplateSyncConfigRequest::DeleteTemplateSyncConfigRequest(const DeleteTemplateSyncConfigRequest &other)
    : ProtonRequest(new DeleteTemplateSyncConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteTemplateSyncConfigRequest object.
 */
DeleteTemplateSyncConfigRequest::DeleteTemplateSyncConfigRequest()
    : ProtonRequest(new DeleteTemplateSyncConfigRequestPrivate(ProtonRequest::DeleteTemplateSyncConfigAction, this))
{
 ...
 * \reimp
 */
bool DeleteTemplateSyncConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteTemplateSyncConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteTemplateSyncConfigRequest::response(QNetworkReply * const reply) const
{
    return new DeleteTemplateSyncConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::DeleteTemplateSyncConfigRequestPrivate
 * \brief The DeleteTemplateSyncConfigRequestPrivate class provides private implementation for DeleteTemplateSyncConfigRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a DeleteTemplateSyncConfigRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
DeleteTemplateSyncConfigRequestPrivate::DeleteTemplateSyncConfigRequestPrivate(
    const ProtonRequest::Action action, DeleteTemplateSyncConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteTemplateSyncConfigRequest
 * class' copy constructor.
 */
DeleteTemplateSyncConfigRequestPrivate::DeleteTemplateSyncConfigRequestPrivate(
    const DeleteTemplateSyncConfigRequestPrivate &other, DeleteTemplateSyncConfigRequest * const q)
