...
#include "updateenvironmenttemplateresponse_p.h"
...
/*!
 * \class QtAws::Proton::UpdateEnvironmentTemplateResponse
 * \brief The UpdateEnvironmentTemplateResponse class provides an interace for Proton UpdateEnvironmentTemplate responses.
 *
...
/*!
 * Constructs a UpdateEnvironmentTemplateResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateEnvironmentTemplateResponse::UpdateEnvironmentTemplateResponse(
        const UpdateEnvironmentTemplateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new UpdateEnvironmentTemplateResponsePrivate(this), parent)
{
    setRequest(new UpdateEnvironmentTemplateRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton UpdateEnvironmentTemplate \a response.
 */
void UpdateEnvironmentTemplateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateEnvironmentTemplateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::UpdateEnvironmentTemplateResponsePrivate
 * \brief The UpdateEnvironmentTemplateResponsePrivate class provides private implementation for UpdateEnvironmentTemplateResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateEnvironmentTemplateResponsePrivate object with public implementation \a q.
 */
UpdateEnvironmentTemplateResponsePrivate::UpdateEnvironmentTemplateResponsePrivate(
    UpdateEnvironmentTemplateResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton UpdateEnvironmentTemplate response element from \a xml.
 */
void UpdateEnvironmentTemplateResponsePrivate::parseUpdateEnvironmentTemplateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateEnvironmentTemplateResponse"));
    Q_UNUSED(xml) ///< @todo
}
