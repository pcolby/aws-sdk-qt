...
#include "cancelserviceinstancedeploymentresponse_p.h"
...
/*!
 * \class QtAws::Proton::CancelServiceInstanceDeploymentResponse
 * \brief The CancelServiceInstanceDeploymentResponse class provides an interace for Proton CancelServiceInstanceDeployment responses.
 *
...
/*!
 * Constructs a CancelServiceInstanceDeploymentResponse object for \a reply to \a request, with parent \a parent.
 */
CancelServiceInstanceDeploymentResponse::CancelServiceInstanceDeploymentResponse(
        const CancelServiceInstanceDeploymentRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new CancelServiceInstanceDeploymentResponsePrivate(this), parent)
{
    setRequest(new CancelServiceInstanceDeploymentRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton CancelServiceInstanceDeployment \a response.
 */
void CancelServiceInstanceDeploymentResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CancelServiceInstanceDeploymentResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::CancelServiceInstanceDeploymentResponsePrivate
 * \brief The CancelServiceInstanceDeploymentResponsePrivate class provides private implementation for CancelServiceInstanceDeploymentResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CancelServiceInstanceDeploymentResponsePrivate object with public implementation \a q.
 */
CancelServiceInstanceDeploymentResponsePrivate::CancelServiceInstanceDeploymentResponsePrivate(
    CancelServiceInstanceDeploymentResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton CancelServiceInstanceDeployment response element from \a xml.
 */
void CancelServiceInstanceDeploymentResponsePrivate::parseCancelServiceInstanceDeploymentResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CancelServiceInstanceDeploymentResponse"));
    Q_UNUSED(xml) ///< @todo
}
