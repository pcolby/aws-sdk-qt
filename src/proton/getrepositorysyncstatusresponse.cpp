...
#include "getrepositorysyncstatusresponse_p.h"
...
/*!
 * \class QtAws::Proton::GetRepositorySyncStatusResponse
 * \brief The GetRepositorySyncStatusResponse class provides an interace for Proton GetRepositorySyncStatus responses.
 *
 ...
 *
 * \sa ProtonClient::getRepositorySyncStatus
 */

/*!
 * Constructs a GetRepositorySyncStatusResponse object for \a reply to \a request, with parent \a parent.
 */
GetRepositorySyncStatusResponse::GetRepositorySyncStatusResponse(
        const GetRepositorySyncStatusRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new GetRepositorySyncStatusResponsePrivate(this), parent)
{
    setRequest(new GetRepositorySyncStatusRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetRepositorySyncStatusRequest * GetRepositorySyncStatusResponse::request() const
{
    Q_D(const GetRepositorySyncStatusResponse);
    return static_cast<const GetRepositorySyncStatusRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton GetRepositorySyncStatus \a response.
 */
void GetRepositorySyncStatusResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetRepositorySyncStatusResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::GetRepositorySyncStatusResponsePrivate
 * \brief The GetRepositorySyncStatusResponsePrivate class provides private implementation for GetRepositorySyncStatusResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetRepositorySyncStatusResponsePrivate object with public implementation \a q.
 */
GetRepositorySyncStatusResponsePrivate::GetRepositorySyncStatusResponsePrivate(
    GetRepositorySyncStatusResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton GetRepositorySyncStatus response element from \a xml.
 */
void GetRepositorySyncStatusResponsePrivate::parseGetRepositorySyncStatusResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetRepositorySyncStatusResponse"));
    Q_UNUSED(xml) ///< @todo
}
