...
#include "getenvironmentaccountconnectionrequest_p.h"
...
/*!
 * \class QtAws::Proton::GetEnvironmentAccountConnectionRequest
 * \brief The GetEnvironmentAccountConnectionRequest class provides an interface for Proton GetEnvironmentAccountConnection requests.
 *
 ...
 *
 * \sa ProtonClient::getEnvironmentAccountConnection
 */

/*!
 * Constructs a copy of \a other.
 */
GetEnvironmentAccountConnectionRequest::GetEnvironmentAccountConnectionRequest(const GetEnvironmentAccountConnectionRequest &other)
    : ProtonRequest(new GetEnvironmentAccountConnectionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetEnvironmentAccountConnectionRequest object.
 */
GetEnvironmentAccountConnectionRequest::GetEnvironmentAccountConnectionRequest()
    : ProtonRequest(new GetEnvironmentAccountConnectionRequestPrivate(ProtonRequest::GetEnvironmentAccountConnectionAction, this))
{
 ...
 * \reimp
 */
bool GetEnvironmentAccountConnectionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetEnvironmentAccountConnectionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetEnvironmentAccountConnectionRequest::response(QNetworkReply * const reply) const
{
    return new GetEnvironmentAccountConnectionResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::GetEnvironmentAccountConnectionRequestPrivate
 * \brief The GetEnvironmentAccountConnectionRequestPrivate class provides private implementation for GetEnvironmentAccountConnectionRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetEnvironmentAccountConnectionRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
GetEnvironmentAccountConnectionRequestPrivate::GetEnvironmentAccountConnectionRequestPrivate(
    const ProtonRequest::Action action, GetEnvironmentAccountConnectionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetEnvironmentAccountConnectionRequest
 * class' copy constructor.
 */
GetEnvironmentAccountConnectionRequestPrivate::GetEnvironmentAccountConnectionRequestPrivate(
    const GetEnvironmentAccountConnectionRequestPrivate &other, GetEnvironmentAccountConnectionRequest * const q)
