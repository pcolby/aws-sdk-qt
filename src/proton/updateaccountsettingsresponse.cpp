...
/*!
 * \class QtAws::Proton::UpdateAccountSettingsResponse
 * \brief The UpdateAccountSettingsResponse class provides an interace for Proton UpdateAccountSettings responses.
 *
...
UpdateAccountSettingsResponse::UpdateAccountSettingsResponse(
    ...
    : ProtonResponse(new UpdateAccountSettingsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton UpdateAccountSettings \a response.
 */
...
/*!
 * \class QtAws::Proton::UpdateAccountSettingsResponsePrivate
...
UpdateAccountSettingsResponsePrivate::UpdateAccountSettingsResponsePrivate(
    UpdateAccountSettingsResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton UpdateAccountSettings response element from \a xml.
 */
