...
#include "listenvironmentoutputsresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListEnvironmentOutputsResponse
 * \brief The ListEnvironmentOutputsResponse class provides an interace for Proton ListEnvironmentOutputs responses.
 *
 ...
 *
 * \sa ProtonClient::listEnvironmentOutputs
 */

/*!
 * Constructs a ListEnvironmentOutputsResponse object for \a reply to \a request, with parent \a parent.
 */
ListEnvironmentOutputsResponse::ListEnvironmentOutputsResponse(
        const ListEnvironmentOutputsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListEnvironmentOutputsResponsePrivate(this), parent)
{
    setRequest(new ListEnvironmentOutputsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListEnvironmentOutputsRequest * ListEnvironmentOutputsResponse::request() const
{
    Q_D(const ListEnvironmentOutputsResponse);
    return static_cast<const ListEnvironmentOutputsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton ListEnvironmentOutputs \a response.
 */
void ListEnvironmentOutputsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListEnvironmentOutputsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListEnvironmentOutputsResponsePrivate
 * \brief The ListEnvironmentOutputsResponsePrivate class provides private implementation for ListEnvironmentOutputsResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListEnvironmentOutputsResponsePrivate object with public implementation \a q.
 */
ListEnvironmentOutputsResponsePrivate::ListEnvironmentOutputsResponsePrivate(
    ListEnvironmentOutputsResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListEnvironmentOutputs response element from \a xml.
 */
void ListEnvironmentOutputsResponsePrivate::parseListEnvironmentOutputsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListEnvironmentOutputsResponse"));
    Q_UNUSED(xml) ///< @todo
}
