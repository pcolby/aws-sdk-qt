...
/*!
 * \class QtAws::Proton::CreateRepositoryRequest
 * \brief The CreateRepositoryRequest class provides an interface for Proton CreateRepository requests.
 *
 ...
 *
 * \sa ProtonClient::createRepository
 */
...
CreateRepositoryRequest::CreateRepositoryRequest(const CreateRepositoryRequest &other)
    : ProtonRequest(new CreateRepositoryRequestPrivate(*other.d_func(), this))
{
...
CreateRepositoryRequest::CreateRepositoryRequest()
    : ProtonRequest(new CreateRepositoryRequestPrivate(ProtonRequest::CreateRepositoryAction, this))
{
...
/*!
 * \class QtAws::Proton::CreateRepositoryRequestPrivate
...
/*!
 * Constructs a CreateRepositoryRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
CreateRepositoryRequestPrivate::CreateRepositoryRequestPrivate(
    const ProtonRequest::Action action, CreateRepositoryRequest * const q)
