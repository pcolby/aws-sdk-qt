...
#include "createservicetemplateresponse_p.h"
...
/*!
 * \class QtAws::Proton::CreateServiceTemplateResponse
 * \brief The CreateServiceTemplateResponse class provides an interace for Proton CreateServiceTemplate responses.
 *
 ...
 *
 * \sa ProtonClient::createServiceTemplate
 */

/*!
 * Constructs a CreateServiceTemplateResponse object for \a reply to \a request, with parent \a parent.
 */
CreateServiceTemplateResponse::CreateServiceTemplateResponse(
        const CreateServiceTemplateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new CreateServiceTemplateResponsePrivate(this), parent)
{
    setRequest(new CreateServiceTemplateRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateServiceTemplateRequest * CreateServiceTemplateResponse::request() const
{
    Q_D(const CreateServiceTemplateResponse);
    return static_cast<const CreateServiceTemplateRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton CreateServiceTemplate \a response.
 */
void CreateServiceTemplateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateServiceTemplateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::CreateServiceTemplateResponsePrivate
 * \brief The CreateServiceTemplateResponsePrivate class provides private implementation for CreateServiceTemplateResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CreateServiceTemplateResponsePrivate object with public implementation \a q.
 */
CreateServiceTemplateResponsePrivate::CreateServiceTemplateResponsePrivate(
    CreateServiceTemplateResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton CreateServiceTemplate response element from \a xml.
 */
void CreateServiceTemplateResponsePrivate::parseCreateServiceTemplateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateServiceTemplateResponse"));
    Q_UNUSED(xml) ///< @todo
}
