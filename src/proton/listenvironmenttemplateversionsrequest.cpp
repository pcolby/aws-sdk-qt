...
#include "listenvironmenttemplateversionsrequest_p.h"
...
/*!
 * \class QtAws::Proton::ListEnvironmentTemplateVersionsRequest
 * \brief The ListEnvironmentTemplateVersionsRequest class provides an interface for Proton ListEnvironmentTemplateVersions requests.
 *
 ...
 */
ListEnvironmentTemplateVersionsRequest::ListEnvironmentTemplateVersionsRequest(const ListEnvironmentTemplateVersionsRequest &other)
    : ProtonRequest(new ListEnvironmentTemplateVersionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListEnvironmentTemplateVersionsRequest object.
 */
ListEnvironmentTemplateVersionsRequest::ListEnvironmentTemplateVersionsRequest()
    : ProtonRequest(new ListEnvironmentTemplateVersionsRequestPrivate(ProtonRequest::ListEnvironmentTemplateVersionsAction, this))
{
 ...
 * \reimp
 */
bool ListEnvironmentTemplateVersionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListEnvironmentTemplateVersionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListEnvironmentTemplateVersionsRequest::response(QNetworkReply * const reply) const
{
    return new ListEnvironmentTemplateVersionsResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::ListEnvironmentTemplateVersionsRequestPrivate
 * \brief The ListEnvironmentTemplateVersionsRequestPrivate class provides private implementation for ListEnvironmentTemplateVersionsRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListEnvironmentTemplateVersionsRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListEnvironmentTemplateVersionsRequestPrivate::ListEnvironmentTemplateVersionsRequestPrivate(
    const ProtonRequest::Action action, ListEnvironmentTemplateVersionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListEnvironmentTemplateVersionsRequest
 * class' copy constructor.
 */
ListEnvironmentTemplateVersionsRequestPrivate::ListEnvironmentTemplateVersionsRequestPrivate(
    const ListEnvironmentTemplateVersionsRequestPrivate &other, ListEnvironmentTemplateVersionsRequest * const q)
