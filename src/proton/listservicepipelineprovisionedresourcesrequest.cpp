...
#include "listservicepipelineprovisionedresourcesrequest_p.h"
...
/*!
 * \class QtAws::Proton::ListServicePipelineProvisionedResourcesRequest
 * \brief The ListServicePipelineProvisionedResourcesRequest class provides an interface for Proton ListServicePipelineProvisionedResources requests.
 *
 ...
 */
ListServicePipelineProvisionedResourcesRequest::ListServicePipelineProvisionedResourcesRequest(const ListServicePipelineProvisionedResourcesRequest &other)
    : ProtonRequest(new ListServicePipelineProvisionedResourcesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListServicePipelineProvisionedResourcesRequest object.
 */
ListServicePipelineProvisionedResourcesRequest::ListServicePipelineProvisionedResourcesRequest()
    : ProtonRequest(new ListServicePipelineProvisionedResourcesRequestPrivate(ProtonRequest::ListServicePipelineProvisionedResourcesAction, this))
{
 ...
 * \reimp
 */
bool ListServicePipelineProvisionedResourcesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListServicePipelineProvisionedResourcesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListServicePipelineProvisionedResourcesRequest::response(QNetworkReply * const reply) const
{
    return new ListServicePipelineProvisionedResourcesResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::ListServicePipelineProvisionedResourcesRequestPrivate
 * \brief The ListServicePipelineProvisionedResourcesRequestPrivate class provides private implementation for ListServicePipelineProvisionedResourcesRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListServicePipelineProvisionedResourcesRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListServicePipelineProvisionedResourcesRequestPrivate::ListServicePipelineProvisionedResourcesRequestPrivate(
    const ProtonRequest::Action action, ListServicePipelineProvisionedResourcesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListServicePipelineProvisionedResourcesRequest
 * class' copy constructor.
 */
ListServicePipelineProvisionedResourcesRequestPrivate::ListServicePipelineProvisionedResourcesRequestPrivate(
    const ListServicePipelineProvisionedResourcesRequestPrivate &other, ListServicePipelineProvisionedResourcesRequest * const q)
