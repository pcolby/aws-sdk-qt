...
class QTAWS_EXPORT GetEnvironmentAccountConnectionResponsePrivate : public ProtonResponsePrivate {

public:

    GetEnvironmentAccountConnectionResponsePrivate(GetEnvironmentAccountConnectionResponse * const q);
