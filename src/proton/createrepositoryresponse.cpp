...
/*!
 * \class QtAws::Proton::CreateRepositoryResponse
 * \brief The CreateRepositoryResponse class provides an interace for Proton CreateRepository responses.
 *
...
CreateRepositoryResponse::CreateRepositoryResponse(
    ...
    : ProtonResponse(new CreateRepositoryResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton CreateRepository \a response.
 */
...
/*!
 * \class QtAws::Proton::CreateRepositoryResponsePrivate
...
CreateRepositoryResponsePrivate::CreateRepositoryResponsePrivate(
    CreateRepositoryResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton CreateRepository response element from \a xml.
 */
