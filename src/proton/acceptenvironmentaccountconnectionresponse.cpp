...
#include "acceptenvironmentaccountconnectionresponse_p.h"
...
/*!
 * \class QtAws::Proton::AcceptEnvironmentAccountConnectionResponse
 * \brief The AcceptEnvironmentAccountConnectionResponse class provides an interace for Proton AcceptEnvironmentAccountConnection responses.
 *
 ...
 *
 * \sa ProtonClient::acceptEnvironmentAccountConnection
 */

/*!
 * Constructs a AcceptEnvironmentAccountConnectionResponse object for \a reply to \a request, with parent \a parent.
 */
AcceptEnvironmentAccountConnectionResponse::AcceptEnvironmentAccountConnectionResponse(
        const AcceptEnvironmentAccountConnectionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new AcceptEnvironmentAccountConnectionResponsePrivate(this), parent)
{
    setRequest(new AcceptEnvironmentAccountConnectionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const AcceptEnvironmentAccountConnectionRequest * AcceptEnvironmentAccountConnectionResponse::request() const
{
    Q_D(const AcceptEnvironmentAccountConnectionResponse);
    return static_cast<const AcceptEnvironmentAccountConnectionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton AcceptEnvironmentAccountConnection \a response.
 */
void AcceptEnvironmentAccountConnectionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AcceptEnvironmentAccountConnectionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::AcceptEnvironmentAccountConnectionResponsePrivate
 * \brief The AcceptEnvironmentAccountConnectionResponsePrivate class provides private implementation for AcceptEnvironmentAccountConnectionResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a AcceptEnvironmentAccountConnectionResponsePrivate object with public implementation \a q.
 */
AcceptEnvironmentAccountConnectionResponsePrivate::AcceptEnvironmentAccountConnectionResponsePrivate(
    AcceptEnvironmentAccountConnectionResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton AcceptEnvironmentAccountConnection response element from \a xml.
 */
void AcceptEnvironmentAccountConnectionResponsePrivate::parseAcceptEnvironmentAccountConnectionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AcceptEnvironmentAccountConnectionResponse"));
    Q_UNUSED(xml) ///< @todo
}
