...
#include "updateenvironmentaccountconnectionresponse_p.h"
...
/*!
 * \class QtAws::Proton::UpdateEnvironmentAccountConnectionResponse
 * \brief The UpdateEnvironmentAccountConnectionResponse class provides an interace for Proton UpdateEnvironmentAccountConnection responses.
 *
 ...
 *
 * \sa ProtonClient::updateEnvironmentAccountConnection
 */

/*!
 * Constructs a UpdateEnvironmentAccountConnectionResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateEnvironmentAccountConnectionResponse::UpdateEnvironmentAccountConnectionResponse(
        const UpdateEnvironmentAccountConnectionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new UpdateEnvironmentAccountConnectionResponsePrivate(this), parent)
{
    setRequest(new UpdateEnvironmentAccountConnectionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateEnvironmentAccountConnectionRequest * UpdateEnvironmentAccountConnectionResponse::request() const
{
    Q_D(const UpdateEnvironmentAccountConnectionResponse);
    return static_cast<const UpdateEnvironmentAccountConnectionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton UpdateEnvironmentAccountConnection \a response.
 */
void UpdateEnvironmentAccountConnectionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateEnvironmentAccountConnectionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::UpdateEnvironmentAccountConnectionResponsePrivate
 * \brief The UpdateEnvironmentAccountConnectionResponsePrivate class provides private implementation for UpdateEnvironmentAccountConnectionResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateEnvironmentAccountConnectionResponsePrivate object with public implementation \a q.
 */
UpdateEnvironmentAccountConnectionResponsePrivate::UpdateEnvironmentAccountConnectionResponsePrivate(
    UpdateEnvironmentAccountConnectionResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton UpdateEnvironmentAccountConnection response element from \a xml.
 */
void UpdateEnvironmentAccountConnectionResponsePrivate::parseUpdateEnvironmentAccountConnectionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateEnvironmentAccountConnectionResponse"));
    Q_UNUSED(xml) ///< @todo
}
