...
#include "listrepositorysyncdefinitionsresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListRepositorySyncDefinitionsResponse
 * \brief The ListRepositorySyncDefinitionsResponse class provides an interace for Proton ListRepositorySyncDefinitions responses.
 *
 ...
 *
 * \sa ProtonClient::listRepositorySyncDefinitions
 */

/*!
 * Constructs a ListRepositorySyncDefinitionsResponse object for \a reply to \a request, with parent \a parent.
 */
ListRepositorySyncDefinitionsResponse::ListRepositorySyncDefinitionsResponse(
        const ListRepositorySyncDefinitionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListRepositorySyncDefinitionsResponsePrivate(this), parent)
{
    setRequest(new ListRepositorySyncDefinitionsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListRepositorySyncDefinitionsRequest * ListRepositorySyncDefinitionsResponse::request() const
{
    Q_D(const ListRepositorySyncDefinitionsResponse);
    return static_cast<const ListRepositorySyncDefinitionsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton ListRepositorySyncDefinitions \a response.
 */
void ListRepositorySyncDefinitionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListRepositorySyncDefinitionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListRepositorySyncDefinitionsResponsePrivate
 * \brief The ListRepositorySyncDefinitionsResponsePrivate class provides private implementation for ListRepositorySyncDefinitionsResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListRepositorySyncDefinitionsResponsePrivate object with public implementation \a q.
 */
ListRepositorySyncDefinitionsResponsePrivate::ListRepositorySyncDefinitionsResponsePrivate(
    ListRepositorySyncDefinitionsResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListRepositorySyncDefinitions response element from \a xml.
 */
void ListRepositorySyncDefinitionsResponsePrivate::parseListRepositorySyncDefinitionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListRepositorySyncDefinitionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
