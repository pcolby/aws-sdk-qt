...
#include "listservicetemplateversionsrequest_p.h"
...
/*!
 * \class QtAws::Proton::ListServiceTemplateVersionsRequest
 * \brief The ListServiceTemplateVersionsRequest class provides an interface for Proton ListServiceTemplateVersions requests.
 *
 ...
 *
 * \sa ProtonClient::listServiceTemplateVersions
 */

/*!
 * Constructs a copy of \a other.
 */
ListServiceTemplateVersionsRequest::ListServiceTemplateVersionsRequest(const ListServiceTemplateVersionsRequest &other)
    : ProtonRequest(new ListServiceTemplateVersionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListServiceTemplateVersionsRequest object.
 */
ListServiceTemplateVersionsRequest::ListServiceTemplateVersionsRequest()
    : ProtonRequest(new ListServiceTemplateVersionsRequestPrivate(ProtonRequest::ListServiceTemplateVersionsAction, this))
{
 ...
 * \reimp
 */
bool ListServiceTemplateVersionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListServiceTemplateVersionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListServiceTemplateVersionsRequest::response(QNetworkReply * const reply) const
{
    return new ListServiceTemplateVersionsResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::ListServiceTemplateVersionsRequestPrivate
 * \brief The ListServiceTemplateVersionsRequestPrivate class provides private implementation for ListServiceTemplateVersionsRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListServiceTemplateVersionsRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListServiceTemplateVersionsRequestPrivate::ListServiceTemplateVersionsRequestPrivate(
    const ProtonRequest::Action action, ListServiceTemplateVersionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListServiceTemplateVersionsRequest
 * class' copy constructor.
 */
ListServiceTemplateVersionsRequestPrivate::ListServiceTemplateVersionsRequestPrivate(
    const ListServiceTemplateVersionsRequestPrivate &other, ListServiceTemplateVersionsRequest * const q)
