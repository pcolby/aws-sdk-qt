...
class QTAWS_EXPORT CreateServiceTemplateResponsePrivate : public ProtonResponsePrivate {

public:

    CreateServiceTemplateResponsePrivate(CreateServiceTemplateResponse * const q);
