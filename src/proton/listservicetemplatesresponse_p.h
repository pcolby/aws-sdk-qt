...
class QTAWS_EXPORT ListServiceTemplatesResponsePrivate : public ProtonResponsePrivate {

public:

    ListServiceTemplatesResponsePrivate(ListServiceTemplatesResponse * const q);
