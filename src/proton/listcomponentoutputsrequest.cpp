...
#include "listcomponentoutputsrequest_p.h"
...
/*!
 * \class QtAws::Proton::ListComponentOutputsRequest
 * \brief The ListComponentOutputsRequest class provides an interface for Proton ListComponentOutputs requests.
 *
 ...
 */
ListComponentOutputsRequest::ListComponentOutputsRequest(const ListComponentOutputsRequest &other)
    : ProtonRequest(new ListComponentOutputsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListComponentOutputsRequest object.
 */
ListComponentOutputsRequest::ListComponentOutputsRequest()
    : ProtonRequest(new ListComponentOutputsRequestPrivate(ProtonRequest::ListComponentOutputsAction, this))
{
 ...
 * \reimp
 */
bool ListComponentOutputsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListComponentOutputsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListComponentOutputsRequest::response(QNetworkReply * const reply) const
{
    return new ListComponentOutputsResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::ListComponentOutputsRequestPrivate
 * \brief The ListComponentOutputsRequestPrivate class provides private implementation for ListComponentOutputsRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListComponentOutputsRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListComponentOutputsRequestPrivate::ListComponentOutputsRequestPrivate(
    const ProtonRequest::Action action, ListComponentOutputsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListComponentOutputsRequest
 * class' copy constructor.
 */
ListComponentOutputsRequestPrivate::ListComponentOutputsRequestPrivate(
    const ListComponentOutputsRequestPrivate &other, ListComponentOutputsRequest * const q)
