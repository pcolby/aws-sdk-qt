...
#include "cancelenvironmentdeploymentresponse_p.h"
...
/*!
 * \class QtAws::Proton::CancelEnvironmentDeploymentResponse
 * \brief The CancelEnvironmentDeploymentResponse class provides an interace for Proton CancelEnvironmentDeployment responses.
 *
...
/*!
 * Constructs a CancelEnvironmentDeploymentResponse object for \a reply to \a request, with parent \a parent.
 */
CancelEnvironmentDeploymentResponse::CancelEnvironmentDeploymentResponse(
        const CancelEnvironmentDeploymentRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new CancelEnvironmentDeploymentResponsePrivate(this), parent)
{
    setRequest(new CancelEnvironmentDeploymentRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton CancelEnvironmentDeployment \a response.
 */
void CancelEnvironmentDeploymentResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CancelEnvironmentDeploymentResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::CancelEnvironmentDeploymentResponsePrivate
 * \brief The CancelEnvironmentDeploymentResponsePrivate class provides private implementation for CancelEnvironmentDeploymentResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CancelEnvironmentDeploymentResponsePrivate object with public implementation \a q.
 */
CancelEnvironmentDeploymentResponsePrivate::CancelEnvironmentDeploymentResponsePrivate(
    CancelEnvironmentDeploymentResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton CancelEnvironmentDeployment response element from \a xml.
 */
void CancelEnvironmentDeploymentResponsePrivate::parseCancelEnvironmentDeploymentResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CancelEnvironmentDeploymentResponse"));
    Q_UNUSED(xml) ///< @todo
}
