...
class QTAWS_EXPORT ListServiceInstancesResponsePrivate : public ProtonResponsePrivate {

public:

    ListServiceInstancesResponsePrivate(ListServiceInstancesResponse * const q);
