...
/*!
 * \class QtAws::Proton::DeleteEnvironmentResponse
 * \brief The DeleteEnvironmentResponse class provides an interace for Proton DeleteEnvironment responses.
 *
 ...
 *
 * \sa ProtonClient::deleteEnvironment
 */
...
DeleteEnvironmentResponse::DeleteEnvironmentResponse(
    ...
    : ProtonResponse(new DeleteEnvironmentResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteEnvironmentRequest *>(ProtonResponse::request());
}

/*!
 * \reimp
 * Parses a successful Proton DeleteEnvironment \a response.
 */
...
/*!
 * \class QtAws::Proton::DeleteEnvironmentResponsePrivate
...
DeleteEnvironmentResponsePrivate::DeleteEnvironmentResponsePrivate(
    DeleteEnvironmentResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton DeleteEnvironment response element from \a xml.
 */
