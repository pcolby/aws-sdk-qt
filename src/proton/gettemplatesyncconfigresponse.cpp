...
#include "gettemplatesyncconfigresponse_p.h"
...
/*!
 * \class QtAws::Proton::GetTemplateSyncConfigResponse
 * \brief The GetTemplateSyncConfigResponse class provides an interace for Proton GetTemplateSyncConfig responses.
 *
 ...
 *
 * \sa ProtonClient::getTemplateSyncConfig
 */

/*!
 * Constructs a GetTemplateSyncConfigResponse object for \a reply to \a request, with parent \a parent.
 */
GetTemplateSyncConfigResponse::GetTemplateSyncConfigResponse(
        const GetTemplateSyncConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new GetTemplateSyncConfigResponsePrivate(this), parent)
{
    setRequest(new GetTemplateSyncConfigRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetTemplateSyncConfigRequest * GetTemplateSyncConfigResponse::request() const
{
    Q_D(const GetTemplateSyncConfigResponse);
    return static_cast<const GetTemplateSyncConfigRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton GetTemplateSyncConfig \a response.
 */
void GetTemplateSyncConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetTemplateSyncConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::GetTemplateSyncConfigResponsePrivate
 * \brief The GetTemplateSyncConfigResponsePrivate class provides private implementation for GetTemplateSyncConfigResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetTemplateSyncConfigResponsePrivate object with public implementation \a q.
 */
GetTemplateSyncConfigResponsePrivate::GetTemplateSyncConfigResponsePrivate(
    GetTemplateSyncConfigResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton GetTemplateSyncConfig response element from \a xml.
 */
void GetTemplateSyncConfigResponsePrivate::parseGetTemplateSyncConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetTemplateSyncConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
