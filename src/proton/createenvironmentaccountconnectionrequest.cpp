...
#include "createenvironmentaccountconnectionrequest_p.h"
...
/*!
 * \class QtAws::Proton::CreateEnvironmentAccountConnectionRequest
 * \brief The CreateEnvironmentAccountConnectionRequest class provides an interface for Proton CreateEnvironmentAccountConnection requests.
 *
 ...
 */
CreateEnvironmentAccountConnectionRequest::CreateEnvironmentAccountConnectionRequest(const CreateEnvironmentAccountConnectionRequest &other)
    : ProtonRequest(new CreateEnvironmentAccountConnectionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateEnvironmentAccountConnectionRequest object.
 */
CreateEnvironmentAccountConnectionRequest::CreateEnvironmentAccountConnectionRequest()
    : ProtonRequest(new CreateEnvironmentAccountConnectionRequestPrivate(ProtonRequest::CreateEnvironmentAccountConnectionAction, this))
{
 ...
 * \reimp
 */
bool CreateEnvironmentAccountConnectionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateEnvironmentAccountConnectionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateEnvironmentAccountConnectionRequest::response(QNetworkReply * const reply) const
{
    return new CreateEnvironmentAccountConnectionResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::CreateEnvironmentAccountConnectionRequestPrivate
 * \brief The CreateEnvironmentAccountConnectionRequestPrivate class provides private implementation for CreateEnvironmentAccountConnectionRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CreateEnvironmentAccountConnectionRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
CreateEnvironmentAccountConnectionRequestPrivate::CreateEnvironmentAccountConnectionRequestPrivate(
    const ProtonRequest::Action action, CreateEnvironmentAccountConnectionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateEnvironmentAccountConnectionRequest
 * class' copy constructor.
 */
CreateEnvironmentAccountConnectionRequestPrivate::CreateEnvironmentAccountConnectionRequestPrivate(
    const CreateEnvironmentAccountConnectionRequestPrivate &other, CreateEnvironmentAccountConnectionRequest * const q)
