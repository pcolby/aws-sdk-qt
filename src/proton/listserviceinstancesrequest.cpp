...
#include "listserviceinstancesrequest_p.h"
...
/*!
 * \class QtAws::Proton::ListServiceInstancesRequest
 * \brief The ListServiceInstancesRequest class provides an interface for Proton ListServiceInstances requests.
 *
 ...
 *
 * \sa ProtonClient::listServiceInstances
 */

/*!
 * Constructs a copy of \a other.
 */
ListServiceInstancesRequest::ListServiceInstancesRequest(const ListServiceInstancesRequest &other)
    : ProtonRequest(new ListServiceInstancesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListServiceInstancesRequest object.
 */
ListServiceInstancesRequest::ListServiceInstancesRequest()
    : ProtonRequest(new ListServiceInstancesRequestPrivate(ProtonRequest::ListServiceInstancesAction, this))
{
 ...
 * \reimp
 */
bool ListServiceInstancesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListServiceInstancesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListServiceInstancesRequest::response(QNetworkReply * const reply) const
{
    return new ListServiceInstancesResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::ListServiceInstancesRequestPrivate
 * \brief The ListServiceInstancesRequestPrivate class provides private implementation for ListServiceInstancesRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListServiceInstancesRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListServiceInstancesRequestPrivate::ListServiceInstancesRequestPrivate(
    const ProtonRequest::Action action, ListServiceInstancesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListServiceInstancesRequest
 * class' copy constructor.
 */
ListServiceInstancesRequestPrivate::ListServiceInstancesRequestPrivate(
    const ListServiceInstancesRequestPrivate &other, ListServiceInstancesRequest * const q)
