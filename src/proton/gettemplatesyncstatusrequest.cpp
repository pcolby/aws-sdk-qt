...
#include "gettemplatesyncstatusrequest_p.h"
...
/*!
 * \class QtAws::Proton::GetTemplateSyncStatusRequest
 * \brief The GetTemplateSyncStatusRequest class provides an interface for Proton GetTemplateSyncStatus requests.
 *
 ...
 */
GetTemplateSyncStatusRequest::GetTemplateSyncStatusRequest(const GetTemplateSyncStatusRequest &other)
    : ProtonRequest(new GetTemplateSyncStatusRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetTemplateSyncStatusRequest object.
 */
GetTemplateSyncStatusRequest::GetTemplateSyncStatusRequest()
    : ProtonRequest(new GetTemplateSyncStatusRequestPrivate(ProtonRequest::GetTemplateSyncStatusAction, this))
{
 ...
 * \reimp
 */
bool GetTemplateSyncStatusRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetTemplateSyncStatusResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetTemplateSyncStatusRequest::response(QNetworkReply * const reply) const
{
    return new GetTemplateSyncStatusResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::GetTemplateSyncStatusRequestPrivate
 * \brief The GetTemplateSyncStatusRequestPrivate class provides private implementation for GetTemplateSyncStatusRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetTemplateSyncStatusRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
GetTemplateSyncStatusRequestPrivate::GetTemplateSyncStatusRequestPrivate(
    const ProtonRequest::Action action, GetTemplateSyncStatusRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetTemplateSyncStatusRequest
 * class' copy constructor.
 */
GetTemplateSyncStatusRequestPrivate::GetTemplateSyncStatusRequestPrivate(
    const GetTemplateSyncStatusRequestPrivate &other, GetTemplateSyncStatusRequest * const q)
