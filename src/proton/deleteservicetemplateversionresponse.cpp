...
#include "deleteservicetemplateversionresponse_p.h"
...
/*!
 * \class QtAws::Proton::DeleteServiceTemplateVersionResponse
 * \brief The DeleteServiceTemplateVersionResponse class provides an interace for Proton DeleteServiceTemplateVersion responses.
 *
 ...
 *
 * \sa ProtonClient::deleteServiceTemplateVersion
 */

/*!
 * Constructs a DeleteServiceTemplateVersionResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteServiceTemplateVersionResponse::DeleteServiceTemplateVersionResponse(
        const DeleteServiceTemplateVersionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new DeleteServiceTemplateVersionResponsePrivate(this), parent)
{
    setRequest(new DeleteServiceTemplateVersionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteServiceTemplateVersionRequest * DeleteServiceTemplateVersionResponse::request() const
{
    Q_D(const DeleteServiceTemplateVersionResponse);
    return static_cast<const DeleteServiceTemplateVersionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton DeleteServiceTemplateVersion \a response.
 */
void DeleteServiceTemplateVersionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteServiceTemplateVersionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::DeleteServiceTemplateVersionResponsePrivate
 * \brief The DeleteServiceTemplateVersionResponsePrivate class provides private implementation for DeleteServiceTemplateVersionResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a DeleteServiceTemplateVersionResponsePrivate object with public implementation \a q.
 */
DeleteServiceTemplateVersionResponsePrivate::DeleteServiceTemplateVersionResponsePrivate(
    DeleteServiceTemplateVersionResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton DeleteServiceTemplateVersion response element from \a xml.
 */
void DeleteServiceTemplateVersionResponsePrivate::parseDeleteServiceTemplateVersionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteServiceTemplateVersionResponse"));
    Q_UNUSED(xml) ///< @todo
}
