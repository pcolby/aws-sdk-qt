...
/*!
 * \class QtAws::Proton::UpdateServiceRequest
 * \brief The UpdateServiceRequest class provides an interface for Proton UpdateService requests.
 *
...
UpdateServiceRequest::UpdateServiceRequest(const UpdateServiceRequest &other)
    : ProtonRequest(new UpdateServiceRequestPrivate(*other.d_func(), this))
{
...
UpdateServiceRequest::UpdateServiceRequest()
    : ProtonRequest(new UpdateServiceRequestPrivate(ProtonRequest::UpdateServiceAction, this))
{
...
/*!
 * \class QtAws::Proton::UpdateServiceRequestPrivate
...
/*!
 * Constructs a UpdateServiceRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
UpdateServiceRequestPrivate::UpdateServiceRequestPrivate(
    const ProtonRequest::Action action, UpdateServiceRequest * const q)
