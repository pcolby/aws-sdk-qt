...
/*!
 * \class QtAws::Proton::UpdateComponentRequest
 * \brief The UpdateComponentRequest class provides an interface for Proton UpdateComponent requests.
 *
 ...
 *
 * \sa ProtonClient::updateComponent
 */
...
UpdateComponentRequest::UpdateComponentRequest(const UpdateComponentRequest &other)
    : ProtonRequest(new UpdateComponentRequestPrivate(*other.d_func(), this))
{
...
UpdateComponentRequest::UpdateComponentRequest()
    : ProtonRequest(new UpdateComponentRequestPrivate(ProtonRequest::UpdateComponentAction, this))
{
...
/*!
 * \class QtAws::Proton::UpdateComponentRequestPrivate
...
/*!
 * Constructs a UpdateComponentRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
UpdateComponentRequestPrivate::UpdateComponentRequestPrivate(
    const ProtonRequest::Action action, UpdateComponentRequest * const q)
