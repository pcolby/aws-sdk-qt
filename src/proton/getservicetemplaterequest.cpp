...
#include "getservicetemplaterequest_p.h"
...
/*!
 * \class QtAws::Proton::GetServiceTemplateRequest
 * \brief The GetServiceTemplateRequest class provides an interface for Proton GetServiceTemplate requests.
 *
 ...
 *
 * \sa ProtonClient::getServiceTemplate
 */

/*!
 * Constructs a copy of \a other.
 */
GetServiceTemplateRequest::GetServiceTemplateRequest(const GetServiceTemplateRequest &other)
    : ProtonRequest(new GetServiceTemplateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetServiceTemplateRequest object.
 */
GetServiceTemplateRequest::GetServiceTemplateRequest()
    : ProtonRequest(new GetServiceTemplateRequestPrivate(ProtonRequest::GetServiceTemplateAction, this))
{
 ...
 * \reimp
 */
bool GetServiceTemplateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetServiceTemplateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetServiceTemplateRequest::response(QNetworkReply * const reply) const
{
    return new GetServiceTemplateResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::GetServiceTemplateRequestPrivate
 * \brief The GetServiceTemplateRequestPrivate class provides private implementation for GetServiceTemplateRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetServiceTemplateRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
GetServiceTemplateRequestPrivate::GetServiceTemplateRequestPrivate(
    const ProtonRequest::Action action, GetServiceTemplateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetServiceTemplateRequest
 * class' copy constructor.
 */
GetServiceTemplateRequestPrivate::GetServiceTemplateRequestPrivate(
    const GetServiceTemplateRequestPrivate &other, GetServiceTemplateRequest * const q)
