...
#include "updateservicepipelineresponse_p.h"
...
/*!
 * \class QtAws::Proton::UpdateServicePipelineResponse
 * \brief The UpdateServicePipelineResponse class provides an interace for Proton UpdateServicePipeline responses.
 *
...
/*!
 * Constructs a UpdateServicePipelineResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateServicePipelineResponse::UpdateServicePipelineResponse(
        const UpdateServicePipelineRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new UpdateServicePipelineResponsePrivate(this), parent)
{
    setRequest(new UpdateServicePipelineRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton UpdateServicePipeline \a response.
 */
void UpdateServicePipelineResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateServicePipelineResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::UpdateServicePipelineResponsePrivate
 * \brief The UpdateServicePipelineResponsePrivate class provides private implementation for UpdateServicePipelineResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateServicePipelineResponsePrivate object with public implementation \a q.
 */
UpdateServicePipelineResponsePrivate::UpdateServicePipelineResponsePrivate(
    UpdateServicePipelineResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton UpdateServicePipeline response element from \a xml.
 */
void UpdateServicePipelineResponsePrivate::parseUpdateServicePipelineResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateServicePipelineResponse"));
    Q_UNUSED(xml) ///< @todo
}
