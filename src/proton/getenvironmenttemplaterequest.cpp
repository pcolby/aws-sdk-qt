...
#include "getenvironmenttemplaterequest_p.h"
...
/*!
 * \class QtAws::Proton::GetEnvironmentTemplateRequest
 * \brief The GetEnvironmentTemplateRequest class provides an interface for Proton GetEnvironmentTemplate requests.
 *
 ...
 */
GetEnvironmentTemplateRequest::GetEnvironmentTemplateRequest(const GetEnvironmentTemplateRequest &other)
    : ProtonRequest(new GetEnvironmentTemplateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetEnvironmentTemplateRequest object.
 */
GetEnvironmentTemplateRequest::GetEnvironmentTemplateRequest()
    : ProtonRequest(new GetEnvironmentTemplateRequestPrivate(ProtonRequest::GetEnvironmentTemplateAction, this))
{
 ...
 * \reimp
 */
bool GetEnvironmentTemplateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetEnvironmentTemplateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetEnvironmentTemplateRequest::response(QNetworkReply * const reply) const
{
    return new GetEnvironmentTemplateResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::GetEnvironmentTemplateRequestPrivate
 * \brief The GetEnvironmentTemplateRequestPrivate class provides private implementation for GetEnvironmentTemplateRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetEnvironmentTemplateRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
GetEnvironmentTemplateRequestPrivate::GetEnvironmentTemplateRequestPrivate(
    const ProtonRequest::Action action, GetEnvironmentTemplateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetEnvironmentTemplateRequest
 * class' copy constructor.
 */
GetEnvironmentTemplateRequestPrivate::GetEnvironmentTemplateRequestPrivate(
    const GetEnvironmentTemplateRequestPrivate &other, GetEnvironmentTemplateRequest * const q)
