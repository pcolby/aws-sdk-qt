...
/*!
 * \class QtAws::Proton::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Proton UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : ProtonResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(ProtonResponse::request());
}

/*!
 * \reimp
 * Parses a successful Proton UntagResource \a response.
 */
...
/*!
 * \class QtAws::Proton::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton UntagResource response element from \a xml.
 */
