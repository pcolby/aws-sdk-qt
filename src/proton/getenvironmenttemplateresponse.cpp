...
#include "getenvironmenttemplateresponse_p.h"
...
/*!
 * \class QtAws::Proton::GetEnvironmentTemplateResponse
 * \brief The GetEnvironmentTemplateResponse class provides an interace for Proton GetEnvironmentTemplate responses.
 *
 ...
 *
 * \sa ProtonClient::getEnvironmentTemplate
 */

/*!
 * Constructs a GetEnvironmentTemplateResponse object for \a reply to \a request, with parent \a parent.
 */
GetEnvironmentTemplateResponse::GetEnvironmentTemplateResponse(
        const GetEnvironmentTemplateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new GetEnvironmentTemplateResponsePrivate(this), parent)
{
    setRequest(new GetEnvironmentTemplateRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetEnvironmentTemplateRequest * GetEnvironmentTemplateResponse::request() const
{
    Q_D(const GetEnvironmentTemplateResponse);
    return static_cast<const GetEnvironmentTemplateRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton GetEnvironmentTemplate \a response.
 */
void GetEnvironmentTemplateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetEnvironmentTemplateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::GetEnvironmentTemplateResponsePrivate
 * \brief The GetEnvironmentTemplateResponsePrivate class provides private implementation for GetEnvironmentTemplateResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetEnvironmentTemplateResponsePrivate object with public implementation \a q.
 */
GetEnvironmentTemplateResponsePrivate::GetEnvironmentTemplateResponsePrivate(
    GetEnvironmentTemplateResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton GetEnvironmentTemplate response element from \a xml.
 */
void GetEnvironmentTemplateResponsePrivate::parseGetEnvironmentTemplateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetEnvironmentTemplateResponse"));
    Q_UNUSED(xml) ///< @todo
}
