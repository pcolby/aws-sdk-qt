...
#include "getservicetemplateversionrequest_p.h"
...
/*!
 * \class QtAws::Proton::GetServiceTemplateVersionRequest
 * \brief The GetServiceTemplateVersionRequest class provides an interface for Proton GetServiceTemplateVersion requests.
 *
 ...
 */
GetServiceTemplateVersionRequest::GetServiceTemplateVersionRequest(const GetServiceTemplateVersionRequest &other)
    : ProtonRequest(new GetServiceTemplateVersionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetServiceTemplateVersionRequest object.
 */
GetServiceTemplateVersionRequest::GetServiceTemplateVersionRequest()
    : ProtonRequest(new GetServiceTemplateVersionRequestPrivate(ProtonRequest::GetServiceTemplateVersionAction, this))
{
 ...
 * \reimp
 */
bool GetServiceTemplateVersionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetServiceTemplateVersionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetServiceTemplateVersionRequest::response(QNetworkReply * const reply) const
{
    return new GetServiceTemplateVersionResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::GetServiceTemplateVersionRequestPrivate
 * \brief The GetServiceTemplateVersionRequestPrivate class provides private implementation for GetServiceTemplateVersionRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetServiceTemplateVersionRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
GetServiceTemplateVersionRequestPrivate::GetServiceTemplateVersionRequestPrivate(
    const ProtonRequest::Action action, GetServiceTemplateVersionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetServiceTemplateVersionRequest
 * class' copy constructor.
 */
GetServiceTemplateVersionRequestPrivate::GetServiceTemplateVersionRequestPrivate(
    const GetServiceTemplateVersionRequestPrivate &other, GetServiceTemplateVersionRequest * const q)
