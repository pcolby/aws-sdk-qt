...
/*!
 * \class QtAws::Proton::ListComponentsResponse
 * \brief The ListComponentsResponse class provides an interace for Proton ListComponents responses.
 *
...
ListComponentsResponse::ListComponentsResponse(
    ...
    : ProtonResponse(new ListComponentsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton ListComponents \a response.
 */
...
/*!
 * \class QtAws::Proton::ListComponentsResponsePrivate
...
ListComponentsResponsePrivate::ListComponentsResponsePrivate(
    ListComponentsResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListComponents response element from \a xml.
 */
