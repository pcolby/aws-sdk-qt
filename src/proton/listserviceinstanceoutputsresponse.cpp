...
#include "listserviceinstanceoutputsresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListServiceInstanceOutputsResponse
 * \brief The ListServiceInstanceOutputsResponse class provides an interace for Proton ListServiceInstanceOutputs responses.
 *
 ...
 *
 * \sa ProtonClient::listServiceInstanceOutputs
 */

/*!
 * Constructs a ListServiceInstanceOutputsResponse object for \a reply to \a request, with parent \a parent.
 */
ListServiceInstanceOutputsResponse::ListServiceInstanceOutputsResponse(
        const ListServiceInstanceOutputsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListServiceInstanceOutputsResponsePrivate(this), parent)
{
    setRequest(new ListServiceInstanceOutputsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListServiceInstanceOutputsRequest * ListServiceInstanceOutputsResponse::request() const
{
    Q_D(const ListServiceInstanceOutputsResponse);
    return static_cast<const ListServiceInstanceOutputsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton ListServiceInstanceOutputs \a response.
 */
void ListServiceInstanceOutputsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListServiceInstanceOutputsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListServiceInstanceOutputsResponsePrivate
 * \brief The ListServiceInstanceOutputsResponsePrivate class provides private implementation for ListServiceInstanceOutputsResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListServiceInstanceOutputsResponsePrivate object with public implementation \a q.
 */
ListServiceInstanceOutputsResponsePrivate::ListServiceInstanceOutputsResponsePrivate(
    ListServiceInstanceOutputsResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListServiceInstanceOutputs response element from \a xml.
 */
void ListServiceInstanceOutputsResponsePrivate::parseListServiceInstanceOutputsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListServiceInstanceOutputsResponse"));
    Q_UNUSED(xml) ///< @todo
}
