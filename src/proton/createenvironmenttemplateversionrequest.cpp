...
#include "createenvironmenttemplateversionrequest_p.h"
...
/*!
 * \class QtAws::Proton::CreateEnvironmentTemplateVersionRequest
 * \brief The CreateEnvironmentTemplateVersionRequest class provides an interface for Proton CreateEnvironmentTemplateVersion requests.
 *
 ...
 *
 * \sa ProtonClient::createEnvironmentTemplateVersion
 */

/*!
 * Constructs a copy of \a other.
 */
CreateEnvironmentTemplateVersionRequest::CreateEnvironmentTemplateVersionRequest(const CreateEnvironmentTemplateVersionRequest &other)
    : ProtonRequest(new CreateEnvironmentTemplateVersionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateEnvironmentTemplateVersionRequest object.
 */
CreateEnvironmentTemplateVersionRequest::CreateEnvironmentTemplateVersionRequest()
    : ProtonRequest(new CreateEnvironmentTemplateVersionRequestPrivate(ProtonRequest::CreateEnvironmentTemplateVersionAction, this))
{
 ...
 * \reimp
 */
bool CreateEnvironmentTemplateVersionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateEnvironmentTemplateVersionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateEnvironmentTemplateVersionRequest::response(QNetworkReply * const reply) const
{
    return new CreateEnvironmentTemplateVersionResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::CreateEnvironmentTemplateVersionRequestPrivate
 * \brief The CreateEnvironmentTemplateVersionRequestPrivate class provides private implementation for CreateEnvironmentTemplateVersionRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CreateEnvironmentTemplateVersionRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
CreateEnvironmentTemplateVersionRequestPrivate::CreateEnvironmentTemplateVersionRequestPrivate(
    const ProtonRequest::Action action, CreateEnvironmentTemplateVersionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateEnvironmentTemplateVersionRequest
 * class' copy constructor.
 */
CreateEnvironmentTemplateVersionRequestPrivate::CreateEnvironmentTemplateVersionRequestPrivate(
    const CreateEnvironmentTemplateVersionRequestPrivate &other, CreateEnvironmentTemplateVersionRequest * const q)
