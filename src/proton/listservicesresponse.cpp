...
/*!
 * \class QtAws::Proton::ListServicesResponse
 * \brief The ListServicesResponse class provides an interace for Proton ListServices responses.
 *
...
ListServicesResponse::ListServicesResponse(
    ...
    : ProtonResponse(new ListServicesResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton ListServices \a response.
 */
...
/*!
 * \class QtAws::Proton::ListServicesResponsePrivate
...
ListServicesResponsePrivate::ListServicesResponsePrivate(
    ListServicesResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListServices response element from \a xml.
 */
