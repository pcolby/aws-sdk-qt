...
#include "createenvironmenttemplateresponse_p.h"
...
/*!
 * \class QtAws::Proton::CreateEnvironmentTemplateResponse
 * \brief The CreateEnvironmentTemplateResponse class provides an interace for Proton CreateEnvironmentTemplate responses.
 *
 ...
 *
 * \sa ProtonClient::createEnvironmentTemplate
 */

/*!
 * Constructs a CreateEnvironmentTemplateResponse object for \a reply to \a request, with parent \a parent.
 */
CreateEnvironmentTemplateResponse::CreateEnvironmentTemplateResponse(
        const CreateEnvironmentTemplateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new CreateEnvironmentTemplateResponsePrivate(this), parent)
{
    setRequest(new CreateEnvironmentTemplateRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateEnvironmentTemplateRequest * CreateEnvironmentTemplateResponse::request() const
{
    Q_D(const CreateEnvironmentTemplateResponse);
    return static_cast<const CreateEnvironmentTemplateRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton CreateEnvironmentTemplate \a response.
 */
void CreateEnvironmentTemplateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateEnvironmentTemplateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::CreateEnvironmentTemplateResponsePrivate
 * \brief The CreateEnvironmentTemplateResponsePrivate class provides private implementation for CreateEnvironmentTemplateResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CreateEnvironmentTemplateResponsePrivate object with public implementation \a q.
 */
CreateEnvironmentTemplateResponsePrivate::CreateEnvironmentTemplateResponsePrivate(
    CreateEnvironmentTemplateResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton CreateEnvironmentTemplate response element from \a xml.
 */
void CreateEnvironmentTemplateResponsePrivate::parseCreateEnvironmentTemplateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateEnvironmentTemplateResponse"));
    Q_UNUSED(xml) ///< @todo
}
