...
/*!
 * \class QtAws::Proton::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for Proton UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : ProtonRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : ProtonRequest(new UntagResourceRequestPrivate(ProtonRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::Proton::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const ProtonRequest::Action action, UntagResourceRequest * const q)
