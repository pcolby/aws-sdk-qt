...
/*!
 * \class QtAws::Proton::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for Proton TagResource requests.
 *
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : ProtonRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : ProtonRequest(new TagResourceRequestPrivate(ProtonRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::Proton::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const ProtonRequest::Action action, TagResourceRequest * const q)
