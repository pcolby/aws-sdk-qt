...
/*!
 * \class QtAws::Proton::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for Proton ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : ProtonRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : ProtonRequest(new ListTagsForResourceRequestPrivate(ProtonRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::Proton::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const ProtonRequest::Action action, ListTagsForResourceRequest * const q)
