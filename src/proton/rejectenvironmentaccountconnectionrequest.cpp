...
#include "rejectenvironmentaccountconnectionrequest_p.h"
...
/*!
 * \class QtAws::Proton::RejectEnvironmentAccountConnectionRequest
 * \brief The RejectEnvironmentAccountConnectionRequest class provides an interface for Proton RejectEnvironmentAccountConnection requests.
 *
 ...
 */
RejectEnvironmentAccountConnectionRequest::RejectEnvironmentAccountConnectionRequest(const RejectEnvironmentAccountConnectionRequest &other)
    : ProtonRequest(new RejectEnvironmentAccountConnectionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a RejectEnvironmentAccountConnectionRequest object.
 */
RejectEnvironmentAccountConnectionRequest::RejectEnvironmentAccountConnectionRequest()
    : ProtonRequest(new RejectEnvironmentAccountConnectionRequestPrivate(ProtonRequest::RejectEnvironmentAccountConnectionAction, this))
{
 ...
 * \reimp
 */
bool RejectEnvironmentAccountConnectionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a RejectEnvironmentAccountConnectionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * RejectEnvironmentAccountConnectionRequest::response(QNetworkReply * const reply) const
{
    return new RejectEnvironmentAccountConnectionResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::RejectEnvironmentAccountConnectionRequestPrivate
 * \brief The RejectEnvironmentAccountConnectionRequestPrivate class provides private implementation for RejectEnvironmentAccountConnectionRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a RejectEnvironmentAccountConnectionRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
RejectEnvironmentAccountConnectionRequestPrivate::RejectEnvironmentAccountConnectionRequestPrivate(
    const ProtonRequest::Action action, RejectEnvironmentAccountConnectionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the RejectEnvironmentAccountConnectionRequest
 * class' copy constructor.
 */
RejectEnvironmentAccountConnectionRequestPrivate::RejectEnvironmentAccountConnectionRequestPrivate(
    const RejectEnvironmentAccountConnectionRequestPrivate &other, RejectEnvironmentAccountConnectionRequest * const q)
