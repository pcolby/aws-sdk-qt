...
#include "listcomponentoutputsresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListComponentOutputsResponse
 * \brief The ListComponentOutputsResponse class provides an interace for Proton ListComponentOutputs responses.
 *
 ...
 *
 * \sa ProtonClient::listComponentOutputs
 */

/*!
 * Constructs a ListComponentOutputsResponse object for \a reply to \a request, with parent \a parent.
 */
ListComponentOutputsResponse::ListComponentOutputsResponse(
        const ListComponentOutputsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListComponentOutputsResponsePrivate(this), parent)
{
    setRequest(new ListComponentOutputsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListComponentOutputsRequest * ListComponentOutputsResponse::request() const
{
    Q_D(const ListComponentOutputsResponse);
    return static_cast<const ListComponentOutputsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton ListComponentOutputs \a response.
 */
void ListComponentOutputsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListComponentOutputsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListComponentOutputsResponsePrivate
 * \brief The ListComponentOutputsResponsePrivate class provides private implementation for ListComponentOutputsResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListComponentOutputsResponsePrivate object with public implementation \a q.
 */
ListComponentOutputsResponsePrivate::ListComponentOutputsResponsePrivate(
    ListComponentOutputsResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListComponentOutputs response element from \a xml.
 */
void ListComponentOutputsResponsePrivate::parseListComponentOutputsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListComponentOutputsResponse"));
    Q_UNUSED(xml) ///< @todo
}
