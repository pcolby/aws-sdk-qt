...
class QTAWS_EXPORT DeleteEnvironmentTemplateVersionResponsePrivate : public ProtonResponsePrivate {

public:

    DeleteEnvironmentTemplateVersionResponsePrivate(DeleteEnvironmentTemplateVersionResponse * const q);
