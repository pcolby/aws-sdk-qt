...
/*!
 * \class QtAws::Proton::ListEnvironmentsResponse
 * \brief The ListEnvironmentsResponse class provides an interace for Proton ListEnvironments responses.
 *
...
ListEnvironmentsResponse::ListEnvironmentsResponse(
    ...
    : ProtonResponse(new ListEnvironmentsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton ListEnvironments \a response.
 */
...
/*!
 * \class QtAws::Proton::ListEnvironmentsResponsePrivate
...
ListEnvironmentsResponsePrivate::ListEnvironmentsResponsePrivate(
    ListEnvironmentsResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListEnvironments response element from \a xml.
 */
