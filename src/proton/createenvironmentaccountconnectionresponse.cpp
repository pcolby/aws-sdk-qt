...
#include "createenvironmentaccountconnectionresponse_p.h"
...
/*!
 * \class QtAws::Proton::CreateEnvironmentAccountConnectionResponse
 * \brief The CreateEnvironmentAccountConnectionResponse class provides an interace for Proton CreateEnvironmentAccountConnection responses.
 *
 ...
 *
 * \sa ProtonClient::createEnvironmentAccountConnection
 */

/*!
 * Constructs a CreateEnvironmentAccountConnectionResponse object for \a reply to \a request, with parent \a parent.
 */
CreateEnvironmentAccountConnectionResponse::CreateEnvironmentAccountConnectionResponse(
        const CreateEnvironmentAccountConnectionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new CreateEnvironmentAccountConnectionResponsePrivate(this), parent)
{
    setRequest(new CreateEnvironmentAccountConnectionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateEnvironmentAccountConnectionRequest * CreateEnvironmentAccountConnectionResponse::request() const
{
    Q_D(const CreateEnvironmentAccountConnectionResponse);
    return static_cast<const CreateEnvironmentAccountConnectionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton CreateEnvironmentAccountConnection \a response.
 */
void CreateEnvironmentAccountConnectionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateEnvironmentAccountConnectionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::CreateEnvironmentAccountConnectionResponsePrivate
 * \brief The CreateEnvironmentAccountConnectionResponsePrivate class provides private implementation for CreateEnvironmentAccountConnectionResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CreateEnvironmentAccountConnectionResponsePrivate object with public implementation \a q.
 */
CreateEnvironmentAccountConnectionResponsePrivate::CreateEnvironmentAccountConnectionResponsePrivate(
    CreateEnvironmentAccountConnectionResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton CreateEnvironmentAccountConnection response element from \a xml.
 */
void CreateEnvironmentAccountConnectionResponsePrivate::parseCreateEnvironmentAccountConnectionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateEnvironmentAccountConnectionResponse"));
    Q_UNUSED(xml) ///< @todo
}
