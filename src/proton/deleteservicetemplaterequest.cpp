...
#include "deleteservicetemplaterequest_p.h"
...
/*!
 * \class QtAws::Proton::DeleteServiceTemplateRequest
 * \brief The DeleteServiceTemplateRequest class provides an interface for Proton DeleteServiceTemplate requests.
 *
 ...
 *
 * \sa ProtonClient::deleteServiceTemplate
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteServiceTemplateRequest::DeleteServiceTemplateRequest(const DeleteServiceTemplateRequest &other)
    : ProtonRequest(new DeleteServiceTemplateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteServiceTemplateRequest object.
 */
DeleteServiceTemplateRequest::DeleteServiceTemplateRequest()
    : ProtonRequest(new DeleteServiceTemplateRequestPrivate(ProtonRequest::DeleteServiceTemplateAction, this))
{
 ...
 * \reimp
 */
bool DeleteServiceTemplateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteServiceTemplateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteServiceTemplateRequest::response(QNetworkReply * const reply) const
{
    return new DeleteServiceTemplateResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::DeleteServiceTemplateRequestPrivate
 * \brief The DeleteServiceTemplateRequestPrivate class provides private implementation for DeleteServiceTemplateRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a DeleteServiceTemplateRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
DeleteServiceTemplateRequestPrivate::DeleteServiceTemplateRequestPrivate(
    const ProtonRequest::Action action, DeleteServiceTemplateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteServiceTemplateRequest
 * class' copy constructor.
 */
DeleteServiceTemplateRequestPrivate::DeleteServiceTemplateRequestPrivate(
    const DeleteServiceTemplateRequestPrivate &other, DeleteServiceTemplateRequest * const q)
