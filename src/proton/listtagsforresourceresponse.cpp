...
/*!
 * \class QtAws::Proton::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Proton ListTagsForResource responses.
 *
 ...
 *
 * \sa ProtonClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ProtonResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(ProtonResponse::request());
}

/*!
 * \reimp
 * Parses a successful Proton ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Proton::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListTagsForResource response element from \a xml.
 */
