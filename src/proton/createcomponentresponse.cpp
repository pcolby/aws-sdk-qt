...
/*!
 * \class QtAws::Proton::CreateComponentResponse
 * \brief The CreateComponentResponse class provides an interace for Proton CreateComponent responses.
 *
...
CreateComponentResponse::CreateComponentResponse(
    ...
    : ProtonResponse(new CreateComponentResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton CreateComponent \a response.
 */
...
/*!
 * \class QtAws::Proton::CreateComponentResponsePrivate
...
CreateComponentResponsePrivate::CreateComponentResponsePrivate(
    CreateComponentResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton CreateComponent response element from \a xml.
 */
