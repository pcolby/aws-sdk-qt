...
/*!
 * \class QtAws::Proton::CreateEnvironmentResponse
 * \brief The CreateEnvironmentResponse class provides an interace for Proton CreateEnvironment responses.
 *
...
CreateEnvironmentResponse::CreateEnvironmentResponse(
    ...
    : ProtonResponse(new CreateEnvironmentResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton CreateEnvironment \a response.
 */
...
/*!
 * \class QtAws::Proton::CreateEnvironmentResponsePrivate
...
CreateEnvironmentResponsePrivate::CreateEnvironmentResponsePrivate(
    CreateEnvironmentResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton CreateEnvironment response element from \a xml.
 */
