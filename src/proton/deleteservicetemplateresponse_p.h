...
class QTAWS_EXPORT DeleteServiceTemplateResponsePrivate : public ProtonResponsePrivate {

public:

    DeleteServiceTemplateResponsePrivate(DeleteServiceTemplateResponse * const q);
