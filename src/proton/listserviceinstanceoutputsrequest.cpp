...
#include "listserviceinstanceoutputsrequest_p.h"
...
/*!
 * \class QtAws::Proton::ListServiceInstanceOutputsRequest
 * \brief The ListServiceInstanceOutputsRequest class provides an interface for Proton ListServiceInstanceOutputs requests.
 *
 ...
 */
ListServiceInstanceOutputsRequest::ListServiceInstanceOutputsRequest(const ListServiceInstanceOutputsRequest &other)
    : ProtonRequest(new ListServiceInstanceOutputsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListServiceInstanceOutputsRequest object.
 */
ListServiceInstanceOutputsRequest::ListServiceInstanceOutputsRequest()
    : ProtonRequest(new ListServiceInstanceOutputsRequestPrivate(ProtonRequest::ListServiceInstanceOutputsAction, this))
{
 ...
 * \reimp
 */
bool ListServiceInstanceOutputsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListServiceInstanceOutputsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListServiceInstanceOutputsRequest::response(QNetworkReply * const reply) const
{
    return new ListServiceInstanceOutputsResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::ListServiceInstanceOutputsRequestPrivate
 * \brief The ListServiceInstanceOutputsRequestPrivate class provides private implementation for ListServiceInstanceOutputsRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListServiceInstanceOutputsRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListServiceInstanceOutputsRequestPrivate::ListServiceInstanceOutputsRequestPrivate(
    const ProtonRequest::Action action, ListServiceInstanceOutputsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListServiceInstanceOutputsRequest
 * class' copy constructor.
 */
ListServiceInstanceOutputsRequestPrivate::ListServiceInstanceOutputsRequestPrivate(
    const ListServiceInstanceOutputsRequestPrivate &other, ListServiceInstanceOutputsRequest * const q)
