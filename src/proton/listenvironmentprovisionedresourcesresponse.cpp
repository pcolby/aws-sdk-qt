...
#include "listenvironmentprovisionedresourcesresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListEnvironmentProvisionedResourcesResponse
 * \brief The ListEnvironmentProvisionedResourcesResponse class provides an interace for Proton ListEnvironmentProvisionedResources responses.
 *
 ...
 *
 * \sa ProtonClient::listEnvironmentProvisionedResources
 */

/*!
 * Constructs a ListEnvironmentProvisionedResourcesResponse object for \a reply to \a request, with parent \a parent.
 */
ListEnvironmentProvisionedResourcesResponse::ListEnvironmentProvisionedResourcesResponse(
        const ListEnvironmentProvisionedResourcesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListEnvironmentProvisionedResourcesResponsePrivate(this), parent)
{
    setRequest(new ListEnvironmentProvisionedResourcesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListEnvironmentProvisionedResourcesRequest * ListEnvironmentProvisionedResourcesResponse::request() const
{
    Q_D(const ListEnvironmentProvisionedResourcesResponse);
    return static_cast<const ListEnvironmentProvisionedResourcesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton ListEnvironmentProvisionedResources \a response.
 */
void ListEnvironmentProvisionedResourcesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListEnvironmentProvisionedResourcesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListEnvironmentProvisionedResourcesResponsePrivate
 * \brief The ListEnvironmentProvisionedResourcesResponsePrivate class provides private implementation for ListEnvironmentProvisionedResourcesResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListEnvironmentProvisionedResourcesResponsePrivate object with public implementation \a q.
 */
ListEnvironmentProvisionedResourcesResponsePrivate::ListEnvironmentProvisionedResourcesResponsePrivate(
    ListEnvironmentProvisionedResourcesResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListEnvironmentProvisionedResources response element from \a xml.
 */
void ListEnvironmentProvisionedResourcesResponsePrivate::parseListEnvironmentProvisionedResourcesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListEnvironmentProvisionedResourcesResponse"));
    Q_UNUSED(xml) ///< @todo
}
