...
#include "listenvironmentaccountconnectionsresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListEnvironmentAccountConnectionsResponse
 * \brief The ListEnvironmentAccountConnectionsResponse class provides an interace for Proton ListEnvironmentAccountConnections responses.
 *
 ...
 *
 * \sa ProtonClient::listEnvironmentAccountConnections
 */

/*!
 * Constructs a ListEnvironmentAccountConnectionsResponse object for \a reply to \a request, with parent \a parent.
 */
ListEnvironmentAccountConnectionsResponse::ListEnvironmentAccountConnectionsResponse(
        const ListEnvironmentAccountConnectionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListEnvironmentAccountConnectionsResponsePrivate(this), parent)
{
    setRequest(new ListEnvironmentAccountConnectionsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListEnvironmentAccountConnectionsRequest * ListEnvironmentAccountConnectionsResponse::request() const
{
    Q_D(const ListEnvironmentAccountConnectionsResponse);
    return static_cast<const ListEnvironmentAccountConnectionsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton ListEnvironmentAccountConnections \a response.
 */
void ListEnvironmentAccountConnectionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListEnvironmentAccountConnectionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListEnvironmentAccountConnectionsResponsePrivate
 * \brief The ListEnvironmentAccountConnectionsResponsePrivate class provides private implementation for ListEnvironmentAccountConnectionsResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListEnvironmentAccountConnectionsResponsePrivate object with public implementation \a q.
 */
ListEnvironmentAccountConnectionsResponsePrivate::ListEnvironmentAccountConnectionsResponsePrivate(
    ListEnvironmentAccountConnectionsResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListEnvironmentAccountConnections response element from \a xml.
 */
void ListEnvironmentAccountConnectionsResponsePrivate::parseListEnvironmentAccountConnectionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListEnvironmentAccountConnectionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
