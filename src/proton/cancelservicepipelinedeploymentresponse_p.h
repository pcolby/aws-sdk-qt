...
class QTAWS_EXPORT CancelServicePipelineDeploymentResponsePrivate : public ProtonResponsePrivate {

public:

    CancelServicePipelineDeploymentResponsePrivate(CancelServicePipelineDeploymentResponse * const q);
