...
/*!
 * \class QtAws::Proton::GetServiceResponse
 * \brief The GetServiceResponse class provides an interace for Proton GetService responses.
 *
...
GetServiceResponse::GetServiceResponse(
    ...
    : ProtonResponse(new GetServiceResponsePrivate(this), parent)
{
...
{
    return static_cast<const GetServiceRequest *>(ProtonResponse::request());
}

/*!
 * \reimp
 * Parses a successful Proton GetService \a response.
 */
...
/*!
 * \class QtAws::Proton::GetServiceResponsePrivate
...
GetServiceResponsePrivate::GetServiceResponsePrivate(
    GetServiceResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton GetService response element from \a xml.
 */
