...
/*!
 * \class QtAws::Proton::CreateComponentRequest
 * \brief The CreateComponentRequest class provides an interface for Proton CreateComponent requests.
 *
 ...
 *
 * \sa ProtonClient::createComponent
 */
...
CreateComponentRequest::CreateComponentRequest(const CreateComponentRequest &other)
    : ProtonRequest(new CreateComponentRequestPrivate(*other.d_func(), this))
{
...
CreateComponentRequest::CreateComponentRequest()
    : ProtonRequest(new CreateComponentRequestPrivate(ProtonRequest::CreateComponentAction, this))
{
...
/*!
 * \class QtAws::Proton::CreateComponentRequestPrivate
...
/*!
 * Constructs a CreateComponentRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
CreateComponentRequestPrivate::CreateComponentRequestPrivate(
    const ProtonRequest::Action action, CreateComponentRequest * const q)
