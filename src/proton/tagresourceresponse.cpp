...
/*!
 * \class QtAws::Proton::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Proton TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ProtonResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(ProtonResponse::request());
}

/*!
 * \reimp
 * Parses a successful Proton TagResource \a response.
 */
...
/*!
 * \class QtAws::Proton::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton TagResource response element from \a xml.
 */
