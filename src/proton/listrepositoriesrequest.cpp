...
/*!
 * \class QtAws::Proton::ListRepositoriesRequest
 * \brief The ListRepositoriesRequest class provides an interface for Proton ListRepositories requests.
 *
 ...
 *
 * \sa ProtonClient::listRepositories
 */
...
ListRepositoriesRequest::ListRepositoriesRequest(const ListRepositoriesRequest &other)
    : ProtonRequest(new ListRepositoriesRequestPrivate(*other.d_func(), this))
{
...
ListRepositoriesRequest::ListRepositoriesRequest()
    : ProtonRequest(new ListRepositoriesRequestPrivate(ProtonRequest::ListRepositoriesAction, this))
{
...
/*!
 * \class QtAws::Proton::ListRepositoriesRequestPrivate
...
/*!
 * Constructs a ListRepositoriesRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListRepositoriesRequestPrivate::ListRepositoriesRequestPrivate(
    const ProtonRequest::Action action, ListRepositoriesRequest * const q)
