...
#include "updatetemplatesyncconfigrequest_p.h"
...
/*!
 * \class QtAws::Proton::UpdateTemplateSyncConfigRequest
 * \brief The UpdateTemplateSyncConfigRequest class provides an interface for Proton UpdateTemplateSyncConfig requests.
 *
 ...
 */
UpdateTemplateSyncConfigRequest::UpdateTemplateSyncConfigRequest(const UpdateTemplateSyncConfigRequest &other)
    : ProtonRequest(new UpdateTemplateSyncConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateTemplateSyncConfigRequest object.
 */
UpdateTemplateSyncConfigRequest::UpdateTemplateSyncConfigRequest()
    : ProtonRequest(new UpdateTemplateSyncConfigRequestPrivate(ProtonRequest::UpdateTemplateSyncConfigAction, this))
{
 ...
 * \reimp
 */
bool UpdateTemplateSyncConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateTemplateSyncConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateTemplateSyncConfigRequest::response(QNetworkReply * const reply) const
{
    return new UpdateTemplateSyncConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::UpdateTemplateSyncConfigRequestPrivate
 * \brief The UpdateTemplateSyncConfigRequestPrivate class provides private implementation for UpdateTemplateSyncConfigRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateTemplateSyncConfigRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
UpdateTemplateSyncConfigRequestPrivate::UpdateTemplateSyncConfigRequestPrivate(
    const ProtonRequest::Action action, UpdateTemplateSyncConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateTemplateSyncConfigRequest
 * class' copy constructor.
 */
UpdateTemplateSyncConfigRequestPrivate::UpdateTemplateSyncConfigRequestPrivate(
    const UpdateTemplateSyncConfigRequestPrivate &other, UpdateTemplateSyncConfigRequest * const q)
