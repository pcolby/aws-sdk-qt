...
/*!
 * \class QtAws::Proton::ListEnvironmentsRequest
 * \brief The ListEnvironmentsRequest class provides an interface for Proton ListEnvironments requests.
 *
 ...
 *
 * \sa ProtonClient::listEnvironments
 */
...
ListEnvironmentsRequest::ListEnvironmentsRequest(const ListEnvironmentsRequest &other)
    : ProtonRequest(new ListEnvironmentsRequestPrivate(*other.d_func(), this))
{
...
ListEnvironmentsRequest::ListEnvironmentsRequest()
    : ProtonRequest(new ListEnvironmentsRequestPrivate(ProtonRequest::ListEnvironmentsAction, this))
{
...
/*!
 * \class QtAws::Proton::ListEnvironmentsRequestPrivate
...
/*!
 * Constructs a ListEnvironmentsRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListEnvironmentsRequestPrivate::ListEnvironmentsRequestPrivate(
    const ProtonRequest::Action action, ListEnvironmentsRequest * const q)
