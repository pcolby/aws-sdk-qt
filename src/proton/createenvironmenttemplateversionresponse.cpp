...
#include "createenvironmenttemplateversionresponse_p.h"
...
/*!
 * \class QtAws::Proton::CreateEnvironmentTemplateVersionResponse
 * \brief The CreateEnvironmentTemplateVersionResponse class provides an interace for Proton CreateEnvironmentTemplateVersion responses.
 *
...
/*!
 * Constructs a CreateEnvironmentTemplateVersionResponse object for \a reply to \a request, with parent \a parent.
 */
CreateEnvironmentTemplateVersionResponse::CreateEnvironmentTemplateVersionResponse(
        const CreateEnvironmentTemplateVersionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new CreateEnvironmentTemplateVersionResponsePrivate(this), parent)
{
    setRequest(new CreateEnvironmentTemplateVersionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton CreateEnvironmentTemplateVersion \a response.
 */
void CreateEnvironmentTemplateVersionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateEnvironmentTemplateVersionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::CreateEnvironmentTemplateVersionResponsePrivate
 * \brief The CreateEnvironmentTemplateVersionResponsePrivate class provides private implementation for CreateEnvironmentTemplateVersionResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CreateEnvironmentTemplateVersionResponsePrivate object with public implementation \a q.
 */
CreateEnvironmentTemplateVersionResponsePrivate::CreateEnvironmentTemplateVersionResponsePrivate(
    CreateEnvironmentTemplateVersionResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton CreateEnvironmentTemplateVersion response element from \a xml.
 */
void CreateEnvironmentTemplateVersionResponsePrivate::parseCreateEnvironmentTemplateVersionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateEnvironmentTemplateVersionResponse"));
    Q_UNUSED(xml) ///< @todo
}
