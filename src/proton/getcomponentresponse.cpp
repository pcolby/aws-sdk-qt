...
/*!
 * \class QtAws::Proton::GetComponentResponse
 * \brief The GetComponentResponse class provides an interace for Proton GetComponent responses.
 *
...
GetComponentResponse::GetComponentResponse(
    ...
    : ProtonResponse(new GetComponentResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton GetComponent \a response.
 */
...
/*!
 * \class QtAws::Proton::GetComponentResponsePrivate
...
GetComponentResponsePrivate::GetComponentResponsePrivate(
    GetComponentResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton GetComponent response element from \a xml.
 */
