...
class QTAWS_EXPORT UpdateServiceInstanceResponsePrivate : public ProtonResponsePrivate {

public:

    UpdateServiceInstanceResponsePrivate(UpdateServiceInstanceResponse * const q);
