...
/*!
 * \class QtAws::Proton::GetAccountSettingsRequest
 * \brief The GetAccountSettingsRequest class provides an interface for Proton GetAccountSettings requests.
 *
 ...
 *
 * \sa ProtonClient::getAccountSettings
 */
...
GetAccountSettingsRequest::GetAccountSettingsRequest(const GetAccountSettingsRequest &other)
    : ProtonRequest(new GetAccountSettingsRequestPrivate(*other.d_func(), this))
{
...
GetAccountSettingsRequest::GetAccountSettingsRequest()
    : ProtonRequest(new GetAccountSettingsRequestPrivate(ProtonRequest::GetAccountSettingsAction, this))
{
...
/*!
 * \class QtAws::Proton::GetAccountSettingsRequestPrivate
...
/*!
 * Constructs a GetAccountSettingsRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
GetAccountSettingsRequestPrivate::GetAccountSettingsRequestPrivate(
    const ProtonRequest::Action action, GetAccountSettingsRequest * const q)
