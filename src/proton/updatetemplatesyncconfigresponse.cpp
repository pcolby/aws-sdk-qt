...
#include "updatetemplatesyncconfigresponse_p.h"
...
/*!
 * \class QtAws::Proton::UpdateTemplateSyncConfigResponse
 * \brief The UpdateTemplateSyncConfigResponse class provides an interace for Proton UpdateTemplateSyncConfig responses.
 *
 ...
 *
 * \sa ProtonClient::updateTemplateSyncConfig
 */

/*!
 * Constructs a UpdateTemplateSyncConfigResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateTemplateSyncConfigResponse::UpdateTemplateSyncConfigResponse(
        const UpdateTemplateSyncConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new UpdateTemplateSyncConfigResponsePrivate(this), parent)
{
    setRequest(new UpdateTemplateSyncConfigRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateTemplateSyncConfigRequest * UpdateTemplateSyncConfigResponse::request() const
{
    Q_D(const UpdateTemplateSyncConfigResponse);
    return static_cast<const UpdateTemplateSyncConfigRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton UpdateTemplateSyncConfig \a response.
 */
void UpdateTemplateSyncConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateTemplateSyncConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::UpdateTemplateSyncConfigResponsePrivate
 * \brief The UpdateTemplateSyncConfigResponsePrivate class provides private implementation for UpdateTemplateSyncConfigResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateTemplateSyncConfigResponsePrivate object with public implementation \a q.
 */
UpdateTemplateSyncConfigResponsePrivate::UpdateTemplateSyncConfigResponsePrivate(
    UpdateTemplateSyncConfigResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton UpdateTemplateSyncConfig response element from \a xml.
 */
void UpdateTemplateSyncConfigResponsePrivate::parseUpdateTemplateSyncConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateTemplateSyncConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
