...
#include "deleteenvironmenttemplateversionresponse_p.h"
...
/*!
 * \class QtAws::Proton::DeleteEnvironmentTemplateVersionResponse
 * \brief The DeleteEnvironmentTemplateVersionResponse class provides an interace for Proton DeleteEnvironmentTemplateVersion responses.
 *
 ...
 *
 * \sa ProtonClient::deleteEnvironmentTemplateVersion
 */

/*!
 * Constructs a DeleteEnvironmentTemplateVersionResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteEnvironmentTemplateVersionResponse::DeleteEnvironmentTemplateVersionResponse(
        const DeleteEnvironmentTemplateVersionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new DeleteEnvironmentTemplateVersionResponsePrivate(this), parent)
{
    setRequest(new DeleteEnvironmentTemplateVersionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteEnvironmentTemplateVersionRequest * DeleteEnvironmentTemplateVersionResponse::request() const
{
    Q_D(const DeleteEnvironmentTemplateVersionResponse);
    return static_cast<const DeleteEnvironmentTemplateVersionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton DeleteEnvironmentTemplateVersion \a response.
 */
void DeleteEnvironmentTemplateVersionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteEnvironmentTemplateVersionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::DeleteEnvironmentTemplateVersionResponsePrivate
 * \brief The DeleteEnvironmentTemplateVersionResponsePrivate class provides private implementation for DeleteEnvironmentTemplateVersionResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a DeleteEnvironmentTemplateVersionResponsePrivate object with public implementation \a q.
 */
DeleteEnvironmentTemplateVersionResponsePrivate::DeleteEnvironmentTemplateVersionResponsePrivate(
    DeleteEnvironmentTemplateVersionResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton DeleteEnvironmentTemplateVersion response element from \a xml.
 */
void DeleteEnvironmentTemplateVersionResponsePrivate::parseDeleteEnvironmentTemplateVersionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteEnvironmentTemplateVersionResponse"));
    Q_UNUSED(xml) ///< @todo
}
