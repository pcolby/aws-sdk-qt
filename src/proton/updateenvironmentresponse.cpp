...
/*!
 * \class QtAws::Proton::UpdateEnvironmentResponse
 * \brief The UpdateEnvironmentResponse class provides an interace for Proton UpdateEnvironment responses.
 *
 ...
 *
 * \sa ProtonClient::updateEnvironment
 */
...
UpdateEnvironmentResponse::UpdateEnvironmentResponse(
    ...
    : ProtonResponse(new UpdateEnvironmentResponsePrivate(this), parent)
{
...
{
    return static_cast<const UpdateEnvironmentRequest *>(ProtonResponse::request());
}

/*!
 * \reimp
 * Parses a successful Proton UpdateEnvironment \a response.
 */
...
/*!
 * \class QtAws::Proton::UpdateEnvironmentResponsePrivate
...
UpdateEnvironmentResponsePrivate::UpdateEnvironmentResponsePrivate(
    UpdateEnvironmentResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton UpdateEnvironment response element from \a xml.
 */
