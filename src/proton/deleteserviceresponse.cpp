...
/*!
 * \class QtAws::Proton::DeleteServiceResponse
 * \brief The DeleteServiceResponse class provides an interace for Proton DeleteService responses.
 *
...
DeleteServiceResponse::DeleteServiceResponse(
    ...
    : ProtonResponse(new DeleteServiceResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteServiceRequest *>(ProtonResponse::request());
}

/*!
 * \reimp
 * Parses a successful Proton DeleteService \a response.
 */
...
/*!
 * \class QtAws::Proton::DeleteServiceResponsePrivate
...
DeleteServiceResponsePrivate::DeleteServiceResponsePrivate(
    DeleteServiceResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton DeleteService response element from \a xml.
 */
