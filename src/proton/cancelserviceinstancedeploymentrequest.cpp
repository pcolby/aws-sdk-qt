...
#include "cancelserviceinstancedeploymentrequest_p.h"
...
/*!
 * \class QtAws::Proton::CancelServiceInstanceDeploymentRequest
 * \brief The CancelServiceInstanceDeploymentRequest class provides an interface for Proton CancelServiceInstanceDeployment requests.
 *
 ...
 *
 * \sa ProtonClient::cancelServiceInstanceDeployment
 */

/*!
 * Constructs a copy of \a other.
 */
CancelServiceInstanceDeploymentRequest::CancelServiceInstanceDeploymentRequest(const CancelServiceInstanceDeploymentRequest &other)
    : ProtonRequest(new CancelServiceInstanceDeploymentRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CancelServiceInstanceDeploymentRequest object.
 */
CancelServiceInstanceDeploymentRequest::CancelServiceInstanceDeploymentRequest()
    : ProtonRequest(new CancelServiceInstanceDeploymentRequestPrivate(ProtonRequest::CancelServiceInstanceDeploymentAction, this))
{
 ...
 * \reimp
 */
bool CancelServiceInstanceDeploymentRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CancelServiceInstanceDeploymentResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CancelServiceInstanceDeploymentRequest::response(QNetworkReply * const reply) const
{
    return new CancelServiceInstanceDeploymentResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::CancelServiceInstanceDeploymentRequestPrivate
 * \brief The CancelServiceInstanceDeploymentRequestPrivate class provides private implementation for CancelServiceInstanceDeploymentRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CancelServiceInstanceDeploymentRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
CancelServiceInstanceDeploymentRequestPrivate::CancelServiceInstanceDeploymentRequestPrivate(
    const ProtonRequest::Action action, CancelServiceInstanceDeploymentRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CancelServiceInstanceDeploymentRequest
 * class' copy constructor.
 */
CancelServiceInstanceDeploymentRequestPrivate::CancelServiceInstanceDeploymentRequestPrivate(
    const CancelServiceInstanceDeploymentRequestPrivate &other, CancelServiceInstanceDeploymentRequest * const q)
