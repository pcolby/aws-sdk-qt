...
/*!
 * \class QtAws::Proton::GetServiceRequest
 * \brief The GetServiceRequest class provides an interface for Proton GetService requests.
 *
...
GetServiceRequest::GetServiceRequest(const GetServiceRequest &other)
    : ProtonRequest(new GetServiceRequestPrivate(*other.d_func(), this))
{
...
GetServiceRequest::GetServiceRequest()
    : ProtonRequest(new GetServiceRequestPrivate(ProtonRequest::GetServiceAction, this))
{
...
/*!
 * \class QtAws::Proton::GetServiceRequestPrivate
...
/*!
 * Constructs a GetServiceRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
GetServiceRequestPrivate::GetServiceRequestPrivate(
    const ProtonRequest::Action action, GetServiceRequest * const q)
