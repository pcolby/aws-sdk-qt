...
#include "listenvironmentoutputsrequest_p.h"
...
/*!
 * \class QtAws::Proton::ListEnvironmentOutputsRequest
 * \brief The ListEnvironmentOutputsRequest class provides an interface for Proton ListEnvironmentOutputs requests.
 *
 ...
 */
ListEnvironmentOutputsRequest::ListEnvironmentOutputsRequest(const ListEnvironmentOutputsRequest &other)
    : ProtonRequest(new ListEnvironmentOutputsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListEnvironmentOutputsRequest object.
 */
ListEnvironmentOutputsRequest::ListEnvironmentOutputsRequest()
    : ProtonRequest(new ListEnvironmentOutputsRequestPrivate(ProtonRequest::ListEnvironmentOutputsAction, this))
{
 ...
 * \reimp
 */
bool ListEnvironmentOutputsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListEnvironmentOutputsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListEnvironmentOutputsRequest::response(QNetworkReply * const reply) const
{
    return new ListEnvironmentOutputsResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::ListEnvironmentOutputsRequestPrivate
 * \brief The ListEnvironmentOutputsRequestPrivate class provides private implementation for ListEnvironmentOutputsRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListEnvironmentOutputsRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListEnvironmentOutputsRequestPrivate::ListEnvironmentOutputsRequestPrivate(
    const ProtonRequest::Action action, ListEnvironmentOutputsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListEnvironmentOutputsRequest
 * class' copy constructor.
 */
ListEnvironmentOutputsRequestPrivate::ListEnvironmentOutputsRequestPrivate(
    const ListEnvironmentOutputsRequestPrivate &other, ListEnvironmentOutputsRequest * const q)
