...
#include "gettemplatesyncconfigrequest_p.h"
...
/*!
 * \class QtAws::Proton::GetTemplateSyncConfigRequest
 * \brief The GetTemplateSyncConfigRequest class provides an interface for Proton GetTemplateSyncConfig requests.
 *
 ...
 */
GetTemplateSyncConfigRequest::GetTemplateSyncConfigRequest(const GetTemplateSyncConfigRequest &other)
    : ProtonRequest(new GetTemplateSyncConfigRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetTemplateSyncConfigRequest object.
 */
GetTemplateSyncConfigRequest::GetTemplateSyncConfigRequest()
    : ProtonRequest(new GetTemplateSyncConfigRequestPrivate(ProtonRequest::GetTemplateSyncConfigAction, this))
{
 ...
 * \reimp
 */
bool GetTemplateSyncConfigRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetTemplateSyncConfigResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetTemplateSyncConfigRequest::response(QNetworkReply * const reply) const
{
    return new GetTemplateSyncConfigResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::GetTemplateSyncConfigRequestPrivate
 * \brief The GetTemplateSyncConfigRequestPrivate class provides private implementation for GetTemplateSyncConfigRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetTemplateSyncConfigRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
GetTemplateSyncConfigRequestPrivate::GetTemplateSyncConfigRequestPrivate(
    const ProtonRequest::Action action, GetTemplateSyncConfigRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetTemplateSyncConfigRequest
 * class' copy constructor.
 */
GetTemplateSyncConfigRequestPrivate::GetTemplateSyncConfigRequestPrivate(
    const GetTemplateSyncConfigRequestPrivate &other, GetTemplateSyncConfigRequest * const q)
