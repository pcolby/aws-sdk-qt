...
class QTAWS_EXPORT CreateEnvironmentTemplateVersionResponsePrivate : public ProtonResponsePrivate {

public:

    CreateEnvironmentTemplateVersionResponsePrivate(CreateEnvironmentTemplateVersionResponse * const q);
