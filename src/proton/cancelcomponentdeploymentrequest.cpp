...
#include "cancelcomponentdeploymentrequest_p.h"
...
/*!
 * \class QtAws::Proton::CancelComponentDeploymentRequest
 * \brief The CancelComponentDeploymentRequest class provides an interface for Proton CancelComponentDeployment requests.
 *
 ...
 */
CancelComponentDeploymentRequest::CancelComponentDeploymentRequest(const CancelComponentDeploymentRequest &other)
    : ProtonRequest(new CancelComponentDeploymentRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CancelComponentDeploymentRequest object.
 */
CancelComponentDeploymentRequest::CancelComponentDeploymentRequest()
    : ProtonRequest(new CancelComponentDeploymentRequestPrivate(ProtonRequest::CancelComponentDeploymentAction, this))
{
 ...
 * \reimp
 */
bool CancelComponentDeploymentRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CancelComponentDeploymentResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CancelComponentDeploymentRequest::response(QNetworkReply * const reply) const
{
    return new CancelComponentDeploymentResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::CancelComponentDeploymentRequestPrivate
 * \brief The CancelComponentDeploymentRequestPrivate class provides private implementation for CancelComponentDeploymentRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CancelComponentDeploymentRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
CancelComponentDeploymentRequestPrivate::CancelComponentDeploymentRequestPrivate(
    const ProtonRequest::Action action, CancelComponentDeploymentRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CancelComponentDeploymentRequest
 * class' copy constructor.
 */
CancelComponentDeploymentRequestPrivate::CancelComponentDeploymentRequestPrivate(
    const CancelComponentDeploymentRequestPrivate &other, CancelComponentDeploymentRequest * const q)
