...
#include "listservicepipelineprovisionedresourcesresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListServicePipelineProvisionedResourcesResponse
 * \brief The ListServicePipelineProvisionedResourcesResponse class provides an interace for Proton ListServicePipelineProvisionedResources responses.
 *
 ...
 *
 * \sa ProtonClient::listServicePipelineProvisionedResources
 */

/*!
 * Constructs a ListServicePipelineProvisionedResourcesResponse object for \a reply to \a request, with parent \a parent.
 */
ListServicePipelineProvisionedResourcesResponse::ListServicePipelineProvisionedResourcesResponse(
        const ListServicePipelineProvisionedResourcesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListServicePipelineProvisionedResourcesResponsePrivate(this), parent)
{
    setRequest(new ListServicePipelineProvisionedResourcesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListServicePipelineProvisionedResourcesRequest * ListServicePipelineProvisionedResourcesResponse::request() const
{
    Q_D(const ListServicePipelineProvisionedResourcesResponse);
    return static_cast<const ListServicePipelineProvisionedResourcesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton ListServicePipelineProvisionedResources \a response.
 */
void ListServicePipelineProvisionedResourcesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListServicePipelineProvisionedResourcesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListServicePipelineProvisionedResourcesResponsePrivate
 * \brief The ListServicePipelineProvisionedResourcesResponsePrivate class provides private implementation for ListServicePipelineProvisionedResourcesResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListServicePipelineProvisionedResourcesResponsePrivate object with public implementation \a q.
 */
ListServicePipelineProvisionedResourcesResponsePrivate::ListServicePipelineProvisionedResourcesResponsePrivate(
    ListServicePipelineProvisionedResourcesResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListServicePipelineProvisionedResources response element from \a xml.
 */
void ListServicePipelineProvisionedResourcesResponsePrivate::parseListServicePipelineProvisionedResourcesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListServicePipelineProvisionedResourcesResponse"));
    Q_UNUSED(xml) ///< @todo
}
