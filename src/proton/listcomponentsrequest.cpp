...
/*!
 * \class QtAws::Proton::ListComponentsRequest
 * \brief The ListComponentsRequest class provides an interface for Proton ListComponents requests.
 *
 ...
 *
 * \sa ProtonClient::listComponents
 */
...
ListComponentsRequest::ListComponentsRequest(const ListComponentsRequest &other)
    : ProtonRequest(new ListComponentsRequestPrivate(*other.d_func(), this))
{
...
ListComponentsRequest::ListComponentsRequest()
    : ProtonRequest(new ListComponentsRequestPrivate(ProtonRequest::ListComponentsAction, this))
{
...
/*!
 * \class QtAws::Proton::ListComponentsRequestPrivate
...
/*!
 * Constructs a ListComponentsRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListComponentsRequestPrivate::ListComponentsRequestPrivate(
    const ProtonRequest::Action action, ListComponentsRequest * const q)
