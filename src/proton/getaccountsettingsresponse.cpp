...
/*!
 * \class QtAws::Proton::GetAccountSettingsResponse
 * \brief The GetAccountSettingsResponse class provides an interace for Proton GetAccountSettings responses.
 *
...
GetAccountSettingsResponse::GetAccountSettingsResponse(
    ...
    : ProtonResponse(new GetAccountSettingsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton GetAccountSettings \a response.
 */
...
/*!
 * \class QtAws::Proton::GetAccountSettingsResponsePrivate
...
GetAccountSettingsResponsePrivate::GetAccountSettingsResponsePrivate(
    GetAccountSettingsResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton GetAccountSettings response element from \a xml.
 */
