...
/*!
 * \class QtAws::Proton::GetEnvironmentResponse
 * \brief The GetEnvironmentResponse class provides an interace for Proton GetEnvironment responses.
 *
 ...
 *
 * \sa ProtonClient::getEnvironment
 */
...
GetEnvironmentResponse::GetEnvironmentResponse(
    ...
    : ProtonResponse(new GetEnvironmentResponsePrivate(this), parent)
{
...
{
    return static_cast<const GetEnvironmentRequest *>(ProtonResponse::request());
}

/*!
 * \reimp
 * Parses a successful Proton GetEnvironment \a response.
 */
...
/*!
 * \class QtAws::Proton::GetEnvironmentResponsePrivate
...
GetEnvironmentResponsePrivate::GetEnvironmentResponsePrivate(
    GetEnvironmentResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton GetEnvironment response element from \a xml.
 */
