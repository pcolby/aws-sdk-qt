...
#include "createservicetemplateversionrequest_p.h"
...
/*!
 * \class QtAws::Proton::CreateServiceTemplateVersionRequest
 * \brief The CreateServiceTemplateVersionRequest class provides an interface for Proton CreateServiceTemplateVersion requests.
 *
 ...
 *
 * \sa ProtonClient::createServiceTemplateVersion
 */

/*!
 * Constructs a copy of \a other.
 */
CreateServiceTemplateVersionRequest::CreateServiceTemplateVersionRequest(const CreateServiceTemplateVersionRequest &other)
    : ProtonRequest(new CreateServiceTemplateVersionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateServiceTemplateVersionRequest object.
 */
CreateServiceTemplateVersionRequest::CreateServiceTemplateVersionRequest()
    : ProtonRequest(new CreateServiceTemplateVersionRequestPrivate(ProtonRequest::CreateServiceTemplateVersionAction, this))
{
 ...
 * \reimp
 */
bool CreateServiceTemplateVersionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateServiceTemplateVersionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateServiceTemplateVersionRequest::response(QNetworkReply * const reply) const
{
    return new CreateServiceTemplateVersionResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::CreateServiceTemplateVersionRequestPrivate
 * \brief The CreateServiceTemplateVersionRequestPrivate class provides private implementation for CreateServiceTemplateVersionRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CreateServiceTemplateVersionRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
CreateServiceTemplateVersionRequestPrivate::CreateServiceTemplateVersionRequestPrivate(
    const ProtonRequest::Action action, CreateServiceTemplateVersionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateServiceTemplateVersionRequest
 * class' copy constructor.
 */
CreateServiceTemplateVersionRequestPrivate::CreateServiceTemplateVersionRequestPrivate(
    const CreateServiceTemplateVersionRequestPrivate &other, CreateServiceTemplateVersionRequest * const q)
