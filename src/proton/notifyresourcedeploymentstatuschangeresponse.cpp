...
#include "notifyresourcedeploymentstatuschangeresponse_p.h"
...
/*!
 * \class QtAws::Proton::NotifyResourceDeploymentStatusChangeResponse
 * \brief The NotifyResourceDeploymentStatusChangeResponse class provides an interace for Proton NotifyResourceDeploymentStatusChange responses.
 *
 ...
 *
 * \sa ProtonClient::notifyResourceDeploymentStatusChange
 */

/*!
 * Constructs a NotifyResourceDeploymentStatusChangeResponse object for \a reply to \a request, with parent \a parent.
 */
NotifyResourceDeploymentStatusChangeResponse::NotifyResourceDeploymentStatusChangeResponse(
        const NotifyResourceDeploymentStatusChangeRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new NotifyResourceDeploymentStatusChangeResponsePrivate(this), parent)
{
    setRequest(new NotifyResourceDeploymentStatusChangeRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const NotifyResourceDeploymentStatusChangeRequest * NotifyResourceDeploymentStatusChangeResponse::request() const
{
    Q_D(const NotifyResourceDeploymentStatusChangeResponse);
    return static_cast<const NotifyResourceDeploymentStatusChangeRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton NotifyResourceDeploymentStatusChange \a response.
 */
void NotifyResourceDeploymentStatusChangeResponse::parseSuccess(QIODevice &response)
{
    //Q_D(NotifyResourceDeploymentStatusChangeResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::NotifyResourceDeploymentStatusChangeResponsePrivate
 * \brief The NotifyResourceDeploymentStatusChangeResponsePrivate class provides private implementation for NotifyResourceDeploymentStatusChangeResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a NotifyResourceDeploymentStatusChangeResponsePrivate object with public implementation \a q.
 */
NotifyResourceDeploymentStatusChangeResponsePrivate::NotifyResourceDeploymentStatusChangeResponsePrivate(
    NotifyResourceDeploymentStatusChangeResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton NotifyResourceDeploymentStatusChange response element from \a xml.
 */
void NotifyResourceDeploymentStatusChangeResponsePrivate::parseNotifyResourceDeploymentStatusChangeResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("NotifyResourceDeploymentStatusChangeResponse"));
    Q_UNUSED(xml) ///< @todo
}
