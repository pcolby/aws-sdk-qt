...
/*!
 * \class QtAws::Proton::DeleteEnvironmentRequest
 * \brief The DeleteEnvironmentRequest class provides an interface for Proton DeleteEnvironment requests.
 *
...
DeleteEnvironmentRequest::DeleteEnvironmentRequest(const DeleteEnvironmentRequest &other)
    : ProtonRequest(new DeleteEnvironmentRequestPrivate(*other.d_func(), this))
{
...
DeleteEnvironmentRequest::DeleteEnvironmentRequest()
    : ProtonRequest(new DeleteEnvironmentRequestPrivate(ProtonRequest::DeleteEnvironmentAction, this))
{
...
/*!
 * \class QtAws::Proton::DeleteEnvironmentRequestPrivate
...
/*!
 * Constructs a DeleteEnvironmentRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
DeleteEnvironmentRequestPrivate::DeleteEnvironmentRequestPrivate(
    const ProtonRequest::Action action, DeleteEnvironmentRequest * const q)
