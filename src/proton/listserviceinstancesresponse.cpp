...
#include "listserviceinstancesresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListServiceInstancesResponse
 * \brief The ListServiceInstancesResponse class provides an interace for Proton ListServiceInstances responses.
 *
...
/*!
 * Constructs a ListServiceInstancesResponse object for \a reply to \a request, with parent \a parent.
 */
ListServiceInstancesResponse::ListServiceInstancesResponse(
        const ListServiceInstancesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListServiceInstancesResponsePrivate(this), parent)
{
    setRequest(new ListServiceInstancesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton ListServiceInstances \a response.
 */
void ListServiceInstancesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListServiceInstancesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListServiceInstancesResponsePrivate
 * \brief The ListServiceInstancesResponsePrivate class provides private implementation for ListServiceInstancesResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListServiceInstancesResponsePrivate object with public implementation \a q.
 */
ListServiceInstancesResponsePrivate::ListServiceInstancesResponsePrivate(
    ListServiceInstancesResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListServiceInstances response element from \a xml.
 */
void ListServiceInstancesResponsePrivate::parseListServiceInstancesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListServiceInstancesResponse"));
    Q_UNUSED(xml) ///< @todo
}
