...
#include "updateservicetemplaterequest_p.h"
...
/*!
 * \class QtAws::Proton::UpdateServiceTemplateRequest
 * \brief The UpdateServiceTemplateRequest class provides an interface for Proton UpdateServiceTemplate requests.
 *
 ...
 *
 * \sa ProtonClient::updateServiceTemplate
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateServiceTemplateRequest::UpdateServiceTemplateRequest(const UpdateServiceTemplateRequest &other)
    : ProtonRequest(new UpdateServiceTemplateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateServiceTemplateRequest object.
 */
UpdateServiceTemplateRequest::UpdateServiceTemplateRequest()
    : ProtonRequest(new UpdateServiceTemplateRequestPrivate(ProtonRequest::UpdateServiceTemplateAction, this))
{
 ...
 * \reimp
 */
bool UpdateServiceTemplateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateServiceTemplateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateServiceTemplateRequest::response(QNetworkReply * const reply) const
{
    return new UpdateServiceTemplateResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::UpdateServiceTemplateRequestPrivate
 * \brief The UpdateServiceTemplateRequestPrivate class provides private implementation for UpdateServiceTemplateRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateServiceTemplateRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
UpdateServiceTemplateRequestPrivate::UpdateServiceTemplateRequestPrivate(
    const ProtonRequest::Action action, UpdateServiceTemplateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateServiceTemplateRequest
 * class' copy constructor.
 */
UpdateServiceTemplateRequestPrivate::UpdateServiceTemplateRequestPrivate(
    const UpdateServiceTemplateRequestPrivate &other, UpdateServiceTemplateRequest * const q)
