...
#include "updateserviceinstancerequest_p.h"
...
/*!
 * \class QtAws::Proton::UpdateServiceInstanceRequest
 * \brief The UpdateServiceInstanceRequest class provides an interface for Proton UpdateServiceInstance requests.
 *
 ...
 */
UpdateServiceInstanceRequest::UpdateServiceInstanceRequest(const UpdateServiceInstanceRequest &other)
    : ProtonRequest(new UpdateServiceInstanceRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateServiceInstanceRequest object.
 */
UpdateServiceInstanceRequest::UpdateServiceInstanceRequest()
    : ProtonRequest(new UpdateServiceInstanceRequestPrivate(ProtonRequest::UpdateServiceInstanceAction, this))
{
 ...
 * \reimp
 */
bool UpdateServiceInstanceRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateServiceInstanceResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateServiceInstanceRequest::response(QNetworkReply * const reply) const
{
    return new UpdateServiceInstanceResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::UpdateServiceInstanceRequestPrivate
 * \brief The UpdateServiceInstanceRequestPrivate class provides private implementation for UpdateServiceInstanceRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateServiceInstanceRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
UpdateServiceInstanceRequestPrivate::UpdateServiceInstanceRequestPrivate(
    const ProtonRequest::Action action, UpdateServiceInstanceRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateServiceInstanceRequest
 * class' copy constructor.
 */
UpdateServiceInstanceRequestPrivate::UpdateServiceInstanceRequestPrivate(
    const UpdateServiceInstanceRequestPrivate &other, UpdateServiceInstanceRequest * const q)
