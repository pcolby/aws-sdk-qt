...
#include "listservicetemplatesrequest_p.h"
...
/*!
 * \class QtAws::Proton::ListServiceTemplatesRequest
 * \brief The ListServiceTemplatesRequest class provides an interface for Proton ListServiceTemplates requests.
 *
 ...
 */
ListServiceTemplatesRequest::ListServiceTemplatesRequest(const ListServiceTemplatesRequest &other)
    : ProtonRequest(new ListServiceTemplatesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListServiceTemplatesRequest object.
 */
ListServiceTemplatesRequest::ListServiceTemplatesRequest()
    : ProtonRequest(new ListServiceTemplatesRequestPrivate(ProtonRequest::ListServiceTemplatesAction, this))
{
 ...
 * \reimp
 */
bool ListServiceTemplatesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListServiceTemplatesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListServiceTemplatesRequest::response(QNetworkReply * const reply) const
{
    return new ListServiceTemplatesResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::ListServiceTemplatesRequestPrivate
 * \brief The ListServiceTemplatesRequestPrivate class provides private implementation for ListServiceTemplatesRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListServiceTemplatesRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListServiceTemplatesRequestPrivate::ListServiceTemplatesRequestPrivate(
    const ProtonRequest::Action action, ListServiceTemplatesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListServiceTemplatesRequest
 * class' copy constructor.
 */
ListServiceTemplatesRequestPrivate::ListServiceTemplatesRequestPrivate(
    const ListServiceTemplatesRequestPrivate &other, ListServiceTemplatesRequest * const q)
