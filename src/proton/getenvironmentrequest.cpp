...
/*!
 * \class QtAws::Proton::GetEnvironmentRequest
 * \brief The GetEnvironmentRequest class provides an interface for Proton GetEnvironment requests.
 *
...
GetEnvironmentRequest::GetEnvironmentRequest(const GetEnvironmentRequest &other)
    : ProtonRequest(new GetEnvironmentRequestPrivate(*other.d_func(), this))
{
...
GetEnvironmentRequest::GetEnvironmentRequest()
    : ProtonRequest(new GetEnvironmentRequestPrivate(ProtonRequest::GetEnvironmentAction, this))
{
...
/*!
 * \class QtAws::Proton::GetEnvironmentRequestPrivate
...
/*!
 * Constructs a GetEnvironmentRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
GetEnvironmentRequestPrivate::GetEnvironmentRequestPrivate(
    const ProtonRequest::Action action, GetEnvironmentRequest * const q)
