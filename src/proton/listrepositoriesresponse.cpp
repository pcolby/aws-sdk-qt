...
/*!
 * \class QtAws::Proton::ListRepositoriesResponse
 * \brief The ListRepositoriesResponse class provides an interace for Proton ListRepositories responses.
 *
...
ListRepositoriesResponse::ListRepositoriesResponse(
    ...
    : ProtonResponse(new ListRepositoriesResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton ListRepositories \a response.
 */
...
/*!
 * \class QtAws::Proton::ListRepositoriesResponsePrivate
...
ListRepositoriesResponsePrivate::ListRepositoriesResponsePrivate(
    ListRepositoriesResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListRepositories response element from \a xml.
 */
