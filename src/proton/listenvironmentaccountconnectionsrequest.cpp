...
#include "listenvironmentaccountconnectionsrequest_p.h"
...
/*!
 * \class QtAws::Proton::ListEnvironmentAccountConnectionsRequest
 * \brief The ListEnvironmentAccountConnectionsRequest class provides an interface for Proton ListEnvironmentAccountConnections requests.
 *
 ...
 */
ListEnvironmentAccountConnectionsRequest::ListEnvironmentAccountConnectionsRequest(const ListEnvironmentAccountConnectionsRequest &other)
    : ProtonRequest(new ListEnvironmentAccountConnectionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListEnvironmentAccountConnectionsRequest object.
 */
ListEnvironmentAccountConnectionsRequest::ListEnvironmentAccountConnectionsRequest()
    : ProtonRequest(new ListEnvironmentAccountConnectionsRequestPrivate(ProtonRequest::ListEnvironmentAccountConnectionsAction, this))
{
 ...
 * \reimp
 */
bool ListEnvironmentAccountConnectionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListEnvironmentAccountConnectionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListEnvironmentAccountConnectionsRequest::response(QNetworkReply * const reply) const
{
    return new ListEnvironmentAccountConnectionsResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::ListEnvironmentAccountConnectionsRequestPrivate
 * \brief The ListEnvironmentAccountConnectionsRequestPrivate class provides private implementation for ListEnvironmentAccountConnectionsRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListEnvironmentAccountConnectionsRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListEnvironmentAccountConnectionsRequestPrivate::ListEnvironmentAccountConnectionsRequestPrivate(
    const ProtonRequest::Action action, ListEnvironmentAccountConnectionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListEnvironmentAccountConnectionsRequest
 * class' copy constructor.
 */
ListEnvironmentAccountConnectionsRequestPrivate::ListEnvironmentAccountConnectionsRequestPrivate(
    const ListEnvironmentAccountConnectionsRequestPrivate &other, ListEnvironmentAccountConnectionsRequest * const q)
