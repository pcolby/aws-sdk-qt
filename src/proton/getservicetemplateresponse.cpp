...
#include "getservicetemplateresponse_p.h"
...
/*!
 * \class QtAws::Proton::GetServiceTemplateResponse
 * \brief The GetServiceTemplateResponse class provides an interace for Proton GetServiceTemplate responses.
 *
...
/*!
 * Constructs a GetServiceTemplateResponse object for \a reply to \a request, with parent \a parent.
 */
GetServiceTemplateResponse::GetServiceTemplateResponse(
        const GetServiceTemplateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new GetServiceTemplateResponsePrivate(this), parent)
{
    setRequest(new GetServiceTemplateRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton GetServiceTemplate \a response.
 */
void GetServiceTemplateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetServiceTemplateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::GetServiceTemplateResponsePrivate
 * \brief The GetServiceTemplateResponsePrivate class provides private implementation for GetServiceTemplateResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetServiceTemplateResponsePrivate object with public implementation \a q.
 */
GetServiceTemplateResponsePrivate::GetServiceTemplateResponsePrivate(
    GetServiceTemplateResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton GetServiceTemplate response element from \a xml.
 */
void GetServiceTemplateResponsePrivate::parseGetServiceTemplateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetServiceTemplateResponse"));
    Q_UNUSED(xml) ///< @todo
}
