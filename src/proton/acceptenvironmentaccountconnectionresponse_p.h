...
class QTAWS_EXPORT AcceptEnvironmentAccountConnectionResponsePrivate : public ProtonResponsePrivate {

public:

    AcceptEnvironmentAccountConnectionResponsePrivate(AcceptEnvironmentAccountConnectionResponse * const q);
