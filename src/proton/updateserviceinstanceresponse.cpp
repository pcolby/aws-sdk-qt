...
#include "updateserviceinstanceresponse_p.h"
...
/*!
 * \class QtAws::Proton::UpdateServiceInstanceResponse
 * \brief The UpdateServiceInstanceResponse class provides an interace for Proton UpdateServiceInstance responses.
 *
 ...
 *
 * \sa ProtonClient::updateServiceInstance
 */

/*!
 * Constructs a UpdateServiceInstanceResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateServiceInstanceResponse::UpdateServiceInstanceResponse(
        const UpdateServiceInstanceRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new UpdateServiceInstanceResponsePrivate(this), parent)
{
    setRequest(new UpdateServiceInstanceRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateServiceInstanceRequest * UpdateServiceInstanceResponse::request() const
{
    Q_D(const UpdateServiceInstanceResponse);
    return static_cast<const UpdateServiceInstanceRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton UpdateServiceInstance \a response.
 */
void UpdateServiceInstanceResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateServiceInstanceResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::UpdateServiceInstanceResponsePrivate
 * \brief The UpdateServiceInstanceResponsePrivate class provides private implementation for UpdateServiceInstanceResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateServiceInstanceResponsePrivate object with public implementation \a q.
 */
UpdateServiceInstanceResponsePrivate::UpdateServiceInstanceResponsePrivate(
    UpdateServiceInstanceResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton UpdateServiceInstance response element from \a xml.
 */
void UpdateServiceInstanceResponsePrivate::parseUpdateServiceInstanceResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateServiceInstanceResponse"));
    Q_UNUSED(xml) ///< @todo
}
