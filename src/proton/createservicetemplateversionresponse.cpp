...
#include "createservicetemplateversionresponse_p.h"
...
/*!
 * \class QtAws::Proton::CreateServiceTemplateVersionResponse
 * \brief The CreateServiceTemplateVersionResponse class provides an interace for Proton CreateServiceTemplateVersion responses.
 *
...
/*!
 * Constructs a CreateServiceTemplateVersionResponse object for \a reply to \a request, with parent \a parent.
 */
CreateServiceTemplateVersionResponse::CreateServiceTemplateVersionResponse(
        const CreateServiceTemplateVersionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new CreateServiceTemplateVersionResponsePrivate(this), parent)
{
    setRequest(new CreateServiceTemplateVersionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton CreateServiceTemplateVersion \a response.
 */
void CreateServiceTemplateVersionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateServiceTemplateVersionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::CreateServiceTemplateVersionResponsePrivate
 * \brief The CreateServiceTemplateVersionResponsePrivate class provides private implementation for CreateServiceTemplateVersionResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CreateServiceTemplateVersionResponsePrivate object with public implementation \a q.
 */
CreateServiceTemplateVersionResponsePrivate::CreateServiceTemplateVersionResponsePrivate(
    CreateServiceTemplateVersionResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton CreateServiceTemplateVersion response element from \a xml.
 */
void CreateServiceTemplateVersionResponsePrivate::parseCreateServiceTemplateVersionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateServiceTemplateVersionResponse"));
    Q_UNUSED(xml) ///< @todo
}
