...
/*!
 * \class QtAws::Proton::UpdateAccountSettingsRequest
 * \brief The UpdateAccountSettingsRequest class provides an interface for Proton UpdateAccountSettings requests.
 *
 ...
 *
 * \sa ProtonClient::updateAccountSettings
 */
...
UpdateAccountSettingsRequest::UpdateAccountSettingsRequest(const UpdateAccountSettingsRequest &other)
    : ProtonRequest(new UpdateAccountSettingsRequestPrivate(*other.d_func(), this))
{
...
UpdateAccountSettingsRequest::UpdateAccountSettingsRequest()
    : ProtonRequest(new UpdateAccountSettingsRequestPrivate(ProtonRequest::UpdateAccountSettingsAction, this))
{
...
/*!
 * \class QtAws::Proton::UpdateAccountSettingsRequestPrivate
...
/*!
 * Constructs a UpdateAccountSettingsRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
UpdateAccountSettingsRequestPrivate::UpdateAccountSettingsRequestPrivate(
    const ProtonRequest::Action action, UpdateAccountSettingsRequest * const q)
