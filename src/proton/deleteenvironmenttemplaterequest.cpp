...
#include "deleteenvironmenttemplaterequest_p.h"
...
/*!
 * \class QtAws::Proton::DeleteEnvironmentTemplateRequest
 * \brief The DeleteEnvironmentTemplateRequest class provides an interface for Proton DeleteEnvironmentTemplate requests.
 *
 ...
 *
 * \sa ProtonClient::deleteEnvironmentTemplate
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteEnvironmentTemplateRequest::DeleteEnvironmentTemplateRequest(const DeleteEnvironmentTemplateRequest &other)
    : ProtonRequest(new DeleteEnvironmentTemplateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteEnvironmentTemplateRequest object.
 */
DeleteEnvironmentTemplateRequest::DeleteEnvironmentTemplateRequest()
    : ProtonRequest(new DeleteEnvironmentTemplateRequestPrivate(ProtonRequest::DeleteEnvironmentTemplateAction, this))
{
 ...
 * \reimp
 */
bool DeleteEnvironmentTemplateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteEnvironmentTemplateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteEnvironmentTemplateRequest::response(QNetworkReply * const reply) const
{
    return new DeleteEnvironmentTemplateResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::DeleteEnvironmentTemplateRequestPrivate
 * \brief The DeleteEnvironmentTemplateRequestPrivate class provides private implementation for DeleteEnvironmentTemplateRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a DeleteEnvironmentTemplateRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
DeleteEnvironmentTemplateRequestPrivate::DeleteEnvironmentTemplateRequestPrivate(
    const ProtonRequest::Action action, DeleteEnvironmentTemplateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteEnvironmentTemplateRequest
 * class' copy constructor.
 */
DeleteEnvironmentTemplateRequestPrivate::DeleteEnvironmentTemplateRequestPrivate(
    const DeleteEnvironmentTemplateRequestPrivate &other, DeleteEnvironmentTemplateRequest * const q)
