...
#include "cancelservicepipelinedeploymentrequest_p.h"
...
/*!
 * \class QtAws::Proton::CancelServicePipelineDeploymentRequest
 * \brief The CancelServicePipelineDeploymentRequest class provides an interface for Proton CancelServicePipelineDeployment requests.
 *
 ...
 */
CancelServicePipelineDeploymentRequest::CancelServicePipelineDeploymentRequest(const CancelServicePipelineDeploymentRequest &other)
    : ProtonRequest(new CancelServicePipelineDeploymentRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CancelServicePipelineDeploymentRequest object.
 */
CancelServicePipelineDeploymentRequest::CancelServicePipelineDeploymentRequest()
    : ProtonRequest(new CancelServicePipelineDeploymentRequestPrivate(ProtonRequest::CancelServicePipelineDeploymentAction, this))
{
 ...
 * \reimp
 */
bool CancelServicePipelineDeploymentRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CancelServicePipelineDeploymentResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CancelServicePipelineDeploymentRequest::response(QNetworkReply * const reply) const
{
    return new CancelServicePipelineDeploymentResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::CancelServicePipelineDeploymentRequestPrivate
 * \brief The CancelServicePipelineDeploymentRequestPrivate class provides private implementation for CancelServicePipelineDeploymentRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CancelServicePipelineDeploymentRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
CancelServicePipelineDeploymentRequestPrivate::CancelServicePipelineDeploymentRequestPrivate(
    const ProtonRequest::Action action, CancelServicePipelineDeploymentRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CancelServicePipelineDeploymentRequest
 * class' copy constructor.
 */
CancelServicePipelineDeploymentRequestPrivate::CancelServicePipelineDeploymentRequestPrivate(
    const CancelServicePipelineDeploymentRequestPrivate &other, CancelServicePipelineDeploymentRequest * const q)
