...
class QTAWS_EXPORT CreateEnvironmentTemplateResponsePrivate : public ProtonResponsePrivate {

public:

    CreateEnvironmentTemplateResponsePrivate(CreateEnvironmentTemplateResponse * const q);
