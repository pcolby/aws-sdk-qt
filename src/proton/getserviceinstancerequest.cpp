...
#include "getserviceinstancerequest_p.h"
...
/*!
 * \class QtAws::Proton::GetServiceInstanceRequest
 * \brief The GetServiceInstanceRequest class provides an interface for Proton GetServiceInstance requests.
 *
 ...
 *
 * \sa ProtonClient::getServiceInstance
 */

/*!
 * Constructs a copy of \a other.
 */
GetServiceInstanceRequest::GetServiceInstanceRequest(const GetServiceInstanceRequest &other)
    : ProtonRequest(new GetServiceInstanceRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetServiceInstanceRequest object.
 */
GetServiceInstanceRequest::GetServiceInstanceRequest()
    : ProtonRequest(new GetServiceInstanceRequestPrivate(ProtonRequest::GetServiceInstanceAction, this))
{
 ...
 * \reimp
 */
bool GetServiceInstanceRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetServiceInstanceResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetServiceInstanceRequest::response(QNetworkReply * const reply) const
{
    return new GetServiceInstanceResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::GetServiceInstanceRequestPrivate
 * \brief The GetServiceInstanceRequestPrivate class provides private implementation for GetServiceInstanceRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetServiceInstanceRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
GetServiceInstanceRequestPrivate::GetServiceInstanceRequestPrivate(
    const ProtonRequest::Action action, GetServiceInstanceRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetServiceInstanceRequest
 * class' copy constructor.
 */
GetServiceInstanceRequestPrivate::GetServiceInstanceRequestPrivate(
    const GetServiceInstanceRequestPrivate &other, GetServiceInstanceRequest * const q)
