...
#include "listservicetemplatesresponse_p.h"
...
/*!
 * \class QtAws::Proton::ListServiceTemplatesResponse
 * \brief The ListServiceTemplatesResponse class provides an interace for Proton ListServiceTemplates responses.
 *
 ...
 *
 * \sa ProtonClient::listServiceTemplates
 */

/*!
 * Constructs a ListServiceTemplatesResponse object for \a reply to \a request, with parent \a parent.
 */
ListServiceTemplatesResponse::ListServiceTemplatesResponse(
        const ListServiceTemplatesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new ListServiceTemplatesResponsePrivate(this), parent)
{
    setRequest(new ListServiceTemplatesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListServiceTemplatesRequest * ListServiceTemplatesResponse::request() const
{
    Q_D(const ListServiceTemplatesResponse);
    return static_cast<const ListServiceTemplatesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton ListServiceTemplates \a response.
 */
void ListServiceTemplatesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListServiceTemplatesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::ListServiceTemplatesResponsePrivate
 * \brief The ListServiceTemplatesResponsePrivate class provides private implementation for ListServiceTemplatesResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListServiceTemplatesResponsePrivate object with public implementation \a q.
 */
ListServiceTemplatesResponsePrivate::ListServiceTemplatesResponsePrivate(
    ListServiceTemplatesResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton ListServiceTemplates response element from \a xml.
 */
void ListServiceTemplatesResponsePrivate::parseListServiceTemplatesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListServiceTemplatesResponse"));
    Q_UNUSED(xml) ///< @todo
}
