...
/*!
 * \class QtAws::Proton::UpdateComponentResponse
 * \brief The UpdateComponentResponse class provides an interace for Proton UpdateComponent responses.
 *
...
UpdateComponentResponse::UpdateComponentResponse(
    ...
    : ProtonResponse(new UpdateComponentResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Proton UpdateComponent \a response.
 */
...
/*!
 * \class QtAws::Proton::UpdateComponentResponsePrivate
...
UpdateComponentResponsePrivate::UpdateComponentResponsePrivate(
    UpdateComponentResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton UpdateComponent response element from \a xml.
 */
