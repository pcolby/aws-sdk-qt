...
#include "createenvironmenttemplaterequest_p.h"
...
/*!
 * \class QtAws::Proton::CreateEnvironmentTemplateRequest
 * \brief The CreateEnvironmentTemplateRequest class provides an interface for Proton CreateEnvironmentTemplate requests.
 *
 ...
 */
CreateEnvironmentTemplateRequest::CreateEnvironmentTemplateRequest(const CreateEnvironmentTemplateRequest &other)
    : ProtonRequest(new CreateEnvironmentTemplateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateEnvironmentTemplateRequest object.
 */
CreateEnvironmentTemplateRequest::CreateEnvironmentTemplateRequest()
    : ProtonRequest(new CreateEnvironmentTemplateRequestPrivate(ProtonRequest::CreateEnvironmentTemplateAction, this))
{
 ...
 * \reimp
 */
bool CreateEnvironmentTemplateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateEnvironmentTemplateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateEnvironmentTemplateRequest::response(QNetworkReply * const reply) const
{
    return new CreateEnvironmentTemplateResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::CreateEnvironmentTemplateRequestPrivate
 * \brief The CreateEnvironmentTemplateRequestPrivate class provides private implementation for CreateEnvironmentTemplateRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CreateEnvironmentTemplateRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
CreateEnvironmentTemplateRequestPrivate::CreateEnvironmentTemplateRequestPrivate(
    const ProtonRequest::Action action, CreateEnvironmentTemplateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateEnvironmentTemplateRequest
 * class' copy constructor.
 */
CreateEnvironmentTemplateRequestPrivate::CreateEnvironmentTemplateRequestPrivate(
    const CreateEnvironmentTemplateRequestPrivate &other, CreateEnvironmentTemplateRequest * const q)
