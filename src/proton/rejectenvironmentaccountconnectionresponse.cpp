...
#include "rejectenvironmentaccountconnectionresponse_p.h"
...
/*!
 * \class QtAws::Proton::RejectEnvironmentAccountConnectionResponse
 * \brief The RejectEnvironmentAccountConnectionResponse class provides an interace for Proton RejectEnvironmentAccountConnection responses.
 *
 ...
 *
 * \sa ProtonClient::rejectEnvironmentAccountConnection
 */

/*!
 * Constructs a RejectEnvironmentAccountConnectionResponse object for \a reply to \a request, with parent \a parent.
 */
RejectEnvironmentAccountConnectionResponse::RejectEnvironmentAccountConnectionResponse(
        const RejectEnvironmentAccountConnectionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new RejectEnvironmentAccountConnectionResponsePrivate(this), parent)
{
    setRequest(new RejectEnvironmentAccountConnectionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const RejectEnvironmentAccountConnectionRequest * RejectEnvironmentAccountConnectionResponse::request() const
{
    Q_D(const RejectEnvironmentAccountConnectionResponse);
    return static_cast<const RejectEnvironmentAccountConnectionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton RejectEnvironmentAccountConnection \a response.
 */
void RejectEnvironmentAccountConnectionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(RejectEnvironmentAccountConnectionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::RejectEnvironmentAccountConnectionResponsePrivate
 * \brief The RejectEnvironmentAccountConnectionResponsePrivate class provides private implementation for RejectEnvironmentAccountConnectionResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a RejectEnvironmentAccountConnectionResponsePrivate object with public implementation \a q.
 */
RejectEnvironmentAccountConnectionResponsePrivate::RejectEnvironmentAccountConnectionResponsePrivate(
    RejectEnvironmentAccountConnectionResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton RejectEnvironmentAccountConnection response element from \a xml.
 */
void RejectEnvironmentAccountConnectionResponsePrivate::parseRejectEnvironmentAccountConnectionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("RejectEnvironmentAccountConnectionResponse"));
    Q_UNUSED(xml) ///< @todo
}
