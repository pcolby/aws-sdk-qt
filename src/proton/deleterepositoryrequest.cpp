...
/*!
 * \class QtAws::Proton::DeleteRepositoryRequest
 * \brief The DeleteRepositoryRequest class provides an interface for Proton DeleteRepository requests.
 *
 ...
 *
 * \sa ProtonClient::deleteRepository
 */
...
DeleteRepositoryRequest::DeleteRepositoryRequest(const DeleteRepositoryRequest &other)
    : ProtonRequest(new DeleteRepositoryRequestPrivate(*other.d_func(), this))
{
...
DeleteRepositoryRequest::DeleteRepositoryRequest()
    : ProtonRequest(new DeleteRepositoryRequestPrivate(ProtonRequest::DeleteRepositoryAction, this))
{
...
/*!
 * \class QtAws::Proton::DeleteRepositoryRequestPrivate
...
/*!
 * Constructs a DeleteRepositoryRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
DeleteRepositoryRequestPrivate::DeleteRepositoryRequestPrivate(
    const ProtonRequest::Action action, DeleteRepositoryRequest * const q)
