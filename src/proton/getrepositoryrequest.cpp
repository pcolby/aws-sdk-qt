...
/*!
 * \class QtAws::Proton::GetRepositoryRequest
 * \brief The GetRepositoryRequest class provides an interface for Proton GetRepository requests.
 *
...
GetRepositoryRequest::GetRepositoryRequest(const GetRepositoryRequest &other)
    : ProtonRequest(new GetRepositoryRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetRepositoryRequest object.
 */
GetRepositoryRequest::GetRepositoryRequest()
    : ProtonRequest(new GetRepositoryRequestPrivate(ProtonRequest::GetRepositoryAction, this))
{
...
/*!
 * Returns a GetRepositoryResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetRepositoryRequest::response(QNetworkReply * const reply) const
{
    return new GetRepositoryResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::GetRepositoryRequestPrivate
 * \brief The GetRepositoryRequestPrivate class provides private implementation for GetRepositoryRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetRepositoryRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
GetRepositoryRequestPrivate::GetRepositoryRequestPrivate(
    const ProtonRequest::Action action, GetRepositoryRequest * const q)
