...
#include "cancelcomponentdeploymentresponse_p.h"
...
/*!
 * \class QtAws::Proton::CancelComponentDeploymentResponse
 * \brief The CancelComponentDeploymentResponse class provides an interace for Proton CancelComponentDeployment responses.
 *
 ...
 *
 * \sa ProtonClient::cancelComponentDeployment
 */

/*!
 * Constructs a CancelComponentDeploymentResponse object for \a reply to \a request, with parent \a parent.
 */
CancelComponentDeploymentResponse::CancelComponentDeploymentResponse(
        const CancelComponentDeploymentRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new CancelComponentDeploymentResponsePrivate(this), parent)
{
    setRequest(new CancelComponentDeploymentRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CancelComponentDeploymentRequest * CancelComponentDeploymentResponse::request() const
{
    Q_D(const CancelComponentDeploymentResponse);
    return static_cast<const CancelComponentDeploymentRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton CancelComponentDeployment \a response.
 */
void CancelComponentDeploymentResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CancelComponentDeploymentResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::CancelComponentDeploymentResponsePrivate
 * \brief The CancelComponentDeploymentResponsePrivate class provides private implementation for CancelComponentDeploymentResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CancelComponentDeploymentResponsePrivate object with public implementation \a q.
 */
CancelComponentDeploymentResponsePrivate::CancelComponentDeploymentResponsePrivate(
    CancelComponentDeploymentResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton CancelComponentDeployment response element from \a xml.
 */
void CancelComponentDeploymentResponsePrivate::parseCancelComponentDeploymentResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CancelComponentDeploymentResponse"));
    Q_UNUSED(xml) ///< @todo
}
