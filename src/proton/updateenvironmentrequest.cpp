...
/*!
 * \class QtAws::Proton::UpdateEnvironmentRequest
 * \brief The UpdateEnvironmentRequest class provides an interface for Proton UpdateEnvironment requests.
 *
...
UpdateEnvironmentRequest::UpdateEnvironmentRequest(const UpdateEnvironmentRequest &other)
    : ProtonRequest(new UpdateEnvironmentRequestPrivate(*other.d_func(), this))
{
...
UpdateEnvironmentRequest::UpdateEnvironmentRequest()
    : ProtonRequest(new UpdateEnvironmentRequestPrivate(ProtonRequest::UpdateEnvironmentAction, this))
{
...
/*!
 * \class QtAws::Proton::UpdateEnvironmentRequestPrivate
...
/*!
 * Constructs a UpdateEnvironmentRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
UpdateEnvironmentRequestPrivate::UpdateEnvironmentRequestPrivate(
    const ProtonRequest::Action action, UpdateEnvironmentRequest * const q)
