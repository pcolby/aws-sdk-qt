...
#include "deleteenvironmentaccountconnectionrequest_p.h"
...
/*!
 * \class QtAws::Proton::DeleteEnvironmentAccountConnectionRequest
 * \brief The DeleteEnvironmentAccountConnectionRequest class provides an interface for Proton DeleteEnvironmentAccountConnection requests.
 *
 ...
 *
 * \sa ProtonClient::deleteEnvironmentAccountConnection
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteEnvironmentAccountConnectionRequest::DeleteEnvironmentAccountConnectionRequest(const DeleteEnvironmentAccountConnectionRequest &other)
    : ProtonRequest(new DeleteEnvironmentAccountConnectionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteEnvironmentAccountConnectionRequest object.
 */
DeleteEnvironmentAccountConnectionRequest::DeleteEnvironmentAccountConnectionRequest()
    : ProtonRequest(new DeleteEnvironmentAccountConnectionRequestPrivate(ProtonRequest::DeleteEnvironmentAccountConnectionAction, this))
{
 ...
 * \reimp
 */
bool DeleteEnvironmentAccountConnectionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteEnvironmentAccountConnectionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteEnvironmentAccountConnectionRequest::response(QNetworkReply * const reply) const
{
    return new DeleteEnvironmentAccountConnectionResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::DeleteEnvironmentAccountConnectionRequestPrivate
 * \brief The DeleteEnvironmentAccountConnectionRequestPrivate class provides private implementation for DeleteEnvironmentAccountConnectionRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a DeleteEnvironmentAccountConnectionRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
DeleteEnvironmentAccountConnectionRequestPrivate::DeleteEnvironmentAccountConnectionRequestPrivate(
    const ProtonRequest::Action action, DeleteEnvironmentAccountConnectionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteEnvironmentAccountConnectionRequest
 * class' copy constructor.
 */
DeleteEnvironmentAccountConnectionRequestPrivate::DeleteEnvironmentAccountConnectionRequestPrivate(
    const DeleteEnvironmentAccountConnectionRequestPrivate &other, DeleteEnvironmentAccountConnectionRequest * const q)
