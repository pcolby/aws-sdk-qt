...
#include "cancelenvironmentdeploymentrequest_p.h"
...
/*!
 * \class QtAws::Proton::CancelEnvironmentDeploymentRequest
 * \brief The CancelEnvironmentDeploymentRequest class provides an interface for Proton CancelEnvironmentDeployment requests.
 *
 ...
 *
 * \sa ProtonClient::cancelEnvironmentDeployment
 */

/*!
 * Constructs a copy of \a other.
 */
CancelEnvironmentDeploymentRequest::CancelEnvironmentDeploymentRequest(const CancelEnvironmentDeploymentRequest &other)
    : ProtonRequest(new CancelEnvironmentDeploymentRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CancelEnvironmentDeploymentRequest object.
 */
CancelEnvironmentDeploymentRequest::CancelEnvironmentDeploymentRequest()
    : ProtonRequest(new CancelEnvironmentDeploymentRequestPrivate(ProtonRequest::CancelEnvironmentDeploymentAction, this))
{
 ...
 * \reimp
 */
bool CancelEnvironmentDeploymentRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CancelEnvironmentDeploymentResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CancelEnvironmentDeploymentRequest::response(QNetworkReply * const reply) const
{
    return new CancelEnvironmentDeploymentResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::CancelEnvironmentDeploymentRequestPrivate
 * \brief The CancelEnvironmentDeploymentRequestPrivate class provides private implementation for CancelEnvironmentDeploymentRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a CancelEnvironmentDeploymentRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
CancelEnvironmentDeploymentRequestPrivate::CancelEnvironmentDeploymentRequestPrivate(
    const ProtonRequest::Action action, CancelEnvironmentDeploymentRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CancelEnvironmentDeploymentRequest
 * class' copy constructor.
 */
CancelEnvironmentDeploymentRequestPrivate::CancelEnvironmentDeploymentRequestPrivate(
    const CancelEnvironmentDeploymentRequestPrivate &other, CancelEnvironmentDeploymentRequest * const q)
