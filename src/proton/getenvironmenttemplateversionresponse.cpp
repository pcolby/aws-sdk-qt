...
#include "getenvironmenttemplateversionresponse_p.h"
...
/*!
 * \class QtAws::Proton::GetEnvironmentTemplateVersionResponse
 * \brief The GetEnvironmentTemplateVersionResponse class provides an interace for Proton GetEnvironmentTemplateVersion responses.
 *
 ...
 *
 * \sa ProtonClient::getEnvironmentTemplateVersion
 */

/*!
 * Constructs a GetEnvironmentTemplateVersionResponse object for \a reply to \a request, with parent \a parent.
 */
GetEnvironmentTemplateVersionResponse::GetEnvironmentTemplateVersionResponse(
        const GetEnvironmentTemplateVersionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new GetEnvironmentTemplateVersionResponsePrivate(this), parent)
{
    setRequest(new GetEnvironmentTemplateVersionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetEnvironmentTemplateVersionRequest * GetEnvironmentTemplateVersionResponse::request() const
{
    Q_D(const GetEnvironmentTemplateVersionResponse);
    return static_cast<const GetEnvironmentTemplateVersionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton GetEnvironmentTemplateVersion \a response.
 */
void GetEnvironmentTemplateVersionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetEnvironmentTemplateVersionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::GetEnvironmentTemplateVersionResponsePrivate
 * \brief The GetEnvironmentTemplateVersionResponsePrivate class provides private implementation for GetEnvironmentTemplateVersionResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetEnvironmentTemplateVersionResponsePrivate object with public implementation \a q.
 */
GetEnvironmentTemplateVersionResponsePrivate::GetEnvironmentTemplateVersionResponsePrivate(
    GetEnvironmentTemplateVersionResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton GetEnvironmentTemplateVersion response element from \a xml.
 */
void GetEnvironmentTemplateVersionResponsePrivate::parseGetEnvironmentTemplateVersionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetEnvironmentTemplateVersionResponse"));
    Q_UNUSED(xml) ///< @todo
}
