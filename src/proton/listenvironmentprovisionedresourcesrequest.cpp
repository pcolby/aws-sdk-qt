...
#include "listenvironmentprovisionedresourcesrequest_p.h"
...
/*!
 * \class QtAws::Proton::ListEnvironmentProvisionedResourcesRequest
 * \brief The ListEnvironmentProvisionedResourcesRequest class provides an interface for Proton ListEnvironmentProvisionedResources requests.
 *
 ...
 */
ListEnvironmentProvisionedResourcesRequest::ListEnvironmentProvisionedResourcesRequest(const ListEnvironmentProvisionedResourcesRequest &other)
    : ProtonRequest(new ListEnvironmentProvisionedResourcesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListEnvironmentProvisionedResourcesRequest object.
 */
ListEnvironmentProvisionedResourcesRequest::ListEnvironmentProvisionedResourcesRequest()
    : ProtonRequest(new ListEnvironmentProvisionedResourcesRequestPrivate(ProtonRequest::ListEnvironmentProvisionedResourcesAction, this))
{
 ...
 * \reimp
 */
bool ListEnvironmentProvisionedResourcesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListEnvironmentProvisionedResourcesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListEnvironmentProvisionedResourcesRequest::response(QNetworkReply * const reply) const
{
    return new ListEnvironmentProvisionedResourcesResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::ListEnvironmentProvisionedResourcesRequestPrivate
 * \brief The ListEnvironmentProvisionedResourcesRequestPrivate class provides private implementation for ListEnvironmentProvisionedResourcesRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListEnvironmentProvisionedResourcesRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListEnvironmentProvisionedResourcesRequestPrivate::ListEnvironmentProvisionedResourcesRequestPrivate(
    const ProtonRequest::Action action, ListEnvironmentProvisionedResourcesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListEnvironmentProvisionedResourcesRequest
 * class' copy constructor.
 */
ListEnvironmentProvisionedResourcesRequestPrivate::ListEnvironmentProvisionedResourcesRequestPrivate(
    const ListEnvironmentProvisionedResourcesRequestPrivate &other, ListEnvironmentProvisionedResourcesRequest * const q)
