...
#include "getservicetemplateversionresponse_p.h"
...
/*!
 * \class QtAws::Proton::GetServiceTemplateVersionResponse
 * \brief The GetServiceTemplateVersionResponse class provides an interace for Proton GetServiceTemplateVersion responses.
 *
 ...
 *
 * \sa ProtonClient::getServiceTemplateVersion
 */

/*!
 * Constructs a GetServiceTemplateVersionResponse object for \a reply to \a request, with parent \a parent.
 */
GetServiceTemplateVersionResponse::GetServiceTemplateVersionResponse(
        const GetServiceTemplateVersionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new GetServiceTemplateVersionResponsePrivate(this), parent)
{
    setRequest(new GetServiceTemplateVersionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetServiceTemplateVersionRequest * GetServiceTemplateVersionResponse::request() const
{
    Q_D(const GetServiceTemplateVersionResponse);
    return static_cast<const GetServiceTemplateVersionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton GetServiceTemplateVersion \a response.
 */
void GetServiceTemplateVersionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetServiceTemplateVersionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::GetServiceTemplateVersionResponsePrivate
 * \brief The GetServiceTemplateVersionResponsePrivate class provides private implementation for GetServiceTemplateVersionResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a GetServiceTemplateVersionResponsePrivate object with public implementation \a q.
 */
GetServiceTemplateVersionResponsePrivate::GetServiceTemplateVersionResponsePrivate(
    GetServiceTemplateVersionResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton GetServiceTemplateVersion response element from \a xml.
 */
void GetServiceTemplateVersionResponsePrivate::parseGetServiceTemplateVersionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetServiceTemplateVersionResponse"));
    Q_UNUSED(xml) ///< @todo
}
