...
#include "deleteenvironmentaccountconnectionresponse_p.h"
...
/*!
 * \class QtAws::Proton::DeleteEnvironmentAccountConnectionResponse
 * \brief The DeleteEnvironmentAccountConnectionResponse class provides an interace for Proton DeleteEnvironmentAccountConnection responses.
 *
...
/*!
 * Constructs a DeleteEnvironmentAccountConnectionResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteEnvironmentAccountConnectionResponse::DeleteEnvironmentAccountConnectionResponse(
        const DeleteEnvironmentAccountConnectionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new DeleteEnvironmentAccountConnectionResponsePrivate(this), parent)
{
    setRequest(new DeleteEnvironmentAccountConnectionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton DeleteEnvironmentAccountConnection \a response.
 */
void DeleteEnvironmentAccountConnectionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteEnvironmentAccountConnectionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::DeleteEnvironmentAccountConnectionResponsePrivate
 * \brief The DeleteEnvironmentAccountConnectionResponsePrivate class provides private implementation for DeleteEnvironmentAccountConnectionResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a DeleteEnvironmentAccountConnectionResponsePrivate object with public implementation \a q.
 */
DeleteEnvironmentAccountConnectionResponsePrivate::DeleteEnvironmentAccountConnectionResponsePrivate(
    DeleteEnvironmentAccountConnectionResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton DeleteEnvironmentAccountConnection response element from \a xml.
 */
void DeleteEnvironmentAccountConnectionResponsePrivate::parseDeleteEnvironmentAccountConnectionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteEnvironmentAccountConnectionResponse"));
    Q_UNUSED(xml) ///< @todo
}
