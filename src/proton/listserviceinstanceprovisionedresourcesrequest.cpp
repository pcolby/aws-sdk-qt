...
#include "listserviceinstanceprovisionedresourcesrequest_p.h"
...
/*!
 * \class QtAws::Proton::ListServiceInstanceProvisionedResourcesRequest
 * \brief The ListServiceInstanceProvisionedResourcesRequest class provides an interface for Proton ListServiceInstanceProvisionedResources requests.
 *
 ...
 */
ListServiceInstanceProvisionedResourcesRequest::ListServiceInstanceProvisionedResourcesRequest(const ListServiceInstanceProvisionedResourcesRequest &other)
    : ProtonRequest(new ListServiceInstanceProvisionedResourcesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListServiceInstanceProvisionedResourcesRequest object.
 */
ListServiceInstanceProvisionedResourcesRequest::ListServiceInstanceProvisionedResourcesRequest()
    : ProtonRequest(new ListServiceInstanceProvisionedResourcesRequestPrivate(ProtonRequest::ListServiceInstanceProvisionedResourcesAction, this))
{
 ...
 * \reimp
 */
bool ListServiceInstanceProvisionedResourcesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListServiceInstanceProvisionedResourcesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListServiceInstanceProvisionedResourcesRequest::response(QNetworkReply * const reply) const
{
    return new ListServiceInstanceProvisionedResourcesResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::ListServiceInstanceProvisionedResourcesRequestPrivate
 * \brief The ListServiceInstanceProvisionedResourcesRequestPrivate class provides private implementation for ListServiceInstanceProvisionedResourcesRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListServiceInstanceProvisionedResourcesRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListServiceInstanceProvisionedResourcesRequestPrivate::ListServiceInstanceProvisionedResourcesRequestPrivate(
    const ProtonRequest::Action action, ListServiceInstanceProvisionedResourcesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListServiceInstanceProvisionedResourcesRequest
 * class' copy constructor.
 */
ListServiceInstanceProvisionedResourcesRequestPrivate::ListServiceInstanceProvisionedResourcesRequestPrivate(
    const ListServiceInstanceProvisionedResourcesRequestPrivate &other, ListServiceInstanceProvisionedResourcesRequest * const q)
