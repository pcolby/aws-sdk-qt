...
#include "deleteenvironmenttemplateresponse_p.h"
...
/*!
 * \class QtAws::Proton::DeleteEnvironmentTemplateResponse
 * \brief The DeleteEnvironmentTemplateResponse class provides an interace for Proton DeleteEnvironmentTemplate responses.
 *
...
/*!
 * Constructs a DeleteEnvironmentTemplateResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteEnvironmentTemplateResponse::DeleteEnvironmentTemplateResponse(
        const DeleteEnvironmentTemplateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new DeleteEnvironmentTemplateResponsePrivate(this), parent)
{
    setRequest(new DeleteEnvironmentTemplateRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Proton DeleteEnvironmentTemplate \a response.
 */
void DeleteEnvironmentTemplateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteEnvironmentTemplateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::DeleteEnvironmentTemplateResponsePrivate
 * \brief The DeleteEnvironmentTemplateResponsePrivate class provides private implementation for DeleteEnvironmentTemplateResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a DeleteEnvironmentTemplateResponsePrivate object with public implementation \a q.
 */
DeleteEnvironmentTemplateResponsePrivate::DeleteEnvironmentTemplateResponsePrivate(
    DeleteEnvironmentTemplateResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton DeleteEnvironmentTemplate response element from \a xml.
 */
void DeleteEnvironmentTemplateResponsePrivate::parseDeleteEnvironmentTemplateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteEnvironmentTemplateResponse"));
    Q_UNUSED(xml) ///< @todo
}
