...
#include "deletetemplatesyncconfigresponse_p.h"
...
/*!
 * \class QtAws::Proton::DeleteTemplateSyncConfigResponse
 * \brief The DeleteTemplateSyncConfigResponse class provides an interace for Proton DeleteTemplateSyncConfig responses.
 *
 ...
 *
 * \sa ProtonClient::deleteTemplateSyncConfig
 */

/*!
 * Constructs a DeleteTemplateSyncConfigResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteTemplateSyncConfigResponse::DeleteTemplateSyncConfigResponse(
        const DeleteTemplateSyncConfigRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ProtonResponse(new DeleteTemplateSyncConfigResponsePrivate(this), parent)
{
    setRequest(new DeleteTemplateSyncConfigRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteTemplateSyncConfigRequest * DeleteTemplateSyncConfigResponse::request() const
{
    Q_D(const DeleteTemplateSyncConfigResponse);
    return static_cast<const DeleteTemplateSyncConfigRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Proton DeleteTemplateSyncConfig \a response.
 */
void DeleteTemplateSyncConfigResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteTemplateSyncConfigResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Proton::DeleteTemplateSyncConfigResponsePrivate
 * \brief The DeleteTemplateSyncConfigResponsePrivate class provides private implementation for DeleteTemplateSyncConfigResponse.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a DeleteTemplateSyncConfigResponsePrivate object with public implementation \a q.
 */
DeleteTemplateSyncConfigResponsePrivate::DeleteTemplateSyncConfigResponsePrivate(
    DeleteTemplateSyncConfigResponse * const q) : ProtonResponsePrivate(q)
{

}

/*!
 * Parses a Proton DeleteTemplateSyncConfig response element from \a xml.
 */
void DeleteTemplateSyncConfigResponsePrivate::parseDeleteTemplateSyncConfigResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteTemplateSyncConfigResponse"));
    Q_UNUSED(xml) ///< @todo
}
