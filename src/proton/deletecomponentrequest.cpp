...
/*!
 * \class QtAws::Proton::DeleteComponentRequest
 * \brief The DeleteComponentRequest class provides an interface for Proton DeleteComponent requests.
 *
 ...
 *
 * \sa ProtonClient::deleteComponent
 */
...
DeleteComponentRequest::DeleteComponentRequest(const DeleteComponentRequest &other)
    : ProtonRequest(new DeleteComponentRequestPrivate(*other.d_func(), this))
{
...
DeleteComponentRequest::DeleteComponentRequest()
    : ProtonRequest(new DeleteComponentRequestPrivate(ProtonRequest::DeleteComponentAction, this))
{
...
/*!
 * \class QtAws::Proton::DeleteComponentRequestPrivate
...
/*!
 * Constructs a DeleteComponentRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
DeleteComponentRequestPrivate::DeleteComponentRequestPrivate(
    const ProtonRequest::Action action, DeleteComponentRequest * const q)
