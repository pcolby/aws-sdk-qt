...
#include "listrepositorysyncdefinitionsrequest_p.h"
...
/*!
 * \class QtAws::Proton::ListRepositorySyncDefinitionsRequest
 * \brief The ListRepositorySyncDefinitionsRequest class provides an interface for Proton ListRepositorySyncDefinitions requests.
 *
 ...
 */
ListRepositorySyncDefinitionsRequest::ListRepositorySyncDefinitionsRequest(const ListRepositorySyncDefinitionsRequest &other)
    : ProtonRequest(new ListRepositorySyncDefinitionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListRepositorySyncDefinitionsRequest object.
 */
ListRepositorySyncDefinitionsRequest::ListRepositorySyncDefinitionsRequest()
    : ProtonRequest(new ListRepositorySyncDefinitionsRequestPrivate(ProtonRequest::ListRepositorySyncDefinitionsAction, this))
{
 ...
 * \reimp
 */
bool ListRepositorySyncDefinitionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListRepositorySyncDefinitionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListRepositorySyncDefinitionsRequest::response(QNetworkReply * const reply) const
{
    return new ListRepositorySyncDefinitionsResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::ListRepositorySyncDefinitionsRequestPrivate
 * \brief The ListRepositorySyncDefinitionsRequestPrivate class provides private implementation for ListRepositorySyncDefinitionsRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a ListRepositorySyncDefinitionsRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
ListRepositorySyncDefinitionsRequestPrivate::ListRepositorySyncDefinitionsRequestPrivate(
    const ProtonRequest::Action action, ListRepositorySyncDefinitionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListRepositorySyncDefinitionsRequest
 * class' copy constructor.
 */
ListRepositorySyncDefinitionsRequestPrivate::ListRepositorySyncDefinitionsRequestPrivate(
    const ListRepositorySyncDefinitionsRequestPrivate &other, ListRepositorySyncDefinitionsRequest * const q)
