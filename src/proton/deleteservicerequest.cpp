...
/*!
 * \class QtAws::Proton::DeleteServiceRequest
 * \brief The DeleteServiceRequest class provides an interface for Proton DeleteService requests.
 *
...
DeleteServiceRequest::DeleteServiceRequest(const DeleteServiceRequest &other)
    : ProtonRequest(new DeleteServiceRequestPrivate(*other.d_func(), this))
{
...
DeleteServiceRequest::DeleteServiceRequest()
    : ProtonRequest(new DeleteServiceRequestPrivate(ProtonRequest::DeleteServiceAction, this))
{
...
/*!
 * \class QtAws::Proton::DeleteServiceRequestPrivate
...
/*!
 * Constructs a DeleteServiceRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
DeleteServiceRequestPrivate::DeleteServiceRequestPrivate(
    const ProtonRequest::Action action, DeleteServiceRequest * const q)
