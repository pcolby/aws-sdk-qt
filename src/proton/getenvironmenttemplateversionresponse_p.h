...
class QTAWS_EXPORT GetEnvironmentTemplateVersionResponsePrivate : public ProtonResponsePrivate {

public:

    GetEnvironmentTemplateVersionResponsePrivate(GetEnvironmentTemplateVersionResponse * const q);
