...
#include "deleteservicetemplateversionrequest_p.h"
...
/*!
 * \class QtAws::Proton::DeleteServiceTemplateVersionRequest
 * \brief The DeleteServiceTemplateVersionRequest class provides an interface for Proton DeleteServiceTemplateVersion requests.
 *
 ...
 */
DeleteServiceTemplateVersionRequest::DeleteServiceTemplateVersionRequest(const DeleteServiceTemplateVersionRequest &other)
    : ProtonRequest(new DeleteServiceTemplateVersionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteServiceTemplateVersionRequest object.
 */
DeleteServiceTemplateVersionRequest::DeleteServiceTemplateVersionRequest()
    : ProtonRequest(new DeleteServiceTemplateVersionRequestPrivate(ProtonRequest::DeleteServiceTemplateVersionAction, this))
{
 ...
 * \reimp
 */
bool DeleteServiceTemplateVersionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteServiceTemplateVersionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteServiceTemplateVersionRequest::response(QNetworkReply * const reply) const
{
    return new DeleteServiceTemplateVersionResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::DeleteServiceTemplateVersionRequestPrivate
 * \brief The DeleteServiceTemplateVersionRequestPrivate class provides private implementation for DeleteServiceTemplateVersionRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a DeleteServiceTemplateVersionRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
DeleteServiceTemplateVersionRequestPrivate::DeleteServiceTemplateVersionRequestPrivate(
    const ProtonRequest::Action action, DeleteServiceTemplateVersionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteServiceTemplateVersionRequest
 * class' copy constructor.
 */
DeleteServiceTemplateVersionRequestPrivate::DeleteServiceTemplateVersionRequestPrivate(
    const DeleteServiceTemplateVersionRequestPrivate &other, DeleteServiceTemplateVersionRequest * const q)
