...
#include "updateenvironmenttemplaterequest_p.h"
...
/*!
 * \class QtAws::Proton::UpdateEnvironmentTemplateRequest
 * \brief The UpdateEnvironmentTemplateRequest class provides an interface for Proton UpdateEnvironmentTemplate requests.
 *
 ...
 *
 * \sa ProtonClient::updateEnvironmentTemplate
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateEnvironmentTemplateRequest::UpdateEnvironmentTemplateRequest(const UpdateEnvironmentTemplateRequest &other)
    : ProtonRequest(new UpdateEnvironmentTemplateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateEnvironmentTemplateRequest object.
 */
UpdateEnvironmentTemplateRequest::UpdateEnvironmentTemplateRequest()
    : ProtonRequest(new UpdateEnvironmentTemplateRequestPrivate(ProtonRequest::UpdateEnvironmentTemplateAction, this))
{
 ...
 * \reimp
 */
bool UpdateEnvironmentTemplateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateEnvironmentTemplateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateEnvironmentTemplateRequest::response(QNetworkReply * const reply) const
{
    return new UpdateEnvironmentTemplateResponse(*this, reply);
}

/*!
 * \class QtAws::Proton::UpdateEnvironmentTemplateRequestPrivate
 * \brief The UpdateEnvironmentTemplateRequestPrivate class provides private implementation for UpdateEnvironmentTemplateRequest.
 * \internal
 *
 * \inmodule QtAwsProton
 */
...
/*!
 * Constructs a UpdateEnvironmentTemplateRequestPrivate object for Proton \a action,
 * with public implementation \a q.
 */
UpdateEnvironmentTemplateRequestPrivate::UpdateEnvironmentTemplateRequestPrivate(
    const ProtonRequest::Action action, UpdateEnvironmentTemplateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateEnvironmentTemplateRequest
 * class' copy constructor.
 */
UpdateEnvironmentTemplateRequestPrivate::UpdateEnvironmentTemplateRequestPrivate(
    const UpdateEnvironmentTemplateRequestPrivate &other, UpdateEnvironmentTemplateRequest * const q)
