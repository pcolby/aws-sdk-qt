...
/*!
 * \class QtAws::WorkLink::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for WorkLink TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : WorkLinkResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(WorkLinkResponse::request());
}

/*!
 * \reimp
 * Parses a successful WorkLink TagResource \a response.
 */
...
/*!
 * \class QtAws::WorkLink::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : WorkLinkResponsePrivate(q)
{

}

/*!
 * Parses a WorkLink TagResource response element from \a xml.
 */
