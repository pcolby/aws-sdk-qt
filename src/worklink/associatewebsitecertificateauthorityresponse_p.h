...
class QTAWS_EXPORT AssociateWebsiteCertificateAuthorityResponsePrivate : public WorkLinkResponsePrivate {

public:

    AssociateWebsiteCertificateAuthorityResponsePrivate(AssociateWebsiteCertificateAuthorityResponse * const q);
