...
/*!
 * \class QtAws::WorkLink::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for WorkLink ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : WorkLinkResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WorkLink ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::WorkLink::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : WorkLinkResponsePrivate(q)
{

}

/*!
 * Parses a WorkLink ListTagsForResource response element from \a xml.
 */
