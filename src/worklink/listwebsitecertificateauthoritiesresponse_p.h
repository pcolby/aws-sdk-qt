...
class QTAWS_EXPORT ListWebsiteCertificateAuthoritiesResponsePrivate : public WorkLinkResponsePrivate {

public:

    ListWebsiteCertificateAuthoritiesResponsePrivate(ListWebsiteCertificateAuthoritiesResponse * const q);
