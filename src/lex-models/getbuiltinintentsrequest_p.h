...
class QTAWS_EXPORT GetBuiltinIntentsRequestPrivate : public LexModelBuildingServicePrivate {

public:
    GetBuiltinIntentsRequestPrivate(const LexModelBuildingService::Action action,
