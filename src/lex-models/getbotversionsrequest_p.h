...
class QTAWS_EXPORT GetBotVersionsRequestPrivate : public LexModelBuildingServiceRequestPrivate {

public:
    GetBotVersionsRequestPrivate(const LexModelBuildingServiceRequest::Action action,
