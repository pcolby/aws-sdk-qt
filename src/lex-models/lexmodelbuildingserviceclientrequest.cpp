...
/**
 * @brief  Constructs a new LexModelBuildingServiceClientRequest object.
 *
...
/**
 * @brief  Constructs a new LexModelBuildingServiceClientRequest object by copying another.
 *
 ...
 */
LexModelBuildingServiceClientRequest& LexModelBuildingServiceClientRequest::operator=(const LexModelBuildingServiceClientRequest &other)
{
    Q_D(LexModelBuildingServiceClientRequest);
 ...
 * implementation that inherits from LexModelBuildingServiceClientRequestPrivate.
 *
 ...
 */
LexModelBuildingServiceClientRequest::Action LexModelBuildingServiceClientRequest::action() const
{
    Q_D(const LexModelBuildingServiceClientRequest);
    return d->action;
}
 ...
 */
QString LexModelBuildingServiceClientRequest::actionString() const
{
    return LexModelBuildingServiceClientRequestPrivate::toString(action());
}
 ...
 */
QString LexModelBuildingServiceClientRequest::apiVersion() const
{
    Q_D(const LexModelBuildingServiceClientRequest);
    return d->apiVersion;
}
 ...
 */
void LexModelBuildingServiceClientRequest::setAction(const Action action)
{
    Q_D(LexModelBuildingServiceClientRequest);
    d->action = action;
}
 ...
 */
void LexModelBuildingServiceClientRequest::setApiVersion(const QString &version)
{
    Q_D(LexModelBuildingServiceClientRequest);
 ...
 */
bool LexModelBuildingServiceClientRequest::operator==(const LexModelBuildingServiceClientRequest &other) const
{
 ...
 */
bool LexModelBuildingServiceClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int LexModelBuildingServiceClientRequest::clearParameter(const QString &name)
{
    Q_D(LexModelBuildingServiceClientRequest);
 ...
 */
void LexModelBuildingServiceClientRequest::clearParameters()
{
    Q_D(LexModelBuildingServiceClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant LexModelBuildingServiceClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const LexModelBuildingServiceClientRequest);
 ...
 */
const QVariantMap &LexModelBuildingServiceClientRequest::parameters() const
{
    Q_D(const LexModelBuildingServiceClientRequest);
    return d->parameters;
}
 ...
 */
void LexModelBuildingServiceClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(LexModelBuildingServiceClientRequest);
 ...
 */
void LexModelBuildingServiceClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(LexModelBuildingServiceClientRequest);
 ...
 */
QNetworkRequest LexModelBuildingServiceClientRequest::unsignedRequest(const QUrl &endpoint) const
{
    Q_D(const LexModelBuildingServiceClientRequest);
    QUrl url(endpoint);
 ...
 *
 * @brief  Private implementation for LexModelBuildingServiceClientRequest.
 */

/**
 * @internal
 *
 * @brief  Constructs a new LexModelBuildingServiceClientRequestPrivate object.
 *
 ...
 * @internal
 *
 * @brief  Constructs a new LexModelBuildingServiceClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the LexModelBuildingServiceClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public LexModelBuildingServiceClientRequest instance.
 */
 ...
 *
 * This function converts LexModelBuildingServiceClientRequest::Action enumerator values to their respective
 ...
 */
QString LexModelBuildingServiceClientRequestPrivate::toString(const LexModelBuildingServiceClientRequest::Action &action)
{
    #define ActionToString(action) \
        case LexModelBuildingServiceClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
