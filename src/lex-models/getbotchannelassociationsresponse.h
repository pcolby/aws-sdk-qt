...
class QTAWS_EXPORT GetBotChannelAssociationsResponse : public GetBotChannelAssociationsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetBotChannelAssociationsRequest * request() const;
