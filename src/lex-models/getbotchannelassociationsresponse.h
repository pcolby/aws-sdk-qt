...
class QTAWS_EXPORT GetBotChannelAssociationsResponse : public LexModelBuildingServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetBotChannelAssociationsRequest * request() const override;
