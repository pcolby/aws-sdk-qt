...
class QTAWS_EXPORT ListUserPoolClientsResponsePrivate : public CognitoIdentityProviderResponsePrivate {
    Q_OBJECT

public:

    ListUserPoolClientsResponsePrivate(ListUserPoolClientsResponse * const q);
