...
#include "cognitoidentityproviderclientrequest_p.h"
...
/**
 * @brief  Constructs a new CognitoIdentityProviderClientRequest object.
 *
...
/**
 * @brief  Constructs a new CognitoIdentityProviderClientRequest object by copying another.
 *
 ...
 */
CognitoIdentityProviderClientRequest& CognitoIdentityProviderClientRequest::operator=(const CognitoIdentityProviderClientRequest &other)
{
    Q_D(CognitoIdentityProviderClientRequest);
 ...
 * implementation that inherits from CognitoIdentityProviderClientRequestPrivate.
 *
 ...
 */
CognitoIdentityProviderClientRequest::Action CognitoIdentityProviderClientRequest::action() const
{
    Q_D(const CognitoIdentityProviderClientRequest);
    return d->action;
}
 ...
 */
QString CognitoIdentityProviderClientRequest::actionString() const
{
    return CognitoIdentityProviderClientRequestPrivate::toString(action());
}
 ...
 */
QString CognitoIdentityProviderClientRequest::apiVersion() const
{
    Q_D(const CognitoIdentityProviderClientRequest);
    return d->apiVersion;
}
 ...
 */
void CognitoIdentityProviderClientRequest::setAction(const Action action)
{
    Q_D(CognitoIdentityProviderClientRequest);
    d->action = action;
}
 ...
 */
void CognitoIdentityProviderClientRequest::setApiVersion(const QString &version)
{
    Q_D(CognitoIdentityProviderClientRequest);
 ...
 */
bool CognitoIdentityProviderClientRequest::operator==(const CognitoIdentityProviderClientRequest &other) const
{
 ...
 */
bool CognitoIdentityProviderClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int CognitoIdentityProviderClientRequest::clearParameter(const QString &name)
{
    Q_D(CognitoIdentityProviderClientRequest);
 ...
 */
void CognitoIdentityProviderClientRequest::clearParameters()
{
    Q_D(CognitoIdentityProviderClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant CognitoIdentityProviderClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const CognitoIdentityProviderClientRequest);
 ...
 */
const QVariantMap &CognitoIdentityProviderClientRequest::parameters() const
{
    Q_D(const CognitoIdentityProviderClientRequest);
    return d->parameters;
}
 ...
 */
void CognitoIdentityProviderClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(CognitoIdentityProviderClientRequest);
 ...
 */
void CognitoIdentityProviderClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(CognitoIdentityProviderClientRequest);
 ...
 */
QNetworkRequest CognitoIdentityProviderClientRequest::unsignedRequest(const QUrl &endpoint) const
{
    Q_D(const CognitoIdentityProviderClientRequest);
    QUrl url(endpoint);
 ...
 * @internal
 *
 * @class  CognitoIdentityProviderClientRequestPrivate
 *
 * @brief  Private implementation for CognitoIdentityProviderClientRequest.
 */

/**
 * @internal
 *
 * @brief  Constructs a new CognitoIdentityProviderClientRequestPrivate object.
 *
 ...
 * @internal
 *
 * @brief  Constructs a new CognitoIdentityProviderClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the CognitoIdentityProviderClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public CognitoIdentityProviderClientRequest instance.
 */
 ...
 *
 * This function converts CognitoIdentityProviderClientRequest::Action enumerator values to their respective
 ...
 */
QString CognitoIdentityProviderClientRequestPrivate::toString(const CognitoIdentityProviderClientRequest::Action &action)
{
    #define ActionToString(action) \
        case CognitoIdentityProviderClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
