...
class QTAWS_EXPORT DeleteUserPoolDomainRequestPrivate : public CognitoIdentityProviderRequestPrivate {

public:
    DeleteUserPoolDomainRequestPrivate(const CognitoIdentityProvider::Action action,
