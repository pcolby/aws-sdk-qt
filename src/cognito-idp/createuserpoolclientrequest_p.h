...
class QTAWS_EXPORT CreateUserPoolClientRequestPrivate : public CognitoIdentityProviderPrivate {

public:
    CreateUserPoolClientRequestPrivate(const CognitoIdentityProvider::Action action,
