...
class QTAWS_EXPORT CreateUserPoolClientResponse : public CognitoIdentityProviderResponse {
    Q_OBJECT

public:
    CreateUserPoolClientResponse(const CreateUserPoolClientRequest &request, QNetworkReply * const reply, QObject * const parent = 0);

    virtual const CreateUserPoolClientRequest * request() const override;
