...
class QTAWS_EXPORT UpdateUserPoolRequestPrivate : public CognitoIdentityProviderRequestPrivate {

public:
    UpdateUserPoolRequestPrivate(const CognitoIdentityProvider::Action action,
