...
class QTAWS_EXPORT ListUserPoolClientsRequestPrivate : public CognitoIdentityProviderRequestPrivate {

public:
    ListUserPoolClientsRequestPrivate(const CognitoIdentityProvider::Action action,
