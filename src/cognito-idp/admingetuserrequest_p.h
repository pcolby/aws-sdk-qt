...
class QTAWS_EXPORT AdminGetUserRequestPrivate : public CognitoIdentityProviderRequestPrivate {

public:
    AdminGetUserRequestPrivate(const CognitoIdentityProvider::Action action,
