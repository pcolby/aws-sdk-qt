...
class QTAWS_EXPORT DescribeIdentityProviderResponse : public DescribeIdentityProviderResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeIdentityProviderRequest * request() const;
