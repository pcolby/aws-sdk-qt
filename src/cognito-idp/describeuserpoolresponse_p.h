...
class QTAWS_EXPORT DescribeUserPoolResponsePrivate : public CognitoIdentityProviderResponsePrivate {
    Q_OBJECT

public:

    DescribeUserPoolResponsePrivate(DescribeUserPoolResponse * const q);
