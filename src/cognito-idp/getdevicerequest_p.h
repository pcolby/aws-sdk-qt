...
class QTAWS_EXPORT GetDeviceRequestPrivate : public CognitoIdentityProviderRequestPrivate {

public:
    GetDeviceRequestPrivate(const CognitoIdentityProvider::Action action,
