...
class QTAWS_EXPORT DeleteUserPoolClientResponsePrivate : public CognitoIdentityProviderResponsePrivate {
    Q_OBJECT

public:

    DeleteUserPoolClientResponsePrivate(DeleteUserPoolClientResponse * const q);
