...
class QTAWS_EXPORT ListUsersRequestPrivate : public CognitoIdentityProviderRequestPrivate {

public:
    ListUsersRequestPrivate(const CognitoIdentityProvider::Action action,
