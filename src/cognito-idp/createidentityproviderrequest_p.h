...
class QTAWS_EXPORT CreateIdentityProviderRequestPrivate : public CognitoIdentityProviderRequestPrivate {

public:
    CreateIdentityProviderRequestPrivate(const CognitoIdentityProvider::Action action,
