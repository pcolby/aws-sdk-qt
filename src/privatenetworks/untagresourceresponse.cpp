...
/*!
 * \class QtAws::PrivateNetworks::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for PrivateNetworks UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : PrivateNetworksResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful PrivateNetworks UntagResource \a response.
 */
...
/*!
 * \class QtAws::PrivateNetworks::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : PrivateNetworksResponsePrivate(q)
{

}

/*!
 * Parses a PrivateNetworks UntagResource response element from \a xml.
 */
