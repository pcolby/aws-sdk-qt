...
/*!
 * \class QtAws::PrivateNetworks::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for PrivateNetworks ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : PrivateNetworksResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful PrivateNetworks ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::PrivateNetworks::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : PrivateNetworksResponsePrivate(q)
{

}

/*!
 * Parses a PrivateNetworks ListTagsForResource response element from \a xml.
 */
