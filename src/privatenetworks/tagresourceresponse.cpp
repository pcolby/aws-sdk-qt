...
/*!
 * \class QtAws::PrivateNetworks::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for PrivateNetworks TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : PrivateNetworksResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful PrivateNetworks TagResource \a response.
 */
...
/*!
 * \class QtAws::PrivateNetworks::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : PrivateNetworksResponsePrivate(q)
{

}

/*!
 * Parses a PrivateNetworks TagResource response element from \a xml.
 */
