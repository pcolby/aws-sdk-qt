...
TagResourceResponse::TagResourceResponse(
    ...
    : SnsResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(SnsResponse::request());
}
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : SnsResponsePrivate(q)
{
