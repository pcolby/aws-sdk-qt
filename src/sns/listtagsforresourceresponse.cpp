...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : SnsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(SnsResponse::request());
}
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : SnsResponsePrivate(q)
{
