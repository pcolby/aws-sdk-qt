...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : SnsRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : SnsRequest(new UntagResourceRequestPrivate(SnsRequest::UntagResourceAction, this))
{
...
/*!
 * Constructs a UntagResourceRequestPrivate object for Sns \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const SnsRequest::Action action, UntagResourceRequest * const q)
