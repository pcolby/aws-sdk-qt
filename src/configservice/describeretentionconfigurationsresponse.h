...
class QTAWS_EXPORT DescribeRetentionConfigurationsResponse : public ConfigServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeRetentionConfigurationsRequest * request() const override;
