...
class QTAWS_EXPORT DeleteAggregationAuthorizationResponse : public ConfigServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteAggregationAuthorizationRequest * request() const override;
