...
class QTAWS_EXPORT DeleteOrganizationConformancePackResponsePrivate : public ConfigServiceResponsePrivate {

public:

    DeleteOrganizationConformancePackResponsePrivate(DeleteOrganizationConformancePackResponse * const q);
