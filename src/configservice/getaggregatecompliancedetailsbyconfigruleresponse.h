...
class QTAWS_EXPORT GetAggregateComplianceDetailsByConfigRuleResponse : public ConfigServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetAggregateComplianceDetailsByConfigRuleRequest * request() const override;
