...
class QTAWS_EXPORT StartConfigurationRecorderResponse : public ConfigServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const StartConfigurationRecorderRequest * request() const override;
