...
class QTAWS_EXPORT GetConformancePackComplianceDetailsResponsePrivate : public ConfigServiceResponsePrivate {

public:

    GetConformancePackComplianceDetailsResponsePrivate(GetConformancePackComplianceDetailsResponse * const q);
