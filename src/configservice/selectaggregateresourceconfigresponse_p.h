...
class QTAWS_EXPORT SelectAggregateResourceConfigResponsePrivate : public ConfigServiceResponsePrivate {

public:

    SelectAggregateResourceConfigResponsePrivate(SelectAggregateResourceConfigResponse * const q);
