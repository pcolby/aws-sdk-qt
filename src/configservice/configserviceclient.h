...
class QTAWSCONFIGSERVICE_EXPORT ConfigServiceClient : public QtAws::Core::AwsAbstractClient {
    Q_OBJECT
...
public slots:
    ...
    GetCustomRulePolicyResponse * getCustomRulePolicy(const GetCustomRulePolicyRequest &request);
    ...
    GetOrganizationCustomRulePolicyResponse * getOrganizationCustomRulePolicy(const GetOrganizationCustomRulePolicyRequest &request);
    ...
    ListConformancePackComplianceScoresResponse * listConformancePackComplianceScores(const ListConformancePackComplianceScoresRequest &request);
