...
class QTAWS_EXPORT DescribeDeliveryChannelsResponsePrivate : public ConfigServiceResponsePrivate {

public:

    DescribeDeliveryChannelsResponsePrivate(DescribeDeliveryChannelsResponse * const q);
