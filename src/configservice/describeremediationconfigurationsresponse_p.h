...
class QTAWS_EXPORT DescribeRemediationConfigurationsResponsePrivate : public ConfigServiceResponsePrivate {

public:

    DescribeRemediationConfigurationsResponsePrivate(DescribeRemediationConfigurationsResponse * const q);
