...
class QTAWS_EXPORT DescribeOrganizationConformancePacksResponsePrivate : public ConfigServiceResponsePrivate {

public:

    DescribeOrganizationConformancePacksResponsePrivate(DescribeOrganizationConformancePacksResponse * const q);
