...
class QTAWS_EXPORT PutAggregationAuthorizationResponse : public ConfigServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const PutAggregationAuthorizationRequest * request() const override;
