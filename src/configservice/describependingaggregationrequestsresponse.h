...
class QTAWS_EXPORT DescribePendingAggregationRequestsResponse : public ConfigServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribePendingAggregationRequestsRequest * request() const override;
