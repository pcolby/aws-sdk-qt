...
class QTAWS_EXPORT DescribeComplianceByConfigRuleResponse : public ConfigServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeComplianceByConfigRuleRequest * request() const override;
