...
class QTAWS_EXPORT GetComplianceSummaryByConfigRuleResponsePrivate : public ConfigServiceResponsePrivate {

public:

    GetComplianceSummaryByConfigRuleResponsePrivate(GetComplianceSummaryByConfigRuleResponse * const q);
