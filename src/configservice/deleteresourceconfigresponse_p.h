...
class QTAWS_EXPORT DeleteResourceConfigResponsePrivate : public ConfigServiceResponsePrivate {

public:

    DeleteResourceConfigResponsePrivate(DeleteResourceConfigResponse * const q);
