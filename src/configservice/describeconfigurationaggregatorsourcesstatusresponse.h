...
class QTAWS_EXPORT DescribeConfigurationAggregatorSourcesStatusResponse : public ConfigServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeConfigurationAggregatorSourcesStatusRequest * request() const override;
