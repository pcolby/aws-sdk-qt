...
/*!
 * \class QtAws::ConfigService::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for ConfigService ListTagsForResource responses.
 *
 ...
 *
 * \sa ConfigServiceClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ConfigServiceResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(ConfigServiceResponse::request());
}

/*!
 * \reimp
 * Parses a successful ConfigService ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::ConfigService::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ConfigServiceResponsePrivate(q)
{

}

/*!
 * Parses a ConfigService ListTagsForResource response element from \a xml.
 */
