...
SfnClientRequest::SfnClientRequest(const Action action)
    : QtAws::Core::AwsAbstractRequest(new SfnClientRequestPrivate(action, this))
{
...
SfnClientRequest::SfnClientRequest(const SfnClientRequest &other)
    : QtAws::Core::AwsAbstractRequest(new SfnClientRequestPrivate(*other.d_func(), this))
{
 ...
 */
SfnClientRequest::SfnClientRequest(SfnClientRequestPrivate * const d) : QtAws::Core::AwsAbstractRequest(d)
{
