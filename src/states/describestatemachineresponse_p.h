...
class QTAWS_EXPORT DescribeStateMachineResponsePrivate : public SFNResponsePrivate {
    Q_OBJECT

public:

    DescribeStateMachineResponsePrivate(DescribeStateMachineResponse * const q);
