...
class QTAWS_EXPORT UngroupResourcesResponsePrivate : public ResourceGroupsResponsePrivate {

public:

    UngroupResourcesResponsePrivate(UngroupResourcesResponse * const q);
