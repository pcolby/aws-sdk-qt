...
#include "getgroupconfigurationrequest_p.h"
...
/*!
 * \class QtAws::ResourceGroups::GetGroupConfigurationRequest
 * \brief The GetGroupConfigurationRequest class provides an interface for ResourceGroups GetGroupConfiguration requests.
 *
 ...
 */
GetGroupConfigurationRequest::GetGroupConfigurationRequest(const GetGroupConfigurationRequest &other)
    : ResourceGroupsRequest(new GetGroupConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetGroupConfigurationRequest object.
 */
GetGroupConfigurationRequest::GetGroupConfigurationRequest()
    : ResourceGroupsRequest(new GetGroupConfigurationRequestPrivate(ResourceGroupsRequest::GetGroupConfigurationAction, this))
{
 ...
 * \reimp
 */
bool GetGroupConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetGroupConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetGroupConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new GetGroupConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::ResourceGroups::GetGroupConfigurationRequestPrivate
 * \brief The GetGroupConfigurationRequestPrivate class provides private implementation for GetGroupConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsResourceGroups
 */
...
/*!
 * Constructs a GetGroupConfigurationRequestPrivate object for ResourceGroups \a action,
 * with public implementation \a q.
 */
GetGroupConfigurationRequestPrivate::GetGroupConfigurationRequestPrivate(
    const ResourceGroupsRequest::Action action, GetGroupConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetGroupConfigurationRequest
 * class' copy constructor.
 */
GetGroupConfigurationRequestPrivate::GetGroupConfigurationRequestPrivate(
    const GetGroupConfigurationRequestPrivate &other, GetGroupConfigurationRequest * const q)
