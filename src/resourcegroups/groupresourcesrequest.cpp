...
#include "groupresourcesrequest_p.h"
...
/*!
 * \class QtAws::ResourceGroups::GroupResourcesRequest
 * \brief The GroupResourcesRequest class provides an interface for ResourceGroups GroupResources requests.
 *
 ...
 */
GroupResourcesRequest::GroupResourcesRequest(const GroupResourcesRequest &other)
    : ResourceGroupsRequest(new GroupResourcesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GroupResourcesRequest object.
 */
GroupResourcesRequest::GroupResourcesRequest()
    : ResourceGroupsRequest(new GroupResourcesRequestPrivate(ResourceGroupsRequest::GroupResourcesAction, this))
{
 ...
 * \reimp
 */
bool GroupResourcesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GroupResourcesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GroupResourcesRequest::response(QNetworkReply * const reply) const
{
    return new GroupResourcesResponse(*this, reply);
}

/*!
 * \class QtAws::ResourceGroups::GroupResourcesRequestPrivate
 * \brief The GroupResourcesRequestPrivate class provides private implementation for GroupResourcesRequest.
 * \internal
 *
 * \inmodule QtAwsResourceGroups
 */
...
/*!
 * Constructs a GroupResourcesRequestPrivate object for ResourceGroups \a action,
 * with public implementation \a q.
 */
GroupResourcesRequestPrivate::GroupResourcesRequestPrivate(
    const ResourceGroupsRequest::Action action, GroupResourcesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GroupResourcesRequest
 * class' copy constructor.
 */
GroupResourcesRequestPrivate::GroupResourcesRequestPrivate(
    const GroupResourcesRequestPrivate &other, GroupResourcesRequest * const q)
