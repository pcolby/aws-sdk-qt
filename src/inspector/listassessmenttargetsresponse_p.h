...
class QTAWS_EXPORT ListAssessmentTargetsResponsePrivate : public InspectorResponsePrivate {

public:

    ListAssessmentTargetsResponsePrivate(ListAssessmentTargetsResponse * const q);
