 ...
 *
 * @brief  Handles Inspector ListTagsForResource responses.
 *
...
/**
 * @brief  Parse a Inspector ListTagsForResource response.
 *
...
/**
 * @brief  Parse an Inspector ListTagsForResourceResponse element.
 *
