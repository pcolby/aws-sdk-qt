...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : InspectorResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(InspectorResponse::request());
}

/*!
 * \reimp
 * Parses a successful Inspector ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Inspector::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : InspectorResponsePrivate(q)
{

}

/*!
 * Parses a Inspector ListTagsForResource response element from \a xml.
 */
