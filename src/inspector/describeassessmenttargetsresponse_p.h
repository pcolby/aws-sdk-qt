...
class QTAWS_EXPORT DescribeAssessmentTargetsResponsePrivate : public InspectorResponsePrivate {

public:

    DescribeAssessmentTargetsResponsePrivate(DescribeAssessmentTargetsResponse * const q);
