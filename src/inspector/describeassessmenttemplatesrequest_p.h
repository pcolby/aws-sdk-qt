...
class QTAWS_EXPORT DescribeAssessmentTemplatesRequestPrivate : public InspectorPrivate {

public:
    DescribeAssessmentTemplatesRequestPrivate(const Inspector::Action action,
