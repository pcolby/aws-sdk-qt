...
/*!
 * \class QtAws::NimbleStudio::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for NimbleStudio TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : NimbleStudioResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(NimbleStudioResponse::request());
}

/*!
 * \reimp
 * Parses a successful NimbleStudio TagResource \a response.
 */
...
/*!
 * \class QtAws::NimbleStudio::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : NimbleStudioResponsePrivate(q)
{

}

/*!
 * Parses a NimbleStudio TagResource response element from \a xml.
 */
