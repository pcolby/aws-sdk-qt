...
class QTAWS_EXPORT GetLaunchProfileMemberResponsePrivate : public NimbleStudioResponsePrivate {

public:

    GetLaunchProfileMemberResponsePrivate(GetLaunchProfileMemberResponse * const q);
