...
/*!
 * \class QtAws::NimbleStudio::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for NimbleStudio ListTagsForResource responses.
 *
 * \inmodule QtAwsNimbleStudio
 *
 *
 * \sa NimbleStudioClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : NimbleStudioResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(NimbleStudioResponse::request());
}

/*!
 * \reimp
 * Parses a successful NimbleStudio ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::NimbleStudio::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : NimbleStudioResponsePrivate(q)
{

}

/*!
 * Parses a NimbleStudio ListTagsForResource response element from \a xml.
 */
