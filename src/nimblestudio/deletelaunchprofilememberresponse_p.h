...
class QTAWS_EXPORT DeleteLaunchProfileMemberResponsePrivate : public NimbleStudioResponsePrivate {

public:

    DeleteLaunchProfileMemberResponsePrivate(DeleteLaunchProfileMemberResponse * const q);
