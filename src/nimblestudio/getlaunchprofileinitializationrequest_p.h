...
class QTAWS_EXPORT GetLaunchProfileInitializationRequestPrivate : public NimbleStudioRequestPrivate {

public:
    GetLaunchProfileInitializationRequestPrivate(const NimbleStudioRequest::Action action,
