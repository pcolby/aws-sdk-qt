...
class QTAWS_EXPORT GetStreamingSessionStreamResponsePrivate : public NimbleStudioResponsePrivate {

public:

    GetStreamingSessionStreamResponsePrivate(GetStreamingSessionStreamResponse * const q);
