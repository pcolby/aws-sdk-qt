...
class QTAWS_EXPORT CreateStreamingImageResponsePrivate : public NimbleStudioResponsePrivate {

public:

    CreateStreamingImageResponsePrivate(CreateStreamingImageResponse * const q);
