...
class QTAWS_EXPORT CreateStreamingSessionRequestPrivate : public NimbleStudioRequestPrivate {

public:
    CreateStreamingSessionRequestPrivate(const NimbleStudioRequest::Action action,
