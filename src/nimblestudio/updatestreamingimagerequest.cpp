...
/*!
 * \class QtAws::NimbleStudio::UpdateStreamingImageRequest
 * \brief The UpdateStreamingImageRequest class provides an interface for NimbleStudio UpdateStreamingImage requests.
 *
...
UpdateStreamingImageRequest::UpdateStreamingImageRequest(const UpdateStreamingImageRequest &other)
    : NimbleStudioRequest(new UpdateStreamingImageRequestPrivate(*other.d_func(), this))
{
...
UpdateStreamingImageRequest::UpdateStreamingImageRequest()
    : NimbleStudioRequest(new UpdateStreamingImageRequestPrivate(NimbleStudioRequest::UpdateStreamingImageAction, this))
{
...
/*!
 * \class QtAws::NimbleStudio::UpdateStreamingImageRequestPrivate
...
/*!
 * Constructs a UpdateStreamingImageRequestPrivate object for NimbleStudio \a action,
 * with public implementation \a q.
 */
UpdateStreamingImageRequestPrivate::UpdateStreamingImageRequestPrivate(
    const NimbleStudioRequest::Action action, UpdateStreamingImageRequest * const q)
