...
class QTAWS_EXPORT GetLaunchProfileRequestPrivate : public NimbleStudioRequestPrivate {

public:
    GetLaunchProfileRequestPrivate(const NimbleStudioRequest::Action action,
