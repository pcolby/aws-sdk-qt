...
/*!
 * \class QtAws::NimbleStudio::DeleteStudioRequest
 * \brief The DeleteStudioRequest class provides an interface for NimbleStudio DeleteStudio requests.
 *
...
DeleteStudioRequest::DeleteStudioRequest(const DeleteStudioRequest &other)
    : NimbleStudioRequest(new DeleteStudioRequestPrivate(*other.d_func(), this))
{
...
DeleteStudioRequest::DeleteStudioRequest()
    : NimbleStudioRequest(new DeleteStudioRequestPrivate(NimbleStudioRequest::DeleteStudioAction, this))
{
...
/*!
 * \class QtAws::NimbleStudio::DeleteStudioRequestPrivate
...
/*!
 * Constructs a DeleteStudioRequestPrivate object for NimbleStudio \a action,
 * with public implementation \a q.
 */
DeleteStudioRequestPrivate::DeleteStudioRequestPrivate(
    const NimbleStudioRequest::Action action, DeleteStudioRequest * const q)
