...
class QTAWS_EXPORT DeleteLaunchProfileRequestPrivate : public NimbleStudioRequestPrivate {

public:
    DeleteLaunchProfileRequestPrivate(const NimbleStudioRequest::Action action,
