...
class QTAWS_EXPORT DeleteStudioComponentResponsePrivate : public NimbleStudioResponsePrivate {

public:

    DeleteStudioComponentResponsePrivate(DeleteStudioComponentResponse * const q);
