...
class QTAWS_EXPORT UpdateLaunchProfileResponsePrivate : public NimbleStudioResponsePrivate {

public:

    UpdateLaunchProfileResponsePrivate(UpdateLaunchProfileResponse * const q);
