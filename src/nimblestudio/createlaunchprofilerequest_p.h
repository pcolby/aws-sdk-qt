...
class QTAWS_EXPORT CreateLaunchProfileRequestPrivate : public NimbleStudioRequestPrivate {

public:
    CreateLaunchProfileRequestPrivate(const NimbleStudioRequest::Action action,
