...
class QTAWS_EXPORT ListLaunchProfileMembersResponsePrivate : public NimbleStudioResponsePrivate {

public:

    ListLaunchProfileMembersResponsePrivate(ListLaunchProfileMembersResponse * const q);
