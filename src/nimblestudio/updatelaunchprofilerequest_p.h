...
class QTAWS_EXPORT UpdateLaunchProfileRequestPrivate : public NimbleStudioRequestPrivate {

public:
    UpdateLaunchProfileRequestPrivate(const NimbleStudioRequest::Action action,
