...
class QTAWS_EXPORT GetStreamingSessionResponsePrivate : public NimbleStudioResponsePrivate {

public:

    GetStreamingSessionResponsePrivate(GetStreamingSessionResponse * const q);
