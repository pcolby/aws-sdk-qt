...
class QTAWS_EXPORT ListStudioMembersResponsePrivate : public NimbleStudioResponsePrivate {

public:

    ListStudioMembersResponsePrivate(ListStudioMembersResponse * const q);
