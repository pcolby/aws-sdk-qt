...
class QTAWS_EXPORT ListStudioMembersRequestPrivate : public NimbleStudioRequestPrivate {

public:
    ListStudioMembersRequestPrivate(const NimbleStudioRequest::Action action,
