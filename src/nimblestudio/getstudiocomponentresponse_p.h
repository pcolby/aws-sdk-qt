...
class QTAWS_EXPORT GetStudioComponentResponsePrivate : public NimbleStudioResponsePrivate {

public:

    GetStudioComponentResponsePrivate(GetStudioComponentResponse * const q);
