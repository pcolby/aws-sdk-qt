...
class QTAWS_EXPORT StartStudioSSOConfigurationRepairRequestPrivate : public NimbleStudioRequestPrivate {

public:
    StartStudioSSOConfigurationRepairRequestPrivate(const NimbleStudioRequest::Action action,
