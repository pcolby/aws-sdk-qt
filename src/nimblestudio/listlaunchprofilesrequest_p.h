...
class QTAWS_EXPORT ListLaunchProfilesRequestPrivate : public NimbleStudioRequestPrivate {

public:
    ListLaunchProfilesRequestPrivate(const NimbleStudioRequest::Action action,
