...
class QTAWS_EXPORT PutLaunchProfileMembersRequestPrivate : public NimbleStudioRequestPrivate {

public:
    PutLaunchProfileMembersRequestPrivate(const NimbleStudioRequest::Action action,
