...
class QTAWS_EXPORT UpdateLaunchProfileMemberRequestPrivate : public NimbleStudioRequestPrivate {

public:
    UpdateLaunchProfileMemberRequestPrivate(const NimbleStudioRequest::Action action,
