...
class QTAWS_EXPORT DeleteStudioMemberRequestPrivate : public NimbleStudioRequestPrivate {

public:
    DeleteStudioMemberRequestPrivate(const NimbleStudioRequest::Action action,
