...
class QTAWS_EXPORT ListStudioComponentsRequestPrivate : public NimbleStudioRequestPrivate {

public:
    ListStudioComponentsRequestPrivate(const NimbleStudioRequest::Action action,
