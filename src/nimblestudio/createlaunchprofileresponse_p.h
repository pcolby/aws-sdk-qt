...
class QTAWS_EXPORT CreateLaunchProfileResponsePrivate : public NimbleStudioResponsePrivate {

public:

    CreateLaunchProfileResponsePrivate(CreateLaunchProfileResponse * const q);
