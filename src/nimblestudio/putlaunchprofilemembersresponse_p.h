...
class QTAWS_EXPORT PutLaunchProfileMembersResponsePrivate : public NimbleStudioResponsePrivate {

public:

    PutLaunchProfileMembersResponsePrivate(PutLaunchProfileMembersResponse * const q);
