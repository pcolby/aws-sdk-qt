...
class QTAWS_EXPORT UpdateGatewayResponseResponsePrivate : public APIGatewayResponsePrivate {

public:

    UpdateGatewayResponseResponsePrivate(UpdateGatewayResponseResponse * const q);
