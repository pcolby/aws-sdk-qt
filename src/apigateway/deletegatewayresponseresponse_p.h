...
class QTAWS_EXPORT DeleteGatewayResponseResponsePrivate : public APIGatewayResponsePrivate {
    Q_OBJECT

public:

    DeleteGatewayResponseResponsePrivate(DeleteGatewayResponseResponse * const q);
