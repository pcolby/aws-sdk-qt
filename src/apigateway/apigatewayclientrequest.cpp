...
/**
 * @brief  Constructs a new APIGatewayClientRequest object.
 *
...
/**
 * @brief  Constructs a new APIGatewayClientRequest object by copying another.
 *
 ...
 */
APIGatewayClientRequest& APIGatewayClientRequest::operator=(const APIGatewayClientRequest &other)
{
    Q_D(APIGatewayClientRequest);
 ...
 * implementation that inherits from APIGatewayClientRequestPrivate.
 *
 ...
 */
APIGatewayClientRequest::Action APIGatewayClientRequest::action() const
{
    Q_D(const APIGatewayClientRequest);
    return d->action;
}
 ...
 */
QString APIGatewayClientRequest::actionString() const
{
    return APIGatewayClientRequestPrivate::toString(action());
}
 ...
 */
QString APIGatewayClientRequest::apiVersion() const
{
    Q_D(const APIGatewayClientRequest);
    return d->apiVersion;
}
 ...
 */
void APIGatewayClientRequest::setAction(const Action action)
{
    Q_D(APIGatewayClientRequest);
    d->action = action;
}
 ...
 */
void APIGatewayClientRequest::setApiVersion(const QString &version)
{
    Q_D(APIGatewayClientRequest);
 ...
 */
bool APIGatewayClientRequest::operator==(const APIGatewayClientRequest &other) const
{
 ...
 */
bool APIGatewayClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int APIGatewayClientRequest::clearParameter(const QString &name)
{
    Q_D(APIGatewayClientRequest);
 ...
 */
void APIGatewayClientRequest::clearParameters()
{
    Q_D(APIGatewayClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant APIGatewayClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const APIGatewayClientRequest);
 ...
 */
const QVariantMap &APIGatewayClientRequest::parameters() const
{
    Q_D(const APIGatewayClientRequest);
    return d->parameters;
}
 ...
 */
void APIGatewayClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(APIGatewayClientRequest);
 ...
 */
void APIGatewayClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(APIGatewayClientRequest);
 ...
 */
QNetworkRequest APIGatewayClientRequest::unsignedRequest(const QUrl &endpoint) const
{
    Q_D(const APIGatewayClientRequest);
    QUrl url(endpoint);
 ...
 *
 * @brief  Private implementation for APIGatewayClientRequest.
 */

/**
 * @internal
 *
 * @brief  Constructs a new APIGatewayClientRequestPrivate object.
 *
 ...
 * @internal
 *
 * @brief  Constructs a new APIGatewayClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the APIGatewayClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public APIGatewayClientRequest instance.
 */
 ...
 *
 * This function converts APIGatewayClientRequest::Action enumerator values to their respective
 ...
 */
QString APIGatewayClientRequestPrivate::toString(const APIGatewayClientRequest::Action &action)
{
    #define ActionToString(action) \
        case APIGatewayClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
