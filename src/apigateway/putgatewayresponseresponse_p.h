...
class QTAWS_EXPORT PutGatewayResponseResponsePrivate : public APIGatewayResponsePrivate {
    Q_OBJECT

public:

    PutGatewayResponseResponsePrivate(PutGatewayResponseResponse * const q);
