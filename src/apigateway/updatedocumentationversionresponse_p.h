...
class QTAWS_EXPORT UpdateDocumentationVersionResponsePrivate : public APIGatewayResponsePrivate {
    Q_OBJECT

public:

    UpdateDocumentationVersionResponsePrivate(UpdateDocumentationVersionResponse * const q);
