...
class QTAWS_EXPORT DeleteMethodResponseRequestPrivate : public APIGatewayRequestPrivate {

public:
    DeleteMethodResponseRequestPrivate(const APIGateway::Action action,
