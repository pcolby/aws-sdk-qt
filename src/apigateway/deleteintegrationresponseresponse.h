...
class QTAWS_EXPORT DeleteIntegrationResponseResponse : public DeleteIntegrationResponseResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteIntegrationResponseRequest * request() const;
