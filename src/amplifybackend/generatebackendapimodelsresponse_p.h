...
class QTAWS_EXPORT GenerateBackendAPIModelsResponsePrivate : public AmplifyBackendResponsePrivate {

public:

    GenerateBackendAPIModelsResponsePrivate(GenerateBackendAPIModelsResponse * const q);
