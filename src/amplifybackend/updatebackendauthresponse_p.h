...
class QTAWS_EXPORT UpdateBackendAuthResponsePrivate : public AmplifyBackendResponsePrivate {

public:

    UpdateBackendAuthResponsePrivate(UpdateBackendAuthResponse * const q);
