...
class QTAWS_EXPORT CreateBackendAuthResponsePrivate : public AmplifyBackendResponsePrivate {

public:

    CreateBackendAuthResponsePrivate(CreateBackendAuthResponse * const q);
