...
class QTAWS_EXPORT AmplifyBackendResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {

public:

    AmplifyBackendResponsePrivate(AmplifyBackendResponse * const q);
