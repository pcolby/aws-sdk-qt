...
class QTAWS_EXPORT UpdateBackendConfigResponsePrivate : public AmplifyBackendResponsePrivate {

public:

    UpdateBackendConfigResponsePrivate(UpdateBackendConfigResponse * const q);
