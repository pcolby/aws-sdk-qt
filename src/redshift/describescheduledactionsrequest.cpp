...
/*!
 * \class QtAws::Redshift::DescribeScheduledActionsRequest
 * \brief The DescribeScheduledActionsRequest class provides an interface for Redshift DescribeScheduledActions requests.
 *
...
DescribeScheduledActionsRequest::DescribeScheduledActionsRequest(const DescribeScheduledActionsRequest &other)
    : RedshiftRequest(new DescribeScheduledActionsRequestPrivate(*other.d_func(), this))
{
...
DescribeScheduledActionsRequest::DescribeScheduledActionsRequest()
    : RedshiftRequest(new DescribeScheduledActionsRequestPrivate(RedshiftRequest::DescribeScheduledActionsAction, this))
{
...
/*!
 * \class QtAws::Redshift::DescribeScheduledActionsRequestPrivate
...
/*!
 * Constructs a DescribeScheduledActionsRequestPrivate object for Redshift \a action,
 * with public implementation \a q.
 */
DescribeScheduledActionsRequestPrivate::DescribeScheduledActionsRequestPrivate(
    const RedshiftRequest::Action action, DescribeScheduledActionsRequest * const q)
