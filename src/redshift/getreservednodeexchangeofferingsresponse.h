...
class QTAWS_EXPORT GetReservedNodeExchangeOfferingsResponse : public RedshiftResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetReservedNodeExchangeOfferingsRequest * request() const override;
