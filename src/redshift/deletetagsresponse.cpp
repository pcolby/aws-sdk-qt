...
{
    return static_cast<const DeleteTagsRequest *>(RedshiftResponse::request());
}

/*!
 * \reimp
 * Parses a successful Redshift DeleteTags \a response.
 */
...
/*!
 * \class QtAws::Redshift::DeleteTagsResponsePrivate
...
/*!
 * Parses a Redshift DeleteTags response element from \a xml.
 */
