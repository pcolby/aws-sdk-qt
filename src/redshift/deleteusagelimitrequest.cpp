...
/*!
 * \class QtAws::Redshift::DeleteUsageLimitRequest
 * \brief The DeleteUsageLimitRequest class provides an interface for Redshift DeleteUsageLimit requests.
 *
...
DeleteUsageLimitRequest::DeleteUsageLimitRequest(const DeleteUsageLimitRequest &other)
    : RedshiftRequest(new DeleteUsageLimitRequestPrivate(*other.d_func(), this))
{
...
DeleteUsageLimitRequest::DeleteUsageLimitRequest()
    : RedshiftRequest(new DeleteUsageLimitRequestPrivate(RedshiftRequest::DeleteUsageLimitAction, this))
{
...
/*!
 * \class QtAws::Redshift::DeleteUsageLimitRequestPrivate
...
/*!
 * Constructs a DeleteUsageLimitRequestPrivate object for Redshift \a action,
 * with public implementation \a q.
 */
DeleteUsageLimitRequestPrivate::DeleteUsageLimitRequestPrivate(
    const RedshiftRequest::Action action, DeleteUsageLimitRequest * const q)
