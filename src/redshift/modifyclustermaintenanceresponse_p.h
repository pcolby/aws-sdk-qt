...
class QTAWS_EXPORT ModifyClusterMaintenanceResponsePrivate : public RedshiftResponsePrivate {

public:

    ModifyClusterMaintenanceResponsePrivate(ModifyClusterMaintenanceResponse * const q);
