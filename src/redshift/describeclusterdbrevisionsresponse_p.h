...
class QTAWS_EXPORT DescribeClusterDbRevisionsResponsePrivate : public RedshiftResponsePrivate {

public:

    DescribeClusterDbRevisionsResponsePrivate(DescribeClusterDbRevisionsResponse * const q);
