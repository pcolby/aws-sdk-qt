...
class QTAWS_EXPORT ModifyClusterSnapshotResponsePrivate : public RedshiftResponsePrivate {

public:

    ModifyClusterSnapshotResponsePrivate(ModifyClusterSnapshotResponse * const q);
