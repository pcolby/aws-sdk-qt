...
/*!
 * \class QtAws::Redshift::DeleteSnapshotScheduleResponse
 * \brief The DeleteSnapshotScheduleResponse class provides an interace for Redshift DeleteSnapshotSchedule responses.
 *
...
DeleteSnapshotScheduleResponse::DeleteSnapshotScheduleResponse(
    ...
    : RedshiftResponse(new DeleteSnapshotScheduleResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Redshift DeleteSnapshotSchedule \a response.
 */
...
/*!
 * \class QtAws::Redshift::DeleteSnapshotScheduleResponsePrivate
...
DeleteSnapshotScheduleResponsePrivate::DeleteSnapshotScheduleResponsePrivate(
    DeleteSnapshotScheduleResponse * const q) : RedshiftResponsePrivate(q)
{

}

/*!
 * Parses a Redshift DeleteSnapshotSchedule response element from \a xml.
 */
