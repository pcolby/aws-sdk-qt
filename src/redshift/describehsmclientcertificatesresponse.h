...
class QTAWS_EXPORT DescribeHsmClientCertificatesResponse : public RedshiftResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeHsmClientCertificatesRequest * request() const override;
