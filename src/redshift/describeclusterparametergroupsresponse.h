...
class QTAWSREDSHIFT_EXPORT DescribeClusterParameterGroupsResponse : public RedshiftResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeClusterParameterGroupsRequest * request() const Q_DECL_OVERRIDE;
