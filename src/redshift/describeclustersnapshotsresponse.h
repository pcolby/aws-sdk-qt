...
class QTAWS_EXPORT DescribeClusterSnapshotsResponse : public DescribeClusterSnapshotsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeClusterSnapshotsRequest * request() const;
