...
class QTAWS_EXPORT DescribeClusterParameterGroupsResponsePrivate : public RedshiftResponsePrivate {
    Q_OBJECT

public:

    DescribeClusterParameterGroupsResponsePrivate(DescribeClusterParameterGroupsResponse * const q);
