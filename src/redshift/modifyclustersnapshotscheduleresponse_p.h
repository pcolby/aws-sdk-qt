...
class QTAWS_EXPORT ModifyClusterSnapshotScheduleResponsePrivate : public RedshiftResponsePrivate {

public:

    ModifyClusterSnapshotScheduleResponsePrivate(ModifyClusterSnapshotScheduleResponse * const q);
