 ...
 *  data warehouse.
 *
 * \sa RedshiftClient::describeTags
 */
...
/*!
 * \class QtAws::Redshift::DescribeTagsRequestPrivate
...
/*!
 *
 * Constructs a DescribeTagsRequestPrivate object for Redshift \a action with,
