...
/*!
 * \class QtAws::Redshift::DeleteEndpointAccessResponse
 * \brief The DeleteEndpointAccessResponse class provides an interace for Redshift DeleteEndpointAccess responses.
 *
...
DeleteEndpointAccessResponse::DeleteEndpointAccessResponse(
    ...
    : RedshiftResponse(new DeleteEndpointAccessResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Redshift DeleteEndpointAccess \a response.
 */
...
/*!
 * \class QtAws::Redshift::DeleteEndpointAccessResponsePrivate
...
DeleteEndpointAccessResponsePrivate::DeleteEndpointAccessResponsePrivate(
    DeleteEndpointAccessResponse * const q) : RedshiftResponsePrivate(q)
{

}

/*!
 * Parses a Redshift DeleteEndpointAccess response element from \a xml.
 */
