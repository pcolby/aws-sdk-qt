...
class QTAWS_EXPORT DeleteClusterParameterGroupResponse : public DeleteClusterParameterGroupResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteClusterParameterGroupRequest * request() const;
