...
class QTAWS_EXPORT CreateSnapshotScheduleResponsePrivate : public RedshiftResponsePrivate {

public:

    CreateSnapshotScheduleResponsePrivate(CreateSnapshotScheduleResponse * const q);
