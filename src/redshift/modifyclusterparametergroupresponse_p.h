...
class QTAWS_EXPORT ModifyClusterParameterGroupResponsePrivate : public RedshiftResponsePrivate {

public:

    ModifyClusterParameterGroupResponsePrivate(ModifyClusterParameterGroupResponse * const q);
