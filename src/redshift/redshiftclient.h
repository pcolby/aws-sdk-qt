...
public slots:
    ...
    AssociateDataShareConsumerResponse * associateDataShareConsumer(const AssociateDataShareConsumerRequest &request);
    ...
    AuthorizeDataShareResponse * authorizeDataShare(const AuthorizeDataShareRequest &request);
    ...
    CreateAuthenticationProfileResponse * createAuthenticationProfile(const CreateAuthenticationProfileRequest &request);
    ...
    DeauthorizeDataShareResponse * deauthorizeDataShare(const DeauthorizeDataShareRequest &request);
    DeleteAuthenticationProfileResponse * deleteAuthenticationProfile(const DeleteAuthenticationProfileRequest &request);
    ...
    DescribeAuthenticationProfilesResponse * describeAuthenticationProfiles(const DescribeAuthenticationProfilesRequest &request);
    ...
    DescribeDataSharesResponse * describeDataShares(const DescribeDataSharesRequest &request);
    DescribeDataSharesForConsumerResponse * describeDataSharesForConsumer(const DescribeDataSharesForConsumerRequest &request);
    DescribeDataSharesForProducerResponse * describeDataSharesForProducer(const DescribeDataSharesForProducerRequest &request);
    ...
    DescribeReservedNodeExchangeStatusResponse * describeReservedNodeExchangeStatus(const DescribeReservedNodeExchangeStatusRequest &request);
    ...
    DisassociateDataShareConsumerResponse * disassociateDataShareConsumer(const DisassociateDataShareConsumerRequest &request);
    ...
    GetClusterCredentialsWithIAMResponse * getClusterCredentialsWithIAM(const GetClusterCredentialsWithIAMRequest &request);
    GetReservedNodeExchangeConfigurationOptionsResponse * getReservedNodeExchangeConfigurationOptions(const GetReservedNodeExchangeConfigurationOptionsRequest &request);
    ...
    ModifyAuthenticationProfileResponse * modifyAuthenticationProfile(const ModifyAuthenticationProfileRequest &request);
    ...
    RejectDataShareResponse * rejectDataShare(const RejectDataShareRequest &request);
