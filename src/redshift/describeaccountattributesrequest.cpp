...
/*!
 * \class QtAws::Redshift::DescribeAccountAttributesRequest
 * \brief The DescribeAccountAttributesRequest class provides an interface for Redshift DescribeAccountAttributes requests.
 *
...
DescribeAccountAttributesRequest::DescribeAccountAttributesRequest(const DescribeAccountAttributesRequest &other)
    : RedshiftRequest(new DescribeAccountAttributesRequestPrivate(*other.d_func(), this))
{
...
DescribeAccountAttributesRequest::DescribeAccountAttributesRequest()
    : RedshiftRequest(new DescribeAccountAttributesRequestPrivate(RedshiftRequest::DescribeAccountAttributesAction, this))
{
...
/*!
 * \class QtAws::Redshift::DescribeAccountAttributesRequestPrivate
...
/*!
 * Constructs a DescribeAccountAttributesRequestPrivate object for Redshift \a action,
 * with public implementation \a q.
 */
DescribeAccountAttributesRequestPrivate::DescribeAccountAttributesRequestPrivate(
    const RedshiftRequest::Action action, DescribeAccountAttributesRequest * const q)
