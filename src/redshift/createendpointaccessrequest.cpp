...
/*!
 * \class QtAws::Redshift::CreateEndpointAccessRequest
 * \brief The CreateEndpointAccessRequest class provides an interface for Redshift CreateEndpointAccess requests.
 *
 ...
 *  data warehouse.
 *
 * \sa RedshiftClient::createEndpointAccess
 */
...
CreateEndpointAccessRequest::CreateEndpointAccessRequest(const CreateEndpointAccessRequest &other)
    : RedshiftRequest(new CreateEndpointAccessRequestPrivate(*other.d_func(), this))
{
...
CreateEndpointAccessRequest::CreateEndpointAccessRequest()
    : RedshiftRequest(new CreateEndpointAccessRequestPrivate(RedshiftRequest::CreateEndpointAccessAction, this))
{
...
/*!
 * \class QtAws::Redshift::CreateEndpointAccessRequestPrivate
...
/*!
 * Constructs a CreateEndpointAccessRequestPrivate object for Redshift \a action,
 * with public implementation \a q.
 */
CreateEndpointAccessRequestPrivate::CreateEndpointAccessRequestPrivate(
    const RedshiftRequest::Action action, CreateEndpointAccessRequest * const q)
