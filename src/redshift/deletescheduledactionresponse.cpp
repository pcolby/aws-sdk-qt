...
/*!
 * \class QtAws::Redshift::DeleteScheduledActionResponse
 * \brief The DeleteScheduledActionResponse class provides an interace for Redshift DeleteScheduledAction responses.
 *
...
DeleteScheduledActionResponse::DeleteScheduledActionResponse(
    ...
    : RedshiftResponse(new DeleteScheduledActionResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Redshift DeleteScheduledAction \a response.
 */
...
/*!
 * \class QtAws::Redshift::DeleteScheduledActionResponsePrivate
...
DeleteScheduledActionResponsePrivate::DeleteScheduledActionResponsePrivate(
    DeleteScheduledActionResponse * const q) : RedshiftResponsePrivate(q)
{

}

/*!
 * Parses a Redshift DeleteScheduledAction response element from \a xml.
 */
