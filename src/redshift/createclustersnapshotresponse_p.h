...
class QTAWS_EXPORT CreateClusterSnapshotResponsePrivate : public RedshiftResponsePrivate {

public:

    CreateClusterSnapshotResponsePrivate(CreateClusterSnapshotResponse * const q);
