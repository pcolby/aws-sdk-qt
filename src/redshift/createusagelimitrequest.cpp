...
/*!
 * \class QtAws::Redshift::CreateUsageLimitRequest
 * \brief The CreateUsageLimitRequest class provides an interface for Redshift CreateUsageLimit requests.
 *
...
CreateUsageLimitRequest::CreateUsageLimitRequest(const CreateUsageLimitRequest &other)
    : RedshiftRequest(new CreateUsageLimitRequestPrivate(*other.d_func(), this))
{
...
CreateUsageLimitRequest::CreateUsageLimitRequest()
    : RedshiftRequest(new CreateUsageLimitRequestPrivate(RedshiftRequest::CreateUsageLimitAction, this))
{
...
/*!
 * \class QtAws::Redshift::CreateUsageLimitRequestPrivate
...
/*!
 * Constructs a CreateUsageLimitRequestPrivate object for Redshift \a action,
 * with public implementation \a q.
 */
CreateUsageLimitRequestPrivate::CreateUsageLimitRequestPrivate(
    const RedshiftRequest::Action action, CreateUsageLimitRequest * const q)
