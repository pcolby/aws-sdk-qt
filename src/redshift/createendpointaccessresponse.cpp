...
/*!
 * \class QtAws::Redshift::CreateEndpointAccessResponse
 * \brief The CreateEndpointAccessResponse class provides an interace for Redshift CreateEndpointAccess responses.
 *
...
CreateEndpointAccessResponse::CreateEndpointAccessResponse(
    ...
    : RedshiftResponse(new CreateEndpointAccessResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Redshift CreateEndpointAccess \a response.
 */
...
/*!
 * \class QtAws::Redshift::CreateEndpointAccessResponsePrivate
...
CreateEndpointAccessResponsePrivate::CreateEndpointAccessResponsePrivate(
    CreateEndpointAccessResponse * const q) : RedshiftResponsePrivate(q)
{

}

/*!
 * Parses a Redshift CreateEndpointAccess response element from \a xml.
 */
