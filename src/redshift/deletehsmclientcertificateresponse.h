...
class QTAWSREDSHIFT_EXPORT DeleteHsmClientCertificateResponse : public RedshiftResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteHsmClientCertificateRequest * request() const Q_DECL_OVERRIDE;
