 ...
 *  data warehouse.
 *
 * \sa RedshiftClient::describeClusterSubnetGroups
 */
...
{
    return static_cast<const DescribeClusterSubnetGroupsRequest *>(RedshiftResponse::request());
}
...
{
    //Q_D(DescribeClusterSubnetGroupsResponse);
