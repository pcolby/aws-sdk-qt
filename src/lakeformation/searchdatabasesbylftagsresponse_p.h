...
class QTAWS_EXPORT SearchDatabasesByLFTagsResponsePrivate : public LakeFormationResponsePrivate {

public:

    SearchDatabasesByLFTagsResponsePrivate(SearchDatabasesByLFTagsResponse * const q);
