...
public slots:
    ...
    GetAccountSendingEnabledResponse * getAccountSendingEnabled(const GetAccountSendingEnabledRequest &request);
    ...
    GetSendQuotaResponse * getSendQuota(const GetSendQuotaRequest &request);
    GetSendQuotaResponse * getSendQuota();
    GetSendStatisticsResponse * getSendStatistics(const GetSendStatisticsRequest &request);
...
protected:
    ...
    explicit SesClient(SesClientPrivate * const d);
    /// @endcond
