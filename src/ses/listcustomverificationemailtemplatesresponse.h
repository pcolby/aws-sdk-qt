...
class QTAWS_EXPORT ListCustomVerificationEmailTemplatesResponse : public SesResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListCustomVerificationEmailTemplatesRequest * request() const override;
