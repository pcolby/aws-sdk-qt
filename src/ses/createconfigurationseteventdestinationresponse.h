...
class QTAWS_EXPORT CreateConfigurationSetEventDestinationResponse : public SesResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateConfigurationSetEventDestinationRequest * request() const override;
