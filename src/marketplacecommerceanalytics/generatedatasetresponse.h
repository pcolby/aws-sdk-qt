...
class QTAWSMARKETPLACECOMMERCEANALYTICS_EXPORT GenerateDataSetResponse : public MarketplaceCommerceAnalyticsResponse {
    Q_OBJECT

public:
    GenerateDataSetResponse(const GenerateDataSetRequest &request, QNetworkReply * const reply, QObject * const parent = 0);

    virtual const GenerateDataSetRequest * request() const Q_DECL_OVERRIDE;
