...
/*!
 * \class QtAws::Amp::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Amp UntagResource responses.
 *
 * \inmodule QtAwsAmp
 *
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : AmpResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Amp UntagResource \a response.
 */
...
/*!
 * \class QtAws::Amp::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : AmpResponsePrivate(q)
{

}

/*!
 * Parses a Amp UntagResource response element from \a xml.
 */
