...
/*!
 * \class QtAws::Amp::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Amp TagResource responses.
 *
 * \inmodule QtAwsAmp
 *
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : AmpResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Amp TagResource \a response.
 */
...
/*!
 * \class QtAws::Amp::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : AmpResponsePrivate(q)
{

}

/*!
 * Parses a Amp TagResource response element from \a xml.
 */
