...
/*!
 * \class QtAws::Amp::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Amp ListTagsForResource responses.
 *
 * \inmodule QtAwsAmp
 *
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : AmpResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Amp ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Amp::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : AmpResponsePrivate(q)
{

}

/*!
 * Parses a Amp ListTagsForResource response element from \a xml.
 */
