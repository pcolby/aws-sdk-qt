...
class QTAWS_EXPORT KinesisVideoMediaRequest : public QtAws::Core::AwsAbstractRequest {
...
public:
    ...
    virtual bool operator==(const KinesisVideoMediaRequest &other) const override;
