...
/*!
 * \class QtAws::SavingsPlans::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for SavingsPlans TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : SavingsPlansResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(SavingsPlansResponse::request());
}

/*!
 * \reimp
 * Parses a successful SavingsPlans TagResource \a response.
 */
...
/*!
 * \class QtAws::SavingsPlans::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : SavingsPlansResponsePrivate(q)
{

}

/*!
 * Parses a SavingsPlans TagResource response element from \a xml.
 */
