...
class QTAWS_EXPORT DescribeSavingsPlansOfferingsResponsePrivate : public SavingsPlansResponsePrivate {

public:

    DescribeSavingsPlansOfferingsResponsePrivate(DescribeSavingsPlansOfferingsResponse * const q);
