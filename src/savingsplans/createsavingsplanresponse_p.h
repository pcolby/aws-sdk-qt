...
class QTAWS_EXPORT CreateSavingsPlanResponsePrivate : public SavingsPlansResponsePrivate {

public:

    CreateSavingsPlanResponsePrivate(CreateSavingsPlanResponse * const q);
