...
/*!
 * \class QtAws::Athena::CreateWorkGroupResponse
 * \brief The CreateWorkGroupResponse class provides an interace for Athena CreateWorkGroup responses.
 *
...
CreateWorkGroupResponse::CreateWorkGroupResponse(
    ...
    : AthenaResponse(new CreateWorkGroupResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Athena CreateWorkGroup \a response.
 */
...
/*!
 * \class QtAws::Athena::CreateWorkGroupResponsePrivate
...
CreateWorkGroupResponsePrivate::CreateWorkGroupResponsePrivate(
    CreateWorkGroupResponse * const q) : AthenaResponsePrivate(q)
{

}

/*!
 * Parses a Athena CreateWorkGroup response element from \a xml.
 */
