...
/*!
 * \class QtAws::Athena::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Athena TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : AthenaResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(AthenaResponse::request());
}

/*!
 * \reimp
 * Parses a successful Athena TagResource \a response.
 */
...
/*!
 * \class QtAws::Athena::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : AthenaResponsePrivate(q)
{

}

/*!
 * Parses a Athena TagResource response element from \a xml.
 */
