...
/*!
 * \class QtAws::Athena::GetDatabaseRequest
 * \brief The GetDatabaseRequest class provides an interface for Athena GetDatabase requests.
 *
...
GetDatabaseRequest::GetDatabaseRequest(const GetDatabaseRequest &other)
    : AthenaRequest(new GetDatabaseRequestPrivate(*other.d_func(), this))
{
...
GetDatabaseRequest::GetDatabaseRequest()
    : AthenaRequest(new GetDatabaseRequestPrivate(AthenaRequest::GetDatabaseAction, this))
{
...
/*!
 * \class QtAws::Athena::GetDatabaseRequestPrivate
...
/*!
 * Constructs a GetDatabaseRequestPrivate object for Athena \a action,
 * with public implementation \a q.
 */
GetDatabaseRequestPrivate::GetDatabaseRequestPrivate(
    const AthenaRequest::Action action, GetDatabaseRequest * const q)
