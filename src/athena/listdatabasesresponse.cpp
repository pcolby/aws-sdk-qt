...
/*!
 * \class QtAws::Athena::ListDatabasesResponse
 * \brief The ListDatabasesResponse class provides an interace for Athena ListDatabases responses.
 *
...
ListDatabasesResponse::ListDatabasesResponse(
    ...
    : AthenaResponse(new ListDatabasesResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Athena ListDatabases \a response.
 */
...
/*!
 * \class QtAws::Athena::ListDatabasesResponsePrivate
...
ListDatabasesResponsePrivate::ListDatabasesResponsePrivate(
    ListDatabasesResponse * const q) : AthenaResponsePrivate(q)
{

}

/*!
 * Parses a Athena ListDatabases response element from \a xml.
 */
