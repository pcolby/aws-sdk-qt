...
class QTAWS_EXPORT GetPreparedStatementResponsePrivate : public AthenaResponsePrivate {

public:

    GetPreparedStatementResponsePrivate(GetPreparedStatementResponse * const q);
