...
class QTAWS_EXPORT ListPreparedStatementsResponsePrivate : public AthenaResponsePrivate {

public:

    ListPreparedStatementsResponsePrivate(ListPreparedStatementsResponse * const q);
