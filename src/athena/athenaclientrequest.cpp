...
#include "athenaclientrequest_p.h"
...
/**
 * @brief  Constructs a new AthenaClientRequest object.
 *
...
/**
 * @brief  Constructs a new AthenaClientRequest object by copying another.
 *
 ...
 */
AthenaClientRequest& AthenaClientRequest::operator=(const AthenaClientRequest &other)
{
    Q_D(AthenaClientRequest);
 ...
 * implementation that inherits from AthenaClientRequestPrivate.
 *
 ...
 */
AthenaClientRequest::Action AthenaClientRequest::action() const
{
    Q_D(const AthenaClientRequest);
    return d->action;
}
 ...
 */
QString AthenaClientRequest::actionString() const
{
    return AthenaClientRequestPrivate::toString(action());
}
 ...
 */
QString AthenaClientRequest::apiVersion() const
{
    Q_D(const AthenaClientRequest);
    return d->apiVersion;
}
 ...
 */
void AthenaClientRequest::setAction(const Action action)
{
    Q_D(AthenaClientRequest);
    d->action = action;
}
 ...
 */
void AthenaClientRequest::setApiVersion(const QString &version)
{
    Q_D(AthenaClientRequest);
 ...
 */
bool AthenaClientRequest::operator==(const AthenaClientRequest &other) const
{
 ...
 */
bool AthenaClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int AthenaClientRequest::clearParameter(const QString &name)
{
    Q_D(AthenaClientRequest);
 ...
 */
void AthenaClientRequest::clearParameters()
{
    Q_D(AthenaClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant AthenaClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const AthenaClientRequest);
 ...
 */
const QVariantMap &AthenaClientRequest::parameters() const
{
    Q_D(const AthenaClientRequest);
    return d->parameters;
}
 ...
 */
void AthenaClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(AthenaClientRequest);
 ...
 */
void AthenaClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(AthenaClientRequest);
 ...
 */
QNetworkRequest AthenaClientRequest::unsignedRequest(const QUrl &endpoint) const
{
    Q_D(const AthenaClientRequest);
    QUrl url(endpoint);
 ...
 *
 * @brief  Private implementation for AthenaClientRequest.
 */

/**
 * @internal
 *
 * @brief  Constructs a new AthenaClientRequestPrivate object.
 *
 ...
 * @internal
 *
 * @brief  Constructs a new AthenaClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the AthenaClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public AthenaClientRequest instance.
 */
 ...
 *
 * This function converts AthenaClientRequest::Action enumerator values to their respective
 ...
 */
QString AthenaClientRequestPrivate::toString(const AthenaClientRequest::Action &action)
{
    #define ActionToString(action) \
        case AthenaClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
