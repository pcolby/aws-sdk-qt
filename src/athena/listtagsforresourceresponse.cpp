...
/*!
 * \class QtAws::Athena::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Athena ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : AthenaResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(AthenaResponse::request());
}

/*!
 * \reimp
 * Parses a successful Athena ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Athena::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : AthenaResponsePrivate(q)
{

}

/*!
 * Parses a Athena ListTagsForResource response element from \a xml.
 */
