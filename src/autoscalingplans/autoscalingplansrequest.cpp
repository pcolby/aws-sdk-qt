...
AutoScalingPlansRequest::AutoScalingPlansRequest(const Action action)
    : d_ptr(new AutoScalingPlansRequestPrivate(action, this))
{
...
AutoScalingPlansRequest::AutoScalingPlansRequest(const AutoScalingPlansRequest &other)
    : QtAws::Core::AwsAbstractRequest(*this),
      d_ptr(new AutoScalingPlansRequestPrivate(*other.d_func(), this))
{
 ...
 */
AutoScalingPlansRequest::AutoScalingPlansRequest(AutoScalingPlansRequestPrivate * const d) : d_ptr(d)
{
