...
class QTAWS_EXPORT AutoScalingPlansResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {

public:

    AutoScalingPlansResponsePrivate(AutoScalingPlansResponse * const q);
