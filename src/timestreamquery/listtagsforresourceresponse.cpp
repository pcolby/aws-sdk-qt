...
/*!
 * \class QtAws::TimestreamQuery::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for TimestreamQuery ListTagsForResource responses.
 *
 * \inmodule QtAwsTimestreamQuery
 *
 *  <fullname>Amazon Timestream Query </fullname>
 *
 * \sa TimestreamQueryClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : TimestreamQueryResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful TimestreamQuery ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::TimestreamQuery::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : TimestreamQueryResponsePrivate(q)
{

}

/*!
 * Parses a TimestreamQuery ListTagsForResource response element from \a xml.
 */
