...
/*!
 * \class QtAws::TimestreamQuery::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for TimestreamQuery UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : TimestreamQueryResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful TimestreamQuery UntagResource \a response.
 */
...
/*!
 * \class QtAws::TimestreamQuery::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : TimestreamQueryResponsePrivate(q)
{

}

/*!
 * Parses a TimestreamQuery UntagResource response element from \a xml.
 */
