...
/*!
 * \class QtAws::TimestreamQuery::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for TimestreamQuery TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : TimestreamQueryResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful TimestreamQuery TagResource \a response.
 */
...
/*!
 * \class QtAws::TimestreamQuery::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : TimestreamQueryResponsePrivate(q)
{

}

/*!
 * Parses a TimestreamQuery TagResource response element from \a xml.
 */
