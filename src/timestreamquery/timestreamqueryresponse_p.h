...
class QTAWS_EXPORT TimestreamQueryResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {

public:

    TimestreamQueryResponsePrivate(TimestreamQueryResponse * const q);
