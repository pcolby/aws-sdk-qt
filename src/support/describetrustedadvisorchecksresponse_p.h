...
class QTAWS_EXPORT DescribeTrustedAdvisorChecksResponsePrivate : public SupportResponsePrivate {

public:

    DescribeTrustedAdvisorChecksResponsePrivate(DescribeTrustedAdvisorChecksResponse * const q);
