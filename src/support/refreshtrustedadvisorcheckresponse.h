...
class QTAWS_EXPORT RefreshTrustedAdvisorCheckResponse : public RefreshTrustedAdvisorCheckResponse {
    Q_OBJECT
...
public:
    ...
    virtual const RefreshTrustedAdvisorCheckRequest * request() const;
