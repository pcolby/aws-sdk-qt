...
class QTAWS_EXPORT DescribeTrustedAdvisorChecksResponse : public SupportResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeTrustedAdvisorChecksRequest * request() const override;
