...
#include "detectprotectiveequipmentrequest_p.h"
...
/*!
 * \class QtAws::Rekognition::DetectProtectiveEquipmentRequest
 * \brief The DetectProtectiveEquipmentRequest class provides an interface for Rekognition DetectProtectiveEquipment requests.
 *
 ...
 */
DetectProtectiveEquipmentRequest::DetectProtectiveEquipmentRequest(const DetectProtectiveEquipmentRequest &other)
    : RekognitionRequest(new DetectProtectiveEquipmentRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DetectProtectiveEquipmentRequest object.
 */
DetectProtectiveEquipmentRequest::DetectProtectiveEquipmentRequest()
    : RekognitionRequest(new DetectProtectiveEquipmentRequestPrivate(RekognitionRequest::DetectProtectiveEquipmentAction, this))
{
 ...
 * \reimp
 */
bool DetectProtectiveEquipmentRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DetectProtectiveEquipmentResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DetectProtectiveEquipmentRequest::response(QNetworkReply * const reply) const
{
    return new DetectProtectiveEquipmentResponse(*this, reply);
}

/*!
 * \class QtAws::Rekognition::DetectProtectiveEquipmentRequestPrivate
 * \brief The DetectProtectiveEquipmentRequestPrivate class provides private implementation for DetectProtectiveEquipmentRequest.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a DetectProtectiveEquipmentRequestPrivate object for Rekognition \a action,
 * with public implementation \a q.
 */
DetectProtectiveEquipmentRequestPrivate::DetectProtectiveEquipmentRequestPrivate(
    const RekognitionRequest::Action action, DetectProtectiveEquipmentRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DetectProtectiveEquipmentRequest
 * class' copy constructor.
 */
DetectProtectiveEquipmentRequestPrivate::DetectProtectiveEquipmentRequestPrivate(
    const DetectProtectiveEquipmentRequestPrivate &other, DetectProtectiveEquipmentRequest * const q)
