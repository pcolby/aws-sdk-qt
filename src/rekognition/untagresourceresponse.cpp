...
/*!
 * \class QtAws::Rekognition::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Rekognition UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : RekognitionResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Rekognition UntagResource \a response.
 */
...
/*!
 * \class QtAws::Rekognition::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition UntagResource response element from \a xml.
 */
