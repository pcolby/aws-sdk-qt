...
/*!
 * \class QtAws::Rekognition::UpdateDatasetEntriesResponse
 * \brief The UpdateDatasetEntriesResponse class provides an interace for Rekognition UpdateDatasetEntries responses.
 *
...
UpdateDatasetEntriesResponse::UpdateDatasetEntriesResponse(
    ...
    : RekognitionResponse(new UpdateDatasetEntriesResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Rekognition UpdateDatasetEntries \a response.
 */
...
/*!
 * \class QtAws::Rekognition::UpdateDatasetEntriesResponsePrivate
...
UpdateDatasetEntriesResponsePrivate::UpdateDatasetEntriesResponsePrivate(
    UpdateDatasetEntriesResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition UpdateDatasetEntries response element from \a xml.
 */
