...
class QTAWS_EXPORT StartFaceDetectionResponsePrivate : public RekognitionResponsePrivate {
    Q_OBJECT

public:

    StartFaceDetectionResponsePrivate(StartFaceDetectionResponse * const q);
