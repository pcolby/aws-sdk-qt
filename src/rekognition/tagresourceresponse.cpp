...
/*!
 * \class QtAws::Rekognition::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Rekognition TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : RekognitionResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(RekognitionResponse::request());
}

/*!
 * \reimp
 * Parses a successful Rekognition TagResource \a response.
 */
...
/*!
 * \class QtAws::Rekognition::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition TagResource response element from \a xml.
 */
