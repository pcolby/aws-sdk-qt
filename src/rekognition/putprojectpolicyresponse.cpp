...
#include "putprojectpolicyresponse_p.h"
...
/*!
 * \class QtAws::Rekognition::PutProjectPolicyResponse
 * \brief The PutProjectPolicyResponse class provides an interace for Rekognition PutProjectPolicy responses.
 *
 ...
 *
 * \sa RekognitionClient::putProjectPolicy
 */

/*!
 * Constructs a PutProjectPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
PutProjectPolicyResponse::PutProjectPolicyResponse(
        const PutProjectPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RekognitionResponse(new PutProjectPolicyResponsePrivate(this), parent)
{
    setRequest(new PutProjectPolicyRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const PutProjectPolicyRequest * PutProjectPolicyResponse::request() const
{
    Q_D(const PutProjectPolicyResponse);
    return static_cast<const PutProjectPolicyRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Rekognition PutProjectPolicy \a response.
 */
void PutProjectPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutProjectPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rekognition::PutProjectPolicyResponsePrivate
 * \brief The PutProjectPolicyResponsePrivate class provides private implementation for PutProjectPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a PutProjectPolicyResponsePrivate object with public implementation \a q.
 */
PutProjectPolicyResponsePrivate::PutProjectPolicyResponsePrivate(
    PutProjectPolicyResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition PutProjectPolicy response element from \a xml.
 */
void PutProjectPolicyResponsePrivate::parsePutProjectPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutProjectPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
