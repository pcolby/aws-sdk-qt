...
/*!
 * \class QtAws::Rekognition::CreateProjectResponse
 * \brief The CreateProjectResponse class provides an interace for Rekognition CreateProject responses.
 *
...
CreateProjectResponse::CreateProjectResponse(
    ...
    : RekognitionResponse(new CreateProjectResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Rekognition CreateProject \a response.
 */
...
/*!
 * \class QtAws::Rekognition::CreateProjectResponsePrivate
...
CreateProjectResponsePrivate::CreateProjectResponsePrivate(
    CreateProjectResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition CreateProject response element from \a xml.
 */
