...
/*!
 * \class QtAws::Rekognition::CreateDatasetResponse
 * \brief The CreateDatasetResponse class provides an interace for Rekognition CreateDataset responses.
 *
...
CreateDatasetResponse::CreateDatasetResponse(
    ...
    : RekognitionResponse(new CreateDatasetResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Rekognition CreateDataset \a response.
 */
...
/*!
 * \class QtAws::Rekognition::CreateDatasetResponsePrivate
...
CreateDatasetResponsePrivate::CreateDatasetResponsePrivate(
    CreateDatasetResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition CreateDataset response element from \a xml.
 */
