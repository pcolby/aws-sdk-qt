...
#include "deleteprojectpolicyresponse_p.h"
...
/*!
 * \class QtAws::Rekognition::DeleteProjectPolicyResponse
 * \brief The DeleteProjectPolicyResponse class provides an interace for Rekognition DeleteProjectPolicy responses.
 *
 ...
 *
 * \sa RekognitionClient::deleteProjectPolicy
 */

/*!
 * Constructs a DeleteProjectPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteProjectPolicyResponse::DeleteProjectPolicyResponse(
        const DeleteProjectPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RekognitionResponse(new DeleteProjectPolicyResponsePrivate(this), parent)
{
    setRequest(new DeleteProjectPolicyRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteProjectPolicyRequest * DeleteProjectPolicyResponse::request() const
{
    Q_D(const DeleteProjectPolicyResponse);
    return static_cast<const DeleteProjectPolicyRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Rekognition DeleteProjectPolicy \a response.
 */
void DeleteProjectPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteProjectPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rekognition::DeleteProjectPolicyResponsePrivate
 * \brief The DeleteProjectPolicyResponsePrivate class provides private implementation for DeleteProjectPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a DeleteProjectPolicyResponsePrivate object with public implementation \a q.
 */
DeleteProjectPolicyResponsePrivate::DeleteProjectPolicyResponsePrivate(
    DeleteProjectPolicyResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition DeleteProjectPolicy response element from \a xml.
 */
void DeleteProjectPolicyResponsePrivate::parseDeleteProjectPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteProjectPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
