...
class QTAWS_EXPORT GetSegmentDetectionResponsePrivate : public RekognitionResponsePrivate {

public:

    GetSegmentDetectionResponsePrivate(GetSegmentDetectionResponse * const q);
