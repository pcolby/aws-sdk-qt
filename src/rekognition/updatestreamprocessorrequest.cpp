...
#include "updatestreamprocessorrequest_p.h"
...
/*!
 * \class QtAws::Rekognition::UpdateStreamProcessorRequest
 * \brief The UpdateStreamProcessorRequest class provides an interface for Rekognition UpdateStreamProcessor requests.
 *
 ...
 */
UpdateStreamProcessorRequest::UpdateStreamProcessorRequest(const UpdateStreamProcessorRequest &other)
    : RekognitionRequest(new UpdateStreamProcessorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateStreamProcessorRequest object.
 */
UpdateStreamProcessorRequest::UpdateStreamProcessorRequest()
    : RekognitionRequest(new UpdateStreamProcessorRequestPrivate(RekognitionRequest::UpdateStreamProcessorAction, this))
{
 ...
 * \reimp
 */
bool UpdateStreamProcessorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateStreamProcessorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateStreamProcessorRequest::response(QNetworkReply * const reply) const
{
    return new UpdateStreamProcessorResponse(*this, reply);
}

/*!
 * \class QtAws::Rekognition::UpdateStreamProcessorRequestPrivate
 * \brief The UpdateStreamProcessorRequestPrivate class provides private implementation for UpdateStreamProcessorRequest.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a UpdateStreamProcessorRequestPrivate object for Rekognition \a action,
 * with public implementation \a q.
 */
UpdateStreamProcessorRequestPrivate::UpdateStreamProcessorRequestPrivate(
    const RekognitionRequest::Action action, UpdateStreamProcessorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateStreamProcessorRequest
 * class' copy constructor.
 */
UpdateStreamProcessorRequestPrivate::UpdateStreamProcessorRequestPrivate(
    const UpdateStreamProcessorRequestPrivate &other, UpdateStreamProcessorRequest * const q)
