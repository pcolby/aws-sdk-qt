...
#include "listprojectpoliciesresponse_p.h"
...
/*!
 * \class QtAws::Rekognition::ListProjectPoliciesResponse
 * \brief The ListProjectPoliciesResponse class provides an interace for Rekognition ListProjectPolicies responses.
 *
 ...
 *
 * \sa RekognitionClient::listProjectPolicies
 */

/*!
 * Constructs a ListProjectPoliciesResponse object for \a reply to \a request, with parent \a parent.
 */
ListProjectPoliciesResponse::ListProjectPoliciesResponse(
        const ListProjectPoliciesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RekognitionResponse(new ListProjectPoliciesResponsePrivate(this), parent)
{
    setRequest(new ListProjectPoliciesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListProjectPoliciesRequest * ListProjectPoliciesResponse::request() const
{
    Q_D(const ListProjectPoliciesResponse);
    return static_cast<const ListProjectPoliciesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Rekognition ListProjectPolicies \a response.
 */
void ListProjectPoliciesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListProjectPoliciesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rekognition::ListProjectPoliciesResponsePrivate
 * \brief The ListProjectPoliciesResponsePrivate class provides private implementation for ListProjectPoliciesResponse.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a ListProjectPoliciesResponsePrivate object with public implementation \a q.
 */
ListProjectPoliciesResponsePrivate::ListProjectPoliciesResponsePrivate(
    ListProjectPoliciesResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition ListProjectPolicies response element from \a xml.
 */
void ListProjectPoliciesResponsePrivate::parseListProjectPoliciesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListProjectPoliciesResponse"));
    Q_UNUSED(xml) ///< @todo
}
