...
/*!
 * \class QtAws::Rekognition::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for Rekognition ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : RekognitionRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : RekognitionRequest(new ListTagsForResourceRequestPrivate(RekognitionRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::Rekognition::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for Rekognition \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const RekognitionRequest::Action action, ListTagsForResourceRequest * const q)
