...
/*!
 * \class QtAws::Rekognition::DeleteDatasetResponse
 * \brief The DeleteDatasetResponse class provides an interace for Rekognition DeleteDataset responses.
 *
...
DeleteDatasetResponse::DeleteDatasetResponse(
    ...
    : RekognitionResponse(new DeleteDatasetResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Rekognition DeleteDataset \a response.
 */
...
/*!
 * \class QtAws::Rekognition::DeleteDatasetResponsePrivate
...
DeleteDatasetResponsePrivate::DeleteDatasetResponsePrivate(
    DeleteDatasetResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition DeleteDataset response element from \a xml.
 */
