...
#include "copyprojectversionrequest_p.h"
...
/*!
 * \class QtAws::Rekognition::CopyProjectVersionRequest
 * \brief The CopyProjectVersionRequest class provides an interface for Rekognition CopyProjectVersion requests.
 *
 ...
 */
CopyProjectVersionRequest::CopyProjectVersionRequest(const CopyProjectVersionRequest &other)
    : RekognitionRequest(new CopyProjectVersionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CopyProjectVersionRequest object.
 */
CopyProjectVersionRequest::CopyProjectVersionRequest()
    : RekognitionRequest(new CopyProjectVersionRequestPrivate(RekognitionRequest::CopyProjectVersionAction, this))
{
 ...
 * \reimp
 */
bool CopyProjectVersionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CopyProjectVersionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CopyProjectVersionRequest::response(QNetworkReply * const reply) const
{
    return new CopyProjectVersionResponse(*this, reply);
}

/*!
 * \class QtAws::Rekognition::CopyProjectVersionRequestPrivate
 * \brief The CopyProjectVersionRequestPrivate class provides private implementation for CopyProjectVersionRequest.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a CopyProjectVersionRequestPrivate object for Rekognition \a action,
 * with public implementation \a q.
 */
CopyProjectVersionRequestPrivate::CopyProjectVersionRequestPrivate(
    const RekognitionRequest::Action action, CopyProjectVersionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CopyProjectVersionRequest
 * class' copy constructor.
 */
CopyProjectVersionRequestPrivate::CopyProjectVersionRequestPrivate(
    const CopyProjectVersionRequestPrivate &other, CopyProjectVersionRequest * const q)
