...
#include "distributedatasetentriesrequest_p.h"
...
/*!
 * \class QtAws::Rekognition::DistributeDatasetEntriesRequest
 * \brief The DistributeDatasetEntriesRequest class provides an interface for Rekognition DistributeDatasetEntries requests.
 *
 ...
 */
DistributeDatasetEntriesRequest::DistributeDatasetEntriesRequest(const DistributeDatasetEntriesRequest &other)
    : RekognitionRequest(new DistributeDatasetEntriesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DistributeDatasetEntriesRequest object.
 */
DistributeDatasetEntriesRequest::DistributeDatasetEntriesRequest()
    : RekognitionRequest(new DistributeDatasetEntriesRequestPrivate(RekognitionRequest::DistributeDatasetEntriesAction, this))
{
 ...
 * \reimp
 */
bool DistributeDatasetEntriesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DistributeDatasetEntriesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DistributeDatasetEntriesRequest::response(QNetworkReply * const reply) const
{
    return new DistributeDatasetEntriesResponse(*this, reply);
}

/*!
 * \class QtAws::Rekognition::DistributeDatasetEntriesRequestPrivate
 * \brief The DistributeDatasetEntriesRequestPrivate class provides private implementation for DistributeDatasetEntriesRequest.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a DistributeDatasetEntriesRequestPrivate object for Rekognition \a action,
 * with public implementation \a q.
 */
DistributeDatasetEntriesRequestPrivate::DistributeDatasetEntriesRequestPrivate(
    const RekognitionRequest::Action action, DistributeDatasetEntriesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DistributeDatasetEntriesRequest
 * class' copy constructor.
 */
DistributeDatasetEntriesRequestPrivate::DistributeDatasetEntriesRequestPrivate(
    const DistributeDatasetEntriesRequestPrivate &other, DistributeDatasetEntriesRequest * const q)
