...
/*!
 * \class QtAws::Rekognition::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Rekognition ListTagsForResource responses.
 *
 * \inmodule QtAwsRekognition
 *
 *  This is the Amazon Rekognition API
 *
 * \sa RekognitionClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : RekognitionResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(RekognitionResponse::request());
}

/*!
 * \reimp
 * Parses a successful Rekognition ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Rekognition::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition ListTagsForResource response element from \a xml.
 */
