...
/*!
 * \class QtAws::Rekognition::ListDatasetEntriesResponse
 * \brief The ListDatasetEntriesResponse class provides an interace for Rekognition ListDatasetEntries responses.
 *
...
ListDatasetEntriesResponse::ListDatasetEntriesResponse(
    ...
    : RekognitionResponse(new ListDatasetEntriesResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Rekognition ListDatasetEntries \a response.
 */
...
/*!
 * \class QtAws::Rekognition::ListDatasetEntriesResponsePrivate
...
ListDatasetEntriesResponsePrivate::ListDatasetEntriesResponsePrivate(
    ListDatasetEntriesResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition ListDatasetEntries response element from \a xml.
 */
