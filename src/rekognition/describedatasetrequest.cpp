...
/*!
 * \class QtAws::Rekognition::DescribeDatasetRequest
 * \brief The DescribeDatasetRequest class provides an interface for Rekognition DescribeDataset requests.
 *
 ...
 *
 * \sa RekognitionClient::describeDataset
 */
...
DescribeDatasetRequest::DescribeDatasetRequest(const DescribeDatasetRequest &other)
    : RekognitionRequest(new DescribeDatasetRequestPrivate(*other.d_func(), this))
{
...
DescribeDatasetRequest::DescribeDatasetRequest()
    : RekognitionRequest(new DescribeDatasetRequestPrivate(RekognitionRequest::DescribeDatasetAction, this))
{
...
/*!
 * \class QtAws::Rekognition::DescribeDatasetRequestPrivate
...
/*!
 * Constructs a DescribeDatasetRequestPrivate object for Rekognition \a action,
 * with public implementation \a q.
 */
DescribeDatasetRequestPrivate::DescribeDatasetRequestPrivate(
    const RekognitionRequest::Action action, DescribeDatasetRequest * const q)
