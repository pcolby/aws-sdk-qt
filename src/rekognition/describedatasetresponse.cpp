...
/*!
 * \class QtAws::Rekognition::DescribeDatasetResponse
 * \brief The DescribeDatasetResponse class provides an interace for Rekognition DescribeDataset responses.
 *
...
DescribeDatasetResponse::DescribeDatasetResponse(
    ...
    : RekognitionResponse(new DescribeDatasetResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Rekognition DescribeDataset \a response.
 */
...
/*!
 * \class QtAws::Rekognition::DescribeDatasetResponsePrivate
...
DescribeDatasetResponsePrivate::DescribeDatasetResponsePrivate(
    DescribeDatasetResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition DescribeDataset response element from \a xml.
 */
