...
#include "listdatasetlabelsrequest_p.h"
...
/*!
 * \class QtAws::Rekognition::ListDatasetLabelsRequest
 * \brief The ListDatasetLabelsRequest class provides an interface for Rekognition ListDatasetLabels requests.
 *
 ...
 */
ListDatasetLabelsRequest::ListDatasetLabelsRequest(const ListDatasetLabelsRequest &other)
    : RekognitionRequest(new ListDatasetLabelsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListDatasetLabelsRequest object.
 */
ListDatasetLabelsRequest::ListDatasetLabelsRequest()
    : RekognitionRequest(new ListDatasetLabelsRequestPrivate(RekognitionRequest::ListDatasetLabelsAction, this))
{
 ...
 * \reimp
 */
bool ListDatasetLabelsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListDatasetLabelsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListDatasetLabelsRequest::response(QNetworkReply * const reply) const
{
    return new ListDatasetLabelsResponse(*this, reply);
}

/*!
 * \class QtAws::Rekognition::ListDatasetLabelsRequestPrivate
 * \brief The ListDatasetLabelsRequestPrivate class provides private implementation for ListDatasetLabelsRequest.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a ListDatasetLabelsRequestPrivate object for Rekognition \a action,
 * with public implementation \a q.
 */
ListDatasetLabelsRequestPrivate::ListDatasetLabelsRequestPrivate(
    const RekognitionRequest::Action action, ListDatasetLabelsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListDatasetLabelsRequest
 * class' copy constructor.
 */
ListDatasetLabelsRequestPrivate::ListDatasetLabelsRequestPrivate(
    const ListDatasetLabelsRequestPrivate &other, ListDatasetLabelsRequest * const q)
