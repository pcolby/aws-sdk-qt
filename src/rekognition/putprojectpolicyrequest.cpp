...
#include "putprojectpolicyrequest_p.h"
...
/*!
 * \class QtAws::Rekognition::PutProjectPolicyRequest
 * \brief The PutProjectPolicyRequest class provides an interface for Rekognition PutProjectPolicy requests.
 *
 ...
 */
PutProjectPolicyRequest::PutProjectPolicyRequest(const PutProjectPolicyRequest &other)
    : RekognitionRequest(new PutProjectPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutProjectPolicyRequest object.
 */
PutProjectPolicyRequest::PutProjectPolicyRequest()
    : RekognitionRequest(new PutProjectPolicyRequestPrivate(RekognitionRequest::PutProjectPolicyAction, this))
{
 ...
 * \reimp
 */
bool PutProjectPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutProjectPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutProjectPolicyRequest::response(QNetworkReply * const reply) const
{
    return new PutProjectPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::Rekognition::PutProjectPolicyRequestPrivate
 * \brief The PutProjectPolicyRequestPrivate class provides private implementation for PutProjectPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a PutProjectPolicyRequestPrivate object for Rekognition \a action,
 * with public implementation \a q.
 */
PutProjectPolicyRequestPrivate::PutProjectPolicyRequestPrivate(
    const RekognitionRequest::Action action, PutProjectPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutProjectPolicyRequest
 * class' copy constructor.
 */
PutProjectPolicyRequestPrivate::PutProjectPolicyRequestPrivate(
    const PutProjectPolicyRequestPrivate &other, PutProjectPolicyRequest * const q)
