...
#include "distributedatasetentriesresponse_p.h"
...
/*!
 * \class QtAws::Rekognition::DistributeDatasetEntriesResponse
 * \brief The DistributeDatasetEntriesResponse class provides an interace for Rekognition DistributeDatasetEntries responses.
 *
 ...
 *
 * \sa RekognitionClient::distributeDatasetEntries
 */

/*!
 * Constructs a DistributeDatasetEntriesResponse object for \a reply to \a request, with parent \a parent.
 */
DistributeDatasetEntriesResponse::DistributeDatasetEntriesResponse(
        const DistributeDatasetEntriesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RekognitionResponse(new DistributeDatasetEntriesResponsePrivate(this), parent)
{
    setRequest(new DistributeDatasetEntriesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DistributeDatasetEntriesRequest * DistributeDatasetEntriesResponse::request() const
{
    Q_D(const DistributeDatasetEntriesResponse);
    return static_cast<const DistributeDatasetEntriesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Rekognition DistributeDatasetEntries \a response.
 */
void DistributeDatasetEntriesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DistributeDatasetEntriesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rekognition::DistributeDatasetEntriesResponsePrivate
 * \brief The DistributeDatasetEntriesResponsePrivate class provides private implementation for DistributeDatasetEntriesResponse.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a DistributeDatasetEntriesResponsePrivate object with public implementation \a q.
 */
DistributeDatasetEntriesResponsePrivate::DistributeDatasetEntriesResponsePrivate(
    DistributeDatasetEntriesResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition DistributeDatasetEntries response element from \a xml.
 */
void DistributeDatasetEntriesResponsePrivate::parseDistributeDatasetEntriesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DistributeDatasetEntriesResponse"));
    Q_UNUSED(xml) ///< @todo
}
