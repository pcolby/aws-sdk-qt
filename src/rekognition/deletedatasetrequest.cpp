...
/*!
 * \class QtAws::Rekognition::DeleteDatasetRequest
 * \brief The DeleteDatasetRequest class provides an interface for Rekognition DeleteDataset requests.
 *
 ...
 *
 * \sa RekognitionClient::deleteDataset
 */
...
DeleteDatasetRequest::DeleteDatasetRequest(const DeleteDatasetRequest &other)
    : RekognitionRequest(new DeleteDatasetRequestPrivate(*other.d_func(), this))
{
...
DeleteDatasetRequest::DeleteDatasetRequest()
    : RekognitionRequest(new DeleteDatasetRequestPrivate(RekognitionRequest::DeleteDatasetAction, this))
{
...
/*!
 * \class QtAws::Rekognition::DeleteDatasetRequestPrivate
...
/*!
 * Constructs a DeleteDatasetRequestPrivate object for Rekognition \a action,
 * with public implementation \a q.
 */
DeleteDatasetRequestPrivate::DeleteDatasetRequestPrivate(
    const RekognitionRequest::Action action, DeleteDatasetRequest * const q)
