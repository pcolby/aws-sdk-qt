...
#include "updatestreamprocessorresponse_p.h"
...
/*!
 * \class QtAws::Rekognition::UpdateStreamProcessorResponse
 * \brief The UpdateStreamProcessorResponse class provides an interace for Rekognition UpdateStreamProcessor responses.
 *
 ...
 *
 * \sa RekognitionClient::updateStreamProcessor
 */

/*!
 * Constructs a UpdateStreamProcessorResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateStreamProcessorResponse::UpdateStreamProcessorResponse(
        const UpdateStreamProcessorRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RekognitionResponse(new UpdateStreamProcessorResponsePrivate(this), parent)
{
    setRequest(new UpdateStreamProcessorRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateStreamProcessorRequest * UpdateStreamProcessorResponse::request() const
{
    Q_D(const UpdateStreamProcessorResponse);
    return static_cast<const UpdateStreamProcessorRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Rekognition UpdateStreamProcessor \a response.
 */
void UpdateStreamProcessorResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateStreamProcessorResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rekognition::UpdateStreamProcessorResponsePrivate
 * \brief The UpdateStreamProcessorResponsePrivate class provides private implementation for UpdateStreamProcessorResponse.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a UpdateStreamProcessorResponsePrivate object with public implementation \a q.
 */
UpdateStreamProcessorResponsePrivate::UpdateStreamProcessorResponsePrivate(
    UpdateStreamProcessorResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition UpdateStreamProcessor response element from \a xml.
 */
void UpdateStreamProcessorResponsePrivate::parseUpdateStreamProcessorResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateStreamProcessorResponse"));
    Q_UNUSED(xml) ///< @todo
}
