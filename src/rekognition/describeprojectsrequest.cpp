...
#include "describeprojectsrequest_p.h"
...
/*!
 * \class QtAws::Rekognition::DescribeProjectsRequest
 * \brief The DescribeProjectsRequest class provides an interface for Rekognition DescribeProjects requests.
 *
 ...
 */
DescribeProjectsRequest::DescribeProjectsRequest(const DescribeProjectsRequest &other)
    : RekognitionRequest(new DescribeProjectsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeProjectsRequest object.
 */
DescribeProjectsRequest::DescribeProjectsRequest()
    : RekognitionRequest(new DescribeProjectsRequestPrivate(RekognitionRequest::DescribeProjectsAction, this))
{
 ...
 * \reimp
 */
bool DescribeProjectsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeProjectsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeProjectsRequest::response(QNetworkReply * const reply) const
{
    return new DescribeProjectsResponse(*this, reply);
}

/*!
 * \class QtAws::Rekognition::DescribeProjectsRequestPrivate
 * \brief The DescribeProjectsRequestPrivate class provides private implementation for DescribeProjectsRequest.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a DescribeProjectsRequestPrivate object for Rekognition \a action,
 * with public implementation \a q.
 */
DescribeProjectsRequestPrivate::DescribeProjectsRequestPrivate(
    const RekognitionRequest::Action action, DescribeProjectsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeProjectsRequest
 * class' copy constructor.
 */
DescribeProjectsRequestPrivate::DescribeProjectsRequestPrivate(
    const DescribeProjectsRequestPrivate &other, DescribeProjectsRequest * const q)
