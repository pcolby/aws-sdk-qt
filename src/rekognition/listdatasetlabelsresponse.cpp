...
#include "listdatasetlabelsresponse_p.h"
...
/*!
 * \class QtAws::Rekognition::ListDatasetLabelsResponse
 * \brief The ListDatasetLabelsResponse class provides an interace for Rekognition ListDatasetLabels responses.
 *
 ...
 *
 * \sa RekognitionClient::listDatasetLabels
 */

/*!
 * Constructs a ListDatasetLabelsResponse object for \a reply to \a request, with parent \a parent.
 */
ListDatasetLabelsResponse::ListDatasetLabelsResponse(
        const ListDatasetLabelsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RekognitionResponse(new ListDatasetLabelsResponsePrivate(this), parent)
{
    setRequest(new ListDatasetLabelsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListDatasetLabelsRequest * ListDatasetLabelsResponse::request() const
{
    Q_D(const ListDatasetLabelsResponse);
    return static_cast<const ListDatasetLabelsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Rekognition ListDatasetLabels \a response.
 */
void ListDatasetLabelsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListDatasetLabelsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rekognition::ListDatasetLabelsResponsePrivate
 * \brief The ListDatasetLabelsResponsePrivate class provides private implementation for ListDatasetLabelsResponse.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a ListDatasetLabelsResponsePrivate object with public implementation \a q.
 */
ListDatasetLabelsResponsePrivate::ListDatasetLabelsResponsePrivate(
    ListDatasetLabelsResponse * const q) : RekognitionResponsePrivate(q)
{

}

/*!
 * Parses a Rekognition ListDatasetLabels response element from \a xml.
 */
void ListDatasetLabelsResponsePrivate::parseListDatasetLabelsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListDatasetLabelsResponse"));
    Q_UNUSED(xml) ///< @todo
}
