...
class QTAWS_EXPORT StartProjectVersionResponsePrivate : public RekognitionResponsePrivate {

public:

    StartProjectVersionResponsePrivate(StartProjectVersionResponse * const q);
