...
#include "deleteprojectpolicyrequest_p.h"
...
/*!
 * \class QtAws::Rekognition::DeleteProjectPolicyRequest
 * \brief The DeleteProjectPolicyRequest class provides an interface for Rekognition DeleteProjectPolicy requests.
 *
 ...
 */
DeleteProjectPolicyRequest::DeleteProjectPolicyRequest(const DeleteProjectPolicyRequest &other)
    : RekognitionRequest(new DeleteProjectPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteProjectPolicyRequest object.
 */
DeleteProjectPolicyRequest::DeleteProjectPolicyRequest()
    : RekognitionRequest(new DeleteProjectPolicyRequestPrivate(RekognitionRequest::DeleteProjectPolicyAction, this))
{
 ...
 * \reimp
 */
bool DeleteProjectPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteProjectPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteProjectPolicyRequest::response(QNetworkReply * const reply) const
{
    return new DeleteProjectPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::Rekognition::DeleteProjectPolicyRequestPrivate
 * \brief The DeleteProjectPolicyRequestPrivate class provides private implementation for DeleteProjectPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a DeleteProjectPolicyRequestPrivate object for Rekognition \a action,
 * with public implementation \a q.
 */
DeleteProjectPolicyRequestPrivate::DeleteProjectPolicyRequestPrivate(
    const RekognitionRequest::Action action, DeleteProjectPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteProjectPolicyRequest
 * class' copy constructor.
 */
DeleteProjectPolicyRequestPrivate::DeleteProjectPolicyRequestPrivate(
    const DeleteProjectPolicyRequestPrivate &other, DeleteProjectPolicyRequest * const q)
