...
/*!
 * \class QtAws::Rekognition::CreateDatasetRequest
 * \brief The CreateDatasetRequest class provides an interface for Rekognition CreateDataset requests.
 *
 ...
 *
 * \sa RekognitionClient::createDataset
 */
...
CreateDatasetRequest::CreateDatasetRequest(const CreateDatasetRequest &other)
    : RekognitionRequest(new CreateDatasetRequestPrivate(*other.d_func(), this))
{
...
CreateDatasetRequest::CreateDatasetRequest()
    : RekognitionRequest(new CreateDatasetRequestPrivate(RekognitionRequest::CreateDatasetAction, this))
{
...
/*!
 * \class QtAws::Rekognition::CreateDatasetRequestPrivate
...
/*!
 * Constructs a CreateDatasetRequestPrivate object for Rekognition \a action,
 * with public implementation \a q.
 */
CreateDatasetRequestPrivate::CreateDatasetRequestPrivate(
    const RekognitionRequest::Action action, CreateDatasetRequest * const q)
