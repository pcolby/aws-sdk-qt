...
#include "listprojectpoliciesrequest_p.h"
...
/*!
 * \class QtAws::Rekognition::ListProjectPoliciesRequest
 * \brief The ListProjectPoliciesRequest class provides an interface for Rekognition ListProjectPolicies requests.
 *
 ...
 */
ListProjectPoliciesRequest::ListProjectPoliciesRequest(const ListProjectPoliciesRequest &other)
    : RekognitionRequest(new ListProjectPoliciesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListProjectPoliciesRequest object.
 */
ListProjectPoliciesRequest::ListProjectPoliciesRequest()
    : RekognitionRequest(new ListProjectPoliciesRequestPrivate(RekognitionRequest::ListProjectPoliciesAction, this))
{
 ...
 * \reimp
 */
bool ListProjectPoliciesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListProjectPoliciesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListProjectPoliciesRequest::response(QNetworkReply * const reply) const
{
    return new ListProjectPoliciesResponse(*this, reply);
}

/*!
 * \class QtAws::Rekognition::ListProjectPoliciesRequestPrivate
 * \brief The ListProjectPoliciesRequestPrivate class provides private implementation for ListProjectPoliciesRequest.
 * \internal
 *
 * \inmodule QtAwsRekognition
 */
...
/*!
 * Constructs a ListProjectPoliciesRequestPrivate object for Rekognition \a action,
 * with public implementation \a q.
 */
ListProjectPoliciesRequestPrivate::ListProjectPoliciesRequestPrivate(
    const RekognitionRequest::Action action, ListProjectPoliciesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListProjectPoliciesRequest
 * class' copy constructor.
 */
ListProjectPoliciesRequestPrivate::ListProjectPoliciesRequestPrivate(
    const ListProjectPoliciesRequestPrivate &other, ListProjectPoliciesRequest * const q)
