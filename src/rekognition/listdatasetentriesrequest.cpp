...
/*!
 * \class QtAws::Rekognition::ListDatasetEntriesRequest
 * \brief The ListDatasetEntriesRequest class provides an interface for Rekognition ListDatasetEntries requests.
 *
 ...
 *
 * \sa RekognitionClient::listDatasetEntries
 */
...
ListDatasetEntriesRequest::ListDatasetEntriesRequest(const ListDatasetEntriesRequest &other)
    : RekognitionRequest(new ListDatasetEntriesRequestPrivate(*other.d_func(), this))
{
...
ListDatasetEntriesRequest::ListDatasetEntriesRequest()
    : RekognitionRequest(new ListDatasetEntriesRequestPrivate(RekognitionRequest::ListDatasetEntriesAction, this))
{
...
/*!
 * \class QtAws::Rekognition::ListDatasetEntriesRequestPrivate
...
/*!
 * Constructs a ListDatasetEntriesRequestPrivate object for Rekognition \a action,
 * with public implementation \a q.
 */
ListDatasetEntriesRequestPrivate::ListDatasetEntriesRequestPrivate(
    const RekognitionRequest::Action action, ListDatasetEntriesRequest * const q)
