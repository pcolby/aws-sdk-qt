...
class QTAWS_EXPORT GetCelebrityRecognitionResponsePrivate : public RekognitionResponsePrivate {

public:

    GetCelebrityRecognitionResponsePrivate(GetCelebrityRecognitionResponse * const q);
