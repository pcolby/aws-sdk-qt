...
{
    return static_cast<const UntagResourceRequest *>(CloudDirectoryResponse::request());
}

/*!
 * \reimp
 * Parses a successful CloudDirectory UntagResource \a response.
 */
...
/*!
 * \class QtAws::CloudDirectory::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : CloudDirectoryResponsePrivate(q)
{

}

/*!
 * Parses a CloudDirectory UntagResource response element from \a xml.
 */
