...
QString CloudDirectoryRequestPrivate::toString(const CloudDirectoryRequest::Action &action)
{
    ...
    switch (action) {
        ActionToString(AddFacetToObject);
        ActionToString(ApplySchema);
        ActionToString(AttachObject);
        ActionToString(AttachPolicy);
        ActionToString(AttachToIndex);
        ActionToString(AttachTypedLink);
        ActionToString(BatchRead);
        ActionToString(BatchWrite);
        ActionToString(CreateDirectory);
        ActionToString(CreateFacet);
        ActionToString(CreateIndex);
        ActionToString(CreateObject);
        ActionToString(CreateSchema);
        ActionToString(CreateTypedLinkFacet);
        ActionToString(DeleteDirectory);
        ActionToString(DeleteFacet);
        ActionToString(DeleteObject);
        ActionToString(DeleteSchema);
        ActionToString(DeleteTypedLinkFacet);
        ActionToString(DetachFromIndex);
        ActionToString(DetachObject);
        ActionToString(DetachPolicy);
        ActionToString(DetachTypedLink);
        ActionToString(DisableDirectory);
        ActionToString(EnableDirectory);
        ActionToString(GetAppliedSchemaVersion);
        ActionToString(GetDirectory);
        ActionToString(GetFacet);
        ActionToString(GetLinkAttributes);
        ActionToString(GetObjectAttributes);
        ActionToString(GetObjectInformation);
        ActionToString(GetSchemaAsJson);
        ActionToString(GetTypedLinkFacetInformation);
        ActionToString(ListAppliedSchemaArns);
        ActionToString(ListAttachedIndices);
        ActionToString(ListDevelopmentSchemaArns);
        ActionToString(ListDirectories);
        ActionToString(ListFacetAttributes);
        ActionToString(ListFacetNames);
        ActionToString(ListIncomingTypedLinks);
        ActionToString(ListIndex);
        ActionToString(ListManagedSchemaArns);
        ActionToString(ListObjectAttributes);
        ActionToString(ListObjectChildren);
        ActionToString(ListObjectParentPaths);
        ActionToString(ListObjectParents);
        ActionToString(ListObjectPolicies);
        ActionToString(ListOutgoingTypedLinks);
        ActionToString(ListPolicyAttachments);
        ActionToString(ListPublishedSchemaArns);
        ActionToString(ListTagsForResource);
        ActionToString(ListTypedLinkFacetAttributes);
        ActionToString(ListTypedLinkFacetNames);
        ActionToString(LookupPolicy);
        ActionToString(PublishSchema);
        ActionToString(PutSchemaFromJson);
        ActionToString(RemoveFacetFromObject);
        ActionToString(TagResource);
        ActionToString(UntagResource);
        ActionToString(UpdateFacet);
        ActionToString(UpdateLinkAttributes);
        ActionToString(UpdateObjectAttributes);
        ActionToString(UpdateSchema);
        ActionToString(UpdateTypedLinkFacet);
        ActionToString(UpgradeAppliedSchema);
        ActionToString(UpgradePublishedSchema);
        default:
