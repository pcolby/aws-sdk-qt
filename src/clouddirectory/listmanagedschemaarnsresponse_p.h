...
class QTAWS_EXPORT ListManagedSchemaArnsResponsePrivate : public CloudDirectoryResponsePrivate {

public:

    ListManagedSchemaArnsResponsePrivate(ListManagedSchemaArnsResponse * const q);
