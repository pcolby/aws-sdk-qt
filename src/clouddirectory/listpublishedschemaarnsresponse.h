...
class QTAWSCLOUDDIRECTORY_EXPORT ListPublishedSchemaArnsResponse : public CloudDirectoryResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListPublishedSchemaArnsRequest * request() const Q_DECL_OVERRIDE;
