...
class QTAWS_EXPORT ListPublishedSchemaArnsRequestPrivate : public CloudDirectoryPrivate {

public:
    ListPublishedSchemaArnsRequestPrivate(const CloudDirectory::Action action,
