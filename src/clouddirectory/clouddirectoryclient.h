...
public slots:
    ...
    GetLinkAttributesResponse * getLinkAttributes(const GetLinkAttributesRequest &request);
    ...
    UpdateLinkAttributesResponse * updateLinkAttributes(const UpdateLinkAttributesRequest &request);
