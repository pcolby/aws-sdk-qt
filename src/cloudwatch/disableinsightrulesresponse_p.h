...
class QTAWS_EXPORT DisableInsightRulesResponsePrivate : public CloudWatchResponsePrivate {

public:

    DisableInsightRulesResponsePrivate(DisableInsightRulesResponse * const q);
