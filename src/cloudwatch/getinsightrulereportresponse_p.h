...
class QTAWS_EXPORT GetInsightRuleReportResponsePrivate : public CloudWatchResponsePrivate {

public:

    GetInsightRuleReportResponsePrivate(GetInsightRuleReportResponse * const q);
