...
class QTAWS_EXPORT EnableInsightRulesResponsePrivate : public CloudWatchResponsePrivate {

public:

    EnableInsightRulesResponsePrivate(EnableInsightRulesResponse * const q);
