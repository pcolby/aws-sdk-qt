...
class QTAWS_EXPORT ListMetricStreamsResponsePrivate : public CloudWatchResponsePrivate {

public:

    ListMetricStreamsResponsePrivate(ListMetricStreamsResponse * const q);
