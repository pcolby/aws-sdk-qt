...
class QTAWS_EXPORT StartMetricStreamsResponsePrivate : public CloudWatchResponsePrivate {

public:

    StartMetricStreamsResponsePrivate(StartMetricStreamsResponse * const q);
