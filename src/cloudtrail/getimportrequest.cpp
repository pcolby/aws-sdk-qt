...
/*!
 * \class QtAws::CloudTrail::GetImportRequest
 * \brief The GetImportRequest class provides an interface for CloudTrail GetImport requests.
 *
...
GetImportRequest::GetImportRequest(const GetImportRequest &other)
    : CloudTrailRequest(new GetImportRequestPrivate(*other.d_func(), this))
{
...
GetImportRequest::GetImportRequest()
    : CloudTrailRequest(new GetImportRequestPrivate(CloudTrailRequest::GetImportAction, this))
{
...
/*!
 * \class QtAws::CloudTrail::GetImportRequestPrivate
...
/*!
 * Constructs a GetImportRequestPrivate object for CloudTrail \a action,
 * with public implementation \a q.
 */
GetImportRequestPrivate::GetImportRequestPrivate(
    const CloudTrailRequest::Action action, GetImportRequest * const q)
