...
/*!
 * \class QtAws::CloudTrail::CancelQueryRequest
 * \brief The CancelQueryRequest class provides an interface for CloudTrail CancelQuery requests.
 *
...
CancelQueryRequest::CancelQueryRequest(const CancelQueryRequest &other)
    : CloudTrailRequest(new CancelQueryRequestPrivate(*other.d_func(), this))
{
...
CancelQueryRequest::CancelQueryRequest()
    : CloudTrailRequest(new CancelQueryRequestPrivate(CloudTrailRequest::CancelQueryAction, this))
{
...
/*!
 * \class QtAws::CloudTrail::CancelQueryRequestPrivate
...
/*!
 * Constructs a CancelQueryRequestPrivate object for CloudTrail \a action,
 * with public implementation \a q.
 */
CancelQueryRequestPrivate::CancelQueryRequestPrivate(
    const CloudTrailRequest::Action action, CancelQueryRequest * const q)
