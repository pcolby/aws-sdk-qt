...
class QTAWS_EXPORT PutInsightSelectorsResponsePrivate : public CloudTrailResponsePrivate {

public:

    PutInsightSelectorsResponsePrivate(PutInsightSelectorsResponse * const q);
