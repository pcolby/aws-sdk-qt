...
class QTAWS_EXPORT CreateLogPatternResponsePrivate : public ApplicationInsightsResponsePrivate {

public:

    CreateLogPatternResponsePrivate(CreateLogPatternResponse * const q);
