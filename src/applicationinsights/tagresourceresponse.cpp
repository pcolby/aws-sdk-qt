...
/*!
 * \class QtAws::ApplicationInsights::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for ApplicationInsights TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ApplicationInsightsResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ApplicationInsights TagResource \a response.
 */
...
/*!
 * \class QtAws::ApplicationInsights::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ApplicationInsightsResponsePrivate(q)
{

}

/*!
 * Parses a ApplicationInsights TagResource response element from \a xml.
 */
