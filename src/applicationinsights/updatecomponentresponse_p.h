...
class QTAWS_EXPORT UpdateComponentResponsePrivate : public ApplicationInsightsResponsePrivate {

public:

    UpdateComponentResponsePrivate(UpdateComponentResponse * const q);
