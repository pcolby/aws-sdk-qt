...
/*!
 * \class QtAws::ApplicationInsights::DeleteApplicationResponse
 * \brief The DeleteApplicationResponse class provides an interace for ApplicationInsights DeleteApplication responses.
 *
...
DeleteApplicationResponse::DeleteApplicationResponse(
    ...
    : ApplicationInsightsResponse(new DeleteApplicationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ApplicationInsights DeleteApplication \a response.
 */
...
/*!
 * \class QtAws::ApplicationInsights::DeleteApplicationResponsePrivate
...
DeleteApplicationResponsePrivate::DeleteApplicationResponsePrivate(
    DeleteApplicationResponse * const q) : ApplicationInsightsResponsePrivate(q)
{

}

/*!
 * Parses a ApplicationInsights DeleteApplication response element from \a xml.
 */
