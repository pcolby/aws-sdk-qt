...
class QTAWS_EXPORT DescribeObservationResponsePrivate : public ApplicationInsightsResponsePrivate {

public:

    DescribeObservationResponsePrivate(DescribeObservationResponse * const q);
