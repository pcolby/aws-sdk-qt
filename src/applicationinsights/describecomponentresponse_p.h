...
class QTAWS_EXPORT DescribeComponentResponsePrivate : public ApplicationInsightsResponsePrivate {

public:

    DescribeComponentResponsePrivate(DescribeComponentResponse * const q);
