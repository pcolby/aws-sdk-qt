...
/*!
 * \class QtAws::XRay::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for XRay ListTagsForResource responses.
 *
 * \inmodule QtAwsXRay
 *
 *  AWS X-Ray provides APIs for managing debug traces and retrieving service maps and other data created by processing those
 *
 * \sa XRayClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : XRayResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(XRayResponse::request());
}

/*!
 * \reimp
 * Parses a successful XRay ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::XRay::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : XRayResponsePrivate(q)
{

}

/*!
 * Parses a XRay ListTagsForResource response element from \a xml.
 */
