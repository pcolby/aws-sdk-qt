...
/**
 * @brief  Constructs a new XRayClientRequest object.
 *
...
/**
 * @brief  Constructs a new XRayClientRequest object by copying another.
 *
 ...
 */
XRayClientRequest& XRayClientRequest::operator=(const XRayClientRequest &other)
{
    Q_D(XRayClientRequest);
 ...
 * implementation that inherits from XRayClientRequestPrivate.
 *
 ...
 */
XRayClientRequest::Action XRayClientRequest::action() const
{
    Q_D(const XRayClientRequest);
    return d->action;
}
 ...
 */
QString XRayClientRequest::actionString() const
{
    return XRayClientRequestPrivate::toString(action());
}
 ...
 */
QString XRayClientRequest::apiVersion() const
{
    Q_D(const XRayClientRequest);
    return d->apiVersion;
}
 ...
 */
void XRayClientRequest::setAction(const Action action)
{
    Q_D(XRayClientRequest);
    d->action = action;
}
 ...
 */
void XRayClientRequest::setApiVersion(const QString &version)
{
    Q_D(XRayClientRequest);
 ...
 */
bool XRayClientRequest::operator==(const XRayClientRequest &other) const
{
 ...
 */
bool XRayClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int XRayClientRequest::clearParameter(const QString &name)
{
    Q_D(XRayClientRequest);
 ...
 */
void XRayClientRequest::clearParameters()
{
    Q_D(XRayClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant XRayClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const XRayClientRequest);
 ...
 */
const QVariantMap &XRayClientRequest::parameters() const
{
    Q_D(const XRayClientRequest);
    return d->parameters;
}
 ...
 */
void XRayClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(XRayClientRequest);
 ...
 */
void XRayClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(XRayClientRequest);
 ...
 */
QNetworkRequest XRayClientRequest::unsignedRequest(const QUrl &endpoint) const
{
    Q_D(const XRayClientRequest);
    QUrl url(endpoint);
 ...
 *
 * @brief  Private implementation for XRayClientRequest.
 */

/**
 * @internal
 *
 * @brief  Constructs a new XRayClientRequestPrivate object.
 *
 ...
 * @internal
 *
 * @brief  Constructs a new XRayClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the XRayClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public XRayClientRequest instance.
 */
 ...
 *
 * This function converts XRayClientRequest::Action enumerator values to their respective
 ...
 */
QString XRayClientRequestPrivate::toString(const XRayClientRequest::Action &action)
{
    #define ActionToString(action) \
        case XRayClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
