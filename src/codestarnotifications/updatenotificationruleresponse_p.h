...
class QTAWS_EXPORT UpdateNotificationRuleResponsePrivate : public CodeStarNotificationsResponsePrivate {

public:

    UpdateNotificationRuleResponsePrivate(UpdateNotificationRuleResponse * const q);
