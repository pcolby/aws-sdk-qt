...
/*!
 * \class QtAws::CodeStarNotifications::UnsubscribeResponse
 * \brief The UnsubscribeResponse class provides an interace for CodeStarNotifications Unsubscribe responses.
 *
...
UnsubscribeResponse::UnsubscribeResponse(
    ...
    : CodeStarNotificationsResponse(new UnsubscribeResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CodeStarNotifications Unsubscribe \a response.
 */
...
/*!
 * \class QtAws::CodeStarNotifications::UnsubscribeResponsePrivate
...
UnsubscribeResponsePrivate::UnsubscribeResponsePrivate(
    UnsubscribeResponse * const q) : CodeStarNotificationsResponsePrivate(q)
{

}

/*!
 * Parses a CodeStarNotifications Unsubscribe response element from \a xml.
 */
