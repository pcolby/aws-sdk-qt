...
/*!
 * \class QtAws::EFS::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for EFS ListTagsForResource responses.
 *
 * \inmodule QtAwsEFS
 *
 ...
 *
 * \sa EfsClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : EfsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(EfsResponse::request());
}

/*!
 * \reimp
 * Parses a successful EFS ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::EFS::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : EfsResponsePrivate(q)
{

}

/*!
 * Parses a EFS ListTagsForResource response element from \a xml.
 */
