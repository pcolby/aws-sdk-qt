...
#ifndef QTAWS_DESCRIBELIFECYCLECONFIGURATIONREQUEST_H
#define QTAWS_DESCRIBELIFECYCLECONFIGURATIONREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(DescribeLifecycleConfigurationRequest)
