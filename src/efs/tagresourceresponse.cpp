...
/*!
 * \class QtAws::EFS::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for EFS TagResource responses.
 *
 * \inmodule QtAwsEFS
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : EfsResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(EfsResponse::request());
}

/*!
 * \reimp
 * Parses a successful EFS TagResource \a response.
 */
...
/*!
 * \class QtAws::EFS::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : EfsResponsePrivate(q)
{

}

/*!
 * Parses a EFS TagResource response element from \a xml.
 */
