...
/*!
 * \class QtAws::Keyspaces::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Keyspaces UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : KeyspacesResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Keyspaces UntagResource \a response.
 */
...
/*!
 * \class QtAws::Keyspaces::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : KeyspacesResponsePrivate(q)
{

}

/*!
 * Parses a Keyspaces UntagResource response element from \a xml.
 */
