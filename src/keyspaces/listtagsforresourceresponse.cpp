...
/*!
 * \class QtAws::Keyspaces::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Keyspaces ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : KeyspacesResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Keyspaces ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Keyspaces::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : KeyspacesResponsePrivate(q)
{

}

/*!
 * Parses a Keyspaces ListTagsForResource response element from \a xml.
 */
