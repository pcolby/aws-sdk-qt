...
/*!
 * \class QtAws::Keyspaces::UpdateTableRequest
 * \brief The UpdateTableRequest class provides an interface for Keyspaces UpdateTable requests.
 *
...
UpdateTableRequest::UpdateTableRequest(const UpdateTableRequest &other)
    : KeyspacesRequest(new UpdateTableRequestPrivate(*other.d_func(), this))
{
...
UpdateTableRequest::UpdateTableRequest()
    : KeyspacesRequest(new UpdateTableRequestPrivate(KeyspacesRequest::UpdateTableAction, this))
{
...
/*!
 * \class QtAws::Keyspaces::UpdateTableRequestPrivate
...
/*!
 * Constructs a UpdateTableRequestPrivate object for Keyspaces \a action,
 * with public implementation \a q.
 */
UpdateTableRequestPrivate::UpdateTableRequestPrivate(
    const KeyspacesRequest::Action action, UpdateTableRequest * const q)
