...
/*!
 * \class QtAws::ResilienceHub::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for ResilienceHub ListTagsForResource responses.
 *
 ...
 *
 * \sa ResilienceHubClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ResilienceHubResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ResilienceHub ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::ResilienceHub::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ResilienceHubResponsePrivate(q)
{

}

/*!
 * Parses a ResilienceHub ListTagsForResource response element from \a xml.
 */
