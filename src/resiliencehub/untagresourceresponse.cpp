...
/*!
 * \class QtAws::ResilienceHub::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for ResilienceHub UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : ResilienceHubResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ResilienceHub UntagResource \a response.
 */
...
/*!
 * \class QtAws::ResilienceHub::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : ResilienceHubResponsePrivate(q)
{

}

/*!
 * Parses a ResilienceHub UntagResource response element from \a xml.
 */
