...
/*!
 * \class QtAws::ResilienceHub::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for ResilienceHub TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ResilienceHubResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ResilienceHub TagResource \a response.
 */
...
/*!
 * \class QtAws::ResilienceHub::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ResilienceHubResponsePrivate(q)
{

}

/*!
 * Parses a ResilienceHub TagResource response element from \a xml.
 */
