...
class QTAWS_EXPORT ListContactChannelsResponsePrivate : public SSMContactsResponsePrivate {

public:

    ListContactChannelsResponsePrivate(ListContactChannelsResponse * const q);
