...
class QTAWS_EXPORT GetContactChannelResponsePrivate : public SSMContactsResponsePrivate {

public:

    GetContactChannelResponsePrivate(GetContactChannelResponse * const q);
