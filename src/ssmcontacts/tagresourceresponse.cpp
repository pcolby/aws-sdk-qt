...
/*!
 * \class QtAws::SSMContacts::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for SSMContacts TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : SSMContactsResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(SSMContactsResponse::request());
}

/*!
 * \reimp
 * Parses a successful SSMContacts TagResource \a response.
 */
...
/*!
 * \class QtAws::SSMContacts::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : SSMContactsResponsePrivate(q)
{

}

/*!
 * Parses a SSMContacts TagResource response element from \a xml.
 */
