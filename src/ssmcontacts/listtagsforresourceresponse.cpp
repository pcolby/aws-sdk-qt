...
/*!
 * \class QtAws::SSMContacts::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for SSMContacts ListTagsForResource responses.
 *
 * \inmodule QtAwsSSMContacts
 *
 *
 * \sa SSMContactsClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : SSMContactsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(SSMContactsResponse::request());
}

/*!
 * \reimp
 * Parses a successful SSMContacts ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::SSMContacts::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : SSMContactsResponsePrivate(q)
{

}

/*!
 * Parses a SSMContacts ListTagsForResource response element from \a xml.
 */
