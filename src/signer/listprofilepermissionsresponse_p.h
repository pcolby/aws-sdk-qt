...
class QTAWS_EXPORT ListProfilePermissionsResponsePrivate : public signerResponsePrivate {

public:

    ListProfilePermissionsResponsePrivate(ListProfilePermissionsResponse * const q);
