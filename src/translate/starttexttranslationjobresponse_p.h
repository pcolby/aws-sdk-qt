...
class QTAWS_EXPORT StartTextTranslationJobResponsePrivate : public TranslateResponsePrivate {

public:

    StartTextTranslationJobResponsePrivate(StartTextTranslationJobResponse * const q);
