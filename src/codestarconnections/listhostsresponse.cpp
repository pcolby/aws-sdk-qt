...
/*!
 * \class QtAws::CodeStarconnections::ListHostsResponse
 * \brief The ListHostsResponse class provides an interace for CodeStarconnections ListHosts responses.
 *
...
/*!
 * Constructs a ListHostsResponse object for \a reply to \a request, with parent \a parent.
 */
ListHostsResponse::ListHostsResponse(
        const ListHostsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeStarconnectionsResponse(new ListHostsResponsePrivate(this), parent)
{
    setRequest(new ListHostsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeStarconnections ListHosts \a response.
 */
void ListHostsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListHostsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeStarconnections::ListHostsResponsePrivate
 * \brief The ListHostsResponsePrivate class provides private implementation for ListHostsResponse.
 * \internal
 *
 * \inmodule QtAwsCodeStarconnections
 */
...
/*!
 * Constructs a ListHostsResponsePrivate object with public implementation \a q.
 */
ListHostsResponsePrivate::ListHostsResponsePrivate(
    ListHostsResponse * const q) : CodeStarconnectionsResponsePrivate(q)
{

}

/*!
 * Parses a CodeStarconnections ListHosts response element from \a xml.
 */
void ListHostsResponsePrivate::parseListHostsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListHostsResponse"));
    Q_UNUSED(xml) ///< @todo
}
