...
/*!
 * \class QtAws::CodeStarconnections::CreateConnectionRequest
 * \brief The CreateConnectionRequest class provides an interface for CodeStarconnections CreateConnection requests.
 *
 ...
 *
 * \sa CodeStarconnectionsClient::createConnection
 */
...
CreateConnectionRequest::CreateConnectionRequest(const CreateConnectionRequest &other)
    : CodeStarconnectionsRequest(new CreateConnectionRequestPrivate(*other.d_func(), this))
{
...
CreateConnectionRequest::CreateConnectionRequest()
    : CodeStarconnectionsRequest(new CreateConnectionRequestPrivate(CodeStarconnectionsRequest::CreateConnectionAction, this))
{
...
/*!
 * \class QtAws::CodeStarconnections::CreateConnectionRequestPrivate
...
/*!
 * Constructs a CreateConnectionRequestPrivate object for CodeStarconnections \a action,
 * with public implementation \a q.
 */
CreateConnectionRequestPrivate::CreateConnectionRequestPrivate(
    const CodeStarconnectionsRequest::Action action, CreateConnectionRequest * const q)
