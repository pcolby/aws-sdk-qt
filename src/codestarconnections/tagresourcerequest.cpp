...
/*!
 * \class QtAws::CodeStarconnections::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for CodeStarconnections TagResource requests.
 *
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : CodeStarconnectionsRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : CodeStarconnectionsRequest(new TagResourceRequestPrivate(CodeStarconnectionsRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::CodeStarconnections::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for CodeStarconnections \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const CodeStarconnectionsRequest::Action action, TagResourceRequest * const q)
