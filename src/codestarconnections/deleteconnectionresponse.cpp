...
/*!
 * \class QtAws::CodeStarconnections::DeleteConnectionResponse
 * \brief The DeleteConnectionResponse class provides an interace for CodeStarconnections DeleteConnection responses.
 *
...
DeleteConnectionResponse::DeleteConnectionResponse(
    ...
    : CodeStarconnectionsResponse(new DeleteConnectionResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteConnectionRequest *>(CodeStarconnectionsResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeStarconnections DeleteConnection \a response.
 */
...
/*!
 * \class QtAws::CodeStarconnections::DeleteConnectionResponsePrivate
...
DeleteConnectionResponsePrivate::DeleteConnectionResponsePrivate(
    DeleteConnectionResponse * const q) : CodeStarconnectionsResponsePrivate(q)
{

}

/*!
 * Parses a CodeStarconnections DeleteConnection response element from \a xml.
 */
