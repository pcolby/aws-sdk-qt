...
/*!
 * \class QtAws::CodeStarconnections::GetConnectionRequest
 * \brief The GetConnectionRequest class provides an interface for CodeStarconnections GetConnection requests.
 *
...
GetConnectionRequest::GetConnectionRequest(const GetConnectionRequest &other)
    : CodeStarconnectionsRequest(new GetConnectionRequestPrivate(*other.d_func(), this))
{
...
GetConnectionRequest::GetConnectionRequest()
    : CodeStarconnectionsRequest(new GetConnectionRequestPrivate(CodeStarconnectionsRequest::GetConnectionAction, this))
{
...
/*!
 * \class QtAws::CodeStarconnections::GetConnectionRequestPrivate
...
/*!
 * Constructs a GetConnectionRequestPrivate object for CodeStarconnections \a action,
 * with public implementation \a q.
 */
GetConnectionRequestPrivate::GetConnectionRequestPrivate(
    const CodeStarconnectionsRequest::Action action, GetConnectionRequest * const q)
