...
/*!
 * \class QtAws::CodeStarconnections::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for CodeStarconnections UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : CodeStarconnectionsRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : CodeStarconnectionsRequest(new UntagResourceRequestPrivate(CodeStarconnectionsRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::CodeStarconnections::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for CodeStarconnections \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const CodeStarconnectionsRequest::Action action, UntagResourceRequest * const q)
