...
class QTAWS_EXPORT CodeStarconnectionsResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {

public:

    CodeStarconnectionsResponsePrivate(CodeStarconnectionsResponse * const q);
