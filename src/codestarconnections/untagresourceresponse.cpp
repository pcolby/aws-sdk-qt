...
/*!
 * \class QtAws::CodeStarconnections::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for CodeStarconnections UntagResource responses.
 *
 ...
 *
 * \sa CodeStarconnectionsClient::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : CodeStarconnectionsResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(CodeStarconnectionsResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeStarconnections UntagResource \a response.
 */
...
/*!
 * \class QtAws::CodeStarconnections::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : CodeStarconnectionsResponsePrivate(q)
{

}

/*!
 * Parses a CodeStarconnections UntagResource response element from \a xml.
 */
