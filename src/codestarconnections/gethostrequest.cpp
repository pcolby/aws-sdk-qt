...
/*!
 * \class QtAws::CodeStarconnections::GetHostRequest
 * \brief The GetHostRequest class provides an interface for CodeStarconnections GetHost requests.
 *
 ...
 */
GetHostRequest::GetHostRequest(const GetHostRequest &other)
    : CodeStarconnectionsRequest(new GetHostRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetHostRequest object.
 */
GetHostRequest::GetHostRequest()
    : CodeStarconnectionsRequest(new GetHostRequestPrivate(CodeStarconnectionsRequest::GetHostAction, this))
{
 ...
 * \reimp
 */
bool GetHostRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetHostResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetHostRequest::response(QNetworkReply * const reply) const
{
    return new GetHostResponse(*this, reply);
}

/*!
 * \class QtAws::CodeStarconnections::GetHostRequestPrivate
 * \brief The GetHostRequestPrivate class provides private implementation for GetHostRequest.
 * \internal
 *
 * \inmodule QtAwsCodeStarconnections
 */
...
/*!
 * Constructs a GetHostRequestPrivate object for CodeStarconnections \a action,
 * with public implementation \a q.
 */
GetHostRequestPrivate::GetHostRequestPrivate(
    const CodeStarconnectionsRequest::Action action, GetHostRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetHostRequest
 * class' copy constructor.
 */
GetHostRequestPrivate::GetHostRequestPrivate(
    const GetHostRequestPrivate &other, GetHostRequest * const q)
