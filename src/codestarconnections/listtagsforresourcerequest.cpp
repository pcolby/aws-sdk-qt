...
/*!
 * \class QtAws::CodeStarconnections::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for CodeStarconnections ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : CodeStarconnectionsRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : CodeStarconnectionsRequest(new ListTagsForResourceRequestPrivate(CodeStarconnectionsRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::CodeStarconnections::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for CodeStarconnections \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const CodeStarconnectionsRequest::Action action, ListTagsForResourceRequest * const q)
