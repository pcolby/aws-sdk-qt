...
/*!
 * \class QtAws::CodeStarconnections::DeleteHostRequest
 * \brief The DeleteHostRequest class provides an interface for CodeStarconnections DeleteHost requests.
 *
 ...
 */
DeleteHostRequest::DeleteHostRequest(const DeleteHostRequest &other)
    : CodeStarconnectionsRequest(new DeleteHostRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteHostRequest object.
 */
DeleteHostRequest::DeleteHostRequest()
    : CodeStarconnectionsRequest(new DeleteHostRequestPrivate(CodeStarconnectionsRequest::DeleteHostAction, this))
{
 ...
 * \reimp
 */
bool DeleteHostRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteHostResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteHostRequest::response(QNetworkReply * const reply) const
{
    return new DeleteHostResponse(*this, reply);
}

/*!
 * \class QtAws::CodeStarconnections::DeleteHostRequestPrivate
 * \brief The DeleteHostRequestPrivate class provides private implementation for DeleteHostRequest.
 * \internal
 *
 * \inmodule QtAwsCodeStarconnections
 */
...
/*!
 * Constructs a DeleteHostRequestPrivate object for CodeStarconnections \a action,
 * with public implementation \a q.
 */
DeleteHostRequestPrivate::DeleteHostRequestPrivate(
    const CodeStarconnectionsRequest::Action action, DeleteHostRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteHostRequest
 * class' copy constructor.
 */
DeleteHostRequestPrivate::DeleteHostRequestPrivate(
    const DeleteHostRequestPrivate &other, DeleteHostRequest * const q)
