...
/*!
 * \class QtAws::CodeStarconnections::ListHostsRequest
 * \brief The ListHostsRequest class provides an interface for CodeStarconnections ListHosts requests.
 *
 ...
 *
 * \sa CodeStarconnectionsClient::listHosts
 */

/*!
 * Constructs a copy of \a other.
 */
ListHostsRequest::ListHostsRequest(const ListHostsRequest &other)
    : CodeStarconnectionsRequest(new ListHostsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListHostsRequest object.
 */
ListHostsRequest::ListHostsRequest()
    : CodeStarconnectionsRequest(new ListHostsRequestPrivate(CodeStarconnectionsRequest::ListHostsAction, this))
{
 ...
 * \reimp
 */
bool ListHostsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListHostsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListHostsRequest::response(QNetworkReply * const reply) const
{
    return new ListHostsResponse(*this, reply);
}

/*!
 * \class QtAws::CodeStarconnections::ListHostsRequestPrivate
 * \brief The ListHostsRequestPrivate class provides private implementation for ListHostsRequest.
 * \internal
 *
 * \inmodule QtAwsCodeStarconnections
 */
...
/*!
 * Constructs a ListHostsRequestPrivate object for CodeStarconnections \a action,
 * with public implementation \a q.
 */
ListHostsRequestPrivate::ListHostsRequestPrivate(
    const CodeStarconnectionsRequest::Action action, ListHostsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListHostsRequest
 * class' copy constructor.
 */
ListHostsRequestPrivate::ListHostsRequestPrivate(
    const ListHostsRequestPrivate &other, ListHostsRequest * const q)
