...
/*!
 * \class QtAws::CodeStarconnections::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for CodeStarconnections ListTagsForResource responses.
 *
 ...
 *
 * \sa CodeStarconnectionsClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : CodeStarconnectionsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(CodeStarconnectionsResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeStarconnections ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::CodeStarconnections::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : CodeStarconnectionsResponsePrivate(q)
{

}

/*!
 * Parses a CodeStarconnections ListTagsForResource response element from \a xml.
 */
