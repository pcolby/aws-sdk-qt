...
/*!
 * \class QtAws::CodeStarconnections::CreateConnectionResponse
 * \brief The CreateConnectionResponse class provides an interace for CodeStarconnections CreateConnection responses.
 *
...
CreateConnectionResponse::CreateConnectionResponse(
    ...
    : CodeStarconnectionsResponse(new CreateConnectionResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CodeStarconnections CreateConnection \a response.
 */
...
/*!
 * \class QtAws::CodeStarconnections::CreateConnectionResponsePrivate
...
CreateConnectionResponsePrivate::CreateConnectionResponsePrivate(
    CreateConnectionResponse * const q) : CodeStarconnectionsResponsePrivate(q)
{

}

/*!
 * Parses a CodeStarconnections CreateConnection response element from \a xml.
 */
