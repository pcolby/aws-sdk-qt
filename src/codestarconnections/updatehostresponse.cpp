...
#include "updatehostresponse_p.h"
...
/*!
 * \class QtAws::CodeStarconnections::UpdateHostResponse
 * \brief The UpdateHostResponse class provides an interace for CodeStarconnections UpdateHost responses.
 *
...
/*!
 * Constructs a UpdateHostResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateHostResponse::UpdateHostResponse(
        const UpdateHostRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeStarconnectionsResponse(new UpdateHostResponsePrivate(this), parent)
{
    setRequest(new UpdateHostRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeStarconnections UpdateHost \a response.
 */
void UpdateHostResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateHostResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeStarconnections::UpdateHostResponsePrivate
 * \brief The UpdateHostResponsePrivate class provides private implementation for UpdateHostResponse.
 * \internal
 *
 * \inmodule QtAwsCodeStarconnections
 */
...
/*!
 * Constructs a UpdateHostResponsePrivate object with public implementation \a q.
 */
UpdateHostResponsePrivate::UpdateHostResponsePrivate(
    UpdateHostResponse * const q) : CodeStarconnectionsResponsePrivate(q)
{

}

/*!
 * Parses a CodeStarconnections UpdateHost response element from \a xml.
 */
void UpdateHostResponsePrivate::parseUpdateHostResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateHostResponse"));
    Q_UNUSED(xml) ///< @todo
}
