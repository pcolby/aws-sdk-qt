...
#include "createhostresponse_p.h"
...
/*!
 * \class QtAws::CodeStarconnections::CreateHostResponse
 * \brief The CreateHostResponse class provides an interace for CodeStarconnections CreateHost responses.
 *
...
/*!
 * Constructs a CreateHostResponse object for \a reply to \a request, with parent \a parent.
 */
CreateHostResponse::CreateHostResponse(
        const CreateHostRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeStarconnectionsResponse(new CreateHostResponsePrivate(this), parent)
{
    setRequest(new CreateHostRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeStarconnections CreateHost \a response.
 */
void CreateHostResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateHostResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeStarconnections::CreateHostResponsePrivate
 * \brief The CreateHostResponsePrivate class provides private implementation for CreateHostResponse.
 * \internal
 *
 * \inmodule QtAwsCodeStarconnections
 */
...
/*!
 * Constructs a CreateHostResponsePrivate object with public implementation \a q.
 */
CreateHostResponsePrivate::CreateHostResponsePrivate(
    CreateHostResponse * const q) : CodeStarconnectionsResponsePrivate(q)
{

}

/*!
 * Parses a CodeStarconnections CreateHost response element from \a xml.
 */
void CreateHostResponsePrivate::parseCreateHostResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateHostResponse"));
    Q_UNUSED(xml) ///< @todo
}
