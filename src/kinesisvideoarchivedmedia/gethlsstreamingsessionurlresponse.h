...
class QTAWS_EXPORT GetHLSStreamingSessionURLResponse : public KinesisVideoArchivedMediaResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetHLSStreamingSessionURLRequest * request() const override;
