...
class QTAWS_EXPORT DescribeVirtualNodeResponsePrivate : public AppMeshResponsePrivate {

public:

    DescribeVirtualNodeResponsePrivate(DescribeVirtualNodeResponse * const q);
