...
class QTAWS_EXPORT ListVirtualServicesResponsePrivate : public AppMeshResponsePrivate {

public:

    ListVirtualServicesResponsePrivate(ListVirtualServicesResponse * const q);
