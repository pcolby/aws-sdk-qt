...
class QTAWS_EXPORT CreateGatewayRouteResponsePrivate : public AppMeshResponsePrivate {

public:

    CreateGatewayRouteResponsePrivate(CreateGatewayRouteResponse * const q);
