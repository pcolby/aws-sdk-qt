...
class QTAWS_EXPORT ListVirtualRoutersResponsePrivate : public AppMeshResponsePrivate {

public:

    ListVirtualRoutersResponsePrivate(ListVirtualRoutersResponse * const q);
