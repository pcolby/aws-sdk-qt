...
/*!
 * \class QtAws::AppMesh::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for AppMesh ListTagsForResource responses.
 *
 ...
 *  Kubernetes
 *
 * \sa AppMeshClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : AppMeshResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(AppMeshResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppMesh ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::AppMesh::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : AppMeshResponsePrivate(q)
{

}

/*!
 * Parses a AppMesh ListTagsForResource response element from \a xml.
 */
