...
/*!
 * \class QtAws::AppMesh::DeleteRouteResponse
 * \brief The DeleteRouteResponse class provides an interace for AppMesh DeleteRoute responses.
 *
...
DeleteRouteResponse::DeleteRouteResponse(
    ...
    : AppMeshResponse(new DeleteRouteResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful AppMesh DeleteRoute \a response.
 */
...
/*!
 * \class QtAws::AppMesh::DeleteRouteResponsePrivate
...
DeleteRouteResponsePrivate::DeleteRouteResponsePrivate(
    DeleteRouteResponse * const q) : AppMeshResponsePrivate(q)
{

}

/*!
 * Parses a AppMesh DeleteRoute response element from \a xml.
 */
