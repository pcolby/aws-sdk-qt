...
class QTAWS_EXPORT DescribeVirtualServiceResponsePrivate : public AppMeshResponsePrivate {

public:

    DescribeVirtualServiceResponsePrivate(DescribeVirtualServiceResponse * const q);
