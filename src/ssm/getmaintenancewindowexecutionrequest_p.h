...
class QTAWS_EXPORT GetMaintenanceWindowExecutionRequestPrivate : public SSMRequestPrivate {

public:
    GetMaintenanceWindowExecutionRequestPrivate(const SSM::Action action,
