...
#include "updateresourcedatasyncresponse_p.h"
...
/*!
 * \class QtAws::SSM::UpdateResourceDataSyncResponse
 * \brief The UpdateResourceDataSyncResponse class provides an interace for SSM UpdateResourceDataSync responses.
 *
 * \inmodule QtAwsSSM
 *
...
/*!
 * Constructs a UpdateResourceDataSyncResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateResourceDataSyncResponse::UpdateResourceDataSyncResponse(
        const UpdateResourceDataSyncRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : SsmResponse(new UpdateResourceDataSyncResponsePrivate(this), parent)
{
    setRequest(new UpdateResourceDataSyncRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful SSM UpdateResourceDataSync \a response.
 */
void UpdateResourceDataSyncResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateResourceDataSyncResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::SSM::UpdateResourceDataSyncResponsePrivate
 * \brief The UpdateResourceDataSyncResponsePrivate class provides private implementation for UpdateResourceDataSyncResponse.
 * \internal
 *
 * \inmodule QtAwsSSM
 */
...
/*!
 * Constructs a UpdateResourceDataSyncResponsePrivate object with public implementation \a q.
 */
UpdateResourceDataSyncResponsePrivate::UpdateResourceDataSyncResponsePrivate(
    UpdateResourceDataSyncResponse * const q) : SsmResponsePrivate(q)
{

}

/*!
 * Parses a SSM UpdateResourceDataSync response element from \a xml.
 */
void UpdateResourceDataSyncResponsePrivate::parseUpdateResourceDataSyncResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateResourceDataSyncResponse"));
    Q_UNUSED(xml) ///< @todo
}
