...
class QTAWS_EXPORT RegisterDefaultPatchBaselineResponsePrivate : public SSMResponsePrivate {
    Q_OBJECT

public:

    RegisterDefaultPatchBaselineResponsePrivate(RegisterDefaultPatchBaselineResponse * const q);
