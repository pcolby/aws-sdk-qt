...
#include "deleteinventoryrequest_p.h"
...
/*!
 * \class QtAws::SSM::DeleteInventoryRequest
 * \brief The DeleteInventoryRequest class provides an interface for SSM DeleteInventory requests.
 *
 * \inmodule QtAwsSSM
 *
 ...
 * \reimp
 */
bool DeleteInventoryRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteInventoryResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteInventoryRequest::response(QNetworkReply * const reply) const
{
    return new DeleteInventoryResponse(*this, reply);
}

/*!
 * \class QtAws::SSM::DeleteInventoryRequestPrivate
 * \brief The DeleteInventoryRequestPrivate class provides private implementation for DeleteInventoryRequest.
 * \internal
 *
 * \inmodule QtAwsSSM
 */
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteInventoryRequest
