...
class QTAWS_EXPORT ListResourceComplianceSummariesResponse : public SSMResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListResourceComplianceSummariesRequest * request() const override;
