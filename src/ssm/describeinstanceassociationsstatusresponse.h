...
class QTAWS_EXPORT DescribeInstanceAssociationsStatusResponse : public SSMResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeInstanceAssociationsStatusRequest * request() const override;
