...
#ifndef QTAWS_STARTASSOCIATIONSONCERESPONSE_P_H
#define QTAWS_STARTASSOCIATIONSONCERESPONSE_P_H
...
private:
    Q_DECLARE_PUBLIC(StartAssociationsOnceResponse)
    Q_DISABLE_COPY(StartAssociationsOnceResponsePrivate)
