...
class QTAWS_EXPORT RegisterTaskWithMaintenanceWindowResponsePrivate : public SsmResponsePrivate {

public:

    RegisterTaskWithMaintenanceWindowResponsePrivate(RegisterTaskWithMaintenanceWindowResponse * const q);
