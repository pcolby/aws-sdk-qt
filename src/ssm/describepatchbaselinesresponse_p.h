...
class QTAWS_EXPORT DescribePatchBaselinesResponsePrivate : public SsmResponsePrivate {

public:

    DescribePatchBaselinesResponsePrivate(DescribePatchBaselinesResponse * const q);
