 ...
 *
 * \brief The DescribeMaintenanceWindowExecutionTaskInvocationsResponse class encapsulates SSM DescribeMaintenanceWindowExecutionTaskInvocations responses.
 *
 * \ingroup SSM
 *
