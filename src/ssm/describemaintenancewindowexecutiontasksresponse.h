...
class QTAWS_EXPORT DescribeMaintenanceWindowExecutionTasksResponse : public DescribeMaintenanceWindowExecutionTasksResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeMaintenanceWindowExecutionTasksRequest * request() const;
