...
class QTAWS_EXPORT DescribeMaintenanceWindowExecutionTasksResponse : public SsmResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeMaintenanceWindowExecutionTasksRequest * request() const override;
