...
/*!
 * \class QtAws::SSM::GetOpsItemRequest
 * \brief The GetOpsItemRequest class provides an interface for SSM GetOpsItem requests.
 *
 * \inmodule QtAwsSSM
 *
 ...
 *
 * \sa SsmClient::getOpsItem
 */

/*!
 * Constructs a copy of \a other.
 */
GetOpsItemRequest::GetOpsItemRequest(const GetOpsItemRequest &other)
    : SsmRequest(new GetOpsItemRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetOpsItemRequest object.
 */
GetOpsItemRequest::GetOpsItemRequest()
    : SsmRequest(new GetOpsItemRequestPrivate(SsmRequest::GetOpsItemAction, this))
{
 ...
 * \reimp
 */
bool GetOpsItemRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetOpsItemResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetOpsItemRequest::response(QNetworkReply * const reply) const
{
    return new GetOpsItemResponse(*this, reply);
}

/*!
 * \class QtAws::SSM::GetOpsItemRequestPrivate
 * \brief The GetOpsItemRequestPrivate class provides private implementation for GetOpsItemRequest.
 * \internal
 *
 * \inmodule QtAwsSSM
 */
...
/*!
 * Constructs a GetOpsItemRequestPrivate object for Ssm \a action,
 * with public implementation \a q.
 */
GetOpsItemRequestPrivate::GetOpsItemRequestPrivate(
    const SsmRequest::Action action, GetOpsItemRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetOpsItemRequest
 * class' copy constructor.
 */
GetOpsItemRequestPrivate::GetOpsItemRequestPrivate(
    const GetOpsItemRequestPrivate &other, GetOpsItemRequest * const q)
