...
class QTAWS_EXPORT DescribeInstancePatchStatesForPatchGroupResponse : public SsmResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeInstancePatchStatesForPatchGroupRequest * request() const override;
