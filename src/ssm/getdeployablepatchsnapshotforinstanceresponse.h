...
class QTAWS_EXPORT GetDeployablePatchSnapshotForInstanceResponse : public SSMResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetDeployablePatchSnapshotForInstanceRequest * request() const override;
