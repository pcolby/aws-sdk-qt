...
class QTAWS_EXPORT DescribeMaintenanceWindowTasksResponse : public DescribeMaintenanceWindowTasksResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeMaintenanceWindowTasksRequest * request() const;
