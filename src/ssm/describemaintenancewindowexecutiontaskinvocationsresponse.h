...
class QTAWS_EXPORT DescribeMaintenanceWindowExecutionTaskInvocationsResponse : public SSMResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeMaintenanceWindowExecutionTaskInvocationsRequest * request() const override;
