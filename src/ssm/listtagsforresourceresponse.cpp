 ...
 *
 * \sa SsmClient::listTagsForResource
 */
...
{
    return static_cast<const ListTagsForResourceRequest *>(SsmResponse::request());
}

/*!
 * \reimp
 * Parses a successful SSM ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::SSM::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : SsmResponsePrivate(q)
{

}

/*!
 * Parses a SSM ListTagsForResource response element from \a xml.
 */
