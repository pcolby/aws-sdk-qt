...
#include "deleteopsmetadatarequest_p.h"
...
/*!
 * \class QtAws::SSM::DeleteOpsMetadataRequest
 * \brief The DeleteOpsMetadataRequest class provides an interface for SSM DeleteOpsMetadata requests.
 *
 * \inmodule QtAwsSSM
 *
 ...
 */
DeleteOpsMetadataRequest::DeleteOpsMetadataRequest(const DeleteOpsMetadataRequest &other)
    : SsmRequest(new DeleteOpsMetadataRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteOpsMetadataRequest object.
 */
DeleteOpsMetadataRequest::DeleteOpsMetadataRequest()
    : SsmRequest(new DeleteOpsMetadataRequestPrivate(SsmRequest::DeleteOpsMetadataAction, this))
{
 ...
 * \reimp
 */
bool DeleteOpsMetadataRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteOpsMetadataResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteOpsMetadataRequest::response(QNetworkReply * const reply) const
{
    return new DeleteOpsMetadataResponse(*this, reply);
}

/*!
 * \class QtAws::SSM::DeleteOpsMetadataRequestPrivate
 * \brief The DeleteOpsMetadataRequestPrivate class provides private implementation for DeleteOpsMetadataRequest.
 * \internal
 *
 * \inmodule QtAwsSSM
 */
...
/*!
 * Constructs a DeleteOpsMetadataRequestPrivate object for Ssm \a action,
 * with public implementation \a q.
 */
DeleteOpsMetadataRequestPrivate::DeleteOpsMetadataRequestPrivate(
    const SsmRequest::Action action, DeleteOpsMetadataRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteOpsMetadataRequest
 * class' copy constructor.
 */
DeleteOpsMetadataRequestPrivate::DeleteOpsMetadataRequestPrivate(
    const DeleteOpsMetadataRequestPrivate &other, DeleteOpsMetadataRequest * const q)
