...
class QTAWS_EXPORT GetMaintenanceWindowExecutionTaskRequestPrivate : public SSMPrivate {

public:
    GetMaintenanceWindowExecutionTaskRequestPrivate(const SSM::Action action,
