...
class QTAWS_EXPORT RegisterTargetWithMaintenanceWindowResponse : public SsmResponse {
    Q_OBJECT
...
public:
    ...
    virtual const RegisterTargetWithMaintenanceWindowRequest * request() const override;
