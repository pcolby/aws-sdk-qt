...
#include "listopsmetadataresponse_p.h"
...
/*!
 * \class QtAws::SSM::ListOpsMetadataResponse
 * \brief The ListOpsMetadataResponse class provides an interace for SSM ListOpsMetadata responses.
 *
 * \inmodule QtAwsSSM
 *
...
/*!
 * Constructs a ListOpsMetadataResponse object for \a reply to \a request, with parent \a parent.
 */
ListOpsMetadataResponse::ListOpsMetadataResponse(
        const ListOpsMetadataRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : SsmResponse(new ListOpsMetadataResponsePrivate(this), parent)
{
    setRequest(new ListOpsMetadataRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful SSM ListOpsMetadata \a response.
 */
void ListOpsMetadataResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListOpsMetadataResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::SSM::ListOpsMetadataResponsePrivate
 * \brief The ListOpsMetadataResponsePrivate class provides private implementation for ListOpsMetadataResponse.
 * \internal
 *
 * \inmodule QtAwsSSM
 */
...
/*!
 * Constructs a ListOpsMetadataResponsePrivate object with public implementation \a q.
 */
ListOpsMetadataResponsePrivate::ListOpsMetadataResponsePrivate(
    ListOpsMetadataResponse * const q) : SsmResponsePrivate(q)
{

}

/*!
 * Parses a SSM ListOpsMetadata response element from \a xml.
 */
void ListOpsMetadataResponsePrivate::parseListOpsMetadataResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListOpsMetadataResponse"));
    Q_UNUSED(xml) ///< @todo
}
