...
class QTAWS_EXPORT DescribeMaintenanceWindowExecutionTasksRequestPrivate : public SSMPrivate {

public:
    DescribeMaintenanceWindowExecutionTasksRequestPrivate(const SSM::Action action,
