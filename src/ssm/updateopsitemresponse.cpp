...
#include "updateopsitemresponse_p.h"
...
/*!
 * \class QtAws::SSM::UpdateOpsItemResponse
 * \brief The UpdateOpsItemResponse class provides an interace for SSM UpdateOpsItem responses.
 *
 * \inmodule QtAwsSSM
 *
...
/*!
 * Constructs a UpdateOpsItemResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateOpsItemResponse::UpdateOpsItemResponse(
        const UpdateOpsItemRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : SsmResponse(new UpdateOpsItemResponsePrivate(this), parent)
{
    setRequest(new UpdateOpsItemRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful SSM UpdateOpsItem \a response.
 */
void UpdateOpsItemResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateOpsItemResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::SSM::UpdateOpsItemResponsePrivate
 * \brief The UpdateOpsItemResponsePrivate class provides private implementation for UpdateOpsItemResponse.
 * \internal
 *
 * \inmodule QtAwsSSM
 */
...
/*!
 * Constructs a UpdateOpsItemResponsePrivate object with public implementation \a q.
 */
UpdateOpsItemResponsePrivate::UpdateOpsItemResponsePrivate(
    UpdateOpsItemResponse * const q) : SsmResponsePrivate(q)
{

}

/*!
 * Parses a SSM UpdateOpsItem response element from \a xml.
 */
void UpdateOpsItemResponsePrivate::parseUpdateOpsItemResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateOpsItemResponse"));
    Q_UNUSED(xml) ///< @todo
}
