...
class QTAWS_EXPORT GetMaintenanceWindowTaskResponsePrivate : public SSMResponsePrivate {
    Q_OBJECT

public:

    GetMaintenanceWindowTaskResponsePrivate(GetMaintenanceWindowTaskResponse * const q);
