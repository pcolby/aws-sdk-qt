...
class QTAWS_EXPORT GetMaintenanceWindowExecutionTaskResponse : public GetMaintenanceWindowExecutionTaskResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetMaintenanceWindowExecutionTaskRequest * request() const;
