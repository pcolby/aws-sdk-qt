...
class QTAWS_EXPORT DescribeMaintenanceWindowExecutionsRequestPrivate : public SSMRequestPrivate {

public:
    DescribeMaintenanceWindowExecutionsRequestPrivate(const SSM::Action action,
