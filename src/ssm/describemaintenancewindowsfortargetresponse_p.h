...
class QTAWS_EXPORT DescribeMaintenanceWindowsForTargetResponsePrivate : public SsmResponsePrivate {

public:

    DescribeMaintenanceWindowsForTargetResponsePrivate(DescribeMaintenanceWindowsForTargetResponse * const q);
