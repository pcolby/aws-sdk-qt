...
/*!
 * \class QtAws::SSM::DescribeSessionsResponse
 * \brief The DescribeSessionsResponse class provides an interace for SSM DescribeSessions responses.
 *
 * \inmodule QtAwsSSM
 *
...
DescribeSessionsResponse::DescribeSessionsResponse(
    ...
    : SsmResponse(new DescribeSessionsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful SSM DescribeSessions \a response.
 */
...
/*!
 * \class QtAws::SSM::DescribeSessionsResponsePrivate
...
DescribeSessionsResponsePrivate::DescribeSessionsResponsePrivate(
    DescribeSessionsResponse * const q) : SsmResponsePrivate(q)
{

}

/*!
 * Parses a SSM DescribeSessions response element from \a xml.
 */
