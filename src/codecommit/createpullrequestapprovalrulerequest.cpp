...
#include "createpullrequestapprovalrulerequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::CreatePullRequestApprovalRuleRequest
 * \brief The CreatePullRequestApprovalRuleRequest class provides an interface for CodeCommit CreatePullRequestApprovalRule requests.
 *
 ...
 *
 * \sa CodeCommitClient::createPullRequestApprovalRule
 */

/*!
 * Constructs a copy of \a other.
 */
CreatePullRequestApprovalRuleRequest::CreatePullRequestApprovalRuleRequest(const CreatePullRequestApprovalRuleRequest &other)
    : CodeCommitRequest(new CreatePullRequestApprovalRuleRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreatePullRequestApprovalRuleRequest object.
 */
CreatePullRequestApprovalRuleRequest::CreatePullRequestApprovalRuleRequest()
    : CodeCommitRequest(new CreatePullRequestApprovalRuleRequestPrivate(CodeCommitRequest::CreatePullRequestApprovalRuleAction, this))
{
 ...
 * \reimp
 */
bool CreatePullRequestApprovalRuleRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreatePullRequestApprovalRuleResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreatePullRequestApprovalRuleRequest::response(QNetworkReply * const reply) const
{
    return new CreatePullRequestApprovalRuleResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::CreatePullRequestApprovalRuleRequestPrivate
 * \brief The CreatePullRequestApprovalRuleRequestPrivate class provides private implementation for CreatePullRequestApprovalRuleRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a CreatePullRequestApprovalRuleRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
CreatePullRequestApprovalRuleRequestPrivate::CreatePullRequestApprovalRuleRequestPrivate(
    const CodeCommitRequest::Action action, CreatePullRequestApprovalRuleRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreatePullRequestApprovalRuleRequest
 * class' copy constructor.
 */
CreatePullRequestApprovalRuleRequestPrivate::CreatePullRequestApprovalRuleRequestPrivate(
    const CreatePullRequestApprovalRuleRequestPrivate &other, CreatePullRequestApprovalRuleRequest * const q)
