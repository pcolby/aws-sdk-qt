...
#include "evaluatepullrequestapprovalrulesrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::EvaluatePullRequestApprovalRulesRequest
 * \brief The EvaluatePullRequestApprovalRulesRequest class provides an interface for CodeCommit EvaluatePullRequestApprovalRules requests.
 *
 ...
 *
 * \sa CodeCommitClient::evaluatePullRequestApprovalRules
 */

/*!
 * Constructs a copy of \a other.
 */
EvaluatePullRequestApprovalRulesRequest::EvaluatePullRequestApprovalRulesRequest(const EvaluatePullRequestApprovalRulesRequest &other)
    : CodeCommitRequest(new EvaluatePullRequestApprovalRulesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a EvaluatePullRequestApprovalRulesRequest object.
 */
EvaluatePullRequestApprovalRulesRequest::EvaluatePullRequestApprovalRulesRequest()
    : CodeCommitRequest(new EvaluatePullRequestApprovalRulesRequestPrivate(CodeCommitRequest::EvaluatePullRequestApprovalRulesAction, this))
{
 ...
 * \reimp
 */
bool EvaluatePullRequestApprovalRulesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a EvaluatePullRequestApprovalRulesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * EvaluatePullRequestApprovalRulesRequest::response(QNetworkReply * const reply) const
{
    return new EvaluatePullRequestApprovalRulesResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::EvaluatePullRequestApprovalRulesRequestPrivate
 * \brief The EvaluatePullRequestApprovalRulesRequestPrivate class provides private implementation for EvaluatePullRequestApprovalRulesRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a EvaluatePullRequestApprovalRulesRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
EvaluatePullRequestApprovalRulesRequestPrivate::EvaluatePullRequestApprovalRulesRequestPrivate(
    const CodeCommitRequest::Action action, EvaluatePullRequestApprovalRulesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the EvaluatePullRequestApprovalRulesRequest
 * class' copy constructor.
 */
EvaluatePullRequestApprovalRulesRequestPrivate::EvaluatePullRequestApprovalRulesRequestPrivate(
    const EvaluatePullRequestApprovalRulesRequestPrivate &other, EvaluatePullRequestApprovalRulesRequest * const q)
