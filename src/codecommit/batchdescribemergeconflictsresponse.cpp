...
#include "batchdescribemergeconflictsresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::BatchDescribeMergeConflictsResponse
 * \brief The BatchDescribeMergeConflictsResponse class provides an interace for CodeCommit BatchDescribeMergeConflicts responses.
 *
...
/*!
 * Constructs a BatchDescribeMergeConflictsResponse object for \a reply to \a request, with parent \a parent.
 */
BatchDescribeMergeConflictsResponse::BatchDescribeMergeConflictsResponse(
        const BatchDescribeMergeConflictsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new BatchDescribeMergeConflictsResponsePrivate(this), parent)
{
    setRequest(new BatchDescribeMergeConflictsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit BatchDescribeMergeConflicts \a response.
 */
void BatchDescribeMergeConflictsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(BatchDescribeMergeConflictsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::BatchDescribeMergeConflictsResponsePrivate
 * \brief The BatchDescribeMergeConflictsResponsePrivate class provides private implementation for BatchDescribeMergeConflictsResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a BatchDescribeMergeConflictsResponsePrivate object with public implementation \a q.
 */
BatchDescribeMergeConflictsResponsePrivate::BatchDescribeMergeConflictsResponsePrivate(
    BatchDescribeMergeConflictsResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit BatchDescribeMergeConflicts response element from \a xml.
 */
void BatchDescribeMergeConflictsResponsePrivate::parseBatchDescribeMergeConflictsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("BatchDescribeMergeConflictsResponse"));
    Q_UNUSED(xml) ///< @todo
}
