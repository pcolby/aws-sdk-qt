...
#include "mergebranchesbythreewayresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::MergeBranchesByThreeWayResponse
 * \brief The MergeBranchesByThreeWayResponse class provides an interace for CodeCommit MergeBranchesByThreeWay responses.
 *
...
/*!
 * Constructs a MergeBranchesByThreeWayResponse object for \a reply to \a request, with parent \a parent.
 */
MergeBranchesByThreeWayResponse::MergeBranchesByThreeWayResponse(
        const MergeBranchesByThreeWayRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new MergeBranchesByThreeWayResponsePrivate(this), parent)
{
    setRequest(new MergeBranchesByThreeWayRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit MergeBranchesByThreeWay \a response.
 */
void MergeBranchesByThreeWayResponse::parseSuccess(QIODevice &response)
{
    //Q_D(MergeBranchesByThreeWayResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::MergeBranchesByThreeWayResponsePrivate
 * \brief The MergeBranchesByThreeWayResponsePrivate class provides private implementation for MergeBranchesByThreeWayResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a MergeBranchesByThreeWayResponsePrivate object with public implementation \a q.
 */
MergeBranchesByThreeWayResponsePrivate::MergeBranchesByThreeWayResponsePrivate(
    MergeBranchesByThreeWayResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit MergeBranchesByThreeWay response element from \a xml.
 */
void MergeBranchesByThreeWayResponsePrivate::parseMergeBranchesByThreeWayResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("MergeBranchesByThreeWayResponse"));
    Q_UNUSED(xml) ///< @todo
}
