...
#include "putcommentreactionresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::PutCommentReactionResponse
 * \brief The PutCommentReactionResponse class provides an interace for CodeCommit PutCommentReaction responses.
 *
...
/*!
 * Constructs a PutCommentReactionResponse object for \a reply to \a request, with parent \a parent.
 */
PutCommentReactionResponse::PutCommentReactionResponse(
        const PutCommentReactionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new PutCommentReactionResponsePrivate(this), parent)
{
    setRequest(new PutCommentReactionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit PutCommentReaction \a response.
 */
void PutCommentReactionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutCommentReactionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::PutCommentReactionResponsePrivate
 * \brief The PutCommentReactionResponsePrivate class provides private implementation for PutCommentReactionResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a PutCommentReactionResponsePrivate object with public implementation \a q.
 */
PutCommentReactionResponsePrivate::PutCommentReactionResponsePrivate(
    PutCommentReactionResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit PutCommentReaction response element from \a xml.
 */
void PutCommentReactionResponsePrivate::parsePutCommentReactionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutCommentReactionResponse"));
    Q_UNUSED(xml) ///< @todo
}
