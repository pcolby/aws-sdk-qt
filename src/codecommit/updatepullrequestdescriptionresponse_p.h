...
class QTAWS_EXPORT UpdatePullRequestDescriptionResponsePrivate : public CodeCommitResponsePrivate {

public:

    UpdatePullRequestDescriptionResponsePrivate(UpdatePullRequestDescriptionResponse * const q);
