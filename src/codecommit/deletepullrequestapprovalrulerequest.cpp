...
#include "deletepullrequestapprovalrulerequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::DeletePullRequestApprovalRuleRequest
 * \brief The DeletePullRequestApprovalRuleRequest class provides an interface for CodeCommit DeletePullRequestApprovalRule requests.
 *
 ...
 *
 * \sa CodeCommitClient::deletePullRequestApprovalRule
 */

/*!
 * Constructs a copy of \a other.
 */
DeletePullRequestApprovalRuleRequest::DeletePullRequestApprovalRuleRequest(const DeletePullRequestApprovalRuleRequest &other)
    : CodeCommitRequest(new DeletePullRequestApprovalRuleRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeletePullRequestApprovalRuleRequest object.
 */
DeletePullRequestApprovalRuleRequest::DeletePullRequestApprovalRuleRequest()
    : CodeCommitRequest(new DeletePullRequestApprovalRuleRequestPrivate(CodeCommitRequest::DeletePullRequestApprovalRuleAction, this))
{
 ...
 * \reimp
 */
bool DeletePullRequestApprovalRuleRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeletePullRequestApprovalRuleResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeletePullRequestApprovalRuleRequest::response(QNetworkReply * const reply) const
{
    return new DeletePullRequestApprovalRuleResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::DeletePullRequestApprovalRuleRequestPrivate
 * \brief The DeletePullRequestApprovalRuleRequestPrivate class provides private implementation for DeletePullRequestApprovalRuleRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a DeletePullRequestApprovalRuleRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
DeletePullRequestApprovalRuleRequestPrivate::DeletePullRequestApprovalRuleRequestPrivate(
    const CodeCommitRequest::Action action, DeletePullRequestApprovalRuleRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeletePullRequestApprovalRuleRequest
 * class' copy constructor.
 */
DeletePullRequestApprovalRuleRequestPrivate::DeletePullRequestApprovalRuleRequestPrivate(
    const DeletePullRequestApprovalRuleRequestPrivate &other, DeletePullRequestApprovalRuleRequest * const q)
