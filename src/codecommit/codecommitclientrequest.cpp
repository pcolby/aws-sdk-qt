...
#include "codecommitclientrequest_p.h"
...
/**
 * @brief  Constructs a new CodeCommitClientRequest object.
 *
...
/**
 * @brief  Constructs a new CodeCommitClientRequest object by copying another.
 *
 ...
 */
CodeCommitClientRequest& CodeCommitClientRequest::operator=(const CodeCommitClientRequest &other)
{
    Q_D(CodeCommitClientRequest);
 ...
 * implementation that inherits from CodeCommitClientRequestPrivate.
 *
 ...
 */
CodeCommitClientRequest::Action CodeCommitClientRequest::action() const
{
    Q_D(const CodeCommitClientRequest);
    return d->action;
}
 ...
 */
QString CodeCommitClientRequest::actionString() const
{
    return CodeCommitClientRequestPrivate::toString(action());
}
 ...
 */
QString CodeCommitClientRequest::apiVersion() const
{
    Q_D(const CodeCommitClientRequest);
    return d->apiVersion;
}
 ...
 */
void CodeCommitClientRequest::setAction(const Action action)
{
    Q_D(CodeCommitClientRequest);
    d->action = action;
}
 ...
 */
void CodeCommitClientRequest::setApiVersion(const QString &version)
{
    Q_D(CodeCommitClientRequest);
 ...
 */
bool CodeCommitClientRequest::operator==(const CodeCommitClientRequest &other) const
{
 ...
 */
bool CodeCommitClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int CodeCommitClientRequest::clearParameter(const QString &name)
{
    Q_D(CodeCommitClientRequest);
 ...
 */
void CodeCommitClientRequest::clearParameters()
{
    Q_D(CodeCommitClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant CodeCommitClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const CodeCommitClientRequest);
 ...
 */
const QVariantMap &CodeCommitClientRequest::parameters() const
{
    Q_D(const CodeCommitClientRequest);
    return d->parameters;
}
 ...
 */
void CodeCommitClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(CodeCommitClientRequest);
 ...
 */
void CodeCommitClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(CodeCommitClientRequest);
 ...
 */
QNetworkRequest CodeCommitClientRequest::unsignedRequest(const QUrl &endpoint) const
{
    Q_D(const CodeCommitClientRequest);
    QUrl url(endpoint);
 ...
 *
 * @brief  Private implementation for CodeCommitClientRequest.
 */

/**
 * @internal
 *
 * @brief  Constructs a new CodeCommitClientRequestPrivate object.
 *
 ...
 * @internal
 *
 * @brief  Constructs a new CodeCommitClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the CodeCommitClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public CodeCommitClientRequest instance.
 */
 ...
 *
 * This function converts CodeCommitClientRequest::Action enumerator values to their respective
 ...
 */
QString CodeCommitClientRequestPrivate::toString(const CodeCommitClientRequest::Action &action)
{
    #define ActionToString(action) \
        case CodeCommitClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
