...
#include "batchdisassociateapprovalruletemplatefromrepositoriesresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::BatchDisassociateApprovalRuleTemplateFromRepositoriesResponse
 * \brief The BatchDisassociateApprovalRuleTemplateFromRepositoriesResponse class provides an interace for CodeCommit BatchDisassociateApprovalRuleTemplateFromRepositories responses.
 *
...
/*!
 * Constructs a BatchDisassociateApprovalRuleTemplateFromRepositoriesResponse object for \a reply to \a request, with parent \a parent.
 */
BatchDisassociateApprovalRuleTemplateFromRepositoriesResponse::BatchDisassociateApprovalRuleTemplateFromRepositoriesResponse(
        const BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new BatchDisassociateApprovalRuleTemplateFromRepositoriesResponsePrivate(this), parent)
{
    setRequest(new BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit BatchDisassociateApprovalRuleTemplateFromRepositories \a response.
 */
void BatchDisassociateApprovalRuleTemplateFromRepositoriesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(BatchDisassociateApprovalRuleTemplateFromRepositoriesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::BatchDisassociateApprovalRuleTemplateFromRepositoriesResponsePrivate
 * \brief The BatchDisassociateApprovalRuleTemplateFromRepositoriesResponsePrivate class provides private implementation for BatchDisassociateApprovalRuleTemplateFromRepositoriesResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a BatchDisassociateApprovalRuleTemplateFromRepositoriesResponsePrivate object with public implementation \a q.
 */
BatchDisassociateApprovalRuleTemplateFromRepositoriesResponsePrivate::BatchDisassociateApprovalRuleTemplateFromRepositoriesResponsePrivate(
    BatchDisassociateApprovalRuleTemplateFromRepositoriesResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit BatchDisassociateApprovalRuleTemplateFromRepositories response element from \a xml.
 */
void BatchDisassociateApprovalRuleTemplateFromRepositoriesResponsePrivate::parseBatchDisassociateApprovalRuleTemplateFromRepositoriesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("BatchDisassociateApprovalRuleTemplateFromRepositoriesResponse"));
    Q_UNUSED(xml) ///< @todo
}
