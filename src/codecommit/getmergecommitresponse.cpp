...
#include "getmergecommitresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::GetMergeCommitResponse
 * \brief The GetMergeCommitResponse class provides an interace for CodeCommit GetMergeCommit responses.
 *
...
/*!
 * Constructs a GetMergeCommitResponse object for \a reply to \a request, with parent \a parent.
 */
GetMergeCommitResponse::GetMergeCommitResponse(
        const GetMergeCommitRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new GetMergeCommitResponsePrivate(this), parent)
{
    setRequest(new GetMergeCommitRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit GetMergeCommit \a response.
 */
void GetMergeCommitResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetMergeCommitResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::GetMergeCommitResponsePrivate
 * \brief The GetMergeCommitResponsePrivate class provides private implementation for GetMergeCommitResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a GetMergeCommitResponsePrivate object with public implementation \a q.
 */
GetMergeCommitResponsePrivate::GetMergeCommitResponsePrivate(
    GetMergeCommitResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit GetMergeCommit response element from \a xml.
 */
void GetMergeCommitResponsePrivate::parseGetMergeCommitResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetMergeCommitResponse"));
    Q_UNUSED(xml) ///< @todo
}
