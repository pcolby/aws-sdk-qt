...
#include "getmergeoptionsresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::GetMergeOptionsResponse
 * \brief The GetMergeOptionsResponse class provides an interace for CodeCommit GetMergeOptions responses.
 *
...
/*!
 * Constructs a GetMergeOptionsResponse object for \a reply to \a request, with parent \a parent.
 */
GetMergeOptionsResponse::GetMergeOptionsResponse(
        const GetMergeOptionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new GetMergeOptionsResponsePrivate(this), parent)
{
    setRequest(new GetMergeOptionsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit GetMergeOptions \a response.
 */
void GetMergeOptionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetMergeOptionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::GetMergeOptionsResponsePrivate
 * \brief The GetMergeOptionsResponsePrivate class provides private implementation for GetMergeOptionsResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a GetMergeOptionsResponsePrivate object with public implementation \a q.
 */
GetMergeOptionsResponsePrivate::GetMergeOptionsResponsePrivate(
    GetMergeOptionsResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit GetMergeOptions response element from \a xml.
 */
void GetMergeOptionsResponsePrivate::parseGetMergeOptionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetMergeOptionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
