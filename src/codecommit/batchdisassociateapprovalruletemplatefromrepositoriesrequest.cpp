...
#include "batchdisassociateapprovalruletemplatefromrepositoriesrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest
 * \brief The BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest class provides an interface for CodeCommit BatchDisassociateApprovalRuleTemplateFromRepositories requests.
 *
 ...
 *
 * \sa CodeCommitClient::batchDisassociateApprovalRuleTemplateFromRepositories
 */

/*!
 * Constructs a copy of \a other.
 */
BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest::BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest(const BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest &other)
    : CodeCommitRequest(new BatchDisassociateApprovalRuleTemplateFromRepositoriesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest object.
 */
BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest::BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest()
    : CodeCommitRequest(new BatchDisassociateApprovalRuleTemplateFromRepositoriesRequestPrivate(CodeCommitRequest::BatchDisassociateApprovalRuleTemplateFromRepositoriesAction, this))
{
 ...
 * \reimp
 */
bool BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BatchDisassociateApprovalRuleTemplateFromRepositoriesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest::response(QNetworkReply * const reply) const
{
    return new BatchDisassociateApprovalRuleTemplateFromRepositoriesResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::BatchDisassociateApprovalRuleTemplateFromRepositoriesRequestPrivate
 * \brief The BatchDisassociateApprovalRuleTemplateFromRepositoriesRequestPrivate class provides private implementation for BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a BatchDisassociateApprovalRuleTemplateFromRepositoriesRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
BatchDisassociateApprovalRuleTemplateFromRepositoriesRequestPrivate::BatchDisassociateApprovalRuleTemplateFromRepositoriesRequestPrivate(
    const CodeCommitRequest::Action action, BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest
 * class' copy constructor.
 */
BatchDisassociateApprovalRuleTemplateFromRepositoriesRequestPrivate::BatchDisassociateApprovalRuleTemplateFromRepositoriesRequestPrivate(
    const BatchDisassociateApprovalRuleTemplateFromRepositoriesRequestPrivate &other, BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest * const q)
