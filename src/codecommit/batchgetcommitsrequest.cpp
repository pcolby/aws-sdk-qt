...
#include "batchgetcommitsrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::BatchGetCommitsRequest
 * \brief The BatchGetCommitsRequest class provides an interface for CodeCommit BatchGetCommits requests.
 *
 ...
 *
 * \sa CodeCommitClient::batchGetCommits
 */

/*!
 * Constructs a copy of \a other.
 */
BatchGetCommitsRequest::BatchGetCommitsRequest(const BatchGetCommitsRequest &other)
    : CodeCommitRequest(new BatchGetCommitsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a BatchGetCommitsRequest object.
 */
BatchGetCommitsRequest::BatchGetCommitsRequest()
    : CodeCommitRequest(new BatchGetCommitsRequestPrivate(CodeCommitRequest::BatchGetCommitsAction, this))
{
 ...
 * \reimp
 */
bool BatchGetCommitsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BatchGetCommitsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BatchGetCommitsRequest::response(QNetworkReply * const reply) const
{
    return new BatchGetCommitsResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::BatchGetCommitsRequestPrivate
 * \brief The BatchGetCommitsRequestPrivate class provides private implementation for BatchGetCommitsRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a BatchGetCommitsRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
BatchGetCommitsRequestPrivate::BatchGetCommitsRequestPrivate(
    const CodeCommitRequest::Action action, BatchGetCommitsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the BatchGetCommitsRequest
 * class' copy constructor.
 */
BatchGetCommitsRequestPrivate::BatchGetCommitsRequestPrivate(
    const BatchGetCommitsRequestPrivate &other, BatchGetCommitsRequest * const q)
