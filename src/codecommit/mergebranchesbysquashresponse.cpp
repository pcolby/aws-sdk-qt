...
#include "mergebranchesbysquashresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::MergeBranchesBySquashResponse
 * \brief The MergeBranchesBySquashResponse class provides an interace for CodeCommit MergeBranchesBySquash responses.
 *
...
/*!
 * Constructs a MergeBranchesBySquashResponse object for \a reply to \a request, with parent \a parent.
 */
MergeBranchesBySquashResponse::MergeBranchesBySquashResponse(
        const MergeBranchesBySquashRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new MergeBranchesBySquashResponsePrivate(this), parent)
{
    setRequest(new MergeBranchesBySquashRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit MergeBranchesBySquash \a response.
 */
void MergeBranchesBySquashResponse::parseSuccess(QIODevice &response)
{
    //Q_D(MergeBranchesBySquashResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::MergeBranchesBySquashResponsePrivate
 * \brief The MergeBranchesBySquashResponsePrivate class provides private implementation for MergeBranchesBySquashResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a MergeBranchesBySquashResponsePrivate object with public implementation \a q.
 */
MergeBranchesBySquashResponsePrivate::MergeBranchesBySquashResponsePrivate(
    MergeBranchesBySquashResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit MergeBranchesBySquash response element from \a xml.
 */
void MergeBranchesBySquashResponsePrivate::parseMergeBranchesBySquashResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("MergeBranchesBySquashResponse"));
    Q_UNUSED(xml) ///< @todo
}
