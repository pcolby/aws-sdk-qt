...
#include "updatepullrequestapprovalrulecontentresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::UpdatePullRequestApprovalRuleContentResponse
 * \brief The UpdatePullRequestApprovalRuleContentResponse class provides an interace for CodeCommit UpdatePullRequestApprovalRuleContent responses.
 *
...
/*!
 * Constructs a UpdatePullRequestApprovalRuleContentResponse object for \a reply to \a request, with parent \a parent.
 */
UpdatePullRequestApprovalRuleContentResponse::UpdatePullRequestApprovalRuleContentResponse(
        const UpdatePullRequestApprovalRuleContentRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new UpdatePullRequestApprovalRuleContentResponsePrivate(this), parent)
{
    setRequest(new UpdatePullRequestApprovalRuleContentRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit UpdatePullRequestApprovalRuleContent \a response.
 */
void UpdatePullRequestApprovalRuleContentResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdatePullRequestApprovalRuleContentResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::UpdatePullRequestApprovalRuleContentResponsePrivate
 * \brief The UpdatePullRequestApprovalRuleContentResponsePrivate class provides private implementation for UpdatePullRequestApprovalRuleContentResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a UpdatePullRequestApprovalRuleContentResponsePrivate object with public implementation \a q.
 */
UpdatePullRequestApprovalRuleContentResponsePrivate::UpdatePullRequestApprovalRuleContentResponsePrivate(
    UpdatePullRequestApprovalRuleContentResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit UpdatePullRequestApprovalRuleContent response element from \a xml.
 */
void UpdatePullRequestApprovalRuleContentResponsePrivate::parseUpdatePullRequestApprovalRuleContentResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdatePullRequestApprovalRuleContentResponse"));
    Q_UNUSED(xml) ///< @todo
}
