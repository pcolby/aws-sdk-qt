...
#include "getpullrequestapprovalstatesrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::GetPullRequestApprovalStatesRequest
 * \brief The GetPullRequestApprovalStatesRequest class provides an interface for CodeCommit GetPullRequestApprovalStates requests.
 *
 ...
 *
 * \sa CodeCommitClient::getPullRequestApprovalStates
 */

/*!
 * Constructs a copy of \a other.
 */
GetPullRequestApprovalStatesRequest::GetPullRequestApprovalStatesRequest(const GetPullRequestApprovalStatesRequest &other)
    : CodeCommitRequest(new GetPullRequestApprovalStatesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetPullRequestApprovalStatesRequest object.
 */
GetPullRequestApprovalStatesRequest::GetPullRequestApprovalStatesRequest()
    : CodeCommitRequest(new GetPullRequestApprovalStatesRequestPrivate(CodeCommitRequest::GetPullRequestApprovalStatesAction, this))
{
 ...
 * \reimp
 */
bool GetPullRequestApprovalStatesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetPullRequestApprovalStatesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetPullRequestApprovalStatesRequest::response(QNetworkReply * const reply) const
{
    return new GetPullRequestApprovalStatesResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::GetPullRequestApprovalStatesRequestPrivate
 * \brief The GetPullRequestApprovalStatesRequestPrivate class provides private implementation for GetPullRequestApprovalStatesRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a GetPullRequestApprovalStatesRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
GetPullRequestApprovalStatesRequestPrivate::GetPullRequestApprovalStatesRequestPrivate(
    const CodeCommitRequest::Action action, GetPullRequestApprovalStatesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetPullRequestApprovalStatesRequest
 * class' copy constructor.
 */
GetPullRequestApprovalStatesRequestPrivate::GetPullRequestApprovalStatesRequestPrivate(
    const GetPullRequestApprovalStatesRequestPrivate &other, GetPullRequestApprovalStatesRequest * const q)
