...
#include "mergebranchesbythreewayrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::MergeBranchesByThreeWayRequest
 * \brief The MergeBranchesByThreeWayRequest class provides an interface for CodeCommit MergeBranchesByThreeWay requests.
 *
 ...
 *
 * \sa CodeCommitClient::mergeBranchesByThreeWay
 */

/*!
 * Constructs a copy of \a other.
 */
MergeBranchesByThreeWayRequest::MergeBranchesByThreeWayRequest(const MergeBranchesByThreeWayRequest &other)
    : CodeCommitRequest(new MergeBranchesByThreeWayRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a MergeBranchesByThreeWayRequest object.
 */
MergeBranchesByThreeWayRequest::MergeBranchesByThreeWayRequest()
    : CodeCommitRequest(new MergeBranchesByThreeWayRequestPrivate(CodeCommitRequest::MergeBranchesByThreeWayAction, this))
{
 ...
 * \reimp
 */
bool MergeBranchesByThreeWayRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a MergeBranchesByThreeWayResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * MergeBranchesByThreeWayRequest::response(QNetworkReply * const reply) const
{
    return new MergeBranchesByThreeWayResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::MergeBranchesByThreeWayRequestPrivate
 * \brief The MergeBranchesByThreeWayRequestPrivate class provides private implementation for MergeBranchesByThreeWayRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a MergeBranchesByThreeWayRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
MergeBranchesByThreeWayRequestPrivate::MergeBranchesByThreeWayRequestPrivate(
    const CodeCommitRequest::Action action, MergeBranchesByThreeWayRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the MergeBranchesByThreeWayRequest
 * class' copy constructor.
 */
MergeBranchesByThreeWayRequestPrivate::MergeBranchesByThreeWayRequestPrivate(
    const MergeBranchesByThreeWayRequestPrivate &other, MergeBranchesByThreeWayRequest * const q)
