...
#include "getcommentreactionsresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::GetCommentReactionsResponse
 * \brief The GetCommentReactionsResponse class provides an interace for CodeCommit GetCommentReactions responses.
 *
 ...
 *
 * \sa CodeCommitClient::getCommentReactions
 */

/*!
 * Constructs a GetCommentReactionsResponse object for \a reply to \a request, with parent \a parent.
 */
GetCommentReactionsResponse::GetCommentReactionsResponse(
        const GetCommentReactionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new GetCommentReactionsResponsePrivate(this), parent)
{
    setRequest(new GetCommentReactionsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetCommentReactionsRequest * GetCommentReactionsResponse::request() const
{
    Q_D(const GetCommentReactionsResponse);
    return static_cast<const GetCommentReactionsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful CodeCommit GetCommentReactions \a response.
 */
void GetCommentReactionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetCommentReactionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::GetCommentReactionsResponsePrivate
 * \brief The GetCommentReactionsResponsePrivate class provides private implementation for GetCommentReactionsResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a GetCommentReactionsResponsePrivate object with public implementation \a q.
 */
GetCommentReactionsResponsePrivate::GetCommentReactionsResponsePrivate(
    GetCommentReactionsResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit GetCommentReactions response element from \a xml.
 */
void GetCommentReactionsResponsePrivate::parseGetCommentReactionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetCommentReactionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
