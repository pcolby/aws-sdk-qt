...
#include "listrepositoriesforapprovalruletemplaterequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::ListRepositoriesForApprovalRuleTemplateRequest
 * \brief The ListRepositoriesForApprovalRuleTemplateRequest class provides an interface for CodeCommit ListRepositoriesForApprovalRuleTemplate requests.
 *
 ...
 *
 * \sa CodeCommitClient::listRepositoriesForApprovalRuleTemplate
 */

/*!
 * Constructs a copy of \a other.
 */
ListRepositoriesForApprovalRuleTemplateRequest::ListRepositoriesForApprovalRuleTemplateRequest(const ListRepositoriesForApprovalRuleTemplateRequest &other)
    : CodeCommitRequest(new ListRepositoriesForApprovalRuleTemplateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListRepositoriesForApprovalRuleTemplateRequest object.
 */
ListRepositoriesForApprovalRuleTemplateRequest::ListRepositoriesForApprovalRuleTemplateRequest()
    : CodeCommitRequest(new ListRepositoriesForApprovalRuleTemplateRequestPrivate(CodeCommitRequest::ListRepositoriesForApprovalRuleTemplateAction, this))
{
 ...
 * \reimp
 */
bool ListRepositoriesForApprovalRuleTemplateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListRepositoriesForApprovalRuleTemplateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListRepositoriesForApprovalRuleTemplateRequest::response(QNetworkReply * const reply) const
{
    return new ListRepositoriesForApprovalRuleTemplateResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::ListRepositoriesForApprovalRuleTemplateRequestPrivate
 * \brief The ListRepositoriesForApprovalRuleTemplateRequestPrivate class provides private implementation for ListRepositoriesForApprovalRuleTemplateRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a ListRepositoriesForApprovalRuleTemplateRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
ListRepositoriesForApprovalRuleTemplateRequestPrivate::ListRepositoriesForApprovalRuleTemplateRequestPrivate(
    const CodeCommitRequest::Action action, ListRepositoriesForApprovalRuleTemplateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListRepositoriesForApprovalRuleTemplateRequest
 * class' copy constructor.
 */
ListRepositoriesForApprovalRuleTemplateRequestPrivate::ListRepositoriesForApprovalRuleTemplateRequestPrivate(
    const ListRepositoriesForApprovalRuleTemplateRequestPrivate &other, ListRepositoriesForApprovalRuleTemplateRequest * const q)
