...
#include "mergebranchesbyfastforwardresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::MergeBranchesByFastForwardResponse
 * \brief The MergeBranchesByFastForwardResponse class provides an interace for CodeCommit MergeBranchesByFastForward responses.
 *
...
/*!
 * Constructs a MergeBranchesByFastForwardResponse object for \a reply to \a request, with parent \a parent.
 */
MergeBranchesByFastForwardResponse::MergeBranchesByFastForwardResponse(
        const MergeBranchesByFastForwardRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new MergeBranchesByFastForwardResponsePrivate(this), parent)
{
    setRequest(new MergeBranchesByFastForwardRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit MergeBranchesByFastForward \a response.
 */
void MergeBranchesByFastForwardResponse::parseSuccess(QIODevice &response)
{
    //Q_D(MergeBranchesByFastForwardResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::MergeBranchesByFastForwardResponsePrivate
 * \brief The MergeBranchesByFastForwardResponsePrivate class provides private implementation for MergeBranchesByFastForwardResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a MergeBranchesByFastForwardResponsePrivate object with public implementation \a q.
 */
MergeBranchesByFastForwardResponsePrivate::MergeBranchesByFastForwardResponsePrivate(
    MergeBranchesByFastForwardResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit MergeBranchesByFastForward response element from \a xml.
 */
void MergeBranchesByFastForwardResponsePrivate::parseMergeBranchesByFastForwardResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("MergeBranchesByFastForwardResponse"));
    Q_UNUSED(xml) ///< @todo
}
