...
#include "overridepullrequestapprovalrulesresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::OverridePullRequestApprovalRulesResponse
 * \brief The OverridePullRequestApprovalRulesResponse class provides an interace for CodeCommit OverridePullRequestApprovalRules responses.
 *
...
/*!
 * Constructs a OverridePullRequestApprovalRulesResponse object for \a reply to \a request, with parent \a parent.
 */
OverridePullRequestApprovalRulesResponse::OverridePullRequestApprovalRulesResponse(
        const OverridePullRequestApprovalRulesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new OverridePullRequestApprovalRulesResponsePrivate(this), parent)
{
    setRequest(new OverridePullRequestApprovalRulesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit OverridePullRequestApprovalRules \a response.
 */
void OverridePullRequestApprovalRulesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(OverridePullRequestApprovalRulesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::OverridePullRequestApprovalRulesResponsePrivate
 * \brief The OverridePullRequestApprovalRulesResponsePrivate class provides private implementation for OverridePullRequestApprovalRulesResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a OverridePullRequestApprovalRulesResponsePrivate object with public implementation \a q.
 */
OverridePullRequestApprovalRulesResponsePrivate::OverridePullRequestApprovalRulesResponsePrivate(
    OverridePullRequestApprovalRulesResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit OverridePullRequestApprovalRules response element from \a xml.
 */
void OverridePullRequestApprovalRulesResponsePrivate::parseOverridePullRequestApprovalRulesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("OverridePullRequestApprovalRulesResponse"));
    Q_UNUSED(xml) ///< @todo
}
