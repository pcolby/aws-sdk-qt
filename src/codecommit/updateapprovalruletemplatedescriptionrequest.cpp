...
#include "updateapprovalruletemplatedescriptionrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::UpdateApprovalRuleTemplateDescriptionRequest
 * \brief The UpdateApprovalRuleTemplateDescriptionRequest class provides an interface for CodeCommit UpdateApprovalRuleTemplateDescription requests.
 *
 ...
 */
UpdateApprovalRuleTemplateDescriptionRequest::UpdateApprovalRuleTemplateDescriptionRequest(const UpdateApprovalRuleTemplateDescriptionRequest &other)
    : CodeCommitRequest(new UpdateApprovalRuleTemplateDescriptionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateApprovalRuleTemplateDescriptionRequest object.
 */
UpdateApprovalRuleTemplateDescriptionRequest::UpdateApprovalRuleTemplateDescriptionRequest()
    : CodeCommitRequest(new UpdateApprovalRuleTemplateDescriptionRequestPrivate(CodeCommitRequest::UpdateApprovalRuleTemplateDescriptionAction, this))
{
 ...
 * \reimp
 */
bool UpdateApprovalRuleTemplateDescriptionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateApprovalRuleTemplateDescriptionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateApprovalRuleTemplateDescriptionRequest::response(QNetworkReply * const reply) const
{
    return new UpdateApprovalRuleTemplateDescriptionResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::UpdateApprovalRuleTemplateDescriptionRequestPrivate
 * \brief The UpdateApprovalRuleTemplateDescriptionRequestPrivate class provides private implementation for UpdateApprovalRuleTemplateDescriptionRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a UpdateApprovalRuleTemplateDescriptionRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
UpdateApprovalRuleTemplateDescriptionRequestPrivate::UpdateApprovalRuleTemplateDescriptionRequestPrivate(
    const CodeCommitRequest::Action action, UpdateApprovalRuleTemplateDescriptionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateApprovalRuleTemplateDescriptionRequest
 * class' copy constructor.
 */
UpdateApprovalRuleTemplateDescriptionRequestPrivate::UpdateApprovalRuleTemplateDescriptionRequestPrivate(
    const UpdateApprovalRuleTemplateDescriptionRequestPrivate &other, UpdateApprovalRuleTemplateDescriptionRequest * const q)
