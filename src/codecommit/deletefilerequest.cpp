...
/*!
 * \class QtAws::CodeCommit::DeleteFileRequest
 * \brief The DeleteFileRequest class provides an interface for CodeCommit DeleteFile requests.
 *
 ...
 *
 * \sa CodeCommitClient::deleteFile
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteFileRequest::DeleteFileRequest(const DeleteFileRequest &other)
    : CodeCommitRequest(new DeleteFileRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteFileRequest object.
 */
DeleteFileRequest::DeleteFileRequest()
    : CodeCommitRequest(new DeleteFileRequestPrivate(CodeCommitRequest::DeleteFileAction, this))
{
 ...
 * \reimp
 */
bool DeleteFileRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteFileResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteFileRequest::response(QNetworkReply * const reply) const
{
    return new DeleteFileResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::DeleteFileRequestPrivate
 * \brief The DeleteFileRequestPrivate class provides private implementation for DeleteFileRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a DeleteFileRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
DeleteFileRequestPrivate::DeleteFileRequestPrivate(
    const CodeCommitRequest::Action action, DeleteFileRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteFileRequest
 * class' copy constructor.
 */
DeleteFileRequestPrivate::DeleteFileRequestPrivate(
    const DeleteFileRequestPrivate &other, DeleteFileRequest * const q)
