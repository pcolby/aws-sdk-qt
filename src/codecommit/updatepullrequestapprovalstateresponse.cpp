...
#include "updatepullrequestapprovalstateresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::UpdatePullRequestApprovalStateResponse
 * \brief The UpdatePullRequestApprovalStateResponse class provides an interace for CodeCommit UpdatePullRequestApprovalState responses.
 *
 ...
 *
 * \sa CodeCommitClient::updatePullRequestApprovalState
 */

/*!
 * Constructs a UpdatePullRequestApprovalStateResponse object for \a reply to \a request, with parent \a parent.
 */
UpdatePullRequestApprovalStateResponse::UpdatePullRequestApprovalStateResponse(
        const UpdatePullRequestApprovalStateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new UpdatePullRequestApprovalStateResponsePrivate(this), parent)
{
    setRequest(new UpdatePullRequestApprovalStateRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdatePullRequestApprovalStateRequest * UpdatePullRequestApprovalStateResponse::request() const
{
    Q_D(const UpdatePullRequestApprovalStateResponse);
    return static_cast<const UpdatePullRequestApprovalStateRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful CodeCommit UpdatePullRequestApprovalState \a response.
 */
void UpdatePullRequestApprovalStateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdatePullRequestApprovalStateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::UpdatePullRequestApprovalStateResponsePrivate
 * \brief The UpdatePullRequestApprovalStateResponsePrivate class provides private implementation for UpdatePullRequestApprovalStateResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a UpdatePullRequestApprovalStateResponsePrivate object with public implementation \a q.
 */
UpdatePullRequestApprovalStateResponsePrivate::UpdatePullRequestApprovalStateResponsePrivate(
    UpdatePullRequestApprovalStateResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit UpdatePullRequestApprovalState response element from \a xml.
 */
void UpdatePullRequestApprovalStateResponsePrivate::parseUpdatePullRequestApprovalStateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdatePullRequestApprovalStateResponse"));
    Q_UNUSED(xml) ///< @todo
}
