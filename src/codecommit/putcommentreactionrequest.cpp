...
#include "putcommentreactionrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::PutCommentReactionRequest
 * \brief The PutCommentReactionRequest class provides an interface for CodeCommit PutCommentReaction requests.
 *
 ...
 *
 * \sa CodeCommitClient::putCommentReaction
 */

/*!
 * Constructs a copy of \a other.
 */
PutCommentReactionRequest::PutCommentReactionRequest(const PutCommentReactionRequest &other)
    : CodeCommitRequest(new PutCommentReactionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutCommentReactionRequest object.
 */
PutCommentReactionRequest::PutCommentReactionRequest()
    : CodeCommitRequest(new PutCommentReactionRequestPrivate(CodeCommitRequest::PutCommentReactionAction, this))
{
 ...
 * \reimp
 */
bool PutCommentReactionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutCommentReactionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutCommentReactionRequest::response(QNetworkReply * const reply) const
{
    return new PutCommentReactionResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::PutCommentReactionRequestPrivate
 * \brief The PutCommentReactionRequestPrivate class provides private implementation for PutCommentReactionRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a PutCommentReactionRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
PutCommentReactionRequestPrivate::PutCommentReactionRequestPrivate(
    const CodeCommitRequest::Action action, PutCommentReactionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutCommentReactionRequest
 * class' copy constructor.
 */
PutCommentReactionRequestPrivate::PutCommentReactionRequestPrivate(
    const PutCommentReactionRequestPrivate &other, PutCommentReactionRequest * const q)
