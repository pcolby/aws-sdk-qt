...
#include "getpullrequestoverridestateresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::GetPullRequestOverrideStateResponse
 * \brief The GetPullRequestOverrideStateResponse class provides an interace for CodeCommit GetPullRequestOverrideState responses.
 *
...
/*!
 * Constructs a GetPullRequestOverrideStateResponse object for \a reply to \a request, with parent \a parent.
 */
GetPullRequestOverrideStateResponse::GetPullRequestOverrideStateResponse(
        const GetPullRequestOverrideStateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new GetPullRequestOverrideStateResponsePrivate(this), parent)
{
    setRequest(new GetPullRequestOverrideStateRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit GetPullRequestOverrideState \a response.
 */
void GetPullRequestOverrideStateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetPullRequestOverrideStateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::GetPullRequestOverrideStateResponsePrivate
 * \brief The GetPullRequestOverrideStateResponsePrivate class provides private implementation for GetPullRequestOverrideStateResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a GetPullRequestOverrideStateResponsePrivate object with public implementation \a q.
 */
GetPullRequestOverrideStateResponsePrivate::GetPullRequestOverrideStateResponsePrivate(
    GetPullRequestOverrideStateResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit GetPullRequestOverrideState response element from \a xml.
 */
void GetPullRequestOverrideStateResponsePrivate::parseGetPullRequestOverrideStateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetPullRequestOverrideStateResponse"));
    Q_UNUSED(xml) ///< @todo
}
