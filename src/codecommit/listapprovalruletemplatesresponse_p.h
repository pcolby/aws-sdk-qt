...
class QTAWS_EXPORT ListApprovalRuleTemplatesResponsePrivate : public CodeCommitResponsePrivate {

public:

    ListApprovalRuleTemplatesResponsePrivate(ListApprovalRuleTemplatesResponse * const q);
