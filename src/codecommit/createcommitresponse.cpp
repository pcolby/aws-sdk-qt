...
#include "createcommitresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::CreateCommitResponse
 * \brief The CreateCommitResponse class provides an interace for CodeCommit CreateCommit responses.
 *
...
/*!
 * Constructs a CreateCommitResponse object for \a reply to \a request, with parent \a parent.
 */
CreateCommitResponse::CreateCommitResponse(
        const CreateCommitRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new CreateCommitResponsePrivate(this), parent)
{
    setRequest(new CreateCommitRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit CreateCommit \a response.
 */
void CreateCommitResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateCommitResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::CreateCommitResponsePrivate
 * \brief The CreateCommitResponsePrivate class provides private implementation for CreateCommitResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a CreateCommitResponsePrivate object with public implementation \a q.
 */
CreateCommitResponsePrivate::CreateCommitResponsePrivate(
    CreateCommitResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit CreateCommit response element from \a xml.
 */
void CreateCommitResponsePrivate::parseCreateCommitResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateCommitResponse"));
    Q_UNUSED(xml) ///< @todo
}
