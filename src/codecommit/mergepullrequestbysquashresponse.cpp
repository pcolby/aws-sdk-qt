...
#include "mergepullrequestbysquashresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::MergePullRequestBySquashResponse
 * \brief The MergePullRequestBySquashResponse class provides an interace for CodeCommit MergePullRequestBySquash responses.
 *
...
/*!
 * Constructs a MergePullRequestBySquashResponse object for \a reply to \a request, with parent \a parent.
 */
MergePullRequestBySquashResponse::MergePullRequestBySquashResponse(
        const MergePullRequestBySquashRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new MergePullRequestBySquashResponsePrivate(this), parent)
{
    setRequest(new MergePullRequestBySquashRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit MergePullRequestBySquash \a response.
 */
void MergePullRequestBySquashResponse::parseSuccess(QIODevice &response)
{
    //Q_D(MergePullRequestBySquashResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::MergePullRequestBySquashResponsePrivate
 * \brief The MergePullRequestBySquashResponsePrivate class provides private implementation for MergePullRequestBySquashResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a MergePullRequestBySquashResponsePrivate object with public implementation \a q.
 */
MergePullRequestBySquashResponsePrivate::MergePullRequestBySquashResponsePrivate(
    MergePullRequestBySquashResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit MergePullRequestBySquash response element from \a xml.
 */
void MergePullRequestBySquashResponsePrivate::parseMergePullRequestBySquashResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("MergePullRequestBySquashResponse"));
    Q_UNUSED(xml) ///< @todo
}
