...
class QTAWS_EXPORT GetCommentsForComparedCommitResponse : public CodeCommitResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetCommentsForComparedCommitRequest * request() const override;
