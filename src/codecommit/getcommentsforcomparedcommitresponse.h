...
class QTAWS_EXPORT GetCommentsForComparedCommitResponse : public GetCommentsForComparedCommitResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetCommentsForComparedCommitRequest * request() const;
