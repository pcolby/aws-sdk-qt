...
/*!
 * \class QtAws::CodeCommit::GetFolderResponse
 * \brief The GetFolderResponse class provides an interace for CodeCommit GetFolder responses.
 *
...
GetFolderResponse::GetFolderResponse(
    ...
    : CodeCommitResponse(new GetFolderResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CodeCommit GetFolder \a response.
 */
...
/*!
 * \class QtAws::CodeCommit::GetFolderResponsePrivate
...
GetFolderResponsePrivate::GetFolderResponsePrivate(
    GetFolderResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit GetFolder response element from \a xml.
 */
