...
#include "updateapprovalruletemplatecontentresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::UpdateApprovalRuleTemplateContentResponse
 * \brief The UpdateApprovalRuleTemplateContentResponse class provides an interace for CodeCommit UpdateApprovalRuleTemplateContent responses.
 *
 ...
 *
 * \sa CodeCommitClient::updateApprovalRuleTemplateContent
 */

/*!
 * Constructs a UpdateApprovalRuleTemplateContentResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateApprovalRuleTemplateContentResponse::UpdateApprovalRuleTemplateContentResponse(
        const UpdateApprovalRuleTemplateContentRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new UpdateApprovalRuleTemplateContentResponsePrivate(this), parent)
{
    setRequest(new UpdateApprovalRuleTemplateContentRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateApprovalRuleTemplateContentRequest * UpdateApprovalRuleTemplateContentResponse::request() const
{
    Q_D(const UpdateApprovalRuleTemplateContentResponse);
    return static_cast<const UpdateApprovalRuleTemplateContentRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful CodeCommit UpdateApprovalRuleTemplateContent \a response.
 */
void UpdateApprovalRuleTemplateContentResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateApprovalRuleTemplateContentResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::UpdateApprovalRuleTemplateContentResponsePrivate
 * \brief The UpdateApprovalRuleTemplateContentResponsePrivate class provides private implementation for UpdateApprovalRuleTemplateContentResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a UpdateApprovalRuleTemplateContentResponsePrivate object with public implementation \a q.
 */
UpdateApprovalRuleTemplateContentResponsePrivate::UpdateApprovalRuleTemplateContentResponsePrivate(
    UpdateApprovalRuleTemplateContentResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit UpdateApprovalRuleTemplateContent response element from \a xml.
 */
void UpdateApprovalRuleTemplateContentResponsePrivate::parseUpdateApprovalRuleTemplateContentResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateApprovalRuleTemplateContentResponse"));
    Q_UNUSED(xml) ///< @todo
}
