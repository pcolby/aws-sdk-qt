...
#include "createapprovalruletemplaterequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::CreateApprovalRuleTemplateRequest
 * \brief The CreateApprovalRuleTemplateRequest class provides an interface for CodeCommit CreateApprovalRuleTemplate requests.
 *
 ...
 */
CreateApprovalRuleTemplateRequest::CreateApprovalRuleTemplateRequest(const CreateApprovalRuleTemplateRequest &other)
    : CodeCommitRequest(new CreateApprovalRuleTemplateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateApprovalRuleTemplateRequest object.
 */
CreateApprovalRuleTemplateRequest::CreateApprovalRuleTemplateRequest()
    : CodeCommitRequest(new CreateApprovalRuleTemplateRequestPrivate(CodeCommitRequest::CreateApprovalRuleTemplateAction, this))
{
 ...
 * \reimp
 */
bool CreateApprovalRuleTemplateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateApprovalRuleTemplateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateApprovalRuleTemplateRequest::response(QNetworkReply * const reply) const
{
    return new CreateApprovalRuleTemplateResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::CreateApprovalRuleTemplateRequestPrivate
 * \brief The CreateApprovalRuleTemplateRequestPrivate class provides private implementation for CreateApprovalRuleTemplateRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a CreateApprovalRuleTemplateRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
CreateApprovalRuleTemplateRequestPrivate::CreateApprovalRuleTemplateRequestPrivate(
    const CodeCommitRequest::Action action, CreateApprovalRuleTemplateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateApprovalRuleTemplateRequest
 * class' copy constructor.
 */
CreateApprovalRuleTemplateRequestPrivate::CreateApprovalRuleTemplateRequestPrivate(
    const CreateApprovalRuleTemplateRequestPrivate &other, CreateApprovalRuleTemplateRequest * const q)
