...
#include "batchgetcommitsresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::BatchGetCommitsResponse
 * \brief The BatchGetCommitsResponse class provides an interace for CodeCommit BatchGetCommits responses.
 *
...
/*!
 * Constructs a BatchGetCommitsResponse object for \a reply to \a request, with parent \a parent.
 */
BatchGetCommitsResponse::BatchGetCommitsResponse(
        const BatchGetCommitsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new BatchGetCommitsResponsePrivate(this), parent)
{
    setRequest(new BatchGetCommitsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit BatchGetCommits \a response.
 */
void BatchGetCommitsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(BatchGetCommitsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::BatchGetCommitsResponsePrivate
 * \brief The BatchGetCommitsResponsePrivate class provides private implementation for BatchGetCommitsResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a BatchGetCommitsResponsePrivate object with public implementation \a q.
 */
BatchGetCommitsResponsePrivate::BatchGetCommitsResponsePrivate(
    BatchGetCommitsResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit BatchGetCommits response element from \a xml.
 */
void BatchGetCommitsResponsePrivate::parseBatchGetCommitsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("BatchGetCommitsResponse"));
    Q_UNUSED(xml) ///< @todo
}
