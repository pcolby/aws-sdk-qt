...
class QTAWS_EXPORT UpdatePullRequestApprovalStateResponsePrivate : public CodeCommitResponsePrivate {

public:

    UpdatePullRequestApprovalStateResponsePrivate(UpdatePullRequestApprovalStateResponse * const q);
