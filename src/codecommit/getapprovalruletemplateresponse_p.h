...
class QTAWS_EXPORT GetApprovalRuleTemplateResponsePrivate : public CodeCommitResponsePrivate {

public:

    GetApprovalRuleTemplateResponsePrivate(GetApprovalRuleTemplateResponse * const q);
