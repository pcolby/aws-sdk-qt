...
#include "associateapprovalruletemplatewithrepositoryrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::AssociateApprovalRuleTemplateWithRepositoryRequest
 * \brief The AssociateApprovalRuleTemplateWithRepositoryRequest class provides an interface for CodeCommit AssociateApprovalRuleTemplateWithRepository requests.
 *
 ...
 *
 * \sa CodeCommitClient::associateApprovalRuleTemplateWithRepository
 */

/*!
 * Constructs a copy of \a other.
 */
AssociateApprovalRuleTemplateWithRepositoryRequest::AssociateApprovalRuleTemplateWithRepositoryRequest(const AssociateApprovalRuleTemplateWithRepositoryRequest &other)
    : CodeCommitRequest(new AssociateApprovalRuleTemplateWithRepositoryRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AssociateApprovalRuleTemplateWithRepositoryRequest object.
 */
AssociateApprovalRuleTemplateWithRepositoryRequest::AssociateApprovalRuleTemplateWithRepositoryRequest()
    : CodeCommitRequest(new AssociateApprovalRuleTemplateWithRepositoryRequestPrivate(CodeCommitRequest::AssociateApprovalRuleTemplateWithRepositoryAction, this))
{
 ...
 * \reimp
 */
bool AssociateApprovalRuleTemplateWithRepositoryRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AssociateApprovalRuleTemplateWithRepositoryResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AssociateApprovalRuleTemplateWithRepositoryRequest::response(QNetworkReply * const reply) const
{
    return new AssociateApprovalRuleTemplateWithRepositoryResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::AssociateApprovalRuleTemplateWithRepositoryRequestPrivate
 * \brief The AssociateApprovalRuleTemplateWithRepositoryRequestPrivate class provides private implementation for AssociateApprovalRuleTemplateWithRepositoryRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a AssociateApprovalRuleTemplateWithRepositoryRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
AssociateApprovalRuleTemplateWithRepositoryRequestPrivate::AssociateApprovalRuleTemplateWithRepositoryRequestPrivate(
    const CodeCommitRequest::Action action, AssociateApprovalRuleTemplateWithRepositoryRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AssociateApprovalRuleTemplateWithRepositoryRequest
 * class' copy constructor.
 */
AssociateApprovalRuleTemplateWithRepositoryRequestPrivate::AssociateApprovalRuleTemplateWithRepositoryRequestPrivate(
    const AssociateApprovalRuleTemplateWithRepositoryRequestPrivate &other, AssociateApprovalRuleTemplateWithRepositoryRequest * const q)
