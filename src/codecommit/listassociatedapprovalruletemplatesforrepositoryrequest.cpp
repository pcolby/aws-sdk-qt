...
#include "listassociatedapprovalruletemplatesforrepositoryrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::ListAssociatedApprovalRuleTemplatesForRepositoryRequest
 * \brief The ListAssociatedApprovalRuleTemplatesForRepositoryRequest class provides an interface for CodeCommit ListAssociatedApprovalRuleTemplatesForRepository requests.
 *
 ...
 */
ListAssociatedApprovalRuleTemplatesForRepositoryRequest::ListAssociatedApprovalRuleTemplatesForRepositoryRequest(const ListAssociatedApprovalRuleTemplatesForRepositoryRequest &other)
    : CodeCommitRequest(new ListAssociatedApprovalRuleTemplatesForRepositoryRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListAssociatedApprovalRuleTemplatesForRepositoryRequest object.
 */
ListAssociatedApprovalRuleTemplatesForRepositoryRequest::ListAssociatedApprovalRuleTemplatesForRepositoryRequest()
    : CodeCommitRequest(new ListAssociatedApprovalRuleTemplatesForRepositoryRequestPrivate(CodeCommitRequest::ListAssociatedApprovalRuleTemplatesForRepositoryAction, this))
{
 ...
 * \reimp
 */
bool ListAssociatedApprovalRuleTemplatesForRepositoryRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListAssociatedApprovalRuleTemplatesForRepositoryResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListAssociatedApprovalRuleTemplatesForRepositoryRequest::response(QNetworkReply * const reply) const
{
    return new ListAssociatedApprovalRuleTemplatesForRepositoryResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::ListAssociatedApprovalRuleTemplatesForRepositoryRequestPrivate
 * \brief The ListAssociatedApprovalRuleTemplatesForRepositoryRequestPrivate class provides private implementation for ListAssociatedApprovalRuleTemplatesForRepositoryRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a ListAssociatedApprovalRuleTemplatesForRepositoryRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
ListAssociatedApprovalRuleTemplatesForRepositoryRequestPrivate::ListAssociatedApprovalRuleTemplatesForRepositoryRequestPrivate(
    const CodeCommitRequest::Action action, ListAssociatedApprovalRuleTemplatesForRepositoryRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListAssociatedApprovalRuleTemplatesForRepositoryRequest
 * class' copy constructor.
 */
ListAssociatedApprovalRuleTemplatesForRepositoryRequestPrivate::ListAssociatedApprovalRuleTemplatesForRepositoryRequestPrivate(
    const ListAssociatedApprovalRuleTemplatesForRepositoryRequestPrivate &other, ListAssociatedApprovalRuleTemplatesForRepositoryRequest * const q)
