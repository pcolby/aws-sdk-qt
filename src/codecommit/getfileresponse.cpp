...
/*!
 * \class QtAws::CodeCommit::GetFileResponse
 * \brief The GetFileResponse class provides an interace for CodeCommit GetFile responses.
 *
...
/*!
 * Constructs a GetFileResponse object for \a reply to \a request, with parent \a parent.
 */
GetFileResponse::GetFileResponse(
        const GetFileRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new GetFileResponsePrivate(this), parent)
{
    setRequest(new GetFileRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit GetFile \a response.
 */
void GetFileResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetFileResponse);
...
/*!
 * \class QtAws::CodeCommit::GetFileResponsePrivate
 * \brief The GetFileResponsePrivate class provides private implementation for GetFileResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a GetFileResponsePrivate object with public implementation \a q.
 */
GetFileResponsePrivate::GetFileResponsePrivate(
    GetFileResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit GetFile response element from \a xml.
 */
void GetFileResponsePrivate::parseGetFileResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetFileResponse"));
    Q_UNUSED(xml) ///< @todo
}
