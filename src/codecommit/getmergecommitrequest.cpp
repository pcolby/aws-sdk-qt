...
#include "getmergecommitrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::GetMergeCommitRequest
 * \brief The GetMergeCommitRequest class provides an interface for CodeCommit GetMergeCommit requests.
 *
 ...
 *
 * \sa CodeCommitClient::getMergeCommit
 */

/*!
 * Constructs a copy of \a other.
 */
GetMergeCommitRequest::GetMergeCommitRequest(const GetMergeCommitRequest &other)
    : CodeCommitRequest(new GetMergeCommitRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetMergeCommitRequest object.
 */
GetMergeCommitRequest::GetMergeCommitRequest()
    : CodeCommitRequest(new GetMergeCommitRequestPrivate(CodeCommitRequest::GetMergeCommitAction, this))
{
 ...
 * \reimp
 */
bool GetMergeCommitRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetMergeCommitResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetMergeCommitRequest::response(QNetworkReply * const reply) const
{
    return new GetMergeCommitResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::GetMergeCommitRequestPrivate
 * \brief The GetMergeCommitRequestPrivate class provides private implementation for GetMergeCommitRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a GetMergeCommitRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
GetMergeCommitRequestPrivate::GetMergeCommitRequestPrivate(
    const CodeCommitRequest::Action action, GetMergeCommitRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetMergeCommitRequest
 * class' copy constructor.
 */
GetMergeCommitRequestPrivate::GetMergeCommitRequestPrivate(
    const GetMergeCommitRequestPrivate &other, GetMergeCommitRequest * const q)
