...
#include "deleteapprovalruletemplateresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::DeleteApprovalRuleTemplateResponse
 * \brief The DeleteApprovalRuleTemplateResponse class provides an interace for CodeCommit DeleteApprovalRuleTemplate responses.
 *
...
/*!
 * Constructs a DeleteApprovalRuleTemplateResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteApprovalRuleTemplateResponse::DeleteApprovalRuleTemplateResponse(
        const DeleteApprovalRuleTemplateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new DeleteApprovalRuleTemplateResponsePrivate(this), parent)
{
    setRequest(new DeleteApprovalRuleTemplateRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit DeleteApprovalRuleTemplate \a response.
 */
void DeleteApprovalRuleTemplateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteApprovalRuleTemplateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::DeleteApprovalRuleTemplateResponsePrivate
 * \brief The DeleteApprovalRuleTemplateResponsePrivate class provides private implementation for DeleteApprovalRuleTemplateResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a DeleteApprovalRuleTemplateResponsePrivate object with public implementation \a q.
 */
DeleteApprovalRuleTemplateResponsePrivate::DeleteApprovalRuleTemplateResponsePrivate(
    DeleteApprovalRuleTemplateResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit DeleteApprovalRuleTemplate response element from \a xml.
 */
void DeleteApprovalRuleTemplateResponsePrivate::parseDeleteApprovalRuleTemplateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteApprovalRuleTemplateResponse"));
    Q_UNUSED(xml) ///< @todo
}
