...
/*!
 * \class QtAws::CodeCommit::GetFolderRequest
 * \brief The GetFolderRequest class provides an interface for CodeCommit GetFolder requests.
 *
...
GetFolderRequest::GetFolderRequest(const GetFolderRequest &other)
    : CodeCommitRequest(new GetFolderRequestPrivate(*other.d_func(), this))
{
...
GetFolderRequest::GetFolderRequest()
    : CodeCommitRequest(new GetFolderRequestPrivate(CodeCommitRequest::GetFolderAction, this))
{
...
/*!
 * \class QtAws::CodeCommit::GetFolderRequestPrivate
...
/*!
 * Constructs a GetFolderRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
GetFolderRequestPrivate::GetFolderRequestPrivate(
    const CodeCommitRequest::Action action, GetFolderRequest * const q)
