...
/*!
 * \class QtAws::CodeCommit::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for CodeCommit UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : CodeCommitRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : CodeCommitRequest(new UntagResourceRequestPrivate(CodeCommitRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::CodeCommit::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const CodeCommitRequest::Action action, UntagResourceRequest * const q)
