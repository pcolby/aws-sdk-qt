...
#include "createpullrequestapprovalruleresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::CreatePullRequestApprovalRuleResponse
 * \brief The CreatePullRequestApprovalRuleResponse class provides an interace for CodeCommit CreatePullRequestApprovalRule responses.
 *
...
/*!
 * Constructs a CreatePullRequestApprovalRuleResponse object for \a reply to \a request, with parent \a parent.
 */
CreatePullRequestApprovalRuleResponse::CreatePullRequestApprovalRuleResponse(
        const CreatePullRequestApprovalRuleRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new CreatePullRequestApprovalRuleResponsePrivate(this), parent)
{
    setRequest(new CreatePullRequestApprovalRuleRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit CreatePullRequestApprovalRule \a response.
 */
void CreatePullRequestApprovalRuleResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreatePullRequestApprovalRuleResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::CreatePullRequestApprovalRuleResponsePrivate
 * \brief The CreatePullRequestApprovalRuleResponsePrivate class provides private implementation for CreatePullRequestApprovalRuleResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a CreatePullRequestApprovalRuleResponsePrivate object with public implementation \a q.
 */
CreatePullRequestApprovalRuleResponsePrivate::CreatePullRequestApprovalRuleResponsePrivate(
    CreatePullRequestApprovalRuleResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit CreatePullRequestApprovalRule response element from \a xml.
 */
void CreatePullRequestApprovalRuleResponsePrivate::parseCreatePullRequestApprovalRuleResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreatePullRequestApprovalRuleResponse"));
    Q_UNUSED(xml) ///< @todo
}
