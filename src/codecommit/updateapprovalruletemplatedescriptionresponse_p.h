...
class QTAWS_EXPORT UpdateApprovalRuleTemplateDescriptionResponsePrivate : public CodeCommitResponsePrivate {

public:

    UpdateApprovalRuleTemplateDescriptionResponsePrivate(UpdateApprovalRuleTemplateDescriptionResponse * const q);
