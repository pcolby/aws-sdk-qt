...
#include "batchdescribemergeconflictsrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::BatchDescribeMergeConflictsRequest
 * \brief The BatchDescribeMergeConflictsRequest class provides an interface for CodeCommit BatchDescribeMergeConflicts requests.
 *
 ...
 *
 * \sa CodeCommitClient::batchDescribeMergeConflicts
 */

/*!
 * Constructs a copy of \a other.
 */
BatchDescribeMergeConflictsRequest::BatchDescribeMergeConflictsRequest(const BatchDescribeMergeConflictsRequest &other)
    : CodeCommitRequest(new BatchDescribeMergeConflictsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a BatchDescribeMergeConflictsRequest object.
 */
BatchDescribeMergeConflictsRequest::BatchDescribeMergeConflictsRequest()
    : CodeCommitRequest(new BatchDescribeMergeConflictsRequestPrivate(CodeCommitRequest::BatchDescribeMergeConflictsAction, this))
{
 ...
 * \reimp
 */
bool BatchDescribeMergeConflictsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BatchDescribeMergeConflictsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BatchDescribeMergeConflictsRequest::response(QNetworkReply * const reply) const
{
    return new BatchDescribeMergeConflictsResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::BatchDescribeMergeConflictsRequestPrivate
 * \brief The BatchDescribeMergeConflictsRequestPrivate class provides private implementation for BatchDescribeMergeConflictsRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a BatchDescribeMergeConflictsRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
BatchDescribeMergeConflictsRequestPrivate::BatchDescribeMergeConflictsRequestPrivate(
    const CodeCommitRequest::Action action, BatchDescribeMergeConflictsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the BatchDescribeMergeConflictsRequest
 * class' copy constructor.
 */
BatchDescribeMergeConflictsRequestPrivate::BatchDescribeMergeConflictsRequestPrivate(
    const BatchDescribeMergeConflictsRequestPrivate &other, BatchDescribeMergeConflictsRequest * const q)
