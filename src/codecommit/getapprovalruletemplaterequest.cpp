...
#include "getapprovalruletemplaterequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::GetApprovalRuleTemplateRequest
 * \brief The GetApprovalRuleTemplateRequest class provides an interface for CodeCommit GetApprovalRuleTemplate requests.
 *
 ...
 *
 * \sa CodeCommitClient::getApprovalRuleTemplate
 */

/*!
 * Constructs a copy of \a other.
 */
GetApprovalRuleTemplateRequest::GetApprovalRuleTemplateRequest(const GetApprovalRuleTemplateRequest &other)
    : CodeCommitRequest(new GetApprovalRuleTemplateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetApprovalRuleTemplateRequest object.
 */
GetApprovalRuleTemplateRequest::GetApprovalRuleTemplateRequest()
    : CodeCommitRequest(new GetApprovalRuleTemplateRequestPrivate(CodeCommitRequest::GetApprovalRuleTemplateAction, this))
{
 ...
 * \reimp
 */
bool GetApprovalRuleTemplateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetApprovalRuleTemplateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetApprovalRuleTemplateRequest::response(QNetworkReply * const reply) const
{
    return new GetApprovalRuleTemplateResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::GetApprovalRuleTemplateRequestPrivate
 * \brief The GetApprovalRuleTemplateRequestPrivate class provides private implementation for GetApprovalRuleTemplateRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a GetApprovalRuleTemplateRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
GetApprovalRuleTemplateRequestPrivate::GetApprovalRuleTemplateRequestPrivate(
    const CodeCommitRequest::Action action, GetApprovalRuleTemplateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetApprovalRuleTemplateRequest
 * class' copy constructor.
 */
GetApprovalRuleTemplateRequestPrivate::GetApprovalRuleTemplateRequestPrivate(
    const GetApprovalRuleTemplateRequestPrivate &other, GetApprovalRuleTemplateRequest * const q)
