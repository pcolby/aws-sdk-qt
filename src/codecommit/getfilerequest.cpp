...
/*!
 * \class QtAws::CodeCommit::GetFileRequest
 * \brief The GetFileRequest class provides an interface for CodeCommit GetFile requests.
 *
 ...
 *
 * \sa CodeCommitClient::getFile
 */

/*!
 * Constructs a copy of \a other.
 */
GetFileRequest::GetFileRequest(const GetFileRequest &other)
    : CodeCommitRequest(new GetFileRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetFileRequest object.
 */
GetFileRequest::GetFileRequest()
    : CodeCommitRequest(new GetFileRequestPrivate(CodeCommitRequest::GetFileAction, this))
{
 ...
 * \reimp
 */
bool GetFileRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetFileResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetFileRequest::response(QNetworkReply * const reply) const
{
    return new GetFileResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::GetFileRequestPrivate
 * \brief The GetFileRequestPrivate class provides private implementation for GetFileRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a GetFileRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
GetFileRequestPrivate::GetFileRequestPrivate(
    const CodeCommitRequest::Action action, GetFileRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetFileRequest
 * class' copy constructor.
 */
GetFileRequestPrivate::GetFileRequestPrivate(
    const GetFileRequestPrivate &other, GetFileRequest * const q)
