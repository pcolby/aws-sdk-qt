...
class QTAWS_EXPORT UpdatePullRequestTitleRequestPrivate : public CodeCommitRequestPrivate {

public:
    UpdatePullRequestTitleRequestPrivate(const CodeCommit::Action action,
