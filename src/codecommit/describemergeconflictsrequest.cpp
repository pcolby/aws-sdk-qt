...
#include "describemergeconflictsrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::DescribeMergeConflictsRequest
 * \brief The DescribeMergeConflictsRequest class provides an interface for CodeCommit DescribeMergeConflicts requests.
 *
 ...
 *
 * \sa CodeCommitClient::describeMergeConflicts
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeMergeConflictsRequest::DescribeMergeConflictsRequest(const DescribeMergeConflictsRequest &other)
    : CodeCommitRequest(new DescribeMergeConflictsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeMergeConflictsRequest object.
 */
DescribeMergeConflictsRequest::DescribeMergeConflictsRequest()
    : CodeCommitRequest(new DescribeMergeConflictsRequestPrivate(CodeCommitRequest::DescribeMergeConflictsAction, this))
{
 ...
 * \reimp
 */
bool DescribeMergeConflictsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeMergeConflictsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeMergeConflictsRequest::response(QNetworkReply * const reply) const
{
    return new DescribeMergeConflictsResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::DescribeMergeConflictsRequestPrivate
 * \brief The DescribeMergeConflictsRequestPrivate class provides private implementation for DescribeMergeConflictsRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a DescribeMergeConflictsRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
DescribeMergeConflictsRequestPrivate::DescribeMergeConflictsRequestPrivate(
    const CodeCommitRequest::Action action, DescribeMergeConflictsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeMergeConflictsRequest
 * class' copy constructor.
 */
DescribeMergeConflictsRequestPrivate::DescribeMergeConflictsRequestPrivate(
    const DescribeMergeConflictsRequestPrivate &other, DescribeMergeConflictsRequest * const q)
