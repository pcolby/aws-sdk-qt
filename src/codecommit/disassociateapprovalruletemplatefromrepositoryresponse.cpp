...
#include "disassociateapprovalruletemplatefromrepositoryresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::DisassociateApprovalRuleTemplateFromRepositoryResponse
 * \brief The DisassociateApprovalRuleTemplateFromRepositoryResponse class provides an interace for CodeCommit DisassociateApprovalRuleTemplateFromRepository responses.
 *
...
/*!
 * Constructs a DisassociateApprovalRuleTemplateFromRepositoryResponse object for \a reply to \a request, with parent \a parent.
 */
DisassociateApprovalRuleTemplateFromRepositoryResponse::DisassociateApprovalRuleTemplateFromRepositoryResponse(
        const DisassociateApprovalRuleTemplateFromRepositoryRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new DisassociateApprovalRuleTemplateFromRepositoryResponsePrivate(this), parent)
{
    setRequest(new DisassociateApprovalRuleTemplateFromRepositoryRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit DisassociateApprovalRuleTemplateFromRepository \a response.
 */
void DisassociateApprovalRuleTemplateFromRepositoryResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DisassociateApprovalRuleTemplateFromRepositoryResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::DisassociateApprovalRuleTemplateFromRepositoryResponsePrivate
 * \brief The DisassociateApprovalRuleTemplateFromRepositoryResponsePrivate class provides private implementation for DisassociateApprovalRuleTemplateFromRepositoryResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a DisassociateApprovalRuleTemplateFromRepositoryResponsePrivate object with public implementation \a q.
 */
DisassociateApprovalRuleTemplateFromRepositoryResponsePrivate::DisassociateApprovalRuleTemplateFromRepositoryResponsePrivate(
    DisassociateApprovalRuleTemplateFromRepositoryResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit DisassociateApprovalRuleTemplateFromRepository response element from \a xml.
 */
void DisassociateApprovalRuleTemplateFromRepositoryResponsePrivate::parseDisassociateApprovalRuleTemplateFromRepositoryResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DisassociateApprovalRuleTemplateFromRepositoryResponse"));
    Q_UNUSED(xml) ///< @todo
}
