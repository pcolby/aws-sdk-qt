...
class QTAWSCODECOMMIT_EXPORT DescribePullRequestEventsResponse : public CodeCommitResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribePullRequestEventsRequest * request() const Q_DECL_OVERRIDE;
