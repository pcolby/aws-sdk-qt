...
#include "mergebranchesbyfastforwardrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::MergeBranchesByFastForwardRequest
 * \brief The MergeBranchesByFastForwardRequest class provides an interface for CodeCommit MergeBranchesByFastForward requests.
 *
 ...
 *
 * \sa CodeCommitClient::mergeBranchesByFastForward
 */

/*!
 * Constructs a copy of \a other.
 */
MergeBranchesByFastForwardRequest::MergeBranchesByFastForwardRequest(const MergeBranchesByFastForwardRequest &other)
    : CodeCommitRequest(new MergeBranchesByFastForwardRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a MergeBranchesByFastForwardRequest object.
 */
MergeBranchesByFastForwardRequest::MergeBranchesByFastForwardRequest()
    : CodeCommitRequest(new MergeBranchesByFastForwardRequestPrivate(CodeCommitRequest::MergeBranchesByFastForwardAction, this))
{
 ...
 * \reimp
 */
bool MergeBranchesByFastForwardRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a MergeBranchesByFastForwardResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * MergeBranchesByFastForwardRequest::response(QNetworkReply * const reply) const
{
    return new MergeBranchesByFastForwardResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::MergeBranchesByFastForwardRequestPrivate
 * \brief The MergeBranchesByFastForwardRequestPrivate class provides private implementation for MergeBranchesByFastForwardRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a MergeBranchesByFastForwardRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
MergeBranchesByFastForwardRequestPrivate::MergeBranchesByFastForwardRequestPrivate(
    const CodeCommitRequest::Action action, MergeBranchesByFastForwardRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the MergeBranchesByFastForwardRequest
 * class' copy constructor.
 */
MergeBranchesByFastForwardRequestPrivate::MergeBranchesByFastForwardRequestPrivate(
    const MergeBranchesByFastForwardRequestPrivate &other, MergeBranchesByFastForwardRequest * const q)
