...
/*!
 * \class QtAws::CodeCommit::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for CodeCommit UntagResource responses.
 *
 ...
 *
 * \sa CodeCommitClient::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : CodeCommitResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(CodeCommitResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeCommit UntagResource \a response.
 */
...
/*!
 * \class QtAws::CodeCommit::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit UntagResource response element from \a xml.
 */
