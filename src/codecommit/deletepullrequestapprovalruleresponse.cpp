...
#include "deletepullrequestapprovalruleresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::DeletePullRequestApprovalRuleResponse
 * \brief The DeletePullRequestApprovalRuleResponse class provides an interace for CodeCommit DeletePullRequestApprovalRule responses.
 *
...
/*!
 * Constructs a DeletePullRequestApprovalRuleResponse object for \a reply to \a request, with parent \a parent.
 */
DeletePullRequestApprovalRuleResponse::DeletePullRequestApprovalRuleResponse(
        const DeletePullRequestApprovalRuleRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new DeletePullRequestApprovalRuleResponsePrivate(this), parent)
{
    setRequest(new DeletePullRequestApprovalRuleRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit DeletePullRequestApprovalRule \a response.
 */
void DeletePullRequestApprovalRuleResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeletePullRequestApprovalRuleResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::DeletePullRequestApprovalRuleResponsePrivate
 * \brief The DeletePullRequestApprovalRuleResponsePrivate class provides private implementation for DeletePullRequestApprovalRuleResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a DeletePullRequestApprovalRuleResponsePrivate object with public implementation \a q.
 */
DeletePullRequestApprovalRuleResponsePrivate::DeletePullRequestApprovalRuleResponsePrivate(
    DeletePullRequestApprovalRuleResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit DeletePullRequestApprovalRule response element from \a xml.
 */
void DeletePullRequestApprovalRuleResponsePrivate::parseDeletePullRequestApprovalRuleResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeletePullRequestApprovalRuleResponse"));
    Q_UNUSED(xml) ///< @todo
}
