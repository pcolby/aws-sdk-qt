...
/*!
 * \class QtAws::CodeCommit::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for CodeCommit ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : CodeCommitRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : CodeCommitRequest(new ListTagsForResourceRequestPrivate(CodeCommitRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::CodeCommit::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const CodeCommitRequest::Action action, ListTagsForResourceRequest * const q)
