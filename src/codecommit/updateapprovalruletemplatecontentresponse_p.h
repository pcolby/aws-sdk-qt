...
class QTAWS_EXPORT UpdateApprovalRuleTemplateContentResponsePrivate : public CodeCommitResponsePrivate {

public:

    UpdateApprovalRuleTemplateContentResponsePrivate(UpdateApprovalRuleTemplateContentResponse * const q);
