...
/*!
 * \class QtAws::CodeCommit::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for CodeCommit ListTagsForResource responses.
 *
 ...
 *
 * \sa CodeCommitClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : CodeCommitResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(CodeCommitResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeCommit ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::CodeCommit::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit ListTagsForResource response element from \a xml.
 */
