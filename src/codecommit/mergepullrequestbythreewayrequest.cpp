...
#include "mergepullrequestbythreewayrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::MergePullRequestByThreeWayRequest
 * \brief The MergePullRequestByThreeWayRequest class provides an interface for CodeCommit MergePullRequestByThreeWay requests.
 *
 ...
 *
 * \sa CodeCommitClient::mergePullRequestByThreeWay
 */

/*!
 * Constructs a copy of \a other.
 */
MergePullRequestByThreeWayRequest::MergePullRequestByThreeWayRequest(const MergePullRequestByThreeWayRequest &other)
    : CodeCommitRequest(new MergePullRequestByThreeWayRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a MergePullRequestByThreeWayRequest object.
 */
MergePullRequestByThreeWayRequest::MergePullRequestByThreeWayRequest()
    : CodeCommitRequest(new MergePullRequestByThreeWayRequestPrivate(CodeCommitRequest::MergePullRequestByThreeWayAction, this))
{
 ...
 * \reimp
 */
bool MergePullRequestByThreeWayRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a MergePullRequestByThreeWayResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * MergePullRequestByThreeWayRequest::response(QNetworkReply * const reply) const
{
    return new MergePullRequestByThreeWayResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::MergePullRequestByThreeWayRequestPrivate
 * \brief The MergePullRequestByThreeWayRequestPrivate class provides private implementation for MergePullRequestByThreeWayRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a MergePullRequestByThreeWayRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
MergePullRequestByThreeWayRequestPrivate::MergePullRequestByThreeWayRequestPrivate(
    const CodeCommitRequest::Action action, MergePullRequestByThreeWayRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the MergePullRequestByThreeWayRequest
 * class' copy constructor.
 */
MergePullRequestByThreeWayRequestPrivate::MergePullRequestByThreeWayRequestPrivate(
    const MergePullRequestByThreeWayRequestPrivate &other, MergePullRequestByThreeWayRequest * const q)
