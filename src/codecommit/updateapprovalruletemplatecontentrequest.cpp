...
#include "updateapprovalruletemplatecontentrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::UpdateApprovalRuleTemplateContentRequest
 * \brief The UpdateApprovalRuleTemplateContentRequest class provides an interface for CodeCommit UpdateApprovalRuleTemplateContent requests.
 *
 ...
 */
UpdateApprovalRuleTemplateContentRequest::UpdateApprovalRuleTemplateContentRequest(const UpdateApprovalRuleTemplateContentRequest &other)
    : CodeCommitRequest(new UpdateApprovalRuleTemplateContentRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateApprovalRuleTemplateContentRequest object.
 */
UpdateApprovalRuleTemplateContentRequest::UpdateApprovalRuleTemplateContentRequest()
    : CodeCommitRequest(new UpdateApprovalRuleTemplateContentRequestPrivate(CodeCommitRequest::UpdateApprovalRuleTemplateContentAction, this))
{
 ...
 * \reimp
 */
bool UpdateApprovalRuleTemplateContentRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateApprovalRuleTemplateContentResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateApprovalRuleTemplateContentRequest::response(QNetworkReply * const reply) const
{
    return new UpdateApprovalRuleTemplateContentResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::UpdateApprovalRuleTemplateContentRequestPrivate
 * \brief The UpdateApprovalRuleTemplateContentRequestPrivate class provides private implementation for UpdateApprovalRuleTemplateContentRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a UpdateApprovalRuleTemplateContentRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
UpdateApprovalRuleTemplateContentRequestPrivate::UpdateApprovalRuleTemplateContentRequestPrivate(
    const CodeCommitRequest::Action action, UpdateApprovalRuleTemplateContentRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateApprovalRuleTemplateContentRequest
 * class' copy constructor.
 */
UpdateApprovalRuleTemplateContentRequestPrivate::UpdateApprovalRuleTemplateContentRequestPrivate(
    const UpdateApprovalRuleTemplateContentRequestPrivate &other, UpdateApprovalRuleTemplateContentRequest * const q)
