 ...
 *
 * \brief The GetCommentsForComparedCommitRequest class encapsulates CodeCommit GetCommentsForComparedCommit requests.
 *
 * \ingroup CodeCommit
 *
 ...
 *
 * \sa CodeCommitClient::getCommentsForComparedCommit
 */
