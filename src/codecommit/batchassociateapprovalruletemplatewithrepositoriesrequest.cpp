...
#include "batchassociateapprovalruletemplatewithrepositoriesrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::BatchAssociateApprovalRuleTemplateWithRepositoriesRequest
 * \brief The BatchAssociateApprovalRuleTemplateWithRepositoriesRequest class provides an interface for CodeCommit BatchAssociateApprovalRuleTemplateWithRepositories requests.
 *
 ...
 *
 * \sa CodeCommitClient::batchAssociateApprovalRuleTemplateWithRepositories
 */

/*!
 * Constructs a copy of \a other.
 */
BatchAssociateApprovalRuleTemplateWithRepositoriesRequest::BatchAssociateApprovalRuleTemplateWithRepositoriesRequest(const BatchAssociateApprovalRuleTemplateWithRepositoriesRequest &other)
    : CodeCommitRequest(new BatchAssociateApprovalRuleTemplateWithRepositoriesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a BatchAssociateApprovalRuleTemplateWithRepositoriesRequest object.
 */
BatchAssociateApprovalRuleTemplateWithRepositoriesRequest::BatchAssociateApprovalRuleTemplateWithRepositoriesRequest()
    : CodeCommitRequest(new BatchAssociateApprovalRuleTemplateWithRepositoriesRequestPrivate(CodeCommitRequest::BatchAssociateApprovalRuleTemplateWithRepositoriesAction, this))
{
 ...
 * \reimp
 */
bool BatchAssociateApprovalRuleTemplateWithRepositoriesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BatchAssociateApprovalRuleTemplateWithRepositoriesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BatchAssociateApprovalRuleTemplateWithRepositoriesRequest::response(QNetworkReply * const reply) const
{
    return new BatchAssociateApprovalRuleTemplateWithRepositoriesResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::BatchAssociateApprovalRuleTemplateWithRepositoriesRequestPrivate
 * \brief The BatchAssociateApprovalRuleTemplateWithRepositoriesRequestPrivate class provides private implementation for BatchAssociateApprovalRuleTemplateWithRepositoriesRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a BatchAssociateApprovalRuleTemplateWithRepositoriesRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
BatchAssociateApprovalRuleTemplateWithRepositoriesRequestPrivate::BatchAssociateApprovalRuleTemplateWithRepositoriesRequestPrivate(
    const CodeCommitRequest::Action action, BatchAssociateApprovalRuleTemplateWithRepositoriesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the BatchAssociateApprovalRuleTemplateWithRepositoriesRequest
 * class' copy constructor.
 */
BatchAssociateApprovalRuleTemplateWithRepositoriesRequestPrivate::BatchAssociateApprovalRuleTemplateWithRepositoriesRequestPrivate(
    const BatchAssociateApprovalRuleTemplateWithRepositoriesRequestPrivate &other, BatchAssociateApprovalRuleTemplateWithRepositoriesRequest * const q)
