...
#include "associateapprovalruletemplatewithrepositoryresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::AssociateApprovalRuleTemplateWithRepositoryResponse
 * \brief The AssociateApprovalRuleTemplateWithRepositoryResponse class provides an interace for CodeCommit AssociateApprovalRuleTemplateWithRepository responses.
 *
...
/*!
 * Constructs a AssociateApprovalRuleTemplateWithRepositoryResponse object for \a reply to \a request, with parent \a parent.
 */
AssociateApprovalRuleTemplateWithRepositoryResponse::AssociateApprovalRuleTemplateWithRepositoryResponse(
        const AssociateApprovalRuleTemplateWithRepositoryRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new AssociateApprovalRuleTemplateWithRepositoryResponsePrivate(this), parent)
{
    setRequest(new AssociateApprovalRuleTemplateWithRepositoryRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit AssociateApprovalRuleTemplateWithRepository \a response.
 */
void AssociateApprovalRuleTemplateWithRepositoryResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AssociateApprovalRuleTemplateWithRepositoryResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::AssociateApprovalRuleTemplateWithRepositoryResponsePrivate
 * \brief The AssociateApprovalRuleTemplateWithRepositoryResponsePrivate class provides private implementation for AssociateApprovalRuleTemplateWithRepositoryResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a AssociateApprovalRuleTemplateWithRepositoryResponsePrivate object with public implementation \a q.
 */
AssociateApprovalRuleTemplateWithRepositoryResponsePrivate::AssociateApprovalRuleTemplateWithRepositoryResponsePrivate(
    AssociateApprovalRuleTemplateWithRepositoryResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit AssociateApprovalRuleTemplateWithRepository response element from \a xml.
 */
void AssociateApprovalRuleTemplateWithRepositoryResponsePrivate::parseAssociateApprovalRuleTemplateWithRepositoryResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AssociateApprovalRuleTemplateWithRepositoryResponse"));
    Q_UNUSED(xml) ///< @todo
}
