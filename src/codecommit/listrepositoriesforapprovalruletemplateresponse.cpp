...
#include "listrepositoriesforapprovalruletemplateresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::ListRepositoriesForApprovalRuleTemplateResponse
 * \brief The ListRepositoriesForApprovalRuleTemplateResponse class provides an interace for CodeCommit ListRepositoriesForApprovalRuleTemplate responses.
 *
...
/*!
 * Constructs a ListRepositoriesForApprovalRuleTemplateResponse object for \a reply to \a request, with parent \a parent.
 */
ListRepositoriesForApprovalRuleTemplateResponse::ListRepositoriesForApprovalRuleTemplateResponse(
        const ListRepositoriesForApprovalRuleTemplateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new ListRepositoriesForApprovalRuleTemplateResponsePrivate(this), parent)
{
    setRequest(new ListRepositoriesForApprovalRuleTemplateRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit ListRepositoriesForApprovalRuleTemplate \a response.
 */
void ListRepositoriesForApprovalRuleTemplateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListRepositoriesForApprovalRuleTemplateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::ListRepositoriesForApprovalRuleTemplateResponsePrivate
 * \brief The ListRepositoriesForApprovalRuleTemplateResponsePrivate class provides private implementation for ListRepositoriesForApprovalRuleTemplateResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a ListRepositoriesForApprovalRuleTemplateResponsePrivate object with public implementation \a q.
 */
ListRepositoriesForApprovalRuleTemplateResponsePrivate::ListRepositoriesForApprovalRuleTemplateResponsePrivate(
    ListRepositoriesForApprovalRuleTemplateResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit ListRepositoriesForApprovalRuleTemplate response element from \a xml.
 */
void ListRepositoriesForApprovalRuleTemplateResponsePrivate::parseListRepositoriesForApprovalRuleTemplateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListRepositoriesForApprovalRuleTemplateResponse"));
    Q_UNUSED(xml) ///< @todo
}
