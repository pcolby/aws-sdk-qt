...
/*!
 * \class QtAws::CodeCommit::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for CodeCommit TagResource responses.
 *
 ...
 *
 * \sa CodeCommitClient::tagResource
 */
...
TagResourceResponse::TagResourceResponse(
    ...
    : CodeCommitResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(CodeCommitResponse::request());
}

/*!
 * \reimp
 * Parses a successful CodeCommit TagResource \a response.
 */
...
/*!
 * \class QtAws::CodeCommit::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit TagResource response element from \a xml.
 */
