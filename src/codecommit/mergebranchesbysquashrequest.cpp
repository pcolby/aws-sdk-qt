...
#include "mergebranchesbysquashrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::MergeBranchesBySquashRequest
 * \brief The MergeBranchesBySquashRequest class provides an interface for CodeCommit MergeBranchesBySquash requests.
 *
 ...
 *
 * \sa CodeCommitClient::mergeBranchesBySquash
 */

/*!
 * Constructs a copy of \a other.
 */
MergeBranchesBySquashRequest::MergeBranchesBySquashRequest(const MergeBranchesBySquashRequest &other)
    : CodeCommitRequest(new MergeBranchesBySquashRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a MergeBranchesBySquashRequest object.
 */
MergeBranchesBySquashRequest::MergeBranchesBySquashRequest()
    : CodeCommitRequest(new MergeBranchesBySquashRequestPrivate(CodeCommitRequest::MergeBranchesBySquashAction, this))
{
 ...
 * \reimp
 */
bool MergeBranchesBySquashRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a MergeBranchesBySquashResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * MergeBranchesBySquashRequest::response(QNetworkReply * const reply) const
{
    return new MergeBranchesBySquashResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::MergeBranchesBySquashRequestPrivate
 * \brief The MergeBranchesBySquashRequestPrivate class provides private implementation for MergeBranchesBySquashRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a MergeBranchesBySquashRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
MergeBranchesBySquashRequestPrivate::MergeBranchesBySquashRequestPrivate(
    const CodeCommitRequest::Action action, MergeBranchesBySquashRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the MergeBranchesBySquashRequest
 * class' copy constructor.
 */
MergeBranchesBySquashRequestPrivate::MergeBranchesBySquashRequestPrivate(
    const MergeBranchesBySquashRequestPrivate &other, MergeBranchesBySquashRequest * const q)
