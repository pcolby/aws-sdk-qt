...
#include "getcommentreactionsrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::GetCommentReactionsRequest
 * \brief The GetCommentReactionsRequest class provides an interface for CodeCommit GetCommentReactions requests.
 *
 ...
 */
GetCommentReactionsRequest::GetCommentReactionsRequest(const GetCommentReactionsRequest &other)
    : CodeCommitRequest(new GetCommentReactionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetCommentReactionsRequest object.
 */
GetCommentReactionsRequest::GetCommentReactionsRequest()
    : CodeCommitRequest(new GetCommentReactionsRequestPrivate(CodeCommitRequest::GetCommentReactionsAction, this))
{
 ...
 * \reimp
 */
bool GetCommentReactionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetCommentReactionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetCommentReactionsRequest::response(QNetworkReply * const reply) const
{
    return new GetCommentReactionsResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::GetCommentReactionsRequestPrivate
 * \brief The GetCommentReactionsRequestPrivate class provides private implementation for GetCommentReactionsRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a GetCommentReactionsRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
GetCommentReactionsRequestPrivate::GetCommentReactionsRequestPrivate(
    const CodeCommitRequest::Action action, GetCommentReactionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetCommentReactionsRequest
 * class' copy constructor.
 */
GetCommentReactionsRequestPrivate::GetCommentReactionsRequestPrivate(
    const GetCommentReactionsRequestPrivate &other, GetCommentReactionsRequest * const q)
