...
#include "batchassociateapprovalruletemplatewithrepositoriesresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::BatchAssociateApprovalRuleTemplateWithRepositoriesResponse
 * \brief The BatchAssociateApprovalRuleTemplateWithRepositoriesResponse class provides an interace for CodeCommit BatchAssociateApprovalRuleTemplateWithRepositories responses.
 *
...
/*!
 * Constructs a BatchAssociateApprovalRuleTemplateWithRepositoriesResponse object for \a reply to \a request, with parent \a parent.
 */
BatchAssociateApprovalRuleTemplateWithRepositoriesResponse::BatchAssociateApprovalRuleTemplateWithRepositoriesResponse(
        const BatchAssociateApprovalRuleTemplateWithRepositoriesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new BatchAssociateApprovalRuleTemplateWithRepositoriesResponsePrivate(this), parent)
{
    setRequest(new BatchAssociateApprovalRuleTemplateWithRepositoriesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit BatchAssociateApprovalRuleTemplateWithRepositories \a response.
 */
void BatchAssociateApprovalRuleTemplateWithRepositoriesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(BatchAssociateApprovalRuleTemplateWithRepositoriesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::BatchAssociateApprovalRuleTemplateWithRepositoriesResponsePrivate
 * \brief The BatchAssociateApprovalRuleTemplateWithRepositoriesResponsePrivate class provides private implementation for BatchAssociateApprovalRuleTemplateWithRepositoriesResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a BatchAssociateApprovalRuleTemplateWithRepositoriesResponsePrivate object with public implementation \a q.
 */
BatchAssociateApprovalRuleTemplateWithRepositoriesResponsePrivate::BatchAssociateApprovalRuleTemplateWithRepositoriesResponsePrivate(
    BatchAssociateApprovalRuleTemplateWithRepositoriesResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit BatchAssociateApprovalRuleTemplateWithRepositories response element from \a xml.
 */
void BatchAssociateApprovalRuleTemplateWithRepositoriesResponsePrivate::parseBatchAssociateApprovalRuleTemplateWithRepositoriesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("BatchAssociateApprovalRuleTemplateWithRepositoriesResponse"));
    Q_UNUSED(xml) ///< @todo
}
