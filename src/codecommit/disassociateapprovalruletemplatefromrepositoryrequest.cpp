...
#include "disassociateapprovalruletemplatefromrepositoryrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::DisassociateApprovalRuleTemplateFromRepositoryRequest
 * \brief The DisassociateApprovalRuleTemplateFromRepositoryRequest class provides an interface for CodeCommit DisassociateApprovalRuleTemplateFromRepository requests.
 *
 ...
 *
 * \sa CodeCommitClient::disassociateApprovalRuleTemplateFromRepository
 */

/*!
 * Constructs a copy of \a other.
 */
DisassociateApprovalRuleTemplateFromRepositoryRequest::DisassociateApprovalRuleTemplateFromRepositoryRequest(const DisassociateApprovalRuleTemplateFromRepositoryRequest &other)
    : CodeCommitRequest(new DisassociateApprovalRuleTemplateFromRepositoryRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DisassociateApprovalRuleTemplateFromRepositoryRequest object.
 */
DisassociateApprovalRuleTemplateFromRepositoryRequest::DisassociateApprovalRuleTemplateFromRepositoryRequest()
    : CodeCommitRequest(new DisassociateApprovalRuleTemplateFromRepositoryRequestPrivate(CodeCommitRequest::DisassociateApprovalRuleTemplateFromRepositoryAction, this))
{
 ...
 * \reimp
 */
bool DisassociateApprovalRuleTemplateFromRepositoryRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DisassociateApprovalRuleTemplateFromRepositoryResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DisassociateApprovalRuleTemplateFromRepositoryRequest::response(QNetworkReply * const reply) const
{
    return new DisassociateApprovalRuleTemplateFromRepositoryResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::DisassociateApprovalRuleTemplateFromRepositoryRequestPrivate
 * \brief The DisassociateApprovalRuleTemplateFromRepositoryRequestPrivate class provides private implementation for DisassociateApprovalRuleTemplateFromRepositoryRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a DisassociateApprovalRuleTemplateFromRepositoryRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
DisassociateApprovalRuleTemplateFromRepositoryRequestPrivate::DisassociateApprovalRuleTemplateFromRepositoryRequestPrivate(
    const CodeCommitRequest::Action action, DisassociateApprovalRuleTemplateFromRepositoryRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DisassociateApprovalRuleTemplateFromRepositoryRequest
 * class' copy constructor.
 */
DisassociateApprovalRuleTemplateFromRepositoryRequestPrivate::DisassociateApprovalRuleTemplateFromRepositoryRequestPrivate(
    const DisassociateApprovalRuleTemplateFromRepositoryRequestPrivate &other, DisassociateApprovalRuleTemplateFromRepositoryRequest * const q)
