...
#include "updateapprovalruletemplatenamerequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::UpdateApprovalRuleTemplateNameRequest
 * \brief The UpdateApprovalRuleTemplateNameRequest class provides an interface for CodeCommit UpdateApprovalRuleTemplateName requests.
 *
 ...
 */
UpdateApprovalRuleTemplateNameRequest::UpdateApprovalRuleTemplateNameRequest(const UpdateApprovalRuleTemplateNameRequest &other)
    : CodeCommitRequest(new UpdateApprovalRuleTemplateNameRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateApprovalRuleTemplateNameRequest object.
 */
UpdateApprovalRuleTemplateNameRequest::UpdateApprovalRuleTemplateNameRequest()
    : CodeCommitRequest(new UpdateApprovalRuleTemplateNameRequestPrivate(CodeCommitRequest::UpdateApprovalRuleTemplateNameAction, this))
{
 ...
 * \reimp
 */
bool UpdateApprovalRuleTemplateNameRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateApprovalRuleTemplateNameResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateApprovalRuleTemplateNameRequest::response(QNetworkReply * const reply) const
{
    return new UpdateApprovalRuleTemplateNameResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::UpdateApprovalRuleTemplateNameRequestPrivate
 * \brief The UpdateApprovalRuleTemplateNameRequestPrivate class provides private implementation for UpdateApprovalRuleTemplateNameRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a UpdateApprovalRuleTemplateNameRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
UpdateApprovalRuleTemplateNameRequestPrivate::UpdateApprovalRuleTemplateNameRequestPrivate(
    const CodeCommitRequest::Action action, UpdateApprovalRuleTemplateNameRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateApprovalRuleTemplateNameRequest
 * class' copy constructor.
 */
UpdateApprovalRuleTemplateNameRequestPrivate::UpdateApprovalRuleTemplateNameRequestPrivate(
    const UpdateApprovalRuleTemplateNameRequestPrivate &other, UpdateApprovalRuleTemplateNameRequest * const q)
