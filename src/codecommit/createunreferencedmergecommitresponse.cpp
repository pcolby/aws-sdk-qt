...
#include "createunreferencedmergecommitresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::CreateUnreferencedMergeCommitResponse
 * \brief The CreateUnreferencedMergeCommitResponse class provides an interace for CodeCommit CreateUnreferencedMergeCommit responses.
 *
...
/*!
 * Constructs a CreateUnreferencedMergeCommitResponse object for \a reply to \a request, with parent \a parent.
 */
CreateUnreferencedMergeCommitResponse::CreateUnreferencedMergeCommitResponse(
        const CreateUnreferencedMergeCommitRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new CreateUnreferencedMergeCommitResponsePrivate(this), parent)
{
    setRequest(new CreateUnreferencedMergeCommitRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit CreateUnreferencedMergeCommit \a response.
 */
void CreateUnreferencedMergeCommitResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateUnreferencedMergeCommitResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::CreateUnreferencedMergeCommitResponsePrivate
 * \brief The CreateUnreferencedMergeCommitResponsePrivate class provides private implementation for CreateUnreferencedMergeCommitResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a CreateUnreferencedMergeCommitResponsePrivate object with public implementation \a q.
 */
CreateUnreferencedMergeCommitResponsePrivate::CreateUnreferencedMergeCommitResponsePrivate(
    CreateUnreferencedMergeCommitResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit CreateUnreferencedMergeCommit response element from \a xml.
 */
void CreateUnreferencedMergeCommitResponsePrivate::parseCreateUnreferencedMergeCommitResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateUnreferencedMergeCommitResponse"));
    Q_UNUSED(xml) ///< @todo
}
