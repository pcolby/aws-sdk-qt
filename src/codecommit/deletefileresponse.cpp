...
#include "deletefileresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::DeleteFileResponse
 * \brief The DeleteFileResponse class provides an interace for CodeCommit DeleteFile responses.
 *
...
/*!
 * Constructs a DeleteFileResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteFileResponse::DeleteFileResponse(
        const DeleteFileRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new DeleteFileResponsePrivate(this), parent)
{
    setRequest(new DeleteFileRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit DeleteFile \a response.
 */
void DeleteFileResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteFileResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::DeleteFileResponsePrivate
 * \brief The DeleteFileResponsePrivate class provides private implementation for DeleteFileResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a DeleteFileResponsePrivate object with public implementation \a q.
 */
DeleteFileResponsePrivate::DeleteFileResponsePrivate(
    DeleteFileResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit DeleteFile response element from \a xml.
 */
void DeleteFileResponsePrivate::parseDeleteFileResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteFileResponse"));
    Q_UNUSED(xml) ///< @todo
}
