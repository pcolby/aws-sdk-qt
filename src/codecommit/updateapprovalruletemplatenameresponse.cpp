...
#include "updateapprovalruletemplatenameresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::UpdateApprovalRuleTemplateNameResponse
 * \brief The UpdateApprovalRuleTemplateNameResponse class provides an interace for CodeCommit UpdateApprovalRuleTemplateName responses.
 *
 ...
 *
 * \sa CodeCommitClient::updateApprovalRuleTemplateName
 */

/*!
 * Constructs a UpdateApprovalRuleTemplateNameResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateApprovalRuleTemplateNameResponse::UpdateApprovalRuleTemplateNameResponse(
        const UpdateApprovalRuleTemplateNameRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new UpdateApprovalRuleTemplateNameResponsePrivate(this), parent)
{
    setRequest(new UpdateApprovalRuleTemplateNameRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateApprovalRuleTemplateNameRequest * UpdateApprovalRuleTemplateNameResponse::request() const
{
    Q_D(const UpdateApprovalRuleTemplateNameResponse);
    return static_cast<const UpdateApprovalRuleTemplateNameRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful CodeCommit UpdateApprovalRuleTemplateName \a response.
 */
void UpdateApprovalRuleTemplateNameResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateApprovalRuleTemplateNameResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::UpdateApprovalRuleTemplateNameResponsePrivate
 * \brief The UpdateApprovalRuleTemplateNameResponsePrivate class provides private implementation for UpdateApprovalRuleTemplateNameResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a UpdateApprovalRuleTemplateNameResponsePrivate object with public implementation \a q.
 */
UpdateApprovalRuleTemplateNameResponsePrivate::UpdateApprovalRuleTemplateNameResponsePrivate(
    UpdateApprovalRuleTemplateNameResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit UpdateApprovalRuleTemplateName response element from \a xml.
 */
void UpdateApprovalRuleTemplateNameResponsePrivate::parseUpdateApprovalRuleTemplateNameResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateApprovalRuleTemplateNameResponse"));
    Q_UNUSED(xml) ///< @todo
}
