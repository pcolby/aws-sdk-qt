...
#include "overridepullrequestapprovalrulesrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::OverridePullRequestApprovalRulesRequest
 * \brief The OverridePullRequestApprovalRulesRequest class provides an interface for CodeCommit OverridePullRequestApprovalRules requests.
 *
 ...
 *
 * \sa CodeCommitClient::overridePullRequestApprovalRules
 */

/*!
 * Constructs a copy of \a other.
 */
OverridePullRequestApprovalRulesRequest::OverridePullRequestApprovalRulesRequest(const OverridePullRequestApprovalRulesRequest &other)
    : CodeCommitRequest(new OverridePullRequestApprovalRulesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a OverridePullRequestApprovalRulesRequest object.
 */
OverridePullRequestApprovalRulesRequest::OverridePullRequestApprovalRulesRequest()
    : CodeCommitRequest(new OverridePullRequestApprovalRulesRequestPrivate(CodeCommitRequest::OverridePullRequestApprovalRulesAction, this))
{
 ...
 * \reimp
 */
bool OverridePullRequestApprovalRulesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a OverridePullRequestApprovalRulesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * OverridePullRequestApprovalRulesRequest::response(QNetworkReply * const reply) const
{
    return new OverridePullRequestApprovalRulesResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::OverridePullRequestApprovalRulesRequestPrivate
 * \brief The OverridePullRequestApprovalRulesRequestPrivate class provides private implementation for OverridePullRequestApprovalRulesRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a OverridePullRequestApprovalRulesRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
OverridePullRequestApprovalRulesRequestPrivate::OverridePullRequestApprovalRulesRequestPrivate(
    const CodeCommitRequest::Action action, OverridePullRequestApprovalRulesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the OverridePullRequestApprovalRulesRequest
 * class' copy constructor.
 */
OverridePullRequestApprovalRulesRequestPrivate::OverridePullRequestApprovalRulesRequestPrivate(
    const OverridePullRequestApprovalRulesRequestPrivate &other, OverridePullRequestApprovalRulesRequest * const q)
