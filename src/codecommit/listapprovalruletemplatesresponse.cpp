...
#include "listapprovalruletemplatesresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::ListApprovalRuleTemplatesResponse
 * \brief The ListApprovalRuleTemplatesResponse class provides an interace for CodeCommit ListApprovalRuleTemplates responses.
 *
...
/*!
 * Constructs a ListApprovalRuleTemplatesResponse object for \a reply to \a request, with parent \a parent.
 */
ListApprovalRuleTemplatesResponse::ListApprovalRuleTemplatesResponse(
        const ListApprovalRuleTemplatesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new ListApprovalRuleTemplatesResponsePrivate(this), parent)
{
    setRequest(new ListApprovalRuleTemplatesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit ListApprovalRuleTemplates \a response.
 */
void ListApprovalRuleTemplatesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListApprovalRuleTemplatesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::ListApprovalRuleTemplatesResponsePrivate
 * \brief The ListApprovalRuleTemplatesResponsePrivate class provides private implementation for ListApprovalRuleTemplatesResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a ListApprovalRuleTemplatesResponsePrivate object with public implementation \a q.
 */
ListApprovalRuleTemplatesResponsePrivate::ListApprovalRuleTemplatesResponsePrivate(
    ListApprovalRuleTemplatesResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit ListApprovalRuleTemplates response element from \a xml.
 */
void ListApprovalRuleTemplatesResponsePrivate::parseListApprovalRuleTemplatesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListApprovalRuleTemplatesResponse"));
    Q_UNUSED(xml) ///< @todo
}
