...
#include "getpullrequestoverridestaterequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::GetPullRequestOverrideStateRequest
 * \brief The GetPullRequestOverrideStateRequest class provides an interface for CodeCommit GetPullRequestOverrideState requests.
 *
 ...
 *
 * \sa CodeCommitClient::getPullRequestOverrideState
 */

/*!
 * Constructs a copy of \a other.
 */
GetPullRequestOverrideStateRequest::GetPullRequestOverrideStateRequest(const GetPullRequestOverrideStateRequest &other)
    : CodeCommitRequest(new GetPullRequestOverrideStateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetPullRequestOverrideStateRequest object.
 */
GetPullRequestOverrideStateRequest::GetPullRequestOverrideStateRequest()
    : CodeCommitRequest(new GetPullRequestOverrideStateRequestPrivate(CodeCommitRequest::GetPullRequestOverrideStateAction, this))
{
 ...
 * \reimp
 */
bool GetPullRequestOverrideStateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetPullRequestOverrideStateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetPullRequestOverrideStateRequest::response(QNetworkReply * const reply) const
{
    return new GetPullRequestOverrideStateResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::GetPullRequestOverrideStateRequestPrivate
 * \brief The GetPullRequestOverrideStateRequestPrivate class provides private implementation for GetPullRequestOverrideStateRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a GetPullRequestOverrideStateRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
GetPullRequestOverrideStateRequestPrivate::GetPullRequestOverrideStateRequestPrivate(
    const CodeCommitRequest::Action action, GetPullRequestOverrideStateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetPullRequestOverrideStateRequest
 * class' copy constructor.
 */
GetPullRequestOverrideStateRequestPrivate::GetPullRequestOverrideStateRequestPrivate(
    const GetPullRequestOverrideStateRequestPrivate &other, GetPullRequestOverrideStateRequest * const q)
