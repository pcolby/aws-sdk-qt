...
#include "listapprovalruletemplatesrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::ListApprovalRuleTemplatesRequest
 * \brief The ListApprovalRuleTemplatesRequest class provides an interface for CodeCommit ListApprovalRuleTemplates requests.
 *
 ...
 *
 * \sa CodeCommitClient::listApprovalRuleTemplates
 */

/*!
 * Constructs a copy of \a other.
 */
ListApprovalRuleTemplatesRequest::ListApprovalRuleTemplatesRequest(const ListApprovalRuleTemplatesRequest &other)
    : CodeCommitRequest(new ListApprovalRuleTemplatesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListApprovalRuleTemplatesRequest object.
 */
ListApprovalRuleTemplatesRequest::ListApprovalRuleTemplatesRequest()
    : CodeCommitRequest(new ListApprovalRuleTemplatesRequestPrivate(CodeCommitRequest::ListApprovalRuleTemplatesAction, this))
{
 ...
 * \reimp
 */
bool ListApprovalRuleTemplatesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListApprovalRuleTemplatesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListApprovalRuleTemplatesRequest::response(QNetworkReply * const reply) const
{
    return new ListApprovalRuleTemplatesResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::ListApprovalRuleTemplatesRequestPrivate
 * \brief The ListApprovalRuleTemplatesRequestPrivate class provides private implementation for ListApprovalRuleTemplatesRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a ListApprovalRuleTemplatesRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
ListApprovalRuleTemplatesRequestPrivate::ListApprovalRuleTemplatesRequestPrivate(
    const CodeCommitRequest::Action action, ListApprovalRuleTemplatesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListApprovalRuleTemplatesRequest
 * class' copy constructor.
 */
ListApprovalRuleTemplatesRequestPrivate::ListApprovalRuleTemplatesRequestPrivate(
    const ListApprovalRuleTemplatesRequestPrivate &other, ListApprovalRuleTemplatesRequest * const q)
