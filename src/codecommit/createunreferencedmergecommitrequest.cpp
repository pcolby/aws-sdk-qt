...
#include "createunreferencedmergecommitrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::CreateUnreferencedMergeCommitRequest
 * \brief The CreateUnreferencedMergeCommitRequest class provides an interface for CodeCommit CreateUnreferencedMergeCommit requests.
 *
 ...
 *
 * \sa CodeCommitClient::createUnreferencedMergeCommit
 */

/*!
 * Constructs a copy of \a other.
 */
CreateUnreferencedMergeCommitRequest::CreateUnreferencedMergeCommitRequest(const CreateUnreferencedMergeCommitRequest &other)
    : CodeCommitRequest(new CreateUnreferencedMergeCommitRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateUnreferencedMergeCommitRequest object.
 */
CreateUnreferencedMergeCommitRequest::CreateUnreferencedMergeCommitRequest()
    : CodeCommitRequest(new CreateUnreferencedMergeCommitRequestPrivate(CodeCommitRequest::CreateUnreferencedMergeCommitAction, this))
{
 ...
 * \reimp
 */
bool CreateUnreferencedMergeCommitRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateUnreferencedMergeCommitResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateUnreferencedMergeCommitRequest::response(QNetworkReply * const reply) const
{
    return new CreateUnreferencedMergeCommitResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::CreateUnreferencedMergeCommitRequestPrivate
 * \brief The CreateUnreferencedMergeCommitRequestPrivate class provides private implementation for CreateUnreferencedMergeCommitRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a CreateUnreferencedMergeCommitRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
CreateUnreferencedMergeCommitRequestPrivate::CreateUnreferencedMergeCommitRequestPrivate(
    const CodeCommitRequest::Action action, CreateUnreferencedMergeCommitRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateUnreferencedMergeCommitRequest
 * class' copy constructor.
 */
CreateUnreferencedMergeCommitRequestPrivate::CreateUnreferencedMergeCommitRequestPrivate(
    const CreateUnreferencedMergeCommitRequestPrivate &other, CreateUnreferencedMergeCommitRequest * const q)
