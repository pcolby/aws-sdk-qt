...
#include "getmergeoptionsrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::GetMergeOptionsRequest
 * \brief The GetMergeOptionsRequest class provides an interface for CodeCommit GetMergeOptions requests.
 *
 ...
 *
 * \sa CodeCommitClient::getMergeOptions
 */

/*!
 * Constructs a copy of \a other.
 */
GetMergeOptionsRequest::GetMergeOptionsRequest(const GetMergeOptionsRequest &other)
    : CodeCommitRequest(new GetMergeOptionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetMergeOptionsRequest object.
 */
GetMergeOptionsRequest::GetMergeOptionsRequest()
    : CodeCommitRequest(new GetMergeOptionsRequestPrivate(CodeCommitRequest::GetMergeOptionsAction, this))
{
 ...
 * \reimp
 */
bool GetMergeOptionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetMergeOptionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetMergeOptionsRequest::response(QNetworkReply * const reply) const
{
    return new GetMergeOptionsResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::GetMergeOptionsRequestPrivate
 * \brief The GetMergeOptionsRequestPrivate class provides private implementation for GetMergeOptionsRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a GetMergeOptionsRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
GetMergeOptionsRequestPrivate::GetMergeOptionsRequestPrivate(
    const CodeCommitRequest::Action action, GetMergeOptionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetMergeOptionsRequest
 * class' copy constructor.
 */
GetMergeOptionsRequestPrivate::GetMergeOptionsRequestPrivate(
    const GetMergeOptionsRequestPrivate &other, GetMergeOptionsRequest * const q)
