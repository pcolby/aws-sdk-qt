...
#include "getpullrequestapprovalstatesresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::GetPullRequestApprovalStatesResponse
 * \brief The GetPullRequestApprovalStatesResponse class provides an interace for CodeCommit GetPullRequestApprovalStates responses.
 *
...
/*!
 * Constructs a GetPullRequestApprovalStatesResponse object for \a reply to \a request, with parent \a parent.
 */
GetPullRequestApprovalStatesResponse::GetPullRequestApprovalStatesResponse(
        const GetPullRequestApprovalStatesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new GetPullRequestApprovalStatesResponsePrivate(this), parent)
{
    setRequest(new GetPullRequestApprovalStatesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit GetPullRequestApprovalStates \a response.
 */
void GetPullRequestApprovalStatesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetPullRequestApprovalStatesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::GetPullRequestApprovalStatesResponsePrivate
 * \brief The GetPullRequestApprovalStatesResponsePrivate class provides private implementation for GetPullRequestApprovalStatesResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a GetPullRequestApprovalStatesResponsePrivate object with public implementation \a q.
 */
GetPullRequestApprovalStatesResponsePrivate::GetPullRequestApprovalStatesResponsePrivate(
    GetPullRequestApprovalStatesResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit GetPullRequestApprovalStates response element from \a xml.
 */
void GetPullRequestApprovalStatesResponsePrivate::parseGetPullRequestApprovalStatesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetPullRequestApprovalStatesResponse"));
    Q_UNUSED(xml) ///< @todo
}
