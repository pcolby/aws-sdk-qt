...
#include "mergepullrequestbythreewayresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::MergePullRequestByThreeWayResponse
 * \brief The MergePullRequestByThreeWayResponse class provides an interace for CodeCommit MergePullRequestByThreeWay responses.
 *
...
/*!
 * Constructs a MergePullRequestByThreeWayResponse object for \a reply to \a request, with parent \a parent.
 */
MergePullRequestByThreeWayResponse::MergePullRequestByThreeWayResponse(
        const MergePullRequestByThreeWayRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new MergePullRequestByThreeWayResponsePrivate(this), parent)
{
    setRequest(new MergePullRequestByThreeWayRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit MergePullRequestByThreeWay \a response.
 */
void MergePullRequestByThreeWayResponse::parseSuccess(QIODevice &response)
{
    //Q_D(MergePullRequestByThreeWayResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::MergePullRequestByThreeWayResponsePrivate
 * \brief The MergePullRequestByThreeWayResponsePrivate class provides private implementation for MergePullRequestByThreeWayResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a MergePullRequestByThreeWayResponsePrivate object with public implementation \a q.
 */
MergePullRequestByThreeWayResponsePrivate::MergePullRequestByThreeWayResponsePrivate(
    MergePullRequestByThreeWayResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit MergePullRequestByThreeWay response element from \a xml.
 */
void MergePullRequestByThreeWayResponsePrivate::parseMergePullRequestByThreeWayResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("MergePullRequestByThreeWayResponse"));
    Q_UNUSED(xml) ///< @todo
}
