...
#include "getapprovalruletemplateresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::GetApprovalRuleTemplateResponse
 * \brief The GetApprovalRuleTemplateResponse class provides an interace for CodeCommit GetApprovalRuleTemplate responses.
 *
...
/*!
 * Constructs a GetApprovalRuleTemplateResponse object for \a reply to \a request, with parent \a parent.
 */
GetApprovalRuleTemplateResponse::GetApprovalRuleTemplateResponse(
        const GetApprovalRuleTemplateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new GetApprovalRuleTemplateResponsePrivate(this), parent)
{
    setRequest(new GetApprovalRuleTemplateRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit GetApprovalRuleTemplate \a response.
 */
void GetApprovalRuleTemplateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetApprovalRuleTemplateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::GetApprovalRuleTemplateResponsePrivate
 * \brief The GetApprovalRuleTemplateResponsePrivate class provides private implementation for GetApprovalRuleTemplateResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a GetApprovalRuleTemplateResponsePrivate object with public implementation \a q.
 */
GetApprovalRuleTemplateResponsePrivate::GetApprovalRuleTemplateResponsePrivate(
    GetApprovalRuleTemplateResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit GetApprovalRuleTemplate response element from \a xml.
 */
void GetApprovalRuleTemplateResponsePrivate::parseGetApprovalRuleTemplateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetApprovalRuleTemplateResponse"));
    Q_UNUSED(xml) ///< @todo
}
