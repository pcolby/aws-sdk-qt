...
#include "evaluatepullrequestapprovalrulesresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::EvaluatePullRequestApprovalRulesResponse
 * \brief The EvaluatePullRequestApprovalRulesResponse class provides an interace for CodeCommit EvaluatePullRequestApprovalRules responses.
 *
...
/*!
 * Constructs a EvaluatePullRequestApprovalRulesResponse object for \a reply to \a request, with parent \a parent.
 */
EvaluatePullRequestApprovalRulesResponse::EvaluatePullRequestApprovalRulesResponse(
        const EvaluatePullRequestApprovalRulesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new EvaluatePullRequestApprovalRulesResponsePrivate(this), parent)
{
    setRequest(new EvaluatePullRequestApprovalRulesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit EvaluatePullRequestApprovalRules \a response.
 */
void EvaluatePullRequestApprovalRulesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(EvaluatePullRequestApprovalRulesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::EvaluatePullRequestApprovalRulesResponsePrivate
 * \brief The EvaluatePullRequestApprovalRulesResponsePrivate class provides private implementation for EvaluatePullRequestApprovalRulesResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a EvaluatePullRequestApprovalRulesResponsePrivate object with public implementation \a q.
 */
EvaluatePullRequestApprovalRulesResponsePrivate::EvaluatePullRequestApprovalRulesResponsePrivate(
    EvaluatePullRequestApprovalRulesResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit EvaluatePullRequestApprovalRules response element from \a xml.
 */
void EvaluatePullRequestApprovalRulesResponsePrivate::parseEvaluatePullRequestApprovalRulesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("EvaluatePullRequestApprovalRulesResponse"));
    Q_UNUSED(xml) ///< @todo
}
