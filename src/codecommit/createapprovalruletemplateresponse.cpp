...
#include "createapprovalruletemplateresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::CreateApprovalRuleTemplateResponse
 * \brief The CreateApprovalRuleTemplateResponse class provides an interace for CodeCommit CreateApprovalRuleTemplate responses.
 *
 ...
 *
 * \sa CodeCommitClient::createApprovalRuleTemplate
 */

/*!
 * Constructs a CreateApprovalRuleTemplateResponse object for \a reply to \a request, with parent \a parent.
 */
CreateApprovalRuleTemplateResponse::CreateApprovalRuleTemplateResponse(
        const CreateApprovalRuleTemplateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new CreateApprovalRuleTemplateResponsePrivate(this), parent)
{
    setRequest(new CreateApprovalRuleTemplateRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateApprovalRuleTemplateRequest * CreateApprovalRuleTemplateResponse::request() const
{
    Q_D(const CreateApprovalRuleTemplateResponse);
    return static_cast<const CreateApprovalRuleTemplateRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful CodeCommit CreateApprovalRuleTemplate \a response.
 */
void CreateApprovalRuleTemplateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateApprovalRuleTemplateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::CreateApprovalRuleTemplateResponsePrivate
 * \brief The CreateApprovalRuleTemplateResponsePrivate class provides private implementation for CreateApprovalRuleTemplateResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a CreateApprovalRuleTemplateResponsePrivate object with public implementation \a q.
 */
CreateApprovalRuleTemplateResponsePrivate::CreateApprovalRuleTemplateResponsePrivate(
    CreateApprovalRuleTemplateResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit CreateApprovalRuleTemplate response element from \a xml.
 */
void CreateApprovalRuleTemplateResponsePrivate::parseCreateApprovalRuleTemplateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateApprovalRuleTemplateResponse"));
    Q_UNUSED(xml) ///< @todo
}
