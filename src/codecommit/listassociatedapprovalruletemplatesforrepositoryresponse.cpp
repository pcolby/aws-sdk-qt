...
#include "listassociatedapprovalruletemplatesforrepositoryresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::ListAssociatedApprovalRuleTemplatesForRepositoryResponse
 * \brief The ListAssociatedApprovalRuleTemplatesForRepositoryResponse class provides an interace for CodeCommit ListAssociatedApprovalRuleTemplatesForRepository responses.
 *
 ...
 *
 * \sa CodeCommitClient::listAssociatedApprovalRuleTemplatesForRepository
 */

/*!
 * Constructs a ListAssociatedApprovalRuleTemplatesForRepositoryResponse object for \a reply to \a request, with parent \a parent.
 */
ListAssociatedApprovalRuleTemplatesForRepositoryResponse::ListAssociatedApprovalRuleTemplatesForRepositoryResponse(
        const ListAssociatedApprovalRuleTemplatesForRepositoryRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new ListAssociatedApprovalRuleTemplatesForRepositoryResponsePrivate(this), parent)
{
    setRequest(new ListAssociatedApprovalRuleTemplatesForRepositoryRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListAssociatedApprovalRuleTemplatesForRepositoryRequest * ListAssociatedApprovalRuleTemplatesForRepositoryResponse::request() const
{
    Q_D(const ListAssociatedApprovalRuleTemplatesForRepositoryResponse);
    return static_cast<const ListAssociatedApprovalRuleTemplatesForRepositoryRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful CodeCommit ListAssociatedApprovalRuleTemplatesForRepository \a response.
 */
void ListAssociatedApprovalRuleTemplatesForRepositoryResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListAssociatedApprovalRuleTemplatesForRepositoryResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::ListAssociatedApprovalRuleTemplatesForRepositoryResponsePrivate
 * \brief The ListAssociatedApprovalRuleTemplatesForRepositoryResponsePrivate class provides private implementation for ListAssociatedApprovalRuleTemplatesForRepositoryResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a ListAssociatedApprovalRuleTemplatesForRepositoryResponsePrivate object with public implementation \a q.
 */
ListAssociatedApprovalRuleTemplatesForRepositoryResponsePrivate::ListAssociatedApprovalRuleTemplatesForRepositoryResponsePrivate(
    ListAssociatedApprovalRuleTemplatesForRepositoryResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit ListAssociatedApprovalRuleTemplatesForRepository response element from \a xml.
 */
void ListAssociatedApprovalRuleTemplatesForRepositoryResponsePrivate::parseListAssociatedApprovalRuleTemplatesForRepositoryResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListAssociatedApprovalRuleTemplatesForRepositoryResponse"));
    Q_UNUSED(xml) ///< @todo
}
