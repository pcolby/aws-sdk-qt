...
#include "updatepullrequestapprovalrulecontentrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::UpdatePullRequestApprovalRuleContentRequest
 * \brief The UpdatePullRequestApprovalRuleContentRequest class provides an interface for CodeCommit UpdatePullRequestApprovalRuleContent requests.
 *
 ...
 *
 * \sa CodeCommitClient::updatePullRequestApprovalRuleContent
 */

/*!
 * Constructs a copy of \a other.
 */
UpdatePullRequestApprovalRuleContentRequest::UpdatePullRequestApprovalRuleContentRequest(const UpdatePullRequestApprovalRuleContentRequest &other)
    : CodeCommitRequest(new UpdatePullRequestApprovalRuleContentRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdatePullRequestApprovalRuleContentRequest object.
 */
UpdatePullRequestApprovalRuleContentRequest::UpdatePullRequestApprovalRuleContentRequest()
    : CodeCommitRequest(new UpdatePullRequestApprovalRuleContentRequestPrivate(CodeCommitRequest::UpdatePullRequestApprovalRuleContentAction, this))
{
 ...
 * \reimp
 */
bool UpdatePullRequestApprovalRuleContentRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdatePullRequestApprovalRuleContentResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdatePullRequestApprovalRuleContentRequest::response(QNetworkReply * const reply) const
{
    return new UpdatePullRequestApprovalRuleContentResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::UpdatePullRequestApprovalRuleContentRequestPrivate
 * \brief The UpdatePullRequestApprovalRuleContentRequestPrivate class provides private implementation for UpdatePullRequestApprovalRuleContentRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a UpdatePullRequestApprovalRuleContentRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
UpdatePullRequestApprovalRuleContentRequestPrivate::UpdatePullRequestApprovalRuleContentRequestPrivate(
    const CodeCommitRequest::Action action, UpdatePullRequestApprovalRuleContentRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdatePullRequestApprovalRuleContentRequest
 * class' copy constructor.
 */
UpdatePullRequestApprovalRuleContentRequestPrivate::UpdatePullRequestApprovalRuleContentRequestPrivate(
    const UpdatePullRequestApprovalRuleContentRequestPrivate &other, UpdatePullRequestApprovalRuleContentRequest * const q)
