...
#include "deleteapprovalruletemplaterequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::DeleteApprovalRuleTemplateRequest
 * \brief The DeleteApprovalRuleTemplateRequest class provides an interface for CodeCommit DeleteApprovalRuleTemplate requests.
 *
 ...
 *
 * \sa CodeCommitClient::deleteApprovalRuleTemplate
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteApprovalRuleTemplateRequest::DeleteApprovalRuleTemplateRequest(const DeleteApprovalRuleTemplateRequest &other)
    : CodeCommitRequest(new DeleteApprovalRuleTemplateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteApprovalRuleTemplateRequest object.
 */
DeleteApprovalRuleTemplateRequest::DeleteApprovalRuleTemplateRequest()
    : CodeCommitRequest(new DeleteApprovalRuleTemplateRequestPrivate(CodeCommitRequest::DeleteApprovalRuleTemplateAction, this))
{
 ...
 * \reimp
 */
bool DeleteApprovalRuleTemplateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteApprovalRuleTemplateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteApprovalRuleTemplateRequest::response(QNetworkReply * const reply) const
{
    return new DeleteApprovalRuleTemplateResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::DeleteApprovalRuleTemplateRequestPrivate
 * \brief The DeleteApprovalRuleTemplateRequestPrivate class provides private implementation for DeleteApprovalRuleTemplateRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a DeleteApprovalRuleTemplateRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
DeleteApprovalRuleTemplateRequestPrivate::DeleteApprovalRuleTemplateRequestPrivate(
    const CodeCommitRequest::Action action, DeleteApprovalRuleTemplateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteApprovalRuleTemplateRequest
 * class' copy constructor.
 */
DeleteApprovalRuleTemplateRequestPrivate::DeleteApprovalRuleTemplateRequestPrivate(
    const DeleteApprovalRuleTemplateRequestPrivate &other, DeleteApprovalRuleTemplateRequest * const q)
