...
#include "updatepullrequestapprovalstaterequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::UpdatePullRequestApprovalStateRequest
 * \brief The UpdatePullRequestApprovalStateRequest class provides an interface for CodeCommit UpdatePullRequestApprovalState requests.
 *
 ...
 */
UpdatePullRequestApprovalStateRequest::UpdatePullRequestApprovalStateRequest(const UpdatePullRequestApprovalStateRequest &other)
    : CodeCommitRequest(new UpdatePullRequestApprovalStateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdatePullRequestApprovalStateRequest object.
 */
UpdatePullRequestApprovalStateRequest::UpdatePullRequestApprovalStateRequest()
    : CodeCommitRequest(new UpdatePullRequestApprovalStateRequestPrivate(CodeCommitRequest::UpdatePullRequestApprovalStateAction, this))
{
 ...
 * \reimp
 */
bool UpdatePullRequestApprovalStateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdatePullRequestApprovalStateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdatePullRequestApprovalStateRequest::response(QNetworkReply * const reply) const
{
    return new UpdatePullRequestApprovalStateResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::UpdatePullRequestApprovalStateRequestPrivate
 * \brief The UpdatePullRequestApprovalStateRequestPrivate class provides private implementation for UpdatePullRequestApprovalStateRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a UpdatePullRequestApprovalStateRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
UpdatePullRequestApprovalStateRequestPrivate::UpdatePullRequestApprovalStateRequestPrivate(
    const CodeCommitRequest::Action action, UpdatePullRequestApprovalStateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdatePullRequestApprovalStateRequest
 * class' copy constructor.
 */
UpdatePullRequestApprovalStateRequestPrivate::UpdatePullRequestApprovalStateRequestPrivate(
    const UpdatePullRequestApprovalStateRequestPrivate &other, UpdatePullRequestApprovalStateRequest * const q)
