...
/*!
 * \class QtAws::CodeCommit::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for CodeCommit TagResource requests.
 *
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : CodeCommitRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : CodeCommitRequest(new TagResourceRequestPrivate(CodeCommitRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::CodeCommit::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const CodeCommitRequest::Action action, TagResourceRequest * const q)
