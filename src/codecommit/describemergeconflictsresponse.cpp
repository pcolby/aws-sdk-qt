...
#include "describemergeconflictsresponse_p.h"
...
/*!
 * \class QtAws::CodeCommit::DescribeMergeConflictsResponse
 * \brief The DescribeMergeConflictsResponse class provides an interace for CodeCommit DescribeMergeConflicts responses.
 *
...
/*!
 * Constructs a DescribeMergeConflictsResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeMergeConflictsResponse::DescribeMergeConflictsResponse(
        const DescribeMergeConflictsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CodeCommitResponse(new DescribeMergeConflictsResponsePrivate(this), parent)
{
    setRequest(new DescribeMergeConflictsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CodeCommit DescribeMergeConflicts \a response.
 */
void DescribeMergeConflictsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeMergeConflictsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CodeCommit::DescribeMergeConflictsResponsePrivate
 * \brief The DescribeMergeConflictsResponsePrivate class provides private implementation for DescribeMergeConflictsResponse.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a DescribeMergeConflictsResponsePrivate object with public implementation \a q.
 */
DescribeMergeConflictsResponsePrivate::DescribeMergeConflictsResponsePrivate(
    DescribeMergeConflictsResponse * const q) : CodeCommitResponsePrivate(q)
{

}

/*!
 * Parses a CodeCommit DescribeMergeConflicts response element from \a xml.
 */
void DescribeMergeConflictsResponsePrivate::parseDescribeMergeConflictsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeMergeConflictsResponse"));
    Q_UNUSED(xml) ///< @todo
}
