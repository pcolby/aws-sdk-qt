...
#include "createcommitrequest_p.h"
...
/*!
 * \class QtAws::CodeCommit::CreateCommitRequest
 * \brief The CreateCommitRequest class provides an interface for CodeCommit CreateCommit requests.
 *
 ...
 *
 * \sa CodeCommitClient::createCommit
 */

/*!
 * Constructs a copy of \a other.
 */
CreateCommitRequest::CreateCommitRequest(const CreateCommitRequest &other)
    : CodeCommitRequest(new CreateCommitRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateCommitRequest object.
 */
CreateCommitRequest::CreateCommitRequest()
    : CodeCommitRequest(new CreateCommitRequestPrivate(CodeCommitRequest::CreateCommitAction, this))
{
 ...
 * \reimp
 */
bool CreateCommitRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateCommitResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateCommitRequest::response(QNetworkReply * const reply) const
{
    return new CreateCommitResponse(*this, reply);
}

/*!
 * \class QtAws::CodeCommit::CreateCommitRequestPrivate
 * \brief The CreateCommitRequestPrivate class provides private implementation for CreateCommitRequest.
 * \internal
 *
 * \inmodule QtAwsCodeCommit
 */
...
/*!
 * Constructs a CreateCommitRequestPrivate object for CodeCommit \a action,
 * with public implementation \a q.
 */
CreateCommitRequestPrivate::CreateCommitRequestPrivate(
    const CodeCommitRequest::Action action, CreateCommitRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateCommitRequest
 * class' copy constructor.
 */
CreateCommitRequestPrivate::CreateCommitRequestPrivate(
    const CreateCommitRequestPrivate &other, CreateCommitRequest * const q)
