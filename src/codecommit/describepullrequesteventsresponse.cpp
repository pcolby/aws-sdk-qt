 ...
 *
 * \brief The DescribePullRequestEventsResponse class encapsulates CodeCommit DescribePullRequestEvents responses.
 *
 * \ingroup CodeCommit
 *
 ...
 *
 * \sa CodeCommitClient::describePullRequestEvents
 */
