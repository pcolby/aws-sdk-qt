 ...
 *
 * \brief The UpdateRepositoryDescriptionResponse class encapsulates CodeCommit UpdateRepositoryDescription responses.
 *
 * \ingroup CodeCommit
 *
 ...
 *
 * \sa CodeCommitClient::updateRepositoryDescription
 */
