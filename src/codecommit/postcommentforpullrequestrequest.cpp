 ...
 *
 * \brief The PostCommentForPullRequestRequest class encapsulates CodeCommit PostCommentForPullRequest requests.
 *
 * \ingroup CodeCommit
 *
 ...
 *
 * \sa CodeCommitClient::postCommentForPullRequest
 */
