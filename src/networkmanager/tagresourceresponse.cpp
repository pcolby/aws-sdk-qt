...
/*!
 * \class QtAws::NetworkManager::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for NetworkManager TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : NetworkManagerResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(NetworkManagerResponse::request());
}

/*!
 * \reimp
 * Parses a successful NetworkManager TagResource \a response.
 */
...
/*!
 * \class QtAws::NetworkManager::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : NetworkManagerResponsePrivate(q)
{

}

/*!
 * Parses a NetworkManager TagResource response element from \a xml.
 */
