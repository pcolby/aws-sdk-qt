...
/*!
 * \class QtAws::NetworkManager::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for NetworkManager UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : NetworkManagerResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(NetworkManagerResponse::request());
}

/*!
 * \reimp
 * Parses a successful NetworkManager UntagResource \a response.
 */
...
/*!
 * \class QtAws::NetworkManager::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : NetworkManagerResponsePrivate(q)
{

}

/*!
 * Parses a NetworkManager UntagResource response element from \a xml.
 */
