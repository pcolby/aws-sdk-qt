...
class QTAWS_EXPORT RegisterTransitGatewayResponsePrivate : public NetworkManagerResponsePrivate {

public:

    RegisterTransitGatewayResponsePrivate(RegisterTransitGatewayResponse * const q);
