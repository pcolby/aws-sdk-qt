...
/*!
 * \class QtAws::MigrationHubRefactorSpaces::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for MigrationHubRefactorSpaces UntagResource requests.
 *
 ...
 *
 * \sa MigrationHubRefactorSpacesClient::untagResource
 */
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : MigrationHubRefactorSpacesRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : MigrationHubRefactorSpacesRequest(new UntagResourceRequestPrivate(MigrationHubRefactorSpacesRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::MigrationHubRefactorSpaces::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for MigrationHubRefactorSpaces \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const MigrationHubRefactorSpacesRequest::Action action, UntagResourceRequest * const q)
