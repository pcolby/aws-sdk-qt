...
/*!
 * \class QtAws::MigrationHubRefactorSpaces::GetResourcePolicyRequest
 * \brief The GetResourcePolicyRequest class provides an interface for MigrationHubRefactorSpaces GetResourcePolicy requests.
 *
...
GetResourcePolicyRequest::GetResourcePolicyRequest(const GetResourcePolicyRequest &other)
    : MigrationHubRefactorSpacesRequest(new GetResourcePolicyRequestPrivate(*other.d_func(), this))
{
...
GetResourcePolicyRequest::GetResourcePolicyRequest()
    : MigrationHubRefactorSpacesRequest(new GetResourcePolicyRequestPrivate(MigrationHubRefactorSpacesRequest::GetResourcePolicyAction, this))
{
...
/*!
 * \class QtAws::MigrationHubRefactorSpaces::GetResourcePolicyRequestPrivate
...
/*!
 * Constructs a GetResourcePolicyRequestPrivate object for MigrationHubRefactorSpaces \a action,
 * with public implementation \a q.
 */
GetResourcePolicyRequestPrivate::GetResourcePolicyRequestPrivate(
    const MigrationHubRefactorSpacesRequest::Action action, GetResourcePolicyRequest * const q)
