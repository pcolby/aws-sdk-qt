...
/*!
 * \class QtAws::MigrationHubRefactorSpaces::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for MigrationHubRefactorSpaces TagResource requests.
 *
 ...
 *
 * \sa MigrationHubRefactorSpacesClient::tagResource
 */
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : MigrationHubRefactorSpacesRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : MigrationHubRefactorSpacesRequest(new TagResourceRequestPrivate(MigrationHubRefactorSpacesRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::MigrationHubRefactorSpaces::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for MigrationHubRefactorSpaces \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const MigrationHubRefactorSpacesRequest::Action action, TagResourceRequest * const q)
