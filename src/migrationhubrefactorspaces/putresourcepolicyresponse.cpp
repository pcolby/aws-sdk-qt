...
/*!
 * \class QtAws::MigrationHubRefactorSpaces::PutResourcePolicyResponse
 * \brief The PutResourcePolicyResponse class provides an interace for MigrationHubRefactorSpaces PutResourcePolicy responses.
 *
...
PutResourcePolicyResponse::PutResourcePolicyResponse(
    ...
    : MigrationHubRefactorSpacesResponse(new PutResourcePolicyResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful MigrationHubRefactorSpaces PutResourcePolicy \a response.
 */
...
/*!
 * \class QtAws::MigrationHubRefactorSpaces::PutResourcePolicyResponsePrivate
...
PutResourcePolicyResponsePrivate::PutResourcePolicyResponsePrivate(
    PutResourcePolicyResponse * const q) : MigrationHubRefactorSpacesResponsePrivate(q)
{

}

/*!
 * Parses a MigrationHubRefactorSpaces PutResourcePolicy response element from \a xml.
 */
