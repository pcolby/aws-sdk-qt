...
/*!
 * \class QtAws::MigrationHubRefactorSpaces::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for MigrationHubRefactorSpaces TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : MigrationHubRefactorSpacesResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful MigrationHubRefactorSpaces TagResource \a response.
 */
...
/*!
 * \class QtAws::MigrationHubRefactorSpaces::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : MigrationHubRefactorSpacesResponsePrivate(q)
{

}

/*!
 * Parses a MigrationHubRefactorSpaces TagResource response element from \a xml.
 */
