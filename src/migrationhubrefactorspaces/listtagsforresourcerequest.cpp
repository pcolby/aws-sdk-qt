...
/*!
 * \class QtAws::MigrationHubRefactorSpaces::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for MigrationHubRefactorSpaces ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : MigrationHubRefactorSpacesRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : MigrationHubRefactorSpacesRequest(new ListTagsForResourceRequestPrivate(MigrationHubRefactorSpacesRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::MigrationHubRefactorSpaces::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for MigrationHubRefactorSpaces \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const MigrationHubRefactorSpacesRequest::Action action, ListTagsForResourceRequest * const q)
