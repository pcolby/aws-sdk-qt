...
class QTAWS_EXPORT DescribeUpdateActionsResponsePrivate : public ElastiCacheResponsePrivate {

public:

    DescribeUpdateActionsResponsePrivate(DescribeUpdateActionsResponse * const q);
