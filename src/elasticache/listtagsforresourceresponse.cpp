...
{
    return static_cast<const ListTagsForResourceRequest *>(ElastiCacheResponse::request());
}

/*!
 * \reimp
 * Parses a successful ElastiCache ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::ElastiCache::ListTagsForResourceResponsePrivate
...
/*!
 * Parses a ElastiCache ListTagsForResource response element from \a xml.
 */
