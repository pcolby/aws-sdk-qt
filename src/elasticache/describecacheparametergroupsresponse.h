...
class QTAWS_EXPORT DescribeCacheParameterGroupsResponse : public ElastiCacheResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeCacheParameterGroupsRequest * request() const override;
