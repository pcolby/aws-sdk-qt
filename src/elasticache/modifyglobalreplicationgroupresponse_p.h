...
class QTAWS_EXPORT ModifyGlobalReplicationGroupResponsePrivate : public ElastiCacheResponsePrivate {

public:

    ModifyGlobalReplicationGroupResponsePrivate(ModifyGlobalReplicationGroupResponse * const q);
