...
class QTAWS_EXPORT ModifyReplicationGroupResponsePrivate : public ElastiCacheResponsePrivate {
    Q_OBJECT

public:

    ModifyReplicationGroupResponsePrivate(ModifyReplicationGroupResponse * const q);
