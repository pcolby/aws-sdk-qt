...
class QTAWS_EXPORT DescribeServiceUpdatesRequestPrivate : public ElastiCacheRequestPrivate {

public:
    DescribeServiceUpdatesRequestPrivate(const ElastiCacheRequest::Action action,
