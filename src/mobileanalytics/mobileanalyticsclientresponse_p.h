...
public:
    ...
    MobileAnalyticsClientResponsePrivate(MobileAnalyticsClientResponse * const q);

    void parseResponse(QXmlStreamReader &xml);

private:
    Q_DECLARE_PUBLIC(MobileAnalyticsClientResponse)
    Q_DISABLE_COPY(MobileAnalyticsClientResponsePrivate)
