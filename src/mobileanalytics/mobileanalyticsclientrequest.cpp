...
#include "mobileanalyticsclientrequest_p.h"
...
/**
 * @brief  Constructs a new MobileAnalyticsClientRequest object by copying another.
 *
 ...
 */
MobileAnalyticsClientRequest& MobileAnalyticsClientRequest::operator=(const MobileAnalyticsClientRequest &other)
{
    Q_D(MobileAnalyticsClientRequest);
 ...
 * implementation that inherits from MobileAnalyticsClientRequestPrivate.
 *
...
{
    Q_D(const MobileAnalyticsClientRequest);
    return d->action;
}
...
{
    return MobileAnalyticsClientRequestPrivate::toString(action());
}
 ...
 */
void MobileAnalyticsClientRequest::setAction(const Action action)
{
    Q_D(MobileAnalyticsClientRequest);
    d->action = action;
}
 ...
 */
bool MobileAnalyticsClientRequest::operator==(const MobileAnalyticsClientRequest &other) const
{
 ...
 */
bool MobileAnalyticsClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int MobileAnalyticsClientRequest::clearParameter(const QString &name)
{
    Q_D(MobileAnalyticsClientRequest);
 ...
 */
void MobileAnalyticsClientRequest::clearParameters()
{
    Q_D(MobileAnalyticsClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant MobileAnalyticsClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const MobileAnalyticsClientRequest);
 ...
 */
const QVariantMap &MobileAnalyticsClientRequest::parameters() const
{
    Q_D(const MobileAnalyticsClientRequest);
    return d->parameters;
}
 ...
 */
void MobileAnalyticsClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(MobileAnalyticsClientRequest);
 ...
 */
void MobileAnalyticsClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(MobileAnalyticsClientRequest);
 ...
 *
 * @brief  Private implementation for MobileAnalyticsClientRequest.
 */
 ...
 * @internal
 *
 * @brief  Constructs a new MobileAnalyticsClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the MobileAnalyticsClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public MobileAnalyticsClientRequest instance.
 */
 ...
 */
QString MobileAnalyticsClientRequestPrivate::toString(const MobileAnalyticsClientRequest::Action &action)
{
    #define ActionToString(action) \
        case MobileAnalyticsClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
