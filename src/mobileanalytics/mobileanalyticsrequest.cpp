 ...
 * @param  q       Pointer to this object's public MobileAnalyticsRequest instance.
 */
 ...
 * @internal
 *
 * @brief  Constructs a new MobileAnalyticsRequestPrivate object from an existing one.
 *
