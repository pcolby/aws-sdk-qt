...
class QTAWS_EXPORT ListImagePipelineImagesResponsePrivate : public imagebuilderResponsePrivate {

public:

    ListImagePipelineImagesResponsePrivate(ListImagePipelineImagesResponse * const q);
