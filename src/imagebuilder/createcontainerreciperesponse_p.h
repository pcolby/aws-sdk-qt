...
class QTAWS_EXPORT CreateContainerRecipeResponsePrivate : public imagebuilderResponsePrivate {

public:

    CreateContainerRecipeResponsePrivate(CreateContainerRecipeResponse * const q);
