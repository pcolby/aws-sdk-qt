...
class QTAWS_EXPORT DeleteImagePipelineResponsePrivate : public imagebuilderResponsePrivate {

public:

    DeleteImagePipelineResponsePrivate(DeleteImagePipelineResponse * const q);
