...
class QTAWS_EXPORT GetContainerRecipePolicyResponsePrivate : public imagebuilderResponsePrivate {

public:

    GetContainerRecipePolicyResponsePrivate(GetContainerRecipePolicyResponse * const q);
