...
class QTAWS_EXPORT PutImageRecipePolicyResponsePrivate : public imagebuilderResponsePrivate {

public:

    PutImageRecipePolicyResponsePrivate(PutImageRecipePolicyResponse * const q);
