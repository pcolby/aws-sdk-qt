...
class QTAWS_EXPORT DeleteImageRecipeResponsePrivate : public imagebuilderResponsePrivate {

public:

    DeleteImageRecipeResponsePrivate(DeleteImageRecipeResponse * const q);
