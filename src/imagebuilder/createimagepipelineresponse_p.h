...
class QTAWS_EXPORT CreateImagePipelineResponsePrivate : public imagebuilderResponsePrivate {

public:

    CreateImagePipelineResponsePrivate(CreateImagePipelineResponse * const q);
