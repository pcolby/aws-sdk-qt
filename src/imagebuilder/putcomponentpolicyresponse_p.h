...
class QTAWS_EXPORT PutComponentPolicyResponsePrivate : public imagebuilderResponsePrivate {

public:

    PutComponentPolicyResponsePrivate(PutComponentPolicyResponse * const q);
