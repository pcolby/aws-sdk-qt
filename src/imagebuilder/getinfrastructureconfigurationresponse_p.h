...
class QTAWS_EXPORT GetInfrastructureConfigurationResponsePrivate : public imagebuilderResponsePrivate {

public:

    GetInfrastructureConfigurationResponsePrivate(GetInfrastructureConfigurationResponse * const q);
