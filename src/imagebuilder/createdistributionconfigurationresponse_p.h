...
class QTAWS_EXPORT CreateDistributionConfigurationResponsePrivate : public imagebuilderResponsePrivate {

public:

    CreateDistributionConfigurationResponsePrivate(CreateDistributionConfigurationResponse * const q);
