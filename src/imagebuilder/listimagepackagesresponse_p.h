...
class QTAWS_EXPORT ListImagePackagesResponsePrivate : public imagebuilderResponsePrivate {

public:

    ListImagePackagesResponsePrivate(ListImagePackagesResponse * const q);
