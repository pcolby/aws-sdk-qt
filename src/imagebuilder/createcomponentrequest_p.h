...
class QTAWS_EXPORT CreateComponentRequestPrivate : public imagebuilderRequestPrivate {

public:
    CreateComponentRequestPrivate(const imagebuilderRequest::Action action,
