...
class QTAWS_EXPORT CreateImageRecipeResponsePrivate : public imagebuilderResponsePrivate {

public:

    CreateImageRecipeResponsePrivate(CreateImageRecipeResponse * const q);
