...
class QTAWS_EXPORT ListImageBuildVersionsResponsePrivate : public imagebuilderResponsePrivate {

public:

    ListImageBuildVersionsResponsePrivate(ListImageBuildVersionsResponse * const q);
