...
/*!
 * \class QtAws::Wisdom::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Wisdom TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : WisdomResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Wisdom TagResource \a response.
 */
...
/*!
 * \class QtAws::Wisdom::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : WisdomResponsePrivate(q)
{

}

/*!
 * Parses a Wisdom TagResource response element from \a xml.
 */
