...
/*!
 * \class QtAws::Wisdom::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Wisdom ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : WisdomResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Wisdom ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Wisdom::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : WisdomResponsePrivate(q)
{

}

/*!
 * Parses a Wisdom ListTagsForResource response element from \a xml.
 */
