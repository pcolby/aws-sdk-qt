...
/*!
 * \class QtAws::Wisdom::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Wisdom UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : WisdomResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Wisdom UntagResource \a response.
 */
...
/*!
 * \class QtAws::Wisdom::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : WisdomResponsePrivate(q)
{

}

/*!
 * Parses a Wisdom UntagResource response element from \a xml.
 */
