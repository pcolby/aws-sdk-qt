...
class QTAWS_EXPORT DescribeDirectoryConfigsResponsePrivate : public AppStreamResponsePrivate {

public:

    DescribeDirectoryConfigsResponsePrivate(DescribeDirectoryConfigsResponse * const q);
