...
class QTAWS_EXPORT CreateUsageReportSubscriptionResponsePrivate : public AppStreamResponsePrivate {

public:

    CreateUsageReportSubscriptionResponsePrivate(CreateUsageReportSubscriptionResponse * const q);
