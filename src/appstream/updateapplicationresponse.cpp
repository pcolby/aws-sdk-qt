...
/*!
 * \class QtAws::AppStream::UpdateApplicationResponse
 * \brief The UpdateApplicationResponse class provides an interace for AppStream UpdateApplication responses.
 *
...
UpdateApplicationResponse::UpdateApplicationResponse(
    ...
    : AppStreamResponse(new UpdateApplicationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful AppStream UpdateApplication \a response.
 */
...
/*!
 * \class QtAws::AppStream::UpdateApplicationResponsePrivate
...
UpdateApplicationResponsePrivate::UpdateApplicationResponsePrivate(
    UpdateApplicationResponse * const q) : AppStreamResponsePrivate(q)
{

}

/*!
 * Parses a AppStream UpdateApplication response element from \a xml.
 */
