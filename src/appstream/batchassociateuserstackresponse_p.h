...
class QTAWS_EXPORT BatchAssociateUserStackResponsePrivate : public AppStreamResponsePrivate {

public:

    BatchAssociateUserStackResponsePrivate(BatchAssociateUserStackResponse * const q);
