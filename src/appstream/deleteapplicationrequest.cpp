...
/*!
 * \class QtAws::AppStream::DeleteApplicationRequest
 * \brief The DeleteApplicationRequest class provides an interface for AppStream DeleteApplication requests.
 *
...
DeleteApplicationRequest::DeleteApplicationRequest(const DeleteApplicationRequest &other)
    : AppStreamRequest(new DeleteApplicationRequestPrivate(*other.d_func(), this))
{
...
DeleteApplicationRequest::DeleteApplicationRequest()
    : AppStreamRequest(new DeleteApplicationRequestPrivate(AppStreamRequest::DeleteApplicationAction, this))
{
...
/*!
 * \class QtAws::AppStream::DeleteApplicationRequestPrivate
...
/*!
 * Constructs a DeleteApplicationRequestPrivate object for AppStream \a action,
 * with public implementation \a q.
 */
DeleteApplicationRequestPrivate::DeleteApplicationRequestPrivate(
    const AppStreamRequest::Action action, DeleteApplicationRequest * const q)
