...
/*!
 * \class QtAws::IoTAnalytics::DeleteDatasetRequest
 * \brief The DeleteDatasetRequest class provides an interface for IoTAnalytics DeleteDataset requests.
 *
...
DeleteDatasetRequest::DeleteDatasetRequest(const DeleteDatasetRequest &other)
    : IoTAnalyticsRequest(new DeleteDatasetRequestPrivate(*other.d_func(), this))
{
...
DeleteDatasetRequest::DeleteDatasetRequest()
    : IoTAnalyticsRequest(new DeleteDatasetRequestPrivate(IoTAnalyticsRequest::DeleteDatasetAction, this))
{
...
/*!
 * \class QtAws::IoTAnalytics::DeleteDatasetRequestPrivate
...
/*!
 * Constructs a DeleteDatasetRequestPrivate object for IoTAnalytics \a action,
 * with public implementation \a q.
 */
DeleteDatasetRequestPrivate::DeleteDatasetRequestPrivate(
    const IoTAnalyticsRequest::Action action, DeleteDatasetRequest * const q)
