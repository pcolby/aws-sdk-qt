...
/*!
 * \class QtAws::IoTAnalytics::DescribeDatasetResponse
 * \brief The DescribeDatasetResponse class provides an interace for IoTAnalytics DescribeDataset responses.
 *
...
DescribeDatasetResponse::DescribeDatasetResponse(
    ...
    : IoTAnalyticsResponse(new DescribeDatasetResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IoTAnalytics DescribeDataset \a response.
 */
...
/*!
 * \class QtAws::IoTAnalytics::DescribeDatasetResponsePrivate
...
DescribeDatasetResponsePrivate::DescribeDatasetResponsePrivate(
    DescribeDatasetResponse * const q) : IoTAnalyticsResponsePrivate(q)
{

}

/*!
 * Parses a IoTAnalytics DescribeDataset response element from \a xml.
 */
