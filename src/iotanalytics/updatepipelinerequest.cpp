...
/*!
 * \class QtAws::IoTAnalytics::UpdatePipelineRequest
 * \brief The UpdatePipelineRequest class provides an interface for IoTAnalytics UpdatePipeline requests.
 *
...
UpdatePipelineRequest::UpdatePipelineRequest(const UpdatePipelineRequest &other)
    : IoTAnalyticsRequest(new UpdatePipelineRequestPrivate(*other.d_func(), this))
{
...
UpdatePipelineRequest::UpdatePipelineRequest()
    : IoTAnalyticsRequest(new UpdatePipelineRequestPrivate(IoTAnalyticsRequest::UpdatePipelineAction, this))
{
...
/*!
 * \class QtAws::IoTAnalytics::UpdatePipelineRequestPrivate
...
/*!
 * Constructs a UpdatePipelineRequestPrivate object for IoTAnalytics \a action,
 * with public implementation \a q.
 */
UpdatePipelineRequestPrivate::UpdatePipelineRequestPrivate(
    const IoTAnalyticsRequest::Action action, UpdatePipelineRequest * const q)
