...
/*!
 * \class QtAws::IoTAnalytics::DeletePipelineResponse
 * \brief The DeletePipelineResponse class provides an interace for IoTAnalytics DeletePipeline responses.
 *
...
DeletePipelineResponse::DeletePipelineResponse(
    ...
    : IoTAnalyticsResponse(new DeletePipelineResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IoTAnalytics DeletePipeline \a response.
 */
...
/*!
 * \class QtAws::IoTAnalytics::DeletePipelineResponsePrivate
...
DeletePipelineResponsePrivate::DeletePipelineResponsePrivate(
    DeletePipelineResponse * const q) : IoTAnalyticsResponsePrivate(q)
{

}

/*!
 * Parses a IoTAnalytics DeletePipeline response element from \a xml.
 */
