...
/*!
 * \class QtAws::IoTAnalytics::ListChannelsRequest
 * \brief The ListChannelsRequest class provides an interface for IoTAnalytics ListChannels requests.
 *
...
ListChannelsRequest::ListChannelsRequest(const ListChannelsRequest &other)
    : IoTAnalyticsRequest(new ListChannelsRequestPrivate(*other.d_func(), this))
{
...
ListChannelsRequest::ListChannelsRequest()
    : IoTAnalyticsRequest(new ListChannelsRequestPrivate(IoTAnalyticsRequest::ListChannelsAction, this))
{
...
/*!
 * \class QtAws::IoTAnalytics::ListChannelsRequestPrivate
...
/*!
 * Constructs a ListChannelsRequestPrivate object for IoTAnalytics \a action,
 * with public implementation \a q.
 */
ListChannelsRequestPrivate::ListChannelsRequestPrivate(
    const IoTAnalyticsRequest::Action action, ListChannelsRequest * const q)
