...
/*!
 * \class QtAws::IoTAnalytics::CreateChannelResponse
 * \brief The CreateChannelResponse class provides an interace for IoTAnalytics CreateChannel responses.
 *
...
CreateChannelResponse::CreateChannelResponse(
    ...
    : IoTAnalyticsResponse(new CreateChannelResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IoTAnalytics CreateChannel \a response.
 */
...
/*!
 * \class QtAws::IoTAnalytics::CreateChannelResponsePrivate
...
CreateChannelResponsePrivate::CreateChannelResponsePrivate(
    CreateChannelResponse * const q) : IoTAnalyticsResponsePrivate(q)
{

}

/*!
 * Parses a IoTAnalytics CreateChannel response element from \a xml.
 */
