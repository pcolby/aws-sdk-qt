...
#include "createdatasetcontentresponse_p.h"
...
/*!
 * \class QtAws::IoTAnalytics::CreateDatasetContentResponse
 * \brief The CreateDatasetContentResponse class provides an interace for IoTAnalytics CreateDatasetContent responses.
 *
...
/*!
 * Constructs a CreateDatasetContentResponse object for \a reply to \a request, with parent \a parent.
 */
CreateDatasetContentResponse::CreateDatasetContentResponse(
        const CreateDatasetContentRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IoTAnalyticsResponse(new CreateDatasetContentResponsePrivate(this), parent)
{
    setRequest(new CreateDatasetContentRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateDatasetContentRequest * CreateDatasetContentResponse::request() const
{
    Q_D(const CreateDatasetContentResponse);
    return static_cast<const CreateDatasetContentRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful IoTAnalytics CreateDatasetContent \a response.
 */
void CreateDatasetContentResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateDatasetContentResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::IoTAnalytics::CreateDatasetContentResponsePrivate
 * \brief The CreateDatasetContentResponsePrivate class provides private implementation for CreateDatasetContentResponse.
 * \internal
 *
 * \inmodule QtAwsIoTAnalytics
 */
...
/*!
 * Constructs a CreateDatasetContentResponsePrivate object with public implementation \a q.
 */
CreateDatasetContentResponsePrivate::CreateDatasetContentResponsePrivate(
    CreateDatasetContentResponse * const q) : IoTAnalyticsResponsePrivate(q)
{

}

/*!
 * Parses a IoTAnalytics CreateDatasetContent response element from \a xml.
 */
void CreateDatasetContentResponsePrivate::parseCreateDatasetContentResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateDatasetContentResponse"));
    Q_UNUSED(xml) ///< @todo
}
