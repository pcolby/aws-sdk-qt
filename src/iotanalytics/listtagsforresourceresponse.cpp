...
/*!
 * \class QtAws::IoTAnalytics::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for IoTAnalytics ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : IoTAnalyticsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IoTAnalytics ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::IoTAnalytics::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : IoTAnalyticsResponsePrivate(q)
{

}

/*!
 * Parses a IoTAnalytics ListTagsForResource response element from \a xml.
 */
