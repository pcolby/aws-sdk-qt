...
/*!
 * \class QtAws::IoTAnalytics::CreateDatasetRequest
 * \brief The CreateDatasetRequest class provides an interface for IoTAnalytics CreateDataset requests.
 *
...
CreateDatasetRequest::CreateDatasetRequest(const CreateDatasetRequest &other)
    : IoTAnalyticsRequest(new CreateDatasetRequestPrivate(*other.d_func(), this))
{
...
CreateDatasetRequest::CreateDatasetRequest()
    : IoTAnalyticsRequest(new CreateDatasetRequestPrivate(IoTAnalyticsRequest::CreateDatasetAction, this))
{
...
/*!
 * \class QtAws::IoTAnalytics::CreateDatasetRequestPrivate
...
/*!
 * Constructs a CreateDatasetRequestPrivate object for IoTAnalytics \a action,
 * with public implementation \a q.
 */
CreateDatasetRequestPrivate::CreateDatasetRequestPrivate(
    const IoTAnalyticsRequest::Action action, CreateDatasetRequest * const q)
