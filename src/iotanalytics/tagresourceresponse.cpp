...
/*!
 * \class QtAws::IoTAnalytics::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for IoTAnalytics TagResource responses.
 *
 ...
 *
 * \sa IoTAnalyticsClient::tagResource
 */
...
TagResourceResponse::TagResourceResponse(
    ...
    : IoTAnalyticsResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(IoTAnalyticsResponse::request());
}

/*!
 * \reimp
 * Parses a successful IoTAnalytics TagResource \a response.
 */
...
/*!
 * \class QtAws::IoTAnalytics::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : IoTAnalyticsResponsePrivate(q)
{

}

/*!
 * Parses a IoTAnalytics TagResource response element from \a xml.
 */
