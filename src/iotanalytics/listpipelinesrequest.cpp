...
/*!
 * \class QtAws::IoTAnalytics::ListPipelinesRequest
 * \brief The ListPipelinesRequest class provides an interface for IoTAnalytics ListPipelines requests.
 *
...
ListPipelinesRequest::ListPipelinesRequest(const ListPipelinesRequest &other)
    : IoTAnalyticsRequest(new ListPipelinesRequestPrivate(*other.d_func(), this))
{
...
ListPipelinesRequest::ListPipelinesRequest()
    : IoTAnalyticsRequest(new ListPipelinesRequestPrivate(IoTAnalyticsRequest::ListPipelinesAction, this))
{
...
/*!
 * \class QtAws::IoTAnalytics::ListPipelinesRequestPrivate
...
/*!
 * Constructs a ListPipelinesRequestPrivate object for IoTAnalytics \a action,
 * with public implementation \a q.
 */
ListPipelinesRequestPrivate::ListPipelinesRequestPrivate(
    const IoTAnalyticsRequest::Action action, ListPipelinesRequest * const q)
