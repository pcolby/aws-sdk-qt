...
/*!
 * \class QtAws::IoTAnalytics::UpdateChannelResponse
 * \brief The UpdateChannelResponse class provides an interace for IoTAnalytics UpdateChannel responses.
 *
...
UpdateChannelResponse::UpdateChannelResponse(
    ...
    : IoTAnalyticsResponse(new UpdateChannelResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IoTAnalytics UpdateChannel \a response.
 */
...
/*!
 * \class QtAws::IoTAnalytics::UpdateChannelResponsePrivate
...
UpdateChannelResponsePrivate::UpdateChannelResponsePrivate(
    UpdateChannelResponse * const q) : IoTAnalyticsResponsePrivate(q)
{

}

/*!
 * Parses a IoTAnalytics UpdateChannel response element from \a xml.
 */
