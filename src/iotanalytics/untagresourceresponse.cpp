...
/*!
 * \class QtAws::IoTAnalytics::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for IoTAnalytics UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : IoTAnalyticsResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(IoTAnalyticsResponse::request());
}

/*!
 * \reimp
 * Parses a successful IoTAnalytics UntagResource \a response.
 */
...
/*!
 * \class QtAws::IoTAnalytics::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : IoTAnalyticsResponsePrivate(q)
{

}

/*!
 * Parses a IoTAnalytics UntagResource response element from \a xml.
 */
