...
class QTAWS_EXPORT CreateDatasetContentResponsePrivate : public IoTAnalyticsResponsePrivate {

public:

    CreateDatasetContentResponsePrivate(CreateDatasetContentResponse * const q);
