...
/*!
 * \class QtAws::IoTAnalytics::DeleteChannelRequest
 * \brief The DeleteChannelRequest class provides an interface for IoTAnalytics DeleteChannel requests.
 *
...
DeleteChannelRequest::DeleteChannelRequest(const DeleteChannelRequest &other)
    : IoTAnalyticsRequest(new DeleteChannelRequestPrivate(*other.d_func(), this))
{
...
DeleteChannelRequest::DeleteChannelRequest()
    : IoTAnalyticsRequest(new DeleteChannelRequestPrivate(IoTAnalyticsRequest::DeleteChannelAction, this))
{
...
/*!
 * \class QtAws::IoTAnalytics::DeleteChannelRequestPrivate
...
/*!
 * Constructs a DeleteChannelRequestPrivate object for IoTAnalytics \a action,
 * with public implementation \a q.
 */
DeleteChannelRequestPrivate::DeleteChannelRequestPrivate(
    const IoTAnalyticsRequest::Action action, DeleteChannelRequest * const q)
