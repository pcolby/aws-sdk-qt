...
#include "updatedatastoreresponse_p.h"
...
/*!
 * \class QtAws::IoTAnalytics::UpdateDatastoreResponse
 * \brief The UpdateDatastoreResponse class provides an interace for IoTAnalytics UpdateDatastore responses.
 *
...
/*!
 * Constructs a UpdateDatastoreResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateDatastoreResponse::UpdateDatastoreResponse(
        const UpdateDatastoreRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IoTAnalyticsResponse(new UpdateDatastoreResponsePrivate(this), parent)
{
    setRequest(new UpdateDatastoreRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful IoTAnalytics UpdateDatastore \a response.
 */
...
/*!
 * \class QtAws::IoTAnalytics::UpdateDatastoreResponsePrivate
 * \brief The UpdateDatastoreResponsePrivate class provides private implementation for UpdateDatastoreResponse.
 * \internal
 *
 * \inmodule QtAwsIoTAnalytics
 */
...
/*!
 * Constructs a UpdateDatastoreResponsePrivate object with public implementation \a q.
 */
UpdateDatastoreResponsePrivate::UpdateDatastoreResponsePrivate(
    UpdateDatastoreResponse * const q) : IoTAnalyticsResponsePrivate(q)
{

}

/*!
 * Parses a IoTAnalytics UpdateDatastore response element from \a xml.
 */
