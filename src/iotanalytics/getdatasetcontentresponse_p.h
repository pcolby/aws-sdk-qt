...
class QTAWS_EXPORT GetDatasetContentResponsePrivate : public IoTAnalyticsResponsePrivate {

public:

    GetDatasetContentResponsePrivate(GetDatasetContentResponse * const q);
