...
/*!
 * \class QtAws::IoTAnalytics::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for IoTAnalytics TagResource requests.
 *
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : IoTAnalyticsRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : IoTAnalyticsRequest(new TagResourceRequestPrivate(IoTAnalyticsRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::IoTAnalytics::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for IoTAnalytics \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const IoTAnalyticsRequest::Action action, TagResourceRequest * const q)
