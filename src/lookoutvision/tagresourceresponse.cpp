...
/*!
 * \class QtAws::LookoutVision::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for LookoutVision TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : LookoutVisionResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful LookoutVision TagResource \a response.
 */
...
/*!
 * \class QtAws::LookoutVision::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : LookoutVisionResponsePrivate(q)
{

}

/*!
 * Parses a LookoutVision TagResource response element from \a xml.
 */
