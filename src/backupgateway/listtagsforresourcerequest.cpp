...
/*!
 * \class QtAws::BackupGateway::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for BackupGateway ListTagsForResource requests.
 *
 ...
 *
 * \sa BackupGatewayClient::listTagsForResource
 */
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : BackupGatewayRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : BackupGatewayRequest(new ListTagsForResourceRequestPrivate(BackupGatewayRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::BackupGateway::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for BackupGateway \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const BackupGatewayRequest::Action action, ListTagsForResourceRequest * const q)
