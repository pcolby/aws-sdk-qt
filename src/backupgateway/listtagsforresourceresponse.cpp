...
/*!
 * \class QtAws::BackupGateway::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for BackupGateway ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : BackupGatewayResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful BackupGateway ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::BackupGateway::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : BackupGatewayResponsePrivate(q)
{

}

/*!
 * Parses a BackupGateway ListTagsForResource response element from \a xml.
 */
