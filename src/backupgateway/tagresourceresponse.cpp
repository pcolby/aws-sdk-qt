...
/*!
 * \class QtAws::BackupGateway::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for BackupGateway TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : BackupGatewayResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful BackupGateway TagResource \a response.
 */
...
/*!
 * \class QtAws::BackupGateway::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : BackupGatewayResponsePrivate(q)
{

}

/*!
 * Parses a BackupGateway TagResource response element from \a xml.
 */
