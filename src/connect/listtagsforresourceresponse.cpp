...
/*!
 * \class QtAws::Connect::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Connect ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ConnectResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Connect ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Connect::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ConnectResponsePrivate(q)
{

}

/*!
 * Parses a Connect ListTagsForResource response element from \a xml.
 */
