...
class QTAWS_EXPORT UpdateContactAttributesResponsePrivate : public ConnectResponsePrivate {

public:

    UpdateContactAttributesResponsePrivate(UpdateContactAttributesResponse * const q);
