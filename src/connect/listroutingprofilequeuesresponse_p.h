...
class QTAWS_EXPORT ListRoutingProfileQueuesResponsePrivate : public ConnectResponsePrivate {

public:

    ListRoutingProfileQueuesResponsePrivate(ListRoutingProfileQueuesResponse * const q);
