...
/*!
 * \class QtAws::Connect::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Connect TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ConnectResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(ConnectResponse::request());
}

/*!
 * \reimp
 * Parses a successful Connect TagResource \a response.
 */
...
/*!
 * \class QtAws::Connect::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ConnectResponsePrivate(q)
{

}

/*!
 * Parses a Connect TagResource response element from \a xml.
 */
