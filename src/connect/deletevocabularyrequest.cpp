...
/*!
 * \class QtAws::Connect::DeleteVocabularyRequest
 * \brief The DeleteVocabularyRequest class provides an interface for Connect DeleteVocabulary requests.
 *
...
DeleteVocabularyRequest::DeleteVocabularyRequest(const DeleteVocabularyRequest &other)
    : ConnectRequest(new DeleteVocabularyRequestPrivate(*other.d_func(), this))
{
...
DeleteVocabularyRequest::DeleteVocabularyRequest()
    : ConnectRequest(new DeleteVocabularyRequestPrivate(ConnectRequest::DeleteVocabularyAction, this))
{
...
/*!
 * \class QtAws::Connect::DeleteVocabularyRequestPrivate
...
/*!
 * Constructs a DeleteVocabularyRequestPrivate object for Connect \a action,
 * with public implementation \a q.
 */
DeleteVocabularyRequestPrivate::DeleteVocabularyRequestPrivate(
    const ConnectRequest::Action action, DeleteVocabularyRequest * const q)
