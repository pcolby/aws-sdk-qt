...
class QTAWS_EXPORT DescribeInstanceStorageConfigResponsePrivate : public ConnectResponsePrivate {

public:

    DescribeInstanceStorageConfigResponsePrivate(DescribeInstanceStorageConfigResponse * const q);
