...
/*!
 * \class QtAws::Connect::CreateQueueResponse
 * \brief The CreateQueueResponse class provides an interace for Connect CreateQueue responses.
 *
...
CreateQueueResponse::CreateQueueResponse(
    ...
    : ConnectResponse(new CreateQueueResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Connect CreateQueue \a response.
 */
...
/*!
 * \class QtAws::Connect::CreateQueueResponsePrivate
...
CreateQueueResponsePrivate::CreateQueueResponsePrivate(
    CreateQueueResponse * const q) : ConnectResponsePrivate(q)
{

}

/*!
 * Parses a Connect CreateQueue response element from \a xml.
 */
