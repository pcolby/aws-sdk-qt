...
class QTAWS_EXPORT UpdateUserHierarchyResponsePrivate : public ConnectResponsePrivate {

public:

    UpdateUserHierarchyResponsePrivate(UpdateUserHierarchyResponse * const q);
