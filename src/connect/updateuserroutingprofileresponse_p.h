...
class QTAWS_EXPORT UpdateUserRoutingProfileResponsePrivate : public ConnectResponsePrivate {

public:

    UpdateUserRoutingProfileResponsePrivate(UpdateUserRoutingProfileResponse * const q);
