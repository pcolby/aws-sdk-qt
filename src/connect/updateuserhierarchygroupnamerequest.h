...
#ifndef QTAWS_UPDATEUSERHIERARCHYGROUPNAMEREQUEST_H
#define QTAWS_UPDATEUSERHIERARCHYGROUPNAMEREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(UpdateUserHierarchyGroupNameRequest)
