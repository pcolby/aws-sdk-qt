...
class QTAWS_EXPORT DescribeUserHierarchyStructureResponsePrivate : public ConnectResponsePrivate {

public:

    DescribeUserHierarchyStructureResponsePrivate(DescribeUserHierarchyStructureResponse * const q);
