...
class QTAWS_EXPORT UpdateUserHierarchyStructureResponsePrivate : public ConnectResponsePrivate {

public:

    UpdateUserHierarchyStructureResponsePrivate(UpdateUserHierarchyStructureResponse * const q);
