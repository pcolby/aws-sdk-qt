...
/*!
 * \class QtAws::Connect::ReleasePhoneNumberRequest
 * \brief The ReleasePhoneNumberRequest class provides an interface for Connect ReleasePhoneNumber requests.
 *
...
ReleasePhoneNumberRequest::ReleasePhoneNumberRequest(const ReleasePhoneNumberRequest &other)
    : ConnectRequest(new ReleasePhoneNumberRequestPrivate(*other.d_func(), this))
{
...
ReleasePhoneNumberRequest::ReleasePhoneNumberRequest()
    : ConnectRequest(new ReleasePhoneNumberRequestPrivate(ConnectRequest::ReleasePhoneNumberAction, this))
{
...
/*!
 * \class QtAws::Connect::ReleasePhoneNumberRequestPrivate
...
/*!
 * Constructs a ReleasePhoneNumberRequestPrivate object for Connect \a action,
 * with public implementation \a q.
 */
ReleasePhoneNumberRequestPrivate::ReleasePhoneNumberRequestPrivate(
    const ConnectRequest::Action action, ReleasePhoneNumberRequest * const q)
