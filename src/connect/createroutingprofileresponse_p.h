...
class QTAWS_EXPORT CreateRoutingProfileResponsePrivate : public ConnectResponsePrivate {

public:

    CreateRoutingProfileResponsePrivate(CreateRoutingProfileResponse * const q);
