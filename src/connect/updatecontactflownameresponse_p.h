...
class QTAWS_EXPORT UpdateContactFlowNameResponsePrivate : public ConnectResponsePrivate {

public:

    UpdateContactFlowNameResponsePrivate(UpdateContactFlowNameResponse * const q);
