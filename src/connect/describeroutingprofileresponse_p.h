...
class QTAWS_EXPORT DescribeRoutingProfileResponsePrivate : public ConnectResponsePrivate {

public:

    DescribeRoutingProfileResponsePrivate(DescribeRoutingProfileResponse * const q);
