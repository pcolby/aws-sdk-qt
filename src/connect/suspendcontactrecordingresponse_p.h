...
class QTAWS_EXPORT SuspendContactRecordingResponsePrivate : public ConnectResponsePrivate {

public:

    SuspendContactRecordingResponsePrivate(SuspendContactRecordingResponse * const q);
