...
/*!
 * \class QtAws::Connect::CreateSecurityProfileResponse
 * \brief The CreateSecurityProfileResponse class provides an interace for Connect CreateSecurityProfile responses.
 *
...
CreateSecurityProfileResponse::CreateSecurityProfileResponse(
    ...
    : ConnectResponse(new CreateSecurityProfileResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Connect CreateSecurityProfile \a response.
 */
...
/*!
 * \class QtAws::Connect::CreateSecurityProfileResponsePrivate
...
CreateSecurityProfileResponsePrivate::CreateSecurityProfileResponsePrivate(
    CreateSecurityProfileResponse * const q) : ConnectResponsePrivate(q)
{

}

/*!
 * Parses a Connect CreateSecurityProfile response element from \a xml.
 */
