...
class QTAWS_EXPORT UpdateRoutingProfileNameResponsePrivate : public ConnectResponsePrivate {

public:

    UpdateRoutingProfileNameResponsePrivate(UpdateRoutingProfileNameResponse * const q);
