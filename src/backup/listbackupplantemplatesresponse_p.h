...
class QTAWS_EXPORT ListBackupPlanTemplatesResponsePrivate : public BackupResponsePrivate {

public:

    ListBackupPlanTemplatesResponsePrivate(ListBackupPlanTemplatesResponse * const q);
