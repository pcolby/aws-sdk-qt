...
class QTAWS_EXPORT ListRecoveryPointsByResourceResponsePrivate : public BackupResponsePrivate {

public:

    ListRecoveryPointsByResourceResponsePrivate(ListRecoveryPointsByResourceResponse * const q);
