...
class QTAWS_EXPORT PutBackupVaultNotificationsResponsePrivate : public BackupResponsePrivate {

public:

    PutBackupVaultNotificationsResponsePrivate(PutBackupVaultNotificationsResponse * const q);
