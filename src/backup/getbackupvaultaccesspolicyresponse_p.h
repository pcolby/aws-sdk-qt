...
class QTAWS_EXPORT GetBackupVaultAccessPolicyResponsePrivate : public BackupResponsePrivate {

public:

    GetBackupVaultAccessPolicyResponsePrivate(GetBackupVaultAccessPolicyResponse * const q);
