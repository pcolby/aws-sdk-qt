...
/*!
 * \class QtAws::Backup::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Backup TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : BackupResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(BackupResponse::request());
}

/*!
 * \reimp
 * Parses a successful Backup TagResource \a response.
 */
...
/*!
 * \class QtAws::Backup::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : BackupResponsePrivate(q)
{

}

/*!
 * Parses a Backup TagResource response element from \a xml.
 */
