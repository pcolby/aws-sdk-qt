...
class QTAWS_EXPORT ListBackupPlanVersionsResponsePrivate : public BackupResponsePrivate {

public:

    ListBackupPlanVersionsResponsePrivate(ListBackupPlanVersionsResponse * const q);
