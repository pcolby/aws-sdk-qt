...
/*!
 * \class QtAws::Backup::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Backup UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : BackupResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Backup UntagResource \a response.
 */
...
/*!
 * \class QtAws::Backup::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : BackupResponsePrivate(q)
{

}

/*!
 * Parses a Backup UntagResource response element from \a xml.
 */
