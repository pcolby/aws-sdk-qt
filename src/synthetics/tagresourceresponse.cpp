...
/*!
 * \class QtAws::Synthetics::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Synthetics TagResource responses.
 *
 ...
 *
 * \sa SyntheticsClient::tagResource
 */
...
TagResourceResponse::TagResourceResponse(
    ...
    : SyntheticsResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(SyntheticsResponse::request());
}

/*!
 * \reimp
 * Parses a successful Synthetics TagResource \a response.
 */
...
/*!
 * \class QtAws::Synthetics::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : SyntheticsResponsePrivate(q)
{

}

/*!
 * Parses a Synthetics TagResource response element from \a xml.
 */
