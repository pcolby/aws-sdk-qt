...
/*!
 * \class QtAws::Synthetics::DisassociateResourceResponse
 * \brief The DisassociateResourceResponse class provides an interace for Synthetics DisassociateResource responses.
 *
...
DisassociateResourceResponse::DisassociateResourceResponse(
    ...
    : SyntheticsResponse(new DisassociateResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Synthetics DisassociateResource \a response.
 */
...
/*!
 * \class QtAws::Synthetics::DisassociateResourceResponsePrivate
...
DisassociateResourceResponsePrivate::DisassociateResourceResponsePrivate(
    DisassociateResourceResponse * const q) : SyntheticsResponsePrivate(q)
{

}

/*!
 * Parses a Synthetics DisassociateResource response element from \a xml.
 */
