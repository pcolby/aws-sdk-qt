...
/*!
 * \class QtAws::Synthetics::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Synthetics UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : SyntheticsResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Synthetics UntagResource \a response.
 */
...
/*!
 * \class QtAws::Synthetics::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : SyntheticsResponsePrivate(q)
{

}

/*!
 * Parses a Synthetics UntagResource response element from \a xml.
 */
