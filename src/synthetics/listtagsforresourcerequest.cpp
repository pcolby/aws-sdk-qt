...
/*!
 * \class QtAws::Synthetics::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for Synthetics ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : SyntheticsRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : SyntheticsRequest(new ListTagsForResourceRequestPrivate(SyntheticsRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::Synthetics::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for Synthetics \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const SyntheticsRequest::Action action, ListTagsForResourceRequest * const q)
