...
/*!
 * \class QtAws::Synthetics::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Synthetics ListTagsForResource responses.
 *
 ...
 *
 * \sa SyntheticsClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : SyntheticsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(SyntheticsResponse::request());
}

/*!
 * \reimp
 * Parses a successful Synthetics ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Synthetics::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : SyntheticsResponsePrivate(q)
{

}

/*!
 * Parses a Synthetics ListTagsForResource response element from \a xml.
 */
