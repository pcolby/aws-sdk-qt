...
/*!
 * \class QtAws::Synthetics::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for Synthetics UntagResource requests.
 *
 ...
 *
 * \sa SyntheticsClient::untagResource
 */
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : SyntheticsRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : SyntheticsRequest(new UntagResourceRequestPrivate(SyntheticsRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::Synthetics::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for Synthetics \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const SyntheticsRequest::Action action, UntagResourceRequest * const q)
