...
/*!
 * \class QtAws::Synthetics::ListGroupsResponse
 * \brief The ListGroupsResponse class provides an interace for Synthetics ListGroups responses.
 *
...
ListGroupsResponse::ListGroupsResponse(
    ...
    : SyntheticsResponse(new ListGroupsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Synthetics ListGroups \a response.
 */
...
/*!
 * \class QtAws::Synthetics::ListGroupsResponsePrivate
...
ListGroupsResponsePrivate::ListGroupsResponsePrivate(
    ListGroupsResponse * const q) : SyntheticsResponsePrivate(q)
{

}

/*!
 * Parses a Synthetics ListGroups response element from \a xml.
 */
