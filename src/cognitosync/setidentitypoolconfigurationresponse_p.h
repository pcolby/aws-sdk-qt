...
class QTAWS_EXPORT SetIdentityPoolConfigurationResponsePrivate : public CognitoSyncResponsePrivate {
    Q_OBJECT

public:

    SetIdentityPoolConfigurationResponsePrivate(SetIdentityPoolConfigurationResponse * const q);
