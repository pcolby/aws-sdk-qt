...
UntagResourceResponse::UntagResourceResponse(
    ...
    : MwaaResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(MwaaResponse::request());
}
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : MwaaResponsePrivate(q)
{
