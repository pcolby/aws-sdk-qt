...
/*!
 * \class QtAws::SESV2::SendCustomVerificationEmailRequest
 * \brief The SendCustomVerificationEmailRequest class provides an interface for SESV2 SendCustomVerificationEmail requests.
 *
 * \inmodule QtAwsSESV2
 *
...
SendCustomVerificationEmailRequest::SendCustomVerificationEmailRequest(const SendCustomVerificationEmailRequest &other)
    : Sesv2Request(new SendCustomVerificationEmailRequestPrivate(*other.d_func(), this))
{
...
SendCustomVerificationEmailRequest::SendCustomVerificationEmailRequest()
    : Sesv2Request(new SendCustomVerificationEmailRequestPrivate(Sesv2Request::SendCustomVerificationEmailAction, this))
{
...
/*!
 * \class QtAws::SESV2::SendCustomVerificationEmailRequestPrivate
...
/*!
 * Constructs a SendCustomVerificationEmailRequestPrivate object for Sesv2 \a action,
 * with public implementation \a q.
 */
SendCustomVerificationEmailRequestPrivate::SendCustomVerificationEmailRequestPrivate(
    const Sesv2Request::Action action, SendCustomVerificationEmailRequest * const q)
