...
class QTAWS_EXPORT PutSuppressedDestinationResponsePrivate : public Sesv2ResponsePrivate {

public:

    PutSuppressedDestinationResponsePrivate(PutSuppressedDestinationResponse * const q);
