...
/*!
 * \class QtAws::SESV2::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for SESV2 ListTagsForResource requests.
 *
 * \inmodule QtAwsSESV2
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : Sesv2Request(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : Sesv2Request(new ListTagsForResourceRequestPrivate(Sesv2Request::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::SESV2::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for Sesv2 \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const Sesv2Request::Action action, ListTagsForResourceRequest * const q)
