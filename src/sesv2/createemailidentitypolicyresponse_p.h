...
class QTAWS_EXPORT CreateEmailIdentityPolicyResponsePrivate : public Sesv2ResponsePrivate {

public:

    CreateEmailIdentityPolicyResponsePrivate(CreateEmailIdentityPolicyResponse * const q);
