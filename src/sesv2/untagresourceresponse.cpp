...
/*!
 * \class QtAws::SESV2::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for SESV2 UntagResource responses.
 *
 * \inmodule QtAwsSESV2
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : Sesv2Response(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(Sesv2Response::request());
}

/*!
 * \reimp
 * Parses a successful SESV2 UntagResource \a response.
 */
...
/*!
 * \class QtAws::SESV2::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : Sesv2ResponsePrivate(q)
{

}

/*!
 * Parses a SESV2 UntagResource response element from \a xml.
 */
