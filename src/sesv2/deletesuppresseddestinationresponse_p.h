...
class QTAWS_EXPORT DeleteSuppressedDestinationResponsePrivate : public Sesv2ResponsePrivate {

public:

    DeleteSuppressedDestinationResponsePrivate(DeleteSuppressedDestinationResponse * const q);
