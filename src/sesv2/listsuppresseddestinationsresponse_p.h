...
class QTAWS_EXPORT ListSuppressedDestinationsResponsePrivate : public Sesv2ResponsePrivate {

public:

    ListSuppressedDestinationsResponsePrivate(ListSuppressedDestinationsResponse * const q);
