...
/*!
 * \class QtAws::SESv2::CreateConfigurationSetRequest
 * \brief The CreateConfigurationSetRequest class provides an interface for SESv2 CreateConfigurationSet requests.
 *
 * \inmodule QtAwsSESv2
 *
...
CreateConfigurationSetRequest::CreateConfigurationSetRequest(const CreateConfigurationSetRequest &other)
    : SESv2Request(new CreateConfigurationSetRequestPrivate(*other.d_func(), this))
{
...
CreateConfigurationSetRequest::CreateConfigurationSetRequest()
    : SESv2Request(new CreateConfigurationSetRequestPrivate(SESv2Request::CreateConfigurationSetAction, this))
{
...
/*!
 * \class QtAws::SESv2::CreateConfigurationSetRequestPrivate
...
/*!
 * Constructs a CreateConfigurationSetRequestPrivate object for SESv2 \a action,
 * with public implementation \a q.
 */
CreateConfigurationSetRequestPrivate::CreateConfigurationSetRequestPrivate(
    const SESv2Request::Action action, CreateConfigurationSetRequest * const q)
