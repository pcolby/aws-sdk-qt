...
/*!
 * \class QtAws::SESV2::CreateEmailIdentityResponse
 * \brief The CreateEmailIdentityResponse class provides an interace for SESV2 CreateEmailIdentity responses.
 *
 * \inmodule QtAwsSESV2
 *
...
CreateEmailIdentityResponse::CreateEmailIdentityResponse(
    ...
    : Sesv2Response(new CreateEmailIdentityResponsePrivate(this), parent)
{
...
{
    return static_cast<const CreateEmailIdentityRequest *>(Sesv2Response::request());
}

/*!
 * \reimp
 * Parses a successful SESV2 CreateEmailIdentity \a response.
 */
...
/*!
 * \class QtAws::SESV2::CreateEmailIdentityResponsePrivate
...
CreateEmailIdentityResponsePrivate::CreateEmailIdentityResponsePrivate(
    CreateEmailIdentityResponse * const q) : Sesv2ResponsePrivate(q)
{

}

/*!
 * Parses a SESV2 CreateEmailIdentity response element from \a xml.
 */
