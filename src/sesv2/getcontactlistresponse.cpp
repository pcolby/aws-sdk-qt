...
#include "getcontactlistresponse_p.h"
...
/*!
 * \class QtAws::SESV2::GetContactListResponse
 * \brief The GetContactListResponse class provides an interace for SESV2 GetContactList responses.
 *
 * \inmodule QtAwsSESV2
 *
...
/*!
 * Constructs a GetContactListResponse object for \a reply to \a request, with parent \a parent.
 */
GetContactListResponse::GetContactListResponse(
        const GetContactListRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Sesv2Response(new GetContactListResponsePrivate(this), parent)
{
    setRequest(new GetContactListRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful SESV2 GetContactList \a response.
 */
void GetContactListResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetContactListResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::SESV2::GetContactListResponsePrivate
 * \brief The GetContactListResponsePrivate class provides private implementation for GetContactListResponse.
 * \internal
 *
 * \inmodule QtAwsSESV2
 */
...
/*!
 * Constructs a GetContactListResponsePrivate object with public implementation \a q.
 */
GetContactListResponsePrivate::GetContactListResponsePrivate(
    GetContactListResponse * const q) : Sesv2ResponsePrivate(q)
{

}

/*!
 * Parses a SESV2 GetContactList response element from \a xml.
 */
void GetContactListResponsePrivate::parseGetContactListResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetContactListResponse"));
    Q_UNUSED(xml) ///< @todo
}
