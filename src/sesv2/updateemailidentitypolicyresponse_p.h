...
class QTAWS_EXPORT UpdateEmailIdentityPolicyResponsePrivate : public Sesv2ResponsePrivate {

public:

    UpdateEmailIdentityPolicyResponsePrivate(UpdateEmailIdentityPolicyResponse * const q);
