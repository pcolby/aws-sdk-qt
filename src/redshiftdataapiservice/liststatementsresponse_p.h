...
class QTAWS_EXPORT ListStatementsResponsePrivate : public RedshiftDataAPIServiceResponsePrivate {

public:

    ListStatementsResponsePrivate(ListStatementsResponse * const q);
