...
class QTAWS_EXPORT ListDatabasesRequestPrivate : public RedshiftDataAPIServiceRequestPrivate {

public:
    ListDatabasesRequestPrivate(const RedshiftDataAPIServiceRequest::Action action,
