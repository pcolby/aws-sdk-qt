...
/*!
 * \class QtAws::RedshiftDataAPIService::ListSchemasRequest
 * \brief The ListSchemasRequest class provides an interface for RedshiftDataAPIService ListSchemas requests.
 *
...
ListSchemasRequest::ListSchemasRequest(const ListSchemasRequest &other)
    : RedshiftDataAPIServiceRequest(new ListSchemasRequestPrivate(*other.d_func(), this))
{
...
ListSchemasRequest::ListSchemasRequest()
    : RedshiftDataAPIServiceRequest(new ListSchemasRequestPrivate(RedshiftDataAPIServiceRequest::ListSchemasAction, this))
{
...
/*!
 * \class QtAws::RedshiftDataAPIService::ListSchemasRequestPrivate
...
/*!
 * Constructs a ListSchemasRequestPrivate object for RedshiftDataAPIService \a action,
 * with public implementation \a q.
 */
ListSchemasRequestPrivate::ListSchemasRequestPrivate(
    const RedshiftDataAPIServiceRequest::Action action, ListSchemasRequest * const q)
