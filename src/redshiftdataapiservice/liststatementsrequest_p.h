...
class QTAWS_EXPORT ListStatementsRequestPrivate : public RedshiftDataAPIServiceRequestPrivate {

public:
    ListStatementsRequestPrivate(const RedshiftDataAPIServiceRequest::Action action,
