...
class QTAWS_EXPORT DescribeTableRequestPrivate : public RedshiftDataAPIServiceRequestPrivate {

public:
    DescribeTableRequestPrivate(const RedshiftDataAPIServiceRequest::Action action,
