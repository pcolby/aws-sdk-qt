...
class QTAWS_EXPORT ExecuteStatementRequestPrivate : public RedshiftDataAPIServiceRequestPrivate {

public:
    ExecuteStatementRequestPrivate(const RedshiftDataAPIServiceRequest::Action action,
