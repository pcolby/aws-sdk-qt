...
class QTAWS_EXPORT DescribeAutoScalingGroupsResponse : public DescribeAutoScalingGroupsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeAutoScalingGroupsRequest * request() const;
