...
class QTAWS_EXPORT DetachLoadBalancerTargetGroupsResponse : public AutoScalingResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DetachLoadBalancerTargetGroupsRequest * request() const override;
