...
class QTAWS_EXPORT DeleteNotificationConfigurationResponse : public AutoScalingResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteNotificationConfigurationRequest * request() const override;
