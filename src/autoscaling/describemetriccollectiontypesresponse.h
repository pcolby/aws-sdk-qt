...
class QTAWS_EXPORT DescribeMetricCollectionTypesResponse : public AutoScalingResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeMetricCollectionTypesRequest * request() const override;
