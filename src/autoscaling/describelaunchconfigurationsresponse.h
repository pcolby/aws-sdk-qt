...
class QTAWS_EXPORT DescribeLaunchConfigurationsResponse : public AutoScalingResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeLaunchConfigurationsRequest * request() const override;
