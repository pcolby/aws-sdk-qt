...
#include "deletepricingrulerequest_p.h"
...
/*!
 * \class QtAws::BillingConductor::DeletePricingRuleRequest
 * \brief The DeletePricingRuleRequest class provides an interface for BillingConductor DeletePricingRule requests.
 *
 ...
 */
DeletePricingRuleRequest::DeletePricingRuleRequest(const DeletePricingRuleRequest &other)
    : BillingConductorRequest(new DeletePricingRuleRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeletePricingRuleRequest object.
 */
DeletePricingRuleRequest::DeletePricingRuleRequest()
    : BillingConductorRequest(new DeletePricingRuleRequestPrivate(BillingConductorRequest::DeletePricingRuleAction, this))
{
 ...
 * \reimp
 */
bool DeletePricingRuleRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeletePricingRuleResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeletePricingRuleRequest::response(QNetworkReply * const reply) const
{
    return new DeletePricingRuleResponse(*this, reply);
}

/*!
 * \class QtAws::BillingConductor::DeletePricingRuleRequestPrivate
 * \brief The DeletePricingRuleRequestPrivate class provides private implementation for DeletePricingRuleRequest.
 * \internal
 *
 * \inmodule QtAwsBillingConductor
 */
...
/*!
 * Constructs a DeletePricingRuleRequestPrivate object for BillingConductor \a action,
 * with public implementation \a q.
 */
DeletePricingRuleRequestPrivate::DeletePricingRuleRequestPrivate(
    const BillingConductorRequest::Action action, DeletePricingRuleRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeletePricingRuleRequest
 * class' copy constructor.
 */
DeletePricingRuleRequestPrivate::DeletePricingRuleRequestPrivate(
    const DeletePricingRuleRequestPrivate &other, DeletePricingRuleRequest * const q)
