...
/*!
 * \class QtAws::BillingConductor::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for BillingConductor TagResource requests.
 *
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : BillingConductorRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : BillingConductorRequest(new TagResourceRequestPrivate(BillingConductorRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::BillingConductor::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for BillingConductor \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const BillingConductorRequest::Action action, TagResourceRequest * const q)
