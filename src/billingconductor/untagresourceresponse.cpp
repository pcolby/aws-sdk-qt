...
/*!
 * \class QtAws::BillingConductor::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for BillingConductor UntagResource responses.
 *
 ...
 *
 * \sa BillingConductorClient::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : BillingConductorResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful BillingConductor UntagResource \a response.
 */
...
/*!
 * \class QtAws::BillingConductor::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : BillingConductorResponsePrivate(q)
{

}

/*!
 * Parses a BillingConductor UntagResource response element from \a xml.
 */
