...
#include "disassociateaccountsresponse_p.h"
...
/*!
 * \class QtAws::BillingConductor::DisassociateAccountsResponse
 * \brief The DisassociateAccountsResponse class provides an interace for BillingConductor DisassociateAccounts responses.
 *
...
/*!
 * Constructs a DisassociateAccountsResponse object for \a reply to \a request, with parent \a parent.
 */
DisassociateAccountsResponse::DisassociateAccountsResponse(
        const DisassociateAccountsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : BillingConductorResponse(new DisassociateAccountsResponsePrivate(this), parent)
{
    setRequest(new DisassociateAccountsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DisassociateAccountsRequest * DisassociateAccountsResponse::request() const
{
    Q_D(const DisassociateAccountsResponse);
    return static_cast<const DisassociateAccountsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful BillingConductor DisassociateAccounts \a response.
 */
void DisassociateAccountsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DisassociateAccountsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::BillingConductor::DisassociateAccountsResponsePrivate
 * \brief The DisassociateAccountsResponsePrivate class provides private implementation for DisassociateAccountsResponse.
 * \internal
 *
 * \inmodule QtAwsBillingConductor
 */
...
/*!
 * Constructs a DisassociateAccountsResponsePrivate object with public implementation \a q.
 */
DisassociateAccountsResponsePrivate::DisassociateAccountsResponsePrivate(
    DisassociateAccountsResponse * const q) : BillingConductorResponsePrivate(q)
{

}

/*!
 * Parses a BillingConductor DisassociateAccounts response element from \a xml.
 */
void DisassociateAccountsResponsePrivate::parseDisassociateAccountsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DisassociateAccountsResponse"));
    Q_UNUSED(xml) ///< @todo
}
