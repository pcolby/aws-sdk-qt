...
#include "createpricingruleresponse_p.h"
...
/*!
 * \class QtAws::BillingConductor::CreatePricingRuleResponse
 * \brief The CreatePricingRuleResponse class provides an interace for BillingConductor CreatePricingRule responses.
 *
...
/*!
 * Constructs a CreatePricingRuleResponse object for \a reply to \a request, with parent \a parent.
 */
CreatePricingRuleResponse::CreatePricingRuleResponse(
        const CreatePricingRuleRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : BillingConductorResponse(new CreatePricingRuleResponsePrivate(this), parent)
{
    setRequest(new CreatePricingRuleRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreatePricingRuleRequest * CreatePricingRuleResponse::request() const
{
    Q_D(const CreatePricingRuleResponse);
    return static_cast<const CreatePricingRuleRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful BillingConductor CreatePricingRule \a response.
 */
void CreatePricingRuleResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreatePricingRuleResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::BillingConductor::CreatePricingRuleResponsePrivate
 * \brief The CreatePricingRuleResponsePrivate class provides private implementation for CreatePricingRuleResponse.
 * \internal
 *
 * \inmodule QtAwsBillingConductor
 */
...
/*!
 * Constructs a CreatePricingRuleResponsePrivate object with public implementation \a q.
 */
CreatePricingRuleResponsePrivate::CreatePricingRuleResponsePrivate(
    CreatePricingRuleResponse * const q) : BillingConductorResponsePrivate(q)
{

}

/*!
 * Parses a BillingConductor CreatePricingRule response element from \a xml.
 */
void CreatePricingRuleResponsePrivate::parseCreatePricingRuleResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreatePricingRuleResponse"));
    Q_UNUSED(xml) ///< @todo
}
