...
/*!
 * \class QtAws::BillingConductor::DeleteBillingGroupRequest
 * \brief The DeleteBillingGroupRequest class provides an interface for BillingConductor DeleteBillingGroup requests.
 *
...
DeleteBillingGroupRequest::DeleteBillingGroupRequest(const DeleteBillingGroupRequest &other)
    : BillingConductorRequest(new DeleteBillingGroupRequestPrivate(*other.d_func(), this))
{
...
DeleteBillingGroupRequest::DeleteBillingGroupRequest()
    : BillingConductorRequest(new DeleteBillingGroupRequestPrivate(BillingConductorRequest::DeleteBillingGroupAction, this))
{
...
/*!
 * \class QtAws::BillingConductor::DeleteBillingGroupRequestPrivate
...
/*!
 * Constructs a DeleteBillingGroupRequestPrivate object for BillingConductor \a action,
 * with public implementation \a q.
 */
DeleteBillingGroupRequestPrivate::DeleteBillingGroupRequestPrivate(
    const BillingConductorRequest::Action action, DeleteBillingGroupRequest * const q)
