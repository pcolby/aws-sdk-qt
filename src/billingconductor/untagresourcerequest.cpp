...
/*!
 * \class QtAws::BillingConductor::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for BillingConductor UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : BillingConductorRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : BillingConductorRequest(new UntagResourceRequestPrivate(BillingConductorRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::BillingConductor::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for BillingConductor \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const BillingConductorRequest::Action action, UntagResourceRequest * const q)
