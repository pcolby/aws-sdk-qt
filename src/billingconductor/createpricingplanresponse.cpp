...
#include "createpricingplanresponse_p.h"
...
/*!
 * \class QtAws::BillingConductor::CreatePricingPlanResponse
 * \brief The CreatePricingPlanResponse class provides an interace for BillingConductor CreatePricingPlan responses.
 *
...
/*!
 * Constructs a CreatePricingPlanResponse object for \a reply to \a request, with parent \a parent.
 */
CreatePricingPlanResponse::CreatePricingPlanResponse(
        const CreatePricingPlanRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : BillingConductorResponse(new CreatePricingPlanResponsePrivate(this), parent)
{
    setRequest(new CreatePricingPlanRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreatePricingPlanRequest * CreatePricingPlanResponse::request() const
{
    Q_D(const CreatePricingPlanResponse);
    return static_cast<const CreatePricingPlanRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful BillingConductor CreatePricingPlan \a response.
 */
void CreatePricingPlanResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreatePricingPlanResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::BillingConductor::CreatePricingPlanResponsePrivate
 * \brief The CreatePricingPlanResponsePrivate class provides private implementation for CreatePricingPlanResponse.
 * \internal
 *
 * \inmodule QtAwsBillingConductor
 */
...
/*!
 * Constructs a CreatePricingPlanResponsePrivate object with public implementation \a q.
 */
CreatePricingPlanResponsePrivate::CreatePricingPlanResponsePrivate(
    CreatePricingPlanResponse * const q) : BillingConductorResponsePrivate(q)
{

}

/*!
 * Parses a BillingConductor CreatePricingPlan response element from \a xml.
 */
void CreatePricingPlanResponsePrivate::parseCreatePricingPlanResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreatePricingPlanResponse"));
    Q_UNUSED(xml) ///< @todo
}
