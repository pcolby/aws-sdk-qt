...
/*!
 * \class QtAws::BillingConductor::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for BillingConductor ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : BillingConductorResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful BillingConductor ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::BillingConductor::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : BillingConductorResponsePrivate(q)
{

}

/*!
 * Parses a BillingConductor ListTagsForResource response element from \a xml.
 */
