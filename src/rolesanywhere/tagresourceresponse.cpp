...
/*!
 * \class QtAws::RolesAnywhere::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for RolesAnywhere TagResource responses.
 *
 ...
 *
 * \sa RolesAnywhereClient::tagResource
 */
...
TagResourceResponse::TagResourceResponse(
    ...
    : RolesAnywhereResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful RolesAnywhere TagResource \a response.
 */
...
/*!
 * \class QtAws::RolesAnywhere::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : RolesAnywhereResponsePrivate(q)
{

}

/*!
 * Parses a RolesAnywhere TagResource response element from \a xml.
 */
