...
/*!
 * \class QtAws::RolesAnywhere::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for RolesAnywhere UntagResource requests.
 *
 ...
 *
 * \sa RolesAnywhereClient::untagResource
 */
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : RolesAnywhereRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : RolesAnywhereRequest(new UntagResourceRequestPrivate(RolesAnywhereRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::RolesAnywhere::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for RolesAnywhere \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const RolesAnywhereRequest::Action action, UntagResourceRequest * const q)
