...
/*!
 * \class QtAws::RolesAnywhere::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for RolesAnywhere ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : RolesAnywhereRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : RolesAnywhereRequest(new ListTagsForResourceRequestPrivate(RolesAnywhereRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::RolesAnywhere::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for RolesAnywhere \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const RolesAnywhereRequest::Action action, ListTagsForResourceRequest * const q)
