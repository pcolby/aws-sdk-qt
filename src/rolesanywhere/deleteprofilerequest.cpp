...
/*!
 * \class QtAws::RolesAnywhere::DeleteProfileRequest
 * \brief The DeleteProfileRequest class provides an interface for RolesAnywhere DeleteProfile requests.
 *
...
DeleteProfileRequest::DeleteProfileRequest(const DeleteProfileRequest &other)
    : RolesAnywhereRequest(new DeleteProfileRequestPrivate(*other.d_func(), this))
{
...
DeleteProfileRequest::DeleteProfileRequest()
    : RolesAnywhereRequest(new DeleteProfileRequestPrivate(RolesAnywhereRequest::DeleteProfileAction, this))
{
...
/*!
 * \class QtAws::RolesAnywhere::DeleteProfileRequestPrivate
...
/*!
 * Constructs a DeleteProfileRequestPrivate object for RolesAnywhere \a action,
 * with public implementation \a q.
 */
DeleteProfileRequestPrivate::DeleteProfileRequestPrivate(
    const RolesAnywhereRequest::Action action, DeleteProfileRequest * const q)
