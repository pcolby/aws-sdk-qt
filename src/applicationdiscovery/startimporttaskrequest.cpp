 ...
 * \reimp
 */
bool StartImportTaskRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a StartImportTaskResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * StartImportTaskRequest::response(QNetworkReply * const reply) const
{
    return new StartImportTaskResponse(*this, reply);
}
 ...
 *
 * This copy-like constructor exists for the benefit of the StartImportTaskRequest
