...
/*!
 * \class QtAws::IoTTwinMaker::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for IoTTwinMaker ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : IoTTwinMakerResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IoTTwinMaker ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::IoTTwinMaker::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : IoTTwinMakerResponsePrivate(q)
{

}

/*!
 * Parses a IoTTwinMaker ListTagsForResource response element from \a xml.
 */
