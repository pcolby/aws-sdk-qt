...
/*!
 * \class QtAws::IoTTwinMaker::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for IoTTwinMaker UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : IoTTwinMakerResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IoTTwinMaker UntagResource \a response.
 */
...
/*!
 * \class QtAws::IoTTwinMaker::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : IoTTwinMakerResponsePrivate(q)
{

}

/*!
 * Parses a IoTTwinMaker UntagResource response element from \a xml.
 */
