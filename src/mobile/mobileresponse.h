...
#ifndef QTAWS_MOBILERESPONSE_H
#define QTAWS_MOBILERESPONSE_H
...
class QTAWSMOBILE_EXPORT MobileResponse : public QtAws::Core::AwsAbstractResponse {
    Q_OBJECT
...
private:
    Q_DECLARE_PRIVATE(MobileResponse)
    Q_DISABLE_COPY(MobileResponse)
