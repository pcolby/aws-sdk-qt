...
#ifndef QTAWS_APPINTEGRATIONSSERVICERESPONSE_H
...
public:
    AppIntegrationsServiceResponse(QObject * const parent = 0);
...
private:
    Q_DECLARE_PRIVATE(AppIntegrationsServiceResponse)
    Q_DISABLE_COPY(AppIntegrationsServiceResponse)
