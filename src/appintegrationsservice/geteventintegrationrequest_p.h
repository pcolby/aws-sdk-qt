...
class QTAWS_EXPORT GetEventIntegrationRequestPrivate : public AppIntegrationsServiceRequestPrivate {

public:
    GetEventIntegrationRequestPrivate(const AppIntegrationsServiceRequest::Action action,
