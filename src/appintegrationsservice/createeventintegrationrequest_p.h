...
class QTAWS_EXPORT CreateEventIntegrationRequestPrivate : public AppIntegrationsServiceRequestPrivate {

public:
    CreateEventIntegrationRequestPrivate(const AppIntegrationsServiceRequest::Action action,
