...
/*!
 * \class QtAws::AppIntegrationsService::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for AppIntegrationsService ListTagsForResource responses.
 *
 ...
 *
 * \sa AppIntegrationsServiceClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : AppIntegrationsServiceResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(AppIntegrationsServiceResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppIntegrationsService ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::AppIntegrationsService::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : AppIntegrationsServiceResponsePrivate(q)
{

}

/*!
 * Parses a AppIntegrationsService ListTagsForResource response element from \a xml.
 */
