...
/*!
 * \class QtAws::AppIntegrationsService::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for AppIntegrationsService UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : AppIntegrationsServiceResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(AppIntegrationsServiceResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppIntegrationsService UntagResource \a response.
 */
...
/*!
 * \class QtAws::AppIntegrationsService::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : AppIntegrationsServiceResponsePrivate(q)
{

}

/*!
 * Parses a AppIntegrationsService UntagResource response element from \a xml.
 */
