...
class QTAWS_EXPORT DescribeFargateProfileResponsePrivate : public EksResponsePrivate {

public:

    DescribeFargateProfileResponsePrivate(DescribeFargateProfileResponse * const q);
