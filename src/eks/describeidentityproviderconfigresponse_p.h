...
class QTAWS_EXPORT DescribeIdentityProviderConfigResponsePrivate : public EksResponsePrivate {

public:

    DescribeIdentityProviderConfigResponsePrivate(DescribeIdentityProviderConfigResponse * const q);
