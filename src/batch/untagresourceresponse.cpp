...
/*!
 * \class QtAws::Batch::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Batch UntagResource responses.
 *
 * \inmodule QtAwsBatch
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : BatchResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(BatchResponse::request());
}

/*!
 * \reimp
 * Parses a successful Batch UntagResource \a response.
 */
...
/*!
 * \class QtAws::Batch::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : BatchResponsePrivate(q)
{

}

/*!
 * Parses a Batch UntagResource response element from \a xml.
 */
