...
class QTAWS_EXPORT DescribeJobDefinitionsResponsePrivate : public BatchResponsePrivate {

public:

    DescribeJobDefinitionsResponsePrivate(DescribeJobDefinitionsResponse * const q);
