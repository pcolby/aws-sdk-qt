...
class QTAWS_EXPORT ListProjectAssetsResponsePrivate : public IoTSiteWiseResponsePrivate {

public:

    ListProjectAssetsResponsePrivate(ListProjectAssetsResponse * const q);
