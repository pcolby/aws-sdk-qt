...
class QTAWS_EXPORT DescribeAccessPolicyResponsePrivate : public IoTSiteWiseResponsePrivate {

public:

    DescribeAccessPolicyResponsePrivate(DescribeAccessPolicyResponse * const q);
