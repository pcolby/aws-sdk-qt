...
class QTAWS_EXPORT ListAssetRelationshipsResponsePrivate : public IoTSiteWiseResponsePrivate {

public:

    ListAssetRelationshipsResponsePrivate(ListAssetRelationshipsResponse * const q);
