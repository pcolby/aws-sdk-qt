...
class QTAWS_EXPORT PutDefaultEncryptionConfigurationResponsePrivate : public IoTSiteWiseResponsePrivate {

public:

    PutDefaultEncryptionConfigurationResponsePrivate(PutDefaultEncryptionConfigurationResponse * const q);
