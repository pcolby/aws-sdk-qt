...
class QTAWS_EXPORT DescribeAssetModelResponsePrivate : public IoTSiteWiseResponsePrivate {

public:

    DescribeAssetModelResponsePrivate(DescribeAssetModelResponse * const q);
