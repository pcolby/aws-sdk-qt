...
/*!
 * \class QtAws::IoTSiteWise::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for IoTSiteWise TagResource responses.
 *
 ...
 *
 * \sa IoTSiteWiseClient::tagResource
 */
...
TagResourceResponse::TagResourceResponse(
    ...
    : IoTSiteWiseResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(IoTSiteWiseResponse::request());
}

/*!
 * \reimp
 * Parses a successful IoTSiteWise TagResource \a response.
 */
...
/*!
 * \class QtAws::IoTSiteWise::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : IoTSiteWiseResponsePrivate(q)
{

}

/*!
 * Parses a IoTSiteWise TagResource response element from \a xml.
 */
