...
class QTAWS_EXPORT ListAccessPoliciesResponsePrivate : public IoTSiteWiseResponsePrivate {

public:

    ListAccessPoliciesResponsePrivate(ListAccessPoliciesResponse * const q);
