...
#include "putquerydefinitionresponse_p.h"
...
/*!
 * \class QtAws::CloudWatchLogs::PutQueryDefinitionResponse
 * \brief The PutQueryDefinitionResponse class provides an interace for CloudWatchLogs PutQueryDefinition responses.
 *
...
/*!
 * Constructs a PutQueryDefinitionResponse object for \a reply to \a request, with parent \a parent.
 */
PutQueryDefinitionResponse::PutQueryDefinitionResponse(
        const PutQueryDefinitionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CloudWatchLogsResponse(new PutQueryDefinitionResponsePrivate(this), parent)
{
    setRequest(new PutQueryDefinitionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CloudWatchLogs PutQueryDefinition \a response.
 */
void PutQueryDefinitionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutQueryDefinitionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CloudWatchLogs::PutQueryDefinitionResponsePrivate
 * \brief The PutQueryDefinitionResponsePrivate class provides private implementation for PutQueryDefinitionResponse.
 * \internal
 *
 * \inmodule QtAwsCloudWatchLogs
 */
...
/*!
 * Constructs a PutQueryDefinitionResponsePrivate object with public implementation \a q.
 */
PutQueryDefinitionResponsePrivate::PutQueryDefinitionResponsePrivate(
    PutQueryDefinitionResponse * const q) : CloudWatchLogsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchLogs PutQueryDefinition response element from \a xml.
 */
void PutQueryDefinitionResponsePrivate::parsePutQueryDefinitionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutQueryDefinitionResponse"));
    Q_UNUSED(xml) ///< @todo
}
