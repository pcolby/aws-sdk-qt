...
class QTAWS_EXPORT GetLogGroupFieldsResponsePrivate : public CloudWatchLogsResponsePrivate {

public:

    GetLogGroupFieldsResponsePrivate(GetLogGroupFieldsResponse * const q);
