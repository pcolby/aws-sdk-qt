...
class QTAWS_EXPORT DescribeSubscriptionFiltersResponse : public CloudWatchLogsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeSubscriptionFiltersRequest * request() const override;
