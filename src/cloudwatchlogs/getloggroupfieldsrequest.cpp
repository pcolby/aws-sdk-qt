...
#include "getloggroupfieldsrequest_p.h"
...
/*!
 * \class QtAws::CloudWatchLogs::GetLogGroupFieldsRequest
 * \brief The GetLogGroupFieldsRequest class provides an interface for CloudWatchLogs GetLogGroupFields requests.
 *
 ...
 */
GetLogGroupFieldsRequest::GetLogGroupFieldsRequest(const GetLogGroupFieldsRequest &other)
    : CloudWatchLogsRequest(new GetLogGroupFieldsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetLogGroupFieldsRequest object.
 */
GetLogGroupFieldsRequest::GetLogGroupFieldsRequest()
    : CloudWatchLogsRequest(new GetLogGroupFieldsRequestPrivate(CloudWatchLogsRequest::GetLogGroupFieldsAction, this))
{
 ...
 * \reimp
 */
bool GetLogGroupFieldsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetLogGroupFieldsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetLogGroupFieldsRequest::response(QNetworkReply * const reply) const
{
    return new GetLogGroupFieldsResponse(*this, reply);
}

/*!
 * \class QtAws::CloudWatchLogs::GetLogGroupFieldsRequestPrivate
 * \brief The GetLogGroupFieldsRequestPrivate class provides private implementation for GetLogGroupFieldsRequest.
 * \internal
 *
 * \inmodule QtAwsCloudWatchLogs
 */
...
/*!
 * Constructs a GetLogGroupFieldsRequestPrivate object for CloudWatchLogs \a action,
 * with public implementation \a q.
 */
GetLogGroupFieldsRequestPrivate::GetLogGroupFieldsRequestPrivate(
    const CloudWatchLogsRequest::Action action, GetLogGroupFieldsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetLogGroupFieldsRequest
 * class' copy constructor.
 */
GetLogGroupFieldsRequestPrivate::GetLogGroupFieldsRequestPrivate(
    const GetLogGroupFieldsRequestPrivate &other, GetLogGroupFieldsRequest * const q)
