...
#include "describequerydefinitionsrequest_p.h"
...
/*!
 * \class QtAws::CloudWatchLogs::DescribeQueryDefinitionsRequest
 * \brief The DescribeQueryDefinitionsRequest class provides an interface for CloudWatchLogs DescribeQueryDefinitions requests.
 *
 ...
 */
DescribeQueryDefinitionsRequest::DescribeQueryDefinitionsRequest(const DescribeQueryDefinitionsRequest &other)
    : CloudWatchLogsRequest(new DescribeQueryDefinitionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeQueryDefinitionsRequest object.
 */
DescribeQueryDefinitionsRequest::DescribeQueryDefinitionsRequest()
    : CloudWatchLogsRequest(new DescribeQueryDefinitionsRequestPrivate(CloudWatchLogsRequest::DescribeQueryDefinitionsAction, this))
{
 ...
 * \reimp
 */
bool DescribeQueryDefinitionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeQueryDefinitionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeQueryDefinitionsRequest::response(QNetworkReply * const reply) const
{
    return new DescribeQueryDefinitionsResponse(*this, reply);
}

/*!
 * \class QtAws::CloudWatchLogs::DescribeQueryDefinitionsRequestPrivate
 * \brief The DescribeQueryDefinitionsRequestPrivate class provides private implementation for DescribeQueryDefinitionsRequest.
 * \internal
 *
 * \inmodule QtAwsCloudWatchLogs
 */
...
/*!
 * Constructs a DescribeQueryDefinitionsRequestPrivate object for CloudWatchLogs \a action,
 * with public implementation \a q.
 */
DescribeQueryDefinitionsRequestPrivate::DescribeQueryDefinitionsRequestPrivate(
    const CloudWatchLogsRequest::Action action, DescribeQueryDefinitionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeQueryDefinitionsRequest
 * class' copy constructor.
 */
DescribeQueryDefinitionsRequestPrivate::DescribeQueryDefinitionsRequestPrivate(
    const DescribeQueryDefinitionsRequestPrivate &other, DescribeQueryDefinitionsRequest * const q)
