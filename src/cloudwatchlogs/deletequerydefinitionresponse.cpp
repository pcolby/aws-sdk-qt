...
#include "deletequerydefinitionresponse_p.h"
...
/*!
 * \class QtAws::CloudWatchLogs::DeleteQueryDefinitionResponse
 * \brief The DeleteQueryDefinitionResponse class provides an interace for CloudWatchLogs DeleteQueryDefinition responses.
 *
...
/*!
 * Constructs a DeleteQueryDefinitionResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteQueryDefinitionResponse::DeleteQueryDefinitionResponse(
        const DeleteQueryDefinitionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CloudWatchLogsResponse(new DeleteQueryDefinitionResponsePrivate(this), parent)
{
    setRequest(new DeleteQueryDefinitionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CloudWatchLogs DeleteQueryDefinition \a response.
 */
void DeleteQueryDefinitionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteQueryDefinitionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CloudWatchLogs::DeleteQueryDefinitionResponsePrivate
 * \brief The DeleteQueryDefinitionResponsePrivate class provides private implementation for DeleteQueryDefinitionResponse.
 * \internal
 *
 * \inmodule QtAwsCloudWatchLogs
 */
...
/*!
 * Constructs a DeleteQueryDefinitionResponsePrivate object with public implementation \a q.
 */
DeleteQueryDefinitionResponsePrivate::DeleteQueryDefinitionResponsePrivate(
    DeleteQueryDefinitionResponse * const q) : CloudWatchLogsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchLogs DeleteQueryDefinition response element from \a xml.
 */
void DeleteQueryDefinitionResponsePrivate::parseDeleteQueryDefinitionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteQueryDefinitionResponse"));
    Q_UNUSED(xml) ///< @todo
}
