...
/*!
 * \class QtAws::CloudWatchLogs::StartQueryResponse
 * \brief The StartQueryResponse class provides an interace for CloudWatchLogs StartQuery responses.
 *
...
StartQueryResponse::StartQueryResponse(
    ...
    : CloudWatchLogsResponse(new StartQueryResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CloudWatchLogs StartQuery \a response.
 */
...
/*!
 * \class QtAws::CloudWatchLogs::StartQueryResponsePrivate
...
StartQueryResponsePrivate::StartQueryResponsePrivate(
    StartQueryResponse * const q) : CloudWatchLogsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchLogs StartQuery response element from \a xml.
 */
