...
#include "describequeriesresponse_p.h"
...
/*!
 * \class QtAws::CloudWatchLogs::DescribeQueriesResponse
 * \brief The DescribeQueriesResponse class provides an interace for CloudWatchLogs DescribeQueries responses.
 *
...
/*!
 * Constructs a DescribeQueriesResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeQueriesResponse::DescribeQueriesResponse(
        const DescribeQueriesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : CloudWatchLogsResponse(new DescribeQueriesResponsePrivate(this), parent)
{
    setRequest(new DescribeQueriesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful CloudWatchLogs DescribeQueries \a response.
 */
void DescribeQueriesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeQueriesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::CloudWatchLogs::DescribeQueriesResponsePrivate
 * \brief The DescribeQueriesResponsePrivate class provides private implementation for DescribeQueriesResponse.
 * \internal
 *
 * \inmodule QtAwsCloudWatchLogs
 */
...
/*!
 * Constructs a DescribeQueriesResponsePrivate object with public implementation \a q.
 */
DescribeQueriesResponsePrivate::DescribeQueriesResponsePrivate(
    DescribeQueriesResponse * const q) : CloudWatchLogsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchLogs DescribeQueries response element from \a xml.
 */
void DescribeQueriesResponsePrivate::parseDescribeQueriesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeQueriesResponse"));
    Q_UNUSED(xml) ///< @todo
}
