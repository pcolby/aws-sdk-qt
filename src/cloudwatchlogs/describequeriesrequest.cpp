...
#include "describequeriesrequest_p.h"
...
/*!
 * \class QtAws::CloudWatchLogs::DescribeQueriesRequest
 * \brief The DescribeQueriesRequest class provides an interface for CloudWatchLogs DescribeQueries requests.
 *
 ...
 *
 * \sa CloudWatchLogsClient::describeQueries
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeQueriesRequest::DescribeQueriesRequest(const DescribeQueriesRequest &other)
    : CloudWatchLogsRequest(new DescribeQueriesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeQueriesRequest object.
 */
DescribeQueriesRequest::DescribeQueriesRequest()
    : CloudWatchLogsRequest(new DescribeQueriesRequestPrivate(CloudWatchLogsRequest::DescribeQueriesAction, this))
{
 ...
 * \reimp
 */
bool DescribeQueriesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeQueriesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeQueriesRequest::response(QNetworkReply * const reply) const
{
    return new DescribeQueriesResponse(*this, reply);
}

/*!
 * \class QtAws::CloudWatchLogs::DescribeQueriesRequestPrivate
 * \brief The DescribeQueriesRequestPrivate class provides private implementation for DescribeQueriesRequest.
 * \internal
 *
 * \inmodule QtAwsCloudWatchLogs
 */
...
/*!
 * Constructs a DescribeQueriesRequestPrivate object for CloudWatchLogs \a action,
 * with public implementation \a q.
 */
DescribeQueriesRequestPrivate::DescribeQueriesRequestPrivate(
    const CloudWatchLogsRequest::Action action, DescribeQueriesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeQueriesRequest
 * class' copy constructor.
 */
DescribeQueriesRequestPrivate::DescribeQueriesRequestPrivate(
    const DescribeQueriesRequestPrivate &other, DescribeQueriesRequest * const q)
