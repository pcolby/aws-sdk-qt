...
/*!
 * \class QtAws::CloudWatchLogs::StartQueryRequest
 * \brief The StartQueryRequest class provides an interface for CloudWatchLogs StartQuery requests.
 *
 ...
 *
 * \sa CloudWatchLogsClient::startQuery
 */
...
StartQueryRequest::StartQueryRequest(const StartQueryRequest &other)
    : CloudWatchLogsRequest(new StartQueryRequestPrivate(*other.d_func(), this))
{
...
StartQueryRequest::StartQueryRequest()
    : CloudWatchLogsRequest(new StartQueryRequestPrivate(CloudWatchLogsRequest::StartQueryAction, this))
{
...
/*!
 * \class QtAws::CloudWatchLogs::StartQueryRequestPrivate
...
/*!
 * Constructs a StartQueryRequestPrivate object for CloudWatchLogs \a action,
 * with public implementation \a q.
 */
StartQueryRequestPrivate::StartQueryRequestPrivate(
    const CloudWatchLogsRequest::Action action, StartQueryRequest * const q)
