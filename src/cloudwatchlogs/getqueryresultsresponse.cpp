...
/*!
 * \class QtAws::CloudWatchLogs::GetQueryResultsResponse
 * \brief The GetQueryResultsResponse class provides an interace for CloudWatchLogs GetQueryResults responses.
 *
...
GetQueryResultsResponse::GetQueryResultsResponse(
    ...
    : CloudWatchLogsResponse(new GetQueryResultsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful CloudWatchLogs GetQueryResults \a response.
 */
...
/*!
 * \class QtAws::CloudWatchLogs::GetQueryResultsResponsePrivate
...
GetQueryResultsResponsePrivate::GetQueryResultsResponsePrivate(
    GetQueryResultsResponse * const q) : CloudWatchLogsResponsePrivate(q)
{

}

/*!
 * Parses a CloudWatchLogs GetQueryResults response element from \a xml.
 */
