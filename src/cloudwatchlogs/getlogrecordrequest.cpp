...
#include "getlogrecordrequest_p.h"
...
/*!
 * \class QtAws::CloudWatchLogs::GetLogRecordRequest
 * \brief The GetLogRecordRequest class provides an interface for CloudWatchLogs GetLogRecord requests.
 *
 ...
 */
GetLogRecordRequest::GetLogRecordRequest(const GetLogRecordRequest &other)
    : CloudWatchLogsRequest(new GetLogRecordRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetLogRecordRequest object.
 */
GetLogRecordRequest::GetLogRecordRequest()
    : CloudWatchLogsRequest(new GetLogRecordRequestPrivate(CloudWatchLogsRequest::GetLogRecordAction, this))
{
 ...
 * \reimp
 */
bool GetLogRecordRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetLogRecordResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetLogRecordRequest::response(QNetworkReply * const reply) const
{
    return new GetLogRecordResponse(*this, reply);
}

/*!
 * \class QtAws::CloudWatchLogs::GetLogRecordRequestPrivate
 * \brief The GetLogRecordRequestPrivate class provides private implementation for GetLogRecordRequest.
 * \internal
 *
 * \inmodule QtAwsCloudWatchLogs
 */
...
/*!
 * Constructs a GetLogRecordRequestPrivate object for CloudWatchLogs \a action,
 * with public implementation \a q.
 */
GetLogRecordRequestPrivate::GetLogRecordRequestPrivate(
    const CloudWatchLogsRequest::Action action, GetLogRecordRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetLogRecordRequest
 * class' copy constructor.
 */
GetLogRecordRequestPrivate::GetLogRecordRequestPrivate(
    const GetLogRecordRequestPrivate &other, GetLogRecordRequest * const q)
