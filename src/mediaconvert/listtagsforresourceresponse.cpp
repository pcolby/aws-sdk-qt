...
/*!
 * \class QtAws::MediaConvert::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for MediaConvert ListTagsForResource responses.
 *
 * \inmodule QtAwsMediaConvert
 *
 *
 * \sa MediaConvertClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : MediaConvertResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(MediaConvertResponse::request());
}

/*!
 * \reimp
 * Parses a successful MediaConvert ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::MediaConvert::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : MediaConvertResponsePrivate(q)
{

}

/*!
 * Parses a MediaConvert ListTagsForResource response element from \a xml.
 */
