...
/*!
 * \class QtAws::MediaConvert::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for MediaConvert TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : MediaConvertResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(MediaConvertResponse::request());
}

/*!
 * \reimp
 * Parses a successful MediaConvert TagResource \a response.
 */
...
/*!
 * \class QtAws::MediaConvert::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : MediaConvertResponsePrivate(q)
{

}

/*!
 * Parses a MediaConvert TagResource response element from \a xml.
 */
