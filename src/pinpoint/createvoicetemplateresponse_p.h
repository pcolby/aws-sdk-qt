...
class QTAWS_EXPORT CreateVoiceTemplateResponsePrivate : public PinpointResponsePrivate {

public:

    CreateVoiceTemplateResponsePrivate(CreateVoiceTemplateResponse * const q);
