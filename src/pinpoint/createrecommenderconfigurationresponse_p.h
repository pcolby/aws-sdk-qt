...
class QTAWS_EXPORT CreateRecommenderConfigurationResponsePrivate : public PinpointResponsePrivate {

public:

    CreateRecommenderConfigurationResponsePrivate(CreateRecommenderConfigurationResponse * const q);
