...
class QTAWS_EXPORT UpdateVoiceChannelResponsePrivate : public PinpointResponsePrivate {

public:

    UpdateVoiceChannelResponsePrivate(UpdateVoiceChannelResponse * const q);
