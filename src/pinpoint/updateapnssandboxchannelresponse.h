...
class QTAWS_EXPORT UpdateApnsSandboxChannelResponse : public UpdateApnsSandboxChannelResponse {
    Q_OBJECT
...
public:
    ...
    virtual const UpdateApnsSandboxChannelRequest * request() const;
