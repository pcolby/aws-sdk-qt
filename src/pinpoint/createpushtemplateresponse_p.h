...
class QTAWS_EXPORT CreatePushTemplateResponsePrivate : public PinpointResponsePrivate {

public:

    CreatePushTemplateResponsePrivate(CreatePushTemplateResponse * const q);
