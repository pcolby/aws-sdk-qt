...
/*!
 * \class QtAws::Pinpoint::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Pinpoint UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : PinpointResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Pinpoint UntagResource \a response.
 */
...
/*!
 * \class QtAws::Pinpoint::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : PinpointResponsePrivate(q)
{

}

/*!
 * Parses a Pinpoint UntagResource response element from \a xml.
 */
