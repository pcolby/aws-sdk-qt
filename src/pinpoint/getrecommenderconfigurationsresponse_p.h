...
class QTAWS_EXPORT GetRecommenderConfigurationsResponsePrivate : public PinpointResponsePrivate {

public:

    GetRecommenderConfigurationsResponsePrivate(GetRecommenderConfigurationsResponse * const q);
