...
class QTAWS_EXPORT DeletePushTemplateResponsePrivate : public PinpointResponsePrivate {

public:

    DeletePushTemplateResponsePrivate(DeletePushTemplateResponse * const q);
