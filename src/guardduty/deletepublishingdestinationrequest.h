...
#ifndef QTAWS_DELETEPUBLISHINGDESTINATIONREQUEST_H
#define QTAWS_DELETEPUBLISHINGDESTINATIONREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(DeletePublishingDestinationRequest)
