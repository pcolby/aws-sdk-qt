...
/*!
 * \class QtAws::GuardDuty::ListOrganizationAdminAccountsResponse
 * \brief The ListOrganizationAdminAccountsResponse class provides an interace for GuardDuty ListOrganizationAdminAccounts responses.
 *
...
ListOrganizationAdminAccountsResponse::ListOrganizationAdminAccountsResponse(
    ...
    : GuardDutyResponse(new ListOrganizationAdminAccountsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GuardDuty ListOrganizationAdminAccounts \a response.
 */
...
/*!
 * \class QtAws::GuardDuty::ListOrganizationAdminAccountsResponsePrivate
...
ListOrganizationAdminAccountsResponsePrivate::ListOrganizationAdminAccountsResponsePrivate(
    ListOrganizationAdminAccountsResponse * const q) : GuardDutyResponsePrivate(q)
{

}

/*!
 * Parses a GuardDuty ListOrganizationAdminAccounts response element from \a xml.
 */
