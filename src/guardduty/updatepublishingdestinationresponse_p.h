...
class QTAWS_EXPORT UpdatePublishingDestinationResponsePrivate : public GuardDutyResponsePrivate {

public:

    UpdatePublishingDestinationResponsePrivate(UpdatePublishingDestinationResponse * const q);
