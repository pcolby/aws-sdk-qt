...
/*!
 * \class QtAws::GuardDuty::DescribeOrganizationConfigurationRequest
 * \brief The DescribeOrganizationConfigurationRequest class provides an interface for GuardDuty DescribeOrganizationConfiguration requests.
 *
...
DescribeOrganizationConfigurationRequest::DescribeOrganizationConfigurationRequest(const DescribeOrganizationConfigurationRequest &other)
    : GuardDutyRequest(new DescribeOrganizationConfigurationRequestPrivate(*other.d_func(), this))
{
...
DescribeOrganizationConfigurationRequest::DescribeOrganizationConfigurationRequest()
    : GuardDutyRequest(new DescribeOrganizationConfigurationRequestPrivate(GuardDutyRequest::DescribeOrganizationConfigurationAction, this))
{
...
/*!
 * \class QtAws::GuardDuty::DescribeOrganizationConfigurationRequestPrivate
...
/*!
 * Constructs a DescribeOrganizationConfigurationRequestPrivate object for GuardDuty \a action,
 * with public implementation \a q.
 */
DescribeOrganizationConfigurationRequestPrivate::DescribeOrganizationConfigurationRequestPrivate(
    const GuardDutyRequest::Action action, DescribeOrganizationConfigurationRequest * const q)
