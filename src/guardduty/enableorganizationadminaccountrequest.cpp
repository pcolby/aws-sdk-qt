...
/*!
 * \class QtAws::GuardDuty::EnableOrganizationAdminAccountRequest
 * \brief The EnableOrganizationAdminAccountRequest class provides an interface for GuardDuty EnableOrganizationAdminAccount requests.
 *
...
EnableOrganizationAdminAccountRequest::EnableOrganizationAdminAccountRequest(const EnableOrganizationAdminAccountRequest &other)
    : GuardDutyRequest(new EnableOrganizationAdminAccountRequestPrivate(*other.d_func(), this))
{
...
EnableOrganizationAdminAccountRequest::EnableOrganizationAdminAccountRequest()
    : GuardDutyRequest(new EnableOrganizationAdminAccountRequestPrivate(GuardDutyRequest::EnableOrganizationAdminAccountAction, this))
{
...
/*!
 * \class QtAws::GuardDuty::EnableOrganizationAdminAccountRequestPrivate
...
/*!
 * Constructs a EnableOrganizationAdminAccountRequestPrivate object for GuardDuty \a action,
 * with public implementation \a q.
 */
EnableOrganizationAdminAccountRequestPrivate::EnableOrganizationAdminAccountRequestPrivate(
    const GuardDutyRequest::Action action, EnableOrganizationAdminAccountRequest * const q)
