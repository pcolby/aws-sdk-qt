...
/*!
 * \class QtAws::GuardDuty::UpdateOrganizationConfigurationResponse
 * \brief The UpdateOrganizationConfigurationResponse class provides an interace for GuardDuty UpdateOrganizationConfiguration responses.
 *
...
UpdateOrganizationConfigurationResponse::UpdateOrganizationConfigurationResponse(
    ...
    : GuardDutyResponse(new UpdateOrganizationConfigurationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GuardDuty UpdateOrganizationConfiguration \a response.
 */
...
/*!
 * \class QtAws::GuardDuty::UpdateOrganizationConfigurationResponsePrivate
...
UpdateOrganizationConfigurationResponsePrivate::UpdateOrganizationConfigurationResponsePrivate(
    UpdateOrganizationConfigurationResponse * const q) : GuardDutyResponsePrivate(q)
{

}

/*!
 * Parses a GuardDuty UpdateOrganizationConfiguration response element from \a xml.
 */
