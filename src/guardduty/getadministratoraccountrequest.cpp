...
/*!
 * \class QtAws::GuardDuty::GetAdministratorAccountRequest
 * \brief The GetAdministratorAccountRequest class provides an interface for GuardDuty GetAdministratorAccount requests.
 *
...
GetAdministratorAccountRequest::GetAdministratorAccountRequest(const GetAdministratorAccountRequest &other)
    : GuardDutyRequest(new GetAdministratorAccountRequestPrivate(*other.d_func(), this))
{
...
GetAdministratorAccountRequest::GetAdministratorAccountRequest()
    : GuardDutyRequest(new GetAdministratorAccountRequestPrivate(GuardDutyRequest::GetAdministratorAccountAction, this))
{
...
/*!
 * \class QtAws::GuardDuty::GetAdministratorAccountRequestPrivate
...
/*!
 * Constructs a GetAdministratorAccountRequestPrivate object for GuardDuty \a action,
 * with public implementation \a q.
 */
GetAdministratorAccountRequestPrivate::GetAdministratorAccountRequestPrivate(
    const GuardDutyRequest::Action action, GetAdministratorAccountRequest * const q)
