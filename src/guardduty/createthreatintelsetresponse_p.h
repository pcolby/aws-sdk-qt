...
class QTAWS_EXPORT CreateThreatIntelSetResponsePrivate : public GuardDutyResponsePrivate {
    Q_OBJECT

public:

    CreateThreatIntelSetResponsePrivate(CreateThreatIntelSetResponse * const q);
