...
#ifndef QTAWS_DESCRIBEPUBLISHINGDESTINATIONREQUEST_H
#define QTAWS_DESCRIBEPUBLISHINGDESTINATIONREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(DescribePublishingDestinationRequest)
