...
/*!
 * \class QtAws::GuardDuty::DisassociateFromAdministratorAccountResponse
 * \brief The DisassociateFromAdministratorAccountResponse class provides an interace for GuardDuty DisassociateFromAdministratorAccount responses.
 *
...
DisassociateFromAdministratorAccountResponse::DisassociateFromAdministratorAccountResponse(
    ...
    : GuardDutyResponse(new DisassociateFromAdministratorAccountResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GuardDuty DisassociateFromAdministratorAccount \a response.
 */
...
/*!
 * \class QtAws::GuardDuty::DisassociateFromAdministratorAccountResponsePrivate
...
DisassociateFromAdministratorAccountResponsePrivate::DisassociateFromAdministratorAccountResponsePrivate(
    DisassociateFromAdministratorAccountResponse * const q) : GuardDutyResponsePrivate(q)
{

}

/*!
 * Parses a GuardDuty DisassociateFromAdministratorAccount response element from \a xml.
 */
