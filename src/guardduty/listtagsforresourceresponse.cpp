...
/*!
 * \class QtAws::GuardDuty::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for GuardDuty ListTagsForResource responses.
 *
 ...
 *
 * \sa GuardDutyClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : GuardDutyResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(GuardDutyResponse::request());
}

/*!
 * \reimp
 * Parses a successful GuardDuty ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::GuardDuty::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : GuardDutyResponsePrivate(q)
{

}

/*!
 * Parses a GuardDuty ListTagsForResource response element from \a xml.
 */
