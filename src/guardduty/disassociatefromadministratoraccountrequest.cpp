...
/*!
 * \class QtAws::GuardDuty::DisassociateFromAdministratorAccountRequest
 * \brief The DisassociateFromAdministratorAccountRequest class provides an interface for GuardDuty DisassociateFromAdministratorAccount requests.
 *
 ...
 *
 * \sa GuardDutyClient::disassociateFromAdministratorAccount
 */
...
DisassociateFromAdministratorAccountRequest::DisassociateFromAdministratorAccountRequest(const DisassociateFromAdministratorAccountRequest &other)
    : GuardDutyRequest(new DisassociateFromAdministratorAccountRequestPrivate(*other.d_func(), this))
{
...
DisassociateFromAdministratorAccountRequest::DisassociateFromAdministratorAccountRequest()
    : GuardDutyRequest(new DisassociateFromAdministratorAccountRequestPrivate(GuardDutyRequest::DisassociateFromAdministratorAccountAction, this))
{
...
/*!
 * \class QtAws::GuardDuty::DisassociateFromAdministratorAccountRequestPrivate
...
/*!
 * Constructs a DisassociateFromAdministratorAccountRequestPrivate object for GuardDuty \a action,
 * with public implementation \a q.
 */
DisassociateFromAdministratorAccountRequestPrivate::DisassociateFromAdministratorAccountRequestPrivate(
    const GuardDutyRequest::Action action, DisassociateFromAdministratorAccountRequest * const q)
