...
class QTAWS_EXPORT ListEntitiesRequestPrivate : public MarketplaceCatalogRequestPrivate {

public:
    ListEntitiesRequestPrivate(const MarketplaceCatalogRequest::Action action,
