...
class QTAWS_EXPORT ListRecommendationFeedbackResponsePrivate : public CodeGuruReviewerResponsePrivate {

public:

    ListRecommendationFeedbackResponsePrivate(ListRecommendationFeedbackResponse * const q);
