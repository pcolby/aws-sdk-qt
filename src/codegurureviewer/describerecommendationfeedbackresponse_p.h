...
class QTAWS_EXPORT DescribeRecommendationFeedbackResponsePrivate : public CodeGuruReviewerResponsePrivate {

public:

    DescribeRecommendationFeedbackResponsePrivate(DescribeRecommendationFeedbackResponse * const q);
