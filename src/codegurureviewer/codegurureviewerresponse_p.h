...
class QTAWS_EXPORT CodeGuruReviewerResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {

public:

    CodeGuruReviewerResponsePrivate(CodeGuruReviewerResponse * const q);
