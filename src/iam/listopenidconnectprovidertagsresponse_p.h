...
class QTAWS_EXPORT ListOpenIDConnectProviderTagsResponsePrivate : public IamResponsePrivate {

public:

    ListOpenIDConnectProviderTagsResponsePrivate(ListOpenIDConnectProviderTagsResponse * const q);
