...
#ifndef QTAWS_DELETEACCOUNTPASSWORDPOLICYREQUEST_H
#define QTAWS_DELETEACCOUNTPASSWORDPOLICYREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(DeleteAccountPasswordPolicyRequest)
