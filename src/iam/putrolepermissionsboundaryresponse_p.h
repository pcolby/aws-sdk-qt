...
class QTAWS_EXPORT PutRolePermissionsBoundaryResponsePrivate : public IamResponsePrivate {

public:

    PutRolePermissionsBoundaryResponsePrivate(PutRolePermissionsBoundaryResponse * const q);
