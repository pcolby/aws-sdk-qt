...
class QTAWS_EXPORT ListInstanceProfileTagsResponsePrivate : public IamResponsePrivate {

public:

    ListInstanceProfileTagsResponsePrivate(ListInstanceProfileTagsResponse * const q);
