...
class QTAWS_EXPORT ListServerCertificateTagsResponsePrivate : public IamResponsePrivate {

public:

    ListServerCertificateTagsResponsePrivate(ListServerCertificateTagsResponse * const q);
