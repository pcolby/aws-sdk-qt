...
class QTAWS_EXPORT GetContextKeysForCustomPolicyResponse : public GetContextKeysForCustomPolicyResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetContextKeysForCustomPolicyRequest * request() const;
