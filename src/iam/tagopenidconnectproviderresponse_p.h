...
class QTAWS_EXPORT TagOpenIDConnectProviderResponsePrivate : public IamResponsePrivate {

public:

    TagOpenIDConnectProviderResponsePrivate(TagOpenIDConnectProviderResponse * const q);
