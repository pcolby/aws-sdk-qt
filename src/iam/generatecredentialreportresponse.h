...
class QTAWS_EXPORT GenerateCredentialReportResponse : public IamResponse {
    Q_OBJECT

public:
    GenerateCredentialReportResponse(QNetworkReply * const reply, QObject * const parent = 0);
