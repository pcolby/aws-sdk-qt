...
class QTAWS_EXPORT RemoveClientIDFromOpenIDConnectProviderResponse : public RemoveClientIDFromOpenIDConnectProviderResponse {
    Q_OBJECT
...
public:
    ...
    virtual const RemoveClientIDFromOpenIDConnectProviderRequest * request() const;
