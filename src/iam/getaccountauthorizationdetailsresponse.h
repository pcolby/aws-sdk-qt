...
class QTAWS_EXPORT GetAccountAuthorizationDetailsResponse : public IamResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetAccountAuthorizationDetailsRequest * request() const override;
