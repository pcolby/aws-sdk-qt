...
class QTAWS_EXPORT ListServiceSpecificCredentialsResponse : public IAMResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListServiceSpecificCredentialsRequest * request() const override;
