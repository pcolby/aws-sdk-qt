...
class QTAWSIAM_EXPORT DeleteOpenIDConnectProviderResponse : public IamResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteOpenIDConnectProviderRequest * request() const Q_DECL_OVERRIDE;
