...
class QTAWS_EXPORT DeleteUserPermissionsBoundaryResponsePrivate : public IamResponsePrivate {

public:

    DeleteUserPermissionsBoundaryResponsePrivate(DeleteUserPermissionsBoundaryResponse * const q);
