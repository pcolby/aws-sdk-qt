...
class QTAWS_EXPORT AddApplicationInputProcessingConfigurationResponse : public KinesisAnalyticsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const AddApplicationInputProcessingConfigurationRequest * request() const override;
