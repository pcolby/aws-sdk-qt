...
class QTAWS_EXPORT KinesisAnalyticsResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {

public:

    KinesisAnalyticsResponsePrivate(KinesisAnalyticsResponse * const q);
