...
/*!
 * \class QtAws::KinesisAnalytics::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for KinesisAnalytics TagResource responses.
 *
 ...
 *
 * \sa KinesisAnalyticsClient::tagResource
 */
...
TagResourceResponse::TagResourceResponse(
    ...
    : KinesisAnalyticsResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(KinesisAnalyticsResponse::request());
}

/*!
 * \reimp
 * Parses a successful KinesisAnalytics TagResource \a response.
 */
...
/*!
 * \class QtAws::KinesisAnalytics::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : KinesisAnalyticsResponsePrivate(q)
{

}

/*!
 * Parses a KinesisAnalytics TagResource response element from \a xml.
 */
