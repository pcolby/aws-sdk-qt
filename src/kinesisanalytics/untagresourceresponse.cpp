...
/*!
 * \class QtAws::KinesisAnalytics::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for KinesisAnalytics UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : KinesisAnalyticsResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful KinesisAnalytics UntagResource \a response.
 */
...
/*!
 * \class QtAws::KinesisAnalytics::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : KinesisAnalyticsResponsePrivate(q)
{

}

/*!
 * Parses a KinesisAnalytics UntagResource response element from \a xml.
 */
