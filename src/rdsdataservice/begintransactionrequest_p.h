...
class QTAWS_EXPORT BeginTransactionRequestPrivate : public RDSDataServiceRequestPrivate {

public:
    BeginTransactionRequestPrivate(const RDSDataServiceRequest::Action action,
