...
/*!
 * \class QtAws::Evidently::ListProjectsResponse
 * \brief The ListProjectsResponse class provides an interace for Evidently ListProjects responses.
 *
...
ListProjectsResponse::ListProjectsResponse(
    ...
    : EvidentlyResponse(new ListProjectsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Evidently ListProjects \a response.
 */
...
/*!
 * \class QtAws::Evidently::ListProjectsResponsePrivate
...
ListProjectsResponsePrivate::ListProjectsResponsePrivate(
    ListProjectsResponse * const q) : EvidentlyResponsePrivate(q)
{

}

/*!
 * Parses a Evidently ListProjects response element from \a xml.
 */
