...
/*!
 * \class QtAws::Evidently::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Evidently ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : EvidentlyResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Evidently ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Evidently::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : EvidentlyResponsePrivate(q)
{

}

/*!
 * Parses a Evidently ListTagsForResource response element from \a xml.
 */
