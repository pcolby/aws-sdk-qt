...
class DeleteFleetAdvisorDatabasesRequestPrivate : public DatabaseMigrationServiceRequestPrivate {

public:
    DeleteFleetAdvisorDatabasesRequestPrivate(const DatabaseMigrationServiceRequest::Action action,
