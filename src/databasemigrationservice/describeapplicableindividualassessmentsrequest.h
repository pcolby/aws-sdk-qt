...
class QTAWS_EXPORT DescribeApplicableIndividualAssessmentsRequest : public DatabaseMigrationServiceRequest {
...
private:
    Q_DECLARE_PRIVATE(DescribeApplicableIndividualAssessmentsRequest)
