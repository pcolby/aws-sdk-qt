...
class QTAWS_EXPORT DescribeEndpointSettingsRequestPrivate : public DatabaseMigrationServiceRequestPrivate {

public:
    DescribeEndpointSettingsRequestPrivate(const DatabaseMigrationServiceRequest::Action action,
