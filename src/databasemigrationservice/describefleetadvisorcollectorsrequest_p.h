...
class DescribeFleetAdvisorCollectorsRequestPrivate : public DatabaseMigrationServiceRequestPrivate {

public:
    DescribeFleetAdvisorCollectorsRequestPrivate(const DatabaseMigrationServiceRequest::Action action,
