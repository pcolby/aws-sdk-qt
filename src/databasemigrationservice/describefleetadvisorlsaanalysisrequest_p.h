...
class DescribeFleetAdvisorLsaAnalysisRequestPrivate : public DatabaseMigrationServiceRequestPrivate {

public:
    DescribeFleetAdvisorLsaAnalysisRequestPrivate(const DatabaseMigrationServiceRequest::Action action,
