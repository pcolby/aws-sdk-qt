...
class QTAWS_EXPORT DescribeEndpointTypesResponse : public DatabaseMigrationServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeEndpointTypesRequest * request() const override;
