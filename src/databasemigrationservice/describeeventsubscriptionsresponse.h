...
class QTAWS_EXPORT DescribeEventSubscriptionsResponse : public DatabaseMigrationServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeEventSubscriptionsRequest * request() const override;
