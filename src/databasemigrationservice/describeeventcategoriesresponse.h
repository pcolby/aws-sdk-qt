...
class QTAWS_EXPORT DescribeEventCategoriesResponse : public DatabaseMigrationServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeEventCategoriesRequest * request() const override;
