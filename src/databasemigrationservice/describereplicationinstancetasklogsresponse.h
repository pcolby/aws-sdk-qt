...
class QTAWS_EXPORT DescribeReplicationInstanceTaskLogsResponse : public DatabaseMigrationServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeReplicationInstanceTaskLogsRequest * request() const override;
