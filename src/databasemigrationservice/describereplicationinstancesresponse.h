...
class QTAWS_EXPORT DescribeReplicationInstancesResponse : public DatabaseMigrationServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeReplicationInstancesRequest * request() const override;
