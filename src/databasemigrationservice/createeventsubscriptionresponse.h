...
class QTAWS_EXPORT CreateEventSubscriptionResponse : public DatabaseMigrationServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateEventSubscriptionRequest * request() const override;
