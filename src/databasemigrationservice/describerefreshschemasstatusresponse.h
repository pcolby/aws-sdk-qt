...
class QTAWS_EXPORT DescribeRefreshSchemasStatusResponse : public DatabaseMigrationServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeRefreshSchemasStatusRequest * request() const override;
