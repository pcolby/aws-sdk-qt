...
class DescribeFleetAdvisorSchemasRequestPrivate : public DatabaseMigrationServiceRequestPrivate {

public:
    DescribeFleetAdvisorSchemasRequestPrivate(const DatabaseMigrationServiceRequest::Action action,
