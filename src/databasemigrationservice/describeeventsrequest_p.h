...
class QTAWS_EXPORT DescribeEventsRequestPrivate : public DatabaseMigrationServiceRequestPrivate {

public:
    DescribeEventsRequestPrivate(const DatabaseMigrationServiceRequest::Action action,
