...
class QTAWS_EXPORT DescribeReplicationInstancesResponsePrivate : public DatabaseMigrationServiceResponsePrivate {

public:

    DescribeReplicationInstancesResponsePrivate(DescribeReplicationInstancesResponse * const q);
