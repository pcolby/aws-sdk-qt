...
class CreateFleetAdvisorCollectorRequestPrivate : public DatabaseMigrationServiceRequestPrivate {

public:
    CreateFleetAdvisorCollectorRequestPrivate(const DatabaseMigrationServiceRequest::Action action,
