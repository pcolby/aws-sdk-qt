...
class QTAWS_EXPORT CreateReplicationTaskResponse : public DatabaseMigrationServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateReplicationTaskRequest * request() const override;
