...
class QTAWSDATABASEMIGRATIONSERVICE_EXPORT DeleteReplicationSubnetGroupResponse : public DatabaseMigrationServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteReplicationSubnetGroupRequest * request() const Q_DECL_OVERRIDE;
