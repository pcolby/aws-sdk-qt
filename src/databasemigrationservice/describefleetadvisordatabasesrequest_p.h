...
class DescribeFleetAdvisorDatabasesRequestPrivate : public DatabaseMigrationServiceRequestPrivate {

public:
    DescribeFleetAdvisorDatabasesRequestPrivate(const DatabaseMigrationServiceRequest::Action action,
