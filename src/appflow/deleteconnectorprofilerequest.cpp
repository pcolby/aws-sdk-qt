...
#include "deleteconnectorprofilerequest_p.h"
...
/*!
 * \class QtAws::Appflow::DeleteConnectorProfileRequest
 * \brief The DeleteConnectorProfileRequest class provides an interface for Appflow DeleteConnectorProfile requests.
 *
 ...
 */
DeleteConnectorProfileRequest::DeleteConnectorProfileRequest(const DeleteConnectorProfileRequest &other)
    : AppflowRequest(new DeleteConnectorProfileRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteConnectorProfileRequest object.
 */
DeleteConnectorProfileRequest::DeleteConnectorProfileRequest()
    : AppflowRequest(new DeleteConnectorProfileRequestPrivate(AppflowRequest::DeleteConnectorProfileAction, this))
{
 ...
 * \reimp
 */
bool DeleteConnectorProfileRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteConnectorProfileResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteConnectorProfileRequest::response(QNetworkReply * const reply) const
{
    return new DeleteConnectorProfileResponse(*this, reply);
}

/*!
 * \class QtAws::Appflow::DeleteConnectorProfileRequestPrivate
 * \brief The DeleteConnectorProfileRequestPrivate class provides private implementation for DeleteConnectorProfileRequest.
 * \internal
 *
 * \inmodule QtAwsAppflow
 */
...
/*!
 * Constructs a DeleteConnectorProfileRequestPrivate object for Appflow \a action,
 * with public implementation \a q.
 */
DeleteConnectorProfileRequestPrivate::DeleteConnectorProfileRequestPrivate(
    const AppflowRequest::Action action, DeleteConnectorProfileRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteConnectorProfileRequest
 * class' copy constructor.
 */
DeleteConnectorProfileRequestPrivate::DeleteConnectorProfileRequestPrivate(
    const DeleteConnectorProfileRequestPrivate &other, DeleteConnectorProfileRequest * const q)
