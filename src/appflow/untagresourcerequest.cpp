...
/*!
 * \class QtAws::Appflow::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for Appflow UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : AppflowRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : AppflowRequest(new UntagResourceRequestPrivate(AppflowRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::Appflow::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for Appflow \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const AppflowRequest::Action action, UntagResourceRequest * const q)
