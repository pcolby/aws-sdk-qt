...
/*!
 * \class QtAws::Appflow::DeleteFlowResponse
 * \brief The DeleteFlowResponse class provides an interace for Appflow DeleteFlow responses.
 *
...
DeleteFlowResponse::DeleteFlowResponse(
    ...
    : AppflowResponse(new DeleteFlowResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Appflow DeleteFlow \a response.
 */
...
/*!
 * \class QtAws::Appflow::DeleteFlowResponsePrivate
...
DeleteFlowResponsePrivate::DeleteFlowResponsePrivate(
    DeleteFlowResponse * const q) : AppflowResponsePrivate(q)
{

}

/*!
 * Parses a Appflow DeleteFlow response element from \a xml.
 */
