...
#include "describeconnectorentityrequest_p.h"
...
/*!
 * \class QtAws::Appflow::DescribeConnectorEntityRequest
 * \brief The DescribeConnectorEntityRequest class provides an interface for Appflow DescribeConnectorEntity requests.
 *
 ...
 */
DescribeConnectorEntityRequest::DescribeConnectorEntityRequest(const DescribeConnectorEntityRequest &other)
    : AppflowRequest(new DescribeConnectorEntityRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeConnectorEntityRequest object.
 */
DescribeConnectorEntityRequest::DescribeConnectorEntityRequest()
    : AppflowRequest(new DescribeConnectorEntityRequestPrivate(AppflowRequest::DescribeConnectorEntityAction, this))
{
 ...
 * \reimp
 */
bool DescribeConnectorEntityRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeConnectorEntityResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeConnectorEntityRequest::response(QNetworkReply * const reply) const
{
    return new DescribeConnectorEntityResponse(*this, reply);
}

/*!
 * \class QtAws::Appflow::DescribeConnectorEntityRequestPrivate
 * \brief The DescribeConnectorEntityRequestPrivate class provides private implementation for DescribeConnectorEntityRequest.
 * \internal
 *
 * \inmodule QtAwsAppflow
 */
...
/*!
 * Constructs a DescribeConnectorEntityRequestPrivate object for Appflow \a action,
 * with public implementation \a q.
 */
DescribeConnectorEntityRequestPrivate::DescribeConnectorEntityRequestPrivate(
    const AppflowRequest::Action action, DescribeConnectorEntityRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeConnectorEntityRequest
 * class' copy constructor.
 */
DescribeConnectorEntityRequestPrivate::DescribeConnectorEntityRequestPrivate(
    const DescribeConnectorEntityRequestPrivate &other, DescribeConnectorEntityRequest * const q)
