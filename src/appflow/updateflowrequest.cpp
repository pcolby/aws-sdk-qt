...
/*!
 * \class QtAws::Appflow::UpdateFlowRequest
 * \brief The UpdateFlowRequest class provides an interface for Appflow UpdateFlow requests.
 *
...
UpdateFlowRequest::UpdateFlowRequest(const UpdateFlowRequest &other)
    : AppflowRequest(new UpdateFlowRequestPrivate(*other.d_func(), this))
{
...
UpdateFlowRequest::UpdateFlowRequest()
    : AppflowRequest(new UpdateFlowRequestPrivate(AppflowRequest::UpdateFlowAction, this))
{
...
/*!
 * \class QtAws::Appflow::UpdateFlowRequestPrivate
...
/*!
 * Constructs a UpdateFlowRequestPrivate object for Appflow \a action,
 * with public implementation \a q.
 */
UpdateFlowRequestPrivate::UpdateFlowRequestPrivate(
    const AppflowRequest::Action action, UpdateFlowRequest * const q)
