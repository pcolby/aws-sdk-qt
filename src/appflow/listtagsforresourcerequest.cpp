...
/*!
 * \class QtAws::Appflow::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for Appflow ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : AppflowRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : AppflowRequest(new ListTagsForResourceRequestPrivate(AppflowRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::Appflow::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for Appflow \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const AppflowRequest::Action action, ListTagsForResourceRequest * const q)
