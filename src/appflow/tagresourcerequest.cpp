...
/*!
 * \class QtAws::Appflow::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for Appflow TagResource requests.
 *
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : AppflowRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : AppflowRequest(new TagResourceRequestPrivate(AppflowRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::Appflow::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for Appflow \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const AppflowRequest::Action action, TagResourceRequest * const q)
