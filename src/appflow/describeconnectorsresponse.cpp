...
#include "describeconnectorsresponse_p.h"
...
/*!
 * \class QtAws::Appflow::DescribeConnectorsResponse
 * \brief The DescribeConnectorsResponse class provides an interace for Appflow DescribeConnectors responses.
 *
...
/*!
 * Constructs a DescribeConnectorsResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeConnectorsResponse::DescribeConnectorsResponse(
        const DescribeConnectorsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AppflowResponse(new DescribeConnectorsResponsePrivate(this), parent)
{
    setRequest(new DescribeConnectorsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeConnectorsRequest * DescribeConnectorsResponse::request() const
{
    Q_D(const DescribeConnectorsResponse);
    return static_cast<const DescribeConnectorsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Appflow DescribeConnectors \a response.
 */
void DescribeConnectorsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeConnectorsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Appflow::DescribeConnectorsResponsePrivate
 * \brief The DescribeConnectorsResponsePrivate class provides private implementation for DescribeConnectorsResponse.
 * \internal
 *
 * \inmodule QtAwsAppflow
 */
...
/*!
 * Constructs a DescribeConnectorsResponsePrivate object with public implementation \a q.
 */
DescribeConnectorsResponsePrivate::DescribeConnectorsResponsePrivate(
    DescribeConnectorsResponse * const q) : AppflowResponsePrivate(q)
{

}

/*!
 * Parses a Appflow DescribeConnectors response element from \a xml.
 */
void DescribeConnectorsResponsePrivate::parseDescribeConnectorsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeConnectorsResponse"));
    Q_UNUSED(xml) ///< @todo
}
