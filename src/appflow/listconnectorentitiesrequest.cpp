...
#include "listconnectorentitiesrequest_p.h"
...
/*!
 * \class QtAws::Appflow::ListConnectorEntitiesRequest
 * \brief The ListConnectorEntitiesRequest class provides an interface for Appflow ListConnectorEntities requests.
 *
 ...
 */
ListConnectorEntitiesRequest::ListConnectorEntitiesRequest(const ListConnectorEntitiesRequest &other)
    : AppflowRequest(new ListConnectorEntitiesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListConnectorEntitiesRequest object.
 */
ListConnectorEntitiesRequest::ListConnectorEntitiesRequest()
    : AppflowRequest(new ListConnectorEntitiesRequestPrivate(AppflowRequest::ListConnectorEntitiesAction, this))
{
 ...
 * \reimp
 */
bool ListConnectorEntitiesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListConnectorEntitiesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListConnectorEntitiesRequest::response(QNetworkReply * const reply) const
{
    return new ListConnectorEntitiesResponse(*this, reply);
}

/*!
 * \class QtAws::Appflow::ListConnectorEntitiesRequestPrivate
 * \brief The ListConnectorEntitiesRequestPrivate class provides private implementation for ListConnectorEntitiesRequest.
 * \internal
 *
 * \inmodule QtAwsAppflow
 */
...
/*!
 * Constructs a ListConnectorEntitiesRequestPrivate object for Appflow \a action,
 * with public implementation \a q.
 */
ListConnectorEntitiesRequestPrivate::ListConnectorEntitiesRequestPrivate(
    const AppflowRequest::Action action, ListConnectorEntitiesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListConnectorEntitiesRequest
 * class' copy constructor.
 */
ListConnectorEntitiesRequestPrivate::ListConnectorEntitiesRequestPrivate(
    const ListConnectorEntitiesRequestPrivate &other, ListConnectorEntitiesRequest * const q)
