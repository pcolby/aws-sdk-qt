...
/*!
 * \class QtAws::Appflow::ListConnectorsResponse
 * \brief The ListConnectorsResponse class provides an interace for Appflow ListConnectors responses.
 *
...
ListConnectorsResponse::ListConnectorsResponse(
    ...
    : AppflowResponse(new ListConnectorsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Appflow ListConnectors \a response.
 */
...
/*!
 * \class QtAws::Appflow::ListConnectorsResponsePrivate
...
ListConnectorsResponsePrivate::ListConnectorsResponsePrivate(
    ListConnectorsResponse * const q) : AppflowResponsePrivate(q)
{

}

/*!
 * Parses a Appflow ListConnectors response element from \a xml.
 */
