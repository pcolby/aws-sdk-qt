...
class QTAWS_EXPORT DescribeConnectorProfilesResponsePrivate : public AppflowResponsePrivate {

public:

    DescribeConnectorProfilesResponsePrivate(DescribeConnectorProfilesResponse * const q);
