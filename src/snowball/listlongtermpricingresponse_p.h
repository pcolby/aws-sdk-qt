...
class QTAWS_EXPORT ListLongTermPricingResponsePrivate : public SnowballResponsePrivate {

public:

    ListLongTermPricingResponsePrivate(ListLongTermPricingResponse * const q);
