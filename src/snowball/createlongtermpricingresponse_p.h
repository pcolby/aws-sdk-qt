...
class QTAWS_EXPORT CreateLongTermPricingResponsePrivate : public SnowballResponsePrivate {

public:

    CreateLongTermPricingResponsePrivate(CreateLongTermPricingResponse * const q);
