...
class QTAWS_EXPORT DeleteProvisioningTemplateResponsePrivate : public IoTResponsePrivate {

public:

    DeleteProvisioningTemplateResponsePrivate(DeleteProvisioningTemplateResponse * const q);
