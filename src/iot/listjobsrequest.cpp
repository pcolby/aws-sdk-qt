 ...
 * \brief The ListJobsRequest class provides an interface for IoT ListJobs requests.
 *
 * \inmodule QtAwsIoT
 *
...
/*!
 * \class QtAws::IoT::ListJobsRequestPrivate
...
/*!
 *
 * Constructs a ListJobsRequestPrivate object for IoT \a action with,
