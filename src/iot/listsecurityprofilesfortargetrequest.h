...
#ifndef QTAWS_LISTSECURITYPROFILESFORTARGETREQUEST_H
#define QTAWS_LISTSECURITYPROFILESFORTARGETREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(ListSecurityProfilesForTargetRequest)
