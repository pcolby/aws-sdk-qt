...
class QTAWS_EXPORT AddThingToThingGroupResponsePrivate : public IoTResponsePrivate {
    Q_OBJECT

public:

    AddThingToThingGroupResponsePrivate(AddThingToThingGroupResponse * const q);
