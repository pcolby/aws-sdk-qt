...
/*!
 * \class QtAws::IoT::UpdateSecurityProfileResponse
 * \brief The UpdateSecurityProfileResponse class provides an interace for IoT UpdateSecurityProfile responses.
 *
 * \inmodule QtAwsIoT
 *
...
UpdateSecurityProfileResponse::UpdateSecurityProfileResponse(
    ...
    : IoTResponse(new UpdateSecurityProfileResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IoT UpdateSecurityProfile \a response.
 */
...
/*!
 * \class QtAws::IoT::UpdateSecurityProfileResponsePrivate
...
UpdateSecurityProfileResponsePrivate::UpdateSecurityProfileResponsePrivate(
    UpdateSecurityProfileResponse * const q) : IoTResponsePrivate(q)
{

}

/*!
 * Parses a IoT UpdateSecurityProfile response element from \a xml.
 */
