...
class QTAWS_EXPORT ListProvisioningTemplatesResponsePrivate : public IoTResponsePrivate {

public:

    ListProvisioningTemplatesResponsePrivate(ListProvisioningTemplatesResponse * const q);
