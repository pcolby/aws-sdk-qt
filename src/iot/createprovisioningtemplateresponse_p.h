...
class QTAWS_EXPORT CreateProvisioningTemplateResponsePrivate : public IoTResponsePrivate {

public:

    CreateProvisioningTemplateResponsePrivate(CreateProvisioningTemplateResponse * const q);
