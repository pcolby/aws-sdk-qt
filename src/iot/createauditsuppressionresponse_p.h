...
class QTAWS_EXPORT CreateAuditSuppressionResponsePrivate : public IoTResponsePrivate {

public:

    CreateAuditSuppressionResponsePrivate(CreateAuditSuppressionResponse * const q);
