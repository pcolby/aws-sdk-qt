...
class QTAWS_EXPORT StartDetectMitigationActionsTaskResponsePrivate : public IoTResponsePrivate {

public:

    StartDetectMitigationActionsTaskResponsePrivate(StartDetectMitigationActionsTaskResponse * const q);
