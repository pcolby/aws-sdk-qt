...
class QTAWS_EXPORT ListTargetsForSecurityProfileResponsePrivate : public IoTResponsePrivate {

public:

    ListTargetsForSecurityProfileResponsePrivate(ListTargetsForSecurityProfileResponse * const q);
