...
/*!
 * \class QtAws::IoT::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for IoT TagResource responses.
 *
 * \inmodule QtAwsIoT
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : IoTResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IoT TagResource \a response.
 */
...
/*!
 * \class QtAws::IoT::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : IoTResponsePrivate(q)
{

}

/*!
 * Parses a IoT TagResource response element from \a xml.
 */
