...
class QTAWS_EXPORT ListDetectMitigationActionsTasksResponsePrivate : public IoTResponsePrivate {

public:

    ListDetectMitigationActionsTasksResponsePrivate(ListDetectMitigationActionsTasksResponse * const q);
