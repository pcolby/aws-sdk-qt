...
class QTAWS_EXPORT ListSecurityProfilesForTargetResponsePrivate : public IoTResponsePrivate {

public:

    ListSecurityProfilesForTargetResponsePrivate(ListSecurityProfilesForTargetResponse * const q);
