...
class QTAWS_EXPORT DescribeBillingGroupResponsePrivate : public IoTResponsePrivate {

public:

    DescribeBillingGroupResponsePrivate(DescribeBillingGroupResponse * const q);
