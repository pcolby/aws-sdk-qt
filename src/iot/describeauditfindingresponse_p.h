...
class QTAWS_EXPORT DescribeAuditFindingResponsePrivate : public IoTResponsePrivate {

public:

    DescribeAuditFindingResponsePrivate(DescribeAuditFindingResponse * const q);
