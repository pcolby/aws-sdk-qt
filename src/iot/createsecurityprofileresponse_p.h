...
class QTAWS_EXPORT CreateSecurityProfileResponsePrivate : public IoTResponsePrivate {

public:

    CreateSecurityProfileResponsePrivate(CreateSecurityProfileResponse * const q);
