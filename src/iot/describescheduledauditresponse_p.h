...
class QTAWS_EXPORT DescribeScheduledAuditResponsePrivate : public IoTResponsePrivate {

public:

    DescribeScheduledAuditResponsePrivate(DescribeScheduledAuditResponse * const q);
