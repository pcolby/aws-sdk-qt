...
class QTAWS_EXPORT RemoveThingFromBillingGroupResponsePrivate : public IoTResponsePrivate {

public:

    RemoveThingFromBillingGroupResponsePrivate(RemoveThingFromBillingGroupResponse * const q);
