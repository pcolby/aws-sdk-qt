...
class QTAWS_EXPORT DescribeSecurityProfileResponsePrivate : public IoTResponsePrivate {

public:

    DescribeSecurityProfileResponsePrivate(DescribeSecurityProfileResponse * const q);
