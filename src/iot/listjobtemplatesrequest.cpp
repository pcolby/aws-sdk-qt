...
/*!
 * \class QtAws::IoT::ListJobTemplatesRequest
 * \brief The ListJobTemplatesRequest class provides an interface for IoT ListJobTemplates requests.
 *
 * \inmodule QtAwsIoT
 *
...
ListJobTemplatesRequest::ListJobTemplatesRequest(const ListJobTemplatesRequest &other)
    : IoTRequest(new ListJobTemplatesRequestPrivate(*other.d_func(), this))
{
...
ListJobTemplatesRequest::ListJobTemplatesRequest()
    : IoTRequest(new ListJobTemplatesRequestPrivate(IoTRequest::ListJobTemplatesAction, this))
{
...
/*!
 * \class QtAws::IoT::ListJobTemplatesRequestPrivate
...
/*!
 * Constructs a ListJobTemplatesRequestPrivate object for IoT \a action,
 * with public implementation \a q.
 */
ListJobTemplatesRequestPrivate::ListJobTemplatesRequestPrivate(
    const IoTRequest::Action action, ListJobTemplatesRequest * const q)
