...
class QTAWS_EXPORT CreateDynamicThingGroupResponsePrivate : public IoTResponsePrivate {

public:

    CreateDynamicThingGroupResponsePrivate(CreateDynamicThingGroupResponse * const q);
