...
/*!
 * \class QtAws::IoT::DeleteJobResponse
 * \brief The DeleteJobResponse class provides an interace for IoT DeleteJob responses.
 *
 * \inmodule QtAwsIoT
 *
...
DeleteJobResponse::DeleteJobResponse(
    ...
    : IoTResponse(new DeleteJobResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IoT DeleteJob \a response.
 */
...
/*!
 * \class QtAws::IoT::DeleteJobResponsePrivate
...
DeleteJobResponsePrivate::DeleteJobResponsePrivate(
    DeleteJobResponse * const q) : IoTResponsePrivate(q)
{

}

/*!
 * Parses a IoT DeleteJob response element from \a xml.
 */
