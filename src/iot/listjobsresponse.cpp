...
{
    return static_cast<const ListJobsRequest *>(IoTResponse::request());
}

/*!
 * \reimp
 * Parses a successful IoT ListJobs \a response.
 */
...
/*!
 * \class QtAws::IoT::ListJobsResponsePrivate
...
ListJobsResponsePrivate::ListJobsResponsePrivate(
    ListJobsResponse * const q) : IoTResponsePrivate(q)
{

}

/*!
 * Parses a IoT ListJobs response element from \a xml.
 */
