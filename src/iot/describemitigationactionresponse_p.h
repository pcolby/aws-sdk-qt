...
#ifndef QTAWS_DESCRIBEMITIGATIONACTIONRESPONSE_P_H
#define QTAWS_DESCRIBEMITIGATIONACTIONRESPONSE_P_H
...
private:
    Q_DECLARE_PUBLIC(DescribeMitigationActionResponse)
    Q_DISABLE_COPY(DescribeMitigationActionResponsePrivate)
