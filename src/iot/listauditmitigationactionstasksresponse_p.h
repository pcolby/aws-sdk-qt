...
class QTAWS_EXPORT ListAuditMitigationActionsTasksResponsePrivate : public IoTResponsePrivate {

public:

    ListAuditMitigationActionsTasksResponsePrivate(ListAuditMitigationActionsTasksResponse * const q);
