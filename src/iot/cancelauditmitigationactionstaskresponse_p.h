...
class QTAWS_EXPORT CancelAuditMitigationActionsTaskResponsePrivate : public IoTResponsePrivate {

public:

    CancelAuditMitigationActionsTaskResponsePrivate(CancelAuditMitigationActionsTaskResponse * const q);
