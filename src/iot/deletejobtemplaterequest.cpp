...
/*!
 * \class QtAws::IoT::DeleteJobTemplateRequest
 * \brief The DeleteJobTemplateRequest class provides an interface for IoT DeleteJobTemplate requests.
 *
 * \inmodule QtAwsIoT
 *
...
DeleteJobTemplateRequest::DeleteJobTemplateRequest(const DeleteJobTemplateRequest &other)
    : IoTRequest(new DeleteJobTemplateRequestPrivate(*other.d_func(), this))
{
...
DeleteJobTemplateRequest::DeleteJobTemplateRequest()
    : IoTRequest(new DeleteJobTemplateRequestPrivate(IoTRequest::DeleteJobTemplateAction, this))
{
...
/*!
 * \class QtAws::IoT::DeleteJobTemplateRequestPrivate
...
/*!
 * Constructs a DeleteJobTemplateRequestPrivate object for IoT \a action,
 * with public implementation \a q.
 */
DeleteJobTemplateRequestPrivate::DeleteJobTemplateRequestPrivate(
    const IoTRequest::Action action, DeleteJobTemplateRequest * const q)
