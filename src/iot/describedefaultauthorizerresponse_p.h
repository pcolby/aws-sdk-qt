...
class QTAWS_EXPORT DescribeDefaultAuthorizerResponsePrivate : public IoTResponsePrivate {
    Q_OBJECT

public:

    DescribeDefaultAuthorizerResponsePrivate(DescribeDefaultAuthorizerResponse * const q);
