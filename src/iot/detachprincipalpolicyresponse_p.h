...
class QTAWS_EXPORT DetachPrincipalPolicyResponsePrivate : public IoTResponsePrivate {
    Q_OBJECT

public:

    DetachPrincipalPolicyResponsePrivate(DetachPrincipalPolicyResponse * const q);
