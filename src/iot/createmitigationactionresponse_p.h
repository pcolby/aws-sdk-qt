...
class QTAWS_EXPORT CreateMitigationActionResponsePrivate : public IoTResponsePrivate {

public:

    CreateMitigationActionResponsePrivate(CreateMitigationActionResponse * const q);
