...
class QTAWS_EXPORT CreateTopicRuleDestinationResponsePrivate : public IoTResponsePrivate {

public:

    CreateTopicRuleDestinationResponsePrivate(CreateTopicRuleDestinationResponse * const q);
