...
class QTAWS_EXPORT StartThingRegistrationTaskResponse : public StartThingRegistrationTaskResponse {
    Q_OBJECT
...
public:
    ...
    virtual const StartThingRegistrationTaskRequest * request() const;
