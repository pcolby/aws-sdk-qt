...
#ifndef QTAWS_GETBEHAVIORMODELTRAININGSUMMARIESRESPONSE_P_H
#define QTAWS_GETBEHAVIORMODELTRAININGSUMMARIESRESPONSE_P_H
...
private:
    Q_DECLARE_PUBLIC(GetBehaviorModelTrainingSummariesResponse)
    Q_DISABLE_COPY(GetBehaviorModelTrainingSummariesResponsePrivate)
