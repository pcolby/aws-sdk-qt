...
class QTAWS_EXPORT ListThingsInBillingGroupResponsePrivate : public IoTResponsePrivate {

public:

    ListThingsInBillingGroupResponsePrivate(ListThingsInBillingGroupResponse * const q);
