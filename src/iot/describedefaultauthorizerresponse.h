...
class QTAWSIOT_EXPORT DescribeDefaultAuthorizerResponse : public IoTResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeDefaultAuthorizerRequest * request() const Q_DECL_OVERRIDE;
