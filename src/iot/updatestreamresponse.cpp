 ...
 *
 * @brief  Handles IoT UpdateStream responses.
 *
 ...
 */
UpdateStreamResponse::{OperationName}}Response(
 ...
 */
void UpdateStreamResponsePrivate::UpdateStreamResponse(QXmlStreamReader &xml)
{
