...
class QTAWS_EXPORT ListTopicRuleDestinationsResponsePrivate : public IoTResponsePrivate {

public:

    ListTopicRuleDestinationsResponsePrivate(ListTopicRuleDestinationsResponse * const q);
