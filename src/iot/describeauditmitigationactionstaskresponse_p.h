...
class QTAWS_EXPORT DescribeAuditMitigationActionsTaskResponsePrivate : public IoTResponsePrivate {

public:

    DescribeAuditMitigationActionsTaskResponsePrivate(DescribeAuditMitigationActionsTaskResponse * const q);
