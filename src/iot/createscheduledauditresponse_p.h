...
class QTAWS_EXPORT CreateScheduledAuditResponsePrivate : public IoTResponsePrivate {

public:

    CreateScheduledAuditResponsePrivate(CreateScheduledAuditResponse * const q);
