...
class QTAWS_EXPORT ListAuditSuppressionsResponsePrivate : public IoTResponsePrivate {

public:

    ListAuditSuppressionsResponsePrivate(ListAuditSuppressionsResponse * const q);
