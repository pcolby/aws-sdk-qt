...
class QTAWS_EXPORT AcceptCertificateTransferResponsePrivate : public IoTResponsePrivate {

public:

    AcceptCertificateTransferResponsePrivate(AcceptCertificateTransferResponse * const q);
