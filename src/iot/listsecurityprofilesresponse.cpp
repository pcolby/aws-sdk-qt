...
/*!
 * \class QtAws::IoT::ListSecurityProfilesResponse
 * \brief The ListSecurityProfilesResponse class provides an interace for IoT ListSecurityProfiles responses.
 *
 * \inmodule QtAwsIoT
 *
...
ListSecurityProfilesResponse::ListSecurityProfilesResponse(
    ...
    : IoTResponse(new ListSecurityProfilesResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IoT ListSecurityProfiles \a response.
 */
...
/*!
 * \class QtAws::IoT::ListSecurityProfilesResponsePrivate
...
ListSecurityProfilesResponsePrivate::ListSecurityProfilesResponsePrivate(
    ListSecurityProfilesResponse * const q) : IoTResponsePrivate(q)
{

}

/*!
 * Parses a IoT ListSecurityProfiles response element from \a xml.
 */
