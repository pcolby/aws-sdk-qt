...
class QTAWS_EXPORT DescribeProvisioningTemplateVersionResponsePrivate : public IoTResponsePrivate {

public:

    DescribeProvisioningTemplateVersionResponsePrivate(DescribeProvisioningTemplateVersionResponse * const q);
