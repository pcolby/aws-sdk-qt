...
class QTAWS_EXPORT UpdateThingGroupsForThingResponse : public UpdateThingGroupsForThingResponse {
    Q_OBJECT
...
public:
    ...
    virtual const UpdateThingGroupsForThingRequest * request() const;
