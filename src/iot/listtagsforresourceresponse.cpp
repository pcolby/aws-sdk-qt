...
/*!
 * \class QtAws::IoT::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for IoT ListTagsForResource responses.
 *
 * \inmodule QtAwsIoT
 *
 ...
 *
 * \sa IoTClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : IoTResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(IoTResponse::request());
}

/*!
 * \reimp
 * Parses a successful IoT ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::IoT::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : IoTResponsePrivate(q)
{

}

/*!
 * Parses a IoT ListTagsForResource response element from \a xml.
 */
