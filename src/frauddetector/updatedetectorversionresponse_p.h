...
class QTAWS_EXPORT UpdateDetectorVersionResponsePrivate : public FraudDetectorResponsePrivate {

public:

    UpdateDetectorVersionResponsePrivate(UpdateDetectorVersionResponse * const q);
