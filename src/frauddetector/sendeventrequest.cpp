...
/*!
 * \class QtAws::FraudDetector::SendEventRequest
 * \brief The SendEventRequest class provides an interface for FraudDetector SendEvent requests.
 *
 ...
 *
 * \sa FraudDetectorClient::sendEvent
 */
...
SendEventRequest::SendEventRequest(const SendEventRequest &other)
    : FraudDetectorRequest(new SendEventRequestPrivate(*other.d_func(), this))
{
...
SendEventRequest::SendEventRequest()
    : FraudDetectorRequest(new SendEventRequestPrivate(FraudDetectorRequest::SendEventAction, this))
{
...
/*!
 * \class QtAws::FraudDetector::SendEventRequestPrivate
...
/*!
 * Constructs a SendEventRequestPrivate object for FraudDetector \a action,
 * with public implementation \a q.
 */
SendEventRequestPrivate::SendEventRequestPrivate(
    const FraudDetectorRequest::Action action, SendEventRequest * const q)
