...
class QTAWS_EXPORT UpdateDetectorVersionStatusResponsePrivate : public FraudDetectorResponsePrivate {

public:

    UpdateDetectorVersionStatusResponsePrivate(UpdateDetectorVersionStatusResponse * const q);
