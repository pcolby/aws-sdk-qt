...
class QTAWS_EXPORT CreateDetectorVersionResponsePrivate : public FraudDetectorResponsePrivate {

public:

    CreateDetectorVersionResponsePrivate(CreateDetectorVersionResponse * const q);
