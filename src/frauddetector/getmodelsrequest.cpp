...
/*!
 * \class QtAws::FraudDetector::GetModelsRequest
 * \brief The GetModelsRequest class provides an interface for FraudDetector GetModels requests.
 *
...
GetModelsRequest::GetModelsRequest(const GetModelsRequest &other)
    : FraudDetectorRequest(new GetModelsRequestPrivate(*other.d_func(), this))
{
...
GetModelsRequest::GetModelsRequest()
    : FraudDetectorRequest(new GetModelsRequestPrivate(FraudDetectorRequest::GetModelsAction, this))
{
...
/*!
 * \class QtAws::FraudDetector::GetModelsRequestPrivate
...
/*!
 * Constructs a GetModelsRequestPrivate object for FraudDetector \a action,
 * with public implementation \a q.
 */
GetModelsRequestPrivate::GetModelsRequestPrivate(
    const FraudDetectorRequest::Action action, GetModelsRequest * const q)
