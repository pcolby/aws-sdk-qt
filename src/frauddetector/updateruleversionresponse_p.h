...
class QTAWS_EXPORT UpdateRuleVersionResponsePrivate : public FraudDetectorResponsePrivate {

public:

    UpdateRuleVersionResponsePrivate(UpdateRuleVersionResponse * const q);
