...
class QTAWS_EXPORT UpdateModelVersionResponsePrivate : public FraudDetectorResponsePrivate {

public:

    UpdateModelVersionResponsePrivate(UpdateModelVersionResponse * const q);
