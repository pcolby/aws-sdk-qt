...
class QTAWS_EXPORT BatchCreateVariableResponsePrivate : public FraudDetectorResponsePrivate {

public:

    BatchCreateVariableResponsePrivate(BatchCreateVariableResponse * const q);
