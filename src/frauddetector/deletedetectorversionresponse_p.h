...
class QTAWS_EXPORT DeleteDetectorVersionResponsePrivate : public FraudDetectorResponsePrivate {

public:

    DeleteDetectorVersionResponsePrivate(DeleteDetectorVersionResponse * const q);
