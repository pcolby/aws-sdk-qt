...
/*!
 * \class QtAws::FraudDetector::SendEventResponse
 * \brief The SendEventResponse class provides an interace for FraudDetector SendEvent responses.
 *
...
SendEventResponse::SendEventResponse(
    ...
    : FraudDetectorResponse(new SendEventResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful FraudDetector SendEvent \a response.
 */
...
/*!
 * \class QtAws::FraudDetector::SendEventResponsePrivate
...
SendEventResponsePrivate::SendEventResponsePrivate(
    SendEventResponse * const q) : FraudDetectorResponsePrivate(q)
{

}

/*!
 * Parses a FraudDetector SendEvent response element from \a xml.
 */
