...
class QTAWS_EXPORT PutKMSEncryptionKeyResponsePrivate : public FraudDetectorResponsePrivate {

public:

    PutKMSEncryptionKeyResponsePrivate(PutKMSEncryptionKeyResponse * const q);
