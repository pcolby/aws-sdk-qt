...
/*!
 * \class QtAws::Inspector2::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Inspector2 UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : Inspector2Response(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Inspector2 UntagResource \a response.
 */
...
/*!
 * \class QtAws::Inspector2::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : Inspector2ResponsePrivate(q)
{

}

/*!
 * Parses a Inspector2 UntagResource response element from \a xml.
 */
