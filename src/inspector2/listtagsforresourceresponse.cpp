...
/*!
 * \class QtAws::Inspector2::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Inspector2 ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : Inspector2Response(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Inspector2 ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Inspector2::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : Inspector2ResponsePrivate(q)
{

}

/*!
 * Parses a Inspector2 ListTagsForResource response element from \a xml.
 */
