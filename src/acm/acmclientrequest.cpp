...
/**
 * @brief  Constructs a new AcmClientRequest object.
 *
...
/**
 * @brief  Constructs a new AcmClientRequest object by copying another.
 *
 ...
 */
AcmClientRequest& AcmClientRequest::operator=(const AcmClientRequest &other)
{
    Q_D(AcmClientRequest);
 ...
 * implementation that inherits from AcmClientRequestPrivate.
 *
 ...
 */
AcmClientRequest::Action AcmClientRequest::action() const
{
    Q_D(const AcmClientRequest);
    return d->action;
}
 ...
 */
QString AcmClientRequest::actionString() const
{
    return AcmClientRequestPrivate::toString(action());
}
 ...
 */
QString AcmClientRequest::apiVersion() const
{
    Q_D(const AcmClientRequest);
    return d->apiVersion;
}
 ...
 */
void AcmClientRequest::setAction(const Action action)
{
    Q_D(AcmClientRequest);
    d->action = action;
}
 ...
 */
void AcmClientRequest::setApiVersion(const QString &version)
{
    Q_D(AcmClientRequest);
 ...
 */
bool AcmClientRequest::operator==(const AcmClientRequest &other) const
{
 ...
 */
bool AcmClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int AcmClientRequest::clearParameter(const QString &name)
{
    Q_D(AcmClientRequest);
 ...
 */
void AcmClientRequest::clearParameters()
{
    Q_D(AcmClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant AcmClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const AcmClientRequest);
 ...
 */
const QVariantMap &AcmClientRequest::parameters() const
{
    Q_D(const AcmClientRequest);
    return d->parameters;
}
 ...
 */
void AcmClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(AcmClientRequest);
 ...
 */
void AcmClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(AcmClientRequest);
 ...
 */
QNetworkRequest AcmClientRequest::unsignedRequest(const QUrl &endpoint) const
{
    Q_D(const AcmClientRequest);
    QUrl url(endpoint);
 ...
 *
 * @brief  Private implementation for AcmClientRequest.
 */

/**
 * @internal
 *
 * @brief  Constructs a new AcmClientRequestPrivate object.
 *
 ...
 * @internal
 *
 * @brief  Constructs a new AcmClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the AcmClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public AcmClientRequest instance.
 */
 ...
 *
 * This function converts AcmClientRequest::Action enumerator values to their respective
 ...
 */
QString AcmClientRequestPrivate::toString(const AcmClientRequest::Action &action)
{
    #define ActionToString(action) \
        case AcmClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
