...
class QTAWS_EXPORT DescribeCertificateAuthorityAuditReportResponse : public AcmpcaResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeCertificateAuthorityAuditReportRequest * request() const override;
