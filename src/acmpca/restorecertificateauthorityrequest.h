...
#ifndef QTAWS_RESTORECERTIFICATEAUTHORITYREQUEST_H
#define QTAWS_RESTORECERTIFICATEAUTHORITYREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(RestoreCertificateAuthorityRequest)
