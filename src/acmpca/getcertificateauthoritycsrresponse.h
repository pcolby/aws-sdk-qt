...
class QTAWSACMPCA_EXPORT GetCertificateAuthorityCsrResponse : public AcmpcaResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetCertificateAuthorityCsrRequest * request() const Q_DECL_OVERRIDE;
