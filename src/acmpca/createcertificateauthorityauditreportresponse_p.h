...
class QTAWS_EXPORT CreateCertificateAuthorityAuditReportResponsePrivate : public ACMPCAResponsePrivate {
    Q_OBJECT

public:

    CreateCertificateAuthorityAuditReportResponsePrivate(CreateCertificateAuthorityAuditReportResponse * const q);
