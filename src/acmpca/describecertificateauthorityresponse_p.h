...
class QTAWS_EXPORT DescribeCertificateAuthorityResponsePrivate : public AcmpcaResponsePrivate {

public:

    DescribeCertificateAuthorityResponsePrivate(DescribeCertificateAuthorityResponse * const q);
