...
class QTAWS_EXPORT RestoreCertificateAuthorityResponsePrivate : public AcmpcaResponsePrivate {

public:

    RestoreCertificateAuthorityResponsePrivate(RestoreCertificateAuthorityResponse * const q);
