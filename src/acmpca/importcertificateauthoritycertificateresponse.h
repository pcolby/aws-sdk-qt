...
class QTAWS_EXPORT ImportCertificateAuthorityCertificateResponse : public AcmpcaResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ImportCertificateAuthorityCertificateRequest * request() const override;
