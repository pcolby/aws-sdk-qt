...
class QTAWS_EXPORT ModifyWorkspaceAccessPropertiesResponsePrivate : public WorkSpacesResponsePrivate {

public:

    ModifyWorkspaceAccessPropertiesResponsePrivate(ModifyWorkspaceAccessPropertiesResponse * const q);
