...
#ifndef QTAWS_UPDATEWORKSPACEIMAGEPERMISSIONREQUEST_H
#define QTAWS_UPDATEWORKSPACEIMAGEPERMISSIONREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(UpdateWorkspaceImagePermissionRequest)
