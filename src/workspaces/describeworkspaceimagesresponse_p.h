...
class QTAWS_EXPORT DescribeWorkspaceImagesResponsePrivate : public WorkSpacesResponsePrivate {

public:

    DescribeWorkspaceImagesResponsePrivate(DescribeWorkspaceImagesResponse * const q);
