...
/*!
 * \class QtAws::AccessAnalyzer::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for AccessAnalyzer UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : AccessAnalyzerRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : AccessAnalyzerRequest(new UntagResourceRequestPrivate(AccessAnalyzerRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::AccessAnalyzer::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for AccessAnalyzer \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const AccessAnalyzerRequest::Action action, UntagResourceRequest * const q)
