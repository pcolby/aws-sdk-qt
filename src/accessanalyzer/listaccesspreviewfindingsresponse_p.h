...
class QTAWS_EXPORT ListAccessPreviewFindingsResponsePrivate : public AccessAnalyzerResponsePrivate {

public:

    ListAccessPreviewFindingsResponsePrivate(ListAccessPreviewFindingsResponse * const q);
