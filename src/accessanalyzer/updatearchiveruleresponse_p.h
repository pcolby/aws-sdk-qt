...
class QTAWS_EXPORT UpdateArchiveRuleResponsePrivate : public AccessAnalyzerResponsePrivate {

public:

    UpdateArchiveRuleResponsePrivate(UpdateArchiveRuleResponse * const q);
