...
class QTAWS_EXPORT GetAccessPreviewResponsePrivate : public AccessAnalyzerResponsePrivate {

public:

    GetAccessPreviewResponsePrivate(GetAccessPreviewResponse * const q);
