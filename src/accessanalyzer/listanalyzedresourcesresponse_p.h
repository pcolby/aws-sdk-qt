...
class QTAWS_EXPORT ListAnalyzedResourcesResponsePrivate : public AccessAnalyzerResponsePrivate {

public:

    ListAnalyzedResourcesResponsePrivate(ListAnalyzedResourcesResponse * const q);
