...
class QTAWS_EXPORT UpdateClusterSettingsResponsePrivate : public EcsResponsePrivate {

public:

    UpdateClusterSettingsResponsePrivate(UpdateClusterSettingsResponse * const q);
