...
class QTAWS_EXPORT SubmitContainerStateChangeResponse : public SubmitContainerStateChangeResponse {
    Q_OBJECT
...
public:
    ...
    virtual const SubmitContainerStateChangeRequest * request() const;
