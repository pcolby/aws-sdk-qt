...
public slots:
    CreateCapacityProviderResponse * createCapacityProvider(const CreateCapacityProviderRequest &request);
    ...
    DeleteCapacityProviderResponse * deleteCapacityProvider(const DeleteCapacityProviderRequest &request);
    ...
    DescribeCapacityProvidersResponse * describeCapacityProviders(const DescribeCapacityProvidersRequest &request);
    ...
    ExecuteCommandResponse * executeCommand(const ExecuteCommandRequest &request);
    ...
    PutClusterCapacityProvidersResponse * putClusterCapacityProviders(const PutClusterCapacityProvidersRequest &request);
    ...
    UpdateCapacityProviderResponse * updateCapacityProvider(const UpdateCapacityProviderRequest &request);
    UpdateClusterResponse * updateCluster(const UpdateClusterRequest &request);
    UpdateClusterSettingsResponse * updateClusterSettings(const UpdateClusterSettingsRequest &request);
...
protected:
    ...
    explicit EcsClient(EcsClientPrivate * const d);
    /// @endcond
