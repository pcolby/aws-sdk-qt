...
/*!
 * \class QtAws::ECS::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for ECS TagResource responses.
 *
 * \inmodule QtAwsECS
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : EcsResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(EcsResponse::request());
}

/*!
 * \reimp
 * Parses a successful ECS TagResource \a response.
 */
...
/*!
 * \class QtAws::ECS::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : EcsResponsePrivate(q)
{

}

/*!
 * Parses a ECS TagResource response element from \a xml.
 */
