...
class QTAWS_EXPORT DescribeScalingActivitiesResponse : public ApplicationAutoScalingResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeScalingActivitiesRequest * request() const override;
