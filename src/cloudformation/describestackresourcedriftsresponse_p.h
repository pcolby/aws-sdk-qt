...
class QTAWS_EXPORT DescribeStackResourceDriftsResponsePrivate : public CloudFormationResponsePrivate {

public:

    DescribeStackResourceDriftsResponsePrivate(DescribeStackResourceDriftsResponse * const q);
