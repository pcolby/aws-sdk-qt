...
/*!
 * \class QtAws::CloudFormation::ListTypesRequest
 * \brief The ListTypesRequest class provides an interface for CloudFormation ListTypes requests.
 *
...
ListTypesRequest::ListTypesRequest(const ListTypesRequest &other)
    : CloudFormationRequest(new ListTypesRequestPrivate(*other.d_func(), this))
{
...
ListTypesRequest::ListTypesRequest()
    : CloudFormationRequest(new ListTypesRequestPrivate(CloudFormationRequest::ListTypesAction, this))
{
...
/*!
 * \class QtAws::CloudFormation::ListTypesRequestPrivate
...
/*!
 * Constructs a ListTypesRequestPrivate object for CloudFormation \a action,
 * with public implementation \a q.
 */
ListTypesRequestPrivate::ListTypesRequestPrivate(
    const CloudFormationRequest::Action action, ListTypesRequest * const q)
