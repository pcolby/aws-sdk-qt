...
class QTAWS_EXPORT DescribeStackSetResponsePrivate : public CloudFormationResponsePrivate {

public:

    DescribeStackSetResponsePrivate(DescribeStackSetResponse * const q);
