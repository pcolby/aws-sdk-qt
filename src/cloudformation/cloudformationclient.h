...
public slots:
    ActivateTypeResponse * activateType(const ActivateTypeRequest &request);
    BatchDescribeTypeConfigurationsResponse * batchDescribeTypeConfigurations(const BatchDescribeTypeConfigurationsRequest &request);
    ...
    DeactivateTypeResponse * deactivateType(const DeactivateTypeRequest &request);
    ...
    DeregisterTypeResponse * deregisterType(const DeregisterTypeRequest &request);
    ...
    DescribeChangeSetHooksResponse * describeChangeSetHooks(const DescribeChangeSetHooksRequest &request);
    DescribePublisherResponse * describePublisher(const DescribePublisherRequest &request);
    ...
    DescribeTypeResponse * describeType(const DescribeTypeRequest &request);
    DescribeTypeRegistrationResponse * describeTypeRegistration(const DescribeTypeRegistrationRequest &request);
    ...
    DetectStackSetDriftResponse * detectStackSetDrift(const DetectStackSetDriftRequest &request);
    ...
    ImportStacksToStackSetResponse * importStacksToStackSet(const ImportStacksToStackSetRequest &request);
    ...
    ListTypeRegistrationsResponse * listTypeRegistrations(const ListTypeRegistrationsRequest &request);
    ListTypeVersionsResponse * listTypeVersions(const ListTypeVersionsRequest &request);
    ListTypesResponse * listTypes(const ListTypesRequest &request);
    PublishTypeResponse * publishType(const PublishTypeRequest &request);
    RecordHandlerProgressResponse * recordHandlerProgress(const RecordHandlerProgressRequest &request);
    RegisterPublisherResponse * registerPublisher(const RegisterPublisherRequest &request);
    RegisterTypeResponse * registerType(const RegisterTypeRequest &request);
    RollbackStackResponse * rollbackStack(const RollbackStackRequest &request);
    SetStackPolicyResponse * setStackPolicy(const SetStackPolicyRequest &request);
    SetTypeConfigurationResponse * setTypeConfiguration(const SetTypeConfigurationRequest &request);
    SetTypeDefaultVersionResponse * setTypeDefaultVersion(const SetTypeDefaultVersionRequest &request);
    ...
    TestTypeResponse * testType(const TestTypeRequest &request);
