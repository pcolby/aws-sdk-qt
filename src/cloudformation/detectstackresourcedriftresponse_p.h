...
class QTAWS_EXPORT DetectStackResourceDriftResponsePrivate : public CloudFormationResponsePrivate {

public:

    DetectStackResourceDriftResponsePrivate(DetectStackResourceDriftResponse * const q);
