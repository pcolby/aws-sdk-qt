...
class QTAWS_EXPORT ListStackResourcesResponsePrivate : public CloudFormationResponsePrivate {
    Q_OBJECT

public:

    ListStackResourcesResponsePrivate(ListStackResourcesResponse * const q);
