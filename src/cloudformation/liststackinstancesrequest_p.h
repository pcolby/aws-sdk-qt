...
class QTAWS_EXPORT ListStackInstancesRequestPrivate : public CloudFormationRequestPrivate {

public:
    ListStackInstancesRequestPrivate(const CloudFormation::Action action,
