...
class QTAWS_EXPORT DescribeStackInstanceRequestPrivate : public CloudFormationPrivate {

public:
    DescribeStackInstanceRequestPrivate(const CloudFormation::Action action,
