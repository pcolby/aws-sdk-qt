...
class QTAWS_EXPORT CreateStackInstancesRequestPrivate : public CloudFormationPrivate {

public:
    CreateStackInstancesRequestPrivate(const CloudFormation::Action action,
