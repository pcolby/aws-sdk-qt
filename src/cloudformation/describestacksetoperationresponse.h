...
class QTAWS_EXPORT DescribeStackSetOperationResponse : public DescribeStackSetOperationResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeStackSetOperationRequest * request() const;
