...
class QTAWS_EXPORT DescribeStackSetOperationResponse : public CloudFormationResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeStackSetOperationRequest * request() const override;
