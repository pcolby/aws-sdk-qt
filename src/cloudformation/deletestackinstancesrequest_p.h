...
class QTAWS_EXPORT DeleteStackInstancesRequestPrivate : public CloudFormationRequestPrivate {

public:
    DeleteStackInstancesRequestPrivate(const CloudFormation::Action action,
