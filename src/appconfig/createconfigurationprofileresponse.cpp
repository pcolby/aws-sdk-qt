...
#include "createconfigurationprofileresponse_p.h"
...
/*!
 * \class QtAws::AppConfig::CreateConfigurationProfileResponse
 * \brief The CreateConfigurationProfileResponse class provides an interace for AppConfig CreateConfigurationProfile responses.
 *
...
/*!
 * Constructs a CreateConfigurationProfileResponse object for \a reply to \a request, with parent \a parent.
 */
CreateConfigurationProfileResponse::CreateConfigurationProfileResponse(
        const CreateConfigurationProfileRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AppConfigResponse(new CreateConfigurationProfileResponsePrivate(this), parent)
{
    setRequest(new CreateConfigurationProfileRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful AppConfig CreateConfigurationProfile \a response.
 */
void CreateConfigurationProfileResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateConfigurationProfileResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AppConfig::CreateConfigurationProfileResponsePrivate
 * \brief The CreateConfigurationProfileResponsePrivate class provides private implementation for CreateConfigurationProfileResponse.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a CreateConfigurationProfileResponsePrivate object with public implementation \a q.
 */
CreateConfigurationProfileResponsePrivate::CreateConfigurationProfileResponsePrivate(
    CreateConfigurationProfileResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig CreateConfigurationProfile response element from \a xml.
 */
void CreateConfigurationProfileResponsePrivate::parseCreateConfigurationProfileResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateConfigurationProfileResponse"));
    Q_UNUSED(xml) ///< @todo
}
