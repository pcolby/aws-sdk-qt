...
#include "getconfigurationprofilerequest_p.h"
...
/*!
 * \class QtAws::AppConfig::GetConfigurationProfileRequest
 * \brief The GetConfigurationProfileRequest class provides an interface for AppConfig GetConfigurationProfile requests.
 *
 ...
 */
GetConfigurationProfileRequest::GetConfigurationProfileRequest(const GetConfigurationProfileRequest &other)
    : AppConfigRequest(new GetConfigurationProfileRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetConfigurationProfileRequest object.
 */
GetConfigurationProfileRequest::GetConfigurationProfileRequest()
    : AppConfigRequest(new GetConfigurationProfileRequestPrivate(AppConfigRequest::GetConfigurationProfileAction, this))
{
 ...
 * \reimp
 */
bool GetConfigurationProfileRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetConfigurationProfileResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetConfigurationProfileRequest::response(QNetworkReply * const reply) const
{
    return new GetConfigurationProfileResponse(*this, reply);
}

/*!
 * \class QtAws::AppConfig::GetConfigurationProfileRequestPrivate
 * \brief The GetConfigurationProfileRequestPrivate class provides private implementation for GetConfigurationProfileRequest.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a GetConfigurationProfileRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
GetConfigurationProfileRequestPrivate::GetConfigurationProfileRequestPrivate(
    const AppConfigRequest::Action action, GetConfigurationProfileRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetConfigurationProfileRequest
 * class' copy constructor.
 */
GetConfigurationProfileRequestPrivate::GetConfigurationProfileRequestPrivate(
    const GetConfigurationProfileRequestPrivate &other, GetConfigurationProfileRequest * const q)
