...
/*!
 * \class QtAws::AppConfig::ListExtensionsRequest
 * \brief The ListExtensionsRequest class provides an interface for AppConfig ListExtensions requests.
 *
...
ListExtensionsRequest::ListExtensionsRequest(const ListExtensionsRequest &other)
    : AppConfigRequest(new ListExtensionsRequestPrivate(*other.d_func(), this))
{
...
ListExtensionsRequest::ListExtensionsRequest()
    : AppConfigRequest(new ListExtensionsRequestPrivate(AppConfigRequest::ListExtensionsAction, this))
{
...
/*!
 * \class QtAws::AppConfig::ListExtensionsRequestPrivate
...
/*!
 * Constructs a ListExtensionsRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
ListExtensionsRequestPrivate::ListExtensionsRequestPrivate(
    const AppConfigRequest::Action action, ListExtensionsRequest * const q)
