...
/*!
 * \class QtAws::AppConfig::DeleteEnvironmentResponse
 * \brief The DeleteEnvironmentResponse class provides an interace for AppConfig DeleteEnvironment responses.
 *
 ...
 *
 * \sa AppConfigClient::deleteEnvironment
 */
...
DeleteEnvironmentResponse::DeleteEnvironmentResponse(
    ...
    : AppConfigResponse(new DeleteEnvironmentResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteEnvironmentRequest *>(AppConfigResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppConfig DeleteEnvironment \a response.
 */
...
/*!
 * \class QtAws::AppConfig::DeleteEnvironmentResponsePrivate
...
DeleteEnvironmentResponsePrivate::DeleteEnvironmentResponsePrivate(
    DeleteEnvironmentResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig DeleteEnvironment response element from \a xml.
 */
