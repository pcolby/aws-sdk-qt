...
/*!
 * \class QtAws::AppConfig::StartDeploymentRequest
 * \brief The StartDeploymentRequest class provides an interface for AppConfig StartDeployment requests.
 *
...
StartDeploymentRequest::StartDeploymentRequest(const StartDeploymentRequest &other)
    : AppConfigRequest(new StartDeploymentRequestPrivate(*other.d_func(), this))
{
...
StartDeploymentRequest::StartDeploymentRequest()
    : AppConfigRequest(new StartDeploymentRequestPrivate(AppConfigRequest::StartDeploymentAction, this))
{
...
/*!
 * \class QtAws::AppConfig::StartDeploymentRequestPrivate
...
/*!
 * Constructs a StartDeploymentRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
StartDeploymentRequestPrivate::StartDeploymentRequestPrivate(
    const AppConfigRequest::Action action, StartDeploymentRequest * const q)
