...
#include "updatedeploymentstrategyresponse_p.h"
...
/*!
 * \class QtAws::AppConfig::UpdateDeploymentStrategyResponse
 * \brief The UpdateDeploymentStrategyResponse class provides an interace for AppConfig UpdateDeploymentStrategy responses.
 *
...
/*!
 * Constructs a UpdateDeploymentStrategyResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateDeploymentStrategyResponse::UpdateDeploymentStrategyResponse(
        const UpdateDeploymentStrategyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AppConfigResponse(new UpdateDeploymentStrategyResponsePrivate(this), parent)
{
    setRequest(new UpdateDeploymentStrategyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful AppConfig UpdateDeploymentStrategy \a response.
 */
void UpdateDeploymentStrategyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateDeploymentStrategyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AppConfig::UpdateDeploymentStrategyResponsePrivate
 * \brief The UpdateDeploymentStrategyResponsePrivate class provides private implementation for UpdateDeploymentStrategyResponse.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a UpdateDeploymentStrategyResponsePrivate object with public implementation \a q.
 */
UpdateDeploymentStrategyResponsePrivate::UpdateDeploymentStrategyResponsePrivate(
    UpdateDeploymentStrategyResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig UpdateDeploymentStrategy response element from \a xml.
 */
void UpdateDeploymentStrategyResponsePrivate::parseUpdateDeploymentStrategyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateDeploymentStrategyResponse"));
    Q_UNUSED(xml) ///< @todo
}
