...
#include "getconfigurationprofileresponse_p.h"
...
/*!
 * \class QtAws::AppConfig::GetConfigurationProfileResponse
 * \brief The GetConfigurationProfileResponse class provides an interace for AppConfig GetConfigurationProfile responses.
 *
 ...
 *
 * \sa AppConfigClient::getConfigurationProfile
 */

/*!
 * Constructs a GetConfigurationProfileResponse object for \a reply to \a request, with parent \a parent.
 */
GetConfigurationProfileResponse::GetConfigurationProfileResponse(
        const GetConfigurationProfileRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AppConfigResponse(new GetConfigurationProfileResponsePrivate(this), parent)
{
    setRequest(new GetConfigurationProfileRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetConfigurationProfileRequest * GetConfigurationProfileResponse::request() const
{
    Q_D(const GetConfigurationProfileResponse);
    return static_cast<const GetConfigurationProfileRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful AppConfig GetConfigurationProfile \a response.
 */
void GetConfigurationProfileResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetConfigurationProfileResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AppConfig::GetConfigurationProfileResponsePrivate
 * \brief The GetConfigurationProfileResponsePrivate class provides private implementation for GetConfigurationProfileResponse.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a GetConfigurationProfileResponsePrivate object with public implementation \a q.
 */
GetConfigurationProfileResponsePrivate::GetConfigurationProfileResponsePrivate(
    GetConfigurationProfileResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig GetConfigurationProfile response element from \a xml.
 */
void GetConfigurationProfileResponsePrivate::parseGetConfigurationProfileResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetConfigurationProfileResponse"));
    Q_UNUSED(xml) ///< @todo
}
