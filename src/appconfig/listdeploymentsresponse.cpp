...
/*!
 * \class QtAws::AppConfig::ListDeploymentsResponse
 * \brief The ListDeploymentsResponse class provides an interace for AppConfig ListDeployments responses.
 *
 ...
 *
 * \sa AppConfigClient::listDeployments
 */
...
ListDeploymentsResponse::ListDeploymentsResponse(
    ...
    : AppConfigResponse(new ListDeploymentsResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListDeploymentsRequest *>(AppConfigResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppConfig ListDeployments \a response.
 */
...
/*!
 * \class QtAws::AppConfig::ListDeploymentsResponsePrivate
...
ListDeploymentsResponsePrivate::ListDeploymentsResponsePrivate(
    ListDeploymentsResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig ListDeployments response element from \a xml.
 */
