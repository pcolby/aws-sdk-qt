...
#include "listconfigurationprofilesrequest_p.h"
...
/*!
 * \class QtAws::AppConfig::ListConfigurationProfilesRequest
 * \brief The ListConfigurationProfilesRequest class provides an interface for AppConfig ListConfigurationProfiles requests.
 *
 ...
 */
ListConfigurationProfilesRequest::ListConfigurationProfilesRequest(const ListConfigurationProfilesRequest &other)
    : AppConfigRequest(new ListConfigurationProfilesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListConfigurationProfilesRequest object.
 */
ListConfigurationProfilesRequest::ListConfigurationProfilesRequest()
    : AppConfigRequest(new ListConfigurationProfilesRequestPrivate(AppConfigRequest::ListConfigurationProfilesAction, this))
{
 ...
 * \reimp
 */
bool ListConfigurationProfilesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListConfigurationProfilesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListConfigurationProfilesRequest::response(QNetworkReply * const reply) const
{
    return new ListConfigurationProfilesResponse(*this, reply);
}

/*!
 * \class QtAws::AppConfig::ListConfigurationProfilesRequestPrivate
 * \brief The ListConfigurationProfilesRequestPrivate class provides private implementation for ListConfigurationProfilesRequest.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a ListConfigurationProfilesRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
ListConfigurationProfilesRequestPrivate::ListConfigurationProfilesRequestPrivate(
    const AppConfigRequest::Action action, ListConfigurationProfilesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListConfigurationProfilesRequest
 * class' copy constructor.
 */
ListConfigurationProfilesRequestPrivate::ListConfigurationProfilesRequestPrivate(
    const ListConfigurationProfilesRequestPrivate &other, ListConfigurationProfilesRequest * const q)
