...
#include "deleteconfigurationprofilerequest_p.h"
...
/*!
 * \class QtAws::AppConfig::DeleteConfigurationProfileRequest
 * \brief The DeleteConfigurationProfileRequest class provides an interface for AppConfig DeleteConfigurationProfile requests.
 *
 ...
 */
DeleteConfigurationProfileRequest::DeleteConfigurationProfileRequest(const DeleteConfigurationProfileRequest &other)
    : AppConfigRequest(new DeleteConfigurationProfileRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteConfigurationProfileRequest object.
 */
DeleteConfigurationProfileRequest::DeleteConfigurationProfileRequest()
    : AppConfigRequest(new DeleteConfigurationProfileRequestPrivate(AppConfigRequest::DeleteConfigurationProfileAction, this))
{
 ...
 * \reimp
 */
bool DeleteConfigurationProfileRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteConfigurationProfileResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteConfigurationProfileRequest::response(QNetworkReply * const reply) const
{
    return new DeleteConfigurationProfileResponse(*this, reply);
}

/*!
 * \class QtAws::AppConfig::DeleteConfigurationProfileRequestPrivate
 * \brief The DeleteConfigurationProfileRequestPrivate class provides private implementation for DeleteConfigurationProfileRequest.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a DeleteConfigurationProfileRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
DeleteConfigurationProfileRequestPrivate::DeleteConfigurationProfileRequestPrivate(
    const AppConfigRequest::Action action, DeleteConfigurationProfileRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteConfigurationProfileRequest
 * class' copy constructor.
 */
DeleteConfigurationProfileRequestPrivate::DeleteConfigurationProfileRequestPrivate(
    const DeleteConfigurationProfileRequestPrivate &other, DeleteConfigurationProfileRequest * const q)
