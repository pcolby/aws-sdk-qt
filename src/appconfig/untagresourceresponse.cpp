...
/*!
 * \class QtAws::AppConfig::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for AppConfig UntagResource responses.
 *
 ...
 *
 * \sa AppConfigClient::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : AppConfigResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(AppConfigResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppConfig UntagResource \a response.
 */
...
/*!
 * \class QtAws::AppConfig::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig UntagResource response element from \a xml.
 */
