...
#include "validateconfigurationresponse_p.h"
...
/*!
 * \class QtAws::AppConfig::ValidateConfigurationResponse
 * \brief The ValidateConfigurationResponse class provides an interace for AppConfig ValidateConfiguration responses.
 *
...
/*!
 * Constructs a ValidateConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
ValidateConfigurationResponse::ValidateConfigurationResponse(
        const ValidateConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AppConfigResponse(new ValidateConfigurationResponsePrivate(this), parent)
{
    setRequest(new ValidateConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful AppConfig ValidateConfiguration \a response.
 */
void ValidateConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ValidateConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AppConfig::ValidateConfigurationResponsePrivate
 * \brief The ValidateConfigurationResponsePrivate class provides private implementation for ValidateConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a ValidateConfigurationResponsePrivate object with public implementation \a q.
 */
ValidateConfigurationResponsePrivate::ValidateConfigurationResponsePrivate(
    ValidateConfigurationResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig ValidateConfiguration response element from \a xml.
 */
void ValidateConfigurationResponsePrivate::parseValidateConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ValidateConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
