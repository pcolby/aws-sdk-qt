...
#include "createdeploymentstrategyrequest_p.h"
...
/*!
 * \class QtAws::AppConfig::CreateDeploymentStrategyRequest
 * \brief The CreateDeploymentStrategyRequest class provides an interface for AppConfig CreateDeploymentStrategy requests.
 *
 ...
 */
CreateDeploymentStrategyRequest::CreateDeploymentStrategyRequest(const CreateDeploymentStrategyRequest &other)
    : AppConfigRequest(new CreateDeploymentStrategyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateDeploymentStrategyRequest object.
 */
CreateDeploymentStrategyRequest::CreateDeploymentStrategyRequest()
    : AppConfigRequest(new CreateDeploymentStrategyRequestPrivate(AppConfigRequest::CreateDeploymentStrategyAction, this))
{
 ...
 * \reimp
 */
bool CreateDeploymentStrategyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateDeploymentStrategyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateDeploymentStrategyRequest::response(QNetworkReply * const reply) const
{
    return new CreateDeploymentStrategyResponse(*this, reply);
}

/*!
 * \class QtAws::AppConfig::CreateDeploymentStrategyRequestPrivate
 * \brief The CreateDeploymentStrategyRequestPrivate class provides private implementation for CreateDeploymentStrategyRequest.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a CreateDeploymentStrategyRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
CreateDeploymentStrategyRequestPrivate::CreateDeploymentStrategyRequestPrivate(
    const AppConfigRequest::Action action, CreateDeploymentStrategyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateDeploymentStrategyRequest
 * class' copy constructor.
 */
CreateDeploymentStrategyRequestPrivate::CreateDeploymentStrategyRequestPrivate(
    const CreateDeploymentStrategyRequestPrivate &other, CreateDeploymentStrategyRequest * const q)
