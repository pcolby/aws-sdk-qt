...
/*!
 * \class QtAws::AppConfig::StopDeploymentRequest
 * \brief The StopDeploymentRequest class provides an interface for AppConfig StopDeployment requests.
 *
...
StopDeploymentRequest::StopDeploymentRequest(const StopDeploymentRequest &other)
    : AppConfigRequest(new StopDeploymentRequestPrivate(*other.d_func(), this))
{
...
StopDeploymentRequest::StopDeploymentRequest()
    : AppConfigRequest(new StopDeploymentRequestPrivate(AppConfigRequest::StopDeploymentAction, this))
{
...
/*!
 * \class QtAws::AppConfig::StopDeploymentRequestPrivate
...
/*!
 * Constructs a StopDeploymentRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
StopDeploymentRequestPrivate::StopDeploymentRequestPrivate(
    const AppConfigRequest::Action action, StopDeploymentRequest * const q)
