...
/*!
 * \class QtAws::AppConfig::DeleteEnvironmentRequest
 * \brief The DeleteEnvironmentRequest class provides an interface for AppConfig DeleteEnvironment requests.
 *
...
DeleteEnvironmentRequest::DeleteEnvironmentRequest(const DeleteEnvironmentRequest &other)
    : AppConfigRequest(new DeleteEnvironmentRequestPrivate(*other.d_func(), this))
{
...
DeleteEnvironmentRequest::DeleteEnvironmentRequest()
    : AppConfigRequest(new DeleteEnvironmentRequestPrivate(AppConfigRequest::DeleteEnvironmentAction, this))
{
...
/*!
 * \class QtAws::AppConfig::DeleteEnvironmentRequestPrivate
...
/*!
 * Constructs a DeleteEnvironmentRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
DeleteEnvironmentRequestPrivate::DeleteEnvironmentRequestPrivate(
    const AppConfigRequest::Action action, DeleteEnvironmentRequest * const q)
