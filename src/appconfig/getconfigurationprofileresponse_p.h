...
class QTAWS_EXPORT GetConfigurationProfileResponsePrivate : public AppConfigResponsePrivate {

public:

    GetConfigurationProfileResponsePrivate(GetConfigurationProfileResponse * const q);
