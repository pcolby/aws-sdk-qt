...
#include "listconfigurationprofilesresponse_p.h"
...
/*!
 * \class QtAws::AppConfig::ListConfigurationProfilesResponse
 * \brief The ListConfigurationProfilesResponse class provides an interace for AppConfig ListConfigurationProfiles responses.
 *
...
/*!
 * Constructs a ListConfigurationProfilesResponse object for \a reply to \a request, with parent \a parent.
 */
ListConfigurationProfilesResponse::ListConfigurationProfilesResponse(
        const ListConfigurationProfilesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AppConfigResponse(new ListConfigurationProfilesResponsePrivate(this), parent)
{
    setRequest(new ListConfigurationProfilesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful AppConfig ListConfigurationProfiles \a response.
 */
void ListConfigurationProfilesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListConfigurationProfilesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AppConfig::ListConfigurationProfilesResponsePrivate
 * \brief The ListConfigurationProfilesResponsePrivate class provides private implementation for ListConfigurationProfilesResponse.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a ListConfigurationProfilesResponsePrivate object with public implementation \a q.
 */
ListConfigurationProfilesResponsePrivate::ListConfigurationProfilesResponsePrivate(
    ListConfigurationProfilesResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig ListConfigurationProfiles response element from \a xml.
 */
void ListConfigurationProfilesResponsePrivate::parseListConfigurationProfilesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListConfigurationProfilesResponse"));
    Q_UNUSED(xml) ///< @todo
}
