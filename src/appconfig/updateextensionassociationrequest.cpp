...
#include "updateextensionassociationrequest_p.h"
...
/*!
 * \class QtAws::AppConfig::UpdateExtensionAssociationRequest
 * \brief The UpdateExtensionAssociationRequest class provides an interface for AppConfig UpdateExtensionAssociation requests.
 *
 ...
 */
UpdateExtensionAssociationRequest::UpdateExtensionAssociationRequest(const UpdateExtensionAssociationRequest &other)
    : AppConfigRequest(new UpdateExtensionAssociationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateExtensionAssociationRequest object.
 */
UpdateExtensionAssociationRequest::UpdateExtensionAssociationRequest()
    : AppConfigRequest(new UpdateExtensionAssociationRequestPrivate(AppConfigRequest::UpdateExtensionAssociationAction, this))
{
 ...
 * \reimp
 */
bool UpdateExtensionAssociationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateExtensionAssociationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateExtensionAssociationRequest::response(QNetworkReply * const reply) const
{
    return new UpdateExtensionAssociationResponse(*this, reply);
}

/*!
 * \class QtAws::AppConfig::UpdateExtensionAssociationRequestPrivate
 * \brief The UpdateExtensionAssociationRequestPrivate class provides private implementation for UpdateExtensionAssociationRequest.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a UpdateExtensionAssociationRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
UpdateExtensionAssociationRequestPrivate::UpdateExtensionAssociationRequestPrivate(
    const AppConfigRequest::Action action, UpdateExtensionAssociationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateExtensionAssociationRequest
 * class' copy constructor.
 */
UpdateExtensionAssociationRequestPrivate::UpdateExtensionAssociationRequestPrivate(
    const UpdateExtensionAssociationRequestPrivate &other, UpdateExtensionAssociationRequest * const q)
