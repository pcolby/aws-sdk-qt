...
/*!
 * \class QtAws::AppConfig::GetConfigurationResponse
 * \brief The GetConfigurationResponse class provides an interace for AppConfig GetConfiguration responses.
 *
...
GetConfigurationResponse::GetConfigurationResponse(
    ...
    : AppConfigResponse(new GetConfigurationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful AppConfig GetConfiguration \a response.
 */
...
/*!
 * \class QtAws::AppConfig::GetConfigurationResponsePrivate
...
GetConfigurationResponsePrivate::GetConfigurationResponsePrivate(
    GetConfigurationResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig GetConfiguration response element from \a xml.
 */
