...
/*!
 * \class QtAws::AppConfig::ListDeploymentsRequest
 * \brief The ListDeploymentsRequest class provides an interface for AppConfig ListDeployments requests.
 *
...
ListDeploymentsRequest::ListDeploymentsRequest(const ListDeploymentsRequest &other)
    : AppConfigRequest(new ListDeploymentsRequestPrivate(*other.d_func(), this))
{
...
ListDeploymentsRequest::ListDeploymentsRequest()
    : AppConfigRequest(new ListDeploymentsRequestPrivate(AppConfigRequest::ListDeploymentsAction, this))
{
...
/*!
 * \class QtAws::AppConfig::ListDeploymentsRequestPrivate
...
/*!
 * Constructs a ListDeploymentsRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
ListDeploymentsRequestPrivate::ListDeploymentsRequestPrivate(
    const AppConfigRequest::Action action, ListDeploymentsRequest * const q)
