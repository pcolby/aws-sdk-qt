...
#include "deletedeploymentstrategyrequest_p.h"
...
/*!
 * \class QtAws::AppConfig::DeleteDeploymentStrategyRequest
 * \brief The DeleteDeploymentStrategyRequest class provides an interface for AppConfig DeleteDeploymentStrategy requests.
 *
 ...
 *
 * \sa AppConfigClient::deleteDeploymentStrategy
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteDeploymentStrategyRequest::DeleteDeploymentStrategyRequest(const DeleteDeploymentStrategyRequest &other)
    : AppConfigRequest(new DeleteDeploymentStrategyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteDeploymentStrategyRequest object.
 */
DeleteDeploymentStrategyRequest::DeleteDeploymentStrategyRequest()
    : AppConfigRequest(new DeleteDeploymentStrategyRequestPrivate(AppConfigRequest::DeleteDeploymentStrategyAction, this))
{
 ...
 * \reimp
 */
bool DeleteDeploymentStrategyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteDeploymentStrategyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteDeploymentStrategyRequest::response(QNetworkReply * const reply) const
{
    return new DeleteDeploymentStrategyResponse(*this, reply);
}

/*!
 * \class QtAws::AppConfig::DeleteDeploymentStrategyRequestPrivate
 * \brief The DeleteDeploymentStrategyRequestPrivate class provides private implementation for DeleteDeploymentStrategyRequest.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a DeleteDeploymentStrategyRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
DeleteDeploymentStrategyRequestPrivate::DeleteDeploymentStrategyRequestPrivate(
    const AppConfigRequest::Action action, DeleteDeploymentStrategyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteDeploymentStrategyRequest
 * class' copy constructor.
 */
DeleteDeploymentStrategyRequestPrivate::DeleteDeploymentStrategyRequestPrivate(
    const DeleteDeploymentStrategyRequestPrivate &other, DeleteDeploymentStrategyRequest * const q)
