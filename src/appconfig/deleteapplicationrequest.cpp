...
/*!
 * \class QtAws::AppConfig::DeleteApplicationRequest
 * \brief The DeleteApplicationRequest class provides an interface for AppConfig DeleteApplication requests.
 *
...
DeleteApplicationRequest::DeleteApplicationRequest(const DeleteApplicationRequest &other)
    : AppConfigRequest(new DeleteApplicationRequestPrivate(*other.d_func(), this))
{
...
DeleteApplicationRequest::DeleteApplicationRequest()
    : AppConfigRequest(new DeleteApplicationRequestPrivate(AppConfigRequest::DeleteApplicationAction, this))
{
...
/*!
 * \class QtAws::AppConfig::DeleteApplicationRequestPrivate
...
/*!
 * Constructs a DeleteApplicationRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
DeleteApplicationRequestPrivate::DeleteApplicationRequestPrivate(
    const AppConfigRequest::Action action, DeleteApplicationRequest * const q)
