...
/*!
 * \class QtAws::AppConfig::StopDeploymentResponse
 * \brief The StopDeploymentResponse class provides an interace for AppConfig StopDeployment responses.
 *
 ...
 *
 * \sa AppConfigClient::stopDeployment
 */
...
StopDeploymentResponse::StopDeploymentResponse(
    ...
    : AppConfigResponse(new StopDeploymentResponsePrivate(this), parent)
{
...
{
    return static_cast<const StopDeploymentRequest *>(AppConfigResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppConfig StopDeployment \a response.
 */
...
/*!
 * \class QtAws::AppConfig::StopDeploymentResponsePrivate
...
StopDeploymentResponsePrivate::StopDeploymentResponsePrivate(
    StopDeploymentResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig StopDeployment response element from \a xml.
 */
