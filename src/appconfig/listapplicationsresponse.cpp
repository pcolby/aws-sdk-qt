...
/*!
 * \class QtAws::AppConfig::ListApplicationsResponse
 * \brief The ListApplicationsResponse class provides an interace for AppConfig ListApplications responses.
 *
...
ListApplicationsResponse::ListApplicationsResponse(
    ...
    : AppConfigResponse(new ListApplicationsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful AppConfig ListApplications \a response.
 */
...
/*!
 * \class QtAws::AppConfig::ListApplicationsResponsePrivate
...
ListApplicationsResponsePrivate::ListApplicationsResponsePrivate(
    ListApplicationsResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig ListApplications response element from \a xml.
 */
