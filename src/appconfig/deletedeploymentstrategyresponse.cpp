...
#include "deletedeploymentstrategyresponse_p.h"
...
/*!
 * \class QtAws::AppConfig::DeleteDeploymentStrategyResponse
 * \brief The DeleteDeploymentStrategyResponse class provides an interace for AppConfig DeleteDeploymentStrategy responses.
 *
...
/*!
 * Constructs a DeleteDeploymentStrategyResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteDeploymentStrategyResponse::DeleteDeploymentStrategyResponse(
        const DeleteDeploymentStrategyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AppConfigResponse(new DeleteDeploymentStrategyResponsePrivate(this), parent)
{
    setRequest(new DeleteDeploymentStrategyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful AppConfig DeleteDeploymentStrategy \a response.
 */
void DeleteDeploymentStrategyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteDeploymentStrategyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AppConfig::DeleteDeploymentStrategyResponsePrivate
 * \brief The DeleteDeploymentStrategyResponsePrivate class provides private implementation for DeleteDeploymentStrategyResponse.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a DeleteDeploymentStrategyResponsePrivate object with public implementation \a q.
 */
DeleteDeploymentStrategyResponsePrivate::DeleteDeploymentStrategyResponsePrivate(
    DeleteDeploymentStrategyResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig DeleteDeploymentStrategy response element from \a xml.
 */
void DeleteDeploymentStrategyResponsePrivate::parseDeleteDeploymentStrategyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteDeploymentStrategyResponse"));
    Q_UNUSED(xml) ///< @todo
}
