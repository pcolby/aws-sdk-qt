...
/*!
 * \class QtAws::AppConfig::GetApplicationRequest
 * \brief The GetApplicationRequest class provides an interface for AppConfig GetApplication requests.
 *
...
GetApplicationRequest::GetApplicationRequest(const GetApplicationRequest &other)
    : AppConfigRequest(new GetApplicationRequestPrivate(*other.d_func(), this))
{
...
GetApplicationRequest::GetApplicationRequest()
    : AppConfigRequest(new GetApplicationRequestPrivate(AppConfigRequest::GetApplicationAction, this))
{
...
/*!
 * \class QtAws::AppConfig::GetApplicationRequestPrivate
...
/*!
 * Constructs a GetApplicationRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
GetApplicationRequestPrivate::GetApplicationRequestPrivate(
    const AppConfigRequest::Action action, GetApplicationRequest * const q)
