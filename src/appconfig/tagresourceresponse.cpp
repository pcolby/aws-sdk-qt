...
/*!
 * \class QtAws::AppConfig::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for AppConfig TagResource responses.
 *
 ...
 *
 * \sa AppConfigClient::tagResource
 */
...
TagResourceResponse::TagResourceResponse(
    ...
    : AppConfigResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(AppConfigResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppConfig TagResource \a response.
 */
...
/*!
 * \class QtAws::AppConfig::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig TagResource response element from \a xml.
 */
