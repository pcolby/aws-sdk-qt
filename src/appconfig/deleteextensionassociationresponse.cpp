...
#include "deleteextensionassociationresponse_p.h"
...
/*!
 * \class QtAws::AppConfig::DeleteExtensionAssociationResponse
 * \brief The DeleteExtensionAssociationResponse class provides an interace for AppConfig DeleteExtensionAssociation responses.
 *
...
/*!
 * Constructs a DeleteExtensionAssociationResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteExtensionAssociationResponse::DeleteExtensionAssociationResponse(
        const DeleteExtensionAssociationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AppConfigResponse(new DeleteExtensionAssociationResponsePrivate(this), parent)
{
    setRequest(new DeleteExtensionAssociationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteExtensionAssociationRequest * DeleteExtensionAssociationResponse::request() const
{
    Q_D(const DeleteExtensionAssociationResponse);
    return static_cast<const DeleteExtensionAssociationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful AppConfig DeleteExtensionAssociation \a response.
 */
void DeleteExtensionAssociationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteExtensionAssociationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AppConfig::DeleteExtensionAssociationResponsePrivate
 * \brief The DeleteExtensionAssociationResponsePrivate class provides private implementation for DeleteExtensionAssociationResponse.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a DeleteExtensionAssociationResponsePrivate object with public implementation \a q.
 */
DeleteExtensionAssociationResponsePrivate::DeleteExtensionAssociationResponsePrivate(
    DeleteExtensionAssociationResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig DeleteExtensionAssociation response element from \a xml.
 */
void DeleteExtensionAssociationResponsePrivate::parseDeleteExtensionAssociationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteExtensionAssociationResponse"));
    Q_UNUSED(xml) ///< @todo
}
