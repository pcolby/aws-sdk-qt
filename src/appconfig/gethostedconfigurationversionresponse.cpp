...
#include "gethostedconfigurationversionresponse_p.h"
...
/*!
 * \class QtAws::AppConfig::GetHostedConfigurationVersionResponse
 * \brief The GetHostedConfigurationVersionResponse class provides an interace for AppConfig GetHostedConfigurationVersion responses.
 *
...
/*!
 * Constructs a GetHostedConfigurationVersionResponse object for \a reply to \a request, with parent \a parent.
 */
GetHostedConfigurationVersionResponse::GetHostedConfigurationVersionResponse(
        const GetHostedConfigurationVersionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AppConfigResponse(new GetHostedConfigurationVersionResponsePrivate(this), parent)
{
    setRequest(new GetHostedConfigurationVersionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetHostedConfigurationVersionRequest * GetHostedConfigurationVersionResponse::request() const
{
    Q_D(const GetHostedConfigurationVersionResponse);
    return static_cast<const GetHostedConfigurationVersionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful AppConfig GetHostedConfigurationVersion \a response.
 */
void GetHostedConfigurationVersionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetHostedConfigurationVersionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AppConfig::GetHostedConfigurationVersionResponsePrivate
 * \brief The GetHostedConfigurationVersionResponsePrivate class provides private implementation for GetHostedConfigurationVersionResponse.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a GetHostedConfigurationVersionResponsePrivate object with public implementation \a q.
 */
GetHostedConfigurationVersionResponsePrivate::GetHostedConfigurationVersionResponsePrivate(
    GetHostedConfigurationVersionResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig GetHostedConfigurationVersion response element from \a xml.
 */
void GetHostedConfigurationVersionResponsePrivate::parseGetHostedConfigurationVersionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetHostedConfigurationVersionResponse"));
    Q_UNUSED(xml) ///< @todo
}
