...
/*!
 * \class QtAws::AppConfig::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for AppConfig UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : AppConfigRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : AppConfigRequest(new UntagResourceRequestPrivate(AppConfigRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::AppConfig::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const AppConfigRequest::Action action, UntagResourceRequest * const q)
