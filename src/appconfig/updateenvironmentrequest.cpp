...
/*!
 * \class QtAws::AppConfig::UpdateEnvironmentRequest
 * \brief The UpdateEnvironmentRequest class provides an interface for AppConfig UpdateEnvironment requests.
 *
 ...
 *
 * \sa AppConfigClient::updateEnvironment
 */
...
UpdateEnvironmentRequest::UpdateEnvironmentRequest(const UpdateEnvironmentRequest &other)
    : AppConfigRequest(new UpdateEnvironmentRequestPrivate(*other.d_func(), this))
{
...
UpdateEnvironmentRequest::UpdateEnvironmentRequest()
    : AppConfigRequest(new UpdateEnvironmentRequestPrivate(AppConfigRequest::UpdateEnvironmentAction, this))
{
...
/*!
 * \class QtAws::AppConfig::UpdateEnvironmentRequestPrivate
...
/*!
 * Constructs a UpdateEnvironmentRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
UpdateEnvironmentRequestPrivate::UpdateEnvironmentRequestPrivate(
    const AppConfigRequest::Action action, UpdateEnvironmentRequest * const q)
