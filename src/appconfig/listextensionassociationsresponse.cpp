...
#include "listextensionassociationsresponse_p.h"
...
/*!
 * \class QtAws::AppConfig::ListExtensionAssociationsResponse
 * \brief The ListExtensionAssociationsResponse class provides an interace for AppConfig ListExtensionAssociations responses.
 *
...
/*!
 * Constructs a ListExtensionAssociationsResponse object for \a reply to \a request, with parent \a parent.
 */
ListExtensionAssociationsResponse::ListExtensionAssociationsResponse(
        const ListExtensionAssociationsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AppConfigResponse(new ListExtensionAssociationsResponsePrivate(this), parent)
{
    setRequest(new ListExtensionAssociationsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListExtensionAssociationsRequest * ListExtensionAssociationsResponse::request() const
{
    Q_D(const ListExtensionAssociationsResponse);
    return static_cast<const ListExtensionAssociationsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful AppConfig ListExtensionAssociations \a response.
 */
void ListExtensionAssociationsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListExtensionAssociationsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AppConfig::ListExtensionAssociationsResponsePrivate
 * \brief The ListExtensionAssociationsResponsePrivate class provides private implementation for ListExtensionAssociationsResponse.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a ListExtensionAssociationsResponsePrivate object with public implementation \a q.
 */
ListExtensionAssociationsResponsePrivate::ListExtensionAssociationsResponsePrivate(
    ListExtensionAssociationsResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig ListExtensionAssociations response element from \a xml.
 */
void ListExtensionAssociationsResponsePrivate::parseListExtensionAssociationsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListExtensionAssociationsResponse"));
    Q_UNUSED(xml) ///< @todo
}
