...
#include "deletehostedconfigurationversionrequest_p.h"
...
/*!
 * \class QtAws::AppConfig::DeleteHostedConfigurationVersionRequest
 * \brief The DeleteHostedConfigurationVersionRequest class provides an interface for AppConfig DeleteHostedConfigurationVersion requests.
 *
 ...
 */
DeleteHostedConfigurationVersionRequest::DeleteHostedConfigurationVersionRequest(const DeleteHostedConfigurationVersionRequest &other)
    : AppConfigRequest(new DeleteHostedConfigurationVersionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteHostedConfigurationVersionRequest object.
 */
DeleteHostedConfigurationVersionRequest::DeleteHostedConfigurationVersionRequest()
    : AppConfigRequest(new DeleteHostedConfigurationVersionRequestPrivate(AppConfigRequest::DeleteHostedConfigurationVersionAction, this))
{
 ...
 * \reimp
 */
bool DeleteHostedConfigurationVersionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteHostedConfigurationVersionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteHostedConfigurationVersionRequest::response(QNetworkReply * const reply) const
{
    return new DeleteHostedConfigurationVersionResponse(*this, reply);
}

/*!
 * \class QtAws::AppConfig::DeleteHostedConfigurationVersionRequestPrivate
 * \brief The DeleteHostedConfigurationVersionRequestPrivate class provides private implementation for DeleteHostedConfigurationVersionRequest.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a DeleteHostedConfigurationVersionRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
DeleteHostedConfigurationVersionRequestPrivate::DeleteHostedConfigurationVersionRequestPrivate(
    const AppConfigRequest::Action action, DeleteHostedConfigurationVersionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteHostedConfigurationVersionRequest
 * class' copy constructor.
 */
DeleteHostedConfigurationVersionRequestPrivate::DeleteHostedConfigurationVersionRequestPrivate(
    const DeleteHostedConfigurationVersionRequestPrivate &other, DeleteHostedConfigurationVersionRequest * const q)
