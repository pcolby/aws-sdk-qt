...
#include "validateconfigurationrequest_p.h"
...
/*!
 * \class QtAws::AppConfig::ValidateConfigurationRequest
 * \brief The ValidateConfigurationRequest class provides an interface for AppConfig ValidateConfiguration requests.
 *
 ...
 *
 * \sa AppConfigClient::validateConfiguration
 */

/*!
 * Constructs a copy of \a other.
 */
ValidateConfigurationRequest::ValidateConfigurationRequest(const ValidateConfigurationRequest &other)
    : AppConfigRequest(new ValidateConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ValidateConfigurationRequest object.
 */
ValidateConfigurationRequest::ValidateConfigurationRequest()
    : AppConfigRequest(new ValidateConfigurationRequestPrivate(AppConfigRequest::ValidateConfigurationAction, this))
{
 ...
 * \reimp
 */
bool ValidateConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ValidateConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ValidateConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new ValidateConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::AppConfig::ValidateConfigurationRequestPrivate
 * \brief The ValidateConfigurationRequestPrivate class provides private implementation for ValidateConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a ValidateConfigurationRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
ValidateConfigurationRequestPrivate::ValidateConfigurationRequestPrivate(
    const AppConfigRequest::Action action, ValidateConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ValidateConfigurationRequest
 * class' copy constructor.
 */
ValidateConfigurationRequestPrivate::ValidateConfigurationRequestPrivate(
    const ValidateConfigurationRequestPrivate &other, ValidateConfigurationRequest * const q)
