...
/*!
 * \class QtAws::AppConfig::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for AppConfig ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : AppConfigResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(AppConfigResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppConfig ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::AppConfig::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig ListTagsForResource response element from \a xml.
 */
