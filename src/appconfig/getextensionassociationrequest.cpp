...
#include "getextensionassociationrequest_p.h"
...
/*!
 * \class QtAws::AppConfig::GetExtensionAssociationRequest
 * \brief The GetExtensionAssociationRequest class provides an interface for AppConfig GetExtensionAssociation requests.
 *
 ...
 */
GetExtensionAssociationRequest::GetExtensionAssociationRequest(const GetExtensionAssociationRequest &other)
    : AppConfigRequest(new GetExtensionAssociationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetExtensionAssociationRequest object.
 */
GetExtensionAssociationRequest::GetExtensionAssociationRequest()
    : AppConfigRequest(new GetExtensionAssociationRequestPrivate(AppConfigRequest::GetExtensionAssociationAction, this))
{
 ...
 * \reimp
 */
bool GetExtensionAssociationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetExtensionAssociationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetExtensionAssociationRequest::response(QNetworkReply * const reply) const
{
    return new GetExtensionAssociationResponse(*this, reply);
}

/*!
 * \class QtAws::AppConfig::GetExtensionAssociationRequestPrivate
 * \brief The GetExtensionAssociationRequestPrivate class provides private implementation for GetExtensionAssociationRequest.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a GetExtensionAssociationRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
GetExtensionAssociationRequestPrivate::GetExtensionAssociationRequestPrivate(
    const AppConfigRequest::Action action, GetExtensionAssociationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetExtensionAssociationRequest
 * class' copy constructor.
 */
GetExtensionAssociationRequestPrivate::GetExtensionAssociationRequestPrivate(
    const GetExtensionAssociationRequestPrivate &other, GetExtensionAssociationRequest * const q)
