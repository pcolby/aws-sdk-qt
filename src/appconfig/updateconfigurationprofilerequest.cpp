...
#include "updateconfigurationprofilerequest_p.h"
...
/*!
 * \class QtAws::AppConfig::UpdateConfigurationProfileRequest
 * \brief The UpdateConfigurationProfileRequest class provides an interface for AppConfig UpdateConfigurationProfile requests.
 *
 ...
 */
UpdateConfigurationProfileRequest::UpdateConfigurationProfileRequest(const UpdateConfigurationProfileRequest &other)
    : AppConfigRequest(new UpdateConfigurationProfileRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateConfigurationProfileRequest object.
 */
UpdateConfigurationProfileRequest::UpdateConfigurationProfileRequest()
    : AppConfigRequest(new UpdateConfigurationProfileRequestPrivate(AppConfigRequest::UpdateConfigurationProfileAction, this))
{
 ...
 * \reimp
 */
bool UpdateConfigurationProfileRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateConfigurationProfileResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateConfigurationProfileRequest::response(QNetworkReply * const reply) const
{
    return new UpdateConfigurationProfileResponse(*this, reply);
}

/*!
 * \class QtAws::AppConfig::UpdateConfigurationProfileRequestPrivate
 * \brief The UpdateConfigurationProfileRequestPrivate class provides private implementation for UpdateConfigurationProfileRequest.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a UpdateConfigurationProfileRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
UpdateConfigurationProfileRequestPrivate::UpdateConfigurationProfileRequestPrivate(
    const AppConfigRequest::Action action, UpdateConfigurationProfileRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateConfigurationProfileRequest
 * class' copy constructor.
 */
UpdateConfigurationProfileRequestPrivate::UpdateConfigurationProfileRequestPrivate(
    const UpdateConfigurationProfileRequestPrivate &other, UpdateConfigurationProfileRequest * const q)
