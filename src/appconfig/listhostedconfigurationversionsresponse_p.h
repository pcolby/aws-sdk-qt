...
class QTAWS_EXPORT ListHostedConfigurationVersionsResponsePrivate : public AppConfigResponsePrivate {

public:

    ListHostedConfigurationVersionsResponsePrivate(ListHostedConfigurationVersionsResponse * const q);
