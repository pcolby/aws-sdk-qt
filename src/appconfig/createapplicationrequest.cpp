...
/*!
 * \class QtAws::AppConfig::CreateApplicationRequest
 * \brief The CreateApplicationRequest class provides an interface for AppConfig CreateApplication requests.
 *
...
CreateApplicationRequest::CreateApplicationRequest(const CreateApplicationRequest &other)
    : AppConfigRequest(new CreateApplicationRequestPrivate(*other.d_func(), this))
{
...
CreateApplicationRequest::CreateApplicationRequest()
    : AppConfigRequest(new CreateApplicationRequestPrivate(AppConfigRequest::CreateApplicationAction, this))
{
...
/*!
 * \class QtAws::AppConfig::CreateApplicationRequestPrivate
...
/*!
 * Constructs a CreateApplicationRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
CreateApplicationRequestPrivate::CreateApplicationRequestPrivate(
    const AppConfigRequest::Action action, CreateApplicationRequest * const q)
