...
/*!
 * \class QtAws::AppConfig::UpdateEnvironmentResponse
 * \brief The UpdateEnvironmentResponse class provides an interace for AppConfig UpdateEnvironment responses.
 *
...
UpdateEnvironmentResponse::UpdateEnvironmentResponse(
    ...
    : AppConfigResponse(new UpdateEnvironmentResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful AppConfig UpdateEnvironment \a response.
 */
...
/*!
 * \class QtAws::AppConfig::UpdateEnvironmentResponsePrivate
...
UpdateEnvironmentResponsePrivate::UpdateEnvironmentResponsePrivate(
    UpdateEnvironmentResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig UpdateEnvironment response element from \a xml.
 */
