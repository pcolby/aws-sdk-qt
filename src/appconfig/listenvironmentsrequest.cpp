...
/*!
 * \class QtAws::AppConfig::ListEnvironmentsRequest
 * \brief The ListEnvironmentsRequest class provides an interface for AppConfig ListEnvironments requests.
 *
...
ListEnvironmentsRequest::ListEnvironmentsRequest(const ListEnvironmentsRequest &other)
    : AppConfigRequest(new ListEnvironmentsRequestPrivate(*other.d_func(), this))
{
...
ListEnvironmentsRequest::ListEnvironmentsRequest()
    : AppConfigRequest(new ListEnvironmentsRequestPrivate(AppConfigRequest::ListEnvironmentsAction, this))
{
...
/*!
 * \class QtAws::AppConfig::ListEnvironmentsRequestPrivate
...
/*!
 * Constructs a ListEnvironmentsRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
ListEnvironmentsRequestPrivate::ListEnvironmentsRequestPrivate(
    const AppConfigRequest::Action action, ListEnvironmentsRequest * const q)
