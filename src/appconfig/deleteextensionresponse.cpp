...
#include "deleteextensionresponse_p.h"
...
/*!
 * \class QtAws::AppConfig::DeleteExtensionResponse
 * \brief The DeleteExtensionResponse class provides an interace for AppConfig DeleteExtension responses.
 *
...
/*!
 * Constructs a DeleteExtensionResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteExtensionResponse::DeleteExtensionResponse(
        const DeleteExtensionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AppConfigResponse(new DeleteExtensionResponsePrivate(this), parent)
{
    setRequest(new DeleteExtensionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteExtensionRequest * DeleteExtensionResponse::request() const
{
    Q_D(const DeleteExtensionResponse);
    return static_cast<const DeleteExtensionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful AppConfig DeleteExtension \a response.
 */
void DeleteExtensionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteExtensionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AppConfig::DeleteExtensionResponsePrivate
 * \brief The DeleteExtensionResponsePrivate class provides private implementation for DeleteExtensionResponse.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a DeleteExtensionResponsePrivate object with public implementation \a q.
 */
DeleteExtensionResponsePrivate::DeleteExtensionResponsePrivate(
    DeleteExtensionResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig DeleteExtension response element from \a xml.
 */
void DeleteExtensionResponsePrivate::parseDeleteExtensionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteExtensionResponse"));
    Q_UNUSED(xml) ///< @todo
}
