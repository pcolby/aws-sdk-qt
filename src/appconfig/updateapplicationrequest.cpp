...
/*!
 * \class QtAws::AppConfig::UpdateApplicationRequest
 * \brief The UpdateApplicationRequest class provides an interface for AppConfig UpdateApplication requests.
 *
...
UpdateApplicationRequest::UpdateApplicationRequest(const UpdateApplicationRequest &other)
    : AppConfigRequest(new UpdateApplicationRequestPrivate(*other.d_func(), this))
{
...
UpdateApplicationRequest::UpdateApplicationRequest()
    : AppConfigRequest(new UpdateApplicationRequestPrivate(AppConfigRequest::UpdateApplicationAction, this))
{
...
/*!
 * \class QtAws::AppConfig::UpdateApplicationRequestPrivate
...
/*!
 * Constructs a UpdateApplicationRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
UpdateApplicationRequestPrivate::UpdateApplicationRequestPrivate(
    const AppConfigRequest::Action action, UpdateApplicationRequest * const q)
