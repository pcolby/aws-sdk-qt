...
#include "updateextensionresponse_p.h"
...
/*!
 * \class QtAws::AppConfig::UpdateExtensionResponse
 * \brief The UpdateExtensionResponse class provides an interace for AppConfig UpdateExtension responses.
 *
...
/*!
 * Constructs a UpdateExtensionResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateExtensionResponse::UpdateExtensionResponse(
        const UpdateExtensionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AppConfigResponse(new UpdateExtensionResponsePrivate(this), parent)
{
    setRequest(new UpdateExtensionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateExtensionRequest * UpdateExtensionResponse::request() const
{
    Q_D(const UpdateExtensionResponse);
    return static_cast<const UpdateExtensionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful AppConfig UpdateExtension \a response.
 */
void UpdateExtensionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateExtensionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AppConfig::UpdateExtensionResponsePrivate
 * \brief The UpdateExtensionResponsePrivate class provides private implementation for UpdateExtensionResponse.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a UpdateExtensionResponsePrivate object with public implementation \a q.
 */
UpdateExtensionResponsePrivate::UpdateExtensionResponsePrivate(
    UpdateExtensionResponse * const q) : AppConfigResponsePrivate(q)
{

}

/*!
 * Parses a AppConfig UpdateExtension response element from \a xml.
 */
void UpdateExtensionResponsePrivate::parseUpdateExtensionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateExtensionResponse"));
    Q_UNUSED(xml) ///< @todo
}
