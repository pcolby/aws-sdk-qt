...
#include "listhostedconfigurationversionsrequest_p.h"
...
/*!
 * \class QtAws::AppConfig::ListHostedConfigurationVersionsRequest
 * \brief The ListHostedConfigurationVersionsRequest class provides an interface for AppConfig ListHostedConfigurationVersions requests.
 *
 ...
 */
ListHostedConfigurationVersionsRequest::ListHostedConfigurationVersionsRequest(const ListHostedConfigurationVersionsRequest &other)
    : AppConfigRequest(new ListHostedConfigurationVersionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListHostedConfigurationVersionsRequest object.
 */
ListHostedConfigurationVersionsRequest::ListHostedConfigurationVersionsRequest()
    : AppConfigRequest(new ListHostedConfigurationVersionsRequestPrivate(AppConfigRequest::ListHostedConfigurationVersionsAction, this))
{
 ...
 * \reimp
 */
bool ListHostedConfigurationVersionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListHostedConfigurationVersionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListHostedConfigurationVersionsRequest::response(QNetworkReply * const reply) const
{
    return new ListHostedConfigurationVersionsResponse(*this, reply);
}

/*!
 * \class QtAws::AppConfig::ListHostedConfigurationVersionsRequestPrivate
 * \brief The ListHostedConfigurationVersionsRequestPrivate class provides private implementation for ListHostedConfigurationVersionsRequest.
 * \internal
 *
 * \inmodule QtAwsAppConfig
 */
...
/*!
 * Constructs a ListHostedConfigurationVersionsRequestPrivate object for AppConfig \a action,
 * with public implementation \a q.
 */
ListHostedConfigurationVersionsRequestPrivate::ListHostedConfigurationVersionsRequestPrivate(
    const AppConfigRequest::Action action, ListHostedConfigurationVersionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListHostedConfigurationVersionsRequest
 * class' copy constructor.
 */
ListHostedConfigurationVersionsRequestPrivate::ListHostedConfigurationVersionsRequestPrivate(
    const ListHostedConfigurationVersionsRequestPrivate &other, ListHostedConfigurationVersionsRequest * const q)
