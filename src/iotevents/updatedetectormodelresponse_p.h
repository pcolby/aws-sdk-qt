...
class QTAWS_EXPORT UpdateDetectorModelResponsePrivate : public IoTEventsResponsePrivate {

public:

    UpdateDetectorModelResponsePrivate(UpdateDetectorModelResponse * const q);
