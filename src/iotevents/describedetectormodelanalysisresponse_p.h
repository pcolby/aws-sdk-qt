...
class QTAWS_EXPORT DescribeDetectorModelAnalysisResponsePrivate : public IoTEventsResponsePrivate {

public:

    DescribeDetectorModelAnalysisResponsePrivate(DescribeDetectorModelAnalysisResponse * const q);
