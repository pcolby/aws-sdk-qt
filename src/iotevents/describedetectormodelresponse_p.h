...
class QTAWS_EXPORT DescribeDetectorModelResponsePrivate : public IoTEventsResponsePrivate {

public:

    DescribeDetectorModelResponsePrivate(DescribeDetectorModelResponse * const q);
