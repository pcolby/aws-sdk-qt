...
class QTAWS_EXPORT DescribeAlarmModelResponsePrivate : public IoTEventsResponsePrivate {

public:

    DescribeAlarmModelResponsePrivate(DescribeAlarmModelResponse * const q);
