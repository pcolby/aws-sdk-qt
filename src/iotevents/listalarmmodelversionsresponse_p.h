...
class QTAWS_EXPORT ListAlarmModelVersionsResponsePrivate : public IoTEventsResponsePrivate {

public:

    ListAlarmModelVersionsResponsePrivate(ListAlarmModelVersionsResponse * const q);
