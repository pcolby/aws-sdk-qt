...
/*!
 * \class QtAws::IoTEvents::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for IoTEvents UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : IoTEventsResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IoTEvents UntagResource \a response.
 */
...
/*!
 * \class QtAws::IoTEvents::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : IoTEventsResponsePrivate(q)
{

}

/*!
 * Parses a IoTEvents UntagResource response element from \a xml.
 */
