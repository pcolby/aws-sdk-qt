...
class QTAWS_EXPORT ListDominantLanguageDetectionJobsResponse : public ComprehendResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListDominantLanguageDetectionJobsRequest * request() const override;
