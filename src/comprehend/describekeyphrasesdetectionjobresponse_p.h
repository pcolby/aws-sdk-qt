...
class QTAWS_EXPORT DescribeKeyPhrasesDetectionJobResponsePrivate : public ComprehendResponsePrivate {

public:

    DescribeKeyPhrasesDetectionJobResponsePrivate(DescribeKeyPhrasesDetectionJobResponse * const q);
