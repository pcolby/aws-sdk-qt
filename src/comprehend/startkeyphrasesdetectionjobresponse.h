...
class QTAWS_EXPORT StartKeyPhrasesDetectionJobResponse : public ComprehendResponse {
    Q_OBJECT
...
public:
    ...
    virtual const StartKeyPhrasesDetectionJobRequest * request() const override;
