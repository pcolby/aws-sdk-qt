...
class QTAWS_EXPORT StartPiiEntitiesDetectionJobResponsePrivate : public ComprehendResponsePrivate {

public:

    StartPiiEntitiesDetectionJobResponsePrivate(StartPiiEntitiesDetectionJobResponse * const q);
