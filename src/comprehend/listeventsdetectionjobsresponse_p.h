...
class QTAWS_EXPORT ListEventsDetectionJobsResponsePrivate : public ComprehendResponsePrivate {

public:

    ListEventsDetectionJobsResponsePrivate(ListEventsDetectionJobsResponse * const q);
