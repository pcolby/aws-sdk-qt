...
/*!
 * \class QtAws::Comprehend::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Comprehend TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ComprehendResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(ComprehendResponse::request());
}

/*!
 * \reimp
 * Parses a successful Comprehend TagResource \a response.
 */
...
/*!
 * \class QtAws::Comprehend::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ComprehendResponsePrivate(q)
{

}

/*!
 * Parses a Comprehend TagResource response element from \a xml.
 */
