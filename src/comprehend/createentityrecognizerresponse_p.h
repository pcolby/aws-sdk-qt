...
class QTAWS_EXPORT CreateEntityRecognizerResponsePrivate : public ComprehendResponsePrivate {

public:

    CreateEntityRecognizerResponsePrivate(CreateEntityRecognizerResponse * const q);
