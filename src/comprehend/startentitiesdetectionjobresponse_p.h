...
class QTAWS_EXPORT StartEntitiesDetectionJobResponsePrivate : public ComprehendResponsePrivate {

public:

    StartEntitiesDetectionJobResponsePrivate(StartEntitiesDetectionJobResponse * const q);
