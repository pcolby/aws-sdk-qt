...
class QTAWS_EXPORT StopPiiEntitiesDetectionJobResponsePrivate : public ComprehendResponsePrivate {

public:

    StopPiiEntitiesDetectionJobResponsePrivate(StopPiiEntitiesDetectionJobResponse * const q);
