...
class QTAWS_EXPORT DescribeEntitiesDetectionJobResponsePrivate : public ComprehendResponsePrivate {

public:

    DescribeEntitiesDetectionJobResponsePrivate(DescribeEntitiesDetectionJobResponse * const q);
