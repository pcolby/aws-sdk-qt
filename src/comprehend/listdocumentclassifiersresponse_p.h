...
class QTAWS_EXPORT ListDocumentClassifiersResponsePrivate : public ComprehendResponsePrivate {

public:

    ListDocumentClassifiersResponsePrivate(ListDocumentClassifiersResponse * const q);
