...
class QTAWS_EXPORT DescribePiiEntitiesDetectionJobResponsePrivate : public ComprehendResponsePrivate {

public:

    DescribePiiEntitiesDetectionJobResponsePrivate(DescribePiiEntitiesDetectionJobResponse * const q);
