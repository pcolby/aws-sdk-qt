...
class QTAWS_EXPORT DescribeDocumentClassificationJobResponsePrivate : public ComprehendResponsePrivate {

public:

    DescribeDocumentClassificationJobResponsePrivate(DescribeDocumentClassificationJobResponse * const q);
