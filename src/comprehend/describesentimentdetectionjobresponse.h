...
class QTAWS_EXPORT DescribeSentimentDetectionJobResponse : public ComprehendResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeSentimentDetectionJobRequest * request() const override;
