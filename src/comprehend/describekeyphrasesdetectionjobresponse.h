...
class QTAWS_EXPORT DescribeKeyPhrasesDetectionJobResponse : public ComprehendResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeKeyPhrasesDetectionJobRequest * request() const override;
