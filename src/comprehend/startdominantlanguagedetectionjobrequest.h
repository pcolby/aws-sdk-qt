...
#ifndef QTAWS_STARTDOMINANTLANGUAGEDETECTIONJOBREQUEST_H
#define QTAWS_STARTDOMINANTLANGUAGEDETECTIONJOBREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(StartDominantLanguageDetectionJobRequest)
