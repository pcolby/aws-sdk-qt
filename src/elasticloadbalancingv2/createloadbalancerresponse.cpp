 ...
 *
 * \brief The CreateLoadBalancerResponse class encapsulates ElasticLoadBalancingv2 CreateLoadBalancer responses.
 *
 ...
 *  operation, it
 *
 * \sa ElasticLoadBalancingv2Client::createLoadBalancer
 */
...
CreateLoadBalancerResponse::CreateLoadBalancerResponse(
    ...
    : ElasticLoadBalancingv2Response(new CreateLoadBalancerResponsePrivate(this), parent)
{
