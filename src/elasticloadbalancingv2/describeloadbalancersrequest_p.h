...
class QTAWS_EXPORT DescribeLoadBalancersRequestPrivate : public ElasticLoadBalancingv2RequestPrivate {

public:
    DescribeLoadBalancersRequestPrivate(const ElasticLoadBalancingv2::Action action,
