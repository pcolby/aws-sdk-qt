...
class QTAWS_EXPORT DescribeLoadBalancerAttributesResponse : public ElasticLoadBalancingv2Response {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeLoadBalancerAttributesRequest * request() const override;
