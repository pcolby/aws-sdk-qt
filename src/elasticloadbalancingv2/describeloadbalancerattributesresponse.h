...
class QTAWS_EXPORT DescribeLoadBalancerAttributesResponse : public DescribeLoadBalancerAttributesResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeLoadBalancerAttributesRequest * request() const;
