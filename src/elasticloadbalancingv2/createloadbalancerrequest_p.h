...
class QTAWS_EXPORT CreateLoadBalancerRequestPrivate : public ElasticLoadBalancingv2RequestPrivate {

public:
    CreateLoadBalancerRequestPrivate(const ElasticLoadBalancingv2::Action action,
