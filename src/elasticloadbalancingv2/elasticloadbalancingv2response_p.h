...
class QTAWS_EXPORT ElasticLoadBalancingv2ResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {

public:

    ElasticLoadBalancingv2ResponsePrivate(ElasticLoadBalancingv2Response * const q);
