...
public:
    ...
    ElasticLoadBalancingv2ClientResponsePrivate(ElasticLoadBalancingv2ClientResponse * const q);

    void parseResponse(QXmlStreamReader &xml);

private:
    Q_DECLARE_PUBLIC(ElasticLoadBalancingv2ClientResponse)
    Q_DISABLE_COPY(ElasticLoadBalancingv2ClientResponsePrivate)
