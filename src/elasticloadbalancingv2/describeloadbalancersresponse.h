...
class QTAWS_EXPORT DescribeLoadBalancersResponse : public ElasticLoadBalancingv2Response {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeLoadBalancersRequest * request() const override;
