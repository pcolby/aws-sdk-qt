...
class QTAWS_EXPORT ModifyLoadBalancerAttributesResponse : public ElasticLoadBalancingv2Response {
    Q_OBJECT
...
public:
    ...
    virtual const ModifyLoadBalancerAttributesRequest * request() const override;
