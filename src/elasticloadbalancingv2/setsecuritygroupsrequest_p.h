...
class QTAWS_EXPORT SetSecurityGroupsRequestPrivate : public ElasticLoadBalancingv2Private {

public:
    SetSecurityGroupsRequestPrivate(const ElasticLoadBalancingv2::Action action,
