...
class QTAWS_EXPORT CreateLoadBalancerResponsePrivate : public ElasticLoadBalancingv2ResponsePrivate {
    Q_OBJECT

public:

    CreateLoadBalancerResponsePrivate(CreateLoadBalancerResponse * const q);
