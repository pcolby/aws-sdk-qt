...
class QTAWSSIMPLEDB_EXPORT BatchDeleteAttributesResponse : public SimpleDBResponse {
    Q_OBJECT
...
public:
    ...
    virtual const BatchDeleteAttributesRequest * request() const Q_DECL_OVERRIDE;
