...
/*!
 * \class QtAws::Lightsail::GetDiskRequest
 * \brief The GetDiskRequest class provides an interface for Lightsail GetDisk requests.
 *
...
/*!
 * Constructs a GetDiskRequest object.
 */
...
/*!
 * Returns a GetDiskResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetDiskRequest::response(QNetworkReply * const reply) const
{
    return new GetDiskResponse(*this, reply);
}

/*!
 * \class QtAws::Lightsail::GetDiskRequestPrivate
 * \brief The GetDiskRequestPrivate class provides private implementation for GetDiskRequest.
 * \internal
 *
 * \inmodule QtAwsLightsail
 */
...
/*!
 *
 * Constructs a GetDiskRequestPrivate object for Lightsail \a action with,
