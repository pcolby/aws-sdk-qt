...
class QTAWS_EXPORT UpdateRelationalDatabaseResponsePrivate : public LightsailResponsePrivate {

public:

    UpdateRelationalDatabaseResponsePrivate(UpdateRelationalDatabaseResponse * const q);
