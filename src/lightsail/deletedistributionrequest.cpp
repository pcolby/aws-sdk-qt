...
/*!
 * \class QtAws::Lightsail::DeleteDistributionRequest
 * \brief The DeleteDistributionRequest class provides an interface for Lightsail DeleteDistribution requests.
 *
...
DeleteDistributionRequest::DeleteDistributionRequest(const DeleteDistributionRequest &other)
    : LightsailRequest(new DeleteDistributionRequestPrivate(*other.d_func(), this))
{
...
DeleteDistributionRequest::DeleteDistributionRequest()
    : LightsailRequest(new DeleteDistributionRequestPrivate(LightsailRequest::DeleteDistributionAction, this))
{
...
/*!
 * \class QtAws::Lightsail::DeleteDistributionRequestPrivate
...
/*!
 * Constructs a DeleteDistributionRequestPrivate object for Lightsail \a action,
 * with public implementation \a q.
 */
DeleteDistributionRequestPrivate::DeleteDistributionRequestPrivate(
    const LightsailRequest::Action action, DeleteDistributionRequest * const q)
