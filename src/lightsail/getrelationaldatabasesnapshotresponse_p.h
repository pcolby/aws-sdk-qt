...
class QTAWS_EXPORT GetRelationalDatabaseSnapshotResponsePrivate : public LightsailResponsePrivate {

public:

    GetRelationalDatabaseSnapshotResponsePrivate(GetRelationalDatabaseSnapshotResponse * const q);
