...
class QTAWS_EXPORT GetRelationalDatabaseLogStreamsResponsePrivate : public LightsailResponsePrivate {

public:

    GetRelationalDatabaseLogStreamsResponsePrivate(GetRelationalDatabaseLogStreamsResponse * const q);
