...
class QTAWS_EXPORT CreateDiskFromSnapshotResponsePrivate : public LightsailResponsePrivate {

public:

    CreateDiskFromSnapshotResponsePrivate(CreateDiskFromSnapshotResponse * const q);
