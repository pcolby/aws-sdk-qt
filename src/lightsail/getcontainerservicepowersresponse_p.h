...
class QTAWS_EXPORT GetContainerServicePowersResponsePrivate : public LightsailResponsePrivate {

public:

    GetContainerServicePowersResponsePrivate(GetContainerServicePowersResponse * const q);
