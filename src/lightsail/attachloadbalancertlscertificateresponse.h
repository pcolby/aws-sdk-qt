...
class QTAWS_EXPORT AttachLoadBalancerTlsCertificateResponse : public LightsailResponse {
    Q_OBJECT
...
public:
    ...
    virtual const AttachLoadBalancerTlsCertificateRequest * request() const override;
