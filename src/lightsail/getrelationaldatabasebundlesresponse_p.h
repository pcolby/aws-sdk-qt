...
class QTAWS_EXPORT GetRelationalDatabaseBundlesResponsePrivate : public LightsailResponsePrivate {

public:

    GetRelationalDatabaseBundlesResponsePrivate(GetRelationalDatabaseBundlesResponse * const q);
