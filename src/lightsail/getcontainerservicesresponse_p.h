...
class QTAWS_EXPORT GetContainerServicesResponsePrivate : public LightsailResponsePrivate {

public:

    GetContainerServicesResponsePrivate(GetContainerServicesResponse * const q);
