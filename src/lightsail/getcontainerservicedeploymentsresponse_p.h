...
class QTAWS_EXPORT GetContainerServiceDeploymentsResponsePrivate : public LightsailResponsePrivate {

public:

    GetContainerServiceDeploymentsResponsePrivate(GetContainerServiceDeploymentsResponse * const q);
