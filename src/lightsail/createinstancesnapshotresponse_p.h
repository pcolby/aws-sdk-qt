...
class QTAWS_EXPORT CreateInstanceSnapshotResponsePrivate : public LightsailResponsePrivate {

public:

    CreateInstanceSnapshotResponsePrivate(CreateInstanceSnapshotResponse * const q);
