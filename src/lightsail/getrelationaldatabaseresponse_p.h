...
class QTAWS_EXPORT GetRelationalDatabaseResponsePrivate : public LightsailResponsePrivate {

public:

    GetRelationalDatabaseResponsePrivate(GetRelationalDatabaseResponse * const q);
