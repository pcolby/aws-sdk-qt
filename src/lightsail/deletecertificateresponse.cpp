...
/*!
 * \class QtAws::Lightsail::DeleteCertificateResponse
 * \brief The DeleteCertificateResponse class provides an interace for Lightsail DeleteCertificate responses.
 *
...
DeleteCertificateResponse::DeleteCertificateResponse(
    ...
    : LightsailResponse(new DeleteCertificateResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteCertificateRequest *>(LightsailResponse::request());
}

/*!
 * \reimp
 * Parses a successful Lightsail DeleteCertificate \a response.
 */
...
/*!
 * \class QtAws::Lightsail::DeleteCertificateResponsePrivate
...
DeleteCertificateResponsePrivate::DeleteCertificateResponsePrivate(
    DeleteCertificateResponse * const q) : LightsailResponsePrivate(q)
{

}

/*!
 * Parses a Lightsail DeleteCertificate response element from \a xml.
 */
