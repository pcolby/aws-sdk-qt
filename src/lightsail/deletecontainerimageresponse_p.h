...
class QTAWS_EXPORT DeleteContainerImageResponsePrivate : public LightsailResponsePrivate {

public:

    DeleteContainerImageResponsePrivate(DeleteContainerImageResponse * const q);
