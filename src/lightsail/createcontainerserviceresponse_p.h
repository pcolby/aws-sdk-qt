...
class QTAWS_EXPORT CreateContainerServiceResponsePrivate : public LightsailResponsePrivate {

public:

    CreateContainerServiceResponsePrivate(CreateContainerServiceResponse * const q);
