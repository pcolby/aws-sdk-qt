...
class QTAWS_EXPORT GetContainerServiceMetricDataResponsePrivate : public LightsailResponsePrivate {

public:

    GetContainerServiceMetricDataResponsePrivate(GetContainerServiceMetricDataResponse * const q);
