...
/*!
 * \class QtAws::Lightsail::CopySnapshotResponse
 * \brief The CopySnapshotResponse class provides an interace for Lightsail CopySnapshot responses.
 *
...
CopySnapshotResponse::CopySnapshotResponse(
    ...
    : LightsailResponse(new CopySnapshotResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Lightsail CopySnapshot \a response.
 */
...
/*!
 * \class QtAws::Lightsail::CopySnapshotResponsePrivate
...
CopySnapshotResponsePrivate::CopySnapshotResponsePrivate(
    CopySnapshotResponse * const q) : LightsailResponsePrivate(q)
{

}

/*!
 * Parses a Lightsail CopySnapshot response element from \a xml.
 */
