...
class QTAWS_EXPORT DeleteRelationalDatabaseResponsePrivate : public LightsailResponsePrivate {

public:

    DeleteRelationalDatabaseResponsePrivate(DeleteRelationalDatabaseResponse * const q);
