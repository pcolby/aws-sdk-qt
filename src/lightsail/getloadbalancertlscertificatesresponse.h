...
class QTAWS_EXPORT GetLoadBalancerTlsCertificatesResponse : public LightsailResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GetLoadBalancerTlsCertificatesRequest * request() const override;
