...
class QTAWS_EXPORT CreateRelationalDatabaseResponsePrivate : public LightsailResponsePrivate {

public:

    CreateRelationalDatabaseResponsePrivate(CreateRelationalDatabaseResponse * const q);
