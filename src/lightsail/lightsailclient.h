...
public slots:
    ...
    CreateBucketAccessKeyResponse * createBucketAccessKey(const CreateBucketAccessKeyRequest &request);
    ...
    DeleteBucketAccessKeyResponse * deleteBucketAccessKey(const DeleteBucketAccessKeyRequest &request);
    ...
    GetBucketAccessKeysResponse * getBucketAccessKeys(const GetBucketAccessKeysRequest &request);
    GetBucketBundlesResponse * getBucketBundles(const GetBucketBundlesRequest &request);
    GetBucketMetricDataResponse * getBucketMetricData(const GetBucketMetricDataRequest &request);
    GetBucketsResponse * getBuckets(const GetBucketsRequest &request);
    ...
    GetLoadBalancerTlsPoliciesResponse * getLoadBalancerTlsPolicies(const GetLoadBalancerTlsPoliciesRequest &request);
    ...
    SetResourceAccessForBucketResponse * setResourceAccessForBucket(const SetResourceAccessForBucketRequest &request);
    ...
    UpdateBucketResponse * updateBucket(const UpdateBucketRequest &request);
    UpdateBucketBundleResponse * updateBucketBundle(const UpdateBucketBundleRequest &request);
