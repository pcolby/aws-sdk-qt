...
/*!
 * \class QtAws::Lightsail::CreateBucketRequest
 * \brief The CreateBucketRequest class provides an interface for Lightsail CreateBucket requests.
 *
...
CreateBucketRequest::CreateBucketRequest(const CreateBucketRequest &other)
    : LightsailRequest(new CreateBucketRequestPrivate(*other.d_func(), this))
{
...
CreateBucketRequest::CreateBucketRequest()
    : LightsailRequest(new CreateBucketRequestPrivate(LightsailRequest::CreateBucketAction, this))
{
...
/*!
 * \class QtAws::Lightsail::CreateBucketRequestPrivate
...
/*!
 * Constructs a CreateBucketRequestPrivate object for Lightsail \a action,
 * with public implementation \a q.
 */
CreateBucketRequestPrivate::CreateBucketRequestPrivate(
    const LightsailRequest::Action action, CreateBucketRequest * const q)
