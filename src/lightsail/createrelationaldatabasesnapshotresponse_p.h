...
class QTAWS_EXPORT CreateRelationalDatabaseSnapshotResponsePrivate : public LightsailResponsePrivate {

public:

    CreateRelationalDatabaseSnapshotResponsePrivate(CreateRelationalDatabaseSnapshotResponse * const q);
