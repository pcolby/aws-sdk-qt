...
class QTAWS_EXPORT GetRelationalDatabasesResponsePrivate : public LightsailResponsePrivate {

public:

    GetRelationalDatabasesResponsePrivate(GetRelationalDatabasesResponse * const q);
