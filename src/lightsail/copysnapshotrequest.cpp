...
/*!
 * \class QtAws::Lightsail::CopySnapshotRequest
 * \brief The CopySnapshotRequest class provides an interface for Lightsail CopySnapshot requests.
 *
 ...
 *
 * \sa LightsailClient::copySnapshot
 */
...
CopySnapshotRequest::CopySnapshotRequest(const CopySnapshotRequest &other)
    : LightsailRequest(new CopySnapshotRequestPrivate(*other.d_func(), this))
{
...
CopySnapshotRequest::CopySnapshotRequest()
    : LightsailRequest(new CopySnapshotRequestPrivate(LightsailRequest::CopySnapshotAction, this))
{
...
/*!
 * \class QtAws::Lightsail::CopySnapshotRequestPrivate
...
/*!
 * Constructs a CopySnapshotRequestPrivate object for Lightsail \a action,
 * with public implementation \a q.
 */
CopySnapshotRequestPrivate::CopySnapshotRequestPrivate(
    const LightsailRequest::Action action, CopySnapshotRequest * const q)
