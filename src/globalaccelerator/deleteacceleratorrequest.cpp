...
#include "deleteacceleratorrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DeleteAcceleratorRequest
 * \brief The DeleteAcceleratorRequest class provides an interface for GlobalAccelerator DeleteAccelerator requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::deleteAccelerator
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteAcceleratorRequest::DeleteAcceleratorRequest(const DeleteAcceleratorRequest &other)
    : GlobalAcceleratorRequest(new DeleteAcceleratorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteAcceleratorRequest object.
 */
DeleteAcceleratorRequest::DeleteAcceleratorRequest()
    : GlobalAcceleratorRequest(new DeleteAcceleratorRequestPrivate(GlobalAcceleratorRequest::DeleteAcceleratorAction, this))
{
 ...
 * \reimp
 */
bool DeleteAcceleratorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteAcceleratorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteAcceleratorRequest::response(QNetworkReply * const reply) const
{
    return new DeleteAcceleratorResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::DeleteAcceleratorRequestPrivate
 * \brief The DeleteAcceleratorRequestPrivate class provides private implementation for DeleteAcceleratorRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DeleteAcceleratorRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
DeleteAcceleratorRequestPrivate::DeleteAcceleratorRequestPrivate(
    const GlobalAcceleratorRequest::Action action, DeleteAcceleratorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteAcceleratorRequest
 * class' copy constructor.
 */
DeleteAcceleratorRequestPrivate::DeleteAcceleratorRequestPrivate(
    const DeleteAcceleratorRequestPrivate &other, DeleteAcceleratorRequest * const q)
