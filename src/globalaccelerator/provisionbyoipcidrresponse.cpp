...
/*!
 * \class QtAws::GlobalAccelerator::ProvisionByoipCidrResponse
 * \brief The ProvisionByoipCidrResponse class provides an interace for GlobalAccelerator ProvisionByoipCidr responses.
 *
...
ProvisionByoipCidrResponse::ProvisionByoipCidrResponse(
    ...
    : GlobalAcceleratorResponse(new ProvisionByoipCidrResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator ProvisionByoipCidr \a response.
 */
...
/*!
 * \class QtAws::GlobalAccelerator::ProvisionByoipCidrResponsePrivate
...
ProvisionByoipCidrResponsePrivate::ProvisionByoipCidrResponsePrivate(
    ProvisionByoipCidrResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator ProvisionByoipCidr response element from \a xml.
 */
