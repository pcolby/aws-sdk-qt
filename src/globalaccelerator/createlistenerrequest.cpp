...
/*!
 * \class QtAws::GlobalAccelerator::CreateListenerRequest
 * \brief The CreateListenerRequest class provides an interface for GlobalAccelerator CreateListener requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::createListener
 */
...
CreateListenerRequest::CreateListenerRequest(const CreateListenerRequest &other)
    : GlobalAcceleratorRequest(new CreateListenerRequestPrivate(*other.d_func(), this))
{
...
CreateListenerRequest::CreateListenerRequest()
    : GlobalAcceleratorRequest(new CreateListenerRequestPrivate(GlobalAcceleratorRequest::CreateListenerAction, this))
{
...
/*!
 * \class QtAws::GlobalAccelerator::CreateListenerRequestPrivate
...
/*!
 * Constructs a CreateListenerRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
CreateListenerRequestPrivate::CreateListenerRequestPrivate(
    const GlobalAcceleratorRequest::Action action, CreateListenerRequest * const q)
