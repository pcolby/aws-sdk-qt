...
#include "listendpointgroupsrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListEndpointGroupsRequest
 * \brief The ListEndpointGroupsRequest class provides an interface for GlobalAccelerator ListEndpointGroups requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::listEndpointGroups
 */

/*!
 * Constructs a copy of \a other.
 */
ListEndpointGroupsRequest::ListEndpointGroupsRequest(const ListEndpointGroupsRequest &other)
    : GlobalAcceleratorRequest(new ListEndpointGroupsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListEndpointGroupsRequest object.
 */
ListEndpointGroupsRequest::ListEndpointGroupsRequest()
    : GlobalAcceleratorRequest(new ListEndpointGroupsRequestPrivate(GlobalAcceleratorRequest::ListEndpointGroupsAction, this))
{
 ...
 * \reimp
 */
bool ListEndpointGroupsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListEndpointGroupsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListEndpointGroupsRequest::response(QNetworkReply * const reply) const
{
    return new ListEndpointGroupsResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::ListEndpointGroupsRequestPrivate
 * \brief The ListEndpointGroupsRequestPrivate class provides private implementation for ListEndpointGroupsRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListEndpointGroupsRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
ListEndpointGroupsRequestPrivate::ListEndpointGroupsRequestPrivate(
    const GlobalAcceleratorRequest::Action action, ListEndpointGroupsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListEndpointGroupsRequest
 * class' copy constructor.
 */
ListEndpointGroupsRequestPrivate::ListEndpointGroupsRequestPrivate(
    const ListEndpointGroupsRequestPrivate &other, ListEndpointGroupsRequest * const q)
