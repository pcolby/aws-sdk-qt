...
/*!
 * \class QtAws::GlobalAccelerator::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for GlobalAccelerator ListTagsForResource responses.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : GlobalAcceleratorResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(GlobalAcceleratorResponse::request());
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::GlobalAccelerator::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator ListTagsForResource response element from \a xml.
 */
