...
/*!
 * \class QtAws::GlobalAccelerator::DeprovisionByoipCidrRequest
 * \brief The DeprovisionByoipCidrRequest class provides an interface for GlobalAccelerator DeprovisionByoipCidr requests.
 *
...
DeprovisionByoipCidrRequest::DeprovisionByoipCidrRequest(const DeprovisionByoipCidrRequest &other)
    : GlobalAcceleratorRequest(new DeprovisionByoipCidrRequestPrivate(*other.d_func(), this))
{
...
DeprovisionByoipCidrRequest::DeprovisionByoipCidrRequest()
    : GlobalAcceleratorRequest(new DeprovisionByoipCidrRequestPrivate(GlobalAcceleratorRequest::DeprovisionByoipCidrAction, this))
{
...
/*!
 * \class QtAws::GlobalAccelerator::DeprovisionByoipCidrRequestPrivate
...
/*!
 * Constructs a DeprovisionByoipCidrRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
DeprovisionByoipCidrRequestPrivate::DeprovisionByoipCidrRequestPrivate(
    const GlobalAcceleratorRequest::Action action, DeprovisionByoipCidrRequest * const q)
