...
#include "listcustomroutingendpointgroupsrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingEndpointGroupsRequest
 * \brief The ListCustomRoutingEndpointGroupsRequest class provides an interface for GlobalAccelerator ListCustomRoutingEndpointGroups requests.
 *
 ...
 *  Developer
 *
 * \sa GlobalAcceleratorClient::listCustomRoutingEndpointGroups
 */

/*!
 * Constructs a copy of \a other.
 */
ListCustomRoutingEndpointGroupsRequest::ListCustomRoutingEndpointGroupsRequest(const ListCustomRoutingEndpointGroupsRequest &other)
    : GlobalAcceleratorRequest(new ListCustomRoutingEndpointGroupsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListCustomRoutingEndpointGroupsRequest object.
 */
ListCustomRoutingEndpointGroupsRequest::ListCustomRoutingEndpointGroupsRequest()
    : GlobalAcceleratorRequest(new ListCustomRoutingEndpointGroupsRequestPrivate(GlobalAcceleratorRequest::ListCustomRoutingEndpointGroupsAction, this))
{
 ...
 * \reimp
 */
bool ListCustomRoutingEndpointGroupsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListCustomRoutingEndpointGroupsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListCustomRoutingEndpointGroupsRequest::response(QNetworkReply * const reply) const
{
    return new ListCustomRoutingEndpointGroupsResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingEndpointGroupsRequestPrivate
 * \brief The ListCustomRoutingEndpointGroupsRequestPrivate class provides private implementation for ListCustomRoutingEndpointGroupsRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListCustomRoutingEndpointGroupsRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
ListCustomRoutingEndpointGroupsRequestPrivate::ListCustomRoutingEndpointGroupsRequestPrivate(
    const GlobalAcceleratorRequest::Action action, ListCustomRoutingEndpointGroupsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListCustomRoutingEndpointGroupsRequest
 * class' copy constructor.
 */
ListCustomRoutingEndpointGroupsRequestPrivate::ListCustomRoutingEndpointGroupsRequestPrivate(
    const ListCustomRoutingEndpointGroupsRequestPrivate &other, ListCustomRoutingEndpointGroupsRequest * const q)
