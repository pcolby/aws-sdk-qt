...
#include "deleteendpointgroupresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DeleteEndpointGroupResponse
 * \brief The DeleteEndpointGroupResponse class provides an interace for GlobalAccelerator DeleteEndpointGroup responses.
 *
...
/*!
 * Constructs a DeleteEndpointGroupResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteEndpointGroupResponse::DeleteEndpointGroupResponse(
        const DeleteEndpointGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new DeleteEndpointGroupResponsePrivate(this), parent)
{
    setRequest(new DeleteEndpointGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator DeleteEndpointGroup \a response.
 */
void DeleteEndpointGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteEndpointGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::DeleteEndpointGroupResponsePrivate
 * \brief The DeleteEndpointGroupResponsePrivate class provides private implementation for DeleteEndpointGroupResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DeleteEndpointGroupResponsePrivate object with public implementation \a q.
 */
DeleteEndpointGroupResponsePrivate::DeleteEndpointGroupResponsePrivate(
    DeleteEndpointGroupResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator DeleteEndpointGroup response element from \a xml.
 */
void DeleteEndpointGroupResponsePrivate::parseDeleteEndpointGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteEndpointGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
