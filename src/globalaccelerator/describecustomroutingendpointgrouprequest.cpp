...
#include "describecustomroutingendpointgrouprequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingEndpointGroupRequest
 * \brief The DescribeCustomRoutingEndpointGroupRequest class provides an interface for GlobalAccelerator DescribeCustomRoutingEndpointGroup requests.
 *
 ...
 */
DescribeCustomRoutingEndpointGroupRequest::DescribeCustomRoutingEndpointGroupRequest(const DescribeCustomRoutingEndpointGroupRequest &other)
    : GlobalAcceleratorRequest(new DescribeCustomRoutingEndpointGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeCustomRoutingEndpointGroupRequest object.
 */
DescribeCustomRoutingEndpointGroupRequest::DescribeCustomRoutingEndpointGroupRequest()
    : GlobalAcceleratorRequest(new DescribeCustomRoutingEndpointGroupRequestPrivate(GlobalAcceleratorRequest::DescribeCustomRoutingEndpointGroupAction, this))
{
 ...
 * \reimp
 */
bool DescribeCustomRoutingEndpointGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeCustomRoutingEndpointGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeCustomRoutingEndpointGroupRequest::response(QNetworkReply * const reply) const
{
    return new DescribeCustomRoutingEndpointGroupResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingEndpointGroupRequestPrivate
 * \brief The DescribeCustomRoutingEndpointGroupRequestPrivate class provides private implementation for DescribeCustomRoutingEndpointGroupRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DescribeCustomRoutingEndpointGroupRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
DescribeCustomRoutingEndpointGroupRequestPrivate::DescribeCustomRoutingEndpointGroupRequestPrivate(
    const GlobalAcceleratorRequest::Action action, DescribeCustomRoutingEndpointGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeCustomRoutingEndpointGroupRequest
 * class' copy constructor.
 */
DescribeCustomRoutingEndpointGroupRequestPrivate::DescribeCustomRoutingEndpointGroupRequestPrivate(
    const DescribeCustomRoutingEndpointGroupRequestPrivate &other, DescribeCustomRoutingEndpointGroupRequest * const q)
