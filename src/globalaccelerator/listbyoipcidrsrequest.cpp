...
#include "listbyoipcidrsrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListByoipCidrsRequest
 * \brief The ListByoipCidrsRequest class provides an interface for GlobalAccelerator ListByoipCidrs requests.
 *
 ...
 *  Developer
 *
 * \sa GlobalAcceleratorClient::listByoipCidrs
 */

/*!
 * Constructs a copy of \a other.
 */
ListByoipCidrsRequest::ListByoipCidrsRequest(const ListByoipCidrsRequest &other)
    : GlobalAcceleratorRequest(new ListByoipCidrsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListByoipCidrsRequest object.
 */
ListByoipCidrsRequest::ListByoipCidrsRequest()
    : GlobalAcceleratorRequest(new ListByoipCidrsRequestPrivate(GlobalAcceleratorRequest::ListByoipCidrsAction, this))
{
 ...
 * \reimp
 */
bool ListByoipCidrsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListByoipCidrsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListByoipCidrsRequest::response(QNetworkReply * const reply) const
{
    return new ListByoipCidrsResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::ListByoipCidrsRequestPrivate
 * \brief The ListByoipCidrsRequestPrivate class provides private implementation for ListByoipCidrsRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListByoipCidrsRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
ListByoipCidrsRequestPrivate::ListByoipCidrsRequestPrivate(
    const GlobalAcceleratorRequest::Action action, ListByoipCidrsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListByoipCidrsRequest
 * class' copy constructor.
 */
ListByoipCidrsRequestPrivate::ListByoipCidrsRequestPrivate(
    const ListByoipCidrsRequestPrivate &other, ListByoipCidrsRequest * const q)
