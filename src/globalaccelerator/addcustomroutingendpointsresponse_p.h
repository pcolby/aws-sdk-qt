...
class QTAWS_EXPORT AddCustomRoutingEndpointsResponsePrivate : public GlobalAcceleratorResponsePrivate {

public:

    AddCustomRoutingEndpointsResponsePrivate(AddCustomRoutingEndpointsResponse * const q);
