...
#include "createcustomroutingendpointgrouprequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::CreateCustomRoutingEndpointGroupRequest
 * \brief The CreateCustomRoutingEndpointGroupRequest class provides an interface for GlobalAccelerator CreateCustomRoutingEndpointGroup requests.
 *
 ...
 */
CreateCustomRoutingEndpointGroupRequest::CreateCustomRoutingEndpointGroupRequest(const CreateCustomRoutingEndpointGroupRequest &other)
    : GlobalAcceleratorRequest(new CreateCustomRoutingEndpointGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateCustomRoutingEndpointGroupRequest object.
 */
CreateCustomRoutingEndpointGroupRequest::CreateCustomRoutingEndpointGroupRequest()
    : GlobalAcceleratorRequest(new CreateCustomRoutingEndpointGroupRequestPrivate(GlobalAcceleratorRequest::CreateCustomRoutingEndpointGroupAction, this))
{
 ...
 * \reimp
 */
bool CreateCustomRoutingEndpointGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateCustomRoutingEndpointGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateCustomRoutingEndpointGroupRequest::response(QNetworkReply * const reply) const
{
    return new CreateCustomRoutingEndpointGroupResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::CreateCustomRoutingEndpointGroupRequestPrivate
 * \brief The CreateCustomRoutingEndpointGroupRequestPrivate class provides private implementation for CreateCustomRoutingEndpointGroupRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a CreateCustomRoutingEndpointGroupRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
CreateCustomRoutingEndpointGroupRequestPrivate::CreateCustomRoutingEndpointGroupRequestPrivate(
    const GlobalAcceleratorRequest::Action action, CreateCustomRoutingEndpointGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateCustomRoutingEndpointGroupRequest
 * class' copy constructor.
 */
CreateCustomRoutingEndpointGroupRequestPrivate::CreateCustomRoutingEndpointGroupRequestPrivate(
    const CreateCustomRoutingEndpointGroupRequestPrivate &other, CreateCustomRoutingEndpointGroupRequest * const q)
