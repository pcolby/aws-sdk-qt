...
/*!
 * \class QtAws::GlobalAccelerator::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for GlobalAccelerator UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : GlobalAcceleratorRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : GlobalAcceleratorRequest(new UntagResourceRequestPrivate(GlobalAcceleratorRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::GlobalAccelerator::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const GlobalAcceleratorRequest::Action action, UntagResourceRequest * const q)
