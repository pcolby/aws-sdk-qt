...
/*!
 * \class QtAws::GlobalAccelerator::WithdrawByoipCidrResponse
 * \brief The WithdrawByoipCidrResponse class provides an interace for GlobalAccelerator WithdrawByoipCidr responses.
 *
...
WithdrawByoipCidrResponse::WithdrawByoipCidrResponse(
    ...
    : GlobalAcceleratorResponse(new WithdrawByoipCidrResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator WithdrawByoipCidr \a response.
 */
...
/*!
 * \class QtAws::GlobalAccelerator::WithdrawByoipCidrResponsePrivate
...
WithdrawByoipCidrResponsePrivate::WithdrawByoipCidrResponsePrivate(
    WithdrawByoipCidrResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator WithdrawByoipCidr response element from \a xml.
 */
