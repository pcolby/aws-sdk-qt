...
class QTAWS_EXPORT ListAcceleratorsResponsePrivate : public GlobalAcceleratorResponsePrivate {

public:

    ListAcceleratorsResponsePrivate(ListAcceleratorsResponse * const q);
