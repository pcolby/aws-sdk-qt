...
#include "listcustomroutingacceleratorsrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingAcceleratorsRequest
 * \brief The ListCustomRoutingAcceleratorsRequest class provides an interface for GlobalAccelerator ListCustomRoutingAccelerators requests.
 *
 ...
 */
ListCustomRoutingAcceleratorsRequest::ListCustomRoutingAcceleratorsRequest(const ListCustomRoutingAcceleratorsRequest &other)
    : GlobalAcceleratorRequest(new ListCustomRoutingAcceleratorsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListCustomRoutingAcceleratorsRequest object.
 */
ListCustomRoutingAcceleratorsRequest::ListCustomRoutingAcceleratorsRequest()
    : GlobalAcceleratorRequest(new ListCustomRoutingAcceleratorsRequestPrivate(GlobalAcceleratorRequest::ListCustomRoutingAcceleratorsAction, this))
{
 ...
 * \reimp
 */
bool ListCustomRoutingAcceleratorsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListCustomRoutingAcceleratorsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListCustomRoutingAcceleratorsRequest::response(QNetworkReply * const reply) const
{
    return new ListCustomRoutingAcceleratorsResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingAcceleratorsRequestPrivate
 * \brief The ListCustomRoutingAcceleratorsRequestPrivate class provides private implementation for ListCustomRoutingAcceleratorsRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListCustomRoutingAcceleratorsRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
ListCustomRoutingAcceleratorsRequestPrivate::ListCustomRoutingAcceleratorsRequestPrivate(
    const GlobalAcceleratorRequest::Action action, ListCustomRoutingAcceleratorsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListCustomRoutingAcceleratorsRequest
 * class' copy constructor.
 */
ListCustomRoutingAcceleratorsRequestPrivate::ListCustomRoutingAcceleratorsRequestPrivate(
    const ListCustomRoutingAcceleratorsRequestPrivate &other, ListCustomRoutingAcceleratorsRequest * const q)
