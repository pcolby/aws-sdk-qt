...
#include "updatecustomroutinglistenerrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::UpdateCustomRoutingListenerRequest
 * \brief The UpdateCustomRoutingListenerRequest class provides an interface for GlobalAccelerator UpdateCustomRoutingListener requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::updateCustomRoutingListener
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateCustomRoutingListenerRequest::UpdateCustomRoutingListenerRequest(const UpdateCustomRoutingListenerRequest &other)
    : GlobalAcceleratorRequest(new UpdateCustomRoutingListenerRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateCustomRoutingListenerRequest object.
 */
UpdateCustomRoutingListenerRequest::UpdateCustomRoutingListenerRequest()
    : GlobalAcceleratorRequest(new UpdateCustomRoutingListenerRequestPrivate(GlobalAcceleratorRequest::UpdateCustomRoutingListenerAction, this))
{
 ...
 * \reimp
 */
bool UpdateCustomRoutingListenerRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateCustomRoutingListenerResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateCustomRoutingListenerRequest::response(QNetworkReply * const reply) const
{
    return new UpdateCustomRoutingListenerResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::UpdateCustomRoutingListenerRequestPrivate
 * \brief The UpdateCustomRoutingListenerRequestPrivate class provides private implementation for UpdateCustomRoutingListenerRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a UpdateCustomRoutingListenerRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
UpdateCustomRoutingListenerRequestPrivate::UpdateCustomRoutingListenerRequestPrivate(
    const GlobalAcceleratorRequest::Action action, UpdateCustomRoutingListenerRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateCustomRoutingListenerRequest
 * class' copy constructor.
 */
UpdateCustomRoutingListenerRequestPrivate::UpdateCustomRoutingListenerRequestPrivate(
    const UpdateCustomRoutingListenerRequestPrivate &other, UpdateCustomRoutingListenerRequest * const q)
