...
#include "removecustomroutingendpointsresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::RemoveCustomRoutingEndpointsResponse
 * \brief The RemoveCustomRoutingEndpointsResponse class provides an interace for GlobalAccelerator RemoveCustomRoutingEndpoints responses.
 *
...
/*!
 * Constructs a RemoveCustomRoutingEndpointsResponse object for \a reply to \a request, with parent \a parent.
 */
RemoveCustomRoutingEndpointsResponse::RemoveCustomRoutingEndpointsResponse(
        const RemoveCustomRoutingEndpointsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new RemoveCustomRoutingEndpointsResponsePrivate(this), parent)
{
    setRequest(new RemoveCustomRoutingEndpointsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator RemoveCustomRoutingEndpoints \a response.
 */
void RemoveCustomRoutingEndpointsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(RemoveCustomRoutingEndpointsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::RemoveCustomRoutingEndpointsResponsePrivate
 * \brief The RemoveCustomRoutingEndpointsResponsePrivate class provides private implementation for RemoveCustomRoutingEndpointsResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a RemoveCustomRoutingEndpointsResponsePrivate object with public implementation \a q.
 */
RemoveCustomRoutingEndpointsResponsePrivate::RemoveCustomRoutingEndpointsResponsePrivate(
    RemoveCustomRoutingEndpointsResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator RemoveCustomRoutingEndpoints response element from \a xml.
 */
void RemoveCustomRoutingEndpointsResponsePrivate::parseRemoveCustomRoutingEndpointsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("RemoveCustomRoutingEndpointsResponse"));
    Q_UNUSED(xml) ///< @todo
}
