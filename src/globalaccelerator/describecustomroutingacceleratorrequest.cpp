...
#include "describecustomroutingacceleratorrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingAcceleratorRequest
 * \brief The DescribeCustomRoutingAcceleratorRequest class provides an interface for GlobalAccelerator DescribeCustomRoutingAccelerator requests.
 *
 ...
 */
DescribeCustomRoutingAcceleratorRequest::DescribeCustomRoutingAcceleratorRequest(const DescribeCustomRoutingAcceleratorRequest &other)
    : GlobalAcceleratorRequest(new DescribeCustomRoutingAcceleratorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeCustomRoutingAcceleratorRequest object.
 */
DescribeCustomRoutingAcceleratorRequest::DescribeCustomRoutingAcceleratorRequest()
    : GlobalAcceleratorRequest(new DescribeCustomRoutingAcceleratorRequestPrivate(GlobalAcceleratorRequest::DescribeCustomRoutingAcceleratorAction, this))
{
 ...
 * \reimp
 */
bool DescribeCustomRoutingAcceleratorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeCustomRoutingAcceleratorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeCustomRoutingAcceleratorRequest::response(QNetworkReply * const reply) const
{
    return new DescribeCustomRoutingAcceleratorResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingAcceleratorRequestPrivate
 * \brief The DescribeCustomRoutingAcceleratorRequestPrivate class provides private implementation for DescribeCustomRoutingAcceleratorRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DescribeCustomRoutingAcceleratorRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
DescribeCustomRoutingAcceleratorRequestPrivate::DescribeCustomRoutingAcceleratorRequestPrivate(
    const GlobalAcceleratorRequest::Action action, DescribeCustomRoutingAcceleratorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeCustomRoutingAcceleratorRequest
 * class' copy constructor.
 */
DescribeCustomRoutingAcceleratorRequestPrivate::DescribeCustomRoutingAcceleratorRequestPrivate(
    const DescribeCustomRoutingAcceleratorRequestPrivate &other, DescribeCustomRoutingAcceleratorRequest * const q)
