...
class QTAWS_EXPORT ListCustomRoutingAcceleratorsResponsePrivate : public GlobalAcceleratorResponsePrivate {

public:

    ListCustomRoutingAcceleratorsResponsePrivate(ListCustomRoutingAcceleratorsResponse * const q);
