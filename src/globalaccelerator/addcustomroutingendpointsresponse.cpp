...
#include "addcustomroutingendpointsresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::AddCustomRoutingEndpointsResponse
 * \brief The AddCustomRoutingEndpointsResponse class provides an interace for GlobalAccelerator AddCustomRoutingEndpoints responses.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::addCustomRoutingEndpoints
 */

/*!
 * Constructs a AddCustomRoutingEndpointsResponse object for \a reply to \a request, with parent \a parent.
 */
AddCustomRoutingEndpointsResponse::AddCustomRoutingEndpointsResponse(
        const AddCustomRoutingEndpointsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new AddCustomRoutingEndpointsResponsePrivate(this), parent)
{
    setRequest(new AddCustomRoutingEndpointsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const AddCustomRoutingEndpointsRequest * AddCustomRoutingEndpointsResponse::request() const
{
    Q_D(const AddCustomRoutingEndpointsResponse);
    return static_cast<const AddCustomRoutingEndpointsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator AddCustomRoutingEndpoints \a response.
 */
void AddCustomRoutingEndpointsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AddCustomRoutingEndpointsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::AddCustomRoutingEndpointsResponsePrivate
 * \brief The AddCustomRoutingEndpointsResponsePrivate class provides private implementation for AddCustomRoutingEndpointsResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a AddCustomRoutingEndpointsResponsePrivate object with public implementation \a q.
 */
AddCustomRoutingEndpointsResponsePrivate::AddCustomRoutingEndpointsResponsePrivate(
    AddCustomRoutingEndpointsResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator AddCustomRoutingEndpoints response element from \a xml.
 */
void AddCustomRoutingEndpointsResponsePrivate::parseAddCustomRoutingEndpointsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AddCustomRoutingEndpointsResponse"));
    Q_UNUSED(xml) ///< @todo
}
