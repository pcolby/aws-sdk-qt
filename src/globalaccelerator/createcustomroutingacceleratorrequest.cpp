...
#include "createcustomroutingacceleratorrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::CreateCustomRoutingAcceleratorRequest
 * \brief The CreateCustomRoutingAcceleratorRequest class provides an interface for GlobalAccelerator CreateCustomRoutingAccelerator requests.
 *
 ...
 */
CreateCustomRoutingAcceleratorRequest::CreateCustomRoutingAcceleratorRequest(const CreateCustomRoutingAcceleratorRequest &other)
    : GlobalAcceleratorRequest(new CreateCustomRoutingAcceleratorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateCustomRoutingAcceleratorRequest object.
 */
CreateCustomRoutingAcceleratorRequest::CreateCustomRoutingAcceleratorRequest()
    : GlobalAcceleratorRequest(new CreateCustomRoutingAcceleratorRequestPrivate(GlobalAcceleratorRequest::CreateCustomRoutingAcceleratorAction, this))
{
 ...
 * \reimp
 */
bool CreateCustomRoutingAcceleratorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateCustomRoutingAcceleratorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateCustomRoutingAcceleratorRequest::response(QNetworkReply * const reply) const
{
    return new CreateCustomRoutingAcceleratorResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::CreateCustomRoutingAcceleratorRequestPrivate
 * \brief The CreateCustomRoutingAcceleratorRequestPrivate class provides private implementation for CreateCustomRoutingAcceleratorRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a CreateCustomRoutingAcceleratorRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
CreateCustomRoutingAcceleratorRequestPrivate::CreateCustomRoutingAcceleratorRequestPrivate(
    const GlobalAcceleratorRequest::Action action, CreateCustomRoutingAcceleratorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateCustomRoutingAcceleratorRequest
 * class' copy constructor.
 */
CreateCustomRoutingAcceleratorRequestPrivate::CreateCustomRoutingAcceleratorRequestPrivate(
    const CreateCustomRoutingAcceleratorRequestPrivate &other, CreateCustomRoutingAcceleratorRequest * const q)
