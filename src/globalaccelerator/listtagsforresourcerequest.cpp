...
/*!
 * \class QtAws::GlobalAccelerator::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for GlobalAccelerator ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : GlobalAcceleratorRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : GlobalAcceleratorRequest(new ListTagsForResourceRequestPrivate(GlobalAcceleratorRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::GlobalAccelerator::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const GlobalAcceleratorRequest::Action action, ListTagsForResourceRequest * const q)
