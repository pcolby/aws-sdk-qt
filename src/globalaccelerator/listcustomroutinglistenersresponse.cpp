...
#include "listcustomroutinglistenersresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingListenersResponse
 * \brief The ListCustomRoutingListenersResponse class provides an interace for GlobalAccelerator ListCustomRoutingListeners responses.
 *
 ...
 *  Developer
 *
 * \sa GlobalAcceleratorClient::listCustomRoutingListeners
 */

/*!
 * Constructs a ListCustomRoutingListenersResponse object for \a reply to \a request, with parent \a parent.
 */
ListCustomRoutingListenersResponse::ListCustomRoutingListenersResponse(
        const ListCustomRoutingListenersRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new ListCustomRoutingListenersResponsePrivate(this), parent)
{
    setRequest(new ListCustomRoutingListenersRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListCustomRoutingListenersRequest * ListCustomRoutingListenersResponse::request() const
{
    Q_D(const ListCustomRoutingListenersResponse);
    return static_cast<const ListCustomRoutingListenersRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator ListCustomRoutingListeners \a response.
 */
void ListCustomRoutingListenersResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListCustomRoutingListenersResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingListenersResponsePrivate
 * \brief The ListCustomRoutingListenersResponsePrivate class provides private implementation for ListCustomRoutingListenersResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListCustomRoutingListenersResponsePrivate object with public implementation \a q.
 */
ListCustomRoutingListenersResponsePrivate::ListCustomRoutingListenersResponsePrivate(
    ListCustomRoutingListenersResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator ListCustomRoutingListeners response element from \a xml.
 */
void ListCustomRoutingListenersResponsePrivate::parseListCustomRoutingListenersResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListCustomRoutingListenersResponse"));
    Q_UNUSED(xml) ///< @todo
}
