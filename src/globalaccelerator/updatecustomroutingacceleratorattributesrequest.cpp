...
#include "updatecustomroutingacceleratorattributesrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::UpdateCustomRoutingAcceleratorAttributesRequest
 * \brief The UpdateCustomRoutingAcceleratorAttributesRequest class provides an interface for GlobalAccelerator UpdateCustomRoutingAcceleratorAttributes requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::updateCustomRoutingAcceleratorAttributes
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateCustomRoutingAcceleratorAttributesRequest::UpdateCustomRoutingAcceleratorAttributesRequest(const UpdateCustomRoutingAcceleratorAttributesRequest &other)
    : GlobalAcceleratorRequest(new UpdateCustomRoutingAcceleratorAttributesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateCustomRoutingAcceleratorAttributesRequest object.
 */
UpdateCustomRoutingAcceleratorAttributesRequest::UpdateCustomRoutingAcceleratorAttributesRequest()
    : GlobalAcceleratorRequest(new UpdateCustomRoutingAcceleratorAttributesRequestPrivate(GlobalAcceleratorRequest::UpdateCustomRoutingAcceleratorAttributesAction, this))
{
 ...
 * \reimp
 */
bool UpdateCustomRoutingAcceleratorAttributesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateCustomRoutingAcceleratorAttributesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateCustomRoutingAcceleratorAttributesRequest::response(QNetworkReply * const reply) const
{
    return new UpdateCustomRoutingAcceleratorAttributesResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::UpdateCustomRoutingAcceleratorAttributesRequestPrivate
 * \brief The UpdateCustomRoutingAcceleratorAttributesRequestPrivate class provides private implementation for UpdateCustomRoutingAcceleratorAttributesRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a UpdateCustomRoutingAcceleratorAttributesRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
UpdateCustomRoutingAcceleratorAttributesRequestPrivate::UpdateCustomRoutingAcceleratorAttributesRequestPrivate(
    const GlobalAcceleratorRequest::Action action, UpdateCustomRoutingAcceleratorAttributesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateCustomRoutingAcceleratorAttributesRequest
 * class' copy constructor.
 */
UpdateCustomRoutingAcceleratorAttributesRequestPrivate::UpdateCustomRoutingAcceleratorAttributesRequestPrivate(
    const UpdateCustomRoutingAcceleratorAttributesRequestPrivate &other, UpdateCustomRoutingAcceleratorAttributesRequest * const q)
