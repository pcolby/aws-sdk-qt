...
#include "listacceleratorsrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListAcceleratorsRequest
 * \brief The ListAcceleratorsRequest class provides an interface for GlobalAccelerator ListAccelerators requests.
 *
 ...
 *  Developer
 *
 * \sa GlobalAcceleratorClient::listAccelerators
 */

/*!
 * Constructs a copy of \a other.
 */
ListAcceleratorsRequest::ListAcceleratorsRequest(const ListAcceleratorsRequest &other)
    : GlobalAcceleratorRequest(new ListAcceleratorsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListAcceleratorsRequest object.
 */
ListAcceleratorsRequest::ListAcceleratorsRequest()
    : GlobalAcceleratorRequest(new ListAcceleratorsRequestPrivate(GlobalAcceleratorRequest::ListAcceleratorsAction, this))
{
 ...
 * \reimp
 */
bool ListAcceleratorsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListAcceleratorsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListAcceleratorsRequest::response(QNetworkReply * const reply) const
{
    return new ListAcceleratorsResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::ListAcceleratorsRequestPrivate
 * \brief The ListAcceleratorsRequestPrivate class provides private implementation for ListAcceleratorsRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListAcceleratorsRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
ListAcceleratorsRequestPrivate::ListAcceleratorsRequestPrivate(
    const GlobalAcceleratorRequest::Action action, ListAcceleratorsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListAcceleratorsRequest
 * class' copy constructor.
 */
ListAcceleratorsRequestPrivate::ListAcceleratorsRequestPrivate(
    const ListAcceleratorsRequestPrivate &other, ListAcceleratorsRequest * const q)
