...
/*!
 * \class QtAws::GlobalAccelerator::DeleteListenerResponse
 * \brief The DeleteListenerResponse class provides an interace for GlobalAccelerator DeleteListener responses.
 *
...
DeleteListenerResponse::DeleteListenerResponse(
    ...
    : GlobalAcceleratorResponse(new DeleteListenerResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator DeleteListener \a response.
 */
...
/*!
 * \class QtAws::GlobalAccelerator::DeleteListenerResponsePrivate
...
DeleteListenerResponsePrivate::DeleteListenerResponsePrivate(
    DeleteListenerResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator DeleteListener response element from \a xml.
 */
