...
/*!
 * \class QtAws::GlobalAccelerator::WithdrawByoipCidrRequest
 * \brief The WithdrawByoipCidrRequest class provides an interface for GlobalAccelerator WithdrawByoipCidr requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::withdrawByoipCidr
 */
...
WithdrawByoipCidrRequest::WithdrawByoipCidrRequest(const WithdrawByoipCidrRequest &other)
    : GlobalAcceleratorRequest(new WithdrawByoipCidrRequestPrivate(*other.d_func(), this))
{
...
WithdrawByoipCidrRequest::WithdrawByoipCidrRequest()
    : GlobalAcceleratorRequest(new WithdrawByoipCidrRequestPrivate(GlobalAcceleratorRequest::WithdrawByoipCidrAction, this))
{
...
/*!
 * \class QtAws::GlobalAccelerator::WithdrawByoipCidrRequestPrivate
...
/*!
 * Constructs a WithdrawByoipCidrRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
WithdrawByoipCidrRequestPrivate::WithdrawByoipCidrRequestPrivate(
    const GlobalAcceleratorRequest::Action action, WithdrawByoipCidrRequest * const q)
