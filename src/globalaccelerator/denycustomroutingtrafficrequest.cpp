...
#include "denycustomroutingtrafficrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DenyCustomRoutingTrafficRequest
 * \brief The DenyCustomRoutingTrafficRequest class provides an interface for GlobalAccelerator DenyCustomRoutingTraffic requests.
 *
 ...
 *  Developer
 *
 * \sa GlobalAcceleratorClient::denyCustomRoutingTraffic
 */

/*!
 * Constructs a copy of \a other.
 */
DenyCustomRoutingTrafficRequest::DenyCustomRoutingTrafficRequest(const DenyCustomRoutingTrafficRequest &other)
    : GlobalAcceleratorRequest(new DenyCustomRoutingTrafficRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DenyCustomRoutingTrafficRequest object.
 */
DenyCustomRoutingTrafficRequest::DenyCustomRoutingTrafficRequest()
    : GlobalAcceleratorRequest(new DenyCustomRoutingTrafficRequestPrivate(GlobalAcceleratorRequest::DenyCustomRoutingTrafficAction, this))
{
 ...
 * \reimp
 */
bool DenyCustomRoutingTrafficRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DenyCustomRoutingTrafficResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DenyCustomRoutingTrafficRequest::response(QNetworkReply * const reply) const
{
    return new DenyCustomRoutingTrafficResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::DenyCustomRoutingTrafficRequestPrivate
 * \brief The DenyCustomRoutingTrafficRequestPrivate class provides private implementation for DenyCustomRoutingTrafficRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DenyCustomRoutingTrafficRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
DenyCustomRoutingTrafficRequestPrivate::DenyCustomRoutingTrafficRequestPrivate(
    const GlobalAcceleratorRequest::Action action, DenyCustomRoutingTrafficRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DenyCustomRoutingTrafficRequest
 * class' copy constructor.
 */
DenyCustomRoutingTrafficRequestPrivate::DenyCustomRoutingTrafficRequestPrivate(
    const DenyCustomRoutingTrafficRequestPrivate &other, DenyCustomRoutingTrafficRequest * const q)
