...
#include "updatecustomroutingacceleratorattributesresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::UpdateCustomRoutingAcceleratorAttributesResponse
 * \brief The UpdateCustomRoutingAcceleratorAttributesResponse class provides an interace for GlobalAccelerator UpdateCustomRoutingAcceleratorAttributes responses.
 *
...
/*!
 * Constructs a UpdateCustomRoutingAcceleratorAttributesResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateCustomRoutingAcceleratorAttributesResponse::UpdateCustomRoutingAcceleratorAttributesResponse(
        const UpdateCustomRoutingAcceleratorAttributesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new UpdateCustomRoutingAcceleratorAttributesResponsePrivate(this), parent)
{
    setRequest(new UpdateCustomRoutingAcceleratorAttributesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator UpdateCustomRoutingAcceleratorAttributes \a response.
 */
void UpdateCustomRoutingAcceleratorAttributesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateCustomRoutingAcceleratorAttributesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::UpdateCustomRoutingAcceleratorAttributesResponsePrivate
 * \brief The UpdateCustomRoutingAcceleratorAttributesResponsePrivate class provides private implementation for UpdateCustomRoutingAcceleratorAttributesResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a UpdateCustomRoutingAcceleratorAttributesResponsePrivate object with public implementation \a q.
 */
UpdateCustomRoutingAcceleratorAttributesResponsePrivate::UpdateCustomRoutingAcceleratorAttributesResponsePrivate(
    UpdateCustomRoutingAcceleratorAttributesResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator UpdateCustomRoutingAcceleratorAttributes response element from \a xml.
 */
void UpdateCustomRoutingAcceleratorAttributesResponsePrivate::parseUpdateCustomRoutingAcceleratorAttributesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateCustomRoutingAcceleratorAttributesResponse"));
    Q_UNUSED(xml) ///< @todo
}
