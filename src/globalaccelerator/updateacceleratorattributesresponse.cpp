...
#include "updateacceleratorattributesresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::UpdateAcceleratorAttributesResponse
 * \brief The UpdateAcceleratorAttributesResponse class provides an interace for GlobalAccelerator UpdateAcceleratorAttributes responses.
 *
 ...
 *  Developer
 *
 * \sa GlobalAcceleratorClient::updateAcceleratorAttributes
 */

/*!
 * Constructs a UpdateAcceleratorAttributesResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateAcceleratorAttributesResponse::UpdateAcceleratorAttributesResponse(
        const UpdateAcceleratorAttributesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new UpdateAcceleratorAttributesResponsePrivate(this), parent)
{
    setRequest(new UpdateAcceleratorAttributesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateAcceleratorAttributesRequest * UpdateAcceleratorAttributesResponse::request() const
{
    Q_D(const UpdateAcceleratorAttributesResponse);
    return static_cast<const UpdateAcceleratorAttributesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator UpdateAcceleratorAttributes \a response.
 */
void UpdateAcceleratorAttributesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateAcceleratorAttributesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::UpdateAcceleratorAttributesResponsePrivate
 * \brief The UpdateAcceleratorAttributesResponsePrivate class provides private implementation for UpdateAcceleratorAttributesResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a UpdateAcceleratorAttributesResponsePrivate object with public implementation \a q.
 */
UpdateAcceleratorAttributesResponsePrivate::UpdateAcceleratorAttributesResponsePrivate(
    UpdateAcceleratorAttributesResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator UpdateAcceleratorAttributes response element from \a xml.
 */
void UpdateAcceleratorAttributesResponsePrivate::parseUpdateAcceleratorAttributesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateAcceleratorAttributesResponse"));
    Q_UNUSED(xml) ///< @todo
}
