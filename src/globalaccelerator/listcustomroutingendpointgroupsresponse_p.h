...
class QTAWS_EXPORT ListCustomRoutingEndpointGroupsResponsePrivate : public GlobalAcceleratorResponsePrivate {

public:

    ListCustomRoutingEndpointGroupsResponsePrivate(ListCustomRoutingEndpointGroupsResponse * const q);
