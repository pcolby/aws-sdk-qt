...
#include "deletecustomroutingendpointgrouprequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DeleteCustomRoutingEndpointGroupRequest
 * \brief The DeleteCustomRoutingEndpointGroupRequest class provides an interface for GlobalAccelerator DeleteCustomRoutingEndpointGroup requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::deleteCustomRoutingEndpointGroup
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteCustomRoutingEndpointGroupRequest::DeleteCustomRoutingEndpointGroupRequest(const DeleteCustomRoutingEndpointGroupRequest &other)
    : GlobalAcceleratorRequest(new DeleteCustomRoutingEndpointGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteCustomRoutingEndpointGroupRequest object.
 */
DeleteCustomRoutingEndpointGroupRequest::DeleteCustomRoutingEndpointGroupRequest()
    : GlobalAcceleratorRequest(new DeleteCustomRoutingEndpointGroupRequestPrivate(GlobalAcceleratorRequest::DeleteCustomRoutingEndpointGroupAction, this))
{
 ...
 * \reimp
 */
bool DeleteCustomRoutingEndpointGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteCustomRoutingEndpointGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteCustomRoutingEndpointGroupRequest::response(QNetworkReply * const reply) const
{
    return new DeleteCustomRoutingEndpointGroupResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::DeleteCustomRoutingEndpointGroupRequestPrivate
 * \brief The DeleteCustomRoutingEndpointGroupRequestPrivate class provides private implementation for DeleteCustomRoutingEndpointGroupRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DeleteCustomRoutingEndpointGroupRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
DeleteCustomRoutingEndpointGroupRequestPrivate::DeleteCustomRoutingEndpointGroupRequestPrivate(
    const GlobalAcceleratorRequest::Action action, DeleteCustomRoutingEndpointGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteCustomRoutingEndpointGroupRequest
 * class' copy constructor.
 */
DeleteCustomRoutingEndpointGroupRequestPrivate::DeleteCustomRoutingEndpointGroupRequestPrivate(
    const DeleteCustomRoutingEndpointGroupRequestPrivate &other, DeleteCustomRoutingEndpointGroupRequest * const q)
