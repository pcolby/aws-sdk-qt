...
#include "createcustomroutingacceleratorresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::CreateCustomRoutingAcceleratorResponse
 * \brief The CreateCustomRoutingAcceleratorResponse class provides an interace for GlobalAccelerator CreateCustomRoutingAccelerator responses.
 *
 ...
 *  Developer
 *
 * \sa GlobalAcceleratorClient::createCustomRoutingAccelerator
 */

/*!
 * Constructs a CreateCustomRoutingAcceleratorResponse object for \a reply to \a request, with parent \a parent.
 */
CreateCustomRoutingAcceleratorResponse::CreateCustomRoutingAcceleratorResponse(
        const CreateCustomRoutingAcceleratorRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new CreateCustomRoutingAcceleratorResponsePrivate(this), parent)
{
    setRequest(new CreateCustomRoutingAcceleratorRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateCustomRoutingAcceleratorRequest * CreateCustomRoutingAcceleratorResponse::request() const
{
    Q_D(const CreateCustomRoutingAcceleratorResponse);
    return static_cast<const CreateCustomRoutingAcceleratorRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator CreateCustomRoutingAccelerator \a response.
 */
void CreateCustomRoutingAcceleratorResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateCustomRoutingAcceleratorResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::CreateCustomRoutingAcceleratorResponsePrivate
 * \brief The CreateCustomRoutingAcceleratorResponsePrivate class provides private implementation for CreateCustomRoutingAcceleratorResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a CreateCustomRoutingAcceleratorResponsePrivate object with public implementation \a q.
 */
CreateCustomRoutingAcceleratorResponsePrivate::CreateCustomRoutingAcceleratorResponsePrivate(
    CreateCustomRoutingAcceleratorResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator CreateCustomRoutingAccelerator response element from \a xml.
 */
void CreateCustomRoutingAcceleratorResponsePrivate::parseCreateCustomRoutingAcceleratorResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateCustomRoutingAcceleratorResponse"));
    Q_UNUSED(xml) ///< @todo
}
