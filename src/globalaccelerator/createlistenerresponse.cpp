...
/*!
 * \class QtAws::GlobalAccelerator::CreateListenerResponse
 * \brief The CreateListenerResponse class provides an interace for GlobalAccelerator CreateListener responses.
 *
...
CreateListenerResponse::CreateListenerResponse(
    ...
    : GlobalAcceleratorResponse(new CreateListenerResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator CreateListener \a response.
 */
...
/*!
 * \class QtAws::GlobalAccelerator::CreateListenerResponsePrivate
...
CreateListenerResponsePrivate::CreateListenerResponsePrivate(
    CreateListenerResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator CreateListener response element from \a xml.
 */
