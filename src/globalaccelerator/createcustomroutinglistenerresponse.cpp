...
#include "createcustomroutinglistenerresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::CreateCustomRoutingListenerResponse
 * \brief The CreateCustomRoutingListenerResponse class provides an interace for GlobalAccelerator CreateCustomRoutingListener responses.
 *
 ...
 *  Developer
 *
 * \sa GlobalAcceleratorClient::createCustomRoutingListener
 */

/*!
 * Constructs a CreateCustomRoutingListenerResponse object for \a reply to \a request, with parent \a parent.
 */
CreateCustomRoutingListenerResponse::CreateCustomRoutingListenerResponse(
        const CreateCustomRoutingListenerRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new CreateCustomRoutingListenerResponsePrivate(this), parent)
{
    setRequest(new CreateCustomRoutingListenerRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateCustomRoutingListenerRequest * CreateCustomRoutingListenerResponse::request() const
{
    Q_D(const CreateCustomRoutingListenerResponse);
    return static_cast<const CreateCustomRoutingListenerRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator CreateCustomRoutingListener \a response.
 */
void CreateCustomRoutingListenerResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateCustomRoutingListenerResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::CreateCustomRoutingListenerResponsePrivate
 * \brief The CreateCustomRoutingListenerResponsePrivate class provides private implementation for CreateCustomRoutingListenerResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a CreateCustomRoutingListenerResponsePrivate object with public implementation \a q.
 */
CreateCustomRoutingListenerResponsePrivate::CreateCustomRoutingListenerResponsePrivate(
    CreateCustomRoutingListenerResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator CreateCustomRoutingListener response element from \a xml.
 */
void CreateCustomRoutingListenerResponsePrivate::parseCreateCustomRoutingListenerResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateCustomRoutingListenerResponse"));
    Q_UNUSED(xml) ///< @todo
}
