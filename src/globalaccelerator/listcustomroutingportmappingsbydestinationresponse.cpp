...
#include "listcustomroutingportmappingsbydestinationresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingPortMappingsByDestinationResponse
 * \brief The ListCustomRoutingPortMappingsByDestinationResponse class provides an interace for GlobalAccelerator ListCustomRoutingPortMappingsByDestination responses.
 *
...
/*!
 * Constructs a ListCustomRoutingPortMappingsByDestinationResponse object for \a reply to \a request, with parent \a parent.
 */
ListCustomRoutingPortMappingsByDestinationResponse::ListCustomRoutingPortMappingsByDestinationResponse(
        const ListCustomRoutingPortMappingsByDestinationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new ListCustomRoutingPortMappingsByDestinationResponsePrivate(this), parent)
{
    setRequest(new ListCustomRoutingPortMappingsByDestinationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator ListCustomRoutingPortMappingsByDestination \a response.
 */
void ListCustomRoutingPortMappingsByDestinationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListCustomRoutingPortMappingsByDestinationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingPortMappingsByDestinationResponsePrivate
 * \brief The ListCustomRoutingPortMappingsByDestinationResponsePrivate class provides private implementation for ListCustomRoutingPortMappingsByDestinationResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListCustomRoutingPortMappingsByDestinationResponsePrivate object with public implementation \a q.
 */
ListCustomRoutingPortMappingsByDestinationResponsePrivate::ListCustomRoutingPortMappingsByDestinationResponsePrivate(
    ListCustomRoutingPortMappingsByDestinationResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator ListCustomRoutingPortMappingsByDestination response element from \a xml.
 */
void ListCustomRoutingPortMappingsByDestinationResponsePrivate::parseListCustomRoutingPortMappingsByDestinationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListCustomRoutingPortMappingsByDestinationResponse"));
    Q_UNUSED(xml) ///< @todo
}
