...
/*!
 * \class QtAws::GlobalAccelerator::AdvertiseByoipCidrRequest
 * \brief The AdvertiseByoipCidrRequest class provides an interface for GlobalAccelerator AdvertiseByoipCidr requests.
 *
...
AdvertiseByoipCidrRequest::AdvertiseByoipCidrRequest(const AdvertiseByoipCidrRequest &other)
    : GlobalAcceleratorRequest(new AdvertiseByoipCidrRequestPrivate(*other.d_func(), this))
{
...
AdvertiseByoipCidrRequest::AdvertiseByoipCidrRequest()
    : GlobalAcceleratorRequest(new AdvertiseByoipCidrRequestPrivate(GlobalAcceleratorRequest::AdvertiseByoipCidrAction, this))
{
...
/*!
 * \class QtAws::GlobalAccelerator::AdvertiseByoipCidrRequestPrivate
...
/*!
 * Constructs a AdvertiseByoipCidrRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
AdvertiseByoipCidrRequestPrivate::AdvertiseByoipCidrRequestPrivate(
    const GlobalAcceleratorRequest::Action action, AdvertiseByoipCidrRequest * const q)
