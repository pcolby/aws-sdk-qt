...
class QTAWS_EXPORT DescribeEndpointGroupResponsePrivate : public GlobalAcceleratorResponsePrivate {

public:

    DescribeEndpointGroupResponsePrivate(DescribeEndpointGroupResponse * const q);
