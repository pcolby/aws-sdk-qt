...
class QTAWS_EXPORT CreateAcceleratorResponsePrivate : public GlobalAcceleratorResponsePrivate {

public:

    CreateAcceleratorResponsePrivate(CreateAcceleratorResponse * const q);
