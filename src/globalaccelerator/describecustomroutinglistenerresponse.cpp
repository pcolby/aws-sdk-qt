...
#include "describecustomroutinglistenerresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingListenerResponse
 * \brief The DescribeCustomRoutingListenerResponse class provides an interace for GlobalAccelerator DescribeCustomRoutingListener responses.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::describeCustomRoutingListener
 */

/*!
 * Constructs a DescribeCustomRoutingListenerResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeCustomRoutingListenerResponse::DescribeCustomRoutingListenerResponse(
        const DescribeCustomRoutingListenerRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new DescribeCustomRoutingListenerResponsePrivate(this), parent)
{
    setRequest(new DescribeCustomRoutingListenerRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeCustomRoutingListenerRequest * DescribeCustomRoutingListenerResponse::request() const
{
    Q_D(const DescribeCustomRoutingListenerResponse);
    return static_cast<const DescribeCustomRoutingListenerRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator DescribeCustomRoutingListener \a response.
 */
void DescribeCustomRoutingListenerResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeCustomRoutingListenerResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingListenerResponsePrivate
 * \brief The DescribeCustomRoutingListenerResponsePrivate class provides private implementation for DescribeCustomRoutingListenerResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DescribeCustomRoutingListenerResponsePrivate object with public implementation \a q.
 */
DescribeCustomRoutingListenerResponsePrivate::DescribeCustomRoutingListenerResponsePrivate(
    DescribeCustomRoutingListenerResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator DescribeCustomRoutingListener response element from \a xml.
 */
void DescribeCustomRoutingListenerResponsePrivate::parseDescribeCustomRoutingListenerResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeCustomRoutingListenerResponse"));
    Q_UNUSED(xml) ///< @todo
}
