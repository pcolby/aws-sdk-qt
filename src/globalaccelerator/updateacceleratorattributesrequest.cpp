...
#include "updateacceleratorattributesrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::UpdateAcceleratorAttributesRequest
 * \brief The UpdateAcceleratorAttributesRequest class provides an interface for GlobalAccelerator UpdateAcceleratorAttributes requests.
 *
 ...
 */
UpdateAcceleratorAttributesRequest::UpdateAcceleratorAttributesRequest(const UpdateAcceleratorAttributesRequest &other)
    : GlobalAcceleratorRequest(new UpdateAcceleratorAttributesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateAcceleratorAttributesRequest object.
 */
UpdateAcceleratorAttributesRequest::UpdateAcceleratorAttributesRequest()
    : GlobalAcceleratorRequest(new UpdateAcceleratorAttributesRequestPrivate(GlobalAcceleratorRequest::UpdateAcceleratorAttributesAction, this))
{
 ...
 * \reimp
 */
bool UpdateAcceleratorAttributesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateAcceleratorAttributesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateAcceleratorAttributesRequest::response(QNetworkReply * const reply) const
{
    return new UpdateAcceleratorAttributesResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::UpdateAcceleratorAttributesRequestPrivate
 * \brief The UpdateAcceleratorAttributesRequestPrivate class provides private implementation for UpdateAcceleratorAttributesRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a UpdateAcceleratorAttributesRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
UpdateAcceleratorAttributesRequestPrivate::UpdateAcceleratorAttributesRequestPrivate(
    const GlobalAcceleratorRequest::Action action, UpdateAcceleratorAttributesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateAcceleratorAttributesRequest
 * class' copy constructor.
 */
UpdateAcceleratorAttributesRequestPrivate::UpdateAcceleratorAttributesRequestPrivate(
    const UpdateAcceleratorAttributesRequestPrivate &other, UpdateAcceleratorAttributesRequest * const q)
