...
/*!
 * \class QtAws::GlobalAccelerator::ProvisionByoipCidrRequest
 * \brief The ProvisionByoipCidrRequest class provides an interface for GlobalAccelerator ProvisionByoipCidr requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::provisionByoipCidr
 */
...
ProvisionByoipCidrRequest::ProvisionByoipCidrRequest(const ProvisionByoipCidrRequest &other)
    : GlobalAcceleratorRequest(new ProvisionByoipCidrRequestPrivate(*other.d_func(), this))
{
...
ProvisionByoipCidrRequest::ProvisionByoipCidrRequest()
    : GlobalAcceleratorRequest(new ProvisionByoipCidrRequestPrivate(GlobalAcceleratorRequest::ProvisionByoipCidrAction, this))
{
...
/*!
 * \class QtAws::GlobalAccelerator::ProvisionByoipCidrRequestPrivate
...
/*!
 * Constructs a ProvisionByoipCidrRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
ProvisionByoipCidrRequestPrivate::ProvisionByoipCidrRequestPrivate(
    const GlobalAcceleratorRequest::Action action, ProvisionByoipCidrRequest * const q)
