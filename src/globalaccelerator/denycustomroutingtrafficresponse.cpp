...
#include "denycustomroutingtrafficresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DenyCustomRoutingTrafficResponse
 * \brief The DenyCustomRoutingTrafficResponse class provides an interace for GlobalAccelerator DenyCustomRoutingTraffic responses.
 *
...
/*!
 * Constructs a DenyCustomRoutingTrafficResponse object for \a reply to \a request, with parent \a parent.
 */
DenyCustomRoutingTrafficResponse::DenyCustomRoutingTrafficResponse(
        const DenyCustomRoutingTrafficRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new DenyCustomRoutingTrafficResponsePrivate(this), parent)
{
    setRequest(new DenyCustomRoutingTrafficRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator DenyCustomRoutingTraffic \a response.
 */
void DenyCustomRoutingTrafficResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DenyCustomRoutingTrafficResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::DenyCustomRoutingTrafficResponsePrivate
 * \brief The DenyCustomRoutingTrafficResponsePrivate class provides private implementation for DenyCustomRoutingTrafficResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DenyCustomRoutingTrafficResponsePrivate object with public implementation \a q.
 */
DenyCustomRoutingTrafficResponsePrivate::DenyCustomRoutingTrafficResponsePrivate(
    DenyCustomRoutingTrafficResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator DenyCustomRoutingTraffic response element from \a xml.
 */
void DenyCustomRoutingTrafficResponsePrivate::parseDenyCustomRoutingTrafficResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DenyCustomRoutingTrafficResponse"));
    Q_UNUSED(xml) ///< @todo
}
