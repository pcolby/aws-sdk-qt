...
#include "createcustomroutingendpointgroupresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::CreateCustomRoutingEndpointGroupResponse
 * \brief The CreateCustomRoutingEndpointGroupResponse class provides an interace for GlobalAccelerator CreateCustomRoutingEndpointGroup responses.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::createCustomRoutingEndpointGroup
 */

/*!
 * Constructs a CreateCustomRoutingEndpointGroupResponse object for \a reply to \a request, with parent \a parent.
 */
CreateCustomRoutingEndpointGroupResponse::CreateCustomRoutingEndpointGroupResponse(
        const CreateCustomRoutingEndpointGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new CreateCustomRoutingEndpointGroupResponsePrivate(this), parent)
{
    setRequest(new CreateCustomRoutingEndpointGroupRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateCustomRoutingEndpointGroupRequest * CreateCustomRoutingEndpointGroupResponse::request() const
{
    Q_D(const CreateCustomRoutingEndpointGroupResponse);
    return static_cast<const CreateCustomRoutingEndpointGroupRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator CreateCustomRoutingEndpointGroup \a response.
 */
void CreateCustomRoutingEndpointGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateCustomRoutingEndpointGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::CreateCustomRoutingEndpointGroupResponsePrivate
 * \brief The CreateCustomRoutingEndpointGroupResponsePrivate class provides private implementation for CreateCustomRoutingEndpointGroupResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a CreateCustomRoutingEndpointGroupResponsePrivate object with public implementation \a q.
 */
CreateCustomRoutingEndpointGroupResponsePrivate::CreateCustomRoutingEndpointGroupResponsePrivate(
    CreateCustomRoutingEndpointGroupResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator CreateCustomRoutingEndpointGroup response element from \a xml.
 */
void CreateCustomRoutingEndpointGroupResponsePrivate::parseCreateCustomRoutingEndpointGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateCustomRoutingEndpointGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
