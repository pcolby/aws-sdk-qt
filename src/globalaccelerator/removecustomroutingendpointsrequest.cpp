...
#include "removecustomroutingendpointsrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::RemoveCustomRoutingEndpointsRequest
 * \brief The RemoveCustomRoutingEndpointsRequest class provides an interface for GlobalAccelerator RemoveCustomRoutingEndpoints requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::removeCustomRoutingEndpoints
 */

/*!
 * Constructs a copy of \a other.
 */
RemoveCustomRoutingEndpointsRequest::RemoveCustomRoutingEndpointsRequest(const RemoveCustomRoutingEndpointsRequest &other)
    : GlobalAcceleratorRequest(new RemoveCustomRoutingEndpointsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a RemoveCustomRoutingEndpointsRequest object.
 */
RemoveCustomRoutingEndpointsRequest::RemoveCustomRoutingEndpointsRequest()
    : GlobalAcceleratorRequest(new RemoveCustomRoutingEndpointsRequestPrivate(GlobalAcceleratorRequest::RemoveCustomRoutingEndpointsAction, this))
{
 ...
 * \reimp
 */
bool RemoveCustomRoutingEndpointsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a RemoveCustomRoutingEndpointsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * RemoveCustomRoutingEndpointsRequest::response(QNetworkReply * const reply) const
{
    return new RemoveCustomRoutingEndpointsResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::RemoveCustomRoutingEndpointsRequestPrivate
 * \brief The RemoveCustomRoutingEndpointsRequestPrivate class provides private implementation for RemoveCustomRoutingEndpointsRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a RemoveCustomRoutingEndpointsRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
RemoveCustomRoutingEndpointsRequestPrivate::RemoveCustomRoutingEndpointsRequestPrivate(
    const GlobalAcceleratorRequest::Action action, RemoveCustomRoutingEndpointsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the RemoveCustomRoutingEndpointsRequest
 * class' copy constructor.
 */
RemoveCustomRoutingEndpointsRequestPrivate::RemoveCustomRoutingEndpointsRequestPrivate(
    const RemoveCustomRoutingEndpointsRequestPrivate &other, RemoveCustomRoutingEndpointsRequest * const q)
