...
#include "describeendpointgroupresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DescribeEndpointGroupResponse
 * \brief The DescribeEndpointGroupResponse class provides an interace for GlobalAccelerator DescribeEndpointGroup responses.
 *
...
/*!
 * Constructs a DescribeEndpointGroupResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeEndpointGroupResponse::DescribeEndpointGroupResponse(
        const DescribeEndpointGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new DescribeEndpointGroupResponsePrivate(this), parent)
{
    setRequest(new DescribeEndpointGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator DescribeEndpointGroup \a response.
 */
void DescribeEndpointGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeEndpointGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::DescribeEndpointGroupResponsePrivate
 * \brief The DescribeEndpointGroupResponsePrivate class provides private implementation for DescribeEndpointGroupResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DescribeEndpointGroupResponsePrivate object with public implementation \a q.
 */
DescribeEndpointGroupResponsePrivate::DescribeEndpointGroupResponsePrivate(
    DescribeEndpointGroupResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator DescribeEndpointGroup response element from \a xml.
 */
void DescribeEndpointGroupResponsePrivate::parseDescribeEndpointGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeEndpointGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
