...
#include "listendpointgroupsresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListEndpointGroupsResponse
 * \brief The ListEndpointGroupsResponse class provides an interace for GlobalAccelerator ListEndpointGroups responses.
 *
...
/*!
 * Constructs a ListEndpointGroupsResponse object for \a reply to \a request, with parent \a parent.
 */
ListEndpointGroupsResponse::ListEndpointGroupsResponse(
        const ListEndpointGroupsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new ListEndpointGroupsResponsePrivate(this), parent)
{
    setRequest(new ListEndpointGroupsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator ListEndpointGroups \a response.
 */
void ListEndpointGroupsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListEndpointGroupsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::ListEndpointGroupsResponsePrivate
 * \brief The ListEndpointGroupsResponsePrivate class provides private implementation for ListEndpointGroupsResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListEndpointGroupsResponsePrivate object with public implementation \a q.
 */
ListEndpointGroupsResponsePrivate::ListEndpointGroupsResponsePrivate(
    ListEndpointGroupsResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator ListEndpointGroups response element from \a xml.
 */
void ListEndpointGroupsResponsePrivate::parseListEndpointGroupsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListEndpointGroupsResponse"));
    Q_UNUSED(xml) ///< @todo
}
