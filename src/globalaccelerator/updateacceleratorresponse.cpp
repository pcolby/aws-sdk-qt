...
#include "updateacceleratorresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::UpdateAcceleratorResponse
 * \brief The UpdateAcceleratorResponse class provides an interace for GlobalAccelerator UpdateAccelerator responses.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::updateAccelerator
 */

/*!
 * Constructs a UpdateAcceleratorResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateAcceleratorResponse::UpdateAcceleratorResponse(
        const UpdateAcceleratorRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new UpdateAcceleratorResponsePrivate(this), parent)
{
    setRequest(new UpdateAcceleratorRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateAcceleratorRequest * UpdateAcceleratorResponse::request() const
{
    Q_D(const UpdateAcceleratorResponse);
    return static_cast<const UpdateAcceleratorRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator UpdateAccelerator \a response.
 */
void UpdateAcceleratorResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateAcceleratorResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::UpdateAcceleratorResponsePrivate
 * \brief The UpdateAcceleratorResponsePrivate class provides private implementation for UpdateAcceleratorResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a UpdateAcceleratorResponsePrivate object with public implementation \a q.
 */
UpdateAcceleratorResponsePrivate::UpdateAcceleratorResponsePrivate(
    UpdateAcceleratorResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator UpdateAccelerator response element from \a xml.
 */
void UpdateAcceleratorResponsePrivate::parseUpdateAcceleratorResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateAcceleratorResponse"));
    Q_UNUSED(xml) ///< @todo
}
