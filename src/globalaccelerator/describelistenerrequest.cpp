...
#include "describelistenerrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DescribeListenerRequest
 * \brief The DescribeListenerRequest class provides an interface for GlobalAccelerator DescribeListener requests.
 *
 ...
 *  Developer
 *
 * \sa GlobalAcceleratorClient::describeListener
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeListenerRequest::DescribeListenerRequest(const DescribeListenerRequest &other)
    : GlobalAcceleratorRequest(new DescribeListenerRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeListenerRequest object.
 */
DescribeListenerRequest::DescribeListenerRequest()
    : GlobalAcceleratorRequest(new DescribeListenerRequestPrivate(GlobalAcceleratorRequest::DescribeListenerAction, this))
{
 ...
 * \reimp
 */
bool DescribeListenerRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeListenerResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeListenerRequest::response(QNetworkReply * const reply) const
{
    return new DescribeListenerResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::DescribeListenerRequestPrivate
 * \brief The DescribeListenerRequestPrivate class provides private implementation for DescribeListenerRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DescribeListenerRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
DescribeListenerRequestPrivate::DescribeListenerRequestPrivate(
    const GlobalAcceleratorRequest::Action action, DescribeListenerRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeListenerRequest
 * class' copy constructor.
 */
DescribeListenerRequestPrivate::DescribeListenerRequestPrivate(
    const DescribeListenerRequestPrivate &other, DescribeListenerRequest * const q)
