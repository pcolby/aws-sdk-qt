...
#include "deletecustomroutingacceleratorresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DeleteCustomRoutingAcceleratorResponse
 * \brief The DeleteCustomRoutingAcceleratorResponse class provides an interace for GlobalAccelerator DeleteCustomRoutingAccelerator responses.
 *
...
/*!
 * Constructs a DeleteCustomRoutingAcceleratorResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteCustomRoutingAcceleratorResponse::DeleteCustomRoutingAcceleratorResponse(
        const DeleteCustomRoutingAcceleratorRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new DeleteCustomRoutingAcceleratorResponsePrivate(this), parent)
{
    setRequest(new DeleteCustomRoutingAcceleratorRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator DeleteCustomRoutingAccelerator \a response.
 */
void DeleteCustomRoutingAcceleratorResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteCustomRoutingAcceleratorResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::DeleteCustomRoutingAcceleratorResponsePrivate
 * \brief The DeleteCustomRoutingAcceleratorResponsePrivate class provides private implementation for DeleteCustomRoutingAcceleratorResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DeleteCustomRoutingAcceleratorResponsePrivate object with public implementation \a q.
 */
DeleteCustomRoutingAcceleratorResponsePrivate::DeleteCustomRoutingAcceleratorResponsePrivate(
    DeleteCustomRoutingAcceleratorResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator DeleteCustomRoutingAccelerator response element from \a xml.
 */
void DeleteCustomRoutingAcceleratorResponsePrivate::parseDeleteCustomRoutingAcceleratorResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteCustomRoutingAcceleratorResponse"));
    Q_UNUSED(xml) ///< @todo
}
