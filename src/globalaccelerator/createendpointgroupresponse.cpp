...
#include "createendpointgroupresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::CreateEndpointGroupResponse
 * \brief The CreateEndpointGroupResponse class provides an interace for GlobalAccelerator CreateEndpointGroup responses.
 *
...
/*!
 * Constructs a CreateEndpointGroupResponse object for \a reply to \a request, with parent \a parent.
 */
CreateEndpointGroupResponse::CreateEndpointGroupResponse(
        const CreateEndpointGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new CreateEndpointGroupResponsePrivate(this), parent)
{
    setRequest(new CreateEndpointGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator CreateEndpointGroup \a response.
 */
void CreateEndpointGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateEndpointGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::CreateEndpointGroupResponsePrivate
 * \brief The CreateEndpointGroupResponsePrivate class provides private implementation for CreateEndpointGroupResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a CreateEndpointGroupResponsePrivate object with public implementation \a q.
 */
CreateEndpointGroupResponsePrivate::CreateEndpointGroupResponsePrivate(
    CreateEndpointGroupResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator CreateEndpointGroup response element from \a xml.
 */
void CreateEndpointGroupResponsePrivate::parseCreateEndpointGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateEndpointGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
