...
#include "updateendpointgrouprequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::UpdateEndpointGroupRequest
 * \brief The UpdateEndpointGroupRequest class provides an interface for GlobalAccelerator UpdateEndpointGroup requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::updateEndpointGroup
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateEndpointGroupRequest::UpdateEndpointGroupRequest(const UpdateEndpointGroupRequest &other)
    : GlobalAcceleratorRequest(new UpdateEndpointGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateEndpointGroupRequest object.
 */
UpdateEndpointGroupRequest::UpdateEndpointGroupRequest()
    : GlobalAcceleratorRequest(new UpdateEndpointGroupRequestPrivate(GlobalAcceleratorRequest::UpdateEndpointGroupAction, this))
{
 ...
 * \reimp
 */
bool UpdateEndpointGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateEndpointGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateEndpointGroupRequest::response(QNetworkReply * const reply) const
{
    return new UpdateEndpointGroupResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::UpdateEndpointGroupRequestPrivate
 * \brief The UpdateEndpointGroupRequestPrivate class provides private implementation for UpdateEndpointGroupRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a UpdateEndpointGroupRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
UpdateEndpointGroupRequestPrivate::UpdateEndpointGroupRequestPrivate(
    const GlobalAcceleratorRequest::Action action, UpdateEndpointGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateEndpointGroupRequest
 * class' copy constructor.
 */
UpdateEndpointGroupRequestPrivate::UpdateEndpointGroupRequestPrivate(
    const UpdateEndpointGroupRequestPrivate &other, UpdateEndpointGroupRequest * const q)
