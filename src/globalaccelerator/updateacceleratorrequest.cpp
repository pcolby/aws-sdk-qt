...
#include "updateacceleratorrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::UpdateAcceleratorRequest
 * \brief The UpdateAcceleratorRequest class provides an interface for GlobalAccelerator UpdateAccelerator requests.
 *
 ...
 */
UpdateAcceleratorRequest::UpdateAcceleratorRequest(const UpdateAcceleratorRequest &other)
    : GlobalAcceleratorRequest(new UpdateAcceleratorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateAcceleratorRequest object.
 */
UpdateAcceleratorRequest::UpdateAcceleratorRequest()
    : GlobalAcceleratorRequest(new UpdateAcceleratorRequestPrivate(GlobalAcceleratorRequest::UpdateAcceleratorAction, this))
{
 ...
 * \reimp
 */
bool UpdateAcceleratorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateAcceleratorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateAcceleratorRequest::response(QNetworkReply * const reply) const
{
    return new UpdateAcceleratorResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::UpdateAcceleratorRequestPrivate
 * \brief The UpdateAcceleratorRequestPrivate class provides private implementation for UpdateAcceleratorRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a UpdateAcceleratorRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
UpdateAcceleratorRequestPrivate::UpdateAcceleratorRequestPrivate(
    const GlobalAcceleratorRequest::Action action, UpdateAcceleratorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateAcceleratorRequest
 * class' copy constructor.
 */
UpdateAcceleratorRequestPrivate::UpdateAcceleratorRequestPrivate(
    const UpdateAcceleratorRequestPrivate &other, UpdateAcceleratorRequest * const q)
