...
#include "updatecustomroutingacceleratorresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::UpdateCustomRoutingAcceleratorResponse
 * \brief The UpdateCustomRoutingAcceleratorResponse class provides an interace for GlobalAccelerator UpdateCustomRoutingAccelerator responses.
 *
 ...
 *  Developer
 *
 * \sa GlobalAcceleratorClient::updateCustomRoutingAccelerator
 */

/*!
 * Constructs a UpdateCustomRoutingAcceleratorResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateCustomRoutingAcceleratorResponse::UpdateCustomRoutingAcceleratorResponse(
        const UpdateCustomRoutingAcceleratorRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new UpdateCustomRoutingAcceleratorResponsePrivate(this), parent)
{
    setRequest(new UpdateCustomRoutingAcceleratorRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateCustomRoutingAcceleratorRequest * UpdateCustomRoutingAcceleratorResponse::request() const
{
    Q_D(const UpdateCustomRoutingAcceleratorResponse);
    return static_cast<const UpdateCustomRoutingAcceleratorRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator UpdateCustomRoutingAccelerator \a response.
 */
void UpdateCustomRoutingAcceleratorResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateCustomRoutingAcceleratorResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::UpdateCustomRoutingAcceleratorResponsePrivate
 * \brief The UpdateCustomRoutingAcceleratorResponsePrivate class provides private implementation for UpdateCustomRoutingAcceleratorResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a UpdateCustomRoutingAcceleratorResponsePrivate object with public implementation \a q.
 */
UpdateCustomRoutingAcceleratorResponsePrivate::UpdateCustomRoutingAcceleratorResponsePrivate(
    UpdateCustomRoutingAcceleratorResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator UpdateCustomRoutingAccelerator response element from \a xml.
 */
void UpdateCustomRoutingAcceleratorResponsePrivate::parseUpdateCustomRoutingAcceleratorResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateCustomRoutingAcceleratorResponse"));
    Q_UNUSED(xml) ///< @todo
}
