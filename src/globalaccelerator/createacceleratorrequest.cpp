...
#include "createacceleratorrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::CreateAcceleratorRequest
 * \brief The CreateAcceleratorRequest class provides an interface for GlobalAccelerator CreateAccelerator requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::createAccelerator
 */

/*!
 * Constructs a copy of \a other.
 */
CreateAcceleratorRequest::CreateAcceleratorRequest(const CreateAcceleratorRequest &other)
    : GlobalAcceleratorRequest(new CreateAcceleratorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateAcceleratorRequest object.
 */
CreateAcceleratorRequest::CreateAcceleratorRequest()
    : GlobalAcceleratorRequest(new CreateAcceleratorRequestPrivate(GlobalAcceleratorRequest::CreateAcceleratorAction, this))
{
 ...
 * \reimp
 */
bool CreateAcceleratorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateAcceleratorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateAcceleratorRequest::response(QNetworkReply * const reply) const
{
    return new CreateAcceleratorResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::CreateAcceleratorRequestPrivate
 * \brief The CreateAcceleratorRequestPrivate class provides private implementation for CreateAcceleratorRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a CreateAcceleratorRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
CreateAcceleratorRequestPrivate::CreateAcceleratorRequestPrivate(
    const GlobalAcceleratorRequest::Action action, CreateAcceleratorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateAcceleratorRequest
 * class' copy constructor.
 */
CreateAcceleratorRequestPrivate::CreateAcceleratorRequestPrivate(
    const CreateAcceleratorRequestPrivate &other, CreateAcceleratorRequest * const q)
