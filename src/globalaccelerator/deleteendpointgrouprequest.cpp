...
#include "deleteendpointgrouprequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DeleteEndpointGroupRequest
 * \brief The DeleteEndpointGroupRequest class provides an interface for GlobalAccelerator DeleteEndpointGroup requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::deleteEndpointGroup
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteEndpointGroupRequest::DeleteEndpointGroupRequest(const DeleteEndpointGroupRequest &other)
    : GlobalAcceleratorRequest(new DeleteEndpointGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteEndpointGroupRequest object.
 */
DeleteEndpointGroupRequest::DeleteEndpointGroupRequest()
    : GlobalAcceleratorRequest(new DeleteEndpointGroupRequestPrivate(GlobalAcceleratorRequest::DeleteEndpointGroupAction, this))
{
 ...
 * \reimp
 */
bool DeleteEndpointGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteEndpointGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteEndpointGroupRequest::response(QNetworkReply * const reply) const
{
    return new DeleteEndpointGroupResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::DeleteEndpointGroupRequestPrivate
 * \brief The DeleteEndpointGroupRequestPrivate class provides private implementation for DeleteEndpointGroupRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DeleteEndpointGroupRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
DeleteEndpointGroupRequestPrivate::DeleteEndpointGroupRequestPrivate(
    const GlobalAcceleratorRequest::Action action, DeleteEndpointGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteEndpointGroupRequest
 * class' copy constructor.
 */
DeleteEndpointGroupRequestPrivate::DeleteEndpointGroupRequestPrivate(
    const DeleteEndpointGroupRequestPrivate &other, DeleteEndpointGroupRequest * const q)
