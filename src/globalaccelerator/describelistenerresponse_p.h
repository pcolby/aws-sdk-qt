...
class QTAWS_EXPORT DescribeListenerResponsePrivate : public GlobalAcceleratorResponsePrivate {

public:

    DescribeListenerResponsePrivate(DescribeListenerResponse * const q);
