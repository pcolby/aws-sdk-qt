...
#include "listcustomroutinglistenersrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingListenersRequest
 * \brief The ListCustomRoutingListenersRequest class provides an interface for GlobalAccelerator ListCustomRoutingListeners requests.
 *
 ...
 */
ListCustomRoutingListenersRequest::ListCustomRoutingListenersRequest(const ListCustomRoutingListenersRequest &other)
    : GlobalAcceleratorRequest(new ListCustomRoutingListenersRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListCustomRoutingListenersRequest object.
 */
ListCustomRoutingListenersRequest::ListCustomRoutingListenersRequest()
    : GlobalAcceleratorRequest(new ListCustomRoutingListenersRequestPrivate(GlobalAcceleratorRequest::ListCustomRoutingListenersAction, this))
{
 ...
 * \reimp
 */
bool ListCustomRoutingListenersRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListCustomRoutingListenersResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListCustomRoutingListenersRequest::response(QNetworkReply * const reply) const
{
    return new ListCustomRoutingListenersResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingListenersRequestPrivate
 * \brief The ListCustomRoutingListenersRequestPrivate class provides private implementation for ListCustomRoutingListenersRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListCustomRoutingListenersRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
ListCustomRoutingListenersRequestPrivate::ListCustomRoutingListenersRequestPrivate(
    const GlobalAcceleratorRequest::Action action, ListCustomRoutingListenersRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListCustomRoutingListenersRequest
 * class' copy constructor.
 */
ListCustomRoutingListenersRequestPrivate::ListCustomRoutingListenersRequestPrivate(
    const ListCustomRoutingListenersRequestPrivate &other, ListCustomRoutingListenersRequest * const q)
