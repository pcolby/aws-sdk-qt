...
#include "addcustomroutingendpointsrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::AddCustomRoutingEndpointsRequest
 * \brief The AddCustomRoutingEndpointsRequest class provides an interface for GlobalAccelerator AddCustomRoutingEndpoints requests.
 *
 ...
 */
AddCustomRoutingEndpointsRequest::AddCustomRoutingEndpointsRequest(const AddCustomRoutingEndpointsRequest &other)
    : GlobalAcceleratorRequest(new AddCustomRoutingEndpointsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AddCustomRoutingEndpointsRequest object.
 */
AddCustomRoutingEndpointsRequest::AddCustomRoutingEndpointsRequest()
    : GlobalAcceleratorRequest(new AddCustomRoutingEndpointsRequestPrivate(GlobalAcceleratorRequest::AddCustomRoutingEndpointsAction, this))
{
 ...
 * \reimp
 */
bool AddCustomRoutingEndpointsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AddCustomRoutingEndpointsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AddCustomRoutingEndpointsRequest::response(QNetworkReply * const reply) const
{
    return new AddCustomRoutingEndpointsResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::AddCustomRoutingEndpointsRequestPrivate
 * \brief The AddCustomRoutingEndpointsRequestPrivate class provides private implementation for AddCustomRoutingEndpointsRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a AddCustomRoutingEndpointsRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
AddCustomRoutingEndpointsRequestPrivate::AddCustomRoutingEndpointsRequestPrivate(
    const GlobalAcceleratorRequest::Action action, AddCustomRoutingEndpointsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AddCustomRoutingEndpointsRequest
 * class' copy constructor.
 */
AddCustomRoutingEndpointsRequestPrivate::AddCustomRoutingEndpointsRequestPrivate(
    const AddCustomRoutingEndpointsRequestPrivate &other, AddCustomRoutingEndpointsRequest * const q)
