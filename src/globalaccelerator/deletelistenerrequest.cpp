...
/*!
 * \class QtAws::GlobalAccelerator::DeleteListenerRequest
 * \brief The DeleteListenerRequest class provides an interface for GlobalAccelerator DeleteListener requests.
 *
 ...
 *  Developer
 *
 * \sa GlobalAcceleratorClient::deleteListener
 */
...
DeleteListenerRequest::DeleteListenerRequest(const DeleteListenerRequest &other)
    : GlobalAcceleratorRequest(new DeleteListenerRequestPrivate(*other.d_func(), this))
{
...
DeleteListenerRequest::DeleteListenerRequest()
    : GlobalAcceleratorRequest(new DeleteListenerRequestPrivate(GlobalAcceleratorRequest::DeleteListenerAction, this))
{
...
/*!
 * \class QtAws::GlobalAccelerator::DeleteListenerRequestPrivate
...
/*!
 * Constructs a DeleteListenerRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
DeleteListenerRequestPrivate::DeleteListenerRequestPrivate(
    const GlobalAcceleratorRequest::Action action, DeleteListenerRequest * const q)
