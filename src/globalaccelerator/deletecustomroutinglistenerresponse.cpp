...
#include "deletecustomroutinglistenerresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DeleteCustomRoutingListenerResponse
 * \brief The DeleteCustomRoutingListenerResponse class provides an interace for GlobalAccelerator DeleteCustomRoutingListener responses.
 *
...
/*!
 * Constructs a DeleteCustomRoutingListenerResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteCustomRoutingListenerResponse::DeleteCustomRoutingListenerResponse(
        const DeleteCustomRoutingListenerRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new DeleteCustomRoutingListenerResponsePrivate(this), parent)
{
    setRequest(new DeleteCustomRoutingListenerRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator DeleteCustomRoutingListener \a response.
 */
void DeleteCustomRoutingListenerResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteCustomRoutingListenerResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::DeleteCustomRoutingListenerResponsePrivate
 * \brief The DeleteCustomRoutingListenerResponsePrivate class provides private implementation for DeleteCustomRoutingListenerResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DeleteCustomRoutingListenerResponsePrivate object with public implementation \a q.
 */
DeleteCustomRoutingListenerResponsePrivate::DeleteCustomRoutingListenerResponsePrivate(
    DeleteCustomRoutingListenerResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator DeleteCustomRoutingListener response element from \a xml.
 */
void DeleteCustomRoutingListenerResponsePrivate::parseDeleteCustomRoutingListenerResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteCustomRoutingListenerResponse"));
    Q_UNUSED(xml) ///< @todo
}
