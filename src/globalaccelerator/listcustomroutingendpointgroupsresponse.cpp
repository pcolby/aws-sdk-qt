...
#include "listcustomroutingendpointgroupsresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingEndpointGroupsResponse
 * \brief The ListCustomRoutingEndpointGroupsResponse class provides an interace for GlobalAccelerator ListCustomRoutingEndpointGroups responses.
 *
...
/*!
 * Constructs a ListCustomRoutingEndpointGroupsResponse object for \a reply to \a request, with parent \a parent.
 */
ListCustomRoutingEndpointGroupsResponse::ListCustomRoutingEndpointGroupsResponse(
        const ListCustomRoutingEndpointGroupsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new ListCustomRoutingEndpointGroupsResponsePrivate(this), parent)
{
    setRequest(new ListCustomRoutingEndpointGroupsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator ListCustomRoutingEndpointGroups \a response.
 */
void ListCustomRoutingEndpointGroupsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListCustomRoutingEndpointGroupsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingEndpointGroupsResponsePrivate
 * \brief The ListCustomRoutingEndpointGroupsResponsePrivate class provides private implementation for ListCustomRoutingEndpointGroupsResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListCustomRoutingEndpointGroupsResponsePrivate object with public implementation \a q.
 */
ListCustomRoutingEndpointGroupsResponsePrivate::ListCustomRoutingEndpointGroupsResponsePrivate(
    ListCustomRoutingEndpointGroupsResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator ListCustomRoutingEndpointGroups response element from \a xml.
 */
void ListCustomRoutingEndpointGroupsResponsePrivate::parseListCustomRoutingEndpointGroupsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListCustomRoutingEndpointGroupsResponse"));
    Q_UNUSED(xml) ///< @todo
}
