...
#include "updatecustomroutinglistenerresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::UpdateCustomRoutingListenerResponse
 * \brief The UpdateCustomRoutingListenerResponse class provides an interace for GlobalAccelerator UpdateCustomRoutingListener responses.
 *
...
/*!
 * Constructs a UpdateCustomRoutingListenerResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateCustomRoutingListenerResponse::UpdateCustomRoutingListenerResponse(
        const UpdateCustomRoutingListenerRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new UpdateCustomRoutingListenerResponsePrivate(this), parent)
{
    setRequest(new UpdateCustomRoutingListenerRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator UpdateCustomRoutingListener \a response.
 */
void UpdateCustomRoutingListenerResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateCustomRoutingListenerResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::UpdateCustomRoutingListenerResponsePrivate
 * \brief The UpdateCustomRoutingListenerResponsePrivate class provides private implementation for UpdateCustomRoutingListenerResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a UpdateCustomRoutingListenerResponsePrivate object with public implementation \a q.
 */
UpdateCustomRoutingListenerResponsePrivate::UpdateCustomRoutingListenerResponsePrivate(
    UpdateCustomRoutingListenerResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator UpdateCustomRoutingListener response element from \a xml.
 */
void UpdateCustomRoutingListenerResponsePrivate::parseUpdateCustomRoutingListenerResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateCustomRoutingListenerResponse"));
    Q_UNUSED(xml) ///< @todo
}
