...
#include "updatecustomroutingacceleratorrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::UpdateCustomRoutingAcceleratorRequest
 * \brief The UpdateCustomRoutingAcceleratorRequest class provides an interface for GlobalAccelerator UpdateCustomRoutingAccelerator requests.
 *
 ...
 */
UpdateCustomRoutingAcceleratorRequest::UpdateCustomRoutingAcceleratorRequest(const UpdateCustomRoutingAcceleratorRequest &other)
    : GlobalAcceleratorRequest(new UpdateCustomRoutingAcceleratorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateCustomRoutingAcceleratorRequest object.
 */
UpdateCustomRoutingAcceleratorRequest::UpdateCustomRoutingAcceleratorRequest()
    : GlobalAcceleratorRequest(new UpdateCustomRoutingAcceleratorRequestPrivate(GlobalAcceleratorRequest::UpdateCustomRoutingAcceleratorAction, this))
{
 ...
 * \reimp
 */
bool UpdateCustomRoutingAcceleratorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateCustomRoutingAcceleratorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateCustomRoutingAcceleratorRequest::response(QNetworkReply * const reply) const
{
    return new UpdateCustomRoutingAcceleratorResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::UpdateCustomRoutingAcceleratorRequestPrivate
 * \brief The UpdateCustomRoutingAcceleratorRequestPrivate class provides private implementation for UpdateCustomRoutingAcceleratorRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a UpdateCustomRoutingAcceleratorRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
UpdateCustomRoutingAcceleratorRequestPrivate::UpdateCustomRoutingAcceleratorRequestPrivate(
    const GlobalAcceleratorRequest::Action action, UpdateCustomRoutingAcceleratorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateCustomRoutingAcceleratorRequest
 * class' copy constructor.
 */
UpdateCustomRoutingAcceleratorRequestPrivate::UpdateCustomRoutingAcceleratorRequestPrivate(
    const UpdateCustomRoutingAcceleratorRequestPrivate &other, UpdateCustomRoutingAcceleratorRequest * const q)
