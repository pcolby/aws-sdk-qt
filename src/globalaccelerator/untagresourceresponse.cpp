...
/*!
 * \class QtAws::GlobalAccelerator::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for GlobalAccelerator UntagResource responses.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : GlobalAcceleratorResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(GlobalAcceleratorResponse::request());
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator UntagResource \a response.
 */
...
/*!
 * \class QtAws::GlobalAccelerator::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator UntagResource response element from \a xml.
 */
