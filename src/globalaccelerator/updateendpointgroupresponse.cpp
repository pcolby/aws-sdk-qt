...
#include "updateendpointgroupresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::UpdateEndpointGroupResponse
 * \brief The UpdateEndpointGroupResponse class provides an interace for GlobalAccelerator UpdateEndpointGroup responses.
 *
...
/*!
 * Constructs a UpdateEndpointGroupResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateEndpointGroupResponse::UpdateEndpointGroupResponse(
        const UpdateEndpointGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new UpdateEndpointGroupResponsePrivate(this), parent)
{
    setRequest(new UpdateEndpointGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator UpdateEndpointGroup \a response.
 */
void UpdateEndpointGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateEndpointGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::UpdateEndpointGroupResponsePrivate
 * \brief The UpdateEndpointGroupResponsePrivate class provides private implementation for UpdateEndpointGroupResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a UpdateEndpointGroupResponsePrivate object with public implementation \a q.
 */
UpdateEndpointGroupResponsePrivate::UpdateEndpointGroupResponsePrivate(
    UpdateEndpointGroupResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator UpdateEndpointGroup response element from \a xml.
 */
void UpdateEndpointGroupResponsePrivate::parseUpdateEndpointGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateEndpointGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
