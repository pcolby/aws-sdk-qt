...
#include "describecustomroutingacceleratorattributesrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingAcceleratorAttributesRequest
 * \brief The DescribeCustomRoutingAcceleratorAttributesRequest class provides an interface for GlobalAccelerator DescribeCustomRoutingAcceleratorAttributes requests.
 *
 ...
 */
DescribeCustomRoutingAcceleratorAttributesRequest::DescribeCustomRoutingAcceleratorAttributesRequest(const DescribeCustomRoutingAcceleratorAttributesRequest &other)
    : GlobalAcceleratorRequest(new DescribeCustomRoutingAcceleratorAttributesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeCustomRoutingAcceleratorAttributesRequest object.
 */
DescribeCustomRoutingAcceleratorAttributesRequest::DescribeCustomRoutingAcceleratorAttributesRequest()
    : GlobalAcceleratorRequest(new DescribeCustomRoutingAcceleratorAttributesRequestPrivate(GlobalAcceleratorRequest::DescribeCustomRoutingAcceleratorAttributesAction, this))
{
 ...
 * \reimp
 */
bool DescribeCustomRoutingAcceleratorAttributesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeCustomRoutingAcceleratorAttributesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeCustomRoutingAcceleratorAttributesRequest::response(QNetworkReply * const reply) const
{
    return new DescribeCustomRoutingAcceleratorAttributesResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingAcceleratorAttributesRequestPrivate
 * \brief The DescribeCustomRoutingAcceleratorAttributesRequestPrivate class provides private implementation for DescribeCustomRoutingAcceleratorAttributesRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DescribeCustomRoutingAcceleratorAttributesRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
DescribeCustomRoutingAcceleratorAttributesRequestPrivate::DescribeCustomRoutingAcceleratorAttributesRequestPrivate(
    const GlobalAcceleratorRequest::Action action, DescribeCustomRoutingAcceleratorAttributesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeCustomRoutingAcceleratorAttributesRequest
 * class' copy constructor.
 */
DescribeCustomRoutingAcceleratorAttributesRequestPrivate::DescribeCustomRoutingAcceleratorAttributesRequestPrivate(
    const DescribeCustomRoutingAcceleratorAttributesRequestPrivate &other, DescribeCustomRoutingAcceleratorAttributesRequest * const q)
