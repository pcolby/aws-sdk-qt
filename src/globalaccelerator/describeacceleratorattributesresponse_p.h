...
class QTAWS_EXPORT DescribeAcceleratorAttributesResponsePrivate : public GlobalAcceleratorResponsePrivate {

public:

    DescribeAcceleratorAttributesResponsePrivate(DescribeAcceleratorAttributesResponse * const q);
