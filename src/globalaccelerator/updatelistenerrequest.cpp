...
#include "updatelistenerrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::UpdateListenerRequest
 * \brief The UpdateListenerRequest class provides an interface for GlobalAccelerator UpdateListener requests.
 *
 ...
 */
UpdateListenerRequest::UpdateListenerRequest(const UpdateListenerRequest &other)
    : GlobalAcceleratorRequest(new UpdateListenerRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateListenerRequest object.
 */
UpdateListenerRequest::UpdateListenerRequest()
    : GlobalAcceleratorRequest(new UpdateListenerRequestPrivate(GlobalAcceleratorRequest::UpdateListenerAction, this))
{
 ...
 * \reimp
 */
bool UpdateListenerRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateListenerResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateListenerRequest::response(QNetworkReply * const reply) const
{
    return new UpdateListenerResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::UpdateListenerRequestPrivate
 * \brief The UpdateListenerRequestPrivate class provides private implementation for UpdateListenerRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a UpdateListenerRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
UpdateListenerRequestPrivate::UpdateListenerRequestPrivate(
    const GlobalAcceleratorRequest::Action action, UpdateListenerRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateListenerRequest
 * class' copy constructor.
 */
UpdateListenerRequestPrivate::UpdateListenerRequestPrivate(
    const UpdateListenerRequestPrivate &other, UpdateListenerRequest * const q)
