...
#include "describecustomroutingacceleratorattributesresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingAcceleratorAttributesResponse
 * \brief The DescribeCustomRoutingAcceleratorAttributesResponse class provides an interace for GlobalAccelerator DescribeCustomRoutingAcceleratorAttributes responses.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::describeCustomRoutingAcceleratorAttributes
 */

/*!
 * Constructs a DescribeCustomRoutingAcceleratorAttributesResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeCustomRoutingAcceleratorAttributesResponse::DescribeCustomRoutingAcceleratorAttributesResponse(
        const DescribeCustomRoutingAcceleratorAttributesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new DescribeCustomRoutingAcceleratorAttributesResponsePrivate(this), parent)
{
    setRequest(new DescribeCustomRoutingAcceleratorAttributesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeCustomRoutingAcceleratorAttributesRequest * DescribeCustomRoutingAcceleratorAttributesResponse::request() const
{
    Q_D(const DescribeCustomRoutingAcceleratorAttributesResponse);
    return static_cast<const DescribeCustomRoutingAcceleratorAttributesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator DescribeCustomRoutingAcceleratorAttributes \a response.
 */
void DescribeCustomRoutingAcceleratorAttributesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeCustomRoutingAcceleratorAttributesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingAcceleratorAttributesResponsePrivate
 * \brief The DescribeCustomRoutingAcceleratorAttributesResponsePrivate class provides private implementation for DescribeCustomRoutingAcceleratorAttributesResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DescribeCustomRoutingAcceleratorAttributesResponsePrivate object with public implementation \a q.
 */
DescribeCustomRoutingAcceleratorAttributesResponsePrivate::DescribeCustomRoutingAcceleratorAttributesResponsePrivate(
    DescribeCustomRoutingAcceleratorAttributesResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator DescribeCustomRoutingAcceleratorAttributes response element from \a xml.
 */
void DescribeCustomRoutingAcceleratorAttributesResponsePrivate::parseDescribeCustomRoutingAcceleratorAttributesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeCustomRoutingAcceleratorAttributesResponse"));
    Q_UNUSED(xml) ///< @todo
}
