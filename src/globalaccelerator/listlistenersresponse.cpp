...
#include "listlistenersresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListListenersResponse
 * \brief The ListListenersResponse class provides an interace for GlobalAccelerator ListListeners responses.
 *
...
/*!
 * Constructs a ListListenersResponse object for \a reply to \a request, with parent \a parent.
 */
ListListenersResponse::ListListenersResponse(
        const ListListenersRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new ListListenersResponsePrivate(this), parent)
{
    setRequest(new ListListenersRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator ListListeners \a response.
 */
void ListListenersResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListListenersResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::ListListenersResponsePrivate
 * \brief The ListListenersResponsePrivate class provides private implementation for ListListenersResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListListenersResponsePrivate object with public implementation \a q.
 */
ListListenersResponsePrivate::ListListenersResponsePrivate(
    ListListenersResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator ListListeners response element from \a xml.
 */
void ListListenersResponsePrivate::parseListListenersResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListListenersResponse"));
    Q_UNUSED(xml) ///< @todo
}
