...
#include "listcustomroutingportmappingsbydestinationrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingPortMappingsByDestinationRequest
 * \brief The ListCustomRoutingPortMappingsByDestinationRequest class provides an interface for GlobalAccelerator ListCustomRoutingPortMappingsByDestination requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::listCustomRoutingPortMappingsByDestination
 */

/*!
 * Constructs a copy of \a other.
 */
ListCustomRoutingPortMappingsByDestinationRequest::ListCustomRoutingPortMappingsByDestinationRequest(const ListCustomRoutingPortMappingsByDestinationRequest &other)
    : GlobalAcceleratorRequest(new ListCustomRoutingPortMappingsByDestinationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListCustomRoutingPortMappingsByDestinationRequest object.
 */
ListCustomRoutingPortMappingsByDestinationRequest::ListCustomRoutingPortMappingsByDestinationRequest()
    : GlobalAcceleratorRequest(new ListCustomRoutingPortMappingsByDestinationRequestPrivate(GlobalAcceleratorRequest::ListCustomRoutingPortMappingsByDestinationAction, this))
{
 ...
 * \reimp
 */
bool ListCustomRoutingPortMappingsByDestinationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListCustomRoutingPortMappingsByDestinationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListCustomRoutingPortMappingsByDestinationRequest::response(QNetworkReply * const reply) const
{
    return new ListCustomRoutingPortMappingsByDestinationResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingPortMappingsByDestinationRequestPrivate
 * \brief The ListCustomRoutingPortMappingsByDestinationRequestPrivate class provides private implementation for ListCustomRoutingPortMappingsByDestinationRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListCustomRoutingPortMappingsByDestinationRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
ListCustomRoutingPortMappingsByDestinationRequestPrivate::ListCustomRoutingPortMappingsByDestinationRequestPrivate(
    const GlobalAcceleratorRequest::Action action, ListCustomRoutingPortMappingsByDestinationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListCustomRoutingPortMappingsByDestinationRequest
 * class' copy constructor.
 */
ListCustomRoutingPortMappingsByDestinationRequestPrivate::ListCustomRoutingPortMappingsByDestinationRequestPrivate(
    const ListCustomRoutingPortMappingsByDestinationRequestPrivate &other, ListCustomRoutingPortMappingsByDestinationRequest * const q)
