...
#include "createendpointgrouprequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::CreateEndpointGroupRequest
 * \brief The CreateEndpointGroupRequest class provides an interface for GlobalAccelerator CreateEndpointGroup requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::createEndpointGroup
 */

/*!
 * Constructs a copy of \a other.
 */
CreateEndpointGroupRequest::CreateEndpointGroupRequest(const CreateEndpointGroupRequest &other)
    : GlobalAcceleratorRequest(new CreateEndpointGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateEndpointGroupRequest object.
 */
CreateEndpointGroupRequest::CreateEndpointGroupRequest()
    : GlobalAcceleratorRequest(new CreateEndpointGroupRequestPrivate(GlobalAcceleratorRequest::CreateEndpointGroupAction, this))
{
 ...
 * \reimp
 */
bool CreateEndpointGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateEndpointGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateEndpointGroupRequest::response(QNetworkReply * const reply) const
{
    return new CreateEndpointGroupResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::CreateEndpointGroupRequestPrivate
 * \brief The CreateEndpointGroupRequestPrivate class provides private implementation for CreateEndpointGroupRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a CreateEndpointGroupRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
CreateEndpointGroupRequestPrivate::CreateEndpointGroupRequestPrivate(
    const GlobalAcceleratorRequest::Action action, CreateEndpointGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateEndpointGroupRequest
 * class' copy constructor.
 */
CreateEndpointGroupRequestPrivate::CreateEndpointGroupRequestPrivate(
    const CreateEndpointGroupRequestPrivate &other, CreateEndpointGroupRequest * const q)
