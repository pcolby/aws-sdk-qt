...
class QTAWS_EXPORT UpdateCustomRoutingAcceleratorResponsePrivate : public GlobalAcceleratorResponsePrivate {

public:

    UpdateCustomRoutingAcceleratorResponsePrivate(UpdateCustomRoutingAcceleratorResponse * const q);
