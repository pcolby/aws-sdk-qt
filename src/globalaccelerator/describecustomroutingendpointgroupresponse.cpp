...
#include "describecustomroutingendpointgroupresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingEndpointGroupResponse
 * \brief The DescribeCustomRoutingEndpointGroupResponse class provides an interace for GlobalAccelerator DescribeCustomRoutingEndpointGroup responses.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::describeCustomRoutingEndpointGroup
 */

/*!
 * Constructs a DescribeCustomRoutingEndpointGroupResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeCustomRoutingEndpointGroupResponse::DescribeCustomRoutingEndpointGroupResponse(
        const DescribeCustomRoutingEndpointGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new DescribeCustomRoutingEndpointGroupResponsePrivate(this), parent)
{
    setRequest(new DescribeCustomRoutingEndpointGroupRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeCustomRoutingEndpointGroupRequest * DescribeCustomRoutingEndpointGroupResponse::request() const
{
    Q_D(const DescribeCustomRoutingEndpointGroupResponse);
    return static_cast<const DescribeCustomRoutingEndpointGroupRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator DescribeCustomRoutingEndpointGroup \a response.
 */
void DescribeCustomRoutingEndpointGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeCustomRoutingEndpointGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingEndpointGroupResponsePrivate
 * \brief The DescribeCustomRoutingEndpointGroupResponsePrivate class provides private implementation for DescribeCustomRoutingEndpointGroupResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DescribeCustomRoutingEndpointGroupResponsePrivate object with public implementation \a q.
 */
DescribeCustomRoutingEndpointGroupResponsePrivate::DescribeCustomRoutingEndpointGroupResponsePrivate(
    DescribeCustomRoutingEndpointGroupResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator DescribeCustomRoutingEndpointGroup response element from \a xml.
 */
void DescribeCustomRoutingEndpointGroupResponsePrivate::parseDescribeCustomRoutingEndpointGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeCustomRoutingEndpointGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
