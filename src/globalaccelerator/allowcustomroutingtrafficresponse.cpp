...
#include "allowcustomroutingtrafficresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::AllowCustomRoutingTrafficResponse
 * \brief The AllowCustomRoutingTrafficResponse class provides an interace for GlobalAccelerator AllowCustomRoutingTraffic responses.
 *
...
/*!
 * Constructs a AllowCustomRoutingTrafficResponse object for \a reply to \a request, with parent \a parent.
 */
AllowCustomRoutingTrafficResponse::AllowCustomRoutingTrafficResponse(
        const AllowCustomRoutingTrafficRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new AllowCustomRoutingTrafficResponsePrivate(this), parent)
{
    setRequest(new AllowCustomRoutingTrafficRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator AllowCustomRoutingTraffic \a response.
 */
void AllowCustomRoutingTrafficResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AllowCustomRoutingTrafficResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::AllowCustomRoutingTrafficResponsePrivate
 * \brief The AllowCustomRoutingTrafficResponsePrivate class provides private implementation for AllowCustomRoutingTrafficResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a AllowCustomRoutingTrafficResponsePrivate object with public implementation \a q.
 */
AllowCustomRoutingTrafficResponsePrivate::AllowCustomRoutingTrafficResponsePrivate(
    AllowCustomRoutingTrafficResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator AllowCustomRoutingTraffic response element from \a xml.
 */
void AllowCustomRoutingTrafficResponsePrivate::parseAllowCustomRoutingTrafficResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AllowCustomRoutingTrafficResponse"));
    Q_UNUSED(xml) ///< @todo
}
