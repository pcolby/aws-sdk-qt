...
#include "describecustomroutinglistenerrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingListenerRequest
 * \brief The DescribeCustomRoutingListenerRequest class provides an interface for GlobalAccelerator DescribeCustomRoutingListener requests.
 *
 ...
 */
DescribeCustomRoutingListenerRequest::DescribeCustomRoutingListenerRequest(const DescribeCustomRoutingListenerRequest &other)
    : GlobalAcceleratorRequest(new DescribeCustomRoutingListenerRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeCustomRoutingListenerRequest object.
 */
DescribeCustomRoutingListenerRequest::DescribeCustomRoutingListenerRequest()
    : GlobalAcceleratorRequest(new DescribeCustomRoutingListenerRequestPrivate(GlobalAcceleratorRequest::DescribeCustomRoutingListenerAction, this))
{
 ...
 * \reimp
 */
bool DescribeCustomRoutingListenerRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeCustomRoutingListenerResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeCustomRoutingListenerRequest::response(QNetworkReply * const reply) const
{
    return new DescribeCustomRoutingListenerResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingListenerRequestPrivate
 * \brief The DescribeCustomRoutingListenerRequestPrivate class provides private implementation for DescribeCustomRoutingListenerRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DescribeCustomRoutingListenerRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
DescribeCustomRoutingListenerRequestPrivate::DescribeCustomRoutingListenerRequestPrivate(
    const GlobalAcceleratorRequest::Action action, DescribeCustomRoutingListenerRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeCustomRoutingListenerRequest
 * class' copy constructor.
 */
DescribeCustomRoutingListenerRequestPrivate::DescribeCustomRoutingListenerRequestPrivate(
    const DescribeCustomRoutingListenerRequestPrivate &other, DescribeCustomRoutingListenerRequest * const q)
