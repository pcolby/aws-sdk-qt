...
/*!
 * \class QtAws::GlobalAccelerator::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for GlobalAccelerator TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : GlobalAcceleratorResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(GlobalAcceleratorResponse::request());
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator TagResource \a response.
 */
...
/*!
 * \class QtAws::GlobalAccelerator::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator TagResource response element from \a xml.
 */
