...
#include "createacceleratorresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::CreateAcceleratorResponse
 * \brief The CreateAcceleratorResponse class provides an interace for GlobalAccelerator CreateAccelerator responses.
 *
...
/*!
 * Constructs a CreateAcceleratorResponse object for \a reply to \a request, with parent \a parent.
 */
CreateAcceleratorResponse::CreateAcceleratorResponse(
        const CreateAcceleratorRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new CreateAcceleratorResponsePrivate(this), parent)
{
    setRequest(new CreateAcceleratorRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator CreateAccelerator \a response.
 */
void CreateAcceleratorResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateAcceleratorResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::CreateAcceleratorResponsePrivate
 * \brief The CreateAcceleratorResponsePrivate class provides private implementation for CreateAcceleratorResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a CreateAcceleratorResponsePrivate object with public implementation \a q.
 */
CreateAcceleratorResponsePrivate::CreateAcceleratorResponsePrivate(
    CreateAcceleratorResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator CreateAccelerator response element from \a xml.
 */
void CreateAcceleratorResponsePrivate::parseCreateAcceleratorResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateAcceleratorResponse"));
    Q_UNUSED(xml) ///< @todo
}
