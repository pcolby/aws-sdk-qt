...
#include "allowcustomroutingtrafficrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::AllowCustomRoutingTrafficRequest
 * \brief The AllowCustomRoutingTrafficRequest class provides an interface for GlobalAccelerator AllowCustomRoutingTraffic requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::allowCustomRoutingTraffic
 */

/*!
 * Constructs a copy of \a other.
 */
AllowCustomRoutingTrafficRequest::AllowCustomRoutingTrafficRequest(const AllowCustomRoutingTrafficRequest &other)
    : GlobalAcceleratorRequest(new AllowCustomRoutingTrafficRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AllowCustomRoutingTrafficRequest object.
 */
AllowCustomRoutingTrafficRequest::AllowCustomRoutingTrafficRequest()
    : GlobalAcceleratorRequest(new AllowCustomRoutingTrafficRequestPrivate(GlobalAcceleratorRequest::AllowCustomRoutingTrafficAction, this))
{
 ...
 * \reimp
 */
bool AllowCustomRoutingTrafficRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AllowCustomRoutingTrafficResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AllowCustomRoutingTrafficRequest::response(QNetworkReply * const reply) const
{
    return new AllowCustomRoutingTrafficResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::AllowCustomRoutingTrafficRequestPrivate
 * \brief The AllowCustomRoutingTrafficRequestPrivate class provides private implementation for AllowCustomRoutingTrafficRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a AllowCustomRoutingTrafficRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
AllowCustomRoutingTrafficRequestPrivate::AllowCustomRoutingTrafficRequestPrivate(
    const GlobalAcceleratorRequest::Action action, AllowCustomRoutingTrafficRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AllowCustomRoutingTrafficRequest
 * class' copy constructor.
 */
AllowCustomRoutingTrafficRequestPrivate::AllowCustomRoutingTrafficRequestPrivate(
    const AllowCustomRoutingTrafficRequestPrivate &other, AllowCustomRoutingTrafficRequest * const q)
