...
#include "listcustomroutingportmappingsrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingPortMappingsRequest
 * \brief The ListCustomRoutingPortMappingsRequest class provides an interface for GlobalAccelerator ListCustomRoutingPortMappings requests.
 *
 ...
 */
ListCustomRoutingPortMappingsRequest::ListCustomRoutingPortMappingsRequest(const ListCustomRoutingPortMappingsRequest &other)
    : GlobalAcceleratorRequest(new ListCustomRoutingPortMappingsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListCustomRoutingPortMappingsRequest object.
 */
ListCustomRoutingPortMappingsRequest::ListCustomRoutingPortMappingsRequest()
    : GlobalAcceleratorRequest(new ListCustomRoutingPortMappingsRequestPrivate(GlobalAcceleratorRequest::ListCustomRoutingPortMappingsAction, this))
{
 ...
 * \reimp
 */
bool ListCustomRoutingPortMappingsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListCustomRoutingPortMappingsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListCustomRoutingPortMappingsRequest::response(QNetworkReply * const reply) const
{
    return new ListCustomRoutingPortMappingsResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::ListCustomRoutingPortMappingsRequestPrivate
 * \brief The ListCustomRoutingPortMappingsRequestPrivate class provides private implementation for ListCustomRoutingPortMappingsRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListCustomRoutingPortMappingsRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
ListCustomRoutingPortMappingsRequestPrivate::ListCustomRoutingPortMappingsRequestPrivate(
    const GlobalAcceleratorRequest::Action action, ListCustomRoutingPortMappingsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListCustomRoutingPortMappingsRequest
 * class' copy constructor.
 */
ListCustomRoutingPortMappingsRequestPrivate::ListCustomRoutingPortMappingsRequestPrivate(
    const ListCustomRoutingPortMappingsRequestPrivate &other, ListCustomRoutingPortMappingsRequest * const q)
