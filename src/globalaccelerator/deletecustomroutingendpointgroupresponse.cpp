...
#include "deletecustomroutingendpointgroupresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DeleteCustomRoutingEndpointGroupResponse
 * \brief The DeleteCustomRoutingEndpointGroupResponse class provides an interace for GlobalAccelerator DeleteCustomRoutingEndpointGroup responses.
 *
...
/*!
 * Constructs a DeleteCustomRoutingEndpointGroupResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteCustomRoutingEndpointGroupResponse::DeleteCustomRoutingEndpointGroupResponse(
        const DeleteCustomRoutingEndpointGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new DeleteCustomRoutingEndpointGroupResponsePrivate(this), parent)
{
    setRequest(new DeleteCustomRoutingEndpointGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator DeleteCustomRoutingEndpointGroup \a response.
 */
void DeleteCustomRoutingEndpointGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteCustomRoutingEndpointGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::DeleteCustomRoutingEndpointGroupResponsePrivate
 * \brief The DeleteCustomRoutingEndpointGroupResponsePrivate class provides private implementation for DeleteCustomRoutingEndpointGroupResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DeleteCustomRoutingEndpointGroupResponsePrivate object with public implementation \a q.
 */
DeleteCustomRoutingEndpointGroupResponsePrivate::DeleteCustomRoutingEndpointGroupResponsePrivate(
    DeleteCustomRoutingEndpointGroupResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator DeleteCustomRoutingEndpointGroup response element from \a xml.
 */
void DeleteCustomRoutingEndpointGroupResponsePrivate::parseDeleteCustomRoutingEndpointGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteCustomRoutingEndpointGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
