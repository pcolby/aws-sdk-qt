...
#include "listlistenersrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListListenersRequest
 * \brief The ListListenersRequest class provides an interface for GlobalAccelerator ListListeners requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::listListeners
 */

/*!
 * Constructs a copy of \a other.
 */
ListListenersRequest::ListListenersRequest(const ListListenersRequest &other)
    : GlobalAcceleratorRequest(new ListListenersRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListListenersRequest object.
 */
ListListenersRequest::ListListenersRequest()
    : GlobalAcceleratorRequest(new ListListenersRequestPrivate(GlobalAcceleratorRequest::ListListenersAction, this))
{
 ...
 * \reimp
 */
bool ListListenersRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListListenersResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListListenersRequest::response(QNetworkReply * const reply) const
{
    return new ListListenersResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::ListListenersRequestPrivate
 * \brief The ListListenersRequestPrivate class provides private implementation for ListListenersRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListListenersRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
ListListenersRequestPrivate::ListListenersRequestPrivate(
    const GlobalAcceleratorRequest::Action action, ListListenersRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListListenersRequest
 * class' copy constructor.
 */
ListListenersRequestPrivate::ListListenersRequestPrivate(
    const ListListenersRequestPrivate &other, ListListenersRequest * const q)
