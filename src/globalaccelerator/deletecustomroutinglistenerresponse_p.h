...
class QTAWS_EXPORT DeleteCustomRoutingListenerResponsePrivate : public GlobalAcceleratorResponsePrivate {

public:

    DeleteCustomRoutingListenerResponsePrivate(DeleteCustomRoutingListenerResponse * const q);
