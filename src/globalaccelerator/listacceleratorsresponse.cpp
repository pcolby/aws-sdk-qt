...
#include "listacceleratorsresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListAcceleratorsResponse
 * \brief The ListAcceleratorsResponse class provides an interace for GlobalAccelerator ListAccelerators responses.
 *
...
/*!
 * Constructs a ListAcceleratorsResponse object for \a reply to \a request, with parent \a parent.
 */
ListAcceleratorsResponse::ListAcceleratorsResponse(
        const ListAcceleratorsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new ListAcceleratorsResponsePrivate(this), parent)
{
    setRequest(new ListAcceleratorsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator ListAccelerators \a response.
 */
void ListAcceleratorsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListAcceleratorsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::ListAcceleratorsResponsePrivate
 * \brief The ListAcceleratorsResponsePrivate class provides private implementation for ListAcceleratorsResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListAcceleratorsResponsePrivate object with public implementation \a q.
 */
ListAcceleratorsResponsePrivate::ListAcceleratorsResponsePrivate(
    ListAcceleratorsResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator ListAccelerators response element from \a xml.
 */
void ListAcceleratorsResponsePrivate::parseListAcceleratorsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListAcceleratorsResponse"));
    Q_UNUSED(xml) ///< @todo
}
