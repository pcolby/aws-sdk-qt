...
#include "createcustomroutinglistenerrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::CreateCustomRoutingListenerRequest
 * \brief The CreateCustomRoutingListenerRequest class provides an interface for GlobalAccelerator CreateCustomRoutingListener requests.
 *
 ...
 */
CreateCustomRoutingListenerRequest::CreateCustomRoutingListenerRequest(const CreateCustomRoutingListenerRequest &other)
    : GlobalAcceleratorRequest(new CreateCustomRoutingListenerRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateCustomRoutingListenerRequest object.
 */
CreateCustomRoutingListenerRequest::CreateCustomRoutingListenerRequest()
    : GlobalAcceleratorRequest(new CreateCustomRoutingListenerRequestPrivate(GlobalAcceleratorRequest::CreateCustomRoutingListenerAction, this))
{
 ...
 * \reimp
 */
bool CreateCustomRoutingListenerRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateCustomRoutingListenerResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateCustomRoutingListenerRequest::response(QNetworkReply * const reply) const
{
    return new CreateCustomRoutingListenerResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::CreateCustomRoutingListenerRequestPrivate
 * \brief The CreateCustomRoutingListenerRequestPrivate class provides private implementation for CreateCustomRoutingListenerRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a CreateCustomRoutingListenerRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
CreateCustomRoutingListenerRequestPrivate::CreateCustomRoutingListenerRequestPrivate(
    const GlobalAcceleratorRequest::Action action, CreateCustomRoutingListenerRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateCustomRoutingListenerRequest
 * class' copy constructor.
 */
CreateCustomRoutingListenerRequestPrivate::CreateCustomRoutingListenerRequestPrivate(
    const CreateCustomRoutingListenerRequestPrivate &other, CreateCustomRoutingListenerRequest * const q)
