...
#include "describelistenerresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DescribeListenerResponse
 * \brief The DescribeListenerResponse class provides an interace for GlobalAccelerator DescribeListener responses.
 *
...
/*!
 * Constructs a DescribeListenerResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeListenerResponse::DescribeListenerResponse(
        const DescribeListenerRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new DescribeListenerResponsePrivate(this), parent)
{
    setRequest(new DescribeListenerRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator DescribeListener \a response.
 */
void DescribeListenerResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeListenerResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::DescribeListenerResponsePrivate
 * \brief The DescribeListenerResponsePrivate class provides private implementation for DescribeListenerResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DescribeListenerResponsePrivate object with public implementation \a q.
 */
DescribeListenerResponsePrivate::DescribeListenerResponsePrivate(
    DescribeListenerResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator DescribeListener response element from \a xml.
 */
void DescribeListenerResponsePrivate::parseDescribeListenerResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeListenerResponse"));
    Q_UNUSED(xml) ///< @todo
}
