...
#include "deleteacceleratorresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DeleteAcceleratorResponse
 * \brief The DeleteAcceleratorResponse class provides an interace for GlobalAccelerator DeleteAccelerator responses.
 *
...
/*!
 * Constructs a DeleteAcceleratorResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteAcceleratorResponse::DeleteAcceleratorResponse(
        const DeleteAcceleratorRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new DeleteAcceleratorResponsePrivate(this), parent)
{
    setRequest(new DeleteAcceleratorRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator DeleteAccelerator \a response.
 */
void DeleteAcceleratorResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteAcceleratorResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::DeleteAcceleratorResponsePrivate
 * \brief The DeleteAcceleratorResponsePrivate class provides private implementation for DeleteAcceleratorResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DeleteAcceleratorResponsePrivate object with public implementation \a q.
 */
DeleteAcceleratorResponsePrivate::DeleteAcceleratorResponsePrivate(
    DeleteAcceleratorResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator DeleteAccelerator response element from \a xml.
 */
void DeleteAcceleratorResponsePrivate::parseDeleteAcceleratorResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteAcceleratorResponse"));
    Q_UNUSED(xml) ///< @todo
}
