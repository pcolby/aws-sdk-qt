...
#include "listbyoipcidrsresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::ListByoipCidrsResponse
 * \brief The ListByoipCidrsResponse class provides an interace for GlobalAccelerator ListByoipCidrs responses.
 *
...
/*!
 * Constructs a ListByoipCidrsResponse object for \a reply to \a request, with parent \a parent.
 */
ListByoipCidrsResponse::ListByoipCidrsResponse(
        const ListByoipCidrsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new ListByoipCidrsResponsePrivate(this), parent)
{
    setRequest(new ListByoipCidrsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful GlobalAccelerator ListByoipCidrs \a response.
 */
void ListByoipCidrsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListByoipCidrsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::ListByoipCidrsResponsePrivate
 * \brief The ListByoipCidrsResponsePrivate class provides private implementation for ListByoipCidrsResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a ListByoipCidrsResponsePrivate object with public implementation \a q.
 */
ListByoipCidrsResponsePrivate::ListByoipCidrsResponsePrivate(
    ListByoipCidrsResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator ListByoipCidrs response element from \a xml.
 */
void ListByoipCidrsResponsePrivate::parseListByoipCidrsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListByoipCidrsResponse"));
    Q_UNUSED(xml) ///< @todo
}
