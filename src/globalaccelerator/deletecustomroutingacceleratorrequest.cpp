...
#include "deletecustomroutingacceleratorrequest_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DeleteCustomRoutingAcceleratorRequest
 * \brief The DeleteCustomRoutingAcceleratorRequest class provides an interface for GlobalAccelerator DeleteCustomRoutingAccelerator requests.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::deleteCustomRoutingAccelerator
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteCustomRoutingAcceleratorRequest::DeleteCustomRoutingAcceleratorRequest(const DeleteCustomRoutingAcceleratorRequest &other)
    : GlobalAcceleratorRequest(new DeleteCustomRoutingAcceleratorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteCustomRoutingAcceleratorRequest object.
 */
DeleteCustomRoutingAcceleratorRequest::DeleteCustomRoutingAcceleratorRequest()
    : GlobalAcceleratorRequest(new DeleteCustomRoutingAcceleratorRequestPrivate(GlobalAcceleratorRequest::DeleteCustomRoutingAcceleratorAction, this))
{
 ...
 * \reimp
 */
bool DeleteCustomRoutingAcceleratorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteCustomRoutingAcceleratorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteCustomRoutingAcceleratorRequest::response(QNetworkReply * const reply) const
{
    return new DeleteCustomRoutingAcceleratorResponse(*this, reply);
}

/*!
 * \class QtAws::GlobalAccelerator::DeleteCustomRoutingAcceleratorRequestPrivate
 * \brief The DeleteCustomRoutingAcceleratorRequestPrivate class provides private implementation for DeleteCustomRoutingAcceleratorRequest.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DeleteCustomRoutingAcceleratorRequestPrivate object for GlobalAccelerator \a action,
 * with public implementation \a q.
 */
DeleteCustomRoutingAcceleratorRequestPrivate::DeleteCustomRoutingAcceleratorRequestPrivate(
    const GlobalAcceleratorRequest::Action action, DeleteCustomRoutingAcceleratorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteCustomRoutingAcceleratorRequest
 * class' copy constructor.
 */
DeleteCustomRoutingAcceleratorRequestPrivate::DeleteCustomRoutingAcceleratorRequestPrivate(
    const DeleteCustomRoutingAcceleratorRequestPrivate &other, DeleteCustomRoutingAcceleratorRequest * const q)
