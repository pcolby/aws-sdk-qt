...
#include "describecustomroutingacceleratorresponse_p.h"
...
/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingAcceleratorResponse
 * \brief The DescribeCustomRoutingAcceleratorResponse class provides an interace for GlobalAccelerator DescribeCustomRoutingAccelerator responses.
 *
 ...
 *
 * \sa GlobalAcceleratorClient::describeCustomRoutingAccelerator
 */

/*!
 * Constructs a DescribeCustomRoutingAcceleratorResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeCustomRoutingAcceleratorResponse::DescribeCustomRoutingAcceleratorResponse(
        const DescribeCustomRoutingAcceleratorRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : GlobalAcceleratorResponse(new DescribeCustomRoutingAcceleratorResponsePrivate(this), parent)
{
    setRequest(new DescribeCustomRoutingAcceleratorRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeCustomRoutingAcceleratorRequest * DescribeCustomRoutingAcceleratorResponse::request() const
{
    Q_D(const DescribeCustomRoutingAcceleratorResponse);
    return static_cast<const DescribeCustomRoutingAcceleratorRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful GlobalAccelerator DescribeCustomRoutingAccelerator \a response.
 */
void DescribeCustomRoutingAcceleratorResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeCustomRoutingAcceleratorResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::GlobalAccelerator::DescribeCustomRoutingAcceleratorResponsePrivate
 * \brief The DescribeCustomRoutingAcceleratorResponsePrivate class provides private implementation for DescribeCustomRoutingAcceleratorResponse.
 * \internal
 *
 * \inmodule QtAwsGlobalAccelerator
 */
...
/*!
 * Constructs a DescribeCustomRoutingAcceleratorResponsePrivate object with public implementation \a q.
 */
DescribeCustomRoutingAcceleratorResponsePrivate::DescribeCustomRoutingAcceleratorResponsePrivate(
    DescribeCustomRoutingAcceleratorResponse * const q) : GlobalAcceleratorResponsePrivate(q)
{

}

/*!
 * Parses a GlobalAccelerator DescribeCustomRoutingAccelerator response element from \a xml.
 */
void DescribeCustomRoutingAcceleratorResponsePrivate::parseDescribeCustomRoutingAcceleratorResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeCustomRoutingAcceleratorResponse"));
    Q_UNUSED(xml) ///< @todo
}
