...
class QTAWS_EXPORT CreateDirectConnectGatewayResponse : public DirectConnectResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateDirectConnectGatewayRequest * request() const override;
