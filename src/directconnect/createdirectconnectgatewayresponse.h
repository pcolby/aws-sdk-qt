...
class QTAWS_EXPORT CreateDirectConnectGatewayResponse : public CreateDirectConnectGatewayResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateDirectConnectGatewayRequest * request() const;
