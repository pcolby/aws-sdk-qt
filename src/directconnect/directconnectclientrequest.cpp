...
/**
 * @brief  Constructs a new DirectConnectClientRequest object.
 *
...
/**
 * @brief  Constructs a new DirectConnectClientRequest object by copying another.
 *
 ...
 */
DirectConnectClientRequest& DirectConnectClientRequest::operator=(const DirectConnectClientRequest &other)
{
    Q_D(DirectConnectClientRequest);
 ...
 * implementation that inherits from DirectConnectClientRequestPrivate.
 *
 ...
 */
DirectConnectClientRequest::Action DirectConnectClientRequest::action() const
{
    Q_D(const DirectConnectClientRequest);
    return d->action;
}
 ...
 */
QString DirectConnectClientRequest::actionString() const
{
    return DirectConnectClientRequestPrivate::toString(action());
}
 ...
 */
QString DirectConnectClientRequest::apiVersion() const
{
    Q_D(const DirectConnectClientRequest);
    return d->apiVersion;
}
 ...
 */
void DirectConnectClientRequest::setAction(const Action action)
{
    Q_D(DirectConnectClientRequest);
    d->action = action;
}
 ...
 */
void DirectConnectClientRequest::setApiVersion(const QString &version)
{
    Q_D(DirectConnectClientRequest);
 ...
 */
bool DirectConnectClientRequest::operator==(const DirectConnectClientRequest &other) const
{
 ...
 */
bool DirectConnectClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int DirectConnectClientRequest::clearParameter(const QString &name)
{
    Q_D(DirectConnectClientRequest);
 ...
 */
void DirectConnectClientRequest::clearParameters()
{
    Q_D(DirectConnectClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant DirectConnectClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const DirectConnectClientRequest);
 ...
 */
const QVariantMap &DirectConnectClientRequest::parameters() const
{
    Q_D(const DirectConnectClientRequest);
    return d->parameters;
}
 ...
 */
void DirectConnectClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(DirectConnectClientRequest);
 ...
 */
void DirectConnectClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(DirectConnectClientRequest);
 ...
 */
QNetworkRequest DirectConnectClientRequest::unsignedRequest(const QUrl &endpoint) const
{
    Q_D(const DirectConnectClientRequest);
    QUrl url(endpoint);
 ...
 *
 * @brief  Private implementation for DirectConnectClientRequest.
 */

/**
 * @internal
 *
 * @brief  Constructs a new DirectConnectClientRequestPrivate object.
 *
 ...
 * @internal
 *
 * @brief  Constructs a new DirectConnectClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the DirectConnectClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public DirectConnectClientRequest instance.
 */
 ...
 *
 * This function converts DirectConnectClientRequest::Action enumerator values to their respective
 ...
 */
QString DirectConnectClientRequestPrivate::toString(const DirectConnectClientRequest::Action &action)
{
    #define ActionToString(action) \
        case DirectConnectClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
