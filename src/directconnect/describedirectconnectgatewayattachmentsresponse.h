...
class QTAWS_EXPORT DescribeDirectConnectGatewayAttachmentsResponse : public DirectConnectResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeDirectConnectGatewayAttachmentsRequest * request() const override;
