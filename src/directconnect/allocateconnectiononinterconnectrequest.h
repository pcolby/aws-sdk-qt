...
#ifndef QTAWS_ALLOCATECONNECTIONONINTERCONNECTREQUEST_H
#define QTAWS_ALLOCATECONNECTIONONINTERCONNECTREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(AllocateConnectionOnInterconnectRequest)
