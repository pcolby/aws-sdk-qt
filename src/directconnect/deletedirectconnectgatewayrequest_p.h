...
class QTAWS_EXPORT DeleteDirectConnectGatewayRequestPrivate : public DirectConnectPrivate {

public:
    DeleteDirectConnectGatewayRequestPrivate(const DirectConnect::Action action,
