...
class QTAWS_EXPORT DescribeVirtualInterfacesResponse : public DirectConnectResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeVirtualInterfacesRequest * request() const override;
