...
class QTAWS_EXPORT AssociateHostedConnectionResponse : public DirectConnectResponse {
    Q_OBJECT
...
public:
    ...
    virtual const AssociateHostedConnectionRequest * request() const override;
