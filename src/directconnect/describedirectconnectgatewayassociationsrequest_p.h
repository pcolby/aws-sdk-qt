...
class QTAWS_EXPORT DescribeDirectConnectGatewayAssociationsRequestPrivate : public DirectConnectRequestPrivate {

public:
    DescribeDirectConnectGatewayAssociationsRequestPrivate(const DirectConnect::Action action,
