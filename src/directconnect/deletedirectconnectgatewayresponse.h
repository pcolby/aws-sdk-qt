...
class QTAWS_EXPORT DeleteDirectConnectGatewayResponse : public DirectConnectResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteDirectConnectGatewayRequest * request() const override;
