...
class QTAWS_EXPORT ConfirmPrivateVirtualInterfaceResponse : public DirectConnectResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ConfirmPrivateVirtualInterfaceRequest * request() const override;
