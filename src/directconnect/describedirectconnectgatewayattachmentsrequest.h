...
#ifndef QTAWS_DESCRIBEDIRECTCONNECTGATEWAYATTACHMENTSREQUEST_H
#define QTAWS_DESCRIBEDIRECTCONNECTGATEWAYATTACHMENTSREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(DescribeDirectConnectGatewayAttachmentsRequest)
