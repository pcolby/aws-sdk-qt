...
class QTAWSDIRECTCONNECT_EXPORT DisassociateConnectionFromLagResponse : public DirectConnectResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DisassociateConnectionFromLagRequest * request() const Q_DECL_OVERRIDE;
