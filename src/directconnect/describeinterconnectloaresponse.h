...
class QTAWSDIRECTCONNECT_EXPORT DescribeInterconnectLoaResponse : public DirectConnectResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeInterconnectLoaRequest * request() const Q_DECL_OVERRIDE;
