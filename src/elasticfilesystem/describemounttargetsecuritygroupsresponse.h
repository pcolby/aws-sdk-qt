...
class QTAWS_EXPORT DescribeMountTargetSecurityGroupsResponse : public DescribeMountTargetSecurityGroupsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeMountTargetSecurityGroupsRequest * request() const;
