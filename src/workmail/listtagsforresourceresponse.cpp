...
/*!
 * \class QtAws::WorkMail::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for WorkMail ListTagsForResource responses.
 *
 ...
 *  using the IAM
 *
 * \sa WorkMailClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : WorkMailResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(WorkMailResponse::request());
}

/*!
 * \reimp
 * Parses a successful WorkMail ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::WorkMail::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : WorkMailResponsePrivate(q)
{

}

/*!
 * Parses a WorkMail ListTagsForResource response element from \a xml.
 */
