...
/*!
 * \class QtAws::WorkMail::DeleteRetentionPolicyResponse
 * \brief The DeleteRetentionPolicyResponse class provides an interace for WorkMail DeleteRetentionPolicy responses.
 *
...
DeleteRetentionPolicyResponse::DeleteRetentionPolicyResponse(
    ...
    : WorkMailResponse(new DeleteRetentionPolicyResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WorkMail DeleteRetentionPolicy \a response.
 */
...
/*!
 * \class QtAws::WorkMail::DeleteRetentionPolicyResponsePrivate
...
DeleteRetentionPolicyResponsePrivate::DeleteRetentionPolicyResponsePrivate(
    DeleteRetentionPolicyResponse * const q) : WorkMailResponsePrivate(q)
{

}

/*!
 * Parses a WorkMail DeleteRetentionPolicy response element from \a xml.
 */
