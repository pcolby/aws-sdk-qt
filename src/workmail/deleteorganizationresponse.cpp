...
/*!
 * \class QtAws::WorkMail::DeleteOrganizationResponse
 * \brief The DeleteOrganizationResponse class provides an interace for WorkMail DeleteOrganization responses.
 *
...
DeleteOrganizationResponse::DeleteOrganizationResponse(
    ...
    : WorkMailResponse(new DeleteOrganizationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WorkMail DeleteOrganization \a response.
 */
...
/*!
 * \class QtAws::WorkMail::DeleteOrganizationResponsePrivate
 * \brief The DeleteOrganizationResponsePrivate class provides private implementation for DeleteOrganizationResponse.
 * \internal
 *
 * \inmodule QtAwsWorkMail
 */
...
/*!
 * Constructs a DeleteOrganizationResponsePrivate object with public implementation \a q.
 */
DeleteOrganizationResponsePrivate::DeleteOrganizationResponsePrivate(
    DeleteOrganizationResponse * const q) : WorkMailResponsePrivate(q)
{

}

/*!
 * Parses a WorkMail DeleteOrganization response element from \a xml.
 */
