...
/*!
 * \class QtAws::IoTFleetHub::DeleteApplicationResponse
 * \brief The DeleteApplicationResponse class provides an interace for IoTFleetHub DeleteApplication responses.
 *
...
DeleteApplicationResponse::DeleteApplicationResponse(
    ...
    : IoTFleetHubResponse(new DeleteApplicationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IoTFleetHub DeleteApplication \a response.
 */
...
/*!
 * \class QtAws::IoTFleetHub::DeleteApplicationResponsePrivate
...
DeleteApplicationResponsePrivate::DeleteApplicationResponsePrivate(
    DeleteApplicationResponse * const q) : IoTFleetHubResponsePrivate(q)
{

}

/*!
 * Parses a IoTFleetHub DeleteApplication response element from \a xml.
 */
