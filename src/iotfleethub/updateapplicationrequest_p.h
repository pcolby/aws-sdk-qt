...
class QTAWS_EXPORT UpdateApplicationRequestPrivate : public IoTFleetHubRequestPrivate {

public:
    UpdateApplicationRequestPrivate(const IoTFleetHubRequest::Action action,
