...
/*!
 * \class QtAws::IoTFleetHub::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for IoTFleetHub ListTagsForResource responses.
 *
 ...
 *
 * \sa IoTFleetHubClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : IoTFleetHubResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(IoTFleetHubResponse::request());
}

/*!
 * \reimp
 * Parses a successful IoTFleetHub ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::IoTFleetHub::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : IoTFleetHubResponsePrivate(q)
{

}

/*!
 * Parses a IoTFleetHub ListTagsForResource response element from \a xml.
 */
