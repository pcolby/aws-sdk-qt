...
/*!
 * \class QtAws::IoTFleetHub::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for IoTFleetHub UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : IoTFleetHubResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(IoTFleetHubResponse::request());
}

/*!
 * \reimp
 * Parses a successful IoTFleetHub UntagResource \a response.
 */
...
/*!
 * \class QtAws::IoTFleetHub::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : IoTFleetHubResponsePrivate(q)
{

}

/*!
 * Parses a IoTFleetHub UntagResource response element from \a xml.
 */
