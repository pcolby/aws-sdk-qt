...
class QTAWS_EXPORT DisassociateWirelessGatewayFromThingResponsePrivate : public IoTWirelessResponsePrivate {

public:

    DisassociateWirelessGatewayFromThingResponsePrivate(DisassociateWirelessGatewayFromThingResponse * const q);
