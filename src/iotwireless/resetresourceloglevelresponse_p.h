...
class QTAWS_EXPORT ResetResourceLogLevelResponsePrivate : public IoTWirelessResponsePrivate {

public:

    ResetResourceLogLevelResponsePrivate(ResetResourceLogLevelResponse * const q);
