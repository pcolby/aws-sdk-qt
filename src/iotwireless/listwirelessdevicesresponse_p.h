...
class QTAWS_EXPORT ListWirelessDevicesResponsePrivate : public IoTWirelessResponsePrivate {

public:

    ListWirelessDevicesResponsePrivate(ListWirelessDevicesResponse * const q);
