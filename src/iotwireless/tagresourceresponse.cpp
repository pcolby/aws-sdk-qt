...
/*!
 * \class QtAws::IoTWireless::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for IoTWireless TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : IoTWirelessResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(IoTWirelessResponse::request());
}

/*!
 * \reimp
 * Parses a successful IoTWireless TagResource \a response.
 */
...
/*!
 * \class QtAws::IoTWireless::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : IoTWirelessResponsePrivate(q)
{

}

/*!
 * Parses a IoTWireless TagResource response element from \a xml.
 */
