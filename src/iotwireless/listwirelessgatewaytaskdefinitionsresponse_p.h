...
class QTAWS_EXPORT ListWirelessGatewayTaskDefinitionsResponsePrivate : public IoTWirelessResponsePrivate {

public:

    ListWirelessGatewayTaskDefinitionsResponsePrivate(ListWirelessGatewayTaskDefinitionsResponse * const q);
