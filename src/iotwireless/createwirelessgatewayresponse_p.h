...
class QTAWS_EXPORT CreateWirelessGatewayResponsePrivate : public IoTWirelessResponsePrivate {

public:

    CreateWirelessGatewayResponsePrivate(CreateWirelessGatewayResponse * const q);
