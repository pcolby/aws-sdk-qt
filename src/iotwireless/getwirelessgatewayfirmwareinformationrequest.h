...
#ifndef QTAWS_GETWIRELESSGATEWAYFIRMWAREINFORMATIONREQUEST_H
#define QTAWS_GETWIRELESSGATEWAYFIRMWAREINFORMATIONREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(GetWirelessGatewayFirmwareInformationRequest)
