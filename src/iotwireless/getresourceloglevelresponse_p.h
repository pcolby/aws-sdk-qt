...
class QTAWS_EXPORT GetResourceLogLevelResponsePrivate : public IoTWirelessResponsePrivate {

public:

    GetResourceLogLevelResponsePrivate(GetResourceLogLevelResponse * const q);
