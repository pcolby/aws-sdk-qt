...
class QTAWS_EXPORT GetWirelessGatewayStatisticsResponsePrivate : public IoTWirelessResponsePrivate {

public:

    GetWirelessGatewayStatisticsResponsePrivate(GetWirelessGatewayStatisticsResponse * const q);
