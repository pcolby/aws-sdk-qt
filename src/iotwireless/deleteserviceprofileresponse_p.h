...
class QTAWS_EXPORT DeleteServiceProfileResponsePrivate : public IoTWirelessResponsePrivate {

public:

    DeleteServiceProfileResponsePrivate(DeleteServiceProfileResponse * const q);
