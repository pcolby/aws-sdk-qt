...
class QTAWS_EXPORT UpdateWirelessGatewayResponsePrivate : public IoTWirelessResponsePrivate {

public:

    UpdateWirelessGatewayResponsePrivate(UpdateWirelessGatewayResponse * const q);
