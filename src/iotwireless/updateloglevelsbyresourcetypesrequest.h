...
#ifndef QTAWS_UPDATELOGLEVELSBYRESOURCETYPESREQUEST_H
#define QTAWS_UPDATELOGLEVELSBYRESOURCETYPESREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(UpdateLogLevelsByResourceTypesRequest)
