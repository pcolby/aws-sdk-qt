...
class QTAWS_EXPORT GetWirelessDeviceStatisticsResponsePrivate : public IoTWirelessResponsePrivate {

public:

    GetWirelessDeviceStatisticsResponsePrivate(GetWirelessDeviceStatisticsResponse * const q);
