...
class QTAWS_EXPORT GetWirelessDeviceResponsePrivate : public IoTWirelessResponsePrivate {

public:

    GetWirelessDeviceResponsePrivate(GetWirelessDeviceResponse * const q);
