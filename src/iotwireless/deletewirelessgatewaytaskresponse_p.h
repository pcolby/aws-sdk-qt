...
class QTAWS_EXPORT DeleteWirelessGatewayTaskResponsePrivate : public IoTWirelessResponsePrivate {

public:

    DeleteWirelessGatewayTaskResponsePrivate(DeleteWirelessGatewayTaskResponse * const q);
