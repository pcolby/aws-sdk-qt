...
class QTAWS_EXPORT GetWirelessGatewayTaskResponsePrivate : public IoTWirelessResponsePrivate {

public:

    GetWirelessGatewayTaskResponsePrivate(GetWirelessGatewayTaskResponse * const q);
