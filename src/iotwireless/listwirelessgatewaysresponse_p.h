...
class QTAWS_EXPORT ListWirelessGatewaysResponsePrivate : public IoTWirelessResponsePrivate {

public:

    ListWirelessGatewaysResponsePrivate(ListWirelessGatewaysResponse * const q);
