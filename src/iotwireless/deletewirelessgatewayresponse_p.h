...
class QTAWS_EXPORT DeleteWirelessGatewayResponsePrivate : public IoTWirelessResponsePrivate {

public:

    DeleteWirelessGatewayResponsePrivate(DeleteWirelessGatewayResponse * const q);
