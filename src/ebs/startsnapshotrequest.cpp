...
#include "startsnapshotrequest_p.h"
...
/*!
 * \class QtAws::Ebs::StartSnapshotRequest
 * \brief The StartSnapshotRequest class provides an interface for Ebs StartSnapshot requests.
 *
 * \inmodule QtAwsEbs
 *
 ...
 */
StartSnapshotRequest::StartSnapshotRequest(const StartSnapshotRequest &other)
    : EbsRequest(new StartSnapshotRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a StartSnapshotRequest object.
 */
StartSnapshotRequest::StartSnapshotRequest()
    : EbsRequest(new StartSnapshotRequestPrivate(EbsRequest::StartSnapshotAction, this))
{
 ...
 * \reimp
 */
bool StartSnapshotRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a StartSnapshotResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * StartSnapshotRequest::response(QNetworkReply * const reply) const
{
    return new StartSnapshotResponse(*this, reply);
}

/*!
 * \class QtAws::Ebs::StartSnapshotRequestPrivate
 * \brief The StartSnapshotRequestPrivate class provides private implementation for StartSnapshotRequest.
 * \internal
 *
 * \inmodule QtAwsEbs
 */
...
/*!
 * Constructs a StartSnapshotRequestPrivate object for Ebs \a action,
 * with public implementation \a q.
 */
StartSnapshotRequestPrivate::StartSnapshotRequestPrivate(
    const EbsRequest::Action action, StartSnapshotRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the StartSnapshotRequest
 * class' copy constructor.
 */
StartSnapshotRequestPrivate::StartSnapshotRequestPrivate(
    const StartSnapshotRequestPrivate &other, StartSnapshotRequest * const q)
