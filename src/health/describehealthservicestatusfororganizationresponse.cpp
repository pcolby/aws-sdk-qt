...
#include "describehealthservicestatusfororganizationresponse_p.h"
...
/*!
 * \class QtAws::Health::DescribeHealthServiceStatusForOrganizationResponse
 * \brief The DescribeHealthServiceStatusForOrganizationResponse class provides an interace for Health DescribeHealthServiceStatusForOrganization responses.
 *
...
/*!
 * Constructs a DescribeHealthServiceStatusForOrganizationResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeHealthServiceStatusForOrganizationResponse::DescribeHealthServiceStatusForOrganizationResponse(
        const DescribeHealthServiceStatusForOrganizationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : HealthResponse(new DescribeHealthServiceStatusForOrganizationResponsePrivate(this), parent)
{
    setRequest(new DescribeHealthServiceStatusForOrganizationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Health DescribeHealthServiceStatusForOrganization \a response.
 */
void DescribeHealthServiceStatusForOrganizationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeHealthServiceStatusForOrganizationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Health::DescribeHealthServiceStatusForOrganizationResponsePrivate
 * \brief The DescribeHealthServiceStatusForOrganizationResponsePrivate class provides private implementation for DescribeHealthServiceStatusForOrganizationResponse.
 * \internal
 *
 * \inmodule QtAwsHealth
 */
...
/*!
 * Constructs a DescribeHealthServiceStatusForOrganizationResponsePrivate object with public implementation \a q.
 */
DescribeHealthServiceStatusForOrganizationResponsePrivate::DescribeHealthServiceStatusForOrganizationResponsePrivate(
    DescribeHealthServiceStatusForOrganizationResponse * const q) : HealthResponsePrivate(q)
{

}

/*!
 * Parses a Health DescribeHealthServiceStatusForOrganization response element from \a xml.
 */
void DescribeHealthServiceStatusForOrganizationResponsePrivate::parseDescribeHealthServiceStatusForOrganizationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeHealthServiceStatusForOrganizationResponse"));
    Q_UNUSED(xml) ///< @todo
}
