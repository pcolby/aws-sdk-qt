...
#include "describeaffectedentitiesfororganizationresponse_p.h"
...
/*!
 * \class QtAws::Health::DescribeAffectedEntitiesForOrganizationResponse
 * \brief The DescribeAffectedEntitiesForOrganizationResponse class provides an interace for Health DescribeAffectedEntitiesForOrganization responses.
 *
...
/*!
 * Constructs a DescribeAffectedEntitiesForOrganizationResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeAffectedEntitiesForOrganizationResponse::DescribeAffectedEntitiesForOrganizationResponse(
        const DescribeAffectedEntitiesForOrganizationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : HealthResponse(new DescribeAffectedEntitiesForOrganizationResponsePrivate(this), parent)
{
    setRequest(new DescribeAffectedEntitiesForOrganizationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeAffectedEntitiesForOrganizationRequest * DescribeAffectedEntitiesForOrganizationResponse::request() const
{
    Q_D(const DescribeAffectedEntitiesForOrganizationResponse);
    return static_cast<const DescribeAffectedEntitiesForOrganizationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Health DescribeAffectedEntitiesForOrganization \a response.
 */
void DescribeAffectedEntitiesForOrganizationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeAffectedEntitiesForOrganizationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Health::DescribeAffectedEntitiesForOrganizationResponsePrivate
 * \brief The DescribeAffectedEntitiesForOrganizationResponsePrivate class provides private implementation for DescribeAffectedEntitiesForOrganizationResponse.
 * \internal
 *
 * \inmodule QtAwsHealth
 */
...
/*!
 * Constructs a DescribeAffectedEntitiesForOrganizationResponsePrivate object with public implementation \a q.
 */
DescribeAffectedEntitiesForOrganizationResponsePrivate::DescribeAffectedEntitiesForOrganizationResponsePrivate(
    DescribeAffectedEntitiesForOrganizationResponse * const q) : HealthResponsePrivate(q)
{

}

/*!
 * Parses a Health DescribeAffectedEntitiesForOrganization response element from \a xml.
 */
void DescribeAffectedEntitiesForOrganizationResponsePrivate::parseDescribeAffectedEntitiesForOrganizationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeAffectedEntitiesForOrganizationResponse"));
    Q_UNUSED(xml) ///< @todo
}
