...
#include "describeeventdetailsfororganizationresponse_p.h"
...
/*!
 * \class QtAws::Health::DescribeEventDetailsForOrganizationResponse
 * \brief The DescribeEventDetailsForOrganizationResponse class provides an interace for Health DescribeEventDetailsForOrganization responses.
 *
 ...
 *
 * \sa HealthClient::describeEventDetailsForOrganization
 */

/*!
 * Constructs a DescribeEventDetailsForOrganizationResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeEventDetailsForOrganizationResponse::DescribeEventDetailsForOrganizationResponse(
        const DescribeEventDetailsForOrganizationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : HealthResponse(new DescribeEventDetailsForOrganizationResponsePrivate(this), parent)
{
    setRequest(new DescribeEventDetailsForOrganizationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeEventDetailsForOrganizationRequest * DescribeEventDetailsForOrganizationResponse::request() const
{
    Q_D(const DescribeEventDetailsForOrganizationResponse);
    return static_cast<const DescribeEventDetailsForOrganizationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Health DescribeEventDetailsForOrganization \a response.
 */
void DescribeEventDetailsForOrganizationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeEventDetailsForOrganizationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Health::DescribeEventDetailsForOrganizationResponsePrivate
 * \brief The DescribeEventDetailsForOrganizationResponsePrivate class provides private implementation for DescribeEventDetailsForOrganizationResponse.
 * \internal
 *
 * \inmodule QtAwsHealth
 */
...
/*!
 * Constructs a DescribeEventDetailsForOrganizationResponsePrivate object with public implementation \a q.
 */
DescribeEventDetailsForOrganizationResponsePrivate::DescribeEventDetailsForOrganizationResponsePrivate(
    DescribeEventDetailsForOrganizationResponse * const q) : HealthResponsePrivate(q)
{

}

/*!
 * Parses a Health DescribeEventDetailsForOrganization response element from \a xml.
 */
void DescribeEventDetailsForOrganizationResponsePrivate::parseDescribeEventDetailsForOrganizationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeEventDetailsForOrganizationResponse"));
    Q_UNUSED(xml) ///< @todo
}
