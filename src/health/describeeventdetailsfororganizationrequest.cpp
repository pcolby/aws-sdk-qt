...
#include "describeeventdetailsfororganizationrequest_p.h"
...
/*!
 * \class QtAws::Health::DescribeEventDetailsForOrganizationRequest
 * \brief The DescribeEventDetailsForOrganizationRequest class provides an interface for Health DescribeEventDetailsForOrganization requests.
 *
 ...
 */
DescribeEventDetailsForOrganizationRequest::DescribeEventDetailsForOrganizationRequest(const DescribeEventDetailsForOrganizationRequest &other)
    : HealthRequest(new DescribeEventDetailsForOrganizationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeEventDetailsForOrganizationRequest object.
 */
DescribeEventDetailsForOrganizationRequest::DescribeEventDetailsForOrganizationRequest()
    : HealthRequest(new DescribeEventDetailsForOrganizationRequestPrivate(HealthRequest::DescribeEventDetailsForOrganizationAction, this))
{
 ...
 * \reimp
 */
bool DescribeEventDetailsForOrganizationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeEventDetailsForOrganizationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeEventDetailsForOrganizationRequest::response(QNetworkReply * const reply) const
{
    return new DescribeEventDetailsForOrganizationResponse(*this, reply);
}

/*!
 * \class QtAws::Health::DescribeEventDetailsForOrganizationRequestPrivate
 * \brief The DescribeEventDetailsForOrganizationRequestPrivate class provides private implementation for DescribeEventDetailsForOrganizationRequest.
 * \internal
 *
 * \inmodule QtAwsHealth
 */
...
/*!
 * Constructs a DescribeEventDetailsForOrganizationRequestPrivate object for Health \a action,
 * with public implementation \a q.
 */
DescribeEventDetailsForOrganizationRequestPrivate::DescribeEventDetailsForOrganizationRequestPrivate(
    const HealthRequest::Action action, DescribeEventDetailsForOrganizationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeEventDetailsForOrganizationRequest
 * class' copy constructor.
 */
DescribeEventDetailsForOrganizationRequestPrivate::DescribeEventDetailsForOrganizationRequestPrivate(
    const DescribeEventDetailsForOrganizationRequestPrivate &other, DescribeEventDetailsForOrganizationRequest * const q)
