...
/*!
 * \class QtAws::Health::DescribeEventsResponse
 * \brief The DescribeEventsResponse class provides an interace for Health DescribeEvents responses.
 *
...
DescribeEventsResponse::DescribeEventsResponse(
    ...
    : HealthResponse(new DescribeEventsResponsePrivate(this), parent)
{
...
{
    return static_cast<const DescribeEventsRequest *>(HealthResponse::request());
}

/*!
 * \reimp
 * Parses a successful Health DescribeEvents \a response.
 */
...
/*!
 * \class QtAws::Health::DescribeEventsResponsePrivate
...
/*!
 * Parses a Health DescribeEvents response element from \a xml.
 */
