...
#include "describeaffectedaccountsfororganizationresponse_p.h"
...
/*!
 * \class QtAws::Health::DescribeAffectedAccountsForOrganizationResponse
 * \brief The DescribeAffectedAccountsForOrganizationResponse class provides an interace for Health DescribeAffectedAccountsForOrganization responses.
 *
...
/*!
 * Constructs a DescribeAffectedAccountsForOrganizationResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeAffectedAccountsForOrganizationResponse::DescribeAffectedAccountsForOrganizationResponse(
        const DescribeAffectedAccountsForOrganizationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : HealthResponse(new DescribeAffectedAccountsForOrganizationResponsePrivate(this), parent)
{
    setRequest(new DescribeAffectedAccountsForOrganizationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeAffectedAccountsForOrganizationRequest * DescribeAffectedAccountsForOrganizationResponse::request() const
{
    Q_D(const DescribeAffectedAccountsForOrganizationResponse);
    return static_cast<const DescribeAffectedAccountsForOrganizationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Health DescribeAffectedAccountsForOrganization \a response.
 */
void DescribeAffectedAccountsForOrganizationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeAffectedAccountsForOrganizationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Health::DescribeAffectedAccountsForOrganizationResponsePrivate
 * \brief The DescribeAffectedAccountsForOrganizationResponsePrivate class provides private implementation for DescribeAffectedAccountsForOrganizationResponse.
 * \internal
 *
 * \inmodule QtAwsHealth
 */
...
/*!
 * Constructs a DescribeAffectedAccountsForOrganizationResponsePrivate object with public implementation \a q.
 */
DescribeAffectedAccountsForOrganizationResponsePrivate::DescribeAffectedAccountsForOrganizationResponsePrivate(
    DescribeAffectedAccountsForOrganizationResponse * const q) : HealthResponsePrivate(q)
{

}

/*!
 * Parses a Health DescribeAffectedAccountsForOrganization response element from \a xml.
 */
void DescribeAffectedAccountsForOrganizationResponsePrivate::parseDescribeAffectedAccountsForOrganizationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeAffectedAccountsForOrganizationResponse"));
    Q_UNUSED(xml) ///< @todo
}
