 ...
 *
 * \brief The StopDataCollectionByAgentIdsRequest class encapsulates ApplicationDiscoveryService StopDataCollectionByAgentIds requests.
 *
 ...
 *
 * \sa ApplicationDiscoveryServiceClient::stopDataCollectionByAgentIds
 */
