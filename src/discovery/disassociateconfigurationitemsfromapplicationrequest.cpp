 ...
 *
 * \brief The DisassociateConfigurationItemsFromApplicationRequest class encapsulates ApplicationDiscoveryService DisassociateConfigurationItemsFromApplication requests.
 *
