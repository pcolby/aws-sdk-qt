 ...
 *
 * @brief  Handles ApplicationDiscoveryService ListConfigurations responses.
 *
 ...
 */
ListConfigurationsResponse::{OperationName}}Response(
...
/**
 * @brief  Parse a ApplicationDiscoveryService ListConfigurations response.
 *
...
/**
 * @brief  Parse an ApplicationDiscoveryService ListConfigurationsResponse element.
 *
 * @param  xml  XML stream to parse.
 */
void ListConfigurationsResponsePrivate::ListConfigurationsResponse(QXmlStreamReader &xml)
{
