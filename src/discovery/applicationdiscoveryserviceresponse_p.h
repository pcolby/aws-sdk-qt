...
class QTAWS_EXPORT ApplicationDiscoveryServiceResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {
    Q_OBJECT

public:

    ApplicationDiscoveryServiceResponsePrivate(ApplicationDiscoveryServiceResponse * const q);
