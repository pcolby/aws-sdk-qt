...
/*!
 * \class QtAws::Forecast::CreateDatasetImportJobResponse
 * \brief The CreateDatasetImportJobResponse class provides an interace for Forecast CreateDatasetImportJob responses.
 *
...
CreateDatasetImportJobResponse::CreateDatasetImportJobResponse(
    ...
    : ForecastResponse(new CreateDatasetImportJobResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Forecast CreateDatasetImportJob \a response.
 */
...
/*!
 * \class QtAws::Forecast::CreateDatasetImportJobResponsePrivate
...
CreateDatasetImportJobResponsePrivate::CreateDatasetImportJobResponsePrivate(
    CreateDatasetImportJobResponse * const q) : ForecastResponsePrivate(q)
{

}

/*!
 * Parses a Forecast CreateDatasetImportJob response element from \a xml.
 */
