...
/*!
 * \class QtAws::Forecast::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Forecast UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : ForecastResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Forecast UntagResource \a response.
 */
...
/*!
 * \class QtAws::Forecast::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : ForecastResponsePrivate(q)
{

}

/*!
 * Parses a Forecast UntagResource response element from \a xml.
 */
