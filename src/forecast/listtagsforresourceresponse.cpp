...
/*!
 * \class QtAws::Forecast::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Forecast ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ForecastResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Forecast ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Forecast::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ForecastResponsePrivate(q)
{

}

/*!
 * Parses a Forecast ListTagsForResource response element from \a xml.
 */
