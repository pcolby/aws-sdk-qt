...
/*!
 * \class QtAws::ApiGatewayV2::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for ApiGatewayV2 UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : ApiGatewayV2Response(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ApiGatewayV2 UntagResource \a response.
 */
...
/*!
 * \class QtAws::ApiGatewayV2::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : ApiGatewayV2ResponsePrivate(q)
{

}

/*!
 * Parses a ApiGatewayV2 UntagResource response element from \a xml.
 */
