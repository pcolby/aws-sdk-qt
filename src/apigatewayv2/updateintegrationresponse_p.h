...
class QTAWS_EXPORT UpdateIntegrationResponsePrivate : public ApiGatewayV2ResponsePrivate {

public:

    UpdateIntegrationResponsePrivate(UpdateIntegrationResponse * const q);
