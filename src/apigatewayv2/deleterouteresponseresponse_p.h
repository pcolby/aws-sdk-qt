...
class QTAWS_EXPORT DeleteRouteResponseResponsePrivate : public ApiGatewayV2ResponsePrivate {

public:

    DeleteRouteResponseResponsePrivate(DeleteRouteResponseResponse * const q);
