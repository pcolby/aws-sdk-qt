...
#ifndef QTAWS_DELETEROUTEREQUESTPARAMETERREQUEST_H
#define QTAWS_DELETEROUTEREQUESTPARAMETERREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(DeleteRouteRequestParameterRequest)
