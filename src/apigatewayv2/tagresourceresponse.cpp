...
/*!
 * \class QtAws::ApiGatewayV2::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for ApiGatewayV2 TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ApiGatewayV2Response(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ApiGatewayV2 TagResource \a response.
 */
...
/*!
 * \class QtAws::ApiGatewayV2::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ApiGatewayV2ResponsePrivate(q)
{

}

/*!
 * Parses a ApiGatewayV2 TagResource response element from \a xml.
 */
