...
class QTAWS_EXPORT CreateIntegrationResponsePrivate : public ApiGatewayV2ResponsePrivate {

public:

    CreateIntegrationResponsePrivate(CreateIntegrationResponse * const q);
