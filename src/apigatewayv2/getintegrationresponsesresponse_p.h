...
class QTAWS_EXPORT GetIntegrationResponsesResponsePrivate : public ApiGatewayV2ResponsePrivate {

public:

    GetIntegrationResponsesResponsePrivate(GetIntegrationResponsesResponse * const q);
