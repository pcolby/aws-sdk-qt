...
class QTAWS_EXPORT CreateProgressUpdateStreamResponse : public MigrationHubResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateProgressUpdateStreamRequest * request() const override;
