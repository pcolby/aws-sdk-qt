...
QString DeviceFarmRequestPrivate::toString(const DeviceFarmRequest::Action &action)
{
    ...
    switch (action) {
        ActionToString(CreateDevicePool);
        ActionToString(CreateInstanceProfile);
        ActionToString(CreateNetworkProfile);
        ActionToString(CreateProject);
        ActionToString(CreateRemoteAccessSession);
        ActionToString(CreateTestGridProject);
        ActionToString(CreateTestGridUrl);
        ActionToString(CreateUpload);
        ActionToString(CreateVPCEConfiguration);
        ActionToString(DeleteDevicePool);
        ActionToString(DeleteInstanceProfile);
        ActionToString(DeleteNetworkProfile);
        ActionToString(DeleteProject);
        ActionToString(DeleteRemoteAccessSession);
        ActionToString(DeleteRun);
        ActionToString(DeleteTestGridProject);
        ActionToString(DeleteUpload);
        ActionToString(DeleteVPCEConfiguration);
        ActionToString(GetAccountSettings);
        ActionToString(GetDevice);
        ActionToString(GetDeviceInstance);
        ActionToString(GetDevicePool);
        ActionToString(GetDevicePoolCompatibility);
        ActionToString(GetInstanceProfile);
        ActionToString(GetJob);
        ActionToString(GetNetworkProfile);
        ActionToString(GetOfferingStatus);
        ActionToString(GetProject);
        ActionToString(GetRemoteAccessSession);
        ActionToString(GetRun);
        ActionToString(GetSuite);
        ActionToString(GetTest);
        ActionToString(GetTestGridProject);
        ActionToString(GetTestGridSession);
        ActionToString(GetUpload);
        ActionToString(GetVPCEConfiguration);
        ActionToString(InstallToRemoteAccessSession);
        ActionToString(ListArtifacts);
        ActionToString(ListDeviceInstances);
        ActionToString(ListDevicePools);
        ActionToString(ListDevices);
        ActionToString(ListInstanceProfiles);
        ActionToString(ListJobs);
        ActionToString(ListNetworkProfiles);
        ActionToString(ListOfferingPromotions);
        ActionToString(ListOfferingTransactions);
        ActionToString(ListOfferings);
        ActionToString(ListProjects);
        ActionToString(ListRemoteAccessSessions);
        ActionToString(ListRuns);
        ActionToString(ListSamples);
        ActionToString(ListSuites);
        ActionToString(ListTagsForResource);
        ActionToString(ListTestGridProjects);
        ActionToString(ListTestGridSessionActions);
        ActionToString(ListTestGridSessionArtifacts);
        ActionToString(ListTestGridSessions);
        ActionToString(ListTests);
        ActionToString(ListUniqueProblems);
        ActionToString(ListUploads);
        ActionToString(ListVPCEConfigurations);
        ActionToString(PurchaseOffering);
        ActionToString(RenewOffering);
        ActionToString(ScheduleRun);
        ActionToString(StopJob);
        ActionToString(StopRemoteAccessSession);
        ActionToString(StopRun);
        ActionToString(TagResource);
        ActionToString(UntagResource);
        ActionToString(UpdateDeviceInstance);
        ActionToString(UpdateDevicePool);
        ActionToString(UpdateInstanceProfile);
        ActionToString(UpdateNetworkProfile);
        ActionToString(UpdateProject);
        ActionToString(UpdateTestGridProject);
        ActionToString(UpdateUpload);
        ActionToString(UpdateVPCEConfiguration);
        default:
