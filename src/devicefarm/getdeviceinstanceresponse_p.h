...
class QTAWS_EXPORT GetDeviceInstanceResponsePrivate : public DeviceFarmResponsePrivate {

public:

    GetDeviceInstanceResponsePrivate(GetDeviceInstanceResponse * const q);
