...
public slots:
    ...
    CreateTestGridProjectResponse * createTestGridProject(const CreateTestGridProjectRequest &request);
    CreateTestGridUrlResponse * createTestGridUrl(const CreateTestGridUrlRequest &request);
    ...
    DeleteTestGridProjectResponse * deleteTestGridProject(const DeleteTestGridProjectRequest &request);
    ...
    GetTestGridProjectResponse * getTestGridProject(const GetTestGridProjectRequest &request);
    GetTestGridSessionResponse * getTestGridSession(const GetTestGridSessionRequest &request);
    ...
    ListTestGridProjectsResponse * listTestGridProjects(const ListTestGridProjectsRequest &request);
    ListTestGridSessionActionsResponse * listTestGridSessionActions(const ListTestGridSessionActionsRequest &request);
    ListTestGridSessionArtifactsResponse * listTestGridSessionArtifacts(const ListTestGridSessionArtifactsRequest &request);
    ListTestGridSessionsResponse * listTestGridSessions(const ListTestGridSessionsRequest &request);
    ...
    UpdateTestGridProjectResponse * updateTestGridProject(const UpdateTestGridProjectRequest &request);
