...
class QTAWS_EXPORT ListTestGridSessionActionsResponsePrivate : public DeviceFarmResponsePrivate {

public:

    ListTestGridSessionActionsResponsePrivate(ListTestGridSessionActionsResponse * const q);
