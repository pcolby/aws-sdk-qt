...
class QTAWS_EXPORT CreateRemoteAccessSessionResponse : public CreateRemoteAccessSessionResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateRemoteAccessSessionRequest * request() const;
