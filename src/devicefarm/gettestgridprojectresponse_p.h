...
class QTAWS_EXPORT GetTestGridProjectResponsePrivate : public DeviceFarmResponsePrivate {

public:

    GetTestGridProjectResponsePrivate(GetTestGridProjectResponse * const q);
