...
/*!
 * \class QtAws::DeviceFarm::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for DeviceFarm ListTagsForResource responses.
 *
 ...
 *
 * \sa DeviceFarmClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : DeviceFarmResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(DeviceFarmResponse::request());
}

/*!
 * \reimp
 * Parses a successful DeviceFarm ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::DeviceFarm::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : DeviceFarmResponsePrivate(q)
{

}

/*!
 * Parses a DeviceFarm ListTagsForResource response element from \a xml.
 */
