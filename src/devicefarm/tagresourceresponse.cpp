...
/*!
 * \class QtAws::DeviceFarm::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for DeviceFarm TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : DeviceFarmResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(DeviceFarmResponse::request());
}

/*!
 * \reimp
 * Parses a successful DeviceFarm TagResource \a response.
 */
...
/*!
 * \class QtAws::DeviceFarm::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : DeviceFarmResponsePrivate(q)
{

}

/*!
 * Parses a DeviceFarm TagResource response element from \a xml.
 */
