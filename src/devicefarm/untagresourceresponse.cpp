...
/*!
 * \class QtAws::DeviceFarm::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for DeviceFarm UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : DeviceFarmResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful DeviceFarm UntagResource \a response.
 */
...
/*!
 * \class QtAws::DeviceFarm::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : DeviceFarmResponsePrivate(q)
{

}

/*!
 * Parses a DeviceFarm UntagResource response element from \a xml.
 */
