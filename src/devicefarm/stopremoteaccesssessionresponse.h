...
class QTAWSDEVICEFARM_EXPORT StopRemoteAccessSessionResponse : public DeviceFarmResponse {
    Q_OBJECT
...
public:
    ...
    virtual const StopRemoteAccessSessionRequest * request() const Q_DECL_OVERRIDE;
