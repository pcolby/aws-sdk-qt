...
class QTAWSDEVICEFARM_EXPORT DeleteVPCEConfigurationResponse : public DeviceFarmResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteVPCEConfigurationRequest * request() const Q_DECL_OVERRIDE;
