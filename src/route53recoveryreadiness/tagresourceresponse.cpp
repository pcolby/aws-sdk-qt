...
/*!
 * \class QtAws::Route53RecoveryReadiness::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Route53RecoveryReadiness TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : Route53RecoveryReadinessResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Route53RecoveryReadiness TagResource \a response.
 */
...
/*!
 * \class QtAws::Route53RecoveryReadiness::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : Route53RecoveryReadinessResponsePrivate(q)
{

}

/*!
 * Parses a Route53RecoveryReadiness TagResource response element from \a xml.
 */
