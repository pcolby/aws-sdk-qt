...
/*!
 * \class QtAws::IvsChat::DeleteRoomResponse
 * \brief The DeleteRoomResponse class provides an interace for IvsChat DeleteRoom responses.
 *
...
DeleteRoomResponse::DeleteRoomResponse(
    ...
    : IvsChatResponse(new DeleteRoomResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IvsChat DeleteRoom \a response.
 */
...
/*!
 * \class QtAws::IvsChat::DeleteRoomResponsePrivate
...
DeleteRoomResponsePrivate::DeleteRoomResponsePrivate(
    DeleteRoomResponse * const q) : IvsChatResponsePrivate(q)
{

}

/*!
 * Parses a IvsChat DeleteRoom response element from \a xml.
 */
