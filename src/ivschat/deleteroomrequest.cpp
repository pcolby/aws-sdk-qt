...
/*!
 * \class QtAws::IvsChat::DeleteRoomRequest
 * \brief The DeleteRoomRequest class provides an interface for IvsChat DeleteRoom requests.
 *
...
DeleteRoomRequest::DeleteRoomRequest(const DeleteRoomRequest &other)
    : IvsChatRequest(new DeleteRoomRequestPrivate(*other.d_func(), this))
{
...
DeleteRoomRequest::DeleteRoomRequest()
    : IvsChatRequest(new DeleteRoomRequestPrivate(IvsChatRequest::DeleteRoomAction, this))
{
...
/*!
 * \class QtAws::IvsChat::DeleteRoomRequestPrivate
...
/*!
 * Constructs a DeleteRoomRequestPrivate object for IvsChat \a action,
 * with public implementation \a q.
 */
DeleteRoomRequestPrivate::DeleteRoomRequestPrivate(
    const IvsChatRequest::Action action, DeleteRoomRequest * const q)
