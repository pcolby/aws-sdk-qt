...
/*!
 * \class QtAws::IvsChat::DeleteMessageRequest
 * \brief The DeleteMessageRequest class provides an interface for IvsChat DeleteMessage requests.
 *
 ...
 *
 * \sa IvsChatClient::deleteMessage
 */
...
DeleteMessageRequest::DeleteMessageRequest(const DeleteMessageRequest &other)
    : IvsChatRequest(new DeleteMessageRequestPrivate(*other.d_func(), this))
{
...
DeleteMessageRequest::DeleteMessageRequest()
    : IvsChatRequest(new DeleteMessageRequestPrivate(IvsChatRequest::DeleteMessageAction, this))
{
...
/*!
 * \class QtAws::IvsChat::DeleteMessageRequestPrivate
...
/*!
 * Constructs a DeleteMessageRequestPrivate object for IvsChat \a action,
 * with public implementation \a q.
 */
DeleteMessageRequestPrivate::DeleteMessageRequestPrivate(
    const IvsChatRequest::Action action, DeleteMessageRequest * const q)
