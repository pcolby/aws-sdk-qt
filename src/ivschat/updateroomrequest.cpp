...
/*!
 * \class QtAws::IvsChat::UpdateRoomRequest
 * \brief The UpdateRoomRequest class provides an interface for IvsChat UpdateRoom requests.
 *
...
UpdateRoomRequest::UpdateRoomRequest(const UpdateRoomRequest &other)
    : IvsChatRequest(new UpdateRoomRequestPrivate(*other.d_func(), this))
{
...
UpdateRoomRequest::UpdateRoomRequest()
    : IvsChatRequest(new UpdateRoomRequestPrivate(IvsChatRequest::UpdateRoomAction, this))
{
...
/*!
 * \class QtAws::IvsChat::UpdateRoomRequestPrivate
...
/*!
 * Constructs a UpdateRoomRequestPrivate object for IvsChat \a action,
 * with public implementation \a q.
 */
UpdateRoomRequestPrivate::UpdateRoomRequestPrivate(
    const IvsChatRequest::Action action, UpdateRoomRequest * const q)
