...
/*!
 * \class QtAws::IvsChat::ListRoomsRequest
 * \brief The ListRoomsRequest class provides an interface for IvsChat ListRooms requests.
 *
 ...
 *
 * \sa IvsChatClient::listRooms
 */

/*!
 * Constructs a copy of \a other.
 */
ListRoomsRequest::ListRoomsRequest(const ListRoomsRequest &other)
    : IvsChatRequest(new ListRoomsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListRoomsRequest object.
 */
ListRoomsRequest::ListRoomsRequest()
    : IvsChatRequest(new ListRoomsRequestPrivate(IvsChatRequest::ListRoomsAction, this))
{
 ...
 * \reimp
 */
bool ListRoomsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListRoomsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListRoomsRequest::response(QNetworkReply * const reply) const
{
    return new ListRoomsResponse(*this, reply);
}

/*!
 * \class QtAws::IvsChat::ListRoomsRequestPrivate
 * \brief The ListRoomsRequestPrivate class provides private implementation for ListRoomsRequest.
 * \internal
 *
 * \inmodule QtAwsIvsChat
 */
...
/*!
 * Constructs a ListRoomsRequestPrivate object for IvsChat \a action,
 * with public implementation \a q.
 */
ListRoomsRequestPrivate::ListRoomsRequestPrivate(
    const IvsChatRequest::Action action, ListRoomsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListRoomsRequest
 * class' copy constructor.
 */
ListRoomsRequestPrivate::ListRoomsRequestPrivate(
    const ListRoomsRequestPrivate &other, ListRoomsRequest * const q)
