...
/*!
 * \class QtAws::IvsChat::CreateRoomRequest
 * \brief The CreateRoomRequest class provides an interface for IvsChat CreateRoom requests.
 *
...
CreateRoomRequest::CreateRoomRequest(const CreateRoomRequest &other)
    : IvsChatRequest(new CreateRoomRequestPrivate(*other.d_func(), this))
{
...
CreateRoomRequest::CreateRoomRequest()
    : IvsChatRequest(new CreateRoomRequestPrivate(IvsChatRequest::CreateRoomAction, this))
{
...
/*!
 * \class QtAws::IvsChat::CreateRoomRequestPrivate
...
/*!
 * Constructs a CreateRoomRequestPrivate object for IvsChat \a action,
 * with public implementation \a q.
 */
CreateRoomRequestPrivate::CreateRoomRequestPrivate(
    const IvsChatRequest::Action action, CreateRoomRequest * const q)
