...
/*!
 * \class QtAws::IvsChat::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for IvsChat TagResource requests.
 *
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : IvsChatRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : IvsChatRequest(new TagResourceRequestPrivate(IvsChatRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::IvsChat::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for IvsChat \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const IvsChatRequest::Action action, TagResourceRequest * const q)
