...
#include "createchattokenrequest_p.h"
...
/*!
 * \class QtAws::IvsChat::CreateChatTokenRequest
 * \brief The CreateChatTokenRequest class provides an interface for IvsChat CreateChatToken requests.
 *
 ...
 */
CreateChatTokenRequest::CreateChatTokenRequest(const CreateChatTokenRequest &other)
    : IvsChatRequest(new CreateChatTokenRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateChatTokenRequest object.
 */
CreateChatTokenRequest::CreateChatTokenRequest()
    : IvsChatRequest(new CreateChatTokenRequestPrivate(IvsChatRequest::CreateChatTokenAction, this))
{
 ...
 * \reimp
 */
bool CreateChatTokenRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateChatTokenResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateChatTokenRequest::response(QNetworkReply * const reply) const
{
    return new CreateChatTokenResponse(*this, reply);
}

/*!
 * \class QtAws::IvsChat::CreateChatTokenRequestPrivate
 * \brief The CreateChatTokenRequestPrivate class provides private implementation for CreateChatTokenRequest.
 * \internal
 *
 * \inmodule QtAwsIvsChat
 */
...
/*!
 * Constructs a CreateChatTokenRequestPrivate object for IvsChat \a action,
 * with public implementation \a q.
 */
CreateChatTokenRequestPrivate::CreateChatTokenRequestPrivate(
    const IvsChatRequest::Action action, CreateChatTokenRequest * const q)
    : IvsChatRequestPrivate(action, q)
{
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateChatTokenRequest
 * class' copy constructor.
 */
CreateChatTokenRequestPrivate::CreateChatTokenRequestPrivate(
    const CreateChatTokenRequestPrivate &other, CreateChatTokenRequest * const q)
    : IvsChatRequestPrivate(other, q)
{
