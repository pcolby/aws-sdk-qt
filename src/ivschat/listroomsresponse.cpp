...
/*!
 * \class QtAws::IvsChat::ListRoomsResponse
 * \brief The ListRoomsResponse class provides an interace for IvsChat ListRooms responses.
 *
...
/*!
 * Constructs a ListRoomsResponse object for \a reply to \a request, with parent \a parent.
 */
ListRoomsResponse::ListRoomsResponse(
        const ListRoomsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsChatResponse(new ListRoomsResponsePrivate(this), parent)
{
    setRequest(new ListRoomsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful IvsChat ListRooms \a response.
 */
void ListRoomsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListRoomsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::IvsChat::ListRoomsResponsePrivate
 * \brief The ListRoomsResponsePrivate class provides private implementation for ListRoomsResponse.
 * \internal
 *
 * \inmodule QtAwsIvsChat
 */
...
/*!
 * Constructs a ListRoomsResponsePrivate object with public implementation \a q.
 */
ListRoomsResponsePrivate::ListRoomsResponsePrivate(
    ListRoomsResponse * const q) : IvsChatResponsePrivate(q)
{

}

/*!
 * Parses a IvsChat ListRooms response element from \a xml.
 */
void ListRoomsResponsePrivate::parseListRoomsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListRoomsResponse"));
    Q_UNUSED(xml) ///< @todo
}
