...
/*!
 * \class QtAws::IvsChat::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for IvsChat ListTagsForResource requests.
 *
 ...
 *
 * \sa IvsChatClient::listTagsForResource
 */
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : IvsChatRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : IvsChatRequest(new ListTagsForResourceRequestPrivate(IvsChatRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::IvsChat::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for IvsChat \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const IvsChatRequest::Action action, ListTagsForResourceRequest * const q)
