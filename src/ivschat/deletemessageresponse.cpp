...
/*!
 * \class QtAws::IvsChat::DeleteMessageResponse
 * \brief The DeleteMessageResponse class provides an interace for IvsChat DeleteMessage responses.
 *
...
DeleteMessageResponse::DeleteMessageResponse(
    ...
    : IvsChatResponse(new DeleteMessageResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IvsChat DeleteMessage \a response.
 */
...
/*!
 * \class QtAws::IvsChat::DeleteMessageResponsePrivate
...
DeleteMessageResponsePrivate::DeleteMessageResponsePrivate(
    DeleteMessageResponse * const q) : IvsChatResponsePrivate(q)
{

}

/*!
 * Parses a IvsChat DeleteMessage response element from \a xml.
 */
