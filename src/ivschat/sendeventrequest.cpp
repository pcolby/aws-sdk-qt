...
/*!
 * \class QtAws::IvsChat::SendEventRequest
 * \brief The SendEventRequest class provides an interface for IvsChat SendEvent requests.
 *
...
SendEventRequest::SendEventRequest(const SendEventRequest &other)
    : IvsChatRequest(new SendEventRequestPrivate(*other.d_func(), this))
{
...
SendEventRequest::SendEventRequest()
    : IvsChatRequest(new SendEventRequestPrivate(IvsChatRequest::SendEventAction, this))
{
...
/*!
 * \class QtAws::IvsChat::SendEventRequestPrivate
...
/*!
 * Constructs a SendEventRequestPrivate object for IvsChat \a action,
 * with public implementation \a q.
 */
SendEventRequestPrivate::SendEventRequestPrivate(
    const IvsChatRequest::Action action, SendEventRequest * const q)
