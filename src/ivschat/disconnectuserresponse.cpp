...
#include "disconnectuserresponse_p.h"
...
/*!
 * \class QtAws::IvsChat::DisconnectUserResponse
 * \brief The DisconnectUserResponse class provides an interace for IvsChat DisconnectUser responses.
 *
 ...
 *
 * \sa IvsChatClient::disconnectUser
 */

/*!
 * Constructs a DisconnectUserResponse object for \a reply to \a request, with parent \a parent.
 */
DisconnectUserResponse::DisconnectUserResponse(
        const DisconnectUserRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsChatResponse(new DisconnectUserResponsePrivate(this), parent)
{
    setRequest(new DisconnectUserRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DisconnectUserRequest * DisconnectUserResponse::request() const
{
    Q_D(const DisconnectUserResponse);
    return static_cast<const DisconnectUserRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful IvsChat DisconnectUser \a response.
 */
void DisconnectUserResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DisconnectUserResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::IvsChat::DisconnectUserResponsePrivate
 * \brief The DisconnectUserResponsePrivate class provides private implementation for DisconnectUserResponse.
 * \internal
 *
 * \inmodule QtAwsIvsChat
 */
...
/*!
 * Constructs a DisconnectUserResponsePrivate object with public implementation \a q.
 */
DisconnectUserResponsePrivate::DisconnectUserResponsePrivate(
    DisconnectUserResponse * const q) : IvsChatResponsePrivate(q)
{

}

/*!
 * Parses a IvsChat DisconnectUser response element from \a xml.
 */
void DisconnectUserResponsePrivate::parseDisconnectUserResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DisconnectUserResponse"));
    Q_UNUSED(xml) ///< @todo
}
