...
/*!
 * \class QtAws::IvsChat::CreateRoomResponse
 * \brief The CreateRoomResponse class provides an interace for IvsChat CreateRoom responses.
 *
...
CreateRoomResponse::CreateRoomResponse(
    ...
    : IvsChatResponse(new CreateRoomResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IvsChat CreateRoom \a response.
 */
...
/*!
 * \class QtAws::IvsChat::CreateRoomResponsePrivate
...
CreateRoomResponsePrivate::CreateRoomResponsePrivate(
    CreateRoomResponse * const q) : IvsChatResponsePrivate(q)
{

}

/*!
 * Parses a IvsChat CreateRoom response element from \a xml.
 */
