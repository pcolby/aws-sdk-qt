...
#include "disconnectuserrequest_p.h"
...
/*!
 * \class QtAws::IvsChat::DisconnectUserRequest
 * \brief The DisconnectUserRequest class provides an interface for IvsChat DisconnectUser requests.
 *
 ...
 */
DisconnectUserRequest::DisconnectUserRequest(const DisconnectUserRequest &other)
    : IvsChatRequest(new DisconnectUserRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DisconnectUserRequest object.
 */
DisconnectUserRequest::DisconnectUserRequest()
    : IvsChatRequest(new DisconnectUserRequestPrivate(IvsChatRequest::DisconnectUserAction, this))
{
 ...
 * \reimp
 */
bool DisconnectUserRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DisconnectUserResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DisconnectUserRequest::response(QNetworkReply * const reply) const
{
    return new DisconnectUserResponse(*this, reply);
}

/*!
 * \class QtAws::IvsChat::DisconnectUserRequestPrivate
 * \brief The DisconnectUserRequestPrivate class provides private implementation for DisconnectUserRequest.
 * \internal
 *
 * \inmodule QtAwsIvsChat
 */
...
/*!
 * Constructs a DisconnectUserRequestPrivate object for IvsChat \a action,
 * with public implementation \a q.
 */
DisconnectUserRequestPrivate::DisconnectUserRequestPrivate(
    const IvsChatRequest::Action action, DisconnectUserRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DisconnectUserRequest
 * class' copy constructor.
 */
DisconnectUserRequestPrivate::DisconnectUserRequestPrivate(
    const DisconnectUserRequestPrivate &other, DisconnectUserRequest * const q)
