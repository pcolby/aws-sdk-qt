...
/*!
 * \class QtAws::IvsChat::SendEventResponse
 * \brief The SendEventResponse class provides an interace for IvsChat SendEvent responses.
 *
...
SendEventResponse::SendEventResponse(
    ...
    : IvsChatResponse(new SendEventResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IvsChat SendEvent \a response.
 */
...
/*!
 * \class QtAws::IvsChat::SendEventResponsePrivate
...
SendEventResponsePrivate::SendEventResponsePrivate(
    SendEventResponse * const q) : IvsChatResponsePrivate(q)
{

}

/*!
 * Parses a IvsChat SendEvent response element from \a xml.
 */
