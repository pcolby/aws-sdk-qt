...
/*!
 * \class QtAws::IvsChat::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for IvsChat TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : IvsChatResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IvsChat TagResource \a response.
 */
...
/*!
 * \class QtAws::IvsChat::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : IvsChatResponsePrivate(q)
{

}

/*!
 * Parses a IvsChat TagResource response element from \a xml.
 */
