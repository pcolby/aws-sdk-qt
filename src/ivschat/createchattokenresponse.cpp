...
#include "createchattokenresponse_p.h"
...
/*!
 * \class QtAws::IvsChat::CreateChatTokenResponse
 * \brief The CreateChatTokenResponse class provides an interace for IvsChat CreateChatToken responses.
 *
 ...
 *
 * \sa IvsChatClient::createChatToken
 */

/*!
 * Constructs a CreateChatTokenResponse object for \a reply to \a request, with parent \a parent.
 */
CreateChatTokenResponse::CreateChatTokenResponse(
        const CreateChatTokenRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsChatResponse(new CreateChatTokenResponsePrivate(this), parent)
{
    setRequest(new CreateChatTokenRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateChatTokenRequest * CreateChatTokenResponse::request() const
{
    Q_D(const CreateChatTokenResponse);
    return static_cast<const CreateChatTokenRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful IvsChat CreateChatToken \a response.
 */
void CreateChatTokenResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateChatTokenResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::IvsChat::CreateChatTokenResponsePrivate
 * \brief The CreateChatTokenResponsePrivate class provides private implementation for CreateChatTokenResponse.
 * \internal
 *
 * \inmodule QtAwsIvsChat
 */
...
/*!
 * Constructs a CreateChatTokenResponsePrivate object with public implementation \a q.
 */
CreateChatTokenResponsePrivate::CreateChatTokenResponsePrivate(
    CreateChatTokenResponse * const q) : IvsChatResponsePrivate(q)
{

}

/*!
 * Parses a IvsChat CreateChatToken response element from \a xml.
 */
void CreateChatTokenResponsePrivate::parseCreateChatTokenResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateChatTokenResponse"));
    Q_UNUSED(xml) ///< @todo
}
