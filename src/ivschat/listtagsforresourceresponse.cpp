...
/*!
 * \class QtAws::IvsChat::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for IvsChat ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : IvsChatResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IvsChat ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::IvsChat::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : IvsChatResponsePrivate(q)
{

}

/*!
 * Parses a IvsChat ListTagsForResource response element from \a xml.
 */
