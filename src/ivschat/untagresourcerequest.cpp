...
/*!
 * \class QtAws::IvsChat::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for IvsChat UntagResource requests.
 *
 ...
 *
 * \sa IvsChatClient::untagResource
 */
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : IvsChatRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : IvsChatRequest(new UntagResourceRequestPrivate(IvsChatRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::IvsChat::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for IvsChat \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const IvsChatRequest::Action action, UntagResourceRequest * const q)
