...
/*!
 * \class QtAws::IvsChat::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for IvsChat UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : IvsChatResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IvsChat UntagResource \a response.
 */
...
/*!
 * \class QtAws::IvsChat::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : IvsChatResponsePrivate(q)
{

}

/*!
 * Parses a IvsChat UntagResource response element from \a xml.
 */
