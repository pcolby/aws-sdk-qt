...
/*!
 * \class QtAws::IvsChat::UpdateRoomResponse
 * \brief The UpdateRoomResponse class provides an interace for IvsChat UpdateRoom responses.
 *
...
UpdateRoomResponse::UpdateRoomResponse(
    ...
    : IvsChatResponse(new UpdateRoomResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IvsChat UpdateRoom \a response.
 */
...
/*!
 * \class QtAws::IvsChat::UpdateRoomResponsePrivate
...
UpdateRoomResponsePrivate::UpdateRoomResponsePrivate(
    UpdateRoomResponse * const q) : IvsChatResponsePrivate(q)
{

}

/*!
 * Parses a IvsChat UpdateRoom response element from \a xml.
 */
