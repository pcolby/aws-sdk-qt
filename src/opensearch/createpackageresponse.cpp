...
/*!
 * \class QtAws::OpenSearch::CreatePackageResponse
 * \brief The CreatePackageResponse class provides an interace for OpenSearch CreatePackage responses.
 *
...
CreatePackageResponse::CreatePackageResponse(
    ...
    : OpenSearchResponse(new CreatePackageResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful OpenSearch CreatePackage \a response.
 */
...
/*!
 * \class QtAws::OpenSearch::CreatePackageResponsePrivate
...
CreatePackageResponsePrivate::CreatePackageResponsePrivate(
    CreatePackageResponse * const q) : OpenSearchResponsePrivate(q)
{

}

/*!
 * Parses a OpenSearch CreatePackage response element from \a xml.
 */
