...
/*!
 * \class QtAws::Honeycode::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Honeycode TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : HoneycodeResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Honeycode TagResource \a response.
 */
...
/*!
 * \class QtAws::Honeycode::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : HoneycodeResponsePrivate(q)
{

}

/*!
 * Parses a Honeycode TagResource response element from \a xml.
 */
