...
/*!
 * \class QtAws::ServiceQuotas::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for ServiceQuotas UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : ServiceQuotasResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ServiceQuotas UntagResource \a response.
 */
...
/*!
 * \class QtAws::ServiceQuotas::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : ServiceQuotasResponsePrivate(q)
{

}

/*!
 * Parses a ServiceQuotas UntagResource response element from \a xml.
 */
