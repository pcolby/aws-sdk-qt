...
/*!
 * \class QtAws::ServiceQuotas::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for ServiceQuotas TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ServiceQuotasResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(ServiceQuotasResponse::request());
}

/*!
 * \reimp
 * Parses a successful ServiceQuotas TagResource \a response.
 */
...
/*!
 * \class QtAws::ServiceQuotas::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ServiceQuotasResponsePrivate(q)
{

}

/*!
 * Parses a ServiceQuotas TagResource response element from \a xml.
 */
