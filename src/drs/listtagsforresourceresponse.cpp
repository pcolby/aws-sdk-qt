...
/*!
 * \class QtAws::Drs::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Drs ListTagsForResource responses.
 *
 * \inmodule QtAwsDrs
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : DrsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Drs ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Drs::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : DrsResponsePrivate(q)
{

}

/*!
 * Parses a Drs ListTagsForResource response element from \a xml.
 */
