...
/*!
 * \class QtAws::Drs::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Drs TagResource responses.
 *
 * \inmodule QtAwsDrs
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : DrsResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Drs TagResource \a response.
 */
...
/*!
 * \class QtAws::Drs::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : DrsResponsePrivate(q)
{

}

/*!
 * Parses a Drs TagResource response element from \a xml.
 */
