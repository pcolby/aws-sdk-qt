...
/*!
 * \class QtAws::Drs::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Drs UntagResource responses.
 *
 * \inmodule QtAwsDrs
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : DrsResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Drs UntagResource \a response.
 */
...
/*!
 * \class QtAws::Drs::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : DrsResponsePrivate(q)
{

}

/*!
 * Parses a Drs UntagResource response element from \a xml.
 */
