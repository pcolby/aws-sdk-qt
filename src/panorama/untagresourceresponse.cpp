...
/*!
 * \class QtAws::Panorama::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Panorama UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : PanoramaResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Panorama UntagResource \a response.
 */
...
/*!
 * \class QtAws::Panorama::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : PanoramaResponsePrivate(q)
{

}

/*!
 * Parses a Panorama UntagResource response element from \a xml.
 */
