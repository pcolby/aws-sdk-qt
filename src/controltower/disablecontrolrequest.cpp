...
#include "disablecontrolrequest_p.h"
...
/*!
 * \class QtAws::ControlTower::DisableControlRequest
 * \brief The DisableControlRequest class provides an interface for ControlTower DisableControl requests.
 *
 ...
 */
DisableControlRequest::DisableControlRequest(const DisableControlRequest &other)
    : ControlTowerRequest(new DisableControlRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DisableControlRequest object.
 */
DisableControlRequest::DisableControlRequest()
    : ControlTowerRequest(new DisableControlRequestPrivate(ControlTowerRequest::DisableControlAction, this))
{
 ...
 * \reimp
 */
bool DisableControlRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DisableControlResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DisableControlRequest::response(QNetworkReply * const reply) const
{
    return new DisableControlResponse(*this, reply);
}

/*!
 * \class QtAws::ControlTower::DisableControlRequestPrivate
 * \brief The DisableControlRequestPrivate class provides private implementation for DisableControlRequest.
 * \internal
 *
 * \inmodule QtAwsControlTower
 */
...
/*!
 * Constructs a DisableControlRequestPrivate object for ControlTower \a action,
 * with public implementation \a q.
 */
DisableControlRequestPrivate::DisableControlRequestPrivate(
    const ControlTowerRequest::Action action, DisableControlRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DisableControlRequest
 * class' copy constructor.
 */
DisableControlRequestPrivate::DisableControlRequestPrivate(
    const DisableControlRequestPrivate &other, DisableControlRequest * const q)
