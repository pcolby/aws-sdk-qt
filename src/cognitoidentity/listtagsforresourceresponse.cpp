...
/*!
 * \class QtAws::CognitoIdentity::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for CognitoIdentity ListTagsForResource responses.
 *
 ...
 *
 * \sa CognitoIdentityClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : CognitoIdentityResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(CognitoIdentityResponse::request());
}

/*!
 * \reimp
 * Parses a successful CognitoIdentity ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::CognitoIdentity::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : CognitoIdentityResponsePrivate(q)
{

}

/*!
 * Parses a CognitoIdentity ListTagsForResource response element from \a xml.
 */
