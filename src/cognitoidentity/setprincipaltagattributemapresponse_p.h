...
class QTAWS_EXPORT SetPrincipalTagAttributeMapResponsePrivate : public CognitoIdentityResponsePrivate {

public:

    SetPrincipalTagAttributeMapResponsePrivate(SetPrincipalTagAttributeMapResponse * const q);
