...
/*!
 * \class QtAws::CognitoIdentity::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for CognitoIdentity ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : CognitoIdentityRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : CognitoIdentityRequest(new ListTagsForResourceRequestPrivate(CognitoIdentityRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::CognitoIdentity::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for CognitoIdentity \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const CognitoIdentityRequest::Action action, ListTagsForResourceRequest * const q)
