...
/*!
 * \class QtAws::CognitoIdentity::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for CognitoIdentity TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : CognitoIdentityResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(CognitoIdentityResponse::request());
}

/*!
 * \reimp
 * Parses a successful CognitoIdentity TagResource \a response.
 */
...
/*!
 * \class QtAws::CognitoIdentity::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : CognitoIdentityResponsePrivate(q)
{

}

/*!
 * Parses a CognitoIdentity TagResource response element from \a xml.
 */
