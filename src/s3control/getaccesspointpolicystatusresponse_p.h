...
class QTAWS_EXPORT GetAccessPointPolicyStatusResponsePrivate : public S3ControlResponsePrivate {

public:

    GetAccessPointPolicyStatusResponsePrivate(GetAccessPointPolicyStatusResponse * const q);
