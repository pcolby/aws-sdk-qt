...
class QTAWS_EXPORT DeleteAccessPointPolicyForObjectLambdaResponsePrivate : public S3ControlResponsePrivate {

public:

    DeleteAccessPointPolicyForObjectLambdaResponsePrivate(DeleteAccessPointPolicyForObjectLambdaResponse * const q);
