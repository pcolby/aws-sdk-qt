...
class QTAWS_EXPORT PutAccessPointPolicyResponsePrivate : public S3ControlResponsePrivate {

public:

    PutAccessPointPolicyResponsePrivate(PutAccessPointPolicyResponse * const q);
