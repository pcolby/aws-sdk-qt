...
class QTAWS_EXPORT GetAccessPointForObjectLambdaResponsePrivate : public S3ControlResponsePrivate {

public:

    GetAccessPointForObjectLambdaResponsePrivate(GetAccessPointForObjectLambdaResponse * const q);
