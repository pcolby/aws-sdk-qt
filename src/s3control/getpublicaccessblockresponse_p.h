...
class QTAWS_EXPORT GetPublicAccessBlockResponsePrivate : public S3ControlResponsePrivate {

public:

    GetPublicAccessBlockResponsePrivate(GetPublicAccessBlockResponse * const q);
