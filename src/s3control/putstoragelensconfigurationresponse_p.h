...
class QTAWS_EXPORT PutStorageLensConfigurationResponsePrivate : public S3ControlResponsePrivate {

public:

    PutStorageLensConfigurationResponsePrivate(PutStorageLensConfigurationResponse * const q);
