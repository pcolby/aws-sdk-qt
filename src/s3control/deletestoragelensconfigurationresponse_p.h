...
class QTAWS_EXPORT DeleteStorageLensConfigurationResponsePrivate : public S3ControlResponsePrivate {

public:

    DeleteStorageLensConfigurationResponsePrivate(DeleteStorageLensConfigurationResponse * const q);
