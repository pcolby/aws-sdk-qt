...
class QTAWS_EXPORT DescribeJournalS3ExportResponsePrivate : public QldbResponsePrivate {

public:

    DescribeJournalS3ExportResponsePrivate(DescribeJournalS3ExportResponse * const q);
