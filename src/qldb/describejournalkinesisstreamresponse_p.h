...
class QTAWS_EXPORT DescribeJournalKinesisStreamResponsePrivate : public QldbResponsePrivate {

public:

    DescribeJournalKinesisStreamResponsePrivate(DescribeJournalKinesisStreamResponse * const q);
