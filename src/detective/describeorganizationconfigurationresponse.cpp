...
/*!
 * \class QtAws::Detective::DescribeOrganizationConfigurationResponse
 * \brief The DescribeOrganizationConfigurationResponse class provides an interace for Detective DescribeOrganizationConfiguration responses.
 *
...
DescribeOrganizationConfigurationResponse::DescribeOrganizationConfigurationResponse(
    ...
    : DetectiveResponse(new DescribeOrganizationConfigurationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Detective DescribeOrganizationConfiguration \a response.
 */
...
/*!
 * \class QtAws::Detective::DescribeOrganizationConfigurationResponsePrivate
...
DescribeOrganizationConfigurationResponsePrivate::DescribeOrganizationConfigurationResponsePrivate(
    DescribeOrganizationConfigurationResponse * const q) : DetectiveResponsePrivate(q)
{

}

/*!
 * Parses a Detective DescribeOrganizationConfiguration response element from \a xml.
 */
