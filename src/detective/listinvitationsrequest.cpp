...
/*!
 * \class QtAws::Detective::ListInvitationsRequest
 * \brief The ListInvitationsRequest class provides an interface for Detective ListInvitations requests.
 *
...
ListInvitationsRequest::ListInvitationsRequest(const ListInvitationsRequest &other)
    : DetectiveRequest(new ListInvitationsRequestPrivate(*other.d_func(), this))
{
...
ListInvitationsRequest::ListInvitationsRequest()
    : DetectiveRequest(new ListInvitationsRequestPrivate(DetectiveRequest::ListInvitationsAction, this))
{
...
/*!
 * \class QtAws::Detective::ListInvitationsRequestPrivate
...
/*!
 * Constructs a ListInvitationsRequestPrivate object for Detective \a action,
 * with public implementation \a q.
 */
ListInvitationsRequestPrivate::ListInvitationsRequestPrivate(
    const DetectiveRequest::Action action, ListInvitationsRequest * const q)
