...
/*!
 * \class QtAws::Detective::UpdateOrganizationConfigurationResponse
 * \brief The UpdateOrganizationConfigurationResponse class provides an interace for Detective UpdateOrganizationConfiguration responses.
 *
...
UpdateOrganizationConfigurationResponse::UpdateOrganizationConfigurationResponse(
    ...
    : DetectiveResponse(new UpdateOrganizationConfigurationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Detective UpdateOrganizationConfiguration \a response.
 */
...
/*!
 * \class QtAws::Detective::UpdateOrganizationConfigurationResponsePrivate
...
UpdateOrganizationConfigurationResponsePrivate::UpdateOrganizationConfigurationResponsePrivate(
    UpdateOrganizationConfigurationResponse * const q) : DetectiveResponsePrivate(q)
{

}

/*!
 * Parses a Detective UpdateOrganizationConfiguration response element from \a xml.
 */
