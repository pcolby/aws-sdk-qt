...
/*!
 * \class QtAws::Detective::DescribeOrganizationConfigurationRequest
 * \brief The DescribeOrganizationConfigurationRequest class provides an interface for Detective DescribeOrganizationConfiguration requests.
 *
 ...
 *  behavior
 *
 * \sa DetectiveClient::describeOrganizationConfiguration
 */
...
DescribeOrganizationConfigurationRequest::DescribeOrganizationConfigurationRequest(const DescribeOrganizationConfigurationRequest &other)
    : DetectiveRequest(new DescribeOrganizationConfigurationRequestPrivate(*other.d_func(), this))
{
...
DescribeOrganizationConfigurationRequest::DescribeOrganizationConfigurationRequest()
    : DetectiveRequest(new DescribeOrganizationConfigurationRequestPrivate(DetectiveRequest::DescribeOrganizationConfigurationAction, this))
{
...
/*!
 * \class QtAws::Detective::DescribeOrganizationConfigurationRequestPrivate
...
/*!
 * Constructs a DescribeOrganizationConfigurationRequestPrivate object for Detective \a action,
 * with public implementation \a q.
 */
DescribeOrganizationConfigurationRequestPrivate::DescribeOrganizationConfigurationRequestPrivate(
    const DetectiveRequest::Action action, DescribeOrganizationConfigurationRequest * const q)
