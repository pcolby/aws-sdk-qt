...
/*!
 * \class QtAws::Detective::CreateMembersRequest
 * \brief The CreateMembersRequest class provides an interface for Detective CreateMembers requests.
 *
...
CreateMembersRequest::CreateMembersRequest(const CreateMembersRequest &other)
    : DetectiveRequest(new CreateMembersRequestPrivate(*other.d_func(), this))
{
...
CreateMembersRequest::CreateMembersRequest()
    : DetectiveRequest(new CreateMembersRequestPrivate(DetectiveRequest::CreateMembersAction, this))
{
...
/*!
 * \class QtAws::Detective::CreateMembersRequestPrivate
...
/*!
 * Constructs a CreateMembersRequestPrivate object for Detective \a action,
 * with public implementation \a q.
 */
CreateMembersRequestPrivate::CreateMembersRequestPrivate(
    const DetectiveRequest::Action action, CreateMembersRequest * const q)
