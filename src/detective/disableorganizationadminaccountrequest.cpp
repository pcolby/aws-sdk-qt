...
/*!
 * \class QtAws::Detective::DisableOrganizationAdminAccountRequest
 * \brief The DisableOrganizationAdminAccountRequest class provides an interface for Detective DisableOrganizationAdminAccount requests.
 *
 ...
 *  behavior
 *
 * \sa DetectiveClient::disableOrganizationAdminAccount
 */
...
DisableOrganizationAdminAccountRequest::DisableOrganizationAdminAccountRequest(const DisableOrganizationAdminAccountRequest &other)
    : DetectiveRequest(new DisableOrganizationAdminAccountRequestPrivate(*other.d_func(), this))
{
...
DisableOrganizationAdminAccountRequest::DisableOrganizationAdminAccountRequest()
    : DetectiveRequest(new DisableOrganizationAdminAccountRequestPrivate(DetectiveRequest::DisableOrganizationAdminAccountAction, this))
{
...
/*!
 * \class QtAws::Detective::DisableOrganizationAdminAccountRequestPrivate
...
/*!
 * Constructs a DisableOrganizationAdminAccountRequestPrivate object for Detective \a action,
 * with public implementation \a q.
 */
DisableOrganizationAdminAccountRequestPrivate::DisableOrganizationAdminAccountRequestPrivate(
    const DetectiveRequest::Action action, DisableOrganizationAdminAccountRequest * const q)
