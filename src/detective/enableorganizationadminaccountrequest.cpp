...
/*!
 * \class QtAws::Detective::EnableOrganizationAdminAccountRequest
 * \brief The EnableOrganizationAdminAccountRequest class provides an interface for Detective EnableOrganizationAdminAccount requests.
 *
 ...
 *  behavior
 *
 * \sa DetectiveClient::enableOrganizationAdminAccount
 */
...
EnableOrganizationAdminAccountRequest::EnableOrganizationAdminAccountRequest(const EnableOrganizationAdminAccountRequest &other)
    : DetectiveRequest(new EnableOrganizationAdminAccountRequestPrivate(*other.d_func(), this))
{
...
EnableOrganizationAdminAccountRequest::EnableOrganizationAdminAccountRequest()
    : DetectiveRequest(new EnableOrganizationAdminAccountRequestPrivate(DetectiveRequest::EnableOrganizationAdminAccountAction, this))
{
...
/*!
 * \class QtAws::Detective::EnableOrganizationAdminAccountRequestPrivate
...
/*!
 * Constructs a EnableOrganizationAdminAccountRequestPrivate object for Detective \a action,
 * with public implementation \a q.
 */
EnableOrganizationAdminAccountRequestPrivate::EnableOrganizationAdminAccountRequestPrivate(
    const DetectiveRequest::Action action, EnableOrganizationAdminAccountRequest * const q)
