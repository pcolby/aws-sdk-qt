...
/*!
 * \class QtAws::Detective::ListOrganizationAdminAccountsRequest
 * \brief The ListOrganizationAdminAccountsRequest class provides an interface for Detective ListOrganizationAdminAccounts requests.
 *
...
ListOrganizationAdminAccountsRequest::ListOrganizationAdminAccountsRequest(const ListOrganizationAdminAccountsRequest &other)
    : DetectiveRequest(new ListOrganizationAdminAccountsRequestPrivate(*other.d_func(), this))
{
...
ListOrganizationAdminAccountsRequest::ListOrganizationAdminAccountsRequest()
    : DetectiveRequest(new ListOrganizationAdminAccountsRequestPrivate(DetectiveRequest::ListOrganizationAdminAccountsAction, this))
{
...
/*!
 * \class QtAws::Detective::ListOrganizationAdminAccountsRequestPrivate
...
/*!
 * Constructs a ListOrganizationAdminAccountsRequestPrivate object for Detective \a action,
 * with public implementation \a q.
 */
ListOrganizationAdminAccountsRequestPrivate::ListOrganizationAdminAccountsRequestPrivate(
    const DetectiveRequest::Action action, ListOrganizationAdminAccountsRequest * const q)
