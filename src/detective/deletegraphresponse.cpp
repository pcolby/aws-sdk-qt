...
#include "deletegraphresponse_p.h"
...
/*!
 * \class QtAws::Detective::DeleteGraphResponse
 * \brief The DeleteGraphResponse class provides an interace for Detective DeleteGraph responses.
 *
...
/*!
 * Constructs a DeleteGraphResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteGraphResponse::DeleteGraphResponse(
        const DeleteGraphRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : DetectiveResponse(new DeleteGraphResponsePrivate(this), parent)
{
    setRequest(new DeleteGraphRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Detective DeleteGraph \a response.
 */
void DeleteGraphResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteGraphResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Detective::DeleteGraphResponsePrivate
 * \brief The DeleteGraphResponsePrivate class provides private implementation for DeleteGraphResponse.
 * \internal
 *
 * \inmodule QtAwsDetective
 */
...
/*!
 * Constructs a DeleteGraphResponsePrivate object with public implementation \a q.
 */
DeleteGraphResponsePrivate::DeleteGraphResponsePrivate(
    DeleteGraphResponse * const q) : DetectiveResponsePrivate(q)
{

}

/*!
 * Parses a Detective DeleteGraph response element from \a xml.
 */
void DeleteGraphResponsePrivate::parseDeleteGraphResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteGraphResponse"));
    Q_UNUSED(xml) ///< @todo
}
