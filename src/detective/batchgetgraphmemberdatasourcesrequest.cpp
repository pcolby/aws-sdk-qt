...
#include "batchgetgraphmemberdatasourcesrequest_p.h"
...
/*!
 * \class QtAws::Detective::BatchGetGraphMemberDatasourcesRequest
 * \brief The BatchGetGraphMemberDatasourcesRequest class provides an interface for Detective BatchGetGraphMemberDatasources requests.
 *
 ...
 */
BatchGetGraphMemberDatasourcesRequest::BatchGetGraphMemberDatasourcesRequest(const BatchGetGraphMemberDatasourcesRequest &other)
    : DetectiveRequest(new BatchGetGraphMemberDatasourcesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a BatchGetGraphMemberDatasourcesRequest object.
 */
BatchGetGraphMemberDatasourcesRequest::BatchGetGraphMemberDatasourcesRequest()
    : DetectiveRequest(new BatchGetGraphMemberDatasourcesRequestPrivate(DetectiveRequest::BatchGetGraphMemberDatasourcesAction, this))
{
 ...
 * \reimp
 */
bool BatchGetGraphMemberDatasourcesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BatchGetGraphMemberDatasourcesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BatchGetGraphMemberDatasourcesRequest::response(QNetworkReply * const reply) const
{
    return new BatchGetGraphMemberDatasourcesResponse(*this, reply);
}

/*!
 * \class QtAws::Detective::BatchGetGraphMemberDatasourcesRequestPrivate
 * \brief The BatchGetGraphMemberDatasourcesRequestPrivate class provides private implementation for BatchGetGraphMemberDatasourcesRequest.
 * \internal
 *
 * \inmodule QtAwsDetective
 */
...
/*!
 * Constructs a BatchGetGraphMemberDatasourcesRequestPrivate object for Detective \a action,
 * with public implementation \a q.
 */
BatchGetGraphMemberDatasourcesRequestPrivate::BatchGetGraphMemberDatasourcesRequestPrivate(
    const DetectiveRequest::Action action, BatchGetGraphMemberDatasourcesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the BatchGetGraphMemberDatasourcesRequest
 * class' copy constructor.
 */
BatchGetGraphMemberDatasourcesRequestPrivate::BatchGetGraphMemberDatasourcesRequestPrivate(
    const BatchGetGraphMemberDatasourcesRequestPrivate &other, BatchGetGraphMemberDatasourcesRequest * const q)
