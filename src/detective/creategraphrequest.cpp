...
#include "creategraphrequest_p.h"
...
/*!
 * \class QtAws::Detective::CreateGraphRequest
 * \brief The CreateGraphRequest class provides an interface for Detective CreateGraph requests.
 *
 ...
 */
CreateGraphRequest::CreateGraphRequest(const CreateGraphRequest &other)
    : DetectiveRequest(new CreateGraphRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateGraphRequest object.
 */
CreateGraphRequest::CreateGraphRequest()
    : DetectiveRequest(new CreateGraphRequestPrivate(DetectiveRequest::CreateGraphAction, this))
{
 ...
 * \reimp
 */
bool CreateGraphRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateGraphResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateGraphRequest::response(QNetworkReply * const reply) const
{
    return new CreateGraphResponse(*this, reply);
}

/*!
 * \class QtAws::Detective::CreateGraphRequestPrivate
 * \brief The CreateGraphRequestPrivate class provides private implementation for CreateGraphRequest.
 * \internal
 *
 * \inmodule QtAwsDetective
 */
...
/*!
 * Constructs a CreateGraphRequestPrivate object for Detective \a action,
 * with public implementation \a q.
 */
CreateGraphRequestPrivate::CreateGraphRequestPrivate(
    const DetectiveRequest::Action action, CreateGraphRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateGraphRequest
 * class' copy constructor.
 */
CreateGraphRequestPrivate::CreateGraphRequestPrivate(
    const CreateGraphRequestPrivate &other, CreateGraphRequest * const q)
