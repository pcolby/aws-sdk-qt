...
#include "updatedatasourcepackagesrequest_p.h"
...
/*!
 * \class QtAws::Detective::UpdateDatasourcePackagesRequest
 * \brief The UpdateDatasourcePackagesRequest class provides an interface for Detective UpdateDatasourcePackages requests.
 *
 ...
 */
UpdateDatasourcePackagesRequest::UpdateDatasourcePackagesRequest(const UpdateDatasourcePackagesRequest &other)
    : DetectiveRequest(new UpdateDatasourcePackagesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateDatasourcePackagesRequest object.
 */
UpdateDatasourcePackagesRequest::UpdateDatasourcePackagesRequest()
    : DetectiveRequest(new UpdateDatasourcePackagesRequestPrivate(DetectiveRequest::UpdateDatasourcePackagesAction, this))
{
 ...
 * \reimp
 */
bool UpdateDatasourcePackagesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateDatasourcePackagesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateDatasourcePackagesRequest::response(QNetworkReply * const reply) const
{
    return new UpdateDatasourcePackagesResponse(*this, reply);
}

/*!
 * \class QtAws::Detective::UpdateDatasourcePackagesRequestPrivate
 * \brief The UpdateDatasourcePackagesRequestPrivate class provides private implementation for UpdateDatasourcePackagesRequest.
 * \internal
 *
 * \inmodule QtAwsDetective
 */
...
/*!
 * Constructs a UpdateDatasourcePackagesRequestPrivate object for Detective \a action,
 * with public implementation \a q.
 */
UpdateDatasourcePackagesRequestPrivate::UpdateDatasourcePackagesRequestPrivate(
    const DetectiveRequest::Action action, UpdateDatasourcePackagesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateDatasourcePackagesRequest
 * class' copy constructor.
 */
UpdateDatasourcePackagesRequestPrivate::UpdateDatasourcePackagesRequestPrivate(
    const UpdateDatasourcePackagesRequestPrivate &other, UpdateDatasourcePackagesRequest * const q)
