...
/*!
 * \class QtAws::Detective::UpdateOrganizationConfigurationRequest
 * \brief The UpdateOrganizationConfigurationRequest class provides an interface for Detective UpdateOrganizationConfiguration requests.
 *
 ...
 *  behavior
 *
 * \sa DetectiveClient::updateOrganizationConfiguration
 */
...
UpdateOrganizationConfigurationRequest::UpdateOrganizationConfigurationRequest(const UpdateOrganizationConfigurationRequest &other)
    : DetectiveRequest(new UpdateOrganizationConfigurationRequestPrivate(*other.d_func(), this))
{
...
UpdateOrganizationConfigurationRequest::UpdateOrganizationConfigurationRequest()
    : DetectiveRequest(new UpdateOrganizationConfigurationRequestPrivate(DetectiveRequest::UpdateOrganizationConfigurationAction, this))
{
...
/*!
 * \class QtAws::Detective::UpdateOrganizationConfigurationRequestPrivate
...
/*!
 * Constructs a UpdateOrganizationConfigurationRequestPrivate object for Detective \a action,
 * with public implementation \a q.
 */
UpdateOrganizationConfigurationRequestPrivate::UpdateOrganizationConfigurationRequestPrivate(
    const DetectiveRequest::Action action, UpdateOrganizationConfigurationRequest * const q)
