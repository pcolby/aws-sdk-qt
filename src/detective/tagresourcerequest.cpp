...
/*!
 * \class QtAws::Detective::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for Detective TagResource requests.
 *
 ...
 *  behavior
 *
 * \sa DetectiveClient::tagResource
 */
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : DetectiveRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : DetectiveRequest(new TagResourceRequestPrivate(DetectiveRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::Detective::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for Detective \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const DetectiveRequest::Action action, TagResourceRequest * const q)
