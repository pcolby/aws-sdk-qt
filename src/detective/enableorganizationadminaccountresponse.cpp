...
/*!
 * \class QtAws::Detective::EnableOrganizationAdminAccountResponse
 * \brief The EnableOrganizationAdminAccountResponse class provides an interace for Detective EnableOrganizationAdminAccount responses.
 *
...
EnableOrganizationAdminAccountResponse::EnableOrganizationAdminAccountResponse(
    ...
    : DetectiveResponse(new EnableOrganizationAdminAccountResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Detective EnableOrganizationAdminAccount \a response.
 */
...
/*!
 * \class QtAws::Detective::EnableOrganizationAdminAccountResponsePrivate
...
EnableOrganizationAdminAccountResponsePrivate::EnableOrganizationAdminAccountResponsePrivate(
    EnableOrganizationAdminAccountResponse * const q) : DetectiveResponsePrivate(q)
{

}

/*!
 * Parses a Detective EnableOrganizationAdminAccount response element from \a xml.
 */
