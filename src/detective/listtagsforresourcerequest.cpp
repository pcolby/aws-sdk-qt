...
/*!
 * \class QtAws::Detective::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for Detective ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : DetectiveRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : DetectiveRequest(new ListTagsForResourceRequestPrivate(DetectiveRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::Detective::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for Detective \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const DetectiveRequest::Action action, ListTagsForResourceRequest * const q)
