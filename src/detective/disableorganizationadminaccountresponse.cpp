...
/*!
 * \class QtAws::Detective::DisableOrganizationAdminAccountResponse
 * \brief The DisableOrganizationAdminAccountResponse class provides an interace for Detective DisableOrganizationAdminAccount responses.
 *
...
DisableOrganizationAdminAccountResponse::DisableOrganizationAdminAccountResponse(
    ...
    : DetectiveResponse(new DisableOrganizationAdminAccountResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Detective DisableOrganizationAdminAccount \a response.
 */
...
/*!
 * \class QtAws::Detective::DisableOrganizationAdminAccountResponsePrivate
...
DisableOrganizationAdminAccountResponsePrivate::DisableOrganizationAdminAccountResponsePrivate(
    DisableOrganizationAdminAccountResponse * const q) : DetectiveResponsePrivate(q)
{

}

/*!
 * Parses a Detective DisableOrganizationAdminAccount response element from \a xml.
 */
