...
/*!
 * \class QtAws::Detective::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Detective ListTagsForResource responses.
 *
 ...
 *  behavior
 *
 * \sa DetectiveClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : DetectiveResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(DetectiveResponse::request());
}

/*!
 * \reimp
 * Parses a successful Detective ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Detective::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : DetectiveResponsePrivate(q)
{

}

/*!
 * Parses a Detective ListTagsForResource response element from \a xml.
 */
