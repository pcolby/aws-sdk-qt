...
#include "deletegraphrequest_p.h"
...
/*!
 * \class QtAws::Detective::DeleteGraphRequest
 * \brief The DeleteGraphRequest class provides an interface for Detective DeleteGraph requests.
 *
 ...
 *  behavior
 *
 * \sa DetectiveClient::deleteGraph
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteGraphRequest::DeleteGraphRequest(const DeleteGraphRequest &other)
    : DetectiveRequest(new DeleteGraphRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteGraphRequest object.
 */
DeleteGraphRequest::DeleteGraphRequest()
    : DetectiveRequest(new DeleteGraphRequestPrivate(DetectiveRequest::DeleteGraphAction, this))
{
 ...
 * \reimp
 */
bool DeleteGraphRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteGraphResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteGraphRequest::response(QNetworkReply * const reply) const
{
    return new DeleteGraphResponse(*this, reply);
}

/*!
 * \class QtAws::Detective::DeleteGraphRequestPrivate
 * \brief The DeleteGraphRequestPrivate class provides private implementation for DeleteGraphRequest.
 * \internal
 *
 * \inmodule QtAwsDetective
 */
...
/*!
 * Constructs a DeleteGraphRequestPrivate object for Detective \a action,
 * with public implementation \a q.
 */
DeleteGraphRequestPrivate::DeleteGraphRequestPrivate(
    const DetectiveRequest::Action action, DeleteGraphRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteGraphRequest
 * class' copy constructor.
 */
DeleteGraphRequestPrivate::DeleteGraphRequestPrivate(
    const DeleteGraphRequestPrivate &other, DeleteGraphRequest * const q)
