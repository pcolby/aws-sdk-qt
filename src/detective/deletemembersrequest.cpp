...
/*!
 * \class QtAws::Detective::DeleteMembersRequest
 * \brief The DeleteMembersRequest class provides an interface for Detective DeleteMembers requests.
 *
...
DeleteMembersRequest::DeleteMembersRequest(const DeleteMembersRequest &other)
    : DetectiveRequest(new DeleteMembersRequestPrivate(*other.d_func(), this))
{
...
DeleteMembersRequest::DeleteMembersRequest()
    : DetectiveRequest(new DeleteMembersRequestPrivate(DetectiveRequest::DeleteMembersAction, this))
{
...
/*!
 * \class QtAws::Detective::DeleteMembersRequestPrivate
...
/*!
 * Constructs a DeleteMembersRequestPrivate object for Detective \a action,
 * with public implementation \a q.
 */
DeleteMembersRequestPrivate::DeleteMembersRequestPrivate(
    const DetectiveRequest::Action action, DeleteMembersRequest * const q)
