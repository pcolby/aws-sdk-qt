...
/*!
 * \class QtAws::Kms::VerifyMacRequest
 * \brief The VerifyMacRequest class provides an interface for Kms VerifyMac requests.
 *
 * \inmodule QtAwsKms
 *
 ...
 */
VerifyMacRequest::VerifyMacRequest(const VerifyMacRequest &other)
    : KmsRequest(new VerifyMacRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a VerifyMacRequest object.
 */
VerifyMacRequest::VerifyMacRequest()
    : KmsRequest(new VerifyMacRequestPrivate(KmsRequest::VerifyMacAction, this))
{
 ...
 * \reimp
 */
bool VerifyMacRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a VerifyMacResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * VerifyMacRequest::response(QNetworkReply * const reply) const
{
    return new VerifyMacResponse(*this, reply);
}

/*!
 * \class QtAws::Kms::VerifyMacRequestPrivate
 * \brief The VerifyMacRequestPrivate class provides private implementation for VerifyMacRequest.
 * \internal
 *
 * \inmodule QtAwsKms
 */
...
/*!
 * Constructs a VerifyMacRequestPrivate object for Kms \a action,
 * with public implementation \a q.
 */
VerifyMacRequestPrivate::VerifyMacRequestPrivate(
    const KmsRequest::Action action, VerifyMacRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the VerifyMacRequest
 * class' copy constructor.
 */
VerifyMacRequestPrivate::VerifyMacRequestPrivate(
    const VerifyMacRequestPrivate &other, VerifyMacRequest * const q)
