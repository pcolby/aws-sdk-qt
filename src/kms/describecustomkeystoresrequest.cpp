...
#include "describecustomkeystoresrequest_p.h"
...
/*!
 * \class QtAws::Kms::DescribeCustomKeyStoresRequest
 * \brief The DescribeCustomKeyStoresRequest class provides an interface for Kms DescribeCustomKeyStores requests.
 *
 * \inmodule QtAwsKms
 *
 ...
 */
DescribeCustomKeyStoresRequest::DescribeCustomKeyStoresRequest(const DescribeCustomKeyStoresRequest &other)
    : KmsRequest(new DescribeCustomKeyStoresRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeCustomKeyStoresRequest object.
 */
DescribeCustomKeyStoresRequest::DescribeCustomKeyStoresRequest()
    : KmsRequest(new DescribeCustomKeyStoresRequestPrivate(KmsRequest::DescribeCustomKeyStoresAction, this))
{
 ...
 * \reimp
 */
bool DescribeCustomKeyStoresRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeCustomKeyStoresResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeCustomKeyStoresRequest::response(QNetworkReply * const reply) const
{
    return new DescribeCustomKeyStoresResponse(*this, reply);
}

/*!
 * \class QtAws::Kms::DescribeCustomKeyStoresRequestPrivate
 * \brief The DescribeCustomKeyStoresRequestPrivate class provides private implementation for DescribeCustomKeyStoresRequest.
 * \internal
 *
 * \inmodule QtAwsKms
 */
...
/*!
 * Constructs a DescribeCustomKeyStoresRequestPrivate object for Kms \a action,
 * with public implementation \a q.
 */
DescribeCustomKeyStoresRequestPrivate::DescribeCustomKeyStoresRequestPrivate(
    const KmsRequest::Action action, DescribeCustomKeyStoresRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeCustomKeyStoresRequest
 * class' copy constructor.
 */
DescribeCustomKeyStoresRequestPrivate::DescribeCustomKeyStoresRequestPrivate(
    const DescribeCustomKeyStoresRequestPrivate &other, DescribeCustomKeyStoresRequest * const q)
