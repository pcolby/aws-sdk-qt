...
/*!
 * \class QtAws::Kms::SignRequest
 * \brief The SignRequest class provides an interface for Kms Sign requests.
 *
 * \inmodule QtAwsKms
 *
 ...
 */
SignRequest::SignRequest(const SignRequest &other)
    : KmsRequest(new SignRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a SignRequest object.
 */
SignRequest::SignRequest()
    : KmsRequest(new SignRequestPrivate(KmsRequest::SignAction, this))
{
 ...
 * \reimp
 */
bool SignRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a SignResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * SignRequest::response(QNetworkReply * const reply) const
{
    return new SignResponse(*this, reply);
}

/*!
 * \class QtAws::Kms::SignRequestPrivate
 * \brief The SignRequestPrivate class provides private implementation for SignRequest.
 * \internal
 *
 * \inmodule QtAwsKms
 */
...
/*!
 * Constructs a SignRequestPrivate object for Kms \a action,
 * with public implementation \a q.
 */
SignRequestPrivate::SignRequestPrivate(
    const KmsRequest::Action action, SignRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the SignRequest
 * class' copy constructor.
 */
SignRequestPrivate::SignRequestPrivate(
    const SignRequestPrivate &other, SignRequest * const q)
