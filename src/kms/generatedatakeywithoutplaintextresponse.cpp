 ...
 *
 * \brief The GenerateDataKeyWithoutPlaintextResponse class encapsulates KMS GenerateDataKeyWithoutPlaintext responses.
 *
 * \ingroup KMS
 *
 ...
 *
 * \sa KMSClient::generateDataKeyWithoutPlaintext
 */
