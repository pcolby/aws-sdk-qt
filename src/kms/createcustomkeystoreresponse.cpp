...
#include "createcustomkeystoreresponse_p.h"
...
/*!
 * \class QtAws::Kms::CreateCustomKeyStoreResponse
 * \brief The CreateCustomKeyStoreResponse class provides an interace for Kms CreateCustomKeyStore responses.
 *
 * \inmodule QtAwsKms
 *
...
/*!
 * Constructs a CreateCustomKeyStoreResponse object for \a reply to \a request, with parent \a parent.
 */
CreateCustomKeyStoreResponse::CreateCustomKeyStoreResponse(
        const CreateCustomKeyStoreRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : KmsResponse(new CreateCustomKeyStoreResponsePrivate(this), parent)
{
    setRequest(new CreateCustomKeyStoreRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Kms CreateCustomKeyStore \a response.
 */
void CreateCustomKeyStoreResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateCustomKeyStoreResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Kms::CreateCustomKeyStoreResponsePrivate
 * \brief The CreateCustomKeyStoreResponsePrivate class provides private implementation for CreateCustomKeyStoreResponse.
 * \internal
 *
 * \inmodule QtAwsKms
 */
...
/*!
 * Constructs a CreateCustomKeyStoreResponsePrivate object with public implementation \a q.
 */
CreateCustomKeyStoreResponsePrivate::CreateCustomKeyStoreResponsePrivate(
    CreateCustomKeyStoreResponse * const q) : KmsResponsePrivate(q)
{

}

/*!
 * Parses a Kms CreateCustomKeyStore response element from \a xml.
 */
void CreateCustomKeyStoreResponsePrivate::parseCreateCustomKeyStoreResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateCustomKeyStoreResponse"));
    Q_UNUSED(xml) ///< @todo
}
