...
#include "generatedatakeypairwithoutplaintextrequest_p.h"
...
/*!
 * \class QtAws::Kms::GenerateDataKeyPairWithoutPlaintextRequest
 * \brief The GenerateDataKeyPairWithoutPlaintextRequest class provides an interface for Kms GenerateDataKeyPairWithoutPlaintext requests.
 *
 * \inmodule QtAwsKms
 *
 ...
 *
 * \sa KmsClient::generateDataKeyPairWithoutPlaintext
 */

/*!
 * Constructs a copy of \a other.
 */
GenerateDataKeyPairWithoutPlaintextRequest::GenerateDataKeyPairWithoutPlaintextRequest(const GenerateDataKeyPairWithoutPlaintextRequest &other)
    : KmsRequest(new GenerateDataKeyPairWithoutPlaintextRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GenerateDataKeyPairWithoutPlaintextRequest object.
 */
GenerateDataKeyPairWithoutPlaintextRequest::GenerateDataKeyPairWithoutPlaintextRequest()
    : KmsRequest(new GenerateDataKeyPairWithoutPlaintextRequestPrivate(KmsRequest::GenerateDataKeyPairWithoutPlaintextAction, this))
{
 ...
 * \reimp
 */
bool GenerateDataKeyPairWithoutPlaintextRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GenerateDataKeyPairWithoutPlaintextResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GenerateDataKeyPairWithoutPlaintextRequest::response(QNetworkReply * const reply) const
{
    return new GenerateDataKeyPairWithoutPlaintextResponse(*this, reply);
}

/*!
 * \class QtAws::Kms::GenerateDataKeyPairWithoutPlaintextRequestPrivate
 * \brief The GenerateDataKeyPairWithoutPlaintextRequestPrivate class provides private implementation for GenerateDataKeyPairWithoutPlaintextRequest.
 * \internal
 *
 * \inmodule QtAwsKms
 */
...
/*!
 * Constructs a GenerateDataKeyPairWithoutPlaintextRequestPrivate object for Kms \a action,
 * with public implementation \a q.
 */
GenerateDataKeyPairWithoutPlaintextRequestPrivate::GenerateDataKeyPairWithoutPlaintextRequestPrivate(
    const KmsRequest::Action action, GenerateDataKeyPairWithoutPlaintextRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GenerateDataKeyPairWithoutPlaintextRequest
 * class' copy constructor.
 */
GenerateDataKeyPairWithoutPlaintextRequestPrivate::GenerateDataKeyPairWithoutPlaintextRequestPrivate(
    const GenerateDataKeyPairWithoutPlaintextRequestPrivate &other, GenerateDataKeyPairWithoutPlaintextRequest * const q)
