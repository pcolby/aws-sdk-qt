...
class QTAWS_EXPORT GenerateDataKeyWithoutPlaintextResponse : public KmsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const GenerateDataKeyWithoutPlaintextRequest * request() const override;
