...
#include "generatedatakeypairresponse_p.h"
...
/*!
 * \class QtAws::Kms::GenerateDataKeyPairResponse
 * \brief The GenerateDataKeyPairResponse class provides an interace for Kms GenerateDataKeyPair responses.
 *
 * \inmodule QtAwsKms
 *
 ...
 *
 * \sa KmsClient::generateDataKeyPair
 */

/*!
 * Constructs a GenerateDataKeyPairResponse object for \a reply to \a request, with parent \a parent.
 */
GenerateDataKeyPairResponse::GenerateDataKeyPairResponse(
        const GenerateDataKeyPairRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : KmsResponse(new GenerateDataKeyPairResponsePrivate(this), parent)
{
    setRequest(new GenerateDataKeyPairRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GenerateDataKeyPairRequest * GenerateDataKeyPairResponse::request() const
{
    Q_D(const GenerateDataKeyPairResponse);
    return static_cast<const GenerateDataKeyPairRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Kms GenerateDataKeyPair \a response.
 */
void GenerateDataKeyPairResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GenerateDataKeyPairResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Kms::GenerateDataKeyPairResponsePrivate
 * \brief The GenerateDataKeyPairResponsePrivate class provides private implementation for GenerateDataKeyPairResponse.
 * \internal
 *
 * \inmodule QtAwsKms
 */
...
/*!
 * Constructs a GenerateDataKeyPairResponsePrivate object with public implementation \a q.
 */
GenerateDataKeyPairResponsePrivate::GenerateDataKeyPairResponsePrivate(
    GenerateDataKeyPairResponse * const q) : KmsResponsePrivate(q)
{

}

/*!
 * Parses a Kms GenerateDataKeyPair response element from \a xml.
 */
void GenerateDataKeyPairResponsePrivate::parseGenerateDataKeyPairResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GenerateDataKeyPairResponse"));
    Q_UNUSED(xml) ///< @todo
}
