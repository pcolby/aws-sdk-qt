...
#include "updateprimaryregionrequest_p.h"
...
/*!
 * \class QtAws::Kms::UpdatePrimaryRegionRequest
 * \brief The UpdatePrimaryRegionRequest class provides an interface for Kms UpdatePrimaryRegion requests.
 *
 * \inmodule QtAwsKms
 *
 ...
 */
UpdatePrimaryRegionRequest::UpdatePrimaryRegionRequest(const UpdatePrimaryRegionRequest &other)
    : KmsRequest(new UpdatePrimaryRegionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdatePrimaryRegionRequest object.
 */
UpdatePrimaryRegionRequest::UpdatePrimaryRegionRequest()
    : KmsRequest(new UpdatePrimaryRegionRequestPrivate(KmsRequest::UpdatePrimaryRegionAction, this))
{
 ...
 * \reimp
 */
bool UpdatePrimaryRegionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdatePrimaryRegionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdatePrimaryRegionRequest::response(QNetworkReply * const reply) const
{
    return new UpdatePrimaryRegionResponse(*this, reply);
}

/*!
 * \class QtAws::Kms::UpdatePrimaryRegionRequestPrivate
 * \brief The UpdatePrimaryRegionRequestPrivate class provides private implementation for UpdatePrimaryRegionRequest.
 * \internal
 *
 * \inmodule QtAwsKms
 */
...
/*!
 * Constructs a UpdatePrimaryRegionRequestPrivate object for Kms \a action,
 * with public implementation \a q.
 */
UpdatePrimaryRegionRequestPrivate::UpdatePrimaryRegionRequestPrivate(
    const KmsRequest::Action action, UpdatePrimaryRegionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdatePrimaryRegionRequest
 * class' copy constructor.
 */
UpdatePrimaryRegionRequestPrivate::UpdatePrimaryRegionRequestPrivate(
    const UpdatePrimaryRegionRequestPrivate &other, UpdatePrimaryRegionRequest * const q)
