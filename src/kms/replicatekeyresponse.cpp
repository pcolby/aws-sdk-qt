...
#include "replicatekeyresponse_p.h"
...
/*!
 * \class QtAws::Kms::ReplicateKeyResponse
 * \brief The ReplicateKeyResponse class provides an interace for Kms ReplicateKey responses.
 *
 * \inmodule QtAwsKms
 *
 ...
 *
 * \sa KmsClient::replicateKey
 */

/*!
 * Constructs a ReplicateKeyResponse object for \a reply to \a request, with parent \a parent.
 */
ReplicateKeyResponse::ReplicateKeyResponse(
        const ReplicateKeyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : KmsResponse(new ReplicateKeyResponsePrivate(this), parent)
{
    setRequest(new ReplicateKeyRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ReplicateKeyRequest * ReplicateKeyResponse::request() const
{
    Q_D(const ReplicateKeyResponse);
    return static_cast<const ReplicateKeyRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Kms ReplicateKey \a response.
 */
void ReplicateKeyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ReplicateKeyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Kms::ReplicateKeyResponsePrivate
 * \brief The ReplicateKeyResponsePrivate class provides private implementation for ReplicateKeyResponse.
 * \internal
 *
 * \inmodule QtAwsKms
 */
...
/*!
 * Constructs a ReplicateKeyResponsePrivate object with public implementation \a q.
 */
ReplicateKeyResponsePrivate::ReplicateKeyResponsePrivate(
    ReplicateKeyResponse * const q) : KmsResponsePrivate(q)
{

}

/*!
 * Parses a Kms ReplicateKey response element from \a xml.
 */
void ReplicateKeyResponsePrivate::parseReplicateKeyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ReplicateKeyResponse"));
    Q_UNUSED(xml) ///< @todo
}
