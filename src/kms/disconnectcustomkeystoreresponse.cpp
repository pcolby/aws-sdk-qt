...
#include "disconnectcustomkeystoreresponse_p.h"
...
/*!
 * \class QtAws::KMS::DisconnectCustomKeyStoreResponse
 * \brief The DisconnectCustomKeyStoreResponse class provides an interace for KMS DisconnectCustomKeyStore responses.
 *
 * \inmodule QtAwsKMS
 *
...
/*!
 * Constructs a DisconnectCustomKeyStoreResponse object for \a reply to \a request, with parent \a parent.
 */
DisconnectCustomKeyStoreResponse::DisconnectCustomKeyStoreResponse(
        const DisconnectCustomKeyStoreRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : KmsResponse(new DisconnectCustomKeyStoreResponsePrivate(this), parent)
{
    setRequest(new DisconnectCustomKeyStoreRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful KMS DisconnectCustomKeyStore \a response.
 */
void DisconnectCustomKeyStoreResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DisconnectCustomKeyStoreResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::KMS::DisconnectCustomKeyStoreResponsePrivate
 * \brief The DisconnectCustomKeyStoreResponsePrivate class provides private implementation for DisconnectCustomKeyStoreResponse.
 * \internal
 *
 * \inmodule QtAwsKMS
 */
...
/*!
 * Constructs a DisconnectCustomKeyStoreResponsePrivate object with public implementation \a q.
 */
DisconnectCustomKeyStoreResponsePrivate::DisconnectCustomKeyStoreResponsePrivate(
    DisconnectCustomKeyStoreResponse * const q) : KmsResponsePrivate(q)
{

}

/*!
 * Parses a KMS DisconnectCustomKeyStore response element from \a xml.
 */
void DisconnectCustomKeyStoreResponsePrivate::parseDisconnectCustomKeyStoreResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DisconnectCustomKeyStoreResponse"));
    Q_UNUSED(xml) ///< @todo
}
