...
/*!
 * \class QtAws::KMS::GetPublicKeyRequest
 * \brief The GetPublicKeyRequest class provides an interface for KMS GetPublicKey requests.
 *
 * \inmodule QtAwsKMS
 *
...
GetPublicKeyRequest::GetPublicKeyRequest(const GetPublicKeyRequest &other)
    : KmsRequest(new GetPublicKeyRequestPrivate(*other.d_func(), this))
{
...
GetPublicKeyRequest::GetPublicKeyRequest()
    : KmsRequest(new GetPublicKeyRequestPrivate(KmsRequest::GetPublicKeyAction, this))
{
...
/*!
 * \class QtAws::KMS::GetPublicKeyRequestPrivate
...
/*!
 * Constructs a GetPublicKeyRequestPrivate object for Kms \a action,
 * with public implementation \a q.
 */
GetPublicKeyRequestPrivate::GetPublicKeyRequestPrivate(
    const KmsRequest::Action action, GetPublicKeyRequest * const q)
