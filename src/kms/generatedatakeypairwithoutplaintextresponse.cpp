...
#include "generatedatakeypairwithoutplaintextresponse_p.h"
...
/*!
 * \class QtAws::Kms::GenerateDataKeyPairWithoutPlaintextResponse
 * \brief The GenerateDataKeyPairWithoutPlaintextResponse class provides an interace for Kms GenerateDataKeyPairWithoutPlaintext responses.
 *
 * \inmodule QtAwsKms
 *
...
/*!
 * Constructs a GenerateDataKeyPairWithoutPlaintextResponse object for \a reply to \a request, with parent \a parent.
 */
GenerateDataKeyPairWithoutPlaintextResponse::GenerateDataKeyPairWithoutPlaintextResponse(
        const GenerateDataKeyPairWithoutPlaintextRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : KmsResponse(new GenerateDataKeyPairWithoutPlaintextResponsePrivate(this), parent)
{
    setRequest(new GenerateDataKeyPairWithoutPlaintextRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Kms GenerateDataKeyPairWithoutPlaintext \a response.
 */
void GenerateDataKeyPairWithoutPlaintextResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GenerateDataKeyPairWithoutPlaintextResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Kms::GenerateDataKeyPairWithoutPlaintextResponsePrivate
 * \brief The GenerateDataKeyPairWithoutPlaintextResponsePrivate class provides private implementation for GenerateDataKeyPairWithoutPlaintextResponse.
 * \internal
 *
 * \inmodule QtAwsKms
 */
...
/*!
 * Constructs a GenerateDataKeyPairWithoutPlaintextResponsePrivate object with public implementation \a q.
 */
GenerateDataKeyPairWithoutPlaintextResponsePrivate::GenerateDataKeyPairWithoutPlaintextResponsePrivate(
    GenerateDataKeyPairWithoutPlaintextResponse * const q) : KmsResponsePrivate(q)
{

}

/*!
 * Parses a Kms GenerateDataKeyPairWithoutPlaintext response element from \a xml.
 */
void GenerateDataKeyPairWithoutPlaintextResponsePrivate::parseGenerateDataKeyPairWithoutPlaintextResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GenerateDataKeyPairWithoutPlaintextResponse"));
    Q_UNUSED(xml) ///< @todo
}
