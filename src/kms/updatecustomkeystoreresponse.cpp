...
#include "updatecustomkeystoreresponse_p.h"
...
/*!
 * \class QtAws::KMS::UpdateCustomKeyStoreResponse
 * \brief The UpdateCustomKeyStoreResponse class provides an interace for KMS UpdateCustomKeyStore responses.
 *
 * \inmodule QtAwsKMS
 *
 ...
 *
 * \sa KmsClient::updateCustomKeyStore
 */

/*!
 * Constructs a UpdateCustomKeyStoreResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateCustomKeyStoreResponse::UpdateCustomKeyStoreResponse(
        const UpdateCustomKeyStoreRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : KmsResponse(new UpdateCustomKeyStoreResponsePrivate(this), parent)
{
    setRequest(new UpdateCustomKeyStoreRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateCustomKeyStoreRequest * UpdateCustomKeyStoreResponse::request() const
{
    Q_D(const UpdateCustomKeyStoreResponse);
    return static_cast<const UpdateCustomKeyStoreRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful KMS UpdateCustomKeyStore \a response.
 */
void UpdateCustomKeyStoreResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateCustomKeyStoreResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::KMS::UpdateCustomKeyStoreResponsePrivate
 * \brief The UpdateCustomKeyStoreResponsePrivate class provides private implementation for UpdateCustomKeyStoreResponse.
 * \internal
 *
 * \inmodule QtAwsKMS
 */
...
/*!
 * Constructs a UpdateCustomKeyStoreResponsePrivate object with public implementation \a q.
 */
UpdateCustomKeyStoreResponsePrivate::UpdateCustomKeyStoreResponsePrivate(
    UpdateCustomKeyStoreResponse * const q) : KmsResponsePrivate(q)
{

}

/*!
 * Parses a KMS UpdateCustomKeyStore response element from \a xml.
 */
void UpdateCustomKeyStoreResponsePrivate::parseUpdateCustomKeyStoreResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateCustomKeyStoreResponse"));
    Q_UNUSED(xml) ///< @todo
}
