...
class QTAWS_EXPORT DescribeCustomKeyStoresResponsePrivate : public KmsResponsePrivate {

public:

    DescribeCustomKeyStoresResponsePrivate(DescribeCustomKeyStoresResponse * const q);
