...
#include "updateprimaryregionresponse_p.h"
...
/*!
 * \class QtAws::Kms::UpdatePrimaryRegionResponse
 * \brief The UpdatePrimaryRegionResponse class provides an interace for Kms UpdatePrimaryRegion responses.
 *
 * \inmodule QtAwsKms
 *
 ...
 *
 * \sa KmsClient::updatePrimaryRegion
 */

/*!
 * Constructs a UpdatePrimaryRegionResponse object for \a reply to \a request, with parent \a parent.
 */
UpdatePrimaryRegionResponse::UpdatePrimaryRegionResponse(
        const UpdatePrimaryRegionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : KmsResponse(new UpdatePrimaryRegionResponsePrivate(this), parent)
{
    setRequest(new UpdatePrimaryRegionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdatePrimaryRegionRequest * UpdatePrimaryRegionResponse::request() const
{
    Q_D(const UpdatePrimaryRegionResponse);
    return static_cast<const UpdatePrimaryRegionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Kms UpdatePrimaryRegion \a response.
 */
void UpdatePrimaryRegionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdatePrimaryRegionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Kms::UpdatePrimaryRegionResponsePrivate
 * \brief The UpdatePrimaryRegionResponsePrivate class provides private implementation for UpdatePrimaryRegionResponse.
 * \internal
 *
 * \inmodule QtAwsKms
 */
...
/*!
 * Constructs a UpdatePrimaryRegionResponsePrivate object with public implementation \a q.
 */
UpdatePrimaryRegionResponsePrivate::UpdatePrimaryRegionResponsePrivate(
    UpdatePrimaryRegionResponse * const q) : KmsResponsePrivate(q)
{

}

/*!
 * Parses a Kms UpdatePrimaryRegion response element from \a xml.
 */
void UpdatePrimaryRegionResponsePrivate::parseUpdatePrimaryRegionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdatePrimaryRegionResponse"));
    Q_UNUSED(xml) ///< @todo
}
