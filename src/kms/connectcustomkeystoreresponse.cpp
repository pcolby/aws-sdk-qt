...
#include "connectcustomkeystoreresponse_p.h"
...
/*!
 * \class QtAws::KMS::ConnectCustomKeyStoreResponse
 * \brief The ConnectCustomKeyStoreResponse class provides an interace for KMS ConnectCustomKeyStore responses.
 *
 * \inmodule QtAwsKMS
 *
...
/*!
 * Constructs a ConnectCustomKeyStoreResponse object for \a reply to \a request, with parent \a parent.
 */
ConnectCustomKeyStoreResponse::ConnectCustomKeyStoreResponse(
        const ConnectCustomKeyStoreRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : KmsResponse(new ConnectCustomKeyStoreResponsePrivate(this), parent)
{
    setRequest(new ConnectCustomKeyStoreRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful KMS ConnectCustomKeyStore \a response.
 */
void ConnectCustomKeyStoreResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ConnectCustomKeyStoreResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::KMS::ConnectCustomKeyStoreResponsePrivate
 * \brief The ConnectCustomKeyStoreResponsePrivate class provides private implementation for ConnectCustomKeyStoreResponse.
 * \internal
 *
 * \inmodule QtAwsKMS
 */
...
/*!
 * Constructs a ConnectCustomKeyStoreResponsePrivate object with public implementation \a q.
 */
ConnectCustomKeyStoreResponsePrivate::ConnectCustomKeyStoreResponsePrivate(
    ConnectCustomKeyStoreResponse * const q) : KmsResponsePrivate(q)
{

}

/*!
 * Parses a KMS ConnectCustomKeyStore response element from \a xml.
 */
void ConnectCustomKeyStoreResponsePrivate::parseConnectCustomKeyStoreResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ConnectCustomKeyStoreResponse"));
    Q_UNUSED(xml) ///< @todo
}
