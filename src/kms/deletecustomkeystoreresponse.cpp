...
#include "deletecustomkeystoreresponse_p.h"
...
/*!
 * \class QtAws::KMS::DeleteCustomKeyStoreResponse
 * \brief The DeleteCustomKeyStoreResponse class provides an interace for KMS DeleteCustomKeyStore responses.
 *
 * \inmodule QtAwsKMS
 *
...
/*!
 * Constructs a DeleteCustomKeyStoreResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteCustomKeyStoreResponse::DeleteCustomKeyStoreResponse(
        const DeleteCustomKeyStoreRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : KmsResponse(new DeleteCustomKeyStoreResponsePrivate(this), parent)
{
    setRequest(new DeleteCustomKeyStoreRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful KMS DeleteCustomKeyStore \a response.
 */
void DeleteCustomKeyStoreResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteCustomKeyStoreResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::KMS::DeleteCustomKeyStoreResponsePrivate
 * \brief The DeleteCustomKeyStoreResponsePrivate class provides private implementation for DeleteCustomKeyStoreResponse.
 * \internal
 *
 * \inmodule QtAwsKMS
 */
...
/*!
 * Constructs a DeleteCustomKeyStoreResponsePrivate object with public implementation \a q.
 */
DeleteCustomKeyStoreResponsePrivate::DeleteCustomKeyStoreResponsePrivate(
    DeleteCustomKeyStoreResponse * const q) : KmsResponsePrivate(q)
{

}

/*!
 * Parses a KMS DeleteCustomKeyStore response element from \a xml.
 */
void DeleteCustomKeyStoreResponsePrivate::parseDeleteCustomKeyStoreResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteCustomKeyStoreResponse"));
    Q_UNUSED(xml) ///< @todo
}
