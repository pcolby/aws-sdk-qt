...
class QTAWS_EXPORT GenerateDataKeyPairWithoutPlaintextResponsePrivate : public KmsResponsePrivate {

public:

    GenerateDataKeyPairWithoutPlaintextResponsePrivate(GenerateDataKeyPairWithoutPlaintextResponse * const q);
