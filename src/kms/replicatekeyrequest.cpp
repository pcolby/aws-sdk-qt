...
#include "replicatekeyrequest_p.h"
...
/*!
 * \class QtAws::Kms::ReplicateKeyRequest
 * \brief The ReplicateKeyRequest class provides an interface for Kms ReplicateKey requests.
 *
 * \inmodule QtAwsKms
 *
 ...
 */
ReplicateKeyRequest::ReplicateKeyRequest(const ReplicateKeyRequest &other)
    : KmsRequest(new ReplicateKeyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ReplicateKeyRequest object.
 */
ReplicateKeyRequest::ReplicateKeyRequest()
    : KmsRequest(new ReplicateKeyRequestPrivate(KmsRequest::ReplicateKeyAction, this))
{
 ...
 * \reimp
 */
bool ReplicateKeyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ReplicateKeyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ReplicateKeyRequest::response(QNetworkReply * const reply) const
{
    return new ReplicateKeyResponse(*this, reply);
}

/*!
 * \class QtAws::Kms::ReplicateKeyRequestPrivate
 * \brief The ReplicateKeyRequestPrivate class provides private implementation for ReplicateKeyRequest.
 * \internal
 *
 * \inmodule QtAwsKms
 */
...
/*!
 * Constructs a ReplicateKeyRequestPrivate object for Kms \a action,
 * with public implementation \a q.
 */
ReplicateKeyRequestPrivate::ReplicateKeyRequestPrivate(
    const KmsRequest::Action action, ReplicateKeyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ReplicateKeyRequest
 * class' copy constructor.
 */
ReplicateKeyRequestPrivate::ReplicateKeyRequestPrivate(
    const ReplicateKeyRequestPrivate &other, ReplicateKeyRequest * const q)
