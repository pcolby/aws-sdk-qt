...
#include "generatemacrequest_p.h"
...
/*!
 * \class QtAws::Kms::GenerateMacRequest
 * \brief The GenerateMacRequest class provides an interface for Kms GenerateMac requests.
 *
 * \inmodule QtAwsKms
 *
 ...
 */
GenerateMacRequest::GenerateMacRequest(const GenerateMacRequest &other)
    : KmsRequest(new GenerateMacRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GenerateMacRequest object.
 */
GenerateMacRequest::GenerateMacRequest()
    : KmsRequest(new GenerateMacRequestPrivate(KmsRequest::GenerateMacAction, this))
{
 ...
 * \reimp
 */
bool GenerateMacRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GenerateMacResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GenerateMacRequest::response(QNetworkReply * const reply) const
{
    return new GenerateMacResponse(*this, reply);
}

/*!
 * \class QtAws::Kms::GenerateMacRequestPrivate
 * \brief The GenerateMacRequestPrivate class provides private implementation for GenerateMacRequest.
 * \internal
 *
 * \inmodule QtAwsKms
 */
...
/*!
 * Constructs a GenerateMacRequestPrivate object for Kms \a action,
 * with public implementation \a q.
 */
GenerateMacRequestPrivate::GenerateMacRequestPrivate(
    const KmsRequest::Action action, GenerateMacRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GenerateMacRequest
 * class' copy constructor.
 */
GenerateMacRequestPrivate::GenerateMacRequestPrivate(
    const GenerateMacRequestPrivate &other, GenerateMacRequest * const q)
