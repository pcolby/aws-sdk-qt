...
#include "generatedatakeypairrequest_p.h"
...
/*!
 * \class QtAws::KMS::GenerateDataKeyPairRequest
 * \brief The GenerateDataKeyPairRequest class provides an interface for KMS GenerateDataKeyPair requests.
 *
 * \inmodule QtAwsKMS
 *
 ...
 */
GenerateDataKeyPairRequest::GenerateDataKeyPairRequest(const GenerateDataKeyPairRequest &other)
    : KmsRequest(new GenerateDataKeyPairRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GenerateDataKeyPairRequest object.
 */
GenerateDataKeyPairRequest::GenerateDataKeyPairRequest()
    : KmsRequest(new GenerateDataKeyPairRequestPrivate(KmsRequest::GenerateDataKeyPairAction, this))
{
 ...
 * \reimp
 */
bool GenerateDataKeyPairRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GenerateDataKeyPairResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GenerateDataKeyPairRequest::response(QNetworkReply * const reply) const
{
    return new GenerateDataKeyPairResponse(*this, reply);
}

/*!
 * \class QtAws::KMS::GenerateDataKeyPairRequestPrivate
 * \brief The GenerateDataKeyPairRequestPrivate class provides private implementation for GenerateDataKeyPairRequest.
 * \internal
 *
 * \inmodule QtAwsKMS
 */
...
/*!
 * Constructs a GenerateDataKeyPairRequestPrivate object for Kms \a action,
 * with public implementation \a q.
 */
GenerateDataKeyPairRequestPrivate::GenerateDataKeyPairRequestPrivate(
    const KmsRequest::Action action, GenerateDataKeyPairRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GenerateDataKeyPairRequest
 * class' copy constructor.
 */
GenerateDataKeyPairRequestPrivate::GenerateDataKeyPairRequestPrivate(
    const GenerateDataKeyPairRequestPrivate &other, GenerateDataKeyPairRequest * const q)
