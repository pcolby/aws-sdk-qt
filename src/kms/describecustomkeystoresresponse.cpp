...
#include "describecustomkeystoresresponse_p.h"
...
/*!
 * \class QtAws::KMS::DescribeCustomKeyStoresResponse
 * \brief The DescribeCustomKeyStoresResponse class provides an interace for KMS DescribeCustomKeyStores responses.
 *
 * \inmodule QtAwsKMS
 *
 ...
 *
 * \sa KmsClient::describeCustomKeyStores
 */

/*!
 * Constructs a DescribeCustomKeyStoresResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeCustomKeyStoresResponse::DescribeCustomKeyStoresResponse(
        const DescribeCustomKeyStoresRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : KmsResponse(new DescribeCustomKeyStoresResponsePrivate(this), parent)
{
    setRequest(new DescribeCustomKeyStoresRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeCustomKeyStoresRequest * DescribeCustomKeyStoresResponse::request() const
{
    Q_D(const DescribeCustomKeyStoresResponse);
    return static_cast<const DescribeCustomKeyStoresRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful KMS DescribeCustomKeyStores \a response.
 */
void DescribeCustomKeyStoresResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeCustomKeyStoresResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::KMS::DescribeCustomKeyStoresResponsePrivate
 * \brief The DescribeCustomKeyStoresResponsePrivate class provides private implementation for DescribeCustomKeyStoresResponse.
 * \internal
 *
 * \inmodule QtAwsKMS
 */
...
/*!
 * Constructs a DescribeCustomKeyStoresResponsePrivate object with public implementation \a q.
 */
DescribeCustomKeyStoresResponsePrivate::DescribeCustomKeyStoresResponsePrivate(
    DescribeCustomKeyStoresResponse * const q) : KmsResponsePrivate(q)
{

}

/*!
 * Parses a KMS DescribeCustomKeyStores response element from \a xml.
 */
void DescribeCustomKeyStoresResponsePrivate::parseDescribeCustomKeyStoresResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeCustomKeyStoresResponse"));
    Q_UNUSED(xml) ///< @todo
}
