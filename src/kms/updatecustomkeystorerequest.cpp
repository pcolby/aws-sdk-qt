...
#include "updatecustomkeystorerequest_p.h"
...
/*!
 * \class QtAws::KMS::UpdateCustomKeyStoreRequest
 * \brief The UpdateCustomKeyStoreRequest class provides an interface for KMS UpdateCustomKeyStore requests.
 *
 * \inmodule QtAwsKMS
 *
 ...
 */
UpdateCustomKeyStoreRequest::UpdateCustomKeyStoreRequest(const UpdateCustomKeyStoreRequest &other)
    : KmsRequest(new UpdateCustomKeyStoreRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateCustomKeyStoreRequest object.
 */
UpdateCustomKeyStoreRequest::UpdateCustomKeyStoreRequest()
    : KmsRequest(new UpdateCustomKeyStoreRequestPrivate(KmsRequest::UpdateCustomKeyStoreAction, this))
{
 ...
 * \reimp
 */
bool UpdateCustomKeyStoreRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateCustomKeyStoreResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateCustomKeyStoreRequest::response(QNetworkReply * const reply) const
{
    return new UpdateCustomKeyStoreResponse(*this, reply);
}

/*!
 * \class QtAws::KMS::UpdateCustomKeyStoreRequestPrivate
 * \brief The UpdateCustomKeyStoreRequestPrivate class provides private implementation for UpdateCustomKeyStoreRequest.
 * \internal
 *
 * \inmodule QtAwsKMS
 */
...
/*!
 * Constructs a UpdateCustomKeyStoreRequestPrivate object for Kms \a action,
 * with public implementation \a q.
 */
UpdateCustomKeyStoreRequestPrivate::UpdateCustomKeyStoreRequestPrivate(
    const KmsRequest::Action action, UpdateCustomKeyStoreRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateCustomKeyStoreRequest
 * class' copy constructor.
 */
UpdateCustomKeyStoreRequestPrivate::UpdateCustomKeyStoreRequestPrivate(
    const UpdateCustomKeyStoreRequestPrivate &other, UpdateCustomKeyStoreRequest * const q)
