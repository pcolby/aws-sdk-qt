...
#include "disconnectcustomkeystorerequest_p.h"
...
/*!
 * \class QtAws::Kms::DisconnectCustomKeyStoreRequest
 * \brief The DisconnectCustomKeyStoreRequest class provides an interface for Kms DisconnectCustomKeyStore requests.
 *
 * \inmodule QtAwsKms
 *
 ...
 *
 * \sa KmsClient::disconnectCustomKeyStore
 */

/*!
 * Constructs a copy of \a other.
 */
DisconnectCustomKeyStoreRequest::DisconnectCustomKeyStoreRequest(const DisconnectCustomKeyStoreRequest &other)
    : KmsRequest(new DisconnectCustomKeyStoreRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DisconnectCustomKeyStoreRequest object.
 */
DisconnectCustomKeyStoreRequest::DisconnectCustomKeyStoreRequest()
    : KmsRequest(new DisconnectCustomKeyStoreRequestPrivate(KmsRequest::DisconnectCustomKeyStoreAction, this))
{
 ...
 * \reimp
 */
bool DisconnectCustomKeyStoreRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DisconnectCustomKeyStoreResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DisconnectCustomKeyStoreRequest::response(QNetworkReply * const reply) const
{
    return new DisconnectCustomKeyStoreResponse(*this, reply);
}

/*!
 * \class QtAws::Kms::DisconnectCustomKeyStoreRequestPrivate
 * \brief The DisconnectCustomKeyStoreRequestPrivate class provides private implementation for DisconnectCustomKeyStoreRequest.
 * \internal
 *
 * \inmodule QtAwsKms
 */
...
/*!
 * Constructs a DisconnectCustomKeyStoreRequestPrivate object for Kms \a action,
 * with public implementation \a q.
 */
DisconnectCustomKeyStoreRequestPrivate::DisconnectCustomKeyStoreRequestPrivate(
    const KmsRequest::Action action, DisconnectCustomKeyStoreRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DisconnectCustomKeyStoreRequest
 * class' copy constructor.
 */
DisconnectCustomKeyStoreRequestPrivate::DisconnectCustomKeyStoreRequestPrivate(
    const DisconnectCustomKeyStoreRequestPrivate &other, DisconnectCustomKeyStoreRequest * const q)
