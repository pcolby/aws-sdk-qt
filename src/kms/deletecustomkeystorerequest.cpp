...
#include "deletecustomkeystorerequest_p.h"
...
/*!
 * \class QtAws::KMS::DeleteCustomKeyStoreRequest
 * \brief The DeleteCustomKeyStoreRequest class provides an interface for KMS DeleteCustomKeyStore requests.
 *
 * \inmodule QtAwsKMS
 *
 ...
 *
 * \sa KmsClient::deleteCustomKeyStore
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteCustomKeyStoreRequest::DeleteCustomKeyStoreRequest(const DeleteCustomKeyStoreRequest &other)
    : KmsRequest(new DeleteCustomKeyStoreRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteCustomKeyStoreRequest object.
 */
DeleteCustomKeyStoreRequest::DeleteCustomKeyStoreRequest()
    : KmsRequest(new DeleteCustomKeyStoreRequestPrivate(KmsRequest::DeleteCustomKeyStoreAction, this))
{
 ...
 * \reimp
 */
bool DeleteCustomKeyStoreRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteCustomKeyStoreResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteCustomKeyStoreRequest::response(QNetworkReply * const reply) const
{
    return new DeleteCustomKeyStoreResponse(*this, reply);
}

/*!
 * \class QtAws::KMS::DeleteCustomKeyStoreRequestPrivate
 * \brief The DeleteCustomKeyStoreRequestPrivate class provides private implementation for DeleteCustomKeyStoreRequest.
 * \internal
 *
 * \inmodule QtAwsKMS
 */
...
/*!
 * Constructs a DeleteCustomKeyStoreRequestPrivate object for Kms \a action,
 * with public implementation \a q.
 */
DeleteCustomKeyStoreRequestPrivate::DeleteCustomKeyStoreRequestPrivate(
    const KmsRequest::Action action, DeleteCustomKeyStoreRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteCustomKeyStoreRequest
 * class' copy constructor.
 */
DeleteCustomKeyStoreRequestPrivate::DeleteCustomKeyStoreRequestPrivate(
    const DeleteCustomKeyStoreRequestPrivate &other, DeleteCustomKeyStoreRequest * const q)
