...
/*!
 * \class QtAws::Kms::VerifyRequest
 * \brief The VerifyRequest class provides an interface for Kms Verify requests.
 *
 * \inmodule QtAwsKms
 *
 ...
 */
VerifyRequest::VerifyRequest(const VerifyRequest &other)
    : KmsRequest(new VerifyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a VerifyRequest object.
 */
VerifyRequest::VerifyRequest()
    : KmsRequest(new VerifyRequestPrivate(KmsRequest::VerifyAction, this))
{
 ...
 * \reimp
 */
bool VerifyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a VerifyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * VerifyRequest::response(QNetworkReply * const reply) const
{
    return new VerifyResponse(*this, reply);
}

/*!
 * \class QtAws::Kms::VerifyRequestPrivate
 * \brief The VerifyRequestPrivate class provides private implementation for VerifyRequest.
 * \internal
 *
 * \inmodule QtAwsKms
 */
...
/*!
 * Constructs a VerifyRequestPrivate object for Kms \a action,
 * with public implementation \a q.
 */
VerifyRequestPrivate::VerifyRequestPrivate(
    const KmsRequest::Action action, VerifyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the VerifyRequest
 * class' copy constructor.
 */
VerifyRequestPrivate::VerifyRequestPrivate(
    const VerifyRequestPrivate &other, VerifyRequest * const q)
