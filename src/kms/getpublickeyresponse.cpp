...
/*!
 * \class QtAws::Kms::GetPublicKeyResponse
 * \brief The GetPublicKeyResponse class provides an interace for Kms GetPublicKey responses.
 *
 * \inmodule QtAwsKms
 *
...
GetPublicKeyResponse::GetPublicKeyResponse(
    ...
    : KmsResponse(new GetPublicKeyResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Kms GetPublicKey \a response.
 */
...
/*!
 * \class QtAws::Kms::GetPublicKeyResponsePrivate
...
GetPublicKeyResponsePrivate::GetPublicKeyResponsePrivate(
    GetPublicKeyResponse * const q) : KmsResponsePrivate(q)
{

}

/*!
 * Parses a Kms GetPublicKey response element from \a xml.
 */
