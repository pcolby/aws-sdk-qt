...
class QTAWS_EXPORT LexRuntimeServiceRequest : public QtAws::Core::AwsAbstractRequest {
...
public:
    ...
    virtual bool operator==(const LexRuntimeServiceRequest &other) const override;
