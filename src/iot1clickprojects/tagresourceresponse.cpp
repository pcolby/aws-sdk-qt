...
/*!
 * \class QtAws::IoT1ClickProjects::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for IoT1ClickProjects TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : IoT1ClickProjectsResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(IoT1ClickProjectsResponse::request());
}

/*!
 * \reimp
 * Parses a successful IoT1ClickProjects TagResource \a response.
 */
...
/*!
 * \class QtAws::IoT1ClickProjects::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : IoT1ClickProjectsResponsePrivate(q)
{

}

/*!
 * Parses a IoT1ClickProjects TagResource response element from \a xml.
 */
