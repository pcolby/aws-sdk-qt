...
/*!
 * \class QtAws::IoT1ClickProjects::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for IoT1ClickProjects ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : IoT1ClickProjectsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IoT1ClickProjects ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::IoT1ClickProjects::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : IoT1ClickProjectsResponsePrivate(q)
{

}

/*!
 * Parses a IoT1ClickProjects ListTagsForResource response element from \a xml.
 */
