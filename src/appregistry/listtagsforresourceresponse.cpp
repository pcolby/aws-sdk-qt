...
/*!
 * \class QtAws::AppRegistry::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for AppRegistry ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : AppRegistryResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(AppRegistryResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppRegistry ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::AppRegistry::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : AppRegistryResponsePrivate(q)
{

}

/*!
 * Parses a AppRegistry ListTagsForResource response element from \a xml.
 */
