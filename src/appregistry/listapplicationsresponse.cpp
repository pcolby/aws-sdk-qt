...
/*!
 * \class QtAws::AppRegistry::ListApplicationsResponse
 * \brief The ListApplicationsResponse class provides an interace for AppRegistry ListApplications responses.
 *
...
ListApplicationsResponse::ListApplicationsResponse(
    ...
    : AppRegistryResponse(new ListApplicationsResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListApplicationsRequest *>(AppRegistryResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppRegistry ListApplications \a response.
 */
...
/*!
 * \class QtAws::AppRegistry::ListApplicationsResponsePrivate
...
ListApplicationsResponsePrivate::ListApplicationsResponsePrivate(
    ListApplicationsResponse * const q) : AppRegistryResponsePrivate(q)
{

}

/*!
 * Parses a AppRegistry ListApplications response element from \a xml.
 */
