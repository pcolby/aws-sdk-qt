...
class QTAWS_EXPORT GetAttributeGroupRequestPrivate : public AppRegistryRequestPrivate {

public:
    GetAttributeGroupRequestPrivate(const AppRegistryRequest::Action action,
