...
class QTAWS_EXPORT ListAssociatedResourcesResponsePrivate : public AppRegistryResponsePrivate {

public:

    ListAssociatedResourcesResponsePrivate(ListAssociatedResourcesResponse * const q);
