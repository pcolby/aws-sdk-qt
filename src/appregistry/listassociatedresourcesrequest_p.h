...
class QTAWS_EXPORT ListAssociatedResourcesRequestPrivate : public AppRegistryRequestPrivate {

public:
    ListAssociatedResourcesRequestPrivate(const AppRegistryRequest::Action action,
