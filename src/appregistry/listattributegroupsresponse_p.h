...
class QTAWS_EXPORT ListAttributeGroupsResponsePrivate : public AppRegistryResponsePrivate {

public:

    ListAttributeGroupsResponsePrivate(ListAttributeGroupsResponse * const q);
