...
/*!
 * \class QtAws::AppRegistry::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for AppRegistry TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : AppRegistryResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful AppRegistry TagResource \a response.
 */
...
/*!
 * \class QtAws::AppRegistry::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : AppRegistryResponsePrivate(q)
{

}

/*!
 * Parses a AppRegistry TagResource response element from \a xml.
 */
