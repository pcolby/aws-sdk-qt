...
class QTAWS_EXPORT CreateAttributeGroupResponsePrivate : public AppRegistryResponsePrivate {

public:

    CreateAttributeGroupResponsePrivate(CreateAttributeGroupResponse * const q);
