...
/*!
 * \class QtAws::AppRegistry::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for AppRegistry UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : AppRegistryResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful AppRegistry UntagResource \a response.
 */
...
/*!
 * \class QtAws::AppRegistry::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : AppRegistryResponsePrivate(q)
{

}

/*!
 * Parses a AppRegistry UntagResource response element from \a xml.
 */
