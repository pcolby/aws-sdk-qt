...
class QTAWS_EXPORT CreateAttributeGroupRequestPrivate : public AppRegistryRequestPrivate {

public:
    CreateAttributeGroupRequestPrivate(const AppRegistryRequest::Action action,
