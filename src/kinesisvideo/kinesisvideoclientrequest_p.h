...
public:
    KinesisVideoClientRequest::Action action; ///<  action to be performed.
    ...
    KinesisVideoClientRequestPrivate(const RequestPrivate &other, KinesisVideoClientRequest * const q);
