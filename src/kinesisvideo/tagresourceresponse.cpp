...
/*!
 * \class QtAws::KinesisVideo::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for KinesisVideo TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : KinesisVideoResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(KinesisVideoResponse::request());
}

/*!
 * \reimp
 * Parses a successful KinesisVideo TagResource \a response.
 */
...
/*!
 * \class QtAws::KinesisVideo::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : KinesisVideoResponsePrivate(q)
{

}

/*!
 * Parses a KinesisVideo TagResource response element from \a xml.
 */
