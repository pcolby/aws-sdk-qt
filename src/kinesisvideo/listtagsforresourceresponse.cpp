...
/*!
 * \class QtAws::KinesisVideo::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for KinesisVideo ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : KinesisVideoResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(KinesisVideoResponse::request());
}

/*!
 * \reimp
 * Parses a successful KinesisVideo ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::KinesisVideo::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : KinesisVideoResponsePrivate(q)
{

}

/*!
 * Parses a KinesisVideo ListTagsForResource response element from \a xml.
 */
