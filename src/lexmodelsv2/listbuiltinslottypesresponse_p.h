...
class QTAWS_EXPORT ListBuiltInSlotTypesResponsePrivate : public LexModelsV2ResponsePrivate {

public:

    ListBuiltInSlotTypesResponsePrivate(ListBuiltInSlotTypesResponse * const q);
