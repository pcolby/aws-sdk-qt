...
class QTAWS_EXPORT CreateResourcePolicyStatementResponsePrivate : public LexModelsV2ResponsePrivate {

public:

    CreateResourcePolicyStatementResponsePrivate(CreateResourcePolicyStatementResponse * const q);
