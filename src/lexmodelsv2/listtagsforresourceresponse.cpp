...
/*!
 * \class QtAws::LexModelsV2::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for LexModelsV2 ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : LexModelsV2Response(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful LexModelsV2 ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::LexModelsV2::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : LexModelsV2ResponsePrivate(q)
{

}

/*!
 * Parses a LexModelsV2 ListTagsForResource response element from \a xml.
 */
