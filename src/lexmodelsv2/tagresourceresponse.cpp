...
/*!
 * \class QtAws::LexModelsV2::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for LexModelsV2 TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : LexModelsV2Response(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful LexModelsV2 TagResource \a response.
 */
...
/*!
 * \class QtAws::LexModelsV2::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : LexModelsV2ResponsePrivate(q)
{

}

/*!
 * Parses a LexModelsV2 TagResource response element from \a xml.
 */
