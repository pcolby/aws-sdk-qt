...
class QTAWS_EXPORT DescribeBotVersionResponsePrivate : public LexModelsV2ResponsePrivate {

public:

    DescribeBotVersionResponsePrivate(DescribeBotVersionResponse * const q);
