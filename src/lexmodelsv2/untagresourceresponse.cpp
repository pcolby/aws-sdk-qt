...
/*!
 * \class QtAws::LexModelsV2::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for LexModelsV2 UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : LexModelsV2Response(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful LexModelsV2 UntagResource \a response.
 */
...
/*!
 * \class QtAws::LexModelsV2::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : LexModelsV2ResponsePrivate(q)
{

}

/*!
 * Parses a LexModelsV2 UntagResource response element from \a xml.
 */
