...
class QTAWS_EXPORT DescribeBotLocaleResponsePrivate : public LexModelsV2ResponsePrivate {

public:

    DescribeBotLocaleResponsePrivate(DescribeBotLocaleResponse * const q);
