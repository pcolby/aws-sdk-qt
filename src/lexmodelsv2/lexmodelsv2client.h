...
public slots:
    ...
    DeleteCustomVocabularyResponse * deleteCustomVocabulary(const DeleteCustomVocabularyRequest &request);
    ...
    DescribeBotRecommendationResponse * describeBotRecommendation(const DescribeBotRecommendationRequest &request);
    DescribeBotVersionResponse * describeBotVersion(const DescribeBotVersionRequest &request);
    DescribeCustomVocabularyMetadataResponse * describeCustomVocabularyMetadata(const DescribeCustomVocabularyMetadataRequest &request);
    ...
    ListAggregatedUtterancesResponse * listAggregatedUtterances(const ListAggregatedUtterancesRequest &request);
    ...
    ListBotRecommendationsResponse * listBotRecommendations(const ListBotRecommendationsRequest &request);
    ...
    ListRecommendedIntentsResponse * listRecommendedIntents(const ListRecommendedIntentsRequest &request);
    ...
    SearchAssociatedTranscriptsResponse * searchAssociatedTranscripts(const SearchAssociatedTranscriptsRequest &request);
    StartBotRecommendationResponse * startBotRecommendation(const StartBotRecommendationRequest &request);
    StartImportResponse * startImport(const StartImportRequest &request);
    StopBotRecommendationResponse * stopBotRecommendation(const StopBotRecommendationRequest &request);
    ...
    UpdateBotRecommendationResponse * updateBotRecommendation(const UpdateBotRecommendationRequest &request);
