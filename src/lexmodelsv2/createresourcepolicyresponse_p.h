...
class QTAWS_EXPORT CreateResourcePolicyResponsePrivate : public LexModelsV2ResponsePrivate {

public:

    CreateResourcePolicyResponsePrivate(CreateResourcePolicyResponse * const q);
