...
#include "describehubrequest_p.h"
...
/*!
 * \class QtAws::SecurityHub::DescribeHubRequest
 * \brief The DescribeHubRequest class provides an interface for SecurityHub DescribeHub requests.
 *
 ...
 */
DescribeHubRequest::DescribeHubRequest(const DescribeHubRequest &other)
    : SecurityHubRequest(new DescribeHubRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeHubRequest object.
 */
DescribeHubRequest::DescribeHubRequest()
    : SecurityHubRequest(new DescribeHubRequestPrivate(SecurityHubRequest::DescribeHubAction, this))
{
 ...
 * \reimp
 */
bool DescribeHubRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeHubResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeHubRequest::response(QNetworkReply * const reply) const
{
    return new DescribeHubResponse(*this, reply);
}

/*!
 * \class QtAws::SecurityHub::DescribeHubRequestPrivate
 * \brief The DescribeHubRequestPrivate class provides private implementation for DescribeHubRequest.
 * \internal
 *
 * \inmodule QtAwsSecurityHub
 */
...
/*!
 * Constructs a DescribeHubRequestPrivate object for SecurityHub \a action,
 * with public implementation \a q.
 */
DescribeHubRequestPrivate::DescribeHubRequestPrivate(
    const SecurityHubRequest::Action action, DescribeHubRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeHubRequest
 * class' copy constructor.
 */
DescribeHubRequestPrivate::DescribeHubRequestPrivate(
    const DescribeHubRequestPrivate &other, DescribeHubRequest * const q)
