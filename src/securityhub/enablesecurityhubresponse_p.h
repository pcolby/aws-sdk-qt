...
class QTAWS_EXPORT EnableSecurityHubResponsePrivate : public SecurityHubResponsePrivate {

public:

    EnableSecurityHubResponsePrivate(EnableSecurityHubResponse * const q);
