...
#include "updatesecurityhubconfigurationresponse_p.h"
...
/*!
 * \class QtAws::SecurityHub::UpdateSecurityHubConfigurationResponse
 * \brief The UpdateSecurityHubConfigurationResponse class provides an interace for SecurityHub UpdateSecurityHubConfiguration responses.
 *
...
/*!
 * Constructs a UpdateSecurityHubConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateSecurityHubConfigurationResponse::UpdateSecurityHubConfigurationResponse(
        const UpdateSecurityHubConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : SecurityHubResponse(new UpdateSecurityHubConfigurationResponsePrivate(this), parent)
{
    setRequest(new UpdateSecurityHubConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful SecurityHub UpdateSecurityHubConfiguration \a response.
 */
void UpdateSecurityHubConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateSecurityHubConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::SecurityHub::UpdateSecurityHubConfigurationResponsePrivate
 * \brief The UpdateSecurityHubConfigurationResponsePrivate class provides private implementation for UpdateSecurityHubConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsSecurityHub
 */
...
/*!
 * Constructs a UpdateSecurityHubConfigurationResponsePrivate object with public implementation \a q.
 */
UpdateSecurityHubConfigurationResponsePrivate::UpdateSecurityHubConfigurationResponsePrivate(
    UpdateSecurityHubConfigurationResponse * const q) : SecurityHubResponsePrivate(q)
{

}

/*!
 * Parses a SecurityHub UpdateSecurityHubConfiguration response element from \a xml.
 */
void UpdateSecurityHubConfigurationResponsePrivate::parseUpdateSecurityHubConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateSecurityHubConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
