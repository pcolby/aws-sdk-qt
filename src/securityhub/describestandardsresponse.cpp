...
#include "describestandardsresponse_p.h"
...
/*!
 * \class QtAws::SecurityHub::DescribeStandardsResponse
 * \brief The DescribeStandardsResponse class provides an interace for SecurityHub DescribeStandards responses.
 *
...
/*!
 * Constructs a DescribeStandardsResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeStandardsResponse::DescribeStandardsResponse(
        const DescribeStandardsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : SecurityHubResponse(new DescribeStandardsResponsePrivate(this), parent)
{
    setRequest(new DescribeStandardsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful SecurityHub DescribeStandards \a response.
 */
void DescribeStandardsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeStandardsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::SecurityHub::DescribeStandardsResponsePrivate
 * \brief The DescribeStandardsResponsePrivate class provides private implementation for DescribeStandardsResponse.
 * \internal
 *
 * \inmodule QtAwsSecurityHub
 */
...
/*!
 * Constructs a DescribeStandardsResponsePrivate object with public implementation \a q.
 */
DescribeStandardsResponsePrivate::DescribeStandardsResponsePrivate(
    DescribeStandardsResponse * const q) : SecurityHubResponsePrivate(q)
{

}

/*!
 * Parses a SecurityHub DescribeStandards response element from \a xml.
 */
void DescribeStandardsResponsePrivate::parseDescribeStandardsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeStandardsResponse"));
    Q_UNUSED(xml) ///< @todo
}
