...
/*!
 * \class QtAws::SecurityHub::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for SecurityHub UntagResource responses.
 *
 ...
 *
 * \sa SecurityHubClient::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : SecurityHubResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(SecurityHubResponse::request());
}

/*!
 * \reimp
 * Parses a successful SecurityHub UntagResource \a response.
 */
...
/*!
 * \class QtAws::SecurityHub::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : SecurityHubResponsePrivate(q)
{

}

/*!
 * Parses a SecurityHub UntagResource response element from \a xml.
 */
