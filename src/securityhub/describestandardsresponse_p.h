...
class QTAWS_EXPORT DescribeStandardsResponsePrivate : public SecurityHubResponsePrivate {

public:

    DescribeStandardsResponsePrivate(DescribeStandardsResponse * const q);
