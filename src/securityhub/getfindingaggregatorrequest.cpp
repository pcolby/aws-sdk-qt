...
#include "getfindingaggregatorrequest_p.h"
...
/*!
 * \class QtAws::SecurityHub::GetFindingAggregatorRequest
 * \brief The GetFindingAggregatorRequest class provides an interface for SecurityHub GetFindingAggregator requests.
 *
 ...
 */
GetFindingAggregatorRequest::GetFindingAggregatorRequest(const GetFindingAggregatorRequest &other)
    : SecurityHubRequest(new GetFindingAggregatorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetFindingAggregatorRequest object.
 */
GetFindingAggregatorRequest::GetFindingAggregatorRequest()
    : SecurityHubRequest(new GetFindingAggregatorRequestPrivate(SecurityHubRequest::GetFindingAggregatorAction, this))
{
 ...
 * \reimp
 */
bool GetFindingAggregatorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetFindingAggregatorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetFindingAggregatorRequest::response(QNetworkReply * const reply) const
{
    return new GetFindingAggregatorResponse(*this, reply);
}

/*!
 * \class QtAws::SecurityHub::GetFindingAggregatorRequestPrivate
 * \brief The GetFindingAggregatorRequestPrivate class provides private implementation for GetFindingAggregatorRequest.
 * \internal
 *
 * \inmodule QtAwsSecurityHub
 */
...
/*!
 * Constructs a GetFindingAggregatorRequestPrivate object for SecurityHub \a action,
 * with public implementation \a q.
 */
GetFindingAggregatorRequestPrivate::GetFindingAggregatorRequestPrivate(
    const SecurityHubRequest::Action action, GetFindingAggregatorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetFindingAggregatorRequest
 * class' copy constructor.
 */
GetFindingAggregatorRequestPrivate::GetFindingAggregatorRequestPrivate(
    const GetFindingAggregatorRequestPrivate &other, GetFindingAggregatorRequest * const q)
