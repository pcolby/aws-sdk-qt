...
#include "updatestandardscontrolresponse_p.h"
...
/*!
 * \class QtAws::SecurityHub::UpdateStandardsControlResponse
 * \brief The UpdateStandardsControlResponse class provides an interace for SecurityHub UpdateStandardsControl responses.
 *
...
/*!
 * Constructs a UpdateStandardsControlResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateStandardsControlResponse::UpdateStandardsControlResponse(
        const UpdateStandardsControlRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : SecurityHubResponse(new UpdateStandardsControlResponsePrivate(this), parent)
{
    setRequest(new UpdateStandardsControlRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful SecurityHub UpdateStandardsControl \a response.
 */
void UpdateStandardsControlResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateStandardsControlResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::SecurityHub::UpdateStandardsControlResponsePrivate
 * \brief The UpdateStandardsControlResponsePrivate class provides private implementation for UpdateStandardsControlResponse.
 * \internal
 *
 * \inmodule QtAwsSecurityHub
 */
...
/*!
 * Constructs a UpdateStandardsControlResponsePrivate object with public implementation \a q.
 */
UpdateStandardsControlResponsePrivate::UpdateStandardsControlResponsePrivate(
    UpdateStandardsControlResponse * const q) : SecurityHubResponsePrivate(q)
{

}

/*!
 * Parses a SecurityHub UpdateStandardsControl response element from \a xml.
 */
void UpdateStandardsControlResponsePrivate::parseUpdateStandardsControlResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateStandardsControlResponse"));
    Q_UNUSED(xml) ///< @todo
}
