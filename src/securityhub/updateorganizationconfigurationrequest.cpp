...
/*!
 * \class QtAws::SecurityHub::UpdateOrganizationConfigurationRequest
 * \brief The UpdateOrganizationConfigurationRequest class provides an interface for SecurityHub UpdateOrganizationConfiguration requests.
 *
...
UpdateOrganizationConfigurationRequest::UpdateOrganizationConfigurationRequest(const UpdateOrganizationConfigurationRequest &other)
    : SecurityHubRequest(new UpdateOrganizationConfigurationRequestPrivate(*other.d_func(), this))
{
...
UpdateOrganizationConfigurationRequest::UpdateOrganizationConfigurationRequest()
    : SecurityHubRequest(new UpdateOrganizationConfigurationRequestPrivate(SecurityHubRequest::UpdateOrganizationConfigurationAction, this))
{
...
/*!
 * \class QtAws::SecurityHub::UpdateOrganizationConfigurationRequestPrivate
...
/*!
 * Constructs a UpdateOrganizationConfigurationRequestPrivate object for SecurityHub \a action,
 * with public implementation \a q.
 */
UpdateOrganizationConfigurationRequestPrivate::UpdateOrganizationConfigurationRequestPrivate(
    const SecurityHubRequest::Action action, UpdateOrganizationConfigurationRequest * const q)
