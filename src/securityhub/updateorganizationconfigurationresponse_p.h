...
class QTAWS_EXPORT UpdateOrganizationConfigurationResponsePrivate : public SecurityHubResponsePrivate {

public:

    UpdateOrganizationConfigurationResponsePrivate(UpdateOrganizationConfigurationResponse * const q);
