...
#include "createactiontargetrequest_p.h"
...
/*!
 * \class QtAws::SecurityHub::CreateActionTargetRequest
 * \brief The CreateActionTargetRequest class provides an interface for SecurityHub CreateActionTarget requests.
 *
 ...
 */
CreateActionTargetRequest::CreateActionTargetRequest(const CreateActionTargetRequest &other)
    : SecurityHubRequest(new CreateActionTargetRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateActionTargetRequest object.
 */
CreateActionTargetRequest::CreateActionTargetRequest()
    : SecurityHubRequest(new CreateActionTargetRequestPrivate(SecurityHubRequest::CreateActionTargetAction, this))
{
 ...
 * \reimp
 */
bool CreateActionTargetRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateActionTargetResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateActionTargetRequest::response(QNetworkReply * const reply) const
{
    return new CreateActionTargetResponse(*this, reply);
}

/*!
 * \class QtAws::SecurityHub::CreateActionTargetRequestPrivate
 * \brief The CreateActionTargetRequestPrivate class provides private implementation for CreateActionTargetRequest.
 * \internal
 *
 * \inmodule QtAwsSecurityHub
 */
...
/*!
 * Constructs a CreateActionTargetRequestPrivate object for SecurityHub \a action,
 * with public implementation \a q.
 */
CreateActionTargetRequestPrivate::CreateActionTargetRequestPrivate(
    const SecurityHubRequest::Action action, CreateActionTargetRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateActionTargetRequest
 * class' copy constructor.
 */
CreateActionTargetRequestPrivate::CreateActionTargetRequestPrivate(
    const CreateActionTargetRequestPrivate &other, CreateActionTargetRequest * const q)
