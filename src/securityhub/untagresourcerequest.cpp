...
/*!
 * \class QtAws::SecurityHub::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for SecurityHub UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : SecurityHubRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : SecurityHubRequest(new UntagResourceRequestPrivate(SecurityHubRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::SecurityHub::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for SecurityHub \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const SecurityHubRequest::Action action, UntagResourceRequest * const q)
