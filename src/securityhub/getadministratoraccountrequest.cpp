...
/*!
 * \class QtAws::SecurityHub::GetAdministratorAccountRequest
 * \brief The GetAdministratorAccountRequest class provides an interface for SecurityHub GetAdministratorAccount requests.
 *
...
GetAdministratorAccountRequest::GetAdministratorAccountRequest(const GetAdministratorAccountRequest &other)
    : SecurityHubRequest(new GetAdministratorAccountRequestPrivate(*other.d_func(), this))
{
...
GetAdministratorAccountRequest::GetAdministratorAccountRequest()
    : SecurityHubRequest(new GetAdministratorAccountRequestPrivate(SecurityHubRequest::GetAdministratorAccountAction, this))
{
...
/*!
 * \class QtAws::SecurityHub::GetAdministratorAccountRequestPrivate
...
/*!
 * Constructs a GetAdministratorAccountRequestPrivate object for SecurityHub \a action,
 * with public implementation \a q.
 */
GetAdministratorAccountRequestPrivate::GetAdministratorAccountRequestPrivate(
    const SecurityHubRequest::Action action, GetAdministratorAccountRequest * const q)
