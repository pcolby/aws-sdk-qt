...
/*!
 * \class QtAws::SecurityHub::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for SecurityHub ListTagsForResource responses.
 *
 ...
 *
 * \sa SecurityHubClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : SecurityHubResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(SecurityHubResponse::request());
}

/*!
 * \reimp
 * Parses a successful SecurityHub ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::SecurityHub::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : SecurityHubResponsePrivate(q)
{

}

/*!
 * Parses a SecurityHub ListTagsForResource response element from \a xml.
 */
