...
/*!
 * \class QtAws::SecurityHub::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for SecurityHub TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : SecurityHubResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(SecurityHubResponse::request());
}

/*!
 * \reimp
 * Parses a successful SecurityHub TagResource \a response.
 */
...
/*!
 * \class QtAws::SecurityHub::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : SecurityHubResponsePrivate(q)
{

}

/*!
 * Parses a SecurityHub TagResource response element from \a xml.
 */
