...
class QTAWS_EXPORT BatchImportFindingsResponsePrivate : public SecurityHubResponsePrivate {

public:

    BatchImportFindingsResponsePrivate(BatchImportFindingsResponse * const q);
