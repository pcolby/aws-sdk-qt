...
/*!
 * \class QtAws::SecurityHub::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for SecurityHub ListTagsForResource requests.
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : SecurityHubRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : SecurityHubRequest(new ListTagsForResourceRequestPrivate(SecurityHubRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::SecurityHub::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for SecurityHub \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const SecurityHubRequest::Action action, ListTagsForResourceRequest * const q)
