...
class QTAWS_EXPORT EnableImportFindingsForProductResponsePrivate : public SecurityHubResponsePrivate {

public:

    EnableImportFindingsForProductResponsePrivate(EnableImportFindingsForProductResponse * const q);
