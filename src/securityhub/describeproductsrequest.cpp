...
#include "describeproductsrequest_p.h"
...
/*!
 * \class QtAws::SecurityHub::DescribeProductsRequest
 * \brief The DescribeProductsRequest class provides an interface for SecurityHub DescribeProducts requests.
 *
 ...
 */
DescribeProductsRequest::DescribeProductsRequest(const DescribeProductsRequest &other)
    : SecurityHubRequest(new DescribeProductsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeProductsRequest object.
 */
DescribeProductsRequest::DescribeProductsRequest()
    : SecurityHubRequest(new DescribeProductsRequestPrivate(SecurityHubRequest::DescribeProductsAction, this))
{
 ...
 * \reimp
 */
bool DescribeProductsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeProductsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeProductsRequest::response(QNetworkReply * const reply) const
{
    return new DescribeProductsResponse(*this, reply);
}

/*!
 * \class QtAws::SecurityHub::DescribeProductsRequestPrivate
 * \brief The DescribeProductsRequestPrivate class provides private implementation for DescribeProductsRequest.
 * \internal
 *
 * \inmodule QtAwsSecurityHub
 */
...
/*!
 * Constructs a DescribeProductsRequestPrivate object for SecurityHub \a action,
 * with public implementation \a q.
 */
DescribeProductsRequestPrivate::DescribeProductsRequestPrivate(
    const SecurityHubRequest::Action action, DescribeProductsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeProductsRequest
 * class' copy constructor.
 */
DescribeProductsRequestPrivate::DescribeProductsRequestPrivate(
    const DescribeProductsRequestPrivate &other, DescribeProductsRequest * const q)
