...
/*!
 * \class QtAws::SecurityHub::DeleteInsightResponse
 * \brief The DeleteInsightResponse class provides an interace for SecurityHub DeleteInsight responses.
 *
...
DeleteInsightResponse::DeleteInsightResponse(
    ...
    : SecurityHubResponse(new DeleteInsightResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful SecurityHub DeleteInsight \a response.
 */
...
/*!
 * \class QtAws::SecurityHub::DeleteInsightResponsePrivate
...
DeleteInsightResponsePrivate::DeleteInsightResponsePrivate(
    DeleteInsightResponse * const q) : SecurityHubResponsePrivate(q)
{

}

/*!
 * Parses a SecurityHub DeleteInsight response element from \a xml.
 */
