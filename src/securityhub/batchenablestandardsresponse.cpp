...
#include "batchenablestandardsresponse_p.h"
...
/*!
 * \class QtAws::SecurityHub::BatchEnableStandardsResponse
 * \brief The BatchEnableStandardsResponse class provides an interace for SecurityHub BatchEnableStandards responses.
 *
...
/*!
 * Constructs a BatchEnableStandardsResponse object for \a reply to \a request, with parent \a parent.
 */
BatchEnableStandardsResponse::BatchEnableStandardsResponse(
        const BatchEnableStandardsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : SecurityHubResponse(new BatchEnableStandardsResponsePrivate(this), parent)
{
    setRequest(new BatchEnableStandardsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful SecurityHub BatchEnableStandards \a response.
 */
void BatchEnableStandardsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(BatchEnableStandardsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::SecurityHub::BatchEnableStandardsResponsePrivate
 * \brief The BatchEnableStandardsResponsePrivate class provides private implementation for BatchEnableStandardsResponse.
 * \internal
 *
 * \inmodule QtAwsSecurityHub
 */
...
/*!
 * Constructs a BatchEnableStandardsResponsePrivate object with public implementation \a q.
 */
BatchEnableStandardsResponsePrivate::BatchEnableStandardsResponsePrivate(
    BatchEnableStandardsResponse * const q) : SecurityHubResponsePrivate(q)
{

}

/*!
 * Parses a SecurityHub BatchEnableStandards response element from \a xml.
 */
void BatchEnableStandardsResponsePrivate::parseBatchEnableStandardsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("BatchEnableStandardsResponse"));
    Q_UNUSED(xml) ///< @todo
}
