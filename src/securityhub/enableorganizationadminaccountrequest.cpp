...
/*!
 * \class QtAws::SecurityHub::EnableOrganizationAdminAccountRequest
 * \brief The EnableOrganizationAdminAccountRequest class provides an interface for SecurityHub EnableOrganizationAdminAccount requests.
 *
...
EnableOrganizationAdminAccountRequest::EnableOrganizationAdminAccountRequest(const EnableOrganizationAdminAccountRequest &other)
    : SecurityHubRequest(new EnableOrganizationAdminAccountRequestPrivate(*other.d_func(), this))
{
...
EnableOrganizationAdminAccountRequest::EnableOrganizationAdminAccountRequest()
    : SecurityHubRequest(new EnableOrganizationAdminAccountRequestPrivate(SecurityHubRequest::EnableOrganizationAdminAccountAction, this))
{
...
/*!
 * \class QtAws::SecurityHub::EnableOrganizationAdminAccountRequestPrivate
...
/*!
 * Constructs a EnableOrganizationAdminAccountRequestPrivate object for SecurityHub \a action,
 * with public implementation \a q.
 */
EnableOrganizationAdminAccountRequestPrivate::EnableOrganizationAdminAccountRequestPrivate(
    const SecurityHubRequest::Action action, EnableOrganizationAdminAccountRequest * const q)
