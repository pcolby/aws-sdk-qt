...
#include "describestandardscontrolsresponse_p.h"
...
/*!
 * \class QtAws::SecurityHub::DescribeStandardsControlsResponse
 * \brief The DescribeStandardsControlsResponse class provides an interace for SecurityHub DescribeStandardsControls responses.
 *
...
/*!
 * Constructs a DescribeStandardsControlsResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeStandardsControlsResponse::DescribeStandardsControlsResponse(
        const DescribeStandardsControlsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : SecurityHubResponse(new DescribeStandardsControlsResponsePrivate(this), parent)
{
    setRequest(new DescribeStandardsControlsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful SecurityHub DescribeStandardsControls \a response.
 */
void DescribeStandardsControlsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeStandardsControlsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::SecurityHub::DescribeStandardsControlsResponsePrivate
 * \brief The DescribeStandardsControlsResponsePrivate class provides private implementation for DescribeStandardsControlsResponse.
 * \internal
 *
 * \inmodule QtAwsSecurityHub
 */
...
/*!
 * Constructs a DescribeStandardsControlsResponsePrivate object with public implementation \a q.
 */
DescribeStandardsControlsResponsePrivate::DescribeStandardsControlsResponsePrivate(
    DescribeStandardsControlsResponse * const q) : SecurityHubResponsePrivate(q)
{

}

/*!
 * Parses a SecurityHub DescribeStandardsControls response element from \a xml.
 */
void DescribeStandardsControlsResponsePrivate::parseDescribeStandardsControlsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeStandardsControlsResponse"));
    Q_UNUSED(xml) ///< @todo
}
