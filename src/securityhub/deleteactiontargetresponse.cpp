...
#include "deleteactiontargetresponse_p.h"
...
/*!
 * \class QtAws::SecurityHub::DeleteActionTargetResponse
 * \brief The DeleteActionTargetResponse class provides an interace for SecurityHub DeleteActionTarget responses.
 *
...
/*!
 * Constructs a DeleteActionTargetResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteActionTargetResponse::DeleteActionTargetResponse(
        const DeleteActionTargetRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : SecurityHubResponse(new DeleteActionTargetResponsePrivate(this), parent)
{
    setRequest(new DeleteActionTargetRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful SecurityHub DeleteActionTarget \a response.
 */
void DeleteActionTargetResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteActionTargetResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::SecurityHub::DeleteActionTargetResponsePrivate
 * \brief The DeleteActionTargetResponsePrivate class provides private implementation for DeleteActionTargetResponse.
 * \internal
 *
 * \inmodule QtAwsSecurityHub
 */
...
/*!
 * Constructs a DeleteActionTargetResponsePrivate object with public implementation \a q.
 */
DeleteActionTargetResponsePrivate::DeleteActionTargetResponsePrivate(
    DeleteActionTargetResponse * const q) : SecurityHubResponsePrivate(q)
{

}

/*!
 * Parses a SecurityHub DeleteActionTarget response element from \a xml.
 */
void DeleteActionTargetResponsePrivate::parseDeleteActionTargetResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteActionTargetResponse"));
    Q_UNUSED(xml) ///< @todo
}
