...
/*!
 * \class QtAws::NetworkFirewall::DeleteRuleGroupResponse
 * \brief The DeleteRuleGroupResponse class provides an interace for NetworkFirewall DeleteRuleGroup responses.
 *
...
DeleteRuleGroupResponse::DeleteRuleGroupResponse(
    ...
    : NetworkFirewallResponse(new DeleteRuleGroupResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall DeleteRuleGroup \a response.
 */
...
/*!
 * \class QtAws::NetworkFirewall::DeleteRuleGroupResponsePrivate
...
DeleteRuleGroupResponsePrivate::DeleteRuleGroupResponsePrivate(
    DeleteRuleGroupResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall DeleteRuleGroup response element from \a xml.
 */
