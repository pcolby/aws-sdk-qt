...
#include "describerulegroupresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::DescribeRuleGroupResponse
 * \brief The DescribeRuleGroupResponse class provides an interace for NetworkFirewall DescribeRuleGroup responses.
 *
 ...
 *
 * \sa NetworkFirewallClient::describeRuleGroup
 */

/*!
 * Constructs a DescribeRuleGroupResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeRuleGroupResponse::DescribeRuleGroupResponse(
        const DescribeRuleGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new DescribeRuleGroupResponsePrivate(this), parent)
{
    setRequest(new DescribeRuleGroupRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeRuleGroupRequest * DescribeRuleGroupResponse::request() const
{
    Q_D(const DescribeRuleGroupResponse);
    return static_cast<const DescribeRuleGroupRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful NetworkFirewall DescribeRuleGroup \a response.
 */
void DescribeRuleGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeRuleGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::DescribeRuleGroupResponsePrivate
 * \brief The DescribeRuleGroupResponsePrivate class provides private implementation for DescribeRuleGroupResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a DescribeRuleGroupResponsePrivate object with public implementation \a q.
 */
DescribeRuleGroupResponsePrivate::DescribeRuleGroupResponsePrivate(
    DescribeRuleGroupResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall DescribeRuleGroup response element from \a xml.
 */
void DescribeRuleGroupResponsePrivate::parseDescribeRuleGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeRuleGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
