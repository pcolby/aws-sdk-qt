...
#include "disassociatesubnetsresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::DisassociateSubnetsResponse
 * \brief The DisassociateSubnetsResponse class provides an interace for NetworkFirewall DisassociateSubnets responses.
 *
...
/*!
 * Constructs a DisassociateSubnetsResponse object for \a reply to \a request, with parent \a parent.
 */
DisassociateSubnetsResponse::DisassociateSubnetsResponse(
        const DisassociateSubnetsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new DisassociateSubnetsResponsePrivate(this), parent)
{
    setRequest(new DisassociateSubnetsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall DisassociateSubnets \a response.
 */
void DisassociateSubnetsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DisassociateSubnetsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::DisassociateSubnetsResponsePrivate
 * \brief The DisassociateSubnetsResponsePrivate class provides private implementation for DisassociateSubnetsResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a DisassociateSubnetsResponsePrivate object with public implementation \a q.
 */
DisassociateSubnetsResponsePrivate::DisassociateSubnetsResponsePrivate(
    DisassociateSubnetsResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall DisassociateSubnets response element from \a xml.
 */
void DisassociateSubnetsResponsePrivate::parseDisassociateSubnetsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DisassociateSubnetsResponse"));
    Q_UNUSED(xml) ///< @todo
}
