...
/*!
 * \class QtAws::NetworkFirewall::UpdateLoggingConfigurationRequest
 * \brief The UpdateLoggingConfigurationRequest class provides an interface for NetworkFirewall UpdateLoggingConfiguration requests.
 *
 ...
 *
 * \sa NetworkFirewallClient::updateLoggingConfiguration
 */
...
UpdateLoggingConfigurationRequest::UpdateLoggingConfigurationRequest(const UpdateLoggingConfigurationRequest &other)
    : NetworkFirewallRequest(new UpdateLoggingConfigurationRequestPrivate(*other.d_func(), this))
{
...
UpdateLoggingConfigurationRequest::UpdateLoggingConfigurationRequest()
    : NetworkFirewallRequest(new UpdateLoggingConfigurationRequestPrivate(NetworkFirewallRequest::UpdateLoggingConfigurationAction, this))
{
...
/*!
 * \class QtAws::NetworkFirewall::UpdateLoggingConfigurationRequestPrivate
...
/*!
 * Constructs a UpdateLoggingConfigurationRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
UpdateLoggingConfigurationRequestPrivate::UpdateLoggingConfigurationRequestPrivate(
    const NetworkFirewallRequest::Action action, UpdateLoggingConfigurationRequest * const q)
