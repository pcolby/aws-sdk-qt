...
/*!
 * \class QtAws::NetworkFirewall::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for NetworkFirewall TagResource responses.
 *
 ...
 *
 * \sa NetworkFirewallClient::tagResource
 */
...
TagResourceResponse::TagResourceResponse(
    ...
    : NetworkFirewallResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(NetworkFirewallResponse::request());
}

/*!
 * \reimp
 * Parses a successful NetworkFirewall TagResource \a response.
 */
...
/*!
 * \class QtAws::NetworkFirewall::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall TagResource response element from \a xml.
 */
