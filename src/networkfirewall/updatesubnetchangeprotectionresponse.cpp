...
#include "updatesubnetchangeprotectionresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::UpdateSubnetChangeProtectionResponse
 * \brief The UpdateSubnetChangeProtectionResponse class provides an interace for NetworkFirewall UpdateSubnetChangeProtection responses.
 *
...
/*!
 * Constructs a UpdateSubnetChangeProtectionResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateSubnetChangeProtectionResponse::UpdateSubnetChangeProtectionResponse(
        const UpdateSubnetChangeProtectionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new UpdateSubnetChangeProtectionResponsePrivate(this), parent)
{
    setRequest(new UpdateSubnetChangeProtectionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall UpdateSubnetChangeProtection \a response.
 */
void UpdateSubnetChangeProtectionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateSubnetChangeProtectionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::UpdateSubnetChangeProtectionResponsePrivate
 * \brief The UpdateSubnetChangeProtectionResponsePrivate class provides private implementation for UpdateSubnetChangeProtectionResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a UpdateSubnetChangeProtectionResponsePrivate object with public implementation \a q.
 */
UpdateSubnetChangeProtectionResponsePrivate::UpdateSubnetChangeProtectionResponsePrivate(
    UpdateSubnetChangeProtectionResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall UpdateSubnetChangeProtection response element from \a xml.
 */
void UpdateSubnetChangeProtectionResponsePrivate::parseUpdateSubnetChangeProtectionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateSubnetChangeProtectionResponse"));
    Q_UNUSED(xml) ///< @todo
}
