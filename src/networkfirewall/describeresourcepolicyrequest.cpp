...
/*!
 * \class QtAws::NetworkFirewall::DescribeResourcePolicyRequest
 * \brief The DescribeResourcePolicyRequest class provides an interface for NetworkFirewall DescribeResourcePolicy requests.
 *
 ...
 *
 * \sa NetworkFirewallClient::describeResourcePolicy
 */
...
DescribeResourcePolicyRequest::DescribeResourcePolicyRequest(const DescribeResourcePolicyRequest &other)
    : NetworkFirewallRequest(new DescribeResourcePolicyRequestPrivate(*other.d_func(), this))
{
...
DescribeResourcePolicyRequest::DescribeResourcePolicyRequest()
    : NetworkFirewallRequest(new DescribeResourcePolicyRequestPrivate(NetworkFirewallRequest::DescribeResourcePolicyAction, this))
{
...
/*!
 * \class QtAws::NetworkFirewall::DescribeResourcePolicyRequestPrivate
...
/*!
 * Constructs a DescribeResourcePolicyRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
DescribeResourcePolicyRequestPrivate::DescribeResourcePolicyRequestPrivate(
    const NetworkFirewallRequest::Action action, DescribeResourcePolicyRequest * const q)
