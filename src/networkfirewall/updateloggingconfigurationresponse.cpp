...
/*!
 * \class QtAws::NetworkFirewall::UpdateLoggingConfigurationResponse
 * \brief The UpdateLoggingConfigurationResponse class provides an interace for NetworkFirewall UpdateLoggingConfiguration responses.
 *
...
UpdateLoggingConfigurationResponse::UpdateLoggingConfigurationResponse(
    ...
    : NetworkFirewallResponse(new UpdateLoggingConfigurationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall UpdateLoggingConfiguration \a response.
 */
...
/*!
 * \class QtAws::NetworkFirewall::UpdateLoggingConfigurationResponsePrivate
...
UpdateLoggingConfigurationResponsePrivate::UpdateLoggingConfigurationResponsePrivate(
    UpdateLoggingConfigurationResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall UpdateLoggingConfiguration response element from \a xml.
 */
