...
#include "listfirewallpoliciesresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::ListFirewallPoliciesResponse
 * \brief The ListFirewallPoliciesResponse class provides an interace for NetworkFirewall ListFirewallPolicies responses.
 *
 ...
 *
 * \sa NetworkFirewallClient::listFirewallPolicies
 */

/*!
 * Constructs a ListFirewallPoliciesResponse object for \a reply to \a request, with parent \a parent.
 */
ListFirewallPoliciesResponse::ListFirewallPoliciesResponse(
        const ListFirewallPoliciesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new ListFirewallPoliciesResponsePrivate(this), parent)
{
    setRequest(new ListFirewallPoliciesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListFirewallPoliciesRequest * ListFirewallPoliciesResponse::request() const
{
    Q_D(const ListFirewallPoliciesResponse);
    return static_cast<const ListFirewallPoliciesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful NetworkFirewall ListFirewallPolicies \a response.
 */
void ListFirewallPoliciesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListFirewallPoliciesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::ListFirewallPoliciesResponsePrivate
 * \brief The ListFirewallPoliciesResponsePrivate class provides private implementation for ListFirewallPoliciesResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a ListFirewallPoliciesResponsePrivate object with public implementation \a q.
 */
ListFirewallPoliciesResponsePrivate::ListFirewallPoliciesResponsePrivate(
    ListFirewallPoliciesResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall ListFirewallPolicies response element from \a xml.
 */
void ListFirewallPoliciesResponsePrivate::parseListFirewallPoliciesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListFirewallPoliciesResponse"));
    Q_UNUSED(xml) ///< @todo
}
