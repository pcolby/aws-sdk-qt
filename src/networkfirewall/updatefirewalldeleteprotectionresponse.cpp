...
#include "updatefirewalldeleteprotectionresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallDeleteProtectionResponse
 * \brief The UpdateFirewallDeleteProtectionResponse class provides an interace for NetworkFirewall UpdateFirewallDeleteProtection responses.
 *
...
/*!
 * Constructs a UpdateFirewallDeleteProtectionResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateFirewallDeleteProtectionResponse::UpdateFirewallDeleteProtectionResponse(
        const UpdateFirewallDeleteProtectionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new UpdateFirewallDeleteProtectionResponsePrivate(this), parent)
{
    setRequest(new UpdateFirewallDeleteProtectionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall UpdateFirewallDeleteProtection \a response.
 */
void UpdateFirewallDeleteProtectionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateFirewallDeleteProtectionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallDeleteProtectionResponsePrivate
 * \brief The UpdateFirewallDeleteProtectionResponsePrivate class provides private implementation for UpdateFirewallDeleteProtectionResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a UpdateFirewallDeleteProtectionResponsePrivate object with public implementation \a q.
 */
UpdateFirewallDeleteProtectionResponsePrivate::UpdateFirewallDeleteProtectionResponsePrivate(
    UpdateFirewallDeleteProtectionResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall UpdateFirewallDeleteProtection response element from \a xml.
 */
void UpdateFirewallDeleteProtectionResponsePrivate::parseUpdateFirewallDeleteProtectionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateFirewallDeleteProtectionResponse"));
    Q_UNUSED(xml) ///< @todo
}
