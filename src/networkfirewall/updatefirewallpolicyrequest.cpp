...
#include "updatefirewallpolicyrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallPolicyRequest
 * \brief The UpdateFirewallPolicyRequest class provides an interface for NetworkFirewall UpdateFirewallPolicy requests.
 *
 ...
 */
UpdateFirewallPolicyRequest::UpdateFirewallPolicyRequest(const UpdateFirewallPolicyRequest &other)
    : NetworkFirewallRequest(new UpdateFirewallPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateFirewallPolicyRequest object.
 */
UpdateFirewallPolicyRequest::UpdateFirewallPolicyRequest()
    : NetworkFirewallRequest(new UpdateFirewallPolicyRequestPrivate(NetworkFirewallRequest::UpdateFirewallPolicyAction, this))
{
 ...
 * \reimp
 */
bool UpdateFirewallPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateFirewallPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateFirewallPolicyRequest::response(QNetworkReply * const reply) const
{
    return new UpdateFirewallPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallPolicyRequestPrivate
 * \brief The UpdateFirewallPolicyRequestPrivate class provides private implementation for UpdateFirewallPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a UpdateFirewallPolicyRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
UpdateFirewallPolicyRequestPrivate::UpdateFirewallPolicyRequestPrivate(
    const NetworkFirewallRequest::Action action, UpdateFirewallPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateFirewallPolicyRequest
 * class' copy constructor.
 */
UpdateFirewallPolicyRequestPrivate::UpdateFirewallPolicyRequestPrivate(
    const UpdateFirewallPolicyRequestPrivate &other, UpdateFirewallPolicyRequest * const q)
