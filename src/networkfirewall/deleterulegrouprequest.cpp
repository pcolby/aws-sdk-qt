...
/*!
 * \class QtAws::NetworkFirewall::DeleteRuleGroupRequest
 * \brief The DeleteRuleGroupRequest class provides an interface for NetworkFirewall DeleteRuleGroup requests.
 *
 ...
 *
 * \sa NetworkFirewallClient::deleteRuleGroup
 */
...
DeleteRuleGroupRequest::DeleteRuleGroupRequest(const DeleteRuleGroupRequest &other)
    : NetworkFirewallRequest(new DeleteRuleGroupRequestPrivate(*other.d_func(), this))
{
...
DeleteRuleGroupRequest::DeleteRuleGroupRequest()
    : NetworkFirewallRequest(new DeleteRuleGroupRequestPrivate(NetworkFirewallRequest::DeleteRuleGroupAction, this))
{
...
/*!
 * \class QtAws::NetworkFirewall::DeleteRuleGroupRequestPrivate
...
/*!
 * Constructs a DeleteRuleGroupRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
DeleteRuleGroupRequestPrivate::DeleteRuleGroupRequestPrivate(
    const NetworkFirewallRequest::Action action, DeleteRuleGroupRequest * const q)
