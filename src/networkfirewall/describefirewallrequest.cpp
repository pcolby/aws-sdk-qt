...
#include "describefirewallrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::DescribeFirewallRequest
 * \brief The DescribeFirewallRequest class provides an interface for NetworkFirewall DescribeFirewall requests.
 *
 ...
 */
DescribeFirewallRequest::DescribeFirewallRequest(const DescribeFirewallRequest &other)
    : NetworkFirewallRequest(new DescribeFirewallRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeFirewallRequest object.
 */
DescribeFirewallRequest::DescribeFirewallRequest()
    : NetworkFirewallRequest(new DescribeFirewallRequestPrivate(NetworkFirewallRequest::DescribeFirewallAction, this))
{
 ...
 * \reimp
 */
bool DescribeFirewallRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeFirewallResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeFirewallRequest::response(QNetworkReply * const reply) const
{
    return new DescribeFirewallResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::DescribeFirewallRequestPrivate
 * \brief The DescribeFirewallRequestPrivate class provides private implementation for DescribeFirewallRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a DescribeFirewallRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
DescribeFirewallRequestPrivate::DescribeFirewallRequestPrivate(
    const NetworkFirewallRequest::Action action, DescribeFirewallRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeFirewallRequest
 * class' copy constructor.
 */
DescribeFirewallRequestPrivate::DescribeFirewallRequestPrivate(
    const DescribeFirewallRequestPrivate &other, DescribeFirewallRequest * const q)
