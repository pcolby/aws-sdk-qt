...
#include "deletefirewallresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::DeleteFirewallResponse
 * \brief The DeleteFirewallResponse class provides an interace for NetworkFirewall DeleteFirewall responses.
 *
 ...
 *
 * \sa NetworkFirewallClient::deleteFirewall
 */

/*!
 * Constructs a DeleteFirewallResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteFirewallResponse::DeleteFirewallResponse(
        const DeleteFirewallRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new DeleteFirewallResponsePrivate(this), parent)
{
    setRequest(new DeleteFirewallRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteFirewallRequest * DeleteFirewallResponse::request() const
{
    Q_D(const DeleteFirewallResponse);
    return static_cast<const DeleteFirewallRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful NetworkFirewall DeleteFirewall \a response.
 */
void DeleteFirewallResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteFirewallResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::DeleteFirewallResponsePrivate
 * \brief The DeleteFirewallResponsePrivate class provides private implementation for DeleteFirewallResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a DeleteFirewallResponsePrivate object with public implementation \a q.
 */
DeleteFirewallResponsePrivate::DeleteFirewallResponsePrivate(
    DeleteFirewallResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall DeleteFirewall response element from \a xml.
 */
void DeleteFirewallResponsePrivate::parseDeleteFirewallResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteFirewallResponse"));
    Q_UNUSED(xml) ///< @todo
}
