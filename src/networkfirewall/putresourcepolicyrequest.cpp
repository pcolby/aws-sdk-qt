...
/*!
 * \class QtAws::NetworkFirewall::PutResourcePolicyRequest
 * \brief The PutResourcePolicyRequest class provides an interface for NetworkFirewall PutResourcePolicy requests.
 *
...
PutResourcePolicyRequest::PutResourcePolicyRequest(const PutResourcePolicyRequest &other)
    : NetworkFirewallRequest(new PutResourcePolicyRequestPrivate(*other.d_func(), this))
{
...
PutResourcePolicyRequest::PutResourcePolicyRequest()
    : NetworkFirewallRequest(new PutResourcePolicyRequestPrivate(NetworkFirewallRequest::PutResourcePolicyAction, this))
{
...
/*!
 * \class QtAws::NetworkFirewall::PutResourcePolicyRequestPrivate
...
/*!
 * Constructs a PutResourcePolicyRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
PutResourcePolicyRequestPrivate::PutResourcePolicyRequestPrivate(
    const NetworkFirewallRequest::Action action, PutResourcePolicyRequest * const q)
