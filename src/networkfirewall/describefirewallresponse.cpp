...
#include "describefirewallresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::DescribeFirewallResponse
 * \brief The DescribeFirewallResponse class provides an interace for NetworkFirewall DescribeFirewall responses.
 *
 ...
 *
 * \sa NetworkFirewallClient::describeFirewall
 */

/*!
 * Constructs a DescribeFirewallResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeFirewallResponse::DescribeFirewallResponse(
        const DescribeFirewallRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new DescribeFirewallResponsePrivate(this), parent)
{
    setRequest(new DescribeFirewallRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeFirewallRequest * DescribeFirewallResponse::request() const
{
    Q_D(const DescribeFirewallResponse);
    return static_cast<const DescribeFirewallRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful NetworkFirewall DescribeFirewall \a response.
 */
void DescribeFirewallResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeFirewallResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::DescribeFirewallResponsePrivate
 * \brief The DescribeFirewallResponsePrivate class provides private implementation for DescribeFirewallResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a DescribeFirewallResponsePrivate object with public implementation \a q.
 */
DescribeFirewallResponsePrivate::DescribeFirewallResponsePrivate(
    DescribeFirewallResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall DescribeFirewall response element from \a xml.
 */
void DescribeFirewallResponsePrivate::parseDescribeFirewallResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeFirewallResponse"));
    Q_UNUSED(xml) ///< @todo
}
