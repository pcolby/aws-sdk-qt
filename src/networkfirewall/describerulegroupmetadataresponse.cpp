...
#include "describerulegroupmetadataresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::DescribeRuleGroupMetadataResponse
 * \brief The DescribeRuleGroupMetadataResponse class provides an interace for NetworkFirewall DescribeRuleGroupMetadata responses.
 *
 ...
 *
 * \sa NetworkFirewallClient::describeRuleGroupMetadata
 */

/*!
 * Constructs a DescribeRuleGroupMetadataResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeRuleGroupMetadataResponse::DescribeRuleGroupMetadataResponse(
        const DescribeRuleGroupMetadataRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new DescribeRuleGroupMetadataResponsePrivate(this), parent)
{
    setRequest(new DescribeRuleGroupMetadataRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeRuleGroupMetadataRequest * DescribeRuleGroupMetadataResponse::request() const
{
    Q_D(const DescribeRuleGroupMetadataResponse);
    return static_cast<const DescribeRuleGroupMetadataRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful NetworkFirewall DescribeRuleGroupMetadata \a response.
 */
void DescribeRuleGroupMetadataResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeRuleGroupMetadataResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::DescribeRuleGroupMetadataResponsePrivate
 * \brief The DescribeRuleGroupMetadataResponsePrivate class provides private implementation for DescribeRuleGroupMetadataResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a DescribeRuleGroupMetadataResponsePrivate object with public implementation \a q.
 */
DescribeRuleGroupMetadataResponsePrivate::DescribeRuleGroupMetadataResponsePrivate(
    DescribeRuleGroupMetadataResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall DescribeRuleGroupMetadata response element from \a xml.
 */
void DescribeRuleGroupMetadataResponsePrivate::parseDescribeRuleGroupMetadataResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeRuleGroupMetadataResponse"));
    Q_UNUSED(xml) ///< @todo
}
