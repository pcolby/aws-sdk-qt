...
/*!
 * \class QtAws::NetworkFirewall::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for NetworkFirewall TagResource requests.
 *
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : NetworkFirewallRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : NetworkFirewallRequest(new TagResourceRequestPrivate(NetworkFirewallRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::NetworkFirewall::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const NetworkFirewallRequest::Action action, TagResourceRequest * const q)
