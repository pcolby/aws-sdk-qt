...
/*!
 * \class QtAws::NetworkFirewall::CreateRuleGroupRequest
 * \brief The CreateRuleGroupRequest class provides an interface for NetworkFirewall CreateRuleGroup requests.
 *
 ...
 *
 * \sa NetworkFirewallClient::createRuleGroup
 */
...
CreateRuleGroupRequest::CreateRuleGroupRequest(const CreateRuleGroupRequest &other)
    : NetworkFirewallRequest(new CreateRuleGroupRequestPrivate(*other.d_func(), this))
{
...
CreateRuleGroupRequest::CreateRuleGroupRequest()
    : NetworkFirewallRequest(new CreateRuleGroupRequestPrivate(NetworkFirewallRequest::CreateRuleGroupAction, this))
{
...
/*!
 * \class QtAws::NetworkFirewall::CreateRuleGroupRequestPrivate
...
/*!
 * Constructs a CreateRuleGroupRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
CreateRuleGroupRequestPrivate::CreateRuleGroupRequestPrivate(
    const NetworkFirewallRequest::Action action, CreateRuleGroupRequest * const q)
