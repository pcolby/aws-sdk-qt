...
/*!
 * \class QtAws::NetworkFirewall::UpdateRuleGroupResponse
 * \brief The UpdateRuleGroupResponse class provides an interace for NetworkFirewall UpdateRuleGroup responses.
 *
...
UpdateRuleGroupResponse::UpdateRuleGroupResponse(
    ...
    : NetworkFirewallResponse(new UpdateRuleGroupResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall UpdateRuleGroup \a response.
 */
...
/*!
 * \class QtAws::NetworkFirewall::UpdateRuleGroupResponsePrivate
...
UpdateRuleGroupResponsePrivate::UpdateRuleGroupResponsePrivate(
    UpdateRuleGroupResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall UpdateRuleGroup response element from \a xml.
 */
