...
#include "createfirewallresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::CreateFirewallResponse
 * \brief The CreateFirewallResponse class provides an interace for NetworkFirewall CreateFirewall responses.
 *
 ...
 *
 * \sa NetworkFirewallClient::createFirewall
 */

/*!
 * Constructs a CreateFirewallResponse object for \a reply to \a request, with parent \a parent.
 */
CreateFirewallResponse::CreateFirewallResponse(
        const CreateFirewallRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new CreateFirewallResponsePrivate(this), parent)
{
    setRequest(new CreateFirewallRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateFirewallRequest * CreateFirewallResponse::request() const
{
    Q_D(const CreateFirewallResponse);
    return static_cast<const CreateFirewallRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful NetworkFirewall CreateFirewall \a response.
 */
void CreateFirewallResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateFirewallResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::CreateFirewallResponsePrivate
 * \brief The CreateFirewallResponsePrivate class provides private implementation for CreateFirewallResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a CreateFirewallResponsePrivate object with public implementation \a q.
 */
CreateFirewallResponsePrivate::CreateFirewallResponsePrivate(
    CreateFirewallResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall CreateFirewall response element from \a xml.
 */
void CreateFirewallResponsePrivate::parseCreateFirewallResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateFirewallResponse"));
    Q_UNUSED(xml) ///< @todo
}
