...
#include "updatefirewallpolicyresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallPolicyResponse
 * \brief The UpdateFirewallPolicyResponse class provides an interace for NetworkFirewall UpdateFirewallPolicy responses.
 *
 ...
 *
 * \sa NetworkFirewallClient::updateFirewallPolicy
 */

/*!
 * Constructs a UpdateFirewallPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateFirewallPolicyResponse::UpdateFirewallPolicyResponse(
        const UpdateFirewallPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new UpdateFirewallPolicyResponsePrivate(this), parent)
{
    setRequest(new UpdateFirewallPolicyRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateFirewallPolicyRequest * UpdateFirewallPolicyResponse::request() const
{
    Q_D(const UpdateFirewallPolicyResponse);
    return static_cast<const UpdateFirewallPolicyRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful NetworkFirewall UpdateFirewallPolicy \a response.
 */
void UpdateFirewallPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateFirewallPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallPolicyResponsePrivate
 * \brief The UpdateFirewallPolicyResponsePrivate class provides private implementation for UpdateFirewallPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a UpdateFirewallPolicyResponsePrivate object with public implementation \a q.
 */
UpdateFirewallPolicyResponsePrivate::UpdateFirewallPolicyResponsePrivate(
    UpdateFirewallPolicyResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall UpdateFirewallPolicy response element from \a xml.
 */
void UpdateFirewallPolicyResponsePrivate::parseUpdateFirewallPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateFirewallPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
