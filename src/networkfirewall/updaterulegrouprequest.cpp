...
/*!
 * \class QtAws::NetworkFirewall::UpdateRuleGroupRequest
 * \brief The UpdateRuleGroupRequest class provides an interface for NetworkFirewall UpdateRuleGroup requests.
 *
 ...
 *
 * \sa NetworkFirewallClient::updateRuleGroup
 */
...
UpdateRuleGroupRequest::UpdateRuleGroupRequest(const UpdateRuleGroupRequest &other)
    : NetworkFirewallRequest(new UpdateRuleGroupRequestPrivate(*other.d_func(), this))
{
...
UpdateRuleGroupRequest::UpdateRuleGroupRequest()
    : NetworkFirewallRequest(new UpdateRuleGroupRequestPrivate(NetworkFirewallRequest::UpdateRuleGroupAction, this))
{
...
/*!
 * \class QtAws::NetworkFirewall::UpdateRuleGroupRequestPrivate
...
/*!
 * Constructs a UpdateRuleGroupRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
UpdateRuleGroupRequestPrivate::UpdateRuleGroupRequestPrivate(
    const NetworkFirewallRequest::Action action, UpdateRuleGroupRequest * const q)
