...
#include "describerulegrouprequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::DescribeRuleGroupRequest
 * \brief The DescribeRuleGroupRequest class provides an interface for NetworkFirewall DescribeRuleGroup requests.
 *
 ...
 */
DescribeRuleGroupRequest::DescribeRuleGroupRequest(const DescribeRuleGroupRequest &other)
    : NetworkFirewallRequest(new DescribeRuleGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeRuleGroupRequest object.
 */
DescribeRuleGroupRequest::DescribeRuleGroupRequest()
    : NetworkFirewallRequest(new DescribeRuleGroupRequestPrivate(NetworkFirewallRequest::DescribeRuleGroupAction, this))
{
 ...
 * \reimp
 */
bool DescribeRuleGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeRuleGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeRuleGroupRequest::response(QNetworkReply * const reply) const
{
    return new DescribeRuleGroupResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::DescribeRuleGroupRequestPrivate
 * \brief The DescribeRuleGroupRequestPrivate class provides private implementation for DescribeRuleGroupRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a DescribeRuleGroupRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
DescribeRuleGroupRequestPrivate::DescribeRuleGroupRequestPrivate(
    const NetworkFirewallRequest::Action action, DescribeRuleGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeRuleGroupRequest
 * class' copy constructor.
 */
DescribeRuleGroupRequestPrivate::DescribeRuleGroupRequestPrivate(
    const DescribeRuleGroupRequestPrivate &other, DescribeRuleGroupRequest * const q)
