...
/*!
 * \class QtAws::NetworkFirewall::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for NetworkFirewall ListTagsForResource requests.
 *
 ...
 *
 * \sa NetworkFirewallClient::listTagsForResource
 */
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : NetworkFirewallRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : NetworkFirewallRequest(new ListTagsForResourceRequestPrivate(NetworkFirewallRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::NetworkFirewall::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const NetworkFirewallRequest::Action action, ListTagsForResourceRequest * const q)
