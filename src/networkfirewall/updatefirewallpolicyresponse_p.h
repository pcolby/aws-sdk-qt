...
class QTAWS_EXPORT UpdateFirewallPolicyResponsePrivate : public NetworkFirewallResponsePrivate {

public:

    UpdateFirewallPolicyResponsePrivate(UpdateFirewallPolicyResponse * const q);
