...
/*!
 * \class QtAws::NetworkFirewall::DescribeResourcePolicyResponse
 * \brief The DescribeResourcePolicyResponse class provides an interace for NetworkFirewall DescribeResourcePolicy responses.
 *
...
DescribeResourcePolicyResponse::DescribeResourcePolicyResponse(
    ...
    : NetworkFirewallResponse(new DescribeResourcePolicyResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall DescribeResourcePolicy \a response.
 */
...
/*!
 * \class QtAws::NetworkFirewall::DescribeResourcePolicyResponsePrivate
...
DescribeResourcePolicyResponsePrivate::DescribeResourcePolicyResponsePrivate(
    DescribeResourcePolicyResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall DescribeResourcePolicy response element from \a xml.
 */
