...
#include "updatefirewallencryptionconfigurationrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallEncryptionConfigurationRequest
 * \brief The UpdateFirewallEncryptionConfigurationRequest class provides an interface for NetworkFirewall UpdateFirewallEncryptionConfiguration requests.
 *
 ...
 */
UpdateFirewallEncryptionConfigurationRequest::UpdateFirewallEncryptionConfigurationRequest(const UpdateFirewallEncryptionConfigurationRequest &other)
    : NetworkFirewallRequest(new UpdateFirewallEncryptionConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateFirewallEncryptionConfigurationRequest object.
 */
UpdateFirewallEncryptionConfigurationRequest::UpdateFirewallEncryptionConfigurationRequest()
    : NetworkFirewallRequest(new UpdateFirewallEncryptionConfigurationRequestPrivate(NetworkFirewallRequest::UpdateFirewallEncryptionConfigurationAction, this))
{
 ...
 * \reimp
 */
bool UpdateFirewallEncryptionConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateFirewallEncryptionConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateFirewallEncryptionConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new UpdateFirewallEncryptionConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallEncryptionConfigurationRequestPrivate
 * \brief The UpdateFirewallEncryptionConfigurationRequestPrivate class provides private implementation for UpdateFirewallEncryptionConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a UpdateFirewallEncryptionConfigurationRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
UpdateFirewallEncryptionConfigurationRequestPrivate::UpdateFirewallEncryptionConfigurationRequestPrivate(
    const NetworkFirewallRequest::Action action, UpdateFirewallEncryptionConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateFirewallEncryptionConfigurationRequest
 * class' copy constructor.
 */
UpdateFirewallEncryptionConfigurationRequestPrivate::UpdateFirewallEncryptionConfigurationRequestPrivate(
    const UpdateFirewallEncryptionConfigurationRequestPrivate &other, UpdateFirewallEncryptionConfigurationRequest * const q)
