...
#include "createfirewallpolicyrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::CreateFirewallPolicyRequest
 * \brief The CreateFirewallPolicyRequest class provides an interface for NetworkFirewall CreateFirewallPolicy requests.
 *
 ...
 */
CreateFirewallPolicyRequest::CreateFirewallPolicyRequest(const CreateFirewallPolicyRequest &other)
    : NetworkFirewallRequest(new CreateFirewallPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateFirewallPolicyRequest object.
 */
CreateFirewallPolicyRequest::CreateFirewallPolicyRequest()
    : NetworkFirewallRequest(new CreateFirewallPolicyRequestPrivate(NetworkFirewallRequest::CreateFirewallPolicyAction, this))
{
 ...
 * \reimp
 */
bool CreateFirewallPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateFirewallPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateFirewallPolicyRequest::response(QNetworkReply * const reply) const
{
    return new CreateFirewallPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::CreateFirewallPolicyRequestPrivate
 * \brief The CreateFirewallPolicyRequestPrivate class provides private implementation for CreateFirewallPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a CreateFirewallPolicyRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
CreateFirewallPolicyRequestPrivate::CreateFirewallPolicyRequestPrivate(
    const NetworkFirewallRequest::Action action, CreateFirewallPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateFirewallPolicyRequest
 * class' copy constructor.
 */
CreateFirewallPolicyRequestPrivate::CreateFirewallPolicyRequestPrivate(
    const CreateFirewallPolicyRequestPrivate &other, CreateFirewallPolicyRequest * const q)
