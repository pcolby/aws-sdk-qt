...
#include "deletefirewallpolicyresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::DeleteFirewallPolicyResponse
 * \brief The DeleteFirewallPolicyResponse class provides an interace for NetworkFirewall DeleteFirewallPolicy responses.
 *
...
/*!
 * Constructs a DeleteFirewallPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteFirewallPolicyResponse::DeleteFirewallPolicyResponse(
        const DeleteFirewallPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new DeleteFirewallPolicyResponsePrivate(this), parent)
{
    setRequest(new DeleteFirewallPolicyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall DeleteFirewallPolicy \a response.
 */
void DeleteFirewallPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteFirewallPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::DeleteFirewallPolicyResponsePrivate
 * \brief The DeleteFirewallPolicyResponsePrivate class provides private implementation for DeleteFirewallPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a DeleteFirewallPolicyResponsePrivate object with public implementation \a q.
 */
DeleteFirewallPolicyResponsePrivate::DeleteFirewallPolicyResponsePrivate(
    DeleteFirewallPolicyResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall DeleteFirewallPolicy response element from \a xml.
 */
void DeleteFirewallPolicyResponsePrivate::parseDeleteFirewallPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteFirewallPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
