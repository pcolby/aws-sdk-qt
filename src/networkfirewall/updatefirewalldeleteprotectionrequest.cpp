...
#include "updatefirewalldeleteprotectionrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallDeleteProtectionRequest
 * \brief The UpdateFirewallDeleteProtectionRequest class provides an interface for NetworkFirewall UpdateFirewallDeleteProtection requests.
 *
 ...
 *
 * \sa NetworkFirewallClient::updateFirewallDeleteProtection
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateFirewallDeleteProtectionRequest::UpdateFirewallDeleteProtectionRequest(const UpdateFirewallDeleteProtectionRequest &other)
    : NetworkFirewallRequest(new UpdateFirewallDeleteProtectionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateFirewallDeleteProtectionRequest object.
 */
UpdateFirewallDeleteProtectionRequest::UpdateFirewallDeleteProtectionRequest()
    : NetworkFirewallRequest(new UpdateFirewallDeleteProtectionRequestPrivate(NetworkFirewallRequest::UpdateFirewallDeleteProtectionAction, this))
{
 ...
 * \reimp
 */
bool UpdateFirewallDeleteProtectionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateFirewallDeleteProtectionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateFirewallDeleteProtectionRequest::response(QNetworkReply * const reply) const
{
    return new UpdateFirewallDeleteProtectionResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallDeleteProtectionRequestPrivate
 * \brief The UpdateFirewallDeleteProtectionRequestPrivate class provides private implementation for UpdateFirewallDeleteProtectionRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a UpdateFirewallDeleteProtectionRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
UpdateFirewallDeleteProtectionRequestPrivate::UpdateFirewallDeleteProtectionRequestPrivate(
    const NetworkFirewallRequest::Action action, UpdateFirewallDeleteProtectionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateFirewallDeleteProtectionRequest
 * class' copy constructor.
 */
UpdateFirewallDeleteProtectionRequestPrivate::UpdateFirewallDeleteProtectionRequestPrivate(
    const UpdateFirewallDeleteProtectionRequestPrivate &other, UpdateFirewallDeleteProtectionRequest * const q)
