...
#include "updatefirewalldescriptionresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallDescriptionResponse
 * \brief The UpdateFirewallDescriptionResponse class provides an interace for NetworkFirewall UpdateFirewallDescription responses.
 *
...
/*!
 * Constructs a UpdateFirewallDescriptionResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateFirewallDescriptionResponse::UpdateFirewallDescriptionResponse(
        const UpdateFirewallDescriptionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new UpdateFirewallDescriptionResponsePrivate(this), parent)
{
    setRequest(new UpdateFirewallDescriptionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall UpdateFirewallDescription \a response.
 */
void UpdateFirewallDescriptionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateFirewallDescriptionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallDescriptionResponsePrivate
 * \brief The UpdateFirewallDescriptionResponsePrivate class provides private implementation for UpdateFirewallDescriptionResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a UpdateFirewallDescriptionResponsePrivate object with public implementation \a q.
 */
UpdateFirewallDescriptionResponsePrivate::UpdateFirewallDescriptionResponsePrivate(
    UpdateFirewallDescriptionResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall UpdateFirewallDescription response element from \a xml.
 */
void UpdateFirewallDescriptionResponsePrivate::parseUpdateFirewallDescriptionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateFirewallDescriptionResponse"));
    Q_UNUSED(xml) ///< @todo
}
