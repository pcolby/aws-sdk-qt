...
#include "describerulegroupmetadatarequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::DescribeRuleGroupMetadataRequest
 * \brief The DescribeRuleGroupMetadataRequest class provides an interface for NetworkFirewall DescribeRuleGroupMetadata requests.
 *
 ...
 */
DescribeRuleGroupMetadataRequest::DescribeRuleGroupMetadataRequest(const DescribeRuleGroupMetadataRequest &other)
    : NetworkFirewallRequest(new DescribeRuleGroupMetadataRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeRuleGroupMetadataRequest object.
 */
DescribeRuleGroupMetadataRequest::DescribeRuleGroupMetadataRequest()
    : NetworkFirewallRequest(new DescribeRuleGroupMetadataRequestPrivate(NetworkFirewallRequest::DescribeRuleGroupMetadataAction, this))
{
 ...
 * \reimp
 */
bool DescribeRuleGroupMetadataRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeRuleGroupMetadataResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeRuleGroupMetadataRequest::response(QNetworkReply * const reply) const
{
    return new DescribeRuleGroupMetadataResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::DescribeRuleGroupMetadataRequestPrivate
 * \brief The DescribeRuleGroupMetadataRequestPrivate class provides private implementation for DescribeRuleGroupMetadataRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a DescribeRuleGroupMetadataRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
DescribeRuleGroupMetadataRequestPrivate::DescribeRuleGroupMetadataRequestPrivate(
    const NetworkFirewallRequest::Action action, DescribeRuleGroupMetadataRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeRuleGroupMetadataRequest
 * class' copy constructor.
 */
DescribeRuleGroupMetadataRequestPrivate::DescribeRuleGroupMetadataRequestPrivate(
    const DescribeRuleGroupMetadataRequestPrivate &other, DescribeRuleGroupMetadataRequest * const q)
