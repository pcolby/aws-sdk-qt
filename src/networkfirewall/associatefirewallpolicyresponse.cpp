...
#include "associatefirewallpolicyresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::AssociateFirewallPolicyResponse
 * \brief The AssociateFirewallPolicyResponse class provides an interace for NetworkFirewall AssociateFirewallPolicy responses.
 *
...
/*!
 * Constructs a AssociateFirewallPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
AssociateFirewallPolicyResponse::AssociateFirewallPolicyResponse(
        const AssociateFirewallPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new AssociateFirewallPolicyResponsePrivate(this), parent)
{
    setRequest(new AssociateFirewallPolicyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall AssociateFirewallPolicy \a response.
 */
void AssociateFirewallPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AssociateFirewallPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::AssociateFirewallPolicyResponsePrivate
 * \brief The AssociateFirewallPolicyResponsePrivate class provides private implementation for AssociateFirewallPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a AssociateFirewallPolicyResponsePrivate object with public implementation \a q.
 */
AssociateFirewallPolicyResponsePrivate::AssociateFirewallPolicyResponsePrivate(
    AssociateFirewallPolicyResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall AssociateFirewallPolicy response element from \a xml.
 */
void AssociateFirewallPolicyResponsePrivate::parseAssociateFirewallPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AssociateFirewallPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
