...
#include "disassociatesubnetsrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::DisassociateSubnetsRequest
 * \brief The DisassociateSubnetsRequest class provides an interface for NetworkFirewall DisassociateSubnets requests.
 *
 ...
 *
 * \sa NetworkFirewallClient::disassociateSubnets
 */

/*!
 * Constructs a copy of \a other.
 */
DisassociateSubnetsRequest::DisassociateSubnetsRequest(const DisassociateSubnetsRequest &other)
    : NetworkFirewallRequest(new DisassociateSubnetsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DisassociateSubnetsRequest object.
 */
DisassociateSubnetsRequest::DisassociateSubnetsRequest()
    : NetworkFirewallRequest(new DisassociateSubnetsRequestPrivate(NetworkFirewallRequest::DisassociateSubnetsAction, this))
{
 ...
 * \reimp
 */
bool DisassociateSubnetsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DisassociateSubnetsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DisassociateSubnetsRequest::response(QNetworkReply * const reply) const
{
    return new DisassociateSubnetsResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::DisassociateSubnetsRequestPrivate
 * \brief The DisassociateSubnetsRequestPrivate class provides private implementation for DisassociateSubnetsRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a DisassociateSubnetsRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
DisassociateSubnetsRequestPrivate::DisassociateSubnetsRequestPrivate(
    const NetworkFirewallRequest::Action action, DisassociateSubnetsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DisassociateSubnetsRequest
 * class' copy constructor.
 */
DisassociateSubnetsRequestPrivate::DisassociateSubnetsRequestPrivate(
    const DisassociateSubnetsRequestPrivate &other, DisassociateSubnetsRequest * const q)
