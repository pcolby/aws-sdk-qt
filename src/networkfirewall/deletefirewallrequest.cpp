...
#include "deletefirewallrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::DeleteFirewallRequest
 * \brief The DeleteFirewallRequest class provides an interface for NetworkFirewall DeleteFirewall requests.
 *
 ...
 */
DeleteFirewallRequest::DeleteFirewallRequest(const DeleteFirewallRequest &other)
    : NetworkFirewallRequest(new DeleteFirewallRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteFirewallRequest object.
 */
DeleteFirewallRequest::DeleteFirewallRequest()
    : NetworkFirewallRequest(new DeleteFirewallRequestPrivate(NetworkFirewallRequest::DeleteFirewallAction, this))
{
 ...
 * \reimp
 */
bool DeleteFirewallRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteFirewallResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteFirewallRequest::response(QNetworkReply * const reply) const
{
    return new DeleteFirewallResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::DeleteFirewallRequestPrivate
 * \brief The DeleteFirewallRequestPrivate class provides private implementation for DeleteFirewallRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a DeleteFirewallRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
DeleteFirewallRequestPrivate::DeleteFirewallRequestPrivate(
    const NetworkFirewallRequest::Action action, DeleteFirewallRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteFirewallRequest
 * class' copy constructor.
 */
DeleteFirewallRequestPrivate::DeleteFirewallRequestPrivate(
    const DeleteFirewallRequestPrivate &other, DeleteFirewallRequest * const q)
