...
/*!
 * \class QtAws::NetworkFirewall::ListRuleGroupsResponse
 * \brief The ListRuleGroupsResponse class provides an interace for NetworkFirewall ListRuleGroups responses.
 *
...
ListRuleGroupsResponse::ListRuleGroupsResponse(
    ...
    : NetworkFirewallResponse(new ListRuleGroupsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall ListRuleGroups \a response.
 */
...
/*!
 * \class QtAws::NetworkFirewall::ListRuleGroupsResponsePrivate
...
ListRuleGroupsResponsePrivate::ListRuleGroupsResponsePrivate(
    ListRuleGroupsResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall ListRuleGroups response element from \a xml.
 */
