...
#include "createfirewallpolicyresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::CreateFirewallPolicyResponse
 * \brief The CreateFirewallPolicyResponse class provides an interace for NetworkFirewall CreateFirewallPolicy responses.
 *
 ...
 *
 * \sa NetworkFirewallClient::createFirewallPolicy
 */

/*!
 * Constructs a CreateFirewallPolicyResponse object for \a reply to \a request, with parent \a parent.
 */
CreateFirewallPolicyResponse::CreateFirewallPolicyResponse(
        const CreateFirewallPolicyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new CreateFirewallPolicyResponsePrivate(this), parent)
{
    setRequest(new CreateFirewallPolicyRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateFirewallPolicyRequest * CreateFirewallPolicyResponse::request() const
{
    Q_D(const CreateFirewallPolicyResponse);
    return static_cast<const CreateFirewallPolicyRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful NetworkFirewall CreateFirewallPolicy \a response.
 */
void CreateFirewallPolicyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateFirewallPolicyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::CreateFirewallPolicyResponsePrivate
 * \brief The CreateFirewallPolicyResponsePrivate class provides private implementation for CreateFirewallPolicyResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a CreateFirewallPolicyResponsePrivate object with public implementation \a q.
 */
CreateFirewallPolicyResponsePrivate::CreateFirewallPolicyResponsePrivate(
    CreateFirewallPolicyResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall CreateFirewallPolicy response element from \a xml.
 */
void CreateFirewallPolicyResponsePrivate::parseCreateFirewallPolicyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateFirewallPolicyResponse"));
    Q_UNUSED(xml) ///< @todo
}
