...
/*!
 * \class QtAws::NetworkFirewall::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for NetworkFirewall UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : NetworkFirewallRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : NetworkFirewallRequest(new UntagResourceRequestPrivate(NetworkFirewallRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::NetworkFirewall::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const NetworkFirewallRequest::Action action, UntagResourceRequest * const q)
