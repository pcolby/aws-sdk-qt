...
#include "deletefirewallpolicyrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::DeleteFirewallPolicyRequest
 * \brief The DeleteFirewallPolicyRequest class provides an interface for NetworkFirewall DeleteFirewallPolicy requests.
 *
 ...
 *
 * \sa NetworkFirewallClient::deleteFirewallPolicy
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteFirewallPolicyRequest::DeleteFirewallPolicyRequest(const DeleteFirewallPolicyRequest &other)
    : NetworkFirewallRequest(new DeleteFirewallPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteFirewallPolicyRequest object.
 */
DeleteFirewallPolicyRequest::DeleteFirewallPolicyRequest()
    : NetworkFirewallRequest(new DeleteFirewallPolicyRequestPrivate(NetworkFirewallRequest::DeleteFirewallPolicyAction, this))
{
 ...
 * \reimp
 */
bool DeleteFirewallPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteFirewallPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteFirewallPolicyRequest::response(QNetworkReply * const reply) const
{
    return new DeleteFirewallPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::DeleteFirewallPolicyRequestPrivate
 * \brief The DeleteFirewallPolicyRequestPrivate class provides private implementation for DeleteFirewallPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a DeleteFirewallPolicyRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
DeleteFirewallPolicyRequestPrivate::DeleteFirewallPolicyRequestPrivate(
    const NetworkFirewallRequest::Action action, DeleteFirewallPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteFirewallPolicyRequest
 * class' copy constructor.
 */
DeleteFirewallPolicyRequestPrivate::DeleteFirewallPolicyRequestPrivate(
    const DeleteFirewallPolicyRequestPrivate &other, DeleteFirewallPolicyRequest * const q)
