...
#include "updatefirewallencryptionconfigurationresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallEncryptionConfigurationResponse
 * \brief The UpdateFirewallEncryptionConfigurationResponse class provides an interace for NetworkFirewall UpdateFirewallEncryptionConfiguration responses.
 *
 ...
 *
 * \sa NetworkFirewallClient::updateFirewallEncryptionConfiguration
 */

/*!
 * Constructs a UpdateFirewallEncryptionConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateFirewallEncryptionConfigurationResponse::UpdateFirewallEncryptionConfigurationResponse(
        const UpdateFirewallEncryptionConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new UpdateFirewallEncryptionConfigurationResponsePrivate(this), parent)
{
    setRequest(new UpdateFirewallEncryptionConfigurationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateFirewallEncryptionConfigurationRequest * UpdateFirewallEncryptionConfigurationResponse::request() const
{
    Q_D(const UpdateFirewallEncryptionConfigurationResponse);
    return static_cast<const UpdateFirewallEncryptionConfigurationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful NetworkFirewall UpdateFirewallEncryptionConfiguration \a response.
 */
void UpdateFirewallEncryptionConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateFirewallEncryptionConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallEncryptionConfigurationResponsePrivate
 * \brief The UpdateFirewallEncryptionConfigurationResponsePrivate class provides private implementation for UpdateFirewallEncryptionConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a UpdateFirewallEncryptionConfigurationResponsePrivate object with public implementation \a q.
 */
UpdateFirewallEncryptionConfigurationResponsePrivate::UpdateFirewallEncryptionConfigurationResponsePrivate(
    UpdateFirewallEncryptionConfigurationResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall UpdateFirewallEncryptionConfiguration response element from \a xml.
 */
void UpdateFirewallEncryptionConfigurationResponsePrivate::parseUpdateFirewallEncryptionConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateFirewallEncryptionConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
