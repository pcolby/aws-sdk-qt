...
#include "createfirewallrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::CreateFirewallRequest
 * \brief The CreateFirewallRequest class provides an interface for NetworkFirewall CreateFirewall requests.
 *
 ...
 */
CreateFirewallRequest::CreateFirewallRequest(const CreateFirewallRequest &other)
    : NetworkFirewallRequest(new CreateFirewallRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateFirewallRequest object.
 */
CreateFirewallRequest::CreateFirewallRequest()
    : NetworkFirewallRequest(new CreateFirewallRequestPrivate(NetworkFirewallRequest::CreateFirewallAction, this))
{
 ...
 * \reimp
 */
bool CreateFirewallRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateFirewallResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateFirewallRequest::response(QNetworkReply * const reply) const
{
    return new CreateFirewallResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::CreateFirewallRequestPrivate
 * \brief The CreateFirewallRequestPrivate class provides private implementation for CreateFirewallRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a CreateFirewallRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
CreateFirewallRequestPrivate::CreateFirewallRequestPrivate(
    const NetworkFirewallRequest::Action action, CreateFirewallRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateFirewallRequest
 * class' copy constructor.
 */
CreateFirewallRequestPrivate::CreateFirewallRequestPrivate(
    const CreateFirewallRequestPrivate &other, CreateFirewallRequest * const q)
