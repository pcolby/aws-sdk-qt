...
/*!
 * \class QtAws::NetworkFirewall::DescribeLoggingConfigurationResponse
 * \brief The DescribeLoggingConfigurationResponse class provides an interace for NetworkFirewall DescribeLoggingConfiguration responses.
 *
...
DescribeLoggingConfigurationResponse::DescribeLoggingConfigurationResponse(
    ...
    : NetworkFirewallResponse(new DescribeLoggingConfigurationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall DescribeLoggingConfiguration \a response.
 */
...
/*!
 * \class QtAws::NetworkFirewall::DescribeLoggingConfigurationResponsePrivate
...
DescribeLoggingConfigurationResponsePrivate::DescribeLoggingConfigurationResponsePrivate(
    DescribeLoggingConfigurationResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall DescribeLoggingConfiguration response element from \a xml.
 */
