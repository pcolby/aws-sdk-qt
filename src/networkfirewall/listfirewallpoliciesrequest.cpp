...
#include "listfirewallpoliciesrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::ListFirewallPoliciesRequest
 * \brief The ListFirewallPoliciesRequest class provides an interface for NetworkFirewall ListFirewallPolicies requests.
 *
 ...
 */
ListFirewallPoliciesRequest::ListFirewallPoliciesRequest(const ListFirewallPoliciesRequest &other)
    : NetworkFirewallRequest(new ListFirewallPoliciesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListFirewallPoliciesRequest object.
 */
ListFirewallPoliciesRequest::ListFirewallPoliciesRequest()
    : NetworkFirewallRequest(new ListFirewallPoliciesRequestPrivate(NetworkFirewallRequest::ListFirewallPoliciesAction, this))
{
 ...
 * \reimp
 */
bool ListFirewallPoliciesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListFirewallPoliciesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListFirewallPoliciesRequest::response(QNetworkReply * const reply) const
{
    return new ListFirewallPoliciesResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::ListFirewallPoliciesRequestPrivate
 * \brief The ListFirewallPoliciesRequestPrivate class provides private implementation for ListFirewallPoliciesRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a ListFirewallPoliciesRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
ListFirewallPoliciesRequestPrivate::ListFirewallPoliciesRequestPrivate(
    const NetworkFirewallRequest::Action action, ListFirewallPoliciesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListFirewallPoliciesRequest
 * class' copy constructor.
 */
ListFirewallPoliciesRequestPrivate::ListFirewallPoliciesRequestPrivate(
    const ListFirewallPoliciesRequestPrivate &other, ListFirewallPoliciesRequest * const q)
