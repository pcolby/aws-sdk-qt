...
#include "associatesubnetsresponse_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::AssociateSubnetsResponse
 * \brief The AssociateSubnetsResponse class provides an interace for NetworkFirewall AssociateSubnets responses.
 *
...
/*!
 * Constructs a AssociateSubnetsResponse object for \a reply to \a request, with parent \a parent.
 */
AssociateSubnetsResponse::AssociateSubnetsResponse(
        const AssociateSubnetsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : NetworkFirewallResponse(new AssociateSubnetsResponsePrivate(this), parent)
{
    setRequest(new AssociateSubnetsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall AssociateSubnets \a response.
 */
void AssociateSubnetsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AssociateSubnetsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::NetworkFirewall::AssociateSubnetsResponsePrivate
 * \brief The AssociateSubnetsResponsePrivate class provides private implementation for AssociateSubnetsResponse.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a AssociateSubnetsResponsePrivate object with public implementation \a q.
 */
AssociateSubnetsResponsePrivate::AssociateSubnetsResponsePrivate(
    AssociateSubnetsResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall AssociateSubnets response element from \a xml.
 */
void AssociateSubnetsResponsePrivate::parseAssociateSubnetsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AssociateSubnetsResponse"));
    Q_UNUSED(xml) ///< @todo
}
