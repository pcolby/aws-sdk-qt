...
#include "associatefirewallpolicyrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::AssociateFirewallPolicyRequest
 * \brief The AssociateFirewallPolicyRequest class provides an interface for NetworkFirewall AssociateFirewallPolicy requests.
 *
 ...
 *
 * \sa NetworkFirewallClient::associateFirewallPolicy
 */

/*!
 * Constructs a copy of \a other.
 */
AssociateFirewallPolicyRequest::AssociateFirewallPolicyRequest(const AssociateFirewallPolicyRequest &other)
    : NetworkFirewallRequest(new AssociateFirewallPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AssociateFirewallPolicyRequest object.
 */
AssociateFirewallPolicyRequest::AssociateFirewallPolicyRequest()
    : NetworkFirewallRequest(new AssociateFirewallPolicyRequestPrivate(NetworkFirewallRequest::AssociateFirewallPolicyAction, this))
{
 ...
 * \reimp
 */
bool AssociateFirewallPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AssociateFirewallPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AssociateFirewallPolicyRequest::response(QNetworkReply * const reply) const
{
    return new AssociateFirewallPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::AssociateFirewallPolicyRequestPrivate
 * \brief The AssociateFirewallPolicyRequestPrivate class provides private implementation for AssociateFirewallPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a AssociateFirewallPolicyRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
AssociateFirewallPolicyRequestPrivate::AssociateFirewallPolicyRequestPrivate(
    const NetworkFirewallRequest::Action action, AssociateFirewallPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AssociateFirewallPolicyRequest
 * class' copy constructor.
 */
AssociateFirewallPolicyRequestPrivate::AssociateFirewallPolicyRequestPrivate(
    const AssociateFirewallPolicyRequestPrivate &other, AssociateFirewallPolicyRequest * const q)
