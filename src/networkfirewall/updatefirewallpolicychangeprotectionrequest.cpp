...
#include "updatefirewallpolicychangeprotectionrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallPolicyChangeProtectionRequest
 * \brief The UpdateFirewallPolicyChangeProtectionRequest class provides an interface for NetworkFirewall UpdateFirewallPolicyChangeProtection requests.
 *
 ...
 */
UpdateFirewallPolicyChangeProtectionRequest::UpdateFirewallPolicyChangeProtectionRequest(const UpdateFirewallPolicyChangeProtectionRequest &other)
    : NetworkFirewallRequest(new UpdateFirewallPolicyChangeProtectionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateFirewallPolicyChangeProtectionRequest object.
 */
UpdateFirewallPolicyChangeProtectionRequest::UpdateFirewallPolicyChangeProtectionRequest()
    : NetworkFirewallRequest(new UpdateFirewallPolicyChangeProtectionRequestPrivate(NetworkFirewallRequest::UpdateFirewallPolicyChangeProtectionAction, this))
{
 ...
 * \reimp
 */
bool UpdateFirewallPolicyChangeProtectionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateFirewallPolicyChangeProtectionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateFirewallPolicyChangeProtectionRequest::response(QNetworkReply * const reply) const
{
    return new UpdateFirewallPolicyChangeProtectionResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::UpdateFirewallPolicyChangeProtectionRequestPrivate
 * \brief The UpdateFirewallPolicyChangeProtectionRequestPrivate class provides private implementation for UpdateFirewallPolicyChangeProtectionRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a UpdateFirewallPolicyChangeProtectionRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
UpdateFirewallPolicyChangeProtectionRequestPrivate::UpdateFirewallPolicyChangeProtectionRequestPrivate(
    const NetworkFirewallRequest::Action action, UpdateFirewallPolicyChangeProtectionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateFirewallPolicyChangeProtectionRequest
 * class' copy constructor.
 */
UpdateFirewallPolicyChangeProtectionRequestPrivate::UpdateFirewallPolicyChangeProtectionRequestPrivate(
    const UpdateFirewallPolicyChangeProtectionRequestPrivate &other, UpdateFirewallPolicyChangeProtectionRequest * const q)
