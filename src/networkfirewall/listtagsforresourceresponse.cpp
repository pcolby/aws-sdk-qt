...
/*!
 * \class QtAws::NetworkFirewall::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for NetworkFirewall ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : NetworkFirewallResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::NetworkFirewall::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall ListTagsForResource response element from \a xml.
 */
