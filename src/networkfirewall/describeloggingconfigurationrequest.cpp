...
/*!
 * \class QtAws::NetworkFirewall::DescribeLoggingConfigurationRequest
 * \brief The DescribeLoggingConfigurationRequest class provides an interface for NetworkFirewall DescribeLoggingConfiguration requests.
 *
 ...
 *
 * \sa NetworkFirewallClient::describeLoggingConfiguration
 */
...
DescribeLoggingConfigurationRequest::DescribeLoggingConfigurationRequest(const DescribeLoggingConfigurationRequest &other)
    : NetworkFirewallRequest(new DescribeLoggingConfigurationRequestPrivate(*other.d_func(), this))
{
...
DescribeLoggingConfigurationRequest::DescribeLoggingConfigurationRequest()
    : NetworkFirewallRequest(new DescribeLoggingConfigurationRequestPrivate(NetworkFirewallRequest::DescribeLoggingConfigurationAction, this))
{
...
/*!
 * \class QtAws::NetworkFirewall::DescribeLoggingConfigurationRequestPrivate
...
/*!
 * Constructs a DescribeLoggingConfigurationRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
DescribeLoggingConfigurationRequestPrivate::DescribeLoggingConfigurationRequestPrivate(
    const NetworkFirewallRequest::Action action, DescribeLoggingConfigurationRequest * const q)
