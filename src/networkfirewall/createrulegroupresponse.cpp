...
/*!
 * \class QtAws::NetworkFirewall::CreateRuleGroupResponse
 * \brief The CreateRuleGroupResponse class provides an interace for NetworkFirewall CreateRuleGroup responses.
 *
...
CreateRuleGroupResponse::CreateRuleGroupResponse(
    ...
    : NetworkFirewallResponse(new CreateRuleGroupResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful NetworkFirewall CreateRuleGroup \a response.
 */
...
/*!
 * \class QtAws::NetworkFirewall::CreateRuleGroupResponsePrivate
...
CreateRuleGroupResponsePrivate::CreateRuleGroupResponsePrivate(
    CreateRuleGroupResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall CreateRuleGroup response element from \a xml.
 */
