...
#include "describefirewallpolicyrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::DescribeFirewallPolicyRequest
 * \brief The DescribeFirewallPolicyRequest class provides an interface for NetworkFirewall DescribeFirewallPolicy requests.
 *
 ...
 */
DescribeFirewallPolicyRequest::DescribeFirewallPolicyRequest(const DescribeFirewallPolicyRequest &other)
    : NetworkFirewallRequest(new DescribeFirewallPolicyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeFirewallPolicyRequest object.
 */
DescribeFirewallPolicyRequest::DescribeFirewallPolicyRequest()
    : NetworkFirewallRequest(new DescribeFirewallPolicyRequestPrivate(NetworkFirewallRequest::DescribeFirewallPolicyAction, this))
{
 ...
 * \reimp
 */
bool DescribeFirewallPolicyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeFirewallPolicyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeFirewallPolicyRequest::response(QNetworkReply * const reply) const
{
    return new DescribeFirewallPolicyResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::DescribeFirewallPolicyRequestPrivate
 * \brief The DescribeFirewallPolicyRequestPrivate class provides private implementation for DescribeFirewallPolicyRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a DescribeFirewallPolicyRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
DescribeFirewallPolicyRequestPrivate::DescribeFirewallPolicyRequestPrivate(
    const NetworkFirewallRequest::Action action, DescribeFirewallPolicyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeFirewallPolicyRequest
 * class' copy constructor.
 */
DescribeFirewallPolicyRequestPrivate::DescribeFirewallPolicyRequestPrivate(
    const DescribeFirewallPolicyRequestPrivate &other, DescribeFirewallPolicyRequest * const q)
