...
#include "associatesubnetsrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::AssociateSubnetsRequest
 * \brief The AssociateSubnetsRequest class provides an interface for NetworkFirewall AssociateSubnets requests.
 *
 ...
 *
 * \sa NetworkFirewallClient::associateSubnets
 */

/*!
 * Constructs a copy of \a other.
 */
AssociateSubnetsRequest::AssociateSubnetsRequest(const AssociateSubnetsRequest &other)
    : NetworkFirewallRequest(new AssociateSubnetsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AssociateSubnetsRequest object.
 */
AssociateSubnetsRequest::AssociateSubnetsRequest()
    : NetworkFirewallRequest(new AssociateSubnetsRequestPrivate(NetworkFirewallRequest::AssociateSubnetsAction, this))
{
 ...
 * \reimp
 */
bool AssociateSubnetsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AssociateSubnetsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AssociateSubnetsRequest::response(QNetworkReply * const reply) const
{
    return new AssociateSubnetsResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::AssociateSubnetsRequestPrivate
 * \brief The AssociateSubnetsRequestPrivate class provides private implementation for AssociateSubnetsRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a AssociateSubnetsRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
AssociateSubnetsRequestPrivate::AssociateSubnetsRequestPrivate(
    const NetworkFirewallRequest::Action action, AssociateSubnetsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AssociateSubnetsRequest
 * class' copy constructor.
 */
AssociateSubnetsRequestPrivate::AssociateSubnetsRequestPrivate(
    const AssociateSubnetsRequestPrivate &other, AssociateSubnetsRequest * const q)
