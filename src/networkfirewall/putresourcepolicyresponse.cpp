...
/*!
 * \class QtAws::NetworkFirewall::PutResourcePolicyResponse
 * \brief The PutResourcePolicyResponse class provides an interace for NetworkFirewall PutResourcePolicy responses.
 *
 ...
 *
 * \sa NetworkFirewallClient::putResourcePolicy
 */
...
PutResourcePolicyResponse::PutResourcePolicyResponse(
    ...
    : NetworkFirewallResponse(new PutResourcePolicyResponsePrivate(this), parent)
{
...
{
    return static_cast<const PutResourcePolicyRequest *>(NetworkFirewallResponse::request());
}

/*!
 * \reimp
 * Parses a successful NetworkFirewall PutResourcePolicy \a response.
 */
...
/*!
 * \class QtAws::NetworkFirewall::PutResourcePolicyResponsePrivate
...
PutResourcePolicyResponsePrivate::PutResourcePolicyResponsePrivate(
    PutResourcePolicyResponse * const q) : NetworkFirewallResponsePrivate(q)
{

}

/*!
 * Parses a NetworkFirewall PutResourcePolicy response element from \a xml.
 */
