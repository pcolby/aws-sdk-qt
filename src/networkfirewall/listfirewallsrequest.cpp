...
#include "listfirewallsrequest_p.h"
...
/*!
 * \class QtAws::NetworkFirewall::ListFirewallsRequest
 * \brief The ListFirewallsRequest class provides an interface for NetworkFirewall ListFirewalls requests.
 *
 ...
 */
ListFirewallsRequest::ListFirewallsRequest(const ListFirewallsRequest &other)
    : NetworkFirewallRequest(new ListFirewallsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListFirewallsRequest object.
 */
ListFirewallsRequest::ListFirewallsRequest()
    : NetworkFirewallRequest(new ListFirewallsRequestPrivate(NetworkFirewallRequest::ListFirewallsAction, this))
{
 ...
 * \reimp
 */
bool ListFirewallsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListFirewallsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListFirewallsRequest::response(QNetworkReply * const reply) const
{
    return new ListFirewallsResponse(*this, reply);
}

/*!
 * \class QtAws::NetworkFirewall::ListFirewallsRequestPrivate
 * \brief The ListFirewallsRequestPrivate class provides private implementation for ListFirewallsRequest.
 * \internal
 *
 * \inmodule QtAwsNetworkFirewall
 */
...
/*!
 * Constructs a ListFirewallsRequestPrivate object for NetworkFirewall \a action,
 * with public implementation \a q.
 */
ListFirewallsRequestPrivate::ListFirewallsRequestPrivate(
    const NetworkFirewallRequest::Action action, ListFirewallsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListFirewallsRequest
 * class' copy constructor.
 */
ListFirewallsRequestPrivate::ListFirewallsRequestPrivate(
    const ListFirewallsRequestPrivate &other, ListFirewallsRequest * const q)
