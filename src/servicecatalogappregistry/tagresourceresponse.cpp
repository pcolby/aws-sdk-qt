...
/*!
 * \class QtAws::ServiceCatalogAppRegistry::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for ServiceCatalogAppRegistry TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ServiceCatalogAppRegistryResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ServiceCatalogAppRegistry TagResource \a response.
 */
...
/*!
 * \class QtAws::ServiceCatalogAppRegistry::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ServiceCatalogAppRegistryResponsePrivate(q)
{

}

/*!
 * Parses a ServiceCatalogAppRegistry TagResource response element from \a xml.
 */
