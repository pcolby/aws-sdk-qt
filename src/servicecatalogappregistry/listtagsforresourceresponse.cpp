...
/*!
 * \class QtAws::ServiceCatalogAppRegistry::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for ServiceCatalogAppRegistry ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ServiceCatalogAppRegistryResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ServiceCatalogAppRegistry ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::ServiceCatalogAppRegistry::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ServiceCatalogAppRegistryResponsePrivate(q)
{

}

/*!
 * Parses a ServiceCatalogAppRegistry ListTagsForResource response element from \a xml.
 */
