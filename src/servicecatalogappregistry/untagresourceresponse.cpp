...
/*!
 * \class QtAws::ServiceCatalogAppRegistry::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for ServiceCatalogAppRegistry UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : ServiceCatalogAppRegistryResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ServiceCatalogAppRegistry UntagResource \a response.
 */
...
/*!
 * \class QtAws::ServiceCatalogAppRegistry::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : ServiceCatalogAppRegistryResponsePrivate(q)
{

}

/*!
 * Parses a ServiceCatalogAppRegistry UntagResource response element from \a xml.
 */
