...
class ListApplicationsRequestPrivate : public ServiceCatalogAppRegistryRequestPrivate {

public:
    ListApplicationsRequestPrivate(const ServiceCatalogAppRegistryRequest::Action action,
