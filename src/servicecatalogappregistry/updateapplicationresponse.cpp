...
/*!
 * \class QtAws::ServiceCatalogAppRegistry::UpdateApplicationResponse
 * \brief The UpdateApplicationResponse class provides an interace for ServiceCatalogAppRegistry UpdateApplication responses.
 *
...
UpdateApplicationResponse::UpdateApplicationResponse(
    ...
    : ServiceCatalogAppRegistryResponse(new UpdateApplicationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ServiceCatalogAppRegistry UpdateApplication \a response.
 */
...
/*!
 * \class QtAws::ServiceCatalogAppRegistry::UpdateApplicationResponsePrivate
...
UpdateApplicationResponsePrivate::UpdateApplicationResponsePrivate(
    UpdateApplicationResponse * const q) : ServiceCatalogAppRegistryResponsePrivate(q)
{

}

/*!
 * Parses a ServiceCatalogAppRegistry UpdateApplication response element from \a xml.
 */
