...
class QTAWS_EXPORT IoTJobsDataPlaneResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {
    Q_OBJECT

public:

    IoTJobsDataPlaneResponsePrivate(IoTJobsDataPlaneResponse * const q);
