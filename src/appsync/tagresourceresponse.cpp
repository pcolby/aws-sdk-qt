...
/*!
 * \class QtAws::AppSync::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for AppSync TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : AppSyncResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(AppSyncResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppSync TagResource \a response.
 */
...
/*!
 * \class QtAws::AppSync::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : AppSyncResponsePrivate(q)
{

}

/*!
 * Parses a AppSync TagResource response element from \a xml.
 */
