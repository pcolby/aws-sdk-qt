...
/*!
 * \class QtAws::AppSync::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for AppSync ListTagsForResource responses.
 *
 * \inmodule QtAwsAppSync
 *
 *  AWS AppSync provides API actions for creating and interacting with data sources using GraphQL from your
 *
 * \sa AppSyncClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : AppSyncResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(AppSyncResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppSync ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::AppSync::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : AppSyncResponsePrivate(q)
{

}

/*!
 * Parses a AppSync ListTagsForResource response element from \a xml.
 */
