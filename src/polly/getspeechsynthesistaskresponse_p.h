...
class QTAWS_EXPORT GetSpeechSynthesisTaskResponsePrivate : public PollyResponsePrivate {

public:

    GetSpeechSynthesisTaskResponsePrivate(GetSpeechSynthesisTaskResponse * const q);
