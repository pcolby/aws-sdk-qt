...
/*!
 * \class QtAws::ChimeSdkMediaPipelines::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for ChimeSdkMediaPipelines ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ChimeSdkMediaPipelinesResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ChimeSdkMediaPipelines ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::ChimeSdkMediaPipelines::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ChimeSdkMediaPipelinesResponsePrivate(q)
{

}

/*!
 * Parses a ChimeSdkMediaPipelines ListTagsForResource response element from \a xml.
 */
