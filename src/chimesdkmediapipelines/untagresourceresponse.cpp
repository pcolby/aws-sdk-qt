...
/*!
 * \class QtAws::ChimeSdkMediaPipelines::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for ChimeSdkMediaPipelines UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : ChimeSdkMediaPipelinesResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ChimeSdkMediaPipelines UntagResource \a response.
 */
...
/*!
 * \class QtAws::ChimeSdkMediaPipelines::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : ChimeSdkMediaPipelinesResponsePrivate(q)
{

}

/*!
 * Parses a ChimeSdkMediaPipelines UntagResource response element from \a xml.
 */
