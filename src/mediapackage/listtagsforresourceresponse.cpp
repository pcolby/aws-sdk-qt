...
/*!
 * \class QtAws::MediaPackage::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for MediaPackage ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : MediaPackageResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(MediaPackageResponse::request());
}

/*!
 * \reimp
 * Parses a successful MediaPackage ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::MediaPackage::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : MediaPackageResponsePrivate(q)
{

}

/*!
 * Parses a MediaPackage ListTagsForResource response element from \a xml.
 */
