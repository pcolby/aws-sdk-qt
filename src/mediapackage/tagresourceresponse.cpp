...
/*!
 * \class QtAws::MediaPackage::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for MediaPackage TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : MediaPackageResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(MediaPackageResponse::request());
}

/*!
 * \reimp
 * Parses a successful MediaPackage TagResource \a response.
 */
...
/*!
 * \class QtAws::MediaPackage::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : MediaPackageResponsePrivate(q)
{

}

/*!
 * Parses a MediaPackage TagResource response element from \a xml.
 */
