...
class QTAWS_EXPORT DeleteThingShadowResponsePrivate : public IoTDataPlaneResponsePrivate {

public:

    DeleteThingShadowResponsePrivate(DeleteThingShadowResponse * const q);
