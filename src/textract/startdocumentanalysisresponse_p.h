...
class QTAWS_EXPORT StartDocumentAnalysisResponsePrivate : public TextractResponsePrivate {

public:

    StartDocumentAnalysisResponsePrivate(StartDocumentAnalysisResponse * const q);
