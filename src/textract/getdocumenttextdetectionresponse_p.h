...
class QTAWS_EXPORT GetDocumentTextDetectionResponsePrivate : public TextractResponsePrivate {

public:

    GetDocumentTextDetectionResponsePrivate(GetDocumentTextDetectionResponse * const q);
