...
UntagResourceResponse::UntagResourceResponse(
    ...
    : EcrResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(EcrResponse::request());
}
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : EcrResponsePrivate(q)
{
