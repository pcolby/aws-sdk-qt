...
class QTAWS_EXPORT DescribeImageScanFindingsResponsePrivate : public EcrResponsePrivate {

public:

    DescribeImageScanFindingsResponsePrivate(DescribeImageScanFindingsResponse * const q);
