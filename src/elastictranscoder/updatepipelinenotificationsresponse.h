...
class QTAWS_EXPORT UpdatePipelineNotificationsResponse : public ElasticTranscoderResponse {
    Q_OBJECT
...
public:
    ...
    virtual const UpdatePipelineNotificationsRequest * request() const override;
