...
class QTAWSTRANSCRIBESTREAMINGSERVICE_EXPORT TranscribeStreamingServiceResponse : public QtAws::Core::AwsAbstractResponse {
    Q_OBJECT
...
protected:
    /// @cond internal
    TranscribeStreamingServiceResponsePrivate * const d_ptr; ///< Internal d-pointer.
