 ...
 * @param  q       Pointer to this object's public KinesisVideoArchivedMediaRequest instance.
 */
 ...
 * @internal
 *
 * @brief  Constructs a new KinesisVideoArchivedMediaRequestPrivate object from an existing one.
 *
