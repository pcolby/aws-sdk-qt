...
class QTAWS_EXPORT KinesisVideoArchivedMediaResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {
    Q_OBJECT

public:

    KinesisVideoArchivedMediaResponsePrivate(KinesisVideoArchivedMediaResponse * const q);
