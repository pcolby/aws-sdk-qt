...
/*!
 * \class QtAws::AuditManager::GetInsightsResponse
 * \brief The GetInsightsResponse class provides an interace for AuditManager GetInsights responses.
 *
...
GetInsightsResponse::GetInsightsResponse(
    ...
    : AuditManagerResponse(new GetInsightsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful AuditManager GetInsights \a response.
 */
...
/*!
 * \class QtAws::AuditManager::GetInsightsResponsePrivate
...
GetInsightsResponsePrivate::GetInsightsResponsePrivate(
    GetInsightsResponse * const q) : AuditManagerResponsePrivate(q)
{

}

/*!
 * Parses a AuditManager GetInsights response element from \a xml.
 */
