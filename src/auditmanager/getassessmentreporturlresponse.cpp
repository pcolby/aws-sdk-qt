...
#include "getassessmentreporturlresponse_p.h"
...
/*!
 * \class QtAws::AuditManager::GetAssessmentReportUrlResponse
 * \brief The GetAssessmentReportUrlResponse class provides an interace for AuditManager GetAssessmentReportUrl responses.
 *
...
/*!
 * Constructs a GetAssessmentReportUrlResponse object for \a reply to \a request, with parent \a parent.
 */
GetAssessmentReportUrlResponse::GetAssessmentReportUrlResponse(
        const GetAssessmentReportUrlRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AuditManagerResponse(new GetAssessmentReportUrlResponsePrivate(this), parent)
{
    setRequest(new GetAssessmentReportUrlRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful AuditManager GetAssessmentReportUrl \a response.
 */
void GetAssessmentReportUrlResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetAssessmentReportUrlResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AuditManager::GetAssessmentReportUrlResponsePrivate
 * \brief The GetAssessmentReportUrlResponsePrivate class provides private implementation for GetAssessmentReportUrlResponse.
 * \internal
 *
 * \inmodule QtAwsAuditManager
 */
...
/*!
 * Constructs a GetAssessmentReportUrlResponsePrivate object with public implementation \a q.
 */
GetAssessmentReportUrlResponsePrivate::GetAssessmentReportUrlResponsePrivate(
    GetAssessmentReportUrlResponse * const q) : AuditManagerResponsePrivate(q)
{

}

/*!
 * Parses a AuditManager GetAssessmentReportUrl response element from \a xml.
 */
void GetAssessmentReportUrlResponsePrivate::parseGetAssessmentReportUrlResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetAssessmentReportUrlResponse"));
    Q_UNUSED(xml) ///< @todo
}
