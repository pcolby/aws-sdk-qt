...
class QTAWS_EXPORT UpdateAssessmentControlResponsePrivate : public AuditManagerResponsePrivate {

public:

    UpdateAssessmentControlResponsePrivate(UpdateAssessmentControlResponse * const q);
