...
#include "getdelegationsrequest_p.h"
...
/*!
 * \class QtAws::AuditManager::GetDelegationsRequest
 * \brief The GetDelegationsRequest class provides an interface for AuditManager GetDelegations requests.
 *
 ...
 */
GetDelegationsRequest::GetDelegationsRequest(const GetDelegationsRequest &other)
    : AuditManagerRequest(new GetDelegationsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetDelegationsRequest object.
 */
GetDelegationsRequest::GetDelegationsRequest()
    : AuditManagerRequest(new GetDelegationsRequestPrivate(AuditManagerRequest::GetDelegationsAction, this))
{
 ...
 * \reimp
 */
bool GetDelegationsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetDelegationsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetDelegationsRequest::response(QNetworkReply * const reply) const
{
    return new GetDelegationsResponse(*this, reply);
}

/*!
 * \class QtAws::AuditManager::GetDelegationsRequestPrivate
 * \brief The GetDelegationsRequestPrivate class provides private implementation for GetDelegationsRequest.
 * \internal
 *
 * \inmodule QtAwsAuditManager
 */
...
/*!
 * Constructs a GetDelegationsRequestPrivate object for AuditManager \a action,
 * with public implementation \a q.
 */
GetDelegationsRequestPrivate::GetDelegationsRequestPrivate(
    const AuditManagerRequest::Action action, GetDelegationsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetDelegationsRequest
 * class' copy constructor.
 */
GetDelegationsRequestPrivate::GetDelegationsRequestPrivate(
    const GetDelegationsRequestPrivate &other, GetDelegationsRequest * const q)
