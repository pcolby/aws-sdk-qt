...
/*!
 * \class QtAws::AuditManager::ListNotificationsRequest
 * \brief The ListNotificationsRequest class provides an interface for AuditManager ListNotifications requests.
 *
...
ListNotificationsRequest::ListNotificationsRequest(const ListNotificationsRequest &other)
    : AuditManagerRequest(new ListNotificationsRequestPrivate(*other.d_func(), this))
{
...
ListNotificationsRequest::ListNotificationsRequest()
    : AuditManagerRequest(new ListNotificationsRequestPrivate(AuditManagerRequest::ListNotificationsAction, this))
{
...
/*!
 * \class QtAws::AuditManager::ListNotificationsRequestPrivate
...
/*!
 * Constructs a ListNotificationsRequestPrivate object for AuditManager \a action,
 * with public implementation \a q.
 */
ListNotificationsRequestPrivate::ListNotificationsRequestPrivate(
    const AuditManagerRequest::Action action, ListNotificationsRequest * const q)
