...
#include "listassessmentframeworksresponse_p.h"
...
/*!
 * \class QtAws::AuditManager::ListAssessmentFrameworksResponse
 * \brief The ListAssessmentFrameworksResponse class provides an interace for AuditManager ListAssessmentFrameworks responses.
 *
...
/*!
 * Constructs a ListAssessmentFrameworksResponse object for \a reply to \a request, with parent \a parent.
 */
ListAssessmentFrameworksResponse::ListAssessmentFrameworksResponse(
        const ListAssessmentFrameworksRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AuditManagerResponse(new ListAssessmentFrameworksResponsePrivate(this), parent)
{
    setRequest(new ListAssessmentFrameworksRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful AuditManager ListAssessmentFrameworks \a response.
 */
void ListAssessmentFrameworksResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListAssessmentFrameworksResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AuditManager::ListAssessmentFrameworksResponsePrivate
 * \brief The ListAssessmentFrameworksResponsePrivate class provides private implementation for ListAssessmentFrameworksResponse.
 * \internal
 *
 * \inmodule QtAwsAuditManager
 */
...
/*!
 * Constructs a ListAssessmentFrameworksResponsePrivate object with public implementation \a q.
 */
ListAssessmentFrameworksResponsePrivate::ListAssessmentFrameworksResponsePrivate(
    ListAssessmentFrameworksResponse * const q) : AuditManagerResponsePrivate(q)
{

}

/*!
 * Parses a AuditManager ListAssessmentFrameworks response element from \a xml.
 */
void ListAssessmentFrameworksResponsePrivate::parseListAssessmentFrameworksResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListAssessmentFrameworksResponse"));
    Q_UNUSED(xml) ///< @todo
}
