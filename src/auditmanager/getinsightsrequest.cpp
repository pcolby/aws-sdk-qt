...
/*!
 * \class QtAws::AuditManager::GetInsightsRequest
 * \brief The GetInsightsRequest class provides an interface for AuditManager GetInsights requests.
 *
 ...
 *
 * \sa AuditManagerClient::getInsights
 */
...
GetInsightsRequest::GetInsightsRequest(const GetInsightsRequest &other)
    : AuditManagerRequest(new GetInsightsRequestPrivate(*other.d_func(), this))
{
...
GetInsightsRequest::GetInsightsRequest()
    : AuditManagerRequest(new GetInsightsRequestPrivate(AuditManagerRequest::GetInsightsAction, this))
{
...
/*!
 * \class QtAws::AuditManager::GetInsightsRequestPrivate
...
/*!
 * Constructs a GetInsightsRequestPrivate object for AuditManager \a action,
 * with public implementation \a q.
 */
GetInsightsRequestPrivate::GetInsightsRequestPrivate(
    const AuditManagerRequest::Action action, GetInsightsRequest * const q)
