...
#include "registeraccountresponse_p.h"
...
/*!
 * \class QtAws::AuditManager::RegisterAccountResponse
 * \brief The RegisterAccountResponse class provides an interace for AuditManager RegisterAccount responses.
 *
...
/*!
 * Constructs a RegisterAccountResponse object for \a reply to \a request, with parent \a parent.
 */
RegisterAccountResponse::RegisterAccountResponse(
        const RegisterAccountRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AuditManagerResponse(new RegisterAccountResponsePrivate(this), parent)
{
    setRequest(new RegisterAccountRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful AuditManager RegisterAccount \a response.
 */
void RegisterAccountResponse::parseSuccess(QIODevice &response)
{
    //Q_D(RegisterAccountResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AuditManager::RegisterAccountResponsePrivate
 * \brief The RegisterAccountResponsePrivate class provides private implementation for RegisterAccountResponse.
 * \internal
 *
 * \inmodule QtAwsAuditManager
 */
...
/*!
 * Constructs a RegisterAccountResponsePrivate object with public implementation \a q.
 */
RegisterAccountResponsePrivate::RegisterAccountResponsePrivate(
    RegisterAccountResponse * const q) : AuditManagerResponsePrivate(q)
{

}

/*!
 * Parses a AuditManager RegisterAccount response element from \a xml.
 */
void RegisterAccountResponsePrivate::parseRegisterAccountResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("RegisterAccountResponse"));
    Q_UNUSED(xml) ///< @todo
}
