...
class QTAWS_EXPORT DeleteAssessmentReportResponsePrivate : public AuditManagerResponsePrivate {

public:

    DeleteAssessmentReportResponsePrivate(DeleteAssessmentReportResponse * const q);
