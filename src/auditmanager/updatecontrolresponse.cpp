...
#include "updatecontrolresponse_p.h"
...
/*!
 * \class QtAws::AuditManager::UpdateControlResponse
 * \brief The UpdateControlResponse class provides an interace for AuditManager UpdateControl responses.
 *
...
/*!
 * Constructs a UpdateControlResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateControlResponse::UpdateControlResponse(
        const UpdateControlRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AuditManagerResponse(new UpdateControlResponsePrivate(this), parent)
{
    setRequest(new UpdateControlRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful AuditManager UpdateControl \a response.
 */
void UpdateControlResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateControlResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AuditManager::UpdateControlResponsePrivate
 * \brief The UpdateControlResponsePrivate class provides private implementation for UpdateControlResponse.
 * \internal
 *
 * \inmodule QtAwsAuditManager
 */
...
/*!
 * Constructs a UpdateControlResponsePrivate object with public implementation \a q.
 */
UpdateControlResponsePrivate::UpdateControlResponsePrivate(
    UpdateControlResponse * const q) : AuditManagerResponsePrivate(q)
{

}

/*!
 * Parses a AuditManager UpdateControl response element from \a xml.
 */
void UpdateControlResponsePrivate::parseUpdateControlResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateControlResponse"));
    Q_UNUSED(xml) ///< @todo
}
