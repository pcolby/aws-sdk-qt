...
/*!
 * \class QtAws::AuditManager::GetAssessmentResponse
 * \brief The GetAssessmentResponse class provides an interace for AuditManager GetAssessment responses.
 *
...
GetAssessmentResponse::GetAssessmentResponse(
    ...
    : AuditManagerResponse(new GetAssessmentResponsePrivate(this), parent)
{
...
{
    return static_cast<const GetAssessmentRequest *>(AuditManagerResponse::request());
}

/*!
 * \reimp
 * Parses a successful AuditManager GetAssessment \a response.
 */
...
/*!
 * \class QtAws::AuditManager::GetAssessmentResponsePrivate
...
GetAssessmentResponsePrivate::GetAssessmentResponsePrivate(
    GetAssessmentResponse * const q) : AuditManagerResponsePrivate(q)
{

}

/*!
 * Parses a AuditManager GetAssessment response element from \a xml.
 */
