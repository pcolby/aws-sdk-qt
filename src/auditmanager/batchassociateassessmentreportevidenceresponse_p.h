...
class QTAWS_EXPORT BatchAssociateAssessmentReportEvidenceResponsePrivate : public AuditManagerResponsePrivate {

public:

    BatchAssociateAssessmentReportEvidenceResponsePrivate(BatchAssociateAssessmentReportEvidenceResponse * const q);
