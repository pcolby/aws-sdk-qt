...
class QTAWS_EXPORT CreateAssessmentFrameworkResponsePrivate : public AuditManagerResponsePrivate {

public:

    CreateAssessmentFrameworkResponsePrivate(CreateAssessmentFrameworkResponse * const q);
