...
class QTAWS_EXPORT GetEvidenceFoldersByAssessmentControlResponsePrivate : public AuditManagerResponsePrivate {

public:

    GetEvidenceFoldersByAssessmentControlResponsePrivate(GetEvidenceFoldersByAssessmentControlResponse * const q);
