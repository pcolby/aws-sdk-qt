...
#include "getcontrolresponse_p.h"
...
/*!
 * \class QtAws::AuditManager::GetControlResponse
 * \brief The GetControlResponse class provides an interace for AuditManager GetControl responses.
 *
...
/*!
 * Constructs a GetControlResponse object for \a reply to \a request, with parent \a parent.
 */
GetControlResponse::GetControlResponse(
        const GetControlRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : AuditManagerResponse(new GetControlResponsePrivate(this), parent)
{
    setRequest(new GetControlRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful AuditManager GetControl \a response.
 */
void GetControlResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetControlResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::AuditManager::GetControlResponsePrivate
 * \brief The GetControlResponsePrivate class provides private implementation for GetControlResponse.
 * \internal
 *
 * \inmodule QtAwsAuditManager
 */
...
/*!
 * Constructs a GetControlResponsePrivate object with public implementation \a q.
 */
GetControlResponsePrivate::GetControlResponsePrivate(
    GetControlResponse * const q) : AuditManagerResponsePrivate(q)
{

}

/*!
 * Parses a AuditManager GetControl response element from \a xml.
 */
void GetControlResponsePrivate::parseGetControlResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetControlResponse"));
    Q_UNUSED(xml) ///< @todo
}
