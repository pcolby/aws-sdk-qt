...
/*!
 * \class QtAws::AuditManager::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for AuditManager TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : AuditManagerResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(AuditManagerResponse::request());
}

/*!
 * \reimp
 * Parses a successful AuditManager TagResource \a response.
 */
...
/*!
 * \class QtAws::AuditManager::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : AuditManagerResponsePrivate(q)
{

}

/*!
 * Parses a AuditManager TagResource response element from \a xml.
 */
