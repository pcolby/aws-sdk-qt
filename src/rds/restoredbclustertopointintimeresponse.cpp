 ...
 *
 * \brief The RestoreDBClusterToPointInTimeResponse class encapsulates RDS RestoreDBClusterToPointInTime responses.
 *
 * \ingroup RDS
 *
 ...
 *
 * \sa RDSClient::restoreDBClusterToPointInTime
 */
