...
class QTAWS_EXPORT DescribeDBProxyTargetsResponsePrivate : public RdsResponsePrivate {

public:

    DescribeDBProxyTargetsResponsePrivate(DescribeDBProxyTargetsResponse * const q);
