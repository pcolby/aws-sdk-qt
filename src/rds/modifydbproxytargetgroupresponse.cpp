...
#include "modifydbproxytargetgroupresponse_p.h"
...
/*!
 * Constructs a ModifyDBProxyTargetGroupResponse object for \a reply to \a request, with parent \a parent.
 */
ModifyDBProxyTargetGroupResponse::ModifyDBProxyTargetGroupResponse(
        const ModifyDBProxyTargetGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new ModifyDBProxyTargetGroupResponsePrivate(this), parent)
{
    setRequest(new ModifyDBProxyTargetGroupRequest(request));
    setReply(reply);
}
...
{
    //Q_D(ModifyDBProxyTargetGroupResponse);
...
/*!
 * Constructs a ModifyDBProxyTargetGroupResponsePrivate object with public implementation \a q.
 */
ModifyDBProxyTargetGroupResponsePrivate::ModifyDBProxyTargetGroupResponsePrivate(
    ModifyDBProxyTargetGroupResponse * const q) : RdsResponsePrivate(q)
{
...
{
    Q_ASSERT(xml.name() == QLatin1String("ModifyDBProxyTargetGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
