...
#include "deletedbproxyresponse_p.h"
...
/*!
 * \class QtAws::Rds::DeleteDBProxyResponse
 * \brief The DeleteDBProxyResponse class provides an interace for Rds DeleteDBProxy responses.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::deleteDBProxy
 */

/*!
 * Constructs a DeleteDBProxyResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteDBProxyResponse::DeleteDBProxyResponse(
        const DeleteDBProxyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new DeleteDBProxyResponsePrivate(this), parent)
{
    setRequest(new DeleteDBProxyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Rds DeleteDBProxy \a response.
 */
void DeleteDBProxyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteDBProxyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rds::DeleteDBProxyResponsePrivate
 * \brief The DeleteDBProxyResponsePrivate class provides private implementation for DeleteDBProxyResponse.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a DeleteDBProxyResponsePrivate object with public implementation \a q.
 */
DeleteDBProxyResponsePrivate::DeleteDBProxyResponsePrivate(
    DeleteDBProxyResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a Rds DeleteDBProxy response element from \a xml.
 */
void DeleteDBProxyResponsePrivate::parseDeleteDBProxyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteDBProxyResponse"));
    Q_UNUSED(xml) ///< @todo
}
