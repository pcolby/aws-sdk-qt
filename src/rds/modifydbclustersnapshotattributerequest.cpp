...
/*!
 * \class QtAws::RDS::ModifyDBClusterSnapshotAttributeRequestPrivate
...
/*!
 *
 * Constructs a ModifyDBClusterSnapshotAttributeRequestPrivate object for RDS \a action with,
