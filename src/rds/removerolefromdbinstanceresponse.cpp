...
#include "removerolefromdbinstanceresponse_p.h"
...
/*!
 * Constructs a RemoveRoleFromDBInstanceResponse object for \a reply to \a request, with parent \a parent.
 */
RemoveRoleFromDBInstanceResponse::RemoveRoleFromDBInstanceResponse(
        const RemoveRoleFromDBInstanceRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new RemoveRoleFromDBInstanceResponsePrivate(this), parent)
{
    setRequest(new RemoveRoleFromDBInstanceRequest(request));
    setReply(reply);
}
...
{
    //Q_D(RemoveRoleFromDBInstanceResponse);
...
/*!
 * Constructs a RemoveRoleFromDBInstanceResponsePrivate object with public implementation \a q.
 */
RemoveRoleFromDBInstanceResponsePrivate::RemoveRoleFromDBInstanceResponsePrivate(
    RemoveRoleFromDBInstanceResponse * const q) : RdsResponsePrivate(q)
{
...
{
    Q_ASSERT(xml.name() == QLatin1String("RemoveRoleFromDBInstanceResponse"));
    Q_UNUSED(xml) ///< @todo
}
