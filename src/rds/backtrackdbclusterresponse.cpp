...
#include "backtrackdbclusterresponse_p.h"
...
/*!
 * \class QtAws::RDS::BacktrackDBClusterResponse
 * \brief The BacktrackDBClusterResponse class provides an interace for RDS BacktrackDBCluster responses.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::backtrackDBCluster
 */

/*!
 * Constructs a BacktrackDBClusterResponse object for \a reply to \a request, with parent \a parent.
 */
BacktrackDBClusterResponse::BacktrackDBClusterResponse(
        const BacktrackDBClusterRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new BacktrackDBClusterResponsePrivate(this), parent)
{
    setRequest(new BacktrackDBClusterRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const BacktrackDBClusterRequest * BacktrackDBClusterResponse::request() const
{
    Q_D(const BacktrackDBClusterResponse);
    return static_cast<const BacktrackDBClusterRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful RDS BacktrackDBCluster \a response.
 */
void BacktrackDBClusterResponse::parseSuccess(QIODevice &response)
{
    //Q_D(BacktrackDBClusterResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::RDS::BacktrackDBClusterResponsePrivate
 * \brief The BacktrackDBClusterResponsePrivate class provides private implementation for BacktrackDBClusterResponse.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a BacktrackDBClusterResponsePrivate object with public implementation \a q.
 */
BacktrackDBClusterResponsePrivate::BacktrackDBClusterResponsePrivate(
    BacktrackDBClusterResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS BacktrackDBCluster response element from \a xml.
 */
