...
/*!
 * \class QtAws::Rds::StartDBClusterRequest
 * \brief The StartDBClusterRequest class provides an interface for Rds StartDBCluster requests.
 *
 * \inmodule QtAwsRds
 *
...
StartDBClusterRequest::StartDBClusterRequest(const StartDBClusterRequest &other)
    : RdsRequest(new StartDBClusterRequestPrivate(*other.d_func(), this))
{
...
StartDBClusterRequest::StartDBClusterRequest()
    : RdsRequest(new StartDBClusterRequestPrivate(RdsRequest::StartDBClusterAction, this))
{
...
/*!
 * \class QtAws::Rds::StartDBClusterRequestPrivate
...
/*!
 * Constructs a StartDBClusterRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
StartDBClusterRequestPrivate::StartDBClusterRequestPrivate(
    const RdsRequest::Action action, StartDBClusterRequest * const q)
