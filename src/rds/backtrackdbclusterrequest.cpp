...
#include "backtrackdbclusterrequest_p.h"
 ...
 */
BacktrackDBClusterRequest::BacktrackDBClusterRequest(const BacktrackDBClusterRequest &other)
    : RdsRequest(new BacktrackDBClusterRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a BacktrackDBClusterRequest object.
 */
BacktrackDBClusterRequest::BacktrackDBClusterRequest()
    : RdsRequest(new BacktrackDBClusterRequestPrivate(RdsRequest::BacktrackDBClusterAction, this))
{
 ...
 * \reimp
 */
bool BacktrackDBClusterRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BacktrackDBClusterResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BacktrackDBClusterRequest::response(QNetworkReply * const reply) const
{
    return new BacktrackDBClusterResponse(*this, reply);
}
...
/*!
 * Constructs a BacktrackDBClusterRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
BacktrackDBClusterRequestPrivate::BacktrackDBClusterRequestPrivate(
    const RdsRequest::Action action, BacktrackDBClusterRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the BacktrackDBClusterRequest
 * class' copy constructor.
 */
BacktrackDBClusterRequestPrivate::BacktrackDBClusterRequestPrivate(
    const BacktrackDBClusterRequestPrivate &other, BacktrackDBClusterRequest * const q)
