...
StopDBClusterRequest::StopDBClusterRequest(const StopDBClusterRequest &other)
    : RdsRequest(new StopDBClusterRequestPrivate(*other.d_func(), this))
{
...
StopDBClusterRequest::StopDBClusterRequest()
    : RdsRequest(new StopDBClusterRequestPrivate(RdsRequest::StopDBClusterAction, this))
{
...
/*!
 * Constructs a StopDBClusterRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
StopDBClusterRequestPrivate::StopDBClusterRequestPrivate(
    const RdsRequest::Action action, StopDBClusterRequest * const q)
