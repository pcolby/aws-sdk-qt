...
#include "deleteinstallationmediaresponse_p.h"
...
/*!
 * \class QtAws::RDS::DeleteInstallationMediaResponse
 * \brief The DeleteInstallationMediaResponse class provides an interace for RDS DeleteInstallationMedia responses.
 *
 * \inmodule QtAwsRDS
 *
...
/*!
 * Constructs a DeleteInstallationMediaResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteInstallationMediaResponse::DeleteInstallationMediaResponse(
        const DeleteInstallationMediaRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new DeleteInstallationMediaResponsePrivate(this), parent)
{
    setRequest(new DeleteInstallationMediaRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful RDS DeleteInstallationMedia \a response.
 */
void DeleteInstallationMediaResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteInstallationMediaResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::RDS::DeleteInstallationMediaResponsePrivate
 * \brief The DeleteInstallationMediaResponsePrivate class provides private implementation for DeleteInstallationMediaResponse.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a DeleteInstallationMediaResponsePrivate object with public implementation \a q.
 */
DeleteInstallationMediaResponsePrivate::DeleteInstallationMediaResponsePrivate(
    DeleteInstallationMediaResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS DeleteInstallationMedia response element from \a xml.
 */
void DeleteInstallationMediaResponsePrivate::parseDeleteInstallationMediaResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteInstallationMediaResponse"));
    Q_UNUSED(xml) ///< @todo
}
