...
/*!
 * \class QtAws::Rds::FailoverGlobalClusterRequest
 * \brief The FailoverGlobalClusterRequest class provides an interface for Rds FailoverGlobalCluster requests.
 *
 * \inmodule QtAwsRds
 *
...
FailoverGlobalClusterRequest::FailoverGlobalClusterRequest(const FailoverGlobalClusterRequest &other)
    : RdsRequest(new FailoverGlobalClusterRequestPrivate(*other.d_func(), this))
{
...
FailoverGlobalClusterRequest::FailoverGlobalClusterRequest()
    : RdsRequest(new FailoverGlobalClusterRequestPrivate(RdsRequest::FailoverGlobalClusterAction, this))
{
...
/*!
 * \class QtAws::Rds::FailoverGlobalClusterRequestPrivate
...
/*!
 * Constructs a FailoverGlobalClusterRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
FailoverGlobalClusterRequestPrivate::FailoverGlobalClusterRequestPrivate(
    const RdsRequest::Action action, FailoverGlobalClusterRequest * const q)
