...
#include "rebootdbclusterresponse_p.h"
...
/*!
 * \class QtAws::Rds::RebootDBClusterResponse
 * \brief The RebootDBClusterResponse class provides an interace for Rds RebootDBCluster responses.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::rebootDBCluster
 */

/*!
 * Constructs a RebootDBClusterResponse object for \a reply to \a request, with parent \a parent.
 */
RebootDBClusterResponse::RebootDBClusterResponse(
        const RebootDBClusterRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new RebootDBClusterResponsePrivate(this), parent)
{
    setRequest(new RebootDBClusterRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const RebootDBClusterRequest * RebootDBClusterResponse::request() const
{
    Q_D(const RebootDBClusterResponse);
    return static_cast<const RebootDBClusterRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Rds RebootDBCluster \a response.
 */
void RebootDBClusterResponse::parseSuccess(QIODevice &response)
{
    //Q_D(RebootDBClusterResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rds::RebootDBClusterResponsePrivate
 * \brief The RebootDBClusterResponsePrivate class provides private implementation for RebootDBClusterResponse.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a RebootDBClusterResponsePrivate object with public implementation \a q.
 */
RebootDBClusterResponsePrivate::RebootDBClusterResponsePrivate(
    RebootDBClusterResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a Rds RebootDBCluster response element from \a xml.
 */
void RebootDBClusterResponsePrivate::parseRebootDBClusterResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("RebootDBClusterResponse"));
    Q_UNUSED(xml) ///< @todo
}
