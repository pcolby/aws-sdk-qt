...
DescribeDBClusterEndpointsResponse::DescribeDBClusterEndpointsResponse(
    ...
    : RdsResponse(new DescribeDBClusterEndpointsResponsePrivate(this), parent)
{
...
{
    return static_cast<const DescribeDBClusterEndpointsRequest *>(RdsResponse::request());
}
...
DescribeDBClusterEndpointsResponsePrivate::DescribeDBClusterEndpointsResponsePrivate(
    DescribeDBClusterEndpointsResponse * const q) : RdsResponsePrivate(q)
{
