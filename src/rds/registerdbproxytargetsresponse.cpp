...
#include "registerdbproxytargetsresponse_p.h"
...
/*!
 * \class QtAws::RDS::RegisterDBProxyTargetsResponse
 * \brief The RegisterDBProxyTargetsResponse class provides an interace for RDS RegisterDBProxyTargets responses.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::registerDBProxyTargets
 */

/*!
 * Constructs a RegisterDBProxyTargetsResponse object for \a reply to \a request, with parent \a parent.
 */
RegisterDBProxyTargetsResponse::RegisterDBProxyTargetsResponse(
        const RegisterDBProxyTargetsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new RegisterDBProxyTargetsResponsePrivate(this), parent)
{
    setRequest(new RegisterDBProxyTargetsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful RDS RegisterDBProxyTargets \a response.
 */
void RegisterDBProxyTargetsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(RegisterDBProxyTargetsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::RDS::RegisterDBProxyTargetsResponsePrivate
 * \brief The RegisterDBProxyTargetsResponsePrivate class provides private implementation for RegisterDBProxyTargetsResponse.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a RegisterDBProxyTargetsResponsePrivate object with public implementation \a q.
 */
RegisterDBProxyTargetsResponsePrivate::RegisterDBProxyTargetsResponsePrivate(
    RegisterDBProxyTargetsResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS RegisterDBProxyTargets response element from \a xml.
 */
void RegisterDBProxyTargetsResponsePrivate::parseRegisterDBProxyTargetsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("RegisterDBProxyTargetsResponse"));
    Q_UNUSED(xml) ///< @todo
}
