...
#include "createcustomavailabilityzoneresponse_p.h"
...
/*!
 * \class QtAws::RDS::CreateCustomAvailabilityZoneResponse
 * \brief The CreateCustomAvailabilityZoneResponse class provides an interace for RDS CreateCustomAvailabilityZone responses.
 *
 * \inmodule QtAwsRDS
 *
...
/*!
 * Constructs a CreateCustomAvailabilityZoneResponse object for \a reply to \a request, with parent \a parent.
 */
CreateCustomAvailabilityZoneResponse::CreateCustomAvailabilityZoneResponse(
        const CreateCustomAvailabilityZoneRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new CreateCustomAvailabilityZoneResponsePrivate(this), parent)
{
    setRequest(new CreateCustomAvailabilityZoneRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful RDS CreateCustomAvailabilityZone \a response.
 */
void CreateCustomAvailabilityZoneResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateCustomAvailabilityZoneResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::RDS::CreateCustomAvailabilityZoneResponsePrivate
 * \brief The CreateCustomAvailabilityZoneResponsePrivate class provides private implementation for CreateCustomAvailabilityZoneResponse.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a CreateCustomAvailabilityZoneResponsePrivate object with public implementation \a q.
 */
CreateCustomAvailabilityZoneResponsePrivate::CreateCustomAvailabilityZoneResponsePrivate(
    CreateCustomAvailabilityZoneResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS CreateCustomAvailabilityZone response element from \a xml.
 */
void CreateCustomAvailabilityZoneResponsePrivate::parseCreateCustomAvailabilityZoneResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateCustomAvailabilityZoneResponse"));
    Q_UNUSED(xml) ///< @todo
}
