...
#include "describedbinstanceautomatedbackupsresponse_p.h"
...
/*!
 * \class QtAws::RDS::DescribeDBInstanceAutomatedBackupsResponse
 * \brief The DescribeDBInstanceAutomatedBackupsResponse class provides an interace for RDS DescribeDBInstanceAutomatedBackups responses.
 *
 * \inmodule QtAwsRDS
 *
...
/*!
 * Constructs a DescribeDBInstanceAutomatedBackupsResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeDBInstanceAutomatedBackupsResponse::DescribeDBInstanceAutomatedBackupsResponse(
        const DescribeDBInstanceAutomatedBackupsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new DescribeDBInstanceAutomatedBackupsResponsePrivate(this), parent)
{
    setRequest(new DescribeDBInstanceAutomatedBackupsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful RDS DescribeDBInstanceAutomatedBackups \a response.
 */
void DescribeDBInstanceAutomatedBackupsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeDBInstanceAutomatedBackupsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::RDS::DescribeDBInstanceAutomatedBackupsResponsePrivate
 * \brief The DescribeDBInstanceAutomatedBackupsResponsePrivate class provides private implementation for DescribeDBInstanceAutomatedBackupsResponse.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a DescribeDBInstanceAutomatedBackupsResponsePrivate object with public implementation \a q.
 */
DescribeDBInstanceAutomatedBackupsResponsePrivate::DescribeDBInstanceAutomatedBackupsResponsePrivate(
    DescribeDBInstanceAutomatedBackupsResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS DescribeDBInstanceAutomatedBackups response element from \a xml.
 */
void DescribeDBInstanceAutomatedBackupsResponsePrivate::parseDescribeDBInstanceAutomatedBackupsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeDBInstanceAutomatedBackupsResponse"));
    Q_UNUSED(xml) ///< @todo
}
