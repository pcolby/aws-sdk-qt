...
/*!
 * \class QtAws::Rds::DescribeExportTasksRequest
 * \brief The DescribeExportTasksRequest class provides an interface for Rds DescribeExportTasks requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::describeExportTasks
 */
...
DescribeExportTasksRequest::DescribeExportTasksRequest(const DescribeExportTasksRequest &other)
    : RdsRequest(new DescribeExportTasksRequestPrivate(*other.d_func(), this))
{
...
DescribeExportTasksRequest::DescribeExportTasksRequest()
    : RdsRequest(new DescribeExportTasksRequestPrivate(RdsRequest::DescribeExportTasksAction, this))
{
...
/*!
 * \class QtAws::Rds::DescribeExportTasksRequestPrivate
...
/*!
 * Constructs a DescribeExportTasksRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DescribeExportTasksRequestPrivate::DescribeExportTasksRequestPrivate(
    const RdsRequest::Action action, DescribeExportTasksRequest * const q)
