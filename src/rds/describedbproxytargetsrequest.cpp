...
#include "describedbproxytargetsrequest_p.h"
...
/*!
 * \class QtAws::Rds::DescribeDBProxyTargetsRequest
 * \brief The DescribeDBProxyTargetsRequest class provides an interface for Rds DescribeDBProxyTargets requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 */
DescribeDBProxyTargetsRequest::DescribeDBProxyTargetsRequest(const DescribeDBProxyTargetsRequest &other)
    : RdsRequest(new DescribeDBProxyTargetsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeDBProxyTargetsRequest object.
 */
DescribeDBProxyTargetsRequest::DescribeDBProxyTargetsRequest()
    : RdsRequest(new DescribeDBProxyTargetsRequestPrivate(RdsRequest::DescribeDBProxyTargetsAction, this))
{
 ...
 * \reimp
 */
bool DescribeDBProxyTargetsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeDBProxyTargetsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeDBProxyTargetsRequest::response(QNetworkReply * const reply) const
{
    return new DescribeDBProxyTargetsResponse(*this, reply);
}

/*!
 * \class QtAws::Rds::DescribeDBProxyTargetsRequestPrivate
 * \brief The DescribeDBProxyTargetsRequestPrivate class provides private implementation for DescribeDBProxyTargetsRequest.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a DescribeDBProxyTargetsRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DescribeDBProxyTargetsRequestPrivate::DescribeDBProxyTargetsRequestPrivate(
    const RdsRequest::Action action, DescribeDBProxyTargetsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeDBProxyTargetsRequest
 * class' copy constructor.
 */
DescribeDBProxyTargetsRequestPrivate::DescribeDBProxyTargetsRequestPrivate(
    const DescribeDBProxyTargetsRequestPrivate &other, DescribeDBProxyTargetsRequest * const q)
