...
/*!
 * \class QtAws::Rds::CreateGlobalClusterRequest
 * \brief The CreateGlobalClusterRequest class provides an interface for Rds CreateGlobalCluster requests.
 *
 * \inmodule QtAwsRds
 *
...
CreateGlobalClusterRequest::CreateGlobalClusterRequest(const CreateGlobalClusterRequest &other)
    : RdsRequest(new CreateGlobalClusterRequestPrivate(*other.d_func(), this))
{
...
CreateGlobalClusterRequest::CreateGlobalClusterRequest()
    : RdsRequest(new CreateGlobalClusterRequestPrivate(RdsRequest::CreateGlobalClusterAction, this))
{
...
/*!
 * \class QtAws::Rds::CreateGlobalClusterRequestPrivate
...
/*!
 * Constructs a CreateGlobalClusterRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
CreateGlobalClusterRequestPrivate::CreateGlobalClusterRequestPrivate(
    const RdsRequest::Action action, CreateGlobalClusterRequest * const q)
