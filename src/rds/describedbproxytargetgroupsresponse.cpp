...
#include "describedbproxytargetgroupsresponse_p.h"
...
/*!
 * \class QtAws::RDS::DescribeDBProxyTargetGroupsResponse
 * \brief The DescribeDBProxyTargetGroupsResponse class provides an interace for RDS DescribeDBProxyTargetGroups responses.
 *
 * \inmodule QtAwsRDS
 *
...
/*!
 * Constructs a DescribeDBProxyTargetGroupsResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeDBProxyTargetGroupsResponse::DescribeDBProxyTargetGroupsResponse(
        const DescribeDBProxyTargetGroupsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new DescribeDBProxyTargetGroupsResponsePrivate(this), parent)
{
    setRequest(new DescribeDBProxyTargetGroupsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful RDS DescribeDBProxyTargetGroups \a response.
 */
void DescribeDBProxyTargetGroupsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeDBProxyTargetGroupsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::RDS::DescribeDBProxyTargetGroupsResponsePrivate
 * \brief The DescribeDBProxyTargetGroupsResponsePrivate class provides private implementation for DescribeDBProxyTargetGroupsResponse.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a DescribeDBProxyTargetGroupsResponsePrivate object with public implementation \a q.
 */
DescribeDBProxyTargetGroupsResponsePrivate::DescribeDBProxyTargetGroupsResponsePrivate(
    DescribeDBProxyTargetGroupsResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS DescribeDBProxyTargetGroups response element from \a xml.
 */
void DescribeDBProxyTargetGroupsResponsePrivate::parseDescribeDBProxyTargetGroupsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeDBProxyTargetGroupsResponse"));
    Q_UNUSED(xml) ///< @todo
}
