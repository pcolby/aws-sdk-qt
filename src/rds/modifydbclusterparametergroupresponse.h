...
class QTAWS_EXPORT ModifyDBClusterParameterGroupResponse : public ModifyDBClusterParameterGroupResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ModifyDBClusterParameterGroupRequest * request() const;
