 ...
 *
 * \brief The DescribeDBClusterSnapshotAttributesResponse class encapsulates RDS DescribeDBClusterSnapshotAttributes responses.
 *
 * \ingroup RDS
 *
 ...
 *
 * \sa RDSClient::describeDBClusterSnapshotAttributes
 */
