...
#include "deregisterdbproxytargetsrequest_p.h"
...
/*!
 * \class QtAws::Rds::DeregisterDBProxyTargetsRequest
 * \brief The DeregisterDBProxyTargetsRequest class provides an interface for Rds DeregisterDBProxyTargets requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::deregisterDBProxyTargets
 */

/*!
 * Constructs a copy of \a other.
 */
DeregisterDBProxyTargetsRequest::DeregisterDBProxyTargetsRequest(const DeregisterDBProxyTargetsRequest &other)
    : RdsRequest(new DeregisterDBProxyTargetsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeregisterDBProxyTargetsRequest object.
 */
DeregisterDBProxyTargetsRequest::DeregisterDBProxyTargetsRequest()
    : RdsRequest(new DeregisterDBProxyTargetsRequestPrivate(RdsRequest::DeregisterDBProxyTargetsAction, this))
{
 ...
 * \reimp
 */
bool DeregisterDBProxyTargetsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeregisterDBProxyTargetsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeregisterDBProxyTargetsRequest::response(QNetworkReply * const reply) const
{
    return new DeregisterDBProxyTargetsResponse(*this, reply);
}

/*!
 * \class QtAws::Rds::DeregisterDBProxyTargetsRequestPrivate
 * \brief The DeregisterDBProxyTargetsRequestPrivate class provides private implementation for DeregisterDBProxyTargetsRequest.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a DeregisterDBProxyTargetsRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DeregisterDBProxyTargetsRequestPrivate::DeregisterDBProxyTargetsRequestPrivate(
    const RdsRequest::Action action, DeregisterDBProxyTargetsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeregisterDBProxyTargetsRequest
 * class' copy constructor.
 */
DeregisterDBProxyTargetsRequestPrivate::DeregisterDBProxyTargetsRequestPrivate(
    const DeregisterDBProxyTargetsRequestPrivate &other, DeregisterDBProxyTargetsRequest * const q)
