...
StartExportTaskRequest::StartExportTaskRequest(const StartExportTaskRequest &other)
    : RdsRequest(new StartExportTaskRequestPrivate(*other.d_func(), this))
{
...
StartExportTaskRequest::StartExportTaskRequest()
    : RdsRequest(new StartExportTaskRequestPrivate(RdsRequest::StartExportTaskAction, this))
{
...
/*!
 * Constructs a StartExportTaskRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
StartExportTaskRequestPrivate::StartExportTaskRequestPrivate(
    const RdsRequest::Action action, StartExportTaskRequest * const q)
