...
#include "stopdbinstanceautomatedbackupsreplicationrequest_p.h"
 ...
 */
StopDBInstanceAutomatedBackupsReplicationRequest::StopDBInstanceAutomatedBackupsReplicationRequest(const StopDBInstanceAutomatedBackupsReplicationRequest &other)
    : RdsRequest(new StopDBInstanceAutomatedBackupsReplicationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a StopDBInstanceAutomatedBackupsReplicationRequest object.
 */
StopDBInstanceAutomatedBackupsReplicationRequest::StopDBInstanceAutomatedBackupsReplicationRequest()
    : RdsRequest(new StopDBInstanceAutomatedBackupsReplicationRequestPrivate(RdsRequest::StopDBInstanceAutomatedBackupsReplicationAction, this))
{
 ...
 * \reimp
 */
bool StopDBInstanceAutomatedBackupsReplicationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a StopDBInstanceAutomatedBackupsReplicationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * StopDBInstanceAutomatedBackupsReplicationRequest::response(QNetworkReply * const reply) const
{
    return new StopDBInstanceAutomatedBackupsReplicationResponse(*this, reply);
}
...
/*!
 * Constructs a StopDBInstanceAutomatedBackupsReplicationRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
StopDBInstanceAutomatedBackupsReplicationRequestPrivate::StopDBInstanceAutomatedBackupsReplicationRequestPrivate(
    const RdsRequest::Action action, StopDBInstanceAutomatedBackupsReplicationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the StopDBInstanceAutomatedBackupsReplicationRequest
 * class' copy constructor.
 */
StopDBInstanceAutomatedBackupsReplicationRequestPrivate::StopDBInstanceAutomatedBackupsReplicationRequestPrivate(
    const StopDBInstanceAutomatedBackupsReplicationRequestPrivate &other, StopDBInstanceAutomatedBackupsReplicationRequest * const q)
