...
#include "deletecustomavailabilityzonerequest_p.h"
...
/*!
 * \class QtAws::RDS::DeleteCustomAvailabilityZoneRequest
 * \brief The DeleteCustomAvailabilityZoneRequest class provides an interface for RDS DeleteCustomAvailabilityZone requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::deleteCustomAvailabilityZone
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteCustomAvailabilityZoneRequest::DeleteCustomAvailabilityZoneRequest(const DeleteCustomAvailabilityZoneRequest &other)
    : RdsRequest(new DeleteCustomAvailabilityZoneRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteCustomAvailabilityZoneRequest object.
 */
DeleteCustomAvailabilityZoneRequest::DeleteCustomAvailabilityZoneRequest()
    : RdsRequest(new DeleteCustomAvailabilityZoneRequestPrivate(RdsRequest::DeleteCustomAvailabilityZoneAction, this))
{
 ...
 * \reimp
 */
bool DeleteCustomAvailabilityZoneRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteCustomAvailabilityZoneResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteCustomAvailabilityZoneRequest::response(QNetworkReply * const reply) const
{
    return new DeleteCustomAvailabilityZoneResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::DeleteCustomAvailabilityZoneRequestPrivate
 * \brief The DeleteCustomAvailabilityZoneRequestPrivate class provides private implementation for DeleteCustomAvailabilityZoneRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a DeleteCustomAvailabilityZoneRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DeleteCustomAvailabilityZoneRequestPrivate::DeleteCustomAvailabilityZoneRequestPrivate(
    const RdsRequest::Action action, DeleteCustomAvailabilityZoneRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteCustomAvailabilityZoneRequest
 * class' copy constructor.
 */
DeleteCustomAvailabilityZoneRequestPrivate::DeleteCustomAvailabilityZoneRequestPrivate(
    const DeleteCustomAvailabilityZoneRequestPrivate &other, DeleteCustomAvailabilityZoneRequest * const q)
