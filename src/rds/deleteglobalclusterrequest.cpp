...
/*!
 * \class QtAws::RDS::DeleteGlobalClusterRequest
 * \brief The DeleteGlobalClusterRequest class provides an interface for RDS DeleteGlobalCluster requests.
 *
 * \inmodule QtAwsRDS
 *
...
DeleteGlobalClusterRequest::DeleteGlobalClusterRequest(const DeleteGlobalClusterRequest &other)
    : RdsRequest(new DeleteGlobalClusterRequestPrivate(*other.d_func(), this))
{
...
DeleteGlobalClusterRequest::DeleteGlobalClusterRequest()
    : RdsRequest(new DeleteGlobalClusterRequestPrivate(RdsRequest::DeleteGlobalClusterAction, this))
{
...
/*!
 * \class QtAws::RDS::DeleteGlobalClusterRequestPrivate
...
/*!
 * Constructs a DeleteGlobalClusterRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DeleteGlobalClusterRequestPrivate::DeleteGlobalClusterRequestPrivate(
    const RdsRequest::Action action, DeleteGlobalClusterRequest * const q)
