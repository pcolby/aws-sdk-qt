...
#include "deleteinstallationmediarequest_p.h"
...
/*!
 * \class QtAws::RDS::DeleteInstallationMediaRequest
 * \brief The DeleteInstallationMediaRequest class provides an interface for RDS DeleteInstallationMedia requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::deleteInstallationMedia
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteInstallationMediaRequest::DeleteInstallationMediaRequest(const DeleteInstallationMediaRequest &other)
    : RdsRequest(new DeleteInstallationMediaRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteInstallationMediaRequest object.
 */
DeleteInstallationMediaRequest::DeleteInstallationMediaRequest()
    : RdsRequest(new DeleteInstallationMediaRequestPrivate(RdsRequest::DeleteInstallationMediaAction, this))
{
 ...
 * \reimp
 */
bool DeleteInstallationMediaRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteInstallationMediaResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteInstallationMediaRequest::response(QNetworkReply * const reply) const
{
    return new DeleteInstallationMediaResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::DeleteInstallationMediaRequestPrivate
 * \brief The DeleteInstallationMediaRequestPrivate class provides private implementation for DeleteInstallationMediaRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a DeleteInstallationMediaRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DeleteInstallationMediaRequestPrivate::DeleteInstallationMediaRequestPrivate(
    const RdsRequest::Action action, DeleteInstallationMediaRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteInstallationMediaRequest
 * class' copy constructor.
 */
DeleteInstallationMediaRequestPrivate::DeleteInstallationMediaRequestPrivate(
    const DeleteInstallationMediaRequestPrivate &other, DeleteInstallationMediaRequest * const q)
