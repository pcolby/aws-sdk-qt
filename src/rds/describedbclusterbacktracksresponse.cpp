...
#include "describedbclusterbacktracksresponse_p.h"
...
/*!
 * Constructs a DescribeDBClusterBacktracksResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeDBClusterBacktracksResponse::DescribeDBClusterBacktracksResponse(
        const DescribeDBClusterBacktracksRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new DescribeDBClusterBacktracksResponsePrivate(this), parent)
{
    setRequest(new DescribeDBClusterBacktracksRequest(request));
    setReply(reply);
}
...
/*!
 * Constructs a DescribeDBClusterBacktracksResponsePrivate object with public implementation \a q.
 */
DescribeDBClusterBacktracksResponsePrivate::DescribeDBClusterBacktracksResponsePrivate(
    DescribeDBClusterBacktracksResponse * const q) : RdsResponsePrivate(q)
{
...
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeDBClusterBacktracksResponse"));
    Q_UNUSED(xml) ///< @todo
}
