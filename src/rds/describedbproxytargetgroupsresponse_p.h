...
class QTAWS_EXPORT DescribeDBProxyTargetGroupsResponsePrivate : public RdsResponsePrivate {

public:

    DescribeDBProxyTargetGroupsResponsePrivate(DescribeDBProxyTargetGroupsResponse * const q);
