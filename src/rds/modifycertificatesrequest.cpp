...
#include "modifycertificatesrequest_p.h"
...
/*!
 * \class QtAws::RDS::ModifyCertificatesRequest
 * \brief The ModifyCertificatesRequest class provides an interface for RDS ModifyCertificates requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::modifyCertificates
 */

/*!
 * Constructs a copy of \a other.
 */
ModifyCertificatesRequest::ModifyCertificatesRequest(const ModifyCertificatesRequest &other)
    : RdsRequest(new ModifyCertificatesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ModifyCertificatesRequest object.
 */
ModifyCertificatesRequest::ModifyCertificatesRequest()
    : RdsRequest(new ModifyCertificatesRequestPrivate(RdsRequest::ModifyCertificatesAction, this))
{
 ...
 * \reimp
 */
bool ModifyCertificatesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ModifyCertificatesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ModifyCertificatesRequest::response(QNetworkReply * const reply) const
{
    return new ModifyCertificatesResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::ModifyCertificatesRequestPrivate
 * \brief The ModifyCertificatesRequestPrivate class provides private implementation for ModifyCertificatesRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a ModifyCertificatesRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
ModifyCertificatesRequestPrivate::ModifyCertificatesRequestPrivate(
    const RdsRequest::Action action, ModifyCertificatesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ModifyCertificatesRequest
 * class' copy constructor.
 */
ModifyCertificatesRequestPrivate::ModifyCertificatesRequestPrivate(
    const ModifyCertificatesRequestPrivate &other, ModifyCertificatesRequest * const q)
