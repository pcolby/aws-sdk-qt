...
#include "stopactivitystreamrequest_p.h"
 ...
 */
StopActivityStreamRequest::StopActivityStreamRequest(const StopActivityStreamRequest &other)
    : RdsRequest(new StopActivityStreamRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a StopActivityStreamRequest object.
 */
StopActivityStreamRequest::StopActivityStreamRequest()
    : RdsRequest(new StopActivityStreamRequestPrivate(RdsRequest::StopActivityStreamAction, this))
{
 ...
 * \reimp
 */
bool StopActivityStreamRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a StopActivityStreamResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * StopActivityStreamRequest::response(QNetworkReply * const reply) const
{
    return new StopActivityStreamResponse(*this, reply);
}
...
/*!
 * Constructs a StopActivityStreamRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
StopActivityStreamRequestPrivate::StopActivityStreamRequestPrivate(
    const RdsRequest::Action action, StopActivityStreamRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the StopActivityStreamRequest
 * class' copy constructor.
 */
StopActivityStreamRequestPrivate::StopActivityStreamRequestPrivate(
    const StopActivityStreamRequestPrivate &other, StopActivityStreamRequest * const q)
