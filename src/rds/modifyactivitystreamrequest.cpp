...
#include "modifyactivitystreamrequest_p.h"
...
/*!
 * \class QtAws::Rds::ModifyActivityStreamRequest
 * \brief The ModifyActivityStreamRequest class provides an interface for Rds ModifyActivityStream requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 */
ModifyActivityStreamRequest::ModifyActivityStreamRequest(const ModifyActivityStreamRequest &other)
    : RdsRequest(new ModifyActivityStreamRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ModifyActivityStreamRequest object.
 */
ModifyActivityStreamRequest::ModifyActivityStreamRequest()
    : RdsRequest(new ModifyActivityStreamRequestPrivate(RdsRequest::ModifyActivityStreamAction, this))
{
 ...
 * \reimp
 */
bool ModifyActivityStreamRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ModifyActivityStreamResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ModifyActivityStreamRequest::response(QNetworkReply * const reply) const
{
    return new ModifyActivityStreamResponse(*this, reply);
}

/*!
 * \class QtAws::Rds::ModifyActivityStreamRequestPrivate
 * \brief The ModifyActivityStreamRequestPrivate class provides private implementation for ModifyActivityStreamRequest.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a ModifyActivityStreamRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
ModifyActivityStreamRequestPrivate::ModifyActivityStreamRequestPrivate(
    const RdsRequest::Action action, ModifyActivityStreamRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ModifyActivityStreamRequest
 * class' copy constructor.
 */
ModifyActivityStreamRequestPrivate::ModifyActivityStreamRequestPrivate(
    const ModifyActivityStreamRequestPrivate &other, ModifyActivityStreamRequest * const q)
