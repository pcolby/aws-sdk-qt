...
class QTAWS_EXPORT CreateDBInstanceReadReplicaResponse : public CreateDBInstanceReadReplicaResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateDBInstanceReadReplicaRequest * request() const;
