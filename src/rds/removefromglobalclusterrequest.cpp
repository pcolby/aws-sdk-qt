 ...
 *
 * \sa RdsClient::removeFromGlobalCluster
 */
...
RemoveFromGlobalClusterRequest::RemoveFromGlobalClusterRequest(const RemoveFromGlobalClusterRequest &other)
    : RdsRequest(new RemoveFromGlobalClusterRequestPrivate(*other.d_func(), this))
{
...
RemoveFromGlobalClusterRequest::RemoveFromGlobalClusterRequest()
    : RdsRequest(new RemoveFromGlobalClusterRequestPrivate(RdsRequest::RemoveFromGlobalClusterAction, this))
{
...
/*!
 * Constructs a RemoveFromGlobalClusterRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
RemoveFromGlobalClusterRequestPrivate::RemoveFromGlobalClusterRequestPrivate(
    const RdsRequest::Action action, RemoveFromGlobalClusterRequest * const q)
