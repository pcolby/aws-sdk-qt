...
/*!
 * \class QtAws::Rds::DescribeGlobalClustersRequest
 * \brief The DescribeGlobalClustersRequest class provides an interface for Rds DescribeGlobalClusters requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::describeGlobalClusters
 */
...
DescribeGlobalClustersRequest::DescribeGlobalClustersRequest(const DescribeGlobalClustersRequest &other)
    : RdsRequest(new DescribeGlobalClustersRequestPrivate(*other.d_func(), this))
{
...
DescribeGlobalClustersRequest::DescribeGlobalClustersRequest()
    : RdsRequest(new DescribeGlobalClustersRequestPrivate(RdsRequest::DescribeGlobalClustersAction, this))
{
...
/*!
 * \class QtAws::Rds::DescribeGlobalClustersRequestPrivate
...
/*!
 * Constructs a DescribeGlobalClustersRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DescribeGlobalClustersRequestPrivate::DescribeGlobalClustersRequestPrivate(
    const RdsRequest::Action action, DescribeGlobalClustersRequest * const q)
