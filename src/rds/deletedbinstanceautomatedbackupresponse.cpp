...
#include "deletedbinstanceautomatedbackupresponse_p.h"
...
/*!
 * \class QtAws::RDS::DeleteDBInstanceAutomatedBackupResponse
 * \brief The DeleteDBInstanceAutomatedBackupResponse class provides an interace for RDS DeleteDBInstanceAutomatedBackup responses.
 *
 * \inmodule QtAwsRDS
 *
...
/*!
 * Constructs a DeleteDBInstanceAutomatedBackupResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteDBInstanceAutomatedBackupResponse::DeleteDBInstanceAutomatedBackupResponse(
        const DeleteDBInstanceAutomatedBackupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new DeleteDBInstanceAutomatedBackupResponsePrivate(this), parent)
{
    setRequest(new DeleteDBInstanceAutomatedBackupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful RDS DeleteDBInstanceAutomatedBackup \a response.
 */
void DeleteDBInstanceAutomatedBackupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteDBInstanceAutomatedBackupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::RDS::DeleteDBInstanceAutomatedBackupResponsePrivate
 * \brief The DeleteDBInstanceAutomatedBackupResponsePrivate class provides private implementation for DeleteDBInstanceAutomatedBackupResponse.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a DeleteDBInstanceAutomatedBackupResponsePrivate object with public implementation \a q.
 */
DeleteDBInstanceAutomatedBackupResponsePrivate::DeleteDBInstanceAutomatedBackupResponsePrivate(
    DeleteDBInstanceAutomatedBackupResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS DeleteDBInstanceAutomatedBackup response element from \a xml.
 */
void DeleteDBInstanceAutomatedBackupResponsePrivate::parseDeleteDBInstanceAutomatedBackupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteDBInstanceAutomatedBackupResponse"));
    Q_UNUSED(xml) ///< @todo
}
