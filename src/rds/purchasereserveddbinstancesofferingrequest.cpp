 ...
 *
 * \brief The PurchaseReservedDBInstancesOfferingRequest class encapsulates RDS PurchaseReservedDBInstancesOffering requests.
 *
 * \ingroup RDS
 *
 ...
 *
 * \sa RDSClient::purchaseReservedDBInstancesOffering
 */
