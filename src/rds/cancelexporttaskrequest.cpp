...
CancelExportTaskRequest::CancelExportTaskRequest(const CancelExportTaskRequest &other)
    : RdsRequest(new CancelExportTaskRequestPrivate(*other.d_func(), this))
{
...
CancelExportTaskRequest::CancelExportTaskRequest()
    : RdsRequest(new CancelExportTaskRequestPrivate(RdsRequest::CancelExportTaskAction, this))
{
...
/*!
 * Constructs a CancelExportTaskRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
CancelExportTaskRequestPrivate::CancelExportTaskRequestPrivate(
    const RdsRequest::Action action, CancelExportTaskRequest * const q)
