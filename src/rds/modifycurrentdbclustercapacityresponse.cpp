...
#include "modifycurrentdbclustercapacityresponse_p.h"
...
/*!
 * Constructs a ModifyCurrentDBClusterCapacityResponse object for \a reply to \a request, with parent \a parent.
 */
ModifyCurrentDBClusterCapacityResponse::ModifyCurrentDBClusterCapacityResponse(
        const ModifyCurrentDBClusterCapacityRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new ModifyCurrentDBClusterCapacityResponsePrivate(this), parent)
{
    setRequest(new ModifyCurrentDBClusterCapacityRequest(request));
    setReply(reply);
}
...
{
    //Q_D(ModifyCurrentDBClusterCapacityResponse);
...
/*!
 * Constructs a ModifyCurrentDBClusterCapacityResponsePrivate object with public implementation \a q.
 */
ModifyCurrentDBClusterCapacityResponsePrivate::ModifyCurrentDBClusterCapacityResponsePrivate(
    ModifyCurrentDBClusterCapacityResponse * const q) : RdsResponsePrivate(q)
{
...
{
    Q_ASSERT(xml.name() == QLatin1String("ModifyCurrentDBClusterCapacityResponse"));
    Q_UNUSED(xml) ///< @todo
}
