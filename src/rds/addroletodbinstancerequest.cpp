...
#include "addroletodbinstancerequest_p.h"
...
/*!
 * \class QtAws::RDS::AddRoleToDBInstanceRequest
 * \brief The AddRoleToDBInstanceRequest class provides an interface for RDS AddRoleToDBInstance requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::addRoleToDBInstance
 */

/*!
 * Constructs a copy of \a other.
 */
AddRoleToDBInstanceRequest::AddRoleToDBInstanceRequest(const AddRoleToDBInstanceRequest &other)
    : RdsRequest(new AddRoleToDBInstanceRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AddRoleToDBInstanceRequest object.
 */
AddRoleToDBInstanceRequest::AddRoleToDBInstanceRequest()
    : RdsRequest(new AddRoleToDBInstanceRequestPrivate(RdsRequest::AddRoleToDBInstanceAction, this))
{
 ...
 * \reimp
 */
bool AddRoleToDBInstanceRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AddRoleToDBInstanceResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AddRoleToDBInstanceRequest::response(QNetworkReply * const reply) const
{
    return new AddRoleToDBInstanceResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::AddRoleToDBInstanceRequestPrivate
 * \brief The AddRoleToDBInstanceRequestPrivate class provides private implementation for AddRoleToDBInstanceRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a AddRoleToDBInstanceRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
AddRoleToDBInstanceRequestPrivate::AddRoleToDBInstanceRequestPrivate(
    const RdsRequest::Action action, AddRoleToDBInstanceRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AddRoleToDBInstanceRequest
 * class' copy constructor.
 */
AddRoleToDBInstanceRequestPrivate::AddRoleToDBInstanceRequestPrivate(
    const AddRoleToDBInstanceRequestPrivate &other, AddRoleToDBInstanceRequest * const q)
