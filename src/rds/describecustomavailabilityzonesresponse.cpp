...
#include "describecustomavailabilityzonesresponse_p.h"
...
/*!
 * \class QtAws::RDS::DescribeCustomAvailabilityZonesResponse
 * \brief The DescribeCustomAvailabilityZonesResponse class provides an interace for RDS DescribeCustomAvailabilityZones responses.
 *
 * \inmodule QtAwsRDS
 *
...
/*!
 * Constructs a DescribeCustomAvailabilityZonesResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeCustomAvailabilityZonesResponse::DescribeCustomAvailabilityZonesResponse(
        const DescribeCustomAvailabilityZonesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new DescribeCustomAvailabilityZonesResponsePrivate(this), parent)
{
    setRequest(new DescribeCustomAvailabilityZonesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful RDS DescribeCustomAvailabilityZones \a response.
 */
void DescribeCustomAvailabilityZonesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeCustomAvailabilityZonesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::RDS::DescribeCustomAvailabilityZonesResponsePrivate
 * \brief The DescribeCustomAvailabilityZonesResponsePrivate class provides private implementation for DescribeCustomAvailabilityZonesResponse.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a DescribeCustomAvailabilityZonesResponsePrivate object with public implementation \a q.
 */
DescribeCustomAvailabilityZonesResponsePrivate::DescribeCustomAvailabilityZonesResponsePrivate(
    DescribeCustomAvailabilityZonesResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS DescribeCustomAvailabilityZones response element from \a xml.
 */
void DescribeCustomAvailabilityZonesResponsePrivate::parseDescribeCustomAvailabilityZonesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeCustomAvailabilityZonesResponse"));
    Q_UNUSED(xml) ///< @todo
}
