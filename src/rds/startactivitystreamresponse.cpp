...
#include "startactivitystreamresponse_p.h"
...
/*!
 * \class QtAws::RDS::StartActivityStreamResponse
 * \brief The StartActivityStreamResponse class provides an interace for RDS StartActivityStream responses.
 *
 * \inmodule QtAwsRDS
 *
...
/*!
 * Constructs a StartActivityStreamResponse object for \a reply to \a request, with parent \a parent.
 */
StartActivityStreamResponse::StartActivityStreamResponse(
        const StartActivityStreamRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new StartActivityStreamResponsePrivate(this), parent)
{
    setRequest(new StartActivityStreamRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful RDS StartActivityStream \a response.
 */
void StartActivityStreamResponse::parseSuccess(QIODevice &response)
{
    //Q_D(StartActivityStreamResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::RDS::StartActivityStreamResponsePrivate
 * \brief The StartActivityStreamResponsePrivate class provides private implementation for StartActivityStreamResponse.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a StartActivityStreamResponsePrivate object with public implementation \a q.
 */
StartActivityStreamResponsePrivate::StartActivityStreamResponsePrivate(
    StartActivityStreamResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS StartActivityStream response element from \a xml.
 */
void StartActivityStreamResponsePrivate::parseStartActivityStreamResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("StartActivityStreamResponse"));
    Q_UNUSED(xml) ///< @todo
}
