...
#include "modifydbproxyendpointrequest_p.h"
...
/*!
 * \class QtAws::RDS::ModifyDBProxyEndpointRequest
 * \brief The ModifyDBProxyEndpointRequest class provides an interface for RDS ModifyDBProxyEndpoint requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 */
ModifyDBProxyEndpointRequest::ModifyDBProxyEndpointRequest(const ModifyDBProxyEndpointRequest &other)
    : RdsRequest(new ModifyDBProxyEndpointRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ModifyDBProxyEndpointRequest object.
 */
ModifyDBProxyEndpointRequest::ModifyDBProxyEndpointRequest()
    : RdsRequest(new ModifyDBProxyEndpointRequestPrivate(RdsRequest::ModifyDBProxyEndpointAction, this))
{
 ...
 * \reimp
 */
bool ModifyDBProxyEndpointRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ModifyDBProxyEndpointResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ModifyDBProxyEndpointRequest::response(QNetworkReply * const reply) const
{
    return new ModifyDBProxyEndpointResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::ModifyDBProxyEndpointRequestPrivate
 * \brief The ModifyDBProxyEndpointRequestPrivate class provides private implementation for ModifyDBProxyEndpointRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a ModifyDBProxyEndpointRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
ModifyDBProxyEndpointRequestPrivate::ModifyDBProxyEndpointRequestPrivate(
    const RdsRequest::Action action, ModifyDBProxyEndpointRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ModifyDBProxyEndpointRequest
 * class' copy constructor.
 */
ModifyDBProxyEndpointRequestPrivate::ModifyDBProxyEndpointRequestPrivate(
    const ModifyDBProxyEndpointRequestPrivate &other, ModifyDBProxyEndpointRequest * const q)
