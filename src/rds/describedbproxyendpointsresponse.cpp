...
#include "describedbproxyendpointsresponse_p.h"
...
/*!
 * Constructs a DescribeDBProxyEndpointsResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeDBProxyEndpointsResponse::DescribeDBProxyEndpointsResponse(
        const DescribeDBProxyEndpointsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new DescribeDBProxyEndpointsResponsePrivate(this), parent)
{
    setRequest(new DescribeDBProxyEndpointsRequest(request));
    setReply(reply);
}
...
{
    //Q_D(DescribeDBProxyEndpointsResponse);
...
/*!
 * Constructs a DescribeDBProxyEndpointsResponsePrivate object with public implementation \a q.
 */
DescribeDBProxyEndpointsResponsePrivate::DescribeDBProxyEndpointsResponsePrivate(
    DescribeDBProxyEndpointsResponse * const q) : RdsResponsePrivate(q)
{
...
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeDBProxyEndpointsResponse"));
    Q_UNUSED(xml) ///< @todo
}
