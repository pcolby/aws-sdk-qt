...
#include "switchoverreadreplicaresponse_p.h"
...
/*!
 * \class QtAws::Rds::SwitchoverReadReplicaResponse
 * \brief The SwitchoverReadReplicaResponse class provides an interace for Rds SwitchoverReadReplica responses.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::switchoverReadReplica
 */

/*!
 * Constructs a SwitchoverReadReplicaResponse object for \a reply to \a request, with parent \a parent.
 */
SwitchoverReadReplicaResponse::SwitchoverReadReplicaResponse(
        const SwitchoverReadReplicaRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new SwitchoverReadReplicaResponsePrivate(this), parent)
{
    setRequest(new SwitchoverReadReplicaRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const SwitchoverReadReplicaRequest * SwitchoverReadReplicaResponse::request() const
{
    Q_D(const SwitchoverReadReplicaResponse);
    return static_cast<const SwitchoverReadReplicaRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Rds SwitchoverReadReplica \a response.
 */
void SwitchoverReadReplicaResponse::parseSuccess(QIODevice &response)
{
    //Q_D(SwitchoverReadReplicaResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rds::SwitchoverReadReplicaResponsePrivate
 * \brief The SwitchoverReadReplicaResponsePrivate class provides private implementation for SwitchoverReadReplicaResponse.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a SwitchoverReadReplicaResponsePrivate object with public implementation \a q.
 */
SwitchoverReadReplicaResponsePrivate::SwitchoverReadReplicaResponsePrivate(
    SwitchoverReadReplicaResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a Rds SwitchoverReadReplica response element from \a xml.
 */
void SwitchoverReadReplicaResponsePrivate::parseSwitchoverReadReplicaResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("SwitchoverReadReplicaResponse"));
    Q_UNUSED(xml) ///< @todo
}
