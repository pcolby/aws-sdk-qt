...
#include "describedbproxiesrequest_p.h"
...
/*!
 * \class QtAws::Rds::DescribeDBProxiesRequest
 * \brief The DescribeDBProxiesRequest class provides an interface for Rds DescribeDBProxies requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::describeDBProxies
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeDBProxiesRequest::DescribeDBProxiesRequest(const DescribeDBProxiesRequest &other)
    : RdsRequest(new DescribeDBProxiesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeDBProxiesRequest object.
 */
DescribeDBProxiesRequest::DescribeDBProxiesRequest()
    : RdsRequest(new DescribeDBProxiesRequestPrivate(RdsRequest::DescribeDBProxiesAction, this))
{
 ...
 * \reimp
 */
bool DescribeDBProxiesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeDBProxiesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeDBProxiesRequest::response(QNetworkReply * const reply) const
{
    return new DescribeDBProxiesResponse(*this, reply);
}

/*!
 * \class QtAws::Rds::DescribeDBProxiesRequestPrivate
 * \brief The DescribeDBProxiesRequestPrivate class provides private implementation for DescribeDBProxiesRequest.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a DescribeDBProxiesRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DescribeDBProxiesRequestPrivate::DescribeDBProxiesRequestPrivate(
    const RdsRequest::Action action, DescribeDBProxiesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeDBProxiesRequest
 * class' copy constructor.
 */
DescribeDBProxiesRequestPrivate::DescribeDBProxiesRequestPrivate(
    const DescribeDBProxiesRequestPrivate &other, DescribeDBProxiesRequest * const q)
