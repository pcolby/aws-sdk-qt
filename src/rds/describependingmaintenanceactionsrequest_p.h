...
class QTAWS_EXPORT DescribePendingMaintenanceActionsRequestPrivate : public RDSRequestPrivate {

public:
    DescribePendingMaintenanceActionsRequestPrivate(const RDS::Action action,
