...
CreateDBClusterEndpointResponse::CreateDBClusterEndpointResponse(
    ...
    : RdsResponse(new CreateDBClusterEndpointResponsePrivate(this), parent)
{
...
{
    return static_cast<const CreateDBClusterEndpointRequest *>(RdsResponse::request());
}
...
CreateDBClusterEndpointResponsePrivate::CreateDBClusterEndpointResponsePrivate(
    CreateDBClusterEndpointResponse * const q) : RdsResponsePrivate(q)
{
