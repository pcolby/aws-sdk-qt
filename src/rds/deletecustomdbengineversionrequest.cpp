...
#include "deletecustomdbengineversionrequest_p.h"
...
/*!
 * \class QtAws::Rds::DeleteCustomDBEngineVersionRequest
 * \brief The DeleteCustomDBEngineVersionRequest class provides an interface for Rds DeleteCustomDBEngineVersion requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 */
DeleteCustomDBEngineVersionRequest::DeleteCustomDBEngineVersionRequest(const DeleteCustomDBEngineVersionRequest &other)
    : RdsRequest(new DeleteCustomDBEngineVersionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteCustomDBEngineVersionRequest object.
 */
DeleteCustomDBEngineVersionRequest::DeleteCustomDBEngineVersionRequest()
    : RdsRequest(new DeleteCustomDBEngineVersionRequestPrivate(RdsRequest::DeleteCustomDBEngineVersionAction, this))
{
 ...
 * \reimp
 */
bool DeleteCustomDBEngineVersionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteCustomDBEngineVersionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteCustomDBEngineVersionRequest::response(QNetworkReply * const reply) const
{
    return new DeleteCustomDBEngineVersionResponse(*this, reply);
}

/*!
 * \class QtAws::Rds::DeleteCustomDBEngineVersionRequestPrivate
 * \brief The DeleteCustomDBEngineVersionRequestPrivate class provides private implementation for DeleteCustomDBEngineVersionRequest.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a DeleteCustomDBEngineVersionRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DeleteCustomDBEngineVersionRequestPrivate::DeleteCustomDBEngineVersionRequestPrivate(
    const RdsRequest::Action action, DeleteCustomDBEngineVersionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteCustomDBEngineVersionRequest
 * class' copy constructor.
 */
DeleteCustomDBEngineVersionRequestPrivate::DeleteCustomDBEngineVersionRequestPrivate(
    const DeleteCustomDBEngineVersionRequestPrivate &other, DeleteCustomDBEngineVersionRequest * const q)
