...
#include "modifydbproxytargetgrouprequest_p.h"
 ...
 *
 * \sa RdsClient::modifyDBProxyTargetGroup
 */

/*!
 * Constructs a copy of \a other.
 */
ModifyDBProxyTargetGroupRequest::ModifyDBProxyTargetGroupRequest(const ModifyDBProxyTargetGroupRequest &other)
    : RdsRequest(new ModifyDBProxyTargetGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ModifyDBProxyTargetGroupRequest object.
 */
ModifyDBProxyTargetGroupRequest::ModifyDBProxyTargetGroupRequest()
    : RdsRequest(new ModifyDBProxyTargetGroupRequestPrivate(RdsRequest::ModifyDBProxyTargetGroupAction, this))
{
 ...
 * \reimp
 */
bool ModifyDBProxyTargetGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ModifyDBProxyTargetGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ModifyDBProxyTargetGroupRequest::response(QNetworkReply * const reply) const
{
    return new ModifyDBProxyTargetGroupResponse(*this, reply);
}
...
/*!
 * Constructs a ModifyDBProxyTargetGroupRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
ModifyDBProxyTargetGroupRequestPrivate::ModifyDBProxyTargetGroupRequestPrivate(
    const RdsRequest::Action action, ModifyDBProxyTargetGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ModifyDBProxyTargetGroupRequest
 * class' copy constructor.
 */
ModifyDBProxyTargetGroupRequestPrivate::ModifyDBProxyTargetGroupRequestPrivate(
    const ModifyDBProxyTargetGroupRequestPrivate &other, ModifyDBProxyTargetGroupRequest * const q)
