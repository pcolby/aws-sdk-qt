 ...
 *
 * \sa RdsClient::revokeDBSecurityGroupIngress
 */

/*!
 * Constructs a RevokeDBSecurityGroupIngressResponse object for \a reply to \a request, with parent \a parent.
 */
...
{
    Q_D(RevokeDBSecurityGroupIngressResponse);
