...
#include "modifydbproxyendpointresponse_p.h"
...
/*!
 * \class QtAws::Rds::ModifyDBProxyEndpointResponse
 * \brief The ModifyDBProxyEndpointResponse class provides an interace for Rds ModifyDBProxyEndpoint responses.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::modifyDBProxyEndpoint
 */

/*!
 * Constructs a ModifyDBProxyEndpointResponse object for \a reply to \a request, with parent \a parent.
 */
ModifyDBProxyEndpointResponse::ModifyDBProxyEndpointResponse(
        const ModifyDBProxyEndpointRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new ModifyDBProxyEndpointResponsePrivate(this), parent)
{
    setRequest(new ModifyDBProxyEndpointRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ModifyDBProxyEndpointRequest * ModifyDBProxyEndpointResponse::request() const
{
    Q_D(const ModifyDBProxyEndpointResponse);
    return static_cast<const ModifyDBProxyEndpointRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Rds ModifyDBProxyEndpoint \a response.
 */
void ModifyDBProxyEndpointResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ModifyDBProxyEndpointResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rds::ModifyDBProxyEndpointResponsePrivate
 * \brief The ModifyDBProxyEndpointResponsePrivate class provides private implementation for ModifyDBProxyEndpointResponse.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a ModifyDBProxyEndpointResponsePrivate object with public implementation \a q.
 */
ModifyDBProxyEndpointResponsePrivate::ModifyDBProxyEndpointResponsePrivate(
    ModifyDBProxyEndpointResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a Rds ModifyDBProxyEndpoint response element from \a xml.
 */
void ModifyDBProxyEndpointResponsePrivate::parseModifyDBProxyEndpointResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ModifyDBProxyEndpointResponse"));
    Q_UNUSED(xml) ///< @todo
}
