...
#include "stopdbinstanceautomatedbackupsreplicationresponse_p.h"
...
/*!
 * \class QtAws::Rds::StopDBInstanceAutomatedBackupsReplicationResponse
 * \brief The StopDBInstanceAutomatedBackupsReplicationResponse class provides an interace for Rds StopDBInstanceAutomatedBackupsReplication responses.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::stopDBInstanceAutomatedBackupsReplication
 */

/*!
 * Constructs a StopDBInstanceAutomatedBackupsReplicationResponse object for \a reply to \a request, with parent \a parent.
 */
StopDBInstanceAutomatedBackupsReplicationResponse::StopDBInstanceAutomatedBackupsReplicationResponse(
        const StopDBInstanceAutomatedBackupsReplicationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new StopDBInstanceAutomatedBackupsReplicationResponsePrivate(this), parent)
{
    setRequest(new StopDBInstanceAutomatedBackupsReplicationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Rds StopDBInstanceAutomatedBackupsReplication \a response.
 */
void StopDBInstanceAutomatedBackupsReplicationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(StopDBInstanceAutomatedBackupsReplicationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rds::StopDBInstanceAutomatedBackupsReplicationResponsePrivate
 * \brief The StopDBInstanceAutomatedBackupsReplicationResponsePrivate class provides private implementation for StopDBInstanceAutomatedBackupsReplicationResponse.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a StopDBInstanceAutomatedBackupsReplicationResponsePrivate object with public implementation \a q.
 */
StopDBInstanceAutomatedBackupsReplicationResponsePrivate::StopDBInstanceAutomatedBackupsReplicationResponsePrivate(
    StopDBInstanceAutomatedBackupsReplicationResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a Rds StopDBInstanceAutomatedBackupsReplication response element from \a xml.
 */
void StopDBInstanceAutomatedBackupsReplicationResponsePrivate::parseStopDBInstanceAutomatedBackupsReplicationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("StopDBInstanceAutomatedBackupsReplicationResponse"));
    Q_UNUSED(xml) ///< @todo
}
