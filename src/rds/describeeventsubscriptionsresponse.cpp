 ...
 *
 * @brief  Handles RDS DescribeEventSubscriptions responses.
 *
...
/**
 * @brief  Parse a RDS DescribeEventSubscriptions response.
 *
...
/**
 * @brief  Parse an RDS DescribeEventSubscriptionsResponse element.
 *
