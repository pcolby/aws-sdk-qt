...
#include "deletedbproxyendpointrequest_p.h"
...
/*!
 * \class QtAws::RDS::DeleteDBProxyEndpointRequest
 * \brief The DeleteDBProxyEndpointRequest class provides an interface for RDS DeleteDBProxyEndpoint requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 */
DeleteDBProxyEndpointRequest::DeleteDBProxyEndpointRequest(const DeleteDBProxyEndpointRequest &other)
    : RdsRequest(new DeleteDBProxyEndpointRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteDBProxyEndpointRequest object.
 */
DeleteDBProxyEndpointRequest::DeleteDBProxyEndpointRequest()
    : RdsRequest(new DeleteDBProxyEndpointRequestPrivate(RdsRequest::DeleteDBProxyEndpointAction, this))
{
 ...
 * \reimp
 */
bool DeleteDBProxyEndpointRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteDBProxyEndpointResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteDBProxyEndpointRequest::response(QNetworkReply * const reply) const
{
    return new DeleteDBProxyEndpointResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::DeleteDBProxyEndpointRequestPrivate
 * \brief The DeleteDBProxyEndpointRequestPrivate class provides private implementation for DeleteDBProxyEndpointRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a DeleteDBProxyEndpointRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DeleteDBProxyEndpointRequestPrivate::DeleteDBProxyEndpointRequestPrivate(
    const RdsRequest::Action action, DeleteDBProxyEndpointRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteDBProxyEndpointRequest
 * class' copy constructor.
 */
DeleteDBProxyEndpointRequestPrivate::DeleteDBProxyEndpointRequestPrivate(
    const DeleteDBProxyEndpointRequestPrivate &other, DeleteDBProxyEndpointRequest * const q)
