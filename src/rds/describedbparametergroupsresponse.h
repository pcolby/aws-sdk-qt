...
class QTAWS_EXPORT DescribeDBParameterGroupsResponse : public DescribeDBParameterGroupsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeDBParameterGroupsRequest * request() const;
