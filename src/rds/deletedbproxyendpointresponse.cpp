...
#include "deletedbproxyendpointresponse_p.h"
...
/*!
 * \class QtAws::RDS::DeleteDBProxyEndpointResponse
 * \brief The DeleteDBProxyEndpointResponse class provides an interace for RDS DeleteDBProxyEndpoint responses.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::deleteDBProxyEndpoint
 */

/*!
 * Constructs a DeleteDBProxyEndpointResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteDBProxyEndpointResponse::DeleteDBProxyEndpointResponse(
        const DeleteDBProxyEndpointRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new DeleteDBProxyEndpointResponsePrivate(this), parent)
{
    setRequest(new DeleteDBProxyEndpointRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteDBProxyEndpointRequest * DeleteDBProxyEndpointResponse::request() const
{
    Q_D(const DeleteDBProxyEndpointResponse);
    return static_cast<const DeleteDBProxyEndpointRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful RDS DeleteDBProxyEndpoint \a response.
 */
void DeleteDBProxyEndpointResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteDBProxyEndpointResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::RDS::DeleteDBProxyEndpointResponsePrivate
 * \brief The DeleteDBProxyEndpointResponsePrivate class provides private implementation for DeleteDBProxyEndpointResponse.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a DeleteDBProxyEndpointResponsePrivate object with public implementation \a q.
 */
DeleteDBProxyEndpointResponsePrivate::DeleteDBProxyEndpointResponsePrivate(
    DeleteDBProxyEndpointResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS DeleteDBProxyEndpoint response element from \a xml.
 */
void DeleteDBProxyEndpointResponsePrivate::parseDeleteDBProxyEndpointResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteDBProxyEndpointResponse"));
    Q_UNUSED(xml) ///< @todo
}
