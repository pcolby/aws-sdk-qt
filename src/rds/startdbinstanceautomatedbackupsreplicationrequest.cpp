...
#include "startdbinstanceautomatedbackupsreplicationrequest_p.h"
...
/*!
 * \class QtAws::RDS::StartDBInstanceAutomatedBackupsReplicationRequest
 * \brief The StartDBInstanceAutomatedBackupsReplicationRequest class provides an interface for RDS StartDBInstanceAutomatedBackupsReplication requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::startDBInstanceAutomatedBackupsReplication
 */

/*!
 * Constructs a copy of \a other.
 */
StartDBInstanceAutomatedBackupsReplicationRequest::StartDBInstanceAutomatedBackupsReplicationRequest(const StartDBInstanceAutomatedBackupsReplicationRequest &other)
    : RdsRequest(new StartDBInstanceAutomatedBackupsReplicationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a StartDBInstanceAutomatedBackupsReplicationRequest object.
 */
StartDBInstanceAutomatedBackupsReplicationRequest::StartDBInstanceAutomatedBackupsReplicationRequest()
    : RdsRequest(new StartDBInstanceAutomatedBackupsReplicationRequestPrivate(RdsRequest::StartDBInstanceAutomatedBackupsReplicationAction, this))
{
 ...
 * \reimp
 */
bool StartDBInstanceAutomatedBackupsReplicationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a StartDBInstanceAutomatedBackupsReplicationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * StartDBInstanceAutomatedBackupsReplicationRequest::response(QNetworkReply * const reply) const
{
    return new StartDBInstanceAutomatedBackupsReplicationResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::StartDBInstanceAutomatedBackupsReplicationRequestPrivate
 * \brief The StartDBInstanceAutomatedBackupsReplicationRequestPrivate class provides private implementation for StartDBInstanceAutomatedBackupsReplicationRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a StartDBInstanceAutomatedBackupsReplicationRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
StartDBInstanceAutomatedBackupsReplicationRequestPrivate::StartDBInstanceAutomatedBackupsReplicationRequestPrivate(
    const RdsRequest::Action action, StartDBInstanceAutomatedBackupsReplicationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the StartDBInstanceAutomatedBackupsReplicationRequest
 * class' copy constructor.
 */
StartDBInstanceAutomatedBackupsReplicationRequestPrivate::StartDBInstanceAutomatedBackupsReplicationRequestPrivate(
    const StartDBInstanceAutomatedBackupsReplicationRequestPrivate &other, StartDBInstanceAutomatedBackupsReplicationRequest * const q)
