...
class QTAWS_EXPORT DescribeDBClusterBacktracksResponsePrivate : public RdsResponsePrivate {

public:

    DescribeDBClusterBacktracksResponsePrivate(DescribeDBClusterBacktracksResponse * const q);
