...
#include "modifycertificatesresponse_p.h"
...
/*!
 * Constructs a ModifyCertificatesResponse object for \a reply to \a request, with parent \a parent.
 */
ModifyCertificatesResponse::ModifyCertificatesResponse(
        const ModifyCertificatesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new ModifyCertificatesResponsePrivate(this), parent)
{
    setRequest(new ModifyCertificatesRequest(request));
    setReply(reply);
}
...
{
    //Q_D(ModifyCertificatesResponse);
...
/*!
 * Constructs a ModifyCertificatesResponsePrivate object with public implementation \a q.
 */
ModifyCertificatesResponsePrivate::ModifyCertificatesResponsePrivate(
    ModifyCertificatesResponse * const q) : RdsResponsePrivate(q)
{
...
{
    Q_ASSERT(xml.name() == QLatin1String("ModifyCertificatesResponse"));
    Q_UNUSED(xml) ///< @todo
}
