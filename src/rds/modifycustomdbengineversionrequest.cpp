...
#include "modifycustomdbengineversionrequest_p.h"
...
/*!
 * \class QtAws::Rds::ModifyCustomDBEngineVersionRequest
 * \brief The ModifyCustomDBEngineVersionRequest class provides an interface for Rds ModifyCustomDBEngineVersion requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 */
ModifyCustomDBEngineVersionRequest::ModifyCustomDBEngineVersionRequest(const ModifyCustomDBEngineVersionRequest &other)
    : RdsRequest(new ModifyCustomDBEngineVersionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ModifyCustomDBEngineVersionRequest object.
 */
ModifyCustomDBEngineVersionRequest::ModifyCustomDBEngineVersionRequest()
    : RdsRequest(new ModifyCustomDBEngineVersionRequestPrivate(RdsRequest::ModifyCustomDBEngineVersionAction, this))
{
 ...
 * \reimp
 */
bool ModifyCustomDBEngineVersionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ModifyCustomDBEngineVersionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ModifyCustomDBEngineVersionRequest::response(QNetworkReply * const reply) const
{
    return new ModifyCustomDBEngineVersionResponse(*this, reply);
}

/*!
 * \class QtAws::Rds::ModifyCustomDBEngineVersionRequestPrivate
 * \brief The ModifyCustomDBEngineVersionRequestPrivate class provides private implementation for ModifyCustomDBEngineVersionRequest.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a ModifyCustomDBEngineVersionRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
ModifyCustomDBEngineVersionRequestPrivate::ModifyCustomDBEngineVersionRequestPrivate(
    const RdsRequest::Action action, ModifyCustomDBEngineVersionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ModifyCustomDBEngineVersionRequest
 * class' copy constructor.
 */
ModifyCustomDBEngineVersionRequestPrivate::ModifyCustomDBEngineVersionRequestPrivate(
    const ModifyCustomDBEngineVersionRequestPrivate &other, ModifyCustomDBEngineVersionRequest * const q)
