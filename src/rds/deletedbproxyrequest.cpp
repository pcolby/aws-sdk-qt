...
#include "deletedbproxyrequest_p.h"
 ...
 */
DeleteDBProxyRequest::DeleteDBProxyRequest(const DeleteDBProxyRequest &other)
    : RdsRequest(new DeleteDBProxyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteDBProxyRequest object.
 */
DeleteDBProxyRequest::DeleteDBProxyRequest()
    : RdsRequest(new DeleteDBProxyRequestPrivate(RdsRequest::DeleteDBProxyAction, this))
{
 ...
 * \reimp
 */
bool DeleteDBProxyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteDBProxyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteDBProxyRequest::response(QNetworkReply * const reply) const
{
    return new DeleteDBProxyResponse(*this, reply);
}
...
/*!
 * Constructs a DeleteDBProxyRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DeleteDBProxyRequestPrivate::DeleteDBProxyRequestPrivate(
    const RdsRequest::Action action, DeleteDBProxyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteDBProxyRequest
 * class' copy constructor.
 */
DeleteDBProxyRequestPrivate::DeleteDBProxyRequestPrivate(
    const DeleteDBProxyRequestPrivate &other, DeleteDBProxyRequest * const q)
