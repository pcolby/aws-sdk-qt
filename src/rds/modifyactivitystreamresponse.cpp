...
#include "modifyactivitystreamresponse_p.h"
...
/*!
 * \class QtAws::Rds::ModifyActivityStreamResponse
 * \brief The ModifyActivityStreamResponse class provides an interace for Rds ModifyActivityStream responses.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::modifyActivityStream
 */

/*!
 * Constructs a ModifyActivityStreamResponse object for \a reply to \a request, with parent \a parent.
 */
ModifyActivityStreamResponse::ModifyActivityStreamResponse(
        const ModifyActivityStreamRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new ModifyActivityStreamResponsePrivate(this), parent)
{
    setRequest(new ModifyActivityStreamRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ModifyActivityStreamRequest * ModifyActivityStreamResponse::request() const
{
    Q_D(const ModifyActivityStreamResponse);
    return static_cast<const ModifyActivityStreamRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Rds ModifyActivityStream \a response.
 */
void ModifyActivityStreamResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ModifyActivityStreamResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rds::ModifyActivityStreamResponsePrivate
 * \brief The ModifyActivityStreamResponsePrivate class provides private implementation for ModifyActivityStreamResponse.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a ModifyActivityStreamResponsePrivate object with public implementation \a q.
 */
ModifyActivityStreamResponsePrivate::ModifyActivityStreamResponsePrivate(
    ModifyActivityStreamResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a Rds ModifyActivityStream response element from \a xml.
 */
void ModifyActivityStreamResponsePrivate::parseModifyActivityStreamResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ModifyActivityStreamResponse"));
    Q_UNUSED(xml) ///< @todo
}
