...
#ifndef QTAWS_CREATECUSTOMAVAILABILITYZONEREQUEST_H
#define QTAWS_CREATECUSTOMAVAILABILITYZONEREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(CreateCustomAvailabilityZoneRequest)
