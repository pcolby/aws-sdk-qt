...
#include "deletecustomavailabilityzoneresponse_p.h"
...
/*!
 * \class QtAws::RDS::DeleteCustomAvailabilityZoneResponse
 * \brief The DeleteCustomAvailabilityZoneResponse class provides an interace for RDS DeleteCustomAvailabilityZone responses.
 *
 * \inmodule QtAwsRDS
 *
...
/*!
 * Constructs a DeleteCustomAvailabilityZoneResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteCustomAvailabilityZoneResponse::DeleteCustomAvailabilityZoneResponse(
        const DeleteCustomAvailabilityZoneRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new DeleteCustomAvailabilityZoneResponsePrivate(this), parent)
{
    setRequest(new DeleteCustomAvailabilityZoneRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful RDS DeleteCustomAvailabilityZone \a response.
 */
void DeleteCustomAvailabilityZoneResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteCustomAvailabilityZoneResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::RDS::DeleteCustomAvailabilityZoneResponsePrivate
 * \brief The DeleteCustomAvailabilityZoneResponsePrivate class provides private implementation for DeleteCustomAvailabilityZoneResponse.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a DeleteCustomAvailabilityZoneResponsePrivate object with public implementation \a q.
 */
DeleteCustomAvailabilityZoneResponsePrivate::DeleteCustomAvailabilityZoneResponsePrivate(
    DeleteCustomAvailabilityZoneResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS DeleteCustomAvailabilityZone response element from \a xml.
 */
void DeleteCustomAvailabilityZoneResponsePrivate::parseDeleteCustomAvailabilityZoneResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteCustomAvailabilityZoneResponse"));
    Q_UNUSED(xml) ///< @todo
}
