...
#ifndef QTAWS_DELETECUSTOMAVAILABILITYZONEREQUEST_H
#define QTAWS_DELETECUSTOMAVAILABILITYZONEREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(DeleteCustomAvailabilityZoneRequest)
