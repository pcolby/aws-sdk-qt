...
#ifndef QTAWS_STARTDBINSTANCEAUTOMATEDBACKUPSREPLICATIONREQUEST_H
#define QTAWS_STARTDBINSTANCEAUTOMATEDBACKUPSREPLICATIONREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(StartDBInstanceAutomatedBackupsReplicationRequest)
