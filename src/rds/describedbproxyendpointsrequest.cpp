...
#include "describedbproxyendpointsrequest_p.h"
...
/*!
 * \class QtAws::Rds::DescribeDBProxyEndpointsRequest
 * \brief The DescribeDBProxyEndpointsRequest class provides an interface for Rds DescribeDBProxyEndpoints requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::describeDBProxyEndpoints
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeDBProxyEndpointsRequest::DescribeDBProxyEndpointsRequest(const DescribeDBProxyEndpointsRequest &other)
    : RdsRequest(new DescribeDBProxyEndpointsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeDBProxyEndpointsRequest object.
 */
DescribeDBProxyEndpointsRequest::DescribeDBProxyEndpointsRequest()
    : RdsRequest(new DescribeDBProxyEndpointsRequestPrivate(RdsRequest::DescribeDBProxyEndpointsAction, this))
{
 ...
 * \reimp
 */
bool DescribeDBProxyEndpointsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeDBProxyEndpointsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeDBProxyEndpointsRequest::response(QNetworkReply * const reply) const
{
    return new DescribeDBProxyEndpointsResponse(*this, reply);
}

/*!
 * \class QtAws::Rds::DescribeDBProxyEndpointsRequestPrivate
 * \brief The DescribeDBProxyEndpointsRequestPrivate class provides private implementation for DescribeDBProxyEndpointsRequest.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a DescribeDBProxyEndpointsRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DescribeDBProxyEndpointsRequestPrivate::DescribeDBProxyEndpointsRequestPrivate(
    const RdsRequest::Action action, DescribeDBProxyEndpointsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeDBProxyEndpointsRequest
 * class' copy constructor.
 */
DescribeDBProxyEndpointsRequestPrivate::DescribeDBProxyEndpointsRequestPrivate(
    const DescribeDBProxyEndpointsRequestPrivate &other, DescribeDBProxyEndpointsRequest * const q)
