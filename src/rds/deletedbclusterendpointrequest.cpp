...
/*!
 * \class QtAws::Rds::DeleteDBClusterEndpointRequest
 * \brief The DeleteDBClusterEndpointRequest class provides an interface for Rds DeleteDBClusterEndpoint requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::deleteDBClusterEndpoint
 */
...
DeleteDBClusterEndpointRequest::DeleteDBClusterEndpointRequest(const DeleteDBClusterEndpointRequest &other)
    : RdsRequest(new DeleteDBClusterEndpointRequestPrivate(*other.d_func(), this))
{
...
DeleteDBClusterEndpointRequest::DeleteDBClusterEndpointRequest()
    : RdsRequest(new DeleteDBClusterEndpointRequestPrivate(RdsRequest::DeleteDBClusterEndpointAction, this))
{
...
/*!
 * \class QtAws::Rds::DeleteDBClusterEndpointRequestPrivate
...
/*!
 * Constructs a DeleteDBClusterEndpointRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DeleteDBClusterEndpointRequestPrivate::DeleteDBClusterEndpointRequestPrivate(
    const RdsRequest::Action action, DeleteDBClusterEndpointRequest * const q)
