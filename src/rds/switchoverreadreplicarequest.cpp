...
#include "switchoverreadreplicarequest_p.h"
...
/*!
 * \class QtAws::Rds::SwitchoverReadReplicaRequest
 * \brief The SwitchoverReadReplicaRequest class provides an interface for Rds SwitchoverReadReplica requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 */
SwitchoverReadReplicaRequest::SwitchoverReadReplicaRequest(const SwitchoverReadReplicaRequest &other)
    : RdsRequest(new SwitchoverReadReplicaRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a SwitchoverReadReplicaRequest object.
 */
SwitchoverReadReplicaRequest::SwitchoverReadReplicaRequest()
    : RdsRequest(new SwitchoverReadReplicaRequestPrivate(RdsRequest::SwitchoverReadReplicaAction, this))
{
 ...
 * \reimp
 */
bool SwitchoverReadReplicaRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a SwitchoverReadReplicaResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * SwitchoverReadReplicaRequest::response(QNetworkReply * const reply) const
{
    return new SwitchoverReadReplicaResponse(*this, reply);
}

/*!
 * \class QtAws::Rds::SwitchoverReadReplicaRequestPrivate
 * \brief The SwitchoverReadReplicaRequestPrivate class provides private implementation for SwitchoverReadReplicaRequest.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a SwitchoverReadReplicaRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
SwitchoverReadReplicaRequestPrivate::SwitchoverReadReplicaRequestPrivate(
    const RdsRequest::Action action, SwitchoverReadReplicaRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the SwitchoverReadReplicaRequest
 * class' copy constructor.
 */
SwitchoverReadReplicaRequestPrivate::SwitchoverReadReplicaRequestPrivate(
    const SwitchoverReadReplicaRequestPrivate &other, SwitchoverReadReplicaRequest * const q)
