...
#include "createdbproxyendpointresponse_p.h"
...
/*!
 * \class QtAws::RDS::CreateDBProxyEndpointResponse
 * \brief The CreateDBProxyEndpointResponse class provides an interace for RDS CreateDBProxyEndpoint responses.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::createDBProxyEndpoint
 */

/*!
 * Constructs a CreateDBProxyEndpointResponse object for \a reply to \a request, with parent \a parent.
 */
CreateDBProxyEndpointResponse::CreateDBProxyEndpointResponse(
        const CreateDBProxyEndpointRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new CreateDBProxyEndpointResponsePrivate(this), parent)
{
    setRequest(new CreateDBProxyEndpointRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateDBProxyEndpointRequest * CreateDBProxyEndpointResponse::request() const
{
    Q_D(const CreateDBProxyEndpointResponse);
    return static_cast<const CreateDBProxyEndpointRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful RDS CreateDBProxyEndpoint \a response.
 */
void CreateDBProxyEndpointResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateDBProxyEndpointResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::RDS::CreateDBProxyEndpointResponsePrivate
 * \brief The CreateDBProxyEndpointResponsePrivate class provides private implementation for CreateDBProxyEndpointResponse.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a CreateDBProxyEndpointResponsePrivate object with public implementation \a q.
 */
CreateDBProxyEndpointResponsePrivate::CreateDBProxyEndpointResponsePrivate(
    CreateDBProxyEndpointResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS CreateDBProxyEndpoint response element from \a xml.
 */
void CreateDBProxyEndpointResponsePrivate::parseCreateDBProxyEndpointResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateDBProxyEndpointResponse"));
    Q_UNUSED(xml) ///< @todo
}
