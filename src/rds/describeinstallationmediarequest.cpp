...
#include "describeinstallationmediarequest_p.h"
...
/*!
 * \class QtAws::RDS::DescribeInstallationMediaRequest
 * \brief The DescribeInstallationMediaRequest class provides an interface for RDS DescribeInstallationMedia requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 */
DescribeInstallationMediaRequest::DescribeInstallationMediaRequest(const DescribeInstallationMediaRequest &other)
    : RdsRequest(new DescribeInstallationMediaRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeInstallationMediaRequest object.
 */
DescribeInstallationMediaRequest::DescribeInstallationMediaRequest()
    : RdsRequest(new DescribeInstallationMediaRequestPrivate(RdsRequest::DescribeInstallationMediaAction, this))
{
 ...
 * \reimp
 */
bool DescribeInstallationMediaRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeInstallationMediaResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeInstallationMediaRequest::response(QNetworkReply * const reply) const
{
    return new DescribeInstallationMediaResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::DescribeInstallationMediaRequestPrivate
 * \brief The DescribeInstallationMediaRequestPrivate class provides private implementation for DescribeInstallationMediaRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a DescribeInstallationMediaRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DescribeInstallationMediaRequestPrivate::DescribeInstallationMediaRequestPrivate(
    const RdsRequest::Action action, DescribeInstallationMediaRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeInstallationMediaRequest
 * class' copy constructor.
 */
DescribeInstallationMediaRequestPrivate::DescribeInstallationMediaRequestPrivate(
    const DescribeInstallationMediaRequestPrivate &other, DescribeInstallationMediaRequest * const q)
