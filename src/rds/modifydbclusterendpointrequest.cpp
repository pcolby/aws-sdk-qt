...
/*!
 * \class QtAws::RDS::ModifyDBClusterEndpointRequest
 * \brief The ModifyDBClusterEndpointRequest class provides an interface for RDS ModifyDBClusterEndpoint requests.
 *
 * \inmodule QtAwsRDS
 *
...
ModifyDBClusterEndpointRequest::ModifyDBClusterEndpointRequest(const ModifyDBClusterEndpointRequest &other)
    : RdsRequest(new ModifyDBClusterEndpointRequestPrivate(*other.d_func(), this))
{
...
ModifyDBClusterEndpointRequest::ModifyDBClusterEndpointRequest()
    : RdsRequest(new ModifyDBClusterEndpointRequestPrivate(RdsRequest::ModifyDBClusterEndpointAction, this))
{
...
/*!
 * \class QtAws::RDS::ModifyDBClusterEndpointRequestPrivate
...
/*!
 * Constructs a ModifyDBClusterEndpointRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
ModifyDBClusterEndpointRequestPrivate::ModifyDBClusterEndpointRequestPrivate(
    const RdsRequest::Action action, ModifyDBClusterEndpointRequest * const q)
