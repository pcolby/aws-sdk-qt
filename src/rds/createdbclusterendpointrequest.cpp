...
/*!
 * \class QtAws::RDS::CreateDBClusterEndpointRequest
 * \brief The CreateDBClusterEndpointRequest class provides an interface for RDS CreateDBClusterEndpoint requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::createDBClusterEndpoint
 */
...
CreateDBClusterEndpointRequest::CreateDBClusterEndpointRequest(const CreateDBClusterEndpointRequest &other)
    : RdsRequest(new CreateDBClusterEndpointRequestPrivate(*other.d_func(), this))
{
...
CreateDBClusterEndpointRequest::CreateDBClusterEndpointRequest()
    : RdsRequest(new CreateDBClusterEndpointRequestPrivate(RdsRequest::CreateDBClusterEndpointAction, this))
{
...
/*!
 * \class QtAws::RDS::CreateDBClusterEndpointRequestPrivate
...
/*!
 * Constructs a CreateDBClusterEndpointRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
CreateDBClusterEndpointRequestPrivate::CreateDBClusterEndpointRequestPrivate(
    const RdsRequest::Action action, CreateDBClusterEndpointRequest * const q)
