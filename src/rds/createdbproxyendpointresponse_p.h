...
class QTAWS_EXPORT CreateDBProxyEndpointResponsePrivate : public RdsResponsePrivate {

public:

    CreateDBProxyEndpointResponsePrivate(CreateDBProxyEndpointResponse * const q);
