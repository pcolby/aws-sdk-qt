...
#include "createcustomdbengineversionresponse_p.h"
...
/*!
 * \class QtAws::Rds::CreateCustomDBEngineVersionResponse
 * \brief The CreateCustomDBEngineVersionResponse class provides an interace for Rds CreateCustomDBEngineVersion responses.
 *
 * \inmodule QtAwsRds
 *
...
/*!
 * Constructs a CreateCustomDBEngineVersionResponse object for \a reply to \a request, with parent \a parent.
 */
CreateCustomDBEngineVersionResponse::CreateCustomDBEngineVersionResponse(
        const CreateCustomDBEngineVersionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new CreateCustomDBEngineVersionResponsePrivate(this), parent)
{
    setRequest(new CreateCustomDBEngineVersionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateCustomDBEngineVersionRequest * CreateCustomDBEngineVersionResponse::request() const
{
    Q_D(const CreateCustomDBEngineVersionResponse);
    return static_cast<const CreateCustomDBEngineVersionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Rds CreateCustomDBEngineVersion \a response.
 */
void CreateCustomDBEngineVersionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateCustomDBEngineVersionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rds::CreateCustomDBEngineVersionResponsePrivate
 * \brief The CreateCustomDBEngineVersionResponsePrivate class provides private implementation for CreateCustomDBEngineVersionResponse.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a CreateCustomDBEngineVersionResponsePrivate object with public implementation \a q.
 */
CreateCustomDBEngineVersionResponsePrivate::CreateCustomDBEngineVersionResponsePrivate(
    CreateCustomDBEngineVersionResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a Rds CreateCustomDBEngineVersion response element from \a xml.
 */
void CreateCustomDBEngineVersionResponsePrivate::parseCreateCustomDBEngineVersionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateCustomDBEngineVersionResponse"));
    Q_UNUSED(xml) ///< @todo
}
