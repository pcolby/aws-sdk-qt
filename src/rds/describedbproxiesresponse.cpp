...
#include "describedbproxiesresponse_p.h"
...
/*!
 * \class QtAws::Rds::DescribeDBProxiesResponse
 * \brief The DescribeDBProxiesResponse class provides an interace for Rds DescribeDBProxies responses.
 *
 * \inmodule QtAwsRds
 *
...
/*!
 * Constructs a DescribeDBProxiesResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeDBProxiesResponse::DescribeDBProxiesResponse(
        const DescribeDBProxiesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new DescribeDBProxiesResponsePrivate(this), parent)
{
    setRequest(new DescribeDBProxiesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Rds DescribeDBProxies \a response.
 */
void DescribeDBProxiesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeDBProxiesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rds::DescribeDBProxiesResponsePrivate
 * \brief The DescribeDBProxiesResponsePrivate class provides private implementation for DescribeDBProxiesResponse.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a DescribeDBProxiesResponsePrivate object with public implementation \a q.
 */
DescribeDBProxiesResponsePrivate::DescribeDBProxiesResponsePrivate(
    DescribeDBProxiesResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a Rds DescribeDBProxies response element from \a xml.
 */
void DescribeDBProxiesResponsePrivate::parseDescribeDBProxiesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeDBProxiesResponse"));
    Q_UNUSED(xml) ///< @todo
}
