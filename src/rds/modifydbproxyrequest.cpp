...
#include "modifydbproxyrequest_p.h"
...
/*!
 * \class QtAws::RDS::ModifyDBProxyRequest
 * \brief The ModifyDBProxyRequest class provides an interface for RDS ModifyDBProxy requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::modifyDBProxy
 */

/*!
 * Constructs a copy of \a other.
 */
ModifyDBProxyRequest::ModifyDBProxyRequest(const ModifyDBProxyRequest &other)
    : RdsRequest(new ModifyDBProxyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ModifyDBProxyRequest object.
 */
ModifyDBProxyRequest::ModifyDBProxyRequest()
    : RdsRequest(new ModifyDBProxyRequestPrivate(RdsRequest::ModifyDBProxyAction, this))
{
 ...
 * \reimp
 */
bool ModifyDBProxyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ModifyDBProxyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ModifyDBProxyRequest::response(QNetworkReply * const reply) const
{
    return new ModifyDBProxyResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::ModifyDBProxyRequestPrivate
 * \brief The ModifyDBProxyRequestPrivate class provides private implementation for ModifyDBProxyRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a ModifyDBProxyRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
ModifyDBProxyRequestPrivate::ModifyDBProxyRequestPrivate(
    const RdsRequest::Action action, ModifyDBProxyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ModifyDBProxyRequest
 * class' copy constructor.
 */
ModifyDBProxyRequestPrivate::ModifyDBProxyRequestPrivate(
    const ModifyDBProxyRequestPrivate &other, ModifyDBProxyRequest * const q)
