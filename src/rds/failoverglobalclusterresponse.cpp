 ...
 *
 * \sa RdsClient::failoverGlobalCluster
 */
...
FailoverGlobalClusterResponse::FailoverGlobalClusterResponse(
    ...
    : RdsResponse(new FailoverGlobalClusterResponsePrivate(this), parent)
{
...
FailoverGlobalClusterResponsePrivate::FailoverGlobalClusterResponsePrivate(
    FailoverGlobalClusterResponse * const q) : RdsResponsePrivate(q)
{
