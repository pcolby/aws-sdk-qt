...
#include "describedbinstanceautomatedbackupsrequest_p.h"
...
/*!
 * \class QtAws::RDS::DescribeDBInstanceAutomatedBackupsRequest
 * \brief The DescribeDBInstanceAutomatedBackupsRequest class provides an interface for RDS DescribeDBInstanceAutomatedBackups requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::describeDBInstanceAutomatedBackups
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeDBInstanceAutomatedBackupsRequest::DescribeDBInstanceAutomatedBackupsRequest(const DescribeDBInstanceAutomatedBackupsRequest &other)
    : RdsRequest(new DescribeDBInstanceAutomatedBackupsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeDBInstanceAutomatedBackupsRequest object.
 */
DescribeDBInstanceAutomatedBackupsRequest::DescribeDBInstanceAutomatedBackupsRequest()
    : RdsRequest(new DescribeDBInstanceAutomatedBackupsRequestPrivate(RdsRequest::DescribeDBInstanceAutomatedBackupsAction, this))
{
 ...
 * \reimp
 */
bool DescribeDBInstanceAutomatedBackupsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeDBInstanceAutomatedBackupsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeDBInstanceAutomatedBackupsRequest::response(QNetworkReply * const reply) const
{
    return new DescribeDBInstanceAutomatedBackupsResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::DescribeDBInstanceAutomatedBackupsRequestPrivate
 * \brief The DescribeDBInstanceAutomatedBackupsRequestPrivate class provides private implementation for DescribeDBInstanceAutomatedBackupsRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a DescribeDBInstanceAutomatedBackupsRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DescribeDBInstanceAutomatedBackupsRequestPrivate::DescribeDBInstanceAutomatedBackupsRequestPrivate(
    const RdsRequest::Action action, DescribeDBInstanceAutomatedBackupsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeDBInstanceAutomatedBackupsRequest
 * class' copy constructor.
 */
DescribeDBInstanceAutomatedBackupsRequestPrivate::DescribeDBInstanceAutomatedBackupsRequestPrivate(
    const DescribeDBInstanceAutomatedBackupsRequestPrivate &other, DescribeDBInstanceAutomatedBackupsRequest * const q)
