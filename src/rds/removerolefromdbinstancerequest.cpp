...
#include "removerolefromdbinstancerequest_p.h"
...
/*!
 * \class QtAws::Rds::RemoveRoleFromDBInstanceRequest
 * \brief The RemoveRoleFromDBInstanceRequest class provides an interface for Rds RemoveRoleFromDBInstance requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::removeRoleFromDBInstance
 */

/*!
 * Constructs a copy of \a other.
 */
RemoveRoleFromDBInstanceRequest::RemoveRoleFromDBInstanceRequest(const RemoveRoleFromDBInstanceRequest &other)
    : RdsRequest(new RemoveRoleFromDBInstanceRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a RemoveRoleFromDBInstanceRequest object.
 */
RemoveRoleFromDBInstanceRequest::RemoveRoleFromDBInstanceRequest()
    : RdsRequest(new RemoveRoleFromDBInstanceRequestPrivate(RdsRequest::RemoveRoleFromDBInstanceAction, this))
{
 ...
 * \reimp
 */
bool RemoveRoleFromDBInstanceRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a RemoveRoleFromDBInstanceResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * RemoveRoleFromDBInstanceRequest::response(QNetworkReply * const reply) const
{
    return new RemoveRoleFromDBInstanceResponse(*this, reply);
}

/*!
 * \class QtAws::Rds::RemoveRoleFromDBInstanceRequestPrivate
 * \brief The RemoveRoleFromDBInstanceRequestPrivate class provides private implementation for RemoveRoleFromDBInstanceRequest.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a RemoveRoleFromDBInstanceRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
RemoveRoleFromDBInstanceRequestPrivate::RemoveRoleFromDBInstanceRequestPrivate(
    const RdsRequest::Action action, RemoveRoleFromDBInstanceRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the RemoveRoleFromDBInstanceRequest
 * class' copy constructor.
 */
RemoveRoleFromDBInstanceRequestPrivate::RemoveRoleFromDBInstanceRequestPrivate(
    const RemoveRoleFromDBInstanceRequestPrivate &other, RemoveRoleFromDBInstanceRequest * const q)
