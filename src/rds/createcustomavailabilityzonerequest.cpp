...
#include "createcustomavailabilityzonerequest_p.h"
...
/*!
 * \class QtAws::RDS::CreateCustomAvailabilityZoneRequest
 * \brief The CreateCustomAvailabilityZoneRequest class provides an interface for RDS CreateCustomAvailabilityZone requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::createCustomAvailabilityZone
 */

/*!
 * Constructs a copy of \a other.
 */
CreateCustomAvailabilityZoneRequest::CreateCustomAvailabilityZoneRequest(const CreateCustomAvailabilityZoneRequest &other)
    : RdsRequest(new CreateCustomAvailabilityZoneRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateCustomAvailabilityZoneRequest object.
 */
CreateCustomAvailabilityZoneRequest::CreateCustomAvailabilityZoneRequest()
    : RdsRequest(new CreateCustomAvailabilityZoneRequestPrivate(RdsRequest::CreateCustomAvailabilityZoneAction, this))
{
 ...
 * \reimp
 */
bool CreateCustomAvailabilityZoneRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateCustomAvailabilityZoneResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateCustomAvailabilityZoneRequest::response(QNetworkReply * const reply) const
{
    return new CreateCustomAvailabilityZoneResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::CreateCustomAvailabilityZoneRequestPrivate
 * \brief The CreateCustomAvailabilityZoneRequestPrivate class provides private implementation for CreateCustomAvailabilityZoneRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a CreateCustomAvailabilityZoneRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
CreateCustomAvailabilityZoneRequestPrivate::CreateCustomAvailabilityZoneRequestPrivate(
    const RdsRequest::Action action, CreateCustomAvailabilityZoneRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateCustomAvailabilityZoneRequest
 * class' copy constructor.
 */
CreateCustomAvailabilityZoneRequestPrivate::CreateCustomAvailabilityZoneRequestPrivate(
    const CreateCustomAvailabilityZoneRequestPrivate &other, CreateCustomAvailabilityZoneRequest * const q)
