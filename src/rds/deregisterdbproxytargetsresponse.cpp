...
#include "deregisterdbproxytargetsresponse_p.h"
...
/*!
 * Constructs a DeregisterDBProxyTargetsResponse object for \a reply to \a request, with parent \a parent.
 */
DeregisterDBProxyTargetsResponse::DeregisterDBProxyTargetsResponse(
        const DeregisterDBProxyTargetsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new DeregisterDBProxyTargetsResponsePrivate(this), parent)
{
    setRequest(new DeregisterDBProxyTargetsRequest(request));
    setReply(reply);
}
...
{
    //Q_D(DeregisterDBProxyTargetsResponse);
...
/*!
 * Constructs a DeregisterDBProxyTargetsResponsePrivate object with public implementation \a q.
 */
DeregisterDBProxyTargetsResponsePrivate::DeregisterDBProxyTargetsResponsePrivate(
    DeregisterDBProxyTargetsResponse * const q) : RdsResponsePrivate(q)
{
...
{
    Q_ASSERT(xml.name() == QLatin1String("DeregisterDBProxyTargetsResponse"));
    Q_UNUSED(xml) ///< @todo
}
