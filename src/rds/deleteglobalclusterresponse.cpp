...
/*!
 * \class QtAws::RDS::DeleteGlobalClusterResponse
 * \brief The DeleteGlobalClusterResponse class provides an interace for RDS DeleteGlobalCluster responses.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::deleteGlobalCluster
 */
...
DeleteGlobalClusterResponse::DeleteGlobalClusterResponse(
    ...
    : RdsResponse(new DeleteGlobalClusterResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteGlobalClusterRequest *>(RdsResponse::request());
}

/*!
 * \reimp
 * Parses a successful RDS DeleteGlobalCluster \a response.
 */
...
/*!
 * \class QtAws::RDS::DeleteGlobalClusterResponsePrivate
...
DeleteGlobalClusterResponsePrivate::DeleteGlobalClusterResponsePrivate(
    DeleteGlobalClusterResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS DeleteGlobalCluster response element from \a xml.
 */
