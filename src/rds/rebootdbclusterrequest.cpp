...
#include "rebootdbclusterrequest_p.h"
...
/*!
 * \class QtAws::Rds::RebootDBClusterRequest
 * \brief The RebootDBClusterRequest class provides an interface for Rds RebootDBCluster requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 */
RebootDBClusterRequest::RebootDBClusterRequest(const RebootDBClusterRequest &other)
    : RdsRequest(new RebootDBClusterRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a RebootDBClusterRequest object.
 */
RebootDBClusterRequest::RebootDBClusterRequest()
    : RdsRequest(new RebootDBClusterRequestPrivate(RdsRequest::RebootDBClusterAction, this))
{
 ...
 * \reimp
 */
bool RebootDBClusterRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a RebootDBClusterResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * RebootDBClusterRequest::response(QNetworkReply * const reply) const
{
    return new RebootDBClusterResponse(*this, reply);
}

/*!
 * \class QtAws::Rds::RebootDBClusterRequestPrivate
 * \brief The RebootDBClusterRequestPrivate class provides private implementation for RebootDBClusterRequest.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a RebootDBClusterRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
RebootDBClusterRequestPrivate::RebootDBClusterRequestPrivate(
    const RdsRequest::Action action, RebootDBClusterRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the RebootDBClusterRequest
 * class' copy constructor.
 */
RebootDBClusterRequestPrivate::RebootDBClusterRequestPrivate(
    const RebootDBClusterRequestPrivate &other, RebootDBClusterRequest * const q)
