...
/*!
 * \class QtAws::Rds::DescribeDBClusterEndpointsRequest
 * \brief The DescribeDBClusterEndpointsRequest class provides an interface for Rds DescribeDBClusterEndpoints requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::describeDBClusterEndpoints
 */
...
DescribeDBClusterEndpointsRequest::DescribeDBClusterEndpointsRequest(const DescribeDBClusterEndpointsRequest &other)
    : RdsRequest(new DescribeDBClusterEndpointsRequestPrivate(*other.d_func(), this))
{
...
DescribeDBClusterEndpointsRequest::DescribeDBClusterEndpointsRequest()
    : RdsRequest(new DescribeDBClusterEndpointsRequestPrivate(RdsRequest::DescribeDBClusterEndpointsAction, this))
{
...
/*!
 * \class QtAws::Rds::DescribeDBClusterEndpointsRequestPrivate
...
/*!
 * Constructs a DescribeDBClusterEndpointsRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DescribeDBClusterEndpointsRequestPrivate::DescribeDBClusterEndpointsRequestPrivate(
    const RdsRequest::Action action, DescribeDBClusterEndpointsRequest * const q)
