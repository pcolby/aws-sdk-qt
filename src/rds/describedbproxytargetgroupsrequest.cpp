...
#include "describedbproxytargetgroupsrequest_p.h"
...
/*!
 * \class QtAws::RDS::DescribeDBProxyTargetGroupsRequest
 * \brief The DescribeDBProxyTargetGroupsRequest class provides an interface for RDS DescribeDBProxyTargetGroups requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::describeDBProxyTargetGroups
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeDBProxyTargetGroupsRequest::DescribeDBProxyTargetGroupsRequest(const DescribeDBProxyTargetGroupsRequest &other)
    : RdsRequest(new DescribeDBProxyTargetGroupsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeDBProxyTargetGroupsRequest object.
 */
DescribeDBProxyTargetGroupsRequest::DescribeDBProxyTargetGroupsRequest()
    : RdsRequest(new DescribeDBProxyTargetGroupsRequestPrivate(RdsRequest::DescribeDBProxyTargetGroupsAction, this))
{
 ...
 * \reimp
 */
bool DescribeDBProxyTargetGroupsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeDBProxyTargetGroupsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeDBProxyTargetGroupsRequest::response(QNetworkReply * const reply) const
{
    return new DescribeDBProxyTargetGroupsResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::DescribeDBProxyTargetGroupsRequestPrivate
 * \brief The DescribeDBProxyTargetGroupsRequestPrivate class provides private implementation for DescribeDBProxyTargetGroupsRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a DescribeDBProxyTargetGroupsRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DescribeDBProxyTargetGroupsRequestPrivate::DescribeDBProxyTargetGroupsRequestPrivate(
    const RdsRequest::Action action, DescribeDBProxyTargetGroupsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeDBProxyTargetGroupsRequest
 * class' copy constructor.
 */
DescribeDBProxyTargetGroupsRequestPrivate::DescribeDBProxyTargetGroupsRequestPrivate(
    const DescribeDBProxyTargetGroupsRequestPrivate &other, DescribeDBProxyTargetGroupsRequest * const q)
