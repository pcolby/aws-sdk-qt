...
#include "describedbclusterbacktracksrequest_p.h"
...
/*!
 * \class QtAws::Rds::DescribeDBClusterBacktracksRequest
 * \brief The DescribeDBClusterBacktracksRequest class provides an interface for Rds DescribeDBClusterBacktracks requests.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::describeDBClusterBacktracks
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeDBClusterBacktracksRequest::DescribeDBClusterBacktracksRequest(const DescribeDBClusterBacktracksRequest &other)
    : RdsRequest(new DescribeDBClusterBacktracksRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeDBClusterBacktracksRequest object.
 */
DescribeDBClusterBacktracksRequest::DescribeDBClusterBacktracksRequest()
    : RdsRequest(new DescribeDBClusterBacktracksRequestPrivate(RdsRequest::DescribeDBClusterBacktracksAction, this))
{
 ...
 * \reimp
 */
bool DescribeDBClusterBacktracksRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeDBClusterBacktracksResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeDBClusterBacktracksRequest::response(QNetworkReply * const reply) const
{
    return new DescribeDBClusterBacktracksResponse(*this, reply);
}

/*!
 * \class QtAws::Rds::DescribeDBClusterBacktracksRequestPrivate
 * \brief The DescribeDBClusterBacktracksRequestPrivate class provides private implementation for DescribeDBClusterBacktracksRequest.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a DescribeDBClusterBacktracksRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DescribeDBClusterBacktracksRequestPrivate::DescribeDBClusterBacktracksRequestPrivate(
    const RdsRequest::Action action, DescribeDBClusterBacktracksRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeDBClusterBacktracksRequest
 * class' copy constructor.
 */
DescribeDBClusterBacktracksRequestPrivate::DescribeDBClusterBacktracksRequestPrivate(
    const DescribeDBClusterBacktracksRequestPrivate &other, DescribeDBClusterBacktracksRequest * const q)
