...
#include "startactivitystreamrequest_p.h"
...
/*!
 * \class QtAws::RDS::StartActivityStreamRequest
 * \brief The StartActivityStreamRequest class provides an interface for RDS StartActivityStream requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::startActivityStream
 */

/*!
 * Constructs a copy of \a other.
 */
StartActivityStreamRequest::StartActivityStreamRequest(const StartActivityStreamRequest &other)
    : RdsRequest(new StartActivityStreamRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a StartActivityStreamRequest object.
 */
StartActivityStreamRequest::StartActivityStreamRequest()
    : RdsRequest(new StartActivityStreamRequestPrivate(RdsRequest::StartActivityStreamAction, this))
{
 ...
 * \reimp
 */
bool StartActivityStreamRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a StartActivityStreamResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * StartActivityStreamRequest::response(QNetworkReply * const reply) const
{
    return new StartActivityStreamResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::StartActivityStreamRequestPrivate
 * \brief The StartActivityStreamRequestPrivate class provides private implementation for StartActivityStreamRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a StartActivityStreamRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
StartActivityStreamRequestPrivate::StartActivityStreamRequestPrivate(
    const RdsRequest::Action action, StartActivityStreamRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the StartActivityStreamRequest
 * class' copy constructor.
 */
StartActivityStreamRequestPrivate::StartActivityStreamRequestPrivate(
    const StartActivityStreamRequestPrivate &other, StartActivityStreamRequest * const q)
