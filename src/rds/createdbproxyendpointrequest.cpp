...
#include "createdbproxyendpointrequest_p.h"
 ...
 */
CreateDBProxyEndpointRequest::CreateDBProxyEndpointRequest(const CreateDBProxyEndpointRequest &other)
    : RdsRequest(new CreateDBProxyEndpointRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateDBProxyEndpointRequest object.
 */
CreateDBProxyEndpointRequest::CreateDBProxyEndpointRequest()
    : RdsRequest(new CreateDBProxyEndpointRequestPrivate(RdsRequest::CreateDBProxyEndpointAction, this))
{
 ...
 * \reimp
 */
bool CreateDBProxyEndpointRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateDBProxyEndpointResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateDBProxyEndpointRequest::response(QNetworkReply * const reply) const
{
    return new CreateDBProxyEndpointResponse(*this, reply);
}
...
/*!
 * Constructs a CreateDBProxyEndpointRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
CreateDBProxyEndpointRequestPrivate::CreateDBProxyEndpointRequestPrivate(
    const RdsRequest::Action action, CreateDBProxyEndpointRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateDBProxyEndpointRequest
 * class' copy constructor.
 */
CreateDBProxyEndpointRequestPrivate::CreateDBProxyEndpointRequestPrivate(
    const CreateDBProxyEndpointRequestPrivate &other, CreateDBProxyEndpointRequest * const q)
