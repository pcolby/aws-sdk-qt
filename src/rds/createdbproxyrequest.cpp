...
#include "createdbproxyrequest_p.h"
...
/*!
 * \class QtAws::RDS::CreateDBProxyRequest
 * \brief The CreateDBProxyRequest class provides an interface for RDS CreateDBProxy requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::createDBProxy
 */

/*!
 * Constructs a copy of \a other.
 */
CreateDBProxyRequest::CreateDBProxyRequest(const CreateDBProxyRequest &other)
    : RdsRequest(new CreateDBProxyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateDBProxyRequest object.
 */
CreateDBProxyRequest::CreateDBProxyRequest()
    : RdsRequest(new CreateDBProxyRequestPrivate(RdsRequest::CreateDBProxyAction, this))
{
 ...
 * \reimp
 */
bool CreateDBProxyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateDBProxyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateDBProxyRequest::response(QNetworkReply * const reply) const
{
    return new CreateDBProxyResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::CreateDBProxyRequestPrivate
 * \brief The CreateDBProxyRequestPrivate class provides private implementation for CreateDBProxyRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a CreateDBProxyRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
CreateDBProxyRequestPrivate::CreateDBProxyRequestPrivate(
    const RdsRequest::Action action, CreateDBProxyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateDBProxyRequest
 * class' copy constructor.
 */
CreateDBProxyRequestPrivate::CreateDBProxyRequestPrivate(
    const CreateDBProxyRequestPrivate &other, CreateDBProxyRequest * const q)
