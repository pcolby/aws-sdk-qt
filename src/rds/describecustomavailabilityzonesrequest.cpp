...
#include "describecustomavailabilityzonesrequest_p.h"
...
/*!
 * \class QtAws::RDS::DescribeCustomAvailabilityZonesRequest
 * \brief The DescribeCustomAvailabilityZonesRequest class provides an interface for RDS DescribeCustomAvailabilityZones requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::describeCustomAvailabilityZones
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeCustomAvailabilityZonesRequest::DescribeCustomAvailabilityZonesRequest(const DescribeCustomAvailabilityZonesRequest &other)
    : RdsRequest(new DescribeCustomAvailabilityZonesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeCustomAvailabilityZonesRequest object.
 */
DescribeCustomAvailabilityZonesRequest::DescribeCustomAvailabilityZonesRequest()
    : RdsRequest(new DescribeCustomAvailabilityZonesRequestPrivate(RdsRequest::DescribeCustomAvailabilityZonesAction, this))
{
 ...
 * \reimp
 */
bool DescribeCustomAvailabilityZonesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeCustomAvailabilityZonesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeCustomAvailabilityZonesRequest::response(QNetworkReply * const reply) const
{
    return new DescribeCustomAvailabilityZonesResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::DescribeCustomAvailabilityZonesRequestPrivate
 * \brief The DescribeCustomAvailabilityZonesRequestPrivate class provides private implementation for DescribeCustomAvailabilityZonesRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a DescribeCustomAvailabilityZonesRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
DescribeCustomAvailabilityZonesRequestPrivate::DescribeCustomAvailabilityZonesRequestPrivate(
    const RdsRequest::Action action, DescribeCustomAvailabilityZonesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeCustomAvailabilityZonesRequest
 * class' copy constructor.
 */
DescribeCustomAvailabilityZonesRequestPrivate::DescribeCustomAvailabilityZonesRequestPrivate(
    const DescribeCustomAvailabilityZonesRequestPrivate &other, DescribeCustomAvailabilityZonesRequest * const q)
