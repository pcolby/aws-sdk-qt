...
/*!
 * \class QtAws::RDS::ModifyGlobalClusterRequest
 * \brief The ModifyGlobalClusterRequest class provides an interface for RDS ModifyGlobalCluster requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::modifyGlobalCluster
 */
...
ModifyGlobalClusterRequest::ModifyGlobalClusterRequest(const ModifyGlobalClusterRequest &other)
    : RdsRequest(new ModifyGlobalClusterRequestPrivate(*other.d_func(), this))
{
...
ModifyGlobalClusterRequest::ModifyGlobalClusterRequest()
    : RdsRequest(new ModifyGlobalClusterRequestPrivate(RdsRequest::ModifyGlobalClusterAction, this))
{
...
/*!
 * \class QtAws::RDS::ModifyGlobalClusterRequestPrivate
...
/*!
 * Constructs a ModifyGlobalClusterRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
ModifyGlobalClusterRequestPrivate::ModifyGlobalClusterRequestPrivate(
    const RdsRequest::Action action, ModifyGlobalClusterRequest * const q)
