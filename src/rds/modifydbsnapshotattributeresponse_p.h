...
class QTAWS_EXPORT ModifyDBSnapshotAttributeResponsePrivate : public RdsResponsePrivate {

public:

    ModifyDBSnapshotAttributeResponsePrivate(ModifyDBSnapshotAttributeResponse * const q);
