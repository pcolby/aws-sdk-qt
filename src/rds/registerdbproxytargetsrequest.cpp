...
#include "registerdbproxytargetsrequest_p.h"
 ...
 */
RegisterDBProxyTargetsRequest::RegisterDBProxyTargetsRequest(const RegisterDBProxyTargetsRequest &other)
    : RdsRequest(new RegisterDBProxyTargetsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a RegisterDBProxyTargetsRequest object.
 */
RegisterDBProxyTargetsRequest::RegisterDBProxyTargetsRequest()
    : RdsRequest(new RegisterDBProxyTargetsRequestPrivate(RdsRequest::RegisterDBProxyTargetsAction, this))
{
 ...
 * \reimp
 */
bool RegisterDBProxyTargetsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a RegisterDBProxyTargetsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * RegisterDBProxyTargetsRequest::response(QNetworkReply * const reply) const
{
    return new RegisterDBProxyTargetsResponse(*this, reply);
}
...
/*!
 * Constructs a RegisterDBProxyTargetsRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
RegisterDBProxyTargetsRequestPrivate::RegisterDBProxyTargetsRequestPrivate(
    const RdsRequest::Action action, RegisterDBProxyTargetsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the RegisterDBProxyTargetsRequest
 * class' copy constructor.
 */
RegisterDBProxyTargetsRequestPrivate::RegisterDBProxyTargetsRequestPrivate(
    const RegisterDBProxyTargetsRequestPrivate &other, RegisterDBProxyTargetsRequest * const q)
