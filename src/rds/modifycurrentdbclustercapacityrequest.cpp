...
#include "modifycurrentdbclustercapacityrequest_p.h"
 ...
 *
 * \sa RdsClient::modifyCurrentDBClusterCapacity
 */

/*!
 * Constructs a copy of \a other.
 */
ModifyCurrentDBClusterCapacityRequest::ModifyCurrentDBClusterCapacityRequest(const ModifyCurrentDBClusterCapacityRequest &other)
    : RdsRequest(new ModifyCurrentDBClusterCapacityRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ModifyCurrentDBClusterCapacityRequest object.
 */
ModifyCurrentDBClusterCapacityRequest::ModifyCurrentDBClusterCapacityRequest()
    : RdsRequest(new ModifyCurrentDBClusterCapacityRequestPrivate(RdsRequest::ModifyCurrentDBClusterCapacityAction, this))
{
 ...
 * \reimp
 */
bool ModifyCurrentDBClusterCapacityRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ModifyCurrentDBClusterCapacityResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ModifyCurrentDBClusterCapacityRequest::response(QNetworkReply * const reply) const
{
    return new ModifyCurrentDBClusterCapacityResponse(*this, reply);
}
...
/*!
 * Constructs a ModifyCurrentDBClusterCapacityRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
ModifyCurrentDBClusterCapacityRequestPrivate::ModifyCurrentDBClusterCapacityRequestPrivate(
    const RdsRequest::Action action, ModifyCurrentDBClusterCapacityRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ModifyCurrentDBClusterCapacityRequest
 * class' copy constructor.
 */
ModifyCurrentDBClusterCapacityRequestPrivate::ModifyCurrentDBClusterCapacityRequestPrivate(
    const ModifyCurrentDBClusterCapacityRequestPrivate &other, ModifyCurrentDBClusterCapacityRequest * const q)
