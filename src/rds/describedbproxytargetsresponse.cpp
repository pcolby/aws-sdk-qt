...
#include "describedbproxytargetsresponse_p.h"
...
/*!
 * \class QtAws::Rds::DescribeDBProxyTargetsResponse
 * \brief The DescribeDBProxyTargetsResponse class provides an interace for Rds DescribeDBProxyTargets responses.
 *
 * \inmodule QtAwsRds
 *
 ...
 *
 * \sa RdsClient::describeDBProxyTargets
 */

/*!
 * Constructs a DescribeDBProxyTargetsResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeDBProxyTargetsResponse::DescribeDBProxyTargetsResponse(
        const DescribeDBProxyTargetsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new DescribeDBProxyTargetsResponsePrivate(this), parent)
{
    setRequest(new DescribeDBProxyTargetsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DescribeDBProxyTargetsRequest * DescribeDBProxyTargetsResponse::request() const
{
    Q_D(const DescribeDBProxyTargetsResponse);
    return static_cast<const DescribeDBProxyTargetsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Rds DescribeDBProxyTargets \a response.
 */
void DescribeDBProxyTargetsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeDBProxyTargetsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Rds::DescribeDBProxyTargetsResponsePrivate
 * \brief The DescribeDBProxyTargetsResponsePrivate class provides private implementation for DescribeDBProxyTargetsResponse.
 * \internal
 *
 * \inmodule QtAwsRds
 */
...
/*!
 * Constructs a DescribeDBProxyTargetsResponsePrivate object with public implementation \a q.
 */
DescribeDBProxyTargetsResponsePrivate::DescribeDBProxyTargetsResponsePrivate(
    DescribeDBProxyTargetsResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a Rds DescribeDBProxyTargets response element from \a xml.
 */
void DescribeDBProxyTargetsResponsePrivate::parseDescribeDBProxyTargetsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeDBProxyTargetsResponse"));
    Q_UNUSED(xml) ///< @todo
}
