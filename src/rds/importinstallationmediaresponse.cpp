...
#include "importinstallationmediaresponse_p.h"
...
/*!
 * \class QtAws::RDS::ImportInstallationMediaResponse
 * \brief The ImportInstallationMediaResponse class provides an interace for RDS ImportInstallationMedia responses.
 *
 * \inmodule QtAwsRDS
 *
...
/*!
 * Constructs a ImportInstallationMediaResponse object for \a reply to \a request, with parent \a parent.
 */
ImportInstallationMediaResponse::ImportInstallationMediaResponse(
        const ImportInstallationMediaRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new ImportInstallationMediaResponsePrivate(this), parent)
{
    setRequest(new ImportInstallationMediaRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful RDS ImportInstallationMedia \a response.
 */
void ImportInstallationMediaResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ImportInstallationMediaResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::RDS::ImportInstallationMediaResponsePrivate
 * \brief The ImportInstallationMediaResponsePrivate class provides private implementation for ImportInstallationMediaResponse.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a ImportInstallationMediaResponsePrivate object with public implementation \a q.
 */
ImportInstallationMediaResponsePrivate::ImportInstallationMediaResponsePrivate(
    ImportInstallationMediaResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS ImportInstallationMedia response element from \a xml.
 */
void ImportInstallationMediaResponsePrivate::parseImportInstallationMediaResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ImportInstallationMediaResponse"));
    Q_UNUSED(xml) ///< @todo
}
