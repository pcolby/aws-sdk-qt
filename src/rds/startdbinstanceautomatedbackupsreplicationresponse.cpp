...
#include "startdbinstanceautomatedbackupsreplicationresponse_p.h"
...
/*!
 * Constructs a StartDBInstanceAutomatedBackupsReplicationResponse object for \a reply to \a request, with parent \a parent.
 */
StartDBInstanceAutomatedBackupsReplicationResponse::StartDBInstanceAutomatedBackupsReplicationResponse(
        const StartDBInstanceAutomatedBackupsReplicationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new StartDBInstanceAutomatedBackupsReplicationResponsePrivate(this), parent)
{
    setRequest(new StartDBInstanceAutomatedBackupsReplicationRequest(request));
    setReply(reply);
}
...
{
    //Q_D(StartDBInstanceAutomatedBackupsReplicationResponse);
...
/*!
 * Constructs a StartDBInstanceAutomatedBackupsReplicationResponsePrivate object with public implementation \a q.
 */
StartDBInstanceAutomatedBackupsReplicationResponsePrivate::StartDBInstanceAutomatedBackupsReplicationResponsePrivate(
    StartDBInstanceAutomatedBackupsReplicationResponse * const q) : RdsResponsePrivate(q)
{
...
{
    Q_ASSERT(xml.name() == QLatin1String("StartDBInstanceAutomatedBackupsReplicationResponse"));
    Q_UNUSED(xml) ///< @todo
}
