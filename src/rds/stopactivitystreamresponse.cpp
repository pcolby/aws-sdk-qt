...
#include "stopactivitystreamresponse_p.h"
...
/*!
 * \class QtAws::RDS::StopActivityStreamResponse
 * \brief The StopActivityStreamResponse class provides an interace for RDS StopActivityStream responses.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::stopActivityStream
 */

/*!
 * Constructs a StopActivityStreamResponse object for \a reply to \a request, with parent \a parent.
 */
StopActivityStreamResponse::StopActivityStreamResponse(
        const StopActivityStreamRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new StopActivityStreamResponsePrivate(this), parent)
{
    setRequest(new StopActivityStreamRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful RDS StopActivityStream \a response.
 */
void StopActivityStreamResponse::parseSuccess(QIODevice &response)
{
    //Q_D(StopActivityStreamResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::RDS::StopActivityStreamResponsePrivate
 * \brief The StopActivityStreamResponsePrivate class provides private implementation for StopActivityStreamResponse.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a StopActivityStreamResponsePrivate object with public implementation \a q.
 */
StopActivityStreamResponsePrivate::StopActivityStreamResponsePrivate(
    StopActivityStreamResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS StopActivityStream response element from \a xml.
 */
void StopActivityStreamResponsePrivate::parseStopActivityStreamResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("StopActivityStreamResponse"));
    Q_UNUSED(xml) ///< @todo
}
