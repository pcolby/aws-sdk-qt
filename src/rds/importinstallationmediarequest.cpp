...
#include "importinstallationmediarequest_p.h"
...
/*!
 * \class QtAws::RDS::ImportInstallationMediaRequest
 * \brief The ImportInstallationMediaRequest class provides an interface for RDS ImportInstallationMedia requests.
 *
 * \inmodule QtAwsRDS
 *
 ...
 *
 * \sa RdsClient::importInstallationMedia
 */

/*!
 * Constructs a copy of \a other.
 */
ImportInstallationMediaRequest::ImportInstallationMediaRequest(const ImportInstallationMediaRequest &other)
    : RdsRequest(new ImportInstallationMediaRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ImportInstallationMediaRequest object.
 */
ImportInstallationMediaRequest::ImportInstallationMediaRequest()
    : RdsRequest(new ImportInstallationMediaRequestPrivate(RdsRequest::ImportInstallationMediaAction, this))
{
 ...
 * \reimp
 */
bool ImportInstallationMediaRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ImportInstallationMediaResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ImportInstallationMediaRequest::response(QNetworkReply * const reply) const
{
    return new ImportInstallationMediaResponse(*this, reply);
}

/*!
 * \class QtAws::RDS::ImportInstallationMediaRequestPrivate
 * \brief The ImportInstallationMediaRequestPrivate class provides private implementation for ImportInstallationMediaRequest.
 * \internal
 *
 * \inmodule QtAwsRDS
 */
...
/*!
 * Constructs a ImportInstallationMediaRequestPrivate object for Rds \a action,
 * with public implementation \a q.
 */
ImportInstallationMediaRequestPrivate::ImportInstallationMediaRequestPrivate(
    const RdsRequest::Action action, ImportInstallationMediaRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ImportInstallationMediaRequest
 * class' copy constructor.
 */
ImportInstallationMediaRequestPrivate::ImportInstallationMediaRequestPrivate(
    const ImportInstallationMediaRequestPrivate &other, ImportInstallationMediaRequest * const q)
