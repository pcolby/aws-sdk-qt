...
#include "addroletodbinstanceresponse_p.h"
...
/*!
 * Constructs a AddRoleToDBInstanceResponse object for \a reply to \a request, with parent \a parent.
 */
AddRoleToDBInstanceResponse::AddRoleToDBInstanceResponse(
        const AddRoleToDBInstanceRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : RdsResponse(new AddRoleToDBInstanceResponsePrivate(this), parent)
{
    setRequest(new AddRoleToDBInstanceRequest(request));
    setReply(reply);
}
...
{
    //Q_D(AddRoleToDBInstanceResponse);
...
/*!
 * Constructs a AddRoleToDBInstanceResponsePrivate object with public implementation \a q.
 */
AddRoleToDBInstanceResponsePrivate::AddRoleToDBInstanceResponsePrivate(
    AddRoleToDBInstanceResponse * const q) : RdsResponsePrivate(q)
{
...
{
    Q_ASSERT(xml.name() == QLatin1String("AddRoleToDBInstanceResponse"));
    Q_UNUSED(xml) ///< @todo
}
