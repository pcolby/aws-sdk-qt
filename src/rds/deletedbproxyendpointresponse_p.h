...
class QTAWS_EXPORT DeleteDBProxyEndpointResponsePrivate : public RdsResponsePrivate {

public:

    DeleteDBProxyEndpointResponsePrivate(DeleteDBProxyEndpointResponse * const q);
