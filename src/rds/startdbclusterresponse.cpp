...
/*!
 * \class QtAws::RDS::StartDBClusterResponse
 * \brief The StartDBClusterResponse class provides an interace for RDS StartDBCluster responses.
 *
 * \inmodule QtAwsRDS
 *
...
StartDBClusterResponse::StartDBClusterResponse(
    ...
    : RdsResponse(new StartDBClusterResponsePrivate(this), parent)
{
...
{
    return static_cast<const StartDBClusterRequest *>(RdsResponse::request());
}

/*!
 * \reimp
 * Parses a successful RDS StartDBCluster \a response.
 */
...
/*!
 * \class QtAws::RDS::StartDBClusterResponsePrivate
...
StartDBClusterResponsePrivate::StartDBClusterResponsePrivate(
    StartDBClusterResponse * const q) : RdsResponsePrivate(q)
{

}

/*!
 * Parses a RDS StartDBCluster response element from \a xml.
 */
