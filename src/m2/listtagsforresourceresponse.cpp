...
/*!
 * \class QtAws::M2::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for M2 ListTagsForResource responses.
 *
 * \inmodule QtAwsM2
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : M2Response(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful M2 ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::M2::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : M2ResponsePrivate(q)
{

}

/*!
 * Parses a M2 ListTagsForResource response element from \a xml.
 */
