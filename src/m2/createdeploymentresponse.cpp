...
/*!
 * \class QtAws::M2::CreateDeploymentResponse
 * \brief The CreateDeploymentResponse class provides an interace for M2 CreateDeployment responses.
 *
 * \inmodule QtAwsM2
 *
...
CreateDeploymentResponse::CreateDeploymentResponse(
    ...
    : M2Response(new CreateDeploymentResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful M2 CreateDeployment \a response.
 */
...
/*!
 * \class QtAws::M2::CreateDeploymentResponsePrivate
...
CreateDeploymentResponsePrivate::CreateDeploymentResponsePrivate(
    CreateDeploymentResponse * const q) : M2ResponsePrivate(q)
{

}

/*!
 * Parses a M2 CreateDeployment response element from \a xml.
 */
