...
/*!
 * \class QtAws::M2::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for M2 TagResource responses.
 *
 * \inmodule QtAwsM2
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : M2Response(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful M2 TagResource \a response.
 */
...
/*!
 * \class QtAws::M2::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : M2ResponsePrivate(q)
{

}

/*!
 * Parses a M2 TagResource response element from \a xml.
 */
