...
class QTAWS_EXPORT DescribeElasticsearchDomainsResponse : public DescribeElasticsearchDomainsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeElasticsearchDomainsRequest * request() const;
