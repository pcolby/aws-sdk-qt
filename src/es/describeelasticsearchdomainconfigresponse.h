...
class QTAWS_EXPORT DescribeElasticsearchDomainConfigResponse : public ElasticsearchServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeElasticsearchDomainConfigRequest * request() const override;
