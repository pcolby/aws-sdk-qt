 ...
 * @param  q       Pointer to this object's public ElasticsearchServiceRequest instance.
 */
 ...
 * @internal
 *
 * @brief  Constructs a new ElasticsearchServiceRequestPrivate object from an existing one.
 *
