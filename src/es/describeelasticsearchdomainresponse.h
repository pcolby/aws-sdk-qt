...
class QTAWS_EXPORT DescribeElasticsearchDomainResponse : public DescribeElasticsearchDomainResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeElasticsearchDomainRequest * request() const;
