...
class QTAWS_EXPORT DescribeElasticsearchDomainResponse : public ElasticsearchServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeElasticsearchDomainRequest * request() const override;
