...
/*!
 * \class QtAws::ChimeSdkMessaging::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for ChimeSdkMessaging ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ChimeSdkMessagingResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ChimeSdkMessaging ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::ChimeSdkMessaging::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ChimeSdkMessagingResponsePrivate(q)
{

}

/*!
 * Parses a ChimeSdkMessaging ListTagsForResource response element from \a xml.
 */
