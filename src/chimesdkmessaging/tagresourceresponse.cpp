...
/*!
 * \class QtAws::ChimeSdkMessaging::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for ChimeSdkMessaging TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ChimeSdkMessagingResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ChimeSdkMessaging TagResource \a response.
 */
...
/*!
 * \class QtAws::ChimeSdkMessaging::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ChimeSdkMessagingResponsePrivate(q)
{

}

/*!
 * Parses a ChimeSdkMessaging TagResource response element from \a xml.
 */
