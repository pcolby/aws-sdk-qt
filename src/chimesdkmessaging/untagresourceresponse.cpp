...
/*!
 * \class QtAws::ChimeSdkMessaging::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for ChimeSdkMessaging UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : ChimeSdkMessagingResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ChimeSdkMessaging UntagResource \a response.
 */
...
/*!
 * \class QtAws::ChimeSdkMessaging::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : ChimeSdkMessagingResponsePrivate(q)
{

}

/*!
 * Parses a ChimeSdkMessaging UntagResource response element from \a xml.
 */
