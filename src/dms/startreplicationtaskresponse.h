...
class QTAWS_EXPORT StartReplicationTaskResponse : public DatabaseMigrationServiceResponse {
    Q_OBJECT

public:
    StartReplicationTaskResponse(const StartReplicationTaskRequest &request, QNetworkReply * const reply, QObject * const parent = 0);

    virtual const StartReplicationTaskRequest * request() const override;
