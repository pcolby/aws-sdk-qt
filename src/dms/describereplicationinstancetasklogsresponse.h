...
class QTAWS_EXPORT DescribeReplicationInstanceTaskLogsResponse : public DescribeReplicationInstanceTaskLogsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeReplicationInstanceTaskLogsRequest * request() const;
