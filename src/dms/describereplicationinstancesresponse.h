...
class QTAWS_EXPORT DescribeReplicationInstancesResponse : public DescribeReplicationInstancesResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeReplicationInstancesRequest * request() const;
