...
class QTAWS_EXPORT DeleteReplicationInstanceResponse : public DatabaseMigrationServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteReplicationInstanceRequest * request() const override;
