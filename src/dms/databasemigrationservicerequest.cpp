 ...
 * @param  q       Pointer to this object's public DatabaseMigrationServiceRequest instance.
 */
 ...
 * @internal
 *
 * @brief  Constructs a new DatabaseMigrationServiceRequestPrivate object from an existing one.
 *
