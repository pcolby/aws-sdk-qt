...
class QTAWS_EXPORT DeleteEventSubscriptionResponse : public DatabaseMigrationServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteEventSubscriptionRequest * request() const override;
