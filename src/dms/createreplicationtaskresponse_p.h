...
class QTAWS_EXPORT CreateReplicationTaskResponsePrivate : public DatabaseMigrationServiceResponsePrivate {
    Q_OBJECT

public:

    CreateReplicationTaskResponsePrivate(CreateReplicationTaskResponse * const q);
