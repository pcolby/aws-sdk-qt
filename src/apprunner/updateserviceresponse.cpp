...
/*!
 * \class QtAws::AppRunner::UpdateServiceResponse
 * \brief The UpdateServiceResponse class provides an interace for AppRunner UpdateService responses.
 *
...
UpdateServiceResponse::UpdateServiceResponse(
    ...
    : AppRunnerResponse(new UpdateServiceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful AppRunner UpdateService \a response.
 */
...
/*!
 * \class QtAws::AppRunner::UpdateServiceResponsePrivate
...
UpdateServiceResponsePrivate::UpdateServiceResponsePrivate(
    UpdateServiceResponse * const q) : AppRunnerResponsePrivate(q)
{

}

/*!
 * Parses a AppRunner UpdateService response element from \a xml.
 */
