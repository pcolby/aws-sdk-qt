...
/*!
 * \class QtAws::AppRunner::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for AppRunner UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : AppRunnerRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : AppRunnerRequest(new UntagResourceRequestPrivate(AppRunnerRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::AppRunner::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for AppRunner \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const AppRunnerRequest::Action action, UntagResourceRequest * const q)
