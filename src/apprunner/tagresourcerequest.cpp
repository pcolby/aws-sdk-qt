...
/*!
 * \class QtAws::AppRunner::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for AppRunner TagResource requests.
 *
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : AppRunnerRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : AppRunnerRequest(new TagResourceRequestPrivate(AppRunnerRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::AppRunner::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for AppRunner \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const AppRunnerRequest::Action action, TagResourceRequest * const q)
