...
/*!
 * \class QtAws::AppRunner::DeleteConnectionResponse
 * \brief The DeleteConnectionResponse class provides an interace for AppRunner DeleteConnection responses.
 *
...
DeleteConnectionResponse::DeleteConnectionResponse(
    ...
    : AppRunnerResponse(new DeleteConnectionResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteConnectionRequest *>(AppRunnerResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppRunner DeleteConnection \a response.
 */
...
/*!
 * \class QtAws::AppRunner::DeleteConnectionResponsePrivate
...
DeleteConnectionResponsePrivate::DeleteConnectionResponsePrivate(
    DeleteConnectionResponse * const q) : AppRunnerResponsePrivate(q)
{

}

/*!
 * Parses a AppRunner DeleteConnection response element from \a xml.
 */
