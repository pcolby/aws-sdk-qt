...
class QTAWS_EXPORT DescribeAutoScalingConfigurationResponsePrivate : public AppRunnerResponsePrivate {

public:

    DescribeAutoScalingConfigurationResponsePrivate(DescribeAutoScalingConfigurationResponse * const q);
