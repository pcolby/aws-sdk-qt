...
/*!
 * \class QtAws::AppRunner::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for AppRunner UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : AppRunnerResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(AppRunnerResponse::request());
}

/*!
 * \reimp
 * Parses a successful AppRunner UntagResource \a response.
 */
...
/*!
 * \class QtAws::AppRunner::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : AppRunnerResponsePrivate(q)
{

}

/*!
 * Parses a AppRunner UntagResource response element from \a xml.
 */
