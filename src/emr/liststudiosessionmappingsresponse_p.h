...
class QTAWS_EXPORT ListStudioSessionMappingsResponsePrivate : public EmrResponsePrivate {

public:

    ListStudioSessionMappingsResponsePrivate(ListStudioSessionMappingsResponse * const q);
