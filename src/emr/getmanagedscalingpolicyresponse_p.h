...
class QTAWS_EXPORT GetManagedScalingPolicyResponsePrivate : public EmrResponsePrivate {

public:

    GetManagedScalingPolicyResponsePrivate(GetManagedScalingPolicyResponse * const q);
