...
#ifndef QTAWS_PUTBLOCKPUBLICACCESSCONFIGURATIONREQUEST_H
#define QTAWS_PUTBLOCKPUBLICACCESSCONFIGURATIONREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(PutBlockPublicAccessConfigurationRequest)
