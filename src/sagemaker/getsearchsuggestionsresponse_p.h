...
class QTAWS_EXPORT GetSearchSuggestionsResponsePrivate : public SageMakerResponsePrivate {

public:

    GetSearchSuggestionsResponsePrivate(GetSearchSuggestionsResponse * const q);
