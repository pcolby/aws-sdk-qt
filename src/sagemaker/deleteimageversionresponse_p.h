...
class QTAWS_EXPORT DeleteImageVersionResponsePrivate : public SageMakerResponsePrivate {

public:

    DeleteImageVersionResponsePrivate(DeleteImageVersionResponse * const q);
