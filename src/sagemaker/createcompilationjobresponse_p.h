...
class QTAWS_EXPORT CreateCompilationJobResponsePrivate : public SageMakerResponsePrivate {

public:

    CreateCompilationJobResponsePrivate(CreateCompilationJobResponse * const q);
