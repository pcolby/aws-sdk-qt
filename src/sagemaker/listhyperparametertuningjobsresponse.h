...
class QTAWSSAGEMAKER_EXPORT ListHyperParameterTuningJobsResponse : public SageMakerResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListHyperParameterTuningJobsRequest * request() const Q_DECL_OVERRIDE;
