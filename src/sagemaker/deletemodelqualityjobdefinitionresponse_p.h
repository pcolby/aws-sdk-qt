...
class QTAWS_EXPORT DeleteModelQualityJobDefinitionResponsePrivate : public SageMakerResponsePrivate {

public:

    DeleteModelQualityJobDefinitionResponsePrivate(DeleteModelQualityJobDefinitionResponse * const q);
