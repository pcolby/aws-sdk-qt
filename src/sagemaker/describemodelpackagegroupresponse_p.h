...
class QTAWS_EXPORT DescribeModelPackageGroupResponsePrivate : public SageMakerResponsePrivate {

public:

    DescribeModelPackageGroupResponsePrivate(DescribeModelPackageGroupResponse * const q);
