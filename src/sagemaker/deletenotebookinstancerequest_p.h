...
class QTAWS_EXPORT DeleteNotebookInstanceRequestPrivate : public SageMakerRequestPrivate {

public:
    DeleteNotebookInstanceRequestPrivate(const SageMaker::Action action,
