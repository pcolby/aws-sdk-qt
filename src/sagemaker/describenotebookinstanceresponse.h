...
class QTAWS_EXPORT DescribeNotebookInstanceResponse : public DescribeNotebookInstanceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeNotebookInstanceRequest * request() const;
