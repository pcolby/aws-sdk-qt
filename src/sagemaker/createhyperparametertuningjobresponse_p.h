...
class QTAWS_EXPORT CreateHyperParameterTuningJobResponsePrivate : public SageMakerResponsePrivate {

public:

    CreateHyperParameterTuningJobResponsePrivate(CreateHyperParameterTuningJobResponse * const q);
