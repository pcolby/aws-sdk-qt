...
class QTAWS_EXPORT DescribeModelPackageResponsePrivate : public SageMakerResponsePrivate {

public:

    DescribeModelPackageResponsePrivate(DescribeModelPackageResponse * const q);
