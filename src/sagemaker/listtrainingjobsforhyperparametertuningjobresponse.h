...
class QTAWS_EXPORT ListTrainingJobsForHyperParameterTuningJobResponse : public SageMakerResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListTrainingJobsForHyperParameterTuningJobRequest * request() const override;
