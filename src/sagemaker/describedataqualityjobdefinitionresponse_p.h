...
class QTAWS_EXPORT DescribeDataQualityJobDefinitionResponsePrivate : public SageMakerResponsePrivate {

public:

    DescribeDataQualityJobDefinitionResponsePrivate(DescribeDataQualityJobDefinitionResponse * const q);
