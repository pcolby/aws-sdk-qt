...
class QTAWS_EXPORT CreateTransformJobResponsePrivate : public SageMakerResponsePrivate {

public:

    CreateTransformJobResponsePrivate(CreateTransformJobResponse * const q);
