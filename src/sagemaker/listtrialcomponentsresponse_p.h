...
class QTAWS_EXPORT ListTrialComponentsResponsePrivate : public SageMakerResponsePrivate {

public:

    ListTrialComponentsResponsePrivate(ListTrialComponentsResponse * const q);
