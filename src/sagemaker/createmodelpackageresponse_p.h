...
class QTAWS_EXPORT CreateModelPackageResponsePrivate : public SageMakerResponsePrivate {

public:

    CreateModelPackageResponsePrivate(CreateModelPackageResponse * const q);
