...
class QTAWS_EXPORT DescribeHumanTaskUiResponsePrivate : public SageMakerResponsePrivate {

public:

    DescribeHumanTaskUiResponsePrivate(DescribeHumanTaskUiResponse * const q);
