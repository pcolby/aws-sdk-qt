...
class QTAWS_EXPORT DescribeSubscribedWorkteamResponsePrivate : public SageMakerResponsePrivate {

public:

    DescribeSubscribedWorkteamResponsePrivate(DescribeSubscribedWorkteamResponse * const q);
