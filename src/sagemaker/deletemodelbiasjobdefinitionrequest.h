...
#ifndef QTAWS_DELETEMODELBIASJOBDEFINITIONREQUEST_H
#define QTAWS_DELETEMODELBIASJOBDEFINITIONREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(DeleteModelBiasJobDefinitionRequest)
