...
class QTAWS_EXPORT CreateMonitoringScheduleResponsePrivate : public SageMakerResponsePrivate {

public:

    CreateMonitoringScheduleResponsePrivate(CreateMonitoringScheduleResponse * const q);
