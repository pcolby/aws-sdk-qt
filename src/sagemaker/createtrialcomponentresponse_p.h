...
class QTAWS_EXPORT CreateTrialComponentResponsePrivate : public SageMakerResponsePrivate {

public:

    CreateTrialComponentResponsePrivate(CreateTrialComponentResponse * const q);
