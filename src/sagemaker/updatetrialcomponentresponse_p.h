...
class QTAWS_EXPORT UpdateTrialComponentResponsePrivate : public SageMakerResponsePrivate {

public:

    UpdateTrialComponentResponsePrivate(UpdateTrialComponentResponse * const q);
