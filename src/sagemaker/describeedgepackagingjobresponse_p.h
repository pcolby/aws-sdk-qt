...
class QTAWS_EXPORT DescribeEdgePackagingJobResponsePrivate : public SageMakerResponsePrivate {

public:

    DescribeEdgePackagingJobResponsePrivate(DescribeEdgePackagingJobResponse * const q);
