...
class QTAWS_EXPORT DescribeModelQualityJobDefinitionResponsePrivate : public SageMakerResponsePrivate {

public:

    DescribeModelQualityJobDefinitionResponsePrivate(DescribeModelQualityJobDefinitionResponse * const q);
