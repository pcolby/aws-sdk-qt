...
class QTAWS_EXPORT CreateFeatureGroupResponsePrivate : public SageMakerResponsePrivate {

public:

    CreateFeatureGroupResponsePrivate(CreateFeatureGroupResponse * const q);
