...
class QTAWS_EXPORT ListEndpointConfigsResponsePrivate : public SageMakerResponsePrivate {

public:

    ListEndpointConfigsResponsePrivate(ListEndpointConfigsResponse * const q);
