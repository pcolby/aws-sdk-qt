...
class QTAWS_EXPORT ListPipelineExecutionStepsResponsePrivate : public SageMakerResponsePrivate {

public:

    ListPipelineExecutionStepsResponsePrivate(ListPipelineExecutionStepsResponse * const q);
