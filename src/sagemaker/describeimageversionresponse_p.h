...
class QTAWS_EXPORT DescribeImageVersionResponsePrivate : public SageMakerResponsePrivate {

public:

    DescribeImageVersionResponsePrivate(DescribeImageVersionResponse * const q);
