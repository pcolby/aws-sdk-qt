...
class QTAWS_EXPORT DeleteModelPackageGroupPolicyResponsePrivate : public SageMakerResponsePrivate {

public:

    DeleteModelPackageGroupPolicyResponsePrivate(DeleteModelPackageGroupPolicyResponse * const q);
