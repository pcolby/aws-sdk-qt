...
class QTAWS_EXPORT DescribeTransformJobResponsePrivate : public SageMakerResponsePrivate {

public:

    DescribeTransformJobResponsePrivate(DescribeTransformJobResponse * const q);
