...
class QTAWS_EXPORT DescribeHyperParameterTuningJobResponse : public SageMakerResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeHyperParameterTuningJobRequest * request() const override;
