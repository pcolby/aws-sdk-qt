...
class QTAWS_EXPORT ListCompilationJobsResponsePrivate : public SageMakerResponsePrivate {

public:

    ListCompilationJobsResponsePrivate(ListCompilationJobsResponse * const q);
