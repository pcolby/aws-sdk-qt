...
class QTAWS_EXPORT ListAppImageConfigsResponsePrivate : public SageMakerResponsePrivate {

public:

    ListAppImageConfigsResponsePrivate(ListAppImageConfigsResponse * const q);
