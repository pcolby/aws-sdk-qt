...
class QTAWS_EXPORT DescribeLabelingJobResponsePrivate : public SageMakerResponsePrivate {

public:

    DescribeLabelingJobResponsePrivate(DescribeLabelingJobResponse * const q);
