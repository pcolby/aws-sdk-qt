...
class QTAWS_EXPORT StopCompilationJobResponsePrivate : public SageMakerResponsePrivate {

public:

    StopCompilationJobResponsePrivate(StopCompilationJobResponse * const q);
