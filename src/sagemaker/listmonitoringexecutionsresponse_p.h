...
class QTAWS_EXPORT ListMonitoringExecutionsResponsePrivate : public SageMakerResponsePrivate {

public:

    ListMonitoringExecutionsResponsePrivate(ListMonitoringExecutionsResponse * const q);
