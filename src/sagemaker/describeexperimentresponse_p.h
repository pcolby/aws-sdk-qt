...
class QTAWS_EXPORT DescribeExperimentResponsePrivate : public SageMakerResponsePrivate {

public:

    DescribeExperimentResponsePrivate(DescribeExperimentResponse * const q);
