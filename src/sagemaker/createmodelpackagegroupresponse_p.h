...
class QTAWS_EXPORT CreateModelPackageGroupResponsePrivate : public SageMakerResponsePrivate {

public:

    CreateModelPackageGroupResponsePrivate(CreateModelPackageGroupResponse * const q);
