...
class QTAWS_EXPORT ListProcessingJobsResponsePrivate : public SageMakerResponsePrivate {

public:

    ListProcessingJobsResponsePrivate(ListProcessingJobsResponse * const q);
