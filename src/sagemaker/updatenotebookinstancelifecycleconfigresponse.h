...
class QTAWS_EXPORT UpdateNotebookInstanceLifecycleConfigResponse : public SageMakerResponse {
    Q_OBJECT
...
public:
    ...
    virtual const UpdateNotebookInstanceLifecycleConfigRequest * request() const override;
