...
class QTAWS_EXPORT DescribeDeviceFleetResponsePrivate : public SageMakerResponsePrivate {

public:

    DescribeDeviceFleetResponsePrivate(DescribeDeviceFleetResponse * const q);
