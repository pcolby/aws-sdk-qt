...
class QTAWS_EXPORT ListFlowDefinitionsResponsePrivate : public SageMakerResponsePrivate {

public:

    ListFlowDefinitionsResponsePrivate(ListFlowDefinitionsResponse * const q);
