...
class QTAWS_EXPORT CreateNotebookInstanceResponsePrivate : public SageMakerResponsePrivate {
    Q_OBJECT

public:

    CreateNotebookInstanceResponsePrivate(CreateNotebookInstanceResponse * const q);
