...
class QTAWS_EXPORT ListModelBiasJobDefinitionsResponsePrivate : public SageMakerResponsePrivate {

public:

    ListModelBiasJobDefinitionsResponsePrivate(ListModelBiasJobDefinitionsResponse * const q);
