...
class QTAWS_EXPORT ListNotebookInstanceLifecycleConfigsResponse : public ListNotebookInstanceLifecycleConfigsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListNotebookInstanceLifecycleConfigsRequest * request() const;
