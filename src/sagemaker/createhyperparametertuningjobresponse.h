...
class QTAWS_EXPORT CreateHyperParameterTuningJobResponse : public SageMakerResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateHyperParameterTuningJobRequest * request() const override;
