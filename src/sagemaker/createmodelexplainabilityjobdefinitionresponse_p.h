...
class QTAWS_EXPORT CreateModelExplainabilityJobDefinitionResponsePrivate : public SageMakerResponsePrivate {

public:

    CreateModelExplainabilityJobDefinitionResponsePrivate(CreateModelExplainabilityJobDefinitionResponse * const q);
