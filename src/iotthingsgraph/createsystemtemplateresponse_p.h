...
class QTAWS_EXPORT CreateSystemTemplateResponsePrivate : public IoTThingsGraphResponsePrivate {

public:

    CreateSystemTemplateResponsePrivate(CreateSystemTemplateResponse * const q);
