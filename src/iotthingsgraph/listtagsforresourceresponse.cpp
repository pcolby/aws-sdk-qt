...
/*!
 * \class QtAws::IoTThingsGraph::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for IoTThingsGraph ListTagsForResource responses.
 *
 ...
 *
 * \sa IoTThingsGraphClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : IoTThingsGraphResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(IoTThingsGraphResponse::request());
}

/*!
 * \reimp
 * Parses a successful IoTThingsGraph ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::IoTThingsGraph::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : IoTThingsGraphResponsePrivate(q)
{

}

/*!
 * Parses a IoTThingsGraph ListTagsForResource response element from \a xml.
 */
