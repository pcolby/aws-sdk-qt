...
class QTAWS_EXPORT GetFlowTemplateRevisionsResponsePrivate : public IoTThingsGraphResponsePrivate {

public:

    GetFlowTemplateRevisionsResponsePrivate(GetFlowTemplateRevisionsResponse * const q);
