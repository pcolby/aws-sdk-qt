...
class QTAWS_EXPORT SearchFlowTemplatesResponsePrivate : public IoTThingsGraphResponsePrivate {

public:

    SearchFlowTemplatesResponsePrivate(SearchFlowTemplatesResponse * const q);
