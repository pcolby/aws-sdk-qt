...
class QTAWS_EXPORT CreateSystemInstanceResponsePrivate : public IoTThingsGraphResponsePrivate {

public:

    CreateSystemInstanceResponsePrivate(CreateSystemInstanceResponse * const q);
