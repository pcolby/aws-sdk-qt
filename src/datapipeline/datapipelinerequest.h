...
#ifndef QTAWS_DATAPIPELINEREQUEST_H
#define QTAWS_DATAPIPELINEREQUEST_H
...
public:
    ...
    DataPipelineRequest(const Action action);
    DataPipelineRequest(const DataPipelineRequest &other);
    DataPipelineRequest &operator=(const DataPipelineRequest &other);
    ...
    virtual bool operator==(const DataPipelineRequest &other) const override;
...
private:
    Q_DECLARE_PRIVATE(DataPipelineRequest)
