 ...
 *
 * @brief  Handles DataPipeline ListPipelines responses.
 *
...
ListPipelinesResponse::ListPipelinesResponse(
    ...
    : ListPipelinesResponse(new ListPipelinesResponsePrivate(this), parent)
{
...
/**
 * @brief  Parse a DataPipeline ListPipelines response.
 *
...
/**
 * @brief  Parse an DataPipeline ListPipelinesResponse element.
 *
