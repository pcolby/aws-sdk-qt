...
class QTAWS_EXPORT DescribePipelinesResponsePrivate : public DataPipelineResponsePrivate {

public:

    DescribePipelinesResponsePrivate(DescribePipelinesResponse * const q);
