...
/*!
 * \class QtAws::ChimeSdkMeetings::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for ChimeSdkMeetings ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ChimeSdkMeetingsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ChimeSdkMeetings ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::ChimeSdkMeetings::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ChimeSdkMeetingsResponsePrivate(q)
{

}

/*!
 * Parses a ChimeSdkMeetings ListTagsForResource response element from \a xml.
 */
