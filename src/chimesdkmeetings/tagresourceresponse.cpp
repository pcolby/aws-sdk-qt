...
/*!
 * \class QtAws::ChimeSdkMeetings::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for ChimeSdkMeetings TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ChimeSdkMeetingsResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ChimeSdkMeetings TagResource \a response.
 */
...
/*!
 * \class QtAws::ChimeSdkMeetings::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ChimeSdkMeetingsResponsePrivate(q)
{

}

/*!
 * Parses a ChimeSdkMeetings TagResource response element from \a xml.
 */
