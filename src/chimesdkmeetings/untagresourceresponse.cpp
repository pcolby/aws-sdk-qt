...
/*!
 * \class QtAws::ChimeSdkMeetings::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for ChimeSdkMeetings UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : ChimeSdkMeetingsResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful ChimeSdkMeetings UntagResource \a response.
 */
...
/*!
 * \class QtAws::ChimeSdkMeetings::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : ChimeSdkMeetingsResponsePrivate(q)
{

}

/*!
 * Parses a ChimeSdkMeetings UntagResource response element from \a xml.
 */
