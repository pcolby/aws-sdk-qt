...
class QTAWS_EXPORT PutEmailIdentityMailFromAttributesResponsePrivate : public PinpointEmailResponsePrivate {

public:

    PutEmailIdentityMailFromAttributesResponsePrivate(PutEmailIdentityMailFromAttributesResponse * const q);
