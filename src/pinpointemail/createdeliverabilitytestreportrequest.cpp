...
/*!
 * \class QtAws::PinpointEmail::CreateDeliverabilityTestReportRequest
 * \brief The CreateDeliverabilityTestReportRequest class provides an interface for PinpointEmail CreateDeliverabilityTestReport requests.
 *
...
CreateDeliverabilityTestReportRequest::CreateDeliverabilityTestReportRequest(const CreateDeliverabilityTestReportRequest &other)
    : PinpointEmailRequest(new CreateDeliverabilityTestReportRequestPrivate(*other.d_func(), this))
{
...
CreateDeliverabilityTestReportRequest::CreateDeliverabilityTestReportRequest()
    : PinpointEmailRequest(new CreateDeliverabilityTestReportRequestPrivate(PinpointEmailRequest::CreateDeliverabilityTestReportAction, this))
{
...
/*!
 * \class QtAws::PinpointEmail::CreateDeliverabilityTestReportRequestPrivate
...
/*!
 * Constructs a CreateDeliverabilityTestReportRequestPrivate object for PinpointEmail \a action,
 * with public implementation \a q.
 */
CreateDeliverabilityTestReportRequestPrivate::CreateDeliverabilityTestReportRequestPrivate(
    const PinpointEmailRequest::Action action, CreateDeliverabilityTestReportRequest * const q)
