...
/*!
 * \class QtAws::PinpointEmail::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for PinpointEmail UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : PinpointEmailResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(PinpointEmailResponse::request());
}

/*!
 * \reimp
 * Parses a successful PinpointEmail UntagResource \a response.
 */
...
/*!
 * \class QtAws::PinpointEmail::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : PinpointEmailResponsePrivate(q)
{

}

/*!
 * Parses a PinpointEmail UntagResource response element from \a xml.
 */
