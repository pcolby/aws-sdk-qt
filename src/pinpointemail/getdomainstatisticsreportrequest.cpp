...
/*!
 * \class QtAws::PinpointEmail::GetDomainStatisticsReportRequest
 * \brief The GetDomainStatisticsReportRequest class provides an interface for PinpointEmail GetDomainStatisticsReport requests.
 *
...
GetDomainStatisticsReportRequest::GetDomainStatisticsReportRequest(const GetDomainStatisticsReportRequest &other)
    : PinpointEmailRequest(new GetDomainStatisticsReportRequestPrivate(*other.d_func(), this))
{
...
GetDomainStatisticsReportRequest::GetDomainStatisticsReportRequest()
    : PinpointEmailRequest(new GetDomainStatisticsReportRequestPrivate(PinpointEmailRequest::GetDomainStatisticsReportAction, this))
{
...
/*!
 * \class QtAws::PinpointEmail::GetDomainStatisticsReportRequestPrivate
...
/*!
 * Constructs a GetDomainStatisticsReportRequestPrivate object for PinpointEmail \a action,
 * with public implementation \a q.
 */
GetDomainStatisticsReportRequestPrivate::GetDomainStatisticsReportRequestPrivate(
    const PinpointEmailRequest::Action action, GetDomainStatisticsReportRequest * const q)
