...
/*!
 * \class QtAws::PinpointEmail::DeleteEmailIdentityRequest
 * \brief The DeleteEmailIdentityRequest class provides an interface for PinpointEmail DeleteEmailIdentity requests.
 *
...
DeleteEmailIdentityRequest::DeleteEmailIdentityRequest(const DeleteEmailIdentityRequest &other)
    : PinpointEmailRequest(new DeleteEmailIdentityRequestPrivate(*other.d_func(), this))
{
...
DeleteEmailIdentityRequest::DeleteEmailIdentityRequest()
    : PinpointEmailRequest(new DeleteEmailIdentityRequestPrivate(PinpointEmailRequest::DeleteEmailIdentityAction, this))
{
...
/*!
 * \class QtAws::PinpointEmail::DeleteEmailIdentityRequestPrivate
...
/*!
 * Constructs a DeleteEmailIdentityRequestPrivate object for PinpointEmail \a action,
 * with public implementation \a q.
 */
DeleteEmailIdentityRequestPrivate::DeleteEmailIdentityRequestPrivate(
    const PinpointEmailRequest::Action action, DeleteEmailIdentityRequest * const q)
