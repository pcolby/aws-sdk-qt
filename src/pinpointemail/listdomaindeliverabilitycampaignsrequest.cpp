...
/*!
 * \class QtAws::PinpointEmail::ListDomainDeliverabilityCampaignsRequest
 * \brief The ListDomainDeliverabilityCampaignsRequest class provides an interface for PinpointEmail ListDomainDeliverabilityCampaigns requests.
 *
...
ListDomainDeliverabilityCampaignsRequest::ListDomainDeliverabilityCampaignsRequest(const ListDomainDeliverabilityCampaignsRequest &other)
    : PinpointEmailRequest(new ListDomainDeliverabilityCampaignsRequestPrivate(*other.d_func(), this))
{
...
ListDomainDeliverabilityCampaignsRequest::ListDomainDeliverabilityCampaignsRequest()
    : PinpointEmailRequest(new ListDomainDeliverabilityCampaignsRequestPrivate(PinpointEmailRequest::ListDomainDeliverabilityCampaignsAction, this))
{
...
/*!
 * \class QtAws::PinpointEmail::ListDomainDeliverabilityCampaignsRequestPrivate
...
/*!
 * Constructs a ListDomainDeliverabilityCampaignsRequestPrivate object for PinpointEmail \a action,
 * with public implementation \a q.
 */
ListDomainDeliverabilityCampaignsRequestPrivate::ListDomainDeliverabilityCampaignsRequestPrivate(
    const PinpointEmailRequest::Action action, ListDomainDeliverabilityCampaignsRequest * const q)
