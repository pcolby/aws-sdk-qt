...
/*!
 * \class QtAws::PinpointEmail::GetAccountRequest
 * \brief The GetAccountRequest class provides an interface for PinpointEmail GetAccount requests.
 *
...
GetAccountRequest::GetAccountRequest(const GetAccountRequest &other)
    : PinpointEmailRequest(new GetAccountRequestPrivate(*other.d_func(), this))
{
...
GetAccountRequest::GetAccountRequest()
    : PinpointEmailRequest(new GetAccountRequestPrivate(PinpointEmailRequest::GetAccountAction, this))
{
...
/*!
 * \class QtAws::PinpointEmail::GetAccountRequestPrivate
...
/*!
 * Constructs a GetAccountRequestPrivate object for PinpointEmail \a action,
 * with public implementation \a q.
 */
GetAccountRequestPrivate::GetAccountRequestPrivate(
    const PinpointEmailRequest::Action action, GetAccountRequest * const q)
