...
/*!
 * \class QtAws::PinpointEmail::DeleteDedicatedIpPoolRequest
 * \brief The DeleteDedicatedIpPoolRequest class provides an interface for PinpointEmail DeleteDedicatedIpPool requests.
 *
...
DeleteDedicatedIpPoolRequest::DeleteDedicatedIpPoolRequest(const DeleteDedicatedIpPoolRequest &other)
    : PinpointEmailRequest(new DeleteDedicatedIpPoolRequestPrivate(*other.d_func(), this))
{
...
DeleteDedicatedIpPoolRequest::DeleteDedicatedIpPoolRequest()
    : PinpointEmailRequest(new DeleteDedicatedIpPoolRequestPrivate(PinpointEmailRequest::DeleteDedicatedIpPoolAction, this))
{
...
/*!
 * \class QtAws::PinpointEmail::DeleteDedicatedIpPoolRequestPrivate
...
/*!
 * Constructs a DeleteDedicatedIpPoolRequestPrivate object for PinpointEmail \a action,
 * with public implementation \a q.
 */
DeleteDedicatedIpPoolRequestPrivate::DeleteDedicatedIpPoolRequestPrivate(
    const PinpointEmailRequest::Action action, DeleteDedicatedIpPoolRequest * const q)
