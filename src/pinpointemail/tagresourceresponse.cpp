...
/*!
 * \class QtAws::PinpointEmail::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for PinpointEmail TagResource responses.
 *
 ...
 *
 * \sa PinpointEmailClient::tagResource
 */
...
TagResourceResponse::TagResourceResponse(
    ...
    : PinpointEmailResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(PinpointEmailResponse::request());
}

/*!
 * \reimp
 * Parses a successful PinpointEmail TagResource \a response.
 */
...
/*!
 * \class QtAws::PinpointEmail::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : PinpointEmailResponsePrivate(q)
{

}

/*!
 * Parses a PinpointEmail TagResource response element from \a xml.
 */
