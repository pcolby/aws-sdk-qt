...
class QTAWS_EXPORT GetEmailIdentityResponsePrivate : public PinpointEmailResponsePrivate {

public:

    GetEmailIdentityResponsePrivate(GetEmailIdentityResponse * const q);
