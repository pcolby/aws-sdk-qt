...
/*!
 * \class QtAws::PinpointEmail::PutConfigurationSetSendingOptionsRequest
 * \brief The PutConfigurationSetSendingOptionsRequest class provides an interface for PinpointEmail PutConfigurationSetSendingOptions requests.
 *
...
PutConfigurationSetSendingOptionsRequest::PutConfigurationSetSendingOptionsRequest(const PutConfigurationSetSendingOptionsRequest &other)
    : PinpointEmailRequest(new PutConfigurationSetSendingOptionsRequestPrivate(*other.d_func(), this))
{
...
PutConfigurationSetSendingOptionsRequest::PutConfigurationSetSendingOptionsRequest()
    : PinpointEmailRequest(new PutConfigurationSetSendingOptionsRequestPrivate(PinpointEmailRequest::PutConfigurationSetSendingOptionsAction, this))
{
...
/*!
 * \class QtAws::PinpointEmail::PutConfigurationSetSendingOptionsRequestPrivate
...
/*!
 * Constructs a PutConfigurationSetSendingOptionsRequestPrivate object for PinpointEmail \a action,
 * with public implementation \a q.
 */
PutConfigurationSetSendingOptionsRequestPrivate::PutConfigurationSetSendingOptionsRequestPrivate(
    const PinpointEmailRequest::Action action, PutConfigurationSetSendingOptionsRequest * const q)
