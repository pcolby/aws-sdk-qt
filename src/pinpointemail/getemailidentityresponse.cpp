...
/*!
 * \class QtAws::PinpointEmail::GetEmailIdentityResponse
 * \brief The GetEmailIdentityResponse class provides an interace for PinpointEmail GetEmailIdentity responses.
 *
...
GetEmailIdentityResponse::GetEmailIdentityResponse(
    ...
    : PinpointEmailResponse(new GetEmailIdentityResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful PinpointEmail GetEmailIdentity \a response.
 */
...
/*!
 * \class QtAws::PinpointEmail::GetEmailIdentityResponsePrivate
...
GetEmailIdentityResponsePrivate::GetEmailIdentityResponsePrivate(
    GetEmailIdentityResponse * const q) : PinpointEmailResponsePrivate(q)
{

}

/*!
 * Parses a PinpointEmail GetEmailIdentity response element from \a xml.
 */
