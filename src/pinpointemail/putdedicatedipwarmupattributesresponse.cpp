...
/*!
 * \class QtAws::PinpointEmail::PutDedicatedIpWarmupAttributesResponse
 * \brief The PutDedicatedIpWarmupAttributesResponse class provides an interace for PinpointEmail PutDedicatedIpWarmupAttributes responses.
 *
...
PutDedicatedIpWarmupAttributesResponse::PutDedicatedIpWarmupAttributesResponse(
    ...
    : PinpointEmailResponse(new PutDedicatedIpWarmupAttributesResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful PinpointEmail PutDedicatedIpWarmupAttributes \a response.
 */
...
/*!
 * \class QtAws::PinpointEmail::PutDedicatedIpWarmupAttributesResponsePrivate
...
PutDedicatedIpWarmupAttributesResponsePrivate::PutDedicatedIpWarmupAttributesResponsePrivate(
    PutDedicatedIpWarmupAttributesResponse * const q) : PinpointEmailResponsePrivate(q)
{

}

/*!
 * Parses a PinpointEmail PutDedicatedIpWarmupAttributes response element from \a xml.
 */
