...
/*!
 * \class QtAws::PinpointEmail::GetDeliverabilityTestReportRequest
 * \brief The GetDeliverabilityTestReportRequest class provides an interface for PinpointEmail GetDeliverabilityTestReport requests.
 *
...
GetDeliverabilityTestReportRequest::GetDeliverabilityTestReportRequest(const GetDeliverabilityTestReportRequest &other)
    : PinpointEmailRequest(new GetDeliverabilityTestReportRequestPrivate(*other.d_func(), this))
{
...
GetDeliverabilityTestReportRequest::GetDeliverabilityTestReportRequest()
    : PinpointEmailRequest(new GetDeliverabilityTestReportRequestPrivate(PinpointEmailRequest::GetDeliverabilityTestReportAction, this))
{
...
/*!
 * \class QtAws::PinpointEmail::GetDeliverabilityTestReportRequestPrivate
...
/*!
 * Constructs a GetDeliverabilityTestReportRequestPrivate object for PinpointEmail \a action,
 * with public implementation \a q.
 */
GetDeliverabilityTestReportRequestPrivate::GetDeliverabilityTestReportRequestPrivate(
    const PinpointEmailRequest::Action action, GetDeliverabilityTestReportRequest * const q)
