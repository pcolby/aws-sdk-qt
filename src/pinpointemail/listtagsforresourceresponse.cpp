...
/*!
 * \class QtAws::PinpointEmail::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for PinpointEmail ListTagsForResource responses.
 *
 ...
 *
 * \sa PinpointEmailClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : PinpointEmailResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(PinpointEmailResponse::request());
}

/*!
 * \reimp
 * Parses a successful PinpointEmail ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::PinpointEmail::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : PinpointEmailResponsePrivate(q)
{

}

/*!
 * Parses a PinpointEmail ListTagsForResource response element from \a xml.
 */
