...
/*!
 * \class QtAws::PinpointEmail::ListDedicatedIpPoolsResponse
 * \brief The ListDedicatedIpPoolsResponse class provides an interace for PinpointEmail ListDedicatedIpPools responses.
 *
...
ListDedicatedIpPoolsResponse::ListDedicatedIpPoolsResponse(
    ...
    : PinpointEmailResponse(new ListDedicatedIpPoolsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful PinpointEmail ListDedicatedIpPools \a response.
 */
...
/*!
 * \class QtAws::PinpointEmail::ListDedicatedIpPoolsResponsePrivate
...
ListDedicatedIpPoolsResponsePrivate::ListDedicatedIpPoolsResponsePrivate(
    ListDedicatedIpPoolsResponse * const q) : PinpointEmailResponsePrivate(q)
{

}

/*!
 * Parses a PinpointEmail ListDedicatedIpPools response element from \a xml.
 */
