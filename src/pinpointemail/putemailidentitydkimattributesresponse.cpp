...
/*!
 * \class QtAws::PinpointEmail::PutEmailIdentityDkimAttributesResponse
 * \brief The PutEmailIdentityDkimAttributesResponse class provides an interace for PinpointEmail PutEmailIdentityDkimAttributes responses.
 *
...
PutEmailIdentityDkimAttributesResponse::PutEmailIdentityDkimAttributesResponse(
    ...
    : PinpointEmailResponse(new PutEmailIdentityDkimAttributesResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful PinpointEmail PutEmailIdentityDkimAttributes \a response.
 */
...
/*!
 * \class QtAws::PinpointEmail::PutEmailIdentityDkimAttributesResponsePrivate
...
PutEmailIdentityDkimAttributesResponsePrivate::PutEmailIdentityDkimAttributesResponsePrivate(
    PutEmailIdentityDkimAttributesResponse * const q) : PinpointEmailResponsePrivate(q)
{

}

/*!
 * Parses a PinpointEmail PutEmailIdentityDkimAttributes response element from \a xml.
 */
