...
/*!
 * \class QtAws::Cloud9::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Cloud9 ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : Cloud9Response(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(Cloud9Response::request());
}

/*!
 * \reimp
 * Parses a successful Cloud9 ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Cloud9::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : Cloud9ResponsePrivate(q)
{

}

/*!
 * Parses a Cloud9 ListTagsForResource response element from \a xml.
 */
