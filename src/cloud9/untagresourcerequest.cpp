...
/*!
 * \class QtAws::Cloud9::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for Cloud9 UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : Cloud9Request(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : Cloud9Request(new UntagResourceRequestPrivate(Cloud9Request::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::Cloud9::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for Cloud9 \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const Cloud9Request::Action action, UntagResourceRequest * const q)
