...
/*!
 * \class QtAws::GreengrassV2::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for GreengrassV2 UntagResource responses.
 *
 ...
 *
 * \sa GreengrassV2Client::untagResource
 */
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : GreengrassV2Response(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(GreengrassV2Response::request());
}

/*!
 * \reimp
 * Parses a successful GreengrassV2 UntagResource \a response.
 */
...
/*!
 * \class QtAws::GreengrassV2::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : GreengrassV2ResponsePrivate(q)
{

}

/*!
 * Parses a GreengrassV2 UntagResource response element from \a xml.
 */
