...
/*!
 * \class QtAws::GreengrassV2::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for GreengrassV2 UntagResource requests.
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : GreengrassV2Request(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : GreengrassV2Request(new UntagResourceRequestPrivate(GreengrassV2Request::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::GreengrassV2::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for GreengrassV2 \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const GreengrassV2Request::Action action, UntagResourceRequest * const q)
