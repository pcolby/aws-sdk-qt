...
/*!
 * \class QtAws::GreengrassV2::CreateDeploymentRequest
 * \brief The CreateDeploymentRequest class provides an interface for GreengrassV2 CreateDeployment requests.
 *
...
CreateDeploymentRequest::CreateDeploymentRequest(const CreateDeploymentRequest &other)
    : GreengrassV2Request(new CreateDeploymentRequestPrivate(*other.d_func(), this))
{
...
CreateDeploymentRequest::CreateDeploymentRequest()
    : GreengrassV2Request(new CreateDeploymentRequestPrivate(GreengrassV2Request::CreateDeploymentAction, this))
{
...
/*!
 * \class QtAws::GreengrassV2::CreateDeploymentRequestPrivate
...
/*!
 * Constructs a CreateDeploymentRequestPrivate object for GreengrassV2 \a action,
 * with public implementation \a q.
 */
CreateDeploymentRequestPrivate::CreateDeploymentRequestPrivate(
    const GreengrassV2Request::Action action, CreateDeploymentRequest * const q)
