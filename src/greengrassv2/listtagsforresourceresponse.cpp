...
/*!
 * \class QtAws::GreengrassV2::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for GreengrassV2 ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : GreengrassV2Response(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GreengrassV2 ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::GreengrassV2::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : GreengrassV2ResponsePrivate(q)
{

}

/*!
 * Parses a GreengrassV2 ListTagsForResource response element from \a xml.
 */
