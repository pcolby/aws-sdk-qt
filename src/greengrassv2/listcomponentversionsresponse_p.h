...
class QTAWS_EXPORT ListComponentVersionsResponsePrivate : public GreengrassV2ResponsePrivate {

public:

    ListComponentVersionsResponsePrivate(ListComponentVersionsResponse * const q);
