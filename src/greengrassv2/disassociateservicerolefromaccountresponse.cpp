...
/*!
 * \class QtAws::GreengrassV2::DisassociateServiceRoleFromAccountResponse
 * \brief The DisassociateServiceRoleFromAccountResponse class provides an interace for GreengrassV2 DisassociateServiceRoleFromAccount responses.
 *
...
DisassociateServiceRoleFromAccountResponse::DisassociateServiceRoleFromAccountResponse(
    ...
    : GreengrassV2Response(new DisassociateServiceRoleFromAccountResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GreengrassV2 DisassociateServiceRoleFromAccount \a response.
 */
...
/*!
 * \class QtAws::GreengrassV2::DisassociateServiceRoleFromAccountResponsePrivate
...
DisassociateServiceRoleFromAccountResponsePrivate::DisassociateServiceRoleFromAccountResponsePrivate(
    DisassociateServiceRoleFromAccountResponse * const q) : GreengrassV2ResponsePrivate(q)
{

}

/*!
 * Parses a GreengrassV2 DisassociateServiceRoleFromAccount response element from \a xml.
 */
