...
/*!
 * \class QtAws::DataSync::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for DataSync ListTagsForResource responses.
 *
 ...
 *  manage AWS
 *
 * \sa DataSyncClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : DataSyncResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(DataSyncResponse::request());
}

/*!
 * \reimp
 * Parses a successful DataSync ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::DataSync::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : DataSyncResponsePrivate(q)
{

}

/*!
 * Parses a DataSync ListTagsForResource response element from \a xml.
 */
