...
public slots:
    ...
    CreateLocationFsxLustreResponse * createLocationFsxLustre(const CreateLocationFsxLustreRequest &request);
    CreateLocationFsxOntapResponse * createLocationFsxOntap(const CreateLocationFsxOntapRequest &request);
    CreateLocationFsxOpenZfsResponse * createLocationFsxOpenZfs(const CreateLocationFsxOpenZfsRequest &request);
    CreateLocationFsxWindowsResponse * createLocationFsxWindows(const CreateLocationFsxWindowsRequest &request);
    CreateLocationHdfsResponse * createLocationHdfs(const CreateLocationHdfsRequest &request);
    ...
    DescribeLocationFsxLustreResponse * describeLocationFsxLustre(const DescribeLocationFsxLustreRequest &request);
    DescribeLocationFsxOntapResponse * describeLocationFsxOntap(const DescribeLocationFsxOntapRequest &request);
    DescribeLocationFsxOpenZfsResponse * describeLocationFsxOpenZfs(const DescribeLocationFsxOpenZfsRequest &request);
    DescribeLocationFsxWindowsResponse * describeLocationFsxWindows(const DescribeLocationFsxWindowsRequest &request);
    DescribeLocationHdfsResponse * describeLocationHdfs(const DescribeLocationHdfsRequest &request);
    ...
    UpdateLocationHdfsResponse * updateLocationHdfs(const UpdateLocationHdfsRequest &request);
