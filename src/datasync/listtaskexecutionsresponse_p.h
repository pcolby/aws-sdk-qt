...
class QTAWS_EXPORT ListTaskExecutionsResponsePrivate : public DataSyncResponsePrivate {

public:

    ListTaskExecutionsResponsePrivate(ListTaskExecutionsResponse * const q);
