...
class QTAWS_EXPORT DescribeLocationEfsResponsePrivate : public DataSyncResponsePrivate {

public:

    DescribeLocationEfsResponsePrivate(DescribeLocationEfsResponse * const q);
