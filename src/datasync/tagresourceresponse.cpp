...
/*!
 * \class QtAws::DataSync::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for DataSync TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : DataSyncResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(DataSyncResponse::request());
}

/*!
 * \reimp
 * Parses a successful DataSync TagResource \a response.
 */
...
/*!
 * \class QtAws::DataSync::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : DataSyncResponsePrivate(q)
{

}

/*!
 * Parses a DataSync TagResource response element from \a xml.
 */
