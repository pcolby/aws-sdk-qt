...
class QTAWS_EXPORT DescribeLocationSmbResponsePrivate : public DataSyncResponsePrivate {

public:

    DescribeLocationSmbResponsePrivate(DescribeLocationSmbResponse * const q);
