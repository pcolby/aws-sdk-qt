...
class QTAWS_EXPORT StartTaskExecutionResponsePrivate : public DataSyncResponsePrivate {

public:

    StartTaskExecutionResponsePrivate(StartTaskExecutionResponse * const q);
