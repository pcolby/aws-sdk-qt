...
class QTAWS_EXPORT DescribeTaskExecutionResponsePrivate : public DataSyncResponsePrivate {

public:

    DescribeTaskExecutionResponsePrivate(DescribeTaskExecutionResponse * const q);
