...
class QTAWS_EXPORT CreateRobotApplicationVersionResponsePrivate : public RoboMakerResponsePrivate {

public:

    CreateRobotApplicationVersionResponsePrivate(CreateRobotApplicationVersionResponse * const q);
