...
class QTAWS_EXPORT ListDeploymentJobsResponsePrivate : public RoboMakerResponsePrivate {

public:

    ListDeploymentJobsResponsePrivate(ListDeploymentJobsResponse * const q);
