...
class QTAWS_EXPORT CreateWorldGenerationJobResponsePrivate : public RoboMakerResponsePrivate {

public:

    CreateWorldGenerationJobResponsePrivate(CreateWorldGenerationJobResponse * const q);
