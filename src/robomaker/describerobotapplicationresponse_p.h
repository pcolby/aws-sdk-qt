...
class QTAWS_EXPORT DescribeRobotApplicationResponsePrivate : public RoboMakerResponsePrivate {

public:

    DescribeRobotApplicationResponsePrivate(DescribeRobotApplicationResponse * const q);
