...
/*!
 * \class QtAws::RoboMaker::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for RoboMaker TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : RoboMakerResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(RoboMakerResponse::request());
}

/*!
 * \reimp
 * Parses a successful RoboMaker TagResource \a response.
 */
...
/*!
 * \class QtAws::RoboMaker::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : RoboMakerResponsePrivate(q)
{

}

/*!
 * Parses a RoboMaker TagResource response element from \a xml.
 */
