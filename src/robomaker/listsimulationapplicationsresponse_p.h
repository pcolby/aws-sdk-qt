...
class QTAWS_EXPORT ListSimulationApplicationsResponsePrivate : public RoboMakerResponsePrivate {

public:

    ListSimulationApplicationsResponsePrivate(ListSimulationApplicationsResponse * const q);
