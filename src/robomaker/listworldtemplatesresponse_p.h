...
class QTAWS_EXPORT ListWorldTemplatesResponsePrivate : public RoboMakerResponsePrivate {

public:

    ListWorldTemplatesResponsePrivate(ListWorldTemplatesResponse * const q);
