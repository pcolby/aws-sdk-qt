...
class QTAWS_EXPORT ListSimulationJobsResponsePrivate : public RoboMakerResponsePrivate {

public:

    ListSimulationJobsResponsePrivate(ListSimulationJobsResponse * const q);
