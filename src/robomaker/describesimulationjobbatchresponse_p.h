...
class QTAWS_EXPORT DescribeSimulationJobBatchResponsePrivate : public RoboMakerResponsePrivate {

public:

    DescribeSimulationJobBatchResponsePrivate(DescribeSimulationJobBatchResponse * const q);
