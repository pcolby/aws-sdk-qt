...
class QTAWS_EXPORT CreateSimulationApplicationResponsePrivate : public RoboMakerResponsePrivate {

public:

    CreateSimulationApplicationResponsePrivate(CreateSimulationApplicationResponse * const q);
