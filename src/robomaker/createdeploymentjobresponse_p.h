...
class QTAWS_EXPORT CreateDeploymentJobResponsePrivate : public RoboMakerResponsePrivate {

public:

    CreateDeploymentJobResponsePrivate(CreateDeploymentJobResponse * const q);
