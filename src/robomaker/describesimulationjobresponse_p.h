...
class QTAWS_EXPORT DescribeSimulationJobResponsePrivate : public RoboMakerResponsePrivate {

public:

    DescribeSimulationJobResponsePrivate(DescribeSimulationJobResponse * const q);
