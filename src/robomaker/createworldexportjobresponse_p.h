...
class QTAWS_EXPORT CreateWorldExportJobResponsePrivate : public RoboMakerResponsePrivate {

public:

    CreateWorldExportJobResponsePrivate(CreateWorldExportJobResponse * const q);
