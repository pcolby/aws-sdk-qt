...
class QTAWS_EXPORT ListWorldExportJobsResponsePrivate : public RoboMakerResponsePrivate {

public:

    ListWorldExportJobsResponsePrivate(ListWorldExportJobsResponse * const q);
