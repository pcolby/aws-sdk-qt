...
class QTAWS_EXPORT DeleteRobotApplicationResponsePrivate : public RoboMakerResponsePrivate {

public:

    DeleteRobotApplicationResponsePrivate(DeleteRobotApplicationResponse * const q);
