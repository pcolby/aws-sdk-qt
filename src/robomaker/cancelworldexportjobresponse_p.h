...
class QTAWS_EXPORT CancelWorldExportJobResponsePrivate : public RoboMakerResponsePrivate {

public:

    CancelWorldExportJobResponsePrivate(CancelWorldExportJobResponse * const q);
