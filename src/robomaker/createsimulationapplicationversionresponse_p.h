...
class QTAWS_EXPORT CreateSimulationApplicationVersionResponsePrivate : public RoboMakerResponsePrivate {

public:

    CreateSimulationApplicationVersionResponsePrivate(CreateSimulationApplicationVersionResponse * const q);
