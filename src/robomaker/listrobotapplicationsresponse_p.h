...
class QTAWS_EXPORT ListRobotApplicationsResponsePrivate : public RoboMakerResponsePrivate {

public:

    ListRobotApplicationsResponsePrivate(ListRobotApplicationsResponse * const q);
