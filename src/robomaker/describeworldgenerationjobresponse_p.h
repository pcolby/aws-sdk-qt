...
class QTAWS_EXPORT DescribeWorldGenerationJobResponsePrivate : public RoboMakerResponsePrivate {

public:

    DescribeWorldGenerationJobResponsePrivate(DescribeWorldGenerationJobResponse * const q);
