...
#ifndef QTAWS_CREATESIMULATIONAPPLICATIONVERSIONREQUEST_H
#define QTAWS_CREATESIMULATIONAPPLICATIONVERSIONREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(CreateSimulationApplicationVersionRequest)
