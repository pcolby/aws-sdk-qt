...
class QTAWS_EXPORT CancelSimulationJobBatchResponsePrivate : public RoboMakerResponsePrivate {

public:

    CancelSimulationJobBatchResponsePrivate(CancelSimulationJobBatchResponse * const q);
