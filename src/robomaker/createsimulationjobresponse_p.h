...
class QTAWS_EXPORT CreateSimulationJobResponsePrivate : public RoboMakerResponsePrivate {

public:

    CreateSimulationJobResponsePrivate(CreateSimulationJobResponse * const q);
