...
/*!
 * \class QtAws::DataBrew::ListJobsResponse
 * \brief The ListJobsResponse class provides an interace for DataBrew ListJobs responses.
 *
...
ListJobsResponse::ListJobsResponse(
    ...
    : DataBrewResponse(new ListJobsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful DataBrew ListJobs \a response.
 */
...
/*!
 * \class QtAws::DataBrew::ListJobsResponsePrivate
...
ListJobsResponsePrivate::ListJobsResponsePrivate(
    ListJobsResponse * const q) : DataBrewResponsePrivate(q)
{

}

/*!
 * Parses a DataBrew ListJobs response element from \a xml.
 */
