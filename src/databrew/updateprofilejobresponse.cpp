...
/*!
 * \class QtAws::DataBrew::UpdateProfileJobResponse
 * \brief The UpdateProfileJobResponse class provides an interace for DataBrew UpdateProfileJob responses.
 *
...
UpdateProfileJobResponse::UpdateProfileJobResponse(
    ...
    : DataBrewResponse(new UpdateProfileJobResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful DataBrew UpdateProfileJob \a response.
 */
...
/*!
 * \class QtAws::DataBrew::UpdateProfileJobResponsePrivate
...
UpdateProfileJobResponsePrivate::UpdateProfileJobResponsePrivate(
    UpdateProfileJobResponse * const q) : DataBrewResponsePrivate(q)
{

}

/*!
 * Parses a DataBrew UpdateProfileJob response element from \a xml.
 */
