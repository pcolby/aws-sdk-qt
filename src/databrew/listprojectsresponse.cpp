...
/*!
 * \class QtAws::DataBrew::ListProjectsResponse
 * \brief The ListProjectsResponse class provides an interace for DataBrew ListProjects responses.
 *
...
ListProjectsResponse::ListProjectsResponse(
    ...
    : DataBrewResponse(new ListProjectsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful DataBrew ListProjects \a response.
 */
...
/*!
 * \class QtAws::DataBrew::ListProjectsResponsePrivate
...
ListProjectsResponsePrivate::ListProjectsResponsePrivate(
    ListProjectsResponse * const q) : DataBrewResponsePrivate(q)
{

}

/*!
 * Parses a DataBrew ListProjects response element from \a xml.
 */
