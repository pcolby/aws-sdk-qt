...
/*!
 * \class QtAws::DataBrew::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for DataBrew TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : DataBrewResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful DataBrew TagResource \a response.
 */
...
/*!
 * \class QtAws::DataBrew::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : DataBrewResponsePrivate(q)
{

}

/*!
 * Parses a DataBrew TagResource response element from \a xml.
 */
