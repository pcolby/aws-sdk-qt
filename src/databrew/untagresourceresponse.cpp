...
/*!
 * \class QtAws::DataBrew::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for DataBrew UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : DataBrewResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful DataBrew UntagResource \a response.
 */
...
/*!
 * \class QtAws::DataBrew::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : DataBrewResponsePrivate(q)
{

}

/*!
 * Parses a DataBrew UntagResource response element from \a xml.
 */
