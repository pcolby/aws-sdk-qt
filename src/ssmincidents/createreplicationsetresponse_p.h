...
class QTAWS_EXPORT CreateReplicationSetResponsePrivate : public SSMIncidentsResponsePrivate {

public:

    CreateReplicationSetResponsePrivate(CreateReplicationSetResponse * const q);
