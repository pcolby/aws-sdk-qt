...
class QTAWS_EXPORT DeleteResponsePlanResponsePrivate : public SSMIncidentsResponsePrivate {

public:

    DeleteResponsePlanResponsePrivate(DeleteResponsePlanResponse * const q);
