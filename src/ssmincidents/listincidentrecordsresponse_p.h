...
class QTAWS_EXPORT ListIncidentRecordsResponsePrivate : public SSMIncidentsResponsePrivate {

public:

    ListIncidentRecordsResponsePrivate(ListIncidentRecordsResponse * const q);
