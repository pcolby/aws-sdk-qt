...
class QTAWS_EXPORT UpdateResponsePlanResponsePrivate : public SSMIncidentsResponsePrivate {

public:

    UpdateResponsePlanResponsePrivate(UpdateResponsePlanResponse * const q);
