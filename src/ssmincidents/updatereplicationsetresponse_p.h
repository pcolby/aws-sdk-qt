...
class QTAWS_EXPORT UpdateReplicationSetResponsePrivate : public SSMIncidentsResponsePrivate {

public:

    UpdateReplicationSetResponsePrivate(UpdateReplicationSetResponse * const q);
