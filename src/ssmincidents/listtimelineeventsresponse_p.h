...
class QTAWS_EXPORT ListTimelineEventsResponsePrivate : public SSMIncidentsResponsePrivate {

public:

    ListTimelineEventsResponsePrivate(ListTimelineEventsResponse * const q);
