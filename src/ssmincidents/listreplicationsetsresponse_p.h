...
class QTAWS_EXPORT ListReplicationSetsResponsePrivate : public SSMIncidentsResponsePrivate {

public:

    ListReplicationSetsResponsePrivate(ListReplicationSetsResponse * const q);
