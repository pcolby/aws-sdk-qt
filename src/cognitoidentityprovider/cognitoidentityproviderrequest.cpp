...
CognitoIdentityProviderRequestPrivate::CognitoIdentityProviderRequestPrivate(const CognitoIdentityProviderRequest::Action action, CognitoIdentityProviderRequest * const q)
    : QtAws::Core::AwsAbstractRequestPrivate(q), action(action), apiVersion(QLatin1String("2016-04-18"))
{
...
QString CognitoIdentityProviderRequestPrivate::toString(const CognitoIdentityProviderRequest::Action &action)
{
    ...
    switch (action) {
        ActionToString(AddCustomAttributes);
        ActionToString(AdminAddUserToGroup);
        ActionToString(AdminConfirmSignUp);
        ActionToString(AdminCreateUser);
        ActionToString(AdminDeleteUser);
        ActionToString(AdminDeleteUserAttributes);
        ActionToString(AdminDisableProviderForUser);
        ActionToString(AdminDisableUser);
        ActionToString(AdminEnableUser);
        ActionToString(AdminForgetDevice);
        ActionToString(AdminGetDevice);
        ActionToString(AdminGetUser);
        ActionToString(AdminInitiateAuth);
        ActionToString(AdminLinkProviderForUser);
        ActionToString(AdminListDevices);
        ActionToString(AdminListGroupsForUser);
        ActionToString(AdminListUserAuthEvents);
        ActionToString(AdminRemoveUserFromGroup);
        ActionToString(AdminResetUserPassword);
        ActionToString(AdminRespondToAuthChallenge);
        ActionToString(AdminSetUserMFAPreference);
        ActionToString(AdminSetUserPassword);
        ActionToString(AdminSetUserSettings);
        ActionToString(AdminUpdateAuthEventFeedback);
        ActionToString(AdminUpdateDeviceStatus);
        ActionToString(AdminUpdateUserAttributes);
        ActionToString(AdminUserGlobalSignOut);
        ActionToString(AssociateSoftwareToken);
        ActionToString(ChangePassword);
        ActionToString(ConfirmDevice);
        ActionToString(ConfirmForgotPassword);
        ActionToString(ConfirmSignUp);
        ActionToString(CreateGroup);
        ActionToString(CreateIdentityProvider);
        ActionToString(CreateResourceServer);
        ActionToString(CreateUserImportJob);
        ActionToString(CreateUserPool);
        ActionToString(CreateUserPoolClient);
        ActionToString(CreateUserPoolDomain);
        ActionToString(DeleteGroup);
        ActionToString(DeleteIdentityProvider);
        ActionToString(DeleteResourceServer);
        ActionToString(DeleteUser);
        ActionToString(DeleteUserAttributes);
        ActionToString(DeleteUserPool);
        ActionToString(DeleteUserPoolClient);
        ActionToString(DeleteUserPoolDomain);
        ActionToString(DescribeIdentityProvider);
        ActionToString(DescribeResourceServer);
        ActionToString(DescribeRiskConfiguration);
        ActionToString(DescribeUserImportJob);
        ActionToString(DescribeUserPool);
        ActionToString(DescribeUserPoolClient);
        ActionToString(DescribeUserPoolDomain);
        ActionToString(ForgetDevice);
        ActionToString(ForgotPassword);
        ActionToString(GetCSVHeader);
        ActionToString(GetDevice);
        ActionToString(GetGroup);
        ActionToString(GetIdentityProviderByIdentifier);
        ActionToString(GetSigningCertificate);
        ActionToString(GetUICustomization);
        ActionToString(GetUser);
        ActionToString(GetUserAttributeVerificationCode);
        ActionToString(GetUserPoolMfaConfig);
        ActionToString(GlobalSignOut);
        ActionToString(InitiateAuth);
        ActionToString(ListDevices);
        ActionToString(ListGroups);
        ActionToString(ListIdentityProviders);
        ActionToString(ListResourceServers);
        ActionToString(ListTagsForResource);
        ActionToString(ListUserImportJobs);
        ActionToString(ListUserPoolClients);
        ActionToString(ListUserPools);
        ActionToString(ListUsers);
        ActionToString(ListUsersInGroup);
        ActionToString(ResendConfirmationCode);
        ActionToString(RespondToAuthChallenge);
        ActionToString(RevokeToken);
        ActionToString(SetRiskConfiguration);
        ActionToString(SetUICustomization);
        ActionToString(SetUserMFAPreference);
        ActionToString(SetUserPoolMfaConfig);
        ActionToString(SetUserSettings);
        ActionToString(SignUp);
        ActionToString(StartUserImportJob);
        ActionToString(StopUserImportJob);
        ActionToString(TagResource);
        ActionToString(UntagResource);
        ActionToString(UpdateAuthEventFeedback);
        ActionToString(UpdateDeviceStatus);
        ActionToString(UpdateGroup);
        ActionToString(UpdateIdentityProvider);
        ActionToString(UpdateResourceServer);
        ActionToString(UpdateUserAttributes);
        ActionToString(UpdateUserPool);
        ActionToString(UpdateUserPoolClient);
        ActionToString(UpdateUserPoolDomain);
        ActionToString(VerifySoftwareToken);
        ActionToString(VerifyUserAttribute);
        default:
