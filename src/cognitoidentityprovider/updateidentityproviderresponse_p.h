...
class QTAWS_EXPORT UpdateIdentityProviderResponsePrivate : public CognitoIdentityProviderResponsePrivate {

public:

    UpdateIdentityProviderResponsePrivate(UpdateIdentityProviderResponse * const q);
