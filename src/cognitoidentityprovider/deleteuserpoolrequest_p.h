...
class QTAWS_EXPORT DeleteUserPoolRequestPrivate : public CognitoIdentityProviderRequestPrivate {

public:
    DeleteUserPoolRequestPrivate(const CognitoIdentityProviderRequest::Action action,
