...
/*!
 * \class QtAws::CognitoIdentityProvider::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for CognitoIdentityProvider ListTagsForResource responses.
 *
 ...
 *
 * \sa CognitoIdentityProviderClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : CognitoIdentityProviderResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(CognitoIdentityProviderResponse::request());
}

/*!
 * \reimp
 * Parses a successful CognitoIdentityProvider ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::CognitoIdentityProvider::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : CognitoIdentityProviderResponsePrivate(q)
{

}

/*!
 * Parses a CognitoIdentityProvider ListTagsForResource response element from \a xml.
 */
