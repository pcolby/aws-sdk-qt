...
class QTAWS_EXPORT DescribeIdentityProviderResponse : public CognitoIdentityProviderResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeIdentityProviderRequest * request() const override;
