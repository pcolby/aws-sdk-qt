...
class QTAWS_EXPORT UpdateUserPoolClientResponse : public CognitoIdentityProviderResponse {
    Q_OBJECT

public:
    UpdateUserPoolClientResponse(const UpdateUserPoolClientRequest &request, QNetworkReply * const reply, QObject * const parent = 0);

    virtual const UpdateUserPoolClientRequest * request() const override;
