...
class QTAWS_EXPORT CognitoIdentityProviderResponsePrivate : public QtAws::Core::AwsAbstractResponsePrivate {

public:

    CognitoIdentityProviderResponsePrivate(CognitoIdentityProviderResponse * const q);
