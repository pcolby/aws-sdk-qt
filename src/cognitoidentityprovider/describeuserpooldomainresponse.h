...
class QTAWSCOGNITOIDENTITYPROVIDER_EXPORT DescribeUserPoolDomainResponse : public CognitoIdentityProviderResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeUserPoolDomainRequest * request() const Q_DECL_OVERRIDE;
