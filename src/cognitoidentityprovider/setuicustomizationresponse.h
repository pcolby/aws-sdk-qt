...
class QTAWSCOGNITOIDENTITYPROVIDER_EXPORT SetUICustomizationResponse : public CognitoIdentityProviderResponse {
    Q_OBJECT

public:
    SetUICustomizationResponse(const SetUICustomizationRequest &request, QNetworkReply * const reply, QObject * const parent = 0);

    virtual const SetUICustomizationRequest * request() const Q_DECL_OVERRIDE;
