...
class QTAWS_EXPORT DeleteUserPoolDomainResponse : public CognitoIdentityProviderResponse {
    Q_OBJECT

public:
    DeleteUserPoolDomainResponse(const DeleteUserPoolDomainRequest &request, QNetworkReply * const reply, QObject * const parent = 0);

    virtual const DeleteUserPoolDomainRequest * request() const override;
