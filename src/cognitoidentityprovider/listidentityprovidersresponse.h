...
class QTAWS_EXPORT ListIdentityProvidersResponse : public CognitoIdentityProviderResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListIdentityProvidersRequest * request() const override;
