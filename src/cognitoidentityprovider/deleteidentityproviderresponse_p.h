...
class QTAWS_EXPORT DeleteIdentityProviderResponsePrivate : public CognitoIdentityProviderResponsePrivate {

public:

    DeleteIdentityProviderResponsePrivate(DeleteIdentityProviderResponse * const q);
