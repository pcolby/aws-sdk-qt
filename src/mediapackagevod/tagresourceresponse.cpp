...
/*!
 * \class QtAws::MediaPackageVod::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for MediaPackageVod TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : MediaPackageVodResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(MediaPackageVodResponse::request());
}

/*!
 * \reimp
 * Parses a successful MediaPackageVod TagResource \a response.
 */
...
/*!
 * \class QtAws::MediaPackageVod::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : MediaPackageVodResponsePrivate(q)
{

}

/*!
 * Parses a MediaPackageVod TagResource response element from \a xml.
 */
