...
class QTAWS_EXPORT CreatePackagingGroupResponsePrivate : public MediaPackageVodResponsePrivate {

public:

    CreatePackagingGroupResponsePrivate(CreatePackagingGroupResponse * const q);
