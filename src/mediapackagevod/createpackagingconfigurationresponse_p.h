...
class QTAWS_EXPORT CreatePackagingConfigurationResponsePrivate : public MediaPackageVodResponsePrivate {

public:

    CreatePackagingConfigurationResponsePrivate(CreatePackagingConfigurationResponse * const q);
