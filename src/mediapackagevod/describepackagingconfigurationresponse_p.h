...
class QTAWS_EXPORT DescribePackagingConfigurationResponsePrivate : public MediaPackageVodResponsePrivate {

public:

    DescribePackagingConfigurationResponsePrivate(DescribePackagingConfigurationResponse * const q);
