...
class QTAWS_EXPORT ListPackagingGroupsResponsePrivate : public MediaPackageVodResponsePrivate {

public:

    ListPackagingGroupsResponsePrivate(ListPackagingGroupsResponse * const q);
