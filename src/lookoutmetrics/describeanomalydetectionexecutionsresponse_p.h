...
class QTAWS_EXPORT DescribeAnomalyDetectionExecutionsResponsePrivate : public LookoutMetricsResponsePrivate {

public:

    DescribeAnomalyDetectionExecutionsResponsePrivate(DescribeAnomalyDetectionExecutionsResponse * const q);
