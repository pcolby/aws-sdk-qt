...
class QTAWS_EXPORT UpdateAnomalyDetectorResponsePrivate : public LookoutMetricsResponsePrivate {

public:

    UpdateAnomalyDetectorResponsePrivate(UpdateAnomalyDetectorResponse * const q);
