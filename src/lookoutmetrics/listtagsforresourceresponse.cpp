...
/*!
 * \class QtAws::LookoutMetrics::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for LookoutMetrics ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : LookoutMetricsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful LookoutMetrics ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::LookoutMetrics::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : LookoutMetricsResponsePrivate(q)
{

}

/*!
 * Parses a LookoutMetrics ListTagsForResource response element from \a xml.
 */
