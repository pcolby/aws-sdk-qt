 ...
 * @param  q       Pointer to this object's public ResourceGroupsTaggingAPIRequest instance.
 */
 ...
 * @internal
 *
 * @brief  Constructs a new ResourceGroupsTaggingAPIRequestPrivate object from an existing one.
 *
