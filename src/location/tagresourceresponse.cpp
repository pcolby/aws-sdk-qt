...
/*!
 * \class QtAws::Location::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Location TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : LocationResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Location TagResource \a response.
 */
...
/*!
 * \class QtAws::Location::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : LocationResponsePrivate(q)
{

}

/*!
 * Parses a Location TagResource response element from \a xml.
 */
