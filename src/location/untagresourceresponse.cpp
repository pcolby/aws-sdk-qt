...
/*!
 * \class QtAws::Location::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Location UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : LocationResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Location UntagResource \a response.
 */
...
/*!
 * \class QtAws::Location::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : LocationResponsePrivate(q)
{

}

/*!
 * Parses a Location UntagResource response element from \a xml.
 */
