...
/*!
 * \class QtAws::Location::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Location ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : LocationResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Location ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Location::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : LocationResponsePrivate(q)
{

}

/*!
 * Parses a Location ListTagsForResource response element from \a xml.
 */
