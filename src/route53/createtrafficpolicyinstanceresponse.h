...
class QTAWSROUTE53_EXPORT CreateTrafficPolicyInstanceResponse : public Route53Response {
    Q_OBJECT
...
public:
    ...
    virtual const CreateTrafficPolicyInstanceRequest * request() const Q_DECL_OVERRIDE;
