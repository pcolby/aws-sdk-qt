...
class QTAWS_EXPORT DeleteTrafficPolicyInstanceResponse : public DeleteTrafficPolicyInstanceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteTrafficPolicyInstanceRequest * request() const;
