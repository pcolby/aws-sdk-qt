 ...
 * \brief The ListTagsForResourceResponse class provides an interace for Route53 ListTagsForResource responses.
 *
...
{
    return static_cast<const ListTagsForResourceRequest *>(Route53Response::request());
}

/*!
 * \reimp
 * Parses a successful Route53 ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Route53::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : Route53ResponsePrivate(q)
{

}

/*!
 * Parses a Route53 ListTagsForResource response element from \a xml.
 */
