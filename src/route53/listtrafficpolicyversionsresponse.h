...
class QTAWS_EXPORT ListTrafficPolicyVersionsResponse : public ListTrafficPolicyVersionsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListTrafficPolicyVersionsRequest * request() const;
