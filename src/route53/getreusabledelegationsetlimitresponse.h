...
class QTAWS_EXPORT GetReusableDelegationSetLimitResponse : public Route53Response {
    Q_OBJECT
...
public:
    ...
    virtual const GetReusableDelegationSetLimitRequest * request() const override;
