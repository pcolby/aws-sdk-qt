...
class QTAWSROUTE53_EXPORT GetReusableDelegationSetResponse : public Route53Response {
    Q_OBJECT
...
public:
    ...
    virtual const GetReusableDelegationSetRequest * request() const Q_DECL_OVERRIDE;
