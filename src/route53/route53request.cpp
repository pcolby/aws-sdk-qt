...
QString Route53RequestPrivate::toString(const Route53Request::Action &action)
{
    ...
    switch (action) {
        ...
        ActionToString(CreateQueryLoggingConfig);
        ActionToString(CreateReusableDelegationSet);
        ActionToString(CreateTrafficPolicy);
        ActionToString(CreateTrafficPolicyInstance);
        ...
        ActionToString(DeleteQueryLoggingConfig);
        ActionToString(DeleteReusableDelegationSet);
        ActionToString(DeleteTrafficPolicy);
        ActionToString(DeleteTrafficPolicyInstance);
        ActionToString(DeleteVPCAssociationAuthorization);
        ActionToString(DisableHostedZoneDNSSEC);
        ActionToString(DisassociateVPCFromHostedZone);
        ActionToString(EnableHostedZoneDNSSEC);
        ActionToString(GetAccountLimit);
        ActionToString(GetChange);
        ActionToString(GetCheckerIpRanges);
        ActionToString(GetDNSSEC);
        ActionToString(GetGeoLocation);
        ActionToString(GetHealthCheck);
        ActionToString(GetHealthCheckCount);
        ActionToString(GetHealthCheckLastFailureReason);
        ActionToString(GetHealthCheckStatus);
        ActionToString(GetHostedZone);
        ActionToString(GetHostedZoneCount);
        ActionToString(GetHostedZoneLimit);
        ActionToString(GetQueryLoggingConfig);
        ActionToString(GetReusableDelegationSet);
        ActionToString(GetReusableDelegationSetLimit);
        ...
        ActionToString(ListHostedZonesByName);
        ActionToString(ListHostedZonesByVPC);
        ActionToString(ListQueryLoggingConfigs);
        ActionToString(ListResourceRecordSets);
        ActionToString(ListReusableDelegationSets);
        ActionToString(ListTagsForResource);
        ActionToString(ListTagsForResources);
        ActionToString(ListTrafficPolicies);
        ActionToString(ListTrafficPolicyInstances);
        ActionToString(ListTrafficPolicyInstancesByHostedZone);
        ActionToString(ListTrafficPolicyInstancesByPolicy);
        ActionToString(ListTrafficPolicyVersions);
        ActionToString(ListVPCAssociationAuthorizations);
        ActionToString(TestDNSAnswer);
        ActionToString(UpdateHealthCheck);
        ActionToString(UpdateHostedZoneComment);
        ActionToString(UpdateTrafficPolicyComment);
        ActionToString(UpdateTrafficPolicyInstance);
        default:
