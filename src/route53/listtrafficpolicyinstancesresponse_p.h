...
class QTAWS_EXPORT ListTrafficPolicyInstancesResponsePrivate : public Route53ResponsePrivate {
    Q_OBJECT

public:

    ListTrafficPolicyInstancesResponsePrivate(ListTrafficPolicyInstancesResponse * const q);
