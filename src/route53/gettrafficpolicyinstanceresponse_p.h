...
class QTAWS_EXPORT GetTrafficPolicyInstanceResponsePrivate : public Route53ResponsePrivate {
    Q_OBJECT

public:

    GetTrafficPolicyInstanceResponsePrivate(GetTrafficPolicyInstanceResponse * const q);
