...
class QTAWS_EXPORT DeactivateKeySigningKeyResponsePrivate : public Route53ResponsePrivate {

public:

    DeactivateKeySigningKeyResponsePrivate(DeactivateKeySigningKeyResponse * const q);
