...
public slots:
    ...
    ChangeCidrCollectionResponse * changeCidrCollection(const ChangeCidrCollectionRequest &request);
    ...
    CreateCidrCollectionResponse * createCidrCollection(const CreateCidrCollectionRequest &request);
    ...
    DeleteCidrCollectionResponse * deleteCidrCollection(const DeleteCidrCollectionRequest &request);
    ...
    ListCidrBlocksResponse * listCidrBlocks(const ListCidrBlocksRequest &request);
    ListCidrCollectionsResponse * listCidrCollections(const ListCidrCollectionsRequest &request);
    ListCidrLocationsResponse * listCidrLocations(const ListCidrLocationsRequest &request);
