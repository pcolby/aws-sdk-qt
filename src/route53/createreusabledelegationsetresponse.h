...
class QTAWS_EXPORT CreateReusableDelegationSetResponse : public CreateReusableDelegationSetResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateReusableDelegationSetRequest * request() const;
