...
class QTAWS_EXPORT ListVPCAssociationAuthorizationsResponse : public Route53Response {
    Q_OBJECT
...
public:
    ...
    virtual const ListVPCAssociationAuthorizationsRequest * request() const override;
