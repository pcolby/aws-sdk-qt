...
class QTAWS_EXPORT CreateTrafficPolicyVersionResponse : public CreateTrafficPolicyVersionResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateTrafficPolicyVersionRequest * request() const;
