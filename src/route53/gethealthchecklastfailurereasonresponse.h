...
class QTAWS_EXPORT GetHealthCheckLastFailureReasonResponse : public Route53Response {
    Q_OBJECT
...
public:
    ...
    virtual const GetHealthCheckLastFailureReasonRequest * request() const override;
