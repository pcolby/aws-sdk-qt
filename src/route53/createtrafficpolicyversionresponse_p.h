...
class QTAWS_EXPORT CreateTrafficPolicyVersionResponsePrivate : public Route53ResponsePrivate {
    Q_OBJECT

public:

    CreateTrafficPolicyVersionResponsePrivate(CreateTrafficPolicyVersionResponse * const q);
