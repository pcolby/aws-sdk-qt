...
class QTAWS_EXPORT GetTrafficPolicyInstanceRequestPrivate : public Route53RequestPrivate {

public:
    GetTrafficPolicyInstanceRequestPrivate(const Route53::Action action,
