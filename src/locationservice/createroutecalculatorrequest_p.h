...
class QTAWS_EXPORT CreateRouteCalculatorRequestPrivate : public LocationServiceRequestPrivate {

public:
    CreateRouteCalculatorRequestPrivate(const LocationServiceRequest::Action action,
