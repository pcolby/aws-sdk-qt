...
class QTAWS_EXPORT ListGeofenceCollectionsResponsePrivate : public LocationServiceResponsePrivate {

public:

    ListGeofenceCollectionsResponsePrivate(ListGeofenceCollectionsResponse * const q);
