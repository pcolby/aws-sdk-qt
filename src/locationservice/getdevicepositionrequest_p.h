...
class QTAWS_EXPORT GetDevicePositionRequestPrivate : public LocationServiceRequestPrivate {

public:
    GetDevicePositionRequestPrivate(const LocationServiceRequest::Action action,
