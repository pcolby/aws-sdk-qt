...
class QTAWS_EXPORT BatchDeleteDevicePositionHistoryRequestPrivate : public LocationServiceRequestPrivate {

public:
    BatchDeleteDevicePositionHistoryRequestPrivate(const LocationServiceRequest::Action action,
