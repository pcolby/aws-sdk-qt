...
class QTAWS_EXPORT CreateGeofenceCollectionRequestPrivate : public LocationServiceRequestPrivate {

public:
    CreateGeofenceCollectionRequestPrivate(const LocationServiceRequest::Action action,
