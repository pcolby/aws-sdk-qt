...
class QTAWS_EXPORT CreateRouteCalculatorResponsePrivate : public LocationServiceResponsePrivate {

public:

    CreateRouteCalculatorResponsePrivate(CreateRouteCalculatorResponse * const q);
