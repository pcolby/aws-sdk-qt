...
/*!
 * \class QtAws::LocationService::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for LocationService TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : LocationServiceResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(LocationServiceResponse::request());
}

/*!
 * \reimp
 * Parses a successful LocationService TagResource \a response.
 */
...
/*!
 * \class QtAws::LocationService::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : LocationServiceResponsePrivate(q)
{

}

/*!
 * Parses a LocationService TagResource response element from \a xml.
 */
