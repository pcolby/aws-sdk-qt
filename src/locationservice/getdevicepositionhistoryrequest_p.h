...
class QTAWS_EXPORT GetDevicePositionHistoryRequestPrivate : public LocationServiceRequestPrivate {

public:
    GetDevicePositionHistoryRequestPrivate(const LocationServiceRequest::Action action,
