...
class QTAWS_EXPORT GetMapSpritesRequestPrivate : public LocationServiceRequestPrivate {

public:
    GetMapSpritesRequestPrivate(const LocationServiceRequest::Action action,
