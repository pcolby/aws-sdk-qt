...
class QTAWS_EXPORT DescribeTrackerRequestPrivate : public LocationServiceRequestPrivate {

public:
    DescribeTrackerRequestPrivate(const LocationServiceRequest::Action action,
