...
class QTAWS_EXPORT ListTrackerConsumersResponsePrivate : public LocationServiceResponsePrivate {

public:

    ListTrackerConsumersResponsePrivate(ListTrackerConsumersResponse * const q);
