...
class QTAWS_EXPORT CreatePlaceIndexResponsePrivate : public LocationServiceResponsePrivate {

public:

    CreatePlaceIndexResponsePrivate(CreatePlaceIndexResponse * const q);
