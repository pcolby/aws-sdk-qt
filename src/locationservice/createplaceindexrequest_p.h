...
class QTAWS_EXPORT CreatePlaceIndexRequestPrivate : public LocationServiceRequestPrivate {

public:
    CreatePlaceIndexRequestPrivate(const LocationServiceRequest::Action action,
