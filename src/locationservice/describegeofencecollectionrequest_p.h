...
class QTAWS_EXPORT DescribeGeofenceCollectionRequestPrivate : public LocationServiceRequestPrivate {

public:
    DescribeGeofenceCollectionRequestPrivate(const LocationServiceRequest::Action action,
