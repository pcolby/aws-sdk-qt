...
class QTAWS_EXPORT DescribeRouteCalculatorRequestPrivate : public LocationServiceRequestPrivate {

public:
    DescribeRouteCalculatorRequestPrivate(const LocationServiceRequest::Action action,
