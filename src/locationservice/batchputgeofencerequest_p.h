...
class QTAWS_EXPORT BatchPutGeofenceRequestPrivate : public LocationServiceRequestPrivate {

public:
    BatchPutGeofenceRequestPrivate(const LocationServiceRequest::Action action,
