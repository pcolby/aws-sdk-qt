...
class QTAWS_EXPORT BatchGetDevicePositionResponsePrivate : public LocationServiceResponsePrivate {

public:

    BatchGetDevicePositionResponsePrivate(BatchGetDevicePositionResponse * const q);
