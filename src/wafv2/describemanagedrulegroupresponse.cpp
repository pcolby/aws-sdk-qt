...
#include "describemanagedrulegroupresponse_p.h"
...
/*!
 * \class QtAws::Wafv2::DescribeManagedRuleGroupResponse
 * \brief The DescribeManagedRuleGroupResponse class provides an interace for Wafv2 DescribeManagedRuleGroup responses.
 *
 * \inmodule QtAwsWafv2
 *
...
/*!
 * Constructs a DescribeManagedRuleGroupResponse object for \a reply to \a request, with parent \a parent.
 */
DescribeManagedRuleGroupResponse::DescribeManagedRuleGroupResponse(
        const DescribeManagedRuleGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Wafv2Response(new DescribeManagedRuleGroupResponsePrivate(this), parent)
{
    setRequest(new DescribeManagedRuleGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Wafv2 DescribeManagedRuleGroup \a response.
 */
void DescribeManagedRuleGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DescribeManagedRuleGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Wafv2::DescribeManagedRuleGroupResponsePrivate
 * \brief The DescribeManagedRuleGroupResponsePrivate class provides private implementation for DescribeManagedRuleGroupResponse.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a DescribeManagedRuleGroupResponsePrivate object with public implementation \a q.
 */
DescribeManagedRuleGroupResponsePrivate::DescribeManagedRuleGroupResponsePrivate(
    DescribeManagedRuleGroupResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a Wafv2 DescribeManagedRuleGroup response element from \a xml.
 */
void DescribeManagedRuleGroupResponsePrivate::parseDescribeManagedRuleGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeManagedRuleGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
