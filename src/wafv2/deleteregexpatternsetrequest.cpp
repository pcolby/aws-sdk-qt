...
/*!
 * \class QtAws::Wafv2::DeleteRegexPatternSetRequest
 * \brief The DeleteRegexPatternSetRequest class provides an interface for Wafv2 DeleteRegexPatternSet requests.
 *
 * \inmodule QtAwsWafv2
 *
...
DeleteRegexPatternSetRequest::DeleteRegexPatternSetRequest(const DeleteRegexPatternSetRequest &other)
    : Wafv2Request(new DeleteRegexPatternSetRequestPrivate(*other.d_func(), this))
{
...
DeleteRegexPatternSetRequest::DeleteRegexPatternSetRequest()
    : Wafv2Request(new DeleteRegexPatternSetRequestPrivate(Wafv2Request::DeleteRegexPatternSetAction, this))
{
...
/*!
 * \class QtAws::Wafv2::DeleteRegexPatternSetRequestPrivate
...
/*!
 * Constructs a DeleteRegexPatternSetRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
DeleteRegexPatternSetRequestPrivate::DeleteRegexPatternSetRequestPrivate(
    const Wafv2Request::Action action, DeleteRegexPatternSetRequest * const q)
