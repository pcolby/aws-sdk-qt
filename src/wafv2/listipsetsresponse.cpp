...
/*!
 * \class QtAws::WAFV2::ListIPSetsResponse
 * \brief The ListIPSetsResponse class provides an interace for WAFV2 ListIPSets responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
ListIPSetsResponse::ListIPSetsResponse(
    ...
    : Wafv2Response(new ListIPSetsResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListIPSetsRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 ListIPSets \a response.
 */
...
/*!
 * \class QtAws::WAFV2::ListIPSetsResponsePrivate
...
ListIPSetsResponsePrivate::ListIPSetsResponsePrivate(
    ListIPSetsResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 ListIPSets response element from \a xml.
 */
