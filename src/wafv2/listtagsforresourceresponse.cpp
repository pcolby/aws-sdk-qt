...
/*!
 * \class QtAws::WAFV2::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for WAFV2 ListTagsForResource responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
 ...
 *
 * \sa Wafv2Client::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : Wafv2Response(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::WAFV2::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 ListTagsForResource response element from \a xml.
 */
