...
/*!
 * \class QtAws::WAFV2::CreateRuleGroupResponse
 * \brief The CreateRuleGroupResponse class provides an interace for WAFV2 CreateRuleGroup responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
 ...
 *
 * \sa Wafv2Client::createRuleGroup
 */
...
CreateRuleGroupResponse::CreateRuleGroupResponse(
    ...
    : Wafv2Response(new CreateRuleGroupResponsePrivate(this), parent)
{
...
{
    return static_cast<const CreateRuleGroupRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 CreateRuleGroup \a response.
 */
...
/*!
 * \class QtAws::WAFV2::CreateRuleGroupResponsePrivate
...
CreateRuleGroupResponsePrivate::CreateRuleGroupResponsePrivate(
    CreateRuleGroupResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 CreateRuleGroup response element from \a xml.
 */
