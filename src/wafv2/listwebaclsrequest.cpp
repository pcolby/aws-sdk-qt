...
/*!
 * \class QtAws::Wafv2::ListWebACLsRequest
 * \brief The ListWebACLsRequest class provides an interface for Wafv2 ListWebACLs requests.
 *
 * \inmodule QtAwsWafv2
 *
...
ListWebACLsRequest::ListWebACLsRequest(const ListWebACLsRequest &other)
    : Wafv2Request(new ListWebACLsRequestPrivate(*other.d_func(), this))
{
...
ListWebACLsRequest::ListWebACLsRequest()
    : Wafv2Request(new ListWebACLsRequestPrivate(Wafv2Request::ListWebACLsAction, this))
{
...
/*!
 * \class QtAws::Wafv2::ListWebACLsRequestPrivate
...
/*!
 * Constructs a ListWebACLsRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
ListWebACLsRequestPrivate::ListWebACLsRequestPrivate(
    const Wafv2Request::Action action, ListWebACLsRequest * const q)
