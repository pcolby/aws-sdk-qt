...
/*!
 * \class QtAws::Wafv2::ListResourcesForWebACLRequest
 * \brief The ListResourcesForWebACLRequest class provides an interface for Wafv2 ListResourcesForWebACL requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::listResourcesForWebACL
 */
...
ListResourcesForWebACLRequest::ListResourcesForWebACLRequest(const ListResourcesForWebACLRequest &other)
    : Wafv2Request(new ListResourcesForWebACLRequestPrivate(*other.d_func(), this))
{
...
ListResourcesForWebACLRequest::ListResourcesForWebACLRequest()
    : Wafv2Request(new ListResourcesForWebACLRequestPrivate(Wafv2Request::ListResourcesForWebACLAction, this))
{
...
/*!
 * \class QtAws::Wafv2::ListResourcesForWebACLRequestPrivate
...
/*!
 * Constructs a ListResourcesForWebACLRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
ListResourcesForWebACLRequestPrivate::ListResourcesForWebACLRequestPrivate(
    const Wafv2Request::Action action, ListResourcesForWebACLRequest * const q)
