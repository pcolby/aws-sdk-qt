...
/*!
 * \class QtAws::WAFV2::CreateRegexPatternSetResponse
 * \brief The CreateRegexPatternSetResponse class provides an interace for WAFV2 CreateRegexPatternSet responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
 ...
 *
 * \sa Wafv2Client::createRegexPatternSet
 */
...
CreateRegexPatternSetResponse::CreateRegexPatternSetResponse(
    ...
    : Wafv2Response(new CreateRegexPatternSetResponsePrivate(this), parent)
{
...
{
    return static_cast<const CreateRegexPatternSetRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 CreateRegexPatternSet \a response.
 */
...
/*!
 * \class QtAws::WAFV2::CreateRegexPatternSetResponsePrivate
...
CreateRegexPatternSetResponsePrivate::CreateRegexPatternSetResponsePrivate(
    CreateRegexPatternSetResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 CreateRegexPatternSet response element from \a xml.
 */
