...
/*!
 * \class QtAws::WAFV2::DeleteRuleGroupResponse
 * \brief The DeleteRuleGroupResponse class provides an interace for WAFV2 DeleteRuleGroup responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
 ...
 *
 * \sa Wafv2Client::deleteRuleGroup
 */
...
DeleteRuleGroupResponse::DeleteRuleGroupResponse(
    ...
    : Wafv2Response(new DeleteRuleGroupResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteRuleGroupRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 DeleteRuleGroup \a response.
 */
...
/*!
 * \class QtAws::WAFV2::DeleteRuleGroupResponsePrivate
...
DeleteRuleGroupResponsePrivate::DeleteRuleGroupResponsePrivate(
    DeleteRuleGroupResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 DeleteRuleGroup response element from \a xml.
 */
