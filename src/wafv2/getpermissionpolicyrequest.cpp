...
/*!
 * \class QtAws::WAFV2::GetPermissionPolicyRequest
 * \brief The GetPermissionPolicyRequest class provides an interface for WAFV2 GetPermissionPolicy requests.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
 ...
 *
 * \sa Wafv2Client::getPermissionPolicy
 */
...
GetPermissionPolicyRequest::GetPermissionPolicyRequest(const GetPermissionPolicyRequest &other)
    : Wafv2Request(new GetPermissionPolicyRequestPrivate(*other.d_func(), this))
{
...
GetPermissionPolicyRequest::GetPermissionPolicyRequest()
    : Wafv2Request(new GetPermissionPolicyRequestPrivate(Wafv2Request::GetPermissionPolicyAction, this))
{
...
/*!
 * \class QtAws::WAFV2::GetPermissionPolicyRequestPrivate
...
/*!
 * Constructs a GetPermissionPolicyRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
GetPermissionPolicyRequestPrivate::GetPermissionPolicyRequestPrivate(
    const Wafv2Request::Action action, GetPermissionPolicyRequest * const q)
