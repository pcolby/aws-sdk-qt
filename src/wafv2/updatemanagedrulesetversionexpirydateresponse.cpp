...
#include "updatemanagedrulesetversionexpirydateresponse_p.h"
...
/*!
 * \class QtAws::Wafv2::UpdateManagedRuleSetVersionExpiryDateResponse
 * \brief The UpdateManagedRuleSetVersionExpiryDateResponse class provides an interace for Wafv2 UpdateManagedRuleSetVersionExpiryDate responses.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::updateManagedRuleSetVersionExpiryDate
 */

/*!
 * Constructs a UpdateManagedRuleSetVersionExpiryDateResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateManagedRuleSetVersionExpiryDateResponse::UpdateManagedRuleSetVersionExpiryDateResponse(
        const UpdateManagedRuleSetVersionExpiryDateRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Wafv2Response(new UpdateManagedRuleSetVersionExpiryDateResponsePrivate(this), parent)
{
    setRequest(new UpdateManagedRuleSetVersionExpiryDateRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateManagedRuleSetVersionExpiryDateRequest * UpdateManagedRuleSetVersionExpiryDateResponse::request() const
{
    Q_D(const UpdateManagedRuleSetVersionExpiryDateResponse);
    return static_cast<const UpdateManagedRuleSetVersionExpiryDateRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Wafv2 UpdateManagedRuleSetVersionExpiryDate \a response.
 */
void UpdateManagedRuleSetVersionExpiryDateResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateManagedRuleSetVersionExpiryDateResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Wafv2::UpdateManagedRuleSetVersionExpiryDateResponsePrivate
 * \brief The UpdateManagedRuleSetVersionExpiryDateResponsePrivate class provides private implementation for UpdateManagedRuleSetVersionExpiryDateResponse.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a UpdateManagedRuleSetVersionExpiryDateResponsePrivate object with public implementation \a q.
 */
UpdateManagedRuleSetVersionExpiryDateResponsePrivate::UpdateManagedRuleSetVersionExpiryDateResponsePrivate(
    UpdateManagedRuleSetVersionExpiryDateResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a Wafv2 UpdateManagedRuleSetVersionExpiryDate response element from \a xml.
 */
void UpdateManagedRuleSetVersionExpiryDateResponsePrivate::parseUpdateManagedRuleSetVersionExpiryDateResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateManagedRuleSetVersionExpiryDateResponse"));
    Q_UNUSED(xml) ///< @todo
}
