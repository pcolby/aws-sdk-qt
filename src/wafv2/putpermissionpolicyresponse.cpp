...
/*!
 * \class QtAws::WAFV2::PutPermissionPolicyResponse
 * \brief The PutPermissionPolicyResponse class provides an interace for WAFV2 PutPermissionPolicy responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
 ...
 *
 * \sa Wafv2Client::putPermissionPolicy
 */
...
PutPermissionPolicyResponse::PutPermissionPolicyResponse(
    ...
    : Wafv2Response(new PutPermissionPolicyResponsePrivate(this), parent)
{
...
{
    return static_cast<const PutPermissionPolicyRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 PutPermissionPolicy \a response.
 */
...
/*!
 * \class QtAws::WAFV2::PutPermissionPolicyResponsePrivate
...
PutPermissionPolicyResponsePrivate::PutPermissionPolicyResponsePrivate(
    PutPermissionPolicyResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 PutPermissionPolicy response element from \a xml.
 */
