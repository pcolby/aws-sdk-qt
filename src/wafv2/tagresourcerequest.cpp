...
/*!
 * \class QtAws::WAFV2::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for WAFV2 TagResource requests.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : Wafv2Request(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : Wafv2Request(new TagResourceRequestPrivate(Wafv2Request::TagResourceAction, this))
{
...
/*!
 * \class QtAws::WAFV2::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const Wafv2Request::Action action, TagResourceRequest * const q)
