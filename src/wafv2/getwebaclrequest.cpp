...
/*!
 * \class QtAws::Wafv2::GetWebACLRequest
 * \brief The GetWebACLRequest class provides an interface for Wafv2 GetWebACL requests.
 *
 * \inmodule QtAwsWafv2
 *
...
GetWebACLRequest::GetWebACLRequest(const GetWebACLRequest &other)
    : Wafv2Request(new GetWebACLRequestPrivate(*other.d_func(), this))
{
...
GetWebACLRequest::GetWebACLRequest()
    : Wafv2Request(new GetWebACLRequestPrivate(Wafv2Request::GetWebACLAction, this))
{
...
/*!
 * \class QtAws::Wafv2::GetWebACLRequestPrivate
...
/*!
 * Constructs a GetWebACLRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
GetWebACLRequestPrivate::GetWebACLRequestPrivate(
    const Wafv2Request::Action action, GetWebACLRequest * const q)
