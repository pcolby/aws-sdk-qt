...
/*!
 * \class QtAws::WAFV2::AssociateWebACLResponse
 * \brief The AssociateWebACLResponse class provides an interace for WAFV2 AssociateWebACL responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
AssociateWebACLResponse::AssociateWebACLResponse(
    ...
    : Wafv2Response(new AssociateWebACLResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WAFV2 AssociateWebACL \a response.
 */
...
/*!
 * \class QtAws::WAFV2::AssociateWebACLResponsePrivate
...
AssociateWebACLResponsePrivate::AssociateWebACLResponsePrivate(
    AssociateWebACLResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 AssociateWebACL response element from \a xml.
 */
