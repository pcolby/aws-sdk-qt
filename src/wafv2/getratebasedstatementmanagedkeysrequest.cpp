...
#include "getratebasedstatementmanagedkeysrequest_p.h"
...
/*!
 * \class QtAws::WAFV2::GetRateBasedStatementManagedKeysRequest
 * \brief The GetRateBasedStatementManagedKeysRequest class provides an interface for WAFV2 GetRateBasedStatementManagedKeys requests.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
 ...
 *
 * \sa Wafv2Client::getRateBasedStatementManagedKeys
 */

/*!
 * Constructs a copy of \a other.
 */
GetRateBasedStatementManagedKeysRequest::GetRateBasedStatementManagedKeysRequest(const GetRateBasedStatementManagedKeysRequest &other)
    : Wafv2Request(new GetRateBasedStatementManagedKeysRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetRateBasedStatementManagedKeysRequest object.
 */
GetRateBasedStatementManagedKeysRequest::GetRateBasedStatementManagedKeysRequest()
    : Wafv2Request(new GetRateBasedStatementManagedKeysRequestPrivate(Wafv2Request::GetRateBasedStatementManagedKeysAction, this))
{
 ...
 * \reimp
 */
bool GetRateBasedStatementManagedKeysRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetRateBasedStatementManagedKeysResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetRateBasedStatementManagedKeysRequest::response(QNetworkReply * const reply) const
{
    return new GetRateBasedStatementManagedKeysResponse(*this, reply);
}

/*!
 * \class QtAws::WAFV2::GetRateBasedStatementManagedKeysRequestPrivate
 * \brief The GetRateBasedStatementManagedKeysRequestPrivate class provides private implementation for GetRateBasedStatementManagedKeysRequest.
 * \internal
 *
 * \inmodule QtAwsWAFV2
 */
...
/*!
 * Constructs a GetRateBasedStatementManagedKeysRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
GetRateBasedStatementManagedKeysRequestPrivate::GetRateBasedStatementManagedKeysRequestPrivate(
    const Wafv2Request::Action action, GetRateBasedStatementManagedKeysRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetRateBasedStatementManagedKeysRequest
 * class' copy constructor.
 */
GetRateBasedStatementManagedKeysRequestPrivate::GetRateBasedStatementManagedKeysRequestPrivate(
    const GetRateBasedStatementManagedKeysRequestPrivate &other, GetRateBasedStatementManagedKeysRequest * const q)
