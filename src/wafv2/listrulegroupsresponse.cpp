...
/*!
 * \class QtAws::WAFV2::ListRuleGroupsResponse
 * \brief The ListRuleGroupsResponse class provides an interace for WAFV2 ListRuleGroups responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
ListRuleGroupsResponse::ListRuleGroupsResponse(
    ...
    : Wafv2Response(new ListRuleGroupsResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListRuleGroupsRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 ListRuleGroups \a response.
 */
...
/*!
 * \class QtAws::WAFV2::ListRuleGroupsResponsePrivate
...
ListRuleGroupsResponsePrivate::ListRuleGroupsResponsePrivate(
    ListRuleGroupsResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 ListRuleGroups response element from \a xml.
 */
