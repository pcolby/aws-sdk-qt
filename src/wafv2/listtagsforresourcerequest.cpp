...
/*!
 * \class QtAws::Wafv2::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for Wafv2 ListTagsForResource requests.
 *
 * \inmodule QtAwsWafv2
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : Wafv2Request(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : Wafv2Request(new ListTagsForResourceRequestPrivate(Wafv2Request::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::Wafv2::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const Wafv2Request::Action action, ListTagsForResourceRequest * const q)
