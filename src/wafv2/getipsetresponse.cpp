...
/*!
 * \class QtAws::WAFV2::GetIPSetResponse
 * \brief The GetIPSetResponse class provides an interace for WAFV2 GetIPSet responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
GetIPSetResponse::GetIPSetResponse(
    ...
    : Wafv2Response(new GetIPSetResponsePrivate(this), parent)
{
...
{
    return static_cast<const GetIPSetRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 GetIPSet \a response.
 */
...
/*!
 * \class QtAws::WAFV2::GetIPSetResponsePrivate
...
GetIPSetResponsePrivate::GetIPSetResponsePrivate(
    GetIPSetResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 GetIPSet response element from \a xml.
 */
