...
/*!
 * \class QtAws::Wafv2::ListRuleGroupsRequest
 * \brief The ListRuleGroupsRequest class provides an interface for Wafv2 ListRuleGroups requests.
 *
 * \inmodule QtAwsWafv2
 *
...
ListRuleGroupsRequest::ListRuleGroupsRequest(const ListRuleGroupsRequest &other)
    : Wafv2Request(new ListRuleGroupsRequestPrivate(*other.d_func(), this))
{
...
ListRuleGroupsRequest::ListRuleGroupsRequest()
    : Wafv2Request(new ListRuleGroupsRequestPrivate(Wafv2Request::ListRuleGroupsAction, this))
{
...
/*!
 * \class QtAws::Wafv2::ListRuleGroupsRequestPrivate
...
/*!
 * Constructs a ListRuleGroupsRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
ListRuleGroupsRequestPrivate::ListRuleGroupsRequestPrivate(
    const Wafv2Request::Action action, ListRuleGroupsRequest * const q)
