...
/*!
 * \class QtAws::WAFV2::UpdateRuleGroupRequest
 * \brief The UpdateRuleGroupRequest class provides an interface for WAFV2 UpdateRuleGroup requests.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
UpdateRuleGroupRequest::UpdateRuleGroupRequest(const UpdateRuleGroupRequest &other)
    : Wafv2Request(new UpdateRuleGroupRequestPrivate(*other.d_func(), this))
{
...
UpdateRuleGroupRequest::UpdateRuleGroupRequest()
    : Wafv2Request(new UpdateRuleGroupRequestPrivate(Wafv2Request::UpdateRuleGroupAction, this))
{
...
/*!
 * \class QtAws::WAFV2::UpdateRuleGroupRequestPrivate
...
/*!
 * Constructs a UpdateRuleGroupRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
UpdateRuleGroupRequestPrivate::UpdateRuleGroupRequestPrivate(
    const Wafv2Request::Action action, UpdateRuleGroupRequest * const q)
