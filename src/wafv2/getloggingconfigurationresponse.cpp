...
/*!
 * \class QtAws::WAFV2::GetLoggingConfigurationResponse
 * \brief The GetLoggingConfigurationResponse class provides an interace for WAFV2 GetLoggingConfiguration responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
GetLoggingConfigurationResponse::GetLoggingConfigurationResponse(
    ...
    : Wafv2Response(new GetLoggingConfigurationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WAFV2 GetLoggingConfiguration \a response.
 */
...
/*!
 * \class QtAws::WAFV2::GetLoggingConfigurationResponsePrivate
...
GetLoggingConfigurationResponsePrivate::GetLoggingConfigurationResponsePrivate(
    GetLoggingConfigurationResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 GetLoggingConfiguration response element from \a xml.
 */
