...
#include "listavailablemanagedrulegroupsresponse_p.h"
...
/*!
 * \class QtAws::Wafv2::ListAvailableManagedRuleGroupsResponse
 * \brief The ListAvailableManagedRuleGroupsResponse class provides an interace for Wafv2 ListAvailableManagedRuleGroups responses.
 *
 * \inmodule QtAwsWafv2
 *
...
/*!
 * Constructs a ListAvailableManagedRuleGroupsResponse object for \a reply to \a request, with parent \a parent.
 */
ListAvailableManagedRuleGroupsResponse::ListAvailableManagedRuleGroupsResponse(
        const ListAvailableManagedRuleGroupsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Wafv2Response(new ListAvailableManagedRuleGroupsResponsePrivate(this), parent)
{
    setRequest(new ListAvailableManagedRuleGroupsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Wafv2 ListAvailableManagedRuleGroups \a response.
 */
void ListAvailableManagedRuleGroupsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListAvailableManagedRuleGroupsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Wafv2::ListAvailableManagedRuleGroupsResponsePrivate
 * \brief The ListAvailableManagedRuleGroupsResponsePrivate class provides private implementation for ListAvailableManagedRuleGroupsResponse.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a ListAvailableManagedRuleGroupsResponsePrivate object with public implementation \a q.
 */
ListAvailableManagedRuleGroupsResponsePrivate::ListAvailableManagedRuleGroupsResponsePrivate(
    ListAvailableManagedRuleGroupsResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a Wafv2 ListAvailableManagedRuleGroups response element from \a xml.
 */
void ListAvailableManagedRuleGroupsResponsePrivate::parseListAvailableManagedRuleGroupsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListAvailableManagedRuleGroupsResponse"));
    Q_UNUSED(xml) ///< @todo
}
