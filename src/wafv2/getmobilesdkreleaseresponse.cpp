...
#include "getmobilesdkreleaseresponse_p.h"
...
/*!
 * \class QtAws::Wafv2::GetMobileSdkReleaseResponse
 * \brief The GetMobileSdkReleaseResponse class provides an interace for Wafv2 GetMobileSdkRelease responses.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::getMobileSdkRelease
 */

/*!
 * Constructs a GetMobileSdkReleaseResponse object for \a reply to \a request, with parent \a parent.
 */
GetMobileSdkReleaseResponse::GetMobileSdkReleaseResponse(
        const GetMobileSdkReleaseRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Wafv2Response(new GetMobileSdkReleaseResponsePrivate(this), parent)
{
    setRequest(new GetMobileSdkReleaseRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetMobileSdkReleaseRequest * GetMobileSdkReleaseResponse::request() const
{
    Q_D(const GetMobileSdkReleaseResponse);
    return static_cast<const GetMobileSdkReleaseRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Wafv2 GetMobileSdkRelease \a response.
 */
void GetMobileSdkReleaseResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetMobileSdkReleaseResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Wafv2::GetMobileSdkReleaseResponsePrivate
 * \brief The GetMobileSdkReleaseResponsePrivate class provides private implementation for GetMobileSdkReleaseResponse.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a GetMobileSdkReleaseResponsePrivate object with public implementation \a q.
 */
GetMobileSdkReleaseResponsePrivate::GetMobileSdkReleaseResponsePrivate(
    GetMobileSdkReleaseResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a Wafv2 GetMobileSdkRelease response element from \a xml.
 */
void GetMobileSdkReleaseResponsePrivate::parseGetMobileSdkReleaseResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetMobileSdkReleaseResponse"));
    Q_UNUSED(xml) ///< @todo
}
