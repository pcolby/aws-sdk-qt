...
/*!
 * \class QtAws::WAFV2::DeletePermissionPolicyRequest
 * \brief The DeletePermissionPolicyRequest class provides an interface for WAFV2 DeletePermissionPolicy requests.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
DeletePermissionPolicyRequest::DeletePermissionPolicyRequest(const DeletePermissionPolicyRequest &other)
    : Wafv2Request(new DeletePermissionPolicyRequestPrivate(*other.d_func(), this))
{
...
DeletePermissionPolicyRequest::DeletePermissionPolicyRequest()
    : Wafv2Request(new DeletePermissionPolicyRequestPrivate(Wafv2Request::DeletePermissionPolicyAction, this))
{
...
/*!
 * \class QtAws::WAFV2::DeletePermissionPolicyRequestPrivate
...
/*!
 * Constructs a DeletePermissionPolicyRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
DeletePermissionPolicyRequestPrivate::DeletePermissionPolicyRequestPrivate(
    const Wafv2Request::Action action, DeletePermissionPolicyRequest * const q)
