...
/*!
 * \class QtAws::WAFV2::ListRegexPatternSetsResponse
 * \brief The ListRegexPatternSetsResponse class provides an interace for WAFV2 ListRegexPatternSets responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
ListRegexPatternSetsResponse::ListRegexPatternSetsResponse(
    ...
    : Wafv2Response(new ListRegexPatternSetsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WAFV2 ListRegexPatternSets \a response.
 */
...
/*!
 * \class QtAws::WAFV2::ListRegexPatternSetsResponsePrivate
...
ListRegexPatternSetsResponsePrivate::ListRegexPatternSetsResponsePrivate(
    ListRegexPatternSetsResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 ListRegexPatternSets response element from \a xml.
 */
