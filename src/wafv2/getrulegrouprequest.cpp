...
/*!
 * \class QtAws::Wafv2::GetRuleGroupRequest
 * \brief The GetRuleGroupRequest class provides an interface for Wafv2 GetRuleGroup requests.
 *
 * \inmodule QtAwsWafv2
 *
...
GetRuleGroupRequest::GetRuleGroupRequest(const GetRuleGroupRequest &other)
    : Wafv2Request(new GetRuleGroupRequestPrivate(*other.d_func(), this))
{
...
GetRuleGroupRequest::GetRuleGroupRequest()
    : Wafv2Request(new GetRuleGroupRequestPrivate(Wafv2Request::GetRuleGroupAction, this))
{
...
/*!
 * \class QtAws::Wafv2::GetRuleGroupRequestPrivate
...
/*!
 * Constructs a GetRuleGroupRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
GetRuleGroupRequestPrivate::GetRuleGroupRequestPrivate(
    const Wafv2Request::Action action, GetRuleGroupRequest * const q)
