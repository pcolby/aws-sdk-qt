...
#include "listavailablemanagedrulegroupsrequest_p.h"
...
/*!
 * \class QtAws::WAFV2::ListAvailableManagedRuleGroupsRequest
 * \brief The ListAvailableManagedRuleGroupsRequest class provides an interface for WAFV2 ListAvailableManagedRuleGroups requests.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
 ...
 *
 * \sa Wafv2Client::listAvailableManagedRuleGroups
 */

/*!
 * Constructs a copy of \a other.
 */
ListAvailableManagedRuleGroupsRequest::ListAvailableManagedRuleGroupsRequest(const ListAvailableManagedRuleGroupsRequest &other)
    : Wafv2Request(new ListAvailableManagedRuleGroupsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListAvailableManagedRuleGroupsRequest object.
 */
ListAvailableManagedRuleGroupsRequest::ListAvailableManagedRuleGroupsRequest()
    : Wafv2Request(new ListAvailableManagedRuleGroupsRequestPrivate(Wafv2Request::ListAvailableManagedRuleGroupsAction, this))
{
 ...
 * \reimp
 */
bool ListAvailableManagedRuleGroupsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListAvailableManagedRuleGroupsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListAvailableManagedRuleGroupsRequest::response(QNetworkReply * const reply) const
{
    return new ListAvailableManagedRuleGroupsResponse(*this, reply);
}

/*!
 * \class QtAws::WAFV2::ListAvailableManagedRuleGroupsRequestPrivate
 * \brief The ListAvailableManagedRuleGroupsRequestPrivate class provides private implementation for ListAvailableManagedRuleGroupsRequest.
 * \internal
 *
 * \inmodule QtAwsWAFV2
 */
...
/*!
 * Constructs a ListAvailableManagedRuleGroupsRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
ListAvailableManagedRuleGroupsRequestPrivate::ListAvailableManagedRuleGroupsRequestPrivate(
    const Wafv2Request::Action action, ListAvailableManagedRuleGroupsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListAvailableManagedRuleGroupsRequest
 * class' copy constructor.
 */
ListAvailableManagedRuleGroupsRequestPrivate::ListAvailableManagedRuleGroupsRequestPrivate(
    const ListAvailableManagedRuleGroupsRequestPrivate &other, ListAvailableManagedRuleGroupsRequest * const q)
