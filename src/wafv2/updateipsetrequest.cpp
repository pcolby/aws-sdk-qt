...
/*!
 * \class QtAws::Wafv2::UpdateIPSetRequest
 * \brief The UpdateIPSetRequest class provides an interface for Wafv2 UpdateIPSet requests.
 *
 * \inmodule QtAwsWafv2
 *
...
UpdateIPSetRequest::UpdateIPSetRequest(const UpdateIPSetRequest &other)
    : Wafv2Request(new UpdateIPSetRequestPrivate(*other.d_func(), this))
{
...
UpdateIPSetRequest::UpdateIPSetRequest()
    : Wafv2Request(new UpdateIPSetRequestPrivate(Wafv2Request::UpdateIPSetAction, this))
{
...
/*!
 * \class QtAws::Wafv2::UpdateIPSetRequestPrivate
...
/*!
 * Constructs a UpdateIPSetRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
UpdateIPSetRequestPrivate::UpdateIPSetRequestPrivate(
    const Wafv2Request::Action action, UpdateIPSetRequest * const q)
