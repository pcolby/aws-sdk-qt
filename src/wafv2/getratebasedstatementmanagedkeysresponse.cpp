...
#include "getratebasedstatementmanagedkeysresponse_p.h"
...
/*!
 * \class QtAws::Wafv2::GetRateBasedStatementManagedKeysResponse
 * \brief The GetRateBasedStatementManagedKeysResponse class provides an interace for Wafv2 GetRateBasedStatementManagedKeys responses.
 *
 * \inmodule QtAwsWafv2
 *
...
/*!
 * Constructs a GetRateBasedStatementManagedKeysResponse object for \a reply to \a request, with parent \a parent.
 */
GetRateBasedStatementManagedKeysResponse::GetRateBasedStatementManagedKeysResponse(
        const GetRateBasedStatementManagedKeysRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Wafv2Response(new GetRateBasedStatementManagedKeysResponsePrivate(this), parent)
{
    setRequest(new GetRateBasedStatementManagedKeysRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Wafv2 GetRateBasedStatementManagedKeys \a response.
 */
void GetRateBasedStatementManagedKeysResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetRateBasedStatementManagedKeysResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Wafv2::GetRateBasedStatementManagedKeysResponsePrivate
 * \brief The GetRateBasedStatementManagedKeysResponsePrivate class provides private implementation for GetRateBasedStatementManagedKeysResponse.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a GetRateBasedStatementManagedKeysResponsePrivate object with public implementation \a q.
 */
GetRateBasedStatementManagedKeysResponsePrivate::GetRateBasedStatementManagedKeysResponsePrivate(
    GetRateBasedStatementManagedKeysResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a Wafv2 GetRateBasedStatementManagedKeys response element from \a xml.
 */
void GetRateBasedStatementManagedKeysResponsePrivate::parseGetRateBasedStatementManagedKeysResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetRateBasedStatementManagedKeysResponse"));
    Q_UNUSED(xml) ///< @todo
}
