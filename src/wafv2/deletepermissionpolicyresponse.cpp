...
/*!
 * \class QtAws::WAFV2::DeletePermissionPolicyResponse
 * \brief The DeletePermissionPolicyResponse class provides an interace for WAFV2 DeletePermissionPolicy responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
 ...
 *
 * \sa Wafv2Client::deletePermissionPolicy
 */
...
DeletePermissionPolicyResponse::DeletePermissionPolicyResponse(
    ...
    : Wafv2Response(new DeletePermissionPolicyResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeletePermissionPolicyRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 DeletePermissionPolicy \a response.
 */
...
/*!
 * \class QtAws::WAFV2::DeletePermissionPolicyResponsePrivate
...
DeletePermissionPolicyResponsePrivate::DeletePermissionPolicyResponsePrivate(
    DeletePermissionPolicyResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 DeletePermissionPolicy response element from \a xml.
 */
