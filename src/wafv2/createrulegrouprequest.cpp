...
/*!
 * \class QtAws::WAFV2::CreateRuleGroupRequest
 * \brief The CreateRuleGroupRequest class provides an interface for WAFV2 CreateRuleGroup requests.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
CreateRuleGroupRequest::CreateRuleGroupRequest(const CreateRuleGroupRequest &other)
    : Wafv2Request(new CreateRuleGroupRequestPrivate(*other.d_func(), this))
{
...
CreateRuleGroupRequest::CreateRuleGroupRequest()
    : Wafv2Request(new CreateRuleGroupRequestPrivate(Wafv2Request::CreateRuleGroupAction, this))
{
...
/*!
 * \class QtAws::WAFV2::CreateRuleGroupRequestPrivate
...
/*!
 * Constructs a CreateRuleGroupRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
CreateRuleGroupRequestPrivate::CreateRuleGroupRequestPrivate(
    const Wafv2Request::Action action, CreateRuleGroupRequest * const q)
