...
/*!
 * \class QtAws::Wafv2::GetWebACLForResourceRequest
 * \brief The GetWebACLForResourceRequest class provides an interface for Wafv2 GetWebACLForResource requests.
 *
 * \inmodule QtAwsWafv2
 *
...
GetWebACLForResourceRequest::GetWebACLForResourceRequest(const GetWebACLForResourceRequest &other)
    : Wafv2Request(new GetWebACLForResourceRequestPrivate(*other.d_func(), this))
{
...
GetWebACLForResourceRequest::GetWebACLForResourceRequest()
    : Wafv2Request(new GetWebACLForResourceRequestPrivate(Wafv2Request::GetWebACLForResourceAction, this))
{
...
/*!
 * \class QtAws::Wafv2::GetWebACLForResourceRequestPrivate
...
/*!
 * Constructs a GetWebACLForResourceRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
GetWebACLForResourceRequestPrivate::GetWebACLForResourceRequestPrivate(
    const Wafv2Request::Action action, GetWebACLForResourceRequest * const q)
