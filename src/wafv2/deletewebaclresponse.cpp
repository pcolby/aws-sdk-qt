...
/*!
 * \class QtAws::WAFV2::DeleteWebACLResponse
 * \brief The DeleteWebACLResponse class provides an interace for WAFV2 DeleteWebACL responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
DeleteWebACLResponse::DeleteWebACLResponse(
    ...
    : Wafv2Response(new DeleteWebACLResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WAFV2 DeleteWebACL \a response.
 */
...
/*!
 * \class QtAws::WAFV2::DeleteWebACLResponsePrivate
...
DeleteWebACLResponsePrivate::DeleteWebACLResponsePrivate(
    DeleteWebACLResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 DeleteWebACL response element from \a xml.
 */
