...
/*!
 * \class QtAws::WAFV2::ListLoggingConfigurationsResponse
 * \brief The ListLoggingConfigurationsResponse class provides an interace for WAFV2 ListLoggingConfigurations responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
ListLoggingConfigurationsResponse::ListLoggingConfigurationsResponse(
    ...
    : Wafv2Response(new ListLoggingConfigurationsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WAFV2 ListLoggingConfigurations \a response.
 */
...
/*!
 * \class QtAws::WAFV2::ListLoggingConfigurationsResponsePrivate
...
ListLoggingConfigurationsResponsePrivate::ListLoggingConfigurationsResponsePrivate(
    ListLoggingConfigurationsResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 ListLoggingConfigurations response element from \a xml.
 */
