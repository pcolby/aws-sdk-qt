...
/*!
 * \class QtAws::WAFV2::PutLoggingConfigurationRequest
 * \brief The PutLoggingConfigurationRequest class provides an interface for WAFV2 PutLoggingConfiguration requests.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
 ...
 *
 * \sa Wafv2Client::putLoggingConfiguration
 */
...
PutLoggingConfigurationRequest::PutLoggingConfigurationRequest(const PutLoggingConfigurationRequest &other)
    : Wafv2Request(new PutLoggingConfigurationRequestPrivate(*other.d_func(), this))
{
...
PutLoggingConfigurationRequest::PutLoggingConfigurationRequest()
    : Wafv2Request(new PutLoggingConfigurationRequestPrivate(Wafv2Request::PutLoggingConfigurationAction, this))
{
...
/*!
 * \class QtAws::WAFV2::PutLoggingConfigurationRequestPrivate
...
/*!
 * Constructs a PutLoggingConfigurationRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
PutLoggingConfigurationRequestPrivate::PutLoggingConfigurationRequestPrivate(
    const Wafv2Request::Action action, PutLoggingConfigurationRequest * const q)
