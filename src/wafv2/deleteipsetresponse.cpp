...
/*!
 * \class QtAws::WAFV2::DeleteIPSetResponse
 * \brief The DeleteIPSetResponse class provides an interace for WAFV2 DeleteIPSet responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
DeleteIPSetResponse::DeleteIPSetResponse(
    ...
    : Wafv2Response(new DeleteIPSetResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteIPSetRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 DeleteIPSet \a response.
 */
...
/*!
 * \class QtAws::WAFV2::DeleteIPSetResponsePrivate
...
DeleteIPSetResponsePrivate::DeleteIPSetResponsePrivate(
    DeleteIPSetResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 DeleteIPSet response element from \a xml.
 */
