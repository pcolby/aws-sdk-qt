...
/*!
 * \class QtAws::Wafv2::CreateWebACLRequest
 * \brief The CreateWebACLRequest class provides an interface for Wafv2 CreateWebACL requests.
 *
 * \inmodule QtAwsWafv2
 *
...
CreateWebACLRequest::CreateWebACLRequest(const CreateWebACLRequest &other)
    : Wafv2Request(new CreateWebACLRequestPrivate(*other.d_func(), this))
{
...
CreateWebACLRequest::CreateWebACLRequest()
    : Wafv2Request(new CreateWebACLRequestPrivate(Wafv2Request::CreateWebACLAction, this))
{
...
/*!
 * \class QtAws::Wafv2::CreateWebACLRequestPrivate
...
/*!
 * Constructs a CreateWebACLRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
CreateWebACLRequestPrivate::CreateWebACLRequestPrivate(
    const Wafv2Request::Action action, CreateWebACLRequest * const q)
