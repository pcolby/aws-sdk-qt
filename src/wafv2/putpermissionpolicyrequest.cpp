...
/*!
 * \class QtAws::WAFV2::PutPermissionPolicyRequest
 * \brief The PutPermissionPolicyRequest class provides an interface for WAFV2 PutPermissionPolicy requests.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
PutPermissionPolicyRequest::PutPermissionPolicyRequest(const PutPermissionPolicyRequest &other)
    : Wafv2Request(new PutPermissionPolicyRequestPrivate(*other.d_func(), this))
{
...
PutPermissionPolicyRequest::PutPermissionPolicyRequest()
    : Wafv2Request(new PutPermissionPolicyRequestPrivate(Wafv2Request::PutPermissionPolicyAction, this))
{
...
/*!
 * \class QtAws::WAFV2::PutPermissionPolicyRequestPrivate
...
/*!
 * Constructs a PutPermissionPolicyRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
PutPermissionPolicyRequestPrivate::PutPermissionPolicyRequestPrivate(
    const Wafv2Request::Action action, PutPermissionPolicyRequest * const q)
