...
#include "listavailablemanagedrulegroupversionsrequest_p.h"
...
/*!
 * \class QtAws::Wafv2::ListAvailableManagedRuleGroupVersionsRequest
 * \brief The ListAvailableManagedRuleGroupVersionsRequest class provides an interface for Wafv2 ListAvailableManagedRuleGroupVersions requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 */
ListAvailableManagedRuleGroupVersionsRequest::ListAvailableManagedRuleGroupVersionsRequest(const ListAvailableManagedRuleGroupVersionsRequest &other)
    : Wafv2Request(new ListAvailableManagedRuleGroupVersionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListAvailableManagedRuleGroupVersionsRequest object.
 */
ListAvailableManagedRuleGroupVersionsRequest::ListAvailableManagedRuleGroupVersionsRequest()
    : Wafv2Request(new ListAvailableManagedRuleGroupVersionsRequestPrivate(Wafv2Request::ListAvailableManagedRuleGroupVersionsAction, this))
{
 ...
 * \reimp
 */
bool ListAvailableManagedRuleGroupVersionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListAvailableManagedRuleGroupVersionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListAvailableManagedRuleGroupVersionsRequest::response(QNetworkReply * const reply) const
{
    return new ListAvailableManagedRuleGroupVersionsResponse(*this, reply);
}

/*!
 * \class QtAws::Wafv2::ListAvailableManagedRuleGroupVersionsRequestPrivate
 * \brief The ListAvailableManagedRuleGroupVersionsRequestPrivate class provides private implementation for ListAvailableManagedRuleGroupVersionsRequest.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a ListAvailableManagedRuleGroupVersionsRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
ListAvailableManagedRuleGroupVersionsRequestPrivate::ListAvailableManagedRuleGroupVersionsRequestPrivate(
    const Wafv2Request::Action action, ListAvailableManagedRuleGroupVersionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListAvailableManagedRuleGroupVersionsRequest
 * class' copy constructor.
 */
ListAvailableManagedRuleGroupVersionsRequestPrivate::ListAvailableManagedRuleGroupVersionsRequestPrivate(
    const ListAvailableManagedRuleGroupVersionsRequestPrivate &other, ListAvailableManagedRuleGroupVersionsRequest * const q)
