...
#include "listmobilesdkreleasesrequest_p.h"
...
/*!
 * \class QtAws::Wafv2::ListMobileSdkReleasesRequest
 * \brief The ListMobileSdkReleasesRequest class provides an interface for Wafv2 ListMobileSdkReleases requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 */
ListMobileSdkReleasesRequest::ListMobileSdkReleasesRequest(const ListMobileSdkReleasesRequest &other)
    : Wafv2Request(new ListMobileSdkReleasesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListMobileSdkReleasesRequest object.
 */
ListMobileSdkReleasesRequest::ListMobileSdkReleasesRequest()
    : Wafv2Request(new ListMobileSdkReleasesRequestPrivate(Wafv2Request::ListMobileSdkReleasesAction, this))
{
 ...
 * \reimp
 */
bool ListMobileSdkReleasesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListMobileSdkReleasesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListMobileSdkReleasesRequest::response(QNetworkReply * const reply) const
{
    return new ListMobileSdkReleasesResponse(*this, reply);
}

/*!
 * \class QtAws::Wafv2::ListMobileSdkReleasesRequestPrivate
 * \brief The ListMobileSdkReleasesRequestPrivate class provides private implementation for ListMobileSdkReleasesRequest.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a ListMobileSdkReleasesRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
ListMobileSdkReleasesRequestPrivate::ListMobileSdkReleasesRequestPrivate(
    const Wafv2Request::Action action, ListMobileSdkReleasesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListMobileSdkReleasesRequest
 * class' copy constructor.
 */
ListMobileSdkReleasesRequestPrivate::ListMobileSdkReleasesRequestPrivate(
    const ListMobileSdkReleasesRequestPrivate &other, ListMobileSdkReleasesRequest * const q)
