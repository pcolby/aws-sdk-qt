...
/*!
 * \class QtAws::WAFV2::DeleteLoggingConfigurationResponse
 * \brief The DeleteLoggingConfigurationResponse class provides an interace for WAFV2 DeleteLoggingConfiguration responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
 ...
 *
 * \sa Wafv2Client::deleteLoggingConfiguration
 */
...
DeleteLoggingConfigurationResponse::DeleteLoggingConfigurationResponse(
    ...
    : Wafv2Response(new DeleteLoggingConfigurationResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteLoggingConfigurationRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 DeleteLoggingConfiguration \a response.
 */
...
/*!
 * \class QtAws::WAFV2::DeleteLoggingConfigurationResponsePrivate
...
DeleteLoggingConfigurationResponsePrivate::DeleteLoggingConfigurationResponsePrivate(
    DeleteLoggingConfigurationResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 DeleteLoggingConfiguration response element from \a xml.
 */
