...
/*!
 * \class QtAws::Wafv2::GetIPSetRequest
 * \brief The GetIPSetRequest class provides an interface for Wafv2 GetIPSet requests.
 *
 * \inmodule QtAwsWafv2
 *
...
GetIPSetRequest::GetIPSetRequest(const GetIPSetRequest &other)
    : Wafv2Request(new GetIPSetRequestPrivate(*other.d_func(), this))
{
...
GetIPSetRequest::GetIPSetRequest()
    : Wafv2Request(new GetIPSetRequestPrivate(Wafv2Request::GetIPSetAction, this))
{
...
/*!
 * \class QtAws::Wafv2::GetIPSetRequestPrivate
...
/*!
 * Constructs a GetIPSetRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
GetIPSetRequestPrivate::GetIPSetRequestPrivate(
    const Wafv2Request::Action action, GetIPSetRequest * const q)
