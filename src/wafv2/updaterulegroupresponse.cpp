...
/*!
 * \class QtAws::WAFV2::UpdateRuleGroupResponse
 * \brief The UpdateRuleGroupResponse class provides an interace for WAFV2 UpdateRuleGroup responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
 ...
 *
 * \sa Wafv2Client::updateRuleGroup
 */
...
UpdateRuleGroupResponse::UpdateRuleGroupResponse(
    ...
    : Wafv2Response(new UpdateRuleGroupResponsePrivate(this), parent)
{
...
{
    return static_cast<const UpdateRuleGroupRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 UpdateRuleGroup \a response.
 */
...
/*!
 * \class QtAws::WAFV2::UpdateRuleGroupResponsePrivate
...
UpdateRuleGroupResponsePrivate::UpdateRuleGroupResponsePrivate(
    UpdateRuleGroupResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 UpdateRuleGroup response element from \a xml.
 */
