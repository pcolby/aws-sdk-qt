...
#include "listmobilesdkreleasesresponse_p.h"
...
/*!
 * \class QtAws::Wafv2::ListMobileSdkReleasesResponse
 * \brief The ListMobileSdkReleasesResponse class provides an interace for Wafv2 ListMobileSdkReleases responses.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::listMobileSdkReleases
 */

/*!
 * Constructs a ListMobileSdkReleasesResponse object for \a reply to \a request, with parent \a parent.
 */
ListMobileSdkReleasesResponse::ListMobileSdkReleasesResponse(
        const ListMobileSdkReleasesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Wafv2Response(new ListMobileSdkReleasesResponsePrivate(this), parent)
{
    setRequest(new ListMobileSdkReleasesRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListMobileSdkReleasesRequest * ListMobileSdkReleasesResponse::request() const
{
    Q_D(const ListMobileSdkReleasesResponse);
    return static_cast<const ListMobileSdkReleasesRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Wafv2 ListMobileSdkReleases \a response.
 */
void ListMobileSdkReleasesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListMobileSdkReleasesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Wafv2::ListMobileSdkReleasesResponsePrivate
 * \brief The ListMobileSdkReleasesResponsePrivate class provides private implementation for ListMobileSdkReleasesResponse.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a ListMobileSdkReleasesResponsePrivate object with public implementation \a q.
 */
ListMobileSdkReleasesResponsePrivate::ListMobileSdkReleasesResponsePrivate(
    ListMobileSdkReleasesResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a Wafv2 ListMobileSdkReleases response element from \a xml.
 */
void ListMobileSdkReleasesResponsePrivate::parseListMobileSdkReleasesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListMobileSdkReleasesResponse"));
    Q_UNUSED(xml) ///< @todo
}
