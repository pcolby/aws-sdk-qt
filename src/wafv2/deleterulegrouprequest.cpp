...
/*!
 * \class QtAws::WAFV2::DeleteRuleGroupRequest
 * \brief The DeleteRuleGroupRequest class provides an interface for WAFV2 DeleteRuleGroup requests.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
DeleteRuleGroupRequest::DeleteRuleGroupRequest(const DeleteRuleGroupRequest &other)
    : Wafv2Request(new DeleteRuleGroupRequestPrivate(*other.d_func(), this))
{
...
DeleteRuleGroupRequest::DeleteRuleGroupRequest()
    : Wafv2Request(new DeleteRuleGroupRequestPrivate(Wafv2Request::DeleteRuleGroupAction, this))
{
...
/*!
 * \class QtAws::WAFV2::DeleteRuleGroupRequestPrivate
...
/*!
 * Constructs a DeleteRuleGroupRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
DeleteRuleGroupRequestPrivate::DeleteRuleGroupRequestPrivate(
    const Wafv2Request::Action action, DeleteRuleGroupRequest * const q)
