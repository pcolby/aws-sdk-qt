...
/*!
 * \class QtAws::WAFV2::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for WAFV2 TagResource responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
TagResourceResponse::TagResourceResponse(
    ...
    : Wafv2Response(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 TagResource \a response.
 */
...
/*!
 * \class QtAws::WAFV2::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 TagResource response element from \a xml.
 */
