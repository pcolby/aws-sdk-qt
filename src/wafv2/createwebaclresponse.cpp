...
/*!
 * \class QtAws::WAFV2::CreateWebACLResponse
 * \brief The CreateWebACLResponse class provides an interace for WAFV2 CreateWebACL responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
CreateWebACLResponse::CreateWebACLResponse(
    ...
    : Wafv2Response(new CreateWebACLResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WAFV2 CreateWebACL \a response.
 */
...
/*!
 * \class QtAws::WAFV2::CreateWebACLResponsePrivate
...
CreateWebACLResponsePrivate::CreateWebACLResponsePrivate(
    CreateWebACLResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 CreateWebACL response element from \a xml.
 */
