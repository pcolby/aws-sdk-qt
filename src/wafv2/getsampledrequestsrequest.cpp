...
/*!
 * \class QtAws::Wafv2::GetSampledRequestsRequest
 * \brief The GetSampledRequestsRequest class provides an interface for Wafv2 GetSampledRequests requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::getSampledRequests
 */
...
GetSampledRequestsRequest::GetSampledRequestsRequest(const GetSampledRequestsRequest &other)
    : Wafv2Request(new GetSampledRequestsRequestPrivate(*other.d_func(), this))
{
...
GetSampledRequestsRequest::GetSampledRequestsRequest()
    : Wafv2Request(new GetSampledRequestsRequestPrivate(Wafv2Request::GetSampledRequestsAction, this))
{
...
/*!
 * \class QtAws::Wafv2::GetSampledRequestsRequestPrivate
...
/*!
 * Constructs a GetSampledRequestsRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
GetSampledRequestsRequestPrivate::GetSampledRequestsRequestPrivate(
    const Wafv2Request::Action action, GetSampledRequestsRequest * const q)
