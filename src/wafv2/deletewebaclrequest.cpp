...
/*!
 * \class QtAws::Wafv2::DeleteWebACLRequest
 * \brief The DeleteWebACLRequest class provides an interface for Wafv2 DeleteWebACL requests.
 *
 * \inmodule QtAwsWafv2
 *
...
DeleteWebACLRequest::DeleteWebACLRequest(const DeleteWebACLRequest &other)
    : Wafv2Request(new DeleteWebACLRequestPrivate(*other.d_func(), this))
{
...
DeleteWebACLRequest::DeleteWebACLRequest()
    : Wafv2Request(new DeleteWebACLRequestPrivate(Wafv2Request::DeleteWebACLAction, this))
{
...
/*!
 * \class QtAws::Wafv2::DeleteWebACLRequestPrivate
...
/*!
 * Constructs a DeleteWebACLRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
DeleteWebACLRequestPrivate::DeleteWebACLRequestPrivate(
    const Wafv2Request::Action action, DeleteWebACLRequest * const q)
