...
#include "getmobilesdkreleaserequest_p.h"
...
/*!
 * \class QtAws::Wafv2::GetMobileSdkReleaseRequest
 * \brief The GetMobileSdkReleaseRequest class provides an interface for Wafv2 GetMobileSdkRelease requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 */
GetMobileSdkReleaseRequest::GetMobileSdkReleaseRequest(const GetMobileSdkReleaseRequest &other)
    : Wafv2Request(new GetMobileSdkReleaseRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetMobileSdkReleaseRequest object.
 */
GetMobileSdkReleaseRequest::GetMobileSdkReleaseRequest()
    : Wafv2Request(new GetMobileSdkReleaseRequestPrivate(Wafv2Request::GetMobileSdkReleaseAction, this))
{
 ...
 * \reimp
 */
bool GetMobileSdkReleaseRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetMobileSdkReleaseResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetMobileSdkReleaseRequest::response(QNetworkReply * const reply) const
{
    return new GetMobileSdkReleaseResponse(*this, reply);
}

/*!
 * \class QtAws::Wafv2::GetMobileSdkReleaseRequestPrivate
 * \brief The GetMobileSdkReleaseRequestPrivate class provides private implementation for GetMobileSdkReleaseRequest.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a GetMobileSdkReleaseRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
GetMobileSdkReleaseRequestPrivate::GetMobileSdkReleaseRequestPrivate(
    const Wafv2Request::Action action, GetMobileSdkReleaseRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetMobileSdkReleaseRequest
 * class' copy constructor.
 */
GetMobileSdkReleaseRequestPrivate::GetMobileSdkReleaseRequestPrivate(
    const GetMobileSdkReleaseRequestPrivate &other, GetMobileSdkReleaseRequest * const q)
