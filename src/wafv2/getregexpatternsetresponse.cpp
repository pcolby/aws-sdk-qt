...
/*!
 * \class QtAws::WAFV2::GetRegexPatternSetResponse
 * \brief The GetRegexPatternSetResponse class provides an interace for WAFV2 GetRegexPatternSet responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
GetRegexPatternSetResponse::GetRegexPatternSetResponse(
    ...
    : Wafv2Response(new GetRegexPatternSetResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WAFV2 GetRegexPatternSet \a response.
 */
...
/*!
 * \class QtAws::WAFV2::GetRegexPatternSetResponsePrivate
...
GetRegexPatternSetResponsePrivate::GetRegexPatternSetResponsePrivate(
    GetRegexPatternSetResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 GetRegexPatternSet response element from \a xml.
 */
