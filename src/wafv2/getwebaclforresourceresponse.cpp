...
/*!
 * \class QtAws::WAFV2::GetWebACLForResourceResponse
 * \brief The GetWebACLForResourceResponse class provides an interace for WAFV2 GetWebACLForResource responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
 ...
 *
 * \sa Wafv2Client::getWebACLForResource
 */
...
GetWebACLForResourceResponse::GetWebACLForResourceResponse(
    ...
    : Wafv2Response(new GetWebACLForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const GetWebACLForResourceRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 GetWebACLForResource \a response.
 */
...
/*!
 * \class QtAws::WAFV2::GetWebACLForResourceResponsePrivate
...
GetWebACLForResourceResponsePrivate::GetWebACLForResourceResponsePrivate(
    GetWebACLForResourceResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 GetWebACLForResource response element from \a xml.
 */
