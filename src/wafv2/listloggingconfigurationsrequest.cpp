...
/*!
 * \class QtAws::Wafv2::ListLoggingConfigurationsRequest
 * \brief The ListLoggingConfigurationsRequest class provides an interface for Wafv2 ListLoggingConfigurations requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::listLoggingConfigurations
 */
...
ListLoggingConfigurationsRequest::ListLoggingConfigurationsRequest(const ListLoggingConfigurationsRequest &other)
    : Wafv2Request(new ListLoggingConfigurationsRequestPrivate(*other.d_func(), this))
{
...
ListLoggingConfigurationsRequest::ListLoggingConfigurationsRequest()
    : Wafv2Request(new ListLoggingConfigurationsRequestPrivate(Wafv2Request::ListLoggingConfigurationsAction, this))
{
...
/*!
 * \class QtAws::Wafv2::ListLoggingConfigurationsRequestPrivate
...
/*!
 * Constructs a ListLoggingConfigurationsRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
ListLoggingConfigurationsRequestPrivate::ListLoggingConfigurationsRequestPrivate(
    const Wafv2Request::Action action, ListLoggingConfigurationsRequest * const q)
