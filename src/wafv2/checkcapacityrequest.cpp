...
#include "checkcapacityrequest_p.h"
...
/*!
 * \class QtAws::Wafv2::CheckCapacityRequest
 * \brief The CheckCapacityRequest class provides an interface for Wafv2 CheckCapacity requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::checkCapacity
 */

/*!
 * Constructs a copy of \a other.
 */
CheckCapacityRequest::CheckCapacityRequest(const CheckCapacityRequest &other)
    : Wafv2Request(new CheckCapacityRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CheckCapacityRequest object.
 */
CheckCapacityRequest::CheckCapacityRequest()
    : Wafv2Request(new CheckCapacityRequestPrivate(Wafv2Request::CheckCapacityAction, this))
{
 ...
 * \reimp
 */
bool CheckCapacityRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CheckCapacityResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CheckCapacityRequest::response(QNetworkReply * const reply) const
{
    return new CheckCapacityResponse(*this, reply);
}

/*!
 * \class QtAws::Wafv2::CheckCapacityRequestPrivate
 * \brief The CheckCapacityRequestPrivate class provides private implementation for CheckCapacityRequest.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a CheckCapacityRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
CheckCapacityRequestPrivate::CheckCapacityRequestPrivate(
    const Wafv2Request::Action action, CheckCapacityRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CheckCapacityRequest
 * class' copy constructor.
 */
CheckCapacityRequestPrivate::CheckCapacityRequestPrivate(
    const CheckCapacityRequestPrivate &other, CheckCapacityRequest * const q)
