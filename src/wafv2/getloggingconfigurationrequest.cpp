...
/*!
 * \class QtAws::Wafv2::GetLoggingConfigurationRequest
 * \brief The GetLoggingConfigurationRequest class provides an interface for Wafv2 GetLoggingConfiguration requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::getLoggingConfiguration
 */
...
GetLoggingConfigurationRequest::GetLoggingConfigurationRequest(const GetLoggingConfigurationRequest &other)
    : Wafv2Request(new GetLoggingConfigurationRequestPrivate(*other.d_func(), this))
{
...
GetLoggingConfigurationRequest::GetLoggingConfigurationRequest()
    : Wafv2Request(new GetLoggingConfigurationRequestPrivate(Wafv2Request::GetLoggingConfigurationAction, this))
{
...
/*!
 * \class QtAws::Wafv2::GetLoggingConfigurationRequestPrivate
...
/*!
 * Constructs a GetLoggingConfigurationRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
GetLoggingConfigurationRequestPrivate::GetLoggingConfigurationRequestPrivate(
    const Wafv2Request::Action action, GetLoggingConfigurationRequest * const q)
