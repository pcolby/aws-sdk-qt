...
#include "listavailablemanagedrulegroupversionsresponse_p.h"
...
/*!
 * \class QtAws::Wafv2::ListAvailableManagedRuleGroupVersionsResponse
 * \brief The ListAvailableManagedRuleGroupVersionsResponse class provides an interace for Wafv2 ListAvailableManagedRuleGroupVersions responses.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::listAvailableManagedRuleGroupVersions
 */

/*!
 * Constructs a ListAvailableManagedRuleGroupVersionsResponse object for \a reply to \a request, with parent \a parent.
 */
ListAvailableManagedRuleGroupVersionsResponse::ListAvailableManagedRuleGroupVersionsResponse(
        const ListAvailableManagedRuleGroupVersionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Wafv2Response(new ListAvailableManagedRuleGroupVersionsResponsePrivate(this), parent)
{
    setRequest(new ListAvailableManagedRuleGroupVersionsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListAvailableManagedRuleGroupVersionsRequest * ListAvailableManagedRuleGroupVersionsResponse::request() const
{
    Q_D(const ListAvailableManagedRuleGroupVersionsResponse);
    return static_cast<const ListAvailableManagedRuleGroupVersionsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Wafv2 ListAvailableManagedRuleGroupVersions \a response.
 */
void ListAvailableManagedRuleGroupVersionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListAvailableManagedRuleGroupVersionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Wafv2::ListAvailableManagedRuleGroupVersionsResponsePrivate
 * \brief The ListAvailableManagedRuleGroupVersionsResponsePrivate class provides private implementation for ListAvailableManagedRuleGroupVersionsResponse.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a ListAvailableManagedRuleGroupVersionsResponsePrivate object with public implementation \a q.
 */
ListAvailableManagedRuleGroupVersionsResponsePrivate::ListAvailableManagedRuleGroupVersionsResponsePrivate(
    ListAvailableManagedRuleGroupVersionsResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a Wafv2 ListAvailableManagedRuleGroupVersions response element from \a xml.
 */
void ListAvailableManagedRuleGroupVersionsResponsePrivate::parseListAvailableManagedRuleGroupVersionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListAvailableManagedRuleGroupVersionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
