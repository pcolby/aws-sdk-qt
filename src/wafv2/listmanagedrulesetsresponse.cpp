...
#include "listmanagedrulesetsresponse_p.h"
...
/*!
 * \class QtAws::Wafv2::ListManagedRuleSetsResponse
 * \brief The ListManagedRuleSetsResponse class provides an interace for Wafv2 ListManagedRuleSets responses.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::listManagedRuleSets
 */

/*!
 * Constructs a ListManagedRuleSetsResponse object for \a reply to \a request, with parent \a parent.
 */
ListManagedRuleSetsResponse::ListManagedRuleSetsResponse(
        const ListManagedRuleSetsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Wafv2Response(new ListManagedRuleSetsResponsePrivate(this), parent)
{
    setRequest(new ListManagedRuleSetsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListManagedRuleSetsRequest * ListManagedRuleSetsResponse::request() const
{
    Q_D(const ListManagedRuleSetsResponse);
    return static_cast<const ListManagedRuleSetsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Wafv2 ListManagedRuleSets \a response.
 */
void ListManagedRuleSetsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListManagedRuleSetsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Wafv2::ListManagedRuleSetsResponsePrivate
 * \brief The ListManagedRuleSetsResponsePrivate class provides private implementation for ListManagedRuleSetsResponse.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a ListManagedRuleSetsResponsePrivate object with public implementation \a q.
 */
ListManagedRuleSetsResponsePrivate::ListManagedRuleSetsResponsePrivate(
    ListManagedRuleSetsResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a Wafv2 ListManagedRuleSets response element from \a xml.
 */
void ListManagedRuleSetsResponsePrivate::parseListManagedRuleSetsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListManagedRuleSetsResponse"));
    Q_UNUSED(xml) ///< @todo
}
