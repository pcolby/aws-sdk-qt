...
#include "getmanagedrulesetresponse_p.h"
...
/*!
 * \class QtAws::Wafv2::GetManagedRuleSetResponse
 * \brief The GetManagedRuleSetResponse class provides an interace for Wafv2 GetManagedRuleSet responses.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::getManagedRuleSet
 */

/*!
 * Constructs a GetManagedRuleSetResponse object for \a reply to \a request, with parent \a parent.
 */
GetManagedRuleSetResponse::GetManagedRuleSetResponse(
        const GetManagedRuleSetRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Wafv2Response(new GetManagedRuleSetResponsePrivate(this), parent)
{
    setRequest(new GetManagedRuleSetRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetManagedRuleSetRequest * GetManagedRuleSetResponse::request() const
{
    Q_D(const GetManagedRuleSetResponse);
    return static_cast<const GetManagedRuleSetRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Wafv2 GetManagedRuleSet \a response.
 */
void GetManagedRuleSetResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetManagedRuleSetResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Wafv2::GetManagedRuleSetResponsePrivate
 * \brief The GetManagedRuleSetResponsePrivate class provides private implementation for GetManagedRuleSetResponse.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a GetManagedRuleSetResponsePrivate object with public implementation \a q.
 */
GetManagedRuleSetResponsePrivate::GetManagedRuleSetResponsePrivate(
    GetManagedRuleSetResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a Wafv2 GetManagedRuleSet response element from \a xml.
 */
void GetManagedRuleSetResponsePrivate::parseGetManagedRuleSetResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetManagedRuleSetResponse"));
    Q_UNUSED(xml) ///< @todo
}
