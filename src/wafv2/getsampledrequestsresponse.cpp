...
/*!
 * \class QtAws::Wafv2::GetSampledRequestsResponse
 * \brief The GetSampledRequestsResponse class provides an interace for Wafv2 GetSampledRequests responses.
 *
 * \inmodule QtAwsWafv2
 *
...
GetSampledRequestsResponse::GetSampledRequestsResponse(
    ...
    : Wafv2Response(new GetSampledRequestsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Wafv2 GetSampledRequests \a response.
 */
...
/*!
 * \class QtAws::Wafv2::GetSampledRequestsResponsePrivate
...
GetSampledRequestsResponsePrivate::GetSampledRequestsResponsePrivate(
    GetSampledRequestsResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a Wafv2 GetSampledRequests response element from \a xml.
 */
