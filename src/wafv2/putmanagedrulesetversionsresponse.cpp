...
#include "putmanagedrulesetversionsresponse_p.h"
...
/*!
 * \class QtAws::Wafv2::PutManagedRuleSetVersionsResponse
 * \brief The PutManagedRuleSetVersionsResponse class provides an interace for Wafv2 PutManagedRuleSetVersions responses.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::putManagedRuleSetVersions
 */

/*!
 * Constructs a PutManagedRuleSetVersionsResponse object for \a reply to \a request, with parent \a parent.
 */
PutManagedRuleSetVersionsResponse::PutManagedRuleSetVersionsResponse(
        const PutManagedRuleSetVersionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Wafv2Response(new PutManagedRuleSetVersionsResponsePrivate(this), parent)
{
    setRequest(new PutManagedRuleSetVersionsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const PutManagedRuleSetVersionsRequest * PutManagedRuleSetVersionsResponse::request() const
{
    Q_D(const PutManagedRuleSetVersionsResponse);
    return static_cast<const PutManagedRuleSetVersionsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Wafv2 PutManagedRuleSetVersions \a response.
 */
void PutManagedRuleSetVersionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutManagedRuleSetVersionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Wafv2::PutManagedRuleSetVersionsResponsePrivate
 * \brief The PutManagedRuleSetVersionsResponsePrivate class provides private implementation for PutManagedRuleSetVersionsResponse.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a PutManagedRuleSetVersionsResponsePrivate object with public implementation \a q.
 */
PutManagedRuleSetVersionsResponsePrivate::PutManagedRuleSetVersionsResponsePrivate(
    PutManagedRuleSetVersionsResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a Wafv2 PutManagedRuleSetVersions response element from \a xml.
 */
void PutManagedRuleSetVersionsResponsePrivate::parsePutManagedRuleSetVersionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutManagedRuleSetVersionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
