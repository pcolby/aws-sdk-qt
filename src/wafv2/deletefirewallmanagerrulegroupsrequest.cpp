...
#include "deletefirewallmanagerrulegroupsrequest_p.h"
...
/*!
 * \class QtAws::Wafv2::DeleteFirewallManagerRuleGroupsRequest
 * \brief The DeleteFirewallManagerRuleGroupsRequest class provides an interface for Wafv2 DeleteFirewallManagerRuleGroups requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::deleteFirewallManagerRuleGroups
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteFirewallManagerRuleGroupsRequest::DeleteFirewallManagerRuleGroupsRequest(const DeleteFirewallManagerRuleGroupsRequest &other)
    : Wafv2Request(new DeleteFirewallManagerRuleGroupsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteFirewallManagerRuleGroupsRequest object.
 */
DeleteFirewallManagerRuleGroupsRequest::DeleteFirewallManagerRuleGroupsRequest()
    : Wafv2Request(new DeleteFirewallManagerRuleGroupsRequestPrivate(Wafv2Request::DeleteFirewallManagerRuleGroupsAction, this))
{
 ...
 * \reimp
 */
bool DeleteFirewallManagerRuleGroupsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteFirewallManagerRuleGroupsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteFirewallManagerRuleGroupsRequest::response(QNetworkReply * const reply) const
{
    return new DeleteFirewallManagerRuleGroupsResponse(*this, reply);
}

/*!
 * \class QtAws::Wafv2::DeleteFirewallManagerRuleGroupsRequestPrivate
 * \brief The DeleteFirewallManagerRuleGroupsRequestPrivate class provides private implementation for DeleteFirewallManagerRuleGroupsRequest.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a DeleteFirewallManagerRuleGroupsRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
DeleteFirewallManagerRuleGroupsRequestPrivate::DeleteFirewallManagerRuleGroupsRequestPrivate(
    const Wafv2Request::Action action, DeleteFirewallManagerRuleGroupsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteFirewallManagerRuleGroupsRequest
 * class' copy constructor.
 */
DeleteFirewallManagerRuleGroupsRequestPrivate::DeleteFirewallManagerRuleGroupsRequestPrivate(
    const DeleteFirewallManagerRuleGroupsRequestPrivate &other, DeleteFirewallManagerRuleGroupsRequest * const q)
