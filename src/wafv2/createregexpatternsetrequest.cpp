...
/*!
 * \class QtAws::Wafv2::CreateRegexPatternSetRequest
 * \brief The CreateRegexPatternSetRequest class provides an interface for Wafv2 CreateRegexPatternSet requests.
 *
 * \inmodule QtAwsWafv2
 *
...
CreateRegexPatternSetRequest::CreateRegexPatternSetRequest(const CreateRegexPatternSetRequest &other)
    : Wafv2Request(new CreateRegexPatternSetRequestPrivate(*other.d_func(), this))
{
...
CreateRegexPatternSetRequest::CreateRegexPatternSetRequest()
    : Wafv2Request(new CreateRegexPatternSetRequestPrivate(Wafv2Request::CreateRegexPatternSetAction, this))
{
...
/*!
 * \class QtAws::Wafv2::CreateRegexPatternSetRequestPrivate
...
/*!
 * Constructs a CreateRegexPatternSetRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
CreateRegexPatternSetRequestPrivate::CreateRegexPatternSetRequestPrivate(
    const Wafv2Request::Action action, CreateRegexPatternSetRequest * const q)
