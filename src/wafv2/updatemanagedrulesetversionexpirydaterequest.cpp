...
#include "updatemanagedrulesetversionexpirydaterequest_p.h"
...
/*!
 * \class QtAws::Wafv2::UpdateManagedRuleSetVersionExpiryDateRequest
 * \brief The UpdateManagedRuleSetVersionExpiryDateRequest class provides an interface for Wafv2 UpdateManagedRuleSetVersionExpiryDate requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 */
UpdateManagedRuleSetVersionExpiryDateRequest::UpdateManagedRuleSetVersionExpiryDateRequest(const UpdateManagedRuleSetVersionExpiryDateRequest &other)
    : Wafv2Request(new UpdateManagedRuleSetVersionExpiryDateRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateManagedRuleSetVersionExpiryDateRequest object.
 */
UpdateManagedRuleSetVersionExpiryDateRequest::UpdateManagedRuleSetVersionExpiryDateRequest()
    : Wafv2Request(new UpdateManagedRuleSetVersionExpiryDateRequestPrivate(Wafv2Request::UpdateManagedRuleSetVersionExpiryDateAction, this))
{
 ...
 * \reimp
 */
bool UpdateManagedRuleSetVersionExpiryDateRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateManagedRuleSetVersionExpiryDateResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateManagedRuleSetVersionExpiryDateRequest::response(QNetworkReply * const reply) const
{
    return new UpdateManagedRuleSetVersionExpiryDateResponse(*this, reply);
}

/*!
 * \class QtAws::Wafv2::UpdateManagedRuleSetVersionExpiryDateRequestPrivate
 * \brief The UpdateManagedRuleSetVersionExpiryDateRequestPrivate class provides private implementation for UpdateManagedRuleSetVersionExpiryDateRequest.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a UpdateManagedRuleSetVersionExpiryDateRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
UpdateManagedRuleSetVersionExpiryDateRequestPrivate::UpdateManagedRuleSetVersionExpiryDateRequestPrivate(
    const Wafv2Request::Action action, UpdateManagedRuleSetVersionExpiryDateRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateManagedRuleSetVersionExpiryDateRequest
 * class' copy constructor.
 */
UpdateManagedRuleSetVersionExpiryDateRequestPrivate::UpdateManagedRuleSetVersionExpiryDateRequestPrivate(
    const UpdateManagedRuleSetVersionExpiryDateRequestPrivate &other, UpdateManagedRuleSetVersionExpiryDateRequest * const q)
