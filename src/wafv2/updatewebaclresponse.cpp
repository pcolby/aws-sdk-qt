...
/*!
 * \class QtAws::WAFV2::UpdateWebACLResponse
 * \brief The UpdateWebACLResponse class provides an interace for WAFV2 UpdateWebACL responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
UpdateWebACLResponse::UpdateWebACLResponse(
    ...
    : Wafv2Response(new UpdateWebACLResponsePrivate(this), parent)
{
...
{
    return static_cast<const UpdateWebACLRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 UpdateWebACL \a response.
 */
...
/*!
 * \class QtAws::WAFV2::UpdateWebACLResponsePrivate
...
UpdateWebACLResponsePrivate::UpdateWebACLResponsePrivate(
    UpdateWebACLResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 UpdateWebACL response element from \a xml.
 */
