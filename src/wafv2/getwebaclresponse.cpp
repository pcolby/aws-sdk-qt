...
/*!
 * \class QtAws::Wafv2::GetWebACLResponse
 * \brief The GetWebACLResponse class provides an interace for Wafv2 GetWebACL responses.
 *
 * \inmodule QtAwsWafv2
 *
...
GetWebACLResponse::GetWebACLResponse(
    ...
    : Wafv2Response(new GetWebACLResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Wafv2 GetWebACL \a response.
 */
...
/*!
 * \class QtAws::Wafv2::GetWebACLResponsePrivate
...
GetWebACLResponsePrivate::GetWebACLResponsePrivate(
    GetWebACLResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a Wafv2 GetWebACL response element from \a xml.
 */
