...
/*!
 * \class QtAws::Wafv2::DeleteLoggingConfigurationRequest
 * \brief The DeleteLoggingConfigurationRequest class provides an interface for Wafv2 DeleteLoggingConfiguration requests.
 *
 * \inmodule QtAwsWafv2
 *
...
DeleteLoggingConfigurationRequest::DeleteLoggingConfigurationRequest(const DeleteLoggingConfigurationRequest &other)
    : Wafv2Request(new DeleteLoggingConfigurationRequestPrivate(*other.d_func(), this))
{
...
DeleteLoggingConfigurationRequest::DeleteLoggingConfigurationRequest()
    : Wafv2Request(new DeleteLoggingConfigurationRequestPrivate(Wafv2Request::DeleteLoggingConfigurationAction, this))
{
...
/*!
 * \class QtAws::Wafv2::DeleteLoggingConfigurationRequestPrivate
...
/*!
 * Constructs a DeleteLoggingConfigurationRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
DeleteLoggingConfigurationRequestPrivate::DeleteLoggingConfigurationRequestPrivate(
    const Wafv2Request::Action action, DeleteLoggingConfigurationRequest * const q)
