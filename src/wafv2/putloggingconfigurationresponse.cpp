...
/*!
 * \class QtAws::WAFV2::PutLoggingConfigurationResponse
 * \brief The PutLoggingConfigurationResponse class provides an interace for WAFV2 PutLoggingConfiguration responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
PutLoggingConfigurationResponse::PutLoggingConfigurationResponse(
    ...
    : Wafv2Response(new PutLoggingConfigurationResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WAFV2 PutLoggingConfiguration \a response.
 */
...
/*!
 * \class QtAws::WAFV2::PutLoggingConfigurationResponsePrivate
...
PutLoggingConfigurationResponsePrivate::PutLoggingConfigurationResponsePrivate(
    PutLoggingConfigurationResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 PutLoggingConfiguration response element from \a xml.
 */
