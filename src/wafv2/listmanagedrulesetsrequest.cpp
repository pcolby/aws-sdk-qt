...
#include "listmanagedrulesetsrequest_p.h"
...
/*!
 * \class QtAws::Wafv2::ListManagedRuleSetsRequest
 * \brief The ListManagedRuleSetsRequest class provides an interface for Wafv2 ListManagedRuleSets requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 */
ListManagedRuleSetsRequest::ListManagedRuleSetsRequest(const ListManagedRuleSetsRequest &other)
    : Wafv2Request(new ListManagedRuleSetsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListManagedRuleSetsRequest object.
 */
ListManagedRuleSetsRequest::ListManagedRuleSetsRequest()
    : Wafv2Request(new ListManagedRuleSetsRequestPrivate(Wafv2Request::ListManagedRuleSetsAction, this))
{
 ...
 * \reimp
 */
bool ListManagedRuleSetsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListManagedRuleSetsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListManagedRuleSetsRequest::response(QNetworkReply * const reply) const
{
    return new ListManagedRuleSetsResponse(*this, reply);
}

/*!
 * \class QtAws::Wafv2::ListManagedRuleSetsRequestPrivate
 * \brief The ListManagedRuleSetsRequestPrivate class provides private implementation for ListManagedRuleSetsRequest.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a ListManagedRuleSetsRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
ListManagedRuleSetsRequestPrivate::ListManagedRuleSetsRequestPrivate(
    const Wafv2Request::Action action, ListManagedRuleSetsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListManagedRuleSetsRequest
 * class' copy constructor.
 */
ListManagedRuleSetsRequestPrivate::ListManagedRuleSetsRequestPrivate(
    const ListManagedRuleSetsRequestPrivate &other, ListManagedRuleSetsRequest * const q)
