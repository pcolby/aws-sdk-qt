...
/*!
 * \class QtAws::WAFV2::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for WAFV2 UntagResource responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : Wafv2Response(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 UntagResource \a response.
 */
...
/*!
 * \class QtAws::WAFV2::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 UntagResource response element from \a xml.
 */
