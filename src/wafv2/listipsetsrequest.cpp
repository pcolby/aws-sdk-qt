...
/*!
 * \class QtAws::Wafv2::ListIPSetsRequest
 * \brief The ListIPSetsRequest class provides an interface for Wafv2 ListIPSets requests.
 *
 * \inmodule QtAwsWafv2
 *
...
ListIPSetsRequest::ListIPSetsRequest(const ListIPSetsRequest &other)
    : Wafv2Request(new ListIPSetsRequestPrivate(*other.d_func(), this))
{
...
ListIPSetsRequest::ListIPSetsRequest()
    : Wafv2Request(new ListIPSetsRequestPrivate(Wafv2Request::ListIPSetsAction, this))
{
...
/*!
 * \class QtAws::Wafv2::ListIPSetsRequestPrivate
...
/*!
 * Constructs a ListIPSetsRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
ListIPSetsRequestPrivate::ListIPSetsRequestPrivate(
    const Wafv2Request::Action action, ListIPSetsRequest * const q)
