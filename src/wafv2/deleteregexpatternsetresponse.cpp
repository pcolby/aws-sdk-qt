...
/*!
 * \class QtAws::WAFV2::DeleteRegexPatternSetResponse
 * \brief The DeleteRegexPatternSetResponse class provides an interace for WAFV2 DeleteRegexPatternSet responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
 ...
 *
 * \sa Wafv2Client::deleteRegexPatternSet
 */
...
DeleteRegexPatternSetResponse::DeleteRegexPatternSetResponse(
    ...
    : Wafv2Response(new DeleteRegexPatternSetResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteRegexPatternSetRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 DeleteRegexPatternSet \a response.
 */
...
/*!
 * \class QtAws::WAFV2::DeleteRegexPatternSetResponsePrivate
...
DeleteRegexPatternSetResponsePrivate::DeleteRegexPatternSetResponsePrivate(
    DeleteRegexPatternSetResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 DeleteRegexPatternSet response element from \a xml.
 */
