...
/*!
 * \class QtAws::WAFV2::ListResourcesForWebACLResponse
 * \brief The ListResourcesForWebACLResponse class provides an interace for WAFV2 ListResourcesForWebACL responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
ListResourcesForWebACLResponse::ListResourcesForWebACLResponse(
    ...
    : Wafv2Response(new ListResourcesForWebACLResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WAFV2 ListResourcesForWebACL \a response.
 */
...
/*!
 * \class QtAws::WAFV2::ListResourcesForWebACLResponsePrivate
...
ListResourcesForWebACLResponsePrivate::ListResourcesForWebACLResponsePrivate(
    ListResourcesForWebACLResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 ListResourcesForWebACL response element from \a xml.
 */
