...
#include "putmanagedrulesetversionsrequest_p.h"
...
/*!
 * \class QtAws::Wafv2::PutManagedRuleSetVersionsRequest
 * \brief The PutManagedRuleSetVersionsRequest class provides an interface for Wafv2 PutManagedRuleSetVersions requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 */
PutManagedRuleSetVersionsRequest::PutManagedRuleSetVersionsRequest(const PutManagedRuleSetVersionsRequest &other)
    : Wafv2Request(new PutManagedRuleSetVersionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutManagedRuleSetVersionsRequest object.
 */
PutManagedRuleSetVersionsRequest::PutManagedRuleSetVersionsRequest()
    : Wafv2Request(new PutManagedRuleSetVersionsRequestPrivate(Wafv2Request::PutManagedRuleSetVersionsAction, this))
{
 ...
 * \reimp
 */
bool PutManagedRuleSetVersionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutManagedRuleSetVersionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutManagedRuleSetVersionsRequest::response(QNetworkReply * const reply) const
{
    return new PutManagedRuleSetVersionsResponse(*this, reply);
}

/*!
 * \class QtAws::Wafv2::PutManagedRuleSetVersionsRequestPrivate
 * \brief The PutManagedRuleSetVersionsRequestPrivate class provides private implementation for PutManagedRuleSetVersionsRequest.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a PutManagedRuleSetVersionsRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
PutManagedRuleSetVersionsRequestPrivate::PutManagedRuleSetVersionsRequestPrivate(
    const Wafv2Request::Action action, PutManagedRuleSetVersionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutManagedRuleSetVersionsRequest
 * class' copy constructor.
 */
PutManagedRuleSetVersionsRequestPrivate::PutManagedRuleSetVersionsRequestPrivate(
    const PutManagedRuleSetVersionsRequestPrivate &other, PutManagedRuleSetVersionsRequest * const q)
