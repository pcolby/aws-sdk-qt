...
/*!
 * \class QtAws::Wafv2::AssociateWebACLRequest
 * \brief The AssociateWebACLRequest class provides an interface for Wafv2 AssociateWebACL requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::associateWebACL
 */
...
AssociateWebACLRequest::AssociateWebACLRequest(const AssociateWebACLRequest &other)
    : Wafv2Request(new AssociateWebACLRequestPrivate(*other.d_func(), this))
{
...
AssociateWebACLRequest::AssociateWebACLRequest()
    : Wafv2Request(new AssociateWebACLRequestPrivate(Wafv2Request::AssociateWebACLAction, this))
{
...
/*!
 * \class QtAws::Wafv2::AssociateWebACLRequestPrivate
...
/*!
 * Constructs a AssociateWebACLRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
AssociateWebACLRequestPrivate::AssociateWebACLRequestPrivate(
    const Wafv2Request::Action action, AssociateWebACLRequest * const q)
