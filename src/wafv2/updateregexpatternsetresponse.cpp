...
/*!
 * \class QtAws::WAFV2::UpdateRegexPatternSetResponse
 * \brief The UpdateRegexPatternSetResponse class provides an interace for WAFV2 UpdateRegexPatternSet responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
UpdateRegexPatternSetResponse::UpdateRegexPatternSetResponse(
    ...
    : Wafv2Response(new UpdateRegexPatternSetResponsePrivate(this), parent)
{
...
{
    return static_cast<const UpdateRegexPatternSetRequest *>(Wafv2Response::request());
}

/*!
 * \reimp
 * Parses a successful WAFV2 UpdateRegexPatternSet \a response.
 */
...
/*!
 * \class QtAws::WAFV2::UpdateRegexPatternSetResponsePrivate
...
UpdateRegexPatternSetResponsePrivate::UpdateRegexPatternSetResponsePrivate(
    UpdateRegexPatternSetResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 UpdateRegexPatternSet response element from \a xml.
 */
