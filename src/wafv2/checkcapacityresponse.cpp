...
#include "checkcapacityresponse_p.h"
...
/*!
 * \class QtAws::Wafv2::CheckCapacityResponse
 * \brief The CheckCapacityResponse class provides an interace for Wafv2 CheckCapacity responses.
 *
 * \inmodule QtAwsWafv2
 *
...
/*!
 * Constructs a CheckCapacityResponse object for \a reply to \a request, with parent \a parent.
 */
CheckCapacityResponse::CheckCapacityResponse(
        const CheckCapacityRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Wafv2Response(new CheckCapacityResponsePrivate(this), parent)
{
    setRequest(new CheckCapacityRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Wafv2 CheckCapacity \a response.
 */
void CheckCapacityResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CheckCapacityResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Wafv2::CheckCapacityResponsePrivate
 * \brief The CheckCapacityResponsePrivate class provides private implementation for CheckCapacityResponse.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a CheckCapacityResponsePrivate object with public implementation \a q.
 */
CheckCapacityResponsePrivate::CheckCapacityResponsePrivate(
    CheckCapacityResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a Wafv2 CheckCapacity response element from \a xml.
 */
void CheckCapacityResponsePrivate::parseCheckCapacityResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CheckCapacityResponse"));
    Q_UNUSED(xml) ///< @todo
}
