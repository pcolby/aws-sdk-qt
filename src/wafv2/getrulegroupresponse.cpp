...
/*!
 * \class QtAws::WAFV2::GetRuleGroupResponse
 * \brief The GetRuleGroupResponse class provides an interace for WAFV2 GetRuleGroup responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
GetRuleGroupResponse::GetRuleGroupResponse(
    ...
    : Wafv2Response(new GetRuleGroupResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WAFV2 GetRuleGroup \a response.
 */
...
/*!
 * \class QtAws::WAFV2::GetRuleGroupResponsePrivate
...
GetRuleGroupResponsePrivate::GetRuleGroupResponsePrivate(
    GetRuleGroupResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 GetRuleGroup response element from \a xml.
 */
