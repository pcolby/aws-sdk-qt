...
#include "generatemobilesdkreleaseurlresponse_p.h"
...
/*!
 * \class QtAws::Wafv2::GenerateMobileSdkReleaseUrlResponse
 * \brief The GenerateMobileSdkReleaseUrlResponse class provides an interace for Wafv2 GenerateMobileSdkReleaseUrl responses.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::generateMobileSdkReleaseUrl
 */

/*!
 * Constructs a GenerateMobileSdkReleaseUrlResponse object for \a reply to \a request, with parent \a parent.
 */
GenerateMobileSdkReleaseUrlResponse::GenerateMobileSdkReleaseUrlResponse(
        const GenerateMobileSdkReleaseUrlRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : Wafv2Response(new GenerateMobileSdkReleaseUrlResponsePrivate(this), parent)
{
    setRequest(new GenerateMobileSdkReleaseUrlRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GenerateMobileSdkReleaseUrlRequest * GenerateMobileSdkReleaseUrlResponse::request() const
{
    Q_D(const GenerateMobileSdkReleaseUrlResponse);
    return static_cast<const GenerateMobileSdkReleaseUrlRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Wafv2 GenerateMobileSdkReleaseUrl \a response.
 */
void GenerateMobileSdkReleaseUrlResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GenerateMobileSdkReleaseUrlResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Wafv2::GenerateMobileSdkReleaseUrlResponsePrivate
 * \brief The GenerateMobileSdkReleaseUrlResponsePrivate class provides private implementation for GenerateMobileSdkReleaseUrlResponse.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a GenerateMobileSdkReleaseUrlResponsePrivate object with public implementation \a q.
 */
GenerateMobileSdkReleaseUrlResponsePrivate::GenerateMobileSdkReleaseUrlResponsePrivate(
    GenerateMobileSdkReleaseUrlResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a Wafv2 GenerateMobileSdkReleaseUrl response element from \a xml.
 */
void GenerateMobileSdkReleaseUrlResponsePrivate::parseGenerateMobileSdkReleaseUrlResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GenerateMobileSdkReleaseUrlResponse"));
    Q_UNUSED(xml) ///< @todo
}
