...
#include "generatemobilesdkreleaseurlrequest_p.h"
...
/*!
 * \class QtAws::Wafv2::GenerateMobileSdkReleaseUrlRequest
 * \brief The GenerateMobileSdkReleaseUrlRequest class provides an interface for Wafv2 GenerateMobileSdkReleaseUrl requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 */
GenerateMobileSdkReleaseUrlRequest::GenerateMobileSdkReleaseUrlRequest(const GenerateMobileSdkReleaseUrlRequest &other)
    : Wafv2Request(new GenerateMobileSdkReleaseUrlRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GenerateMobileSdkReleaseUrlRequest object.
 */
GenerateMobileSdkReleaseUrlRequest::GenerateMobileSdkReleaseUrlRequest()
    : Wafv2Request(new GenerateMobileSdkReleaseUrlRequestPrivate(Wafv2Request::GenerateMobileSdkReleaseUrlAction, this))
{
 ...
 * \reimp
 */
bool GenerateMobileSdkReleaseUrlRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GenerateMobileSdkReleaseUrlResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GenerateMobileSdkReleaseUrlRequest::response(QNetworkReply * const reply) const
{
    return new GenerateMobileSdkReleaseUrlResponse(*this, reply);
}

/*!
 * \class QtAws::Wafv2::GenerateMobileSdkReleaseUrlRequestPrivate
 * \brief The GenerateMobileSdkReleaseUrlRequestPrivate class provides private implementation for GenerateMobileSdkReleaseUrlRequest.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a GenerateMobileSdkReleaseUrlRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
GenerateMobileSdkReleaseUrlRequestPrivate::GenerateMobileSdkReleaseUrlRequestPrivate(
    const Wafv2Request::Action action, GenerateMobileSdkReleaseUrlRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GenerateMobileSdkReleaseUrlRequest
 * class' copy constructor.
 */
GenerateMobileSdkReleaseUrlRequestPrivate::GenerateMobileSdkReleaseUrlRequestPrivate(
    const GenerateMobileSdkReleaseUrlRequestPrivate &other, GenerateMobileSdkReleaseUrlRequest * const q)
