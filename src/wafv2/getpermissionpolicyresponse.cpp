...
/*!
 * \class QtAws::WAFV2::GetPermissionPolicyResponse
 * \brief The GetPermissionPolicyResponse class provides an interace for WAFV2 GetPermissionPolicy responses.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
GetPermissionPolicyResponse::GetPermissionPolicyResponse(
    ...
    : Wafv2Response(new GetPermissionPolicyResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful WAFV2 GetPermissionPolicy \a response.
 */
...
/*!
 * \class QtAws::WAFV2::GetPermissionPolicyResponsePrivate
...
GetPermissionPolicyResponsePrivate::GetPermissionPolicyResponsePrivate(
    GetPermissionPolicyResponse * const q) : Wafv2ResponsePrivate(q)
{

}

/*!
 * Parses a WAFV2 GetPermissionPolicy response element from \a xml.
 */
