...
#include "describemanagedrulegrouprequest_p.h"
...
/*!
 * \class QtAws::Wafv2::DescribeManagedRuleGroupRequest
 * \brief The DescribeManagedRuleGroupRequest class provides an interface for Wafv2 DescribeManagedRuleGroup requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 *
 * \sa Wafv2Client::describeManagedRuleGroup
 */

/*!
 * Constructs a copy of \a other.
 */
DescribeManagedRuleGroupRequest::DescribeManagedRuleGroupRequest(const DescribeManagedRuleGroupRequest &other)
    : Wafv2Request(new DescribeManagedRuleGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeManagedRuleGroupRequest object.
 */
DescribeManagedRuleGroupRequest::DescribeManagedRuleGroupRequest()
    : Wafv2Request(new DescribeManagedRuleGroupRequestPrivate(Wafv2Request::DescribeManagedRuleGroupAction, this))
{
 ...
 * \reimp
 */
bool DescribeManagedRuleGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeManagedRuleGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeManagedRuleGroupRequest::response(QNetworkReply * const reply) const
{
    return new DescribeManagedRuleGroupResponse(*this, reply);
}

/*!
 * \class QtAws::Wafv2::DescribeManagedRuleGroupRequestPrivate
 * \brief The DescribeManagedRuleGroupRequestPrivate class provides private implementation for DescribeManagedRuleGroupRequest.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a DescribeManagedRuleGroupRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
DescribeManagedRuleGroupRequestPrivate::DescribeManagedRuleGroupRequestPrivate(
    const Wafv2Request::Action action, DescribeManagedRuleGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeManagedRuleGroupRequest
 * class' copy constructor.
 */
DescribeManagedRuleGroupRequestPrivate::DescribeManagedRuleGroupRequestPrivate(
    const DescribeManagedRuleGroupRequestPrivate &other, DescribeManagedRuleGroupRequest * const q)
