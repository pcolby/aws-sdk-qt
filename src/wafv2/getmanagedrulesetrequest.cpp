...
#include "getmanagedrulesetrequest_p.h"
...
/*!
 * \class QtAws::Wafv2::GetManagedRuleSetRequest
 * \brief The GetManagedRuleSetRequest class provides an interface for Wafv2 GetManagedRuleSet requests.
 *
 * \inmodule QtAwsWafv2
 *
 ...
 */
GetManagedRuleSetRequest::GetManagedRuleSetRequest(const GetManagedRuleSetRequest &other)
    : Wafv2Request(new GetManagedRuleSetRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetManagedRuleSetRequest object.
 */
GetManagedRuleSetRequest::GetManagedRuleSetRequest()
    : Wafv2Request(new GetManagedRuleSetRequestPrivate(Wafv2Request::GetManagedRuleSetAction, this))
{
 ...
 * \reimp
 */
bool GetManagedRuleSetRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetManagedRuleSetResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetManagedRuleSetRequest::response(QNetworkReply * const reply) const
{
    return new GetManagedRuleSetResponse(*this, reply);
}

/*!
 * \class QtAws::Wafv2::GetManagedRuleSetRequestPrivate
 * \brief The GetManagedRuleSetRequestPrivate class provides private implementation for GetManagedRuleSetRequest.
 * \internal
 *
 * \inmodule QtAwsWafv2
 */
...
/*!
 * Constructs a GetManagedRuleSetRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
GetManagedRuleSetRequestPrivate::GetManagedRuleSetRequestPrivate(
    const Wafv2Request::Action action, GetManagedRuleSetRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetManagedRuleSetRequest
 * class' copy constructor.
 */
GetManagedRuleSetRequestPrivate::GetManagedRuleSetRequestPrivate(
    const GetManagedRuleSetRequestPrivate &other, GetManagedRuleSetRequest * const q)
