...
/*!
 * \class QtAws::WAFV2::DeleteIPSetRequest
 * \brief The DeleteIPSetRequest class provides an interface for WAFV2 DeleteIPSet requests.
 *
 * \inmodule QtAwsWAFV2
 *
 *  <note>
...
DeleteIPSetRequest::DeleteIPSetRequest(const DeleteIPSetRequest &other)
    : Wafv2Request(new DeleteIPSetRequestPrivate(*other.d_func(), this))
{
...
DeleteIPSetRequest::DeleteIPSetRequest()
    : Wafv2Request(new DeleteIPSetRequestPrivate(Wafv2Request::DeleteIPSetAction, this))
{
...
/*!
 * \class QtAws::WAFV2::DeleteIPSetRequestPrivate
...
/*!
 * Constructs a DeleteIPSetRequestPrivate object for Wafv2 \a action,
 * with public implementation \a q.
 */
DeleteIPSetRequestPrivate::DeleteIPSetRequestPrivate(
    const Wafv2Request::Action action, DeleteIPSetRequest * const q)
