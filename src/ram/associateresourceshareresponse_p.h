...
class QTAWS_EXPORT AssociateResourceShareResponsePrivate : public RamResponsePrivate {

public:

    AssociateResourceShareResponsePrivate(AssociateResourceShareResponse * const q);
