...
class QTAWS_EXPORT DisassociateResourceSharePermissionResponsePrivate : public RamResponsePrivate {

public:

    DisassociateResourceSharePermissionResponsePrivate(DisassociateResourceSharePermissionResponse * const q);
