...
class QTAWS_EXPORT AssociateResourceSharePermissionResponsePrivate : public RamResponsePrivate {

public:

    AssociateResourceSharePermissionResponsePrivate(AssociateResourceSharePermissionResponse * const q);
