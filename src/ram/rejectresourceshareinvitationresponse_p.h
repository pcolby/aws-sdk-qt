...
class QTAWS_EXPORT RejectResourceShareInvitationResponsePrivate : public RamResponsePrivate {

public:

    RejectResourceShareInvitationResponsePrivate(RejectResourceShareInvitationResponse * const q);
