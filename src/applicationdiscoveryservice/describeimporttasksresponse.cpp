...
#include "describeimporttasksresponse_p.h"
...
/*!
 * Constructs a DescribeImportTasksResponse object for \a reply to \a request, with parent \a parent.
 */
...
{
    //Q_D(DescribeImportTasksResponse);
...
{
    Q_ASSERT(xml.name() == QLatin1String("DescribeImportTasksResponse"));
    Q_UNUSED(xml) ///< @todo
}
