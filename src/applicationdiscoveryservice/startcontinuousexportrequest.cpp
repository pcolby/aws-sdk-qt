 ...
 * \reimp
 */
bool StartContinuousExportRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a StartContinuousExportResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * StartContinuousExportRequest::response(QNetworkReply * const reply) const
{
    return new StartContinuousExportResponse(*this, reply);
}
 ...
 *
 * This copy-like constructor exists for the benefit of the StartContinuousExportRequest
