...
#include "startimporttaskresponse_p.h"
...
/*!
 * Constructs a StartImportTaskResponse object for \a reply to \a request, with parent \a parent.
 */
...
{
    Q_ASSERT(xml.name() == QLatin1String("StartImportTaskResponse"));
    Q_UNUSED(xml) ///< @todo
}
