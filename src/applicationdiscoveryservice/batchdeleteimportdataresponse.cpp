...
#include "batchdeleteimportdataresponse_p.h"
...
/*!
 * Constructs a BatchDeleteImportDataResponse object for \a reply to \a request, with parent \a parent.
 */
...
{
    //Q_D(BatchDeleteImportDataResponse);
...
{
    Q_ASSERT(xml.name() == QLatin1String("BatchDeleteImportDataResponse"));
    Q_UNUSED(xml) ///< @todo
}
