...
class QTAWS_EXPORT DescribeExportConfigurationsResponse : public ApplicationDiscoveryServiceResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeExportConfigurationsRequest * request() const override;
