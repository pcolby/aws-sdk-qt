 ...
 * \reimp
 */
bool ExportConfigurationsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ExportConfigurationsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ExportConfigurationsRequest::response(QNetworkReply * const reply) const
{
    return new ExportConfigurationsResponse(*this, reply);
}
 ...
 *
 * This copy-like constructor exists for the benefit of the ExportConfigurationsRequest
