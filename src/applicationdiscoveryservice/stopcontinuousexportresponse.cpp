...
#include "stopcontinuousexportresponse_p.h"
...
/*!
 * Constructs a StopContinuousExportResponse object for \a reply to \a request, with parent \a parent.
 */
...
{
    //Q_D(StopContinuousExportResponse);
...
{
    Q_ASSERT(xml.name() == QLatin1String("StopContinuousExportResponse"));
    Q_UNUSED(xml) ///< @todo
}
