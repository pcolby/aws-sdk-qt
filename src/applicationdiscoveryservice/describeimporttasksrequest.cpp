 ...
 * \reimp
 */
bool DescribeImportTasksRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeImportTasksResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeImportTasksRequest::response(QNetworkReply * const reply) const
{
    return new DescribeImportTasksResponse(*this, reply);
}
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeImportTasksRequest
