 ...
 * \reimp
 */
bool BatchDeleteImportDataRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BatchDeleteImportDataResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BatchDeleteImportDataRequest::response(QNetworkReply * const reply) const
{
    return new BatchDeleteImportDataResponse(*this, reply);
}
 ...
 *
 * This copy-like constructor exists for the benefit of the BatchDeleteImportDataRequest
