...
class QTAWS_EXPORT CreateWorkspaceResponsePrivate : public PrometheusServiceResponsePrivate {

public:

    CreateWorkspaceResponsePrivate(CreateWorkspaceResponse * const q);
