...
class QTAWS_EXPORT ListWorkspacesRequestPrivate : public PrometheusServiceRequestPrivate {

public:
    ListWorkspacesRequestPrivate(const PrometheusServiceRequest::Action action,
