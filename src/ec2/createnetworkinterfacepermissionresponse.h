...
class QTAWS_EXPORT CreateNetworkInterfacePermissionResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const CreateNetworkInterfacePermissionRequest * request() const override;
