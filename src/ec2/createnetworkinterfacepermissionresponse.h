...
class QTAWS_EXPORT CreateNetworkInterfacePermissionResponse : public CreateNetworkInterfacePermissionResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateNetworkInterfacePermissionRequest * request() const;
