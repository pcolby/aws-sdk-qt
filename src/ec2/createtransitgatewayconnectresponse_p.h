...
class QTAWS_EXPORT CreateTransitGatewayConnectResponsePrivate : public Ec2ResponsePrivate {

public:

    CreateTransitGatewayConnectResponsePrivate(CreateTransitGatewayConnectResponse * const q);
