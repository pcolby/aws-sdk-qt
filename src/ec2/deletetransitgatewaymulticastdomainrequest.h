...
#ifndef QTAWS_DELETETRANSITGATEWAYMULTICASTDOMAINREQUEST_H
#define QTAWS_DELETETRANSITGATEWAYMULTICASTDOMAINREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(DeleteTransitGatewayMulticastDomainRequest)
