...
class QTAWS_EXPORT AcceptTransitGatewayVpcAttachmentResponsePrivate : public Ec2ResponsePrivate {

public:

    AcceptTransitGatewayVpcAttachmentResponsePrivate(AcceptTransitGatewayVpcAttachmentResponse * const q);
