...
public:
    ...
    enum Action {
        ...
        CancelCapacityReservationFleetsAction,
        ...
        CreateImageAction,
        CreateInstanceEventWindowAction,
        CreateInstanceExportTaskAction,
        CreateInternetGatewayAction,
        CreateIpamAction,
        CreateIpamPoolAction,
        CreateIpamScopeAction,
        CreateKeyPairAction,
        CreateLaunchTemplateAction,
        CreateLaunchTemplateVersionAction,
        CreateLocalGatewayRouteAction,
        CreateLocalGatewayRouteTableAction,
        CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationAction,
        ...
        CreateNetworkInsightsAccessScopeAction,
        ...
        CreateSubnetAction,
        CreateSubnetCidrReservationAction,
        CreateTagsAction,
        ...
        DeleteCoipCidrAction,
        DeleteCoipPoolAction,
        ...
        DeleteInstanceEventWindowAction,
        DeleteInternetGatewayAction,
        DeleteIpamAction,
        DeleteIpamPoolAction,
        DeleteIpamScopeAction,
        DeleteKeyPairAction,
        DeleteLaunchTemplateAction,
        DeleteLaunchTemplateVersionsAction,
        DeleteLocalGatewayRouteAction,
        DeleteLocalGatewayRouteTableAction,
        DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationAction,
        ...
        DeleteNetworkInsightsAccessScopeAction,
        DeleteNetworkInsightsAccessScopeAnalysisAction,
        ...
        DeleteSubnetAction,
        DeleteSubnetCidrReservationAction,
        DeleteTagsAction,
        ...
        DeprovisionIpamPoolCidrAction,
        DeprovisionPublicIpv4PoolCidrAction,
        ...
        DescribeCapacityReservationFleetsAction,
        ...
        DescribeFastLaunchImagesAction,
        ...
        DescribeInstanceEventWindowsAction,
        ...
        DescribeIpamPoolsAction,
        DescribeIpamScopesAction,
        DescribeIpamsAction,
        ...
        DescribeNetworkInsightsAccessScopeAnalysesAction,
        DescribeNetworkInsightsAccessScopesAction,
        ...
        DescribeSecurityGroupRulesAction,
        DescribeSecurityGroupsAction,
        DescribeSnapshotAttributeAction,
        DescribeSnapshotTierStatusAction,
        ...
        DescribeTransitGatewayPolicyTablesAction,
        DescribeTransitGatewayRouteTableAnnouncementsAction,
        DescribeTransitGatewayRouteTablesAction,
        DescribeTransitGatewayVpcAttachmentsAction,
        DescribeTransitGatewaysAction,
        DescribeTrunkInterfaceAssociationsAction,
        ...
        DisableFastLaunchAction,
        DisableFastSnapshotRestoresAction,
        DisableImageDeprecationAction,
        DisableIpamOrganizationAdminAccountAction,
        ...
        GetInstanceTypesFromInstanceRequirementsAction,
        GetInstanceUefiDataAction,
        GetIpamAddressHistoryAction,
        GetIpamPoolAllocationsAction,
        GetIpamPoolCidrsAction,
        GetIpamResourceCidrsAction,
        GetLaunchTemplateDataAction,
        GetManagedPrefixListAssociationsAction,
        GetManagedPrefixListEntriesAction,
        GetNetworkInsightsAccessScopeAnalysisFindingsAction,
        GetNetworkInsightsAccessScopeContentAction,
        GetPasswordDataAction,
        GetReservedInstancesExchangeQuoteAction,
        GetSerialConsoleAccessStatusAction,
        GetSpotPlacementScoresAction,
        GetSubnetCidrReservationsAction,
        GetTransitGatewayAttachmentPropagationsAction,
        GetTransitGatewayMulticastDomainAssociationsAction,
        GetTransitGatewayPolicyTableAssociationsAction,
        GetTransitGatewayPolicyTableEntriesAction,
        ...
        GetVpnConnectionDeviceSampleConfigurationAction,
        GetVpnConnectionDeviceTypesAction,
        ...
        ImportVolumeAction,
        ListImagesInRecycleBinAction,
        ListSnapshotsInRecycleBinAction,
        ModifyAddressAttributeAction,
        ModifyAvailabilityZoneGroupAction,
        ModifyCapacityReservationAction,
        ModifyCapacityReservationFleetAction,
        ...
        ModifyInstanceEventWindowAction,
        ModifyInstanceMaintenanceOptionsAction,
        ModifyInstanceMetadataOptionsAction,
        ModifyInstancePlacementAction,
        ModifyIpamAction,
        ModifyIpamPoolAction,
        ModifyIpamResourceCidrAction,
        ModifyIpamScopeAction,
        ModifyLaunchTemplateAction,
        ModifyLocalGatewayRouteAction,
        ModifyManagedPrefixListAction,
        ModifyNetworkInterfaceAttributeAction,
        ModifyPrivateDnsNameOptionsAction,
        ModifyReservedInstancesAction,
        ModifySecurityGroupRulesAction,
        ModifySnapshotAttributeAction,
        ModifySnapshotTierAction,
        ...
        ModifyVpcEndpointServicePayerResponsibilityAction,
        ...
        MoveByoipCidrToIpamAction,
        ProvisionByoipCidrAction,
        ProvisionIpamPoolCidrAction,
        ProvisionPublicIpv4PoolCidrAction,
        ...
        ReleaseHostsAction,
        ReleaseIpamPoolAllocationAction,
        ...
        RestoreImageFromRecycleBinAction,
        RestoreManagedPrefixListVersionAction,
        RestoreSnapshotFromRecycleBinAction,
        RestoreSnapshotTierAction,
        ...
        StartNetworkInsightsAccessScopeAnalysisAction,
