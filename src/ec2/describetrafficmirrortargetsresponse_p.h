...
class QTAWS_EXPORT DescribeTrafficMirrorTargetsResponsePrivate : public Ec2ResponsePrivate {

public:

    DescribeTrafficMirrorTargetsResponsePrivate(DescribeTrafficMirrorTargetsResponse * const q);
