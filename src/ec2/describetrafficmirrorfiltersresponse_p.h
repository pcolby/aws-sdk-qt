...
class QTAWS_EXPORT DescribeTrafficMirrorFiltersResponsePrivate : public Ec2ResponsePrivate {

public:

    DescribeTrafficMirrorFiltersResponsePrivate(DescribeTrafficMirrorFiltersResponse * const q);
