...
class QTAWS_EXPORT DescribeClientVpnRoutesResponsePrivate : public Ec2ResponsePrivate {

public:

    DescribeClientVpnRoutesResponsePrivate(DescribeClientVpnRoutesResponse * const q);
