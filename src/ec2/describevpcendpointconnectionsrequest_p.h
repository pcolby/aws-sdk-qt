...
class QTAWS_EXPORT DescribeVpcEndpointConnectionsRequestPrivate : public EC2RequestPrivate {

public:
    DescribeVpcEndpointConnectionsRequestPrivate(const EC2::Action action,
