...
class QTAWS_EXPORT DescribeNetworkInterfacePermissionsRequestPrivate : public EC2RequestPrivate {

public:
    DescribeNetworkInterfacePermissionsRequestPrivate(const EC2::Action action,
