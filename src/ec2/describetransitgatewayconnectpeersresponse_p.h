...
class QTAWS_EXPORT DescribeTransitGatewayConnectPeersResponsePrivate : public Ec2ResponsePrivate {

public:

    DescribeTransitGatewayConnectPeersResponsePrivate(DescribeTransitGatewayConnectPeersResponse * const q);
