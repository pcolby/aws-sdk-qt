...
class QTAWS_EXPORT DescribeTransitGatewayAttachmentsResponsePrivate : public Ec2ResponsePrivate {

public:

    DescribeTransitGatewayAttachmentsResponsePrivate(DescribeTransitGatewayAttachmentsResponse * const q);
