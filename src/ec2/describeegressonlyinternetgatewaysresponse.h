...
class QTAWS_EXPORT DescribeEgressOnlyInternetGatewaysResponse : public DescribeEgressOnlyInternetGatewaysResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeEgressOnlyInternetGatewaysRequest * request() const;
