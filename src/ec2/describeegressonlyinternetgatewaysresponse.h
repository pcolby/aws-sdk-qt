...
class QTAWS_EXPORT DescribeEgressOnlyInternetGatewaysResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeEgressOnlyInternetGatewaysRequest * request() const override;
