...
public slots:
    ...
    AllocateIpamPoolCidrResponse * allocateIpamPoolCidr(const AllocateIpamPoolCidrRequest &request);
    ...
    AssociateInstanceEventWindowResponse * associateInstanceEventWindow(const AssociateInstanceEventWindowRequest &request);
    ...
    AssociateTransitGatewayPolicyTableResponse * associateTransitGatewayPolicyTable(const AssociateTransitGatewayPolicyTableRequest &request);
    ...
    AssociateTrunkInterfaceResponse * associateTrunkInterface(const AssociateTrunkInterfaceRequest &request);
    ...
    CancelCapacityReservationFleetsResponse * cancelCapacityReservationFleets(const CancelCapacityReservationFleetsRequest &request);
    ...
    CreateCapacityReservationFleetResponse * createCapacityReservationFleet(const CreateCapacityReservationFleetRequest &request);
    ...
    CreateCoipCidrResponse * createCoipCidr(const CreateCoipCidrRequest &request);
    CreateCoipPoolResponse * createCoipPool(const CreateCoipPoolRequest &request);
    ...
    CreateInstanceEventWindowResponse * createInstanceEventWindow(const CreateInstanceEventWindowRequest &request);
    ...
    CreateIpamResponse * createIpam(const CreateIpamRequest &request);
    CreateIpamPoolResponse * createIpamPool(const CreateIpamPoolRequest &request);
    CreateIpamScopeResponse * createIpamScope(const CreateIpamScopeRequest &request);
    ...
    CreateLocalGatewayRouteTableResponse * createLocalGatewayRouteTable(const CreateLocalGatewayRouteTableRequest &request);
    CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationResponse * createLocalGatewayRouteTableVirtualInterfaceGroupAssociation(const CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest &request);
    ...
    CreateNetworkInsightsAccessScopeResponse * createNetworkInsightsAccessScope(const CreateNetworkInsightsAccessScopeRequest &request);
    ...
    CreatePublicIpv4PoolResponse * createPublicIpv4Pool(const CreatePublicIpv4PoolRequest &request);
    ...
    CreateSubnetCidrReservationResponse * createSubnetCidrReservation(const CreateSubnetCidrReservationRequest &request);
    ...
    CreateTransitGatewayPolicyTableResponse * createTransitGatewayPolicyTable(const CreateTransitGatewayPolicyTableRequest &request);
    ...
    CreateTransitGatewayRouteTableAnnouncementResponse * createTransitGatewayRouteTableAnnouncement(const CreateTransitGatewayRouteTableAnnouncementRequest &request);
    ...
    DeleteCoipCidrResponse * deleteCoipCidr(const DeleteCoipCidrRequest &request);
    DeleteCoipPoolResponse * deleteCoipPool(const DeleteCoipPoolRequest &request);
    ...
    DeleteInstanceEventWindowResponse * deleteInstanceEventWindow(const DeleteInstanceEventWindowRequest &request);
    DeleteInternetGatewayResponse * deleteInternetGateway(const DeleteInternetGatewayRequest &request);
    DeleteIpamResponse * deleteIpam(const DeleteIpamRequest &request);
    DeleteIpamPoolResponse * deleteIpamPool(const DeleteIpamPoolRequest &request);
    DeleteIpamScopeResponse * deleteIpamScope(const DeleteIpamScopeRequest &request);
    ...
    DeleteLocalGatewayRouteTableResponse * deleteLocalGatewayRouteTable(const DeleteLocalGatewayRouteTableRequest &request);
    DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationResponse * deleteLocalGatewayRouteTableVirtualInterfaceGroupAssociation(const DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest &request);
    ...
    DeleteNetworkInsightsAccessScopeResponse * deleteNetworkInsightsAccessScope(const DeleteNetworkInsightsAccessScopeRequest &request);
    DeleteNetworkInsightsAccessScopeAnalysisResponse * deleteNetworkInsightsAccessScopeAnalysis(const DeleteNetworkInsightsAccessScopeAnalysisRequest &request);
    ...
    DeletePublicIpv4PoolResponse * deletePublicIpv4Pool(const DeletePublicIpv4PoolRequest &request);
    ...
    DeleteSubnetCidrReservationResponse * deleteSubnetCidrReservation(const DeleteSubnetCidrReservationRequest &request);
    ...
    DeleteTransitGatewayPolicyTableResponse * deleteTransitGatewayPolicyTable(const DeleteTransitGatewayPolicyTableRequest &request);
    ...
    DeleteTransitGatewayRouteTableAnnouncementResponse * deleteTransitGatewayRouteTableAnnouncement(const DeleteTransitGatewayRouteTableAnnouncementRequest &request);
    ...
    DeprovisionIpamPoolCidrResponse * deprovisionIpamPoolCidr(const DeprovisionIpamPoolCidrRequest &request);
    DeprovisionPublicIpv4PoolCidrResponse * deprovisionPublicIpv4PoolCidr(const DeprovisionPublicIpv4PoolCidrRequest &request);
    ...
    DescribeCapacityReservationFleetsResponse * describeCapacityReservationFleets(const DescribeCapacityReservationFleetsRequest &request);
    ...
    DescribeFastLaunchImagesResponse * describeFastLaunchImages(const DescribeFastLaunchImagesRequest &request);
    ...
    DescribeInstanceEventWindowsResponse * describeInstanceEventWindows(const DescribeInstanceEventWindowsRequest &request);
    ...
    DescribeIpamPoolsResponse * describeIpamPools(const DescribeIpamPoolsRequest &request);
    DescribeIpamScopesResponse * describeIpamScopes(const DescribeIpamScopesRequest &request);
    DescribeIpamsResponse * describeIpams(const DescribeIpamsRequest &request);
    ...
    DescribeNetworkInsightsAccessScopeAnalysesResponse * describeNetworkInsightsAccessScopeAnalyses(const DescribeNetworkInsightsAccessScopeAnalysesRequest &request);
    DescribeNetworkInsightsAccessScopesResponse * describeNetworkInsightsAccessScopes(const DescribeNetworkInsightsAccessScopesRequest &request);
    ...
    DescribeSecurityGroupRulesResponse * describeSecurityGroupRules(const DescribeSecurityGroupRulesRequest &request);
    ...
    DescribeSnapshotTierStatusResponse * describeSnapshotTierStatus(const DescribeSnapshotTierStatusRequest &request);
    ...
    DescribeTransitGatewayPolicyTablesResponse * describeTransitGatewayPolicyTables(const DescribeTransitGatewayPolicyTablesRequest &request);
    DescribeTransitGatewayRouteTableAnnouncementsResponse * describeTransitGatewayRouteTableAnnouncements(const DescribeTransitGatewayRouteTableAnnouncementsRequest &request);
    ...
    DescribeTrunkInterfaceAssociationsResponse * describeTrunkInterfaceAssociations(const DescribeTrunkInterfaceAssociationsRequest &request);
    ...
    DisableFastLaunchResponse * disableFastLaunch(const DisableFastLaunchRequest &request);
    ...
    DisableIpamOrganizationAdminAccountResponse * disableIpamOrganizationAdminAccount(const DisableIpamOrganizationAdminAccountRequest &request);
    ...
    DisassociateInstanceEventWindowResponse * disassociateInstanceEventWindow(const DisassociateInstanceEventWindowRequest &request);
    ...
    DisassociateTransitGatewayPolicyTableResponse * disassociateTransitGatewayPolicyTable(const DisassociateTransitGatewayPolicyTableRequest &request);
    ...
    DisassociateTrunkInterfaceResponse * disassociateTrunkInterface(const DisassociateTrunkInterfaceRequest &request);
    ...
    EnableFastLaunchResponse * enableFastLaunch(const EnableFastLaunchRequest &request);
    ...
    EnableIpamOrganizationAdminAccountResponse * enableIpamOrganizationAdminAccount(const EnableIpamOrganizationAdminAccountRequest &request);
    ...
    GetInstanceTypesFromInstanceRequirementsResponse * getInstanceTypesFromInstanceRequirements(const GetInstanceTypesFromInstanceRequirementsRequest &request);
    GetInstanceUefiDataResponse * getInstanceUefiData(const GetInstanceUefiDataRequest &request);
    GetIpamAddressHistoryResponse * getIpamAddressHistory(const GetIpamAddressHistoryRequest &request);
    GetIpamPoolAllocationsResponse * getIpamPoolAllocations(const GetIpamPoolAllocationsRequest &request);
    GetIpamPoolCidrsResponse * getIpamPoolCidrs(const GetIpamPoolCidrsRequest &request);
    GetIpamResourceCidrsResponse * getIpamResourceCidrs(const GetIpamResourceCidrsRequest &request);
    ...
    GetNetworkInsightsAccessScopeAnalysisFindingsResponse * getNetworkInsightsAccessScopeAnalysisFindings(const GetNetworkInsightsAccessScopeAnalysisFindingsRequest &request);
    GetNetworkInsightsAccessScopeContentResponse * getNetworkInsightsAccessScopeContent(const GetNetworkInsightsAccessScopeContentRequest &request);
    ...
    GetSpotPlacementScoresResponse * getSpotPlacementScores(const GetSpotPlacementScoresRequest &request);
    GetSubnetCidrReservationsResponse * getSubnetCidrReservations(const GetSubnetCidrReservationsRequest &request);
    ...
    GetTransitGatewayPolicyTableAssociationsResponse * getTransitGatewayPolicyTableAssociations(const GetTransitGatewayPolicyTableAssociationsRequest &request);
    GetTransitGatewayPolicyTableEntriesResponse * getTransitGatewayPolicyTableEntries(const GetTransitGatewayPolicyTableEntriesRequest &request);
    ...
    GetVpnConnectionDeviceSampleConfigurationResponse * getVpnConnectionDeviceSampleConfiguration(const GetVpnConnectionDeviceSampleConfigurationRequest &request);
    GetVpnConnectionDeviceTypesResponse * getVpnConnectionDeviceTypes(const GetVpnConnectionDeviceTypesRequest &request);
    ...
    ListImagesInRecycleBinResponse * listImagesInRecycleBin(const ListImagesInRecycleBinRequest &request);
    ListSnapshotsInRecycleBinResponse * listSnapshotsInRecycleBin(const ListSnapshotsInRecycleBinRequest &request);
    ...
    ModifyCapacityReservationFleetResponse * modifyCapacityReservationFleet(const ModifyCapacityReservationFleetRequest &request);
    ...
    ModifyInstanceEventWindowResponse * modifyInstanceEventWindow(const ModifyInstanceEventWindowRequest &request);
    ModifyInstanceMaintenanceOptionsResponse * modifyInstanceMaintenanceOptions(const ModifyInstanceMaintenanceOptionsRequest &request);
    ...
    ModifyIpamResponse * modifyIpam(const ModifyIpamRequest &request);
    ModifyIpamPoolResponse * modifyIpamPool(const ModifyIpamPoolRequest &request);
    ModifyIpamResourceCidrResponse * modifyIpamResourceCidr(const ModifyIpamResourceCidrRequest &request);
    ModifyIpamScopeResponse * modifyIpamScope(const ModifyIpamScopeRequest &request);
    ModifyLaunchTemplateResponse * modifyLaunchTemplate(const ModifyLaunchTemplateRequest &request);
    ModifyLocalGatewayRouteResponse * modifyLocalGatewayRoute(const ModifyLocalGatewayRouteRequest &request);
    ...
    ModifyPrivateDnsNameOptionsResponse * modifyPrivateDnsNameOptions(const ModifyPrivateDnsNameOptionsRequest &request);
    ModifyReservedInstancesResponse * modifyReservedInstances(const ModifyReservedInstancesRequest &request);
    ModifySecurityGroupRulesResponse * modifySecurityGroupRules(const ModifySecurityGroupRulesRequest &request);
    ModifySnapshotAttributeResponse * modifySnapshotAttribute(const ModifySnapshotAttributeRequest &request);
    ModifySnapshotTierResponse * modifySnapshotTier(const ModifySnapshotTierRequest &request);
    ...
    ModifyVpcEndpointServicePayerResponsibilityResponse * modifyVpcEndpointServicePayerResponsibility(const ModifyVpcEndpointServicePayerResponsibilityRequest &request);
    ...
    MoveByoipCidrToIpamResponse * moveByoipCidrToIpam(const MoveByoipCidrToIpamRequest &request);
    ProvisionByoipCidrResponse * provisionByoipCidr(const ProvisionByoipCidrRequest &request);
    ProvisionIpamPoolCidrResponse * provisionIpamPoolCidr(const ProvisionIpamPoolCidrRequest &request);
    ProvisionPublicIpv4PoolCidrResponse * provisionPublicIpv4PoolCidr(const ProvisionPublicIpv4PoolCidrRequest &request);
    ...
    ReleaseIpamPoolAllocationResponse * releaseIpamPoolAllocation(const ReleaseIpamPoolAllocationRequest &request);
    ...
    RestoreImageFromRecycleBinResponse * restoreImageFromRecycleBin(const RestoreImageFromRecycleBinRequest &request);
    ...
    RestoreSnapshotFromRecycleBinResponse * restoreSnapshotFromRecycleBin(const RestoreSnapshotFromRecycleBinRequest &request);
    RestoreSnapshotTierResponse * restoreSnapshotTier(const RestoreSnapshotTierRequest &request);
    ...
    StartNetworkInsightsAccessScopeAnalysisResponse * startNetworkInsightsAccessScopeAnalysis(const StartNetworkInsightsAccessScopeAnalysisRequest &request);
