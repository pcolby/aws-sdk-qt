...
class QTAWS_EXPORT CreateTransitGatewayRouteResponsePrivate : public Ec2ResponsePrivate {

public:

    CreateTransitGatewayRouteResponsePrivate(CreateTransitGatewayRouteResponse * const q);
