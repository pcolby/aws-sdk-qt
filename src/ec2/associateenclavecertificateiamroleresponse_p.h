...
class QTAWS_EXPORT AssociateEnclaveCertificateIamRoleResponsePrivate : public Ec2ResponsePrivate {

public:

    AssociateEnclaveCertificateIamRoleResponsePrivate(AssociateEnclaveCertificateIamRoleResponse * const q);
