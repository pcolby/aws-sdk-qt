...
/**
 * @brief  Constructs a new EC2Request object.
 *
...
/**
 * @brief  Constructs a new EC2Request object by copying another.
 *
 ...
 *
 * @brief  Private implementation for EC2Request.
 */

/**
 * @internal
 *
 * @brief  Constructs a new EC2RequestPrivate object.
 *
 * @param  action  EC2 action being performed by the \a q request.
 * @param  q       Pointer to this object's public EC2Request instance.
 */
 ...
 * @internal
 *
 * @brief  Constructs a new EC2RequestPrivate object from an existing one.
 *
