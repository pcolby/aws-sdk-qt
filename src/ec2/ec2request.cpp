...
/*!
 * \brief Returns the EC2 action to be performed by this request.
 */
...
/*!
 * \brief Returns the name of the EC2 action to be performed by this request.
 */
...
/*!
 * \brief Returns the EC2 API version implemented by this request.
 */
...
/*!
 * @brief Set the EC2 action to be performed by this request to \a action.
 */
...
/*!
 * Set the EC2 API version to include in this request to \a version.
 */
...
/*!
 * \brief Returns a network request for this EC2 request using the given \a endpoint.
 *
 ...
 * \internal
 *
 * \brief Constructs a new EC2RequestPrivate object, copying an existing one.
 *
