...
class QTAWS_EXPORT DescribeVpcEndpointServicesResponsePrivate : public EC2ResponsePrivate {
    Q_OBJECT

public:

    DescribeVpcEndpointServicesResponsePrivate(DescribeVpcEndpointServicesResponse * const q);
