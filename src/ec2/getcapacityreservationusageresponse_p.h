...
class QTAWS_EXPORT GetCapacityReservationUsageResponsePrivate : public Ec2ResponsePrivate {

public:

    GetCapacityReservationUsageResponsePrivate(GetCapacityReservationUsageResponse * const q);
