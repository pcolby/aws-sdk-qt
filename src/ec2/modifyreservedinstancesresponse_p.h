...
class QTAWS_EXPORT ModifyReservedInstancesResponsePrivate : public EC2ResponsePrivate {
    Q_OBJECT

public:

    ModifyReservedInstancesResponsePrivate(ModifyReservedInstancesResponse * const q);
