...
class QTAWS_EXPORT DeleteNetworkInterfacePermissionResponse : public DeleteNetworkInterfacePermissionResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteNetworkInterfacePermissionRequest * request() const;
