...
class QTAWS_EXPORT DeleteNetworkInterfacePermissionResponse : public EC2Response {
    Q_OBJECT
...
public:
    ...
    virtual const DeleteNetworkInterfacePermissionRequest * request() const override;
