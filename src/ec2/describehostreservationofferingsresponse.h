...
class QTAWS_EXPORT DescribeHostReservationOfferingsResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeHostReservationOfferingsRequest * request() const override;
