...
class QTAWS_EXPORT DescribeInstanceTypesResponsePrivate : public Ec2ResponsePrivate {

public:

    DescribeInstanceTypesResponsePrivate(DescribeInstanceTypesResponse * const q);
