...
class QTAWS_EXPORT CreateLaunchTemplateResponsePrivate : public Ec2ResponsePrivate {

public:

    CreateLaunchTemplateResponsePrivate(CreateLaunchTemplateResponse * const q);
