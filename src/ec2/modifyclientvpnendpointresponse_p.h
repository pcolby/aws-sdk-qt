...
class QTAWS_EXPORT ModifyClientVpnEndpointResponsePrivate : public Ec2ResponsePrivate {

public:

    ModifyClientVpnEndpointResponsePrivate(ModifyClientVpnEndpointResponse * const q);
