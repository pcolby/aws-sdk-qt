...
class QTAWS_EXPORT EnableFastSnapshotRestoresResponsePrivate : public Ec2ResponsePrivate {

public:

    EnableFastSnapshotRestoresResponsePrivate(EnableFastSnapshotRestoresResponse * const q);
