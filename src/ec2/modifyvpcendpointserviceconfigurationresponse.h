...
class QTAWS_EXPORT ModifyVpcEndpointServiceConfigurationResponse : public EC2Response {
    Q_OBJECT
...
public:
    ...
    virtual const ModifyVpcEndpointServiceConfigurationRequest * request() const override;
