...
class QTAWS_EXPORT CreateClientVpnEndpointResponsePrivate : public Ec2ResponsePrivate {

public:

    CreateClientVpnEndpointResponsePrivate(CreateClientVpnEndpointResponse * const q);
