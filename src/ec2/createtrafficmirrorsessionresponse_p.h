...
class QTAWS_EXPORT CreateTrafficMirrorSessionResponsePrivate : public Ec2ResponsePrivate {

public:

    CreateTrafficMirrorSessionResponsePrivate(CreateTrafficMirrorSessionResponse * const q);
