...
class QTAWS_EXPORT CancelReservedInstancesListingResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const CancelReservedInstancesListingRequest * request() const override;
