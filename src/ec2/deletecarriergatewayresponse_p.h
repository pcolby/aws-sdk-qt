...
class QTAWS_EXPORT DeleteCarrierGatewayResponsePrivate : public Ec2ResponsePrivate {

public:

    DeleteCarrierGatewayResponsePrivate(DeleteCarrierGatewayResponse * const q);
