...
class QTAWS_EXPORT ModifyCapacityReservationResponsePrivate : public Ec2ResponsePrivate {

public:

    ModifyCapacityReservationResponsePrivate(ModifyCapacityReservationResponse * const q);
