...
class QTAWS_EXPORT CreateReservedInstancesListingResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const CreateReservedInstancesListingRequest * request() const override;
