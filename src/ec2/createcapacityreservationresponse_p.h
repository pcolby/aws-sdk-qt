...
class QTAWS_EXPORT CreateCapacityReservationResponsePrivate : public Ec2ResponsePrivate {

public:

    CreateCapacityReservationResponsePrivate(CreateCapacityReservationResponse * const q);
