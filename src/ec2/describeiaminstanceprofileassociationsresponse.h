...
class QTAWSEC2_EXPORT DescribeIamInstanceProfileAssociationsResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeIamInstanceProfileAssociationsRequest * request() const Q_DECL_OVERRIDE;
