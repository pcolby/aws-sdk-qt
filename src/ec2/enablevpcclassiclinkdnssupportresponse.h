...
class QTAWSEC2_EXPORT EnableVpcClassicLinkDnsSupportResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const EnableVpcClassicLinkDnsSupportRequest * request() const Q_DECL_OVERRIDE;
