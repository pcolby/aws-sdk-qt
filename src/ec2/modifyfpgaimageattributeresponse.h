...
class QTAWS_EXPORT ModifyFpgaImageAttributeResponse : public ModifyFpgaImageAttributeResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ModifyFpgaImageAttributeRequest * request() const;
