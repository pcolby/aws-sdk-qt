...
class QTAWS_EXPORT CreateLaunchTemplateVersionResponse : public CreateLaunchTemplateVersionResponse {
    Q_OBJECT
...
public:
    ...
    virtual const CreateLaunchTemplateVersionRequest * request() const;
