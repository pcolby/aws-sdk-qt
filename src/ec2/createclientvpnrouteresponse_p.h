...
class QTAWS_EXPORT CreateClientVpnRouteResponsePrivate : public Ec2ResponsePrivate {

public:

    CreateClientVpnRouteResponsePrivate(CreateClientVpnRouteResponse * const q);
