...
class QTAWSEC2_EXPORT ModifyVpcPeeringConnectionOptionsResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const ModifyVpcPeeringConnectionOptionsRequest * request() const Q_DECL_OVERRIDE;
