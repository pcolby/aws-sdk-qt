...
#ifndef QTAWS_REGISTERTRANSITGATEWAYMULTICASTGROUPMEMBERSREQUEST_H
#define QTAWS_REGISTERTRANSITGATEWAYMULTICASTGROUPMEMBERSREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(RegisterTransitGatewayMulticastGroupMembersRequest)
