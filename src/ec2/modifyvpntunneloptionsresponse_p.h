...
class QTAWS_EXPORT ModifyVpnTunnelOptionsResponsePrivate : public Ec2ResponsePrivate {

public:

    ModifyVpnTunnelOptionsResponsePrivate(ModifyVpnTunnelOptionsResponse * const q);
