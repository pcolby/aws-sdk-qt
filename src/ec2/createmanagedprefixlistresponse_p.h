...
class QTAWS_EXPORT CreateManagedPrefixListResponsePrivate : public Ec2ResponsePrivate {

public:

    CreateManagedPrefixListResponsePrivate(CreateManagedPrefixListResponse * const q);
