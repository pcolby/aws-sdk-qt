...
class QTAWS_EXPORT CreateVpcEndpointServiceConfigurationResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const CreateVpcEndpointServiceConfigurationRequest * request() const override;
