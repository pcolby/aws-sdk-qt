...
class QTAWS_EXPORT DescribeNetworkInsightsAnalysesResponsePrivate : public Ec2ResponsePrivate {

public:

    DescribeNetworkInsightsAnalysesResponsePrivate(DescribeNetworkInsightsAnalysesResponse * const q);
