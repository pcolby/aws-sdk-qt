...
class QTAWS_EXPORT CreateTransitGatewayVpcAttachmentResponsePrivate : public Ec2ResponsePrivate {

public:

    CreateTransitGatewayVpcAttachmentResponsePrivate(CreateTransitGatewayVpcAttachmentResponse * const q);
