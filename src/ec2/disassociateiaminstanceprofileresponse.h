...
class QTAWSEC2_EXPORT DisassociateIamInstanceProfileResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const DisassociateIamInstanceProfileRequest * request() const Q_DECL_OVERRIDE;
