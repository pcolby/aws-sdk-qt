...
class QTAWS_EXPORT CreateRestoreImageTaskResponsePrivate : public Ec2ResponsePrivate {

public:

    CreateRestoreImageTaskResponsePrivate(CreateRestoreImageTaskResponse * const q);
