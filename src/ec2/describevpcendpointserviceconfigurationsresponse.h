...
class QTAWS_EXPORT DescribeVpcEndpointServiceConfigurationsResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeVpcEndpointServiceConfigurationsRequest * request() const override;
