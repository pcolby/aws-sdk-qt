...
class QTAWS_EXPORT DescribeReservedInstancesResponse : public DescribeReservedInstancesResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeReservedInstancesRequest * request() const;
