...
class QTAWS_EXPORT DescribeImportImageTasksResponse : public DescribeImportImageTasksResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeImportImageTasksRequest * request() const;
