...
class QTAWS_EXPORT DescribeManagedPrefixListsResponsePrivate : public Ec2ResponsePrivate {

public:

    DescribeManagedPrefixListsResponsePrivate(DescribeManagedPrefixListsResponse * const q);
