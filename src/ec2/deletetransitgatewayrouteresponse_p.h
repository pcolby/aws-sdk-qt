...
class QTAWS_EXPORT DeleteTransitGatewayRouteResponsePrivate : public Ec2ResponsePrivate {

public:

    DeleteTransitGatewayRouteResponsePrivate(DeleteTransitGatewayRouteResponse * const q);
