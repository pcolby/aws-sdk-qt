 ...
 *
 * @brief  Handles EC2 DescribeSpotFleetRequests responses.
 *
 ...
 */
DescribeSpotFleetRequestsResponse::{OperationName}}Response(
...
DescribeSpotFleetRequestsResponsePrivate::DescribeSpotFleetRequestsResponsePrivate(
    DescribeSpotFleetRequestsQueueResponse * const q) : DescribeSpotFleetRequestsPrivate(q)
{
 ...
 */
void DescribeSpotFleetRequestsResponsePrivate::DescribeSpotFleetRequestsResponse(QXmlStreamReader &xml)
{
