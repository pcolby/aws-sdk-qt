...
class QTAWS_EXPORT DescribeImageAttributeResponsePrivate : public Ec2ResponsePrivate {

public:

    DescribeImageAttributeResponsePrivate(DescribeImageAttributeResponse * const q);
