...
class QTAWS_EXPORT DeleteTransitGatewayRouteTableResponsePrivate : public Ec2ResponsePrivate {

public:

    DeleteTransitGatewayRouteTableResponsePrivate(DeleteTransitGatewayRouteTableResponse * const q);
