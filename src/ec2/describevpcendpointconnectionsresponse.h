...
class QTAWS_EXPORT DescribeVpcEndpointConnectionsResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeVpcEndpointConnectionsRequest * request() const override;
