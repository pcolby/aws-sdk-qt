...
class QTAWS_EXPORT DescribeCustomerGatewaysResponse : public DescribeCustomerGatewaysResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeCustomerGatewaysRequest * request() const;
