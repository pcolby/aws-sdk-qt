...
#ifndef QTAWS_GETGROUPSFORCAPACITYRESERVATIONREQUEST_H
#define QTAWS_GETGROUPSFORCAPACITYRESERVATIONREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(GetGroupsForCapacityReservationRequest)
