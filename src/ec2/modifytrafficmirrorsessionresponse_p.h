...
class QTAWS_EXPORT ModifyTrafficMirrorSessionResponsePrivate : public Ec2ResponsePrivate {

public:

    ModifyTrafficMirrorSessionResponsePrivate(ModifyTrafficMirrorSessionResponse * const q);
