...
class QTAWS_EXPORT CreateVpcEndpointServiceConfigurationRequestPrivate : public EC2Private {

public:
    CreateVpcEndpointServiceConfigurationRequestPrivate(const EC2::Action action,
