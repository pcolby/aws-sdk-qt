...
class QTAWS_EXPORT DescribeVpcEndpointConnectionNotificationsResponse : public EC2Response {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeVpcEndpointConnectionNotificationsRequest * request() const override;
