...
class QTAWS_EXPORT DescribeNetworkInsightsPathsResponsePrivate : public Ec2ResponsePrivate {

public:

    DescribeNetworkInsightsPathsResponsePrivate(DescribeNetworkInsightsPathsResponse * const q);
