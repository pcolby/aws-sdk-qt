...
class QTAWS_EXPORT ModifyTrafficMirrorFilterRuleResponsePrivate : public Ec2ResponsePrivate {

public:

    ModifyTrafficMirrorFilterRuleResponsePrivate(ModifyTrafficMirrorFilterRuleResponse * const q);
