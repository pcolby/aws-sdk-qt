...
class QTAWS_EXPORT CreateTransitGatewayRouteTableResponsePrivate : public Ec2ResponsePrivate {

public:

    CreateTransitGatewayRouteTableResponsePrivate(CreateTransitGatewayRouteTableResponse * const q);
