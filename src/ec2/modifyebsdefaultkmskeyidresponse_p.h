...
class QTAWS_EXPORT ModifyEbsDefaultKmsKeyIdResponsePrivate : public Ec2ResponsePrivate {

public:

    ModifyEbsDefaultKmsKeyIdResponsePrivate(ModifyEbsDefaultKmsKeyIdResponse * const q);
