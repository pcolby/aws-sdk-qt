...
class QTAWS_EXPORT ModifyVpcEndpointConnectionNotificationResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const ModifyVpcEndpointConnectionNotificationRequest * request() const override;
