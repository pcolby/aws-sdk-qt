...
class QTAWSEC2_EXPORT DisassociateSubnetCidrBlockResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const DisassociateSubnetCidrBlockRequest * request() const Q_DECL_OVERRIDE;
