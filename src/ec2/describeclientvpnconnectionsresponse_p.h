...
class QTAWS_EXPORT DescribeClientVpnConnectionsResponsePrivate : public Ec2ResponsePrivate {

public:

    DescribeClientVpnConnectionsResponsePrivate(DescribeClientVpnConnectionsResponse * const q);
