...
class QTAWS_EXPORT DescribeSpotFleetRequestsResponse : public DescribeSpotFleetRequestsResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeSpotFleetRequestsRequest * request() const;
