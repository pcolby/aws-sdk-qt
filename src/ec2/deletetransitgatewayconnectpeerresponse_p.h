...
class QTAWS_EXPORT DeleteTransitGatewayConnectPeerResponsePrivate : public Ec2ResponsePrivate {

public:

    DeleteTransitGatewayConnectPeerResponsePrivate(DeleteTransitGatewayConnectPeerResponse * const q);
