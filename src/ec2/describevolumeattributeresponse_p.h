...
class QTAWS_EXPORT DescribeVolumeAttributeResponsePrivate : public Ec2ResponsePrivate {

public:

    DescribeVolumeAttributeResponsePrivate(DescribeVolumeAttributeResponse * const q);
