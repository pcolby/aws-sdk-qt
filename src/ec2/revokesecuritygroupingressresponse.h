...
class QTAWS_EXPORT RevokeSecurityGroupIngressResponse : public RevokeSecurityGroupIngressResponse {
    Q_OBJECT
...
public:
    ...
    virtual const RevokeSecurityGroupIngressRequest * request() const;
