...
class QTAWSEC2_EXPORT DescribeSnapshotAttributeResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeSnapshotAttributeRequest * request() const Q_DECL_OVERRIDE;
