...
class QTAWS_EXPORT CreateTransitGatewayConnectPeerResponsePrivate : public Ec2ResponsePrivate {

public:

    CreateTransitGatewayConnectPeerResponsePrivate(CreateTransitGatewayConnectPeerResponse * const q);
