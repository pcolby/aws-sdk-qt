...
class QTAWS_EXPORT DeleteTrafficMirrorTargetResponsePrivate : public Ec2ResponsePrivate {

public:

    DeleteTrafficMirrorTargetResponsePrivate(DeleteTrafficMirrorTargetResponse * const q);
