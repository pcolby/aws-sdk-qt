...
class QTAWS_EXPORT GetEbsEncryptionByDefaultResponsePrivate : public Ec2ResponsePrivate {

public:

    GetEbsEncryptionByDefaultResponsePrivate(GetEbsEncryptionByDefaultResponse * const q);
