...
class QTAWS_EXPORT EnableSerialConsoleAccessResponsePrivate : public Ec2ResponsePrivate {

public:

    EnableSerialConsoleAccessResponsePrivate(EnableSerialConsoleAccessResponse * const q);
