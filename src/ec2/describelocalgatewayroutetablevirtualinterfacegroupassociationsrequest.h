...
#ifndef QTAWS_DESCRIBELOCALGATEWAYROUTETABLEVIRTUALINTERFACEGROUPASSOCIATIONSREQUEST_H
#define QTAWS_DESCRIBELOCALGATEWAYROUTETABLEVIRTUALINTERFACEGROUPASSOCIATIONSREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest)
