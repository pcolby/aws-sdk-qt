...
class QTAWS_EXPORT CreateEgressOnlyInternetGatewayResponse : public EC2Response {
    Q_OBJECT
...
public:
    ...
    virtual const CreateEgressOnlyInternetGatewayRequest * request() const override;
