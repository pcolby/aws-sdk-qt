...
class QTAWS_EXPORT DescribeLaunchTemplateVersionsResponse : public Ec2Response {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeLaunchTemplateVersionsRequest * request() const override;
