...
class QTAWS_EXPORT DescribeFleetInstancesResponsePrivate : public Ec2ResponsePrivate {

public:

    DescribeFleetInstancesResponsePrivate(DescribeFleetInstancesResponse * const q);
