...
class CreateNetworkAclEntryResponsePrivate : public Ec2ResponsePrivate {

public:

    explicit CreateNetworkAclEntryResponsePrivate(CreateNetworkAclEntryResponse * const q);
