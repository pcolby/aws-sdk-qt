...
class QTAWS_EXPORT CreateTransitGatewayResponsePrivate : public Ec2ResponsePrivate {

public:

    CreateTransitGatewayResponsePrivate(CreateTransitGatewayResponse * const q);
