...
class QTAWS_EXPORT GetManagedPrefixListAssociationsResponsePrivate : public Ec2ResponsePrivate {

public:

    GetManagedPrefixListAssociationsResponsePrivate(GetManagedPrefixListAssociationsResponse * const q);
