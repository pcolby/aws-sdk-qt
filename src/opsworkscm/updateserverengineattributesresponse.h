...
class QTAWS_EXPORT UpdateServerEngineAttributesResponse : public OpsWorksCMResponse {
    Q_OBJECT
...
public:
    ...
    virtual const UpdateServerEngineAttributesRequest * request() const override;
