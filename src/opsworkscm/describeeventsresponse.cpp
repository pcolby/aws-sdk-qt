 ...
 *
 * @brief  Handles OpsWorksCM DescribeEvents responses.
 *
...
/**
 * @brief  Parse a OpsWorksCM DescribeEvents response.
 *
...
/**
 * @brief  Parse an OpsWorksCM DescribeEventsResponse element.
 *
