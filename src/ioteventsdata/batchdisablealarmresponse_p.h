...
class QTAWS_EXPORT BatchDisableAlarmResponsePrivate : public IoTEventsDataResponsePrivate {

public:

    BatchDisableAlarmResponsePrivate(BatchDisableAlarmResponse * const q);
