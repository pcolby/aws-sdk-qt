...
class QTAWS_EXPORT BatchEnableAlarmResponsePrivate : public IoTEventsDataResponsePrivate {

public:

    BatchEnableAlarmResponsePrivate(BatchEnableAlarmResponse * const q);
