...
/*!
 * \class QtAws::Chime::ListChannelsModeratedByAppInstanceUserResponse
 * \brief The ListChannelsModeratedByAppInstanceUserResponse class provides an interace for Chime ListChannelsModeratedByAppInstanceUser responses.
 *
 * \inmodule QtAwsChime
 *
...
ListChannelsModeratedByAppInstanceUserResponse::ListChannelsModeratedByAppInstanceUserResponse(
    ...
    : ChimeResponse(new ListChannelsModeratedByAppInstanceUserResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime ListChannelsModeratedByAppInstanceUser \a response.
 */
...
/*!
 * \class QtAws::Chime::ListChannelsModeratedByAppInstanceUserResponsePrivate
...
ListChannelsModeratedByAppInstanceUserResponsePrivate::ListChannelsModeratedByAppInstanceUserResponsePrivate(
    ListChannelsModeratedByAppInstanceUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListChannelsModeratedByAppInstanceUser response element from \a xml.
 */
