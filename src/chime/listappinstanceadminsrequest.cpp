...
/*!
 * \class QtAws::Chime::ListAppInstanceAdminsRequest
 * \brief The ListAppInstanceAdminsRequest class provides an interface for Chime ListAppInstanceAdmins requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listAppInstanceAdmins
 */
...
ListAppInstanceAdminsRequest::ListAppInstanceAdminsRequest(const ListAppInstanceAdminsRequest &other)
    : ChimeRequest(new ListAppInstanceAdminsRequestPrivate(*other.d_func(), this))
{
...
ListAppInstanceAdminsRequest::ListAppInstanceAdminsRequest()
    : ChimeRequest(new ListAppInstanceAdminsRequestPrivate(ChimeRequest::ListAppInstanceAdminsAction, this))
{
...
/*!
 * \class QtAws::Chime::ListAppInstanceAdminsRequestPrivate
...
/*!
 * Constructs a ListAppInstanceAdminsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListAppInstanceAdminsRequestPrivate::ListAppInstanceAdminsRequestPrivate(
    const ChimeRequest::Action action, ListAppInstanceAdminsRequest * const q)
