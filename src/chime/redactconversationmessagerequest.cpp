...
#include "redactconversationmessagerequest_p.h"
...
/*!
 * \class QtAws::Chime::RedactConversationMessageRequest
 * \brief The RedactConversationMessageRequest class provides an interface for Chime RedactConversationMessage requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::redactConversationMessage
 */

/*!
 * Constructs a copy of \a other.
 */
RedactConversationMessageRequest::RedactConversationMessageRequest(const RedactConversationMessageRequest &other)
    : ChimeRequest(new RedactConversationMessageRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a RedactConversationMessageRequest object.
 */
RedactConversationMessageRequest::RedactConversationMessageRequest()
    : ChimeRequest(new RedactConversationMessageRequestPrivate(ChimeRequest::RedactConversationMessageAction, this))
{
 ...
 * \reimp
 */
bool RedactConversationMessageRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a RedactConversationMessageResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * RedactConversationMessageRequest::response(QNetworkReply * const reply) const
{
    return new RedactConversationMessageResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::RedactConversationMessageRequestPrivate
 * \brief The RedactConversationMessageRequestPrivate class provides private implementation for RedactConversationMessageRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a RedactConversationMessageRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
RedactConversationMessageRequestPrivate::RedactConversationMessageRequestPrivate(
    const ChimeRequest::Action action, RedactConversationMessageRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the RedactConversationMessageRequest
 * class' copy constructor.
 */
RedactConversationMessageRequestPrivate::RedactConversationMessageRequestPrivate(
    const RedactConversationMessageRequestPrivate &other, RedactConversationMessageRequest * const q)
