...
#include "deleteaccountrequest_p.h"
...
/*!
 * \class QtAws::Chime::DeleteAccountRequest
 * \brief The DeleteAccountRequest class provides an interface for Chime DeleteAccount requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
DeleteAccountRequest::DeleteAccountRequest(const DeleteAccountRequest &other)
    : ChimeRequest(new DeleteAccountRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteAccountRequest object.
 */
DeleteAccountRequest::DeleteAccountRequest()
    : ChimeRequest(new DeleteAccountRequestPrivate(ChimeRequest::DeleteAccountAction, this))
{
 ...
 * \reimp
 */
bool DeleteAccountRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteAccountResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteAccountRequest::response(QNetworkReply * const reply) const
{
    return new DeleteAccountResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeleteAccountRequestPrivate
 * \brief The DeleteAccountRequestPrivate class provides private implementation for DeleteAccountRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteAccountRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteAccountRequestPrivate::DeleteAccountRequestPrivate(
    const ChimeRequest::Action action, DeleteAccountRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteAccountRequest
 * class' copy constructor.
 */
DeleteAccountRequestPrivate::DeleteAccountRequestPrivate(
    const DeleteAccountRequestPrivate &other, DeleteAccountRequest * const q)
