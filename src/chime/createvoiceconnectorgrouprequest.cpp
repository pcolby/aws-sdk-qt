...
#include "createvoiceconnectorgrouprequest_p.h"
...
/*!
 * \class QtAws::Chime::CreateVoiceConnectorGroupRequest
 * \brief The CreateVoiceConnectorGroupRequest class provides an interface for Chime CreateVoiceConnectorGroup requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createVoiceConnectorGroup
 */

/*!
 * Constructs a copy of \a other.
 */
CreateVoiceConnectorGroupRequest::CreateVoiceConnectorGroupRequest(const CreateVoiceConnectorGroupRequest &other)
    : ChimeRequest(new CreateVoiceConnectorGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateVoiceConnectorGroupRequest object.
 */
CreateVoiceConnectorGroupRequest::CreateVoiceConnectorGroupRequest()
    : ChimeRequest(new CreateVoiceConnectorGroupRequestPrivate(ChimeRequest::CreateVoiceConnectorGroupAction, this))
{
 ...
 * \reimp
 */
bool CreateVoiceConnectorGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateVoiceConnectorGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateVoiceConnectorGroupRequest::response(QNetworkReply * const reply) const
{
    return new CreateVoiceConnectorGroupResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::CreateVoiceConnectorGroupRequestPrivate
 * \brief The CreateVoiceConnectorGroupRequestPrivate class provides private implementation for CreateVoiceConnectorGroupRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateVoiceConnectorGroupRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateVoiceConnectorGroupRequestPrivate::CreateVoiceConnectorGroupRequestPrivate(
    const ChimeRequest::Action action, CreateVoiceConnectorGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateVoiceConnectorGroupRequest
 * class' copy constructor.
 */
CreateVoiceConnectorGroupRequestPrivate::CreateVoiceConnectorGroupRequestPrivate(
    const CreateVoiceConnectorGroupRequestPrivate &other, CreateVoiceConnectorGroupRequest * const q)
