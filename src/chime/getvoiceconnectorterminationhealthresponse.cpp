...
#include "getvoiceconnectorterminationhealthresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorTerminationHealthResponse
 * \brief The GetVoiceConnectorTerminationHealthResponse class provides an interace for Chime GetVoiceConnectorTerminationHealth responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getVoiceConnectorTerminationHealth
 */

/*!
 * Constructs a GetVoiceConnectorTerminationHealthResponse object for \a reply to \a request, with parent \a parent.
 */
GetVoiceConnectorTerminationHealthResponse::GetVoiceConnectorTerminationHealthResponse(
        const GetVoiceConnectorTerminationHealthRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetVoiceConnectorTerminationHealthResponsePrivate(this), parent)
{
    setRequest(new GetVoiceConnectorTerminationHealthRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetVoiceConnectorTerminationHealthRequest * GetVoiceConnectorTerminationHealthResponse::request() const
{
    Q_D(const GetVoiceConnectorTerminationHealthResponse);
    return static_cast<const GetVoiceConnectorTerminationHealthRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime GetVoiceConnectorTerminationHealth \a response.
 */
void GetVoiceConnectorTerminationHealthResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetVoiceConnectorTerminationHealthResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorTerminationHealthResponsePrivate
 * \brief The GetVoiceConnectorTerminationHealthResponsePrivate class provides private implementation for GetVoiceConnectorTerminationHealthResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorTerminationHealthResponsePrivate object with public implementation \a q.
 */
GetVoiceConnectorTerminationHealthResponsePrivate::GetVoiceConnectorTerminationHealthResponsePrivate(
    GetVoiceConnectorTerminationHealthResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetVoiceConnectorTerminationHealth response element from \a xml.
 */
void GetVoiceConnectorTerminationHealthResponsePrivate::parseGetVoiceConnectorTerminationHealthResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetVoiceConnectorTerminationHealthResponse"));
    Q_UNUSED(xml) ///< @todo
}
