...
#include "createvoiceconnectorgroupresponse_p.h"
...
/*!
 * \class QtAws::Chime::CreateVoiceConnectorGroupResponse
 * \brief The CreateVoiceConnectorGroupResponse class provides an interace for Chime CreateVoiceConnectorGroup responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a CreateVoiceConnectorGroupResponse object for \a reply to \a request, with parent \a parent.
 */
CreateVoiceConnectorGroupResponse::CreateVoiceConnectorGroupResponse(
        const CreateVoiceConnectorGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new CreateVoiceConnectorGroupResponsePrivate(this), parent)
{
    setRequest(new CreateVoiceConnectorGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime CreateVoiceConnectorGroup \a response.
 */
void CreateVoiceConnectorGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateVoiceConnectorGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::CreateVoiceConnectorGroupResponsePrivate
 * \brief The CreateVoiceConnectorGroupResponsePrivate class provides private implementation for CreateVoiceConnectorGroupResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateVoiceConnectorGroupResponsePrivate object with public implementation \a q.
 */
CreateVoiceConnectorGroupResponsePrivate::CreateVoiceConnectorGroupResponsePrivate(
    CreateVoiceConnectorGroupResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateVoiceConnectorGroup response element from \a xml.
 */
void CreateVoiceConnectorGroupResponsePrivate::parseCreateVoiceConnectorGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateVoiceConnectorGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
