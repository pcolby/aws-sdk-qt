...
/*!
 * \class QtAws::Chime::GetMeetingResponse
 * \brief The GetMeetingResponse class provides an interace for Chime GetMeeting responses.
 *
 * \inmodule QtAwsChime
 *
...
GetMeetingResponse::GetMeetingResponse(
    ...
    : ChimeResponse(new GetMeetingResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime GetMeeting \a response.
 */
...
/*!
 * \class QtAws::Chime::GetMeetingResponsePrivate
...
GetMeetingResponsePrivate::GetMeetingResponsePrivate(
    GetMeetingResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetMeeting response element from \a xml.
 */
