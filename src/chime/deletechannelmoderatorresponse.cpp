...
/*!
 * \class QtAws::Chime::DeleteChannelModeratorResponse
 * \brief The DeleteChannelModeratorResponse class provides an interace for Chime DeleteChannelModerator responses.
 *
 * \inmodule QtAwsChime
 *
...
DeleteChannelModeratorResponse::DeleteChannelModeratorResponse(
    ...
    : ChimeResponse(new DeleteChannelModeratorResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DeleteChannelModerator \a response.
 */
...
/*!
 * \class QtAws::Chime::DeleteChannelModeratorResponsePrivate
...
DeleteChannelModeratorResponsePrivate::DeleteChannelModeratorResponsePrivate(
    DeleteChannelModeratorResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteChannelModerator response element from \a xml.
 */
