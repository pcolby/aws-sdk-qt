...
/*!
 * \class QtAws::Chime::ListMediaCapturePipelinesResponse
 * \brief The ListMediaCapturePipelinesResponse class provides an interace for Chime ListMediaCapturePipelines responses.
 *
 * \inmodule QtAwsChime
 *
...
ListMediaCapturePipelinesResponse::ListMediaCapturePipelinesResponse(
    ...
    : ChimeResponse(new ListMediaCapturePipelinesResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime ListMediaCapturePipelines \a response.
 */
...
/*!
 * \class QtAws::Chime::ListMediaCapturePipelinesResponsePrivate
...
ListMediaCapturePipelinesResponsePrivate::ListMediaCapturePipelinesResponsePrivate(
    ListMediaCapturePipelinesResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListMediaCapturePipelines response element from \a xml.
 */
