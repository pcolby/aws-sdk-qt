...
#include "updatesipmediaapplicationresponse_p.h"
...
/*!
 * \class QtAws::Chime::UpdateSipMediaApplicationResponse
 * \brief The UpdateSipMediaApplicationResponse class provides an interace for Chime UpdateSipMediaApplication responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a UpdateSipMediaApplicationResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateSipMediaApplicationResponse::UpdateSipMediaApplicationResponse(
        const UpdateSipMediaApplicationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new UpdateSipMediaApplicationResponsePrivate(this), parent)
{
    setRequest(new UpdateSipMediaApplicationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime UpdateSipMediaApplication \a response.
 */
void UpdateSipMediaApplicationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateSipMediaApplicationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::UpdateSipMediaApplicationResponsePrivate
 * \brief The UpdateSipMediaApplicationResponsePrivate class provides private implementation for UpdateSipMediaApplicationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UpdateSipMediaApplicationResponsePrivate object with public implementation \a q.
 */
UpdateSipMediaApplicationResponsePrivate::UpdateSipMediaApplicationResponsePrivate(
    UpdateSipMediaApplicationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateSipMediaApplication response element from \a xml.
 */
void UpdateSipMediaApplicationResponsePrivate::parseUpdateSipMediaApplicationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateSipMediaApplicationResponse"));
    Q_UNUSED(xml) ///< @todo
}
