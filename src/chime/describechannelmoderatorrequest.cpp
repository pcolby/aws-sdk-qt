...
/*!
 * \class QtAws::Chime::DescribeChannelModeratorRequest
 * \brief The DescribeChannelModeratorRequest class provides an interface for Chime DescribeChannelModerator requests.
 *
 * \inmodule QtAwsChime
 *
...
DescribeChannelModeratorRequest::DescribeChannelModeratorRequest(const DescribeChannelModeratorRequest &other)
    : ChimeRequest(new DescribeChannelModeratorRequestPrivate(*other.d_func(), this))
{
...
DescribeChannelModeratorRequest::DescribeChannelModeratorRequest()
    : ChimeRequest(new DescribeChannelModeratorRequestPrivate(ChimeRequest::DescribeChannelModeratorAction, this))
{
...
/*!
 * \class QtAws::Chime::DescribeChannelModeratorRequestPrivate
...
/*!
 * Constructs a DescribeChannelModeratorRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DescribeChannelModeratorRequestPrivate::DescribeChannelModeratorRequestPrivate(
    const ChimeRequest::Action action, DescribeChannelModeratorRequest * const q)
