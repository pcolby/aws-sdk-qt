...
#include "getvoiceconnectorterminationhealthrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorTerminationHealthRequest
 * \brief The GetVoiceConnectorTerminationHealthRequest class provides an interface for Chime GetVoiceConnectorTerminationHealth requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
GetVoiceConnectorTerminationHealthRequest::GetVoiceConnectorTerminationHealthRequest(const GetVoiceConnectorTerminationHealthRequest &other)
    : ChimeRequest(new GetVoiceConnectorTerminationHealthRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetVoiceConnectorTerminationHealthRequest object.
 */
GetVoiceConnectorTerminationHealthRequest::GetVoiceConnectorTerminationHealthRequest()
    : ChimeRequest(new GetVoiceConnectorTerminationHealthRequestPrivate(ChimeRequest::GetVoiceConnectorTerminationHealthAction, this))
{
 ...
 * \reimp
 */
bool GetVoiceConnectorTerminationHealthRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetVoiceConnectorTerminationHealthResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetVoiceConnectorTerminationHealthRequest::response(QNetworkReply * const reply) const
{
    return new GetVoiceConnectorTerminationHealthResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorTerminationHealthRequestPrivate
 * \brief The GetVoiceConnectorTerminationHealthRequestPrivate class provides private implementation for GetVoiceConnectorTerminationHealthRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorTerminationHealthRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetVoiceConnectorTerminationHealthRequestPrivate::GetVoiceConnectorTerminationHealthRequestPrivate(
    const ChimeRequest::Action action, GetVoiceConnectorTerminationHealthRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetVoiceConnectorTerminationHealthRequest
 * class' copy constructor.
 */
GetVoiceConnectorTerminationHealthRequestPrivate::GetVoiceConnectorTerminationHealthRequestPrivate(
    const GetVoiceConnectorTerminationHealthRequestPrivate &other, GetVoiceConnectorTerminationHealthRequest * const q)
