...
/*!
 * \class QtAws::Chime::DeleteRoomRequest
 * \brief The DeleteRoomRequest class provides an interface for Chime DeleteRoom requests.
 *
 * \inmodule QtAwsChime
 *
...
DeleteRoomRequest::DeleteRoomRequest(const DeleteRoomRequest &other)
    : ChimeRequest(new DeleteRoomRequestPrivate(*other.d_func(), this))
{
...
DeleteRoomRequest::DeleteRoomRequest()
    : ChimeRequest(new DeleteRoomRequestPrivate(ChimeRequest::DeleteRoomAction, this))
{
...
/*!
 * \class QtAws::Chime::DeleteRoomRequestPrivate
...
/*!
 * Constructs a DeleteRoomRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteRoomRequestPrivate::DeleteRoomRequestPrivate(
    const ChimeRequest::Action action, DeleteRoomRequest * const q)
