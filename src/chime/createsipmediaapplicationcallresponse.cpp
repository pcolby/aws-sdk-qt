...
#include "createsipmediaapplicationcallresponse_p.h"
...
/*!
 * \class QtAws::Chime::CreateSipMediaApplicationCallResponse
 * \brief The CreateSipMediaApplicationCallResponse class provides an interace for Chime CreateSipMediaApplicationCall responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a CreateSipMediaApplicationCallResponse object for \a reply to \a request, with parent \a parent.
 */
CreateSipMediaApplicationCallResponse::CreateSipMediaApplicationCallResponse(
        const CreateSipMediaApplicationCallRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new CreateSipMediaApplicationCallResponsePrivate(this), parent)
{
    setRequest(new CreateSipMediaApplicationCallRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime CreateSipMediaApplicationCall \a response.
 */
void CreateSipMediaApplicationCallResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateSipMediaApplicationCallResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::CreateSipMediaApplicationCallResponsePrivate
 * \brief The CreateSipMediaApplicationCallResponsePrivate class provides private implementation for CreateSipMediaApplicationCallResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateSipMediaApplicationCallResponsePrivate object with public implementation \a q.
 */
CreateSipMediaApplicationCallResponsePrivate::CreateSipMediaApplicationCallResponsePrivate(
    CreateSipMediaApplicationCallResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateSipMediaApplicationCall response element from \a xml.
 */
void CreateSipMediaApplicationCallResponsePrivate::parseCreateSipMediaApplicationCallResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateSipMediaApplicationCallResponse"));
    Q_UNUSED(xml) ///< @todo
}
