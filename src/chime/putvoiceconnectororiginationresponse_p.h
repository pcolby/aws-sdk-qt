...
class QTAWS_EXPORT PutVoiceConnectorOriginationResponsePrivate : public ChimeResponsePrivate {

public:

    PutVoiceConnectorOriginationResponsePrivate(PutVoiceConnectorOriginationResponse * const q);
