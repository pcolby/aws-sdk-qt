...
#include "getproxysessionresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetProxySessionResponse
 * \brief The GetProxySessionResponse class provides an interace for Chime GetProxySession responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a GetProxySessionResponse object for \a reply to \a request, with parent \a parent.
 */
GetProxySessionResponse::GetProxySessionResponse(
        const GetProxySessionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetProxySessionResponsePrivate(this), parent)
{
    setRequest(new GetProxySessionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime GetProxySession \a response.
 */
void GetProxySessionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetProxySessionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetProxySessionResponsePrivate
 * \brief The GetProxySessionResponsePrivate class provides private implementation for GetProxySessionResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetProxySessionResponsePrivate object with public implementation \a q.
 */
GetProxySessionResponsePrivate::GetProxySessionResponsePrivate(
    GetProxySessionResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetProxySession response element from \a xml.
 */
void GetProxySessionResponsePrivate::parseGetProxySessionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetProxySessionResponse"));
    Q_UNUSED(xml) ///< @todo
}
