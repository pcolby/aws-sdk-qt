...
#include "getvoiceconnectorproxyrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorProxyRequest
 * \brief The GetVoiceConnectorProxyRequest class provides an interface for Chime GetVoiceConnectorProxy requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getVoiceConnectorProxy
 */

/*!
 * Constructs a copy of \a other.
 */
GetVoiceConnectorProxyRequest::GetVoiceConnectorProxyRequest(const GetVoiceConnectorProxyRequest &other)
    : ChimeRequest(new GetVoiceConnectorProxyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetVoiceConnectorProxyRequest object.
 */
GetVoiceConnectorProxyRequest::GetVoiceConnectorProxyRequest()
    : ChimeRequest(new GetVoiceConnectorProxyRequestPrivate(ChimeRequest::GetVoiceConnectorProxyAction, this))
{
 ...
 * \reimp
 */
bool GetVoiceConnectorProxyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetVoiceConnectorProxyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetVoiceConnectorProxyRequest::response(QNetworkReply * const reply) const
{
    return new GetVoiceConnectorProxyResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorProxyRequestPrivate
 * \brief The GetVoiceConnectorProxyRequestPrivate class provides private implementation for GetVoiceConnectorProxyRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorProxyRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetVoiceConnectorProxyRequestPrivate::GetVoiceConnectorProxyRequestPrivate(
    const ChimeRequest::Action action, GetVoiceConnectorProxyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetVoiceConnectorProxyRequest
 * class' copy constructor.
 */
GetVoiceConnectorProxyRequestPrivate::GetVoiceConnectorProxyRequestPrivate(
    const GetVoiceConnectorProxyRequestPrivate &other, GetVoiceConnectorProxyRequest * const q)
