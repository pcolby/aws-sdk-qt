...
/*!
 * \class QtAws::Chime::StopMeetingTranscriptionResponse
 * \brief The StopMeetingTranscriptionResponse class provides an interace for Chime StopMeetingTranscription responses.
 *
 * \inmodule QtAwsChime
 *
...
StopMeetingTranscriptionResponse::StopMeetingTranscriptionResponse(
    ...
    : ChimeResponse(new StopMeetingTranscriptionResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime StopMeetingTranscription \a response.
 */
...
/*!
 * \class QtAws::Chime::StopMeetingTranscriptionResponsePrivate
...
StopMeetingTranscriptionResponsePrivate::StopMeetingTranscriptionResponsePrivate(
    StopMeetingTranscriptionResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime StopMeetingTranscription response element from \a xml.
 */
