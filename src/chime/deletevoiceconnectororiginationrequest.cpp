...
#include "deletevoiceconnectororiginationrequest_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorOriginationRequest
 * \brief The DeleteVoiceConnectorOriginationRequest class provides an interface for Chime DeleteVoiceConnectorOrigination requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
DeleteVoiceConnectorOriginationRequest::DeleteVoiceConnectorOriginationRequest(const DeleteVoiceConnectorOriginationRequest &other)
    : ChimeRequest(new DeleteVoiceConnectorOriginationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteVoiceConnectorOriginationRequest object.
 */
DeleteVoiceConnectorOriginationRequest::DeleteVoiceConnectorOriginationRequest()
    : ChimeRequest(new DeleteVoiceConnectorOriginationRequestPrivate(ChimeRequest::DeleteVoiceConnectorOriginationAction, this))
{
 ...
 * \reimp
 */
bool DeleteVoiceConnectorOriginationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteVoiceConnectorOriginationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteVoiceConnectorOriginationRequest::response(QNetworkReply * const reply) const
{
    return new DeleteVoiceConnectorOriginationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorOriginationRequestPrivate
 * \brief The DeleteVoiceConnectorOriginationRequestPrivate class provides private implementation for DeleteVoiceConnectorOriginationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorOriginationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteVoiceConnectorOriginationRequestPrivate::DeleteVoiceConnectorOriginationRequestPrivate(
    const ChimeRequest::Action action, DeleteVoiceConnectorOriginationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteVoiceConnectorOriginationRequest
 * class' copy constructor.
 */
DeleteVoiceConnectorOriginationRequestPrivate::DeleteVoiceConnectorOriginationRequestPrivate(
    const DeleteVoiceConnectorOriginationRequestPrivate &other, DeleteVoiceConnectorOriginationRequest * const q)
