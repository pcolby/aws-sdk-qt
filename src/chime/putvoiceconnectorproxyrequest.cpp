...
#include "putvoiceconnectorproxyrequest_p.h"
...
/*!
 * \class QtAws::Chime::PutVoiceConnectorProxyRequest
 * \brief The PutVoiceConnectorProxyRequest class provides an interface for Chime PutVoiceConnectorProxy requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::putVoiceConnectorProxy
 */

/*!
 * Constructs a copy of \a other.
 */
PutVoiceConnectorProxyRequest::PutVoiceConnectorProxyRequest(const PutVoiceConnectorProxyRequest &other)
    : ChimeRequest(new PutVoiceConnectorProxyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutVoiceConnectorProxyRequest object.
 */
PutVoiceConnectorProxyRequest::PutVoiceConnectorProxyRequest()
    : ChimeRequest(new PutVoiceConnectorProxyRequestPrivate(ChimeRequest::PutVoiceConnectorProxyAction, this))
{
 ...
 * \reimp
 */
bool PutVoiceConnectorProxyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutVoiceConnectorProxyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutVoiceConnectorProxyRequest::response(QNetworkReply * const reply) const
{
    return new PutVoiceConnectorProxyResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::PutVoiceConnectorProxyRequestPrivate
 * \brief The PutVoiceConnectorProxyRequestPrivate class provides private implementation for PutVoiceConnectorProxyRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutVoiceConnectorProxyRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
PutVoiceConnectorProxyRequestPrivate::PutVoiceConnectorProxyRequestPrivate(
    const ChimeRequest::Action action, PutVoiceConnectorProxyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutVoiceConnectorProxyRequest
 * class' copy constructor.
 */
PutVoiceConnectorProxyRequestPrivate::PutVoiceConnectorProxyRequestPrivate(
    const PutVoiceConnectorProxyRequestPrivate &other, PutVoiceConnectorProxyRequest * const q)
