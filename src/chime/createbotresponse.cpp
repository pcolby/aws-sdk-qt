...
/*!
 * \class QtAws::Chime::CreateBotResponse
 * \brief The CreateBotResponse class provides an interace for Chime CreateBot responses.
 *
 * \inmodule QtAwsChime
 *
...
CreateBotResponse::CreateBotResponse(
    ...
    : ChimeResponse(new CreateBotResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime CreateBot \a response.
 */
...
/*!
 * \class QtAws::Chime::CreateBotResponsePrivate
...
CreateBotResponsePrivate::CreateBotResponsePrivate(
    CreateBotResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateBot response element from \a xml.
 */
