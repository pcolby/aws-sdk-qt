...
/*!
 * \class QtAws::Chime::GetAttendeeResponse
 * \brief The GetAttendeeResponse class provides an interace for Chime GetAttendee responses.
 *
 * \inmodule QtAwsChime
 *
...
GetAttendeeResponse::GetAttendeeResponse(
    ...
    : ChimeResponse(new GetAttendeeResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime GetAttendee \a response.
 */
...
/*!
 * \class QtAws::Chime::GetAttendeeResponsePrivate
...
GetAttendeeResponsePrivate::GetAttendeeResponsePrivate(
    GetAttendeeResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetAttendee response element from \a xml.
 */
