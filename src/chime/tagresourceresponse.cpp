...
/*!
 * \class QtAws::Chime::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Chime TagResource responses.
 *
 * \inmodule QtAwsChime
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : ChimeResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime TagResource \a response.
 */
...
/*!
 * \class QtAws::Chime::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime TagResource response element from \a xml.
 */
