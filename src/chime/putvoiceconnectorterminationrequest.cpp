...
#include "putvoiceconnectorterminationrequest_p.h"
...
/*!
 * \class QtAws::Chime::PutVoiceConnectorTerminationRequest
 * \brief The PutVoiceConnectorTerminationRequest class provides an interface for Chime PutVoiceConnectorTermination requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
PutVoiceConnectorTerminationRequest::PutVoiceConnectorTerminationRequest(const PutVoiceConnectorTerminationRequest &other)
    : ChimeRequest(new PutVoiceConnectorTerminationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutVoiceConnectorTerminationRequest object.
 */
PutVoiceConnectorTerminationRequest::PutVoiceConnectorTerminationRequest()
    : ChimeRequest(new PutVoiceConnectorTerminationRequestPrivate(ChimeRequest::PutVoiceConnectorTerminationAction, this))
{
 ...
 * \reimp
 */
bool PutVoiceConnectorTerminationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutVoiceConnectorTerminationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutVoiceConnectorTerminationRequest::response(QNetworkReply * const reply) const
{
    return new PutVoiceConnectorTerminationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::PutVoiceConnectorTerminationRequestPrivate
 * \brief The PutVoiceConnectorTerminationRequestPrivate class provides private implementation for PutVoiceConnectorTerminationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutVoiceConnectorTerminationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
PutVoiceConnectorTerminationRequestPrivate::PutVoiceConnectorTerminationRequestPrivate(
    const ChimeRequest::Action action, PutVoiceConnectorTerminationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutVoiceConnectorTerminationRequest
 * class' copy constructor.
 */
PutVoiceConnectorTerminationRequestPrivate::PutVoiceConnectorTerminationRequestPrivate(
    const PutVoiceConnectorTerminationRequestPrivate &other, PutVoiceConnectorTerminationRequest * const q)
