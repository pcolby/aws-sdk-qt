...
/*!
 * \class QtAws::Chime::GetMessagingSessionEndpointRequest
 * \brief The GetMessagingSessionEndpointRequest class provides an interface for Chime GetMessagingSessionEndpoint requests.
 *
 * \inmodule QtAwsChime
 *
...
GetMessagingSessionEndpointRequest::GetMessagingSessionEndpointRequest(const GetMessagingSessionEndpointRequest &other)
    : ChimeRequest(new GetMessagingSessionEndpointRequestPrivate(*other.d_func(), this))
{
...
GetMessagingSessionEndpointRequest::GetMessagingSessionEndpointRequest()
    : ChimeRequest(new GetMessagingSessionEndpointRequestPrivate(ChimeRequest::GetMessagingSessionEndpointAction, this))
{
...
/*!
 * \class QtAws::Chime::GetMessagingSessionEndpointRequestPrivate
...
/*!
 * Constructs a GetMessagingSessionEndpointRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetMessagingSessionEndpointRequestPrivate::GetMessagingSessionEndpointRequestPrivate(
    const ChimeRequest::Action action, GetMessagingSessionEndpointRequest * const q)
