...
#include "listmeetingtagsresponse_p.h"
...
/*!
 * \class QtAws::Chime::ListMeetingTagsResponse
 * \brief The ListMeetingTagsResponse class provides an interace for Chime ListMeetingTags responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listMeetingTags
 */

/*!
 * Constructs a ListMeetingTagsResponse object for \a reply to \a request, with parent \a parent.
 */
ListMeetingTagsResponse::ListMeetingTagsResponse(
        const ListMeetingTagsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new ListMeetingTagsResponsePrivate(this), parent)
{
    setRequest(new ListMeetingTagsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListMeetingTagsRequest * ListMeetingTagsResponse::request() const
{
    Q_D(const ListMeetingTagsResponse);
    return static_cast<const ListMeetingTagsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime ListMeetingTags \a response.
 */
void ListMeetingTagsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListMeetingTagsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::ListMeetingTagsResponsePrivate
 * \brief The ListMeetingTagsResponsePrivate class provides private implementation for ListMeetingTagsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListMeetingTagsResponsePrivate object with public implementation \a q.
 */
ListMeetingTagsResponsePrivate::ListMeetingTagsResponsePrivate(
    ListMeetingTagsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListMeetingTags response element from \a xml.
 */
void ListMeetingTagsResponsePrivate::parseListMeetingTagsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListMeetingTagsResponse"));
    Q_UNUSED(xml) ///< @todo
}
