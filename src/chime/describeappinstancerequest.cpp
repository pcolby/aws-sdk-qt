...
/*!
 * \class QtAws::Chime::DescribeAppInstanceRequest
 * \brief The DescribeAppInstanceRequest class provides an interface for Chime DescribeAppInstance requests.
 *
 * \inmodule QtAwsChime
 *
...
DescribeAppInstanceRequest::DescribeAppInstanceRequest(const DescribeAppInstanceRequest &other)
    : ChimeRequest(new DescribeAppInstanceRequestPrivate(*other.d_func(), this))
{
...
DescribeAppInstanceRequest::DescribeAppInstanceRequest()
    : ChimeRequest(new DescribeAppInstanceRequestPrivate(ChimeRequest::DescribeAppInstanceAction, this))
{
...
/*!
 * \class QtAws::Chime::DescribeAppInstanceRequestPrivate
...
/*!
 * Constructs a DescribeAppInstanceRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DescribeAppInstanceRequestPrivate::DescribeAppInstanceRequestPrivate(
    const ChimeRequest::Action action, DescribeAppInstanceRequest * const q)
