...
class QTAWS_EXPORT DeleteAppInstanceUserResponsePrivate : public ChimeResponsePrivate {

public:

    DeleteAppInstanceUserResponsePrivate(DeleteAppInstanceUserResponse * const q);
