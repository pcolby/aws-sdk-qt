...
/*!
 * \class QtAws::Chime::GetAccountSettingsResponse
 * \brief The GetAccountSettingsResponse class provides an interace for Chime GetAccountSettings responses.
 *
 * \inmodule QtAwsChime
 *
...
GetAccountSettingsResponse::GetAccountSettingsResponse(
    ...
    : ChimeResponse(new GetAccountSettingsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime GetAccountSettings \a response.
 */
...
/*!
 * \class QtAws::Chime::GetAccountSettingsResponsePrivate
...
GetAccountSettingsResponsePrivate::GetAccountSettingsResponsePrivate(
    GetAccountSettingsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetAccountSettings response element from \a xml.
 */
