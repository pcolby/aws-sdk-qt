...
#include "getphonenumberorderrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetPhoneNumberOrderRequest
 * \brief The GetPhoneNumberOrderRequest class provides an interface for Chime GetPhoneNumberOrder requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
GetPhoneNumberOrderRequest::GetPhoneNumberOrderRequest(const GetPhoneNumberOrderRequest &other)
    : ChimeRequest(new GetPhoneNumberOrderRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetPhoneNumberOrderRequest object.
 */
GetPhoneNumberOrderRequest::GetPhoneNumberOrderRequest()
    : ChimeRequest(new GetPhoneNumberOrderRequestPrivate(ChimeRequest::GetPhoneNumberOrderAction, this))
{
 ...
 * \reimp
 */
bool GetPhoneNumberOrderRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetPhoneNumberOrderResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetPhoneNumberOrderRequest::response(QNetworkReply * const reply) const
{
    return new GetPhoneNumberOrderResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetPhoneNumberOrderRequestPrivate
 * \brief The GetPhoneNumberOrderRequestPrivate class provides private implementation for GetPhoneNumberOrderRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetPhoneNumberOrderRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetPhoneNumberOrderRequestPrivate::GetPhoneNumberOrderRequestPrivate(
    const ChimeRequest::Action action, GetPhoneNumberOrderRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetPhoneNumberOrderRequest
 * class' copy constructor.
 */
GetPhoneNumberOrderRequestPrivate::GetPhoneNumberOrderRequestPrivate(
    const GetPhoneNumberOrderRequestPrivate &other, GetPhoneNumberOrderRequest * const q)
