...
/*!
 * \class QtAws::Chime::DeleteAppInstanceAdminResponse
 * \brief The DeleteAppInstanceAdminResponse class provides an interace for Chime DeleteAppInstanceAdmin responses.
 *
 * \inmodule QtAwsChime
 *
...
DeleteAppInstanceAdminResponse::DeleteAppInstanceAdminResponse(
    ...
    : ChimeResponse(new DeleteAppInstanceAdminResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DeleteAppInstanceAdmin \a response.
 */
...
/*!
 * \class QtAws::Chime::DeleteAppInstanceAdminResponsePrivate
...
DeleteAppInstanceAdminResponsePrivate::DeleteAppInstanceAdminResponsePrivate(
    DeleteAppInstanceAdminResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteAppInstanceAdmin response element from \a xml.
 */
