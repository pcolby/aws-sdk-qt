...
#include "putvoiceconnectorloggingconfigurationrequest_p.h"
...
/*!
 * \class QtAws::Chime::PutVoiceConnectorLoggingConfigurationRequest
 * \brief The PutVoiceConnectorLoggingConfigurationRequest class provides an interface for Chime PutVoiceConnectorLoggingConfiguration requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::putVoiceConnectorLoggingConfiguration
 */

/*!
 * Constructs a copy of \a other.
 */
PutVoiceConnectorLoggingConfigurationRequest::PutVoiceConnectorLoggingConfigurationRequest(const PutVoiceConnectorLoggingConfigurationRequest &other)
    : ChimeRequest(new PutVoiceConnectorLoggingConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutVoiceConnectorLoggingConfigurationRequest object.
 */
PutVoiceConnectorLoggingConfigurationRequest::PutVoiceConnectorLoggingConfigurationRequest()
    : ChimeRequest(new PutVoiceConnectorLoggingConfigurationRequestPrivate(ChimeRequest::PutVoiceConnectorLoggingConfigurationAction, this))
{
 ...
 * \reimp
 */
bool PutVoiceConnectorLoggingConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutVoiceConnectorLoggingConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutVoiceConnectorLoggingConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new PutVoiceConnectorLoggingConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::PutVoiceConnectorLoggingConfigurationRequestPrivate
 * \brief The PutVoiceConnectorLoggingConfigurationRequestPrivate class provides private implementation for PutVoiceConnectorLoggingConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutVoiceConnectorLoggingConfigurationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
PutVoiceConnectorLoggingConfigurationRequestPrivate::PutVoiceConnectorLoggingConfigurationRequestPrivate(
    const ChimeRequest::Action action, PutVoiceConnectorLoggingConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutVoiceConnectorLoggingConfigurationRequest
 * class' copy constructor.
 */
PutVoiceConnectorLoggingConfigurationRequestPrivate::PutVoiceConnectorLoggingConfigurationRequestPrivate(
    const PutVoiceConnectorLoggingConfigurationRequestPrivate &other, PutVoiceConnectorLoggingConfigurationRequest * const q)
