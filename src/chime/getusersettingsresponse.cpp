...
/*!
 * \class QtAws::Chime::GetUserSettingsResponse
 * \brief The GetUserSettingsResponse class provides an interace for Chime GetUserSettings responses.
 *
 * \inmodule QtAwsChime
 *
...
GetUserSettingsResponse::GetUserSettingsResponse(
    ...
    : ChimeResponse(new GetUserSettingsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime GetUserSettings \a response.
 */
...
/*!
 * \class QtAws::Chime::GetUserSettingsResponsePrivate
...
GetUserSettingsResponsePrivate::GetUserSettingsResponsePrivate(
    GetUserSettingsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetUserSettings response element from \a xml.
 */
