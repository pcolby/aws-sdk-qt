...
/*!
 * \class QtAws::Chime::SendChannelMessageRequest
 * \brief The SendChannelMessageRequest class provides an interface for Chime SendChannelMessage requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::sendChannelMessage
 */
...
SendChannelMessageRequest::SendChannelMessageRequest(const SendChannelMessageRequest &other)
    : ChimeRequest(new SendChannelMessageRequestPrivate(*other.d_func(), this))
{
...
SendChannelMessageRequest::SendChannelMessageRequest()
    : ChimeRequest(new SendChannelMessageRequestPrivate(ChimeRequest::SendChannelMessageAction, this))
{
...
/*!
 * \class QtAws::Chime::SendChannelMessageRequestPrivate
...
/*!
 * Constructs a SendChannelMessageRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
SendChannelMessageRequestPrivate::SendChannelMessageRequestPrivate(
    const ChimeRequest::Action action, SendChannelMessageRequest * const q)
