...
/*!
 * \class QtAws::Chime::DeleteAppInstanceResponse
 * \brief The DeleteAppInstanceResponse class provides an interace for Chime DeleteAppInstance responses.
 *
 * \inmodule QtAwsChime
 *
...
DeleteAppInstanceResponse::DeleteAppInstanceResponse(
    ...
    : ChimeResponse(new DeleteAppInstanceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DeleteAppInstance \a response.
 */
...
/*!
 * \class QtAws::Chime::DeleteAppInstanceResponsePrivate
...
DeleteAppInstanceResponsePrivate::DeleteAppInstanceResponsePrivate(
    DeleteAppInstanceResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteAppInstance response element from \a xml.
 */
