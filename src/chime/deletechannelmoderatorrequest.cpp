...
/*!
 * \class QtAws::Chime::DeleteChannelModeratorRequest
 * \brief The DeleteChannelModeratorRequest class provides an interface for Chime DeleteChannelModerator requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteChannelModerator
 */
...
DeleteChannelModeratorRequest::DeleteChannelModeratorRequest(const DeleteChannelModeratorRequest &other)
    : ChimeRequest(new DeleteChannelModeratorRequestPrivate(*other.d_func(), this))
{
...
DeleteChannelModeratorRequest::DeleteChannelModeratorRequest()
    : ChimeRequest(new DeleteChannelModeratorRequestPrivate(ChimeRequest::DeleteChannelModeratorAction, this))
{
...
/*!
 * \class QtAws::Chime::DeleteChannelModeratorRequestPrivate
...
/*!
 * Constructs a DeleteChannelModeratorRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteChannelModeratorRequestPrivate::DeleteChannelModeratorRequestPrivate(
    const ChimeRequest::Action action, DeleteChannelModeratorRequest * const q)
