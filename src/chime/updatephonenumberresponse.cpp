...
/*!
 * \class QtAws::Chime::UpdatePhoneNumberResponse
 * \brief The UpdatePhoneNumberResponse class provides an interace for Chime UpdatePhoneNumber responses.
 *
 * \inmodule QtAwsChime
 *
...
UpdatePhoneNumberResponse::UpdatePhoneNumberResponse(
    ...
    : ChimeResponse(new UpdatePhoneNumberResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime UpdatePhoneNumber \a response.
 */
...
/*!
 * \class QtAws::Chime::UpdatePhoneNumberResponsePrivate
...
UpdatePhoneNumberResponsePrivate::UpdatePhoneNumberResponsePrivate(
    UpdatePhoneNumberResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdatePhoneNumber response element from \a xml.
 */
