...
#include "getappinstancestreamingconfigurationsresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetAppInstanceStreamingConfigurationsResponse
 * \brief The GetAppInstanceStreamingConfigurationsResponse class provides an interace for Chime GetAppInstanceStreamingConfigurations responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a GetAppInstanceStreamingConfigurationsResponse object for \a reply to \a request, with parent \a parent.
 */
GetAppInstanceStreamingConfigurationsResponse::GetAppInstanceStreamingConfigurationsResponse(
        const GetAppInstanceStreamingConfigurationsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetAppInstanceStreamingConfigurationsResponsePrivate(this), parent)
{
    setRequest(new GetAppInstanceStreamingConfigurationsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime GetAppInstanceStreamingConfigurations \a response.
 */
void GetAppInstanceStreamingConfigurationsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetAppInstanceStreamingConfigurationsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetAppInstanceStreamingConfigurationsResponsePrivate
 * \brief The GetAppInstanceStreamingConfigurationsResponsePrivate class provides private implementation for GetAppInstanceStreamingConfigurationsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetAppInstanceStreamingConfigurationsResponsePrivate object with public implementation \a q.
 */
GetAppInstanceStreamingConfigurationsResponsePrivate::GetAppInstanceStreamingConfigurationsResponsePrivate(
    GetAppInstanceStreamingConfigurationsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetAppInstanceStreamingConfigurations response element from \a xml.
 */
void GetAppInstanceStreamingConfigurationsResponsePrivate::parseGetAppInstanceStreamingConfigurationsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetAppInstanceStreamingConfigurationsResponse"));
    Q_UNUSED(xml) ///< @todo
}
