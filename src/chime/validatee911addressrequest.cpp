...
#include "validatee911addressrequest_p.h"
...
/*!
 * \class QtAws::Chime::ValidateE911AddressRequest
 * \brief The ValidateE911AddressRequest class provides an interface for Chime ValidateE911Address requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
ValidateE911AddressRequest::ValidateE911AddressRequest(const ValidateE911AddressRequest &other)
    : ChimeRequest(new ValidateE911AddressRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ValidateE911AddressRequest object.
 */
ValidateE911AddressRequest::ValidateE911AddressRequest()
    : ChimeRequest(new ValidateE911AddressRequestPrivate(ChimeRequest::ValidateE911AddressAction, this))
{
 ...
 * \reimp
 */
bool ValidateE911AddressRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ValidateE911AddressResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ValidateE911AddressRequest::response(QNetworkReply * const reply) const
{
    return new ValidateE911AddressResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::ValidateE911AddressRequestPrivate
 * \brief The ValidateE911AddressRequestPrivate class provides private implementation for ValidateE911AddressRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ValidateE911AddressRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ValidateE911AddressRequestPrivate::ValidateE911AddressRequestPrivate(
    const ChimeRequest::Action action, ValidateE911AddressRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ValidateE911AddressRequest
 * class' copy constructor.
 */
ValidateE911AddressRequestPrivate::ValidateE911AddressRequestPrivate(
    const ValidateE911AddressRequestPrivate &other, ValidateE911AddressRequest * const q)
