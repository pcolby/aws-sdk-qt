...
#include "listattendeetagsrequest_p.h"
...
/*!
 * \class QtAws::Chime::ListAttendeeTagsRequest
 * \brief The ListAttendeeTagsRequest class provides an interface for Chime ListAttendeeTags requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listAttendeeTags
 */

/*!
 * Constructs a copy of \a other.
 */
ListAttendeeTagsRequest::ListAttendeeTagsRequest(const ListAttendeeTagsRequest &other)
    : ChimeRequest(new ListAttendeeTagsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListAttendeeTagsRequest object.
 */
ListAttendeeTagsRequest::ListAttendeeTagsRequest()
    : ChimeRequest(new ListAttendeeTagsRequestPrivate(ChimeRequest::ListAttendeeTagsAction, this))
{
 ...
 * \reimp
 */
bool ListAttendeeTagsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListAttendeeTagsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListAttendeeTagsRequest::response(QNetworkReply * const reply) const
{
    return new ListAttendeeTagsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::ListAttendeeTagsRequestPrivate
 * \brief The ListAttendeeTagsRequestPrivate class provides private implementation for ListAttendeeTagsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListAttendeeTagsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListAttendeeTagsRequestPrivate::ListAttendeeTagsRequestPrivate(
    const ChimeRequest::Action action, ListAttendeeTagsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListAttendeeTagsRequest
 * class' copy constructor.
 */
ListAttendeeTagsRequestPrivate::ListAttendeeTagsRequestPrivate(
    const ListAttendeeTagsRequestPrivate &other, ListAttendeeTagsRequest * const q)
