...
/*!
 * \class QtAws::Chime::ListBotsResponse
 * \brief The ListBotsResponse class provides an interace for Chime ListBots responses.
 *
 * \inmodule QtAwsChime
 *
...
ListBotsResponse::ListBotsResponse(
    ...
    : ChimeResponse(new ListBotsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime ListBots \a response.
 */
...
/*!
 * \class QtAws::Chime::ListBotsResponsePrivate
...
ListBotsResponsePrivate::ListBotsResponsePrivate(
    ListBotsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListBots response element from \a xml.
 */
