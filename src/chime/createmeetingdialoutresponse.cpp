...
#include "createmeetingdialoutresponse_p.h"
...
/*!
 * \class QtAws::Chime::CreateMeetingDialOutResponse
 * \brief The CreateMeetingDialOutResponse class provides an interace for Chime CreateMeetingDialOut responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a CreateMeetingDialOutResponse object for \a reply to \a request, with parent \a parent.
 */
CreateMeetingDialOutResponse::CreateMeetingDialOutResponse(
        const CreateMeetingDialOutRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new CreateMeetingDialOutResponsePrivate(this), parent)
{
    setRequest(new CreateMeetingDialOutRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime CreateMeetingDialOut \a response.
 */
void CreateMeetingDialOutResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateMeetingDialOutResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::CreateMeetingDialOutResponsePrivate
 * \brief The CreateMeetingDialOutResponsePrivate class provides private implementation for CreateMeetingDialOutResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateMeetingDialOutResponsePrivate object with public implementation \a q.
 */
CreateMeetingDialOutResponsePrivate::CreateMeetingDialOutResponsePrivate(
    CreateMeetingDialOutResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateMeetingDialOut response element from \a xml.
 */
void CreateMeetingDialOutResponsePrivate::parseCreateMeetingDialOutResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateMeetingDialOutResponse"));
    Q_UNUSED(xml) ///< @todo
}
