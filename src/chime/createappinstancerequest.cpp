...
/*!
 * \class QtAws::Chime::CreateAppInstanceRequest
 * \brief The CreateAppInstanceRequest class provides an interface for Chime CreateAppInstance requests.
 *
 * \inmodule QtAwsChime
 *
...
CreateAppInstanceRequest::CreateAppInstanceRequest(const CreateAppInstanceRequest &other)
    : ChimeRequest(new CreateAppInstanceRequestPrivate(*other.d_func(), this))
{
...
CreateAppInstanceRequest::CreateAppInstanceRequest()
    : ChimeRequest(new CreateAppInstanceRequestPrivate(ChimeRequest::CreateAppInstanceAction, this))
{
...
/*!
 * \class QtAws::Chime::CreateAppInstanceRequestPrivate
...
/*!
 * Constructs a CreateAppInstanceRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateAppInstanceRequestPrivate::CreateAppInstanceRequestPrivate(
    const ChimeRequest::Action action, CreateAppInstanceRequest * const q)
