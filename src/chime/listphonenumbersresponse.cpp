...
/*!
 * \class QtAws::Chime::ListPhoneNumbersResponse
 * \brief The ListPhoneNumbersResponse class provides an interace for Chime ListPhoneNumbers responses.
 *
 * \inmodule QtAwsChime
 *
...
ListPhoneNumbersResponse::ListPhoneNumbersResponse(
    ...
    : ChimeResponse(new ListPhoneNumbersResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime ListPhoneNumbers \a response.
 */
...
/*!
 * \class QtAws::Chime::ListPhoneNumbersResponsePrivate
...
ListPhoneNumbersResponsePrivate::ListPhoneNumbersResponsePrivate(
    ListPhoneNumbersResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListPhoneNumbers response element from \a xml.
 */
