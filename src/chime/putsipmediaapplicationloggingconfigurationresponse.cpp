...
#include "putsipmediaapplicationloggingconfigurationresponse_p.h"
...
/*!
 * \class QtAws::Chime::PutSipMediaApplicationLoggingConfigurationResponse
 * \brief The PutSipMediaApplicationLoggingConfigurationResponse class provides an interace for Chime PutSipMediaApplicationLoggingConfiguration responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a PutSipMediaApplicationLoggingConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
PutSipMediaApplicationLoggingConfigurationResponse::PutSipMediaApplicationLoggingConfigurationResponse(
        const PutSipMediaApplicationLoggingConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new PutSipMediaApplicationLoggingConfigurationResponsePrivate(this), parent)
{
    setRequest(new PutSipMediaApplicationLoggingConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime PutSipMediaApplicationLoggingConfiguration \a response.
 */
void PutSipMediaApplicationLoggingConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutSipMediaApplicationLoggingConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::PutSipMediaApplicationLoggingConfigurationResponsePrivate
 * \brief The PutSipMediaApplicationLoggingConfigurationResponsePrivate class provides private implementation for PutSipMediaApplicationLoggingConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutSipMediaApplicationLoggingConfigurationResponsePrivate object with public implementation \a q.
 */
PutSipMediaApplicationLoggingConfigurationResponsePrivate::PutSipMediaApplicationLoggingConfigurationResponsePrivate(
    PutSipMediaApplicationLoggingConfigurationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime PutSipMediaApplicationLoggingConfiguration response element from \a xml.
 */
void PutSipMediaApplicationLoggingConfigurationResponsePrivate::parsePutSipMediaApplicationLoggingConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutSipMediaApplicationLoggingConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
