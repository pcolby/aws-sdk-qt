...
#include "deleteroommembershiprequest_p.h"
...
/*!
 * \class QtAws::Chime::DeleteRoomMembershipRequest
 * \brief The DeleteRoomMembershipRequest class provides an interface for Chime DeleteRoomMembership requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
DeleteRoomMembershipRequest::DeleteRoomMembershipRequest(const DeleteRoomMembershipRequest &other)
    : ChimeRequest(new DeleteRoomMembershipRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteRoomMembershipRequest object.
 */
DeleteRoomMembershipRequest::DeleteRoomMembershipRequest()
    : ChimeRequest(new DeleteRoomMembershipRequestPrivate(ChimeRequest::DeleteRoomMembershipAction, this))
{
 ...
 * \reimp
 */
bool DeleteRoomMembershipRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteRoomMembershipResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteRoomMembershipRequest::response(QNetworkReply * const reply) const
{
    return new DeleteRoomMembershipResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeleteRoomMembershipRequestPrivate
 * \brief The DeleteRoomMembershipRequestPrivate class provides private implementation for DeleteRoomMembershipRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteRoomMembershipRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteRoomMembershipRequestPrivate::DeleteRoomMembershipRequestPrivate(
    const ChimeRequest::Action action, DeleteRoomMembershipRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteRoomMembershipRequest
 * class' copy constructor.
 */
DeleteRoomMembershipRequestPrivate::DeleteRoomMembershipRequestPrivate(
    const DeleteRoomMembershipRequestPrivate &other, DeleteRoomMembershipRequest * const q)
