...
/*!
 * \class QtAws::Chime::DeleteRoomResponse
 * \brief The DeleteRoomResponse class provides an interace for Chime DeleteRoom responses.
 *
 * \inmodule QtAwsChime
 *
...
DeleteRoomResponse::DeleteRoomResponse(
    ...
    : ChimeResponse(new DeleteRoomResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DeleteRoom \a response.
 */
...
/*!
 * \class QtAws::Chime::DeleteRoomResponsePrivate
...
DeleteRoomResponsePrivate::DeleteRoomResponsePrivate(
    DeleteRoomResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteRoom response element from \a xml.
 */
