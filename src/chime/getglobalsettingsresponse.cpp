...
#include "getglobalsettingsresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetGlobalSettingsResponse
 * \brief The GetGlobalSettingsResponse class provides an interace for Chime GetGlobalSettings responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getGlobalSettings
 */

/*!
 * Constructs a GetGlobalSettingsResponse object for \a reply to \a request, with parent \a parent.
 */
GetGlobalSettingsResponse::GetGlobalSettingsResponse(
        const GetGlobalSettingsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetGlobalSettingsResponsePrivate(this), parent)
{
    setRequest(new GetGlobalSettingsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetGlobalSettingsRequest * GetGlobalSettingsResponse::request() const
{
    Q_D(const GetGlobalSettingsResponse);
    return static_cast<const GetGlobalSettingsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime GetGlobalSettings \a response.
 */
void GetGlobalSettingsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetGlobalSettingsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetGlobalSettingsResponsePrivate
 * \brief The GetGlobalSettingsResponsePrivate class provides private implementation for GetGlobalSettingsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetGlobalSettingsResponsePrivate object with public implementation \a q.
 */
GetGlobalSettingsResponsePrivate::GetGlobalSettingsResponsePrivate(
    GetGlobalSettingsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetGlobalSettings response element from \a xml.
 */
void GetGlobalSettingsResponsePrivate::parseGetGlobalSettingsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetGlobalSettingsResponse"));
    Q_UNUSED(xml) ///< @todo
}
