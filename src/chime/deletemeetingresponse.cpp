...
/*!
 * \class QtAws::Chime::DeleteMeetingResponse
 * \brief The DeleteMeetingResponse class provides an interace for Chime DeleteMeeting responses.
 *
 * \inmodule QtAwsChime
 *
...
DeleteMeetingResponse::DeleteMeetingResponse(
    ...
    : ChimeResponse(new DeleteMeetingResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DeleteMeeting \a response.
 */
...
/*!
 * \class QtAws::Chime::DeleteMeetingResponsePrivate
...
DeleteMeetingResponsePrivate::DeleteMeetingResponsePrivate(
    DeleteMeetingResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteMeeting response element from \a xml.
 */
