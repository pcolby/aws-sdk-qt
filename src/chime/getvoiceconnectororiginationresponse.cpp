...
#include "getvoiceconnectororiginationresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorOriginationResponse
 * \brief The GetVoiceConnectorOriginationResponse class provides an interace for Chime GetVoiceConnectorOrigination responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getVoiceConnectorOrigination
 */

/*!
 * Constructs a GetVoiceConnectorOriginationResponse object for \a reply to \a request, with parent \a parent.
 */
GetVoiceConnectorOriginationResponse::GetVoiceConnectorOriginationResponse(
        const GetVoiceConnectorOriginationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetVoiceConnectorOriginationResponsePrivate(this), parent)
{
    setRequest(new GetVoiceConnectorOriginationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetVoiceConnectorOriginationRequest * GetVoiceConnectorOriginationResponse::request() const
{
    Q_D(const GetVoiceConnectorOriginationResponse);
    return static_cast<const GetVoiceConnectorOriginationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime GetVoiceConnectorOrigination \a response.
 */
void GetVoiceConnectorOriginationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetVoiceConnectorOriginationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorOriginationResponsePrivate
 * \brief The GetVoiceConnectorOriginationResponsePrivate class provides private implementation for GetVoiceConnectorOriginationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorOriginationResponsePrivate object with public implementation \a q.
 */
GetVoiceConnectorOriginationResponsePrivate::GetVoiceConnectorOriginationResponsePrivate(
    GetVoiceConnectorOriginationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetVoiceConnectorOrigination response element from \a xml.
 */
void GetVoiceConnectorOriginationResponsePrivate::parseGetVoiceConnectorOriginationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetVoiceConnectorOriginationResponse"));
    Q_UNUSED(xml) ///< @todo
}
