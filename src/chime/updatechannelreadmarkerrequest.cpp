...
/*!
 * \class QtAws::Chime::UpdateChannelReadMarkerRequest
 * \brief The UpdateChannelReadMarkerRequest class provides an interface for Chime UpdateChannelReadMarker requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::updateChannelReadMarker
 */
...
UpdateChannelReadMarkerRequest::UpdateChannelReadMarkerRequest(const UpdateChannelReadMarkerRequest &other)
    : ChimeRequest(new UpdateChannelReadMarkerRequestPrivate(*other.d_func(), this))
{
...
UpdateChannelReadMarkerRequest::UpdateChannelReadMarkerRequest()
    : ChimeRequest(new UpdateChannelReadMarkerRequestPrivate(ChimeRequest::UpdateChannelReadMarkerAction, this))
{
...
/*!
 * \class QtAws::Chime::UpdateChannelReadMarkerRequestPrivate
...
/*!
 * Constructs a UpdateChannelReadMarkerRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateChannelReadMarkerRequestPrivate::UpdateChannelReadMarkerRequestPrivate(
    const ChimeRequest::Action action, UpdateChannelReadMarkerRequest * const q)
