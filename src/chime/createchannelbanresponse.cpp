...
/*!
 * \class QtAws::Chime::CreateChannelBanResponse
 * \brief The CreateChannelBanResponse class provides an interace for Chime CreateChannelBan responses.
 *
 * \inmodule QtAwsChime
 *
...
CreateChannelBanResponse::CreateChannelBanResponse(
    ...
    : ChimeResponse(new CreateChannelBanResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime CreateChannelBan \a response.
 */
...
/*!
 * \class QtAws::Chime::CreateChannelBanResponsePrivate
...
CreateChannelBanResponsePrivate::CreateChannelBanResponsePrivate(
    CreateChannelBanResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateChannelBan response element from \a xml.
 */
