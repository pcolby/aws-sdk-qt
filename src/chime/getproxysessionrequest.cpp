...
#include "getproxysessionrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetProxySessionRequest
 * \brief The GetProxySessionRequest class provides an interface for Chime GetProxySession requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getProxySession
 */

/*!
 * Constructs a copy of \a other.
 */
GetProxySessionRequest::GetProxySessionRequest(const GetProxySessionRequest &other)
    : ChimeRequest(new GetProxySessionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetProxySessionRequest object.
 */
GetProxySessionRequest::GetProxySessionRequest()
    : ChimeRequest(new GetProxySessionRequestPrivate(ChimeRequest::GetProxySessionAction, this))
{
 ...
 * \reimp
 */
bool GetProxySessionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetProxySessionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetProxySessionRequest::response(QNetworkReply * const reply) const
{
    return new GetProxySessionResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetProxySessionRequestPrivate
 * \brief The GetProxySessionRequestPrivate class provides private implementation for GetProxySessionRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetProxySessionRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetProxySessionRequestPrivate::GetProxySessionRequestPrivate(
    const ChimeRequest::Action action, GetProxySessionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetProxySessionRequest
 * class' copy constructor.
 */
GetProxySessionRequestPrivate::GetProxySessionRequestPrivate(
    const GetProxySessionRequestPrivate &other, GetProxySessionRequest * const q)
