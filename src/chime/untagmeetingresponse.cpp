...
#include "untagmeetingresponse_p.h"
...
/*!
 * \class QtAws::Chime::UntagMeetingResponse
 * \brief The UntagMeetingResponse class provides an interace for Chime UntagMeeting responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a UntagMeetingResponse object for \a reply to \a request, with parent \a parent.
 */
UntagMeetingResponse::UntagMeetingResponse(
        const UntagMeetingRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new UntagMeetingResponsePrivate(this), parent)
{
    setRequest(new UntagMeetingRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime UntagMeeting \a response.
 */
void UntagMeetingResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UntagMeetingResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::UntagMeetingResponsePrivate
 * \brief The UntagMeetingResponsePrivate class provides private implementation for UntagMeetingResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UntagMeetingResponsePrivate object with public implementation \a q.
 */
UntagMeetingResponsePrivate::UntagMeetingResponsePrivate(
    UntagMeetingResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UntagMeeting response element from \a xml.
 */
void UntagMeetingResponsePrivate::parseUntagMeetingResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UntagMeetingResponse"));
    Q_UNUSED(xml) ///< @todo
}
