...
class QTAWS_EXPORT DescribeChannelModeratorResponsePrivate : public ChimeResponsePrivate {

public:

    DescribeChannelModeratorResponsePrivate(DescribeChannelModeratorResponse * const q);
