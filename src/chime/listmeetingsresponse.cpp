...
#include "listmeetingsresponse_p.h"
...
/*!
 * \class QtAws::Chime::ListMeetingsResponse
 * \brief The ListMeetingsResponse class provides an interace for Chime ListMeetings responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a ListMeetingsResponse object for \a reply to \a request, with parent \a parent.
 */
ListMeetingsResponse::ListMeetingsResponse(
        const ListMeetingsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new ListMeetingsResponsePrivate(this), parent)
{
    setRequest(new ListMeetingsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime ListMeetings \a response.
 */
void ListMeetingsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListMeetingsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::ListMeetingsResponsePrivate
 * \brief The ListMeetingsResponsePrivate class provides private implementation for ListMeetingsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListMeetingsResponsePrivate object with public implementation \a q.
 */
ListMeetingsResponsePrivate::ListMeetingsResponsePrivate(
    ListMeetingsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListMeetings response element from \a xml.
 */
void ListMeetingsResponsePrivate::parseListMeetingsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListMeetingsResponse"));
    Q_UNUSED(xml) ///< @todo
}
