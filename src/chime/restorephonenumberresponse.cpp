...
#include "restorephonenumberresponse_p.h"
...
/*!
 * \class QtAws::Chime::RestorePhoneNumberResponse
 * \brief The RestorePhoneNumberResponse class provides an interace for Chime RestorePhoneNumber responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a RestorePhoneNumberResponse object for \a reply to \a request, with parent \a parent.
 */
RestorePhoneNumberResponse::RestorePhoneNumberResponse(
        const RestorePhoneNumberRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new RestorePhoneNumberResponsePrivate(this), parent)
{
    setRequest(new RestorePhoneNumberRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime RestorePhoneNumber \a response.
 */
void RestorePhoneNumberResponse::parseSuccess(QIODevice &response)
{
    //Q_D(RestorePhoneNumberResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::RestorePhoneNumberResponsePrivate
 * \brief The RestorePhoneNumberResponsePrivate class provides private implementation for RestorePhoneNumberResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a RestorePhoneNumberResponsePrivate object with public implementation \a q.
 */
RestorePhoneNumberResponsePrivate::RestorePhoneNumberResponsePrivate(
    RestorePhoneNumberResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime RestorePhoneNumber response element from \a xml.
 */
void RestorePhoneNumberResponsePrivate::parseRestorePhoneNumberResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("RestorePhoneNumberResponse"));
    Q_UNUSED(xml) ///< @todo
}
