...
/*!
 * \class QtAws::Chime::UpdatePhoneNumberRequest
 * \brief The UpdatePhoneNumberRequest class provides an interface for Chime UpdatePhoneNumber requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::updatePhoneNumber
 */
...
UpdatePhoneNumberRequest::UpdatePhoneNumberRequest(const UpdatePhoneNumberRequest &other)
    : ChimeRequest(new UpdatePhoneNumberRequestPrivate(*other.d_func(), this))
{
...
UpdatePhoneNumberRequest::UpdatePhoneNumberRequest()
    : ChimeRequest(new UpdatePhoneNumberRequestPrivate(ChimeRequest::UpdatePhoneNumberAction, this))
{
...
/*!
 * \class QtAws::Chime::UpdatePhoneNumberRequestPrivate
...
/*!
 * Constructs a UpdatePhoneNumberRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdatePhoneNumberRequestPrivate::UpdatePhoneNumberRequestPrivate(
    const ChimeRequest::Action action, UpdatePhoneNumberRequest * const q)
