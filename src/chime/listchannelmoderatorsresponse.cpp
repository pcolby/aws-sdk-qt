...
/*!
 * \class QtAws::Chime::ListChannelModeratorsResponse
 * \brief The ListChannelModeratorsResponse class provides an interace for Chime ListChannelModerators responses.
 *
 * \inmodule QtAwsChime
 *
...
ListChannelModeratorsResponse::ListChannelModeratorsResponse(
    ...
    : ChimeResponse(new ListChannelModeratorsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime ListChannelModerators \a response.
 */
...
/*!
 * \class QtAws::Chime::ListChannelModeratorsResponsePrivate
...
ListChannelModeratorsResponsePrivate::ListChannelModeratorsResponsePrivate(
    ListChannelModeratorsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListChannelModerators response element from \a xml.
 */
