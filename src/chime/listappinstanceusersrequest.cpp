...
/*!
 * \class QtAws::Chime::ListAppInstanceUsersRequest
 * \brief The ListAppInstanceUsersRequest class provides an interface for Chime ListAppInstanceUsers requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listAppInstanceUsers
 */
...
ListAppInstanceUsersRequest::ListAppInstanceUsersRequest(const ListAppInstanceUsersRequest &other)
    : ChimeRequest(new ListAppInstanceUsersRequestPrivate(*other.d_func(), this))
{
...
ListAppInstanceUsersRequest::ListAppInstanceUsersRequest()
    : ChimeRequest(new ListAppInstanceUsersRequestPrivate(ChimeRequest::ListAppInstanceUsersAction, this))
{
...
/*!
 * \class QtAws::Chime::ListAppInstanceUsersRequestPrivate
...
/*!
 * Constructs a ListAppInstanceUsersRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListAppInstanceUsersRequestPrivate::ListAppInstanceUsersRequestPrivate(
    const ChimeRequest::Action action, ListAppInstanceUsersRequest * const q)
