...
#include "createproxysessionrequest_p.h"
...
/*!
 * \class QtAws::Chime::CreateProxySessionRequest
 * \brief The CreateProxySessionRequest class provides an interface for Chime CreateProxySession requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createProxySession
 */

/*!
 * Constructs a copy of \a other.
 */
CreateProxySessionRequest::CreateProxySessionRequest(const CreateProxySessionRequest &other)
    : ChimeRequest(new CreateProxySessionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateProxySessionRequest object.
 */
CreateProxySessionRequest::CreateProxySessionRequest()
    : ChimeRequest(new CreateProxySessionRequestPrivate(ChimeRequest::CreateProxySessionAction, this))
{
 ...
 * \reimp
 */
bool CreateProxySessionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateProxySessionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateProxySessionRequest::response(QNetworkReply * const reply) const
{
    return new CreateProxySessionResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::CreateProxySessionRequestPrivate
 * \brief The CreateProxySessionRequestPrivate class provides private implementation for CreateProxySessionRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateProxySessionRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateProxySessionRequestPrivate::CreateProxySessionRequestPrivate(
    const ChimeRequest::Action action, CreateProxySessionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateProxySessionRequest
 * class' copy constructor.
 */
CreateProxySessionRequestPrivate::CreateProxySessionRequestPrivate(
    const CreateProxySessionRequestPrivate &other, CreateProxySessionRequest * const q)
