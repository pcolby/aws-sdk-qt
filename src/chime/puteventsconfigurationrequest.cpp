...
#include "puteventsconfigurationrequest_p.h"
...
/*!
 * \class QtAws::Chime::PutEventsConfigurationRequest
 * \brief The PutEventsConfigurationRequest class provides an interface for Chime PutEventsConfiguration requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::putEventsConfiguration
 */

/*!
 * Constructs a copy of \a other.
 */
PutEventsConfigurationRequest::PutEventsConfigurationRequest(const PutEventsConfigurationRequest &other)
    : ChimeRequest(new PutEventsConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutEventsConfigurationRequest object.
 */
PutEventsConfigurationRequest::PutEventsConfigurationRequest()
    : ChimeRequest(new PutEventsConfigurationRequestPrivate(ChimeRequest::PutEventsConfigurationAction, this))
{
 ...
 * \reimp
 */
bool PutEventsConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutEventsConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutEventsConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new PutEventsConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::PutEventsConfigurationRequestPrivate
 * \brief The PutEventsConfigurationRequestPrivate class provides private implementation for PutEventsConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutEventsConfigurationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
PutEventsConfigurationRequestPrivate::PutEventsConfigurationRequestPrivate(
    const ChimeRequest::Action action, PutEventsConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutEventsConfigurationRequest
 * class' copy constructor.
 */
PutEventsConfigurationRequestPrivate::PutEventsConfigurationRequestPrivate(
    const PutEventsConfigurationRequestPrivate &other, PutEventsConfigurationRequest * const q)
