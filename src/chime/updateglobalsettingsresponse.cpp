...
/*!
 * \class QtAws::Chime::UpdateGlobalSettingsResponse
 * \brief The UpdateGlobalSettingsResponse class provides an interace for Chime UpdateGlobalSettings responses.
 *
 * \inmodule QtAwsChime
 *
...
UpdateGlobalSettingsResponse::UpdateGlobalSettingsResponse(
    ...
    : ChimeResponse(new UpdateGlobalSettingsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime UpdateGlobalSettings \a response.
 */
...
/*!
 * \class QtAws::Chime::UpdateGlobalSettingsResponsePrivate
...
UpdateGlobalSettingsResponsePrivate::UpdateGlobalSettingsResponsePrivate(
    UpdateGlobalSettingsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateGlobalSettings response element from \a xml.
 */
