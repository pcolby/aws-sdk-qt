...
/*!
 * \class QtAws::Chime::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for Chime TagResource requests.
 *
 * \inmodule QtAwsChime
 *
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : ChimeRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : ChimeRequest(new TagResourceRequestPrivate(ChimeRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::Chime::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const ChimeRequest::Action action, TagResourceRequest * const q)
