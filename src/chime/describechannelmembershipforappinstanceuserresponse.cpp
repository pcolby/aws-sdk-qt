...
/*!
 * \class QtAws::Chime::DescribeChannelMembershipForAppInstanceUserResponse
 * \brief The DescribeChannelMembershipForAppInstanceUserResponse class provides an interace for Chime DescribeChannelMembershipForAppInstanceUser responses.
 *
 * \inmodule QtAwsChime
 *
...
DescribeChannelMembershipForAppInstanceUserResponse::DescribeChannelMembershipForAppInstanceUserResponse(
    ...
    : ChimeResponse(new DescribeChannelMembershipForAppInstanceUserResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DescribeChannelMembershipForAppInstanceUser \a response.
 */
...
/*!
 * \class QtAws::Chime::DescribeChannelMembershipForAppInstanceUserResponsePrivate
...
DescribeChannelMembershipForAppInstanceUserResponsePrivate::DescribeChannelMembershipForAppInstanceUserResponsePrivate(
    DescribeChannelMembershipForAppInstanceUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DescribeChannelMembershipForAppInstanceUser response element from \a xml.
 */
