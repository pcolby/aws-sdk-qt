...
/*!
 * \class QtAws::Chime::GetRoomRequest
 * \brief The GetRoomRequest class provides an interface for Chime GetRoom requests.
 *
 * \inmodule QtAwsChime
 *
...
GetRoomRequest::GetRoomRequest(const GetRoomRequest &other)
    : ChimeRequest(new GetRoomRequestPrivate(*other.d_func(), this))
{
...
GetRoomRequest::GetRoomRequest()
    : ChimeRequest(new GetRoomRequestPrivate(ChimeRequest::GetRoomAction, this))
{
...
/*!
 * \class QtAws::Chime::GetRoomRequestPrivate
...
/*!
 * Constructs a GetRoomRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetRoomRequestPrivate::GetRoomRequestPrivate(
    const ChimeRequest::Action action, GetRoomRequest * const q)
