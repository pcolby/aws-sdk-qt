...
#include "deleteappinstancestreamingconfigurationsrequest_p.h"
...
/*!
 * \class QtAws::Chime::DeleteAppInstanceStreamingConfigurationsRequest
 * \brief The DeleteAppInstanceStreamingConfigurationsRequest class provides an interface for Chime DeleteAppInstanceStreamingConfigurations requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteAppInstanceStreamingConfigurations
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteAppInstanceStreamingConfigurationsRequest::DeleteAppInstanceStreamingConfigurationsRequest(const DeleteAppInstanceStreamingConfigurationsRequest &other)
    : ChimeRequest(new DeleteAppInstanceStreamingConfigurationsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteAppInstanceStreamingConfigurationsRequest object.
 */
DeleteAppInstanceStreamingConfigurationsRequest::DeleteAppInstanceStreamingConfigurationsRequest()
    : ChimeRequest(new DeleteAppInstanceStreamingConfigurationsRequestPrivate(ChimeRequest::DeleteAppInstanceStreamingConfigurationsAction, this))
{
 ...
 * \reimp
 */
bool DeleteAppInstanceStreamingConfigurationsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteAppInstanceStreamingConfigurationsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteAppInstanceStreamingConfigurationsRequest::response(QNetworkReply * const reply) const
{
    return new DeleteAppInstanceStreamingConfigurationsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeleteAppInstanceStreamingConfigurationsRequestPrivate
 * \brief The DeleteAppInstanceStreamingConfigurationsRequestPrivate class provides private implementation for DeleteAppInstanceStreamingConfigurationsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteAppInstanceStreamingConfigurationsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteAppInstanceStreamingConfigurationsRequestPrivate::DeleteAppInstanceStreamingConfigurationsRequestPrivate(
    const ChimeRequest::Action action, DeleteAppInstanceStreamingConfigurationsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteAppInstanceStreamingConfigurationsRequest
 * class' copy constructor.
 */
DeleteAppInstanceStreamingConfigurationsRequestPrivate::DeleteAppInstanceStreamingConfigurationsRequestPrivate(
    const DeleteAppInstanceStreamingConfigurationsRequestPrivate &other, DeleteAppInstanceStreamingConfigurationsRequest * const q)
