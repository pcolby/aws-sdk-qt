...
class QTAWS_EXPORT ListChannelModeratorsResponsePrivate : public ChimeResponsePrivate {

public:

    ListChannelModeratorsResponsePrivate(ListChannelModeratorsResponse * const q);
