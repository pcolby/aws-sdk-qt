...
/*!
 * \class QtAws::Chime::StartMeetingTranscriptionRequest
 * \brief The StartMeetingTranscriptionRequest class provides an interface for Chime StartMeetingTranscription requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::startMeetingTranscription
 */
...
StartMeetingTranscriptionRequest::StartMeetingTranscriptionRequest(const StartMeetingTranscriptionRequest &other)
    : ChimeRequest(new StartMeetingTranscriptionRequestPrivate(*other.d_func(), this))
{
...
StartMeetingTranscriptionRequest::StartMeetingTranscriptionRequest()
    : ChimeRequest(new StartMeetingTranscriptionRequestPrivate(ChimeRequest::StartMeetingTranscriptionAction, this))
{
...
/*!
 * \class QtAws::Chime::StartMeetingTranscriptionRequestPrivate
...
/*!
 * Constructs a StartMeetingTranscriptionRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
StartMeetingTranscriptionRequestPrivate::StartMeetingTranscriptionRequestPrivate(
    const ChimeRequest::Action action, StartMeetingTranscriptionRequest * const q)
