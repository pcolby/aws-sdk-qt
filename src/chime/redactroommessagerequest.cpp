...
#include "redactroommessagerequest_p.h"
...
/*!
 * \class QtAws::Chime::RedactRoomMessageRequest
 * \brief The RedactRoomMessageRequest class provides an interface for Chime RedactRoomMessage requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::redactRoomMessage
 */

/*!
 * Constructs a copy of \a other.
 */
RedactRoomMessageRequest::RedactRoomMessageRequest(const RedactRoomMessageRequest &other)
    : ChimeRequest(new RedactRoomMessageRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a RedactRoomMessageRequest object.
 */
RedactRoomMessageRequest::RedactRoomMessageRequest()
    : ChimeRequest(new RedactRoomMessageRequestPrivate(ChimeRequest::RedactRoomMessageAction, this))
{
 ...
 * \reimp
 */
bool RedactRoomMessageRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a RedactRoomMessageResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * RedactRoomMessageRequest::response(QNetworkReply * const reply) const
{
    return new RedactRoomMessageResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::RedactRoomMessageRequestPrivate
 * \brief The RedactRoomMessageRequestPrivate class provides private implementation for RedactRoomMessageRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a RedactRoomMessageRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
RedactRoomMessageRequestPrivate::RedactRoomMessageRequestPrivate(
    const ChimeRequest::Action action, RedactRoomMessageRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the RedactRoomMessageRequest
 * class' copy constructor.
 */
RedactRoomMessageRequestPrivate::RedactRoomMessageRequestPrivate(
    const RedactRoomMessageRequestPrivate &other, RedactRoomMessageRequest * const q)
