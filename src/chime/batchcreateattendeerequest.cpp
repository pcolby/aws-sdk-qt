...
/*!
 * \class QtAws::Chime::BatchCreateAttendeeRequest
 * \brief The BatchCreateAttendeeRequest class provides an interface for Chime BatchCreateAttendee requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::batchCreateAttendee
 */
...
BatchCreateAttendeeRequest::BatchCreateAttendeeRequest(const BatchCreateAttendeeRequest &other)
    : ChimeRequest(new BatchCreateAttendeeRequestPrivate(*other.d_func(), this))
{
...
BatchCreateAttendeeRequest::BatchCreateAttendeeRequest()
    : ChimeRequest(new BatchCreateAttendeeRequestPrivate(ChimeRequest::BatchCreateAttendeeAction, this))
{
...
/*!
 * \class QtAws::Chime::BatchCreateAttendeeRequestPrivate
...
/*!
 * Constructs a BatchCreateAttendeeRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
BatchCreateAttendeeRequestPrivate::BatchCreateAttendeeRequestPrivate(
    const ChimeRequest::Action action, BatchCreateAttendeeRequest * const q)
