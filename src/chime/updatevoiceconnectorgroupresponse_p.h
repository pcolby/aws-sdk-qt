...
class QTAWS_EXPORT UpdateVoiceConnectorGroupResponsePrivate : public ChimeResponsePrivate {

public:

    UpdateVoiceConnectorGroupResponsePrivate(UpdateVoiceConnectorGroupResponse * const q);
