...
/*!
 * \class QtAws::Chime::ListPhoneNumbersRequest
 * \brief The ListPhoneNumbersRequest class provides an interface for Chime ListPhoneNumbers requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listPhoneNumbers
 */
...
ListPhoneNumbersRequest::ListPhoneNumbersRequest(const ListPhoneNumbersRequest &other)
    : ChimeRequest(new ListPhoneNumbersRequestPrivate(*other.d_func(), this))
{
...
ListPhoneNumbersRequest::ListPhoneNumbersRequest()
    : ChimeRequest(new ListPhoneNumbersRequestPrivate(ChimeRequest::ListPhoneNumbersAction, this))
{
...
/*!
 * \class QtAws::Chime::ListPhoneNumbersRequestPrivate
...
/*!
 * Constructs a ListPhoneNumbersRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListPhoneNumbersRequestPrivate::ListPhoneNumbersRequestPrivate(
    const ChimeRequest::Action action, ListPhoneNumbersRequest * const q)
