...
/*!
 * \class QtAws::Chime::CreateChannelMembershipResponse
 * \brief The CreateChannelMembershipResponse class provides an interace for Chime CreateChannelMembership responses.
 *
 * \inmodule QtAwsChime
 *
...
CreateChannelMembershipResponse::CreateChannelMembershipResponse(
    ...
    : ChimeResponse(new CreateChannelMembershipResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime CreateChannelMembership \a response.
 */
...
/*!
 * \class QtAws::Chime::CreateChannelMembershipResponsePrivate
...
CreateChannelMembershipResponsePrivate::CreateChannelMembershipResponsePrivate(
    CreateChannelMembershipResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateChannelMembership response element from \a xml.
 */
