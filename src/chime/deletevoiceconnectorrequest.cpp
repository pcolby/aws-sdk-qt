...
#include "deletevoiceconnectorrequest_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorRequest
 * \brief The DeleteVoiceConnectorRequest class provides an interface for Chime DeleteVoiceConnector requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
DeleteVoiceConnectorRequest::DeleteVoiceConnectorRequest(const DeleteVoiceConnectorRequest &other)
    : ChimeRequest(new DeleteVoiceConnectorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteVoiceConnectorRequest object.
 */
DeleteVoiceConnectorRequest::DeleteVoiceConnectorRequest()
    : ChimeRequest(new DeleteVoiceConnectorRequestPrivate(ChimeRequest::DeleteVoiceConnectorAction, this))
{
 ...
 * \reimp
 */
bool DeleteVoiceConnectorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteVoiceConnectorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteVoiceConnectorRequest::response(QNetworkReply * const reply) const
{
    return new DeleteVoiceConnectorResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorRequestPrivate
 * \brief The DeleteVoiceConnectorRequestPrivate class provides private implementation for DeleteVoiceConnectorRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteVoiceConnectorRequestPrivate::DeleteVoiceConnectorRequestPrivate(
    const ChimeRequest::Action action, DeleteVoiceConnectorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteVoiceConnectorRequest
 * class' copy constructor.
 */
DeleteVoiceConnectorRequestPrivate::DeleteVoiceConnectorRequestPrivate(
    const DeleteVoiceConnectorRequestPrivate &other, DeleteVoiceConnectorRequest * const q)
