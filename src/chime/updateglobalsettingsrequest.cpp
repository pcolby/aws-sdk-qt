...
/*!
 * \class QtAws::Chime::UpdateGlobalSettingsRequest
 * \brief The UpdateGlobalSettingsRequest class provides an interface for Chime UpdateGlobalSettings requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::updateGlobalSettings
 */
...
UpdateGlobalSettingsRequest::UpdateGlobalSettingsRequest(const UpdateGlobalSettingsRequest &other)
    : ChimeRequest(new UpdateGlobalSettingsRequestPrivate(*other.d_func(), this))
{
...
UpdateGlobalSettingsRequest::UpdateGlobalSettingsRequest()
    : ChimeRequest(new UpdateGlobalSettingsRequestPrivate(ChimeRequest::UpdateGlobalSettingsAction, this))
{
...
/*!
 * \class QtAws::Chime::UpdateGlobalSettingsRequestPrivate
...
/*!
 * Constructs a UpdateGlobalSettingsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateGlobalSettingsRequestPrivate::UpdateGlobalSettingsRequestPrivate(
    const ChimeRequest::Action action, UpdateGlobalSettingsRequest * const q)
