...
/*!
 * \class QtAws::Chime::GetAppInstanceRetentionSettingsResponse
 * \brief The GetAppInstanceRetentionSettingsResponse class provides an interace for Chime GetAppInstanceRetentionSettings responses.
 *
 * \inmodule QtAwsChime
 *
...
GetAppInstanceRetentionSettingsResponse::GetAppInstanceRetentionSettingsResponse(
    ...
    : ChimeResponse(new GetAppInstanceRetentionSettingsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime GetAppInstanceRetentionSettings \a response.
 */
...
/*!
 * \class QtAws::Chime::GetAppInstanceRetentionSettingsResponsePrivate
...
GetAppInstanceRetentionSettingsResponsePrivate::GetAppInstanceRetentionSettingsResponsePrivate(
    GetAppInstanceRetentionSettingsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetAppInstanceRetentionSettings response element from \a xml.
 */
