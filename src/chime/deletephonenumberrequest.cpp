...
#include "deletephonenumberrequest_p.h"
...
/*!
 * \class QtAws::Chime::DeletePhoneNumberRequest
 * \brief The DeletePhoneNumberRequest class provides an interface for Chime DeletePhoneNumber requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deletePhoneNumber
 */

/*!
 * Constructs a copy of \a other.
 */
DeletePhoneNumberRequest::DeletePhoneNumberRequest(const DeletePhoneNumberRequest &other)
    : ChimeRequest(new DeletePhoneNumberRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeletePhoneNumberRequest object.
 */
DeletePhoneNumberRequest::DeletePhoneNumberRequest()
    : ChimeRequest(new DeletePhoneNumberRequestPrivate(ChimeRequest::DeletePhoneNumberAction, this))
{
 ...
 * \reimp
 */
bool DeletePhoneNumberRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeletePhoneNumberResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeletePhoneNumberRequest::response(QNetworkReply * const reply) const
{
    return new DeletePhoneNumberResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeletePhoneNumberRequestPrivate
 * \brief The DeletePhoneNumberRequestPrivate class provides private implementation for DeletePhoneNumberRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeletePhoneNumberRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeletePhoneNumberRequestPrivate::DeletePhoneNumberRequestPrivate(
    const ChimeRequest::Action action, DeletePhoneNumberRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeletePhoneNumberRequest
 * class' copy constructor.
 */
DeletePhoneNumberRequestPrivate::DeletePhoneNumberRequestPrivate(
    const DeletePhoneNumberRequestPrivate &other, DeletePhoneNumberRequest * const q)
