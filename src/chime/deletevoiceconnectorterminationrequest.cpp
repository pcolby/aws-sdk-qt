...
#include "deletevoiceconnectorterminationrequest_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorTerminationRequest
 * \brief The DeleteVoiceConnectorTerminationRequest class provides an interface for Chime DeleteVoiceConnectorTermination requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
DeleteVoiceConnectorTerminationRequest::DeleteVoiceConnectorTerminationRequest(const DeleteVoiceConnectorTerminationRequest &other)
    : ChimeRequest(new DeleteVoiceConnectorTerminationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteVoiceConnectorTerminationRequest object.
 */
DeleteVoiceConnectorTerminationRequest::DeleteVoiceConnectorTerminationRequest()
    : ChimeRequest(new DeleteVoiceConnectorTerminationRequestPrivate(ChimeRequest::DeleteVoiceConnectorTerminationAction, this))
{
 ...
 * \reimp
 */
bool DeleteVoiceConnectorTerminationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteVoiceConnectorTerminationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteVoiceConnectorTerminationRequest::response(QNetworkReply * const reply) const
{
    return new DeleteVoiceConnectorTerminationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorTerminationRequestPrivate
 * \brief The DeleteVoiceConnectorTerminationRequestPrivate class provides private implementation for DeleteVoiceConnectorTerminationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorTerminationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteVoiceConnectorTerminationRequestPrivate::DeleteVoiceConnectorTerminationRequestPrivate(
    const ChimeRequest::Action action, DeleteVoiceConnectorTerminationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteVoiceConnectorTerminationRequest
 * class' copy constructor.
 */
DeleteVoiceConnectorTerminationRequestPrivate::DeleteVoiceConnectorTerminationRequestPrivate(
    const DeleteVoiceConnectorTerminationRequestPrivate &other, DeleteVoiceConnectorTerminationRequest * const q)
