...
/*!
 * \class QtAws::Chime::ListRoomsResponse
 * \brief The ListRoomsResponse class provides an interace for Chime ListRooms responses.
 *
 * \inmodule QtAwsChime
 *
...
ListRoomsResponse::ListRoomsResponse(
    ...
    : ChimeResponse(new ListRoomsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime ListRooms \a response.
 */
...
/*!
 * \class QtAws::Chime::ListRoomsResponsePrivate
...
ListRoomsResponsePrivate::ListRoomsResponsePrivate(
    ListRoomsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListRooms response element from \a xml.
 */
