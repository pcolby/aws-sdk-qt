...
/*!
 * \class QtAws::Chime::CreateAppInstanceAdminRequest
 * \brief The CreateAppInstanceAdminRequest class provides an interface for Chime CreateAppInstanceAdmin requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createAppInstanceAdmin
 */
...
CreateAppInstanceAdminRequest::CreateAppInstanceAdminRequest(const CreateAppInstanceAdminRequest &other)
    : ChimeRequest(new CreateAppInstanceAdminRequestPrivate(*other.d_func(), this))
{
...
CreateAppInstanceAdminRequest::CreateAppInstanceAdminRequest()
    : ChimeRequest(new CreateAppInstanceAdminRequestPrivate(ChimeRequest::CreateAppInstanceAdminAction, this))
{
...
/*!
 * \class QtAws::Chime::CreateAppInstanceAdminRequestPrivate
...
/*!
 * Constructs a CreateAppInstanceAdminRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateAppInstanceAdminRequestPrivate::CreateAppInstanceAdminRequestPrivate(
    const ChimeRequest::Action action, CreateAppInstanceAdminRequest * const q)
