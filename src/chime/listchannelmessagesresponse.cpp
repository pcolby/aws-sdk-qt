...
/*!
 * \class QtAws::Chime::ListChannelMessagesResponse
 * \brief The ListChannelMessagesResponse class provides an interace for Chime ListChannelMessages responses.
 *
 * \inmodule QtAwsChime
 *
...
ListChannelMessagesResponse::ListChannelMessagesResponse(
    ...
    : ChimeResponse(new ListChannelMessagesResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime ListChannelMessages \a response.
 */
...
/*!
 * \class QtAws::Chime::ListChannelMessagesResponsePrivate
...
ListChannelMessagesResponsePrivate::ListChannelMessagesResponsePrivate(
    ListChannelMessagesResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListChannelMessages response element from \a xml.
 */
