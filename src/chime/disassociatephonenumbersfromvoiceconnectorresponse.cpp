...
#include "disassociatephonenumbersfromvoiceconnectorresponse_p.h"
...
/*!
 * \class QtAws::Chime::DisassociatePhoneNumbersFromVoiceConnectorResponse
 * \brief The DisassociatePhoneNumbersFromVoiceConnectorResponse class provides an interace for Chime DisassociatePhoneNumbersFromVoiceConnector responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::disassociatePhoneNumbersFromVoiceConnector
 */

/*!
 * Constructs a DisassociatePhoneNumbersFromVoiceConnectorResponse object for \a reply to \a request, with parent \a parent.
 */
DisassociatePhoneNumbersFromVoiceConnectorResponse::DisassociatePhoneNumbersFromVoiceConnectorResponse(
        const DisassociatePhoneNumbersFromVoiceConnectorRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DisassociatePhoneNumbersFromVoiceConnectorResponsePrivate(this), parent)
{
    setRequest(new DisassociatePhoneNumbersFromVoiceConnectorRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DisassociatePhoneNumbersFromVoiceConnectorRequest * DisassociatePhoneNumbersFromVoiceConnectorResponse::request() const
{
    Q_D(const DisassociatePhoneNumbersFromVoiceConnectorResponse);
    return static_cast<const DisassociatePhoneNumbersFromVoiceConnectorRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime DisassociatePhoneNumbersFromVoiceConnector \a response.
 */
void DisassociatePhoneNumbersFromVoiceConnectorResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DisassociatePhoneNumbersFromVoiceConnectorResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DisassociatePhoneNumbersFromVoiceConnectorResponsePrivate
 * \brief The DisassociatePhoneNumbersFromVoiceConnectorResponsePrivate class provides private implementation for DisassociatePhoneNumbersFromVoiceConnectorResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DisassociatePhoneNumbersFromVoiceConnectorResponsePrivate object with public implementation \a q.
 */
DisassociatePhoneNumbersFromVoiceConnectorResponsePrivate::DisassociatePhoneNumbersFromVoiceConnectorResponsePrivate(
    DisassociatePhoneNumbersFromVoiceConnectorResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DisassociatePhoneNumbersFromVoiceConnector response element from \a xml.
 */
void DisassociatePhoneNumbersFromVoiceConnectorResponsePrivate::parseDisassociatePhoneNumbersFromVoiceConnectorResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DisassociatePhoneNumbersFromVoiceConnectorResponse"));
    Q_UNUSED(xml) ///< @todo
}
