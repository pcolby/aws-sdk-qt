...
/*!
 * \class QtAws::Chime::UpdateUserResponse
 * \brief The UpdateUserResponse class provides an interace for Chime UpdateUser responses.
 *
 * \inmodule QtAwsChime
 *
...
UpdateUserResponse::UpdateUserResponse(
    ...
    : ChimeResponse(new UpdateUserResponsePrivate(this), parent)
{
...
{
    return static_cast<const UpdateUserRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime UpdateUser \a response.
 */
...
/*!
 * \class QtAws::Chime::UpdateUserResponsePrivate
...
UpdateUserResponsePrivate::UpdateUserResponsePrivate(
    UpdateUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateUser response element from \a xml.
 */
