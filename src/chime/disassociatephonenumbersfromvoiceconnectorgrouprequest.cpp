...
#include "disassociatephonenumbersfromvoiceconnectorgrouprequest_p.h"
...
/*!
 * \class QtAws::Chime::DisassociatePhoneNumbersFromVoiceConnectorGroupRequest
 * \brief The DisassociatePhoneNumbersFromVoiceConnectorGroupRequest class provides an interface for Chime DisassociatePhoneNumbersFromVoiceConnectorGroup requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::disassociatePhoneNumbersFromVoiceConnectorGroup
 */

/*!
 * Constructs a copy of \a other.
 */
DisassociatePhoneNumbersFromVoiceConnectorGroupRequest::DisassociatePhoneNumbersFromVoiceConnectorGroupRequest(const DisassociatePhoneNumbersFromVoiceConnectorGroupRequest &other)
    : ChimeRequest(new DisassociatePhoneNumbersFromVoiceConnectorGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DisassociatePhoneNumbersFromVoiceConnectorGroupRequest object.
 */
DisassociatePhoneNumbersFromVoiceConnectorGroupRequest::DisassociatePhoneNumbersFromVoiceConnectorGroupRequest()
    : ChimeRequest(new DisassociatePhoneNumbersFromVoiceConnectorGroupRequestPrivate(ChimeRequest::DisassociatePhoneNumbersFromVoiceConnectorGroupAction, this))
{
 ...
 * \reimp
 */
bool DisassociatePhoneNumbersFromVoiceConnectorGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DisassociatePhoneNumbersFromVoiceConnectorGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DisassociatePhoneNumbersFromVoiceConnectorGroupRequest::response(QNetworkReply * const reply) const
{
    return new DisassociatePhoneNumbersFromVoiceConnectorGroupResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DisassociatePhoneNumbersFromVoiceConnectorGroupRequestPrivate
 * \brief The DisassociatePhoneNumbersFromVoiceConnectorGroupRequestPrivate class provides private implementation for DisassociatePhoneNumbersFromVoiceConnectorGroupRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DisassociatePhoneNumbersFromVoiceConnectorGroupRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DisassociatePhoneNumbersFromVoiceConnectorGroupRequestPrivate::DisassociatePhoneNumbersFromVoiceConnectorGroupRequestPrivate(
    const ChimeRequest::Action action, DisassociatePhoneNumbersFromVoiceConnectorGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DisassociatePhoneNumbersFromVoiceConnectorGroupRequest
 * class' copy constructor.
 */
DisassociatePhoneNumbersFromVoiceConnectorGroupRequestPrivate::DisassociatePhoneNumbersFromVoiceConnectorGroupRequestPrivate(
    const DisassociatePhoneNumbersFromVoiceConnectorGroupRequestPrivate &other, DisassociatePhoneNumbersFromVoiceConnectorGroupRequest * const q)
