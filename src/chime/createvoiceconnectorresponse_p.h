...
class QTAWS_EXPORT CreateVoiceConnectorResponsePrivate : public ChimeResponsePrivate {

public:

    CreateVoiceConnectorResponsePrivate(CreateVoiceConnectorResponse * const q);
