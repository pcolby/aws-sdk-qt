...
/*!
 * \class QtAws::Chime::DeleteChannelRequest
 * \brief The DeleteChannelRequest class provides an interface for Chime DeleteChannel requests.
 *
 * \inmodule QtAwsChime
 *
...
DeleteChannelRequest::DeleteChannelRequest(const DeleteChannelRequest &other)
    : ChimeRequest(new DeleteChannelRequestPrivate(*other.d_func(), this))
{
...
DeleteChannelRequest::DeleteChannelRequest()
    : ChimeRequest(new DeleteChannelRequestPrivate(ChimeRequest::DeleteChannelAction, this))
{
...
/*!
 * \class QtAws::Chime::DeleteChannelRequestPrivate
...
/*!
 * Constructs a DeleteChannelRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteChannelRequestPrivate::DeleteChannelRequestPrivate(
    const ChimeRequest::Action action, DeleteChannelRequest * const q)
