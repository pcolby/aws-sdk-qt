...
/*!
 * \class QtAws::Chime::UpdateAppInstanceUserResponse
 * \brief The UpdateAppInstanceUserResponse class provides an interace for Chime UpdateAppInstanceUser responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::updateAppInstanceUser
 */
...
UpdateAppInstanceUserResponse::UpdateAppInstanceUserResponse(
    ...
    : ChimeResponse(new UpdateAppInstanceUserResponsePrivate(this), parent)
{
...
{
    return static_cast<const UpdateAppInstanceUserRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime UpdateAppInstanceUser \a response.
 */
...
/*!
 * \class QtAws::Chime::UpdateAppInstanceUserResponsePrivate
...
UpdateAppInstanceUserResponsePrivate::UpdateAppInstanceUserResponsePrivate(
    UpdateAppInstanceUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateAppInstanceUser response element from \a xml.
 */
