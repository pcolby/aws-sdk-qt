...
#include "deletevoiceconnectoremergencycallingconfigurationrequest_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorEmergencyCallingConfigurationRequest
 * \brief The DeleteVoiceConnectorEmergencyCallingConfigurationRequest class provides an interface for Chime DeleteVoiceConnectorEmergencyCallingConfiguration requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteVoiceConnectorEmergencyCallingConfiguration
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteVoiceConnectorEmergencyCallingConfigurationRequest::DeleteVoiceConnectorEmergencyCallingConfigurationRequest(const DeleteVoiceConnectorEmergencyCallingConfigurationRequest &other)
    : ChimeRequest(new DeleteVoiceConnectorEmergencyCallingConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteVoiceConnectorEmergencyCallingConfigurationRequest object.
 */
DeleteVoiceConnectorEmergencyCallingConfigurationRequest::DeleteVoiceConnectorEmergencyCallingConfigurationRequest()
    : ChimeRequest(new DeleteVoiceConnectorEmergencyCallingConfigurationRequestPrivate(ChimeRequest::DeleteVoiceConnectorEmergencyCallingConfigurationAction, this))
{
 ...
 * \reimp
 */
bool DeleteVoiceConnectorEmergencyCallingConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteVoiceConnectorEmergencyCallingConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteVoiceConnectorEmergencyCallingConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new DeleteVoiceConnectorEmergencyCallingConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorEmergencyCallingConfigurationRequestPrivate
 * \brief The DeleteVoiceConnectorEmergencyCallingConfigurationRequestPrivate class provides private implementation for DeleteVoiceConnectorEmergencyCallingConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorEmergencyCallingConfigurationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteVoiceConnectorEmergencyCallingConfigurationRequestPrivate::DeleteVoiceConnectorEmergencyCallingConfigurationRequestPrivate(
    const ChimeRequest::Action action, DeleteVoiceConnectorEmergencyCallingConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteVoiceConnectorEmergencyCallingConfigurationRequest
 * class' copy constructor.
 */
DeleteVoiceConnectorEmergencyCallingConfigurationRequestPrivate::DeleteVoiceConnectorEmergencyCallingConfigurationRequestPrivate(
    const DeleteVoiceConnectorEmergencyCallingConfigurationRequestPrivate &other, DeleteVoiceConnectorEmergencyCallingConfigurationRequest * const q)
