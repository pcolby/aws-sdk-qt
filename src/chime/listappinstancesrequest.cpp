...
/*!
 * \class QtAws::Chime::ListAppInstancesRequest
 * \brief The ListAppInstancesRequest class provides an interface for Chime ListAppInstances requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listAppInstances
 */
...
ListAppInstancesRequest::ListAppInstancesRequest(const ListAppInstancesRequest &other)
    : ChimeRequest(new ListAppInstancesRequestPrivate(*other.d_func(), this))
{
...
ListAppInstancesRequest::ListAppInstancesRequest()
    : ChimeRequest(new ListAppInstancesRequestPrivate(ChimeRequest::ListAppInstancesAction, this))
{
...
/*!
 * \class QtAws::Chime::ListAppInstancesRequestPrivate
...
/*!
 * Constructs a ListAppInstancesRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListAppInstancesRequestPrivate::ListAppInstancesRequestPrivate(
    const ChimeRequest::Action action, ListAppInstancesRequest * const q)
