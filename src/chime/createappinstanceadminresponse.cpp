...
/*!
 * \class QtAws::Chime::CreateAppInstanceAdminResponse
 * \brief The CreateAppInstanceAdminResponse class provides an interace for Chime CreateAppInstanceAdmin responses.
 *
 * \inmodule QtAwsChime
 *
...
CreateAppInstanceAdminResponse::CreateAppInstanceAdminResponse(
    ...
    : ChimeResponse(new CreateAppInstanceAdminResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime CreateAppInstanceAdmin \a response.
 */
...
/*!
 * \class QtAws::Chime::CreateAppInstanceAdminResponsePrivate
...
CreateAppInstanceAdminResponsePrivate::CreateAppInstanceAdminResponsePrivate(
    CreateAppInstanceAdminResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateAppInstanceAdmin response element from \a xml.
 */
