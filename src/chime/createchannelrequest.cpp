...
/*!
 * \class QtAws::Chime::CreateChannelRequest
 * \brief The CreateChannelRequest class provides an interface for Chime CreateChannel requests.
 *
 * \inmodule QtAwsChime
 *
...
CreateChannelRequest::CreateChannelRequest(const CreateChannelRequest &other)
    : ChimeRequest(new CreateChannelRequestPrivate(*other.d_func(), this))
{
...
CreateChannelRequest::CreateChannelRequest()
    : ChimeRequest(new CreateChannelRequestPrivate(ChimeRequest::CreateChannelAction, this))
{
...
/*!
 * \class QtAws::Chime::CreateChannelRequestPrivate
...
/*!
 * Constructs a CreateChannelRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateChannelRequestPrivate::CreateChannelRequestPrivate(
    const ChimeRequest::Action action, CreateChannelRequest * const q)
