...
/*!
 * \class QtAws::Chime::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Chime UntagResource responses.
 *
 * \inmodule QtAwsChime
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : ChimeResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime UntagResource \a response.
 */
...
/*!
 * \class QtAws::Chime::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UntagResource response element from \a xml.
 */
