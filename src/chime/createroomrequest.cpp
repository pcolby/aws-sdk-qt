...
/*!
 * \class QtAws::Chime::CreateRoomRequest
 * \brief The CreateRoomRequest class provides an interface for Chime CreateRoom requests.
 *
 * \inmodule QtAwsChime
 *
...
CreateRoomRequest::CreateRoomRequest(const CreateRoomRequest &other)
    : ChimeRequest(new CreateRoomRequestPrivate(*other.d_func(), this))
{
...
CreateRoomRequest::CreateRoomRequest()
    : ChimeRequest(new CreateRoomRequestPrivate(ChimeRequest::CreateRoomAction, this))
{
...
/*!
 * \class QtAws::Chime::CreateRoomRequestPrivate
...
/*!
 * Constructs a CreateRoomRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateRoomRequestPrivate::CreateRoomRequestPrivate(
    const ChimeRequest::Action action, CreateRoomRequest * const q)
