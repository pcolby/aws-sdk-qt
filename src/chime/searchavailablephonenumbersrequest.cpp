...
/*!
 * \class QtAws::Chime::SearchAvailablePhoneNumbersRequest
 * \brief The SearchAvailablePhoneNumbersRequest class provides an interface for Chime SearchAvailablePhoneNumbers requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::searchAvailablePhoneNumbers
 */
...
SearchAvailablePhoneNumbersRequest::SearchAvailablePhoneNumbersRequest(const SearchAvailablePhoneNumbersRequest &other)
    : ChimeRequest(new SearchAvailablePhoneNumbersRequestPrivate(*other.d_func(), this))
{
...
SearchAvailablePhoneNumbersRequest::SearchAvailablePhoneNumbersRequest()
    : ChimeRequest(new SearchAvailablePhoneNumbersRequestPrivate(ChimeRequest::SearchAvailablePhoneNumbersAction, this))
{
...
/*!
 * \class QtAws::Chime::SearchAvailablePhoneNumbersRequestPrivate
...
/*!
 * Constructs a SearchAvailablePhoneNumbersRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
SearchAvailablePhoneNumbersRequestPrivate::SearchAvailablePhoneNumbersRequestPrivate(
    const ChimeRequest::Action action, SearchAvailablePhoneNumbersRequest * const q)
