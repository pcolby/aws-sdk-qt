...
#include "listmeetingtagsrequest_p.h"
...
/*!
 * \class QtAws::Chime::ListMeetingTagsRequest
 * \brief The ListMeetingTagsRequest class provides an interface for Chime ListMeetingTags requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
ListMeetingTagsRequest::ListMeetingTagsRequest(const ListMeetingTagsRequest &other)
    : ChimeRequest(new ListMeetingTagsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListMeetingTagsRequest object.
 */
ListMeetingTagsRequest::ListMeetingTagsRequest()
    : ChimeRequest(new ListMeetingTagsRequestPrivate(ChimeRequest::ListMeetingTagsAction, this))
{
 ...
 * \reimp
 */
bool ListMeetingTagsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListMeetingTagsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListMeetingTagsRequest::response(QNetworkReply * const reply) const
{
    return new ListMeetingTagsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::ListMeetingTagsRequestPrivate
 * \brief The ListMeetingTagsRequestPrivate class provides private implementation for ListMeetingTagsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListMeetingTagsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListMeetingTagsRequestPrivate::ListMeetingTagsRequestPrivate(
    const ChimeRequest::Action action, ListMeetingTagsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListMeetingTagsRequest
 * class' copy constructor.
 */
ListMeetingTagsRequestPrivate::ListMeetingTagsRequestPrivate(
    const ListMeetingTagsRequestPrivate &other, ListMeetingTagsRequest * const q)
