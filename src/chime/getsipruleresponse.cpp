...
#include "getsipruleresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetSipRuleResponse
 * \brief The GetSipRuleResponse class provides an interace for Chime GetSipRule responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getSipRule
 */

/*!
 * Constructs a GetSipRuleResponse object for \a reply to \a request, with parent \a parent.
 */
GetSipRuleResponse::GetSipRuleResponse(
        const GetSipRuleRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetSipRuleResponsePrivate(this), parent)
{
    setRequest(new GetSipRuleRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetSipRuleRequest * GetSipRuleResponse::request() const
{
    Q_D(const GetSipRuleResponse);
    return static_cast<const GetSipRuleRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime GetSipRule \a response.
 */
void GetSipRuleResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetSipRuleResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetSipRuleResponsePrivate
 * \brief The GetSipRuleResponsePrivate class provides private implementation for GetSipRuleResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetSipRuleResponsePrivate object with public implementation \a q.
 */
GetSipRuleResponsePrivate::GetSipRuleResponsePrivate(
    GetSipRuleResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetSipRule response element from \a xml.
 */
void GetSipRuleResponsePrivate::parseGetSipRuleResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetSipRuleResponse"));
    Q_UNUSED(xml) ///< @todo
}
