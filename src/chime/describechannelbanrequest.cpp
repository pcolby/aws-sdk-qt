...
/*!
 * \class QtAws::Chime::DescribeChannelBanRequest
 * \brief The DescribeChannelBanRequest class provides an interface for Chime DescribeChannelBan requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::describeChannelBan
 */
...
DescribeChannelBanRequest::DescribeChannelBanRequest(const DescribeChannelBanRequest &other)
    : ChimeRequest(new DescribeChannelBanRequestPrivate(*other.d_func(), this))
{
...
DescribeChannelBanRequest::DescribeChannelBanRequest()
    : ChimeRequest(new DescribeChannelBanRequestPrivate(ChimeRequest::DescribeChannelBanAction, this))
{
...
/*!
 * \class QtAws::Chime::DescribeChannelBanRequestPrivate
...
/*!
 * Constructs a DescribeChannelBanRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DescribeChannelBanRequestPrivate::DescribeChannelBanRequestPrivate(
    const ChimeRequest::Action action, DescribeChannelBanRequest * const q)
