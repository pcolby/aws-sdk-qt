...
/*!
 * \class QtAws::Chime::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for Chime ListTagsForResource requests.
 *
 * \inmodule QtAwsChime
 *
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : ChimeRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : ChimeRequest(new ListTagsForResourceRequestPrivate(ChimeRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::Chime::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const ChimeRequest::Action action, ListTagsForResourceRequest * const q)
