...
/*!
 * \class QtAws::Chime::UpdateUserSettingsResponse
 * \brief The UpdateUserSettingsResponse class provides an interace for Chime UpdateUserSettings responses.
 *
 * \inmodule QtAwsChime
 *
...
UpdateUserSettingsResponse::UpdateUserSettingsResponse(
    ...
    : ChimeResponse(new UpdateUserSettingsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime UpdateUserSettings \a response.
 */
...
/*!
 * \class QtAws::Chime::UpdateUserSettingsResponsePrivate
...
UpdateUserSettingsResponsePrivate::UpdateUserSettingsResponsePrivate(
    UpdateUserSettingsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateUserSettings response element from \a xml.
 */
