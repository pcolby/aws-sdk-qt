...
#include "getglobalsettingsrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetGlobalSettingsRequest
 * \brief The GetGlobalSettingsRequest class provides an interface for Chime GetGlobalSettings requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
GetGlobalSettingsRequest::GetGlobalSettingsRequest(const GetGlobalSettingsRequest &other)
    : ChimeRequest(new GetGlobalSettingsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetGlobalSettingsRequest object.
 */
GetGlobalSettingsRequest::GetGlobalSettingsRequest()
    : ChimeRequest(new GetGlobalSettingsRequestPrivate(ChimeRequest::GetGlobalSettingsAction, this))
{
 ...
 * \reimp
 */
bool GetGlobalSettingsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetGlobalSettingsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetGlobalSettingsRequest::response(QNetworkReply * const reply) const
{
    return new GetGlobalSettingsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetGlobalSettingsRequestPrivate
 * \brief The GetGlobalSettingsRequestPrivate class provides private implementation for GetGlobalSettingsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetGlobalSettingsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetGlobalSettingsRequestPrivate::GetGlobalSettingsRequestPrivate(
    const ChimeRequest::Action action, GetGlobalSettingsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetGlobalSettingsRequest
 * class' copy constructor.
 */
GetGlobalSettingsRequestPrivate::GetGlobalSettingsRequestPrivate(
    const GetGlobalSettingsRequestPrivate &other, GetGlobalSettingsRequest * const q)
