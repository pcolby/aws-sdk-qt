...
/*!
 * \class QtAws::Chime::UpdateBotRequest
 * \brief The UpdateBotRequest class provides an interface for Chime UpdateBot requests.
 *
 * \inmodule QtAwsChime
 *
...
UpdateBotRequest::UpdateBotRequest(const UpdateBotRequest &other)
    : ChimeRequest(new UpdateBotRequestPrivate(*other.d_func(), this))
{
...
UpdateBotRequest::UpdateBotRequest()
    : ChimeRequest(new UpdateBotRequestPrivate(ChimeRequest::UpdateBotAction, this))
{
...
/*!
 * \class QtAws::Chime::UpdateBotRequestPrivate
...
/*!
 * Constructs a UpdateBotRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateBotRequestPrivate::UpdateBotRequestPrivate(
    const ChimeRequest::Action action, UpdateBotRequest * const q)
