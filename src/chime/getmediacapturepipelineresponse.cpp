...
/*!
 * \class QtAws::Chime::GetMediaCapturePipelineResponse
 * \brief The GetMediaCapturePipelineResponse class provides an interace for Chime GetMediaCapturePipeline responses.
 *
 * \inmodule QtAwsChime
 *
...
GetMediaCapturePipelineResponse::GetMediaCapturePipelineResponse(
    ...
    : ChimeResponse(new GetMediaCapturePipelineResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime GetMediaCapturePipeline \a response.
 */
...
/*!
 * \class QtAws::Chime::GetMediaCapturePipelineResponsePrivate
...
GetMediaCapturePipelineResponsePrivate::GetMediaCapturePipelineResponsePrivate(
    GetMediaCapturePipelineResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetMediaCapturePipeline response element from \a xml.
 */
