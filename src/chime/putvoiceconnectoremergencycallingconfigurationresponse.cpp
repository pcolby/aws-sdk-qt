...
#include "putvoiceconnectoremergencycallingconfigurationresponse_p.h"
...
/*!
 * \class QtAws::Chime::PutVoiceConnectorEmergencyCallingConfigurationResponse
 * \brief The PutVoiceConnectorEmergencyCallingConfigurationResponse class provides an interace for Chime PutVoiceConnectorEmergencyCallingConfiguration responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a PutVoiceConnectorEmergencyCallingConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
PutVoiceConnectorEmergencyCallingConfigurationResponse::PutVoiceConnectorEmergencyCallingConfigurationResponse(
        const PutVoiceConnectorEmergencyCallingConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new PutVoiceConnectorEmergencyCallingConfigurationResponsePrivate(this), parent)
{
    setRequest(new PutVoiceConnectorEmergencyCallingConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime PutVoiceConnectorEmergencyCallingConfiguration \a response.
 */
void PutVoiceConnectorEmergencyCallingConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutVoiceConnectorEmergencyCallingConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::PutVoiceConnectorEmergencyCallingConfigurationResponsePrivate
 * \brief The PutVoiceConnectorEmergencyCallingConfigurationResponsePrivate class provides private implementation for PutVoiceConnectorEmergencyCallingConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutVoiceConnectorEmergencyCallingConfigurationResponsePrivate object with public implementation \a q.
 */
PutVoiceConnectorEmergencyCallingConfigurationResponsePrivate::PutVoiceConnectorEmergencyCallingConfigurationResponsePrivate(
    PutVoiceConnectorEmergencyCallingConfigurationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime PutVoiceConnectorEmergencyCallingConfiguration response element from \a xml.
 */
void PutVoiceConnectorEmergencyCallingConfigurationResponsePrivate::parsePutVoiceConnectorEmergencyCallingConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutVoiceConnectorEmergencyCallingConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
