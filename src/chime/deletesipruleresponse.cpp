...
#include "deletesipruleresponse_p.h"
...
/*!
 * \class QtAws::Chime::DeleteSipRuleResponse
 * \brief The DeleteSipRuleResponse class provides an interace for Chime DeleteSipRule responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a DeleteSipRuleResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteSipRuleResponse::DeleteSipRuleResponse(
        const DeleteSipRuleRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DeleteSipRuleResponsePrivate(this), parent)
{
    setRequest(new DeleteSipRuleRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime DeleteSipRule \a response.
 */
void DeleteSipRuleResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteSipRuleResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DeleteSipRuleResponsePrivate
 * \brief The DeleteSipRuleResponsePrivate class provides private implementation for DeleteSipRuleResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteSipRuleResponsePrivate object with public implementation \a q.
 */
DeleteSipRuleResponsePrivate::DeleteSipRuleResponsePrivate(
    DeleteSipRuleResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteSipRule response element from \a xml.
 */
void DeleteSipRuleResponsePrivate::parseDeleteSipRuleResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteSipRuleResponse"));
    Q_UNUSED(xml) ///< @todo
}
