...
/*!
 * \class QtAws::Chime::RedactChannelMessageRequest
 * \brief The RedactChannelMessageRequest class provides an interface for Chime RedactChannelMessage requests.
 *
 * \inmodule QtAwsChime
 *
...
RedactChannelMessageRequest::RedactChannelMessageRequest(const RedactChannelMessageRequest &other)
    : ChimeRequest(new RedactChannelMessageRequestPrivate(*other.d_func(), this))
{
...
RedactChannelMessageRequest::RedactChannelMessageRequest()
    : ChimeRequest(new RedactChannelMessageRequestPrivate(ChimeRequest::RedactChannelMessageAction, this))
{
...
/*!
 * \class QtAws::Chime::RedactChannelMessageRequestPrivate
...
/*!
 * Constructs a RedactChannelMessageRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
RedactChannelMessageRequestPrivate::RedactChannelMessageRequestPrivate(
    const ChimeRequest::Action action, RedactChannelMessageRequest * const q)
