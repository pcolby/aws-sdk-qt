...
#include "getphonenumberresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetPhoneNumberResponse
 * \brief The GetPhoneNumberResponse class provides an interace for Chime GetPhoneNumber responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a GetPhoneNumberResponse object for \a reply to \a request, with parent \a parent.
 */
GetPhoneNumberResponse::GetPhoneNumberResponse(
        const GetPhoneNumberRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetPhoneNumberResponsePrivate(this), parent)
{
    setRequest(new GetPhoneNumberRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime GetPhoneNumber \a response.
 */
void GetPhoneNumberResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetPhoneNumberResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetPhoneNumberResponsePrivate
 * \brief The GetPhoneNumberResponsePrivate class provides private implementation for GetPhoneNumberResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetPhoneNumberResponsePrivate object with public implementation \a q.
 */
GetPhoneNumberResponsePrivate::GetPhoneNumberResponsePrivate(
    GetPhoneNumberResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetPhoneNumber response element from \a xml.
 */
void GetPhoneNumberResponsePrivate::parseGetPhoneNumberResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetPhoneNumberResponse"));
    Q_UNUSED(xml) ///< @todo
}
