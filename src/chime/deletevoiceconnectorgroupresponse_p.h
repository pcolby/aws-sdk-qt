...
class QTAWS_EXPORT DeleteVoiceConnectorGroupResponsePrivate : public ChimeResponsePrivate {

public:

    DeleteVoiceConnectorGroupResponsePrivate(DeleteVoiceConnectorGroupResponse * const q);
