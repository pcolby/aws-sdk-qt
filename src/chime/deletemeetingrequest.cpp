...
/*!
 * \class QtAws::Chime::DeleteMeetingRequest
 * \brief The DeleteMeetingRequest class provides an interface for Chime DeleteMeeting requests.
 *
 * \inmodule QtAwsChime
 *
...
DeleteMeetingRequest::DeleteMeetingRequest(const DeleteMeetingRequest &other)
    : ChimeRequest(new DeleteMeetingRequestPrivate(*other.d_func(), this))
{
...
DeleteMeetingRequest::DeleteMeetingRequest()
    : ChimeRequest(new DeleteMeetingRequestPrivate(ChimeRequest::DeleteMeetingAction, this))
{
...
/*!
 * \class QtAws::Chime::DeleteMeetingRequestPrivate
...
/*!
 * Constructs a DeleteMeetingRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteMeetingRequestPrivate::DeleteMeetingRequestPrivate(
    const ChimeRequest::Action action, DeleteMeetingRequest * const q)
