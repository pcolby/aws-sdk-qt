...
#include "associatesignindelegategroupswithaccountresponse_p.h"
...
/*!
 * \class QtAws::Chime::AssociateSigninDelegateGroupsWithAccountResponse
 * \brief The AssociateSigninDelegateGroupsWithAccountResponse class provides an interace for Chime AssociateSigninDelegateGroupsWithAccount responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a AssociateSigninDelegateGroupsWithAccountResponse object for \a reply to \a request, with parent \a parent.
 */
AssociateSigninDelegateGroupsWithAccountResponse::AssociateSigninDelegateGroupsWithAccountResponse(
        const AssociateSigninDelegateGroupsWithAccountRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new AssociateSigninDelegateGroupsWithAccountResponsePrivate(this), parent)
{
    setRequest(new AssociateSigninDelegateGroupsWithAccountRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime AssociateSigninDelegateGroupsWithAccount \a response.
 */
void AssociateSigninDelegateGroupsWithAccountResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AssociateSigninDelegateGroupsWithAccountResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::AssociateSigninDelegateGroupsWithAccountResponsePrivate
 * \brief The AssociateSigninDelegateGroupsWithAccountResponsePrivate class provides private implementation for AssociateSigninDelegateGroupsWithAccountResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a AssociateSigninDelegateGroupsWithAccountResponsePrivate object with public implementation \a q.
 */
AssociateSigninDelegateGroupsWithAccountResponsePrivate::AssociateSigninDelegateGroupsWithAccountResponsePrivate(
    AssociateSigninDelegateGroupsWithAccountResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime AssociateSigninDelegateGroupsWithAccount response element from \a xml.
 */
void AssociateSigninDelegateGroupsWithAccountResponsePrivate::parseAssociateSigninDelegateGroupsWithAccountResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AssociateSigninDelegateGroupsWithAccountResponse"));
    Q_UNUSED(xml) ///< @todo
}
