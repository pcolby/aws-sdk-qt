...
/*!
 * \class QtAws::Chime::DeleteAppInstanceAdminRequest
 * \brief The DeleteAppInstanceAdminRequest class provides an interface for Chime DeleteAppInstanceAdmin requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteAppInstanceAdmin
 */
...
DeleteAppInstanceAdminRequest::DeleteAppInstanceAdminRequest(const DeleteAppInstanceAdminRequest &other)
    : ChimeRequest(new DeleteAppInstanceAdminRequestPrivate(*other.d_func(), this))
{
...
DeleteAppInstanceAdminRequest::DeleteAppInstanceAdminRequest()
    : ChimeRequest(new DeleteAppInstanceAdminRequestPrivate(ChimeRequest::DeleteAppInstanceAdminAction, this))
{
...
/*!
 * \class QtAws::Chime::DeleteAppInstanceAdminRequestPrivate
...
/*!
 * Constructs a DeleteAppInstanceAdminRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteAppInstanceAdminRequestPrivate::DeleteAppInstanceAdminRequestPrivate(
    const ChimeRequest::Action action, DeleteAppInstanceAdminRequest * const q)
