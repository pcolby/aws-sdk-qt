...
#include "deletevoiceconnectorstreamingconfigurationresponse_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorStreamingConfigurationResponse
 * \brief The DeleteVoiceConnectorStreamingConfigurationResponse class provides an interace for Chime DeleteVoiceConnectorStreamingConfiguration responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a DeleteVoiceConnectorStreamingConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteVoiceConnectorStreamingConfigurationResponse::DeleteVoiceConnectorStreamingConfigurationResponse(
        const DeleteVoiceConnectorStreamingConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DeleteVoiceConnectorStreamingConfigurationResponsePrivate(this), parent)
{
    setRequest(new DeleteVoiceConnectorStreamingConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime DeleteVoiceConnectorStreamingConfiguration \a response.
 */
void DeleteVoiceConnectorStreamingConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteVoiceConnectorStreamingConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorStreamingConfigurationResponsePrivate
 * \brief The DeleteVoiceConnectorStreamingConfigurationResponsePrivate class provides private implementation for DeleteVoiceConnectorStreamingConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorStreamingConfigurationResponsePrivate object with public implementation \a q.
 */
DeleteVoiceConnectorStreamingConfigurationResponsePrivate::DeleteVoiceConnectorStreamingConfigurationResponsePrivate(
    DeleteVoiceConnectorStreamingConfigurationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteVoiceConnectorStreamingConfiguration response element from \a xml.
 */
void DeleteVoiceConnectorStreamingConfigurationResponsePrivate::parseDeleteVoiceConnectorStreamingConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteVoiceConnectorStreamingConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
