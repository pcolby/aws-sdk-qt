...
#include "geteventsconfigurationrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetEventsConfigurationRequest
 * \brief The GetEventsConfigurationRequest class provides an interface for Chime GetEventsConfiguration requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getEventsConfiguration
 */

/*!
 * Constructs a copy of \a other.
 */
GetEventsConfigurationRequest::GetEventsConfigurationRequest(const GetEventsConfigurationRequest &other)
    : ChimeRequest(new GetEventsConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetEventsConfigurationRequest object.
 */
GetEventsConfigurationRequest::GetEventsConfigurationRequest()
    : ChimeRequest(new GetEventsConfigurationRequestPrivate(ChimeRequest::GetEventsConfigurationAction, this))
{
 ...
 * \reimp
 */
bool GetEventsConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetEventsConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetEventsConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new GetEventsConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetEventsConfigurationRequestPrivate
 * \brief The GetEventsConfigurationRequestPrivate class provides private implementation for GetEventsConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetEventsConfigurationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetEventsConfigurationRequestPrivate::GetEventsConfigurationRequestPrivate(
    const ChimeRequest::Action action, GetEventsConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetEventsConfigurationRequest
 * class' copy constructor.
 */
GetEventsConfigurationRequestPrivate::GetEventsConfigurationRequestPrivate(
    const GetEventsConfigurationRequestPrivate &other, GetEventsConfigurationRequest * const q)
