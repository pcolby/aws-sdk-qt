...
#include "logoutuserresponse_p.h"
...
/*!
 * \class QtAws::Chime::LogoutUserResponse
 * \brief The LogoutUserResponse class provides an interace for Chime LogoutUser responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a LogoutUserResponse object for \a reply to \a request, with parent \a parent.
 */
LogoutUserResponse::LogoutUserResponse(
        const LogoutUserRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new LogoutUserResponsePrivate(this), parent)
{
    setRequest(new LogoutUserRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime LogoutUser \a response.
 */
void LogoutUserResponse::parseSuccess(QIODevice &response)
{
    //Q_D(LogoutUserResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::LogoutUserResponsePrivate
 * \brief The LogoutUserResponsePrivate class provides private implementation for LogoutUserResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a LogoutUserResponsePrivate object with public implementation \a q.
 */
LogoutUserResponsePrivate::LogoutUserResponsePrivate(
    LogoutUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime LogoutUser response element from \a xml.
 */
void LogoutUserResponsePrivate::parseLogoutUserResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("LogoutUserResponse"));
    Q_UNUSED(xml) ///< @todo
}
