...
/*!
 * \class QtAws::Chime::DeleteChannelResponse
 * \brief The DeleteChannelResponse class provides an interace for Chime DeleteChannel responses.
 *
 * \inmodule QtAwsChime
 *
...
DeleteChannelResponse::DeleteChannelResponse(
    ...
    : ChimeResponse(new DeleteChannelResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DeleteChannel \a response.
 */
...
/*!
 * \class QtAws::Chime::DeleteChannelResponsePrivate
...
DeleteChannelResponsePrivate::DeleteChannelResponsePrivate(
    DeleteChannelResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteChannel response element from \a xml.
 */
