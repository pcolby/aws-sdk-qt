...
#include "updateroommembershipresponse_p.h"
...
/*!
 * \class QtAws::Chime::UpdateRoomMembershipResponse
 * \brief The UpdateRoomMembershipResponse class provides an interace for Chime UpdateRoomMembership responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a UpdateRoomMembershipResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateRoomMembershipResponse::UpdateRoomMembershipResponse(
        const UpdateRoomMembershipRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new UpdateRoomMembershipResponsePrivate(this), parent)
{
    setRequest(new UpdateRoomMembershipRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime UpdateRoomMembership \a response.
 */
void UpdateRoomMembershipResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateRoomMembershipResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::UpdateRoomMembershipResponsePrivate
 * \brief The UpdateRoomMembershipResponsePrivate class provides private implementation for UpdateRoomMembershipResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UpdateRoomMembershipResponsePrivate object with public implementation \a q.
 */
UpdateRoomMembershipResponsePrivate::UpdateRoomMembershipResponsePrivate(
    UpdateRoomMembershipResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateRoomMembership response element from \a xml.
 */
void UpdateRoomMembershipResponsePrivate::parseUpdateRoomMembershipResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateRoomMembershipResponse"));
    Q_UNUSED(xml) ///< @todo
}
