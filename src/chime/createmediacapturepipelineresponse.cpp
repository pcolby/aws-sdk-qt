...
/*!
 * \class QtAws::Chime::CreateMediaCapturePipelineResponse
 * \brief The CreateMediaCapturePipelineResponse class provides an interace for Chime CreateMediaCapturePipeline responses.
 *
 * \inmodule QtAwsChime
 *
...
CreateMediaCapturePipelineResponse::CreateMediaCapturePipelineResponse(
    ...
    : ChimeResponse(new CreateMediaCapturePipelineResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime CreateMediaCapturePipeline \a response.
 */
...
/*!
 * \class QtAws::Chime::CreateMediaCapturePipelineResponsePrivate
...
CreateMediaCapturePipelineResponsePrivate::CreateMediaCapturePipelineResponsePrivate(
    CreateMediaCapturePipelineResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateMediaCapturePipeline response element from \a xml.
 */
