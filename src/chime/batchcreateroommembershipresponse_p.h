...
class QTAWS_EXPORT BatchCreateRoomMembershipResponsePrivate : public ChimeResponsePrivate {

public:

    BatchCreateRoomMembershipResponsePrivate(BatchCreateRoomMembershipResponse * const q);
