...
#include "disassociatesignindelegategroupsfromaccountrequest_p.h"
...
/*!
 * \class QtAws::Chime::DisassociateSigninDelegateGroupsFromAccountRequest
 * \brief The DisassociateSigninDelegateGroupsFromAccountRequest class provides an interface for Chime DisassociateSigninDelegateGroupsFromAccount requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::disassociateSigninDelegateGroupsFromAccount
 */

/*!
 * Constructs a copy of \a other.
 */
DisassociateSigninDelegateGroupsFromAccountRequest::DisassociateSigninDelegateGroupsFromAccountRequest(const DisassociateSigninDelegateGroupsFromAccountRequest &other)
    : ChimeRequest(new DisassociateSigninDelegateGroupsFromAccountRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DisassociateSigninDelegateGroupsFromAccountRequest object.
 */
DisassociateSigninDelegateGroupsFromAccountRequest::DisassociateSigninDelegateGroupsFromAccountRequest()
    : ChimeRequest(new DisassociateSigninDelegateGroupsFromAccountRequestPrivate(ChimeRequest::DisassociateSigninDelegateGroupsFromAccountAction, this))
{
 ...
 * \reimp
 */
bool DisassociateSigninDelegateGroupsFromAccountRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DisassociateSigninDelegateGroupsFromAccountResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DisassociateSigninDelegateGroupsFromAccountRequest::response(QNetworkReply * const reply) const
{
    return new DisassociateSigninDelegateGroupsFromAccountResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DisassociateSigninDelegateGroupsFromAccountRequestPrivate
 * \brief The DisassociateSigninDelegateGroupsFromAccountRequestPrivate class provides private implementation for DisassociateSigninDelegateGroupsFromAccountRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DisassociateSigninDelegateGroupsFromAccountRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DisassociateSigninDelegateGroupsFromAccountRequestPrivate::DisassociateSigninDelegateGroupsFromAccountRequestPrivate(
    const ChimeRequest::Action action, DisassociateSigninDelegateGroupsFromAccountRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DisassociateSigninDelegateGroupsFromAccountRequest
 * class' copy constructor.
 */
DisassociateSigninDelegateGroupsFromAccountRequestPrivate::DisassociateSigninDelegateGroupsFromAccountRequestPrivate(
    const DisassociateSigninDelegateGroupsFromAccountRequestPrivate &other, DisassociateSigninDelegateGroupsFromAccountRequest * const q)
