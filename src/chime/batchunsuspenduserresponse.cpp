...
#include "batchunsuspenduserresponse_p.h"
...
/*!
 * \class QtAws::Chime::BatchUnsuspendUserResponse
 * \brief The BatchUnsuspendUserResponse class provides an interace for Chime BatchUnsuspendUser responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a BatchUnsuspendUserResponse object for \a reply to \a request, with parent \a parent.
 */
BatchUnsuspendUserResponse::BatchUnsuspendUserResponse(
        const BatchUnsuspendUserRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new BatchUnsuspendUserResponsePrivate(this), parent)
{
    setRequest(new BatchUnsuspendUserRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime BatchUnsuspendUser \a response.
 */
void BatchUnsuspendUserResponse::parseSuccess(QIODevice &response)
{
    //Q_D(BatchUnsuspendUserResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::BatchUnsuspendUserResponsePrivate
 * \brief The BatchUnsuspendUserResponsePrivate class provides private implementation for BatchUnsuspendUserResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a BatchUnsuspendUserResponsePrivate object with public implementation \a q.
 */
BatchUnsuspendUserResponsePrivate::BatchUnsuspendUserResponsePrivate(
    BatchUnsuspendUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime BatchUnsuspendUser response element from \a xml.
 */
void BatchUnsuspendUserResponsePrivate::parseBatchUnsuspendUserResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("BatchUnsuspendUserResponse"));
    Q_UNUSED(xml) ///< @todo
}
