...
#include "deletephonenumberresponse_p.h"
...
/*!
 * \class QtAws::Chime::DeletePhoneNumberResponse
 * \brief The DeletePhoneNumberResponse class provides an interace for Chime DeletePhoneNumber responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a DeletePhoneNumberResponse object for \a reply to \a request, with parent \a parent.
 */
DeletePhoneNumberResponse::DeletePhoneNumberResponse(
        const DeletePhoneNumberRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DeletePhoneNumberResponsePrivate(this), parent)
{
    setRequest(new DeletePhoneNumberRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime DeletePhoneNumber \a response.
 */
void DeletePhoneNumberResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeletePhoneNumberResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DeletePhoneNumberResponsePrivate
 * \brief The DeletePhoneNumberResponsePrivate class provides private implementation for DeletePhoneNumberResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeletePhoneNumberResponsePrivate object with public implementation \a q.
 */
DeletePhoneNumberResponsePrivate::DeletePhoneNumberResponsePrivate(
    DeletePhoneNumberResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeletePhoneNumber response element from \a xml.
 */
void DeletePhoneNumberResponsePrivate::parseDeletePhoneNumberResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeletePhoneNumberResponse"));
    Q_UNUSED(xml) ///< @todo
}
