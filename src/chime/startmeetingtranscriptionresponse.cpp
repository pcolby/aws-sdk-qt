...
/*!
 * \class QtAws::Chime::StartMeetingTranscriptionResponse
 * \brief The StartMeetingTranscriptionResponse class provides an interace for Chime StartMeetingTranscription responses.
 *
 * \inmodule QtAwsChime
 *
...
StartMeetingTranscriptionResponse::StartMeetingTranscriptionResponse(
    ...
    : ChimeResponse(new StartMeetingTranscriptionResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime StartMeetingTranscription \a response.
 */
...
/*!
 * \class QtAws::Chime::StartMeetingTranscriptionResponsePrivate
...
StartMeetingTranscriptionResponsePrivate::StartMeetingTranscriptionResponsePrivate(
    StartMeetingTranscriptionResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime StartMeetingTranscription response element from \a xml.
 */
