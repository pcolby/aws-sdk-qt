...
#include "associatephonenumberwithuserresponse_p.h"
...
/*!
 * \class QtAws::Chime::AssociatePhoneNumberWithUserResponse
 * \brief The AssociatePhoneNumberWithUserResponse class provides an interace for Chime AssociatePhoneNumberWithUser responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a AssociatePhoneNumberWithUserResponse object for \a reply to \a request, with parent \a parent.
 */
AssociatePhoneNumberWithUserResponse::AssociatePhoneNumberWithUserResponse(
        const AssociatePhoneNumberWithUserRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new AssociatePhoneNumberWithUserResponsePrivate(this), parent)
{
    setRequest(new AssociatePhoneNumberWithUserRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime AssociatePhoneNumberWithUser \a response.
 */
void AssociatePhoneNumberWithUserResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AssociatePhoneNumberWithUserResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::AssociatePhoneNumberWithUserResponsePrivate
 * \brief The AssociatePhoneNumberWithUserResponsePrivate class provides private implementation for AssociatePhoneNumberWithUserResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a AssociatePhoneNumberWithUserResponsePrivate object with public implementation \a q.
 */
AssociatePhoneNumberWithUserResponsePrivate::AssociatePhoneNumberWithUserResponsePrivate(
    AssociatePhoneNumberWithUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime AssociatePhoneNumberWithUser response element from \a xml.
 */
void AssociatePhoneNumberWithUserResponsePrivate::parseAssociatePhoneNumberWithUserResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AssociatePhoneNumberWithUserResponse"));
    Q_UNUSED(xml) ///< @todo
}
