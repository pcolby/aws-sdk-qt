...
class QTAWS_EXPORT GetEventsConfigurationResponsePrivate : public ChimeResponsePrivate {

public:

    GetEventsConfigurationResponsePrivate(GetEventsConfigurationResponse * const q);
