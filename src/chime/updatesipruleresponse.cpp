...
#include "updatesipruleresponse_p.h"
...
/*!
 * \class QtAws::Chime::UpdateSipRuleResponse
 * \brief The UpdateSipRuleResponse class provides an interace for Chime UpdateSipRule responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::updateSipRule
 */

/*!
 * Constructs a UpdateSipRuleResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateSipRuleResponse::UpdateSipRuleResponse(
        const UpdateSipRuleRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new UpdateSipRuleResponsePrivate(this), parent)
{
    setRequest(new UpdateSipRuleRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateSipRuleRequest * UpdateSipRuleResponse::request() const
{
    Q_D(const UpdateSipRuleResponse);
    return static_cast<const UpdateSipRuleRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime UpdateSipRule \a response.
 */
void UpdateSipRuleResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateSipRuleResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::UpdateSipRuleResponsePrivate
 * \brief The UpdateSipRuleResponsePrivate class provides private implementation for UpdateSipRuleResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UpdateSipRuleResponsePrivate object with public implementation \a q.
 */
UpdateSipRuleResponsePrivate::UpdateSipRuleResponsePrivate(
    UpdateSipRuleResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateSipRule response element from \a xml.
 */
void UpdateSipRuleResponsePrivate::parseUpdateSipRuleResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateSipRuleResponse"));
    Q_UNUSED(xml) ///< @todo
}
