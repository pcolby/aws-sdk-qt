...
/*!
 * \class QtAws::Chime::ListAppInstanceUsersResponse
 * \brief The ListAppInstanceUsersResponse class provides an interace for Chime ListAppInstanceUsers responses.
 *
 * \inmodule QtAwsChime
 *
...
ListAppInstanceUsersResponse::ListAppInstanceUsersResponse(
    ...
    : ChimeResponse(new ListAppInstanceUsersResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime ListAppInstanceUsers \a response.
 */
...
/*!
 * \class QtAws::Chime::ListAppInstanceUsersResponsePrivate
...
ListAppInstanceUsersResponsePrivate::ListAppInstanceUsersResponsePrivate(
    ListAppInstanceUsersResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListAppInstanceUsers response element from \a xml.
 */
