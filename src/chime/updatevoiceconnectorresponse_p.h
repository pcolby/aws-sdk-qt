...
class QTAWS_EXPORT UpdateVoiceConnectorResponsePrivate : public ChimeResponsePrivate {

public:

    UpdateVoiceConnectorResponsePrivate(UpdateVoiceConnectorResponse * const q);
