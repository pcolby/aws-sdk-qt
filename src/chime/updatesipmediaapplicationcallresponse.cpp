...
#include "updatesipmediaapplicationcallresponse_p.h"
...
/*!
 * \class QtAws::Chime::UpdateSipMediaApplicationCallResponse
 * \brief The UpdateSipMediaApplicationCallResponse class provides an interace for Chime UpdateSipMediaApplicationCall responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a UpdateSipMediaApplicationCallResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateSipMediaApplicationCallResponse::UpdateSipMediaApplicationCallResponse(
        const UpdateSipMediaApplicationCallRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new UpdateSipMediaApplicationCallResponsePrivate(this), parent)
{
    setRequest(new UpdateSipMediaApplicationCallRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateSipMediaApplicationCallRequest * UpdateSipMediaApplicationCallResponse::request() const
{
    Q_D(const UpdateSipMediaApplicationCallResponse);
    return static_cast<const UpdateSipMediaApplicationCallRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime UpdateSipMediaApplicationCall \a response.
 */
void UpdateSipMediaApplicationCallResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateSipMediaApplicationCallResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::UpdateSipMediaApplicationCallResponsePrivate
 * \brief The UpdateSipMediaApplicationCallResponsePrivate class provides private implementation for UpdateSipMediaApplicationCallResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UpdateSipMediaApplicationCallResponsePrivate object with public implementation \a q.
 */
UpdateSipMediaApplicationCallResponsePrivate::UpdateSipMediaApplicationCallResponsePrivate(
    UpdateSipMediaApplicationCallResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateSipMediaApplicationCall response element from \a xml.
 */
void UpdateSipMediaApplicationCallResponsePrivate::parseUpdateSipMediaApplicationCallResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateSipMediaApplicationCallResponse"));
    Q_UNUSED(xml) ///< @todo
}
