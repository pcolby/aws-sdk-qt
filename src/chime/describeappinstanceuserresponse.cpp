...
/*!
 * \class QtAws::Chime::DescribeAppInstanceUserResponse
 * \brief The DescribeAppInstanceUserResponse class provides an interace for Chime DescribeAppInstanceUser responses.
 *
 * \inmodule QtAwsChime
 *
...
DescribeAppInstanceUserResponse::DescribeAppInstanceUserResponse(
    ...
    : ChimeResponse(new DescribeAppInstanceUserResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DescribeAppInstanceUser \a response.
 */
...
/*!
 * \class QtAws::Chime::DescribeAppInstanceUserResponsePrivate
...
DescribeAppInstanceUserResponsePrivate::DescribeAppInstanceUserResponsePrivate(
    DescribeAppInstanceUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DescribeAppInstanceUser response element from \a xml.
 */
