...
#include "getvoiceconnectororiginationrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorOriginationRequest
 * \brief The GetVoiceConnectorOriginationRequest class provides an interface for Chime GetVoiceConnectorOrigination requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
GetVoiceConnectorOriginationRequest::GetVoiceConnectorOriginationRequest(const GetVoiceConnectorOriginationRequest &other)
    : ChimeRequest(new GetVoiceConnectorOriginationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetVoiceConnectorOriginationRequest object.
 */
GetVoiceConnectorOriginationRequest::GetVoiceConnectorOriginationRequest()
    : ChimeRequest(new GetVoiceConnectorOriginationRequestPrivate(ChimeRequest::GetVoiceConnectorOriginationAction, this))
{
 ...
 * \reimp
 */
bool GetVoiceConnectorOriginationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetVoiceConnectorOriginationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetVoiceConnectorOriginationRequest::response(QNetworkReply * const reply) const
{
    return new GetVoiceConnectorOriginationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorOriginationRequestPrivate
 * \brief The GetVoiceConnectorOriginationRequestPrivate class provides private implementation for GetVoiceConnectorOriginationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorOriginationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetVoiceConnectorOriginationRequestPrivate::GetVoiceConnectorOriginationRequestPrivate(
    const ChimeRequest::Action action, GetVoiceConnectorOriginationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetVoiceConnectorOriginationRequest
 * class' copy constructor.
 */
GetVoiceConnectorOriginationRequestPrivate::GetVoiceConnectorOriginationRequestPrivate(
    const GetVoiceConnectorOriginationRequestPrivate &other, GetVoiceConnectorOriginationRequest * const q)
