...
/*!
 * \class QtAws::Chime::CreateMeetingWithAttendeesRequest
 * \brief The CreateMeetingWithAttendeesRequest class provides an interface for Chime CreateMeetingWithAttendees requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createMeetingWithAttendees
 */
...
CreateMeetingWithAttendeesRequest::CreateMeetingWithAttendeesRequest(const CreateMeetingWithAttendeesRequest &other)
    : ChimeRequest(new CreateMeetingWithAttendeesRequestPrivate(*other.d_func(), this))
{
...
CreateMeetingWithAttendeesRequest::CreateMeetingWithAttendeesRequest()
    : ChimeRequest(new CreateMeetingWithAttendeesRequestPrivate(ChimeRequest::CreateMeetingWithAttendeesAction, this))
{
...
/*!
 * \class QtAws::Chime::CreateMeetingWithAttendeesRequestPrivate
...
/*!
 * Constructs a CreateMeetingWithAttendeesRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateMeetingWithAttendeesRequestPrivate::CreateMeetingWithAttendeesRequestPrivate(
    const ChimeRequest::Action action, CreateMeetingWithAttendeesRequest * const q)
