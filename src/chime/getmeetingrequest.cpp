...
/*!
 * \class QtAws::Chime::GetMeetingRequest
 * \brief The GetMeetingRequest class provides an interface for Chime GetMeeting requests.
 *
 * \inmodule QtAwsChime
 *
...
GetMeetingRequest::GetMeetingRequest(const GetMeetingRequest &other)
    : ChimeRequest(new GetMeetingRequestPrivate(*other.d_func(), this))
{
...
GetMeetingRequest::GetMeetingRequest()
    : ChimeRequest(new GetMeetingRequestPrivate(ChimeRequest::GetMeetingAction, this))
{
...
/*!
 * \class QtAws::Chime::GetMeetingRequestPrivate
...
/*!
 * Constructs a GetMeetingRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetMeetingRequestPrivate::GetMeetingRequestPrivate(
    const ChimeRequest::Action action, GetMeetingRequest * const q)
