...
/*!
 * \class QtAws::Chime::UpdateAccountSettingsRequest
 * \brief The UpdateAccountSettingsRequest class provides an interface for Chime UpdateAccountSettings requests.
 *
 * \inmodule QtAwsChime
 *
...
UpdateAccountSettingsRequest::UpdateAccountSettingsRequest(const UpdateAccountSettingsRequest &other)
    : ChimeRequest(new UpdateAccountSettingsRequestPrivate(*other.d_func(), this))
{
...
UpdateAccountSettingsRequest::UpdateAccountSettingsRequest()
    : ChimeRequest(new UpdateAccountSettingsRequestPrivate(ChimeRequest::UpdateAccountSettingsAction, this))
{
...
/*!
 * \class QtAws::Chime::UpdateAccountSettingsRequestPrivate
...
/*!
 * Constructs a UpdateAccountSettingsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateAccountSettingsRequestPrivate::UpdateAccountSettingsRequestPrivate(
    const ChimeRequest::Action action, UpdateAccountSettingsRequest * const q)
