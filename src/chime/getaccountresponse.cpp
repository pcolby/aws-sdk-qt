...
/*!
 * \class QtAws::Chime::GetAccountResponse
 * \brief The GetAccountResponse class provides an interace for Chime GetAccount responses.
 *
 * \inmodule QtAwsChime
 *
...
GetAccountResponse::GetAccountResponse(
    ...
    : ChimeResponse(new GetAccountResponsePrivate(this), parent)
{
...
{
    return static_cast<const GetAccountRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime GetAccount \a response.
 */
...
/*!
 * \class QtAws::Chime::GetAccountResponsePrivate
...
GetAccountResponsePrivate::GetAccountResponsePrivate(
    GetAccountResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetAccount response element from \a xml.
 */
