...
#include "batchupdateuserrequest_p.h"
...
/*!
 * \class QtAws::Chime::BatchUpdateUserRequest
 * \brief The BatchUpdateUserRequest class provides an interface for Chime BatchUpdateUser requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::batchUpdateUser
 */

/*!
 * Constructs a copy of \a other.
 */
BatchUpdateUserRequest::BatchUpdateUserRequest(const BatchUpdateUserRequest &other)
    : ChimeRequest(new BatchUpdateUserRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a BatchUpdateUserRequest object.
 */
BatchUpdateUserRequest::BatchUpdateUserRequest()
    : ChimeRequest(new BatchUpdateUserRequestPrivate(ChimeRequest::BatchUpdateUserAction, this))
{
 ...
 * \reimp
 */
bool BatchUpdateUserRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BatchUpdateUserResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BatchUpdateUserRequest::response(QNetworkReply * const reply) const
{
    return new BatchUpdateUserResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::BatchUpdateUserRequestPrivate
 * \brief The BatchUpdateUserRequestPrivate class provides private implementation for BatchUpdateUserRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a BatchUpdateUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
BatchUpdateUserRequestPrivate::BatchUpdateUserRequestPrivate(
    const ChimeRequest::Action action, BatchUpdateUserRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the BatchUpdateUserRequest
 * class' copy constructor.
 */
BatchUpdateUserRequestPrivate::BatchUpdateUserRequestPrivate(
    const BatchUpdateUserRequestPrivate &other, BatchUpdateUserRequest * const q)
