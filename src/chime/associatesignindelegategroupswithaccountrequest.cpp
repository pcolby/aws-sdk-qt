...
#include "associatesignindelegategroupswithaccountrequest_p.h"
...
/*!
 * \class QtAws::Chime::AssociateSigninDelegateGroupsWithAccountRequest
 * \brief The AssociateSigninDelegateGroupsWithAccountRequest class provides an interface for Chime AssociateSigninDelegateGroupsWithAccount requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::associateSigninDelegateGroupsWithAccount
 */

/*!
 * Constructs a copy of \a other.
 */
AssociateSigninDelegateGroupsWithAccountRequest::AssociateSigninDelegateGroupsWithAccountRequest(const AssociateSigninDelegateGroupsWithAccountRequest &other)
    : ChimeRequest(new AssociateSigninDelegateGroupsWithAccountRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AssociateSigninDelegateGroupsWithAccountRequest object.
 */
AssociateSigninDelegateGroupsWithAccountRequest::AssociateSigninDelegateGroupsWithAccountRequest()
    : ChimeRequest(new AssociateSigninDelegateGroupsWithAccountRequestPrivate(ChimeRequest::AssociateSigninDelegateGroupsWithAccountAction, this))
{
 ...
 * \reimp
 */
bool AssociateSigninDelegateGroupsWithAccountRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AssociateSigninDelegateGroupsWithAccountResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AssociateSigninDelegateGroupsWithAccountRequest::response(QNetworkReply * const reply) const
{
    return new AssociateSigninDelegateGroupsWithAccountResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::AssociateSigninDelegateGroupsWithAccountRequestPrivate
 * \brief The AssociateSigninDelegateGroupsWithAccountRequestPrivate class provides private implementation for AssociateSigninDelegateGroupsWithAccountRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a AssociateSigninDelegateGroupsWithAccountRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
AssociateSigninDelegateGroupsWithAccountRequestPrivate::AssociateSigninDelegateGroupsWithAccountRequestPrivate(
    const ChimeRequest::Action action, AssociateSigninDelegateGroupsWithAccountRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AssociateSigninDelegateGroupsWithAccountRequest
 * class' copy constructor.
 */
AssociateSigninDelegateGroupsWithAccountRequestPrivate::AssociateSigninDelegateGroupsWithAccountRequestPrivate(
    const AssociateSigninDelegateGroupsWithAccountRequestPrivate &other, AssociateSigninDelegateGroupsWithAccountRequest * const q)
