...
#include "listsiprulesresponse_p.h"
...
/*!
 * \class QtAws::Chime::ListSipRulesResponse
 * \brief The ListSipRulesResponse class provides an interace for Chime ListSipRules responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a ListSipRulesResponse object for \a reply to \a request, with parent \a parent.
 */
ListSipRulesResponse::ListSipRulesResponse(
        const ListSipRulesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new ListSipRulesResponsePrivate(this), parent)
{
    setRequest(new ListSipRulesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime ListSipRules \a response.
 */
void ListSipRulesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListSipRulesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::ListSipRulesResponsePrivate
 * \brief The ListSipRulesResponsePrivate class provides private implementation for ListSipRulesResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListSipRulesResponsePrivate object with public implementation \a q.
 */
ListSipRulesResponsePrivate::ListSipRulesResponsePrivate(
    ListSipRulesResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListSipRules response element from \a xml.
 */
void ListSipRulesResponsePrivate::parseListSipRulesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListSipRulesResponse"));
    Q_UNUSED(xml) ///< @todo
}
