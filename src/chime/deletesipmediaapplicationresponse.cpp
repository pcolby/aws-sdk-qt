...
#include "deletesipmediaapplicationresponse_p.h"
...
/*!
 * \class QtAws::Chime::DeleteSipMediaApplicationResponse
 * \brief The DeleteSipMediaApplicationResponse class provides an interace for Chime DeleteSipMediaApplication responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a DeleteSipMediaApplicationResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteSipMediaApplicationResponse::DeleteSipMediaApplicationResponse(
        const DeleteSipMediaApplicationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DeleteSipMediaApplicationResponsePrivate(this), parent)
{
    setRequest(new DeleteSipMediaApplicationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime DeleteSipMediaApplication \a response.
 */
void DeleteSipMediaApplicationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteSipMediaApplicationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DeleteSipMediaApplicationResponsePrivate
 * \brief The DeleteSipMediaApplicationResponsePrivate class provides private implementation for DeleteSipMediaApplicationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteSipMediaApplicationResponsePrivate object with public implementation \a q.
 */
DeleteSipMediaApplicationResponsePrivate::DeleteSipMediaApplicationResponsePrivate(
    DeleteSipMediaApplicationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteSipMediaApplication response element from \a xml.
 */
void DeleteSipMediaApplicationResponsePrivate::parseDeleteSipMediaApplicationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteSipMediaApplicationResponse"));
    Q_UNUSED(xml) ///< @todo
}
