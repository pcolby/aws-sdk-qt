...
#include "resetpersonalpinrequest_p.h"
...
/*!
 * \class QtAws::Chime::ResetPersonalPINRequest
 * \brief The ResetPersonalPINRequest class provides an interface for Chime ResetPersonalPIN requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::resetPersonalPIN
 */

/*!
 * Constructs a copy of \a other.
 */
ResetPersonalPINRequest::ResetPersonalPINRequest(const ResetPersonalPINRequest &other)
    : ChimeRequest(new ResetPersonalPINRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ResetPersonalPINRequest object.
 */
ResetPersonalPINRequest::ResetPersonalPINRequest()
    : ChimeRequest(new ResetPersonalPINRequestPrivate(ChimeRequest::ResetPersonalPINAction, this))
{
 ...
 * \reimp
 */
bool ResetPersonalPINRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ResetPersonalPINResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ResetPersonalPINRequest::response(QNetworkReply * const reply) const
{
    return new ResetPersonalPINResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::ResetPersonalPINRequestPrivate
 * \brief The ResetPersonalPINRequestPrivate class provides private implementation for ResetPersonalPINRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ResetPersonalPINRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ResetPersonalPINRequestPrivate::ResetPersonalPINRequestPrivate(
    const ChimeRequest::Action action, ResetPersonalPINRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ResetPersonalPINRequest
 * class' copy constructor.
 */
ResetPersonalPINRequestPrivate::ResetPersonalPINRequestPrivate(
    const ResetPersonalPINRequestPrivate &other, ResetPersonalPINRequest * const q)
