...
#include "createphonenumberorderresponse_p.h"
...
/*!
 * \class QtAws::Chime::CreatePhoneNumberOrderResponse
 * \brief The CreatePhoneNumberOrderResponse class provides an interace for Chime CreatePhoneNumberOrder responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a CreatePhoneNumberOrderResponse object for \a reply to \a request, with parent \a parent.
 */
CreatePhoneNumberOrderResponse::CreatePhoneNumberOrderResponse(
        const CreatePhoneNumberOrderRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new CreatePhoneNumberOrderResponsePrivate(this), parent)
{
    setRequest(new CreatePhoneNumberOrderRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime CreatePhoneNumberOrder \a response.
 */
void CreatePhoneNumberOrderResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreatePhoneNumberOrderResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::CreatePhoneNumberOrderResponsePrivate
 * \brief The CreatePhoneNumberOrderResponsePrivate class provides private implementation for CreatePhoneNumberOrderResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreatePhoneNumberOrderResponsePrivate object with public implementation \a q.
 */
CreatePhoneNumberOrderResponsePrivate::CreatePhoneNumberOrderResponsePrivate(
    CreatePhoneNumberOrderResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreatePhoneNumberOrder response element from \a xml.
 */
void CreatePhoneNumberOrderResponsePrivate::parseCreatePhoneNumberOrderResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreatePhoneNumberOrderResponse"));
    Q_UNUSED(xml) ///< @todo
}
