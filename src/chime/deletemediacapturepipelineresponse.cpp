...
/*!
 * \class QtAws::Chime::DeleteMediaCapturePipelineResponse
 * \brief The DeleteMediaCapturePipelineResponse class provides an interace for Chime DeleteMediaCapturePipeline responses.
 *
 * \inmodule QtAwsChime
 *
...
DeleteMediaCapturePipelineResponse::DeleteMediaCapturePipelineResponse(
    ...
    : ChimeResponse(new DeleteMediaCapturePipelineResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DeleteMediaCapturePipeline \a response.
 */
...
/*!
 * \class QtAws::Chime::DeleteMediaCapturePipelineResponsePrivate
...
DeleteMediaCapturePipelineResponsePrivate::DeleteMediaCapturePipelineResponsePrivate(
    DeleteMediaCapturePipelineResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteMediaCapturePipeline response element from \a xml.
 */
