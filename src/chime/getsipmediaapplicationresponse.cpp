...
#include "getsipmediaapplicationresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetSipMediaApplicationResponse
 * \brief The GetSipMediaApplicationResponse class provides an interace for Chime GetSipMediaApplication responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getSipMediaApplication
 */

/*!
 * Constructs a GetSipMediaApplicationResponse object for \a reply to \a request, with parent \a parent.
 */
GetSipMediaApplicationResponse::GetSipMediaApplicationResponse(
        const GetSipMediaApplicationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetSipMediaApplicationResponsePrivate(this), parent)
{
    setRequest(new GetSipMediaApplicationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetSipMediaApplicationRequest * GetSipMediaApplicationResponse::request() const
{
    Q_D(const GetSipMediaApplicationResponse);
    return static_cast<const GetSipMediaApplicationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime GetSipMediaApplication \a response.
 */
void GetSipMediaApplicationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetSipMediaApplicationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetSipMediaApplicationResponsePrivate
 * \brief The GetSipMediaApplicationResponsePrivate class provides private implementation for GetSipMediaApplicationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetSipMediaApplicationResponsePrivate object with public implementation \a q.
 */
GetSipMediaApplicationResponsePrivate::GetSipMediaApplicationResponsePrivate(
    GetSipMediaApplicationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetSipMediaApplication response element from \a xml.
 */
void GetSipMediaApplicationResponsePrivate::parseGetSipMediaApplicationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetSipMediaApplicationResponse"));
    Q_UNUSED(xml) ///< @todo
}
