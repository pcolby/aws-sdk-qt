...
/*!
 * \class QtAws::Chime::SendChannelMessageResponse
 * \brief The SendChannelMessageResponse class provides an interace for Chime SendChannelMessage responses.
 *
 * \inmodule QtAwsChime
 *
...
SendChannelMessageResponse::SendChannelMessageResponse(
    ...
    : ChimeResponse(new SendChannelMessageResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime SendChannelMessage \a response.
 */
...
/*!
 * \class QtAws::Chime::SendChannelMessageResponsePrivate
...
SendChannelMessageResponsePrivate::SendChannelMessageResponsePrivate(
    SendChannelMessageResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime SendChannelMessage response element from \a xml.
 */
