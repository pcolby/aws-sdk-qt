...
#include "tagmeetingresponse_p.h"
...
/*!
 * \class QtAws::Chime::TagMeetingResponse
 * \brief The TagMeetingResponse class provides an interace for Chime TagMeeting responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a TagMeetingResponse object for \a reply to \a request, with parent \a parent.
 */
TagMeetingResponse::TagMeetingResponse(
        const TagMeetingRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new TagMeetingResponsePrivate(this), parent)
{
    setRequest(new TagMeetingRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime TagMeeting \a response.
 */
void TagMeetingResponse::parseSuccess(QIODevice &response)
{
    //Q_D(TagMeetingResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::TagMeetingResponsePrivate
 * \brief The TagMeetingResponsePrivate class provides private implementation for TagMeetingResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a TagMeetingResponsePrivate object with public implementation \a q.
 */
TagMeetingResponsePrivate::TagMeetingResponsePrivate(
    TagMeetingResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime TagMeeting response element from \a xml.
 */
void TagMeetingResponsePrivate::parseTagMeetingResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("TagMeetingResponse"));
    Q_UNUSED(xml) ///< @todo
}
