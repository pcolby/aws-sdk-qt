...
/*!
 * \class QtAws::Chime::GetMediaCapturePipelineRequest
 * \brief The GetMediaCapturePipelineRequest class provides an interface for Chime GetMediaCapturePipeline requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getMediaCapturePipeline
 */
...
GetMediaCapturePipelineRequest::GetMediaCapturePipelineRequest(const GetMediaCapturePipelineRequest &other)
    : ChimeRequest(new GetMediaCapturePipelineRequestPrivate(*other.d_func(), this))
{
...
GetMediaCapturePipelineRequest::GetMediaCapturePipelineRequest()
    : ChimeRequest(new GetMediaCapturePipelineRequestPrivate(ChimeRequest::GetMediaCapturePipelineAction, this))
{
...
/*!
 * \class QtAws::Chime::GetMediaCapturePipelineRequestPrivate
...
/*!
 * Constructs a GetMediaCapturePipelineRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetMediaCapturePipelineRequestPrivate::GetMediaCapturePipelineRequestPrivate(
    const ChimeRequest::Action action, GetMediaCapturePipelineRequest * const q)
