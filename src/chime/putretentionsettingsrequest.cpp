...
#include "putretentionsettingsrequest_p.h"
...
/*!
 * \class QtAws::Chime::PutRetentionSettingsRequest
 * \brief The PutRetentionSettingsRequest class provides an interface for Chime PutRetentionSettings requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
PutRetentionSettingsRequest::PutRetentionSettingsRequest(const PutRetentionSettingsRequest &other)
    : ChimeRequest(new PutRetentionSettingsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutRetentionSettingsRequest object.
 */
PutRetentionSettingsRequest::PutRetentionSettingsRequest()
    : ChimeRequest(new PutRetentionSettingsRequestPrivate(ChimeRequest::PutRetentionSettingsAction, this))
{
 ...
 * \reimp
 */
bool PutRetentionSettingsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutRetentionSettingsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutRetentionSettingsRequest::response(QNetworkReply * const reply) const
{
    return new PutRetentionSettingsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::PutRetentionSettingsRequestPrivate
 * \brief The PutRetentionSettingsRequestPrivate class provides private implementation for PutRetentionSettingsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutRetentionSettingsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
PutRetentionSettingsRequestPrivate::PutRetentionSettingsRequestPrivate(
    const ChimeRequest::Action action, PutRetentionSettingsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutRetentionSettingsRequest
 * class' copy constructor.
 */
PutRetentionSettingsRequestPrivate::PutRetentionSettingsRequestPrivate(
    const PutRetentionSettingsRequestPrivate &other, PutRetentionSettingsRequest * const q)
