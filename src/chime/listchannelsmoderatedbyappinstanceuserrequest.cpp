...
/*!
 * \class QtAws::Chime::ListChannelsModeratedByAppInstanceUserRequest
 * \brief The ListChannelsModeratedByAppInstanceUserRequest class provides an interface for Chime ListChannelsModeratedByAppInstanceUser requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listChannelsModeratedByAppInstanceUser
 */
...
ListChannelsModeratedByAppInstanceUserRequest::ListChannelsModeratedByAppInstanceUserRequest(const ListChannelsModeratedByAppInstanceUserRequest &other)
    : ChimeRequest(new ListChannelsModeratedByAppInstanceUserRequestPrivate(*other.d_func(), this))
{
...
ListChannelsModeratedByAppInstanceUserRequest::ListChannelsModeratedByAppInstanceUserRequest()
    : ChimeRequest(new ListChannelsModeratedByAppInstanceUserRequestPrivate(ChimeRequest::ListChannelsModeratedByAppInstanceUserAction, this))
{
...
/*!
 * \class QtAws::Chime::ListChannelsModeratedByAppInstanceUserRequestPrivate
...
/*!
 * Constructs a ListChannelsModeratedByAppInstanceUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListChannelsModeratedByAppInstanceUserRequestPrivate::ListChannelsModeratedByAppInstanceUserRequestPrivate(
    const ChimeRequest::Action action, ListChannelsModeratedByAppInstanceUserRequest * const q)
