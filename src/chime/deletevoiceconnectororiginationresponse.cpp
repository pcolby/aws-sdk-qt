...
#include "deletevoiceconnectororiginationresponse_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorOriginationResponse
 * \brief The DeleteVoiceConnectorOriginationResponse class provides an interace for Chime DeleteVoiceConnectorOrigination responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteVoiceConnectorOrigination
 */

/*!
 * Constructs a DeleteVoiceConnectorOriginationResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteVoiceConnectorOriginationResponse::DeleteVoiceConnectorOriginationResponse(
    ...
    : ChimeResponse(new DeleteVoiceConnectorOriginationResponsePrivate(this), parent)
{
    setRequest(new DeleteVoiceConnectorOriginationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteVoiceConnectorOriginationRequest * DeleteVoiceConnectorOriginationResponse::request() const
{
    Q_D(const DeleteVoiceConnectorOriginationResponse);
    return static_cast<const DeleteVoiceConnectorOriginationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime DeleteVoiceConnectorOrigination \a response.
 */
void DeleteVoiceConnectorOriginationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteVoiceConnectorOriginationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorOriginationResponsePrivate
 * \brief The DeleteVoiceConnectorOriginationResponsePrivate class provides private implementation for DeleteVoiceConnectorOriginationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorOriginationResponsePrivate object with public implementation \a q.
 */
DeleteVoiceConnectorOriginationResponsePrivate::DeleteVoiceConnectorOriginationResponsePrivate(
    DeleteVoiceConnectorOriginationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteVoiceConnectorOrigination response element from \a xml.
 */
void DeleteVoiceConnectorOriginationResponsePrivate::parseDeleteVoiceConnectorOriginationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteVoiceConnectorOriginationResponse"));
    Q_UNUSED(xml) ///< @todo
}
