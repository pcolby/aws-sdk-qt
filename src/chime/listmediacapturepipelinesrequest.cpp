...
/*!
 * \class QtAws::Chime::ListMediaCapturePipelinesRequest
 * \brief The ListMediaCapturePipelinesRequest class provides an interface for Chime ListMediaCapturePipelines requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listMediaCapturePipelines
 */
...
ListMediaCapturePipelinesRequest::ListMediaCapturePipelinesRequest(const ListMediaCapturePipelinesRequest &other)
    : ChimeRequest(new ListMediaCapturePipelinesRequestPrivate(*other.d_func(), this))
{
...
ListMediaCapturePipelinesRequest::ListMediaCapturePipelinesRequest()
    : ChimeRequest(new ListMediaCapturePipelinesRequestPrivate(ChimeRequest::ListMediaCapturePipelinesAction, this))
{
...
/*!
 * \class QtAws::Chime::ListMediaCapturePipelinesRequestPrivate
...
/*!
 * Constructs a ListMediaCapturePipelinesRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListMediaCapturePipelinesRequestPrivate::ListMediaCapturePipelinesRequestPrivate(
    const ChimeRequest::Action action, ListMediaCapturePipelinesRequest * const q)
