...
/*!
 * \class QtAws::Chime::GetUserSettingsRequest
 * \brief The GetUserSettingsRequest class provides an interface for Chime GetUserSettings requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getUserSettings
 */
...
GetUserSettingsRequest::GetUserSettingsRequest(const GetUserSettingsRequest &other)
    : ChimeRequest(new GetUserSettingsRequestPrivate(*other.d_func(), this))
{
...
GetUserSettingsRequest::GetUserSettingsRequest()
    : ChimeRequest(new GetUserSettingsRequestPrivate(ChimeRequest::GetUserSettingsAction, this))
{
...
/*!
 * \class QtAws::Chime::GetUserSettingsRequestPrivate
...
/*!
 * Constructs a GetUserSettingsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetUserSettingsRequestPrivate::GetUserSettingsRequestPrivate(
    const ChimeRequest::Action action, GetUserSettingsRequest * const q)
