...
#include "getsipmediaapplicationloggingconfigurationrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetSipMediaApplicationLoggingConfigurationRequest
 * \brief The GetSipMediaApplicationLoggingConfigurationRequest class provides an interface for Chime GetSipMediaApplicationLoggingConfiguration requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getSipMediaApplicationLoggingConfiguration
 */

/*!
 * Constructs a copy of \a other.
 */
GetSipMediaApplicationLoggingConfigurationRequest::GetSipMediaApplicationLoggingConfigurationRequest(const GetSipMediaApplicationLoggingConfigurationRequest &other)
    : ChimeRequest(new GetSipMediaApplicationLoggingConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetSipMediaApplicationLoggingConfigurationRequest object.
 */
GetSipMediaApplicationLoggingConfigurationRequest::GetSipMediaApplicationLoggingConfigurationRequest()
    : ChimeRequest(new GetSipMediaApplicationLoggingConfigurationRequestPrivate(ChimeRequest::GetSipMediaApplicationLoggingConfigurationAction, this))
{
 ...
 * \reimp
 */
bool GetSipMediaApplicationLoggingConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetSipMediaApplicationLoggingConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetSipMediaApplicationLoggingConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new GetSipMediaApplicationLoggingConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetSipMediaApplicationLoggingConfigurationRequestPrivate
 * \brief The GetSipMediaApplicationLoggingConfigurationRequestPrivate class provides private implementation for GetSipMediaApplicationLoggingConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetSipMediaApplicationLoggingConfigurationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetSipMediaApplicationLoggingConfigurationRequestPrivate::GetSipMediaApplicationLoggingConfigurationRequestPrivate(
    const ChimeRequest::Action action, GetSipMediaApplicationLoggingConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetSipMediaApplicationLoggingConfigurationRequest
 * class' copy constructor.
 */
GetSipMediaApplicationLoggingConfigurationRequestPrivate::GetSipMediaApplicationLoggingConfigurationRequestPrivate(
    const GetSipMediaApplicationLoggingConfigurationRequestPrivate &other, GetSipMediaApplicationLoggingConfigurationRequest * const q)
