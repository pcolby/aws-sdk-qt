...
#include "deleteeventsconfigurationresponse_p.h"
...
/*!
 * \class QtAws::Chime::DeleteEventsConfigurationResponse
 * \brief The DeleteEventsConfigurationResponse class provides an interace for Chime DeleteEventsConfiguration responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a DeleteEventsConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteEventsConfigurationResponse::DeleteEventsConfigurationResponse(
        const DeleteEventsConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DeleteEventsConfigurationResponsePrivate(this), parent)
{
    setRequest(new DeleteEventsConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime DeleteEventsConfiguration \a response.
 */
void DeleteEventsConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteEventsConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DeleteEventsConfigurationResponsePrivate
 * \brief The DeleteEventsConfigurationResponsePrivate class provides private implementation for DeleteEventsConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteEventsConfigurationResponsePrivate object with public implementation \a q.
 */
DeleteEventsConfigurationResponsePrivate::DeleteEventsConfigurationResponsePrivate(
    DeleteEventsConfigurationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteEventsConfiguration response element from \a xml.
 */
void DeleteEventsConfigurationResponsePrivate::parseDeleteEventsConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteEventsConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
