...
/*!
 * \class QtAws::Chime::DescribeChannelModeratedByAppInstanceUserResponse
 * \brief The DescribeChannelModeratedByAppInstanceUserResponse class provides an interace for Chime DescribeChannelModeratedByAppInstanceUser responses.
 *
 * \inmodule QtAwsChime
 *
...
DescribeChannelModeratedByAppInstanceUserResponse::DescribeChannelModeratedByAppInstanceUserResponse(
    ...
    : ChimeResponse(new DescribeChannelModeratedByAppInstanceUserResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DescribeChannelModeratedByAppInstanceUser \a response.
 */
...
/*!
 * \class QtAws::Chime::DescribeChannelModeratedByAppInstanceUserResponsePrivate
...
DescribeChannelModeratedByAppInstanceUserResponsePrivate::DescribeChannelModeratedByAppInstanceUserResponsePrivate(
    DescribeChannelModeratedByAppInstanceUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DescribeChannelModeratedByAppInstanceUser response element from \a xml.
 */
