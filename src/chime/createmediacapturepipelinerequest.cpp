...
/*!
 * \class QtAws::Chime::CreateMediaCapturePipelineRequest
 * \brief The CreateMediaCapturePipelineRequest class provides an interface for Chime CreateMediaCapturePipeline requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createMediaCapturePipeline
 */
...
CreateMediaCapturePipelineRequest::CreateMediaCapturePipelineRequest(const CreateMediaCapturePipelineRequest &other)
    : ChimeRequest(new CreateMediaCapturePipelineRequestPrivate(*other.d_func(), this))
{
...
CreateMediaCapturePipelineRequest::CreateMediaCapturePipelineRequest()
    : ChimeRequest(new CreateMediaCapturePipelineRequestPrivate(ChimeRequest::CreateMediaCapturePipelineAction, this))
{
...
/*!
 * \class QtAws::Chime::CreateMediaCapturePipelineRequestPrivate
...
/*!
 * Constructs a CreateMediaCapturePipelineRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateMediaCapturePipelineRequestPrivate::CreateMediaCapturePipelineRequestPrivate(
    const ChimeRequest::Action action, CreateMediaCapturePipelineRequest * const q)
