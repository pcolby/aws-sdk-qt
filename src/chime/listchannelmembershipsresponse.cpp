...
/*!
 * \class QtAws::Chime::ListChannelMembershipsResponse
 * \brief The ListChannelMembershipsResponse class provides an interace for Chime ListChannelMemberships responses.
 *
 * \inmodule QtAwsChime
 *
...
ListChannelMembershipsResponse::ListChannelMembershipsResponse(
    ...
    : ChimeResponse(new ListChannelMembershipsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime ListChannelMemberships \a response.
 */
...
/*!
 * \class QtAws::Chime::ListChannelMembershipsResponsePrivate
...
ListChannelMembershipsResponsePrivate::ListChannelMembershipsResponsePrivate(
    ListChannelMembershipsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListChannelMemberships response element from \a xml.
 */
