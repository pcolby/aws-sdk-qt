...
#include "deletevoiceconnectorterminationcredentialsresponse_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorTerminationCredentialsResponse
 * \brief The DeleteVoiceConnectorTerminationCredentialsResponse class provides an interace for Chime DeleteVoiceConnectorTerminationCredentials responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a DeleteVoiceConnectorTerminationCredentialsResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteVoiceConnectorTerminationCredentialsResponse::DeleteVoiceConnectorTerminationCredentialsResponse(
        const DeleteVoiceConnectorTerminationCredentialsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DeleteVoiceConnectorTerminationCredentialsResponsePrivate(this), parent)
{
    setRequest(new DeleteVoiceConnectorTerminationCredentialsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime DeleteVoiceConnectorTerminationCredentials \a response.
 */
void DeleteVoiceConnectorTerminationCredentialsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteVoiceConnectorTerminationCredentialsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorTerminationCredentialsResponsePrivate
 * \brief The DeleteVoiceConnectorTerminationCredentialsResponsePrivate class provides private implementation for DeleteVoiceConnectorTerminationCredentialsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorTerminationCredentialsResponsePrivate object with public implementation \a q.
 */
DeleteVoiceConnectorTerminationCredentialsResponsePrivate::DeleteVoiceConnectorTerminationCredentialsResponsePrivate(
    DeleteVoiceConnectorTerminationCredentialsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteVoiceConnectorTerminationCredentials response element from \a xml.
 */
void DeleteVoiceConnectorTerminationCredentialsResponsePrivate::parseDeleteVoiceConnectorTerminationCredentialsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteVoiceConnectorTerminationCredentialsResponse"));
    Q_UNUSED(xml) ///< @todo
}
