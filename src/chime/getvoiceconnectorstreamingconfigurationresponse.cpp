...
#include "getvoiceconnectorstreamingconfigurationresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorStreamingConfigurationResponse
 * \brief The GetVoiceConnectorStreamingConfigurationResponse class provides an interace for Chime GetVoiceConnectorStreamingConfiguration responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a GetVoiceConnectorStreamingConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
GetVoiceConnectorStreamingConfigurationResponse::GetVoiceConnectorStreamingConfigurationResponse(
        const GetVoiceConnectorStreamingConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetVoiceConnectorStreamingConfigurationResponsePrivate(this), parent)
{
    setRequest(new GetVoiceConnectorStreamingConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime GetVoiceConnectorStreamingConfiguration \a response.
 */
void GetVoiceConnectorStreamingConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetVoiceConnectorStreamingConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorStreamingConfigurationResponsePrivate
 * \brief The GetVoiceConnectorStreamingConfigurationResponsePrivate class provides private implementation for GetVoiceConnectorStreamingConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorStreamingConfigurationResponsePrivate object with public implementation \a q.
 */
GetVoiceConnectorStreamingConfigurationResponsePrivate::GetVoiceConnectorStreamingConfigurationResponsePrivate(
    GetVoiceConnectorStreamingConfigurationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetVoiceConnectorStreamingConfiguration response element from \a xml.
 */
void GetVoiceConnectorStreamingConfigurationResponsePrivate::parseGetVoiceConnectorStreamingConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetVoiceConnectorStreamingConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
