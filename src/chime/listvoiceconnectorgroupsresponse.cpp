...
#include "listvoiceconnectorgroupsresponse_p.h"
...
/*!
 * \class QtAws::Chime::ListVoiceConnectorGroupsResponse
 * \brief The ListVoiceConnectorGroupsResponse class provides an interace for Chime ListVoiceConnectorGroups responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listVoiceConnectorGroups
 */

/*!
 * Constructs a ListVoiceConnectorGroupsResponse object for \a reply to \a request, with parent \a parent.
 */
ListVoiceConnectorGroupsResponse::ListVoiceConnectorGroupsResponse(
        const ListVoiceConnectorGroupsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new ListVoiceConnectorGroupsResponsePrivate(this), parent)
{
    setRequest(new ListVoiceConnectorGroupsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListVoiceConnectorGroupsRequest * ListVoiceConnectorGroupsResponse::request() const
{
    Q_D(const ListVoiceConnectorGroupsResponse);
    return static_cast<const ListVoiceConnectorGroupsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime ListVoiceConnectorGroups \a response.
 */
void ListVoiceConnectorGroupsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListVoiceConnectorGroupsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::ListVoiceConnectorGroupsResponsePrivate
 * \brief The ListVoiceConnectorGroupsResponsePrivate class provides private implementation for ListVoiceConnectorGroupsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListVoiceConnectorGroupsResponsePrivate object with public implementation \a q.
 */
ListVoiceConnectorGroupsResponsePrivate::ListVoiceConnectorGroupsResponsePrivate(
    ListVoiceConnectorGroupsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListVoiceConnectorGroups response element from \a xml.
 */
void ListVoiceConnectorGroupsResponsePrivate::parseListVoiceConnectorGroupsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListVoiceConnectorGroupsResponse"));
    Q_UNUSED(xml) ///< @todo
}
