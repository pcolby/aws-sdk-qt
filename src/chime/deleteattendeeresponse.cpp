...
/*!
 * \class QtAws::Chime::DeleteAttendeeResponse
 * \brief The DeleteAttendeeResponse class provides an interace for Chime DeleteAttendee responses.
 *
 * \inmodule QtAwsChime
 *
...
DeleteAttendeeResponse::DeleteAttendeeResponse(
    ...
    : ChimeResponse(new DeleteAttendeeResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DeleteAttendee \a response.
 */
...
/*!
 * \class QtAws::Chime::DeleteAttendeeResponsePrivate
...
DeleteAttendeeResponsePrivate::DeleteAttendeeResponsePrivate(
    DeleteAttendeeResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteAttendee response element from \a xml.
 */
