...
/*!
 * \class QtAws::Chime::BatchCreateChannelMembershipResponse
 * \brief The BatchCreateChannelMembershipResponse class provides an interace for Chime BatchCreateChannelMembership responses.
 *
 * \inmodule QtAwsChime
 *
...
BatchCreateChannelMembershipResponse::BatchCreateChannelMembershipResponse(
    ...
    : ChimeResponse(new BatchCreateChannelMembershipResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime BatchCreateChannelMembership \a response.
 */
...
/*!
 * \class QtAws::Chime::BatchCreateChannelMembershipResponsePrivate
...
BatchCreateChannelMembershipResponsePrivate::BatchCreateChannelMembershipResponsePrivate(
    BatchCreateChannelMembershipResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime BatchCreateChannelMembership response element from \a xml.
 */
