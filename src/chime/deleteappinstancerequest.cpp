...
/*!
 * \class QtAws::Chime::DeleteAppInstanceRequest
 * \brief The DeleteAppInstanceRequest class provides an interface for Chime DeleteAppInstance requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteAppInstance
 */
...
DeleteAppInstanceRequest::DeleteAppInstanceRequest(const DeleteAppInstanceRequest &other)
    : ChimeRequest(new DeleteAppInstanceRequestPrivate(*other.d_func(), this))
{
...
DeleteAppInstanceRequest::DeleteAppInstanceRequest()
    : ChimeRequest(new DeleteAppInstanceRequestPrivate(ChimeRequest::DeleteAppInstanceAction, this))
{
...
/*!
 * \class QtAws::Chime::DeleteAppInstanceRequestPrivate
...
/*!
 * Constructs a DeleteAppInstanceRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteAppInstanceRequestPrivate::DeleteAppInstanceRequestPrivate(
    const ChimeRequest::Action action, DeleteAppInstanceRequest * const q)
