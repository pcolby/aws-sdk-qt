...
/*!
 * \class QtAws::Chime::UpdateChannelResponse
 * \brief The UpdateChannelResponse class provides an interace for Chime UpdateChannel responses.
 *
 * \inmodule QtAwsChime
 *
...
UpdateChannelResponse::UpdateChannelResponse(
    ...
    : ChimeResponse(new UpdateChannelResponsePrivate(this), parent)
{
...
{
    return static_cast<const UpdateChannelRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime UpdateChannel \a response.
 */
...
/*!
 * \class QtAws::Chime::UpdateChannelResponsePrivate
...
UpdateChannelResponsePrivate::UpdateChannelResponsePrivate(
    UpdateChannelResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateChannel response element from \a xml.
 */
