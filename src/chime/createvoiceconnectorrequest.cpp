...
#include "createvoiceconnectorrequest_p.h"
...
/*!
 * \class QtAws::Chime::CreateVoiceConnectorRequest
 * \brief The CreateVoiceConnectorRequest class provides an interface for Chime CreateVoiceConnector requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
CreateVoiceConnectorRequest::CreateVoiceConnectorRequest(const CreateVoiceConnectorRequest &other)
    : ChimeRequest(new CreateVoiceConnectorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateVoiceConnectorRequest object.
 */
CreateVoiceConnectorRequest::CreateVoiceConnectorRequest()
    : ChimeRequest(new CreateVoiceConnectorRequestPrivate(ChimeRequest::CreateVoiceConnectorAction, this))
{
 ...
 * \reimp
 */
bool CreateVoiceConnectorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateVoiceConnectorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateVoiceConnectorRequest::response(QNetworkReply * const reply) const
{
    return new CreateVoiceConnectorResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::CreateVoiceConnectorRequestPrivate
 * \brief The CreateVoiceConnectorRequestPrivate class provides private implementation for CreateVoiceConnectorRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateVoiceConnectorRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateVoiceConnectorRequestPrivate::CreateVoiceConnectorRequestPrivate(
    const ChimeRequest::Action action, CreateVoiceConnectorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateVoiceConnectorRequest
 * class' copy constructor.
 */
CreateVoiceConnectorRequestPrivate::CreateVoiceConnectorRequestPrivate(
    const CreateVoiceConnectorRequestPrivate &other, CreateVoiceConnectorRequest * const q)
