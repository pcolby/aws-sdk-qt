...
/*!
 * \class QtAws::Chime::CreateChannelModeratorResponse
 * \brief The CreateChannelModeratorResponse class provides an interace for Chime CreateChannelModerator responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createChannelModerator
 */
...
CreateChannelModeratorResponse::CreateChannelModeratorResponse(
    ...
    : ChimeResponse(new CreateChannelModeratorResponsePrivate(this), parent)
{
...
{
    return static_cast<const CreateChannelModeratorRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime CreateChannelModerator \a response.
 */
...
/*!
 * \class QtAws::Chime::CreateChannelModeratorResponsePrivate
...
CreateChannelModeratorResponsePrivate::CreateChannelModeratorResponsePrivate(
    CreateChannelModeratorResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateChannelModerator response element from \a xml.
 */
