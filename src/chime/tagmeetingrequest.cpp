...
/*!
 * \class QtAws::Chime::TagMeetingRequest
 * \brief The TagMeetingRequest class provides an interface for Chime TagMeeting requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::tagMeeting
 */

/*!
 * Constructs a copy of \a other.
 */
TagMeetingRequest::TagMeetingRequest(const TagMeetingRequest &other)
    : ChimeRequest(new TagMeetingRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a TagMeetingRequest object.
 */
TagMeetingRequest::TagMeetingRequest()
    : ChimeRequest(new TagMeetingRequestPrivate(ChimeRequest::TagMeetingAction, this))
{
 ...
 * \reimp
 */
bool TagMeetingRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a TagMeetingResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * TagMeetingRequest::response(QNetworkReply * const reply) const
{
    return new TagMeetingResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::TagMeetingRequestPrivate
 * \brief The TagMeetingRequestPrivate class provides private implementation for TagMeetingRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a TagMeetingRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
TagMeetingRequestPrivate::TagMeetingRequestPrivate(
    const ChimeRequest::Action action, TagMeetingRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the TagMeetingRequest
 * class' copy constructor.
 */
TagMeetingRequestPrivate::TagMeetingRequestPrivate(
    const TagMeetingRequestPrivate &other, TagMeetingRequest * const q)
