...
#include "createsipmediaapplicationcallrequest_p.h"
...
/*!
 * \class QtAws::Chime::CreateSipMediaApplicationCallRequest
 * \brief The CreateSipMediaApplicationCallRequest class provides an interface for Chime CreateSipMediaApplicationCall requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createSipMediaApplicationCall
 */

/*!
 * Constructs a copy of \a other.
 */
CreateSipMediaApplicationCallRequest::CreateSipMediaApplicationCallRequest(const CreateSipMediaApplicationCallRequest &other)
    : ChimeRequest(new CreateSipMediaApplicationCallRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateSipMediaApplicationCallRequest object.
 */
CreateSipMediaApplicationCallRequest::CreateSipMediaApplicationCallRequest()
    : ChimeRequest(new CreateSipMediaApplicationCallRequestPrivate(ChimeRequest::CreateSipMediaApplicationCallAction, this))
{
 ...
 * \reimp
 */
bool CreateSipMediaApplicationCallRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateSipMediaApplicationCallResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateSipMediaApplicationCallRequest::response(QNetworkReply * const reply) const
{
    return new CreateSipMediaApplicationCallResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::CreateSipMediaApplicationCallRequestPrivate
 * \brief The CreateSipMediaApplicationCallRequestPrivate class provides private implementation for CreateSipMediaApplicationCallRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateSipMediaApplicationCallRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateSipMediaApplicationCallRequestPrivate::CreateSipMediaApplicationCallRequestPrivate(
    const ChimeRequest::Action action, CreateSipMediaApplicationCallRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateSipMediaApplicationCallRequest
 * class' copy constructor.
 */
CreateSipMediaApplicationCallRequestPrivate::CreateSipMediaApplicationCallRequestPrivate(
    const CreateSipMediaApplicationCallRequestPrivate &other, CreateSipMediaApplicationCallRequest * const q)
