...
#include "validatee911addressresponse_p.h"
...
/*!
 * \class QtAws::Chime::ValidateE911AddressResponse
 * \brief The ValidateE911AddressResponse class provides an interace for Chime ValidateE911Address responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::validateE911Address
 */

/*!
 * Constructs a ValidateE911AddressResponse object for \a reply to \a request, with parent \a parent.
 */
ValidateE911AddressResponse::ValidateE911AddressResponse(
        const ValidateE911AddressRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new ValidateE911AddressResponsePrivate(this), parent)
{
    setRequest(new ValidateE911AddressRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ValidateE911AddressRequest * ValidateE911AddressResponse::request() const
{
    Q_D(const ValidateE911AddressResponse);
    return static_cast<const ValidateE911AddressRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime ValidateE911Address \a response.
 */
void ValidateE911AddressResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ValidateE911AddressResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::ValidateE911AddressResponsePrivate
 * \brief The ValidateE911AddressResponsePrivate class provides private implementation for ValidateE911AddressResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ValidateE911AddressResponsePrivate object with public implementation \a q.
 */
ValidateE911AddressResponsePrivate::ValidateE911AddressResponsePrivate(
    ValidateE911AddressResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ValidateE911Address response element from \a xml.
 */
void ValidateE911AddressResponsePrivate::parseValidateE911AddressResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ValidateE911AddressResponse"));
    Q_UNUSED(xml) ///< @todo
}
