...
/*!
 * \class QtAws::Chime::GetChannelMessageRequest
 * \brief The GetChannelMessageRequest class provides an interface for Chime GetChannelMessage requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getChannelMessage
 */
...
GetChannelMessageRequest::GetChannelMessageRequest(const GetChannelMessageRequest &other)
    : ChimeRequest(new GetChannelMessageRequestPrivate(*other.d_func(), this))
{
...
GetChannelMessageRequest::GetChannelMessageRequest()
    : ChimeRequest(new GetChannelMessageRequestPrivate(ChimeRequest::GetChannelMessageAction, this))
{
...
/*!
 * \class QtAws::Chime::GetChannelMessageRequestPrivate
...
/*!
 * Constructs a GetChannelMessageRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetChannelMessageRequestPrivate::GetChannelMessageRequestPrivate(
    const ChimeRequest::Action action, GetChannelMessageRequest * const q)
