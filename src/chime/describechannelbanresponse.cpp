...
/*!
 * \class QtAws::Chime::DescribeChannelBanResponse
 * \brief The DescribeChannelBanResponse class provides an interace for Chime DescribeChannelBan responses.
 *
 * \inmodule QtAwsChime
 *
...
DescribeChannelBanResponse::DescribeChannelBanResponse(
    ...
    : ChimeResponse(new DescribeChannelBanResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DescribeChannelBan \a response.
 */
...
/*!
 * \class QtAws::Chime::DescribeChannelBanResponsePrivate
...
DescribeChannelBanResponsePrivate::DescribeChannelBanResponsePrivate(
    DescribeChannelBanResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DescribeChannelBan response element from \a xml.
 */
