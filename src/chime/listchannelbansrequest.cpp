...
/*!
 * \class QtAws::Chime::ListChannelBansRequest
 * \brief The ListChannelBansRequest class provides an interface for Chime ListChannelBans requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listChannelBans
 */
...
ListChannelBansRequest::ListChannelBansRequest(const ListChannelBansRequest &other)
    : ChimeRequest(new ListChannelBansRequestPrivate(*other.d_func(), this))
{
...
ListChannelBansRequest::ListChannelBansRequest()
    : ChimeRequest(new ListChannelBansRequestPrivate(ChimeRequest::ListChannelBansAction, this))
{
...
/*!
 * \class QtAws::Chime::ListChannelBansRequestPrivate
...
/*!
 * Constructs a ListChannelBansRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListChannelBansRequestPrivate::ListChannelBansRequestPrivate(
    const ChimeRequest::Action action, ListChannelBansRequest * const q)
