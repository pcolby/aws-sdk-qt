...
#include "getvoiceconnectorgrouprequest_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorGroupRequest
 * \brief The GetVoiceConnectorGroupRequest class provides an interface for Chime GetVoiceConnectorGroup requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
GetVoiceConnectorGroupRequest::GetVoiceConnectorGroupRequest(const GetVoiceConnectorGroupRequest &other)
    : ChimeRequest(new GetVoiceConnectorGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetVoiceConnectorGroupRequest object.
 */
GetVoiceConnectorGroupRequest::GetVoiceConnectorGroupRequest()
    : ChimeRequest(new GetVoiceConnectorGroupRequestPrivate(ChimeRequest::GetVoiceConnectorGroupAction, this))
{
 ...
 * \reimp
 */
bool GetVoiceConnectorGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetVoiceConnectorGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetVoiceConnectorGroupRequest::response(QNetworkReply * const reply) const
{
    return new GetVoiceConnectorGroupResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorGroupRequestPrivate
 * \brief The GetVoiceConnectorGroupRequestPrivate class provides private implementation for GetVoiceConnectorGroupRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorGroupRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetVoiceConnectorGroupRequestPrivate::GetVoiceConnectorGroupRequestPrivate(
    const ChimeRequest::Action action, GetVoiceConnectorGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetVoiceConnectorGroupRequest
 * class' copy constructor.
 */
GetVoiceConnectorGroupRequestPrivate::GetVoiceConnectorGroupRequestPrivate(
    const GetVoiceConnectorGroupRequestPrivate &other, GetVoiceConnectorGroupRequest * const q)
