...
#include "tagattendeerequest_p.h"
...
/*!
 * \class QtAws::Chime::TagAttendeeRequest
 * \brief The TagAttendeeRequest class provides an interface for Chime TagAttendee requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::tagAttendee
 */

/*!
 * Constructs a copy of \a other.
 */
TagAttendeeRequest::TagAttendeeRequest(const TagAttendeeRequest &other)
    : ChimeRequest(new TagAttendeeRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a TagAttendeeRequest object.
 */
TagAttendeeRequest::TagAttendeeRequest()
    : ChimeRequest(new TagAttendeeRequestPrivate(ChimeRequest::TagAttendeeAction, this))
{
 ...
 * \reimp
 */
bool TagAttendeeRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a TagAttendeeResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * TagAttendeeRequest::response(QNetworkReply * const reply) const
{
    return new TagAttendeeResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::TagAttendeeRequestPrivate
 * \brief The TagAttendeeRequestPrivate class provides private implementation for TagAttendeeRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a TagAttendeeRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
TagAttendeeRequestPrivate::TagAttendeeRequestPrivate(
    const ChimeRequest::Action action, TagAttendeeRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the TagAttendeeRequest
 * class' copy constructor.
 */
TagAttendeeRequestPrivate::TagAttendeeRequestPrivate(
    const TagAttendeeRequestPrivate &other, TagAttendeeRequest * const q)
