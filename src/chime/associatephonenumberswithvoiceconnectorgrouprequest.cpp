...
#include "associatephonenumberswithvoiceconnectorgrouprequest_p.h"
...
/*!
 * \class QtAws::Chime::AssociatePhoneNumbersWithVoiceConnectorGroupRequest
 * \brief The AssociatePhoneNumbersWithVoiceConnectorGroupRequest class provides an interface for Chime AssociatePhoneNumbersWithVoiceConnectorGroup requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::associatePhoneNumbersWithVoiceConnectorGroup
 */

/*!
 * Constructs a copy of \a other.
 */
AssociatePhoneNumbersWithVoiceConnectorGroupRequest::AssociatePhoneNumbersWithVoiceConnectorGroupRequest(const AssociatePhoneNumbersWithVoiceConnectorGroupRequest &other)
    : ChimeRequest(new AssociatePhoneNumbersWithVoiceConnectorGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AssociatePhoneNumbersWithVoiceConnectorGroupRequest object.
 */
AssociatePhoneNumbersWithVoiceConnectorGroupRequest::AssociatePhoneNumbersWithVoiceConnectorGroupRequest()
    : ChimeRequest(new AssociatePhoneNumbersWithVoiceConnectorGroupRequestPrivate(ChimeRequest::AssociatePhoneNumbersWithVoiceConnectorGroupAction, this))
{
 ...
 * \reimp
 */
bool AssociatePhoneNumbersWithVoiceConnectorGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AssociatePhoneNumbersWithVoiceConnectorGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AssociatePhoneNumbersWithVoiceConnectorGroupRequest::response(QNetworkReply * const reply) const
{
    return new AssociatePhoneNumbersWithVoiceConnectorGroupResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::AssociatePhoneNumbersWithVoiceConnectorGroupRequestPrivate
 * \brief The AssociatePhoneNumbersWithVoiceConnectorGroupRequestPrivate class provides private implementation for AssociatePhoneNumbersWithVoiceConnectorGroupRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a AssociatePhoneNumbersWithVoiceConnectorGroupRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
AssociatePhoneNumbersWithVoiceConnectorGroupRequestPrivate::AssociatePhoneNumbersWithVoiceConnectorGroupRequestPrivate(
    const ChimeRequest::Action action, AssociatePhoneNumbersWithVoiceConnectorGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AssociatePhoneNumbersWithVoiceConnectorGroupRequest
 * class' copy constructor.
 */
AssociatePhoneNumbersWithVoiceConnectorGroupRequestPrivate::AssociatePhoneNumbersWithVoiceConnectorGroupRequestPrivate(
    const AssociatePhoneNumbersWithVoiceConnectorGroupRequestPrivate &other, AssociatePhoneNumbersWithVoiceConnectorGroupRequest * const q)
