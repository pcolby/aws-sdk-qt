...
#include "deletevoiceconnectorterminationcredentialsrequest_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorTerminationCredentialsRequest
 * \brief The DeleteVoiceConnectorTerminationCredentialsRequest class provides an interface for Chime DeleteVoiceConnectorTerminationCredentials requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteVoiceConnectorTerminationCredentials
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteVoiceConnectorTerminationCredentialsRequest::DeleteVoiceConnectorTerminationCredentialsRequest(const DeleteVoiceConnectorTerminationCredentialsRequest &other)
    : ChimeRequest(new DeleteVoiceConnectorTerminationCredentialsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteVoiceConnectorTerminationCredentialsRequest object.
 */
DeleteVoiceConnectorTerminationCredentialsRequest::DeleteVoiceConnectorTerminationCredentialsRequest()
    : ChimeRequest(new DeleteVoiceConnectorTerminationCredentialsRequestPrivate(ChimeRequest::DeleteVoiceConnectorTerminationCredentialsAction, this))
{
 ...
 * \reimp
 */
bool DeleteVoiceConnectorTerminationCredentialsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteVoiceConnectorTerminationCredentialsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteVoiceConnectorTerminationCredentialsRequest::response(QNetworkReply * const reply) const
{
    return new DeleteVoiceConnectorTerminationCredentialsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorTerminationCredentialsRequestPrivate
 * \brief The DeleteVoiceConnectorTerminationCredentialsRequestPrivate class provides private implementation for DeleteVoiceConnectorTerminationCredentialsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorTerminationCredentialsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteVoiceConnectorTerminationCredentialsRequestPrivate::DeleteVoiceConnectorTerminationCredentialsRequestPrivate(
    const ChimeRequest::Action action, DeleteVoiceConnectorTerminationCredentialsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteVoiceConnectorTerminationCredentialsRequest
 * class' copy constructor.
 */
DeleteVoiceConnectorTerminationCredentialsRequestPrivate::DeleteVoiceConnectorTerminationCredentialsRequestPrivate(
    const DeleteVoiceConnectorTerminationCredentialsRequestPrivate &other, DeleteVoiceConnectorTerminationCredentialsRequest * const q)
