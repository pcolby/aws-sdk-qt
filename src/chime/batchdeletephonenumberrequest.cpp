...
#include "batchdeletephonenumberrequest_p.h"
...
/*!
 * \class QtAws::Chime::BatchDeletePhoneNumberRequest
 * \brief The BatchDeletePhoneNumberRequest class provides an interface for Chime BatchDeletePhoneNumber requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::batchDeletePhoneNumber
 */

/*!
 * Constructs a copy of \a other.
 */
BatchDeletePhoneNumberRequest::BatchDeletePhoneNumberRequest(const BatchDeletePhoneNumberRequest &other)
    : ChimeRequest(new BatchDeletePhoneNumberRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a BatchDeletePhoneNumberRequest object.
 */
BatchDeletePhoneNumberRequest::BatchDeletePhoneNumberRequest()
    : ChimeRequest(new BatchDeletePhoneNumberRequestPrivate(ChimeRequest::BatchDeletePhoneNumberAction, this))
{
 ...
 * \reimp
 */
bool BatchDeletePhoneNumberRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BatchDeletePhoneNumberResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BatchDeletePhoneNumberRequest::response(QNetworkReply * const reply) const
{
    return new BatchDeletePhoneNumberResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::BatchDeletePhoneNumberRequestPrivate
 * \brief The BatchDeletePhoneNumberRequestPrivate class provides private implementation for BatchDeletePhoneNumberRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a BatchDeletePhoneNumberRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
BatchDeletePhoneNumberRequestPrivate::BatchDeletePhoneNumberRequestPrivate(
    const ChimeRequest::Action action, BatchDeletePhoneNumberRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the BatchDeletePhoneNumberRequest
 * class' copy constructor.
 */
BatchDeletePhoneNumberRequestPrivate::BatchDeletePhoneNumberRequestPrivate(
    const BatchDeletePhoneNumberRequestPrivate &other, BatchDeletePhoneNumberRequest * const q)
