...
/*!
 * \class QtAws::Chime::BatchCreateAttendeeResponse
 * \brief The BatchCreateAttendeeResponse class provides an interace for Chime BatchCreateAttendee responses.
 *
 * \inmodule QtAwsChime
 *
...
BatchCreateAttendeeResponse::BatchCreateAttendeeResponse(
    ...
    : ChimeResponse(new BatchCreateAttendeeResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime BatchCreateAttendee \a response.
 */
...
/*!
 * \class QtAws::Chime::BatchCreateAttendeeResponsePrivate
...
BatchCreateAttendeeResponsePrivate::BatchCreateAttendeeResponsePrivate(
    BatchCreateAttendeeResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime BatchCreateAttendee response element from \a xml.
 */
