...
/*!
 * \class QtAws::Chime::GetBotRequest
 * \brief The GetBotRequest class provides an interface for Chime GetBot requests.
 *
 * \inmodule QtAwsChime
 *
...
GetBotRequest::GetBotRequest(const GetBotRequest &other)
    : ChimeRequest(new GetBotRequestPrivate(*other.d_func(), this))
{
...
GetBotRequest::GetBotRequest()
    : ChimeRequest(new GetBotRequestPrivate(ChimeRequest::GetBotAction, this))
{
...
/*!
 * \class QtAws::Chime::GetBotRequestPrivate
...
/*!
 * Constructs a GetBotRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetBotRequestPrivate::GetBotRequestPrivate(
    const ChimeRequest::Action action, GetBotRequest * const q)
