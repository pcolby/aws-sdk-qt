...
/*!
 * \class QtAws::Chime::DeleteChannelMembershipResponse
 * \brief The DeleteChannelMembershipResponse class provides an interace for Chime DeleteChannelMembership responses.
 *
 * \inmodule QtAwsChime
 *
...
DeleteChannelMembershipResponse::DeleteChannelMembershipResponse(
    ...
    : ChimeResponse(new DeleteChannelMembershipResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DeleteChannelMembership \a response.
 */
...
/*!
 * \class QtAws::Chime::DeleteChannelMembershipResponsePrivate
...
DeleteChannelMembershipResponsePrivate::DeleteChannelMembershipResponsePrivate(
    DeleteChannelMembershipResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteChannelMembership response element from \a xml.
 */
