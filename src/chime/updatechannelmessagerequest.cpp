...
/*!
 * \class QtAws::Chime::UpdateChannelMessageRequest
 * \brief The UpdateChannelMessageRequest class provides an interface for Chime UpdateChannelMessage requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::updateChannelMessage
 */
...
UpdateChannelMessageRequest::UpdateChannelMessageRequest(const UpdateChannelMessageRequest &other)
    : ChimeRequest(new UpdateChannelMessageRequestPrivate(*other.d_func(), this))
{
...
UpdateChannelMessageRequest::UpdateChannelMessageRequest()
    : ChimeRequest(new UpdateChannelMessageRequestPrivate(ChimeRequest::UpdateChannelMessageAction, this))
{
...
/*!
 * \class QtAws::Chime::UpdateChannelMessageRequestPrivate
...
/*!
 * Constructs a UpdateChannelMessageRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateChannelMessageRequestPrivate::UpdateChannelMessageRequestPrivate(
    const ChimeRequest::Action action, UpdateChannelMessageRequest * const q)
