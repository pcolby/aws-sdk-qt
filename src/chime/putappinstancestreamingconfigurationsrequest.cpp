...
#include "putappinstancestreamingconfigurationsrequest_p.h"
...
/*!
 * \class QtAws::Chime::PutAppInstanceStreamingConfigurationsRequest
 * \brief The PutAppInstanceStreamingConfigurationsRequest class provides an interface for Chime PutAppInstanceStreamingConfigurations requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::putAppInstanceStreamingConfigurations
 */

/*!
 * Constructs a copy of \a other.
 */
PutAppInstanceStreamingConfigurationsRequest::PutAppInstanceStreamingConfigurationsRequest(const PutAppInstanceStreamingConfigurationsRequest &other)
    : ChimeRequest(new PutAppInstanceStreamingConfigurationsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutAppInstanceStreamingConfigurationsRequest object.
 */
PutAppInstanceStreamingConfigurationsRequest::PutAppInstanceStreamingConfigurationsRequest()
    : ChimeRequest(new PutAppInstanceStreamingConfigurationsRequestPrivate(ChimeRequest::PutAppInstanceStreamingConfigurationsAction, this))
{
 ...
 * \reimp
 */
bool PutAppInstanceStreamingConfigurationsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutAppInstanceStreamingConfigurationsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutAppInstanceStreamingConfigurationsRequest::response(QNetworkReply * const reply) const
{
    return new PutAppInstanceStreamingConfigurationsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::PutAppInstanceStreamingConfigurationsRequestPrivate
 * \brief The PutAppInstanceStreamingConfigurationsRequestPrivate class provides private implementation for PutAppInstanceStreamingConfigurationsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutAppInstanceStreamingConfigurationsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
PutAppInstanceStreamingConfigurationsRequestPrivate::PutAppInstanceStreamingConfigurationsRequestPrivate(
    const ChimeRequest::Action action, PutAppInstanceStreamingConfigurationsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutAppInstanceStreamingConfigurationsRequest
 * class' copy constructor.
 */
PutAppInstanceStreamingConfigurationsRequestPrivate::PutAppInstanceStreamingConfigurationsRequestPrivate(
    const PutAppInstanceStreamingConfigurationsRequestPrivate &other, PutAppInstanceStreamingConfigurationsRequest * const q)
