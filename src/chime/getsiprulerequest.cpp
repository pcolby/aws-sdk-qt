...
/*!
 * \class QtAws::Chime::GetSipRuleRequest
 * \brief The GetSipRuleRequest class provides an interface for Chime GetSipRule requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
GetSipRuleRequest::GetSipRuleRequest(const GetSipRuleRequest &other)
    : ChimeRequest(new GetSipRuleRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetSipRuleRequest object.
 */
GetSipRuleRequest::GetSipRuleRequest()
    : ChimeRequest(new GetSipRuleRequestPrivate(ChimeRequest::GetSipRuleAction, this))
{
 ...
 * \reimp
 */
bool GetSipRuleRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetSipRuleResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetSipRuleRequest::response(QNetworkReply * const reply) const
{
    return new GetSipRuleResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetSipRuleRequestPrivate
 * \brief The GetSipRuleRequestPrivate class provides private implementation for GetSipRuleRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetSipRuleRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetSipRuleRequestPrivate::GetSipRuleRequestPrivate(
    const ChimeRequest::Action action, GetSipRuleRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetSipRuleRequest
 * class' copy constructor.
 */
GetSipRuleRequestPrivate::GetSipRuleRequestPrivate(
    const GetSipRuleRequestPrivate &other, GetSipRuleRequest * const q)
