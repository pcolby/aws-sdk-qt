...
#include "associatephonenumberwithuserrequest_p.h"
...
/*!
 * \class QtAws::Chime::AssociatePhoneNumberWithUserRequest
 * \brief The AssociatePhoneNumberWithUserRequest class provides an interface for Chime AssociatePhoneNumberWithUser requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::associatePhoneNumberWithUser
 */

/*!
 * Constructs a copy of \a other.
 */
AssociatePhoneNumberWithUserRequest::AssociatePhoneNumberWithUserRequest(const AssociatePhoneNumberWithUserRequest &other)
    : ChimeRequest(new AssociatePhoneNumberWithUserRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AssociatePhoneNumberWithUserRequest object.
 */
AssociatePhoneNumberWithUserRequest::AssociatePhoneNumberWithUserRequest()
    : ChimeRequest(new AssociatePhoneNumberWithUserRequestPrivate(ChimeRequest::AssociatePhoneNumberWithUserAction, this))
{
 ...
 * \reimp
 */
bool AssociatePhoneNumberWithUserRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AssociatePhoneNumberWithUserResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AssociatePhoneNumberWithUserRequest::response(QNetworkReply * const reply) const
{
    return new AssociatePhoneNumberWithUserResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::AssociatePhoneNumberWithUserRequestPrivate
 * \brief The AssociatePhoneNumberWithUserRequestPrivate class provides private implementation for AssociatePhoneNumberWithUserRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a AssociatePhoneNumberWithUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
AssociatePhoneNumberWithUserRequestPrivate::AssociatePhoneNumberWithUserRequestPrivate(
    const ChimeRequest::Action action, AssociatePhoneNumberWithUserRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AssociatePhoneNumberWithUserRequest
 * class' copy constructor.
 */
AssociatePhoneNumberWithUserRequestPrivate::AssociatePhoneNumberWithUserRequestPrivate(
    const AssociatePhoneNumberWithUserRequestPrivate &other, AssociatePhoneNumberWithUserRequest * const q)
