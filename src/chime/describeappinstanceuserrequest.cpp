...
/*!
 * \class QtAws::Chime::DescribeAppInstanceUserRequest
 * \brief The DescribeAppInstanceUserRequest class provides an interface for Chime DescribeAppInstanceUser requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::describeAppInstanceUser
 */
...
DescribeAppInstanceUserRequest::DescribeAppInstanceUserRequest(const DescribeAppInstanceUserRequest &other)
    : ChimeRequest(new DescribeAppInstanceUserRequestPrivate(*other.d_func(), this))
{
...
DescribeAppInstanceUserRequest::DescribeAppInstanceUserRequest()
    : ChimeRequest(new DescribeAppInstanceUserRequestPrivate(ChimeRequest::DescribeAppInstanceUserAction, this))
{
...
/*!
 * \class QtAws::Chime::DescribeAppInstanceUserRequestPrivate
...
/*!
 * Constructs a DescribeAppInstanceUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DescribeAppInstanceUserRequestPrivate::DescribeAppInstanceUserRequestPrivate(
    const ChimeRequest::Action action, DescribeAppInstanceUserRequest * const q)
