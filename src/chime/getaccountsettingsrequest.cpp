...
/*!
 * \class QtAws::Chime::GetAccountSettingsRequest
 * \brief The GetAccountSettingsRequest class provides an interface for Chime GetAccountSettings requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getAccountSettings
 */
...
GetAccountSettingsRequest::GetAccountSettingsRequest(const GetAccountSettingsRequest &other)
    : ChimeRequest(new GetAccountSettingsRequestPrivate(*other.d_func(), this))
{
...
GetAccountSettingsRequest::GetAccountSettingsRequest()
    : ChimeRequest(new GetAccountSettingsRequestPrivate(ChimeRequest::GetAccountSettingsAction, this))
{
...
/*!
 * \class QtAws::Chime::GetAccountSettingsRequestPrivate
...
/*!
 * Constructs a GetAccountSettingsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetAccountSettingsRequestPrivate::GetAccountSettingsRequestPrivate(
    const ChimeRequest::Action action, GetAccountSettingsRequest * const q)
