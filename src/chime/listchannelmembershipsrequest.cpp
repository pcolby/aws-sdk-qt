...
/*!
 * \class QtAws::Chime::ListChannelMembershipsRequest
 * \brief The ListChannelMembershipsRequest class provides an interface for Chime ListChannelMemberships requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listChannelMemberships
 */
...
ListChannelMembershipsRequest::ListChannelMembershipsRequest(const ListChannelMembershipsRequest &other)
    : ChimeRequest(new ListChannelMembershipsRequestPrivate(*other.d_func(), this))
{
...
ListChannelMembershipsRequest::ListChannelMembershipsRequest()
    : ChimeRequest(new ListChannelMembershipsRequestPrivate(ChimeRequest::ListChannelMembershipsAction, this))
{
...
/*!
 * \class QtAws::Chime::ListChannelMembershipsRequestPrivate
...
/*!
 * Constructs a ListChannelMembershipsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListChannelMembershipsRequestPrivate::ListChannelMembershipsRequestPrivate(
    const ChimeRequest::Action action, ListChannelMembershipsRequest * const q)
