...
#include "listvoiceconnectorgroupsrequest_p.h"
...
/*!
 * \class QtAws::Chime::ListVoiceConnectorGroupsRequest
 * \brief The ListVoiceConnectorGroupsRequest class provides an interface for Chime ListVoiceConnectorGroups requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
ListVoiceConnectorGroupsRequest::ListVoiceConnectorGroupsRequest(const ListVoiceConnectorGroupsRequest &other)
    : ChimeRequest(new ListVoiceConnectorGroupsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListVoiceConnectorGroupsRequest object.
 */
ListVoiceConnectorGroupsRequest::ListVoiceConnectorGroupsRequest()
    : ChimeRequest(new ListVoiceConnectorGroupsRequestPrivate(ChimeRequest::ListVoiceConnectorGroupsAction, this))
{
 ...
 * \reimp
 */
bool ListVoiceConnectorGroupsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListVoiceConnectorGroupsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListVoiceConnectorGroupsRequest::response(QNetworkReply * const reply) const
{
    return new ListVoiceConnectorGroupsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::ListVoiceConnectorGroupsRequestPrivate
 * \brief The ListVoiceConnectorGroupsRequestPrivate class provides private implementation for ListVoiceConnectorGroupsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListVoiceConnectorGroupsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListVoiceConnectorGroupsRequestPrivate::ListVoiceConnectorGroupsRequestPrivate(
    const ChimeRequest::Action action, ListVoiceConnectorGroupsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListVoiceConnectorGroupsRequest
 * class' copy constructor.
 */
ListVoiceConnectorGroupsRequestPrivate::ListVoiceConnectorGroupsRequestPrivate(
    const ListVoiceConnectorGroupsRequestPrivate &other, ListVoiceConnectorGroupsRequest * const q)
