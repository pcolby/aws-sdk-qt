...
/*!
 * \class QtAws::Chime::UpdateRoomResponse
 * \brief The UpdateRoomResponse class provides an interace for Chime UpdateRoom responses.
 *
 * \inmodule QtAwsChime
 *
...
UpdateRoomResponse::UpdateRoomResponse(
    ...
    : ChimeResponse(new UpdateRoomResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime UpdateRoom \a response.
 */
...
/*!
 * \class QtAws::Chime::UpdateRoomResponsePrivate
...
UpdateRoomResponsePrivate::UpdateRoomResponsePrivate(
    UpdateRoomResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateRoom response element from \a xml.
 */
