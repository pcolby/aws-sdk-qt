...
#include "getphonenumberrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetPhoneNumberRequest
 * \brief The GetPhoneNumberRequest class provides an interface for Chime GetPhoneNumber requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getPhoneNumber
 */

/*!
 * Constructs a copy of \a other.
 */
GetPhoneNumberRequest::GetPhoneNumberRequest(const GetPhoneNumberRequest &other)
    : ChimeRequest(new GetPhoneNumberRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetPhoneNumberRequest object.
 */
GetPhoneNumberRequest::GetPhoneNumberRequest()
    : ChimeRequest(new GetPhoneNumberRequestPrivate(ChimeRequest::GetPhoneNumberAction, this))
{
 ...
 * \reimp
 */
bool GetPhoneNumberRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetPhoneNumberResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetPhoneNumberRequest::response(QNetworkReply * const reply) const
{
    return new GetPhoneNumberResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetPhoneNumberRequestPrivate
 * \brief The GetPhoneNumberRequestPrivate class provides private implementation for GetPhoneNumberRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetPhoneNumberRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetPhoneNumberRequestPrivate::GetPhoneNumberRequestPrivate(
    const ChimeRequest::Action action, GetPhoneNumberRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetPhoneNumberRequest
 * class' copy constructor.
 */
GetPhoneNumberRequestPrivate::GetPhoneNumberRequestPrivate(
    const GetPhoneNumberRequestPrivate &other, GetPhoneNumberRequest * const q)
