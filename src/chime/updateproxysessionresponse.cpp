...
#include "updateproxysessionresponse_p.h"
...
/*!
 * \class QtAws::Chime::UpdateProxySessionResponse
 * \brief The UpdateProxySessionResponse class provides an interace for Chime UpdateProxySession responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a UpdateProxySessionResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateProxySessionResponse::UpdateProxySessionResponse(
        const UpdateProxySessionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new UpdateProxySessionResponsePrivate(this), parent)
{
    setRequest(new UpdateProxySessionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime UpdateProxySession \a response.
 */
void UpdateProxySessionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateProxySessionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::UpdateProxySessionResponsePrivate
 * \brief The UpdateProxySessionResponsePrivate class provides private implementation for UpdateProxySessionResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UpdateProxySessionResponsePrivate object with public implementation \a q.
 */
UpdateProxySessionResponsePrivate::UpdateProxySessionResponsePrivate(
    UpdateProxySessionResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateProxySession response element from \a xml.
 */
void UpdateProxySessionResponsePrivate::parseUpdateProxySessionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateProxySessionResponse"));
    Q_UNUSED(xml) ///< @todo
}
