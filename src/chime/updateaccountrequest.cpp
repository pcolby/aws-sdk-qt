...
/*!
 * \class QtAws::Chime::UpdateAccountRequest
 * \brief The UpdateAccountRequest class provides an interface for Chime UpdateAccount requests.
 *
 * \inmodule QtAwsChime
 *
...
UpdateAccountRequest::UpdateAccountRequest(const UpdateAccountRequest &other)
    : ChimeRequest(new UpdateAccountRequestPrivate(*other.d_func(), this))
{
...
UpdateAccountRequest::UpdateAccountRequest()
    : ChimeRequest(new UpdateAccountRequestPrivate(ChimeRequest::UpdateAccountAction, this))
{
...
/*!
 * \class QtAws::Chime::UpdateAccountRequestPrivate
...
/*!
 * Constructs a UpdateAccountRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateAccountRequestPrivate::UpdateAccountRequestPrivate(
    const ChimeRequest::Action action, UpdateAccountRequest * const q)
