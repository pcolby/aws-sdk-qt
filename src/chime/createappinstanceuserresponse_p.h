...
class QTAWS_EXPORT CreateAppInstanceUserResponsePrivate : public ChimeResponsePrivate {

public:

    CreateAppInstanceUserResponsePrivate(CreateAppInstanceUserResponse * const q);
