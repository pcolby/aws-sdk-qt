...
#include "createroommembershiprequest_p.h"
...
/*!
 * \class QtAws::Chime::CreateRoomMembershipRequest
 * \brief The CreateRoomMembershipRequest class provides an interface for Chime CreateRoomMembership requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createRoomMembership
 */

/*!
 * Constructs a copy of \a other.
 */
CreateRoomMembershipRequest::CreateRoomMembershipRequest(const CreateRoomMembershipRequest &other)
    : ChimeRequest(new CreateRoomMembershipRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateRoomMembershipRequest object.
 */
CreateRoomMembershipRequest::CreateRoomMembershipRequest()
    : ChimeRequest(new CreateRoomMembershipRequestPrivate(ChimeRequest::CreateRoomMembershipAction, this))
{
 ...
 * \reimp
 */
bool CreateRoomMembershipRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateRoomMembershipResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateRoomMembershipRequest::response(QNetworkReply * const reply) const
{
    return new CreateRoomMembershipResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::CreateRoomMembershipRequestPrivate
 * \brief The CreateRoomMembershipRequestPrivate class provides private implementation for CreateRoomMembershipRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateRoomMembershipRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateRoomMembershipRequestPrivate::CreateRoomMembershipRequestPrivate(
    const ChimeRequest::Action action, CreateRoomMembershipRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateRoomMembershipRequest
 * class' copy constructor.
 */
CreateRoomMembershipRequestPrivate::CreateRoomMembershipRequestPrivate(
    const CreateRoomMembershipRequestPrivate &other, CreateRoomMembershipRequest * const q)
