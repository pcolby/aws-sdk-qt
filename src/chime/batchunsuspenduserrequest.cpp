...
#include "batchunsuspenduserrequest_p.h"
...
/*!
 * \class QtAws::Chime::BatchUnsuspendUserRequest
 * \brief The BatchUnsuspendUserRequest class provides an interface for Chime BatchUnsuspendUser requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::batchUnsuspendUser
 */

/*!
 * Constructs a copy of \a other.
 */
BatchUnsuspendUserRequest::BatchUnsuspendUserRequest(const BatchUnsuspendUserRequest &other)
    : ChimeRequest(new BatchUnsuspendUserRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a BatchUnsuspendUserRequest object.
 */
BatchUnsuspendUserRequest::BatchUnsuspendUserRequest()
    : ChimeRequest(new BatchUnsuspendUserRequestPrivate(ChimeRequest::BatchUnsuspendUserAction, this))
{
 ...
 * \reimp
 */
bool BatchUnsuspendUserRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BatchUnsuspendUserResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BatchUnsuspendUserRequest::response(QNetworkReply * const reply) const
{
    return new BatchUnsuspendUserResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::BatchUnsuspendUserRequestPrivate
 * \brief The BatchUnsuspendUserRequestPrivate class provides private implementation for BatchUnsuspendUserRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a BatchUnsuspendUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
BatchUnsuspendUserRequestPrivate::BatchUnsuspendUserRequestPrivate(
    const ChimeRequest::Action action, BatchUnsuspendUserRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the BatchUnsuspendUserRequest
 * class' copy constructor.
 */
BatchUnsuspendUserRequestPrivate::BatchUnsuspendUserRequestPrivate(
    const BatchUnsuspendUserRequestPrivate &other, BatchUnsuspendUserRequest * const q)
