...
#include "createvoiceconnectorresponse_p.h"
...
/*!
 * \class QtAws::Chime::CreateVoiceConnectorResponse
 * \brief The CreateVoiceConnectorResponse class provides an interace for Chime CreateVoiceConnector responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createVoiceConnector
 */

/*!
 * Constructs a CreateVoiceConnectorResponse object for \a reply to \a request, with parent \a parent.
 */
CreateVoiceConnectorResponse::CreateVoiceConnectorResponse(
        const CreateVoiceConnectorRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new CreateVoiceConnectorResponsePrivate(this), parent)
{
    setRequest(new CreateVoiceConnectorRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateVoiceConnectorRequest * CreateVoiceConnectorResponse::request() const
{
    Q_D(const CreateVoiceConnectorResponse);
    return static_cast<const CreateVoiceConnectorRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime CreateVoiceConnector \a response.
 */
void CreateVoiceConnectorResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateVoiceConnectorResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::CreateVoiceConnectorResponsePrivate
 * \brief The CreateVoiceConnectorResponsePrivate class provides private implementation for CreateVoiceConnectorResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateVoiceConnectorResponsePrivate object with public implementation \a q.
 */
CreateVoiceConnectorResponsePrivate::CreateVoiceConnectorResponsePrivate(
    CreateVoiceConnectorResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateVoiceConnector response element from \a xml.
 */
void CreateVoiceConnectorResponsePrivate::parseCreateVoiceConnectorResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateVoiceConnectorResponse"));
    Q_UNUSED(xml) ///< @todo
}
