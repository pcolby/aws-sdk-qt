...
class QTAWS_EXPORT CreateAppInstanceAdminResponsePrivate : public ChimeResponsePrivate {

public:

    CreateAppInstanceAdminResponsePrivate(CreateAppInstanceAdminResponse * const q);
