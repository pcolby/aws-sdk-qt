...
/*!
 * \class QtAws::Chime::CreateAppInstanceUserRequest
 * \brief The CreateAppInstanceUserRequest class provides an interface for Chime CreateAppInstanceUser requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createAppInstanceUser
 */
...
CreateAppInstanceUserRequest::CreateAppInstanceUserRequest(const CreateAppInstanceUserRequest &other)
    : ChimeRequest(new CreateAppInstanceUserRequestPrivate(*other.d_func(), this))
{
...
CreateAppInstanceUserRequest::CreateAppInstanceUserRequest()
    : ChimeRequest(new CreateAppInstanceUserRequestPrivate(ChimeRequest::CreateAppInstanceUserAction, this))
{
...
/*!
 * \class QtAws::Chime::CreateAppInstanceUserRequestPrivate
...
/*!
 * Constructs a CreateAppInstanceUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateAppInstanceUserRequestPrivate::CreateAppInstanceUserRequestPrivate(
    const ChimeRequest::Action action, CreateAppInstanceUserRequest * const q)
