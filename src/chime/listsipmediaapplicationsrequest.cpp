...
#include "listsipmediaapplicationsrequest_p.h"
...
/*!
 * \class QtAws::Chime::ListSipMediaApplicationsRequest
 * \brief The ListSipMediaApplicationsRequest class provides an interface for Chime ListSipMediaApplications requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listSipMediaApplications
 */

/*!
 * Constructs a copy of \a other.
 */
ListSipMediaApplicationsRequest::ListSipMediaApplicationsRequest(const ListSipMediaApplicationsRequest &other)
    : ChimeRequest(new ListSipMediaApplicationsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListSipMediaApplicationsRequest object.
 */
ListSipMediaApplicationsRequest::ListSipMediaApplicationsRequest()
    : ChimeRequest(new ListSipMediaApplicationsRequestPrivate(ChimeRequest::ListSipMediaApplicationsAction, this))
{
 ...
 * \reimp
 */
bool ListSipMediaApplicationsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListSipMediaApplicationsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListSipMediaApplicationsRequest::response(QNetworkReply * const reply) const
{
    return new ListSipMediaApplicationsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::ListSipMediaApplicationsRequestPrivate
 * \brief The ListSipMediaApplicationsRequestPrivate class provides private implementation for ListSipMediaApplicationsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListSipMediaApplicationsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListSipMediaApplicationsRequestPrivate::ListSipMediaApplicationsRequestPrivate(
    const ChimeRequest::Action action, ListSipMediaApplicationsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListSipMediaApplicationsRequest
 * class' copy constructor.
 */
ListSipMediaApplicationsRequestPrivate::ListSipMediaApplicationsRequestPrivate(
    const ListSipMediaApplicationsRequestPrivate &other, ListSipMediaApplicationsRequest * const q)
