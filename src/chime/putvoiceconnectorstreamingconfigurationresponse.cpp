...
#include "putvoiceconnectorstreamingconfigurationresponse_p.h"
...
/*!
 * \class QtAws::Chime::PutVoiceConnectorStreamingConfigurationResponse
 * \brief The PutVoiceConnectorStreamingConfigurationResponse class provides an interace for Chime PutVoiceConnectorStreamingConfiguration responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a PutVoiceConnectorStreamingConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
PutVoiceConnectorStreamingConfigurationResponse::PutVoiceConnectorStreamingConfigurationResponse(
        const PutVoiceConnectorStreamingConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new PutVoiceConnectorStreamingConfigurationResponsePrivate(this), parent)
{
    setRequest(new PutVoiceConnectorStreamingConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime PutVoiceConnectorStreamingConfiguration \a response.
 */
void PutVoiceConnectorStreamingConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutVoiceConnectorStreamingConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::PutVoiceConnectorStreamingConfigurationResponsePrivate
 * \brief The PutVoiceConnectorStreamingConfigurationResponsePrivate class provides private implementation for PutVoiceConnectorStreamingConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutVoiceConnectorStreamingConfigurationResponsePrivate object with public implementation \a q.
 */
PutVoiceConnectorStreamingConfigurationResponsePrivate::PutVoiceConnectorStreamingConfigurationResponsePrivate(
    PutVoiceConnectorStreamingConfigurationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime PutVoiceConnectorStreamingConfiguration response element from \a xml.
 */
void PutVoiceConnectorStreamingConfigurationResponsePrivate::parsePutVoiceConnectorStreamingConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutVoiceConnectorStreamingConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
