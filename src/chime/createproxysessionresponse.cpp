...
#include "createproxysessionresponse_p.h"
...
/*!
 * \class QtAws::Chime::CreateProxySessionResponse
 * \brief The CreateProxySessionResponse class provides an interace for Chime CreateProxySession responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a CreateProxySessionResponse object for \a reply to \a request, with parent \a parent.
 */
CreateProxySessionResponse::CreateProxySessionResponse(
        const CreateProxySessionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new CreateProxySessionResponsePrivate(this), parent)
{
    setRequest(new CreateProxySessionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime CreateProxySession \a response.
 */
void CreateProxySessionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateProxySessionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::CreateProxySessionResponsePrivate
 * \brief The CreateProxySessionResponsePrivate class provides private implementation for CreateProxySessionResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateProxySessionResponsePrivate object with public implementation \a q.
 */
CreateProxySessionResponsePrivate::CreateProxySessionResponsePrivate(
    CreateProxySessionResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateProxySession response element from \a xml.
 */
void CreateProxySessionResponsePrivate::parseCreateProxySessionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateProxySessionResponse"));
    Q_UNUSED(xml) ///< @todo
}
