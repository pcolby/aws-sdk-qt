...
#include "updatesipmediaapplicationrequest_p.h"
...
/*!
 * \class QtAws::Chime::UpdateSipMediaApplicationRequest
 * \brief The UpdateSipMediaApplicationRequest class provides an interface for Chime UpdateSipMediaApplication requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::updateSipMediaApplication
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateSipMediaApplicationRequest::UpdateSipMediaApplicationRequest(const UpdateSipMediaApplicationRequest &other)
    : ChimeRequest(new UpdateSipMediaApplicationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateSipMediaApplicationRequest object.
 */
UpdateSipMediaApplicationRequest::UpdateSipMediaApplicationRequest()
    : ChimeRequest(new UpdateSipMediaApplicationRequestPrivate(ChimeRequest::UpdateSipMediaApplicationAction, this))
{
 ...
 * \reimp
 */
bool UpdateSipMediaApplicationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateSipMediaApplicationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateSipMediaApplicationRequest::response(QNetworkReply * const reply) const
{
    return new UpdateSipMediaApplicationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::UpdateSipMediaApplicationRequestPrivate
 * \brief The UpdateSipMediaApplicationRequestPrivate class provides private implementation for UpdateSipMediaApplicationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UpdateSipMediaApplicationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateSipMediaApplicationRequestPrivate::UpdateSipMediaApplicationRequestPrivate(
    const ChimeRequest::Action action, UpdateSipMediaApplicationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateSipMediaApplicationRequest
 * class' copy constructor.
 */
UpdateSipMediaApplicationRequestPrivate::UpdateSipMediaApplicationRequestPrivate(
    const UpdateSipMediaApplicationRequestPrivate &other, UpdateSipMediaApplicationRequest * const q)
