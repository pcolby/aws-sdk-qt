...
class QTAWS_EXPORT DescribeChannelMembershipResponsePrivate : public ChimeResponsePrivate {

public:

    DescribeChannelMembershipResponsePrivate(DescribeChannelMembershipResponse * const q);
