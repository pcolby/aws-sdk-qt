...
#include "createroommembershipresponse_p.h"
...
/*!
 * \class QtAws::Chime::CreateRoomMembershipResponse
 * \brief The CreateRoomMembershipResponse class provides an interace for Chime CreateRoomMembership responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a CreateRoomMembershipResponse object for \a reply to \a request, with parent \a parent.
 */
CreateRoomMembershipResponse::CreateRoomMembershipResponse(
        const CreateRoomMembershipRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new CreateRoomMembershipResponsePrivate(this), parent)
{
    setRequest(new CreateRoomMembershipRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime CreateRoomMembership \a response.
 */
void CreateRoomMembershipResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateRoomMembershipResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::CreateRoomMembershipResponsePrivate
 * \brief The CreateRoomMembershipResponsePrivate class provides private implementation for CreateRoomMembershipResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateRoomMembershipResponsePrivate object with public implementation \a q.
 */
CreateRoomMembershipResponsePrivate::CreateRoomMembershipResponsePrivate(
    CreateRoomMembershipResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateRoomMembership response element from \a xml.
 */
void CreateRoomMembershipResponsePrivate::parseCreateRoomMembershipResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateRoomMembershipResponse"));
    Q_UNUSED(xml) ///< @todo
}
