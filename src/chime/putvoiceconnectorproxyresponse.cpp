...
#include "putvoiceconnectorproxyresponse_p.h"
...
/*!
 * \class QtAws::Chime::PutVoiceConnectorProxyResponse
 * \brief The PutVoiceConnectorProxyResponse class provides an interace for Chime PutVoiceConnectorProxy responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a PutVoiceConnectorProxyResponse object for \a reply to \a request, with parent \a parent.
 */
PutVoiceConnectorProxyResponse::PutVoiceConnectorProxyResponse(
        const PutVoiceConnectorProxyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new PutVoiceConnectorProxyResponsePrivate(this), parent)
{
    setRequest(new PutVoiceConnectorProxyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime PutVoiceConnectorProxy \a response.
 */
void PutVoiceConnectorProxyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutVoiceConnectorProxyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::PutVoiceConnectorProxyResponsePrivate
 * \brief The PutVoiceConnectorProxyResponsePrivate class provides private implementation for PutVoiceConnectorProxyResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutVoiceConnectorProxyResponsePrivate object with public implementation \a q.
 */
PutVoiceConnectorProxyResponsePrivate::PutVoiceConnectorProxyResponsePrivate(
    PutVoiceConnectorProxyResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime PutVoiceConnectorProxy response element from \a xml.
 */
void PutVoiceConnectorProxyResponsePrivate::parsePutVoiceConnectorProxyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutVoiceConnectorProxyResponse"));
    Q_UNUSED(xml) ///< @todo
}
