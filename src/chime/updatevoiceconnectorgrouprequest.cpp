...
#include "updatevoiceconnectorgrouprequest_p.h"
...
/*!
 * \class QtAws::Chime::UpdateVoiceConnectorGroupRequest
 * \brief The UpdateVoiceConnectorGroupRequest class provides an interface for Chime UpdateVoiceConnectorGroup requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::updateVoiceConnectorGroup
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateVoiceConnectorGroupRequest::UpdateVoiceConnectorGroupRequest(const UpdateVoiceConnectorGroupRequest &other)
    : ChimeRequest(new UpdateVoiceConnectorGroupRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateVoiceConnectorGroupRequest object.
 */
UpdateVoiceConnectorGroupRequest::UpdateVoiceConnectorGroupRequest()
    : ChimeRequest(new UpdateVoiceConnectorGroupRequestPrivate(ChimeRequest::UpdateVoiceConnectorGroupAction, this))
{
 ...
 * \reimp
 */
bool UpdateVoiceConnectorGroupRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateVoiceConnectorGroupResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateVoiceConnectorGroupRequest::response(QNetworkReply * const reply) const
{
    return new UpdateVoiceConnectorGroupResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::UpdateVoiceConnectorGroupRequestPrivate
 * \brief The UpdateVoiceConnectorGroupRequestPrivate class provides private implementation for UpdateVoiceConnectorGroupRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UpdateVoiceConnectorGroupRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateVoiceConnectorGroupRequestPrivate::UpdateVoiceConnectorGroupRequestPrivate(
    const ChimeRequest::Action action, UpdateVoiceConnectorGroupRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateVoiceConnectorGroupRequest
 * class' copy constructor.
 */
UpdateVoiceConnectorGroupRequestPrivate::UpdateVoiceConnectorGroupRequestPrivate(
    const UpdateVoiceConnectorGroupRequestPrivate &other, UpdateVoiceConnectorGroupRequest * const q)
