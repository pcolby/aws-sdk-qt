...
/*!
 * \class QtAws::Chime::DescribeChannelModeratorResponse
 * \brief The DescribeChannelModeratorResponse class provides an interace for Chime DescribeChannelModerator responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::describeChannelModerator
 */
...
DescribeChannelModeratorResponse::DescribeChannelModeratorResponse(
    ...
    : ChimeResponse(new DescribeChannelModeratorResponsePrivate(this), parent)
{
...
{
    return static_cast<const DescribeChannelModeratorRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime DescribeChannelModerator \a response.
 */
...
/*!
 * \class QtAws::Chime::DescribeChannelModeratorResponsePrivate
...
DescribeChannelModeratorResponsePrivate::DescribeChannelModeratorResponsePrivate(
    DescribeChannelModeratorResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DescribeChannelModerator response element from \a xml.
 */
