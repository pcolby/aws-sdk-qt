...
#include "listsupportedphonenumbercountriesresponse_p.h"
...
/*!
 * \class QtAws::Chime::ListSupportedPhoneNumberCountriesResponse
 * \brief The ListSupportedPhoneNumberCountriesResponse class provides an interace for Chime ListSupportedPhoneNumberCountries responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a ListSupportedPhoneNumberCountriesResponse object for \a reply to \a request, with parent \a parent.
 */
ListSupportedPhoneNumberCountriesResponse::ListSupportedPhoneNumberCountriesResponse(
        const ListSupportedPhoneNumberCountriesRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new ListSupportedPhoneNumberCountriesResponsePrivate(this), parent)
{
    setRequest(new ListSupportedPhoneNumberCountriesRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime ListSupportedPhoneNumberCountries \a response.
 */
void ListSupportedPhoneNumberCountriesResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListSupportedPhoneNumberCountriesResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::ListSupportedPhoneNumberCountriesResponsePrivate
 * \brief The ListSupportedPhoneNumberCountriesResponsePrivate class provides private implementation for ListSupportedPhoneNumberCountriesResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListSupportedPhoneNumberCountriesResponsePrivate object with public implementation \a q.
 */
ListSupportedPhoneNumberCountriesResponsePrivate::ListSupportedPhoneNumberCountriesResponsePrivate(
    ListSupportedPhoneNumberCountriesResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListSupportedPhoneNumberCountries response element from \a xml.
 */
void ListSupportedPhoneNumberCountriesResponsePrivate::parseListSupportedPhoneNumberCountriesResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListSupportedPhoneNumberCountriesResponse"));
    Q_UNUSED(xml) ///< @todo
}
