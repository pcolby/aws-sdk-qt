...
class QTAWS_EXPORT GetAppInstanceRetentionSettingsResponsePrivate : public ChimeResponsePrivate {

public:

    GetAppInstanceRetentionSettingsResponsePrivate(GetAppInstanceRetentionSettingsResponse * const q);
