...
/*!
 * \class QtAws::Chime::CreateAttendeeRequest
 * \brief The CreateAttendeeRequest class provides an interface for Chime CreateAttendee requests.
 *
 * \inmodule QtAwsChime
 *
...
CreateAttendeeRequest::CreateAttendeeRequest(const CreateAttendeeRequest &other)
    : ChimeRequest(new CreateAttendeeRequestPrivate(*other.d_func(), this))
{
...
CreateAttendeeRequest::CreateAttendeeRequest()
    : ChimeRequest(new CreateAttendeeRequestPrivate(ChimeRequest::CreateAttendeeAction, this))
{
...
/*!
 * \class QtAws::Chime::CreateAttendeeRequestPrivate
...
/*!
 * Constructs a CreateAttendeeRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateAttendeeRequestPrivate::CreateAttendeeRequestPrivate(
    const ChimeRequest::Action action, CreateAttendeeRequest * const q)
