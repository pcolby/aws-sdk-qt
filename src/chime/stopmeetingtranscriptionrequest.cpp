...
/*!
 * \class QtAws::Chime::StopMeetingTranscriptionRequest
 * \brief The StopMeetingTranscriptionRequest class provides an interface for Chime StopMeetingTranscription requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::stopMeetingTranscription
 */
...
StopMeetingTranscriptionRequest::StopMeetingTranscriptionRequest(const StopMeetingTranscriptionRequest &other)
    : ChimeRequest(new StopMeetingTranscriptionRequestPrivate(*other.d_func(), this))
{
...
StopMeetingTranscriptionRequest::StopMeetingTranscriptionRequest()
    : ChimeRequest(new StopMeetingTranscriptionRequestPrivate(ChimeRequest::StopMeetingTranscriptionAction, this))
{
...
/*!
 * \class QtAws::Chime::StopMeetingTranscriptionRequestPrivate
...
/*!
 * Constructs a StopMeetingTranscriptionRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
StopMeetingTranscriptionRequestPrivate::StopMeetingTranscriptionRequestPrivate(
    const ChimeRequest::Action action, StopMeetingTranscriptionRequest * const q)
