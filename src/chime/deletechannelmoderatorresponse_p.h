...
class QTAWS_EXPORT DeleteChannelModeratorResponsePrivate : public ChimeResponsePrivate {

public:

    DeleteChannelModeratorResponsePrivate(DeleteChannelModeratorResponse * const q);
