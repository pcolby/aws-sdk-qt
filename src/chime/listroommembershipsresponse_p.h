...
class QTAWS_EXPORT ListRoomMembershipsResponsePrivate : public ChimeResponsePrivate {

public:

    ListRoomMembershipsResponsePrivate(ListRoomMembershipsResponse * const q);
