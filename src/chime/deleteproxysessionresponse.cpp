...
#include "deleteproxysessionresponse_p.h"
...
/*!
 * \class QtAws::Chime::DeleteProxySessionResponse
 * \brief The DeleteProxySessionResponse class provides an interace for Chime DeleteProxySession responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a DeleteProxySessionResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteProxySessionResponse::DeleteProxySessionResponse(
        const DeleteProxySessionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DeleteProxySessionResponsePrivate(this), parent)
{
    setRequest(new DeleteProxySessionRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime DeleteProxySession \a response.
 */
void DeleteProxySessionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteProxySessionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DeleteProxySessionResponsePrivate
 * \brief The DeleteProxySessionResponsePrivate class provides private implementation for DeleteProxySessionResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteProxySessionResponsePrivate object with public implementation \a q.
 */
DeleteProxySessionResponsePrivate::DeleteProxySessionResponsePrivate(
    DeleteProxySessionResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteProxySession response element from \a xml.
 */
void DeleteProxySessionResponsePrivate::parseDeleteProxySessionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteProxySessionResponse"));
    Q_UNUSED(xml) ///< @todo
}
