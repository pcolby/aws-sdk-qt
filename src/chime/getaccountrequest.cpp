...
/*!
 * \class QtAws::Chime::GetAccountRequest
 * \brief The GetAccountRequest class provides an interface for Chime GetAccount requests.
 *
 * \inmodule QtAwsChime
 *
...
GetAccountRequest::GetAccountRequest(const GetAccountRequest &other)
    : ChimeRequest(new GetAccountRequestPrivate(*other.d_func(), this))
{
...
GetAccountRequest::GetAccountRequest()
    : ChimeRequest(new GetAccountRequestPrivate(ChimeRequest::GetAccountAction, this))
{
...
/*!
 * \class QtAws::Chime::GetAccountRequestPrivate
...
/*!
 * Constructs a GetAccountRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetAccountRequestPrivate::GetAccountRequestPrivate(
    const ChimeRequest::Action action, GetAccountRequest * const q)
