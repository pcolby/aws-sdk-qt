...
#include "associatephonenumberswithvoiceconnectorresponse_p.h"
...
/*!
 * \class QtAws::Chime::AssociatePhoneNumbersWithVoiceConnectorResponse
 * \brief The AssociatePhoneNumbersWithVoiceConnectorResponse class provides an interace for Chime AssociatePhoneNumbersWithVoiceConnector responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::associatePhoneNumbersWithVoiceConnector
 */

/*!
 * Constructs a AssociatePhoneNumbersWithVoiceConnectorResponse object for \a reply to \a request, with parent \a parent.
 */
AssociatePhoneNumbersWithVoiceConnectorResponse::AssociatePhoneNumbersWithVoiceConnectorResponse(
        const AssociatePhoneNumbersWithVoiceConnectorRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new AssociatePhoneNumbersWithVoiceConnectorResponsePrivate(this), parent)
{
    setRequest(new AssociatePhoneNumbersWithVoiceConnectorRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const AssociatePhoneNumbersWithVoiceConnectorRequest * AssociatePhoneNumbersWithVoiceConnectorResponse::request() const
{
    Q_D(const AssociatePhoneNumbersWithVoiceConnectorResponse);
    return static_cast<const AssociatePhoneNumbersWithVoiceConnectorRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime AssociatePhoneNumbersWithVoiceConnector \a response.
 */
void AssociatePhoneNumbersWithVoiceConnectorResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AssociatePhoneNumbersWithVoiceConnectorResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::AssociatePhoneNumbersWithVoiceConnectorResponsePrivate
 * \brief The AssociatePhoneNumbersWithVoiceConnectorResponsePrivate class provides private implementation for AssociatePhoneNumbersWithVoiceConnectorResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a AssociatePhoneNumbersWithVoiceConnectorResponsePrivate object with public implementation \a q.
 */
AssociatePhoneNumbersWithVoiceConnectorResponsePrivate::AssociatePhoneNumbersWithVoiceConnectorResponsePrivate(
    AssociatePhoneNumbersWithVoiceConnectorResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime AssociatePhoneNumbersWithVoiceConnector response element from \a xml.
 */
void AssociatePhoneNumbersWithVoiceConnectorResponsePrivate::parseAssociatePhoneNumbersWithVoiceConnectorResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AssociatePhoneNumbersWithVoiceConnectorResponse"));
    Q_UNUSED(xml) ///< @todo
}
