...
class QTAWS_EXPORT GetSipMediaApplicationResponsePrivate : public ChimeResponsePrivate {

public:

    GetSipMediaApplicationResponsePrivate(GetSipMediaApplicationResponse * const q);
