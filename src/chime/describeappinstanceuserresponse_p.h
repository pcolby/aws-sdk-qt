...
class QTAWS_EXPORT DescribeAppInstanceUserResponsePrivate : public ChimeResponsePrivate {

public:

    DescribeAppInstanceUserResponsePrivate(DescribeAppInstanceUserResponse * const q);
