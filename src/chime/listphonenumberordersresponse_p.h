...
class QTAWS_EXPORT ListPhoneNumberOrdersResponsePrivate : public ChimeResponsePrivate {

public:

    ListPhoneNumberOrdersResponsePrivate(ListPhoneNumberOrdersResponse * const q);
