...
#include "getsipmediaapplicationloggingconfigurationresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetSipMediaApplicationLoggingConfigurationResponse
 * \brief The GetSipMediaApplicationLoggingConfigurationResponse class provides an interace for Chime GetSipMediaApplicationLoggingConfiguration responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a GetSipMediaApplicationLoggingConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
GetSipMediaApplicationLoggingConfigurationResponse::GetSipMediaApplicationLoggingConfigurationResponse(
        const GetSipMediaApplicationLoggingConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetSipMediaApplicationLoggingConfigurationResponsePrivate(this), parent)
{
    setRequest(new GetSipMediaApplicationLoggingConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime GetSipMediaApplicationLoggingConfiguration \a response.
 */
void GetSipMediaApplicationLoggingConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetSipMediaApplicationLoggingConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetSipMediaApplicationLoggingConfigurationResponsePrivate
 * \brief The GetSipMediaApplicationLoggingConfigurationResponsePrivate class provides private implementation for GetSipMediaApplicationLoggingConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetSipMediaApplicationLoggingConfigurationResponsePrivate object with public implementation \a q.
 */
GetSipMediaApplicationLoggingConfigurationResponsePrivate::GetSipMediaApplicationLoggingConfigurationResponsePrivate(
    GetSipMediaApplicationLoggingConfigurationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetSipMediaApplicationLoggingConfiguration response element from \a xml.
 */
void GetSipMediaApplicationLoggingConfigurationResponsePrivate::parseGetSipMediaApplicationLoggingConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetSipMediaApplicationLoggingConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
