...
/*!
 * \class QtAws::Chime::DescribeChannelMembershipForAppInstanceUserRequest
 * \brief The DescribeChannelMembershipForAppInstanceUserRequest class provides an interface for Chime DescribeChannelMembershipForAppInstanceUser requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::describeChannelMembershipForAppInstanceUser
 */
...
DescribeChannelMembershipForAppInstanceUserRequest::DescribeChannelMembershipForAppInstanceUserRequest(const DescribeChannelMembershipForAppInstanceUserRequest &other)
    : ChimeRequest(new DescribeChannelMembershipForAppInstanceUserRequestPrivate(*other.d_func(), this))
{
...
DescribeChannelMembershipForAppInstanceUserRequest::DescribeChannelMembershipForAppInstanceUserRequest()
    : ChimeRequest(new DescribeChannelMembershipForAppInstanceUserRequestPrivate(ChimeRequest::DescribeChannelMembershipForAppInstanceUserAction, this))
{
...
/*!
 * \class QtAws::Chime::DescribeChannelMembershipForAppInstanceUserRequestPrivate
...
/*!
 * Constructs a DescribeChannelMembershipForAppInstanceUserRequestPrivate object for Chime \a action,
...
DescribeChannelMembershipForAppInstanceUserRequestPrivate::DescribeChannelMembershipForAppInstanceUserRequestPrivate(
    const ChimeRequest::Action action, DescribeChannelMembershipForAppInstanceUserRequest * const q)
