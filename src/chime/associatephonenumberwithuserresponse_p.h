...
class QTAWS_EXPORT AssociatePhoneNumberWithUserResponsePrivate : public ChimeResponsePrivate {

public:

    AssociatePhoneNumberWithUserResponsePrivate(AssociatePhoneNumberWithUserResponse * const q);
