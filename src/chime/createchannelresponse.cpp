...
/*!
 * \class QtAws::Chime::CreateChannelResponse
 * \brief The CreateChannelResponse class provides an interace for Chime CreateChannel responses.
 *
 * \inmodule QtAwsChime
 *
...
CreateChannelResponse::CreateChannelResponse(
    ...
    : ChimeResponse(new CreateChannelResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime CreateChannel \a response.
 */
...
/*!
 * \class QtAws::Chime::CreateChannelResponsePrivate
...
CreateChannelResponsePrivate::CreateChannelResponsePrivate(
    CreateChannelResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateChannel response element from \a xml.
 */
