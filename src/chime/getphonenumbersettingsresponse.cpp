...
#include "getphonenumbersettingsresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetPhoneNumberSettingsResponse
 * \brief The GetPhoneNumberSettingsResponse class provides an interace for Chime GetPhoneNumberSettings responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getPhoneNumberSettings
 */

/*!
 * Constructs a GetPhoneNumberSettingsResponse object for \a reply to \a request, with parent \a parent.
 */
GetPhoneNumberSettingsResponse::GetPhoneNumberSettingsResponse(
        const GetPhoneNumberSettingsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetPhoneNumberSettingsResponsePrivate(this), parent)
{
    setRequest(new GetPhoneNumberSettingsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetPhoneNumberSettingsRequest * GetPhoneNumberSettingsResponse::request() const
{
    Q_D(const GetPhoneNumberSettingsResponse);
    return static_cast<const GetPhoneNumberSettingsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime GetPhoneNumberSettings \a response.
 */
void GetPhoneNumberSettingsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetPhoneNumberSettingsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetPhoneNumberSettingsResponsePrivate
 * \brief The GetPhoneNumberSettingsResponsePrivate class provides private implementation for GetPhoneNumberSettingsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetPhoneNumberSettingsResponsePrivate object with public implementation \a q.
 */
GetPhoneNumberSettingsResponsePrivate::GetPhoneNumberSettingsResponsePrivate(
    GetPhoneNumberSettingsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetPhoneNumberSettings response element from \a xml.
 */
void GetPhoneNumberSettingsResponsePrivate::parseGetPhoneNumberSettingsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetPhoneNumberSettingsResponse"));
    Q_UNUSED(xml) ///< @todo
}
