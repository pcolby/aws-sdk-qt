...
/*!
 * \class QtAws::Chime::CreateMeetingWithAttendeesResponse
 * \brief The CreateMeetingWithAttendeesResponse class provides an interace for Chime CreateMeetingWithAttendees responses.
 *
 * \inmodule QtAwsChime
 *
...
CreateMeetingWithAttendeesResponse::CreateMeetingWithAttendeesResponse(
    ...
    : ChimeResponse(new CreateMeetingWithAttendeesResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime CreateMeetingWithAttendees \a response.
 */
...
/*!
 * \class QtAws::Chime::CreateMeetingWithAttendeesResponsePrivate
...
CreateMeetingWithAttendeesResponsePrivate::CreateMeetingWithAttendeesResponsePrivate(
    CreateMeetingWithAttendeesResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateMeetingWithAttendees response element from \a xml.
 */
