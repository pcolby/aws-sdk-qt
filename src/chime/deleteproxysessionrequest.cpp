...
#include "deleteproxysessionrequest_p.h"
...
/*!
 * \class QtAws::Chime::DeleteProxySessionRequest
 * \brief The DeleteProxySessionRequest class provides an interface for Chime DeleteProxySession requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteProxySession
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteProxySessionRequest::DeleteProxySessionRequest(const DeleteProxySessionRequest &other)
    : ChimeRequest(new DeleteProxySessionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteProxySessionRequest object.
 */
DeleteProxySessionRequest::DeleteProxySessionRequest()
    : ChimeRequest(new DeleteProxySessionRequestPrivate(ChimeRequest::DeleteProxySessionAction, this))
{
 ...
 * \reimp
 */
bool DeleteProxySessionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteProxySessionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteProxySessionRequest::response(QNetworkReply * const reply) const
{
    return new DeleteProxySessionResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeleteProxySessionRequestPrivate
 * \brief The DeleteProxySessionRequestPrivate class provides private implementation for DeleteProxySessionRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteProxySessionRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteProxySessionRequestPrivate::DeleteProxySessionRequestPrivate(
    const ChimeRequest::Action action, DeleteProxySessionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteProxySessionRequest
 * class' copy constructor.
 */
DeleteProxySessionRequestPrivate::DeleteProxySessionRequestPrivate(
    const DeleteProxySessionRequestPrivate &other, DeleteProxySessionRequest * const q)
