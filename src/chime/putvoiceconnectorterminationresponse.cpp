...
#include "putvoiceconnectorterminationresponse_p.h"
...
/*!
 * \class QtAws::Chime::PutVoiceConnectorTerminationResponse
 * \brief The PutVoiceConnectorTerminationResponse class provides an interace for Chime PutVoiceConnectorTermination responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::putVoiceConnectorTermination
 */

/*!
 * Constructs a PutVoiceConnectorTerminationResponse object for \a reply to \a request, with parent \a parent.
 */
PutVoiceConnectorTerminationResponse::PutVoiceConnectorTerminationResponse(
        const PutVoiceConnectorTerminationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new PutVoiceConnectorTerminationResponsePrivate(this), parent)
{
    setRequest(new PutVoiceConnectorTerminationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const PutVoiceConnectorTerminationRequest * PutVoiceConnectorTerminationResponse::request() const
{
    Q_D(const PutVoiceConnectorTerminationResponse);
    return static_cast<const PutVoiceConnectorTerminationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime PutVoiceConnectorTermination \a response.
 */
void PutVoiceConnectorTerminationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutVoiceConnectorTerminationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::PutVoiceConnectorTerminationResponsePrivate
 * \brief The PutVoiceConnectorTerminationResponsePrivate class provides private implementation for PutVoiceConnectorTerminationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutVoiceConnectorTerminationResponsePrivate object with public implementation \a q.
 */
PutVoiceConnectorTerminationResponsePrivate::PutVoiceConnectorTerminationResponsePrivate(
    PutVoiceConnectorTerminationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime PutVoiceConnectorTermination response element from \a xml.
 */
void PutVoiceConnectorTerminationResponsePrivate::parsePutVoiceConnectorTerminationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutVoiceConnectorTerminationResponse"));
    Q_UNUSED(xml) ///< @todo
}
