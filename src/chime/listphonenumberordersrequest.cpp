...
#include "listphonenumberordersrequest_p.h"
...
/*!
 * \class QtAws::Chime::ListPhoneNumberOrdersRequest
 * \brief The ListPhoneNumberOrdersRequest class provides an interface for Chime ListPhoneNumberOrders requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
ListPhoneNumberOrdersRequest::ListPhoneNumberOrdersRequest(const ListPhoneNumberOrdersRequest &other)
    : ChimeRequest(new ListPhoneNumberOrdersRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListPhoneNumberOrdersRequest object.
 */
ListPhoneNumberOrdersRequest::ListPhoneNumberOrdersRequest()
    : ChimeRequest(new ListPhoneNumberOrdersRequestPrivate(ChimeRequest::ListPhoneNumberOrdersAction, this))
{
 ...
 * \reimp
 */
bool ListPhoneNumberOrdersRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListPhoneNumberOrdersResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListPhoneNumberOrdersRequest::response(QNetworkReply * const reply) const
{
    return new ListPhoneNumberOrdersResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::ListPhoneNumberOrdersRequestPrivate
 * \brief The ListPhoneNumberOrdersRequestPrivate class provides private implementation for ListPhoneNumberOrdersRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListPhoneNumberOrdersRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListPhoneNumberOrdersRequestPrivate::ListPhoneNumberOrdersRequestPrivate(
    const ChimeRequest::Action action, ListPhoneNumberOrdersRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListPhoneNumberOrdersRequest
 * class' copy constructor.
 */
ListPhoneNumberOrdersRequestPrivate::ListPhoneNumberOrdersRequestPrivate(
    const ListPhoneNumberOrdersRequestPrivate &other, ListPhoneNumberOrdersRequest * const q)
