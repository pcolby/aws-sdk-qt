...
class QTAWS_EXPORT UpdateRoomMembershipResponsePrivate : public ChimeResponsePrivate {

public:

    UpdateRoomMembershipResponsePrivate(UpdateRoomMembershipResponse * const q);
