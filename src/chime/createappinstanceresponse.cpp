...
/*!
 * \class QtAws::Chime::CreateAppInstanceResponse
 * \brief The CreateAppInstanceResponse class provides an interace for Chime CreateAppInstance responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createAppInstance
 */
...
CreateAppInstanceResponse::CreateAppInstanceResponse(
    ...
    : ChimeResponse(new CreateAppInstanceResponsePrivate(this), parent)
{
...
{
    return static_cast<const CreateAppInstanceRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime CreateAppInstance \a response.
 */
...
/*!
 * \class QtAws::Chime::CreateAppInstanceResponsePrivate
...
CreateAppInstanceResponsePrivate::CreateAppInstanceResponsePrivate(
    CreateAppInstanceResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateAppInstance response element from \a xml.
 */
