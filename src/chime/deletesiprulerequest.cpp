...
#include "deletesiprulerequest_p.h"
...
/*!
 * \class QtAws::Chime::DeleteSipRuleRequest
 * \brief The DeleteSipRuleRequest class provides an interface for Chime DeleteSipRule requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteSipRule
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteSipRuleRequest::DeleteSipRuleRequest(const DeleteSipRuleRequest &other)
    : ChimeRequest(new DeleteSipRuleRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteSipRuleRequest object.
 */
DeleteSipRuleRequest::DeleteSipRuleRequest()
    : ChimeRequest(new DeleteSipRuleRequestPrivate(ChimeRequest::DeleteSipRuleAction, this))
{
 ...
 * \reimp
 */
bool DeleteSipRuleRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteSipRuleResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteSipRuleRequest::response(QNetworkReply * const reply) const
{
    return new DeleteSipRuleResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeleteSipRuleRequestPrivate
 * \brief The DeleteSipRuleRequestPrivate class provides private implementation for DeleteSipRuleRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteSipRuleRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteSipRuleRequestPrivate::DeleteSipRuleRequestPrivate(
    const ChimeRequest::Action action, DeleteSipRuleRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteSipRuleRequest
 * class' copy constructor.
 */
DeleteSipRuleRequestPrivate::DeleteSipRuleRequestPrivate(
    const DeleteSipRuleRequestPrivate &other, DeleteSipRuleRequest * const q)
