...
class QTAWS_EXPORT DeleteRoomMembershipResponsePrivate : public ChimeResponsePrivate {

public:

    DeleteRoomMembershipResponsePrivate(DeleteRoomMembershipResponse * const q);
