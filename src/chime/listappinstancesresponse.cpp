...
/*!
 * \class QtAws::Chime::ListAppInstancesResponse
 * \brief The ListAppInstancesResponse class provides an interace for Chime ListAppInstances responses.
 *
 * \inmodule QtAwsChime
 *
...
ListAppInstancesResponse::ListAppInstancesResponse(
    ...
    : ChimeResponse(new ListAppInstancesResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime ListAppInstances \a response.
 */
...
/*!
 * \class QtAws::Chime::ListAppInstancesResponsePrivate
...
ListAppInstancesResponsePrivate::ListAppInstancesResponsePrivate(
    ListAppInstancesResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListAppInstances response element from \a xml.
 */
