...
#include "listattendeetagsresponse_p.h"
...
/*!
 * \class QtAws::Chime::ListAttendeeTagsResponse
 * \brief The ListAttendeeTagsResponse class provides an interace for Chime ListAttendeeTags responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a ListAttendeeTagsResponse object for \a reply to \a request, with parent \a parent.
 */
ListAttendeeTagsResponse::ListAttendeeTagsResponse(
        const ListAttendeeTagsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new ListAttendeeTagsResponsePrivate(this), parent)
{
    setRequest(new ListAttendeeTagsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime ListAttendeeTags \a response.
 */
void ListAttendeeTagsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListAttendeeTagsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::ListAttendeeTagsResponsePrivate
 * \brief The ListAttendeeTagsResponsePrivate class provides private implementation for ListAttendeeTagsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListAttendeeTagsResponsePrivate object with public implementation \a q.
 */
ListAttendeeTagsResponsePrivate::ListAttendeeTagsResponsePrivate(
    ListAttendeeTagsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListAttendeeTags response element from \a xml.
 */
void ListAttendeeTagsResponsePrivate::parseListAttendeeTagsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListAttendeeTagsResponse"));
    Q_UNUSED(xml) ///< @todo
}
