...
/*!
 * \class QtAws::Chime::PutAppInstanceRetentionSettingsRequest
 * \brief The PutAppInstanceRetentionSettingsRequest class provides an interface for Chime PutAppInstanceRetentionSettings requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::putAppInstanceRetentionSettings
 */
...
PutAppInstanceRetentionSettingsRequest::PutAppInstanceRetentionSettingsRequest(const PutAppInstanceRetentionSettingsRequest &other)
    : ChimeRequest(new PutAppInstanceRetentionSettingsRequestPrivate(*other.d_func(), this))
{
...
PutAppInstanceRetentionSettingsRequest::PutAppInstanceRetentionSettingsRequest()
    : ChimeRequest(new PutAppInstanceRetentionSettingsRequestPrivate(ChimeRequest::PutAppInstanceRetentionSettingsAction, this))
{
...
/*!
 * \class QtAws::Chime::PutAppInstanceRetentionSettingsRequestPrivate
...
/*!
 * Constructs a PutAppInstanceRetentionSettingsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
PutAppInstanceRetentionSettingsRequestPrivate::PutAppInstanceRetentionSettingsRequestPrivate(
    const ChimeRequest::Action action, PutAppInstanceRetentionSettingsRequest * const q)
