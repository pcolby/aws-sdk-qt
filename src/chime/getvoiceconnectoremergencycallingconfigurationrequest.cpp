...
#include "getvoiceconnectoremergencycallingconfigurationrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorEmergencyCallingConfigurationRequest
 * \brief The GetVoiceConnectorEmergencyCallingConfigurationRequest class provides an interface for Chime GetVoiceConnectorEmergencyCallingConfiguration requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getVoiceConnectorEmergencyCallingConfiguration
 */

/*!
 * Constructs a copy of \a other.
 */
GetVoiceConnectorEmergencyCallingConfigurationRequest::GetVoiceConnectorEmergencyCallingConfigurationRequest(const GetVoiceConnectorEmergencyCallingConfigurationRequest &other)
    : ChimeRequest(new GetVoiceConnectorEmergencyCallingConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetVoiceConnectorEmergencyCallingConfigurationRequest object.
 */
GetVoiceConnectorEmergencyCallingConfigurationRequest::GetVoiceConnectorEmergencyCallingConfigurationRequest()
    : ChimeRequest(new GetVoiceConnectorEmergencyCallingConfigurationRequestPrivate(ChimeRequest::GetVoiceConnectorEmergencyCallingConfigurationAction, this))
{
 ...
 * \reimp
 */
bool GetVoiceConnectorEmergencyCallingConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetVoiceConnectorEmergencyCallingConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetVoiceConnectorEmergencyCallingConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new GetVoiceConnectorEmergencyCallingConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorEmergencyCallingConfigurationRequestPrivate
 * \brief The GetVoiceConnectorEmergencyCallingConfigurationRequestPrivate class provides private implementation for GetVoiceConnectorEmergencyCallingConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorEmergencyCallingConfigurationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetVoiceConnectorEmergencyCallingConfigurationRequestPrivate::GetVoiceConnectorEmergencyCallingConfigurationRequestPrivate(
    const ChimeRequest::Action action, GetVoiceConnectorEmergencyCallingConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetVoiceConnectorEmergencyCallingConfigurationRequest
 * class' copy constructor.
 */
GetVoiceConnectorEmergencyCallingConfigurationRequestPrivate::GetVoiceConnectorEmergencyCallingConfigurationRequestPrivate(
    const GetVoiceConnectorEmergencyCallingConfigurationRequestPrivate &other, GetVoiceConnectorEmergencyCallingConfigurationRequest * const q)
