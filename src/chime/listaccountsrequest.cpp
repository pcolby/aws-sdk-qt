...
/*!
 * \class QtAws::Chime::ListAccountsRequest
 * \brief The ListAccountsRequest class provides an interface for Chime ListAccounts requests.
 *
 * \inmodule QtAwsChime
 *
...
ListAccountsRequest::ListAccountsRequest(const ListAccountsRequest &other)
    : ChimeRequest(new ListAccountsRequestPrivate(*other.d_func(), this))
{
...
ListAccountsRequest::ListAccountsRequest()
    : ChimeRequest(new ListAccountsRequestPrivate(ChimeRequest::ListAccountsAction, this))
{
...
/*!
 * \class QtAws::Chime::ListAccountsRequestPrivate
...
/*!
 * Constructs a ListAccountsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListAccountsRequestPrivate::ListAccountsRequestPrivate(
    const ChimeRequest::Action action, ListAccountsRequest * const q)
