...
#include "deleteappinstancestreamingconfigurationsresponse_p.h"
...
/*!
 * \class QtAws::Chime::DeleteAppInstanceStreamingConfigurationsResponse
 * \brief The DeleteAppInstanceStreamingConfigurationsResponse class provides an interace for Chime DeleteAppInstanceStreamingConfigurations responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a DeleteAppInstanceStreamingConfigurationsResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteAppInstanceStreamingConfigurationsResponse::DeleteAppInstanceStreamingConfigurationsResponse(
        const DeleteAppInstanceStreamingConfigurationsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DeleteAppInstanceStreamingConfigurationsResponsePrivate(this), parent)
{
    setRequest(new DeleteAppInstanceStreamingConfigurationsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime DeleteAppInstanceStreamingConfigurations \a response.
 */
void DeleteAppInstanceStreamingConfigurationsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteAppInstanceStreamingConfigurationsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DeleteAppInstanceStreamingConfigurationsResponsePrivate
 * \brief The DeleteAppInstanceStreamingConfigurationsResponsePrivate class provides private implementation for DeleteAppInstanceStreamingConfigurationsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteAppInstanceStreamingConfigurationsResponsePrivate object with public implementation \a q.
 */
DeleteAppInstanceStreamingConfigurationsResponsePrivate::DeleteAppInstanceStreamingConfigurationsResponsePrivate(
    DeleteAppInstanceStreamingConfigurationsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteAppInstanceStreamingConfigurations response element from \a xml.
 */
void DeleteAppInstanceStreamingConfigurationsResponsePrivate::parseDeleteAppInstanceStreamingConfigurationsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteAppInstanceStreamingConfigurationsResponse"));
    Q_UNUSED(xml) ///< @todo
}
