...
#include "deletevoiceconnectoremergencycallingconfigurationresponse_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorEmergencyCallingConfigurationResponse
 * \brief The DeleteVoiceConnectorEmergencyCallingConfigurationResponse class provides an interace for Chime DeleteVoiceConnectorEmergencyCallingConfiguration responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a DeleteVoiceConnectorEmergencyCallingConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteVoiceConnectorEmergencyCallingConfigurationResponse::DeleteVoiceConnectorEmergencyCallingConfigurationResponse(
    ...
    : ChimeResponse(new DeleteVoiceConnectorEmergencyCallingConfigurationResponsePrivate(this), parent)
{
    setRequest(new DeleteVoiceConnectorEmergencyCallingConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime DeleteVoiceConnectorEmergencyCallingConfiguration \a response.
 */
void DeleteVoiceConnectorEmergencyCallingConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteVoiceConnectorEmergencyCallingConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorEmergencyCallingConfigurationResponsePrivate
 * \brief The DeleteVoiceConnectorEmergencyCallingConfigurationResponsePrivate class provides private implementation for DeleteVoiceConnectorEmergencyCallingConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorEmergencyCallingConfigurationResponsePrivate object with public implementation \a q.
 */
DeleteVoiceConnectorEmergencyCallingConfigurationResponsePrivate::DeleteVoiceConnectorEmergencyCallingConfigurationResponsePrivate(
    DeleteVoiceConnectorEmergencyCallingConfigurationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteVoiceConnectorEmergencyCallingConfiguration response element from \a xml.
 */
void DeleteVoiceConnectorEmergencyCallingConfigurationResponsePrivate::parseDeleteVoiceConnectorEmergencyCallingConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteVoiceConnectorEmergencyCallingConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
