...
#include "listvoiceconnectorterminationcredentialsresponse_p.h"
...
/*!
 * \class QtAws::Chime::ListVoiceConnectorTerminationCredentialsResponse
 * \brief The ListVoiceConnectorTerminationCredentialsResponse class provides an interace for Chime ListVoiceConnectorTerminationCredentials responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a ListVoiceConnectorTerminationCredentialsResponse object for \a reply to \a request, with parent \a parent.
 */
ListVoiceConnectorTerminationCredentialsResponse::ListVoiceConnectorTerminationCredentialsResponse(
        const ListVoiceConnectorTerminationCredentialsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new ListVoiceConnectorTerminationCredentialsResponsePrivate(this), parent)
{
    setRequest(new ListVoiceConnectorTerminationCredentialsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime ListVoiceConnectorTerminationCredentials \a response.
 */
void ListVoiceConnectorTerminationCredentialsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListVoiceConnectorTerminationCredentialsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::ListVoiceConnectorTerminationCredentialsResponsePrivate
 * \brief The ListVoiceConnectorTerminationCredentialsResponsePrivate class provides private implementation for ListVoiceConnectorTerminationCredentialsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListVoiceConnectorTerminationCredentialsResponsePrivate object with public implementation \a q.
 */
ListVoiceConnectorTerminationCredentialsResponsePrivate::ListVoiceConnectorTerminationCredentialsResponsePrivate(
    ListVoiceConnectorTerminationCredentialsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListVoiceConnectorTerminationCredentials response element from \a xml.
 */
void ListVoiceConnectorTerminationCredentialsResponsePrivate::parseListVoiceConnectorTerminationCredentialsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListVoiceConnectorTerminationCredentialsResponse"));
    Q_UNUSED(xml) ///< @todo
}
