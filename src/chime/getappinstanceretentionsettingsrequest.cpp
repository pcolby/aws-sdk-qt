...
/*!
 * \class QtAws::Chime::GetAppInstanceRetentionSettingsRequest
 * \brief The GetAppInstanceRetentionSettingsRequest class provides an interface for Chime GetAppInstanceRetentionSettings requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getAppInstanceRetentionSettings
 */
...
GetAppInstanceRetentionSettingsRequest::GetAppInstanceRetentionSettingsRequest(const GetAppInstanceRetentionSettingsRequest &other)
    : ChimeRequest(new GetAppInstanceRetentionSettingsRequestPrivate(*other.d_func(), this))
{
...
GetAppInstanceRetentionSettingsRequest::GetAppInstanceRetentionSettingsRequest()
    : ChimeRequest(new GetAppInstanceRetentionSettingsRequestPrivate(ChimeRequest::GetAppInstanceRetentionSettingsAction, this))
{
...
/*!
 * \class QtAws::Chime::GetAppInstanceRetentionSettingsRequestPrivate
...
/*!
 * Constructs a GetAppInstanceRetentionSettingsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetAppInstanceRetentionSettingsRequestPrivate::GetAppInstanceRetentionSettingsRequestPrivate(
    const ChimeRequest::Action action, GetAppInstanceRetentionSettingsRequest * const q)
