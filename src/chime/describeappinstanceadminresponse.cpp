...
/*!
 * \class QtAws::Chime::DescribeAppInstanceAdminResponse
 * \brief The DescribeAppInstanceAdminResponse class provides an interace for Chime DescribeAppInstanceAdmin responses.
 *
 * \inmodule QtAwsChime
 *
...
DescribeAppInstanceAdminResponse::DescribeAppInstanceAdminResponse(
    ...
    : ChimeResponse(new DescribeAppInstanceAdminResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DescribeAppInstanceAdmin \a response.
 */
...
/*!
 * \class QtAws::Chime::DescribeAppInstanceAdminResponsePrivate
...
DescribeAppInstanceAdminResponsePrivate::DescribeAppInstanceAdminResponsePrivate(
    DescribeAppInstanceAdminResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DescribeAppInstanceAdmin response element from \a xml.
 */
