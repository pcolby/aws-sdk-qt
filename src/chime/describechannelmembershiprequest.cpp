...
/*!
 * \class QtAws::Chime::DescribeChannelMembershipRequest
 * \brief The DescribeChannelMembershipRequest class provides an interface for Chime DescribeChannelMembership requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::describeChannelMembership
 */
...
DescribeChannelMembershipRequest::DescribeChannelMembershipRequest(const DescribeChannelMembershipRequest &other)
    : ChimeRequest(new DescribeChannelMembershipRequestPrivate(*other.d_func(), this))
{
...
DescribeChannelMembershipRequest::DescribeChannelMembershipRequest()
    : ChimeRequest(new DescribeChannelMembershipRequestPrivate(ChimeRequest::DescribeChannelMembershipAction, this))
{
...
/*!
 * \class QtAws::Chime::DescribeChannelMembershipRequestPrivate
...
/*!
 * Constructs a DescribeChannelMembershipRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DescribeChannelMembershipRequestPrivate::DescribeChannelMembershipRequestPrivate(
    const ChimeRequest::Action action, DescribeChannelMembershipRequest * const q)
