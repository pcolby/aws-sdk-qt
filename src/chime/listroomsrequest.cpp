...
/*!
 * \class QtAws::Chime::ListRoomsRequest
 * \brief The ListRoomsRequest class provides an interface for Chime ListRooms requests.
 *
 * \inmodule QtAwsChime
 *
...
ListRoomsRequest::ListRoomsRequest(const ListRoomsRequest &other)
    : ChimeRequest(new ListRoomsRequestPrivate(*other.d_func(), this))
{
...
ListRoomsRequest::ListRoomsRequest()
    : ChimeRequest(new ListRoomsRequestPrivate(ChimeRequest::ListRoomsAction, this))
{
...
/*!
 * \class QtAws::Chime::ListRoomsRequestPrivate
...
/*!
 * Constructs a ListRoomsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListRoomsRequestPrivate::ListRoomsRequestPrivate(
    const ChimeRequest::Action action, ListRoomsRequest * const q)
