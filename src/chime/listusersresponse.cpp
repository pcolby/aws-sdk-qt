...
/*!
 * \class QtAws::Chime::ListUsersResponse
 * \brief The ListUsersResponse class provides an interace for Chime ListUsers responses.
 *
 * \inmodule QtAwsChime
 *
...
ListUsersResponse::ListUsersResponse(
    ...
    : ChimeResponse(new ListUsersResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListUsersRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime ListUsers \a response.
 */
...
/*!
 * \class QtAws::Chime::ListUsersResponsePrivate
...
ListUsersResponsePrivate::ListUsersResponsePrivate(
    ListUsersResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListUsers response element from \a xml.
 */
