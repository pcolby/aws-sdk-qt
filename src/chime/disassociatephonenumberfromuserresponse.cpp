...
#include "disassociatephonenumberfromuserresponse_p.h"
...
/*!
 * \class QtAws::Chime::DisassociatePhoneNumberFromUserResponse
 * \brief The DisassociatePhoneNumberFromUserResponse class provides an interace for Chime DisassociatePhoneNumberFromUser responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a DisassociatePhoneNumberFromUserResponse object for \a reply to \a request, with parent \a parent.
 */
DisassociatePhoneNumberFromUserResponse::DisassociatePhoneNumberFromUserResponse(
        const DisassociatePhoneNumberFromUserRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DisassociatePhoneNumberFromUserResponsePrivate(this), parent)
{
    setRequest(new DisassociatePhoneNumberFromUserRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime DisassociatePhoneNumberFromUser \a response.
 */
void DisassociatePhoneNumberFromUserResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DisassociatePhoneNumberFromUserResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DisassociatePhoneNumberFromUserResponsePrivate
 * \brief The DisassociatePhoneNumberFromUserResponsePrivate class provides private implementation for DisassociatePhoneNumberFromUserResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DisassociatePhoneNumberFromUserResponsePrivate object with public implementation \a q.
 */
DisassociatePhoneNumberFromUserResponsePrivate::DisassociatePhoneNumberFromUserResponsePrivate(
    DisassociatePhoneNumberFromUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DisassociatePhoneNumberFromUser response element from \a xml.
 */
void DisassociatePhoneNumberFromUserResponsePrivate::parseDisassociatePhoneNumberFromUserResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DisassociatePhoneNumberFromUserResponse"));
    Q_UNUSED(xml) ///< @todo
}
