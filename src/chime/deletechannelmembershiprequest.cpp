...
/*!
 * \class QtAws::Chime::DeleteChannelMembershipRequest
 * \brief The DeleteChannelMembershipRequest class provides an interface for Chime DeleteChannelMembership requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteChannelMembership
 */
...
DeleteChannelMembershipRequest::DeleteChannelMembershipRequest(const DeleteChannelMembershipRequest &other)
    : ChimeRequest(new DeleteChannelMembershipRequestPrivate(*other.d_func(), this))
{
...
DeleteChannelMembershipRequest::DeleteChannelMembershipRequest()
    : ChimeRequest(new DeleteChannelMembershipRequestPrivate(ChimeRequest::DeleteChannelMembershipAction, this))
{
...
/*!
 * \class QtAws::Chime::DeleteChannelMembershipRequestPrivate
...
/*!
 * Constructs a DeleteChannelMembershipRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteChannelMembershipRequestPrivate::DeleteChannelMembershipRequestPrivate(
    const ChimeRequest::Action action, DeleteChannelMembershipRequest * const q)
