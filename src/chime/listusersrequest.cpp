...
/*!
 * \class QtAws::Chime::ListUsersRequest
 * \brief The ListUsersRequest class provides an interface for Chime ListUsers requests.
 *
 * \inmodule QtAwsChime
 *
...
ListUsersRequest::ListUsersRequest(const ListUsersRequest &other)
    : ChimeRequest(new ListUsersRequestPrivate(*other.d_func(), this))
{
...
ListUsersRequest::ListUsersRequest()
    : ChimeRequest(new ListUsersRequestPrivate(ChimeRequest::ListUsersAction, this))
{
...
/*!
 * \class QtAws::Chime::ListUsersRequestPrivate
...
/*!
 * Constructs a ListUsersRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListUsersRequestPrivate::ListUsersRequestPrivate(
    const ChimeRequest::Action action, ListUsersRequest * const q)
