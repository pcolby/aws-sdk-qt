...
#include "listmeetingsrequest_p.h"
...
/*!
 * \class QtAws::Chime::ListMeetingsRequest
 * \brief The ListMeetingsRequest class provides an interface for Chime ListMeetings requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listMeetings
 */

/*!
 * Constructs a copy of \a other.
 */
ListMeetingsRequest::ListMeetingsRequest(const ListMeetingsRequest &other)
    : ChimeRequest(new ListMeetingsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListMeetingsRequest object.
 */
ListMeetingsRequest::ListMeetingsRequest()
    : ChimeRequest(new ListMeetingsRequestPrivate(ChimeRequest::ListMeetingsAction, this))
{
 ...
 * \reimp
 */
bool ListMeetingsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListMeetingsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListMeetingsRequest::response(QNetworkReply * const reply) const
{
    return new ListMeetingsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::ListMeetingsRequestPrivate
 * \brief The ListMeetingsRequestPrivate class provides private implementation for ListMeetingsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListMeetingsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListMeetingsRequestPrivate::ListMeetingsRequestPrivate(
    const ChimeRequest::Action action, ListMeetingsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListMeetingsRequest
 * class' copy constructor.
 */
ListMeetingsRequestPrivate::ListMeetingsRequestPrivate(
    const ListMeetingsRequestPrivate &other, ListMeetingsRequest * const q)
