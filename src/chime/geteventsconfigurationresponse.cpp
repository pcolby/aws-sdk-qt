...
#include "geteventsconfigurationresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetEventsConfigurationResponse
 * \brief The GetEventsConfigurationResponse class provides an interace for Chime GetEventsConfiguration responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a GetEventsConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
GetEventsConfigurationResponse::GetEventsConfigurationResponse(
        const GetEventsConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetEventsConfigurationResponsePrivate(this), parent)
{
    setRequest(new GetEventsConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime GetEventsConfiguration \a response.
 */
void GetEventsConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetEventsConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetEventsConfigurationResponsePrivate
 * \brief The GetEventsConfigurationResponsePrivate class provides private implementation for GetEventsConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetEventsConfigurationResponsePrivate object with public implementation \a q.
 */
GetEventsConfigurationResponsePrivate::GetEventsConfigurationResponsePrivate(
    GetEventsConfigurationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetEventsConfiguration response element from \a xml.
 */
void GetEventsConfigurationResponsePrivate::parseGetEventsConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetEventsConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
