...
#include "createsipmediaapplicationresponse_p.h"
...
/*!
 * \class QtAws::Chime::CreateSipMediaApplicationResponse
 * \brief The CreateSipMediaApplicationResponse class provides an interace for Chime CreateSipMediaApplication responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createSipMediaApplication
 */

/*!
 * Constructs a CreateSipMediaApplicationResponse object for \a reply to \a request, with parent \a parent.
 */
CreateSipMediaApplicationResponse::CreateSipMediaApplicationResponse(
        const CreateSipMediaApplicationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new CreateSipMediaApplicationResponsePrivate(this), parent)
{
    setRequest(new CreateSipMediaApplicationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const CreateSipMediaApplicationRequest * CreateSipMediaApplicationResponse::request() const
{
    Q_D(const CreateSipMediaApplicationResponse);
    return static_cast<const CreateSipMediaApplicationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime CreateSipMediaApplication \a response.
 */
void CreateSipMediaApplicationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateSipMediaApplicationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::CreateSipMediaApplicationResponsePrivate
 * \brief The CreateSipMediaApplicationResponsePrivate class provides private implementation for CreateSipMediaApplicationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateSipMediaApplicationResponsePrivate object with public implementation \a q.
 */
CreateSipMediaApplicationResponsePrivate::CreateSipMediaApplicationResponsePrivate(
    CreateSipMediaApplicationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateSipMediaApplication response element from \a xml.
 */
void CreateSipMediaApplicationResponsePrivate::parseCreateSipMediaApplicationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateSipMediaApplicationResponse"));
    Q_UNUSED(xml) ///< @todo
}
