...
#include "getvoiceconnectorgroupresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorGroupResponse
 * \brief The GetVoiceConnectorGroupResponse class provides an interace for Chime GetVoiceConnectorGroup responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getVoiceConnectorGroup
 */

/*!
 * Constructs a GetVoiceConnectorGroupResponse object for \a reply to \a request, with parent \a parent.
 */
GetVoiceConnectorGroupResponse::GetVoiceConnectorGroupResponse(
        const GetVoiceConnectorGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetVoiceConnectorGroupResponsePrivate(this), parent)
{
    setRequest(new GetVoiceConnectorGroupRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetVoiceConnectorGroupRequest * GetVoiceConnectorGroupResponse::request() const
{
    Q_D(const GetVoiceConnectorGroupResponse);
    return static_cast<const GetVoiceConnectorGroupRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime GetVoiceConnectorGroup \a response.
 */
void GetVoiceConnectorGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetVoiceConnectorGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorGroupResponsePrivate
 * \brief The GetVoiceConnectorGroupResponsePrivate class provides private implementation for GetVoiceConnectorGroupResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorGroupResponsePrivate object with public implementation \a q.
 */
GetVoiceConnectorGroupResponsePrivate::GetVoiceConnectorGroupResponsePrivate(
    GetVoiceConnectorGroupResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetVoiceConnectorGroup response element from \a xml.
 */
void GetVoiceConnectorGroupResponsePrivate::parseGetVoiceConnectorGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetVoiceConnectorGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
