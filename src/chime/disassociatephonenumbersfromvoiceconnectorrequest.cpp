...
#include "disassociatephonenumbersfromvoiceconnectorrequest_p.h"
...
/*!
 * \class QtAws::Chime::DisassociatePhoneNumbersFromVoiceConnectorRequest
 * \brief The DisassociatePhoneNumbersFromVoiceConnectorRequest class provides an interface for Chime DisassociatePhoneNumbersFromVoiceConnector requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
DisassociatePhoneNumbersFromVoiceConnectorRequest::DisassociatePhoneNumbersFromVoiceConnectorRequest(const DisassociatePhoneNumbersFromVoiceConnectorRequest &other)
    : ChimeRequest(new DisassociatePhoneNumbersFromVoiceConnectorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DisassociatePhoneNumbersFromVoiceConnectorRequest object.
 */
DisassociatePhoneNumbersFromVoiceConnectorRequest::DisassociatePhoneNumbersFromVoiceConnectorRequest()
    : ChimeRequest(new DisassociatePhoneNumbersFromVoiceConnectorRequestPrivate(ChimeRequest::DisassociatePhoneNumbersFromVoiceConnectorAction, this))
{
 ...
 * \reimp
 */
bool DisassociatePhoneNumbersFromVoiceConnectorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DisassociatePhoneNumbersFromVoiceConnectorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DisassociatePhoneNumbersFromVoiceConnectorRequest::response(QNetworkReply * const reply) const
{
    return new DisassociatePhoneNumbersFromVoiceConnectorResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DisassociatePhoneNumbersFromVoiceConnectorRequestPrivate
 * \brief The DisassociatePhoneNumbersFromVoiceConnectorRequestPrivate class provides private implementation for DisassociatePhoneNumbersFromVoiceConnectorRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DisassociatePhoneNumbersFromVoiceConnectorRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DisassociatePhoneNumbersFromVoiceConnectorRequestPrivate::DisassociatePhoneNumbersFromVoiceConnectorRequestPrivate(
    const ChimeRequest::Action action, DisassociatePhoneNumbersFromVoiceConnectorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DisassociatePhoneNumbersFromVoiceConnectorRequest
 * class' copy constructor.
 */
DisassociatePhoneNumbersFromVoiceConnectorRequestPrivate::DisassociatePhoneNumbersFromVoiceConnectorRequestPrivate(
    const DisassociatePhoneNumbersFromVoiceConnectorRequestPrivate &other, DisassociatePhoneNumbersFromVoiceConnectorRequest * const q)
