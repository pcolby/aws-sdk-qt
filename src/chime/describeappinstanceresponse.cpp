...
/*!
 * \class QtAws::Chime::DescribeAppInstanceResponse
 * \brief The DescribeAppInstanceResponse class provides an interace for Chime DescribeAppInstance responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::describeAppInstance
 */
...
DescribeAppInstanceResponse::DescribeAppInstanceResponse(
    ...
    : ChimeResponse(new DescribeAppInstanceResponsePrivate(this), parent)
{
...
{
    return static_cast<const DescribeAppInstanceRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime DescribeAppInstance \a response.
 */
...
/*!
 * \class QtAws::Chime::DescribeAppInstanceResponsePrivate
...
DescribeAppInstanceResponsePrivate::DescribeAppInstanceResponsePrivate(
    DescribeAppInstanceResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DescribeAppInstance response element from \a xml.
 */
