...
/*!
 * \class QtAws::Chime::UpdateAppInstanceRequest
 * \brief The UpdateAppInstanceRequest class provides an interface for Chime UpdateAppInstance requests.
 *
 * \inmodule QtAwsChime
 *
...
UpdateAppInstanceRequest::UpdateAppInstanceRequest(const UpdateAppInstanceRequest &other)
    : ChimeRequest(new UpdateAppInstanceRequestPrivate(*other.d_func(), this))
{
...
UpdateAppInstanceRequest::UpdateAppInstanceRequest()
    : ChimeRequest(new UpdateAppInstanceRequestPrivate(ChimeRequest::UpdateAppInstanceAction, this))
{
...
/*!
 * \class QtAws::Chime::UpdateAppInstanceRequestPrivate
...
/*!
 * Constructs a UpdateAppInstanceRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateAppInstanceRequestPrivate::UpdateAppInstanceRequestPrivate(
    const ChimeRequest::Action action, UpdateAppInstanceRequest * const q)
