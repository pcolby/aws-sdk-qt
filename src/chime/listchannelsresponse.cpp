...
/*!
 * \class QtAws::Chime::ListChannelsResponse
 * \brief The ListChannelsResponse class provides an interace for Chime ListChannels responses.
 *
 * \inmodule QtAwsChime
 *
...
ListChannelsResponse::ListChannelsResponse(
    ...
    : ChimeResponse(new ListChannelsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime ListChannels \a response.
 */
...
/*!
 * \class QtAws::Chime::ListChannelsResponsePrivate
...
ListChannelsResponsePrivate::ListChannelsResponsePrivate(
    ListChannelsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListChannels response element from \a xml.
 */
