...
/*!
 * \class QtAws::Chime::CreateAttendeeResponse
 * \brief The CreateAttendeeResponse class provides an interace for Chime CreateAttendee responses.
 *
 * \inmodule QtAwsChime
 *
...
CreateAttendeeResponse::CreateAttendeeResponse(
    ...
    : ChimeResponse(new CreateAttendeeResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime CreateAttendee \a response.
 */
...
/*!
 * \class QtAws::Chime::CreateAttendeeResponsePrivate
...
CreateAttendeeResponsePrivate::CreateAttendeeResponsePrivate(
    CreateAttendeeResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateAttendee response element from \a xml.
 */
