...
#include "getvoiceconnectorrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorRequest
 * \brief The GetVoiceConnectorRequest class provides an interface for Chime GetVoiceConnector requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
GetVoiceConnectorRequest::GetVoiceConnectorRequest(const GetVoiceConnectorRequest &other)
    : ChimeRequest(new GetVoiceConnectorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetVoiceConnectorRequest object.
 */
GetVoiceConnectorRequest::GetVoiceConnectorRequest()
    : ChimeRequest(new GetVoiceConnectorRequestPrivate(ChimeRequest::GetVoiceConnectorAction, this))
{
 ...
 * \reimp
 */
bool GetVoiceConnectorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetVoiceConnectorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetVoiceConnectorRequest::response(QNetworkReply * const reply) const
{
    return new GetVoiceConnectorResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorRequestPrivate
 * \brief The GetVoiceConnectorRequestPrivate class provides private implementation for GetVoiceConnectorRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetVoiceConnectorRequestPrivate::GetVoiceConnectorRequestPrivate(
    const ChimeRequest::Action action, GetVoiceConnectorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetVoiceConnectorRequest
 * class' copy constructor.
 */
GetVoiceConnectorRequestPrivate::GetVoiceConnectorRequestPrivate(
    const GetVoiceConnectorRequestPrivate &other, GetVoiceConnectorRequest * const q)
