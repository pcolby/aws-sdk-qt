...
#include "listproxysessionsrequest_p.h"
...
/*!
 * \class QtAws::Chime::ListProxySessionsRequest
 * \brief The ListProxySessionsRequest class provides an interface for Chime ListProxySessions requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listProxySessions
 */

/*!
 * Constructs a copy of \a other.
 */
ListProxySessionsRequest::ListProxySessionsRequest(const ListProxySessionsRequest &other)
    : ChimeRequest(new ListProxySessionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListProxySessionsRequest object.
 */
ListProxySessionsRequest::ListProxySessionsRequest()
    : ChimeRequest(new ListProxySessionsRequestPrivate(ChimeRequest::ListProxySessionsAction, this))
{
 ...
 * \reimp
 */
bool ListProxySessionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListProxySessionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListProxySessionsRequest::response(QNetworkReply * const reply) const
{
    return new ListProxySessionsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::ListProxySessionsRequestPrivate
 * \brief The ListProxySessionsRequestPrivate class provides private implementation for ListProxySessionsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListProxySessionsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListProxySessionsRequestPrivate::ListProxySessionsRequestPrivate(
    const ChimeRequest::Action action, ListProxySessionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListProxySessionsRequest
 * class' copy constructor.
 */
ListProxySessionsRequestPrivate::ListProxySessionsRequestPrivate(
    const ListProxySessionsRequestPrivate &other, ListProxySessionsRequest * const q)
