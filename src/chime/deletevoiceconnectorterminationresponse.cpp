...
#include "deletevoiceconnectorterminationresponse_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorTerminationResponse
 * \brief The DeleteVoiceConnectorTerminationResponse class provides an interace for Chime DeleteVoiceConnectorTermination responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteVoiceConnectorTermination
 */

/*!
 * Constructs a DeleteVoiceConnectorTerminationResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteVoiceConnectorTerminationResponse::DeleteVoiceConnectorTerminationResponse(
        const DeleteVoiceConnectorTerminationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DeleteVoiceConnectorTerminationResponsePrivate(this), parent)
{
    setRequest(new DeleteVoiceConnectorTerminationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteVoiceConnectorTerminationRequest * DeleteVoiceConnectorTerminationResponse::request() const
{
    Q_D(const DeleteVoiceConnectorTerminationResponse);
    return static_cast<const DeleteVoiceConnectorTerminationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime DeleteVoiceConnectorTermination \a response.
 */
void DeleteVoiceConnectorTerminationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteVoiceConnectorTerminationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorTerminationResponsePrivate
 * \brief The DeleteVoiceConnectorTerminationResponsePrivate class provides private implementation for DeleteVoiceConnectorTerminationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorTerminationResponsePrivate object with public implementation \a q.
 */
DeleteVoiceConnectorTerminationResponsePrivate::DeleteVoiceConnectorTerminationResponsePrivate(
    DeleteVoiceConnectorTerminationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteVoiceConnectorTermination response element from \a xml.
 */
void DeleteVoiceConnectorTerminationResponsePrivate::parseDeleteVoiceConnectorTerminationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteVoiceConnectorTerminationResponse"));
    Q_UNUSED(xml) ///< @todo
}
