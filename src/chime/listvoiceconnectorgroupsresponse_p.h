...
class QTAWS_EXPORT ListVoiceConnectorGroupsResponsePrivate : public ChimeResponsePrivate {

public:

    ListVoiceConnectorGroupsResponsePrivate(ListVoiceConnectorGroupsResponse * const q);
