...
/*!
 * \class QtAws::Chime::DescribeChannelModeratedByAppInstanceUserRequest
 * \brief The DescribeChannelModeratedByAppInstanceUserRequest class provides an interface for Chime DescribeChannelModeratedByAppInstanceUser requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::describeChannelModeratedByAppInstanceUser
 */
...
DescribeChannelModeratedByAppInstanceUserRequest::DescribeChannelModeratedByAppInstanceUserRequest(const DescribeChannelModeratedByAppInstanceUserRequest &other)
    : ChimeRequest(new DescribeChannelModeratedByAppInstanceUserRequestPrivate(*other.d_func(), this))
{
...
DescribeChannelModeratedByAppInstanceUserRequest::DescribeChannelModeratedByAppInstanceUserRequest()
    : ChimeRequest(new DescribeChannelModeratedByAppInstanceUserRequestPrivate(ChimeRequest::DescribeChannelModeratedByAppInstanceUserAction, this))
{
...
/*!
 * \class QtAws::Chime::DescribeChannelModeratedByAppInstanceUserRequestPrivate
...
/*!
 * Constructs a DescribeChannelModeratedByAppInstanceUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DescribeChannelModeratedByAppInstanceUserRequestPrivate::DescribeChannelModeratedByAppInstanceUserRequestPrivate(
    const ChimeRequest::Action action, DescribeChannelModeratedByAppInstanceUserRequest * const q)
