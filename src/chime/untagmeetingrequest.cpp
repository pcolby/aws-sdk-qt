...
#include "untagmeetingrequest_p.h"
...
/*!
 * \class QtAws::Chime::UntagMeetingRequest
 * \brief The UntagMeetingRequest class provides an interface for Chime UntagMeeting requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::untagMeeting
 */

/*!
 * Constructs a copy of \a other.
 */
UntagMeetingRequest::UntagMeetingRequest(const UntagMeetingRequest &other)
    : ChimeRequest(new UntagMeetingRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UntagMeetingRequest object.
 */
UntagMeetingRequest::UntagMeetingRequest()
    : ChimeRequest(new UntagMeetingRequestPrivate(ChimeRequest::UntagMeetingAction, this))
{
 ...
 * \reimp
 */
bool UntagMeetingRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UntagMeetingResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UntagMeetingRequest::response(QNetworkReply * const reply) const
{
    return new UntagMeetingResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::UntagMeetingRequestPrivate
 * \brief The UntagMeetingRequestPrivate class provides private implementation for UntagMeetingRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UntagMeetingRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UntagMeetingRequestPrivate::UntagMeetingRequestPrivate(
    const ChimeRequest::Action action, UntagMeetingRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UntagMeetingRequest
 * class' copy constructor.
 */
UntagMeetingRequestPrivate::UntagMeetingRequestPrivate(
    const UntagMeetingRequestPrivate &other, UntagMeetingRequest * const q)
