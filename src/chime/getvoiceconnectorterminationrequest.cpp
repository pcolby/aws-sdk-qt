...
#include "getvoiceconnectorterminationrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorTerminationRequest
 * \brief The GetVoiceConnectorTerminationRequest class provides an interface for Chime GetVoiceConnectorTermination requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getVoiceConnectorTermination
 */

/*!
 * Constructs a copy of \a other.
 */
GetVoiceConnectorTerminationRequest::GetVoiceConnectorTerminationRequest(const GetVoiceConnectorTerminationRequest &other)
    : ChimeRequest(new GetVoiceConnectorTerminationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetVoiceConnectorTerminationRequest object.
 */
GetVoiceConnectorTerminationRequest::GetVoiceConnectorTerminationRequest()
    : ChimeRequest(new GetVoiceConnectorTerminationRequestPrivate(ChimeRequest::GetVoiceConnectorTerminationAction, this))
{
 ...
 * \reimp
 */
bool GetVoiceConnectorTerminationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetVoiceConnectorTerminationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetVoiceConnectorTerminationRequest::response(QNetworkReply * const reply) const
{
    return new GetVoiceConnectorTerminationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorTerminationRequestPrivate
 * \brief The GetVoiceConnectorTerminationRequestPrivate class provides private implementation for GetVoiceConnectorTerminationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorTerminationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetVoiceConnectorTerminationRequestPrivate::GetVoiceConnectorTerminationRequestPrivate(
    const ChimeRequest::Action action, GetVoiceConnectorTerminationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetVoiceConnectorTerminationRequest
 * class' copy constructor.
 */
GetVoiceConnectorTerminationRequestPrivate::GetVoiceConnectorTerminationRequestPrivate(
    const GetVoiceConnectorTerminationRequestPrivate &other, GetVoiceConnectorTerminationRequest * const q)
