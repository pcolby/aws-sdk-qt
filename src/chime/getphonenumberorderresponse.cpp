...
#include "getphonenumberorderresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetPhoneNumberOrderResponse
 * \brief The GetPhoneNumberOrderResponse class provides an interace for Chime GetPhoneNumberOrder responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getPhoneNumberOrder
 */

/*!
 * Constructs a GetPhoneNumberOrderResponse object for \a reply to \a request, with parent \a parent.
 */
GetPhoneNumberOrderResponse::GetPhoneNumberOrderResponse(
        const GetPhoneNumberOrderRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetPhoneNumberOrderResponsePrivate(this), parent)
{
    setRequest(new GetPhoneNumberOrderRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetPhoneNumberOrderRequest * GetPhoneNumberOrderResponse::request() const
{
    Q_D(const GetPhoneNumberOrderResponse);
    return static_cast<const GetPhoneNumberOrderRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime GetPhoneNumberOrder \a response.
 */
void GetPhoneNumberOrderResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetPhoneNumberOrderResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetPhoneNumberOrderResponsePrivate
 * \brief The GetPhoneNumberOrderResponsePrivate class provides private implementation for GetPhoneNumberOrderResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetPhoneNumberOrderResponsePrivate object with public implementation \a q.
 */
GetPhoneNumberOrderResponsePrivate::GetPhoneNumberOrderResponsePrivate(
    GetPhoneNumberOrderResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetPhoneNumberOrder response element from \a xml.
 */
void GetPhoneNumberOrderResponsePrivate::parseGetPhoneNumberOrderResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetPhoneNumberOrderResponse"));
    Q_UNUSED(xml) ///< @todo
}
