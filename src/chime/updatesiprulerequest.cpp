...
#include "updatesiprulerequest_p.h"
...
/*!
 * \class QtAws::Chime::UpdateSipRuleRequest
 * \brief The UpdateSipRuleRequest class provides an interface for Chime UpdateSipRule requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
UpdateSipRuleRequest::UpdateSipRuleRequest(const UpdateSipRuleRequest &other)
    : ChimeRequest(new UpdateSipRuleRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateSipRuleRequest object.
 */
UpdateSipRuleRequest::UpdateSipRuleRequest()
    : ChimeRequest(new UpdateSipRuleRequestPrivate(ChimeRequest::UpdateSipRuleAction, this))
{
 ...
 * \reimp
 */
bool UpdateSipRuleRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateSipRuleResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateSipRuleRequest::response(QNetworkReply * const reply) const
{
    return new UpdateSipRuleResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::UpdateSipRuleRequestPrivate
 * \brief The UpdateSipRuleRequestPrivate class provides private implementation for UpdateSipRuleRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UpdateSipRuleRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateSipRuleRequestPrivate::UpdateSipRuleRequestPrivate(
    const ChimeRequest::Action action, UpdateSipRuleRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateSipRuleRequest
 * class' copy constructor.
 */
UpdateSipRuleRequestPrivate::UpdateSipRuleRequestPrivate(
    const UpdateSipRuleRequestPrivate &other, UpdateSipRuleRequest * const q)
