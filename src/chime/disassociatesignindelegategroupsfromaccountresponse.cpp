...
#include "disassociatesignindelegategroupsfromaccountresponse_p.h"
...
/*!
 * \class QtAws::Chime::DisassociateSigninDelegateGroupsFromAccountResponse
 * \brief The DisassociateSigninDelegateGroupsFromAccountResponse class provides an interace for Chime DisassociateSigninDelegateGroupsFromAccount responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a DisassociateSigninDelegateGroupsFromAccountResponse object for \a reply to \a request, with parent \a parent.
 */
DisassociateSigninDelegateGroupsFromAccountResponse::DisassociateSigninDelegateGroupsFromAccountResponse(
        const DisassociateSigninDelegateGroupsFromAccountRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DisassociateSigninDelegateGroupsFromAccountResponsePrivate(this), parent)
{
    setRequest(new DisassociateSigninDelegateGroupsFromAccountRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime DisassociateSigninDelegateGroupsFromAccount \a response.
 */
void DisassociateSigninDelegateGroupsFromAccountResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DisassociateSigninDelegateGroupsFromAccountResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DisassociateSigninDelegateGroupsFromAccountResponsePrivate
 * \brief The DisassociateSigninDelegateGroupsFromAccountResponsePrivate class provides private implementation for DisassociateSigninDelegateGroupsFromAccountResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DisassociateSigninDelegateGroupsFromAccountResponsePrivate object with public implementation \a q.
 */
DisassociateSigninDelegateGroupsFromAccountResponsePrivate::DisassociateSigninDelegateGroupsFromAccountResponsePrivate(
    DisassociateSigninDelegateGroupsFromAccountResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DisassociateSigninDelegateGroupsFromAccount response element from \a xml.
 */
void DisassociateSigninDelegateGroupsFromAccountResponsePrivate::parseDisassociateSigninDelegateGroupsFromAccountResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DisassociateSigninDelegateGroupsFromAccountResponse"));
    Q_UNUSED(xml) ///< @todo
}
