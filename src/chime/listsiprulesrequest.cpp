...
#include "listsiprulesrequest_p.h"
...
/*!
 * \class QtAws::Chime::ListSipRulesRequest
 * \brief The ListSipRulesRequest class provides an interface for Chime ListSipRules requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listSipRules
 */

/*!
 * Constructs a copy of \a other.
 */
ListSipRulesRequest::ListSipRulesRequest(const ListSipRulesRequest &other)
    : ChimeRequest(new ListSipRulesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListSipRulesRequest object.
 */
ListSipRulesRequest::ListSipRulesRequest()
    : ChimeRequest(new ListSipRulesRequestPrivate(ChimeRequest::ListSipRulesAction, this))
{
 ...
 * \reimp
 */
bool ListSipRulesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListSipRulesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListSipRulesRequest::response(QNetworkReply * const reply) const
{
    return new ListSipRulesResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::ListSipRulesRequestPrivate
 * \brief The ListSipRulesRequestPrivate class provides private implementation for ListSipRulesRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListSipRulesRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListSipRulesRequestPrivate::ListSipRulesRequestPrivate(
    const ChimeRequest::Action action, ListSipRulesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListSipRulesRequest
 * class' copy constructor.
 */
ListSipRulesRequestPrivate::ListSipRulesRequestPrivate(
    const ListSipRulesRequestPrivate &other, ListSipRulesRequest * const q)
