...
/*!
 * \class QtAws::Chime::UpdateAccountResponse
 * \brief The UpdateAccountResponse class provides an interace for Chime UpdateAccount responses.
 *
 * \inmodule QtAwsChime
 *
...
UpdateAccountResponse::UpdateAccountResponse(
    ...
    : ChimeResponse(new UpdateAccountResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime UpdateAccount \a response.
 */
...
/*!
 * \class QtAws::Chime::UpdateAccountResponsePrivate
...
UpdateAccountResponsePrivate::UpdateAccountResponsePrivate(
    UpdateAccountResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateAccount response element from \a xml.
 */
