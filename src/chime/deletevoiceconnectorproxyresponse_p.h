...
class QTAWS_EXPORT DeleteVoiceConnectorProxyResponsePrivate : public ChimeResponsePrivate {

public:

    DeleteVoiceConnectorProxyResponsePrivate(DeleteVoiceConnectorProxyResponse * const q);
