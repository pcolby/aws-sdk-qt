...
/*!
 * \class QtAws::Chime::PutAppInstanceRetentionSettingsResponse
 * \brief The PutAppInstanceRetentionSettingsResponse class provides an interace for Chime PutAppInstanceRetentionSettings responses.
 *
 * \inmodule QtAwsChime
 *
...
PutAppInstanceRetentionSettingsResponse::PutAppInstanceRetentionSettingsResponse(
    ...
    : ChimeResponse(new PutAppInstanceRetentionSettingsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime PutAppInstanceRetentionSettings \a response.
 */
...
/*!
 * \class QtAws::Chime::PutAppInstanceRetentionSettingsResponsePrivate
...
PutAppInstanceRetentionSettingsResponsePrivate::PutAppInstanceRetentionSettingsResponsePrivate(
    PutAppInstanceRetentionSettingsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime PutAppInstanceRetentionSettings response element from \a xml.
 */
