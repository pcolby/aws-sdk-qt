...
#include "listphonenumberordersresponse_p.h"
...
/*!
 * \class QtAws::Chime::ListPhoneNumberOrdersResponse
 * \brief The ListPhoneNumberOrdersResponse class provides an interace for Chime ListPhoneNumberOrders responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listPhoneNumberOrders
 */

/*!
 * Constructs a ListPhoneNumberOrdersResponse object for \a reply to \a request, with parent \a parent.
 */
ListPhoneNumberOrdersResponse::ListPhoneNumberOrdersResponse(
        const ListPhoneNumberOrdersRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new ListPhoneNumberOrdersResponsePrivate(this), parent)
{
    setRequest(new ListPhoneNumberOrdersRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListPhoneNumberOrdersRequest * ListPhoneNumberOrdersResponse::request() const
{
    Q_D(const ListPhoneNumberOrdersResponse);
    return static_cast<const ListPhoneNumberOrdersRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime ListPhoneNumberOrders \a response.
 */
void ListPhoneNumberOrdersResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListPhoneNumberOrdersResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::ListPhoneNumberOrdersResponsePrivate
 * \brief The ListPhoneNumberOrdersResponsePrivate class provides private implementation for ListPhoneNumberOrdersResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListPhoneNumberOrdersResponsePrivate object with public implementation \a q.
 */
ListPhoneNumberOrdersResponsePrivate::ListPhoneNumberOrdersResponsePrivate(
    ListPhoneNumberOrdersResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListPhoneNumberOrders response element from \a xml.
 */
void ListPhoneNumberOrdersResponsePrivate::parseListPhoneNumberOrdersResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListPhoneNumberOrdersResponse"));
    Q_UNUSED(xml) ///< @todo
}
