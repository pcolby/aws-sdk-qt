...
#include "createphonenumberorderrequest_p.h"
...
/*!
 * \class QtAws::Chime::CreatePhoneNumberOrderRequest
 * \brief The CreatePhoneNumberOrderRequest class provides an interface for Chime CreatePhoneNumberOrder requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createPhoneNumberOrder
 */

/*!
 * Constructs a copy of \a other.
 */
CreatePhoneNumberOrderRequest::CreatePhoneNumberOrderRequest(const CreatePhoneNumberOrderRequest &other)
    : ChimeRequest(new CreatePhoneNumberOrderRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreatePhoneNumberOrderRequest object.
 */
CreatePhoneNumberOrderRequest::CreatePhoneNumberOrderRequest()
    : ChimeRequest(new CreatePhoneNumberOrderRequestPrivate(ChimeRequest::CreatePhoneNumberOrderAction, this))
{
 ...
 * \reimp
 */
bool CreatePhoneNumberOrderRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreatePhoneNumberOrderResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreatePhoneNumberOrderRequest::response(QNetworkReply * const reply) const
{
    return new CreatePhoneNumberOrderResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::CreatePhoneNumberOrderRequestPrivate
 * \brief The CreatePhoneNumberOrderRequestPrivate class provides private implementation for CreatePhoneNumberOrderRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreatePhoneNumberOrderRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreatePhoneNumberOrderRequestPrivate::CreatePhoneNumberOrderRequestPrivate(
    const ChimeRequest::Action action, CreatePhoneNumberOrderRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreatePhoneNumberOrderRequest
 * class' copy constructor.
 */
CreatePhoneNumberOrderRequestPrivate::CreatePhoneNumberOrderRequestPrivate(
    const CreatePhoneNumberOrderRequestPrivate &other, CreatePhoneNumberOrderRequest * const q)
