...
#include "deletevoiceconnectorstreamingconfigurationrequest_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorStreamingConfigurationRequest
 * \brief The DeleteVoiceConnectorStreamingConfigurationRequest class provides an interface for Chime DeleteVoiceConnectorStreamingConfiguration requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteVoiceConnectorStreamingConfiguration
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteVoiceConnectorStreamingConfigurationRequest::DeleteVoiceConnectorStreamingConfigurationRequest(const DeleteVoiceConnectorStreamingConfigurationRequest &other)
    : ChimeRequest(new DeleteVoiceConnectorStreamingConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteVoiceConnectorStreamingConfigurationRequest object.
 */
DeleteVoiceConnectorStreamingConfigurationRequest::DeleteVoiceConnectorStreamingConfigurationRequest()
    : ChimeRequest(new DeleteVoiceConnectorStreamingConfigurationRequestPrivate(ChimeRequest::DeleteVoiceConnectorStreamingConfigurationAction, this))
{
 ...
 * \reimp
 */
bool DeleteVoiceConnectorStreamingConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteVoiceConnectorStreamingConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteVoiceConnectorStreamingConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new DeleteVoiceConnectorStreamingConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorStreamingConfigurationRequestPrivate
 * \brief The DeleteVoiceConnectorStreamingConfigurationRequestPrivate class provides private implementation for DeleteVoiceConnectorStreamingConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorStreamingConfigurationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteVoiceConnectorStreamingConfigurationRequestPrivate::DeleteVoiceConnectorStreamingConfigurationRequestPrivate(
    const ChimeRequest::Action action, DeleteVoiceConnectorStreamingConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteVoiceConnectorStreamingConfigurationRequest
 * class' copy constructor.
 */
DeleteVoiceConnectorStreamingConfigurationRequestPrivate::DeleteVoiceConnectorStreamingConfigurationRequestPrivate(
    const DeleteVoiceConnectorStreamingConfigurationRequestPrivate &other, DeleteVoiceConnectorStreamingConfigurationRequest * const q)
