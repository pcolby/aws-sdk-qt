...
class QTAWS_EXPORT UpdatePhoneNumberSettingsResponsePrivate : public ChimeResponsePrivate {

public:

    UpdatePhoneNumberSettingsResponsePrivate(UpdatePhoneNumberSettingsResponse * const q);
