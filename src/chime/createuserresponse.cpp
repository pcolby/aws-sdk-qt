...
/*!
 * \class QtAws::Chime::CreateUserResponse
 * \brief The CreateUserResponse class provides an interace for Chime CreateUser responses.
 *
 * \inmodule QtAwsChime
 *
...
CreateUserResponse::CreateUserResponse(
    ...
    : ChimeResponse(new CreateUserResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime CreateUser \a response.
 */
...
/*!
 * \class QtAws::Chime::CreateUserResponsePrivate
...
CreateUserResponsePrivate::CreateUserResponsePrivate(
    CreateUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateUser response element from \a xml.
 */
