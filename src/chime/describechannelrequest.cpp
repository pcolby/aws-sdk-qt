...
/*!
 * \class QtAws::Chime::DescribeChannelRequest
 * \brief The DescribeChannelRequest class provides an interface for Chime DescribeChannel requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::describeChannel
 */
...
DescribeChannelRequest::DescribeChannelRequest(const DescribeChannelRequest &other)
    : ChimeRequest(new DescribeChannelRequestPrivate(*other.d_func(), this))
{
...
DescribeChannelRequest::DescribeChannelRequest()
    : ChimeRequest(new DescribeChannelRequestPrivate(ChimeRequest::DescribeChannelAction, this))
{
...
/*!
 * \class QtAws::Chime::DescribeChannelRequestPrivate
...
/*!
 * Constructs a DescribeChannelRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DescribeChannelRequestPrivate::DescribeChannelRequestPrivate(
    const ChimeRequest::Action action, DescribeChannelRequest * const q)
