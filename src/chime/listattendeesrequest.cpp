...
/*!
 * \class QtAws::Chime::ListAttendeesRequest
 * \brief The ListAttendeesRequest class provides an interface for Chime ListAttendees requests.
 *
 * \inmodule QtAwsChime
 *
...
ListAttendeesRequest::ListAttendeesRequest(const ListAttendeesRequest &other)
    : ChimeRequest(new ListAttendeesRequestPrivate(*other.d_func(), this))
{
...
ListAttendeesRequest::ListAttendeesRequest()
    : ChimeRequest(new ListAttendeesRequestPrivate(ChimeRequest::ListAttendeesAction, this))
{
...
/*!
 * \class QtAws::Chime::ListAttendeesRequestPrivate
...
/*!
 * Constructs a ListAttendeesRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListAttendeesRequestPrivate::ListAttendeesRequestPrivate(
    const ChimeRequest::Action action, ListAttendeesRequest * const q)
