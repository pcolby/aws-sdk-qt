...
#include "listproxysessionsresponse_p.h"
...
/*!
 * \class QtAws::Chime::ListProxySessionsResponse
 * \brief The ListProxySessionsResponse class provides an interace for Chime ListProxySessions responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a ListProxySessionsResponse object for \a reply to \a request, with parent \a parent.
 */
ListProxySessionsResponse::ListProxySessionsResponse(
        const ListProxySessionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new ListProxySessionsResponsePrivate(this), parent)
{
    setRequest(new ListProxySessionsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime ListProxySessions \a response.
 */
void ListProxySessionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListProxySessionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::ListProxySessionsResponsePrivate
 * \brief The ListProxySessionsResponsePrivate class provides private implementation for ListProxySessionsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListProxySessionsResponsePrivate object with public implementation \a q.
 */
ListProxySessionsResponsePrivate::ListProxySessionsResponsePrivate(
    ListProxySessionsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListProxySessions response element from \a xml.
 */
void ListProxySessionsResponsePrivate::parseListProxySessionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListProxySessionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
