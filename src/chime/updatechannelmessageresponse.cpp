...
/*!
 * \class QtAws::Chime::UpdateChannelMessageResponse
 * \brief The UpdateChannelMessageResponse class provides an interace for Chime UpdateChannelMessage responses.
 *
 * \inmodule QtAwsChime
 *
...
UpdateChannelMessageResponse::UpdateChannelMessageResponse(
    ...
    : ChimeResponse(new UpdateChannelMessageResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime UpdateChannelMessage \a response.
 */
...
/*!
 * \class QtAws::Chime::UpdateChannelMessageResponsePrivate
...
UpdateChannelMessageResponsePrivate::UpdateChannelMessageResponsePrivate(
    UpdateChannelMessageResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateChannelMessage response element from \a xml.
 */
