...
#include "restorephonenumberrequest_p.h"
...
/*!
 * \class QtAws::Chime::RestorePhoneNumberRequest
 * \brief The RestorePhoneNumberRequest class provides an interface for Chime RestorePhoneNumber requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::restorePhoneNumber
 */

/*!
 * Constructs a copy of \a other.
 */
RestorePhoneNumberRequest::RestorePhoneNumberRequest(const RestorePhoneNumberRequest &other)
    : ChimeRequest(new RestorePhoneNumberRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a RestorePhoneNumberRequest object.
 */
RestorePhoneNumberRequest::RestorePhoneNumberRequest()
    : ChimeRequest(new RestorePhoneNumberRequestPrivate(ChimeRequest::RestorePhoneNumberAction, this))
{
 ...
 * \reimp
 */
bool RestorePhoneNumberRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a RestorePhoneNumberResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * RestorePhoneNumberRequest::response(QNetworkReply * const reply) const
{
    return new RestorePhoneNumberResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::RestorePhoneNumberRequestPrivate
 * \brief The RestorePhoneNumberRequestPrivate class provides private implementation for RestorePhoneNumberRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a RestorePhoneNumberRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
RestorePhoneNumberRequestPrivate::RestorePhoneNumberRequestPrivate(
    const ChimeRequest::Action action, RestorePhoneNumberRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the RestorePhoneNumberRequest
 * class' copy constructor.
 */
RestorePhoneNumberRequestPrivate::RestorePhoneNumberRequestPrivate(
    const RestorePhoneNumberRequestPrivate &other, RestorePhoneNumberRequest * const q)
