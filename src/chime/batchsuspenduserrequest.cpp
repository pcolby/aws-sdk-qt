...
#include "batchsuspenduserrequest_p.h"
...
/*!
 * \class QtAws::Chime::BatchSuspendUserRequest
 * \brief The BatchSuspendUserRequest class provides an interface for Chime BatchSuspendUser requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
BatchSuspendUserRequest::BatchSuspendUserRequest(const BatchSuspendUserRequest &other)
    : ChimeRequest(new BatchSuspendUserRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a BatchSuspendUserRequest object.
 */
BatchSuspendUserRequest::BatchSuspendUserRequest()
    : ChimeRequest(new BatchSuspendUserRequestPrivate(ChimeRequest::BatchSuspendUserAction, this))
{
 ...
 * \reimp
 */
bool BatchSuspendUserRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BatchSuspendUserResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BatchSuspendUserRequest::response(QNetworkReply * const reply) const
{
    return new BatchSuspendUserResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::BatchSuspendUserRequestPrivate
 * \brief The BatchSuspendUserRequestPrivate class provides private implementation for BatchSuspendUserRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a BatchSuspendUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
BatchSuspendUserRequestPrivate::BatchSuspendUserRequestPrivate(
    const ChimeRequest::Action action, BatchSuspendUserRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the BatchSuspendUserRequest
 * class' copy constructor.
 */
BatchSuspendUserRequestPrivate::BatchSuspendUserRequestPrivate(
    const BatchSuspendUserRequestPrivate &other, BatchSuspendUserRequest * const q)
