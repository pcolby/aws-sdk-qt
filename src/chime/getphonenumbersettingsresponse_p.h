...
class QTAWS_EXPORT GetPhoneNumberSettingsResponsePrivate : public ChimeResponsePrivate {

public:

    GetPhoneNumberSettingsResponsePrivate(GetPhoneNumberSettingsResponse * const q);
