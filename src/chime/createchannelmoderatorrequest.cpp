...
/*!
 * \class QtAws::Chime::CreateChannelModeratorRequest
 * \brief The CreateChannelModeratorRequest class provides an interface for Chime CreateChannelModerator requests.
 *
 * \inmodule QtAwsChime
 *
...
CreateChannelModeratorRequest::CreateChannelModeratorRequest(const CreateChannelModeratorRequest &other)
    : ChimeRequest(new CreateChannelModeratorRequestPrivate(*other.d_func(), this))
{
...
CreateChannelModeratorRequest::CreateChannelModeratorRequest()
    : ChimeRequest(new CreateChannelModeratorRequestPrivate(ChimeRequest::CreateChannelModeratorAction, this))
{
...
/*!
 * \class QtAws::Chime::CreateChannelModeratorRequestPrivate
...
/*!
 * Constructs a CreateChannelModeratorRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateChannelModeratorRequestPrivate::CreateChannelModeratorRequestPrivate(
    const ChimeRequest::Action action, CreateChannelModeratorRequest * const q)
