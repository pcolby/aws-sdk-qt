...
#include "disassociatephonenumbersfromvoiceconnectorgroupresponse_p.h"
...
/*!
 * \class QtAws::Chime::DisassociatePhoneNumbersFromVoiceConnectorGroupResponse
 * \brief The DisassociatePhoneNumbersFromVoiceConnectorGroupResponse class provides an interace for Chime DisassociatePhoneNumbersFromVoiceConnectorGroup responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a DisassociatePhoneNumbersFromVoiceConnectorGroupResponse object for \a reply to \a request, with parent \a parent.
 */
DisassociatePhoneNumbersFromVoiceConnectorGroupResponse::DisassociatePhoneNumbersFromVoiceConnectorGroupResponse(
        const DisassociatePhoneNumbersFromVoiceConnectorGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DisassociatePhoneNumbersFromVoiceConnectorGroupResponsePrivate(this), parent)
{
    setRequest(new DisassociatePhoneNumbersFromVoiceConnectorGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime DisassociatePhoneNumbersFromVoiceConnectorGroup \a response.
 */
void DisassociatePhoneNumbersFromVoiceConnectorGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DisassociatePhoneNumbersFromVoiceConnectorGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DisassociatePhoneNumbersFromVoiceConnectorGroupResponsePrivate
 * \brief The DisassociatePhoneNumbersFromVoiceConnectorGroupResponsePrivate class provides private implementation for DisassociatePhoneNumbersFromVoiceConnectorGroupResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DisassociatePhoneNumbersFromVoiceConnectorGroupResponsePrivate object with public implementation \a q.
 */
DisassociatePhoneNumbersFromVoiceConnectorGroupResponsePrivate::DisassociatePhoneNumbersFromVoiceConnectorGroupResponsePrivate(
    DisassociatePhoneNumbersFromVoiceConnectorGroupResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DisassociatePhoneNumbersFromVoiceConnectorGroup response element from \a xml.
 */
void DisassociatePhoneNumbersFromVoiceConnectorGroupResponsePrivate::parseDisassociatePhoneNumbersFromVoiceConnectorGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DisassociatePhoneNumbersFromVoiceConnectorGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
