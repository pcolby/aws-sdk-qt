...
#include "redactconversationmessageresponse_p.h"
...
/*!
 * \class QtAws::Chime::RedactConversationMessageResponse
 * \brief The RedactConversationMessageResponse class provides an interace for Chime RedactConversationMessage responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a RedactConversationMessageResponse object for \a reply to \a request, with parent \a parent.
 */
RedactConversationMessageResponse::RedactConversationMessageResponse(
        const RedactConversationMessageRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new RedactConversationMessageResponsePrivate(this), parent)
{
    setRequest(new RedactConversationMessageRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime RedactConversationMessage \a response.
 */
void RedactConversationMessageResponse::parseSuccess(QIODevice &response)
{
    //Q_D(RedactConversationMessageResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::RedactConversationMessageResponsePrivate
 * \brief The RedactConversationMessageResponsePrivate class provides private implementation for RedactConversationMessageResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a RedactConversationMessageResponsePrivate object with public implementation \a q.
 */
RedactConversationMessageResponsePrivate::RedactConversationMessageResponsePrivate(
    RedactConversationMessageResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime RedactConversationMessage response element from \a xml.
 */
void RedactConversationMessageResponsePrivate::parseRedactConversationMessageResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("RedactConversationMessageResponse"));
    Q_UNUSED(xml) ///< @todo
}
