...
#include "updateroommembershiprequest_p.h"
...
/*!
 * \class QtAws::Chime::UpdateRoomMembershipRequest
 * \brief The UpdateRoomMembershipRequest class provides an interface for Chime UpdateRoomMembership requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::updateRoomMembership
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateRoomMembershipRequest::UpdateRoomMembershipRequest(const UpdateRoomMembershipRequest &other)
    : ChimeRequest(new UpdateRoomMembershipRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateRoomMembershipRequest object.
 */
UpdateRoomMembershipRequest::UpdateRoomMembershipRequest()
    : ChimeRequest(new UpdateRoomMembershipRequestPrivate(ChimeRequest::UpdateRoomMembershipAction, this))
{
 ...
 * \reimp
 */
bool UpdateRoomMembershipRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateRoomMembershipResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateRoomMembershipRequest::response(QNetworkReply * const reply) const
{
    return new UpdateRoomMembershipResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::UpdateRoomMembershipRequestPrivate
 * \brief The UpdateRoomMembershipRequestPrivate class provides private implementation for UpdateRoomMembershipRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UpdateRoomMembershipRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateRoomMembershipRequestPrivate::UpdateRoomMembershipRequestPrivate(
    const ChimeRequest::Action action, UpdateRoomMembershipRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateRoomMembershipRequest
 * class' copy constructor.
 */
UpdateRoomMembershipRequestPrivate::UpdateRoomMembershipRequestPrivate(
    const UpdateRoomMembershipRequestPrivate &other, UpdateRoomMembershipRequest * const q)
