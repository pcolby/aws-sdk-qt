...
/*!
 * \class QtAws::Chime::GetAttendeeRequest
 * \brief The GetAttendeeRequest class provides an interface for Chime GetAttendee requests.
 *
 * \inmodule QtAwsChime
 *
...
GetAttendeeRequest::GetAttendeeRequest(const GetAttendeeRequest &other)
    : ChimeRequest(new GetAttendeeRequestPrivate(*other.d_func(), this))
{
...
GetAttendeeRequest::GetAttendeeRequest()
    : ChimeRequest(new GetAttendeeRequestPrivate(ChimeRequest::GetAttendeeAction, this))
{
...
/*!
 * \class QtAws::Chime::GetAttendeeRequestPrivate
...
/*!
 * Constructs a GetAttendeeRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetAttendeeRequestPrivate::GetAttendeeRequestPrivate(
    const ChimeRequest::Action action, GetAttendeeRequest * const q)
