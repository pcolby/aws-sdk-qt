...
/*!
 * \class QtAws::Chime::CreateMeetingResponse
 * \brief The CreateMeetingResponse class provides an interace for Chime CreateMeeting responses.
 *
 * \inmodule QtAwsChime
 *
...
CreateMeetingResponse::CreateMeetingResponse(
    ...
    : ChimeResponse(new CreateMeetingResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime CreateMeeting \a response.
 */
...
/*!
 * \class QtAws::Chime::CreateMeetingResponsePrivate
...
CreateMeetingResponsePrivate::CreateMeetingResponsePrivate(
    CreateMeetingResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateMeeting response element from \a xml.
 */
