...
/*!
 * \class QtAws::Chime::ListChannelMessagesRequest
 * \brief The ListChannelMessagesRequest class provides an interface for Chime ListChannelMessages requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listChannelMessages
 */
...
ListChannelMessagesRequest::ListChannelMessagesRequest(const ListChannelMessagesRequest &other)
    : ChimeRequest(new ListChannelMessagesRequestPrivate(*other.d_func(), this))
{
...
ListChannelMessagesRequest::ListChannelMessagesRequest()
    : ChimeRequest(new ListChannelMessagesRequestPrivate(ChimeRequest::ListChannelMessagesAction, this))
{
...
/*!
 * \class QtAws::Chime::ListChannelMessagesRequestPrivate
...
/*!
 * Constructs a ListChannelMessagesRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListChannelMessagesRequestPrivate::ListChannelMessagesRequestPrivate(
    const ChimeRequest::Action action, ListChannelMessagesRequest * const q)
