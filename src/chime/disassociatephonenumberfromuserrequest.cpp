...
#include "disassociatephonenumberfromuserrequest_p.h"
...
/*!
 * \class QtAws::Chime::DisassociatePhoneNumberFromUserRequest
 * \brief The DisassociatePhoneNumberFromUserRequest class provides an interface for Chime DisassociatePhoneNumberFromUser requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::disassociatePhoneNumberFromUser
 */

/*!
 * Constructs a copy of \a other.
 */
DisassociatePhoneNumberFromUserRequest::DisassociatePhoneNumberFromUserRequest(const DisassociatePhoneNumberFromUserRequest &other)
    : ChimeRequest(new DisassociatePhoneNumberFromUserRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DisassociatePhoneNumberFromUserRequest object.
 */
DisassociatePhoneNumberFromUserRequest::DisassociatePhoneNumberFromUserRequest()
    : ChimeRequest(new DisassociatePhoneNumberFromUserRequestPrivate(ChimeRequest::DisassociatePhoneNumberFromUserAction, this))
{
 ...
 * \reimp
 */
bool DisassociatePhoneNumberFromUserRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DisassociatePhoneNumberFromUserResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DisassociatePhoneNumberFromUserRequest::response(QNetworkReply * const reply) const
{
    return new DisassociatePhoneNumberFromUserResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DisassociatePhoneNumberFromUserRequestPrivate
 * \brief The DisassociatePhoneNumberFromUserRequestPrivate class provides private implementation for DisassociatePhoneNumberFromUserRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DisassociatePhoneNumberFromUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DisassociatePhoneNumberFromUserRequestPrivate::DisassociatePhoneNumberFromUserRequestPrivate(
    const ChimeRequest::Action action, DisassociatePhoneNumberFromUserRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DisassociatePhoneNumberFromUserRequest
 * class' copy constructor.
 */
DisassociatePhoneNumberFromUserRequestPrivate::DisassociatePhoneNumberFromUserRequestPrivate(
    const DisassociatePhoneNumberFromUserRequestPrivate &other, DisassociatePhoneNumberFromUserRequest * const q)
