...
#include "getretentionsettingsresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetRetentionSettingsResponse
 * \brief The GetRetentionSettingsResponse class provides an interace for Chime GetRetentionSettings responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a GetRetentionSettingsResponse object for \a reply to \a request, with parent \a parent.
 */
GetRetentionSettingsResponse::GetRetentionSettingsResponse(
        const GetRetentionSettingsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetRetentionSettingsResponsePrivate(this), parent)
{
    setRequest(new GetRetentionSettingsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime GetRetentionSettings \a response.
 */
void GetRetentionSettingsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetRetentionSettingsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetRetentionSettingsResponsePrivate
 * \brief The GetRetentionSettingsResponsePrivate class provides private implementation for GetRetentionSettingsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetRetentionSettingsResponsePrivate object with public implementation \a q.
 */
GetRetentionSettingsResponsePrivate::GetRetentionSettingsResponsePrivate(
    GetRetentionSettingsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetRetentionSettings response element from \a xml.
 */
void GetRetentionSettingsResponsePrivate::parseGetRetentionSettingsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetRetentionSettingsResponse"));
    Q_UNUSED(xml) ///< @todo
}
