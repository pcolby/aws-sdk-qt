...
#include "listroommembershipsrequest_p.h"
...
/*!
 * \class QtAws::Chime::ListRoomMembershipsRequest
 * \brief The ListRoomMembershipsRequest class provides an interface for Chime ListRoomMemberships requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listRoomMemberships
 */

/*!
 * Constructs a copy of \a other.
 */
ListRoomMembershipsRequest::ListRoomMembershipsRequest(const ListRoomMembershipsRequest &other)
    : ChimeRequest(new ListRoomMembershipsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListRoomMembershipsRequest object.
 */
ListRoomMembershipsRequest::ListRoomMembershipsRequest()
    : ChimeRequest(new ListRoomMembershipsRequestPrivate(ChimeRequest::ListRoomMembershipsAction, this))
{
 ...
 * \reimp
 */
bool ListRoomMembershipsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListRoomMembershipsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListRoomMembershipsRequest::response(QNetworkReply * const reply) const
{
    return new ListRoomMembershipsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::ListRoomMembershipsRequestPrivate
 * \brief The ListRoomMembershipsRequestPrivate class provides private implementation for ListRoomMembershipsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListRoomMembershipsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListRoomMembershipsRequestPrivate::ListRoomMembershipsRequestPrivate(
    const ChimeRequest::Action action, ListRoomMembershipsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListRoomMembershipsRequest
 * class' copy constructor.
 */
ListRoomMembershipsRequestPrivate::ListRoomMembershipsRequestPrivate(
    const ListRoomMembershipsRequestPrivate &other, ListRoomMembershipsRequest * const q)
