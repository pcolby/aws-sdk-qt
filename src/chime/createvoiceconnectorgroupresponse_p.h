...
class QTAWS_EXPORT CreateVoiceConnectorGroupResponsePrivate : public ChimeResponsePrivate {

public:

    CreateVoiceConnectorGroupResponsePrivate(CreateVoiceConnectorGroupResponse * const q);
