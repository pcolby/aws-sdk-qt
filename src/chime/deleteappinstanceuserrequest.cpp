...
/*!
 * \class QtAws::Chime::DeleteAppInstanceUserRequest
 * \brief The DeleteAppInstanceUserRequest class provides an interface for Chime DeleteAppInstanceUser requests.
 *
 * \inmodule QtAwsChime
 *
...
DeleteAppInstanceUserRequest::DeleteAppInstanceUserRequest(const DeleteAppInstanceUserRequest &other)
    : ChimeRequest(new DeleteAppInstanceUserRequestPrivate(*other.d_func(), this))
{
...
DeleteAppInstanceUserRequest::DeleteAppInstanceUserRequest()
    : ChimeRequest(new DeleteAppInstanceUserRequestPrivate(ChimeRequest::DeleteAppInstanceUserAction, this))
{
...
/*!
 * \class QtAws::Chime::DeleteAppInstanceUserRequestPrivate
...
/*!
 * Constructs a DeleteAppInstanceUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteAppInstanceUserRequestPrivate::DeleteAppInstanceUserRequestPrivate(
    const ChimeRequest::Action action, DeleteAppInstanceUserRequest * const q)
