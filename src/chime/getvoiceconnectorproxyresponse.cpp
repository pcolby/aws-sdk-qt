...
#include "getvoiceconnectorproxyresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorProxyResponse
 * \brief The GetVoiceConnectorProxyResponse class provides an interace for Chime GetVoiceConnectorProxy responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a GetVoiceConnectorProxyResponse object for \a reply to \a request, with parent \a parent.
 */
GetVoiceConnectorProxyResponse::GetVoiceConnectorProxyResponse(
        const GetVoiceConnectorProxyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetVoiceConnectorProxyResponsePrivate(this), parent)
{
    setRequest(new GetVoiceConnectorProxyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime GetVoiceConnectorProxy \a response.
 */
void GetVoiceConnectorProxyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetVoiceConnectorProxyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorProxyResponsePrivate
 * \brief The GetVoiceConnectorProxyResponsePrivate class provides private implementation for GetVoiceConnectorProxyResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorProxyResponsePrivate object with public implementation \a q.
 */
GetVoiceConnectorProxyResponsePrivate::GetVoiceConnectorProxyResponsePrivate(
    GetVoiceConnectorProxyResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetVoiceConnectorProxy response element from \a xml.
 */
void GetVoiceConnectorProxyResponsePrivate::parseGetVoiceConnectorProxyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetVoiceConnectorProxyResponse"));
    Q_UNUSED(xml) ///< @todo
}
