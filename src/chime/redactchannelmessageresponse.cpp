...
/*!
 * \class QtAws::Chime::RedactChannelMessageResponse
 * \brief The RedactChannelMessageResponse class provides an interace for Chime RedactChannelMessage responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::redactChannelMessage
 */
...
RedactChannelMessageResponse::RedactChannelMessageResponse(
    ...
    : ChimeResponse(new RedactChannelMessageResponsePrivate(this), parent)
{
...
{
    return static_cast<const RedactChannelMessageRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime RedactChannelMessage \a response.
 */
...
/*!
 * \class QtAws::Chime::RedactChannelMessageResponsePrivate
...
RedactChannelMessageResponsePrivate::RedactChannelMessageResponsePrivate(
    RedactChannelMessageResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime RedactChannelMessage response element from \a xml.
 */
