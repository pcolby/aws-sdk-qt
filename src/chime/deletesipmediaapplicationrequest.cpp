...
#include "deletesipmediaapplicationrequest_p.h"
...
/*!
 * \class QtAws::Chime::DeleteSipMediaApplicationRequest
 * \brief The DeleteSipMediaApplicationRequest class provides an interface for Chime DeleteSipMediaApplication requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteSipMediaApplication
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteSipMediaApplicationRequest::DeleteSipMediaApplicationRequest(const DeleteSipMediaApplicationRequest &other)
    : ChimeRequest(new DeleteSipMediaApplicationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteSipMediaApplicationRequest object.
 */
DeleteSipMediaApplicationRequest::DeleteSipMediaApplicationRequest()
    : ChimeRequest(new DeleteSipMediaApplicationRequestPrivate(ChimeRequest::DeleteSipMediaApplicationAction, this))
{
 ...
 * \reimp
 */
bool DeleteSipMediaApplicationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteSipMediaApplicationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteSipMediaApplicationRequest::response(QNetworkReply * const reply) const
{
    return new DeleteSipMediaApplicationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeleteSipMediaApplicationRequestPrivate
 * \brief The DeleteSipMediaApplicationRequestPrivate class provides private implementation for DeleteSipMediaApplicationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteSipMediaApplicationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteSipMediaApplicationRequestPrivate::DeleteSipMediaApplicationRequestPrivate(
    const ChimeRequest::Action action, DeleteSipMediaApplicationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteSipMediaApplicationRequest
 * class' copy constructor.
 */
DeleteSipMediaApplicationRequestPrivate::DeleteSipMediaApplicationRequestPrivate(
    const DeleteSipMediaApplicationRequestPrivate &other, DeleteSipMediaApplicationRequest * const q)
