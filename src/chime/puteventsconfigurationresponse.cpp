...
#include "puteventsconfigurationresponse_p.h"
...
/*!
 * \class QtAws::Chime::PutEventsConfigurationResponse
 * \brief The PutEventsConfigurationResponse class provides an interace for Chime PutEventsConfiguration responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a PutEventsConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
PutEventsConfigurationResponse::PutEventsConfigurationResponse(
        const PutEventsConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new PutEventsConfigurationResponsePrivate(this), parent)
{
    setRequest(new PutEventsConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime PutEventsConfiguration \a response.
 */
void PutEventsConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutEventsConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::PutEventsConfigurationResponsePrivate
 * \brief The PutEventsConfigurationResponsePrivate class provides private implementation for PutEventsConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutEventsConfigurationResponsePrivate object with public implementation \a q.
 */
PutEventsConfigurationResponsePrivate::PutEventsConfigurationResponsePrivate(
    PutEventsConfigurationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime PutEventsConfiguration response element from \a xml.
 */
void PutEventsConfigurationResponsePrivate::parsePutEventsConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutEventsConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
