...
/*!
 * \class QtAws::Chime::DeleteMediaCapturePipelineRequest
 * \brief The DeleteMediaCapturePipelineRequest class provides an interface for Chime DeleteMediaCapturePipeline requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteMediaCapturePipeline
 */
...
DeleteMediaCapturePipelineRequest::DeleteMediaCapturePipelineRequest(const DeleteMediaCapturePipelineRequest &other)
    : ChimeRequest(new DeleteMediaCapturePipelineRequestPrivate(*other.d_func(), this))
{
...
DeleteMediaCapturePipelineRequest::DeleteMediaCapturePipelineRequest()
    : ChimeRequest(new DeleteMediaCapturePipelineRequestPrivate(ChimeRequest::DeleteMediaCapturePipelineAction, this))
{
...
/*!
 * \class QtAws::Chime::DeleteMediaCapturePipelineRequestPrivate
...
/*!
 * Constructs a DeleteMediaCapturePipelineRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteMediaCapturePipelineRequestPrivate::DeleteMediaCapturePipelineRequestPrivate(
    const ChimeRequest::Action action, DeleteMediaCapturePipelineRequest * const q)
