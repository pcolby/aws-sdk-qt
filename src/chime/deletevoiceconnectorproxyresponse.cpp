...
#include "deletevoiceconnectorproxyresponse_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorProxyResponse
 * \brief The DeleteVoiceConnectorProxyResponse class provides an interace for Chime DeleteVoiceConnectorProxy responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteVoiceConnectorProxy
 */

/*!
 * Constructs a DeleteVoiceConnectorProxyResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteVoiceConnectorProxyResponse::DeleteVoiceConnectorProxyResponse(
        const DeleteVoiceConnectorProxyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DeleteVoiceConnectorProxyResponsePrivate(this), parent)
{
    setRequest(new DeleteVoiceConnectorProxyRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteVoiceConnectorProxyRequest * DeleteVoiceConnectorProxyResponse::request() const
{
    Q_D(const DeleteVoiceConnectorProxyResponse);
    return static_cast<const DeleteVoiceConnectorProxyRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime DeleteVoiceConnectorProxy \a response.
 */
void DeleteVoiceConnectorProxyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteVoiceConnectorProxyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorProxyResponsePrivate
 * \brief The DeleteVoiceConnectorProxyResponsePrivate class provides private implementation for DeleteVoiceConnectorProxyResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorProxyResponsePrivate object with public implementation \a q.
 */
DeleteVoiceConnectorProxyResponsePrivate::DeleteVoiceConnectorProxyResponsePrivate(
    DeleteVoiceConnectorProxyResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteVoiceConnectorProxy response element from \a xml.
 */
void DeleteVoiceConnectorProxyResponsePrivate::parseDeleteVoiceConnectorProxyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteVoiceConnectorProxyResponse"));
    Q_UNUSED(xml) ///< @todo
}
