...
#include "tagattendeeresponse_p.h"
...
/*!
 * \class QtAws::Chime::TagAttendeeResponse
 * \brief The TagAttendeeResponse class provides an interace for Chime TagAttendee responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a TagAttendeeResponse object for \a reply to \a request, with parent \a parent.
 */
TagAttendeeResponse::TagAttendeeResponse(
        const TagAttendeeRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new TagAttendeeResponsePrivate(this), parent)
{
    setRequest(new TagAttendeeRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime TagAttendee \a response.
 */
void TagAttendeeResponse::parseSuccess(QIODevice &response)
{
    //Q_D(TagAttendeeResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::TagAttendeeResponsePrivate
 * \brief The TagAttendeeResponsePrivate class provides private implementation for TagAttendeeResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a TagAttendeeResponsePrivate object with public implementation \a q.
 */
TagAttendeeResponsePrivate::TagAttendeeResponsePrivate(
    TagAttendeeResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime TagAttendee response element from \a xml.
 */
void TagAttendeeResponsePrivate::parseTagAttendeeResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("TagAttendeeResponse"));
    Q_UNUSED(xml) ///< @todo
}
