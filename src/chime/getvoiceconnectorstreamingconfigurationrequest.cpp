...
#include "getvoiceconnectorstreamingconfigurationrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorStreamingConfigurationRequest
 * \brief The GetVoiceConnectorStreamingConfigurationRequest class provides an interface for Chime GetVoiceConnectorStreamingConfiguration requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getVoiceConnectorStreamingConfiguration
 */

/*!
 * Constructs a copy of \a other.
 */
GetVoiceConnectorStreamingConfigurationRequest::GetVoiceConnectorStreamingConfigurationRequest(const GetVoiceConnectorStreamingConfigurationRequest &other)
    : ChimeRequest(new GetVoiceConnectorStreamingConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetVoiceConnectorStreamingConfigurationRequest object.
 */
GetVoiceConnectorStreamingConfigurationRequest::GetVoiceConnectorStreamingConfigurationRequest()
    : ChimeRequest(new GetVoiceConnectorStreamingConfigurationRequestPrivate(ChimeRequest::GetVoiceConnectorStreamingConfigurationAction, this))
{
 ...
 * \reimp
 */
bool GetVoiceConnectorStreamingConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetVoiceConnectorStreamingConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetVoiceConnectorStreamingConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new GetVoiceConnectorStreamingConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorStreamingConfigurationRequestPrivate
 * \brief The GetVoiceConnectorStreamingConfigurationRequestPrivate class provides private implementation for GetVoiceConnectorStreamingConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorStreamingConfigurationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetVoiceConnectorStreamingConfigurationRequestPrivate::GetVoiceConnectorStreamingConfigurationRequestPrivate(
    const ChimeRequest::Action action, GetVoiceConnectorStreamingConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetVoiceConnectorStreamingConfigurationRequest
 * class' copy constructor.
 */
GetVoiceConnectorStreamingConfigurationRequestPrivate::GetVoiceConnectorStreamingConfigurationRequestPrivate(
    const GetVoiceConnectorStreamingConfigurationRequestPrivate &other, GetVoiceConnectorStreamingConfigurationRequest * const q)
