...
#include "resetpersonalpinresponse_p.h"
...
/*!
 * \class QtAws::Chime::ResetPersonalPINResponse
 * \brief The ResetPersonalPINResponse class provides an interace for Chime ResetPersonalPIN responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a ResetPersonalPINResponse object for \a reply to \a request, with parent \a parent.
 */
ResetPersonalPINResponse::ResetPersonalPINResponse(
        const ResetPersonalPINRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new ResetPersonalPINResponsePrivate(this), parent)
{
    setRequest(new ResetPersonalPINRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime ResetPersonalPIN \a response.
 */
void ResetPersonalPINResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ResetPersonalPINResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::ResetPersonalPINResponsePrivate
 * \brief The ResetPersonalPINResponsePrivate class provides private implementation for ResetPersonalPINResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ResetPersonalPINResponsePrivate object with public implementation \a q.
 */
ResetPersonalPINResponsePrivate::ResetPersonalPINResponsePrivate(
    ResetPersonalPINResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ResetPersonalPIN response element from \a xml.
 */
void ResetPersonalPINResponsePrivate::parseResetPersonalPINResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ResetPersonalPINResponse"));
    Q_UNUSED(xml) ///< @todo
}
