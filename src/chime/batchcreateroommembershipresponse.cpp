...
#include "batchcreateroommembershipresponse_p.h"
...
/*!
 * \class QtAws::Chime::BatchCreateRoomMembershipResponse
 * \brief The BatchCreateRoomMembershipResponse class provides an interace for Chime BatchCreateRoomMembership responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a BatchCreateRoomMembershipResponse object for \a reply to \a request, with parent \a parent.
 */
BatchCreateRoomMembershipResponse::BatchCreateRoomMembershipResponse(
        const BatchCreateRoomMembershipRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new BatchCreateRoomMembershipResponsePrivate(this), parent)
{
    setRequest(new BatchCreateRoomMembershipRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime BatchCreateRoomMembership \a response.
 */
void BatchCreateRoomMembershipResponse::parseSuccess(QIODevice &response)
{
    //Q_D(BatchCreateRoomMembershipResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::BatchCreateRoomMembershipResponsePrivate
 * \brief The BatchCreateRoomMembershipResponsePrivate class provides private implementation for BatchCreateRoomMembershipResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a BatchCreateRoomMembershipResponsePrivate object with public implementation \a q.
 */
BatchCreateRoomMembershipResponsePrivate::BatchCreateRoomMembershipResponsePrivate(
    BatchCreateRoomMembershipResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime BatchCreateRoomMembership response element from \a xml.
 */
void BatchCreateRoomMembershipResponsePrivate::parseBatchCreateRoomMembershipResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("BatchCreateRoomMembershipResponse"));
    Q_UNUSED(xml) ///< @todo
}
