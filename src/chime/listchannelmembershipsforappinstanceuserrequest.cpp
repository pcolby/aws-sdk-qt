...
/*!
 * \class QtAws::Chime::ListChannelMembershipsForAppInstanceUserRequest
 * \brief The ListChannelMembershipsForAppInstanceUserRequest class provides an interface for Chime ListChannelMembershipsForAppInstanceUser requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listChannelMembershipsForAppInstanceUser
 */
...
ListChannelMembershipsForAppInstanceUserRequest::ListChannelMembershipsForAppInstanceUserRequest(const ListChannelMembershipsForAppInstanceUserRequest &other)
    : ChimeRequest(new ListChannelMembershipsForAppInstanceUserRequestPrivate(*other.d_func(), this))
{
...
ListChannelMembershipsForAppInstanceUserRequest::ListChannelMembershipsForAppInstanceUserRequest()
    : ChimeRequest(new ListChannelMembershipsForAppInstanceUserRequestPrivate(ChimeRequest::ListChannelMembershipsForAppInstanceUserAction, this))
{
...
/*!
 * \class QtAws::Chime::ListChannelMembershipsForAppInstanceUserRequestPrivate
...
/*!
 * Constructs a ListChannelMembershipsForAppInstanceUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListChannelMembershipsForAppInstanceUserRequestPrivate::ListChannelMembershipsForAppInstanceUserRequestPrivate(
    const ChimeRequest::Action action, ListChannelMembershipsForAppInstanceUserRequest * const q)
