...
/*!
 * \class QtAws::Chime::UpdateRoomRequest
 * \brief The UpdateRoomRequest class provides an interface for Chime UpdateRoom requests.
 *
 * \inmodule QtAwsChime
 *
...
UpdateRoomRequest::UpdateRoomRequest(const UpdateRoomRequest &other)
    : ChimeRequest(new UpdateRoomRequestPrivate(*other.d_func(), this))
{
...
UpdateRoomRequest::UpdateRoomRequest()
    : ChimeRequest(new UpdateRoomRequestPrivate(ChimeRequest::UpdateRoomAction, this))
{
...
/*!
 * \class QtAws::Chime::UpdateRoomRequestPrivate
...
/*!
 * Constructs a UpdateRoomRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateRoomRequestPrivate::UpdateRoomRequestPrivate(
    const ChimeRequest::Action action, UpdateRoomRequest * const q)
