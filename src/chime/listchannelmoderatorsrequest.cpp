...
/*!
 * \class QtAws::Chime::ListChannelModeratorsRequest
 * \brief The ListChannelModeratorsRequest class provides an interface for Chime ListChannelModerators requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listChannelModerators
 */
...
ListChannelModeratorsRequest::ListChannelModeratorsRequest(const ListChannelModeratorsRequest &other)
    : ChimeRequest(new ListChannelModeratorsRequestPrivate(*other.d_func(), this))
{
...
ListChannelModeratorsRequest::ListChannelModeratorsRequest()
    : ChimeRequest(new ListChannelModeratorsRequestPrivate(ChimeRequest::ListChannelModeratorsAction, this))
{
...
/*!
 * \class QtAws::Chime::ListChannelModeratorsRequestPrivate
...
/*!
 * Constructs a ListChannelModeratorsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListChannelModeratorsRequestPrivate::ListChannelModeratorsRequestPrivate(
    const ChimeRequest::Action action, ListChannelModeratorsRequest * const q)
