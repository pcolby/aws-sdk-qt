...
/*!
 * \class QtAws::Chime::UpdateUserRequest
 * \brief The UpdateUserRequest class provides an interface for Chime UpdateUser requests.
 *
 * \inmodule QtAwsChime
 *
...
UpdateUserRequest::UpdateUserRequest(const UpdateUserRequest &other)
    : ChimeRequest(new UpdateUserRequestPrivate(*other.d_func(), this))
{
...
UpdateUserRequest::UpdateUserRequest()
    : ChimeRequest(new UpdateUserRequestPrivate(ChimeRequest::UpdateUserAction, this))
{
...
/*!
 * \class QtAws::Chime::UpdateUserRequestPrivate
...
/*!
 * Constructs a UpdateUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateUserRequestPrivate::UpdateUserRequestPrivate(
    const ChimeRequest::Action action, UpdateUserRequest * const q)
