...
#include "associatephonenumberswithvoiceconnectorgroupresponse_p.h"
...
/*!
 * \class QtAws::Chime::AssociatePhoneNumbersWithVoiceConnectorGroupResponse
 * \brief The AssociatePhoneNumbersWithVoiceConnectorGroupResponse class provides an interace for Chime AssociatePhoneNumbersWithVoiceConnectorGroup responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a AssociatePhoneNumbersWithVoiceConnectorGroupResponse object for \a reply to \a request, with parent \a parent.
 */
AssociatePhoneNumbersWithVoiceConnectorGroupResponse::AssociatePhoneNumbersWithVoiceConnectorGroupResponse(
        const AssociatePhoneNumbersWithVoiceConnectorGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new AssociatePhoneNumbersWithVoiceConnectorGroupResponsePrivate(this), parent)
{
    setRequest(new AssociatePhoneNumbersWithVoiceConnectorGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime AssociatePhoneNumbersWithVoiceConnectorGroup \a response.
 */
void AssociatePhoneNumbersWithVoiceConnectorGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(AssociatePhoneNumbersWithVoiceConnectorGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::AssociatePhoneNumbersWithVoiceConnectorGroupResponsePrivate
 * \brief The AssociatePhoneNumbersWithVoiceConnectorGroupResponsePrivate class provides private implementation for AssociatePhoneNumbersWithVoiceConnectorGroupResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a AssociatePhoneNumbersWithVoiceConnectorGroupResponsePrivate object with public implementation \a q.
 */
AssociatePhoneNumbersWithVoiceConnectorGroupResponsePrivate::AssociatePhoneNumbersWithVoiceConnectorGroupResponsePrivate(
    AssociatePhoneNumbersWithVoiceConnectorGroupResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime AssociatePhoneNumbersWithVoiceConnectorGroup response element from \a xml.
 */
void AssociatePhoneNumbersWithVoiceConnectorGroupResponsePrivate::parseAssociatePhoneNumbersWithVoiceConnectorGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("AssociatePhoneNumbersWithVoiceConnectorGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
