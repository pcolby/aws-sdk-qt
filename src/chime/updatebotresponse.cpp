...
/*!
 * \class QtAws::Chime::UpdateBotResponse
 * \brief The UpdateBotResponse class provides an interace for Chime UpdateBot responses.
 *
 * \inmodule QtAwsChime
 *
...
UpdateBotResponse::UpdateBotResponse(
    ...
    : ChimeResponse(new UpdateBotResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime UpdateBot \a response.
 */
...
/*!
 * \class QtAws::Chime::UpdateBotResponsePrivate
...
UpdateBotResponsePrivate::UpdateBotResponsePrivate(
    UpdateBotResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateBot response element from \a xml.
 */
