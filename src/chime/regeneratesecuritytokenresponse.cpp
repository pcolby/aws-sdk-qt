...
#include "regeneratesecuritytokenresponse_p.h"
...
/*!
 * \class QtAws::Chime::RegenerateSecurityTokenResponse
 * \brief The RegenerateSecurityTokenResponse class provides an interace for Chime RegenerateSecurityToken responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a RegenerateSecurityTokenResponse object for \a reply to \a request, with parent \a parent.
 */
RegenerateSecurityTokenResponse::RegenerateSecurityTokenResponse(
        const RegenerateSecurityTokenRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new RegenerateSecurityTokenResponsePrivate(this), parent)
{
    setRequest(new RegenerateSecurityTokenRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime RegenerateSecurityToken \a response.
 */
void RegenerateSecurityTokenResponse::parseSuccess(QIODevice &response)
{
    //Q_D(RegenerateSecurityTokenResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::RegenerateSecurityTokenResponsePrivate
 * \brief The RegenerateSecurityTokenResponsePrivate class provides private implementation for RegenerateSecurityTokenResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a RegenerateSecurityTokenResponsePrivate object with public implementation \a q.
 */
RegenerateSecurityTokenResponsePrivate::RegenerateSecurityTokenResponsePrivate(
    RegenerateSecurityTokenResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime RegenerateSecurityToken response element from \a xml.
 */
void RegenerateSecurityTokenResponsePrivate::parseRegenerateSecurityTokenResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("RegenerateSecurityTokenResponse"));
    Q_UNUSED(xml) ///< @todo
}
