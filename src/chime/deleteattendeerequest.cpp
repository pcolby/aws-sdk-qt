...
/*!
 * \class QtAws::Chime::DeleteAttendeeRequest
 * \brief The DeleteAttendeeRequest class provides an interface for Chime DeleteAttendee requests.
 *
 * \inmodule QtAwsChime
 *
...
DeleteAttendeeRequest::DeleteAttendeeRequest(const DeleteAttendeeRequest &other)
    : ChimeRequest(new DeleteAttendeeRequestPrivate(*other.d_func(), this))
{
...
DeleteAttendeeRequest::DeleteAttendeeRequest()
    : ChimeRequest(new DeleteAttendeeRequestPrivate(ChimeRequest::DeleteAttendeeAction, this))
{
...
/*!
 * \class QtAws::Chime::DeleteAttendeeRequestPrivate
...
/*!
 * Constructs a DeleteAttendeeRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteAttendeeRequestPrivate::DeleteAttendeeRequestPrivate(
    const ChimeRequest::Action action, DeleteAttendeeRequest * const q)
