...
class QTAWS_EXPORT DescribeAppInstanceAdminResponsePrivate : public ChimeResponsePrivate {

public:

    DescribeAppInstanceAdminResponsePrivate(DescribeAppInstanceAdminResponse * const q);
