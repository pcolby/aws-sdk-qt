...
/*!
 * \class QtAws::Chime::CreateUserRequest
 * \brief The CreateUserRequest class provides an interface for Chime CreateUser requests.
 *
 * \inmodule QtAwsChime
 *
...
CreateUserRequest::CreateUserRequest(const CreateUserRequest &other)
    : ChimeRequest(new CreateUserRequestPrivate(*other.d_func(), this))
{
...
CreateUserRequest::CreateUserRequest()
    : ChimeRequest(new CreateUserRequestPrivate(ChimeRequest::CreateUserAction, this))
{
...
/*!
 * \class QtAws::Chime::CreateUserRequestPrivate
...
/*!
 * Constructs a CreateUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateUserRequestPrivate::CreateUserRequestPrivate(
    const ChimeRequest::Action action, CreateUserRequest * const q)
