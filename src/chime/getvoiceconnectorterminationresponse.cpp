...
#include "getvoiceconnectorterminationresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorTerminationResponse
 * \brief The GetVoiceConnectorTerminationResponse class provides an interace for Chime GetVoiceConnectorTermination responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a GetVoiceConnectorTerminationResponse object for \a reply to \a request, with parent \a parent.
 */
GetVoiceConnectorTerminationResponse::GetVoiceConnectorTerminationResponse(
        const GetVoiceConnectorTerminationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetVoiceConnectorTerminationResponsePrivate(this), parent)
{
    setRequest(new GetVoiceConnectorTerminationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime GetVoiceConnectorTermination \a response.
 */
void GetVoiceConnectorTerminationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetVoiceConnectorTerminationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorTerminationResponsePrivate
 * \brief The GetVoiceConnectorTerminationResponsePrivate class provides private implementation for GetVoiceConnectorTerminationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorTerminationResponsePrivate object with public implementation \a q.
 */
GetVoiceConnectorTerminationResponsePrivate::GetVoiceConnectorTerminationResponsePrivate(
    GetVoiceConnectorTerminationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetVoiceConnectorTermination response element from \a xml.
 */
void GetVoiceConnectorTerminationResponsePrivate::parseGetVoiceConnectorTerminationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetVoiceConnectorTerminationResponse"));
    Q_UNUSED(xml) ///< @todo
}
