...
#include "getretentionsettingsrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetRetentionSettingsRequest
 * \brief The GetRetentionSettingsRequest class provides an interface for Chime GetRetentionSettings requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getRetentionSettings
 */

/*!
 * Constructs a copy of \a other.
 */
GetRetentionSettingsRequest::GetRetentionSettingsRequest(const GetRetentionSettingsRequest &other)
    : ChimeRequest(new GetRetentionSettingsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetRetentionSettingsRequest object.
 */
GetRetentionSettingsRequest::GetRetentionSettingsRequest()
    : ChimeRequest(new GetRetentionSettingsRequestPrivate(ChimeRequest::GetRetentionSettingsAction, this))
{
 ...
 * \reimp
 */
bool GetRetentionSettingsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetRetentionSettingsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetRetentionSettingsRequest::response(QNetworkReply * const reply) const
{
    return new GetRetentionSettingsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetRetentionSettingsRequestPrivate
 * \brief The GetRetentionSettingsRequestPrivate class provides private implementation for GetRetentionSettingsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetRetentionSettingsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetRetentionSettingsRequestPrivate::GetRetentionSettingsRequestPrivate(
    const ChimeRequest::Action action, GetRetentionSettingsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetRetentionSettingsRequest
 * class' copy constructor.
 */
GetRetentionSettingsRequestPrivate::GetRetentionSettingsRequestPrivate(
    const GetRetentionSettingsRequestPrivate &other, GetRetentionSettingsRequest * const q)
