...
#include "listroommembershipsresponse_p.h"
...
/*!
 * \class QtAws::Chime::ListRoomMembershipsResponse
 * \brief The ListRoomMembershipsResponse class provides an interace for Chime ListRoomMemberships responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a ListRoomMembershipsResponse object for \a reply to \a request, with parent \a parent.
 */
ListRoomMembershipsResponse::ListRoomMembershipsResponse(
        const ListRoomMembershipsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new ListRoomMembershipsResponsePrivate(this), parent)
{
    setRequest(new ListRoomMembershipsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime ListRoomMemberships \a response.
 */
void ListRoomMembershipsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListRoomMembershipsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::ListRoomMembershipsResponsePrivate
 * \brief The ListRoomMembershipsResponsePrivate class provides private implementation for ListRoomMembershipsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListRoomMembershipsResponsePrivate object with public implementation \a q.
 */
ListRoomMembershipsResponsePrivate::ListRoomMembershipsResponsePrivate(
    ListRoomMembershipsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListRoomMemberships response element from \a xml.
 */
void ListRoomMembershipsResponsePrivate::parseListRoomMembershipsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListRoomMembershipsResponse"));
    Q_UNUSED(xml) ///< @todo
}
