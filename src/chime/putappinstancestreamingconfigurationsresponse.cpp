...
#include "putappinstancestreamingconfigurationsresponse_p.h"
...
/*!
 * \class QtAws::Chime::PutAppInstanceStreamingConfigurationsResponse
 * \brief The PutAppInstanceStreamingConfigurationsResponse class provides an interace for Chime PutAppInstanceStreamingConfigurations responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a PutAppInstanceStreamingConfigurationsResponse object for \a reply to \a request, with parent \a parent.
 */
PutAppInstanceStreamingConfigurationsResponse::PutAppInstanceStreamingConfigurationsResponse(
        const PutAppInstanceStreamingConfigurationsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new PutAppInstanceStreamingConfigurationsResponsePrivate(this), parent)
{
    setRequest(new PutAppInstanceStreamingConfigurationsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime PutAppInstanceStreamingConfigurations \a response.
 */
void PutAppInstanceStreamingConfigurationsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutAppInstanceStreamingConfigurationsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::PutAppInstanceStreamingConfigurationsResponsePrivate
 * \brief The PutAppInstanceStreamingConfigurationsResponsePrivate class provides private implementation for PutAppInstanceStreamingConfigurationsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutAppInstanceStreamingConfigurationsResponsePrivate object with public implementation \a q.
 */
PutAppInstanceStreamingConfigurationsResponsePrivate::PutAppInstanceStreamingConfigurationsResponsePrivate(
    PutAppInstanceStreamingConfigurationsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime PutAppInstanceStreamingConfigurations response element from \a xml.
 */
void PutAppInstanceStreamingConfigurationsResponsePrivate::parsePutAppInstanceStreamingConfigurationsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutAppInstanceStreamingConfigurationsResponse"));
    Q_UNUSED(xml) ///< @todo
}
