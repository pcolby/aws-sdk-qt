...
class QTAWS_EXPORT DeleteChannelMembershipResponsePrivate : public ChimeResponsePrivate {

public:

    DeleteChannelMembershipResponsePrivate(DeleteChannelMembershipResponse * const q);
