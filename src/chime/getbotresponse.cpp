...
/*!
 * \class QtAws::Chime::GetBotResponse
 * \brief The GetBotResponse class provides an interace for Chime GetBot responses.
 *
 * \inmodule QtAwsChime
 *
...
GetBotResponse::GetBotResponse(
    ...
    : ChimeResponse(new GetBotResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime GetBot \a response.
 */
...
/*!
 * \class QtAws::Chime::GetBotResponsePrivate
...
GetBotResponsePrivate::GetBotResponsePrivate(
    GetBotResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetBot response element from \a xml.
 */
