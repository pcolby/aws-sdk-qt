...
#include "updatephonenumbersettingsresponse_p.h"
...
/*!
 * \class QtAws::Chime::UpdatePhoneNumberSettingsResponse
 * \brief The UpdatePhoneNumberSettingsResponse class provides an interace for Chime UpdatePhoneNumberSettings responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a UpdatePhoneNumberSettingsResponse object for \a reply to \a request, with parent \a parent.
 */
UpdatePhoneNumberSettingsResponse::UpdatePhoneNumberSettingsResponse(
        const UpdatePhoneNumberSettingsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new UpdatePhoneNumberSettingsResponsePrivate(this), parent)
{
    setRequest(new UpdatePhoneNumberSettingsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdatePhoneNumberSettingsRequest * UpdatePhoneNumberSettingsResponse::request() const
{
    Q_D(const UpdatePhoneNumberSettingsResponse);
    return static_cast<const UpdatePhoneNumberSettingsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime UpdatePhoneNumberSettings \a response.
 */
void UpdatePhoneNumberSettingsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdatePhoneNumberSettingsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::UpdatePhoneNumberSettingsResponsePrivate
 * \brief The UpdatePhoneNumberSettingsResponsePrivate class provides private implementation for UpdatePhoneNumberSettingsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UpdatePhoneNumberSettingsResponsePrivate object with public implementation \a q.
 */
UpdatePhoneNumberSettingsResponsePrivate::UpdatePhoneNumberSettingsResponsePrivate(
    UpdatePhoneNumberSettingsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdatePhoneNumberSettings response element from \a xml.
 */
void UpdatePhoneNumberSettingsResponsePrivate::parseUpdatePhoneNumberSettingsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdatePhoneNumberSettingsResponse"));
    Q_UNUSED(xml) ///< @todo
}
