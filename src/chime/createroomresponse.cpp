...
/*!
 * \class QtAws::Chime::CreateRoomResponse
 * \brief The CreateRoomResponse class provides an interace for Chime CreateRoom responses.
 *
 * \inmodule QtAwsChime
 *
...
CreateRoomResponse::CreateRoomResponse(
    ...
    : ChimeResponse(new CreateRoomResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime CreateRoom \a response.
 */
...
/*!
 * \class QtAws::Chime::CreateRoomResponsePrivate
...
CreateRoomResponsePrivate::CreateRoomResponsePrivate(
    CreateRoomResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateRoom response element from \a xml.
 */
