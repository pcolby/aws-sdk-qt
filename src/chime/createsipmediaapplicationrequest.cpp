...
#include "createsipmediaapplicationrequest_p.h"
...
/*!
 * \class QtAws::Chime::CreateSipMediaApplicationRequest
 * \brief The CreateSipMediaApplicationRequest class provides an interface for Chime CreateSipMediaApplication requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
CreateSipMediaApplicationRequest::CreateSipMediaApplicationRequest(const CreateSipMediaApplicationRequest &other)
    : ChimeRequest(new CreateSipMediaApplicationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateSipMediaApplicationRequest object.
 */
CreateSipMediaApplicationRequest::CreateSipMediaApplicationRequest()
    : ChimeRequest(new CreateSipMediaApplicationRequestPrivate(ChimeRequest::CreateSipMediaApplicationAction, this))
{
 ...
 * \reimp
 */
bool CreateSipMediaApplicationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateSipMediaApplicationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateSipMediaApplicationRequest::response(QNetworkReply * const reply) const
{
    return new CreateSipMediaApplicationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::CreateSipMediaApplicationRequestPrivate
 * \brief The CreateSipMediaApplicationRequestPrivate class provides private implementation for CreateSipMediaApplicationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateSipMediaApplicationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateSipMediaApplicationRequestPrivate::CreateSipMediaApplicationRequestPrivate(
    const ChimeRequest::Action action, CreateSipMediaApplicationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateSipMediaApplicationRequest
 * class' copy constructor.
 */
CreateSipMediaApplicationRequestPrivate::CreateSipMediaApplicationRequestPrivate(
    const CreateSipMediaApplicationRequestPrivate &other, CreateSipMediaApplicationRequest * const q)
