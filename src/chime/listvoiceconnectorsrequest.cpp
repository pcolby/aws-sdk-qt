...
#include "listvoiceconnectorsrequest_p.h"
...
/*!
 * \class QtAws::Chime::ListVoiceConnectorsRequest
 * \brief The ListVoiceConnectorsRequest class provides an interface for Chime ListVoiceConnectors requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listVoiceConnectors
 */

/*!
 * Constructs a copy of \a other.
 */
ListVoiceConnectorsRequest::ListVoiceConnectorsRequest(const ListVoiceConnectorsRequest &other)
    : ChimeRequest(new ListVoiceConnectorsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListVoiceConnectorsRequest object.
 */
ListVoiceConnectorsRequest::ListVoiceConnectorsRequest()
    : ChimeRequest(new ListVoiceConnectorsRequestPrivate(ChimeRequest::ListVoiceConnectorsAction, this))
{
 ...
 * \reimp
 */
bool ListVoiceConnectorsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListVoiceConnectorsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListVoiceConnectorsRequest::response(QNetworkReply * const reply) const
{
    return new ListVoiceConnectorsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::ListVoiceConnectorsRequestPrivate
 * \brief The ListVoiceConnectorsRequestPrivate class provides private implementation for ListVoiceConnectorsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListVoiceConnectorsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListVoiceConnectorsRequestPrivate::ListVoiceConnectorsRequestPrivate(
    const ChimeRequest::Action action, ListVoiceConnectorsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListVoiceConnectorsRequest
 * class' copy constructor.
 */
ListVoiceConnectorsRequestPrivate::ListVoiceConnectorsRequestPrivate(
    const ListVoiceConnectorsRequestPrivate &other, ListVoiceConnectorsRequest * const q)
