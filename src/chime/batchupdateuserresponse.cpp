...
#include "batchupdateuserresponse_p.h"
...
/*!
 * \class QtAws::Chime::BatchUpdateUserResponse
 * \brief The BatchUpdateUserResponse class provides an interace for Chime BatchUpdateUser responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a BatchUpdateUserResponse object for \a reply to \a request, with parent \a parent.
 */
BatchUpdateUserResponse::BatchUpdateUserResponse(
        const BatchUpdateUserRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new BatchUpdateUserResponsePrivate(this), parent)
{
    setRequest(new BatchUpdateUserRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime BatchUpdateUser \a response.
 */
void BatchUpdateUserResponse::parseSuccess(QIODevice &response)
{
    //Q_D(BatchUpdateUserResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::BatchUpdateUserResponsePrivate
 * \brief The BatchUpdateUserResponsePrivate class provides private implementation for BatchUpdateUserResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a BatchUpdateUserResponsePrivate object with public implementation \a q.
 */
BatchUpdateUserResponsePrivate::BatchUpdateUserResponsePrivate(
    BatchUpdateUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime BatchUpdateUser response element from \a xml.
 */
void BatchUpdateUserResponsePrivate::parseBatchUpdateUserResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("BatchUpdateUserResponse"));
    Q_UNUSED(xml) ///< @todo
}
