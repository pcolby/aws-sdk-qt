...
/*!
 * \class QtAws::Chime::GetUserRequest
 * \brief The GetUserRequest class provides an interface for Chime GetUser requests.
 *
 * \inmodule QtAwsChime
 *
...
GetUserRequest::GetUserRequest(const GetUserRequest &other)
    : ChimeRequest(new GetUserRequestPrivate(*other.d_func(), this))
{
...
GetUserRequest::GetUserRequest()
    : ChimeRequest(new GetUserRequestPrivate(ChimeRequest::GetUserAction, this))
{
...
/*!
 * \class QtAws::Chime::GetUserRequestPrivate
...
/*!
 * Constructs a GetUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetUserRequestPrivate::GetUserRequestPrivate(
    const ChimeRequest::Action action, GetUserRequest * const q)
