...
#include "deletevoiceconnectorproxyrequest_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorProxyRequest
 * \brief The DeleteVoiceConnectorProxyRequest class provides an interface for Chime DeleteVoiceConnectorProxy requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
DeleteVoiceConnectorProxyRequest::DeleteVoiceConnectorProxyRequest(const DeleteVoiceConnectorProxyRequest &other)
    : ChimeRequest(new DeleteVoiceConnectorProxyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteVoiceConnectorProxyRequest object.
 */
DeleteVoiceConnectorProxyRequest::DeleteVoiceConnectorProxyRequest()
    : ChimeRequest(new DeleteVoiceConnectorProxyRequestPrivate(ChimeRequest::DeleteVoiceConnectorProxyAction, this))
{
 ...
 * \reimp
 */
bool DeleteVoiceConnectorProxyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteVoiceConnectorProxyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteVoiceConnectorProxyRequest::response(QNetworkReply * const reply) const
{
    return new DeleteVoiceConnectorProxyResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorProxyRequestPrivate
 * \brief The DeleteVoiceConnectorProxyRequestPrivate class provides private implementation for DeleteVoiceConnectorProxyRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorProxyRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteVoiceConnectorProxyRequestPrivate::DeleteVoiceConnectorProxyRequestPrivate(
    const ChimeRequest::Action action, DeleteVoiceConnectorProxyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteVoiceConnectorProxyRequest
 * class' copy constructor.
 */
DeleteVoiceConnectorProxyRequestPrivate::DeleteVoiceConnectorProxyRequestPrivate(
    const DeleteVoiceConnectorProxyRequestPrivate &other, DeleteVoiceConnectorProxyRequest * const q)
