...
/*!
 * \class QtAws::Chime::ListBotsRequest
 * \brief The ListBotsRequest class provides an interface for Chime ListBots requests.
 *
 * \inmodule QtAwsChime
 *
...
ListBotsRequest::ListBotsRequest(const ListBotsRequest &other)
    : ChimeRequest(new ListBotsRequestPrivate(*other.d_func(), this))
{
...
ListBotsRequest::ListBotsRequest()
    : ChimeRequest(new ListBotsRequestPrivate(ChimeRequest::ListBotsAction, this))
{
...
/*!
 * \class QtAws::Chime::ListBotsRequestPrivate
...
/*!
 * Constructs a ListBotsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListBotsRequestPrivate::ListBotsRequestPrivate(
    const ChimeRequest::Action action, ListBotsRequest * const q)
