...
/*!
 * \class QtAws::Chime::UpdateChannelReadMarkerResponse
 * \brief The UpdateChannelReadMarkerResponse class provides an interace for Chime UpdateChannelReadMarker responses.
 *
 * \inmodule QtAwsChime
 *
...
UpdateChannelReadMarkerResponse::UpdateChannelReadMarkerResponse(
    ...
    : ChimeResponse(new UpdateChannelReadMarkerResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime UpdateChannelReadMarker \a response.
 */
...
/*!
 * \class QtAws::Chime::UpdateChannelReadMarkerResponsePrivate
...
UpdateChannelReadMarkerResponsePrivate::UpdateChannelReadMarkerResponsePrivate(
    UpdateChannelReadMarkerResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateChannelReadMarker response element from \a xml.
 */
