...
/*!
 * \class QtAws::Chime::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for Chime UntagResource requests.
 *
 * \inmodule QtAwsChime
 *
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : ChimeRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : ChimeRequest(new UntagResourceRequestPrivate(ChimeRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::Chime::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const ChimeRequest::Action action, UntagResourceRequest * const q)
