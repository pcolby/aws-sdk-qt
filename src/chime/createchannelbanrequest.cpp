...
/*!
 * \class QtAws::Chime::CreateChannelBanRequest
 * \brief The CreateChannelBanRequest class provides an interface for Chime CreateChannelBan requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createChannelBan
 */
...
CreateChannelBanRequest::CreateChannelBanRequest(const CreateChannelBanRequest &other)
    : ChimeRequest(new CreateChannelBanRequestPrivate(*other.d_func(), this))
{
...
CreateChannelBanRequest::CreateChannelBanRequest()
    : ChimeRequest(new CreateChannelBanRequestPrivate(ChimeRequest::CreateChannelBanAction, this))
{
...
/*!
 * \class QtAws::Chime::CreateChannelBanRequestPrivate
...
/*!
 * Constructs a CreateChannelBanRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateChannelBanRequestPrivate::CreateChannelBanRequestPrivate(
    const ChimeRequest::Action action, CreateChannelBanRequest * const q)
