...
/*!
 * \class QtAws::Chime::UpdateAppInstanceUserRequest
 * \brief The UpdateAppInstanceUserRequest class provides an interface for Chime UpdateAppInstanceUser requests.
 *
 * \inmodule QtAwsChime
 *
...
UpdateAppInstanceUserRequest::UpdateAppInstanceUserRequest(const UpdateAppInstanceUserRequest &other)
    : ChimeRequest(new UpdateAppInstanceUserRequestPrivate(*other.d_func(), this))
{
...
UpdateAppInstanceUserRequest::UpdateAppInstanceUserRequest()
    : ChimeRequest(new UpdateAppInstanceUserRequestPrivate(ChimeRequest::UpdateAppInstanceUserAction, this))
{
...
/*!
 * \class QtAws::Chime::UpdateAppInstanceUserRequestPrivate
...
/*!
 * Constructs a UpdateAppInstanceUserRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateAppInstanceUserRequestPrivate::UpdateAppInstanceUserRequestPrivate(
    const ChimeRequest::Action action, UpdateAppInstanceUserRequest * const q)
