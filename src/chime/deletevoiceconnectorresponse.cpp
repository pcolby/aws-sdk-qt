...
#include "deletevoiceconnectorresponse_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorResponse
 * \brief The DeleteVoiceConnectorResponse class provides an interace for Chime DeleteVoiceConnector responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::deleteVoiceConnector
 */

/*!
 * Constructs a DeleteVoiceConnectorResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteVoiceConnectorResponse::DeleteVoiceConnectorResponse(
        const DeleteVoiceConnectorRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DeleteVoiceConnectorResponsePrivate(this), parent)
{
    setRequest(new DeleteVoiceConnectorRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const DeleteVoiceConnectorRequest * DeleteVoiceConnectorResponse::request() const
{
    Q_D(const DeleteVoiceConnectorResponse);
    return static_cast<const DeleteVoiceConnectorRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Chime DeleteVoiceConnector \a response.
 */
void DeleteVoiceConnectorResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteVoiceConnectorResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorResponsePrivate
 * \brief The DeleteVoiceConnectorResponsePrivate class provides private implementation for DeleteVoiceConnectorResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorResponsePrivate object with public implementation \a q.
 */
DeleteVoiceConnectorResponsePrivate::DeleteVoiceConnectorResponsePrivate(
    DeleteVoiceConnectorResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteVoiceConnector response element from \a xml.
 */
void DeleteVoiceConnectorResponsePrivate::parseDeleteVoiceConnectorResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteVoiceConnectorResponse"));
    Q_UNUSED(xml) ///< @todo
}
