...
#include "putvoiceconnectoremergencycallingconfigurationrequest_p.h"
...
/*!
 * \class QtAws::Chime::PutVoiceConnectorEmergencyCallingConfigurationRequest
 * \brief The PutVoiceConnectorEmergencyCallingConfigurationRequest class provides an interface for Chime PutVoiceConnectorEmergencyCallingConfiguration requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::putVoiceConnectorEmergencyCallingConfiguration
 */

/*!
 * Constructs a copy of \a other.
 */
PutVoiceConnectorEmergencyCallingConfigurationRequest::PutVoiceConnectorEmergencyCallingConfigurationRequest(const PutVoiceConnectorEmergencyCallingConfigurationRequest &other)
    : ChimeRequest(new PutVoiceConnectorEmergencyCallingConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutVoiceConnectorEmergencyCallingConfigurationRequest object.
 */
PutVoiceConnectorEmergencyCallingConfigurationRequest::PutVoiceConnectorEmergencyCallingConfigurationRequest()
    : ChimeRequest(new PutVoiceConnectorEmergencyCallingConfigurationRequestPrivate(ChimeRequest::PutVoiceConnectorEmergencyCallingConfigurationAction, this))
{
 ...
 * \reimp
 */
bool PutVoiceConnectorEmergencyCallingConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutVoiceConnectorEmergencyCallingConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutVoiceConnectorEmergencyCallingConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new PutVoiceConnectorEmergencyCallingConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::PutVoiceConnectorEmergencyCallingConfigurationRequestPrivate
 * \brief The PutVoiceConnectorEmergencyCallingConfigurationRequestPrivate class provides private implementation for PutVoiceConnectorEmergencyCallingConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutVoiceConnectorEmergencyCallingConfigurationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
PutVoiceConnectorEmergencyCallingConfigurationRequestPrivate::PutVoiceConnectorEmergencyCallingConfigurationRequestPrivate(
    const ChimeRequest::Action action, PutVoiceConnectorEmergencyCallingConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutVoiceConnectorEmergencyCallingConfigurationRequest
 * class' copy constructor.
 */
PutVoiceConnectorEmergencyCallingConfigurationRequestPrivate::PutVoiceConnectorEmergencyCallingConfigurationRequestPrivate(
    const PutVoiceConnectorEmergencyCallingConfigurationRequestPrivate &other, PutVoiceConnectorEmergencyCallingConfigurationRequest * const q)
