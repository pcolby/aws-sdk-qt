...
#include "putvoiceconnectorloggingconfigurationresponse_p.h"
...
/*!
 * \class QtAws::Chime::PutVoiceConnectorLoggingConfigurationResponse
 * \brief The PutVoiceConnectorLoggingConfigurationResponse class provides an interace for Chime PutVoiceConnectorLoggingConfiguration responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a PutVoiceConnectorLoggingConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
PutVoiceConnectorLoggingConfigurationResponse::PutVoiceConnectorLoggingConfigurationResponse(
    ...
    : ChimeResponse(new PutVoiceConnectorLoggingConfigurationResponsePrivate(this), parent)
{
    setRequest(new PutVoiceConnectorLoggingConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime PutVoiceConnectorLoggingConfiguration \a response.
 */
void PutVoiceConnectorLoggingConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(PutVoiceConnectorLoggingConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::PutVoiceConnectorLoggingConfigurationResponsePrivate
 * \brief The PutVoiceConnectorLoggingConfigurationResponsePrivate class provides private implementation for PutVoiceConnectorLoggingConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutVoiceConnectorLoggingConfigurationResponsePrivate object with public implementation \a q.
 */
PutVoiceConnectorLoggingConfigurationResponsePrivate::PutVoiceConnectorLoggingConfigurationResponsePrivate(
    PutVoiceConnectorLoggingConfigurationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime PutVoiceConnectorLoggingConfiguration response element from \a xml.
 */
void PutVoiceConnectorLoggingConfigurationResponsePrivate::parsePutVoiceConnectorLoggingConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("PutVoiceConnectorLoggingConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
