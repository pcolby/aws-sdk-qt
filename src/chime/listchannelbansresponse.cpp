...
/*!
 * \class QtAws::Chime::ListChannelBansResponse
 * \brief The ListChannelBansResponse class provides an interace for Chime ListChannelBans responses.
 *
 * \inmodule QtAwsChime
 *
...
ListChannelBansResponse::ListChannelBansResponse(
    ...
    : ChimeResponse(new ListChannelBansResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime ListChannelBans \a response.
 */
...
/*!
 * \class QtAws::Chime::ListChannelBansResponsePrivate
...
ListChannelBansResponsePrivate::ListChannelBansResponsePrivate(
    ListChannelBansResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListChannelBans response element from \a xml.
 */
