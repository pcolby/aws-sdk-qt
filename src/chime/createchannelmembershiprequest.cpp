...
/*!
 * \class QtAws::Chime::CreateChannelMembershipRequest
 * \brief The CreateChannelMembershipRequest class provides an interface for Chime CreateChannelMembership requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createChannelMembership
 */
...
CreateChannelMembershipRequest::CreateChannelMembershipRequest(const CreateChannelMembershipRequest &other)
    : ChimeRequest(new CreateChannelMembershipRequestPrivate(*other.d_func(), this))
{
...
CreateChannelMembershipRequest::CreateChannelMembershipRequest()
    : ChimeRequest(new CreateChannelMembershipRequestPrivate(ChimeRequest::CreateChannelMembershipAction, this))
{
...
/*!
 * \class QtAws::Chime::CreateChannelMembershipRequestPrivate
...
/*!
 * Constructs a CreateChannelMembershipRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateChannelMembershipRequestPrivate::CreateChannelMembershipRequestPrivate(
    const ChimeRequest::Action action, CreateChannelMembershipRequest * const q)
