...
class QTAWS_EXPORT DeleteVoiceConnectorTerminationResponsePrivate : public ChimeResponsePrivate {

public:

    DeleteVoiceConnectorTerminationResponsePrivate(DeleteVoiceConnectorTerminationResponse * const q);
