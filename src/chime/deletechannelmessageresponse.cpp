...
/*!
 * \class QtAws::Chime::DeleteChannelMessageResponse
 * \brief The DeleteChannelMessageResponse class provides an interace for Chime DeleteChannelMessage responses.
 *
 * \inmodule QtAwsChime
 *
...
DeleteChannelMessageResponse::DeleteChannelMessageResponse(
    ...
    : ChimeResponse(new DeleteChannelMessageResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteChannelMessageRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime DeleteChannelMessage \a response.
 */
...
/*!
 * \class QtAws::Chime::DeleteChannelMessageResponsePrivate
...
DeleteChannelMessageResponsePrivate::DeleteChannelMessageResponsePrivate(
    DeleteChannelMessageResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteChannelMessage response element from \a xml.
 */
