...
/*!
 * \class QtAws::Chime::GetChannelMessageResponse
 * \brief The GetChannelMessageResponse class provides an interace for Chime GetChannelMessage responses.
 *
 * \inmodule QtAwsChime
 *
...
GetChannelMessageResponse::GetChannelMessageResponse(
    ...
    : ChimeResponse(new GetChannelMessageResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime GetChannelMessage \a response.
 */
...
/*!
 * \class QtAws::Chime::GetChannelMessageResponsePrivate
...
GetChannelMessageResponsePrivate::GetChannelMessageResponsePrivate(
    GetChannelMessageResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetChannelMessage response element from \a xml.
 */
