...
#include "createsiprulerequest_p.h"
...
/*!
 * \class QtAws::Chime::CreateSipRuleRequest
 * \brief The CreateSipRuleRequest class provides an interface for Chime CreateSipRule requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::createSipRule
 */

/*!
 * Constructs a copy of \a other.
 */
CreateSipRuleRequest::CreateSipRuleRequest(const CreateSipRuleRequest &other)
    : ChimeRequest(new CreateSipRuleRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateSipRuleRequest object.
 */
CreateSipRuleRequest::CreateSipRuleRequest()
    : ChimeRequest(new CreateSipRuleRequestPrivate(ChimeRequest::CreateSipRuleAction, this))
{
 ...
 * \reimp
 */
bool CreateSipRuleRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateSipRuleResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateSipRuleRequest::response(QNetworkReply * const reply) const
{
    return new CreateSipRuleResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::CreateSipRuleRequestPrivate
 * \brief The CreateSipRuleRequestPrivate class provides private implementation for CreateSipRuleRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateSipRuleRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
CreateSipRuleRequestPrivate::CreateSipRuleRequestPrivate(
    const ChimeRequest::Action action, CreateSipRuleRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateSipRuleRequest
 * class' copy constructor.
 */
CreateSipRuleRequestPrivate::CreateSipRuleRequestPrivate(
    const CreateSipRuleRequestPrivate &other, CreateSipRuleRequest * const q)
