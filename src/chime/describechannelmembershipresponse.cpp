...
/*!
 * \class QtAws::Chime::DescribeChannelMembershipResponse
 * \brief The DescribeChannelMembershipResponse class provides an interace for Chime DescribeChannelMembership responses.
 *
 * \inmodule QtAwsChime
 *
...
DescribeChannelMembershipResponse::DescribeChannelMembershipResponse(
    ...
    : ChimeResponse(new DescribeChannelMembershipResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DescribeChannelMembership \a response.
 */
...
/*!
 * \class QtAws::Chime::DescribeChannelMembershipResponsePrivate
...
DescribeChannelMembershipResponsePrivate::DescribeChannelMembershipResponsePrivate(
    DescribeChannelMembershipResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DescribeChannelMembership response element from \a xml.
 */
