...
/*!
 * \class QtAws::Chime::GetUserResponse
 * \brief The GetUserResponse class provides an interace for Chime GetUser responses.
 *
 * \inmodule QtAwsChime
 *
...
GetUserResponse::GetUserResponse(
    ...
    : ChimeResponse(new GetUserResponsePrivate(this), parent)
{
...
{
    return static_cast<const GetUserRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime GetUser \a response.
 */
...
/*!
 * \class QtAws::Chime::GetUserResponsePrivate
...
GetUserResponsePrivate::GetUserResponsePrivate(
    GetUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetUser response element from \a xml.
 */
