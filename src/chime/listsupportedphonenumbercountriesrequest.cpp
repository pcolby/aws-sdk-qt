...
#include "listsupportedphonenumbercountriesrequest_p.h"
...
/*!
 * \class QtAws::Chime::ListSupportedPhoneNumberCountriesRequest
 * \brief The ListSupportedPhoneNumberCountriesRequest class provides an interface for Chime ListSupportedPhoneNumberCountries requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listSupportedPhoneNumberCountries
 */

/*!
 * Constructs a copy of \a other.
 */
ListSupportedPhoneNumberCountriesRequest::ListSupportedPhoneNumberCountriesRequest(const ListSupportedPhoneNumberCountriesRequest &other)
    : ChimeRequest(new ListSupportedPhoneNumberCountriesRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListSupportedPhoneNumberCountriesRequest object.
 */
ListSupportedPhoneNumberCountriesRequest::ListSupportedPhoneNumberCountriesRequest()
    : ChimeRequest(new ListSupportedPhoneNumberCountriesRequestPrivate(ChimeRequest::ListSupportedPhoneNumberCountriesAction, this))
{
 ...
 * \reimp
 */
bool ListSupportedPhoneNumberCountriesRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListSupportedPhoneNumberCountriesResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListSupportedPhoneNumberCountriesRequest::response(QNetworkReply * const reply) const
{
    return new ListSupportedPhoneNumberCountriesResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::ListSupportedPhoneNumberCountriesRequestPrivate
 * \brief The ListSupportedPhoneNumberCountriesRequestPrivate class provides private implementation for ListSupportedPhoneNumberCountriesRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListSupportedPhoneNumberCountriesRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListSupportedPhoneNumberCountriesRequestPrivate::ListSupportedPhoneNumberCountriesRequestPrivate(
    const ChimeRequest::Action action, ListSupportedPhoneNumberCountriesRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListSupportedPhoneNumberCountriesRequest
 * class' copy constructor.
 */
ListSupportedPhoneNumberCountriesRequestPrivate::ListSupportedPhoneNumberCountriesRequestPrivate(
    const ListSupportedPhoneNumberCountriesRequestPrivate &other, ListSupportedPhoneNumberCountriesRequest * const q)
