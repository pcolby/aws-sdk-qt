...
#include "getvoiceconnectorloggingconfigurationrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorLoggingConfigurationRequest
 * \brief The GetVoiceConnectorLoggingConfigurationRequest class provides an interface for Chime GetVoiceConnectorLoggingConfiguration requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
GetVoiceConnectorLoggingConfigurationRequest::GetVoiceConnectorLoggingConfigurationRequest(const GetVoiceConnectorLoggingConfigurationRequest &other)
    : ChimeRequest(new GetVoiceConnectorLoggingConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetVoiceConnectorLoggingConfigurationRequest object.
 */
GetVoiceConnectorLoggingConfigurationRequest::GetVoiceConnectorLoggingConfigurationRequest()
    : ChimeRequest(new GetVoiceConnectorLoggingConfigurationRequestPrivate(ChimeRequest::GetVoiceConnectorLoggingConfigurationAction, this))
{
 ...
 * \reimp
 */
bool GetVoiceConnectorLoggingConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetVoiceConnectorLoggingConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetVoiceConnectorLoggingConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new GetVoiceConnectorLoggingConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorLoggingConfigurationRequestPrivate
 * \brief The GetVoiceConnectorLoggingConfigurationRequestPrivate class provides private implementation for GetVoiceConnectorLoggingConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorLoggingConfigurationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetVoiceConnectorLoggingConfigurationRequestPrivate::GetVoiceConnectorLoggingConfigurationRequestPrivate(
    const ChimeRequest::Action action, GetVoiceConnectorLoggingConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetVoiceConnectorLoggingConfigurationRequest
 * class' copy constructor.
 */
GetVoiceConnectorLoggingConfigurationRequestPrivate::GetVoiceConnectorLoggingConfigurationRequestPrivate(
    const GetVoiceConnectorLoggingConfigurationRequestPrivate &other, GetVoiceConnectorLoggingConfigurationRequest * const q)
