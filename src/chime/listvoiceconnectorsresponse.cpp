...
#include "listvoiceconnectorsresponse_p.h"
...
/*!
 * \class QtAws::Chime::ListVoiceConnectorsResponse
 * \brief The ListVoiceConnectorsResponse class provides an interace for Chime ListVoiceConnectors responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a ListVoiceConnectorsResponse object for \a reply to \a request, with parent \a parent.
 */
ListVoiceConnectorsResponse::ListVoiceConnectorsResponse(
        const ListVoiceConnectorsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new ListVoiceConnectorsResponsePrivate(this), parent)
{
    setRequest(new ListVoiceConnectorsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime ListVoiceConnectors \a response.
 */
void ListVoiceConnectorsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListVoiceConnectorsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::ListVoiceConnectorsResponsePrivate
 * \brief The ListVoiceConnectorsResponsePrivate class provides private implementation for ListVoiceConnectorsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListVoiceConnectorsResponsePrivate object with public implementation \a q.
 */
ListVoiceConnectorsResponsePrivate::ListVoiceConnectorsResponsePrivate(
    ListVoiceConnectorsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListVoiceConnectors response element from \a xml.
 */
void ListVoiceConnectorsResponsePrivate::parseListVoiceConnectorsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListVoiceConnectorsResponse"));
    Q_UNUSED(xml) ///< @todo
}
