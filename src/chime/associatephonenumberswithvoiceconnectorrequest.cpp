...
#include "associatephonenumberswithvoiceconnectorrequest_p.h"
...
/*!
 * \class QtAws::Chime::AssociatePhoneNumbersWithVoiceConnectorRequest
 * \brief The AssociatePhoneNumbersWithVoiceConnectorRequest class provides an interface for Chime AssociatePhoneNumbersWithVoiceConnector requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
AssociatePhoneNumbersWithVoiceConnectorRequest::AssociatePhoneNumbersWithVoiceConnectorRequest(const AssociatePhoneNumbersWithVoiceConnectorRequest &other)
    : ChimeRequest(new AssociatePhoneNumbersWithVoiceConnectorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a AssociatePhoneNumbersWithVoiceConnectorRequest object.
 */
AssociatePhoneNumbersWithVoiceConnectorRequest::AssociatePhoneNumbersWithVoiceConnectorRequest()
    : ChimeRequest(new AssociatePhoneNumbersWithVoiceConnectorRequestPrivate(ChimeRequest::AssociatePhoneNumbersWithVoiceConnectorAction, this))
{
 ...
 * \reimp
 */
bool AssociatePhoneNumbersWithVoiceConnectorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a AssociatePhoneNumbersWithVoiceConnectorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * AssociatePhoneNumbersWithVoiceConnectorRequest::response(QNetworkReply * const reply) const
{
    return new AssociatePhoneNumbersWithVoiceConnectorResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::AssociatePhoneNumbersWithVoiceConnectorRequestPrivate
 * \brief The AssociatePhoneNumbersWithVoiceConnectorRequestPrivate class provides private implementation for AssociatePhoneNumbersWithVoiceConnectorRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a AssociatePhoneNumbersWithVoiceConnectorRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
AssociatePhoneNumbersWithVoiceConnectorRequestPrivate::AssociatePhoneNumbersWithVoiceConnectorRequestPrivate(
    const ChimeRequest::Action action, AssociatePhoneNumbersWithVoiceConnectorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the AssociatePhoneNumbersWithVoiceConnectorRequest
 * class' copy constructor.
 */
AssociatePhoneNumbersWithVoiceConnectorRequestPrivate::AssociatePhoneNumbersWithVoiceConnectorRequestPrivate(
    const AssociatePhoneNumbersWithVoiceConnectorRequestPrivate &other, AssociatePhoneNumbersWithVoiceConnectorRequest * const q)
