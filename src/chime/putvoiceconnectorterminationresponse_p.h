...
class QTAWS_EXPORT PutVoiceConnectorTerminationResponsePrivate : public ChimeResponsePrivate {

public:

    PutVoiceConnectorTerminationResponsePrivate(PutVoiceConnectorTerminationResponse * const q);
