...
/*!
 * \class QtAws::Chime::ListAttendeesResponse
 * \brief The ListAttendeesResponse class provides an interace for Chime ListAttendees responses.
 *
 * \inmodule QtAwsChime
 *
...
ListAttendeesResponse::ListAttendeesResponse(
    ...
    : ChimeResponse(new ListAttendeesResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListAttendeesRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime ListAttendees \a response.
 */
...
/*!
 * \class QtAws::Chime::ListAttendeesResponsePrivate
...
ListAttendeesResponsePrivate::ListAttendeesResponsePrivate(
    ListAttendeesResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListAttendees response element from \a xml.
 */
