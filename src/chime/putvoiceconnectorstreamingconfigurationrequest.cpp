...
#include "putvoiceconnectorstreamingconfigurationrequest_p.h"
...
/*!
 * \class QtAws::Chime::PutVoiceConnectorStreamingConfigurationRequest
 * \brief The PutVoiceConnectorStreamingConfigurationRequest class provides an interface for Chime PutVoiceConnectorStreamingConfiguration requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::putVoiceConnectorStreamingConfiguration
 */

/*!
 * Constructs a copy of \a other.
 */
PutVoiceConnectorStreamingConfigurationRequest::PutVoiceConnectorStreamingConfigurationRequest(const PutVoiceConnectorStreamingConfigurationRequest &other)
    : ChimeRequest(new PutVoiceConnectorStreamingConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutVoiceConnectorStreamingConfigurationRequest object.
 */
PutVoiceConnectorStreamingConfigurationRequest::PutVoiceConnectorStreamingConfigurationRequest()
    : ChimeRequest(new PutVoiceConnectorStreamingConfigurationRequestPrivate(ChimeRequest::PutVoiceConnectorStreamingConfigurationAction, this))
{
 ...
 * \reimp
 */
bool PutVoiceConnectorStreamingConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutVoiceConnectorStreamingConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutVoiceConnectorStreamingConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new PutVoiceConnectorStreamingConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::PutVoiceConnectorStreamingConfigurationRequestPrivate
 * \brief The PutVoiceConnectorStreamingConfigurationRequestPrivate class provides private implementation for PutVoiceConnectorStreamingConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutVoiceConnectorStreamingConfigurationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
PutVoiceConnectorStreamingConfigurationRequestPrivate::PutVoiceConnectorStreamingConfigurationRequestPrivate(
    const ChimeRequest::Action action, PutVoiceConnectorStreamingConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutVoiceConnectorStreamingConfigurationRequest
 * class' copy constructor.
 */
PutVoiceConnectorStreamingConfigurationRequestPrivate::PutVoiceConnectorStreamingConfigurationRequestPrivate(
    const PutVoiceConnectorStreamingConfigurationRequestPrivate &other, PutVoiceConnectorStreamingConfigurationRequest * const q)
