...
#include "batchdeletephonenumberresponse_p.h"
...
/*!
 * \class QtAws::Chime::BatchDeletePhoneNumberResponse
 * \brief The BatchDeletePhoneNumberResponse class provides an interace for Chime BatchDeletePhoneNumber responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a BatchDeletePhoneNumberResponse object for \a reply to \a request, with parent \a parent.
 */
BatchDeletePhoneNumberResponse::BatchDeletePhoneNumberResponse(
        const BatchDeletePhoneNumberRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new BatchDeletePhoneNumberResponsePrivate(this), parent)
{
    setRequest(new BatchDeletePhoneNumberRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime BatchDeletePhoneNumber \a response.
 */
void BatchDeletePhoneNumberResponse::parseSuccess(QIODevice &response)
{
    //Q_D(BatchDeletePhoneNumberResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::BatchDeletePhoneNumberResponsePrivate
 * \brief The BatchDeletePhoneNumberResponsePrivate class provides private implementation for BatchDeletePhoneNumberResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a BatchDeletePhoneNumberResponsePrivate object with public implementation \a q.
 */
BatchDeletePhoneNumberResponsePrivate::BatchDeletePhoneNumberResponsePrivate(
    BatchDeletePhoneNumberResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime BatchDeletePhoneNumber response element from \a xml.
 */
void BatchDeletePhoneNumberResponsePrivate::parseBatchDeletePhoneNumberResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("BatchDeletePhoneNumberResponse"));
    Q_UNUSED(xml) ///< @todo
}
