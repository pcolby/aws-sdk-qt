...
class QTAWS_EXPORT DeleteAppInstanceAdminResponsePrivate : public ChimeResponsePrivate {

public:

    DeleteAppInstanceAdminResponsePrivate(DeleteAppInstanceAdminResponse * const q);
