...
#include "createsipruleresponse_p.h"
...
/*!
 * \class QtAws::Chime::CreateSipRuleResponse
 * \brief The CreateSipRuleResponse class provides an interace for Chime CreateSipRule responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a CreateSipRuleResponse object for \a reply to \a request, with parent \a parent.
 */
CreateSipRuleResponse::CreateSipRuleResponse(
        const CreateSipRuleRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new CreateSipRuleResponsePrivate(this), parent)
{
    setRequest(new CreateSipRuleRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime CreateSipRule \a response.
 */
void CreateSipRuleResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateSipRuleResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::CreateSipRuleResponsePrivate
 * \brief The CreateSipRuleResponsePrivate class provides private implementation for CreateSipRuleResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a CreateSipRuleResponsePrivate object with public implementation \a q.
 */
CreateSipRuleResponsePrivate::CreateSipRuleResponsePrivate(
    CreateSipRuleResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateSipRule response element from \a xml.
 */
void CreateSipRuleResponsePrivate::parseCreateSipRuleResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateSipRuleResponse"));
    Q_UNUSED(xml) ///< @todo
}
