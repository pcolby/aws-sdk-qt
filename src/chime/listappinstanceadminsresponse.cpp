...
/*!
 * \class QtAws::Chime::ListAppInstanceAdminsResponse
 * \brief The ListAppInstanceAdminsResponse class provides an interace for Chime ListAppInstanceAdmins responses.
 *
 * \inmodule QtAwsChime
 *
...
ListAppInstanceAdminsResponse::ListAppInstanceAdminsResponse(
    ...
    : ChimeResponse(new ListAppInstanceAdminsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime ListAppInstanceAdmins \a response.
 */
...
/*!
 * \class QtAws::Chime::ListAppInstanceAdminsResponsePrivate
...
ListAppInstanceAdminsResponsePrivate::ListAppInstanceAdminsResponsePrivate(
    ListAppInstanceAdminsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListAppInstanceAdmins response element from \a xml.
 */
