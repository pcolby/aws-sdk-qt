...
/*!
 * \class QtAws::Chime::DescribeAppInstanceAdminRequest
 * \brief The DescribeAppInstanceAdminRequest class provides an interface for Chime DescribeAppInstanceAdmin requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::describeAppInstanceAdmin
 */
...
DescribeAppInstanceAdminRequest::DescribeAppInstanceAdminRequest(const DescribeAppInstanceAdminRequest &other)
    : ChimeRequest(new DescribeAppInstanceAdminRequestPrivate(*other.d_func(), this))
{
...
DescribeAppInstanceAdminRequest::DescribeAppInstanceAdminRequest()
    : ChimeRequest(new DescribeAppInstanceAdminRequestPrivate(ChimeRequest::DescribeAppInstanceAdminAction, this))
{
...
/*!
 * \class QtAws::Chime::DescribeAppInstanceAdminRequestPrivate
...
/*!
 * Constructs a DescribeAppInstanceAdminRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DescribeAppInstanceAdminRequestPrivate::DescribeAppInstanceAdminRequestPrivate(
    const ChimeRequest::Action action, DescribeAppInstanceAdminRequest * const q)
