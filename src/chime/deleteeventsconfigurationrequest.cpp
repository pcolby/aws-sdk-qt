...
#include "deleteeventsconfigurationrequest_p.h"
...
/*!
 * \class QtAws::Chime::DeleteEventsConfigurationRequest
 * \brief The DeleteEventsConfigurationRequest class provides an interface for Chime DeleteEventsConfiguration requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
DeleteEventsConfigurationRequest::DeleteEventsConfigurationRequest(const DeleteEventsConfigurationRequest &other)
    : ChimeRequest(new DeleteEventsConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteEventsConfigurationRequest object.
 */
DeleteEventsConfigurationRequest::DeleteEventsConfigurationRequest()
    : ChimeRequest(new DeleteEventsConfigurationRequestPrivate(ChimeRequest::DeleteEventsConfigurationAction, this))
{
 ...
 * \reimp
 */
bool DeleteEventsConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteEventsConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteEventsConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new DeleteEventsConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::DeleteEventsConfigurationRequestPrivate
 * \brief The DeleteEventsConfigurationRequestPrivate class provides private implementation for DeleteEventsConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteEventsConfigurationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
DeleteEventsConfigurationRequestPrivate::DeleteEventsConfigurationRequestPrivate(
    const ChimeRequest::Action action, DeleteEventsConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteEventsConfigurationRequest
 * class' copy constructor.
 */
DeleteEventsConfigurationRequestPrivate::DeleteEventsConfigurationRequestPrivate(
    const DeleteEventsConfigurationRequestPrivate &other, DeleteEventsConfigurationRequest * const q)
