...
/*!
 * \class QtAws::Chime::UpdateChannelRequest
 * \brief The UpdateChannelRequest class provides an interface for Chime UpdateChannel requests.
 *
 * \inmodule QtAwsChime
 *
...
UpdateChannelRequest::UpdateChannelRequest(const UpdateChannelRequest &other)
    : ChimeRequest(new UpdateChannelRequestPrivate(*other.d_func(), this))
{
...
UpdateChannelRequest::UpdateChannelRequest()
    : ChimeRequest(new UpdateChannelRequestPrivate(ChimeRequest::UpdateChannelAction, this))
{
...
/*!
 * \class QtAws::Chime::UpdateChannelRequestPrivate
...
/*!
 * Constructs a UpdateChannelRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateChannelRequestPrivate::UpdateChannelRequestPrivate(
    const ChimeRequest::Action action, UpdateChannelRequest * const q)
