...
#include "getappinstancestreamingconfigurationsrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetAppInstanceStreamingConfigurationsRequest
 * \brief The GetAppInstanceStreamingConfigurationsRequest class provides an interface for Chime GetAppInstanceStreamingConfigurations requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::getAppInstanceStreamingConfigurations
 */

/*!
 * Constructs a copy of \a other.
 */
GetAppInstanceStreamingConfigurationsRequest::GetAppInstanceStreamingConfigurationsRequest(const GetAppInstanceStreamingConfigurationsRequest &other)
    : ChimeRequest(new GetAppInstanceStreamingConfigurationsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetAppInstanceStreamingConfigurationsRequest object.
 */
GetAppInstanceStreamingConfigurationsRequest::GetAppInstanceStreamingConfigurationsRequest()
    : ChimeRequest(new GetAppInstanceStreamingConfigurationsRequestPrivate(ChimeRequest::GetAppInstanceStreamingConfigurationsAction, this))
{
 ...
 * \reimp
 */
bool GetAppInstanceStreamingConfigurationsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetAppInstanceStreamingConfigurationsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetAppInstanceStreamingConfigurationsRequest::response(QNetworkReply * const reply) const
{
    return new GetAppInstanceStreamingConfigurationsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetAppInstanceStreamingConfigurationsRequestPrivate
 * \brief The GetAppInstanceStreamingConfigurationsRequestPrivate class provides private implementation for GetAppInstanceStreamingConfigurationsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetAppInstanceStreamingConfigurationsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetAppInstanceStreamingConfigurationsRequestPrivate::GetAppInstanceStreamingConfigurationsRequestPrivate(
    const ChimeRequest::Action action, GetAppInstanceStreamingConfigurationsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetAppInstanceStreamingConfigurationsRequest
 * class' copy constructor.
 */
GetAppInstanceStreamingConfigurationsRequestPrivate::GetAppInstanceStreamingConfigurationsRequestPrivate(
    const GetAppInstanceStreamingConfigurationsRequestPrivate &other, GetAppInstanceStreamingConfigurationsRequest * const q)
