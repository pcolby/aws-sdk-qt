...
#include "putvoiceconnectororiginationrequest_p.h"
...
/*!
 * \class QtAws::Chime::PutVoiceConnectorOriginationRequest
 * \brief The PutVoiceConnectorOriginationRequest class provides an interface for Chime PutVoiceConnectorOrigination requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
PutVoiceConnectorOriginationRequest::PutVoiceConnectorOriginationRequest(const PutVoiceConnectorOriginationRequest &other)
    : ChimeRequest(new PutVoiceConnectorOriginationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutVoiceConnectorOriginationRequest object.
 */
PutVoiceConnectorOriginationRequest::PutVoiceConnectorOriginationRequest()
    : ChimeRequest(new PutVoiceConnectorOriginationRequestPrivate(ChimeRequest::PutVoiceConnectorOriginationAction, this))
{
 ...
 * \reimp
 */
bool PutVoiceConnectorOriginationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutVoiceConnectorOriginationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutVoiceConnectorOriginationRequest::response(QNetworkReply * const reply) const
{
    return new PutVoiceConnectorOriginationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::PutVoiceConnectorOriginationRequestPrivate
 * \brief The PutVoiceConnectorOriginationRequestPrivate class provides private implementation for PutVoiceConnectorOriginationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a PutVoiceConnectorOriginationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
PutVoiceConnectorOriginationRequestPrivate::PutVoiceConnectorOriginationRequestPrivate(
    const ChimeRequest::Action action, PutVoiceConnectorOriginationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutVoiceConnectorOriginationRequest
 * class' copy constructor.
 */
PutVoiceConnectorOriginationRequestPrivate::PutVoiceConnectorOriginationRequestPrivate(
    const PutVoiceConnectorOriginationRequestPrivate &other, PutVoiceConnectorOriginationRequest * const q)
