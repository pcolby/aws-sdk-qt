...
#include "updatevoiceconnectorrequest_p.h"
...
/*!
 * \class QtAws::Chime::UpdateVoiceConnectorRequest
 * \brief The UpdateVoiceConnectorRequest class provides an interface for Chime UpdateVoiceConnector requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
UpdateVoiceConnectorRequest::UpdateVoiceConnectorRequest(const UpdateVoiceConnectorRequest &other)
    : ChimeRequest(new UpdateVoiceConnectorRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateVoiceConnectorRequest object.
 */
UpdateVoiceConnectorRequest::UpdateVoiceConnectorRequest()
    : ChimeRequest(new UpdateVoiceConnectorRequestPrivate(ChimeRequest::UpdateVoiceConnectorAction, this))
{
 ...
 * \reimp
 */
bool UpdateVoiceConnectorRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateVoiceConnectorResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateVoiceConnectorRequest::response(QNetworkReply * const reply) const
{
    return new UpdateVoiceConnectorResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::UpdateVoiceConnectorRequestPrivate
 * \brief The UpdateVoiceConnectorRequestPrivate class provides private implementation for UpdateVoiceConnectorRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UpdateVoiceConnectorRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateVoiceConnectorRequestPrivate::UpdateVoiceConnectorRequestPrivate(
    const ChimeRequest::Action action, UpdateVoiceConnectorRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateVoiceConnectorRequest
 * class' copy constructor.
 */
UpdateVoiceConnectorRequestPrivate::UpdateVoiceConnectorRequestPrivate(
    const UpdateVoiceConnectorRequestPrivate &other, UpdateVoiceConnectorRequest * const q)
