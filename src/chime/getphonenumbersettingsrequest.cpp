...
#include "getphonenumbersettingsrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetPhoneNumberSettingsRequest
 * \brief The GetPhoneNumberSettingsRequest class provides an interface for Chime GetPhoneNumberSettings requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
GetPhoneNumberSettingsRequest::GetPhoneNumberSettingsRequest(const GetPhoneNumberSettingsRequest &other)
    : ChimeRequest(new GetPhoneNumberSettingsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetPhoneNumberSettingsRequest object.
 */
GetPhoneNumberSettingsRequest::GetPhoneNumberSettingsRequest()
    : ChimeRequest(new GetPhoneNumberSettingsRequestPrivate(ChimeRequest::GetPhoneNumberSettingsAction, this))
{
 ...
 * \reimp
 */
bool GetPhoneNumberSettingsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetPhoneNumberSettingsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetPhoneNumberSettingsRequest::response(QNetworkReply * const reply) const
{
    return new GetPhoneNumberSettingsResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetPhoneNumberSettingsRequestPrivate
 * \brief The GetPhoneNumberSettingsRequestPrivate class provides private implementation for GetPhoneNumberSettingsRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetPhoneNumberSettingsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetPhoneNumberSettingsRequestPrivate::GetPhoneNumberSettingsRequestPrivate(
    const ChimeRequest::Action action, GetPhoneNumberSettingsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetPhoneNumberSettingsRequest
 * class' copy constructor.
 */
GetPhoneNumberSettingsRequestPrivate::GetPhoneNumberSettingsRequestPrivate(
    const GetPhoneNumberSettingsRequestPrivate &other, GetPhoneNumberSettingsRequest * const q)
