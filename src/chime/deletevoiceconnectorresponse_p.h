...
class QTAWS_EXPORT DeleteVoiceConnectorResponsePrivate : public ChimeResponsePrivate {

public:

    DeleteVoiceConnectorResponsePrivate(DeleteVoiceConnectorResponse * const q);
