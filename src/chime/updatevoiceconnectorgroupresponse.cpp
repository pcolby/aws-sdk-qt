...
#include "updatevoiceconnectorgroupresponse_p.h"
...
/*!
 * \class QtAws::Chime::UpdateVoiceConnectorGroupResponse
 * \brief The UpdateVoiceConnectorGroupResponse class provides an interace for Chime UpdateVoiceConnectorGroup responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a UpdateVoiceConnectorGroupResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateVoiceConnectorGroupResponse::UpdateVoiceConnectorGroupResponse(
        const UpdateVoiceConnectorGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new UpdateVoiceConnectorGroupResponsePrivate(this), parent)
{
    setRequest(new UpdateVoiceConnectorGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime UpdateVoiceConnectorGroup \a response.
 */
void UpdateVoiceConnectorGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateVoiceConnectorGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::UpdateVoiceConnectorGroupResponsePrivate
 * \brief The UpdateVoiceConnectorGroupResponsePrivate class provides private implementation for UpdateVoiceConnectorGroupResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UpdateVoiceConnectorGroupResponsePrivate object with public implementation \a q.
 */
UpdateVoiceConnectorGroupResponsePrivate::UpdateVoiceConnectorGroupResponsePrivate(
    UpdateVoiceConnectorGroupResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UpdateVoiceConnectorGroup response element from \a xml.
 */
void UpdateVoiceConnectorGroupResponsePrivate::parseUpdateVoiceConnectorGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateVoiceConnectorGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
