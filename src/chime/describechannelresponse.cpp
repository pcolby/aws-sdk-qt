...
/*!
 * \class QtAws::Chime::DescribeChannelResponse
 * \brief The DescribeChannelResponse class provides an interace for Chime DescribeChannel responses.
 *
 * \inmodule QtAwsChime
 *
...
DescribeChannelResponse::DescribeChannelResponse(
    ...
    : ChimeResponse(new DescribeChannelResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DescribeChannel \a response.
 */
...
/*!
 * \class QtAws::Chime::DescribeChannelResponsePrivate
...
DescribeChannelResponsePrivate::DescribeChannelResponsePrivate(
    DescribeChannelResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DescribeChannel response element from \a xml.
 */
