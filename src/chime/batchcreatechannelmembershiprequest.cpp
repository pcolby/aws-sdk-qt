...
/*!
 * \class QtAws::Chime::BatchCreateChannelMembershipRequest
 * \brief The BatchCreateChannelMembershipRequest class provides an interface for Chime BatchCreateChannelMembership requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::batchCreateChannelMembership
 */
...
BatchCreateChannelMembershipRequest::BatchCreateChannelMembershipRequest(const BatchCreateChannelMembershipRequest &other)
    : ChimeRequest(new BatchCreateChannelMembershipRequestPrivate(*other.d_func(), this))
{
...
BatchCreateChannelMembershipRequest::BatchCreateChannelMembershipRequest()
    : ChimeRequest(new BatchCreateChannelMembershipRequestPrivate(ChimeRequest::BatchCreateChannelMembershipAction, this))
{
...
/*!
 * \class QtAws::Chime::BatchCreateChannelMembershipRequestPrivate
...
/*!
 * Constructs a BatchCreateChannelMembershipRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
BatchCreateChannelMembershipRequestPrivate::BatchCreateChannelMembershipRequestPrivate(
    const ChimeRequest::Action action, BatchCreateChannelMembershipRequest * const q)
