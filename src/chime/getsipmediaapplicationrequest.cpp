...
#include "getsipmediaapplicationrequest_p.h"
...
/*!
 * \class QtAws::Chime::GetSipMediaApplicationRequest
 * \brief The GetSipMediaApplicationRequest class provides an interface for Chime GetSipMediaApplication requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 */
GetSipMediaApplicationRequest::GetSipMediaApplicationRequest(const GetSipMediaApplicationRequest &other)
    : ChimeRequest(new GetSipMediaApplicationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetSipMediaApplicationRequest object.
 */
GetSipMediaApplicationRequest::GetSipMediaApplicationRequest()
    : ChimeRequest(new GetSipMediaApplicationRequestPrivate(ChimeRequest::GetSipMediaApplicationAction, this))
{
 ...
 * \reimp
 */
bool GetSipMediaApplicationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetSipMediaApplicationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetSipMediaApplicationRequest::response(QNetworkReply * const reply) const
{
    return new GetSipMediaApplicationResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::GetSipMediaApplicationRequestPrivate
 * \brief The GetSipMediaApplicationRequestPrivate class provides private implementation for GetSipMediaApplicationRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetSipMediaApplicationRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
GetSipMediaApplicationRequestPrivate::GetSipMediaApplicationRequestPrivate(
    const ChimeRequest::Action action, GetSipMediaApplicationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetSipMediaApplicationRequest
 * class' copy constructor.
 */
GetSipMediaApplicationRequestPrivate::GetSipMediaApplicationRequestPrivate(
    const GetSipMediaApplicationRequestPrivate &other, GetSipMediaApplicationRequest * const q)
