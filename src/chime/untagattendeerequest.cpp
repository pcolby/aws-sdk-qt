...
#include "untagattendeerequest_p.h"
...
/*!
 * \class QtAws::Chime::UntagAttendeeRequest
 * \brief The UntagAttendeeRequest class provides an interface for Chime UntagAttendee requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::untagAttendee
 */

/*!
 * Constructs a copy of \a other.
 */
UntagAttendeeRequest::UntagAttendeeRequest(const UntagAttendeeRequest &other)
    : ChimeRequest(new UntagAttendeeRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UntagAttendeeRequest object.
 */
UntagAttendeeRequest::UntagAttendeeRequest()
    : ChimeRequest(new UntagAttendeeRequestPrivate(ChimeRequest::UntagAttendeeAction, this))
{
 ...
 * \reimp
 */
bool UntagAttendeeRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UntagAttendeeResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UntagAttendeeRequest::response(QNetworkReply * const reply) const
{
    return new UntagAttendeeResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::UntagAttendeeRequestPrivate
 * \brief The UntagAttendeeRequestPrivate class provides private implementation for UntagAttendeeRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UntagAttendeeRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UntagAttendeeRequestPrivate::UntagAttendeeRequestPrivate(
    const ChimeRequest::Action action, UntagAttendeeRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UntagAttendeeRequest
 * class' copy constructor.
 */
UntagAttendeeRequestPrivate::UntagAttendeeRequestPrivate(
    const UntagAttendeeRequestPrivate &other, UntagAttendeeRequest * const q)
