...
/*!
 * \class QtAws::Chime::DeleteChannelBanResponse
 * \brief The DeleteChannelBanResponse class provides an interace for Chime DeleteChannelBan responses.
 *
 * \inmodule QtAwsChime
 *
...
DeleteChannelBanResponse::DeleteChannelBanResponse(
    ...
    : ChimeResponse(new DeleteChannelBanResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime DeleteChannelBan \a response.
 */
...
/*!
 * \class QtAws::Chime::DeleteChannelBanResponsePrivate
...
DeleteChannelBanResponsePrivate::DeleteChannelBanResponsePrivate(
    DeleteChannelBanResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteChannelBan response element from \a xml.
 */
