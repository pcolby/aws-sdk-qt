...
#include "batchcreateroommembershiprequest_p.h"
...
/*!
 * \class QtAws::Chime::BatchCreateRoomMembershipRequest
 * \brief The BatchCreateRoomMembershipRequest class provides an interface for Chime BatchCreateRoomMembership requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::batchCreateRoomMembership
 */

/*!
 * Constructs a copy of \a other.
 */
BatchCreateRoomMembershipRequest::BatchCreateRoomMembershipRequest(const BatchCreateRoomMembershipRequest &other)
    : ChimeRequest(new BatchCreateRoomMembershipRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a BatchCreateRoomMembershipRequest object.
 */
BatchCreateRoomMembershipRequest::BatchCreateRoomMembershipRequest()
    : ChimeRequest(new BatchCreateRoomMembershipRequestPrivate(ChimeRequest::BatchCreateRoomMembershipAction, this))
{
 ...
 * \reimp
 */
bool BatchCreateRoomMembershipRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BatchCreateRoomMembershipResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BatchCreateRoomMembershipRequest::response(QNetworkReply * const reply) const
{
    return new BatchCreateRoomMembershipResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::BatchCreateRoomMembershipRequestPrivate
 * \brief The BatchCreateRoomMembershipRequestPrivate class provides private implementation for BatchCreateRoomMembershipRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a BatchCreateRoomMembershipRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
BatchCreateRoomMembershipRequestPrivate::BatchCreateRoomMembershipRequestPrivate(
    const ChimeRequest::Action action, BatchCreateRoomMembershipRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the BatchCreateRoomMembershipRequest
 * class' copy constructor.
 */
BatchCreateRoomMembershipRequestPrivate::BatchCreateRoomMembershipRequestPrivate(
    const BatchCreateRoomMembershipRequestPrivate &other, BatchCreateRoomMembershipRequest * const q)
