...
#include "deletevoiceconnectorgroupresponse_p.h"
...
/*!
 * \class QtAws::Chime::DeleteVoiceConnectorGroupResponse
 * \brief The DeleteVoiceConnectorGroupResponse class provides an interace for Chime DeleteVoiceConnectorGroup responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a DeleteVoiceConnectorGroupResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteVoiceConnectorGroupResponse::DeleteVoiceConnectorGroupResponse(
        const DeleteVoiceConnectorGroupRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new DeleteVoiceConnectorGroupResponsePrivate(this), parent)
{
    setRequest(new DeleteVoiceConnectorGroupRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime DeleteVoiceConnectorGroup \a response.
 */
void DeleteVoiceConnectorGroupResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteVoiceConnectorGroupResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::DeleteVoiceConnectorGroupResponsePrivate
 * \brief The DeleteVoiceConnectorGroupResponsePrivate class provides private implementation for DeleteVoiceConnectorGroupResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a DeleteVoiceConnectorGroupResponsePrivate object with public implementation \a q.
 */
DeleteVoiceConnectorGroupResponsePrivate::DeleteVoiceConnectorGroupResponsePrivate(
    DeleteVoiceConnectorGroupResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime DeleteVoiceConnectorGroup response element from \a xml.
 */
void DeleteVoiceConnectorGroupResponsePrivate::parseDeleteVoiceConnectorGroupResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteVoiceConnectorGroupResponse"));
    Q_UNUSED(xml) ///< @todo
}
