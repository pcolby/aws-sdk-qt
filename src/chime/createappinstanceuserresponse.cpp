...
/*!
 * \class QtAws::Chime::CreateAppInstanceUserResponse
 * \brief The CreateAppInstanceUserResponse class provides an interace for Chime CreateAppInstanceUser responses.
 *
 * \inmodule QtAwsChime
 *
...
CreateAppInstanceUserResponse::CreateAppInstanceUserResponse(
    ...
    : ChimeResponse(new CreateAppInstanceUserResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime CreateAppInstanceUser \a response.
 */
...
/*!
 * \class QtAws::Chime::CreateAppInstanceUserResponsePrivate
...
CreateAppInstanceUserResponsePrivate::CreateAppInstanceUserResponsePrivate(
    CreateAppInstanceUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime CreateAppInstanceUser response element from \a xml.
 */
