...
#include "updateproxysessionrequest_p.h"
...
/*!
 * \class QtAws::Chime::UpdateProxySessionRequest
 * \brief The UpdateProxySessionRequest class provides an interface for Chime UpdateProxySession requests.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::updateProxySession
 */

/*!
 * Constructs a copy of \a other.
 */
UpdateProxySessionRequest::UpdateProxySessionRequest(const UpdateProxySessionRequest &other)
    : ChimeRequest(new UpdateProxySessionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a UpdateProxySessionRequest object.
 */
UpdateProxySessionRequest::UpdateProxySessionRequest()
    : ChimeRequest(new UpdateProxySessionRequestPrivate(ChimeRequest::UpdateProxySessionAction, this))
{
 ...
 * \reimp
 */
bool UpdateProxySessionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a UpdateProxySessionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * UpdateProxySessionRequest::response(QNetworkReply * const reply) const
{
    return new UpdateProxySessionResponse(*this, reply);
}

/*!
 * \class QtAws::Chime::UpdateProxySessionRequestPrivate
 * \brief The UpdateProxySessionRequestPrivate class provides private implementation for UpdateProxySessionRequest.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UpdateProxySessionRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
UpdateProxySessionRequestPrivate::UpdateProxySessionRequestPrivate(
    const ChimeRequest::Action action, UpdateProxySessionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the UpdateProxySessionRequest
 * class' copy constructor.
 */
UpdateProxySessionRequestPrivate::UpdateProxySessionRequestPrivate(
    const UpdateProxySessionRequestPrivate &other, UpdateProxySessionRequest * const q)
