...
#include "getvoiceconnectoremergencycallingconfigurationresponse_p.h"
...
/*!
 * \class QtAws::Chime::GetVoiceConnectorEmergencyCallingConfigurationResponse
 * \brief The GetVoiceConnectorEmergencyCallingConfigurationResponse class provides an interace for Chime GetVoiceConnectorEmergencyCallingConfiguration responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a GetVoiceConnectorEmergencyCallingConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
GetVoiceConnectorEmergencyCallingConfigurationResponse::GetVoiceConnectorEmergencyCallingConfigurationResponse(
        const GetVoiceConnectorEmergencyCallingConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new GetVoiceConnectorEmergencyCallingConfigurationResponsePrivate(this), parent)
{
    setRequest(new GetVoiceConnectorEmergencyCallingConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime GetVoiceConnectorEmergencyCallingConfiguration \a response.
 */
void GetVoiceConnectorEmergencyCallingConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetVoiceConnectorEmergencyCallingConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::GetVoiceConnectorEmergencyCallingConfigurationResponsePrivate
 * \brief The GetVoiceConnectorEmergencyCallingConfigurationResponsePrivate class provides private implementation for GetVoiceConnectorEmergencyCallingConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a GetVoiceConnectorEmergencyCallingConfigurationResponsePrivate object with public implementation \a q.
 */
GetVoiceConnectorEmergencyCallingConfigurationResponsePrivate::GetVoiceConnectorEmergencyCallingConfigurationResponsePrivate(
    GetVoiceConnectorEmergencyCallingConfigurationResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime GetVoiceConnectorEmergencyCallingConfiguration response element from \a xml.
 */
void GetVoiceConnectorEmergencyCallingConfigurationResponsePrivate::parseGetVoiceConnectorEmergencyCallingConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetVoiceConnectorEmergencyCallingConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
