...
/*!
 * \class QtAws::Chime::SearchAvailablePhoneNumbersResponse
 * \brief The SearchAvailablePhoneNumbersResponse class provides an interace for Chime SearchAvailablePhoneNumbers responses.
 *
 * \inmodule QtAwsChime
 *
...
SearchAvailablePhoneNumbersResponse::SearchAvailablePhoneNumbersResponse(
    ...
    : ChimeResponse(new SearchAvailablePhoneNumbersResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime SearchAvailablePhoneNumbers \a response.
 */
...
/*!
 * \class QtAws::Chime::SearchAvailablePhoneNumbersResponsePrivate
...
SearchAvailablePhoneNumbersResponsePrivate::SearchAvailablePhoneNumbersResponsePrivate(
    SearchAvailablePhoneNumbersResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime SearchAvailablePhoneNumbers response element from \a xml.
 */
