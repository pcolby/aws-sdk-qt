...
#include "untagattendeeresponse_p.h"
...
/*!
 * \class QtAws::Chime::UntagAttendeeResponse
 * \brief The UntagAttendeeResponse class provides an interace for Chime UntagAttendee responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a UntagAttendeeResponse object for \a reply to \a request, with parent \a parent.
 */
UntagAttendeeResponse::UntagAttendeeResponse(
        const UntagAttendeeRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new UntagAttendeeResponsePrivate(this), parent)
{
    setRequest(new UntagAttendeeRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime UntagAttendee \a response.
 */
void UntagAttendeeResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UntagAttendeeResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::UntagAttendeeResponsePrivate
 * \brief The UntagAttendeeResponsePrivate class provides private implementation for UntagAttendeeResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a UntagAttendeeResponsePrivate object with public implementation \a q.
 */
UntagAttendeeResponsePrivate::UntagAttendeeResponsePrivate(
    UntagAttendeeResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime UntagAttendee response element from \a xml.
 */
void UntagAttendeeResponsePrivate::parseUntagAttendeeResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UntagAttendeeResponse"));
    Q_UNUSED(xml) ///< @todo
}
