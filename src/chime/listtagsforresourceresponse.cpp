...
/*!
 * \class QtAws::Chime::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Chime ListTagsForResource responses.
 *
 * \inmodule QtAwsChime
 *
 ...
 *
 * \sa ChimeClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : ChimeResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(ChimeResponse::request());
}

/*!
 * \reimp
 * Parses a successful Chime ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Chime::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListTagsForResource response element from \a xml.
 */
