...
/*!
 * \class QtAws::Chime::ListChannelMembershipsForAppInstanceUserResponse
 * \brief The ListChannelMembershipsForAppInstanceUserResponse class provides an interace for Chime ListChannelMembershipsForAppInstanceUser responses.
 *
 * \inmodule QtAwsChime
 *
...
ListChannelMembershipsForAppInstanceUserResponse::ListChannelMembershipsForAppInstanceUserResponse(
    ...
    : ChimeResponse(new ListChannelMembershipsForAppInstanceUserResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Chime ListChannelMembershipsForAppInstanceUser \a response.
 */
...
/*!
 * \class QtAws::Chime::ListChannelMembershipsForAppInstanceUserResponsePrivate
...
ListChannelMembershipsForAppInstanceUserResponsePrivate::ListChannelMembershipsForAppInstanceUserResponsePrivate(
    ListChannelMembershipsForAppInstanceUserResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListChannelMembershipsForAppInstanceUser response element from \a xml.
 */
