...
/*!
 * \class QtAws::Chime::ListChannelsRequest
 * \brief The ListChannelsRequest class provides an interface for Chime ListChannels requests.
 *
 * \inmodule QtAwsChime
 *
...
ListChannelsRequest::ListChannelsRequest(const ListChannelsRequest &other)
    : ChimeRequest(new ListChannelsRequestPrivate(*other.d_func(), this))
{
...
ListChannelsRequest::ListChannelsRequest()
    : ChimeRequest(new ListChannelsRequestPrivate(ChimeRequest::ListChannelsAction, this))
{
...
/*!
 * \class QtAws::Chime::ListChannelsRequestPrivate
...
/*!
 * Constructs a ListChannelsRequestPrivate object for Chime \a action,
 * with public implementation \a q.
 */
ListChannelsRequestPrivate::ListChannelsRequestPrivate(
    const ChimeRequest::Action action, ListChannelsRequest * const q)
