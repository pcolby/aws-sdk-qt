...
#include "listsipmediaapplicationsresponse_p.h"
...
/*!
 * \class QtAws::Chime::ListSipMediaApplicationsResponse
 * \brief The ListSipMediaApplicationsResponse class provides an interace for Chime ListSipMediaApplications responses.
 *
 * \inmodule QtAwsChime
 *
...
/*!
 * Constructs a ListSipMediaApplicationsResponse object for \a reply to \a request, with parent \a parent.
 */
ListSipMediaApplicationsResponse::ListSipMediaApplicationsResponse(
        const ListSipMediaApplicationsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : ChimeResponse(new ListSipMediaApplicationsResponsePrivate(this), parent)
{
    setRequest(new ListSipMediaApplicationsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Chime ListSipMediaApplications \a response.
 */
void ListSipMediaApplicationsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListSipMediaApplicationsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Chime::ListSipMediaApplicationsResponsePrivate
 * \brief The ListSipMediaApplicationsResponsePrivate class provides private implementation for ListSipMediaApplicationsResponse.
 * \internal
 *
 * \inmodule QtAwsChime
 */
...
/*!
 * Constructs a ListSipMediaApplicationsResponsePrivate object with public implementation \a q.
 */
ListSipMediaApplicationsResponsePrivate::ListSipMediaApplicationsResponsePrivate(
    ListSipMediaApplicationsResponse * const q) : ChimeResponsePrivate(q)
{

}

/*!
 * Parses a Chime ListSipMediaApplications response element from \a xml.
 */
void ListSipMediaApplicationsResponsePrivate::parseListSipMediaApplicationsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListSipMediaApplicationsResponse"));
    Q_UNUSED(xml) ///< @todo
}
