...
/*!
 * \class QtAws::Outposts::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Outposts TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : OutpostsResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Outposts TagResource \a response.
 */
...
/*!
 * \class QtAws::Outposts::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : OutpostsResponsePrivate(q)
{

}

/*!
 * Parses a Outposts TagResource response element from \a xml.
 */
