...
/*!
 * \class QtAws::Outposts::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Outposts ListTagsForResource responses.
 *
 ...
 *
 * \sa OutpostsClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : OutpostsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(OutpostsResponse::request());
}

/*!
 * \reimp
 * Parses a successful Outposts ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Outposts::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : OutpostsResponsePrivate(q)
{

}

/*!
 * Parses a Outposts ListTagsForResource response element from \a xml.
 */
