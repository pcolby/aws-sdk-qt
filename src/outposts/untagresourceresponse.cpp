...
/*!
 * \class QtAws::Outposts::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Outposts UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : OutpostsResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(OutpostsResponse::request());
}

/*!
 * \reimp
 * Parses a successful Outposts UntagResource \a response.
 */
...
/*!
 * \class QtAws::Outposts::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : OutpostsResponsePrivate(q)
{

}

/*!
 * Parses a Outposts UntagResource response element from \a xml.
 */
