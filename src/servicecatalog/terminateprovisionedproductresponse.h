...
class QTAWS_EXPORT TerminateProvisionedProductResponse : public ServiceCatalogResponse {
    Q_OBJECT
...
public:
    ...
    virtual const TerminateProvisionedProductRequest * request() const override;
