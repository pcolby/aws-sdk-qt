...
public slots:
    ...
    DescribePortfolioSharesResponse * describePortfolioShares(const DescribePortfolioSharesRequest &request);
    ...
    GetProvisionedProductOutputsResponse * getProvisionedProductOutputs(const GetProvisionedProductOutputsRequest &request);
    ImportAsProvisionedProductResponse * importAsProvisionedProduct(const ImportAsProvisionedProductRequest &request);
    ...
    UpdatePortfolioShareResponse * updatePortfolioShare(const UpdatePortfolioShareRequest &request);
