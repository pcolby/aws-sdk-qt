...
class QTAWS_EXPORT DescribeProvisionedProductRequestPrivate : public ServiceCatalogRequestPrivate {

public:
    DescribeProvisionedProductRequestPrivate(const ServiceCatalog::Action action,
