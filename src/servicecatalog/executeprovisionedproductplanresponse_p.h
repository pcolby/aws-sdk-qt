...
class QTAWS_EXPORT ExecuteProvisionedProductPlanResponsePrivate : public ServiceCatalogResponsePrivate {

public:

    ExecuteProvisionedProductPlanResponsePrivate(ExecuteProvisionedProductPlanResponse * const q);
