...
class QTAWS_EXPORT UpdateProvisionedProductResponsePrivate : public ServiceCatalogResponsePrivate {

public:

    UpdateProvisionedProductResponsePrivate(UpdateProvisionedProductResponse * const q);
