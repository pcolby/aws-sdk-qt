...
class QTAWS_EXPORT DescribeProvisioningParametersResponse : public DescribeProvisioningParametersResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeProvisioningParametersRequest * request() const;
