...
class QTAWS_EXPORT ListConstraintsForPortfolioResponse : public ListConstraintsForPortfolioResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListConstraintsForPortfolioRequest * request() const;
