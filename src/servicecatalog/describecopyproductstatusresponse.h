...
class QTAWS_EXPORT DescribeCopyProductStatusResponse : public ServiceCatalogResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeCopyProductStatusRequest * request() const override;
