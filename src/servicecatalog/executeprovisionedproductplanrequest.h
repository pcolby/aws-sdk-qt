...
#ifndef QTAWS_EXECUTEPROVISIONEDPRODUCTPLANREQUEST_H
#define QTAWS_EXECUTEPROVISIONEDPRODUCTPLANREQUEST_H
...
private:
    Q_DECLARE_PRIVATE(ExecuteProvisionedProductPlanRequest)
