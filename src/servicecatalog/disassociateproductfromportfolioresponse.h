...
class QTAWS_EXPORT DisassociateProductFromPortfolioResponse : public ServiceCatalogResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DisassociateProductFromPortfolioRequest * request() const override;
