...
class QTAWS_EXPORT ListProvisionedProductPlansResponse : public ListProvisionedProductPlansResponse {
    Q_OBJECT
...
public:
    ...
    virtual const ListProvisionedProductPlansRequest * request() const;
