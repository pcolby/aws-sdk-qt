...
class QTAWS_EXPORT ListOrganizationPortfolioAccessResponsePrivate : public ServiceCatalogResponsePrivate {

public:

    ListOrganizationPortfolioAccessResponsePrivate(ListOrganizationPortfolioAccessResponse * const q);
