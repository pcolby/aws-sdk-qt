...
class QTAWS_EXPORT DescribePortfolioResponsePrivate : public ServiceCatalogResponsePrivate {

public:

    DescribePortfolioResponsePrivate(DescribePortfolioResponse * const q);
