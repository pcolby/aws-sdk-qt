...
class QTAWS_EXPORT DescribeProvisionedProductPlanResponse : public DescribeProvisionedProductPlanResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeProvisionedProductPlanRequest * request() const;
