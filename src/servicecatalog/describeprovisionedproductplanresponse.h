...
class QTAWS_EXPORT DescribeProvisionedProductPlanResponse : public ServiceCatalogResponse {
    Q_OBJECT
...
public:
    ...
    virtual const DescribeProvisionedProductPlanRequest * request() const override;
