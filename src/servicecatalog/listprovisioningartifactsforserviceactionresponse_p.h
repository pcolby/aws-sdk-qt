...
class QTAWS_EXPORT ListProvisioningArtifactsForServiceActionResponsePrivate : public ServiceCatalogResponsePrivate {

public:

    ListProvisioningArtifactsForServiceActionResponsePrivate(ListProvisioningArtifactsForServiceActionResponse * const q);
