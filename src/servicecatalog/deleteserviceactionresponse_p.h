...
class QTAWS_EXPORT DeleteServiceActionResponsePrivate : public ServiceCatalogResponsePrivate {

public:

    DeleteServiceActionResponsePrivate(DeleteServiceActionResponse * const q);
