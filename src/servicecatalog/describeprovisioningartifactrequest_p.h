...
class QTAWS_EXPORT DescribeProvisioningArtifactRequestPrivate : public ServiceCatalogRequestPrivate {

public:
    DescribeProvisioningArtifactRequestPrivate(const ServiceCatalog::Action action,
