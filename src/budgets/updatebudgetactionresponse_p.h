...
class QTAWS_EXPORT UpdateBudgetActionResponsePrivate : public BudgetsResponsePrivate {

public:

    UpdateBudgetActionResponsePrivate(UpdateBudgetActionResponse * const q);
