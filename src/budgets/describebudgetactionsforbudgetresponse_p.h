...
class QTAWS_EXPORT DescribeBudgetActionsForBudgetResponsePrivate : public BudgetsResponsePrivate {

public:

    DescribeBudgetActionsForBudgetResponsePrivate(DescribeBudgetActionsForBudgetResponse * const q);
