...
#include "executebudgetactionrequest_p.h"
...
/*!
 * \class QtAws::Budgets::ExecuteBudgetActionRequest
 * \brief The ExecuteBudgetActionRequest class provides an interface for Budgets ExecuteBudgetAction requests.
 *
 ...
 */
ExecuteBudgetActionRequest::ExecuteBudgetActionRequest(const ExecuteBudgetActionRequest &other)
    : BudgetsRequest(new ExecuteBudgetActionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ExecuteBudgetActionRequest object.
 */
ExecuteBudgetActionRequest::ExecuteBudgetActionRequest()
    : BudgetsRequest(new ExecuteBudgetActionRequestPrivate(BudgetsRequest::ExecuteBudgetActionAction, this))
{
 ...
 * \reimp
 */
bool ExecuteBudgetActionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ExecuteBudgetActionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ExecuteBudgetActionRequest::response(QNetworkReply * const reply) const
{
    return new ExecuteBudgetActionResponse(*this, reply);
}

/*!
 * \class QtAws::Budgets::ExecuteBudgetActionRequestPrivate
 * \brief The ExecuteBudgetActionRequestPrivate class provides private implementation for ExecuteBudgetActionRequest.
 * \internal
 *
 * \inmodule QtAwsBudgets
 */
...
/*!
 * Constructs a ExecuteBudgetActionRequestPrivate object for Budgets \a action,
 * with public implementation \a q.
 */
ExecuteBudgetActionRequestPrivate::ExecuteBudgetActionRequestPrivate(
    const BudgetsRequest::Action action, ExecuteBudgetActionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ExecuteBudgetActionRequest
 * class' copy constructor.
 */
ExecuteBudgetActionRequestPrivate::ExecuteBudgetActionRequestPrivate(
    const ExecuteBudgetActionRequestPrivate &other, ExecuteBudgetActionRequest * const q)
