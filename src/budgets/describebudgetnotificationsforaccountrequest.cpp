...
#include "describebudgetnotificationsforaccountrequest_p.h"
...
/*!
 * \class QtAws::Budgets::DescribeBudgetNotificationsForAccountRequest
 * \brief The DescribeBudgetNotificationsForAccountRequest class provides an interface for Budgets DescribeBudgetNotificationsForAccount requests.
 *
 ...
 */
DescribeBudgetNotificationsForAccountRequest::DescribeBudgetNotificationsForAccountRequest(const DescribeBudgetNotificationsForAccountRequest &other)
    : BudgetsRequest(new DescribeBudgetNotificationsForAccountRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DescribeBudgetNotificationsForAccountRequest object.
 */
DescribeBudgetNotificationsForAccountRequest::DescribeBudgetNotificationsForAccountRequest()
    : BudgetsRequest(new DescribeBudgetNotificationsForAccountRequestPrivate(BudgetsRequest::DescribeBudgetNotificationsForAccountAction, this))
{
 ...
 * \reimp
 */
bool DescribeBudgetNotificationsForAccountRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DescribeBudgetNotificationsForAccountResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DescribeBudgetNotificationsForAccountRequest::response(QNetworkReply * const reply) const
{
    return new DescribeBudgetNotificationsForAccountResponse(*this, reply);
}

/*!
 * \class QtAws::Budgets::DescribeBudgetNotificationsForAccountRequestPrivate
 * \brief The DescribeBudgetNotificationsForAccountRequestPrivate class provides private implementation for DescribeBudgetNotificationsForAccountRequest.
 * \internal
 *
 * \inmodule QtAwsBudgets
 */
...
/*!
 * Constructs a DescribeBudgetNotificationsForAccountRequestPrivate object for Budgets \a action,
 * with public implementation \a q.
 */
DescribeBudgetNotificationsForAccountRequestPrivate::DescribeBudgetNotificationsForAccountRequestPrivate(
    const BudgetsRequest::Action action, DescribeBudgetNotificationsForAccountRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DescribeBudgetNotificationsForAccountRequest
 * class' copy constructor.
 */
DescribeBudgetNotificationsForAccountRequestPrivate::DescribeBudgetNotificationsForAccountRequestPrivate(
    const DescribeBudgetNotificationsForAccountRequestPrivate &other, DescribeBudgetNotificationsForAccountRequest * const q)
