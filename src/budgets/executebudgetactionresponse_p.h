...
class QTAWS_EXPORT ExecuteBudgetActionResponsePrivate : public BudgetsResponsePrivate {

public:

    ExecuteBudgetActionResponsePrivate(ExecuteBudgetActionResponse * const q);
