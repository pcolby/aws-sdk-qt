...
class QTAWS_EXPORT DescribeBudgetActionsForAccountResponsePrivate : public BudgetsResponsePrivate {

public:

    DescribeBudgetActionsForAccountResponsePrivate(DescribeBudgetActionsForAccountResponse * const q);
