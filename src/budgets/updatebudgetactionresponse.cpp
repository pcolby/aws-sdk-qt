...
#include "updatebudgetactionresponse_p.h"
...
/*!
 * \class QtAws::Budgets::UpdateBudgetActionResponse
 * \brief The UpdateBudgetActionResponse class provides an interace for Budgets UpdateBudgetAction responses.
 *
...
/*!
 * Constructs a UpdateBudgetActionResponse object for \a reply to \a request, with parent \a parent.
 */
UpdateBudgetActionResponse::UpdateBudgetActionResponse(
        const UpdateBudgetActionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : BudgetsResponse(new UpdateBudgetActionResponsePrivate(this), parent)
{
    setRequest(new UpdateBudgetActionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const UpdateBudgetActionRequest * UpdateBudgetActionResponse::request() const
{
    Q_D(const UpdateBudgetActionResponse);
    return static_cast<const UpdateBudgetActionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Budgets UpdateBudgetAction \a response.
 */
void UpdateBudgetActionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(UpdateBudgetActionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Budgets::UpdateBudgetActionResponsePrivate
 * \brief The UpdateBudgetActionResponsePrivate class provides private implementation for UpdateBudgetActionResponse.
 * \internal
 *
 * \inmodule QtAwsBudgets
 */
...
/*!
 * Constructs a UpdateBudgetActionResponsePrivate object with public implementation \a q.
 */
UpdateBudgetActionResponsePrivate::UpdateBudgetActionResponsePrivate(
    UpdateBudgetActionResponse * const q) : BudgetsResponsePrivate(q)
{

}

/*!
 * Parses a Budgets UpdateBudgetAction response element from \a xml.
 */
void UpdateBudgetActionResponsePrivate::parseUpdateBudgetActionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("UpdateBudgetActionResponse"));
    Q_UNUSED(xml) ///< @todo
}
