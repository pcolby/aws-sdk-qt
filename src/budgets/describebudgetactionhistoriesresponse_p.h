...
class QTAWS_EXPORT DescribeBudgetActionHistoriesResponsePrivate : public BudgetsResponsePrivate {

public:

    DescribeBudgetActionHistoriesResponsePrivate(DescribeBudgetActionHistoriesResponse * const q);
