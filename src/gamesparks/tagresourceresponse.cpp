...
/*!
 * \class QtAws::GameSparks::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for GameSparks TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : GameSparksResponse(new TagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GameSparks TagResource \a response.
 */
...
/*!
 * \class QtAws::GameSparks::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : GameSparksResponsePrivate(q)
{

}

/*!
 * Parses a GameSparks TagResource response element from \a xml.
 */
