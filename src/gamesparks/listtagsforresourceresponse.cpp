...
/*!
 * \class QtAws::GameSparks::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for GameSparks ListTagsForResource responses.
 *
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : GameSparksResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GameSparks ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::GameSparks::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : GameSparksResponsePrivate(q)
{

}

/*!
 * Parses a GameSparks ListTagsForResource response element from \a xml.
 */
