...
/*!
 * \class QtAws::GameSparks::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for GameSparks UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : GameSparksResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful GameSparks UntagResource \a response.
 */
...
/*!
 * \class QtAws::GameSparks::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : GameSparksResponsePrivate(q)
{

}

/*!
 * Parses a GameSparks UntagResource response element from \a xml.
 */
