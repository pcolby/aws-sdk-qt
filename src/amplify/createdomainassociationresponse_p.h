...
class QTAWS_EXPORT CreateDomainAssociationResponsePrivate : public AmplifyResponsePrivate {

public:

    CreateDomainAssociationResponsePrivate(CreateDomainAssociationResponse * const q);
