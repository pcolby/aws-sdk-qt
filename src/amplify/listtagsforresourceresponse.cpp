...
/*!
 * \class QtAws::Amplify::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for Amplify ListTagsForResource responses.
 *
 ...
 *
 * \sa AmplifyClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : AmplifyResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(AmplifyResponse::request());
}

/*!
 * \reimp
 * Parses a successful Amplify ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::Amplify::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : AmplifyResponsePrivate(q)
{

}

/*!
 * Parses a Amplify ListTagsForResource response element from \a xml.
 */
