...
/*!
 * \class QtAws::Amplify::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for Amplify UntagResource responses.
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : AmplifyResponse(new UntagResourceResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Amplify UntagResource \a response.
 */
...
/*!
 * \class QtAws::Amplify::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : AmplifyResponsePrivate(q)
{

}

/*!
 * Parses a Amplify UntagResource response element from \a xml.
 */
