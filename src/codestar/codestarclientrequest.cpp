...
/**
 * @brief  Constructs a new CodeStarClientRequest object.
 *
...
/**
 * @brief  Constructs a new CodeStarClientRequest object by copying another.
 *
 ...
 */
CodeStarClientRequest& CodeStarClientRequest::operator=(const CodeStarClientRequest &other)
{
    Q_D(CodeStarClientRequest);
 ...
 * implementation that inherits from CodeStarClientRequestPrivate.
 *
 ...
 */
CodeStarClientRequest::Action CodeStarClientRequest::action() const
{
    Q_D(const CodeStarClientRequest);
    return d->action;
}
 ...
 */
QString CodeStarClientRequest::actionString() const
{
    return CodeStarClientRequestPrivate::toString(action());
}
 ...
 */
QString CodeStarClientRequest::apiVersion() const
{
    Q_D(const CodeStarClientRequest);
    return d->apiVersion;
}
 ...
 */
void CodeStarClientRequest::setAction(const Action action)
{
    Q_D(CodeStarClientRequest);
    d->action = action;
}
 ...
 */
void CodeStarClientRequest::setApiVersion(const QString &version)
{
    Q_D(CodeStarClientRequest);
 ...
 */
bool CodeStarClientRequest::operator==(const CodeStarClientRequest &other) const
{
 ...
 */
bool CodeStarClientRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int CodeStarClientRequest::clearParameter(const QString &name)
{
    Q_D(CodeStarClientRequest);
 ...
 */
void CodeStarClientRequest::clearParameters()
{
    Q_D(CodeStarClientRequest);
    d->parameters.clear();
}
 ...
 */
QVariant CodeStarClientRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const CodeStarClientRequest);
 ...
 */
const QVariantMap &CodeStarClientRequest::parameters() const
{
    Q_D(const CodeStarClientRequest);
    return d->parameters;
}
 ...
 */
void CodeStarClientRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(CodeStarClientRequest);
 ...
 */
void CodeStarClientRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(CodeStarClientRequest);
 ...
 */
QNetworkRequest CodeStarClientRequest::unsignedRequest(const QUrl &endpoint) const
{
    Q_D(const CodeStarClientRequest);
    QUrl url(endpoint);
 ...
 *
 * @brief  Private implementation for CodeStarClientRequest.
 */

/**
 * @internal
 *
 * @brief  Constructs a new CodeStarClientRequestPrivate object.
 *
 ...
 * @internal
 *
 * @brief  Constructs a new CodeStarClientRequestPrivate object from an existing one.
 *
 * This copy-like constructor copies everything from \a other, except for the
 * the object's pointer to its public instance - for that, \a q is used instead.
 *
 * This is required to support the CodeStarClientRequest class's copy constructor.
 *
 * @param  other  Instance to copy.
 * @param  q      Pointer to this object's public CodeStarClientRequest instance.
 */
 ...
 *
 * This function converts CodeStarClientRequest::Action enumerator values to their respective
 ...
 */
QString CodeStarClientRequestPrivate::toString(const CodeStarClientRequest::Action &action)
{
    #define ActionToString(action) \
        case CodeStarClientRequest::action##Action: return QStringLiteral(#action)
    switch (action) {
        ActionToString(/*todo*/);
        default:
