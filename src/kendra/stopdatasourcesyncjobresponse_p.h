...
class QTAWS_EXPORT StopDataSourceSyncJobResponsePrivate : public kendraResponsePrivate {

public:

    StopDataSourceSyncJobResponsePrivate(StopDataSourceSyncJobResponse * const q);
