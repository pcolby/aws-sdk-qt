...
#ifndef QTAWS_STARTDATASOURCESYNCJOBRESPONSE_P_H
#define QTAWS_STARTDATASOURCESYNCJOBRESPONSE_P_H
...
private:
    Q_DECLARE_PUBLIC(StartDataSourceSyncJobResponse)
    Q_DISABLE_COPY(StartDataSourceSyncJobResponsePrivate)
