...
/*!
 * Sets the DlmRequest object to be equal to \a other.
 */
DlmRequest& DlmRequest::operator=(const DlmRequest &other)
{
    Q_D(DlmRequest);
...
/*!
 * Constructs aa DlmRequest object with private implementation \a d.
 *
...
{
    return DlmRequestPrivate::toString(action());
}
 ...
 */
bool DlmRequest::operator==(const DlmRequest &other) const
{
 ...
 */
/*bool DlmRequest::isValidQueueName(const QString &queueName)
{
 ...
 */
int DlmRequest::clearParameter(const QString &name)
{
    Q_D(DlmRequest);
 ...
 */
void DlmRequest::clearParameters()
{
    Q_D(DlmRequest);
    d->parameters.clear();
}
 ...
 */
QVariant DlmRequest::parameter(const QString &name, const QVariant &defaultValue) const
{
    Q_D(const DlmRequest);
 ...
 */
const QVariantMap &DlmRequest::parameters() const
{
    Q_D(const DlmRequest);
    return d->parameters;
}
 ...
 */
void DlmRequest::setParameter(const QString &name, const QVariant &value)
{
    Q_D(DlmRequest);
 ...
 */
void DlmRequest::setParameters(const QVariantMap &parameters)
{
    Q_D(DlmRequest);
 ...
 */
QNetworkRequest DlmRequest::unsignedRequest(const QUrl &endpoint) const
{
    //Q_D(const DlmRequest);
    QUrl url(endpoint);
 ...
 *
 * This is required to support the DlmRequest class's copy constructor.
 */
