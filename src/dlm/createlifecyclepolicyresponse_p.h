...
class QTAWS_EXPORT CreateLifecyclePolicyResponsePrivate : public DlmResponsePrivate {

public:

    CreateLifecyclePolicyResponsePrivate(CreateLifecyclePolicyResponse * const q);
