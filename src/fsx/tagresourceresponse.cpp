...
/*!
 * \class QtAws::FSx::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for FSx TagResource responses.
 *
 * \inmodule QtAwsFSx
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : FSxResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(FSxResponse::request());
}

/*!
 * \reimp
 * Parses a successful FSx TagResource \a response.
 */
...
/*!
 * \class QtAws::FSx::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : FSxResponsePrivate(q)
{

}

/*!
 * Parses a FSx TagResource response element from \a xml.
 */
