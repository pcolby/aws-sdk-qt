...
/*!
 * \class QtAws::FSx::UntagResourceResponse
 * \brief The UntagResourceResponse class provides an interace for FSx UntagResource responses.
 *
 * \inmodule QtAwsFSx
 *
...
UntagResourceResponse::UntagResourceResponse(
    ...
    : FSxResponse(new UntagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const UntagResourceRequest *>(FSxResponse::request());
}

/*!
 * \reimp
 * Parses a successful FSx UntagResource \a response.
 */
...
/*!
 * \class QtAws::FSx::UntagResourceResponsePrivate
...
UntagResourceResponsePrivate::UntagResourceResponsePrivate(
    UntagResourceResponse * const q) : FSxResponsePrivate(q)
{

}

/*!
 * Parses a FSx UntagResource response element from \a xml.
 */
