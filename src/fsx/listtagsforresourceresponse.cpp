...
/*!
 * \class QtAws::FSx::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for FSx ListTagsForResource responses.
 *
 * \inmodule QtAwsFSx
 *
 ...
 *  shared file
 *
 * \sa FSxClient::listTagsForResource
 */
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : FSxResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(FSxResponse::request());
}

/*!
 * \reimp
 * Parses a successful FSx ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::FSx::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : FSxResponsePrivate(q)
{

}

/*!
 * Parses a FSx ListTagsForResource response element from \a xml.
 */
