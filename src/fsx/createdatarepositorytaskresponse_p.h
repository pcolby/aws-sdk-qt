...
class QTAWS_EXPORT CreateDataRepositoryTaskResponsePrivate : public FSxResponsePrivate {

public:

    CreateDataRepositoryTaskResponsePrivate(CreateDataRepositoryTaskResponse * const q);
