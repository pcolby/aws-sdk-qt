...
class QTAWS_EXPORT CreateClassificationJobResponsePrivate : public Macie2ResponsePrivate {

public:

    CreateClassificationJobResponsePrivate(CreateClassificationJobResponse * const q);
