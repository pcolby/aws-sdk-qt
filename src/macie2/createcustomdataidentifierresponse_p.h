...
class QTAWS_EXPORT CreateCustomDataIdentifierResponsePrivate : public Macie2ResponsePrivate {

public:

    CreateCustomDataIdentifierResponsePrivate(CreateCustomDataIdentifierResponse * const q);
