...
class QTAWS_EXPORT TestCustomDataIdentifierResponsePrivate : public Macie2ResponsePrivate {

public:

    TestCustomDataIdentifierResponsePrivate(TestCustomDataIdentifierResponse * const q);
