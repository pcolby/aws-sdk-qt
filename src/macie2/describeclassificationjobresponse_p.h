...
class QTAWS_EXPORT DescribeClassificationJobResponsePrivate : public Macie2ResponsePrivate {

public:

    DescribeClassificationJobResponsePrivate(DescribeClassificationJobResponse * const q);
