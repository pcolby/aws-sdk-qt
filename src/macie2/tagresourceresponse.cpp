...
/*!
 * \class QtAws::Macie2::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for Macie2 TagResource responses.
 *
...
TagResourceResponse::TagResourceResponse(
    ...
    : Macie2Response(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(Macie2Response::request());
}

/*!
 * \reimp
 * Parses a successful Macie2 TagResource \a response.
 */
...
/*!
 * \class QtAws::Macie2::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : Macie2ResponsePrivate(q)
{

}

/*!
 * Parses a Macie2 TagResource response element from \a xml.
 */
