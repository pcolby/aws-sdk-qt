...
#include "getrecordingconfigurationrequest_p.h"
...
/*!
 * \class QtAws::Ivs::GetRecordingConfigurationRequest
 * \brief The GetRecordingConfigurationRequest class provides an interface for Ivs GetRecordingConfiguration requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 */
GetRecordingConfigurationRequest::GetRecordingConfigurationRequest(const GetRecordingConfigurationRequest &other)
    : IvsRequest(new GetRecordingConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetRecordingConfigurationRequest object.
 */
GetRecordingConfigurationRequest::GetRecordingConfigurationRequest()
    : IvsRequest(new GetRecordingConfigurationRequestPrivate(IvsRequest::GetRecordingConfigurationAction, this))
{
 ...
 * \reimp
 */
bool GetRecordingConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetRecordingConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetRecordingConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new GetRecordingConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::Ivs::GetRecordingConfigurationRequestPrivate
 * \brief The GetRecordingConfigurationRequestPrivate class provides private implementation for GetRecordingConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a GetRecordingConfigurationRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
GetRecordingConfigurationRequestPrivate::GetRecordingConfigurationRequestPrivate(
    const IvsRequest::Action action, GetRecordingConfigurationRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetRecordingConfigurationRequest
 * class' copy constructor.
 */
GetRecordingConfigurationRequestPrivate::GetRecordingConfigurationRequestPrivate(
    const GetRecordingConfigurationRequestPrivate &other, GetRecordingConfigurationRequest * const q)
