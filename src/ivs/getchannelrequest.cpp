...
/*!
 * \class QtAws::IVS::GetChannelRequest
 * \brief The GetChannelRequest class provides an interface for IVS GetChannel requests.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::getChannel
 */

/*!
 * Constructs a copy of \a other.
 */
GetChannelRequest::GetChannelRequest(const GetChannelRequest &other)
    : IvsRequest(new GetChannelRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetChannelRequest object.
 */
GetChannelRequest::GetChannelRequest()
    : IvsRequest(new GetChannelRequestPrivate(IvsRequest::GetChannelAction, this))
{
 ...
 * \reimp
 */
bool GetChannelRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetChannelResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetChannelRequest::response(QNetworkReply * const reply) const
{
    return new GetChannelResponse(*this, reply);
}

/*!
 * \class QtAws::IVS::GetChannelRequestPrivate
 * \brief The GetChannelRequestPrivate class provides private implementation for GetChannelRequest.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a GetChannelRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
GetChannelRequestPrivate::GetChannelRequestPrivate(
    const IvsRequest::Action action, GetChannelRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetChannelRequest
 * class' copy constructor.
 */
GetChannelRequestPrivate::GetChannelRequestPrivate(
    const GetChannelRequestPrivate &other, GetChannelRequest * const q)
