...
#include "putmetadatarequest_p.h"
...
/*!
 * \class QtAws::Ivs::PutMetadataRequest
 * \brief The PutMetadataRequest class provides an interface for Ivs PutMetadata requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 */
PutMetadataRequest::PutMetadataRequest(const PutMetadataRequest &other)
    : IvsRequest(new PutMetadataRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a PutMetadataRequest object.
 */
PutMetadataRequest::PutMetadataRequest()
    : IvsRequest(new PutMetadataRequestPrivate(IvsRequest::PutMetadataAction, this))
{
 ...
 * \reimp
 */
bool PutMetadataRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a PutMetadataResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * PutMetadataRequest::response(QNetworkReply * const reply) const
{
    return new PutMetadataResponse(*this, reply);
}

/*!
 * \class QtAws::Ivs::PutMetadataRequestPrivate
 * \brief The PutMetadataRequestPrivate class provides private implementation for PutMetadataRequest.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a PutMetadataRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
PutMetadataRequestPrivate::PutMetadataRequestPrivate(
    const IvsRequest::Action action, PutMetadataRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the PutMetadataRequest
 * class' copy constructor.
 */
PutMetadataRequestPrivate::PutMetadataRequestPrivate(
    const PutMetadataRequestPrivate &other, PutMetadataRequest * const q)
