...
#include "liststreamsessionsresponse_p.h"
...
/*!
 * \class QtAws::Ivs::ListStreamSessionsResponse
 * \brief The ListStreamSessionsResponse class provides an interace for Ivs ListStreamSessions responses.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::listStreamSessions
 */

/*!
 * Constructs a ListStreamSessionsResponse object for \a reply to \a request, with parent \a parent.
 */
ListStreamSessionsResponse::ListStreamSessionsResponse(
        const ListStreamSessionsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new ListStreamSessionsResponsePrivate(this), parent)
{
    setRequest(new ListStreamSessionsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListStreamSessionsRequest * ListStreamSessionsResponse::request() const
{
    Q_D(const ListStreamSessionsResponse);
    return static_cast<const ListStreamSessionsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Ivs ListStreamSessions \a response.
 */
void ListStreamSessionsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListStreamSessionsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Ivs::ListStreamSessionsResponsePrivate
 * \brief The ListStreamSessionsResponsePrivate class provides private implementation for ListStreamSessionsResponse.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a ListStreamSessionsResponsePrivate object with public implementation \a q.
 */
ListStreamSessionsResponsePrivate::ListStreamSessionsResponsePrivate(
    ListStreamSessionsResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a Ivs ListStreamSessions response element from \a xml.
 */
void ListStreamSessionsResponsePrivate::parseListStreamSessionsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListStreamSessionsResponse"));
    Q_UNUSED(xml) ///< @todo
}
