...
#include "getstreamkeyresponse_p.h"
...
/*!
 * \class QtAws::IVS::GetStreamKeyResponse
 * \brief The GetStreamKeyResponse class provides an interace for IVS GetStreamKey responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::getStreamKey
 */

/*!
 * Constructs a GetStreamKeyResponse object for \a reply to \a request, with parent \a parent.
 */
GetStreamKeyResponse::GetStreamKeyResponse(
        const GetStreamKeyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new GetStreamKeyResponsePrivate(this), parent)
{
    setRequest(new GetStreamKeyRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetStreamKeyRequest * GetStreamKeyResponse::request() const
{
    Q_D(const GetStreamKeyResponse);
    return static_cast<const GetStreamKeyRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful IVS GetStreamKey \a response.
 */
void GetStreamKeyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetStreamKeyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::IVS::GetStreamKeyResponsePrivate
 * \brief The GetStreamKeyResponsePrivate class provides private implementation for GetStreamKeyResponse.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a GetStreamKeyResponsePrivate object with public implementation \a q.
 */
GetStreamKeyResponsePrivate::GetStreamKeyResponsePrivate(
    GetStreamKeyResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS GetStreamKey response element from \a xml.
 */
void GetStreamKeyResponsePrivate::parseGetStreamKeyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetStreamKeyResponse"));
    Q_UNUSED(xml) ///< @todo
}
