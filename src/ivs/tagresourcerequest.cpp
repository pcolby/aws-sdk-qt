...
/*!
 * \class QtAws::IVS::TagResourceRequest
 * \brief The TagResourceRequest class provides an interface for IVS TagResource requests.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
...
TagResourceRequest::TagResourceRequest(const TagResourceRequest &other)
    : IvsRequest(new TagResourceRequestPrivate(*other.d_func(), this))
{
...
TagResourceRequest::TagResourceRequest()
    : IvsRequest(new TagResourceRequestPrivate(IvsRequest::TagResourceAction, this))
{
...
/*!
 * \class QtAws::IVS::TagResourceRequestPrivate
...
/*!
 * Constructs a TagResourceRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
TagResourceRequestPrivate::TagResourceRequestPrivate(
    const IvsRequest::Action action, TagResourceRequest * const q)
