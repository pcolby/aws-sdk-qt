...
#include "batchgetstreamkeyrequest_p.h"
...
/*!
 * \class QtAws::IVS::BatchGetStreamKeyRequest
 * \brief The BatchGetStreamKeyRequest class provides an interface for IVS BatchGetStreamKey requests.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::batchGetStreamKey
 */

/*!
 * Constructs a copy of \a other.
 */
BatchGetStreamKeyRequest::BatchGetStreamKeyRequest(const BatchGetStreamKeyRequest &other)
    : IvsRequest(new BatchGetStreamKeyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a BatchGetStreamKeyRequest object.
 */
BatchGetStreamKeyRequest::BatchGetStreamKeyRequest()
    : IvsRequest(new BatchGetStreamKeyRequestPrivate(IvsRequest::BatchGetStreamKeyAction, this))
{
 ...
 * \reimp
 */
bool BatchGetStreamKeyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BatchGetStreamKeyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BatchGetStreamKeyRequest::response(QNetworkReply * const reply) const
{
    return new BatchGetStreamKeyResponse(*this, reply);
}

/*!
 * \class QtAws::IVS::BatchGetStreamKeyRequestPrivate
 * \brief The BatchGetStreamKeyRequestPrivate class provides private implementation for BatchGetStreamKeyRequest.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a BatchGetStreamKeyRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
BatchGetStreamKeyRequestPrivate::BatchGetStreamKeyRequestPrivate(
    const IvsRequest::Action action, BatchGetStreamKeyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the BatchGetStreamKeyRequest
 * class' copy constructor.
 */
BatchGetStreamKeyRequestPrivate::BatchGetStreamKeyRequestPrivate(
    const BatchGetStreamKeyRequestPrivate &other, BatchGetStreamKeyRequest * const q)
