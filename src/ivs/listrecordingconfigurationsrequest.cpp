...
#include "listrecordingconfigurationsrequest_p.h"
...
/*!
 * \class QtAws::IVS::ListRecordingConfigurationsRequest
 * \brief The ListRecordingConfigurationsRequest class provides an interface for IVS ListRecordingConfigurations requests.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::listRecordingConfigurations
 */

/*!
 * Constructs a copy of \a other.
 */
ListRecordingConfigurationsRequest::ListRecordingConfigurationsRequest(const ListRecordingConfigurationsRequest &other)
    : IvsRequest(new ListRecordingConfigurationsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListRecordingConfigurationsRequest object.
 */
ListRecordingConfigurationsRequest::ListRecordingConfigurationsRequest()
    : IvsRequest(new ListRecordingConfigurationsRequestPrivate(IvsRequest::ListRecordingConfigurationsAction, this))
{
 ...
 * \reimp
 */
bool ListRecordingConfigurationsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListRecordingConfigurationsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListRecordingConfigurationsRequest::response(QNetworkReply * const reply) const
{
    return new ListRecordingConfigurationsResponse(*this, reply);
}

/*!
 * \class QtAws::IVS::ListRecordingConfigurationsRequestPrivate
 * \brief The ListRecordingConfigurationsRequestPrivate class provides private implementation for ListRecordingConfigurationsRequest.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a ListRecordingConfigurationsRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
ListRecordingConfigurationsRequestPrivate::ListRecordingConfigurationsRequestPrivate(
    const IvsRequest::Action action, ListRecordingConfigurationsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListRecordingConfigurationsRequest
 * class' copy constructor.
 */
ListRecordingConfigurationsRequestPrivate::ListRecordingConfigurationsRequestPrivate(
    const ListRecordingConfigurationsRequestPrivate &other, ListRecordingConfigurationsRequest * const q)
