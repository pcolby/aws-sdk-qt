...
#include "createrecordingconfigurationresponse_p.h"
...
/*!
 * \class QtAws::IVS::CreateRecordingConfigurationResponse
 * \brief The CreateRecordingConfigurationResponse class provides an interace for IVS CreateRecordingConfiguration responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
...
/*!
 * Constructs a CreateRecordingConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
CreateRecordingConfigurationResponse::CreateRecordingConfigurationResponse(
        const CreateRecordingConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new CreateRecordingConfigurationResponsePrivate(this), parent)
{
    setRequest(new CreateRecordingConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful IVS CreateRecordingConfiguration \a response.
 */
void CreateRecordingConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateRecordingConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::IVS::CreateRecordingConfigurationResponsePrivate
 * \brief The CreateRecordingConfigurationResponsePrivate class provides private implementation for CreateRecordingConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a CreateRecordingConfigurationResponsePrivate object with public implementation \a q.
 */
CreateRecordingConfigurationResponsePrivate::CreateRecordingConfigurationResponsePrivate(
    CreateRecordingConfigurationResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS CreateRecordingConfiguration response element from \a xml.
 */
void CreateRecordingConfigurationResponsePrivate::parseCreateRecordingConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateRecordingConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
