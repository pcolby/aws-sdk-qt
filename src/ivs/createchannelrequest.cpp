...
/*!
 * \class QtAws::Ivs::CreateChannelRequest
 * \brief The CreateChannelRequest class provides an interface for Ivs CreateChannel requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
...
CreateChannelRequest::CreateChannelRequest(const CreateChannelRequest &other)
    : IvsRequest(new CreateChannelRequestPrivate(*other.d_func(), this))
{
...
CreateChannelRequest::CreateChannelRequest()
    : IvsRequest(new CreateChannelRequestPrivate(IvsRequest::CreateChannelAction, this))
{
...
/*!
 * \class QtAws::Ivs::CreateChannelRequestPrivate
...
/*!
 * Constructs a CreateChannelRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
CreateChannelRequestPrivate::CreateChannelRequestPrivate(
    const IvsRequest::Action action, CreateChannelRequest * const q)
