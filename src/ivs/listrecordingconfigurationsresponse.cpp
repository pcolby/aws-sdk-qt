...
#include "listrecordingconfigurationsresponse_p.h"
...
/*!
 * \class QtAws::Ivs::ListRecordingConfigurationsResponse
 * \brief The ListRecordingConfigurationsResponse class provides an interace for Ivs ListRecordingConfigurations responses.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
...
/*!
 * Constructs a ListRecordingConfigurationsResponse object for \a reply to \a request, with parent \a parent.
 */
ListRecordingConfigurationsResponse::ListRecordingConfigurationsResponse(
        const ListRecordingConfigurationsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new ListRecordingConfigurationsResponsePrivate(this), parent)
{
    setRequest(new ListRecordingConfigurationsRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Ivs ListRecordingConfigurations \a response.
 */
void ListRecordingConfigurationsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListRecordingConfigurationsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Ivs::ListRecordingConfigurationsResponsePrivate
 * \brief The ListRecordingConfigurationsResponsePrivate class provides private implementation for ListRecordingConfigurationsResponse.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a ListRecordingConfigurationsResponsePrivate object with public implementation \a q.
 */
ListRecordingConfigurationsResponsePrivate::ListRecordingConfigurationsResponsePrivate(
    ListRecordingConfigurationsResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a Ivs ListRecordingConfigurations response element from \a xml.
 */
void ListRecordingConfigurationsResponsePrivate::parseListRecordingConfigurationsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListRecordingConfigurationsResponse"));
    Q_UNUSED(xml) ///< @todo
}
