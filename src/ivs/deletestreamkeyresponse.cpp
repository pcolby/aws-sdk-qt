...
#include "deletestreamkeyresponse_p.h"
...
/*!
 * \class QtAws::IVS::DeleteStreamKeyResponse
 * \brief The DeleteStreamKeyResponse class provides an interace for IVS DeleteStreamKey responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
...
/*!
 * Constructs a DeleteStreamKeyResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteStreamKeyResponse::DeleteStreamKeyResponse(
        const DeleteStreamKeyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new DeleteStreamKeyResponsePrivate(this), parent)
{
    setRequest(new DeleteStreamKeyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful IVS DeleteStreamKey \a response.
 */
void DeleteStreamKeyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteStreamKeyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::IVS::DeleteStreamKeyResponsePrivate
 * \brief The DeleteStreamKeyResponsePrivate class provides private implementation for DeleteStreamKeyResponse.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a DeleteStreamKeyResponsePrivate object with public implementation \a q.
 */
DeleteStreamKeyResponsePrivate::DeleteStreamKeyResponsePrivate(
    DeleteStreamKeyResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS DeleteStreamKey response element from \a xml.
 */
void DeleteStreamKeyResponsePrivate::parseDeleteStreamKeyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteStreamKeyResponse"));
    Q_UNUSED(xml) ///< @todo
}
