...
class QTAWS_EXPORT GetRecordingConfigurationResponsePrivate : public IvsResponsePrivate {

public:

    GetRecordingConfigurationResponsePrivate(GetRecordingConfigurationResponse * const q);
