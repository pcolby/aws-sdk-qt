...
#include "batchgetstreamkeyresponse_p.h"
...
/*!
 * \class QtAws::Ivs::BatchGetStreamKeyResponse
 * \brief The BatchGetStreamKeyResponse class provides an interace for Ivs BatchGetStreamKey responses.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
...
/*!
 * Constructs a BatchGetStreamKeyResponse object for \a reply to \a request, with parent \a parent.
 */
BatchGetStreamKeyResponse::BatchGetStreamKeyResponse(
        const BatchGetStreamKeyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new BatchGetStreamKeyResponsePrivate(this), parent)
{
    setRequest(new BatchGetStreamKeyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Ivs BatchGetStreamKey \a response.
 */
void BatchGetStreamKeyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(BatchGetStreamKeyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Ivs::BatchGetStreamKeyResponsePrivate
 * \brief The BatchGetStreamKeyResponsePrivate class provides private implementation for BatchGetStreamKeyResponse.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a BatchGetStreamKeyResponsePrivate object with public implementation \a q.
 */
BatchGetStreamKeyResponsePrivate::BatchGetStreamKeyResponsePrivate(
    BatchGetStreamKeyResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a Ivs BatchGetStreamKey response element from \a xml.
 */
void BatchGetStreamKeyResponsePrivate::parseBatchGetStreamKeyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("BatchGetStreamKeyResponse"));
    Q_UNUSED(xml) ///< @todo
}
