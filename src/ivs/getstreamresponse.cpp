...
/*!
 * \class QtAws::Ivs::GetStreamResponse
 * \brief The GetStreamResponse class provides an interace for Ivs GetStream responses.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
...
/*!
 * Constructs a GetStreamResponse object for \a reply to \a request, with parent \a parent.
 */
GetStreamResponse::GetStreamResponse(
        const GetStreamRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new GetStreamResponsePrivate(this), parent)
{
    setRequest(new GetStreamRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetStreamRequest * GetStreamResponse::request() const
{
    Q_D(const GetStreamResponse);
    return static_cast<const GetStreamRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Ivs GetStream \a response.
 */
void GetStreamResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetStreamResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Ivs::GetStreamResponsePrivate
 * \brief The GetStreamResponsePrivate class provides private implementation for GetStreamResponse.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a GetStreamResponsePrivate object with public implementation \a q.
 */
GetStreamResponsePrivate::GetStreamResponsePrivate(
    GetStreamResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a Ivs GetStream response element from \a xml.
 */
void GetStreamResponsePrivate::parseGetStreamResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetStreamResponse"));
    Q_UNUSED(xml) ///< @todo
}
