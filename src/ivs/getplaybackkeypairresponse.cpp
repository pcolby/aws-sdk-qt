...
#include "getplaybackkeypairresponse_p.h"
...
/*!
 * \class QtAws::Ivs::GetPlaybackKeyPairResponse
 * \brief The GetPlaybackKeyPairResponse class provides an interace for Ivs GetPlaybackKeyPair responses.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
...
/*!
 * Constructs a GetPlaybackKeyPairResponse object for \a reply to \a request, with parent \a parent.
 */
GetPlaybackKeyPairResponse::GetPlaybackKeyPairResponse(
        const GetPlaybackKeyPairRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new GetPlaybackKeyPairResponsePrivate(this), parent)
{
    setRequest(new GetPlaybackKeyPairRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful Ivs GetPlaybackKeyPair \a response.
 */
void GetPlaybackKeyPairResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetPlaybackKeyPairResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Ivs::GetPlaybackKeyPairResponsePrivate
 * \brief The GetPlaybackKeyPairResponsePrivate class provides private implementation for GetPlaybackKeyPairResponse.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a GetPlaybackKeyPairResponsePrivate object with public implementation \a q.
 */
GetPlaybackKeyPairResponsePrivate::GetPlaybackKeyPairResponsePrivate(
    GetPlaybackKeyPairResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a Ivs GetPlaybackKeyPair response element from \a xml.
 */
void GetPlaybackKeyPairResponsePrivate::parseGetPlaybackKeyPairResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetPlaybackKeyPairResponse"));
    Q_UNUSED(xml) ///< @todo
}
