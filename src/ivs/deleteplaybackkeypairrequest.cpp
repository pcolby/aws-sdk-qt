...
#include "deleteplaybackkeypairrequest_p.h"
...
/*!
 * \class QtAws::IVS::DeletePlaybackKeyPairRequest
 * \brief The DeletePlaybackKeyPairRequest class provides an interface for IVS DeletePlaybackKeyPair requests.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::deletePlaybackKeyPair
 */

/*!
 * Constructs a copy of \a other.
 */
DeletePlaybackKeyPairRequest::DeletePlaybackKeyPairRequest(const DeletePlaybackKeyPairRequest &other)
    : IvsRequest(new DeletePlaybackKeyPairRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeletePlaybackKeyPairRequest object.
 */
DeletePlaybackKeyPairRequest::DeletePlaybackKeyPairRequest()
    : IvsRequest(new DeletePlaybackKeyPairRequestPrivate(IvsRequest::DeletePlaybackKeyPairAction, this))
{
 ...
 * \reimp
 */
bool DeletePlaybackKeyPairRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeletePlaybackKeyPairResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeletePlaybackKeyPairRequest::response(QNetworkReply * const reply) const
{
    return new DeletePlaybackKeyPairResponse(*this, reply);
}

/*!
 * \class QtAws::IVS::DeletePlaybackKeyPairRequestPrivate
 * \brief The DeletePlaybackKeyPairRequestPrivate class provides private implementation for DeletePlaybackKeyPairRequest.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a DeletePlaybackKeyPairRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
DeletePlaybackKeyPairRequestPrivate::DeletePlaybackKeyPairRequestPrivate(
    const IvsRequest::Action action, DeletePlaybackKeyPairRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeletePlaybackKeyPairRequest
 * class' copy constructor.
 */
DeletePlaybackKeyPairRequestPrivate::DeletePlaybackKeyPairRequestPrivate(
    const DeletePlaybackKeyPairRequestPrivate &other, DeletePlaybackKeyPairRequest * const q)
