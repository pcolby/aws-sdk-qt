...
/*!
 * \class QtAws::IVS::ListStreamsResponse
 * \brief The ListStreamsResponse class provides an interace for IVS ListStreams responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
...
ListStreamsResponse::ListStreamsResponse(
    ...
    : IvsResponse(new ListStreamsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IVS ListStreams \a response.
 */
...
/*!
 * \class QtAws::IVS::ListStreamsResponsePrivate
...
ListStreamsResponsePrivate::ListStreamsResponsePrivate(
    ListStreamsResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS ListStreams response element from \a xml.
 */
