...
#include "deleterecordingconfigurationresponse_p.h"
...
/*!
 * \class QtAws::IVS::DeleteRecordingConfigurationResponse
 * \brief The DeleteRecordingConfigurationResponse class provides an interace for IVS DeleteRecordingConfiguration responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
...
/*!
 * Constructs a DeleteRecordingConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
DeleteRecordingConfigurationResponse::DeleteRecordingConfigurationResponse(
        const DeleteRecordingConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new DeleteRecordingConfigurationResponsePrivate(this), parent)
{
    setRequest(new DeleteRecordingConfigurationRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful IVS DeleteRecordingConfiguration \a response.
 */
void DeleteRecordingConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeleteRecordingConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::IVS::DeleteRecordingConfigurationResponsePrivate
 * \brief The DeleteRecordingConfigurationResponsePrivate class provides private implementation for DeleteRecordingConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a DeleteRecordingConfigurationResponsePrivate object with public implementation \a q.
 */
DeleteRecordingConfigurationResponsePrivate::DeleteRecordingConfigurationResponsePrivate(
    DeleteRecordingConfigurationResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS DeleteRecordingConfiguration response element from \a xml.
 */
void DeleteRecordingConfigurationResponsePrivate::parseDeleteRecordingConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeleteRecordingConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
