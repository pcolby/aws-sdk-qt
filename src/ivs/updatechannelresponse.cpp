...
/*!
 * \class QtAws::Ivs::UpdateChannelResponse
 * \brief The UpdateChannelResponse class provides an interace for Ivs UpdateChannel responses.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
...
UpdateChannelResponse::UpdateChannelResponse(
    ...
    : IvsResponse(new UpdateChannelResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Ivs UpdateChannel \a response.
 */
...
/*!
 * \class QtAws::Ivs::UpdateChannelResponsePrivate
...
UpdateChannelResponsePrivate::UpdateChannelResponsePrivate(
    UpdateChannelResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a Ivs UpdateChannel response element from \a xml.
 */
