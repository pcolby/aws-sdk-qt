...
#include "getstreamsessionresponse_p.h"
...
/*!
 * \class QtAws::Ivs::GetStreamSessionResponse
 * \brief The GetStreamSessionResponse class provides an interace for Ivs GetStreamSession responses.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::getStreamSession
 */

/*!
 * Constructs a GetStreamSessionResponse object for \a reply to \a request, with parent \a parent.
 */
GetStreamSessionResponse::GetStreamSessionResponse(
        const GetStreamSessionRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new GetStreamSessionResponsePrivate(this), parent)
{
    setRequest(new GetStreamSessionRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetStreamSessionRequest * GetStreamSessionResponse::request() const
{
    Q_D(const GetStreamSessionResponse);
    return static_cast<const GetStreamSessionRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Ivs GetStreamSession \a response.
 */
void GetStreamSessionResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetStreamSessionResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Ivs::GetStreamSessionResponsePrivate
 * \brief The GetStreamSessionResponsePrivate class provides private implementation for GetStreamSessionResponse.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a GetStreamSessionResponsePrivate object with public implementation \a q.
 */
GetStreamSessionResponsePrivate::GetStreamSessionResponsePrivate(
    GetStreamSessionResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a Ivs GetStreamSession response element from \a xml.
 */
void GetStreamSessionResponsePrivate::parseGetStreamSessionResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetStreamSessionResponse"));
    Q_UNUSED(xml) ///< @todo
}
