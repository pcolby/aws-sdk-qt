...
/*!
 * \class QtAws::Ivs::ListTagsForResourceRequest
 * \brief The ListTagsForResourceRequest class provides an interface for Ivs ListTagsForResource requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::listTagsForResource
 */
...
ListTagsForResourceRequest::ListTagsForResourceRequest(const ListTagsForResourceRequest &other)
    : IvsRequest(new ListTagsForResourceRequestPrivate(*other.d_func(), this))
{
...
ListTagsForResourceRequest::ListTagsForResourceRequest()
    : IvsRequest(new ListTagsForResourceRequestPrivate(IvsRequest::ListTagsForResourceAction, this))
{
...
/*!
 * \class QtAws::Ivs::ListTagsForResourceRequestPrivate
...
/*!
 * Constructs a ListTagsForResourceRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
ListTagsForResourceRequestPrivate::ListTagsForResourceRequestPrivate(
    const IvsRequest::Action action, ListTagsForResourceRequest * const q)
