...
#include "listplaybackkeypairsrequest_p.h"
...
/*!
 * \class QtAws::Ivs::ListPlaybackKeyPairsRequest
 * \brief The ListPlaybackKeyPairsRequest class provides an interface for Ivs ListPlaybackKeyPairs requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 */
ListPlaybackKeyPairsRequest::ListPlaybackKeyPairsRequest(const ListPlaybackKeyPairsRequest &other)
    : IvsRequest(new ListPlaybackKeyPairsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListPlaybackKeyPairsRequest object.
 */
ListPlaybackKeyPairsRequest::ListPlaybackKeyPairsRequest()
    : IvsRequest(new ListPlaybackKeyPairsRequestPrivate(IvsRequest::ListPlaybackKeyPairsAction, this))
{
 ...
 * \reimp
 */
bool ListPlaybackKeyPairsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListPlaybackKeyPairsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListPlaybackKeyPairsRequest::response(QNetworkReply * const reply) const
{
    return new ListPlaybackKeyPairsResponse(*this, reply);
}

/*!
 * \class QtAws::Ivs::ListPlaybackKeyPairsRequestPrivate
 * \brief The ListPlaybackKeyPairsRequestPrivate class provides private implementation for ListPlaybackKeyPairsRequest.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a ListPlaybackKeyPairsRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
ListPlaybackKeyPairsRequestPrivate::ListPlaybackKeyPairsRequestPrivate(
    const IvsRequest::Action action, ListPlaybackKeyPairsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListPlaybackKeyPairsRequest
 * class' copy constructor.
 */
ListPlaybackKeyPairsRequestPrivate::ListPlaybackKeyPairsRequestPrivate(
    const ListPlaybackKeyPairsRequestPrivate &other, ListPlaybackKeyPairsRequest * const q)
