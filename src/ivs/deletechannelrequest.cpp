...
/*!
 * \class QtAws::Ivs::DeleteChannelRequest
 * \brief The DeleteChannelRequest class provides an interface for Ivs DeleteChannel requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
...
DeleteChannelRequest::DeleteChannelRequest(const DeleteChannelRequest &other)
    : IvsRequest(new DeleteChannelRequestPrivate(*other.d_func(), this))
{
...
DeleteChannelRequest::DeleteChannelRequest()
    : IvsRequest(new DeleteChannelRequestPrivate(IvsRequest::DeleteChannelAction, this))
{
...
/*!
 * \class QtAws::Ivs::DeleteChannelRequestPrivate
...
/*!
 * Constructs a DeleteChannelRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
DeleteChannelRequestPrivate::DeleteChannelRequestPrivate(
    const IvsRequest::Action action, DeleteChannelRequest * const q)
