...
#include "createstreamkeyrequest_p.h"
...
/*!
 * \class QtAws::Ivs::CreateStreamKeyRequest
 * \brief The CreateStreamKeyRequest class provides an interface for Ivs CreateStreamKey requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::createStreamKey
 */

/*!
 * Constructs a copy of \a other.
 */
CreateStreamKeyRequest::CreateStreamKeyRequest(const CreateStreamKeyRequest &other)
    : IvsRequest(new CreateStreamKeyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateStreamKeyRequest object.
 */
CreateStreamKeyRequest::CreateStreamKeyRequest()
    : IvsRequest(new CreateStreamKeyRequestPrivate(IvsRequest::CreateStreamKeyAction, this))
{
 ...
 * \reimp
 */
bool CreateStreamKeyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateStreamKeyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateStreamKeyRequest::response(QNetworkReply * const reply) const
{
    return new CreateStreamKeyResponse(*this, reply);
}

/*!
 * \class QtAws::Ivs::CreateStreamKeyRequestPrivate
 * \brief The CreateStreamKeyRequestPrivate class provides private implementation for CreateStreamKeyRequest.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a CreateStreamKeyRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
CreateStreamKeyRequestPrivate::CreateStreamKeyRequestPrivate(
    const IvsRequest::Action action, CreateStreamKeyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateStreamKeyRequest
 * class' copy constructor.
 */
CreateStreamKeyRequestPrivate::CreateStreamKeyRequestPrivate(
    const CreateStreamKeyRequestPrivate &other, CreateStreamKeyRequest * const q)
