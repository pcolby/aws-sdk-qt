...
#include "deletestreamkeyrequest_p.h"
...
/*!
 * \class QtAws::Ivs::DeleteStreamKeyRequest
 * \brief The DeleteStreamKeyRequest class provides an interface for Ivs DeleteStreamKey requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::deleteStreamKey
 */

/*!
 * Constructs a copy of \a other.
 */
DeleteStreamKeyRequest::DeleteStreamKeyRequest(const DeleteStreamKeyRequest &other)
    : IvsRequest(new DeleteStreamKeyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a DeleteStreamKeyRequest object.
 */
DeleteStreamKeyRequest::DeleteStreamKeyRequest()
    : IvsRequest(new DeleteStreamKeyRequestPrivate(IvsRequest::DeleteStreamKeyAction, this))
{
 ...
 * \reimp
 */
bool DeleteStreamKeyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a DeleteStreamKeyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * DeleteStreamKeyRequest::response(QNetworkReply * const reply) const
{
    return new DeleteStreamKeyResponse(*this, reply);
}

/*!
 * \class QtAws::Ivs::DeleteStreamKeyRequestPrivate
 * \brief The DeleteStreamKeyRequestPrivate class provides private implementation for DeleteStreamKeyRequest.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a DeleteStreamKeyRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
DeleteStreamKeyRequestPrivate::DeleteStreamKeyRequestPrivate(
    const IvsRequest::Action action, DeleteStreamKeyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the DeleteStreamKeyRequest
 * class' copy constructor.
 */
DeleteStreamKeyRequestPrivate::DeleteStreamKeyRequestPrivate(
    const DeleteStreamKeyRequestPrivate &other, DeleteStreamKeyRequest * const q)
