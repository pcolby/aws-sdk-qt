...
/*!
 * \class QtAws::IVS::DeleteChannelResponse
 * \brief The DeleteChannelResponse class provides an interace for IVS DeleteChannel responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
...
DeleteChannelResponse::DeleteChannelResponse(
    ...
    : IvsResponse(new DeleteChannelResponsePrivate(this), parent)
{
...
{
    return static_cast<const DeleteChannelRequest *>(IvsResponse::request());
}

/*!
 * \reimp
 * Parses a successful IVS DeleteChannel \a response.
 */
...
/*!
 * \class QtAws::IVS::DeleteChannelResponsePrivate
...
DeleteChannelResponsePrivate::DeleteChannelResponsePrivate(
    DeleteChannelResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS DeleteChannel response element from \a xml.
 */
