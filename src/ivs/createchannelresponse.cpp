...
/*!
 * \class QtAws::IVS::CreateChannelResponse
 * \brief The CreateChannelResponse class provides an interace for IVS CreateChannel responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
...
CreateChannelResponse::CreateChannelResponse(
    ...
    : IvsResponse(new CreateChannelResponsePrivate(this), parent)
{
...
{
    return static_cast<const CreateChannelRequest *>(IvsResponse::request());
}

/*!
 * \reimp
 * Parses a successful IVS CreateChannel \a response.
 */
...
/*!
 * \class QtAws::IVS::CreateChannelResponsePrivate
...
CreateChannelResponsePrivate::CreateChannelResponsePrivate(
    CreateChannelResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS CreateChannel response element from \a xml.
 */
