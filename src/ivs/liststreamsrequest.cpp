...
/*!
 * \class QtAws::Ivs::ListStreamsRequest
 * \brief The ListStreamsRequest class provides an interface for Ivs ListStreams requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
...
ListStreamsRequest::ListStreamsRequest(const ListStreamsRequest &other)
    : IvsRequest(new ListStreamsRequestPrivate(*other.d_func(), this))
{
...
ListStreamsRequest::ListStreamsRequest()
    : IvsRequest(new ListStreamsRequestPrivate(IvsRequest::ListStreamsAction, this))
{
...
/*!
 * \class QtAws::Ivs::ListStreamsRequestPrivate
...
/*!
 * Constructs a ListStreamsRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
ListStreamsRequestPrivate::ListStreamsRequestPrivate(
    const IvsRequest::Action action, ListStreamsRequest * const q)
