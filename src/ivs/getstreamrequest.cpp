...
/*!
 * \class QtAws::IVS::GetStreamRequest
 * \brief The GetStreamRequest class provides an interface for IVS GetStream requests.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::getStream
 */

/*!
 * Constructs a copy of \a other.
 */
GetStreamRequest::GetStreamRequest(const GetStreamRequest &other)
    : IvsRequest(new GetStreamRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetStreamRequest object.
 */
GetStreamRequest::GetStreamRequest()
    : IvsRequest(new GetStreamRequestPrivate(IvsRequest::GetStreamAction, this))
{
 ...
 * \reimp
 */
bool GetStreamRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetStreamResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetStreamRequest::response(QNetworkReply * const reply) const
{
    return new GetStreamResponse(*this, reply);
}

/*!
 * \class QtAws::IVS::GetStreamRequestPrivate
 * \brief The GetStreamRequestPrivate class provides private implementation for GetStreamRequest.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a GetStreamRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
GetStreamRequestPrivate::GetStreamRequestPrivate(
    const IvsRequest::Action action, GetStreamRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetStreamRequest
 * class' copy constructor.
 */
GetStreamRequestPrivate::GetStreamRequestPrivate(
    const GetStreamRequestPrivate &other, GetStreamRequest * const q)
