...
#include "createrecordingconfigurationrequest_p.h"
...
/*!
 * \class QtAws::Ivs::CreateRecordingConfigurationRequest
 * \brief The CreateRecordingConfigurationRequest class provides an interface for Ivs CreateRecordingConfiguration requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::createRecordingConfiguration
 */

/*!
 * Constructs a copy of \a other.
 */
CreateRecordingConfigurationRequest::CreateRecordingConfigurationRequest(const CreateRecordingConfigurationRequest &other)
    : IvsRequest(new CreateRecordingConfigurationRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a CreateRecordingConfigurationRequest object.
 */
CreateRecordingConfigurationRequest::CreateRecordingConfigurationRequest()
    : IvsRequest(new CreateRecordingConfigurationRequestPrivate(IvsRequest::CreateRecordingConfigurationAction, this))
{
 ...
 * \reimp
 */
bool CreateRecordingConfigurationRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a CreateRecordingConfigurationResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * CreateRecordingConfigurationRequest::response(QNetworkReply * const reply) const
{
    return new CreateRecordingConfigurationResponse(*this, reply);
}

/*!
 * \class QtAws::Ivs::CreateRecordingConfigurationRequestPrivate
 * \brief The CreateRecordingConfigurationRequestPrivate class provides private implementation for CreateRecordingConfigurationRequest.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a CreateRecordingConfigurationRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
CreateRecordingConfigurationRequestPrivate::CreateRecordingConfigurationRequestPrivate(
    const IvsRequest::Action action, CreateRecordingConfigurationRequest * const q)
    : IvsRequestPrivate(action, q)
{
 ...
 *
 * This copy-like constructor exists for the benefit of the CreateRecordingConfigurationRequest
 * class' copy constructor.
 */
CreateRecordingConfigurationRequestPrivate::CreateRecordingConfigurationRequestPrivate(
    const CreateRecordingConfigurationRequestPrivate &other, CreateRecordingConfigurationRequest * const q)
    : IvsRequestPrivate(other, q)
{
