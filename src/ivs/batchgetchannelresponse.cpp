...
#include "batchgetchannelresponse_p.h"
...
/*!
 * \class QtAws::IVS::BatchGetChannelResponse
 * \brief The BatchGetChannelResponse class provides an interace for IVS BatchGetChannel responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
...
/*!
 * Constructs a BatchGetChannelResponse object for \a reply to \a request, with parent \a parent.
 */
BatchGetChannelResponse::BatchGetChannelResponse(
        const BatchGetChannelRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new BatchGetChannelResponsePrivate(this), parent)
{
    setRequest(new BatchGetChannelRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful IVS BatchGetChannel \a response.
 */
void BatchGetChannelResponse::parseSuccess(QIODevice &response)
{
    //Q_D(BatchGetChannelResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::IVS::BatchGetChannelResponsePrivate
 * \brief The BatchGetChannelResponsePrivate class provides private implementation for BatchGetChannelResponse.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a BatchGetChannelResponsePrivate object with public implementation \a q.
 */
BatchGetChannelResponsePrivate::BatchGetChannelResponsePrivate(
    BatchGetChannelResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS BatchGetChannel response element from \a xml.
 */
void BatchGetChannelResponsePrivate::parseBatchGetChannelResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("BatchGetChannelResponse"));
    Q_UNUSED(xml) ///< @todo
}
