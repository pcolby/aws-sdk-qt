...
#include "deleteplaybackkeypairresponse_p.h"
...
/*!
 * \class QtAws::IVS::DeletePlaybackKeyPairResponse
 * \brief The DeletePlaybackKeyPairResponse class provides an interace for IVS DeletePlaybackKeyPair responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
...
/*!
 * Constructs a DeletePlaybackKeyPairResponse object for \a reply to \a request, with parent \a parent.
 */
DeletePlaybackKeyPairResponse::DeletePlaybackKeyPairResponse(
        const DeletePlaybackKeyPairRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new DeletePlaybackKeyPairResponsePrivate(this), parent)
{
    setRequest(new DeletePlaybackKeyPairRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful IVS DeletePlaybackKeyPair \a response.
 */
void DeletePlaybackKeyPairResponse::parseSuccess(QIODevice &response)
{
    //Q_D(DeletePlaybackKeyPairResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::IVS::DeletePlaybackKeyPairResponsePrivate
 * \brief The DeletePlaybackKeyPairResponsePrivate class provides private implementation for DeletePlaybackKeyPairResponse.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a DeletePlaybackKeyPairResponsePrivate object with public implementation \a q.
 */
DeletePlaybackKeyPairResponsePrivate::DeletePlaybackKeyPairResponsePrivate(
    DeletePlaybackKeyPairResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS DeletePlaybackKeyPair response element from \a xml.
 */
void DeletePlaybackKeyPairResponsePrivate::parseDeletePlaybackKeyPairResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("DeletePlaybackKeyPairResponse"));
    Q_UNUSED(xml) ///< @todo
}
