...
#include "getrecordingconfigurationresponse_p.h"
...
/*!
 * \class QtAws::IVS::GetRecordingConfigurationResponse
 * \brief The GetRecordingConfigurationResponse class provides an interace for IVS GetRecordingConfiguration responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::getRecordingConfiguration
 */

/*!
 * Constructs a GetRecordingConfigurationResponse object for \a reply to \a request, with parent \a parent.
 */
GetRecordingConfigurationResponse::GetRecordingConfigurationResponse(
        const GetRecordingConfigurationRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new GetRecordingConfigurationResponsePrivate(this), parent)
{
    setRequest(new GetRecordingConfigurationRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const GetRecordingConfigurationRequest * GetRecordingConfigurationResponse::request() const
{
    Q_D(const GetRecordingConfigurationResponse);
    return static_cast<const GetRecordingConfigurationRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful IVS GetRecordingConfiguration \a response.
 */
void GetRecordingConfigurationResponse::parseSuccess(QIODevice &response)
{
    //Q_D(GetRecordingConfigurationResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::IVS::GetRecordingConfigurationResponsePrivate
 * \brief The GetRecordingConfigurationResponsePrivate class provides private implementation for GetRecordingConfigurationResponse.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a GetRecordingConfigurationResponsePrivate object with public implementation \a q.
 */
GetRecordingConfigurationResponsePrivate::GetRecordingConfigurationResponsePrivate(
    GetRecordingConfigurationResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS GetRecordingConfiguration response element from \a xml.
 */
void GetRecordingConfigurationResponsePrivate::parseGetRecordingConfigurationResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("GetRecordingConfigurationResponse"));
    Q_UNUSED(xml) ///< @todo
}
