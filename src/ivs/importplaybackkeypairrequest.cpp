...
#include "importplaybackkeypairrequest_p.h"
...
/*!
 * \class QtAws::Ivs::ImportPlaybackKeyPairRequest
 * \brief The ImportPlaybackKeyPairRequest class provides an interface for Ivs ImportPlaybackKeyPair requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 */
ImportPlaybackKeyPairRequest::ImportPlaybackKeyPairRequest(const ImportPlaybackKeyPairRequest &other)
    : IvsRequest(new ImportPlaybackKeyPairRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ImportPlaybackKeyPairRequest object.
 */
ImportPlaybackKeyPairRequest::ImportPlaybackKeyPairRequest()
    : IvsRequest(new ImportPlaybackKeyPairRequestPrivate(IvsRequest::ImportPlaybackKeyPairAction, this))
{
 ...
 * \reimp
 */
bool ImportPlaybackKeyPairRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ImportPlaybackKeyPairResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ImportPlaybackKeyPairRequest::response(QNetworkReply * const reply) const
{
    return new ImportPlaybackKeyPairResponse(*this, reply);
}

/*!
 * \class QtAws::Ivs::ImportPlaybackKeyPairRequestPrivate
 * \brief The ImportPlaybackKeyPairRequestPrivate class provides private implementation for ImportPlaybackKeyPairRequest.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a ImportPlaybackKeyPairRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
ImportPlaybackKeyPairRequestPrivate::ImportPlaybackKeyPairRequestPrivate(
    const IvsRequest::Action action, ImportPlaybackKeyPairRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ImportPlaybackKeyPairRequest
 * class' copy constructor.
 */
ImportPlaybackKeyPairRequestPrivate::ImportPlaybackKeyPairRequestPrivate(
    const ImportPlaybackKeyPairRequestPrivate &other, ImportPlaybackKeyPairRequest * const q)
