...
#include "getstreamsessionrequest_p.h"
...
/*!
 * \class QtAws::Ivs::GetStreamSessionRequest
 * \brief The GetStreamSessionRequest class provides an interface for Ivs GetStreamSession requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 */
GetStreamSessionRequest::GetStreamSessionRequest(const GetStreamSessionRequest &other)
    : IvsRequest(new GetStreamSessionRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetStreamSessionRequest object.
 */
GetStreamSessionRequest::GetStreamSessionRequest()
    : IvsRequest(new GetStreamSessionRequestPrivate(IvsRequest::GetStreamSessionAction, this))
{
 ...
 * \reimp
 */
bool GetStreamSessionRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetStreamSessionResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetStreamSessionRequest::response(QNetworkReply * const reply) const
{
    return new GetStreamSessionResponse(*this, reply);
}

/*!
 * \class QtAws::Ivs::GetStreamSessionRequestPrivate
 * \brief The GetStreamSessionRequestPrivate class provides private implementation for GetStreamSessionRequest.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a GetStreamSessionRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
GetStreamSessionRequestPrivate::GetStreamSessionRequestPrivate(
    const IvsRequest::Action action, GetStreamSessionRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetStreamSessionRequest
 * class' copy constructor.
 */
GetStreamSessionRequestPrivate::GetStreamSessionRequestPrivate(
    const GetStreamSessionRequestPrivate &other, GetStreamSessionRequest * const q)
