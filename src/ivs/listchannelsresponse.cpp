...
/*!
 * \class QtAws::IVS::ListChannelsResponse
 * \brief The ListChannelsResponse class provides an interace for IVS ListChannels responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
...
ListChannelsResponse::ListChannelsResponse(
    ...
    : IvsResponse(new ListChannelsResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful IVS ListChannels \a response.
 */
...
/*!
 * \class QtAws::IVS::ListChannelsResponsePrivate
...
ListChannelsResponsePrivate::ListChannelsResponsePrivate(
    ListChannelsResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS ListChannels response element from \a xml.
 */
