...
/*!
 * \class QtAws::IVS::TagResourceResponse
 * \brief The TagResourceResponse class provides an interace for IVS TagResource responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
...
TagResourceResponse::TagResourceResponse(
    ...
    : IvsResponse(new TagResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const TagResourceRequest *>(IvsResponse::request());
}

/*!
 * \reimp
 * Parses a successful IVS TagResource \a response.
 */
...
/*!
 * \class QtAws::IVS::TagResourceResponsePrivate
...
TagResourceResponsePrivate::TagResourceResponsePrivate(
    TagResourceResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS TagResource response element from \a xml.
 */
