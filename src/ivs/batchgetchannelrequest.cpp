...
#include "batchgetchannelrequest_p.h"
...
/*!
 * \class QtAws::Ivs::BatchGetChannelRequest
 * \brief The BatchGetChannelRequest class provides an interface for Ivs BatchGetChannel requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::batchGetChannel
 */

/*!
 * Constructs a copy of \a other.
 */
BatchGetChannelRequest::BatchGetChannelRequest(const BatchGetChannelRequest &other)
    : IvsRequest(new BatchGetChannelRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a BatchGetChannelRequest object.
 */
BatchGetChannelRequest::BatchGetChannelRequest()
    : IvsRequest(new BatchGetChannelRequestPrivate(IvsRequest::BatchGetChannelAction, this))
{
 ...
 * \reimp
 */
bool BatchGetChannelRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a BatchGetChannelResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * BatchGetChannelRequest::response(QNetworkReply * const reply) const
{
    return new BatchGetChannelResponse(*this, reply);
}

/*!
 * \class QtAws::Ivs::BatchGetChannelRequestPrivate
 * \brief The BatchGetChannelRequestPrivate class provides private implementation for BatchGetChannelRequest.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a BatchGetChannelRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
BatchGetChannelRequestPrivate::BatchGetChannelRequestPrivate(
    const IvsRequest::Action action, BatchGetChannelRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the BatchGetChannelRequest
 * class' copy constructor.
 */
BatchGetChannelRequestPrivate::BatchGetChannelRequestPrivate(
    const BatchGetChannelRequestPrivate &other, BatchGetChannelRequest * const q)
