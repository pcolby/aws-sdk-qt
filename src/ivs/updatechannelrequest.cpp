...
/*!
 * \class QtAws::Ivs::UpdateChannelRequest
 * \brief The UpdateChannelRequest class provides an interface for Ivs UpdateChannel requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
...
UpdateChannelRequest::UpdateChannelRequest(const UpdateChannelRequest &other)
    : IvsRequest(new UpdateChannelRequestPrivate(*other.d_func(), this))
{
...
UpdateChannelRequest::UpdateChannelRequest()
    : IvsRequest(new UpdateChannelRequestPrivate(IvsRequest::UpdateChannelAction, this))
{
...
/*!
 * \class QtAws::Ivs::UpdateChannelRequestPrivate
...
/*!
 * Constructs a UpdateChannelRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
UpdateChannelRequestPrivate::UpdateChannelRequestPrivate(
    const IvsRequest::Action action, UpdateChannelRequest * const q)
