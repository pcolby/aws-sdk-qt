...
#include "createstreamkeyresponse_p.h"
...
/*!
 * \class QtAws::IVS::CreateStreamKeyResponse
 * \brief The CreateStreamKeyResponse class provides an interace for IVS CreateStreamKey responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
...
/*!
 * Constructs a CreateStreamKeyResponse object for \a reply to \a request, with parent \a parent.
 */
CreateStreamKeyResponse::CreateStreamKeyResponse(
        const CreateStreamKeyRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new CreateStreamKeyResponsePrivate(this), parent)
{
    setRequest(new CreateStreamKeyRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful IVS CreateStreamKey \a response.
 */
void CreateStreamKeyResponse::parseSuccess(QIODevice &response)
{
    //Q_D(CreateStreamKeyResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::IVS::CreateStreamKeyResponsePrivate
 * \brief The CreateStreamKeyResponsePrivate class provides private implementation for CreateStreamKeyResponse.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a CreateStreamKeyResponsePrivate object with public implementation \a q.
 */
CreateStreamKeyResponsePrivate::CreateStreamKeyResponsePrivate(
    CreateStreamKeyResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS CreateStreamKey response element from \a xml.
 */
void CreateStreamKeyResponsePrivate::parseCreateStreamKeyResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("CreateStreamKeyResponse"));
    Q_UNUSED(xml) ///< @todo
}
