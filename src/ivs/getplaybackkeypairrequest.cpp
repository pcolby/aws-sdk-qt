...
#include "getplaybackkeypairrequest_p.h"
...
/*!
 * \class QtAws::Ivs::GetPlaybackKeyPairRequest
 * \brief The GetPlaybackKeyPairRequest class provides an interface for Ivs GetPlaybackKeyPair requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::getPlaybackKeyPair
 */

/*!
 * Constructs a copy of \a other.
 */
GetPlaybackKeyPairRequest::GetPlaybackKeyPairRequest(const GetPlaybackKeyPairRequest &other)
    : IvsRequest(new GetPlaybackKeyPairRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetPlaybackKeyPairRequest object.
 */
GetPlaybackKeyPairRequest::GetPlaybackKeyPairRequest()
    : IvsRequest(new GetPlaybackKeyPairRequestPrivate(IvsRequest::GetPlaybackKeyPairAction, this))
{
 ...
 * \reimp
 */
bool GetPlaybackKeyPairRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetPlaybackKeyPairResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetPlaybackKeyPairRequest::response(QNetworkReply * const reply) const
{
    return new GetPlaybackKeyPairResponse(*this, reply);
}

/*!
 * \class QtAws::Ivs::GetPlaybackKeyPairRequestPrivate
 * \brief The GetPlaybackKeyPairRequestPrivate class provides private implementation for GetPlaybackKeyPairRequest.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a GetPlaybackKeyPairRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
GetPlaybackKeyPairRequestPrivate::GetPlaybackKeyPairRequestPrivate(
    const IvsRequest::Action action, GetPlaybackKeyPairRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetPlaybackKeyPairRequest
 * class' copy constructor.
 */
GetPlaybackKeyPairRequestPrivate::GetPlaybackKeyPairRequestPrivate(
    const GetPlaybackKeyPairRequestPrivate &other, GetPlaybackKeyPairRequest * const q)
