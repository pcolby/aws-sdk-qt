...
#include "stopstreamresponse_p.h"
...
/*!
 * \class QtAws::IVS::StopStreamResponse
 * \brief The StopStreamResponse class provides an interace for IVS StopStream responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
...
/*!
 * Constructs a StopStreamResponse object for \a reply to \a request, with parent \a parent.
 */
StopStreamResponse::StopStreamResponse(
        const StopStreamRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new StopStreamResponsePrivate(this), parent)
{
    setRequest(new StopStreamRequest(request));
    setReply(reply);
}
...
/*!
 * \reimp
 * Parses a successful IVS StopStream \a response.
 */
void StopStreamResponse::parseSuccess(QIODevice &response)
{
    //Q_D(StopStreamResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::IVS::StopStreamResponsePrivate
 * \brief The StopStreamResponsePrivate class provides private implementation for StopStreamResponse.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a StopStreamResponsePrivate object with public implementation \a q.
 */
StopStreamResponsePrivate::StopStreamResponsePrivate(
    StopStreamResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS StopStream response element from \a xml.
 */
void StopStreamResponsePrivate::parseStopStreamResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("StopStreamResponse"));
    Q_UNUSED(xml) ///< @todo
}
