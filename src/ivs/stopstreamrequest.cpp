...
/*!
 * \class QtAws::Ivs::StopStreamRequest
 * \brief The StopStreamRequest class provides an interface for Ivs StopStream requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::stopStream
 */

/*!
 * Constructs a copy of \a other.
 */
StopStreamRequest::StopStreamRequest(const StopStreamRequest &other)
    : IvsRequest(new StopStreamRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a StopStreamRequest object.
 */
StopStreamRequest::StopStreamRequest()
    : IvsRequest(new StopStreamRequestPrivate(IvsRequest::StopStreamAction, this))
{
 ...
 * \reimp
 */
bool StopStreamRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a StopStreamResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * StopStreamRequest::response(QNetworkReply * const reply) const
{
    return new StopStreamResponse(*this, reply);
}

/*!
 * \class QtAws::Ivs::StopStreamRequestPrivate
 * \brief The StopStreamRequestPrivate class provides private implementation for StopStreamRequest.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a StopStreamRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
StopStreamRequestPrivate::StopStreamRequestPrivate(
    const IvsRequest::Action action, StopStreamRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the StopStreamRequest
 * class' copy constructor.
 */
StopStreamRequestPrivate::StopStreamRequestPrivate(
    const StopStreamRequestPrivate &other, StopStreamRequest * const q)
