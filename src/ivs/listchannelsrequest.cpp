...
/*!
 * \class QtAws::Ivs::ListChannelsRequest
 * \brief The ListChannelsRequest class provides an interface for Ivs ListChannels requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
...
ListChannelsRequest::ListChannelsRequest(const ListChannelsRequest &other)
    : IvsRequest(new ListChannelsRequestPrivate(*other.d_func(), this))
{
...
ListChannelsRequest::ListChannelsRequest()
    : IvsRequest(new ListChannelsRequestPrivate(IvsRequest::ListChannelsAction, this))
{
...
/*!
 * \class QtAws::Ivs::ListChannelsRequestPrivate
...
/*!
 * Constructs a ListChannelsRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
ListChannelsRequestPrivate::ListChannelsRequestPrivate(
    const IvsRequest::Action action, ListChannelsRequest * const q)
