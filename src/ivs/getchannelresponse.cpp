...
/*!
 * \class QtAws::Ivs::GetChannelResponse
 * \brief The GetChannelResponse class provides an interace for Ivs GetChannel responses.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
...
GetChannelResponse::GetChannelResponse(
    ...
    : IvsResponse(new GetChannelResponsePrivate(this), parent)
{
...
/*!
 * \reimp
 * Parses a successful Ivs GetChannel \a response.
 */
...
/*!
 * \class QtAws::Ivs::GetChannelResponsePrivate
...
GetChannelResponsePrivate::GetChannelResponsePrivate(
    GetChannelResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a Ivs GetChannel response element from \a xml.
 */
