...
#include "liststreamkeysrequest_p.h"
...
/*!
 * \class QtAws::IVS::ListStreamKeysRequest
 * \brief The ListStreamKeysRequest class provides an interface for IVS ListStreamKeys requests.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
 ...
 */
ListStreamKeysRequest::ListStreamKeysRequest(const ListStreamKeysRequest &other)
    : IvsRequest(new ListStreamKeysRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListStreamKeysRequest object.
 */
ListStreamKeysRequest::ListStreamKeysRequest()
    : IvsRequest(new ListStreamKeysRequestPrivate(IvsRequest::ListStreamKeysAction, this))
{
 ...
 * \reimp
 */
bool ListStreamKeysRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListStreamKeysResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListStreamKeysRequest::response(QNetworkReply * const reply) const
{
    return new ListStreamKeysResponse(*this, reply);
}

/*!
 * \class QtAws::IVS::ListStreamKeysRequestPrivate
 * \brief The ListStreamKeysRequestPrivate class provides private implementation for ListStreamKeysRequest.
 * \internal
 *
 * \inmodule QtAwsIVS
 */
...
/*!
 * Constructs a ListStreamKeysRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
ListStreamKeysRequestPrivate::ListStreamKeysRequestPrivate(
    const IvsRequest::Action action, ListStreamKeysRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListStreamKeysRequest
 * class' copy constructor.
 */
ListStreamKeysRequestPrivate::ListStreamKeysRequestPrivate(
    const ListStreamKeysRequestPrivate &other, ListStreamKeysRequest * const q)
