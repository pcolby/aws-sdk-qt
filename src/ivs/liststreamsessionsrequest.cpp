...
#include "liststreamsessionsrequest_p.h"
...
/*!
 * \class QtAws::Ivs::ListStreamSessionsRequest
 * \brief The ListStreamSessionsRequest class provides an interface for Ivs ListStreamSessions requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 */
ListStreamSessionsRequest::ListStreamSessionsRequest(const ListStreamSessionsRequest &other)
    : IvsRequest(new ListStreamSessionsRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a ListStreamSessionsRequest object.
 */
ListStreamSessionsRequest::ListStreamSessionsRequest()
    : IvsRequest(new ListStreamSessionsRequestPrivate(IvsRequest::ListStreamSessionsAction, this))
{
 ...
 * \reimp
 */
bool ListStreamSessionsRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a ListStreamSessionsResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * ListStreamSessionsRequest::response(QNetworkReply * const reply) const
{
    return new ListStreamSessionsResponse(*this, reply);
}

/*!
 * \class QtAws::Ivs::ListStreamSessionsRequestPrivate
 * \brief The ListStreamSessionsRequestPrivate class provides private implementation for ListStreamSessionsRequest.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a ListStreamSessionsRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
ListStreamSessionsRequestPrivate::ListStreamSessionsRequestPrivate(
    const IvsRequest::Action action, ListStreamSessionsRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the ListStreamSessionsRequest
 * class' copy constructor.
 */
ListStreamSessionsRequestPrivate::ListStreamSessionsRequestPrivate(
    const ListStreamSessionsRequestPrivate &other, ListStreamSessionsRequest * const q)
