...
/*!
 * \class QtAws::Ivs::UntagResourceRequest
 * \brief The UntagResourceRequest class provides an interface for Ivs UntagResource requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
...
UntagResourceRequest::UntagResourceRequest(const UntagResourceRequest &other)
    : IvsRequest(new UntagResourceRequestPrivate(*other.d_func(), this))
{
...
UntagResourceRequest::UntagResourceRequest()
    : IvsRequest(new UntagResourceRequestPrivate(IvsRequest::UntagResourceAction, this))
{
...
/*!
 * \class QtAws::Ivs::UntagResourceRequestPrivate
...
/*!
 * Constructs a UntagResourceRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
UntagResourceRequestPrivate::UntagResourceRequestPrivate(
    const IvsRequest::Action action, UntagResourceRequest * const q)
