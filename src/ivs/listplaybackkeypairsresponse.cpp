...
#include "listplaybackkeypairsresponse_p.h"
...
/*!
 * \class QtAws::Ivs::ListPlaybackKeyPairsResponse
 * \brief The ListPlaybackKeyPairsResponse class provides an interace for Ivs ListPlaybackKeyPairs responses.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::listPlaybackKeyPairs
 */

/*!
 * Constructs a ListPlaybackKeyPairsResponse object for \a reply to \a request, with parent \a parent.
 */
ListPlaybackKeyPairsResponse::ListPlaybackKeyPairsResponse(
        const ListPlaybackKeyPairsRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new ListPlaybackKeyPairsResponsePrivate(this), parent)
{
    setRequest(new ListPlaybackKeyPairsRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ListPlaybackKeyPairsRequest * ListPlaybackKeyPairsResponse::request() const
{
    Q_D(const ListPlaybackKeyPairsResponse);
    return static_cast<const ListPlaybackKeyPairsRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Ivs ListPlaybackKeyPairs \a response.
 */
void ListPlaybackKeyPairsResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ListPlaybackKeyPairsResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Ivs::ListPlaybackKeyPairsResponsePrivate
 * \brief The ListPlaybackKeyPairsResponsePrivate class provides private implementation for ListPlaybackKeyPairsResponse.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a ListPlaybackKeyPairsResponsePrivate object with public implementation \a q.
 */
ListPlaybackKeyPairsResponsePrivate::ListPlaybackKeyPairsResponsePrivate(
    ListPlaybackKeyPairsResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a Ivs ListPlaybackKeyPairs response element from \a xml.
 */
void ListPlaybackKeyPairsResponsePrivate::parseListPlaybackKeyPairsResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ListPlaybackKeyPairsResponse"));
    Q_UNUSED(xml) ///< @todo
}
