...
#include "importplaybackkeypairresponse_p.h"
...
/*!
 * \class QtAws::Ivs::ImportPlaybackKeyPairResponse
 * \brief The ImportPlaybackKeyPairResponse class provides an interace for Ivs ImportPlaybackKeyPair responses.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 *
 * \sa IvsClient::importPlaybackKeyPair
 */

/*!
 * Constructs a ImportPlaybackKeyPairResponse object for \a reply to \a request, with parent \a parent.
 */
ImportPlaybackKeyPairResponse::ImportPlaybackKeyPairResponse(
        const ImportPlaybackKeyPairRequest &request,
        QNetworkReply * const reply,
        QObject * const parent)
    : IvsResponse(new ImportPlaybackKeyPairResponsePrivate(this), parent)
{
    setRequest(new ImportPlaybackKeyPairRequest(request));
    setReply(reply);
}
 ...
 * \reimp
 */
const ImportPlaybackKeyPairRequest * ImportPlaybackKeyPairResponse::request() const
{
    Q_D(const ImportPlaybackKeyPairResponse);
    return static_cast<const ImportPlaybackKeyPairRequest *>(d->request);
}

/*!
 * \reimp
 * Parses a successful Ivs ImportPlaybackKeyPair \a response.
 */
void ImportPlaybackKeyPairResponse::parseSuccess(QIODevice &response)
{
    //Q_D(ImportPlaybackKeyPairResponse);
    QXmlStreamReader xml(&response);
    /// @todo
}

/*!
 * \class QtAws::Ivs::ImportPlaybackKeyPairResponsePrivate
 * \brief The ImportPlaybackKeyPairResponsePrivate class provides private implementation for ImportPlaybackKeyPairResponse.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a ImportPlaybackKeyPairResponsePrivate object with public implementation \a q.
 */
ImportPlaybackKeyPairResponsePrivate::ImportPlaybackKeyPairResponsePrivate(
    ImportPlaybackKeyPairResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a Ivs ImportPlaybackKeyPair response element from \a xml.
 */
void ImportPlaybackKeyPairResponsePrivate::parseImportPlaybackKeyPairResponse(QXmlStreamReader &xml)
{
    Q_ASSERT(xml.name() == QLatin1String("ImportPlaybackKeyPairResponse"));
    Q_UNUSED(xml) ///< @todo
}
