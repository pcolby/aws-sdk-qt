...
#include "getstreamkeyrequest_p.h"
...
/*!
 * \class QtAws::Ivs::GetStreamKeyRequest
 * \brief The GetStreamKeyRequest class provides an interface for Ivs GetStreamKey requests.
 *
 * \inmodule QtAwsIvs
 *
 *  <b>Introduction</b>
 ...
 */
GetStreamKeyRequest::GetStreamKeyRequest(const GetStreamKeyRequest &other)
    : IvsRequest(new GetStreamKeyRequestPrivate(*other.d_func(), this))
{

}

/*!
 * Constructs a GetStreamKeyRequest object.
 */
GetStreamKeyRequest::GetStreamKeyRequest()
    : IvsRequest(new GetStreamKeyRequestPrivate(IvsRequest::GetStreamKeyAction, this))
{
 ...
 * \reimp
 */
bool GetStreamKeyRequest::isValid() const
{
    return false;
}
...
/*!
 * Returns a GetStreamKeyResponse object to process \a reply.
 *
 * \sa QtAws::Core::AwsAbstractClient::send
 */
QtAws::Core::AwsAbstractResponse * GetStreamKeyRequest::response(QNetworkReply * const reply) const
{
    return new GetStreamKeyResponse(*this, reply);
}

/*!
 * \class QtAws::Ivs::GetStreamKeyRequestPrivate
 * \brief The GetStreamKeyRequestPrivate class provides private implementation for GetStreamKeyRequest.
 * \internal
 *
 * \inmodule QtAwsIvs
 */
...
/*!
 * Constructs a GetStreamKeyRequestPrivate object for Ivs \a action,
 * with public implementation \a q.
 */
GetStreamKeyRequestPrivate::GetStreamKeyRequestPrivate(
    const IvsRequest::Action action, GetStreamKeyRequest * const q)
 ...
 *
 * This copy-like constructor exists for the benefit of the GetStreamKeyRequest
 * class' copy constructor.
 */
GetStreamKeyRequestPrivate::GetStreamKeyRequestPrivate(
    const GetStreamKeyRequestPrivate &other, GetStreamKeyRequest * const q)
