...
/*!
 * \class QtAws::IVS::ListTagsForResourceResponse
 * \brief The ListTagsForResourceResponse class provides an interace for IVS ListTagsForResource responses.
 *
 * \inmodule QtAwsIVS
 *
 *  <b>Introduction</b>
...
ListTagsForResourceResponse::ListTagsForResourceResponse(
    ...
    : IvsResponse(new ListTagsForResourceResponsePrivate(this), parent)
{
...
{
    return static_cast<const ListTagsForResourceRequest *>(IvsResponse::request());
}

/*!
 * \reimp
 * Parses a successful IVS ListTagsForResource \a response.
 */
...
/*!
 * \class QtAws::IVS::ListTagsForResourceResponsePrivate
...
ListTagsForResourceResponsePrivate::ListTagsForResourceResponsePrivate(
    ListTagsForResourceResponse * const q) : IvsResponsePrivate(q)
{

}

/*!
 * Parses a IVS ListTagsForResource response element from \a xml.
 */
