...
void TestAwsEndpoint::serviceName_data()
{
    ...
    NEW_ROW("s3-ap-northeast-1.amazonaws.com", "s3-ap-northeast-1");
    NEW_ROW("s3-ap-southeast-1.amazonaws.com", "s3-ap-southeast-1");
    NEW_ROW("s3-ap-southeast-2.amazonaws.com", "s3-ap-southeast-2");
    NEW_ROW("s3-eu-west-1.amazonaws.com", "s3-eu-west-1");
    NEW_ROW("s3-sa-east-1.amazonaws.com", "s3-sa-east-1");
    NEW_ROW("s3-us-gov-west-1.amazonaws.com", "s3-us-gov-west-1");
    NEW_ROW("s3-us-west-1.amazonaws.com", "s3-us-west-1");
    NEW_ROW("s3-us-west-2.amazonaws.com", "s3-us-west-2");
